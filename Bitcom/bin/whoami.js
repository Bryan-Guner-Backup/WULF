...
module.exports = function () {
  if (process.env.ADDRESS) {
    ...
    qrcode.generate("bitcoin:" + process.env.ADDRESS, function (code) {
      console.log(code);
      datapay
        .connect("https://bchsvexplorer.com")
        .address(process.env.ADDRESS, function (err, info) {
          if (err) {
    ...
    console.log(
      "You haven't generated a keypair. Look inside the .bit file, or generate a new one with 'bit init'"
    );
  }
};
