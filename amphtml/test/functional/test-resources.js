...
describe("Resources", () => {
  ...
  it(
    "should schedule prerenderable resource when" + " document is hidden",
    () => {
      let resource = {
        getState: () => {
          return ResourceState_.READY_FOR_LAYOUT;
...
describe("Resources.Resource", () => {
  ...
  it(
    "should ignore startLayout when document is hidden" +
  ...
  it(
    "should proceed startLayout when document is hidden" +
  ...
  it(
    "should call documentInactiveCallback on built element" +
