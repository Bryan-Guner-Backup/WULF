    ...
    var v = function (a) {
        c(c.address).trigger(
          c.extend(
            ...
            function () {
              for (
                var b = {}, e = c.address.parameterNames(), f = 0, p = e.length;
                f < p;
                f++
              )
      ...
      s = function () {
        return (
          "/" +
          g.pathname.replace(new RegExp(d.state), "") +
          g.search +
          (D() ? "#" + D() : "")
        ).replace(U, "/");
      },
      ...
      O = function () {
        var a =
          ...
          (n.domain != g.hostname ? '";document.domain="' + n.domain : "") +
        ...
        if (!ba) {
          ...
          if (d.wrap) {
            c("body > *")
              .wrapAll(
                '<div style="padding:' +
                  (x(b, "marginTop") + x(b, "paddingTop")) +
                  "px " +
                  (x(b, "marginRight") + x(b, "paddingRight")) +
                  "px " +
                  (x(b, "marginBottom") + x(b, "paddingBottom")) +
                  "px " +
                  (x(b, "marginLeft") + x(b, "paddingLeft")) +
                  'px;" />'
              )
              .parent()
              .wrap(
                '<div id="' +
                  ...
                  (H && !window.statusbar.visible ? "resize:both;" : "") +
                  '" />'
              );
            c("html, body").css({
              height: "100%",
      ...
      o = true,
      l = false,
      d = { autoUpdate: o, crawlable: l, history: o, strict: o, wrap: l },
      z = c.browser,
      ...
      state: function (a) {
        if (a !== k) {
          ...
          if (d.state !== k)
            if (M.pushState)
              b.substr(0, 3) == "/#/" &&
                g.replace(d.state.replace(/^\/$/, "") + b.substr(2));
            else
              b != "/" &&
                b.replace(/^\/#/, "") != D() &&
                t(function () {
      ...
      value: function (a) {
        if (a !== k) {
          ...
          if (d.autoUpdate || L) {
            E(o);
            if (r())
              M[d.history ? "pushState" : "replaceState"](
                {},
                "",
                d.state.replace(/\/$/, "") + (h === "" ? "/" : h)
              );
      ...
      var w = function (r) {
        ...
        if (c(this).is("a")) {
          var s = v
            ...
            : c.address.state() !== undefined && c.address.state() != "/"
            ? c(this)
                .attr("href")
