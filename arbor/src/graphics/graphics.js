...
var Graphics = function (canvas) {
  ...
  var _drawLibrary = {};
  var _drawStyle = { background: null, fill: null, stroke: null, width: 0 };
  ...
  var that = {
    ...
    drawStyle: function (style) {
      ...
      if (arguments.length == 2) {
        ...
        if (typeof styleName == "string" && typeof styleDef == "object") {
          ...
          $.each(
            "background fill stroke width".split(" "),
            function (i, param) {
              if (styleDef[param] !== undefined)
                newStyle[param] = styleDef[param];
            }
          );
    ...
    textStyle: function (style) {
      ...
      if (arguments.length == 2) {
        ...
        if (typeof styleName == "string" && typeof styleDef == "object") {
          ...
          $.each(
            "font size align baseline alpha".split(" "),
            function (i, param) {
              if (styleDef[param] !== undefined)
                newStyle[param] = styleDef[param];
            }
    ...
    text: function (textStr, x, y, opts) {
      // opts: x,y, color, font, align, baseline, width
    ...
    textWidth: function (textStr, style) {
      // style: x,y, color, font, align, baseline, width
