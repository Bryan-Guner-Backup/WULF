ninja.wallets.brainwallet = {
  isOpen: function () {
    return (
      document.getElementById("brainwallet").className.indexOf("selected") != -1
    );
  },
  ...
  open: function () {
    ...
    document.getElementById("brainwarning").innerHTML = ninja.translator.get(
  ...
  view: function () {
    ...
    if (
      ...
      if (key.length >= ninja.wallets.brainwallet.minPassphraseLength) {
        ...
        alert(
          ninja.translator.get("brainalertpassphrasetooshort") +
            ninja.translator.get("brainalertpassphrasewarning")
        );
