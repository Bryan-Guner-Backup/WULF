ninja.wallets.bulkwallet = {
  isOpen: function () {
    return (
      document.getElementById("bulkwallet").className.indexOf("selected") != -1
    );
  },
  ...
  open: function () {
    ...
    if (document.getElementById("bulktextarea").value == "") {
      ...
      setTimeout(function () {
        ninja.wallets.bulkwallet.buildCSV(
          3,
          1,
  ...
  buildCSV: function (rowLimit, startIndex, compressedAddrs) {
    ...
    document.getElementById("bulktextarea").value =
      ninja.translator.get("bulkgeneratingaddresses") + rowLimit;
    bulkWallet.csv = [];
  ...
  batchCSV: function () {
    ...
    if (bulkWallet.csvRowsRemaining > 0) {
      ...
      document.getElementById("bulktextarea").value =
        ninja.translator.get("bulkgeneratingaddresses") +
        bulkWallet.csvRowsRemaining;
