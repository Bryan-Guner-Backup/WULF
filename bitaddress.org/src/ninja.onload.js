// run unit tests
if (
  ninja.getQueryString()["unittests"] == "true" ||
...
if (
  ninja.getQueryString()["asyncunittests"] == "true" ||
...
if (
  ninja.getQueryString()["testnet"] == "true" ||
  ninja.getQueryString()["testnet"] == "1"
) {
  document.getElementById("testnet").innerHTML = ninja.translator.get(
    "testneteditionactivated"
  );
...
if (
  ninja.getQueryString()["showseedpool"] == "true" ||
