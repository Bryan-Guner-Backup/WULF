ninja.translator = {
  ...
  get: function (id) {
    var translation =
      ninja.translator.translations[ninja.translator.currentCulture][id];
    return translation;
  },
  ...
  translations: {
    en: {
      ...
      vanityinvalidinputcouldnotcombinekeys:
        "Invalid input. Could not combine keys.",
      vanityalertinvalidinputpublickeysmatch:
        "Invalid input. The Public Key of both entries match. You must input two different keys.",
      vanityalertinvalidinputcannotmultiple:
        "Invalid input. Cannot multiply two public keys. Select 'Add' to add two public keys to get a bitcoin address.",
      vanityprivatekeyonlyavailable:
        "Only available when combining two private keys",
      vanityalertinvalidinputprivatekeysmatch:
        "Invalid input. The Private Key of both entries match. You must input two different keys.",
    ...
    es: {
      ...
      detailalertnotvalidprivatekey:
        "El texto que has introducido no es una clave privada válida",
      detailconfirmsha256:
        "El texto que has introducido no es una clave privada válida\n\n¿Quieres usar ese texto como si fuera una contraseña y generar una clave privada usando un hash SHA256 de tal contraseña?\n\nAviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus bitcoins.",
      bip38alertincorrectpassphrase:
        "Incorrect passphrase for this encrypted private key.", //TODO: please translate
      bip38alertpassphraserequired: "Passphrase required for BIP38 key", //TODO: please translate
      vanityinvalidinputcouldnotcombinekeys:
        "Entrada no válida. No se puede combinar llaves.",
      vanityalertinvalidinputpublickeysmatch:
        "Entrada no válida. La clave pública de ambos coincidan entradas. Debe introducir dos claves diferentes.",
      vanityalertinvalidinputcannotmultiple:
        "Entrada no válida. No se puede multiplicar dos claves públicas. Seleccione 'Añadir' para agregar dos claves públicas para obtener una dirección bitcoin.",
      vanityprivatekeyonlyavailable:
        "Sólo está disponible cuando se combinan dos claves privadas",
      vanityalertinvalidinputprivatekeysmatch:
        "Entrada no válida. La clave privada de ambos coincidan entradas. Debe introducir dos claves diferentes.",
      ...
      footerlabeltranslatedby:
        "Traducción: <b>12345</b>Vypv2QSmuRXcciT5oEB27mPbWGeva",
      footerlabelpgp: "PGP",
      ...
      statuslabelcryptogood1:
        "Your browser can generate cryptographically random keys using window.crypto.getRandomValues", //TODO: please translate
      statusokcryptogood: "OK", //TODO: please translate
      statuslabelcryptobad: "&times; Oh no!", //TODO: please translate
      statuslabelcryptobad1:
        "Your browser does NOT support window.crypto.getRandomValues. You should use a more modern browser with this generator to increase the security of the keys generated.",
      ...
      statuslabelunittestsbad1:
        "Some synchronous unit tests DID NOT pass. You should find another browser to use with this generator.", //TODO: please translate
      statusokunittestsbad: "OK", //TODO: please translate
      statuslabelprotocolgood: "&#10004; Good!", //TODO: please translate
      statuslabelprotocolgood1:
        "You are running this generator from your local computer. <br />Tip: Double check you are offline by trying ", //TODO: please translate
      ...
      statuslabelprotocolbad1:
        "You appear to be running this generator online from a live website. For valuable wallets it is recommended to", //TODO: please translate
      statuslabelprotocolbad2: "download", //TODO: please translate
      statuslabelprotocolbad3:
        "the zip file from GitHub and run this generator offline as a local html file.", //TODO: please translate
      ...
      singletip1:
        "<b>A Bitcoin wallet</b> is as simple as a single pairing of a Bitcoin address with it's corresponding Bitcoin private key. Such a wallet has been generated for you in your web browser and is displayed above.", //TODO: please translate
      singletip2:
        "<b>To safeguard this wallet</b> you must print or otherwise record the Bitcoin address and private key. It is important to make a backup copy of the private key and store it in a safe location. This site does not have knowledge of your private key. If you are familiar with PGP you can download this all-in-one HTML page and check that you have an authentic version from the author of this site by matching the SHA256 hash of this HTML with the SHA256 hash available in the signed version history document linked on the footer of this site. If you leave/refresh the site or press the Generate New Address button then a new private key will be generated and the previously displayed private key will not be retrievable.	Your Bitcoin private key should be kept a secret. Whomever you share the private key with has access to spend all the bitcoins associated with that address. If you print your wallet then store it in a zip lock bag to keep it safe from water. Treat a paper wallet like cash.", //TODO: please translate
      singletip3:
        "<b>Add funds</b> to this wallet by instructing others to send bitcoins to your Bitcoin address.", //TODO: please translate
      singletip4:
        "<b>Check your balance</b> by going to blockchain.info or blockexplorer.com and entering your Bitcoin address.", //TODO: please translate
      singletip5:
      ...
      vanitylabelstep1privnotes:
        "Copia y pega la clave privada de arriba en un archivo de texto. Es mejor que lo almacenes en un volumen cifrado. Lo necesitarás para recuperar la clave privada una vez Vanity Pool haya encontrado tu prefijo.",
      vanitylabelstep2calculateyourvanitywallet:
        "Paso 2 - Calcula tu cartera personalizada",
      vanitylabelenteryourpart:
        "Introduce la clave privada generada en el paso 1, y que has guardado:",
      vanitylabelenteryourpoolpart:
        "Introduce la clave privada obtenida de la Vanity Pool:",
      vanitylabelnote1:
      ...
      vanitylabelnotespublickeyhex:
        "Lo anterior es la clave pública en formato hexadecimal.",
      vanitylabelprivatekey:
      ...
      detaillabelprivwif:
        "Clave privada para importar (51 caracteres en base58, empieza con un",
      detaillabelprivwifcomp:
        "Clave privada para importar (comprimida, 52 caracteres en base58, empieza con",
      ...
      detaillabelprivmini:
        "Clave privada en formato mini (22, 26 o 30 caracteres, empieza por 'S'):",
    ...
    fr: {
      ...
      brainalertpassphrasetooshort:
        "Le mot de passe que vous avez entré est trop court.\n\n",
      brainalertpassphrasewarning:
      ...
      brainalertpassphrasedoesnotmatch:
        "Le mot de passe ne correspond pas au mot de passe de vérification.",
      detailalertnotvalidprivatekey:
      ...
      bip38alertpassphraserequired:
        "Mot de passe a inventé pour crypter en BIP38",
      vanityinvalidinputcouldnotcombinekeys:
        "Entrée non valide. Impossible de combiner les clés.",
      vanityalertinvalidinputpublickeysmatch:
        "Entrée non valide. La clé publique des deux entrées est identique. Vous devez entrer deux clés différentes.",
      vanityalertinvalidinputcannotmultiple:
        "Entrée non valide. Il n'est pas possible de multiplier deux clés publiques. Sélectionner 'Ajouter' pour ajouter deux clés publiques pour obtenir une adresse Bitcoin.",
      vanityprivatekeyonlyavailable:
        "Seulement disponible si vos combinez deux clés privées",
      vanityalertinvalidinputprivatekeysmatch:
        "Entrée non valide. La clé Privée des deux entrées est identique. Vous devez entrer deux clés différentes.",
      ...
      generatelabelkeypress:
        "OU veuillez taper des caractères aléatoires dans le rectangle blanc suivant",
      ...
      bulklabelq1:
        "Pourquoi utiliserais-je un Porte-monnaie en vrac pour accepter les Bitcoins sur mon site web?",
      bulka1:
        "L'approche traditionnelle pour accepter des Bitcoins sur votre site web requière l'installation du logiciel Bitcoin officiel (\"bitcoind\"). Plusieurs hébergeurs ne supportent pas l'installation du logiciel Bitcoin. De plus, faire fonctionner le logiciel Bitcoin sur votre serveur web signifie que vos clés privées sont hébergées sur le serveur et pourraient donc être volées si votre serveur web était compromis. En utilisant un Porte-monnaie en vrac, vous pouvez publiquer seulement les adresses Bitcoin sur votre serveur et non les clés privées. Vous n'avez alors pas à vous inquiéter du risque de vous faire voler votre porte-monnaie si votre serveur était compromis.",
      bulklabelq2:
        "Comment utiliser le Porte-monnaie en vrac pour utiliser le Bitcoin sur mon site web?",
      bulklabela2li1:
        "Utilisez le Porte-monnaie en vrac pour pré-générer une large quantité d'adresses Bitcoin (10,000+). Copiez collez les données séparées par des virgules (CSV) dans un fichier texte sécurisé dans votre ordinateur. Sauvegardez ce fichier dans un endroit sécurisé.",
      bulklabela2li2:
        "Importez les adresses Bitcoin dans une base de donnée sur votre serveur web. (N'ajoutez pas le porte-monnaie ou les clés privées sur votre serveur web, sinon vous courrez le risque de vous faire voler si votre serveur est compromis. Ajoutez seulement les adresses Bitcoin qui seront visibles à vos visiteurs.)",
      bulklabela2li3:
        'Ajoutez une option dans votre panier en ligne pour que vos clients puissent vous payer en Bitcoin. Quand un client choisi de vous payer en Bitcoin, vous pouvez afficher une des adresses de votre base de donnée comme "adresse de paiment" pour votre client et sauvegarder cette adresse avec sa commande.',
      bulklabela2li4:
      ...
      bulklabela2li5:
        "Les Bitcoins vos s'accumuler de façon sécuritaire dans la chaîne de blocs. Utilisez le porte-monnaie original que vous avez généré à l'étape 1 pour les dépenser.",
      ...
      vanitylabelstep1pubnotes:
        "Copiez celle-ci dans la case Votre-Clé-Publique du site de Vanity Pool.",
      vanitylabelstep1privatekey: "Step 1 Clé Privée:",
      vanitylabelstep1privnotes:
        "Copiez la cette Clé Privée dans un fichier texte. Idéalement, sauvegardez la dans un fichier encrypté. Vous en aurez besoin pour récupérer la Clé Privée lors que Vanity Pool aura trouvé votre préfixe.",
      vanitylabelstep2calculateyourvanitywallet:
        "Étape 2 - Calculer votre Porte-monnaie Vanité",
      vanitylabelenteryourpart:
        "Entrez votre Clé Privée (générée à l'étape 1 plus haut et précédemment sauvegardée):",
      vanitylabelenteryourpoolpart:
        "Entrez la Clé Privée (provenant de Vanity Pool):",
      vanitylabelnote1:
        "[NOTE: cette case peut accepter une clé publique ou un clé privée]",
      vanitylabelnote2:
        "[NOTE: cette case peut accepter une clé publique ou un clé privée]",
      ...
      vanitylabelnotesbitcoinaddress:
        "Ci-haut est votre nouvelle adresse qui devrait inclure le préfix requis.",
      vanitylabelpublickeyhex: "Clé Public Vanité (HEX):",
      vanitylabelnotespublickeyhex:
        "Celle-ci est la Clé Publique dans le format hexadécimal. ",
      vanitylabelprivatekey: "Clé Privée Vanité (WIF):",
      vanitylabelnotesprivatekey:
        "Celle-ci est la Clé Privée pour accéder à votre porte-monnaie. ",
      ...
      detaillabelnote2:
        "Bitcoin v0.6+ conserve les clés publiques dans un format compressé. Le logiciel supporte maintenant aussi l'importation et l'exportation de clés privées avec importprivkey/dumpprivkey. Le format de la clé privée exportée est déterminé selon la version du porte-monnaie Bitcoin.",
      ...
      detaillabelprivwif:
        "Clé Privée WIF (51 caractères base58, débute avec un a",
      detaillabelprivwifcomp:
        "Clé Privée WIF (compressée, 52 caractères base58, débute avec un a",
      detailcompwifprefix: "'K' ou 'L'",
      detaillabelprivhex:
        "Clé Privée Format Hexadecimal (64 caractères [0-9A-F]):",
      detaillabelprivb64: "Clé Privée Base64 (44 caractères):",
      detaillabelprivmini:
        "Clé Privée Format Mini (22, 26 ou 30 caractères, débute avec un 'S'):",
      detaillabelpassphrase: "BIP38 Passphrase", //TODO: please translate
      detaildecrypt: "Decrypt BIP38", //TODO: please translate
      detaillabelq1: "How do I make a wallet using dice? What is B6?", //TODO: please translate
      detaila1:
    ...
    el: {
      ...
      brainalertpassphrasedoesnotmatch:
        "Η φράση κωδικός και η επιβεβαίωση της δε συμφωνούν.",
      detailalertnotvalidprivatekey:
      ...
      bip38alertincorrectpassphrase:
        "Λάθος φράση κωδικός αποκρυπτογράφησης Προσωπικού Κλειδιού.",
      bip38alertpassphraserequired:
        "Απαιτείται η φράση κωδικός για το Κλειδί BIP38",
      vanityinvalidinputcouldnotcombinekeys:
        "Μη έγκυρη εισαγωγή. Ο συνδυασμός των κλειδιών είναι αδύνατος.",
      vanityalertinvalidinputpublickeysmatch:
        "Μη έγκυρη εισαγωγή. Τα Δημόσια Κλειδιά των δύο εγγραφών είναι όμοια. Πρέπει να εισάγετε δύο διαφορετικά Κλειδιά.",
      vanityalertinvalidinputcannotmultiple:
      ...
      vanityprivatekeyonlyavailable:
        "Διαθέσιμο μόνο κατά το συνδυασμό δύο Προσωπικών Κλειδιών",
      vanityalertinvalidinputprivatekeysmatch:
        "Μη έγκυρη εισαγωγή. Τα Προσωπικά Κλειδιά των δύο εγγραφών είναι όμοια. Πρέπει να εισάγετε δύο διαφορετικά Κλειδιά.",
      ...
      generatelabelmovemouse:
        "ΚΟΥΝΗΣΤΕ το ποντίκι τριγύρω για να προσθέσετε επιπλέον τυχαιότητα...",
      generatelabelkeypress: "OR type some random characters into this textbox", //TODO: please translate
      ...
      footerlabeltranslatedby:
        "Μετάφραση: <a href='http://BitcoinX.gr/'><b>BitcoinX.gr</b></a> 1BitcoiNxkUPcTFxwMqxhRiPEiQRzYskf6",
      footerlabelpgp: "PGP",
      ...
      footerlabelcopyright1: "Copyright bitaddress.org.",
      footerlabelcopyright2:
        "Τα πνευματικά δικαιώματα της JavaScript περιλαμβάνονται στον κώδικα.",
      ...
      bulklabelq1:
        "Γιατί να χρησιμοποιήσω Πολλαπλά Πορτοφόλια στην ιστοσελίδα μου;",
      bulka1:
      ...
      bulklabelq2:
        "Πως χρησιμοποιώ τα Πολλαπλά Πορτοφόλια για να δέχομαι bitcoins στην ιστοσελίδα μου;",
      bulklabela2li1:
      ...
      bulklabela2li5:
        "Τα Bitcoins θα συσσωρεύονται με ασφάλεια στην αλυσίδα των μπλοκ. Χρησιμοποιήστε το αρχικό πορτοφόλι που δημιουργήσατε στο βήμα 1 για να τα ξοδέψετε.",
      ...
      // vanity wallet html
      vanitylabelstep1:
        "Βήμα 1 - Δημιουργήστε το «Ζεύγος κλειδιών του Βήματος 1»",
      vanitynewkeypair: "Δημιουργία",
      vanitylabelstep1publickey: "Βήμα 1 Δημόσιο Κλειδί:",
      vanitylabelstep1pubnotes:
        "Αντιγράψτε κι επικολλήστε το παραπάνω στο πεδίο Your-Part-Public-Key στην ιστοσελίδα του Vanity Pool.",
      ...
      vanitylabelstep2calculateyourvanitywallet:
        "Βήμα 2 - Υπολογίστε το Vanity Πορτοφόλι σας.",
      vanitylabelenteryourpart:
      ...
      vanitylabelnotesbitcoinaddress:
        "Παραπάνω είναι η διεύθυνσή σας που θα πρέπει να περιλαμβάνει το επιθυμητό πρόθεμα.",
      vanitylabelpublickeyhex: "Vanity Δημόσιο Κλειδί (HEX):",
      vanitylabelnotespublickeyhex:
        "Παραπάνω είναι το Δημόσιο Κλειδί σε δεκαεξαδική μορφή. ",
      vanitylabelprivatekey: "Vanity Προσωπικό Κλειδί (WIF):",
      vanitylabelnotesprivatekey:
        "Παραπάνω είναι το Προσωπικό Κλειδί που θα φορτώσετε στο Πορτοφόλι σας. ",
      ...
      detaillabelpublickeycomp:
        "Δημόσιο Κλειδί (Συμπιεσμένο, 66 χαρακτήρες [0-9A-F]):",
      detaillabelprivwif:
        "Προσωπικό Κλειδί WIF (51 χαρακτήρες base58, ξεκινάει με",
      detaillabelprivwifcomp:
        "Προσωπικό Κλειδί WIF (Συμπιεσμένο, 52 χαρακτήρες base58, ξεκινάει με",
      detailcompwifprefix: "'K' ή 'L'",
      detaillabelprivhex:
        "Προσωπικό Κλειδί Δεκαεξαδική Μορφή (64 χαρακτήρες [0-9A-F]):",
      detaillabelprivb64: "Προσωπικό Κλειδί Base64 (44 χαρακτήρες):",
      detaillabelprivmini:
        "Προσωπικό Κλειδί Μορφή Mini (22, 26 ή 30 χαρακτήρες, ξεκινάει με 'S'):",
    ...
    it: {
      ...
      brainalertpassphrasewarning:
        "Attenzione: La scelta di una passphrase robusta è importante per evitare attacchi brute force in grado di indovinare la tua passphrase e rubare i tuoi Bitcoin",
      brainalertpassphrasedoesnotmatch:
      ...
      bulklabelq1:
        "Perché dovrei usare tanti portafogli per accettare Bitcoin sul mio sito web?",
      bulka1:
        "Il tradizionale approcio per accettare i Bitcoin è quello di installare il demone ufficiale Bitcoin (\"bitcoind\"). Molti pacchetti di hosting web non supportano l'installazione di tale demone. Inoltre tenere in esecuzione il demone richiede che la chiave privata del portafogli sia custodita sul server, se questo viene violato tramite hacking puoi perdere tutti i Bitcoin. Usando portafogli multipli puoi caricare sul server solo l'indirizzo per il versamento e non la chiave privata. Quindi non devi preoccuparti del tuo portafogli nel caso in cui il server venga violato con un attacco di hacking.",
      bulklabelq2:
        "Come utilizzo tutti questi portafogli per accettare Bitcoin sul mio sito web?",
      bulklabela2li1:
        'Usa la funzione "Portafogli multipli" per generare una grande quantità di indirizzi Bitcoin (10,000+). Copia e incolla la lista generata in formato CSV (campi separati da virgola) su un file, al sicuro nel tuo computer. Fai una copia di backup di questo file e mettilo un posto sicuro.',
      bulklabela2li2:
        "Importa gli indirizzi Bitcoin in una tabella del database sul tuo web server. (Non importare i portafogli/chiavi private sul web server, altrimenti corri il rischio che rubino i tuoi Bitcoin con l'hacking. Usa gli indirizzi Bitcoin così come verranno mostrati ai tuoi clienti.)",
      bulklabela2li3:
        'Fornisci una opzione nel carrello del tuo sito web per pagare in Bitcoin. Quando il cliente sceglie di pagare in Bitcoin, gli mostrerai un indirizzo dal tuo database come "indirizzo di pagamento" e conserverai questo stesso indirizzo insieme ai dati dell\'ordine.',
      bulklabela2li4:
      ...
      bulklabela2li5:
        "In questo modo i Bitcoin transiteranno nella blockchain in tutta sicurezza. Usa il portafogli creato nel Passo 1 per spendere i Bitcoin.",
      ...
      vanitylabelstep1pubnotes:
        'Copia e incolla il testo soprastante nel campo "chiave-pubblica-parziale" sul sito web del pool.',
      vanitylabelstep1privatekey: "Passo 1 Chiave pubblica:",
      vanitylabelstep1privnotes:
        "Copia & incolla la Chiave privata soprastante su un file di testo. Idealmente conservalo su un disco criptato. Ti servirà per recuperare la Chiave privata una volta che il Pool avrà trovato quella col prefisso scelto.",
      vanitylabelstep2calculateyourvanitywallet:
        "Passo 2 - Calcolo del Vanity Wallet",
      vanitylabelenteryourpart:
      ...
      vanitylabelnote1:
        "[NOTA: questo campo può accettare sia chiavi pubbliche che private]",
      vanitylabelnote2:
        "[NOTA: questo campo può accettare sia chiavi pubbliche che private]",
      ...
      vanitylabelnotesbitcoinaddress:
        "Sopra trovi il tuo nuovo indirizzo che dovrebbe includere il prefisso che hai scelto.",
      vanitylabelpublickeyhex: "Chiave pubblica del Vanity Wallet (HEX):",
      vanitylabelnotespublickeyhex:
        "Quella sopra è la Chiave Pubblica nel formato esadecimale. ",
      vanitylabelprivatekey: "Chiave privata del Vanity Wallet (WIF):",
      vanitylabelnotesprivatekey:
        "Quella sopra è la Chiave Privata nel formato esadecimale.  ",
    ...
    de: {
      ...
      paperlabelencryptedkey:
        "Verschl&uuml;sselter privater Schl&uuml;ssel (Passwort ben&ouml;tigt)",
      ...
      detailalertnotvalidprivatekey:
        "Der eingegebene Text ist kein gültiger privater Schlüssel.",
      detailconfirmsha256:
      ...
      vanityinvalidinputcouldnotcombinekeys:
        "Unzulässige Eingaben. Die Schlüssel konnten nicht kombiniert werden.",
      vanityalertinvalidinputpublickeysmatch:
        "Unzulässige Eingaben. Die eingegebenen öffentlichen Schlüssel stimmen überein. Bitte gib zwei unterschiedliche Schlüssel ein.",
      vanityalertinvalidinputcannotmultiple:
        'Unzulässige Eingaben. Zwei öffentliche Schlüssel können nicht miteinander multipliziert werden. Wähle "Addieren" aus, um aus zwei öffentlichen Schlüsseln eine Bitcoin-Adresse zu erstellen.',
      vanityprivatekeyonlyavailable:
        "Nur verfügbar, wenn zwei private Schlüssel kombiniert werden.",
      vanityalertinvalidinputprivatekeysmatch:
        "Unzulässige Eingaben. Die eingegebenen privaten Schlüssel stimmen überein. Bitte gib zwei unterschiedliche Schlüssel ein.",
      ...
      generatelabelmovemouse:
        "Bewege deine Maus umher, um die Zuf&auml;lligkeit zu erh&ouml;hen...",
      generatelabelkeypress: "OR type some random characters into this textbox", //TODO: please translate
      ...
      footerlabeltranslatedby:
        "&Uuml;bersetzung: 1EWPcmYmU8MamRUYMFWQa1r7A2Tskz78t5",
      footerlabelpgp: "PGP",
      ...
      footerlabelcopyright1: "Copyright bitaddress.org.",
      footerlabelcopyright2:
        "JavaScript-Copyrights sind im Quelltext enthalten.",
      ...
      singlelabelprivatekey:
        "Privater Schl&uuml;ssel (WIF &ndash; zum Importieren geeignet):",
      singletip1:
      ...
      vanitylabelnotesbitcoinaddress:
        "Die obige Bitcoin-Adresse sollte den gew&uuml;nschten Pr&auml;fix enthalten.",
      vanitylabelpublickeyhex:
        "Personalisierter &ouml;ffentlicher Schl&uuml;ssel (HEX):",
      vanitylabelnotespublickeyhex:
        "Die obige Zeichenfolge ist der &ouml;ffentliche Schl&uuml;ssel (Bitcoin-Adresse) im Hexadezimalformat.",
      vanitylabelprivatekey: "Personalisierter privater Schl&uuml;ssel (WIF):",
      vanitylabelnotesprivatekey:
        "Der obige private Schl&uuml;ssel erm&ouml;glicht das Importieren in andere Wallets.",

      // detail wallet html
      detaillabelenterprivatekey: "Privaten Schl&uuml;ssel eingeben:",
      detailkeyformats:
        "Unterstützte Formate: WIF, WIFC, HEX, B64, B6, MINI, BIP38",
      detailview: "Details anzeigen",
      detailprint: "Drucken",
      detaillabelnote1:
        "Der private Schl&uuml;ssel deines Wallets ist eine geheime, einzigartige Zeichenfolge, die nur du kennst. Er kann auf mehrer Arten dargestellt werden. Unten findest du die zugeh&ouml;rige Bitcoin-Adresse bzw. &ouml;ffentlichen Schl&uuml;ssel sowie den privaten Schl&uuml;ssel in den verbreitetsten Formaten.",
      detaillabelnote2:
      ...
      detaillabelpublickey:
        "&Ouml;ffentlicher Schl&uuml;ssel (130 Zeichen [0-9A-F]):",
      detaillabelpublickeycomp:
        "Komprimierter &ouml;ffentlicher Schl&uuml;ssel (66 Zeichen [0-9A-F]):",
      detaillabelprivwif:
        "Privater Schl&uuml;ssel WIF  <br /> 51 Zeichen in base58, beginnt mit",
      detaillabelprivwifcomp:
        "Komprimierter privater Schl&uuml;ssel WIF <br /> 52 Zeichen in base58, beginnt mit",
      detailcompwifprefix: "'K' oder 'L'",
      detaillabelprivhex:
        "Privater Schl&uuml;ssel in Hexadezimal (64 Zeichen [0-9A-F]):",
      detaillabelprivb64: "Privater Schl&uuml;ssel in base64 (44 Zeichen):",
      detaillabelprivmini:
        "Privater Schl&uuml;ssel in mini (22, 26 oder 30 Zeichen, beginnt mit 'S'):",
      detaillabelpassphrase: "Passwort f&uuml;r BIP38 eingeben",
      detaildecrypt: "Entschl&uuml;sseln",
      detaillabelq1:
        "Wie erstelle ich ein Wallet mithilfe eines Würfels? Was versteht man unter B6?",
      detaila1:
    ...
    cs: {
      ...
      paperlabelprivatekey:
        "Soukromý klíč (WIF &ndash; Formát pro import do peněženky):",
      ...
      detailconfirmsha256:
        "Zadaný text není platným soukromým klíčem!\n\nChcete použít zadaný text jako heslo a vytvořit soukromý klíč pomocí SHA256?\n\nVarování: Je důležité zvolit silné heslo, které je odolné proti útoku hrubou silou a krádeži vašich Bitcoinů.",
      bip38alertincorrectpassphrase: "Špatné heslo pro BIP38",
      bip38alertpassphraserequired: "Vyžadováno heslo pro BIP38 klíč",
      vanityinvalidinputcouldnotcombinekeys:
        "Špatný vstup. Kombinovat klíče není možné.",
      vanityalertinvalidinputpublickeysmatch:
        "Špatný vstup. Veřejný klíč obou položek je shodný. Musíte zadat dva různé klíče.",
      vanityalertinvalidinputcannotmultiple:
        "Špatný vstup. Dva veřejné klíče není možné násobit. Zvolte 'Přidat' pro přidání dvou veřejných klíčů a získání Bitcoin adresy.",
      vanityprivatekeyonlyavailable:
        "Dostupné pouze při kombinaci dvou soukromých klíčů",
      vanityalertinvalidinputprivatekeysmatch:
        "Špatný vstup. Soukromý klíč obou položek je shodný. Musíte zadat dva různé klíče.",
      ...
      generatelabelkeypress:
        "NEBO napište několik náhodných znaků do tohoto pole",
      ...
      footerlabelcopyright1: "Copyright bitaddress.org.",
      footerlabelcopyright2:
        "Copyright JavaScriptu je uveden ve zdrojovém kódu.",
      ...
      bulklabelformat:
        "Index, Adresa, Soukromý klíč (WIF &ndash; Formát pro import do peněženky)",
      bulklabelq1:
        "Proč bych měl používat Hromadnou peněženku pro příjem Bitcoinů na mé stránce?",
      bulka1:
        'Tradiční způsob jak přijímat Bitcoiny na vaší webové stránce vyžaduje instalaci oficiálního bitcoin klienta ("bitcoind"). Mnoho webhostingových společností neumožňuje tuto instalaci provést. Také běh bitcoin démona na webovém serveru znamená, že soukromé klíče jsou uloženy na serveru a mohou být ukradeny. Pokud použijete Hromadnou peněženku, tak stačí na server nahrát pouze veřejnou bitcoin adresu a ne soukromé klíče. Poté se nemusíte bát, že vaše Bitcoiny budou ukradeny v případě napadení serveru.',
      bulklabelq2:
        "Jakým způsobem mohou přijímat Bitcoiny na mé stránce pomocí Hromadné peněženky?",
      bulklabela2li1:
        "Předgenerujte si velké množství Bitcoin adres (10 000+). Okopírujte si CSV seznam do souboru na bezpečné místo ve vašem počítači. Poté jej vyzálohujte na bezpečné místo.",
      bulklabela2li2:
        "Naimportujte Bitcoin adresy do databáze na vašem webovém serveru. Neimportujte soukromé klíče, abyste zabránili krádeži vašich peněz.",
      bulklabela2li3:
        "Umožněte na vaší stránce platbu pomocí Bitcoinu. Stačí vždy zobrazit jednu z vygenerovaných adres a uložit si ji u objednávky.",
      bulklabela2li4:
        'Nyní je již pouze potřeba zařídit notifikace o příchozí transakci. Zadejte do Google "bitcoin payment notification" a využijte jednu z existujících služeb. Existuje jich několik a podporují např. Web Services, API, SMS, Email, apod. Notifikaci můžete zpracovat automaticky. Pro ruční kontrolu, zda peníze přišly, stačí použít Block Explorer. Nahraďte SEMPATŘÍADRESA Bitcoin adresou, kterou chcete zkontrolovat. Potvrzení transkace může trvat od 10 minut do jedné hodiny.<br />http://www.blockexplorer.com/address/SEMPATŘÍADRESA<br /><br />Nepotvrzené tansakce je možné zkontrolovat na: http://blockchain.info/ <br />Většinou se zde zobrazí do 30 sekund.',
      bulklabela2li5:
        "Bitcoiny budou bezpečně převedeny v řetězci bloků. Pro spotřebování stačí kdykoliv naimportovat soubor vygenerovaný v prvním kroku.",
      ...
      vanitylabelstep1pubnotes:
        "Zkopírujte a vložte výše uvedený klíč do pole Your-Part-Public-Key na Vanity Pool stránce.",
      vanitylabelstep1privatekey: "Soukromý klíč 1. kroku",
      vanitylabelstep1privnotes:
        "Zkopírujte a uschovejte uvedený soukromý klíč. Ideálně na šifrovaný disk. Budete ho potřebovat pro získání vašeho Bitcoin soukromého klíče poté, co pool nalezne začátek.",
      vanitylabelstep2calculateyourvanitywallet:
        "Krok 2 &ndash; Výpočet peněženky Vanity",
      vanitylabelenteryourpart:
        "Zadejte vaši část soukromého klíče (vygenerovaný a uložený v prvním kroku výše):",
      vanitylabelenteryourpoolpart:
        "Zadejte pool část soukromého klíče (z Vanity Poolu):",
      vanitylabelnote1:
        "[POZNÁMKA: do tohoto pole můžete zadat veřejný nebo soukromý klíč]",
      vanitylabelnote2:
        "[POZNÁMKA: do tohoto pole můžete zadat veřejný nebo soukromý klíč]",
      ...
      vanitylabelnotesbitcoinaddress:
        "Výše je vaše nová adresa, která by měla obsahovat požadovaný začátek.",
      vanitylabelpublickeyhex: "Veřejný klíč Vanity (HEX):",
      vanitylabelnotespublickeyhex:
        "Výše je veřejný klíč v hexadecimálním formátu.",
      vanitylabelprivatekey: "Soukromý klíč Vanity (WIF):",
      vanitylabelnotesprivatekey:
        "Výše je soukromý klíč pro načtení do vaší peněženky.",

      // detail wallet html
      detaillabelenterprivatekey: "Zadejte soukromý klíč:",
      detailkeyformats:
        "Podporované formáty: WIF, WIFC, HEX, B64, B6, MINI, BIP38",
    ...
    hu: {
      ...
      brainalertpassphrasedoesnotmatch:
        "A jelmondat és az ellenőrző jelmondat nem azonos.",
      detailalertnotvalidprivatekey:
        "A beadott szöveg nem érvénytelen Privát Kulcs",
      detailconfirmsha256:
        "Az ön által beadott szöveg érvénytelen Privát Kulcs!\n\nSzeretné a beadott szöveget jelmondatként kezelni, és annak SHA256 zanzájából egy Privát Kulcsot előállítani?\n\nFigyelem: Fontos, hogy erős jelmondatot válasszon, mert különben a jelmondatot nyers erővel feltörhetik és a bitcoinjait ellophatják.",
      bip38alertincorrectpassphrase:
        "Érvénytelen jelmondat a titkosított privát kulcshoz.",
      bip38alertpassphraserequired: "A BIP38 kulcshoz jelmondat szükséges",
      vanityinvalidinputcouldnotcombinekeys:
        "Érvénytelen bemenet. A kulcsok nem tartoznak össsze.",
      vanityalertinvalidinputpublickeysmatch:
        "Érvénytelen bemenet. A két megadott nyilvános kulcs azonos. Két különböző kulcs bevitelére van szükség.",
      vanityalertinvalidinputcannotmultiple:
        "Érvénytelen bemenet. Két nyilvános kulcs összeszorzása nem lehetséges. Válassza az 'Összeadás'-t, ha két nyilvános kulcsból szeretne egy bitcoin címet kapni.",
      vanityprivatekeyonlyavailable:
        "Csak két privát kulcs kombinálásakor lehetséges",
      vanityalertinvalidinputprivatekeysmatch:
        "Érvénytelen bemenet. A két megadott privát kulcs azonos. Két különböző kulcs bevitelére van szükség.",

      // header and menu html
      tagline:
        "Nyílt forráskódú, kliens oldali JavaScript, Bitcoin pénztárca előállítására",
      generatelabelbitcoinaddress: "A bitcoin cím előállítása...",
      generatelabelmovemouse:
        "MOZGASSA az egeret, ha fokozni szeretné a véletlenszerűséget...",
      generatelabelkeypress:
        "VAGY gépeljen be néhány véletlenszerű karaktert ebbe a szövegdobozba",
      ...
      footerlabelcopyright1: "Copyright bitaddress.org.",
      footerlabelcopyright2:
        "Az egyes JavaScript kódok szerzőinek jogai a forráskódon belül találhatók meg.",
      ...
      bulklabelq1:
        "Miért jó a Tömeges pénztárca használata, ha Ön bitcoint szeretne elfogadni a web-en?",
      bulka1:
        'Ha Ön bitcoint szeretne elfogadni a web-en, akkor a szokásos megoldás az, hogy installálja a hivatalos bitcoin kliens démont ("bitcoind"). Sok web szolgáltató nem támogatja a bitcoin démon installálását. Ráadásul, ha a bitcoin démont a web szerveren futtatja, akkor a privát kulcsai is a web szerveren lesznek tárolva, és a web szerver meghekkelésekor ellophatják őket. A Tömeges pénztárca használatakor csak a bitcoin címeket kell feltölteni a web szerverre, a privát kulcsokat nem. Így nem kell aggódnia, hogy ellopják a bitcoin pénztárcáját, ha betörnek a web szerverre.',
      bulklabelq2:
        "Hogyan használható a Tömeges pénztárca az Ön web helyén bitcoin elfogadásra?",
      bulklabela2li1:
        "A Tömeges pénztárcával állítson elő nagy mennyiségű (10,000+) bitcoin címet. Másolja át a vesszővel elválasztott adatokat (CSV) egy biztonságos szöveges állományba a számítógépére. A szöveges állományról készítsen mentést, és azt őrizze biztonságos környezetben.",
      bulklabela2li2:
        "Importálja be a Bitcoin címeket a web szerverén futó adatbázisba. (A pénztárca privát kulcsait ne importája be, mert ezzel azt kockáztatja, hogy a hackerek ellopják a pénzét. Csak a bitcoin címeket importálja be, úgy, ahogy azt a ügyfelei látják majd.)",
      bulklabela2li3:
        'Web helyének vásárlókosarába vegye fel a bitcoinnal történő fizetés lehetőségét. Ha egy ügyfél bitcoinnal kíván fizetni, akkor "fizetési címként" az adatbázis egyik címét jelenítse meg, és a megrendelés mellett ezt a címet tárolja.',
      bulklabela2li4:
      ...
      bulklabela2li5:
        "Az Ön bitcoinjai biztonságos módon gyűlnek a blokkláncon. Használja az 1. lépés során előállított eredeti pénztárcát, ha szeretné őket elkölteni.",
      ...
      // vanity wallet html
      vanitylabelstep1:
        '1. lépés - az "1. lépéshez tartozó Kulcspár" előállítása',
      vanitynewkeypair: "Előállítás",
      vanitylabelstep1publickey: "1. lépés, Publikus Kulcs:",
      vanitylabelstep1pubnotes:
        "Másolja a fentiekeket a Vanity Pool webhely Your-Part-Public-Key ('az ön publikus kulcsa') mezőjébe.",
      ...
      vanitylabelstep2calculateyourvanitywallet:
        "2. lépés - A Kérkedő Pénztárca Privát Kulcsának kiszámítása",
      vanitylabelenteryourpart:
        "Adja meg az Önhöz tartozó Privát Kulcsot (amelyet az 1. lépésben állított elő és mentett el):",
      vanitylabelenteryourpoolpart:
        "Adja meg a Pool-hoz tartozó Privát Kulcsot (amely  a Vanity Pool-ból származik):",
      vanitylabelnote1:
        "[MEGJEGYZÉS: ebbe a szövegmezőbe publikus kulcs vagy privát kulcs egyaránt írható]",
      vanitylabelnote2:
        "[MEGJEGYZÉS: ebbe a szövegmezőbe publikus kulcs vagy privát kulcs egyaránt írható]",
      ...
      vanitylabelnotesbitcoinaddress:
        "Fönt látható az ön új címe, mely magában foglalja a kívánt előtagot.",
      ...
      vanitylabelnotesprivatekey:
        "Ez az Ön Privát Kulcsa, mellyel elérheti a pénzét. ",

      // split wallet html
      splitlabelthreshold:
        "A visszaállításhoz szükséges részek minimális száma",
      splitlabelshares: "Részek száma",
      splitview: "Előállítás",
      combinelabelentershares:
        "Adja be a meglévő részeket (Enter-rel, szóközzel vagy más whitespace karakterrel elválasztva)",
      ...
      detailkeyformats:
        "Kulcs formátumok: WIF, WIFC, HEX, B64, B6, MINI, BIP38",
      detailview: "Részletek megjelenítése",
      detailprint: "Nyomtatás",
      detaillabelnote1:
        "A Bitcoin Privát Kulcs egy titkos szám, melyet csak Ön ismer. Számos különböző formátumban kódolható. Az alábbiakban megjelenítettük a a Privát Kulcshoz tartozó Bitcoin Címet és Publikus kulcsot, valamint a Privát Kulcsot a legnépszerűbb kódolási formátumokban (WIF, WIFC, HEX, B64).",
      detaillabelnote2:
        "A Bitcoin v0.6+ a publikus kulcsokat tömörített formátumban tárolja. A kliens az importprivkey/dumpprivkey parancsokkal a privát kulcsok importálását és exportálását is támogatja. Az exportált privát kulcsok formátumát csupán a Bitcoin pénztárca verziószáma határozza meg.",
      ...
      detaillabelpublickeycomp:
        "Tömörített Publikus Kulcs (66 karakter [0-9A-F]):",
      detaillabelprivwif:
        "WIF Privát Kulcs <br />51 db base58 karakter, melynek kezdete",
      detaillabelprivwifcomp:
        "Tömörített WIF Privát Kulcs <br />52 db base58 karakter, melynek kezdete",
      detailcompwifprefix: "'K' vagy 'L'",
      detaillabelprivhex:
        "Hexadecimális formátumú Privát Kulcs (64 karakter [0-9A-F]):",
      detaillabelprivb64: "Base64 formátumú Privát Kulcs (44 karakter):",
      detaillabelprivmini:
        "Mini formátumú Privát Kulcs (22, 26 vagy 30 karakter, amely egy 'S'-sel kezdődik):",
      detaillabelpassphrase: "BIP38 jelmondat",
      detaildecrypt: "BIP38 dekódolás",
      detaillabelq1:
        "Hogyan lehet dobókockával pénztárcát készíteni? Mit jelent a B6 formátum?",
      detaila1:
    ...
    jp: {
      ...
      brainalertpassphrasewarning:
        "注意：強いパスワードを選ばないとプライベートキーを安易に当てられてビットコインを盗まれてしまいます。<br>なお、<b>UTF-8の文字も使えるため、キーボードが半角か全角か今一度ご確認下さい。</b>",
      brainalertpassphrasedoesnotmatch: "パスワードが一致しません",
      detailalertnotvalidprivatekey:
        "入力された文字列は有効なプライベートキーではありません。",
      detailconfirmsha256:
        "入力された文字列は有効なプライベートキーではありません。\n\n代わりにこの文字列をパスワードとして、SHA256ハッシュを用いプライベートキーを生成しますか？\n\n注意: 強いパスワードを選ばないとプライベートキーを安易に当てられてビットコインを盗まれてしまいます。",
      bip38alertincorrectpassphrase:
        "暗号化されたプライベートキーに一致しないパスワードです。",
      bip38alertpassphraserequired:
        "BIP38キーを生成するにはパスワードをかける必要があります。",
      vanityinvalidinputcouldnotcombinekeys:
        "不正入力です。キーを結合できませんでした。",
      vanityalertinvalidinputpublickeysmatch:
        "不正入力です。両方のパブリックキーが同じです。2つの異なるキーをお使い下さい。",
      vanityalertinvalidinputcannotmultiple:
        "不正入力です。2つのパブリックキーを掛け合わせることはできません。「足し算」を選択し、2つのパブリックキーを足し合わせてアドレスを生成して下さい。",
      vanityprivatekeyonlyavailable:
        "2つのプライベートキーを掛け合わせた時だけ有効です。",
      vanityalertinvalidinputprivatekeysmatch:
        "不正入力両方のプライベートキーがチケットに一致します。2つの異なるキーをお使い下さい。",
      ...
      footerlabeltranslatedby:
        "日本語訳寄付先 1o3EBhxPhGn8cGCL6Wzi5F5kTPuBofdMf",
      footerlabelpgp: "PGP",
      ...
      footerlabelcopyright1: "Copyright bitaddress.org.",
      footerlabelcopyright2:
        "JavaScriptのコピーライト情報はソースに含まれています。",
      ...
      bulklabelq1:
        "ウェブサイトでビットコインを受け付ける時、何故大量のアドレスを生成しておいた方がいいのか？",
      bulka1:
        "以前はビットコインをサイトで受け付けたかったら、「bitcoind」というビットコインのシステムサービスをサーバーにアップロードし、サーバー上で実行しなければいけませんでした。しかし、このやり方だとサーバーがハッキングされてしまった場合、プライベートキーも全て持って行かれてしまいます。大量に生成しておいて、ビットコインアドレスだけをサーバーにアップしておけば、プライベートキーを安全な場所に保管できます。",
      bulklabelq2:
        "どうやって大量生成を使ってサイトでビットコインを受け付けられるようにできるのか？",
      bulklabela2li1:
        "大量生成タブで大量のビットコインを生成(10,000+でも可)。出てくるCSVテキストをコピーして、安全なテキストエディターで貼り付けて、安全な場所に保存しておいて下さい。一つバックアップを取り、別の場所で保管しておく(強いパスワードのかかったzipなどで)",
      bulklabela2li2:
        "ビットコインアドレスをウェブサーバーにアップロード。プライベートキーはアップロードしないで下さい。ユーザーに見せたい宛先用のアドレスのみをアップロードして下さい。",
      bulklabela2li3:
        "サイトのショッピングカート機能にビットコインのリンクを追加して下さい。クリックされた時、お値段と先ほどアップしたビットコインアドレスが順番に出てくるようにしておいて下さい(1取引1アドレス)。注文の情報と一緒に、このアドレスも一緒に保存して、後で紐付けられるようにしておいて下さい。",
      bulklabela2li4:
        "後は支払いの通知を受けないと注文を通すか否か分かりません。グーグルで「bitcoin payment notification」と検索したら、SMS、メール、APIなどでビットコインの支払いがあった際教えてくれます。これをコードの中に組み込んで、支払いがあったら注文を通すようにもできます。手動で送金があったかを見る場合、blockchain.infoに行き、宛先のアドレスを入力すれば、取引履歴から送金の事実を確認できます。大体送金の30秒後に表示され、10分～1時間の間に「確認」されます。",
      bulklabela2li5:
        "送られたビットコインはブロックチェーンにて安全に保管されます。送金するには1番で作成したウォレットを何らかのビットコインソフトに取り込んでご利用下さい。",
      ...
      vanitylabelnotesprivatekey:
        "上記のアドレスに送られたビットコインを使うためのプライベートキーです。",
      ...
      detailkeyformats:
        "受け付けるキーの形式 WIF, WIFC, HEX, B64, B6, MINI, BIP38",
      detailview: "詳細を表示",
      detailprint: "印刷",
      detaillabelnote1:
        "ビットコインプライベートキーはあなたにしか分からない秘密の鍵。色々な形式で表示することができ、下記で表示しているのはビットコインアドレス、パブリックキー、プライベートキー、そして複数の形式でプライベートキーを表示します。(WIF, WIFC, HEX, B64)",
      detaillabelnote2:
        "ビットコイン v0.6より圧縮したパブリックキーを保存している。なお、importprivkey / dumpprivkeyのコマンドを用いてプライベートキーのインポートとエクスポートもできる。エクスポートされるプライベートキーの形式はウォレットの作成時期とバージョンによって異なってくる。",
      ...
      detaillabelprivwif:
        "プライベートキー (WIF)<br>(base58コード51文字) 頭文字が",
      detaillabelprivwifcomp:
        "プライベートキー (WIF)<br>(圧縮、base58コード52文字) 頭文字が",
      detailwifprefix: "'5'",
    ...
    "pt-br": {
      ...
      brainalertpassphrasewarning:
        "Aviso: É importante que escolha uma senha forte, para evitar ataques de força bruta que tentem adivinhar sua senha e roubar seus bitcoins.",
      brainalertpassphrasedoesnotmatch: "As senhas digitadas não são iguais.",
      detailalertnotvalidprivatekey:
        "O texto que você digitou não é uma chave privada válida",
      detailconfirmsha256:
      ...
      vanityinvalidinputcouldnotcombinekeys:
        "Entrada inválida. Não foi possível combinar as chaves.",
      vanityalertinvalidinputpublickeysmatch:
        "Entrada inválida. As chaves públicas de ambas entradas são iguais. Você deve inserir duas chaves diferentes.",
      vanityalertinvalidinputcannotmultiple:
        "Entrada inválida. Não é possível multiplicar duas chaves públicas. Clique em 'Somar' para somar duas chaves públicas para adquirir um endereço bitcoin.",
      vanityprivatekeyonlyavailable:
        "Disponível apenas quando se combinam duas chaves privadas",
      vanityalertinvalidinputprivatekeysmatch:
        "Entrada inválida. As chaves privadas de ambas as entradas são iguais. Você deve inserir duas chaves diferentes.",

      // header and menu html
      tagline:
        "Gerador local de carteiras Bitcoin usando Javascript de código aberto",
      generatelabelbitcoinaddress: "Gerando endereço Bitcoin...",
      generatelabelmovemouse:
        "Movimente um pouco o ponteiro do mouse para criar entropia...",
      generatelabelkeypress:
      ...
      vanitylabelstep1pubnotes:
        'Copie e cole a linha acima no campo "Your-Part-Public-Key" presente no site do Vanity Pool.',
      vanitylabelstep1privatekey: "Chave privada:",
      vanitylabelstep1privnotes:
        "Copie e cole a chave privada acima em um arquivo de texto. Idealmente salve em um disco criptografado. Ela será necessária para recuperar a chave privada assim que a Vanity Pool encontrar o seu prefixo.",
      vanitylabelstep2calculateyourvanitywallet:
        "Passo 2 - Calcule sua carteira Vanity",
      vanitylabelenteryourpart:
        "Introduza a chave privada gerada no passo 1 acima, e que você já tem guardada:",
      vanitylabelenteryourpoolpart:
        "Introduza a chave privada obtida no Vanity Pool:",
      vanitylabelnote1:
        "[NOTA: essa caixa de texto pode aceitar uma chave pública ou privada]",
      vanitylabelnote2:
        "[NOTA: essa caixa de texto pode aceitar uma chave pública ou privada]",
      ...
      vanitylabelnotesbitcoinaddress:
        "Esse é o seu novo endereço, que deveria conter o seu prefixo exigido.",
      vanitylabelpublickeyhex: "Chave pública Vanity (HEX):",
      vanitylabelnotespublickeyhex:
        "Essa é a sua chave pública em formato hexadecimal.",
      vanitylabelprivatekey: "Chave privada Vanity (WIF):",
      vanitylabelnotesprivatekey:
        "Essa é a chave privada para introduzir em sua carteira.",

      // detail wallet html
      detaillabelenterprivatekey: "Insira sua chave privada",
      detailkeyformats:
        "Formatos de chave: WIF, WIFC, HEX, B64, B6, MINI, BIP38",
      detailview: "Ver detalhes",
      detailprint: "Imprimir",
      detaillabelnote1:
        "Sua chave privada é um número secreto, único, que somente você tem acesso. Ela pode ser expressa em vários formatos. Abaixo mostramos o endereço e a chave pública que correspondem à sua chave privada, assim como a chave privada nos formatos mais conhecidos (WIF, hex, base64 y mini).",
      detaillabelnote2:
        "As versões do Bitcoin acima da v0.6+ armazenam as chaves públicas comprimidas. O cliente também suporta a importação/exportação de chaves privadas usando importprivkey/dumpprivkey. O formato das chaves privadas exportadas depende se o endereço foi gerado em uma carteira antiga ou nova.",
      ...
      detaillabelprivwif:
        "Chave privada para importação (51 caracteres em base58, inicia com um",
      detaillabelprivwifcomp:
        "Chave privada para importação  (comprimida, 52 caracteres em base58, inicia com",
      detailcompwifprefix: "'K' o 'L'",
      detaillabelprivhex:
        "Chave privada em formato hexadecimal (64 caracteres [0-9A-F]):",
      detaillabelprivb64: "Chave privada em base64 (44 caracteres):",
      detaillabelprivmini:
        "Chave privada en formato mini (22, 26 ou 30 caracteres, inicia com 'S'):",
    ...
    "zh-cn": {
      ...
      brainalertpassphrasewarning:
        "警告：选择一个足够强大的口令非常重要，它可以避免你的私钥被暴力破解。 此外，UTF-8编码有效。请注意区分全角/半角",
      ...
      vanityalertinvalidinputcannotmultiple:
        "错误，两个公钥不能进行乘运算，想要检查两个公钥合成的地址，请选择加运算。",
      ...
      footerlabeltranslatedby:
        "简中翻译捐赠 1BfXayW2vrj6uRpoZg3nR8rMEckLpGmaiL",
      footerlabelpgp: "PGP",
      ...
      singletip1:
        "<b>比特币钱包</b>就是这么简单，一个地址，对应一个私钥，浏览器已自动生成了一个，就显示在上面。私钥必须保密，地址可以公开。",
      singletip2:
        "<b>妥善保管你的钱包</b> 为了保护你的钱包，建议你用打印或者其他方式来保管你的私钥和地址。把你的私钥备份保存在安全、保密的位置是必要的。本站不提供私钥的相关知识，请自行学习。如果你熟悉PGP，你也可以下载这个HTML文件（它是单文件全功能的），用它的SHA256摘要和作者在本站页脚留下的相比对。本工具支持离线使用，这样它生成的私钥-地址就很难被监视了。比特币私钥必须保密，任何知道你私钥的人都可以随意花费其对应地址的比特币。你可以打印你的钱包（即纸钱包），把它装进一个防水的口袋里——就像你在保管纸币一样。",
      singletip3: "<b>获得比特币: </b> 让别人往你的地址汇入比特币。",
      singletip4:
        "<b>查询余额：</b> 访问blockchain.info或者blockexplorer.com可以查看到任何地址中的比特币余额。",
      singletip5:
        "<b>花费比特币：</b> 你可以下载比特币客户端，或者访问blockchain.info之类的在线钱包网站，导入你的比特币私钥来花费对应地址上的比特币。如果你选择了客户端，每当你发送一笔钱之后，找零有可能会发回客户端生成的另外一个地址，记得备份客户端生成的钱包文件，否则你可能丢钱。比特币作者中本聪说过，不要删除任何钱包，因为你的亲戚朋友说不定还会往你的旧地址里汇款。",
      ...
      bulklabela2li2:
        "    把地址列表导入到Web服务器上（注意，<b>不要</b>把私钥部分也一并导入，否则会有被盗的危险）",
      bulklabela2li3:
        "    为你的客户提供一个比特币支付的接口。每当一名客户选择使用比特币支付，你就从你的数据库中提取一个地址，作为该客户专用的“付款地址”，并保存订单信息。",
      bulklabela2li4:
        "接下来你需要一个收款通知，联系相关服务的供应商（谷歌搜索“bitcoin payment notification”），它们可以监视指定地址的资金变动，并通过WebAPI、短信、电邮或者其他方式来提醒你，你也可以通过编程使一切自动化。在http://www.blockexplorer.com/address/地址 或者 https://blockchain.info/address/地址 查看交易确认数。通常情况下，你能够在30秒之内看见交易，而根据你对安全的要求不同，你可能需要10分钟到1小时的时间等待交易确认。",
      bulklabela2li5:
    ...
    ru: {
      ...
      brainalertpassphrasetooshort:
        "Введенная парольная фраза слишком коротка.\n\n",
      brainalertpassphrasewarning:
      ...
      detailalertnotvalidprivatekey:
        "Введенный текст не является корректным приватным ключем",
      detailconfirmsha256:
      ...
      bip38alertincorrectpassphrase:
        "Введена некорректная парольная фраза для этого зашифрованного приватного ключа.",
      bip38alertpassphraserequired:
        "Парольная фраза необходима для ключа BIP38",
      vanityinvalidinputcouldnotcombinekeys:
        "Некорректный ввод. Не удалось объединить ключи.",
      vanityalertinvalidinputpublickeysmatch:
        "Некорректный ввод. Обе записи имеют одинаковый публичный ключ. Введите два разных публичных ключа.",
      vanityalertinvalidinputcannotmultiple:
        "Некорректный ввод. Невозможно объединить два публичных ключа. Выберите 'Добавить', чтобы добавить два публичных ключа для получения биткоин адреса.",
      vanityprivatekeyonlyavailable:
        "Доступно только при объединении двух приватных ключей",
      vanityalertinvalidinputprivatekeysmatch:
        "Некорректный ввод. Обе записи имеют одинаковый приватный ключ. Введите два разных приватных ключа.",

      // header and menu html
      tagline:
        "JavaScript генератор Биткоин кошельков на стороне клиента с открытым исходным кодом",
      generatelabelbitcoinaddress: "Генерация Биткоин адреса...",
      generatelabelmovemouse:
        "Двигайте указателем мыши по экрану для добавления случайности...",
      generatelabelkeypress:
        "ИЛИ введите несколько случайных символов в это текстовое поле",
      ...
      footerlabelcopyright2:
        "Информация о копирайте на JavaScript в исходниках.",
      ...
      vanitylabelstep1pubnotes:
        "Скопируйте и вставьте это значение в поле Вашей части публичного ключа на сайте пула для генерации адресов.",
      vanitylabelstep1privatekey: "Шаг 1 Приватный Ключ:",
      vanitylabelstep1privnotes:
        "Скопируйте и вставьте приватный ключ в файл. В идеале необходимо сохранить его на зашифрованный диск. Вам будет нужен приватный ключ после того, как пул найдет интересующий Вас префикс адреса.",
      vanitylabelstep2calculateyourvanitywallet:
        "Шаг 2 - Вычисление Вашего персонального кошелька",
      vanitylabelenteryourpart:
        "Введите Вашу часть приватного ключа (сгенерированного и сохраненного на шаге 1):",
      vanitylabelenteryourpoolpart:
        "Введите часть приватного ключа пула (предоставляется пулом):",
      ...
      vanitylabelnotesprivatekey:
        "Это Ваш приватный ключ для импорта в другой кошелек.",
      ...
      detaillabelnote1:
        "Ваш Приватный Ключ - это секретная информация, которую знаете только Вы. Этот ключ можно закодировать несколькими способами. Ниже вы видите адрес Биткоин и публичный ключ, которые соответствуют Вашему приватному ключу, если Ваш приватный ключ в одном из популярных форматов (WIF, WIFC, HEX, B64, MINI)",
      detaillabelnote2:
        "Приложение Bitcoin версии 0.6 и выше хранит ключи в сжатом формате. Это приложение также поддерживает импорт и экспорт приватных ключей командами importprivkey/dumpprivkey. Формат экспортированного ключа определяется кошельком, который сгенерировал адрес Биткоин.",
      ...
      detaillabelpublickeycomp:
        "Публичный ключ (короткий, 66 символов [0-9A-F]):",
      detaillabelprivwif:
        "Приватный ключ (в формате импорта), 51 символ base58, начинается с '5'",
      detaillabelprivwifcomp:
        "Приватный ключ, короткий, 52 символа base58, начинается с",
