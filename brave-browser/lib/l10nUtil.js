...
const braveComponentsStringsPath = path.resolve(
  path.join(srcDir, "brave", "app", "components_brave_strings.grd")
);
...
const braveComponentsResourcesPath = path.resolve(
  path.join(
    srcDir,
    "brave",
    "components",
    "resources",
    "brave_components_resources.grd"
  )
);
...
const braveBookmarksPartPath = path.resolve(
  path.join(srcDir, "brave", "app", "bookmarks_strings.grdp")
);
const braveMediaRouterPartPath = path.resolve(
  path.join(srcDir, "brave", "app", "media_router_strings.grdp")
);
const braveSettingsStringsPartPath = path.resolve(
  path.join(srcDir, "brave", "app", "settings_strings.grdp")
);
const braveMdExtensionsPartPath = path.resolve(
  path.join(srcDir, "brave", "app", "md_extensions_strings.grdp")
);
...
const braveSettingsResourcesPath = path.resolve(
  path.join(
    srcDir,
    "brave",
    "browser",
    "resources",
    "settings",
    "settings_resources.grd"
  )
);
const braveBrowserResourcesPath = path.resolve(
  path.join(srcDir, "brave", "browser", "browser_resources.grd")
);
...
const chroimumSettingsPartPath = path.resolve(
...
const chromiumBookmarksPartPath = path.resolve(
  path.join(srcDir, "chrome", "app", "bookmarks_strings.grdp")
);
const chromiumMediaRouterPartPath = path.resolve(
  path.join(srcDir, "chrome", "app", "media_router_strings.grdp")
);
const chromiumSettingsStringsPartPath = path.resolve(
  path.join(srcDir, "chrome", "app", "settings_strings.grdp")
);
const chromiumMdExtensionsPartPath = path.resolve(
  path.join(srcDir, "chrome", "app", "md_extensions_strings.grdp")
);

const chromiumExtensionsResourcesPath = path.resolve(
  path.join(
    srcDir,
    "chrome",
    "browser",
...
const chromiumSettingsResourcesPath = path.resolve(
  path.join(
    srcDir,
    "chrome",
    "browser",
...
const chromiumBrowserResourcesPath = path.resolve(
  path.join(srcDir, "chrome", "browser", "browser_resources.grd")
);
    ...
    fs.writeFileSync(
      ...
      fs
        ...
        .replace(
          ...
          '<structure name="IDR_MD_EXTENSIONS_SIDEBAR_HTML" preprocess="true"'
        )
        .replace(
          '<structure name="IDR_SETTINGS_APPEARANCE_FONTS_PAGE_HTML"',
          '<structure name="IDR_SETTINGS_APPEARANCE_FONTS_PAGE_HTML" preprocess="true"'
        )
        .replace(
          '<structure name="IDR_SETTINGS_PASSWORDS_SECTION_HTML"',
          '<structure name="IDR_SETTINGS_PASSWORDS_SECTION_HTML" preprocess="true"'
        )
        .replace(
          '<include name="IDR_MD_HISTORY_SIDE_BAR_HTML"',
          '<include name="IDR_MD_HISTORY_SIDE_BAR_HTML" flattenhtml="true"'
        )
        .replace(pageVisibility, bravePageVisibility + pageVisibility)
        .replace(
          /settings_chromium_strings.grdp/g,
