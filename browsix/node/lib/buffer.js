...
function createPool() {
  ...
  if (poolSize > 0) flags[kNoZeroFill] = 1;
...
function SlowBuffer(length) {
  ...
  if (length > 0) flags[kNoZeroFill] = 1;
...
function fromObject(obj) {
  ...
  if (Array.isArray(obj)) {
    ...
    for (var i = 0; i < length; i++) b[i] = obj[i] & 255;
    return b;
  }
  ...
  if (obj.buffer instanceof ArrayBuffer || obj.length) {
    var length;
    if (typeof obj.length !== "number" || obj.length !== obj.length) length = 0;
  ...
  if (obj.type === "Buffer" && Array.isArray(obj.data)) {
    ...
    for (var i = 0; i < array.length; i++) b[i] = array[i] & 255;
    return b;
  }
  ...
  for (;;) {
    switch (encoding) {
      ...
      default:
        ...
        if (loweredCase) return binding.byteLengthUtf8(string);
...
Object.defineProperty(Buffer.prototype, "parent", {
  ...
  get: function () {
    ...
    if (this.byteLength === 0 || this.byteLength === this.buffer.byteLength) {
      return undefined;
    }
    return this.buffer;
  },
...
Buffer.prototype.toString = function () {
  ...
  if (result === undefined) throw new Error("toString failed");
  return result;
};
...
Buffer.prototype.writeFloatLE = function writeFloatLE(val, offset, noAssert) {
  val = +val;
  offset = offset >>> 0;
  if (!noAssert) checkFloat(this, val, offset, 4);
...
Buffer.prototype.writeDoubleLE = function writeDoubleLE(val, offset, noAssert) {
  val = +val;
  offset = offset >>> 0;
  if (!noAssert) checkFloat(this, val, offset, 8);
