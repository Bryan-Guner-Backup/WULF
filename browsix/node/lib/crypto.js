...
exports.publicEncrypt = rsaPublic(
  binding.publicEncrypt,
  constants.RSA_PKCS1_OAEP_PADDING
);
exports.publicDecrypt = rsaPublic(
  binding.publicDecrypt,
  constants.RSA_PKCS1_PADDING
);
exports.privateEncrypt = rsaPrivate(
  binding.privateEncrypt,
  constants.RSA_PKCS1_PADDING
);
exports.privateDecrypt = rsaPrivate(
  binding.privateDecrypt,
  constants.RSA_PKCS1_OAEP_PADDING
);
...
function DiffieHellman(sizeOrKey, keyEncoding, generator, genEncoding) {
  ...
  if (!generator) generator = DH_GENERATOR;
...
ECDH.prototype.getPublicKey = function getPublicKey(encoding, format) {
  ...
  if (format) {
    ...
    if (format === "compressed") f = constants.POINT_CONVERSION_COMPRESSED;
    else if (format === "hybrid") f = constants.POINT_CONVERSION_HYBRID;
    // Default
    else if (format === "uncompressed")
      f = constants.POINT_CONVERSION_UNCOMPRESSED;
    else throw new TypeError("Bad format: " + format);
  } else {
    f = constants.POINT_CONVERSION_UNCOMPRESSED;
  }
