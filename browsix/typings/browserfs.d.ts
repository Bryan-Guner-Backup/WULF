...
declare module "browserfs" {
  ...
  export interface File {
    ...
    write(
      ...
      length: number,
      position: number,
      cb: (err: ApiError, written?: number, buffer?: NodeBuffer) => any
    ): void;
    writeSync(
      buffer: NodeBuffer,
      offset: number,
    ...
    read(
      ...
      length: number,
      position: number,
      cb: (err: ApiError, bytesRead?: number, buffer?: NodeBuffer) => void
    ): void;
    readSync(
      buffer: NodeBuffer,
      offset: number,
  ...
  export interface FileSystem {
    ...
    stat(
      p: string,
      isLstat: boolean,
      cb: (err: ApiError, stat?: Stats) => void
    ): void;
    ...
    realpath(
      ...
      cb: (err: ApiError, resolvedPath?: string) => any
    ): void;
    realpathSync(
      p: string,
      cache: {
  ...
  export class fs {
    ...
    static lstat(
      path: string,
      cb?: (err: ApiError, stats?: Stats) => any
    ): void;
    ...
    static read(
      ...
      position: number,
      encoding: string,
      cb?: (err: ApiError, data?: string, bytesRead?: number) => void
    ): void;
    static read(
      fd: File,
      buffer: NodeBuffer,
    ...
    static readdir(
      path: string,
      cb?: (err: ApiError, files?: string[]) => void
    ): void;
    ...
    static readlink(
      path: string,
      cb?: (err: ApiError, linkString: string) => any
    ): void;
