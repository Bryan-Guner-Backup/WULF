...
describe("Mnemonic", function () {
  ...
  describe("@fromRandom", function () {
    it("should make a new mnemonic", function () {
      ...
      Mnemonic.Words.ENGLISH.includes(
        mnemonic.toString().split(" ")[0]
      ).should.equal(true);
      Mnemonic.Words.ENGLISH.includes(
        mnemonic.toString().split(" ")[1]
      ).should.equal(true);
      Mnemonic.Words.ENGLISH.includes(
        mnemonic.toString().split(" ")[2]
      ).should.equal(true);
      let mnemonic3 = Mnemonic.fromRandom(Mnemonic.Words.SPANISH);
      Mnemonic.Words.SPANISH.includes(
        mnemonic3.toString().split(" ")[0]
      ).should.equal(true);
      Mnemonic.Words.SPANISH.includes(
        mnemonic3.toString().split(" ")[1]
      ).should.equal(true);
      Mnemonic.Words.SPANISH.includes(
        mnemonic3.toString().split(" ")[2]
      ).should.equal(true);
    });
  });
  ...
  describe("# Mnemonic", function () {
    ...
    it("has a fromString method", function () {
      ...
      var mnemonic4 = Mnemonic.fromString(
        mnemonic3.toString(),
