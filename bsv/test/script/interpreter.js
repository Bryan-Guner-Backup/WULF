...
describe("Interpreter", function () {
  ...
  const CheckMul = function (a, b, expected) {
    ...
    CheckBinaryOpMagnetic(
      a,
      NegativeValtype(b),
      Opcode.OP_MUL,
      NegativeValtype(expected)
    );
    CheckBinaryOpMagnetic(
      NegativeValtype(a),
      b,
  ...
  const evaluateScript = function (arraySig, arrayPubKey, op, funcDebug) {
    ...
    interp.script = new Script()
      .add(Buffer.from(arraySig))
      .add(Buffer.from(arrayPubKey));
  ...
  const debugScript = function (step, stack, altstack) {
    ...
    for (let item in stack.reverse()) {
      console.log(
        `Step ${step.pc}: ${script}:${stackTop}${stack[item].toString("hex")}`
      );
      stackTop = " ";
    }
  };
  ...
  describe("#NegativeValType", function () {
    it("should pass all tests", function () {
      ...
      NegativeValtype([0xff, 0x02, 0x01]).should.to.deep.equal([
        0xff, 0x02, 0x81,
      ]);
      NegativeValtype([0xff, 0x02, 0x81]).should.to.deep.equal([
        0xff, 0x02, 0x01,
      ]);
      NegativeValtype([0xff, 0xff, 0x02, 0x01]).should.to.deep.equal([
        0xff, 0xff, 0x02, 0x81,
      ]);
      NegativeValtype([0xff, 0xff, 0x02, 0x81]).should.to.deep.equal([
        0xff, 0xff, 0x02, 0x01,
      ]);
  ...
  describe("#OP_LSHIFT tests from bitcoind", function () {
    it("should not shift when no n value", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("10011111000100011111010101010101"));
    });
    it("should shift left 1", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00111110001000111110101010101010"));
    });
    it("should shift left 2", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("01111100010001111101010101010100"));
    });
    it("should shift left 3", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("11111000100011111010101010101000"));
    });
    it("should shift left 4", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("11110001000111110101010101010000"));
    });
    it("should shift left 5", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("11100010001111101010101010100000"));
    });
    it("should shift left 6", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("11000100011111010101010101000000"));
    });
    it("should shift left 7", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("10001000111110101010101010000000"));
    });
    it("should shift left 08", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00010001111101010101010100000000"));
    });
    it("should shift left 9", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00100011111010101010101000000000"));
    });
    it("should shift left 0A", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("01000111110101010101010000000000"));
    });
    it("should shift left 0B", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("10001111101010101010100000000000"));
    });
    it("should shift left 0C", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00011111010101010101000000000000"));
    });
    it("should shift left 0D", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00111110101010101010000000000000"));
    });
    it("should shift left 0E", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("01111101010101010100000000000000"));
    });
    it("should shift left 0F", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("11111010101010101000000000000000"));
    });
  });
  ...
  describe("#OP_RSHIFT tests from bitcoind", function () {
    ...
    it("should shift right 1", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("01001111100010001111101010101010"));
    });
    it("should shift right 2", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00100111110001000111110101010101"));
    });
    it("should shift right 3", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00010011111000100011111010101010"));
    });
    it("should shift right 4", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00001001111100010001111101010101"));
    });
    it("should shift right 5", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000100111110001000111110101010"));
    });
    it("should shift right 6", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000010011111000100011111010101"));
    });
    it("should shift right 7", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000001001111100010001111101010"));
    });
    it("should shift right 08", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000000100111110001000111110101"));
    });
    it("should shift right 9", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000000010011111000100011111010"));
    });
    it("should shift right 0A", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000000001001111100010001111101"));
    });
    it("should shift right 0B", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000000000100111110001000111110"));
    });
    it("should shift right 0C", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000000000010011111000100011111"));
    });
    it("should shift right 0D", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000000000001001111100010001111"));
    });
    it("should shift right 0E", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000000000000100111110001000111"));
    });
    it("should shift right 0F", function () {
      ...
      result
        .toString("hex")
        .should.equal(toBitpattern("00000000000000010011111000100011"));
    });
  });
  describe("#OP_MUL tests from bitcoind", function () {
    it("OP_MUL tests", function () {
      ...
      CheckMul(
        [0x05, 0x26],
        [0x26, 0x03, 0x32],
        [0xbe, 0xb3, 0x71, 0x6d, 0x07]
      );
      CheckMul(
        [0x06, 0x26],
        [0x26, 0x03, 0x32, 0x04],
        [0xe4, 0xb6, 0xa3, 0x85, 0x9f, 0x00]
      );
      CheckMul(
        [0x05, 0x26, 0x09],
        [0x26, 0x03, 0x32],
        [0xbe, 0xb3, 0xc7, 0x89, 0xc9, 0x01]
      );
      CheckMul(
        [0x06, 0x26, 0x09],
        [0x26, 0x03, 0x32, 0x04],
        [0xe4, 0xb6, 0xf9, 0xa1, 0x61, 0x26]
      );
      CheckMul(
        [0x06, 0x26, 0x09, 0x34],
        [0x26, 0x03, 0x32, 0x04],
