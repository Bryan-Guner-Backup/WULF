...
var localInternConfig =
  process.env.CANDY_VAGRANT === "false"
    ? "tests/intern.local"
    : "tests/intern.vagrant";
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
      ...
      bundle: {
        files: {
          "candy.bundle.js": [
            ...
            "src/util.js",
            "src/core/action.js",
            "src/core/chatRoom.js",
            "src/core/chatRoster.js",
            "src/core/chatUser.js",
            "src/core/contact.js",
            "src/core/event.js",
            "src/view/observer.js",
            "src/view/pane/chat.js",
            "src/view/pane/message.js",
            "src/view/pane/privateRoom.js",
            "src/view/pane/room.js",
            "src/view/pane/roster.js",
            "src/view/pane/window.js",
    ...
    natural_docs: {
      all: {
        bin: process.env.NATURALDOCS_DIR
          ? process.env.NATURALDOCS_DIR + "/NaturalDocs"
          : "naturaldocs",
        flags: ["-r"],
        inputs: ["./src"],
        output: "./docs",
