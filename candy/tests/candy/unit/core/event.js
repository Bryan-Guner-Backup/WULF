  ...
  bdd.describe("Candy.Core.Event", function () {
    ...
    bdd.describe("processing non-MUC presence", function () {
      ...
      bdd.it("should trigger the candy:core.presence event", function () {
        var eventParams;
        $(Candy).on("candy:core.presence", function (ev, params) {
          eventParams = params;
        });
        receivePresence();
    ...
    bdd.describe("processing room presence", function () {
      ...
      var setMe = function () {
        var me = new Candy.Core.ChatUser(
          "foo@bar.com",
          "SomeNick",
          "admin",
          "member"
      ...
      bdd.describe("for a room we are in", function () {
        ...
        bdd.describe("when a user joins a room", function () {
          ...
          bdd.it("emits a candy:core.presence.room event", function () {
            var eventParams;
            $(Candy).on("candy:core.presence.room", function (ev, params) {
              eventParams = params;
            });

            receiveJoinPresence();

            expect(eventParams).to.have.keys([
              "roomJid",
              "roomName",
              "user",
              "action",
            ...
            expect(eventParams.user).to.eql(
              room.getRoster().get(participantJid)
            );
        ...
        bdd.describe("when a user leaves a room", function () {
          ...
          bdd.describe("because they were kicked", function () {
            ...
            bdd.it(
              "emits the candy:core.presence.room event indicating they were kicked",
              function () {
                var eventParams;
                $(Candy).on("candy:core.presence.room", function (ev, params) {
                  eventParams = params;
          ...
          bdd.describe("because they were banned", function () {
            ...
            bdd.it(
              "emits the candy:core.presence.room event indicating they were banned",
              function () {
                var eventParams;
                $(Candy).on("candy:core.presence.room", function (ev, params) {
                  eventParams = params;
        ...
        bdd.describe("when we leave a room", function () {
          ...
          bdd.describe("voluntarily", function () {
            ...
            bdd.it("emits a candy:core.presence.leave event", function () {
              var eventParams;
              $(Candy).on("candy:core.presence.leave", function (ev, params) {
                eventParams = params;
              });
          ...
          bdd.describe("because we were kicked", function () {
            ...
            bdd.it(
              "emits the candy:core.presence.leave event indicating they were kicked",
              function () {
                var eventParams;
                $(Candy).on("candy:core.presence.leave", function (ev, params) {
                  eventParams = params;
          ...
          bdd.describe("because we were banned", function () {
            ...
            bdd.it(
              "emits the candy:core.presence.leave event indicating they were banned",
              function () {
                var eventParams;
                $(Candy).on("candy:core.presence.leave", function (ev, params) {
                  eventParams = params;
        ...
        bdd.describe("which is an error", function () {
          ...
          bdd.it("removes the room from our collection", function () {
            expect(Candy.Core.getRooms()[roomJid]).to.be.an.instanceof(
              Candy.Core.ChatRoom
            );
          ...
          bdd.it("emits a candy:core.presence.error event", function () {
            var eventParams;
            $(Candy).on("candy:core.presence.error", function (ev, params) {
              eventParams = params;
            });
      ...
      bdd.describe("when we join a room", function () {
        ...
        bdd.describe("and the room is being created", function () {
          ...
          bdd.it(
            "on a new room it emits a candy:core.presence.room event with isNewRoom set",
            function () {
              var eventParams;
              $(Candy).on("candy:core.presence.room", function (ev, params) {
                eventParams = params;
        ...
        bdd.describe(
          "when I am assigned a different nick to the one I asked for",
          function () {
            ...
            bdd.it(
              "sets the room user to be me with the new nick",
              function () {
            ...
            bdd.it(
              "emits a candy:core.presence.room event with the new nick",
              function () {
                var eventParams;
                $(Candy).on("candy:core.presence.room", function (ev, params) {
                  eventParams = params;
                ...
                expect(eventParams.roomJid).to.eql(
                  "coven@chat.shakespeare.lit"
                );
                expect(eventParams.roomName).to.eql("coven");
                expect(eventParams.user).to.eql(
                  room.getRoster().get(newParticipantJid)
                );
                expect(eventParams.action).to.eql("join");
                expect(eventParams.currentUser).to.eql(room.getUser());
                expect(eventParams.isNewRoom).to.eql(false);
    ...
    bdd.describe("processing messages", function () {
      bdd.describe("which have no type", function () {
        ...
        bdd.it("emits a candy:core:chat:message:normal event", function () {
          var eventParams;
          $(Candy).on("candy:core:chat:message:normal", function (ev, params) {
            eventParams = params;
          });
        ...
        bdd.describe("and contain a mediated MUC invite", function () {
          var receiveMessage = function () {
            var message = $msg({
              ...
              .c("reason")
              .t("Hey Hecate, this is the place for all good witches!")
              .up()
              .c("continue", {
          ...
          bdd.it("emits a candy:core:chat:invite event", function () {
            var eventParams;
            $(Candy).on("candy:core:chat:invite", function (ev, params) {
              eventParams = params;
            });
            ...
            expect(eventParams.reason).to.eql(
              "Hey Hecate, this is the place for all good witches!"
            );
            expect(eventParams.password).to.eql("cauldronburn");
            expect(eventParams.continuedThread).to.eql(
          ...
          bdd.it("emits a candy:core:chat:message:normal event", function () {
            ...
            expect(eventParams.type).to.eql("normal");
            expect(eventParams.message.attr("from")).to.eql(
              "coven@chat.shakespeare.lit"
            );
          });
      ...
      bdd.describe("which are a chat message", function () {
        ...
        bdd.it("emits a candy:core.message event", function () {
          var eventParams;
          $(Candy).on("candy:core.message", function (ev, params) {
            eventParams = params;
          });
          ...
          expect(message.xhtmlMessage.attr("style")).to.eql(
            "font-weight: bold;"
          );
        });
        ...
        bdd.describe("with a delay", function () {
          bdd.describe("according to XEP-0203", function () {
            ...
            bdd.it(
              "emits a candy:core.message event with the timestamp and a delay marker",
              function () {
                var eventParams;
                $(Candy).on("candy:core.message", function (ev, params) {
                  eventParams = params;
          ...
          bdd.describe("according to XEP-0091", function () {
            ...
            bdd.it(
              "emits a candy:core.message event with the timestamp",
              function () {
                var eventParams;
                $(Candy).on("candy:core.message", function (ev, params) {
                  eventParams = params;
          ...
          var receiveMessage = function () {
            testHelper.receiveStanza(
              $msg({
                ...
                .t("Visitors are not allowed to send messages to all occupants")
            );
          };
      ...
      bdd.describe("which are from a MUC room itself", function () {
        ...
        bdd.describe("in which we are not present", function () {
          bdd.it("does not emit a candy:core.message event", function () {
            var emitted = false;
            $(Candy).on("candy:core.message", function () {
              emitted = true;
            });
      ...
      bdd.describe(
        "which are of a type not listed in the XMPP spec",
        function () {
          var receiveMessage = function () {
            testHelper.receiveStanza(
              $msg({
          ...
          bdd.it("emits a candy:core:chat:message:other event", function () {
            var eventParams;
            $(Candy).on("candy:core:chat:message:other", function (ev, params) {
              eventParams = params;
            });
      ...
      bdd.describe("which are from a server admin (broadcast)", function () {
        ...
        bdd.it("emits a candy:core.chat.message.admin event", function () {
          var eventParams;
          $(Candy).on("candy:core.chat.message.admin", function (ev, params) {
            eventParams = params;
          });
      ...
      bdd.describe("which are from the server", function () {
        ...
        bdd.it("emits a candy:core.chat.message.server event", function () {
          var eventParams;
          $(Candy).on("candy:core.chat.message.server", function (ev, params) {
            eventParams = params;
          });
