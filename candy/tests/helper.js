...
(function (testHelper) {
  ...
  self.bootstrapTestClient = function () {
    Candy.Core.init("http://foo.bar/http-bind", {
    ...
    fakeConnection.addHandler(
      fakeConnection.roster._onReceivePresence.bind(fakeConnection.roster),
      null,
      "presence",
      null,
      null,
    ...
    fakeConnection.addHandler(
      fakeConnection.roster._onReceiveIQ.bind(fakeConnection.roster),
      Strophe.NS.ROSTER,
      "iq",
      "set",
      null,
