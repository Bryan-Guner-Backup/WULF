...
_Huh?_ Okay - think [Cygwin](https://en.wikipedia.org/wiki/Cygwin), except:
...
Shell.js _gives the feel of and approximates_ Unix commands in a code environment, but does not aim to precisely implement it.
