...
describe("echo", function () {
  ...
  describe("echo -e", function () {
    it("should interpret backspace with \\b", function () {
      const results = cash.echo(
        "this  \\bone sentences\\b should be grammm\\batically correct.",
        { e: true }
      );
      results.should.equal(
        "this one sentence should be grammatically correct.\n"
      );
    });
    ...
    it("should interpret a carriage return with \\r", function () {
      const results = cash.echo("these\\rare\\ron\\rdifferent\\rlines.", {
        e: true,
      });
