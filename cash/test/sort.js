...
describe("sort", function () {
  ...
  describe("sort -r", function () {
    it("should reverse the result of comparisons", function () {
      sort("default.sort", { reverse: true }).should.equal(
        "-zbz\nzaz\nsss\nqqq\nddd\nCCC\nccc\nBBB\n2bbb\n"
      );
    });

    it("should reverse multiple-file comparisons", function () {
      sort(["default.sort", "default.sort"], { reverse: true }).should.equal(
        "-zbz\n-zbz\nzaz\nzaz\nsss\nsss\nqqq\nqqq\nddd\nddd\nCCC\nCCC\nccc\nccc\nBBB\nBBB\n2bbb\n2bbb\n"
      );
    });
  ...
  describe("sort -o", function () {
    ...
    it("should shit on you for passing an invalid file", function () {
      // Yeah, I'm a muggle.
      sort("default.sort", {
        output: "./platform/nine/and/three/quarters.sort",
      }).should.equal(
        "sort: open failed: ./platform/nine/and/three/quarters.sort: No such file or directory\n"
      );
    });
  });
