!(function () {
  ...
  (Output.prototype.tag = function (name) {
    ...
    (Output.prototype.resize = function (size) {
      return this.actions.push({ method: "resize", options: size }), this;
    }),
    ...
    (Output.prototype.rotate = function (options) {
      return this.actions.push({ method: "rotate", options: options }), this;
    }),
    (Output.prototype.crop = function (position) {
      return this.actions.push({ method: "crop", options: position }), this;
    }),
  ...
  (px.init = function (data) {
    ...
    (px.handleIncoming = function (msg) {
      ...
      data.auth && data.auth === !0 && console.log("Auth successful"),
        data.job_id &&
          data.status &&
        ...
        function (e) {
          ...
          if (e.detail)
            for (var i in e.detail)
              e.detail.hasOwnProperty(i) && args.push(e.detail[i]);
          fn.apply(null, args);
        },
        !1
      );
