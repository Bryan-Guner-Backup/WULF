  ...
  return (function e(t, n, r) {
  ...
  })(
    {
          ...
          (function (root, mod) {
            ...
            function setOptions(opts) {
              ...
              for (var opt in defaultOptions)
                if (!has(options, opt)) options[opt] = defaultOptions[opt];
            ...
            var isEcma6Keyword = makePredicate(
      ...
      4: [
        function (require, module, exports) {
          ...
          CodeGenerator.prototype.generate = function () {
            ...
            return { map: this.map.get(), ast: ast, code: this.buf };
          };
        ...
        },
        {
          "../types": 56,
          "../util": 58,
          "./generators/array-comprehensions": 5,
          "./generators/base": 6,
      ...
      19: [
        ...
        { "./types": 56, "ast-types": 72, estraverse: 99, lodash: 104 },
      ],
      20: [
        function (require, module, exports) {
        ...
        { "../../types": 56, "../../util": 58, "./common": 21, lodash: 104 },
      ],
      21: [
        function (require, module, exports) {
      ...
      23: [
        ...
        { "../../types": 56, "../../util": 58, "./amd": 20, lodash: 104 },
      ],
      24: [
        function (require, module, exports) {
        ...
        },
        {
          ...
          "./modules/umd": 23,
          "./transformer": 25,
          "./transformers/_alias-functions": 26,
          "./transformers/_block-hoist": 27,
          "./transformers/_declarations": 28,
          "./transformers/_module-formatter": 29,
          "./transformers/_property-literals": 30,
          "./transformers/array-comprehension": 31,
          "./transformers/arrow-functions": 32,
          "./transformers/classes": 33,
          "./transformers/computed-property-names": 34,
          "./transformers/constants": 35,
          "./transformers/default-parameters": 36,
          "./transformers/destructuring": 37,
          "./transformers/for-of": 38,
          "./transformers/generators": 39,
          "./transformers/jsx": 40,
          "./transformers/let-scoping": 41,
          "./transformers/modules": 42,
          "./transformers/numeric-literals": 43,
          "./transformers/property-method-assignment": 44,
          "./transformers/property-name-shorthand": 45,
          "./transformers/react": 46,
          "./transformers/rest-parameters": 47,
          "./transformers/spread": 48,
          "./transformers/template-literals": 49,
          "./transformers/unicode-regex": 50,
          "./transformers/use-strict": 51,
          lodash: 104,
        },
      ],
      25: [
        ...
        { "../traverse": 52, "../types": 56, lodash: 104 },
      ],
      26: [
        function (require, module, exports) {
          var traverse = require("../../traverse");
      ...
      33: [
        function (require, module, exports) {
          ...
          var replaceInstanceSuperReferences = function (
            superName,
            methodNode
          ) {
      ...
      38: [
        function (require, module, exports) {
          ...
          exports.ForOfStatement = function (node, parent, file, scope) {
            ...
            var stepValueId = t.memberExpression(
              stepKey,
              t.identifier("value")
            );
            if (t.isIdentifier(left)) {
              declar = t.expressionStatement(
                t.assignmentExpression("=", left, stepValueId)
              );
      ...
      40: [
        ...
        { "../../types": 56, esutils: 103, lodash: 104 },
      ],
      41: [
        function (require, module, exports) {
          var traverse = require("../../traverse");
          ...
          var run = function (forParent, block, parent, file, scope) {
            ...
            if (!letKeys.length)
              return noClosure(declarators, block, info.duplicates);
            var letReferences = {};
            var closurify = false;
            ...
            if (has.hasReturn || has.hasBreak || has.hasContinue) {
              ...
              if (has.hasReturn) {
                retCheck = t.ifStatement(
                  t.binaryExpression(
                    "===",
                    t.unaryExpression("typeof", ret, true),
                    t.literal("object")
                  ),
              ...
              if (has.hasBreak || has.hasContinue) {
                var label = (forParent.label =
                  forParent.label ||
                  t.identifier(file.generateUid("loop", scope)));
                var cases = [];
                if (has.hasBreak) {
                  cases.push(
      ...
      50: [
        ...
        { lodash: 104, "regexpu/rewrite-pattern": 126 },
      ],
      51: [
        function (require, module, exports) {
          var t = require("../../types");
          ...
          t.getIds = function (node, map) {
            ...
            while (search.length) {
              ...
              if (t.isIdentifier(id)) {
                ...
                t.isImportSpecifier(id) ||
                t.isExportSpecifier(id) ||
                t.isVariableDeclarator(id) ||
                t.isFunctionDeclaration(id) ||
                t.isClassDeclaration(id)
              ) {
                search.push(id.id);
              } else if (t.isSpreadElement(id)) {
                search.push(id.argument);
              } else if (
                t.isExportDeclaration(id) ||
                t.isImportDeclaration(id)
              ) {
      ...
      61: [
        ...
        { "../lib/shared": 70, "../lib/types": 71, "./core": 59 },
      ],
      62: [
        function (require, module, exports) {
          require("./core");
      ...
      66: [
        ...
        { "./path": 68, "./scope": 69, "./types": 71, assert: 74, util: 98 },
      ],
      67: [
        function (require, module, exports) {
          var assert = require("assert");
        ...
        { "./node-path": 66, "./types": 71, assert: 74 },
      ],
      68: [
        function (require, module, exports) {
          var assert = require("assert");
      ...
      73: [
        ...
        {
          "/Users/sebastian/Projects/6to5/lib/6to5/transformation/transformers/_property-literals.js": 30,
        },
      ],
      74: [
        function (require, module, exports) {
      ...
      75: [
        ...
        { "base64-js": 76, ieee754: 77, "is-array": 78 },
      ],
      76: [
        function (require, module, exports) {
          var lookup =
      ...
      86: [
        ...
        { "./_stream_transform": 88, "core-util-is": 90, inherits: 80 },
      ],
      87: [
        function (require, module, exports) {
          (function (process) {
      ...
      88: [
        ...
        { "./_stream_duplex": 85, "core-util-is": 90, inherits: 80 },
      ],
      89: [
        function (require, module, exports) {
          (function (process) {
      ...
      98: [
        ...
        { "./support/isBuffer": 97, _process: 83, inherits: 80 },
      ],
      99: [
        function (require, module, exports) {
      ...
      107: [
        ...
        { "./emit": 105, assert: 74, "ast-types": 72, util: 98 },
      ],
      108: [
        function (require, module, exports) {
          var assert = require("assert");
          ...
          var visitor = types.PathVisitor.fromMethodsObject({
            ...
            visitForOfStatement: function (path) {
              ...
              var tempIterDecl = b.variableDeclarator(
                tempIterId,
                b.callExpression(runtimeValuesMethod, [node.right])
              );
      ...
      113: [
        ...
        },
        {
          "./lib/core.js": 114,
          "./lib/done.js": 115,
          "./lib/es6-extensions.js": 116,
          "./lib/node-extensions.js": 117,
        },
      ],
      114: [
        function (require, module, exports) {
      ...
      126: [
        ...
        {
          "./data/character-class-escape-sets.js": 121,
          "./data/iu-mappings.json": 122,
          regenerate: 123,
          regjsgen: 124,
          regjsparser: 125,
        },
      ...
      127: [
        ...
        {
          "./source-map/source-map-consumer": 132,
          "./source-map/source-map-generator": 133,
          "./source-map/source-node": 134,
        },
      ],
      128: [
        function (require, module, exports) {
      ...
      134: [
        ...
        { "./source-map-generator": 133, "./util": 135, amdefine: 136 },
      ],
      135: [
        function (require, module, exports) {
          if (typeof define !== "function") {
