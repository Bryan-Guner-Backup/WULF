  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      22: [
        ...
        { "./types": 68, "ast-types": 84, estraverse: 96, lodash: 101 },
      ],
      23: [
        function (require, module, exports) {
        ...
        { "../../types": 68, "../../util": 70, "./common": 25, lodash: 101 },
      ],
      24: [
        function (require, module, exports) {
      ...
      27: [
        ...
        { "../../types": 68, "../../util": 70, "./amd": 23, lodash: 101 },
      ],
      28: [
        function (require, module, exports) {
        ...
        },
        {
          ...
          "./modules/umd": 27,
          "./transformer": 29,
          "./transformers/_alias-functions": 30,
          "./transformers/_block-hoist": 31,
          "./transformers/_declarations": 32,
          "./transformers/_member-expression-keywords": 33,
          "./transformers/_module-formatter": 34,
          "./transformers/_property-literals": 35,
          "./transformers/array-comprehension": 36,
          "./transformers/arrow-functions": 37,
          "./transformers/classes": 38,
          "./transformers/computed-property-names": 39,
          "./transformers/constants": 40,
          "./transformers/default-parameters": 41,
          "./transformers/destructuring": 42,
          "./transformers/for-of": 43,
          "./transformers/generator-comprehension": 44,
          "./transformers/generators": 49,
          "./transformers/let-scoping": 54,
          "./transformers/modules": 55,
          "./transformers/property-method-assignment": 56,
          "./transformers/property-name-shorthand": 57,
          "./transformers/react": 58,
          "./transformers/rest-parameters": 59,
          "./transformers/spread": 60,
          "./transformers/template-literals": 61,
          "./transformers/unicode-regex": 62,
          "./transformers/use-strict": 63,
          lodash: 101,
        },
      ],
      29: [
        ...
        { "../traverse": 64, "../types": 68, lodash: 101 },
      ],
      30: [
        function (require, module, exports) {
          var traverse = require("../../traverse");
      ...
      35: [
        ...
        { "../../types": 68, esutils: 100, lodash: 101 },
      ],
      36: [
        function (require, module, exports) {
          var util = require("../../util");
      ...
      42: [
        function (require, module, exports) {
          ...
          var pushArrayPattern = function (opts, nodes, pattern, parentId) {
            var _parentId = t.identifier(
              opts.file.generateUid("ref", opts.scope)
            );
            nodes.push(
              t.variableDeclaration("var", [
                t.variableDeclarator(
            ...
            _.each(pattern.elements, function (elem, i) {
              ...
              if (t.isSpreadElement(elem)) {
                newPatternId = util.template("array-from", { VALUE: parentId });
                if (+i > 0) {
      ...
      44: [
        ...
        { "../../types": 68, "./array-comprehension": 36 },
      ],
      45: [
        function (require, module, exports) {
      ...
      48: [
        ...
        { "../../../types": 68, assert: 86, "ast-types": 84, lodash: 101 },
      ],
      49: [
        function (require, module, exports) {
      ...
      50: [
        ...
        { "../../../types": 68, "./emit": 47, assert: 86, util: 95 },
      ],
      51: [
        function (require, module, exports) {
          var assert = require("assert");
        ...
        { assert: 86, "ast-types": 84, lodash: 101, private: 102 },
      ],
      52: [
        function (require, module, exports) {
          var t = require("../../../types");
        ...
        function (require, module, exports) {
          ...
          var getSpreadLiteral = function (spread) {
            ...
            if (!t.isArrayExpression(literal)) {
              literal = util.template("array-from", { VALUE: literal });
            }
            return literal;
          };
      ...
      62: [
        ...
        { lodash: 101, "regexpu/rewrite-pattern": 108 },
      ],
      63: [
        function (require, module, exports) {
          var t = require("../../types");
      ...
      73: [
        ...
        { "../lib/shared": 82, "../lib/types": 83, "./core": 71 },
      ],
      74: [
        function (require, module, exports) {
          require("./core");
      ...
      78: [
        ...
        { "./path": 80, "./scope": 81, "./types": 83, assert: 86, util: 95 },
      ],
      79: [
        function (require, module, exports) {
          var assert = require("assert");
        ...
        { "./node-path": 78, "./types": 83, assert: 86 },
      ],
      80: [
        function (require, module, exports) {
          var assert = require("assert");
      ...
      87: [
        ...
        { "base64-js": 88, ieee754: 89, "is-array": 90 },
      ],
      88: [
        function (require, module, exports) {
          var lookup =
      ...
      95: [
        ...
        { "./support/isBuffer": 94, _process: 93, inherits: 91 },
      ],
      96: [
        function (require, module, exports) {
      ...
      108: [
        ...
        {
          "./data/character-class-escape-sets.js": 103,
          "./data/iu-mappings.json": 104,
          regenerate: 105,
          regjsgen: 106,
          regjsparser: 107,
        },
      ...
      109: [
        ...
        {
          "./source-map/source-map-consumer": 114,
          "./source-map/source-map-generator": 115,
          "./source-map/source-node": 116,
        },
      ],
      110: [
        function (require, module, exports) {
      ...
      116: [
        ...
        { "./source-map-generator": 115, "./util": 117, amdefine: 118 },
      ],
      117: [
        function (require, module, exports) {
          if (typeof define !== "function") {
        ...
        function (require, module, exports) {
          module.exports = {
                  ...
                  expression: {
                    ...
                    expression: {
                      ...
                      _scope: {
                        ...
                        args: { type: "Identifier", name: "args" },
                        bindArgs: { type: "Identifier", name: "bindArgs" },
                        Factory: { type: "Identifier", name: "Factory" },
                      },
                    },
                  },
                },
            ...
            "arguments-slice-assign-arg": {
              ...
              _scope: {
                VARIABLE_NAME: { type: "Identifier", name: "VARIABLE_NAME" },
                SLICE_KEY: { type: "Identifier", name: "SLICE_KEY" },
                arguments: { type: "Identifier", name: "arguments" },
                SLICE_ARG: { type: "Identifier", name: "SLICE_ARG" },
              },
            },
                  ...
                  expression: {
                    ...
                    callee: {
                      ...
                      expression: {
                        ...
                        expression: false,
                        _scope: { KEY: { type: "Identifier", name: "KEY" } },
                      },
                    },
                    arguments: [],
                  },
            ...
            "array-comprehension-for-each": {
                    ...
                    arguments: [
                      {
                        ...
                        generator: false,
                        async: false,
                        body: { type: "BlockStatement", body: [], _scope: {} },
                        expression: false,
                        _scope: { KEY: { type: "Identifier", name: "KEY" } },
                      },
                    ],
              ...
              _scope: { ARRAY: { type: "Identifier", name: "ARRAY" } },
            },
                    ...
                    arguments: [
                      {
                        ...
                        _scope: {
                          KEY: { type: "Identifier", name: "KEY" },
                          STATEMENT: { type: "Identifier", name: "STATEMENT" },
                        },
                      },
                    ],
                  },
            ...
            "array-from": {
              ...
              _scope: {
                Array: { type: "Identifier", name: "Array" },
            ...
            call: {
              ...
              _scope: {
                OBJECT: { type: "Identifier", name: "OBJECT" },
                CONTEXT: { type: "Identifier", name: "CONTEXT" },
              },
            },
            "class-props": {
              type: "Program",
              body: [
                {
                  ...
                  expression: {
                    ...
                    expression: {
                      ...
                      expression: false,
                      _scope: {
                        child: { type: "Identifier", name: "child" },
                        staticProps: {
                          type: "Identifier",
                          name: "staticProps",
                        },
            ...
            "class-super-constructor-call": {
              ...
              _scope: {
                SUPER_NAME: { type: "Identifier", name: "SUPER_NAME" },
                arguments: { type: "Identifier", name: "arguments" },
              },
            },
            class: {
            ...
            "exports-assign-key": {
              ...
              _scope: {
                exports: { type: "Identifier", name: "exports" },
                OBJECT: { type: "Identifier", name: "OBJECT" },
              },
            },
            "exports-assign": {
            ...
            "exports-wildcard": {
              ...
              _scope: { OBJECT: { type: "Identifier", name: "OBJECT" } },
            },
            extends: {
              type: "Program",
              body: [
                {
                  ...
                  expression: {
                    ...
                    expression: {
                      ...
                      _scope: {
                        child: { type: "Identifier", name: "child" },
                        parent: { type: "Identifier", name: "parent" },
                        Object: { type: "Identifier", name: "Object" },
                      },
                    },
                  },
            ...
            "for-of": {
              ...
              _scope: {
                ITERATOR_KEY: { type: "Identifier", name: "ITERATOR_KEY" },
                STEP_KEY: { type: "Identifier", name: "STEP_KEY" },
                OBJECT: { type: "Identifier", name: "OBJECT" },
                Symbol: { type: "Identifier", name: "Symbol" },
              },
            },
            "function-return-obj": {
              type: "Program",
            ...
            "if-undefined-set-to": {
              ...
              _scope: {
                ...
                DEFAULT: { type: "Identifier", name: "DEFAULT" },
              },
            },
            "interop-require": {
              type: "Program",
              body: [
                {
                  ...
                  expression: {
                    ...
                    expression: {
                      ...
                      expression: false,
                      _scope: { obj: { type: "Identifier", name: "obj" } },
                    },
                  },
                },
              ],
            ...
            "let-scoping-return": {
              ...
              _scope: { RETURN: { type: "Identifier", name: "RETURN" } },
            },
                  ...
                  expression: {
                    ...
                    callee: {
                      ...
                      expression: {
                        ...
                        _scope: {
                          KEY: { type: "Identifier", name: "KEY" },
                          CONTENT: { type: "Identifier", name: "CONTENT" },
                        },
                      },
                    },
                    arguments: [{ type: "Identifier", name: "OBJECT" }],
            ...
            "object-define-properties": {
              ...
              _scope: {
                Object: { type: "Identifier", name: "Object" },
                OBJECT: { type: "Identifier", name: "OBJECT" },
                PROPS: { type: "Identifier", name: "PROPS" },
              },
            },
            "prototype-identifier": {
              ...
              _scope: {
                CLASS_NAME: { type: "Identifier", name: "CLASS_NAME" },
              },
            },
            "require-assign-key": {
              type: "Program",
              ...
              _scope: {
                VARIABLE_NAME: { type: "Identifier", name: "VARIABLE_NAME" },
                require: { type: "Identifier", name: "require" },
                MODULE_NAME: { type: "Identifier", name: "MODULE_NAME" },
              },
            },
            "require-assign": {
              type: "Program",
            ...
            "self-global": {
              ...
              _scope: {
                self: { type: "Identifier", name: "self" },
                global: { type: "Identifier", name: "global" },
                window: { type: "Identifier", name: "window" },
              },
            },
            slice: {
              type: "Program",
              ...
              body: [
                {
                  ...
                  expression: {
                    ...
                    expression: {
                      ...
                      expression: false,
                      _scope: {
                        strings: { type: "Identifier", name: "strings" },
                        raw: { type: "Identifier", name: "raw" },
                        Object: { type: "Identifier", name: "Object" },
                      },
                    },
                  },
              ...
              body: [
                {
                  ...
                  expression: {
                    ...
                    expression: {
                      ...
                      _scope: {
                        factory: { type: "Identifier", name: "factory" },
                        define: { type: "Identifier", name: "define" },
                        AMD_ARGUMENTS: {
                          type: "Identifier",
                          name: "AMD_ARGUMENTS",
                        },
