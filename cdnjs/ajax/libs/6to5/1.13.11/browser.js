  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      22: [
        ...
        { "./types": 72, "ast-types": 88, estraverse: 100, lodash: 105 },
      ],
      23: [
        function (require, module, exports) {
        ...
        { "../../types": 72, "../../util": 74, "./common": 25, lodash: 105 },
      ],
      24: [
        function (require, module, exports) {
      ...
      28: [
        ...
        { "../../types": 72, "../../util": 74, "./amd": 23, lodash: 105 },
      ],
      29: [
        function (require, module, exports) {
        ...
        },
        {
          ...
          "./transformers/_member-expression-keywords": 34,
          ...
          "./transformers/react": 66,
          "./transformers/use-strict": 67,
          lodash: 105,
        },
      ],
      30: [
        ...
        { "../traverse": 68, "../types": 72, lodash: 105 },
      ],
      31: [
        function (require, module, exports) {
          var traverse = require("../../traverse");
      ...
      36: [
        ...
        { "../../types": 72, esutils: 104, lodash: 105 },
      ],
      37: [
        function (require, module, exports) {
          var util = require("../../util");
      ...
      43: [
        function (require, module, exports) {
          ...
          var pushObjectPattern = function (opts, nodes, pattern, parentId) {
            _.each(pattern.properties, function (prop, i) {
              if (t.isSpreadProperty(prop)) {
                ...
                nodes.push(
                  buildVariableAssign(opts.kind, prop.argument, value)
                );
              } else {
                ...
                if (t.isPattern(pattern2)) {
                  ...
                  nodes.push(
                    buildVariableAssign(opts.kind, pattern2, patternId2)
                  );
                }
              }
            });
          ...
          exports.ExpressionStatement = function (node, parent, file, scope) {
            ...
            push(
              { kind: false, file: file, scope: scope },
              nodes,
              expr.left,
              ref
            );
      ...
      48: [
        ...
        { "../../../types": 72, assert: 90, "ast-types": 88, lodash: 105 },
      ],
      49: [
        function (require, module, exports) {
      ...
      50: [
        ...
        { "../../../types": 72, "./emit": 47, assert: 90, util: 99 },
      ],
      51: [
        function (require, module, exports) {
          var assert = require("assert");
        ...
        { assert: 90, "ast-types": 88, lodash: 105, private: 106 },
      ],
      52: [
        function (require, module, exports) {
          var t = require("../../../types");
          ...
          exports.Function = function (node, parent, file) {
            ...
            if (node.params.length) {
              call = t.callExpression(
                t.memberExpression(call, t.identifier("slice")),
                [t.literal(node.params.length)]
              );
            }
      ...
      60: [
        ...
        { lodash: 105, "regexpu/rewrite-pattern": 112 },
      ],
      61: [
        function (require, module, exports) {
          var util = require("../../util");
      ...
      64: [
        ...
        { "../../types": 72, "./es7-array-comprehension": 62 },
      ],
      65: [
        function (require, module, exports) {
          var t = require("../../types");
        ...
        function (require, module, exports) {
          ...
          Scope.prototype.push = function (name, id, init) {
            ...
            if (t.isBlockStatement(block) || t.isProgram(block)) {
              ...
              block._declarations[name] = { id: id, init: init };
            } else {
              throw new TypeError(
      ...
      77: [
        ...
        { "../lib/shared": 86, "../lib/types": 87, "./core": 75 },
      ],
      78: [
        function (require, module, exports) {
          require("./core");
      ...
      82: [
        ...
        { "./path": 84, "./scope": 85, "./types": 87, assert: 90, util: 99 },
      ],
      83: [
        function (require, module, exports) {
          var assert = require("assert");
        ...
        { "./node-path": 82, "./types": 87, assert: 90 },
      ],
      84: [
        function (require, module, exports) {
          var assert = require("assert");
      ...
      91: [
        ...
        { "base64-js": 92, ieee754: 93, "is-array": 94 },
      ],
      92: [
        function (require, module, exports) {
          var lookup =
      ...
      99: [
        ...
        { "./support/isBuffer": 98, _process: 97, inherits: 95 },
      ],
      100: [
        function (require, module, exports) {
      ...
      112: [
        ...
        {
          "./data/character-class-escape-sets.js": 107,
          "./data/iu-mappings.json": 108,
          regenerate: 109,
          regjsgen: 110,
          regjsparser: 111,
        },
      ...
      113: [
        ...
        {
          "./source-map/source-map-consumer": 118,
          "./source-map/source-map-generator": 119,
          "./source-map/source-node": 120,
        },
      ],
      114: [
        function (require, module, exports) {
      ...
      120: [
        ...
        { "./source-map-generator": 119, "./util": 121, amdefine: 122 },
      ],
      121: [
        function (require, module, exports) {
          if (typeof define !== "function") {
              ...
              body: [
                {
                  ...
                  expression: {
                    ...
                    expression: {
                      type: "FunctionExpression",
                      id: null,
                      params: [{ type: "Identifier", name: "args" }],
                      defaults: [],
                      rest: null,
                      generator: false,
                      body: {
