  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      22: [
        ...
        { "./types": 74, "ast-types": 91, estraverse: 103, lodash: 108 },
      ],
      23: [
        function (require, module, exports) {
        ...
        { "../../types": 74, "../../util": 76, "./common": 25, lodash: 108 },
      ],
      24: [
        function (require, module, exports) {
      ...
      28: [
        ...
        { "../../types": 74, "../../util": 76, "./amd": 23, lodash: 108 },
      ],
      29: [
        function (require, module, exports) {
        ...
        },
        {
          ...
          "./transformers/react": 68,
          "./transformers/use-strict": 69,
          lodash: 108,
        },
      ],
      30: [
        ...
        { "../traverse": 70, "../types": 74, lodash: 108 },
      ],
      31: [
        function (require, module, exports) {
          var traverse = require("../../traverse");
      ...
      48: [
        ...
        { "../../../types": 74, assert: 93, "ast-types": 91, lodash: 108 },
      ],
      49: [
        function (require, module, exports) {
      ...
      50: [
        ...
        { "../../../types": 74, "./emit": 47, assert: 93, util: 102 },
      ],
      51: [
        function (require, module, exports) {
          var assert = require("assert");
          ...
          exports.AssignmentExpression = function (node, parent, file, scope) {
            ...
            if (!t.isExpressionStatement(parent)) {
              if (t.isDynamic(value)) {
                ...
                scope.push({ key: tempName, id: temp });
              }
            }
      ...
      64: [
        ...
        { "../../types": 74, "./es7-array-comprehension": 62 },
      ],
      65: [
        function (require, module, exports) {
          var t = require("../../types");
        ...
        function (require, module, exports) {
          ...
          exports.BindFunctionExpression = function (
            ...
            if (_.find(node.arguments, t.isDynamic)) {
              ...
              scope.push({ key: argsIdName, id: argsId });
              return t.sequenceExpression([
                t.assignmentExpression(
                  "=",
                  argsId,
      ...
      68: [
        ...
        { "../../types": 74, esutils: 107, lodash: 108 },
      ],
      69: [
        function (require, module, exports) {
          var t = require("../../types");
