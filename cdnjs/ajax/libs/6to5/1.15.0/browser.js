  ...
  })(
    {
      ...
      2: [
        function (require, module, exports) {
          ...
          File.normaliseOptions = function (opts) {
            ...
            _.defaults(opts, { moduleRoot: opts.sourceRoot });
            _.defaults(opts, { sourceRoot: opts.moduleRoot });
            _.defaults(opts, { filenameRelative: opts.filename });
            _.defaults(opts, {
          ...
          File.prototype.getModuleFormatter = function (type) {
            var ModuleFormatter = _.isFunction(type)
              ? type
              : transform.moduleFormatters[type];
            if (!ModuleFormatter) {
          ...
          File.prototype.addDeclaration = function (name) {
            ...
            this.scope.push({ key: name, id: uid, init: ref });
            return uid;
          };
          ...
          File.prototype.generate = function () {
            var opts = this.opts;
            var ast = this.ast;
            var result = { code: "", map: null, ast: null };
      ...
      4: [
        ...
        },
        {
          ...
          "./buffer": 3,
          "./generators/base": 5,
          "./generators/classes": 6,
          "./generators/comprehensions": 7,
          "./generators/expressions": 8,
          "./generators/jsx": 9,
          "./generators/methods": 10,
          "./generators/modules": 11,
          "./generators/playground": 12,
      ...
      12: [
        function (require, module, exports) {
          var _ = require("lodash");
          _.each(
            ["BindMemberExpression", "BindFunctionExpression"],
            function (type) {
              exports[type] = function () {
                throw new ReferenceError(
                  "Trying to render non-standard playground node " +
                    JSON.stringify(type)
                );
              };
            }
      ...
      15: [
        function (require, module, exports) {
          ...
          exports.SpreadElement = exports.SpreadProperty = function (
            node,
            print
          ) {
            this.push("...");
      ...
      22: [
        ...
        { "./types": 75, "ast-types": 92, estraverse: 104, lodash: 109 },
      ],
      23: [
        function (require, module, exports) {
          ...
          AMDFormatter.prototype.getModuleName = function () {
            if (this.file.opts.amdModuleIds) {
              return CommonJSFormatter.prototype.getModuleName.apply(
                this,
                arguments
              );
            } else {
        ...
        { "../../types": 75, "../../util": 77, "./common": 25, lodash: 109 },
      ],
      24: [
        function (require, module, exports) {
          ...
          CommonJSInteropFormatter.prototype.importSpecifier = function (
            specifier,
            node,
            nodes
          ) {
            ...
            if (specifier.default) {
              nodes.push(
                t.variableDeclaration("var", [
                  t.variableDeclarator(
                    variableName,
                    t.callExpression(
                      this.file.addDeclaration("interop-require"),
                      [
                        util.template("require", {
              ...
              CommonJSFormatter.prototype.importSpecifier.apply(
                this,
                arguments
              );
            }
        ...
        function (require, module, exports) {
          ...
          SystemFormatter.prototype.transform = function (ast) {
            ...
            var executeFunctionExpression = t.functionExpression(
              null,
              [],
              t.blockStatement(this.exportedStatements)
            );
            var settersArrayExpression = t.arrayExpression(
              this._buildSetters()
            );
            var moduleReturnStatement = t.returnStatement(
              t.objectExpression([
                t.property(
                  "init",
                  t.identifier("setters"),
                  settersArrayExpression
                ),
                t.property(
                  "init",
          ...
          SystemFormatter.prototype._buildSetters = function () {
            return _.map(this.importedModule, function (specs) {
              ...
              return t.functionExpression(
                ...
                t.blockStatement(expressionStatements)
              );
            });
          };
          ...
          SystemFormatter.prototype.importSpecifier = function (
            specifier,
            node
          ) {
            var variableName = t.getSpecifierName(specifier);
          ...
          SystemFormatter.prototype._export = function (name, identifier) {
            this.exportedStatements.push(
              t.expressionStatement(
                t.callExpression(this.exportIdentifier, [
                  t.literal(name),
                  identifier,
                ])
              )
          ...
          SystemFormatter.prototype.exportSpecifier = function (
            specifier,
            node
          ) {
            var variableName = t.getSpecifierName(specifier);
      ...
      28: [
        function (require, module, exports) {
          ...
          UMDFormatter.prototype.transform = function (ast) {
            ...
            var defineArgs = [
              t.arrayExpression([t.literal("exports")].concat(names)),
            ];
            var moduleName = this.getModuleName();
            if (moduleName) defineArgs.unshift(t.literal(moduleName));
        ...
        { "../../types": 75, "../../util": 77, "./amd": 23, lodash: 109 },
      ],
      29: [
        function (require, module, exports) {
        ...
        },
        {
          ...
          "./modules/amd": 23,
          "./modules/common": 25,
          "./modules/common-interop": 24,
          "./modules/ignore": 26,
          "./modules/system": 27,
          "./modules/umd": 28,
          "./transformer": 30,
          "./transformers/_alias-functions": 31,
          "./transformers/_block-hoist": 32,
          "./transformers/_declarations": 33,
          "./transformers/_member-expression-literals": 34,
          "./transformers/_module-formatter": 35,
          "./transformers/_property-literals": 36,
          "./transformers/es5-property-method-assignment": 37,
          "./transformers/es6-arrow-functions": 38,
          "./transformers/es6-classes": 39,
          "./transformers/es6-computed-property-names": 40,
          "./transformers/es6-constants": 41,
          "./transformers/es6-default-parameters": 42,
          "./transformers/es6-destructuring": 43,
          "./transformers/es6-for-of": 44,
          "./transformers/es6-generators": 49,
          "./transformers/es6-let-scoping": 54,
          "./transformers/es6-modules": 55,
          "./transformers/es6-property-name-shorthand": 56,
          "./transformers/es6-rest-parameters": 57,
          "./transformers/es6-spread": 58,
          "./transformers/es6-template-literals": 59,
          "./transformers/es6-unicode-regex": 60,
          "./transformers/es7-abstract-references": 61,
          "./transformers/es7-array-comprehension": 62,
          "./transformers/es7-exponentiation-operator": 63,
          "./transformers/es7-generator-comprehension": 64,
          "./transformers/es7-object-spread": 65,
          "./transformers/playground-memoization-operator": 66,
          "./transformers/playground-method-binding": 67,
          "./transformers/playground-object-getter-memoization": 68,
          "./transformers/react": 69,
          "./transformers/use-strict": 70,
          lodash: 109,
        },
      ],
      30: [
        ...
        { "../traverse": 71, "../types": 75, lodash: 109 },
      ],
      31: [
        function (require, module, exports) {
          var traverse = require("../../traverse");
          ...
          var go = function (getBody, node, file, scope) {
            ...
            var getArgumentsId = function () {
              return (argumentsId =
                argumentsId || file.generateUidIdentifier("arguments", scope));
            };
            var getThisId = function () {
              return (thisId =
                thisId || file.generateUidIdentifier("this", scope));
            };
        ...
        function (require, module, exports) {
          ...
          exports.Property = function (node) {
            ...
            if (t.isLiteral(key) && t.isValidIdentifier(key.value)) {
              ...
              !node.computed &&
              t.isIdentifier(key) &&
              esutils.keyword.isKeywordES6(key.name, true)
            ) {
      ...
      39: [
        function (require, module, exports) {
          ...
          function Class(node, file, scope) {
            ...
            this.className =
              node.id || file.generateUidIdentifier("class", scope);
          ...
          Class.prototype.run = function () {
            ...
            if (superName) {
              if (t.isMemberExpression(superName)) {
                ...
                superClassCallee = superName = file.generateUidIdentifier(
                  "ref",
                  this.scope
                );
              }
          ...
          Class.prototype.pushMethod = function (node) {
            ...
            if (kind === "") {
              var className = this.className;
              if (!node.static)
                className = t.memberExpression(
                  className,
                  t.identifier("prototype")
                );
              methodName = t.memberExpression(
                className,
                methodName,
                node.computed
              );
              this.body.push(
                t.expressionStatement(
                  t.assignmentExpression("=", methodName, node.value)
                )
              );
            } else {
          ...
          exports.Function = function (node, parent, file, scope) {
            ...
            _.each(node.defaults, function (def, i) {
              ...
              _.each(ids.slice(i), function (ids) {
                var check = function (node, parent) {
                  if (!t.isIdentifier(node) || !t.isReferenced(node, parent))
                    return;
            ...
            _.each(node.defaults, function (def, i) {
              ...
              body.push(
                util.template(
                  "if-undefined-set-to",
                  { VARIABLE: node.params[i], DEFAULT: def },
                  true
                )
              );
            });
      ...
      43: [
        function (require, module, exports) {
            ...
            _.each(pattern.properties, function (prop, i) {
              if (t.isSpreadProperty(prop)) {
                ...
                var value = t.callExpression(
                  opts.file.addDeclaration("object-spread"),
                  [parentId, keys]
                );
                nodes.push(buildVariableAssign(opts, prop.argument, value));
              } else {
                var pattern2 = prop.value;
                var patternId2 = t.memberExpression(
                  parentId,
                  prop.key,
                  prop.computed
                );
              ...
              if (t.isSpreadElement(elem)) {
                ...
                if (+i > 0) {
                  newPatternId = t.callExpression(
                    t.memberExpression(newPatternId, t.identifier("slice")),
                    [t.literal(i)]
                  );
                }
                elem = elem.argument;
          ...
          exports.ForInStatement = exports.ForOfStatement = function (
            ...
            var nodes = [];
            push(
              { kind: declar.kind, file: file, scope: scope },
              nodes,
              pattern,
              key
            );
          ...
          exports.ExpressionStatement = function (node, parent, file, scope) {
            ...
            push(
              { operator: expr.operator, file: file, scope: scope },
              nodes,
              expr.left,
              ref
            );
          ...
          exports.AssignmentExpression = function (node, parent, file, scope) {
            ...
            scope.push({ key: tempName, id: ref });
            var nodes = [];
            nodes.push(t.assignmentExpression("=", ref, node.right));
            push(
              { operator: node.operator, file: file, scope: scope },
              nodes,
              node.left,
              ref
            );
      ...
      45: [
        function (require, module, exports) {
          ...
          exports.MemberExpression = function (
            expr,
            path,
            explodeViaTempVar,
            finish
          ...
          exports.CallExpression = function (
            ...
            if (
              !t.isMemberExpression(oldCalleePath.node) &&
              t.isMemberExpression(newCallee)
            ) {
              newCallee = t.sequenceExpression([t.literal(0), newCallee]);
            }
            return finish(
              t.callExpression(
                newCallee,
          ...
          exports.ArrayExpression = function (
            expr,
            path,
            explodeViaTempVar,
            finish
          ...
          exports.BinaryExpression = function (
            expr,
            path,
            explodeViaTempVar,
            finish
          ...
          exports.YieldExpression = function (expr, path) {
            ...
            if (arg && expr.delegate) {
              ...
              this.emit(
                t.returnStatement(
                  t.callExpression(this.contextProperty("delegateYield"), [
                    arg,
      ...
      46: [
        function (require, module, exports) {
          ...
          exports.ForInStatement = function (path, stmt, labelId) {
            ...
            this.emitAssign(
              keyIterNextFn,
              t.callExpression(runtimeKeysMethod, [
                this.explodeExpression(path.get("right")),
              ])
            );
            this.mark(head);
          ...
          exports.TryStatement = function (path, stmt) {
            ...
            this.leapManager.withEntry(tryEntry, function () {
              ...
              if (finallyLoc) {
                ...
                this.emit(
                  t.callExpression(this.contextProperty("finish"), [
          ...
          exports.ThrowStatement = function (path) {
            this.emit(
              t.throwStatement(this.explodeExpression(path.get("argument")))
            );
          };
        },
        {
      ...
      47: [
        function (require, module, exports) {
          ...
          Emitter.prototype.clearPendingException = function (
            tryLoc,
            assignee
          ) {
        ...
        },
        {
          ...
          "../meta": 51,
          "../util": 52,
          "./explode-expressions": 45,
          "./explode-statements": 46,
          assert: 94,
          "ast-types": 92,
          lodash: 109,
        },
      ...
      48: [
        ...
        { "../../../types": 75, assert: 94, "ast-types": 92, lodash: 109 },
      ],
      49: [
        function (require, module, exports) {
      ...
      50: [
        ...
        { "../../../types": 75, "./emit": 47, assert: 94, util: 103 },
      ],
      51: [
        function (require, module, exports) {
          var assert = require("assert");
          ...
          function makePredicate(propertyName, knownTypes) {
            ...
            function predicate(node) {
              ...
              if (_.has(opaqueTypes, node.type))
                return (meta[propertyName] = false);
              if (_.has(knownTypes, node.type))
        ...
        { assert: 94, "ast-types": 92, lodash: 109, private: 110 },
      ],
      52: [
        function (require, module, exports) {
          var t = require("../../../types");
        ...
        function (require, module, exports) {
          ...
          var visitor = function (path, file) {
            ...
            if (t.isFunctionDeclaration(node)) {
              ...
              while (
                pp &&
                !(t.isBlockStatement(pp.value) || t.isProgram(pp.value))
              ) {
                pp = pp.parent;
              }
              if (!pp) {
        ...
        function (require, module, exports) {
          ...
          LetScoping.prototype.buildHas = function (ret, call) {
            ...
            if (has.hasBreak || has.hasContinue) {
              var label = (loopParent.label =
                loopParent.label ||
                this.file.generateUidIdentifier("loop", this.scope));
              if (has.hasBreak) {
                cases.push(
        ...
        function (require, module, exports) {
          ...
          exports.ImportDeclaration = function (node, parent, file) {
            ...
            if (node.specifiers.length) {
              _.each(node.specifiers, function (specifier) {
                file.moduleFormatter.importSpecifier(
                  specifier,
                  node,
                  nodes,
                  parent
          ...
          exports.ExportDeclaration = function (node, parent, file) {
            ...
            if (node.declaration) {
              ...
              _.each(node.specifiers, function (specifier) {
                file.moduleFormatter.exportSpecifier(
                  specifier,
                  node,
                  nodes,
                  parent
        ...
        function (require, module, exports) {
          ...
          exports.Function = function (node, parent, file) {
            ...
            node.body.body.unshift(
              t.variableDeclaration("var", [t.variableDeclarator(rest, call)])
            );
          };
        },
        { "../../types": 75 },
      ...
      60: [
        ...
        { lodash: 109, "regexpu/rewrite-pattern": 116 },
      ],
      61: [
        function (require, module, exports) {
          var util = require("../../util");
      ...
      64: [
        ...
        { "../../types": 75, "./es7-array-comprehension": 62 },
      ],
      65: [
        function (require, module, exports) {
          var t = require("../../types");
        ...
        function (require, module, exports) {
          ...
          var getPropRef = function (nodes, prop, file, scope) {
            if (t.isIdentifier(prop)) {
              ...
              nodes.push(
                t.variableDeclaration("var", [t.variableDeclarator(temp, prop)])
              );
              return temp;
            }
          };
          var getObjRef = function (nodes, obj, file, scope) {
            if (t.isDynamic(obj)) {
              ...
              nodes.push(
                t.variableDeclaration("var", [t.variableDeclarator(temp, obj)])
              );
              return temp;
            } else {
              return obj;
          ...
          var buildAssignment = function (expr, obj, prop) {
            return t.assignmentExpression(
              "=",
              buildAbsoluteRef(expr.left, obj, prop),
              expr.right
            );
          };
          exports.ExpressionStatement = function (node, parent, file, scope) {
        ...
        function (require, module, exports) {
          ...
          exports.BindMemberExpression = function (node, parent, file, scope) {
            ...
            var call = t.callExpression(
              t.memberExpression(
                t.memberExpression(object, prop),
                t.identifier("bind")
              ),
          ...
          exports.BindFunctionExpression = function (
            node,
            parent,
            file,
            scope
            ...
            var buildCall = function (args) {
              ...
              return t.functionExpression(
                ...
                t.blockStatement([
                  t.returnStatement(
                    t.callExpression(
                      t.memberExpression(param, node.callee),
                      args
                    )
                  ),
                ])
            ...
            if (_.find(node.arguments, t.isDynamic)) {
              ...
              return t.sequenceExpression([
                ...
                buildCall(
                  node.arguments.map(function (node, i) {
      ...
      68: [
        function (require, module, exports) {
          var traverse = require("../../traverse");
          var t = require("../../types");
          exports.Property = exports.MethodDefinition = function (
            node,
            parent,
            file,
            scope
            ...
            var memoId = t.memberExpression(
              t.thisExpression(),
              t.identifier(key)
            );
            var doneId = t.memberExpression(
              t.thisExpression(),
              t.identifier(key + "Done")
            );
            traverse(value, function (node) {
              if (t.isFunction(node)) return;
              if (t.isReturnStatement(node) && node.argument) {
                node.argument = t.assignmentExpression(
                  "=",
                  memoId,
                  node.argument
                );
            ...
            body.unshift(
              t.expressionStatement(
                t.assignmentExpression("=", doneId, t.literal(true))
              )
            );
      ...
      69: [
        ...
        { "../../types": 75, esutils: 108, lodash: 109 },
      ],
      70: [
        function (require, module, exports) {
          var t = require("../../types");
              ...
              var handle = function (obj, key) {
                ...
                var maybeReplace = function (result) {
                  ...
                  if (result != null) {
                    ...
                    if (
                      _.isArray(result) &&
                      _.contains(t.STATEMENT_OR_BLOCK_KEYS, key) &&
                      !t.isBlockStatement(obj)
                    ) {
        ...
        function (require, module, exports) {
          ...
          Scope.prototype.push = function (opts) {
            ...
            if (t.isBlockStatement(block) || t.isProgram(block)) {
              ...
              throw new TypeError(
                "cannot add a declaration here in node type " + block.type
              );
            }
          };
      ...
      75: [
        function (require, module, exports) {
          ...
          t.isValidIdentifier = function (name) {
            return (
              _.isString(name) &&
              esutils.keyword.isIdentifierName(name) &&
              !esutils.keyword.isKeywordES6(name, true)
            );
          };
          ...
          t.inheritsComments = function (child, parent) {
            child.leadingComments = _.compact(
              [].concat(child.leadingComments, parent.leadingComments)
            );
            child.trailingComments = _.compact(
              [].concat(child.trailingComments, parent.trailingComments)
            );
            return child;
          };
          ...
          (function (root, mod) {
            ...
            function getTokenFromCode(code) {
              switch (code) {
                ...
                case 125:
                  ++tokPos;
                  return finishToken(_braceR, undefined, !inXJSChild);
                case 63:
                  ++tokPos;
              ...
              if (eat(_question)) {
                ...
                if (eat(_eq)) {
                  ...
                  if (left.type !== "MemberExpression")
                    raise(
                      left.start,
                      "You can only use member expressions in memoization assignment"
                    );
                  node.right = parseMaybeAssign(noIn);
                  node.operator = "?=";
                  return finishNode(node, "AssignmentExpression");
                ...
                if (
                  consequent.type === "BindMemberExpression" &&
                  tokType !== _colon
                ) {
            ...
            function parseSubscripts(base, start, noCalls) {
              if (options.playground && eat(_colon)) {
                ...
                return parseSubscripts(
                  finishNode(node, "BindMemberExpression"),
                  start,
                  noCalls
                );
                ...
                node.property = parseIdent(true);
                return parseSubscripts(
                  finishNode(node, "VirtualPropertyExpression"),
                  start,
                  noCalls
                );
              } else if (eat(_dot)) {
            ...
            function parseObj() {
              ...
              while (!eat(_braceR)) {
                ...
                if (eat(_colon)) {
                  ...
                  (prop.key.name === "get" ||
                    prop.key.name === "set" ||
                    (options.playground && prop.key.name === "memo"))
                ) {
            ...
            function parseClass(node, isStatement) {
              ...
              while (!eat(_braceR)) {
                ...
                if (
                  ...
                  (method.key.name === "get" ||
                    method.key.name === "set" ||
                    (options.playground && method.key.name === "memo"))
                ) {
                  if (isGenerator || isAsync) unexpected();
      ...
      81: [
        ...
        { "../lib/shared": 90, "../lib/types": 91, "./core": 79 },
      ],
      82: [
        function (require, module, exports) {
          require("./core");
      ...
      83: [
        function (require, module, exports) {
          ...
          def("ObjectTypeAnnotation")
            ...
            .field("properties", [def("Property")])
            .field("nullable", isBoolean);
          def("VoidTypeAnnotation").bases("Pattern");
      ...
      86: [
        function (require, module, exports) {
          ...
          function cleanUpIfStatementAfterPrune(ifStatement) {
            ...
            if (!consequent && !alternate) {
              var testExpressionStatement =
                b.expressionStatement(testExpression);
              ifStatement.replace(testExpressionStatement);
            } else if (!consequent && alternate) {
              var negatedTestExpression = b.unaryExpression(
                "!",
                testExpression,
                true
              );
        ...
        { "./path": 88, "./scope": 89, "./types": 91, assert: 94, util: 103 },
      ],
      87: [
        function (require, module, exports) {
          var assert = require("assert");
        ...
        { "./node-path": 86, "./types": 91, assert: 94 },
      ],
      88: [
        function (require, module, exports) {
          var assert = require("assert");
      ...
      95: [
        ...
        { "base64-js": 96, ieee754: 97, "is-array": 98 },
      ],
      96: [
        function (require, module, exports) {
          var lookup =
      ...
      116: [
        ...
        {
          "./data/character-class-escape-sets.js": 111,
          "./data/iu-mappings.json": 112,
          regenerate: 113,
          regjsgen: 114,
          regjsparser: 115,
        },
      ...
      117: [
        ...
        {
          "./source-map/source-map-consumer": 122,
          "./source-map/source-map-generator": 123,
          "./source-map/source-node": 124,
        },
      ],
      118: [
        function (require, module, exports) {
      ...
      124: [
        ...
        { "./source-map-generator": 123, "./util": 125, amdefine: 126 },
      ],
      125: [
        function (require, module, exports) {
          if (typeof define !== "function") {
                  ...
                  expression: {
                    ...
                    callee: {
                      ...
                      object: {
                        ...
                        callee: {
                          type: "MemberExpression",
                          object: { type: "Identifier", name: "PROPERTY" },
                          property: {
                            type: "MemberExpression",
                  ...
                  expression: {
                    ...
                    callee: {
                      ...
                      property: {
                        type: "MemberExpression",
                        object: { type: "Identifier", name: "Symbol" },
                        property: { type: "Identifier", name: "referenceGet" },
                        computed: false,
                      },
                      computed: true,
                    },
                  ...
                  expression: {
                    ...
                    callee: {
                      ...
                      property: {
                        type: "MemberExpression",
                        object: { type: "Identifier", name: "Symbol" },
                        property: { type: "Identifier", name: "referenceSet" },
                        computed: false,
                      },
                      computed: true,
                    },
                            ...
                            declarations: [
                              {
                                ...
                                id: { type: "Identifier", name: "instance" },
                                init: {
                                  type: "CallExpression",
                                  callee: {
                                    type: "MemberExpression",
              ...
              body: [
                {
                  ...
                  expression: {
                    ...
                    arguments: [
                      ...
                      { type: "Identifier", name: "MODULE_DEPENDENCIES" },
                      { type: "Identifier", name: "MODULE_BODY" },
                    ],
                  },
                },
              ],
                        ...
                        body: [
                          {
                            ...
                            argument: {
                              ...
                              consequent: { type: "Identifier", name: "arr" },
                              alternate: {
                                type: "CallExpression",
                                callee: {
                                  type: "MemberExpression",
