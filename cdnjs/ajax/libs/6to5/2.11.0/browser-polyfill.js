        ...
        (function (global) {
          !(function (global, framework, undefined) {
            ...
            function isIterable(it) {
              ...
              return (
                hasExt || SYMBOL_ITERATOR in O || has(Iterators, classof(O))
              );
            }
              ...
              if (framework) {
                ...
                if (
                  ...
                  forEach.call(getNames(RegExp), function (key) {
                    key in WrappedRegExp ||
                      defineProperty(WrappedRegExp, key, {
                        configurable: true,
                        get: function () {
                          return RegExp[key];
                        },
            ...
            !(function (Promise, test) {
              (isFunction(Promise) &&
                ...
                Promise.resolve((test = new Promise(function () {}))) ==
                  test) ||
                (function (asap, DEF) {
              ...
              $define(GLOBAL + FORCED * !isNative(Promise), {
                Promise: Promise,
              });
            })(global[PROMISE]);
            !(function () {
            ...
            !(function (REFERENCE) {
              ...
              var REFERENCE_SET = getWellKnownSymbol(REFERENCE + SET, true),
                REFERENCE_DELETE = getWellKnownSymbol(
                  REFERENCE + "Delete",
                  true
                );
