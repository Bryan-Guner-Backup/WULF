      ...
      function (require, module, exports) {
        !(function (returnThis, framework, undefined) {
          ...
          function setToStringTag(it, tag, stat) {
            if (it)
              has((it = stat ? it : it[PROTOTYPE]), SYMBOL_TAG) ||
          ...
          function getIterator(it) {
            return assertObject(
              (it[SYMBOL_ITERATOR] || Iterators[classof(it)]).call(it)
            );
          }
            ...
            forEach.call(
              array(
                "hasInstance,isConcatSpreadable,match,replace,search," +
                  "species,split,toPrimitive,unscopables"
              ),
              function (it) {
          ...
          !(function (isFinite, tmp) {
            ...
            $define(PROTO, STRING, {
              ...
              endsWith: function (searchString, endPosition) {
                ...
                searchString += "";
                return (
                  String(this).slice(end - searchString.length, end) ===
                  searchString
                );
              },
              ...
              startsWith: function (searchString, position) {
                ...
                searchString += "";
                return (
                  String(this).slice(index, index + searchString.length) ===
                  searchString
                );
              },
            });
                ...
                assignHidden(Promise[PROTOTYPE], {
                  then: function (onFulfilled, onRejected) {
                    var react = {
                      ...
                      P = (react.P = new this[CONSTRUCTOR](function (
                        resolve,
                        reject
                      ) {
          ...
          !(function () {
            ...
            function getCollection(
              ...
              if (
                ...
                !(
                  isNative(C) &&
                  (isWeak || (has(proto, FOR_EACH) && has(proto, "entries")))
                )
              ) {
                C = isWeak
                  ? function (iterable) {
            ...
            function weakCollectionHas(key) {
              return (
                isObject(key) &&
                has(key, WEAKDATA) &&
                has(key[WEAKDATA], this[WEAKID])
              );
            }
            var weakCollectionMethods = {
              delete: function (key) {
                return (
                  weakCollectionHas.call(this, key) &&
                  delete key[WEAKDATA][this[WEAKID]]
                );
              },
