(function () {
  ...
  if (a.require && a.define) require.packaged = !0;
  else {
    var b = function (a, c, d) {
      typeof a != "string"
        ? b.original
          ? b.original.apply(window, arguments)
    ...
    a.require && (c.original = a.require),
      (a.require = c),
      (require.packaged = !0);
    var d = function (a) {
      ...
      b.edit = function (b) {
        ...
        d.startupPlugins({ env: l }).then(function () {
          (l.document = c),
            (l.editor = k),
            k.resize(),
            f.addListener(window, "resize", function () {
              k.resize();
            }),
            (b.env = l);
        }),
  ...
  define(
    "pilot/types/basic",
    ["require", "exports", "module", "pilot/types"],
    function (a, b, c) {
      function m(a) {
        if (a instanceof e) this.subtype = a;
          ...
          if (this.subtype == null)
            throw new Error("Unknown array subtype: " + a);
        }
      }
      function l(a) {
        if (typeof a.defer != "function")
          throw new Error(
            "Instances of DeferredType need typeSpec.defer to be a function that returns a type"
          );
      ...
      function j(a) {
        if (!Array.isArray(a.data) && typeof a.data != "function")
          throw new Error(
            "instances of SelectionType need typeSpec.data to be an array or function that returns an array:" +
              JSON.stringify(a)
          );
        Object.keys(a).forEach(function (b) {
          this[b] = a[b];
      ...
      (i.stringify = function (a) {
        ...
        (i.parse = function (a) {
          ...
          if (a.replace(/\s/g, "").length === 0)
            return new f(null, g.INCOMPLETE, "");
        ...
        (j.prototype.parse = function (a) {
          ...
          b.forEach(function (b) {
            a == b
              ? ((d = this.fromString(b)), (c = !0))
              : b.indexOf(a) === 0 && e.push(this.fromString(b));
          }, this);
          if (c) return new f(d);
          this.noMatch && this.noMatch();
          if (e.length > 0) {
            var h =
              "Possibilities" + (a.length === 0 ? "" : " for '" + a + "'");
    ...
    function (a, b, c) {
      ...
      function w(a) {
        ...
        if (!!b[v])
          if (typeof b.sender == "string") {
            ...
            if (!j.isFunction(b.sender))
              throw new Error(
                "Key binding must have a sender that is a string or function"
              );
            var g = { command: a, sender: b.sender };
            (keyData = u(c)),
              e[keyData.hashId] || (e[keyData.hashId] = {}),
              e[keyData.hashId][keyData.key]
                ? e[keyData.hashId][keyData.key].push(g)
                : (e[keyData.hashId][keyData.key] = [g]);
          }
      }
      function u(a, b, c) {
        var d,
          ...
          i = f.length;
        for (; g < i; ++g)
          h.KEY_MODS[f[g]] ? (e = e | h.KEY_MODS[f[g]]) : (d = f[g] || "-");
        if (c == null) return { key: d, hashId: e };
        (c[e] || (c[e] = {}))[d] = b;
      }
      function t(a, b, c, d) {
        return ((d && a.toLowerCase()) || a)
          .replace(/(?:^\s+|\n|\s+$)/g, "")
          .split(new RegExp("[\\s ]*" + b + "[\\s ]*", "g"), c || 999);
      }
      ...
      f.implement(J.prototype, i),
        (J.prototype.getParamStatus = function (a) {
          ...
          if (a.name in b) {
            if (b[a.name] == null)
              return a.defaultValue === null ? l.VALID : l.INCOMPLETE;
            var c,
              d = b[a.name].toString();
            try {
              c = a.type.parse(d);
        ...
        (J.prototype.done = function (a) {
          (this.completed = !0),
            ...
            a && this.output(a),
            this.isDone ||
              ((this.isDone = !0), this._dispatchEvent("output", {}));
        }),
        (b.Request = J);
    }
  ),
      ...
      ? e.forEach(function (a) {
          b[a] = function () {
            var b = Array.prototype.slice.call(arguments),
              c = { op: "log", method: a, args: b };
            postMessage(JSON.stringify(c));
          };
        })
      : e.forEach(function (a) {
          window.console && window.console[a]
            ? (b[a] = Function.prototype.bind.call(
                window.console[a],
                window.console
              ))
            : (b[a] = d);
  ...
  define(
    "pilot/stacktrace",
    ["require", "exports", "module", "pilot/useragent", "pilot/console"],
    function (a, b, c) {
      function i() {}
      function g(a) {
        ...
        h = {
          ...
          opera: function (a) {
            var b = a.message.split("\n"),
              ...
              f,
              g;
            for (e = 4, f = 0, g = b.length; e < g; e += 2)
              d.test(b[e]) &&
                (b[f++] =
                  (RegExp.$3
      ...
      i.prototype = {
        ...
        guessFunctionName: function (a, b) {
          try {
            ...
            return (
              "getSource failed with url: " + a + ", exception: " + c.toString()
            );
          }
        },
  ...
  define(
    "pilot/keys",
    ["require", "exports", "module", "pilot/oop"],
    function (a, b, c) {
      var d = a("pilot/oop"),
        e = (function () {
          var a = {
      ...
      (b.startup = function (a, b) {
        ...
        (j.prototype = {
          ...
          set: function (a) {
            this.value !== a &&
              ((this.value = a),
              this._settings.persister &&
                this._settings.persister.persistValue(
                  this._settings,
                  this.name,
                  a
                ),
        ...
        (k.prototype = {
          ...
          _saveToObject: function () {
            return this.getSettingNames().map(
              function (a) {
      ...
      var d = {
          ...
          exec: function (a, b, c) {
            ...
            if (!b.setting) {
              ...
              (d = ""),
                ...
                e.forEach(function (b) {
                  var c = a.settings.getSetting(b),
                    e =
                      "https://wiki.mozilla.org/Labs/Skywriter/Settings#" +
                      c.name;
                  d +=
              ...
              b.value === undefined
                ? (d =
                    "<strong>" + setting.name + "</strong> = " + setting.get())
                : (b.setting.set(b.value),
                  (d =
                    "Setting: <strong>" +
                    b.setting.name +
                    "</strong> = " +
              ...
              ? (d.reset(),
                c.done(
                  "Reset " +
                    d.name +
                    " to default: " +
                    a.settings.get(b.setting)
                ))
              : c.doneWithError(
                  "No setting with the name <strong>" + b.setting + "</strong>."
                );
          },
        },
        f = a("pilot/canon");
  ...
  define(
    "pilot/commands/basic",
    ["require", "exports", "module", "pilot/typecheck", "pilot/canon"],
      ...
      var checks = require("pilot/typecheck"),
        ...
        helpCommandSpec = {
          ...
          exec: function (a, b, c) {
            ...
            if (e && e.exec)
              d.push(
                e.description ? e.description : "No description for " + b.search
              );
            else {
              var f = !1;
              e
                ? (d.push("<h2>Sub-Commands of " + e.name + "</h2>"),
                  d.push("<p>" + e.description + "</p>"))
                : b.search
                ? (b.search == "hidden" && ((b.search = ""), (f = !0)),
                  d.push("<h2>Commands starting with '" + b.search + "':</h2>"))
                : d.push("<h2>Available Commands:</h2>");
          ...
          exec: function (env, args, request) {
            ...
            if (checks.isFunction(result))
              ...
              var items = [],
                value;
              for (x in result)
                result.hasOwnProperty(x) &&
                  (checks.isFunction(result[x])
                    ? (value = "[function]")
                    : checks.isObject(result[x])
                    ? (value = "[object]")
                    : (value = result[x]),
              ...
              for (x = 0; x < items.length; x++)
                msg +=
                  "<b>" + items[x].name + "</b>: " + items[x].value + "<br>";
  ...
  define(
    "pilot/plugin_manager",
    ["require", "exports", "module", "pilot/promise"],
    function (a, b, c) {
  ...
  define(
    "pilot/promise",
    ["require", "exports", "module", "pilot/console", "pilot/stacktrace"],
    function (a, b, c) {
      var d = a("pilot/console"),
        e = a("pilot/stacktrace").Trace,
        f = -1,
        ...
        (Promise.prototype.then = function (a, b) {
          typeof a == "function" &&
            (this._status === h
              ...
              : this._status === g && this._onSuccessHandlers.push(a)),
            typeof b == "function" &&
              (this._status === f
                ? b.call(null, this._value)
                : this._status === g && this._onErrorHandlers.push(b));
          return this;
        }),
    ...
    (b.createElement = function (a, b) {
      ...
      (b.importCssString = function (a, b) {
        ...
        if (b.createStyleSheet) {
          ...
          var e = b.createElementNS
            ? b.createElementNS(d, "style")
      ...
      (b.getInnerWidth = function (a) {
        return (
          parseInt(b.computedStyle(a, "paddingLeft")) +
          parseInt(b.computedStyle(a, "paddingRight")) +
          a.clientWidth
        );
      }),
      (b.getInnerHeight = function (a) {
        return (
          parseInt(b.computedStyle(a, "paddingTop")) +
          parseInt(b.computedStyle(a, "paddingBottom")) +
          a.clientHeight
        );
      }),
      ...
      (b.setInnerText = function (a, b) {
        document.body && "textContent" in document.body
          ? (a.textContent = b)
          : (a.innerText = b);
      }),
      (b.getInnerText = function (a) {
        return document.body && "textContent" in document.body
          ? a.textContent
        ...
        (b.addMultiMouseDownListener = function (a, c, d, f, g) {
          var h = 0,
            ...
            k = function (a) {
              ...
              if (
                !e ||
                Math.abs(a.clientX - i) > 5 ||
                Math.abs(a.clientY - j) > 5
              )
                h = 0;
              h == d && ((h = 0), g(a));
      ...
      (function () {
        d.implement(this, n),
          ...
          (this.addEventListener = function (a, b) {
            return this.$forwardEvents[a]
              ? this.renderer.addEventListener(a, b)
              : this.$originalAddEventListener(a, b);
          }),
          (this.removeEventListener = function (a, b) {
            return this.$forwardEvents[a]
              ? this.renderer.removeEventListener(a, b)
              : this.$originalRemoveEventListener(a, b);
          }),
          ...
          (this.setSession = function (a) {
            if (this.session != a) {
              ...
              (this.session = a),
                ...
                (this.$onChangeTabSize = this.renderer.updateText.bind(
                  this.renderer
                )),
          ...
          (this.removeLeft = function () {
            if (!this.$readOnly) {
              ...
              if (this.getBehavioursEnabled()) {
                var b = this.session,
                  c = b.getState(a.start.row),
                  d = b.getMode().transformAction(c, "deletion", this, b, a);
                d !== !1 && (a = d);
              }
          ...
          (this.transposeLetters = function () {
            if (!this.$readOnly) {
              ...
              if (b < c.length)
                var d = c.charAt(b) + c.charAt(b - 1),
                  e = new m(a.row, b - 1, a.row, b + 1);
              else
                var d = c.charAt(b - 1) + c.charAt(b - 2),
          ...
          (this.removeLines = function () {
            if (!this.$readOnly) {
              ...
              if (a.last == 0 || a.last + 1 < this.session.getLength())
                var b = new m(a.first, 0, a.last + 1, 0);
              else
                var b = new m(
                  a.first - 1,
                  this.session.getLine(a.first).length,
                  a.last,
          ...
          (this.selectPageDown = function () {
            var a =
              this.$getPageDownRow() +
              Math.floor(this.$getVisibleRowCount() / 2);
            this.scrollPageDown();
          ...
          (this.gotoLine = function (a, b) {
            this.selection.clearSelection(),
              ...
              (this.$blockScrolling -= 1),
              this.isRowVisible(this.getCursorPosition().row) ||
                this.scrollToLine(a, !0);
          }),
        ...
        g = function (a, b) {
          ...
          function l(a) {
            if (!i) {
              var d = a || c.value;
              if (d) {
                d.charCodeAt(d.length - 1) == g.charCodeAt(0)
                  ? ((d = d.slice(0, -1)), d && b.onTextInput(d, !j))
                  : b.onTextInput(d, !j);
                if (!u()) return !1;
              }
            }
          ...
          var h = !1,
            ...
            n = function (a) {
              (e.isIE && c.value.charCodeAt(0) > 128) ||
                setTimeout(function () {
                  h || l();
                }, 0);
            },
          ...
          c.attachEvent
            ? d.addListener(c, "propertychange", n)
            : e.isChrome || e.isSafari
            ? d.addListener(c, "textInput", m)
            : e.isIE
            ? d.addListener(c, "textinput", m)
            : d.addListener(c, "input", m),
            d.addListener(c, "paste", function (a) {
              (j = !0),
                a.clipboardData && a.clipboardData.getData
                  ? (l(a.clipboardData.getData("text/plain")),
                    a.preventDefault())
                  : n();
            }),
            e.isIE
              ...
              : (d.addListener(c, "copy", r), d.addListener(c, "cut", s)),
            d.addListener(c, "compositionstart", o),
            e.isGecko && d.addListener(c, "text", p),
            e.isWebKit && d.addListener(c, "keyup", p),
            d.addListener(c, "compositionend", q),
            ...
            (this.onContextMenu = function (a, b) {
              a &&
                (k || (k = c.style.cssText),
                (c.style.cssText =
                  "position:fixed; z-index:1000;left:" +
                  (a.x - 2) +
                  "px; top:" +
                  (a.y - 2) +
                  "px;")),
  ...
  define(
    ...
    function (a, b, c) {
      var d = a("pilot/event"),
        e = a("pilot/dom"),
        f = a("pilot/browser_focus").BrowserFocus,
        g = 0,
        h = 1,
        i = 2,
        j = 250,
        ...
        l = function (a) {
          ...
          d.addListener(b, "mousedown", this.onMouseDown.bind(this)),
            ...
            d.addMultiMouseDownListener(
              ...
              3,
              600,
              this.onMouseTripleClick.bind(this)
            ),
            d.addMultiMouseDownListener(
              b,
              0,
              4,
              600,
              this.onMouseQuadClick.bind(this)
            ),
      ...
      (function () {
        (this.$scrollSpeed = 1),
          ...
          (this.$getEventPosition = function (a) {
            ...
            e.row = Math.max(
              0,
              Math.min(e.row, this.editor.session.getLength() - 1)
            );
            return e;
          }),
          ...
          (this.onMouseDown = function (a) {
            function D(b) {
              a.shiftKey
                ? l.selection.selectToPosition(b)
                : m.$clickSelection ||
                  (l.moveCursorToPosition(b),
                  l.selection.clearSelection(b.row, b.column)),
                (p = h);
            }
            if (
              !(
              ...
              var b = d.getDocumentX(a),
                ...
                r = d.getButton(a);
              if (r !== 0) {
                o && l.moveCursorToPosition(f),
                  r == 2 &&
                    (l.textInput.onContextMenu({ x: b, y: c }, o),
                    d.capture(
                      l.container,
                      function () {},
              ...
              (q = !l.getReadOnly() && !o && n.contains(f.row, f.column)),
                q || D(f);
              var t,
                u,
                v = l.getOverwrite(),
                ...
                B = function () {
                  e.removeCssClass(l.container, "ace_dragging"),
                    ...
                    m.$clickSelection ||
                      x ||
                      (l.moveCursorToPosition(f),
                      l.selection.clearSelection(f.row, f.column));
                  if (!!x) {
                  ...
                  if (t !== undefined && u !== undefined) {
                    if (p == g) {
                      ...
                      if (a > k) {
                        ...
                        (f.row = Math.max(
                          0,
                          Math.min(f.row, l.session.getLength() - 1)
                        )),
                          D(f);
                      } else if (d - w > j) {
                        (p = i), (y = l.getSelectionRange());
                        var n = l.getSelectionStyle();
                        (dragSelectionMarker = l.session.addMarker(
                          y,
                          "ace_selection",
                          n
                        )),
                ...
                E = function () {
                  ...
                  a.row = Math.max(
                    0,
                    Math.min(a.row, l.session.getLength() - 1)
                  );
                  if (m.$clickSelection)
                    if (m.$clickSelection.contains(a.row, a.column))
                      l.selection.setSelectionRange(m.$clickSelection);
                    else {
                      if (m.$clickSelection.compare(a.row, a.column) == -1)
                        var b = m.$clickSelection.end;
                ...
                F = function () {
                  (x = l.renderer.screenToTextCoordinates(t, u)),
                    (x.row = Math.max(
                      0,
                      Math.min(x.row, l.session.getLength() - 1)
                    )),
                    l.moveCursorToPosition(x);
                };
          ...
          (this.onMouseDoubleClick = function (a) {
            var b = this.editor,
              c = this.$getEventPosition(a),
              d = b.session.getFoldAt(c.row, c.column, 1);
            d
              ? b.session.expandFold(d)
      ...
      (function () {
        d.implement(this, f),
          ...
          (this._setFocused = function (a) {
            this._isFocused != a &&
              (a && (this.lastFocus = new Date().getTime()),
              (this._isFocused = a),
      ...
      (function () {
        (this.setKeyboardHandler = function (a) {
          this.$keyboardHandler != a &&
            ((this.$data = {}), (this.$keyboardHandler = a));
        }),
          (this.getKeyboardHandler = function () {
            return this.$keyboardHandler;
          }),
          (this.$callKeyboardHandler = function (a, b, c, d) {
            var e = { editor: this.$editor },
              g;
            this.$keyboardHandler &&
              (g = this.$keyboardHandler.handleKeyboard(
                this.$data,
                b,
                c,
                d,
            ...
            if (!g || !g.command)
              b != 0 || d != 0
                ? (g = { command: h.findKeyCommand(e, "editor", b, c) })
                : (g = { command: "inserttext", args: { text: c } });
            var i = !1;
            g &&
              ((i = h.exec(g.command, e, "editor", g.args)),
              i && f.stopEvent(a));
            return i;
          }),
  ...
  define(
    "ace/commands/default_commands",
    ["require", "exports", "module", "pilot/lang", "pilot/canon"],
    function (a, b, c) {
      function f(a, b) {
      ...
      var d = a("pilot/oop"),
        ...
        m = function (a, b) {
          (this.$modified = !0),
            ...
            b ? this.setMode(b) : this.setMode(new h());
        };
      (function () {
        function o(a) {
          return a < 4352
        ...
        d.implement(this, f),
          ...
          (this.onChange = function (a) {
            ...
            !this.$fromUndo &&
              ...
              this.bgTokenizer.start(b.range.start.row),
          ...
          (this.setUndoManager = function (a) {
            ...
            if (a) {
              ...
              (this.$syncInformUndoManager = function () {
                ...
                (this.$informUndoManager = e.deferredCall(
          ...
          (this.getTabString = function () {
            return this.getUseSoftTabs()
              ? e.stringRepeat(" ", this.getTabSize())
              : "\t";
          }),
          (this.$useSoftTabs = !0),
          ...
          (this.onReloadTokenizer = function (a) {
            ...
            this.bgTokenizer.start(b.first),
              this._dispatchEvent("tokenizerUpdate", a);
          }),
          (this.$mode = null),
            ...
            if (this.$modified || a) {
              ...
              for (var e = 0; e < b.length; e++) {
                ...
                (h = g.length),
                  (c = Math.max(c, h)),
                  this.$useWrapMode ||
                    (d = Math.max(d, this.$getStringScreenWidth(g)[0]));
              }
              (this.width = c),
                this.$useWrapMode
                ...
                (delta = a[d]),
                  delta.group == "doc"
                    ? (this.doc.revertDeltas(delta.deltas),
                      (c = this.$getUndoSelection(delta.deltas, !0, c)))
                    : delta.deltas.forEach(function (a) {
                        this.addFolds(a.folds);
                      }, this);
              (this.$fromUndo = !1),
                c && !b && this.selection.setSelectionRange(c);
              return c;
            }
          }),
              ...
              for (var d = 0; d < a.length; d++)
                (delta = a[d]),
                  delta.group == "doc" &&
                    ...
                    (c = this.$getUndoSelection(delta.deltas, !1, c)));
              (this.$fromUndo = !1),
                c && !b && this.selection.setSelectionRange(c);
              return c;
            }
          ...
          (this.$getUndoSelection = function (a, b, c) {
            ...
            d(e)
              ? ((f = e.range.clone()), (h = !0))
              : ((f = j.fromPoints(e.range.start, e.range.start)), (h = !1));
            for (var i = 1; i < a.length; i++)
              (e = a[i]),
                d(e)
                  ...
                  : ((g = e.range.start),
                    f.compare(g.row, g.column) == -1 &&
                      (f = j.fromPoints(e.range.start, e.range.start)),
                    (h = !1));
            if (c != null) {
              ...
              if (!l) j = this.$getDisplayTokens(e.stringTrimRight(c[m]));
                ...
                (j = []),
                  l.walk(
                    ...
                    l.end.row,
                    c[l.end.row].length + 1
                  );
                while (j.length != 0 && j[j.length - 1] >= k) j.pop();
              }
              (f[m] = this.$computeWrapSplits(j, i, d)),
                (m = this.getRowFoldEnd(m) + 1);
            }
          });
        var b = 1,
          c = 2,
        ...
        (this.$computeWrapSplits = function (a, b, c) {
          ...
          (this.$getStringScreenWidth = function (a, b, c) {
            if (b == 0) return [0, 0];
            b == null && (b = c + a.length * Math.max(this.getTabSize(), 2)),
              (c = c || 0);
            var d, e;
            ...
            while (h <= a) {
              ...
              (h += i),
                ...
                d > o &&
                  ...
                  (n = this.getNextFold(d)),
                  (o = n ? n.start.row : Infinity)),
                l && j.push({ docRow: d, screenRow: h });
            }
            n && n.start.row <= d
              ? (c = this.getFoldDisplayLine(n))
              : ((c = this.getLine(d)), (n = null));
            var p = [];
            this.$useWrapMode &&
              ((p = this.$wrapData[d]),
              p &&
                ...
                a > h &&
                  p.length &&
                  ((e = p[a - h - 1] || p[p.length - 1]),
                  (c = c.substring(e))))),
              (e += this.$getStringScreenWidth(c, b)[1]),
              h + p.length < a && (e = Number.MAX_VALUE),
              this.$useWrapMode
                ? e >= f && (e = f - 1)
                : (e = Math.min(e, c.length));
          ...
          (this.documentToScreenPosition = function (a, b) {
            ...
            var f = 0,
              ...
              h = null,
              i = null;
            (i = this.getFoldAt(a, b, 1)),
              i && ((a = i.start.row), (b = i.start.column));
            var j,
              k = 0,
              l = this.$rowCache;
            ...
            while (k < a) {
              ...
              (f += this.getRowLength(k)),
                (k = j),
                n && l.push({ docRow: k, screenRow: f });
            }
            var q = "";
            o && k >= p
              ? ((q = this.getFoldDisplayLine(o, a, b)), (h = o.start.row))
              : ((q = this.getLine(a).substring(0, b)), (h = a));
            if (this.$useWrapMode) {
              var r = e[h],
                s = 0;
          ...
          (this.getScreenLength = function () {
            ...
            if (!this.$useWrapMode) {
              ...
              var d = this.$foldData;
              for (var e = 0; e < d.length; e++)
                (c = d[e]), (a -= c.end.row - c.start.row);
            } else
              for (var f = 0; f < this.$wrapData.length; f++)
                (c = this.getFoldLine(f, b))
                  ? ((f = c.end.row), (a += 1))
                  : (a += this.$wrapData[f].length + 1);
            return a;
          });
      }.call(m.prototype),
        a("ace/edit_session/folding").Folding.call(m.prototype),
        (b.EditSession = m));
    }
  ),
  define(
        ...
        h = function (a) {
          ...
          this.selectionLead.on("change", function (a) {
            b._dispatchEvent("changeCursor"),
              ...
              !b.$preventUpdateDesiredColumnOnChange &&
                a.old.column != a.value.column &&
                b.$updateDesiredColumn();
          }),
        ...
        d.implement(this, f),
          ...
          (this.setSelectionAnchor = function (a, b) {
            this.selectionAnchor.setPosition(a, b),
              this.$isEmpty &&
                ((this.$isEmpty = !1), this._dispatchEvent("changeSelection"));
          }),
          (this.getSelectionAnchor = function () {
            return this.$isEmpty
              ? this.getSelectionLead()
              : this.selectionAnchor.getPosition();
          }),
          ...
          (this.$updateDesiredColumn = function () {
            ...
            this.$desiredColumn = this.session.documentToScreenColumn(
              a.row,
              a.column
            );
          }),
          ...
          (this.selectLine = function () {
            ...
            c ? ((a = c.start.row), (b = c.end.row)) : (b = a),
              this.setSelectionAnchor(a, 0),
              this.$moveSelection(function () {
          ...
          (this.moveCursorRight = function () {
            ...
            if ((b = this.session.getFoldAt(a.row, a.column, 1)))
              ...
              this.selectionLead.row < this.doc.getLength() - 1 &&
            ...
            if ((f = this.session.getFoldAt(a, b, 1)))
              ...
              if ((e = this.session.nonTokenRe.exec(d)))
                (b += this.session.nonTokenRe.lastIndex),
                  (this.session.nonTokenRe.lastIndex = 0);
              else if ((e = this.session.tokenRe.exec(d)))
          ...
          (this.moveCursorWordLeft = function () {
            ...
            if ((c = this.session.getFoldAt(a, b, -1)))
              ...
              if ((g = this.session.nonTokenRe.exec(f)))
                (b -= this.session.nonTokenRe.lastIndex),
                  (this.session.nonTokenRe.lastIndex = 0);
              else if ((g = this.session.tokenRe.exec(f)))
                (b -= this.session.tokenRe.lastIndex),
                  (this.session.tokenRe.lastIndex = 0);
              this.moveCursorTo(a, b);
            }
          ...
          (this.moveCursorTo = function (a, b, c) {
            ...
            d && ((a = d.start.row), (b = d.start.column)),
              (this.$preventUpdateDesiredColumnOnChange = !0),
              this.selectionLead.setPosition(a, b),
              (this.$preventUpdateDesiredColumnOnChange = !1),
          ...
          (this.highlightSelection = function (a) {
            ...
            if (!c.isEmpty() && !c.isMultiLine()) {
              ...
              var i = a.getCursorPosition(),
                j = { wrap: !0, wholeWord: !0, caseSensitive: !0, needle: h },
    ...
    var d = function (a) {
      ...
      for (var b in this.rules) {
        ...
        for (var h = 0; h < d.length; h++) {
          var i =
              new RegExp("(?:(" + d[h].regex + ")|(.))").exec("a").length - 2,
  ...
  define(
    "ace/mode/text_highlight_rules",
    ["require", "exports", "module", "pilot/lang"],
    function (a, b, c) {
      var d = a("pilot/lang"),
        e = function () {
          this.$rules = {
          ...
          this.$worker = function () {
            if (!!c.running) {
              ...
              while (c.currentLine < f) {
                (c.lines[c.currentLine] = c.$tokenizeRows(
                  c.currentLine,
                  c.currentLine
                )[0]),
                  c.currentLine++,
        ...
        d.implement(this, e),
          ...
          (this.$tokenizeRows = function (a, b) {
            ...
            var c = [],
              ...
              e = !1;
            a > 0 && this.lines[a - 1]
              ? ((d = this.lines[a - 1].state), (e = !0))
              : a == 0
              ? ((d = "start"), (e = !0))
              : this.lines.length > 0 &&
                (d = this.lines[this.lines.length - 1].state);
        ...
        (this.getFoldAt = function (a, b, c) {
          ...
          (this.getFoldStringAt = function (a, b, c, d) {
            ...
            for (var f = 0; f < d.folds.length; f++) {
              ...
              if (h == -1) {
                var i = this.getLine(g.start.row).substring(
                  e.end.column,
                  g.start.column
                );
                break;
            ...
            return c == -1
              ? i.substring(0, b - e.end.column)
              : c == 1
              ? i.substring(b - e.end.column)
              : i;
          }),
          ...
          (this.addFold = function (a, b) {
            ...
            d || (o = this.$addFoldLine(new e(this.$foldData, g))),
              this.$useWrapMode &&
                this.$updateWrapData(o.start.row, o.start.row),
              (this.$modified = !0),
              this._dispatchEvent("changeFold", { data: g });
            return g;
          }),
          ...
          (this.removeFold = function (a) {
            ...
            this.$useWrapMode && this.$updateWrapData(c, d),
              (this.$modified = !0),
              this._dispatchEvent("changeFold", { data: a });
          }),
  ...
  define(
    "ace/search",
    ["require", "exports", "module", "pilot/lang", "pilot/oop", "ace/range"],
    function (a, b, c) {
      var d = a("pilot/lang"),
        e = a("pilot/oop"),
        f = a("ace/range").Range,
                  ...
                  while (!g(k, l, j)) {
                    ...
                    j == d.row && (m = !0),
                      ...
                      b &&
                        (j == e
                          ? (l = f)
                          : j == h && (k = k.substring(0, c.end.column))),
        ...
        (this.showGutter = !0),
          ...
          (this.onResize = function (a) {
            ...
            if (a || c.height != d)
              (c.height = d),
                ...
                (c.scrollerHeight = this.scroller.clientHeight),
                this.scrollBar.setHeight(c.scrollerHeight),
                this.session &&
                  (this.scrollToY(this.getScrollTop()),
                  (b = b | this.CHANGE_FULL));
            var f = e.getInnerWidth(this.container);
            if (a || c.width != f) {
              c.width = f;
              var g = this.showGutter ? this.$gutter.offsetWidth : 0;
              (this.scroller.style.left = g + "px"),
                (c.scrollerWidth = Math.max(
                  0,
                  f - g - this.scrollBar.getWidth()
                )),
                (this.scroller.style.width = c.scrollerWidth + "px");
              if (
          ...
          (this.$computeLayerConfig = function () {
            ...
            this.scrollTop = Math.max(
              0,
              Math.min(this.scrollTop, h - this.$size.scrollerHeight)
            );
            ...
            o && (j = o.start.row),
              (l = a.documentToScreenRow(j, 0)),
              (m = a.getRowHeight(n, j)),
              (k = Math.min(a.screenToDocumentRow(k, 0), a.getLength() - 1)),
              (c = this.$size.scrollerHeight + a.getRowHeight(n, k) + m),
              (b = this.scrollTop - l * this.lineHeight),
              (this.layerConfig = {
                width: d,
          ...
          (this.scrollCursorIntoView = function () {
            if (this.$size.scrollerHeight !== 0) {
              var a = this.$cursorLayer.getPixelPosition(),
                ...
                c = a.top;
              this.scrollTop > c && this.scrollToY(c),
                this.scrollTop + this.$size.scrollerHeight <
                  c + this.lineHeight &&
                  this.scrollToY(
                    c + this.lineHeight - this.$size.scrollerHeight
                  );
              var d = this.scroller.scrollLeft;
              d > b && this.scrollToX(b),
                d + this.$size.scrollerWidth < b + this.characterWidth &&
                  (b > this.layerConfig.width
                    ? (this.$desiredScrollLeft = b + 2 * this.characterWidth)
                    : this.scrollToX(
                        Math.round(
                          b + this.characterWidth - this.$size.scrollerWidth
                        )
                      ));
            }
          }),
          ...
          (this.scrollToLine = function (a, b) {
            var c = { lineHeight: this.lineHeight },
              d = 0;
            for (var e = 1; e < a; e++)
              d += this.session.getRowHeight(c, e - 1);
          ...
          (this.screenToTextCoordinates = function (a, b) {
            var c = this.scroller.getBoundingClientRect(),
              ...
              f = Math.floor(
                (b + this.scrollTop - c.top - e.getPageScrollTop()) /
                  this.lineHeight
              );
          ...
          (this.showComposition = function (a) {
            this.$composition ||
              ((this.$composition = e.createElement("div")),
  ...
  define(
    "ace/layer/gutter",
    ["require", "exports", "module", "pilot/dom"],
    function (a, b, c) {
      var d = a("pilot/dom"),
        e = function (a) {
              ...
              if (a.hasOwnProperty(b)) {
                ...
                for (var e = 0; e < c.length; e++) {
                  ...
                  g == "error"
                    ...
                    : g == "warning" && d.className != "ace_error"
                    ? (d.className = "ace_warning")
                    : g == "info" && !d.className && (d.className = "ace_info");
                }
              }
          }),
          (this.update = function (a) {
            ...
            for (;;) {
              ...
              c.push(
                ...
                this.$decorations[e] || "",
                this.$breakpoints[e] ? " ace_breakpoint " : " ",
                i.className,
                "' title='",
                i.text.join("\n"),
                "' style='height:",
  ...
  define(
    "ace/layer/marker",
    ["require", "exports", "module", "ace/range", "pilot/dom"],
    function (a, b, c) {
      var d = a("ace/range").Range,
        e = a("pilot/dom"),
        f = function (a) {
        ...
        (this.$padding = 0),
              ...
              for (var c in this.markers) {
                ...
                if (d.renderer) {
                  ...
                  f.isMultiLine()
                    ...
                    : this.drawSingleLineMarker(b, f, d.clazz, a, null, d.type);
              }
          ...
          (this.drawMultiLineMarker = function (a, b, c, d, e) {
            ...
            a.push(
              ...
              (i = this.$getTop(b.end.row, d)),
              (h = Math.round(b.end.column * d.characterWidth)),
              a.push(
                "<div class='",
                c,
                "' style='",
        ...
        d.implement(this, h),
          ...
          (this.checkForSizeChanges = function () {
            ...
            a &&
              ...
              this._dispatchEvent("changeCharaterSize", { data: a }));
          }),
          ...
          (this.updateLines = function (a, b, c) {
            ...
            for (var k = d; k <= f; k++) {
              ...
              this.$renderLine(m, k, n[0].tokens, !0),
                (l = e.setInnerHtml(l, m.join(""))),
                (k = this.session.getRowFoldEnd(k));
            }
          }),
          ...
          (this.$renderLinesFragment = function (a, b, c) {
            ...
            for (;;) {
              ...
              k.length == 1 && this.$renderLine(j, f, k[0].tokens, !1),
                (i.innerHTML = j.join(""));
              var l = i.childNodes;
          ...
          (this.$renderLineCore = function (a, b, c, d, e) {
            var f = 0,
              g = 0,
              h,
              i = this.config.characterWidth,
              j = 0,
              k = this;
            !d || d.length == 0 ? (h = Number.MAX_VALUE) : (h = d[0]),
              e ||
                a.push(
            ...
            for (var l = 0; l < c.length; l++) {
              var m = c[l],
                n = m.value;
              if (f + n.length < h)
                (j = k.$renderToken(a, j, m, n)), (f += n.length);
              else {
                while (f + n.length >= h)
                  (j = k.$renderToken(a, j, m, n.substring(0, h - f))),
                    (n = n.substring(h - f)),
                    (f = h),
                    e ||
                      a.push(
                ...
                n.length != 0 &&
                  ((f += n.length), (j = k.$renderToken(a, j, m, n)));
              }
            }
            this.showInvisibles &&
          ...
          (this.$renderFoldLine = function (a, b, c, d) {
            function h(a, b, c) {
              ...
              if (e != b) {
                ...
                f.length > c - b && (f = f.substring(0, c - b)),
                  g.push({ type: a[d].type, value: f }),
                  (e = b + f.length),
                  (d += 1);
              }
              while (e < c) {
                var f = a[d].value;
                f.length + e > c && (f = f.substring(0, c - e)),
                  g.push({ type: a[d].type, value: f }),
                  (e += f.length),
                  (d += 1);
              }
            ...
            f.walk(
              function (a, b, d, e, f) {
                a
                  ? g.push({ type: "fold", value: a })
                  : (f && (c = this.session.getTokens(b, b)[0].tokens),
                    c.length != 0 && h(c, e, d));
              }.bind(this),
              f.end.row,
              this.session.getLine(f.end.row).length
            );
            var i = this.session.$useWrapMode
              ? this.session.$wrapData[b]
              : null;
    ...
    function (a, b, c) {
      ...
      (function () {
        (this.$padding = 0),
          ...
          (this.hideCursor = function () {
            (this.isVisible = !1),
              d.addCssClass(this.cursor, "ace_hidden"),
              clearInterval(this.blinkId);
          }),
          (this.showCursor = function () {
            (this.isVisible = !0),
              d.removeCssClass(this.cursor, "ace_hidden"),
          ...
          (this.getPixelPosition = function (a) {
            ...
            var b = this.session.selection.getCursor(),
              ...
              e =
                (c.row - (a ? this.config.firstRowScreen : 0)) *
                this.config.lineHeight;
            return { left: d, top: e };
          }),
          (this.update = function (a) {
            ...
            b != this.overwrite &&
              ((this.overwrite = b),
              b
                ? d.addCssClass(this.cursor, "ace_overwrite")
                : d.removeCssClass(this.cursor, "ace_overwrite")),
              this.restartTimer();
          }),
          (this.destroy = function () {
            clearInterval(this.blinkId);
  ...
  define(
    "ace/renderloop",
    ["require", "exports", "module", "pilot/event"],
    function (a, b, c) {
      var d = a("pilot/event"),
        e = function (a) {
              ...
              (this.setTimeoutZero = function (a) {
                if (!this.attached) {
                  ...
                  d.addListener(window, "message", function (a) {
                    b.callback &&
                      a.data == b.messageName &&
                      (d.stopPropagation(a), b.callback());
                  }),
                    (this.attached = !0);
                }
  ...
  define(
    "pilot/environment",
    ["require", "exports", "module", "pilot/settings"],
    function (a, b, c) {
      function e() {
        return { settings: d };
      }
  ...
  define(
    "text/ace-0.2.0/textarea/style.css",
    [],
