(function () {
  ...
  if (e.require && e.define) require.packaged = !0;
  else {
    ...
    e.define && (t.original = e.define), (e.define = t);
    var i = function (e, t) {
      if ("[object Array]" === Object.prototype.toString.call(e)) {
        ...
        if ("string" == typeof e) {
          var c = n(e);
          return !c && i.original
            ? i.original.apply(window, arguments)
            : (t && t(), c);
        }
        if (i.original) return i.original.apply(window, arguments);
      }
    };
    e.require && (i.original = e.require),
      (e.require = i),
      (require.packaged = !0);
    var n = function (e) {
      var t = define.modules[e];
      if (null == t) return console.error("Missing module: " + e), null;
      if ("function" == typeof t) {
        var i = {};
        return t(require, i, { id: e, uri: "" }), (define.modules[e] = i), i;
      }
      return t;
    };
  }
})(),
  define("pilot/fixoldbrowsers", ["require", "exports", "module"], function () {
        ...
        var i = e.call(arguments),
          n = function r() {
            if (this instanceof r) {
              ...
              return t.apply(n, i.concat(e.call(arguments))), n;
            }
            return t.call.apply(t, i.concat(e.call(arguments)));
          };
        return (
          (n.length =
            "function" == typeof t ? Math.max(t.length - i.length, 0) : 0),
          n
        );
      };
    }
    var t,
      ...
      c = s.bind(a.hasOwnProperty);
    if (
      ((o = c(a, "__defineGetter__")) &&
        ((t = s.bind(a.__defineGetter__)),
        (i = s.bind(a.__defineSetter__)),
        (n = s.bind(a.__lookupGetter__)),
        (r = s.bind(a.__lookupSetter__))),
      Array.isArray ||
      ...
      Array.prototype.forEach ||
        (Array.prototype.forEach = function (e, t) {
          for (var i = +this.length, n = 0; i > n; n++)
      ...
      Array.prototype.map ||
        (Array.prototype.map = function (e) {
          ...
          for (var i = Array(t), n = arguments[1], r = 0; t > r; r++)
            r in this && (i[r] = e.call(n, this[r], r, this));
          return i;
        }),
      Array.prototype.filter ||
        (Array.prototype.filter = function (e) {
          for (var t = [], i = arguments[1], n = 0; this.length > n; n++)
            e.call(i, this[n]) && t.push(this[n]);
          return t;
        }),
      Array.prototype.every ||
        (Array.prototype.every = function (e) {
          for (var t = arguments[1], i = 0; this.length > i; i++)
            if (!e.call(t, this[i])) return !1;
          return !0;
        }),
      Array.prototype.some ||
        (Array.prototype.some = function (e) {
          for (var t = arguments[1], i = 0; this.length > i; i++)
            if (e.call(t, this[i])) return !0;
          return !1;
        }),
      ...
      Array.prototype.lastIndexOf ||
        (Array.prototype.lastIndexOf = function (e) {
          ...
          if (!t) return -1;
          var i = arguments[1] || t;
          for (0 > i && (i += t), i = Math.min(i, t - 1); i >= 0; i--)
            if (c(this, i) && e === this[i]) return i;
          return -1;
        }),
      ...
      var l = "Object.getOwnPropertyDescriptor called on a non-object: ";
      Object.getOwnPropertyDescriptor = function (e, t) {
        if (("object" != typeof e && "function" != typeof e) || null === e)
          throw new TypeError(l + e);
        if (!c(e, t)) return void 0;
        var i, s, h;
        if (((i = { enumerable: !0, configurable: !0 }), o)) {
          var d = e.__proto__;
          e.__proto__ = a;
          var s = n(e, t),
            h = r(e, t);
          if (((e.__proto__ = d), s || h))
            return (
              s && (descriptor.get = s), h && (descriptor.set = h), descriptor
            );
        }
        return (descriptor.value = e[t]), descriptor;
      };
    }
    if (
      ...
      Object.create ||
        (Object.create = function (e, t) {
          ...
          return t !== void 0 && Object.defineProperties(i, t), i;
        }),
      !Object.defineProperty)
    ) {
      var h = "Property description must be an object: ",
        d = "Object.defineProperty called on non-object: ",
        u = "getters & setters can not be defined on this javascript engine";
      Object.defineProperty = function (e, s, l) {
        if ("object" != typeof e && "function" != typeof e)
          throw new TypeError(d + e);
        if ("object" != typeof e || null === e) throw new TypeError(h + l);
        if (c(l, "value"))
          o && (n(e, s) || r(e, s))
            ? (e.__proto__,
              (e.__proto__ = a),
          ...
          if (!o) throw new TypeError(u);
          c(l, "get") && t(e, s, l.get), c(l, "set") && i(e, s, l.set);
        }
        return e;
      };
    }
    Object.defineProperties ||
      (Object.defineProperties = function (e, t) {
        for (var i in t) c(t, i) && Object.defineProperty(e, i, t[i]);
        return e;
      }),
      Object.seal ||
    ...
    if (
      ...
      var p = !0,
        ...
        m = f.length;
      for (var F in { toString: null }) p = !1;
      Object.keys = function (e) {
        if (("object" != typeof e && "function" != typeof e) || null === e)
          throw new TypeError("Object.keys called on a non-object");
        var t = [];
        for (var i in e) c(e, i) && t.push(i);
        if (p)
          for (var n = 0, r = m; r > n; n++) {
            var o = f[n];
            c(e, o) && t.push(o);
          }
        return t;
    ...
    if (
        ...
        (Date = (function (e) {
          ...
          return (
            ...
            (t.parse = function (t) {
              ...
              if (n) {
                n.shift();
                for (var r = void 0 === n[0], o = 0; 10 > o; o++)
                  7 !== o &&
                    ((n[o] = +(n[o] || (3 > o ? 1 : 0))), 1 === o && n[o]--);
                if (r) return 1e3 * (60 * (60 * n[3] + n[4]) + n[5]) + n[6];
                var s = 1e3 * 60 * (60 * n[8] + n[9]);
                return (
                  "-" === n[6] && (s = -s), e.UTC.apply(this, n.slice(0, 7)) + s
                );
              }
      ...
      String.prototype.trim = function () {
        return (this + "").replace(C, "").replace(A, "");
      };
    }
  }),
  define(
    ...
    function (e, t) {
      e("pilot/index"), e("pilot/fixoldbrowsers");
      var i = e("pilot/plugin_manager").catalog;
      i.registerPlugins(["pilot/index"]);
      var n = e("pilot/dom"),
        r = e("pilot/event"),
        o = e("ace/editor").Editor,
        s = e("ace/edit_session").EditSession,
        a = e("ace/undomanager").UndoManager,
        c = e("ace/virtual_renderer").VirtualRenderer;
      t.edit = function (t) {
        "string" == typeof t && (t = document.getElementById(t));
        var l = new s(n.getInnerText(t));
        l.setUndoManager(new a()), (t.innerHTML = "");
        var h = new o(new c(t, e("ace/theme/textmate")));
        h.setSession(l);
        var d = e("pilot/environment").create();
        return (
          i.startupPlugins({ env: d }).then(function () {
            (d.document = l),
              (d.editor = h),
              h.resize(),
              r.addListener(window, "resize", function () {
                h.resize();
              }),
              (t.env = d);
          }),
  ...
  define(
    ...
    function (e, t) {
      (t.startup = function (t, i) {
        e("pilot/fixoldbrowsers"),
          e("pilot/types/basic").startup(t, i),
          e("pilot/types/command").startup(t, i),
          e("pilot/types/settings").startup(t, i),
          e("pilot/commands/settings").startup(t, i),
          e("pilot/commands/basic").startup(t, i),
          e("pilot/settings/canon").startup(t, i),
          e("pilot/canon").startup(t, i);
      }),
        (t.shutdown = function (t, i) {
          e("pilot/types/basic").shutdown(t, i),
            e("pilot/types/command").shutdown(t, i),
            e("pilot/types/settings").shutdown(t, i),
            e("pilot/commands/settings").shutdown(t, i),
            e("pilot/commands/basic").shutdown(t, i),
            e("pilot/settings/canon").shutdown(t, i),
            e("pilot/canon").shutdown(t, i);
        });
    }
  ),
  define(
    ...
    function (e, t) {
      function i(e) {
        if (e instanceof s) this.subtype = e;
        else {
          if ("string" != typeof e) throw Error("Can' handle array subtype");
          if (((this.subtype = o.getType(e)), null == this.subtype))
            throw Error("Unknown array subtype: " + e);
        }
      }
      function n(e) {
        if ("function" != typeof e.defer)
          throw Error(
      ...
      function r(e) {
        if (!Array.isArray(e.data) && "function" != typeof e.data)
          throw Error(
      ...
      (l.stringify = function (e) {
        ...
        (l.parse = function (e) {
          if ("string" != typeof e)
            throw Error("non-string passed to text.parse()");
          return new a(e);
        }),
        (l.name = "text");
      var h = new s();
      (h.stringify = function (e) {
        ...
        (h.parse = function (e) {
          if ("string" != typeof e)
            throw Error("non-string passed to number.parse()");
          if (0 === e.replace(/\s/g, "").length)
            return new a(null, c.INCOMPLETE, "");
          var t = new a(parseInt(e, 10));
          return (
            isNaN(t.value) &&
              ((t.status = c.INVALID),
              (t.message = "Can't convert \"" + e + '" to a number.')),
            t
          );
        }),
        (h.decrement = function (e) {
          return e - 1;
        }),
        ...
        (r.prototype.parse = function (e) {
          if ("string" != typeof e) throw Error("non-string passed to parse()");
          if (!this.data)
            throw Error("Missing data on selection type extension.");
          var t,
            i = "function" == typeof this.data ? this.data() : this.data,
            n = !1,
            r = [];
          if (
            (i.forEach(function (i) {
              e == i
                ? ((t = this.fromString(i)), (n = !0))
                : 0 === i.indexOf(e) && r.push(this.fromString(i));
            }, this),
            n)
          )
            return new a(t);
          if ((this.noMatch && this.noMatch(), r.length > 0)) {
            var o =
              "Possibilities" + (0 === e.length ? "" : " for '" + e + "'");
            return new a(null, c.INCOMPLETE, o, r);
          }
          var o = "Can't use '" + e + "'.";
          return new a(null, c.INVALID, o, r);
        }),
        (r.prototype.fromString = function (e) {
          return e;
        }),
        (r.prototype.decrement = function (e) {
          var t,
            i = "function" == typeof this.data ? this.data() : this.data;
          if (null == e) t = i.length - 1;
          else {
            var n = this.stringify(e),
              t = i.indexOf(n);
            t = 0 === t ? i.length - 1 : t - 1;
          }
          return this.fromString(i[t]);
        }),
        (r.prototype.increment = function (e) {
          var t,
            i = "function" == typeof this.data ? this.data() : this.data;
          if (null == e) t = 0;
          else {
            var n = this.stringify(e),
              t = i.indexOf(n);
            t = t === i.length - 1 ? 0 : t + 1;
          }
          return this.fromString(i[t]);
        }),
        (r.prototype.name = "selection"),
        (t.SelectionType = r);
      var d = new r({
        name: "bool",
        data: ["true", "false"],
      ...
      (n.prototype = new s()),
        (n.prototype.stringify = function (e) {
          return this.defer().stringify(e);
        }),
        (n.prototype.parse = function (e) {
          return this.defer().parse(e);
        }),
        (n.prototype.decrement = function (e) {
          var t = this.defer();
          return t.decrement ? t.decrement(e) : void 0;
        }),
        (n.prototype.increment = function (e) {
          var t = this.defer();
          return t.increment ? t.increment(e) : void 0;
        }),
        (n.prototype.name = "deferred"),
        (t.DeferredType = n),
        (i.prototype = new s()),
  ...
  define("pilot/types", ["require", "exports", "module"], function (e, t) {
    function i(e, t) {
      if ("[]" === e.substr(-2)) {
        var i = e.slice(0, -2);
        return new s.array(i);
      }
      var n = s[e];
      return "function" == typeof n && (n = new n(t)), n;
    }
    function n() {}
    function r(e, t, i, n) {
      (this.value = e),
        (this.status = t || o.VALID),
        (this.message = i),
        (this.predictions = n || []);
    }
    var o = {
      ...
      combine: function (e) {
        for (var t = o.VALID, i = 0; e.length > i; i++)
          e[i].valueOf() > t.valueOf() && (t = e[i]);
        return t;
      },
    };
    (t.Status = o),
      ...
      (t.Type = n);
    var s = {};
    (t.registerType = function (e) {
      if ("object" == typeof e) {
        if (!(e instanceof n)) throw Error("Can't registerType using: " + e);
        if (!e.name) throw Error("All registered types must have a name");
        s[e.name] = e;
      } else {
        if ("function" != typeof e) throw Error("Unknown type: " + e);
        if (!e.prototype.name)
          throw Error("All registered types must have a name");
        s[e.prototype.name] = e;
      }
    }),
      (t.registerTypes = function (e) {
        Object.keys(e).forEach(function (i) {
          var n = e[i];
          (n.name = i), t.registerType(n);
        });
      }),
      (t.deregisterType = function (e) {
        delete s[e.name];
      }),
      (t.getType = function (e) {
        if ("string" == typeof e) return i(e);
        if ("object" == typeof e) {
          if (!e.name) throw Error("Missing 'name' member to typeSpec");
          return i(e.name, e);
        }
        throw Error("Can't extract type from " + e);
      });
  }),
  define(
    "pilot/types/command",
    ...
    function (e, t) {
      var i = e("pilot/canon"),
        n = e("pilot/types/basic").SelectionType,
        r = e("pilot/types"),
        o = new n({
          name: "command",
          data: function () {
            return i.getCommandNames();
          },
          stringify: function (e) {
            return e.name;
          },
          fromString: function (e) {
            return i.getCommand(e);
          },
        });
      (t.startup = function () {
        r.registerType(o);
  ...
  define(
    ...
    function (e, t) {
      ...
      function n(e, t, n, o, s) {
        function a() {
          e.exec(t, c.args, c), !c.isAsync && !c.isDone && c.done();
        }
        if (("string" == typeof e && (e = D[e]), !e)) return !1;
        var c = new i({ sender: n, command: e, args: o || {}, typed: s });
        if (c.getStatus() == x.INVALID)
          return (
            f.error("Canon.exec: Invalid parameter(s) passed to " + e.name), !1
          );
        if (c.getStatus() == x.INCOMPLETE) {
          var l,
            h = t[n];
          return (
            (h && h.getArgsProvider && (l = h.getArgsProvider())) || (l = r),
            l(c, function () {
              c.getStatus() == x.VALID && a();
            }),
            !0
          );
        }
      ...
      function r(e, t) {
        for (var i = e.args, n = e.command.params, r = 0; n.length > r; r++) {
          var o = n[r];
          if (e.getParamStatus(o) != x.VALID || null === o.defaultValue) {
            var s = o.description;
            null === o.defaultValue && (s += " (optional)");
            var a = prompt(s, o.defaultValue || "");
      ...
      function a(e) {
        ...
        (e = D[t]), delete D[t], w.arrayRemove(k, t);
        var i = B;
        for (var n in i)
          for (var r in i[n])
            for (var o in i[n][r]) i[n][r][o] == e && delete i[n][r][o];
        var s = S;
        for (var n in s)
          for (var r in s[n])
            s[n][r].forEach(function (t, i) {
              t.command == e && s[n][r].splice(i, 1);
            });
      }
      function c(e, t) {
        var i = t.type;
        if (((t.type = v.getType(i)), null == t.type))
          throw Error(
            "In " +
              e +
              "/" +
      ...
      function l(e) {
        if (!e.name) throw Error("All registered commands must have a name");
        if ((null == e.params && (e.params = []), !Array.isArray(e.params)))
          throw Error("command.params must be an array in " + e.name);
        e.params.forEach(function (t) {
          if (!t.name)
            throw Error("In " + e.name + ": all params must have a name");
          c(e.name, t);
        }, this),
          (D[e.name] = e),
          e.bindKey && u(e),
      ...
      function d(e, t, i, n) {
        b.isNumber(n) && (n = C.keyCodeToString(n));
        for (var r = (S[i] || {})[n] || [], o = 0; r.length > o; o++)
          if (r[o].sender(e, t, i, n)) return r[o].command;
        var s = B[t];
        return s && s[i] && s[i][n];
      }
      function u(e) {
        var t = e.bindKey,
          ...
          n = B,
          r = S;
        if (!t.sender) throw Error("All key bindings must have a sender");
        if (!t.mac && null !== t.mac)
          throw Error("All key bindings must have a mac key binding");
        if (!t.win && null !== t.win)
          throw Error("All key bindings must have a windows key binding");
        if (t[L])
          if ("string" == typeof t.sender) {
            var o = p(t.sender, "\\|", null, !0);
            ...
            if (!b.isFunction(t.sender))
              throw Error(
                "Key binding must have a sender that is a string or function"
              );
            var s = { command: e, sender: t.sender };
            (keyData = g(i)),
              r[keyData.hashId] || (r[keyData.hashId] = {}),
              r[keyData.hashId][keyData.key]
                ? r[keyData.hashId][keyData.key].push(s)
                : (r[keyData.hashId][keyData.key] = [s]);
          }
      }
      function g(e, t, i) {
        for (
          var n, r = 0, o = p(e, "\\-", null, !0), s = 0, a = o.length;
          a > s;
          ++s
        )
          C.KEY_MODS[o[s]] ? (r |= C.KEY_MODS[o[s]]) : (n = o[s] || "-");
        return null == i
          ? { key: n, hashId: r }
          : (((i[r] || (i[r] = {}))[n] = t), void 0);
      }
      function p(e, t, i, n) {
        return ((n && e.toLowerCase()) || e)
          .replace(/(?:^\s+|\n|\s+$)/g, "")
          .split(RegExp("[\\s ]*" + t + "[\\s ]*", "g"), i || 999);
      }
      var f = e("pilot/console"),
        m = (e("pilot/stacktrace").Trace, e("pilot/oop")),
        F = e("pilot/useragent"),
        C = e("pilot/keys"),
        A = e("pilot/event_emitter").EventEmitter,
        b = e("pilot/typecheck"),
        E = e("pilot/catalog"),
        x = e("pilot/types").Status,
        v = e("pilot/types"),
        w = e("pilot/lang"),
        y = {
          name: "command",
      ...
      (t.startup = function () {
        E.addExtensionSpec(y);
      }),
        (t.shutdown = function () {
          E.removeExtensionSpec(y);
        });
      var D = {},
        B = {},
        S = {},
      ...
      var _ = [],
        $ = 100;
      m.implement(i.prototype, A),
        (i.prototype.getParamStatus = function (e) {
          var t = this.args || {};
          if (e.name in t) {
            if (null == t[e.name])
              return null === e.defaultValue ? x.VALID : x.INCOMPLETE;
            var i,
              n = "" + t[e.name];
            try {
              i = e.type.parse(n);
            ...
            if (i.status != x.VALID) return i.status;
          } else if (void 0 === e.defaultValue) return x.INCOMPLETE;
          return x.VALID;
        }),
        (i.prototype.getParamNameStatus = function (e) {
          for (var t = this.command.params || [], i = 0; t.length > i; i++)
            if (t[i].name == e) return this.getParamStatus(t[i]);
          throw (
            "Parameter '" +
            e +
        ...
        (i.prototype.getStatus = function () {
          var e = (this.args || {}, this.command.params);
          if (!e || 0 == e.length) return x.VALID;
          for (var t = [], i = 0; e.length > i; i++)
            t.push(this.getParamStatus(e[i]));
          return x.combine(t);
        }),
        (i.prototype._beginOutput = function () {
          for (
            this._begunOutput = !0, this.outputs = [], _.push(this);
            _.length > $;

          )
            _.shiftObject();
          t._dispatchEvent("output", { requests: _, request: this });
        }),
        (i.prototype.doneWithError = function (e) {
          (this.error = !0), this.done(e);
        }),
        (i.prototype.async = function () {
          (this.isAsync = !0), this._begunOutput || this._beginOutput();
        }),
        (i.prototype.output = function (e) {
          return (
            this._begunOutput || this._beginOutput(),
            "string" != typeof e && !(e instanceof Node) && (e = "" + e),
            this.outputs.push(e),
            (this.isDone = !0),
  ...
  define("pilot/console", ["require", "exports", "module"], function (e, t) {
    var i = function () {},
      n = [
        "assert",
        "count",
      ...
      ? n.forEach(function (e) {
          t[e] = function () {
            var t = Array.prototype.slice.call(arguments),
              i = { op: "log", method: e, args: t };
            postMessage(JSON.stringify(i));
          };
        })
      : n.forEach(function (e) {
          t[e] =
            window.console && window.console[e]
              ? Function.prototype.bind.call(window.console[e], window.console)
              : i;
        });
  }),
  define(
    ...
    function (e, t) {
      ...
      var r = e("pilot/useragent"),
        o = e("pilot/console"),
        s = (function () {
          return r.isGecko ? "firefox" : r.isOpera ? "opera" : "other";
        })(),
        a = {
          chrome: function (e) {
            var t = e.stack;
          ...
          opera: function (e) {
            ...
            for (t = 4, i = 0, n = r.length; n > t; t += 2)
              s.test(r[t]) &&
                (r[i++] =
                  (RegExp.$3
                  ...
                  " -- " +
                  r[t + 1].replace(/^\s+/, ""));
            return r.splice(i, r.length - i), r;
          },
          other: function (e) {
            for (
              var t,
              ...
              e &&
              c > s.length &&
              ((t = o.test("" + e) ? RegExp.$1 || r : r),
              (i = Array.prototype.slice.call(e.arguments)),
              (s[a++] = t + "(" + n(i) + ")"),
              e !== e.caller || !window.opera);
      ...
      i.prototype = {
          ...
          for (var t = 0; e.length > t; ++t) {
            ...
            if (r) {
              var o = r[1],
                s = r[4];
              if (o && s) {
                var a = this.guessFunctionName(o, s);
                e[t] = n.replace("{anonymous}", a);
              }
            }
          }
          return e;
        ...
        guessFunctionName: function (e, t) {
          try {
            ...
            return (
              "getSource failed with url: " + e + ", exception: " + ("" + i)
            );
          }
        },
        guessFunctionNameFromLines: function (e, t) {
          for (
            ...
            if (((r = t[e - s] + r), void 0 !== r)) {
              var a = n.exec(r);
              if (a) return a[1];
              if (((a = i.exec(r)), a && a[1])) return a[1];
            }
          return "(?)";
        },
      };
      var c = new i(),
        l = [/http:\/\/localhost:4020\/sproutcore.js:/];
      (t.ignoreFramesMatching = function (e) {
        l.push(e);
      }),
        (t.Trace = function (e, t) {
          (this._ex = e),
            (this._stack = a[s](e)),
            t && (this._stack = c.guessFunctions(this._stack));
        }),
        (t.Trace.prototype.log = function (e) {
          0 >= e && (e = 999999999);
          for (var t = 0, i = 0; this._stack.length > i && e > t; i++) {
            var n = this._stack[i],
              r = !0;
  ...
  define("pilot/useragent", ["require", "exports", "module"], function (e, t) {
    ...
    navigator.appVersion,
      ...
      (t.isGecko = t.isMozilla =
        window.controllers && "Gecko" === window.navigator.product),
      (t.isOldGecko = t.isGecko && /rv\:1/.test(navigator.userAgent)),
      (t.isOpera =
        window.opera &&
  ...
  define("pilot/oop", ["require", "exports", "module"], function (e, t) {
    (t.inherits = (function () {
      var e = function () {};
      return function (t, i) {
      ...
      var n = e("pilot/oop"),
        r = (function () {
          ...
          for (i in e.FUNCTION_KEYS) {
            var t = e.FUNCTION_KEYS[i].toUpperCase();
            e[t] = parseInt(i, 10);
          }
          return (
      ...
      (i._emit = i._dispatchEvent =
        function (e, t) {
          ...
          if (i && i.length) {
            var t = t || {};
            t.type = e;
            for (var n = 0; i.length > n; n++) i[n](t);
          }
        }),
        (i.on = i.addEventListener =
          function (e, t) {
            this._eventRegistry = this._eventRegistry || {};
            var i = this._eventRegistry[e];
            if (!i) var i = (this._eventRegistry[e] = []);
            -1 == i.indexOf(t) && i.push(t);
          }),
        (i.removeListener = i.removeEventListener =
          function (e, t) {
            this._eventRegistry = this._eventRegistry || {};
            var i = this._eventRegistry[e];
            if (i) {
  ...
  define("pilot/typecheck", ["require", "exports", "module"], function (e, t) {
    var i = Object.prototype.toString;
    (t.isString = function (e) {
      return e && "[object String]" === i.call(e);
    }),
      (t.isBoolean = function (e) {
        return e && "[object Boolean]" === i.call(e);
      }),
      (t.isNumber = function (e) {
        return e && "[object Number]" === i.call(e) && isFinite(e);
      }),
      ...
      (t.isFunction = function (e) {
        return e && "[object Function]" === i.call(e);
      });
  }),
  define("pilot/catalog", ["require", "exports", "module"], function (e, t) {
    var i = {};
    (t.addExtensionSpec = function (e) {
      i[e.name] = e;
    }),
      (t.removeExtensionSpec = function (e) {
        "string" == typeof e ? delete i[e] : delete i[e.name];
      }),
      (t.getExtensionSpec = function (e) {
        return i[e];
      }),
      (t.getExtensionSpecs = function () {
        return Object.keys(i);
      });
  }),
  define("pilot/lang", ["require", "exports", "module"], function (e, t) {
    ...
    (t.stringTrimLeft = function (e) {
      ...
      (t.arrayToMap = function (e) {
        for (var t = {}, i = 0; e.length > i; i++) t[e[i]] = 1;
        return t;
      }),
      (t.arrayRemove = function (e, t) {
        for (var i = 0; e.length >= i; i++) t === e[i] && e.splice(i, 1);
      }),
  ...
  define(
    ...
    function (e, t) {
      var i,
        n,
        r = e("pilot/types/basic").SelectionType,
        o = e("pilot/types/basic").DeferredType,
        s = e("pilot/types"),
        a = e("pilot/settings").settings,
        c = new r({
          name: "setting",
          data: function () {
            return n.settings.getSettingNames();
          },
          stringify: function (e) {
            return (i = e), e.name;
          },
          fromString: function (e) {
            return (i = a.getSetting(e));
          },
          noMatch: function () {
            i = null;
          },
        ...
        l = new o({
          name: "settingValue",
          defer: function () {
            return i ? i.type : s.getType("text");
          },
          getDefault: function () {
            var e = this.parse("");
            if (i) {
              var t = i.get();
              if (0 === e.predictions.length) e.predictions.push(t);
              else {
                for (var n = !1; ; ) {
                  var r = e.predictions.indexOf(t);
                  if (-1 === r) break;
                  e.predictions.splice(r, 1), (n = !0);
                }
                n && e.predictions.push(t);
              }
            }
            return e;
          },
      ...
      (t.startup = function (e) {
        (n = e.env), s.registerType(c), s.registerType(l);
      }),
        (t.shutdown = function () {
          s.unregisterType(c), s.unregisterType(l);
        });
    }
  ),
  define(
    ...
    function (e, t) {
      ...
      function r(e, t) {
        ...
        if (!this.name)
          throw Error("Setting.name == undefined. Ignoring.", this);
        if (void 0 === !this.defaultValue)
          throw Error("Setting.defaultValue == undefined", this);
        this.onChange && this.on("change", this.onChange.bind(this)),
          this.set(this.defaultValue);
      }
      var o = e("pilot/console"),
        s = e("pilot/oop"),
        a = e("pilot/types"),
        c = e("pilot/event_emitter").EventEmitter,
        l = e("pilot/catalog"),
        h = {
          name: "setting",
          description:
      ...
      (t.startup = function () {
        l.addExtensionSpec(h);
      }),
        (t.shutdown = function () {
          l.removeExtensionSpec(h);
        }),
        (r.prototype = {
          get: function () {
            return this.value;
          ...
          set: function (e) {
            this.value !== e &&
              ...
              this._dispatchEvent("change", { setting: this, value: e }));
          },
          resetValue: function () {
            this.set(this.defaultValue);
          },
        ...
        (n.prototype = {
          addSetting: function (e) {
            var t = new r(e, this);
            (this._settings[t.name] = t),
              this._settingNames.push(t.name),
              this._settingNames.sort();
          },
          addSettings: function (e) {
            Object.keys(e).forEach(function (t) {
              var i = e[t];
              "name" in i || (i.name = t), this.addSetting(i);
            }, this);
          },
          removeSetting: function (e) {
            ...
            (e = this._settings[t]),
              ...
              util.arrayRemove(this._settingNames, t),
              settings.removeAllListeners("change");
          },
          removeSettings: function (e) {
            Object.keys(e).forEach(function (t) {
              var i = e[t];
              "name" in i || (i.name = t), this.removeSettings(i);
            }, this);
          },
          ...
          setPersister: function (e) {
            (this._persister = e), e && e.loadInitialValues(this);
          },
          resetAll: function () {
            this.getSettingNames().forEach(function (e) {
              this.resetValue(e);
            }, this);
          },
          _list: function () {
            var e = [];
            return (
              this.getSettingNames().forEach(function (t) {
                e.push({ key: t, value: this.getSetting(t).get() });
              }, this),
              e
            );
          },
          ...
          _loadFromObject: function (e) {
            for (var t in e)
              if (e.hasOwnProperty(t)) {
                var i = this._settings[t];
                if (i) {
                  var n = i.type.parse(e[t]);
                  this.set(t, n);
                } else this.set(t, e[t]);
              }
          },
          _saveToObject: function () {
            return this.getSettingNames().map(
              function (e) {
                return this._settings[e].type.stringify(this.get(e));
              }.bind(this)
            );
          },
          _getDefaultValues: function () {
            return this.getSettingNames().map(
              function (e) {
                return this._settings[e].spec.defaultValue;
              }.bind(this)
            );
          },
        }),
        (t.settings = new n()),
        (i.prototype = {
          loadInitialValues: function (e) {
            e._loadDefaultValues();
            var t = cookie.get("settings");
            e._loadFromObject(JSON.parse(t));
          },
          persistValue: function (e) {
            try {
              var t = JSON.stringify(e._saveToObject());
              cookie.set("settings", t);
            } catch (i) {
              return o.error("Unable to JSONify the settings! " + i), void 0;
            }
          },
        }),
        (t.CookiePersister = i);
      ...
      var i = {
          ...
          exec: function (e, t, i) {
            ...
            if (t.setting)
              ...
              var r = e.settings.getSettingNames();
              (n = ""),
                r.sort(function (e, t) {
                  return e.localeCompare(t);
                }),
                r.forEach(function (t) {
                  var i = e.settings.getSetting(t),
                    r =
        ...
        n = {
          ...
          exec: function (e, t, i) {
            var n = e.settings.get(t.setting);
            n
              ? (n.reset(),
                i.done(
                  "Reset " +
                    n.name +
                    " to default: " +
                    e.settings.get(t.setting)
                ))
              : i.doneWithError(
                  "No setting with the name <strong>" + t.setting + "</strong>."
                );
          },
        },
        r = e("pilot/canon");
      (t.startup = function () {
        r.addCommand(i), r.addCommand(n);
      }),
        (t.shutdown = function () {
          r.removeCommand(i), r.removeCommand(n);
        });
    }
  ),
  define(
    ...
    function (require, exports, module) {
      var checks = require("pilot/typecheck"),
        ...
        helpCommandSpec = {
          ...
          exec: function (e, t, i) {
            var n = [],
              r = canon.getCommand(t.search);
            if (r && r.exec)
              n.push(
                r.description ? r.description : "No description for " + t.search
              );
            else {
              var o = !1;
              r
                ? (n.push("<h2>Sub-Commands of " + r.name + "</h2>"),
                  n.push("<p>" + r.description + "</p>"))
                : t.search
                ? ("hidden" == t.search && ((t.search = ""), (o = !0)),
                  n.push("<h2>Commands starting with '" + t.search + "':</h2>"))
                : n.push("<h2>Available Commands:</h2>");
              var s = canon.getCommandNames();
              s.sort(), n.push("<table>");
              for (var a = 0; s.length > a; a++)
                (r = canon.getCommand(s[a])),
                  (o || !r.hidden) &&
                    void 0 !== r.description &&
                    ((t.search && 0 !== r.name.indexOf(t.search)) ||
                      ((t.search || -1 == r.name.indexOf(" ")) &&
                        ((r && r.name == t.search) ||
                          (n.push("<tr>"),
                          n.push('<th class="right">' + r.name + "</th>"),
                          n.push("<td>" + r.description + "</td>"),
                          n.push("</tr>")))));
              n.push("</table>");
            }
            i.done(n.join(""));
            ...
            if (checks.isFunction(result))
              ...
              for (x in result)
                result.hasOwnProperty(x) &&
                  ((value = checks.isFunction(result[x])
                    ? "[function]"
  ...
  define(
    ...
    function (e, t) {
      ...
      (t.startup = function (e) {
        e.env.settings.addSetting(i);
      }),
        (t.shutdown = function (e) {
          e.env.settings.removeSetting(i);
        });
    }
  ),
  define(
    ...
    function (e, t) {
      ...
      (t.REASONS = {
        ...
        (t.Plugin = function (e) {
          (this.name = e), (this.status = this.INSTALLED);
        }),
        (t.Plugin.prototype = {
          NEW: 0,
          INSTALLED: 1,
          ...
          register: function (t, n) {
            var r = new i();
            return this.status != this.INSTALLED
              ? (r.resolve(this), r)
              : (e(
                  [this.name],
                  function (e) {
                    e.register && e.register(t, n),
          ...
          startup: function (n, r) {
            r = r || t.REASONS.APP_STARTUP;
            var o = new i();
            return this.status != this.REGISTERED
              ? (o.resolve(this), o)
              : (e(
                  [this.name],
                  function (e) {
                    e.startup && e.startup(n, r),
          ...
          shutdown: function (t, i) {
            this.status == this.STARTED &&
              ((pluginModule = e(this.name)),
              pluginModule.shutdown && pluginModule.shutdown(t, i));
          },
        }),
        (t.PluginCatalog = function () {
          this.plugins = {};
        }),
        (t.PluginCatalog.prototype = {
          registerPlugins: function (e, n, r) {
            var o = [];
            return (
              e.forEach(
                function (e) {
                  ...
                  void 0 === i &&
                    ((i = new t.Plugin(e)),
                    (this.plugins[e] = i),
                    o.push(i.register(n, r)));
                }.bind(this)
              ),
              i.group(o)
            );
          },
          startupPlugins: function (e, t) {
            var n = [];
            for (var r in this.plugins) {
              var o = this.plugins[r];
              n.push(o.startup(e, t));
            }
            return i.group(n);
          },
        }),
        (t.catalog = new t.PluginCatalog());
    }
  ),
  define(
    "pilot/promise",
    ...
    function (e, t) {
      var i = e("pilot/console"),
        n = e("pilot/stacktrace").Trace,
        r = -1,
        o = 0,
        s = 1,
        a = 0,
      ...
      (Promise = function () {
        ...
        (Promise.prototype.then = function (e, t) {
          return (
            "function" == typeof e &&
              (this._status === s
                ? e.call(null, this._value)
                : this._status === o && this._onSuccessHandlers.push(e)),
            "function" == typeof t &&
              (this._status === r
                ? t.call(null, this._value)
                : this._status === o && this._onErrorHandlers.push(t)),
            this
          );
        }),
        (Promise.prototype.chainPromise = function (e) {
          var t = new Promise();
          return (
            (t._chainedFrom = this),
            this.then(
        ...
        (Promise.prototype.resolve = function (e) {
          return this._complete(this._onSuccessHandlers, s, e, "resolve");
        }),
        (Promise.prototype.reject = function (e) {
          return this._complete(this._onErrorHandlers, r, e, "reject");
        }),
        (Promise.prototype._complete = function (e, t, r, s) {
          if (this._status != o)
            return (
              i.group("Promise already closed"),
              i.error("Attempted " + s + "() with ", r),
              i.error(
                "Previous status = ",
                this._status,
                ", previous value = ",
              ...
              i.trace(),
              this._completeTrace &&
                (i.error("Trace of previous completion:"),
                this._completeTrace.log(5)),
              i.groupEnd(),
              this
            );
          for (
            c && (this._completeTrace = new n(Error())),
              this._status = t,
              this._value = r,
          ...
          var t = new Promise(),
            ...
            o = function (o) {
              return function (s) {
                (i[o] = s),
                  n++,
                  t._status !== r && n === e.length && t.resolve(i);
              };
            };
          return (
  ...
  define("pilot/dom", ["require", "exports", "module"], function (e, t) {
    ...
    (t.createElement = function (e, t) {
      ...
      (t.setText = function (e, t) {
        void 0 !== e.innerText && (e.innerText = t),
          void 0 !== e.textContent && (e.textContent = t);
      }),
      ...
      (t.importCssString = function (e, t) {
        if (((t = t || document), t.createStyleSheet)) {
          var n = t.createStyleSheet();
          n.cssText = e;
        } else {
          var r = t.createElementNS
            ? t.createElementNS(i, "style")
      ...
      (t.getInnerWidth = function (e) {
        return (
          parseInt(t.computedStyle(e, "paddingLeft")) +
          parseInt(t.computedStyle(e, "paddingRight")) +
          e.clientWidth
        );
      }),
      (t.getInnerHeight = function (e) {
        return (
          parseInt(t.computedStyle(e, "paddingTop")) +
          parseInt(t.computedStyle(e, "paddingBottom")) +
          e.clientHeight
        );
      }),
      ...
      (t.setSelectionStart = function (e, t) {
        return (e.selectionStart = t);
      }),
      ...
      (t.setSelectionEnd = function (e, t) {
        return (e.selectionEnd = t);
      });
  }),
  define(
    "pilot/event",
    ...
    function (e, t) {
      function i(e, t, i) {
        ...
        return (
          8 & o && (91 == i || 93 == i) && (i = 0),
          0 != o || i in n.FUNCTION_KEYS ? e(t, o, i) : !1
        );
      }
      var n = e("pilot/keys"),
        r = e("pilot/useragent"),
      ...
      (t.addListener = function (e, t, i) {
        ...
        (t.getDocumentX = function (e) {
          return e.clientX ? e.clientX + o.getPageScrollLeft() : e.pageX;
        }),
        (t.getDocumentY = function (e) {
          return e.clientY ? e.clientY + o.getPageScrollTop() : e.pageY;
        }),
        ...
        (t.capture = document.documentElement.setCapture
          ? function (e, i, n) {
              function r(o) {
                i && i(o),
                  n && n(),
                  t.removeListener(e, "mousemove", i),
                  t.removeListener(e, "mouseup", r),
                  t.removeListener(e, "losecapture", r),
                  e.releaseCapture();
              }
              t.addListener(e, "mousemove", i),
                t.addListener(e, "mouseup", r),
                t.addListener(e, "losecapture", r),
                e.setCapture();
            }
          : function (e, t, i) {
              function n(e) {
        ...
        (t.addMouseWheelListener = function (e, i) {
          ...
          t.addListener(e, "DOMMouseScroll", n),
            t.addListener(e, "mousewheel", n);
        }),
        (t.addMultiMouseDownListener = function (e, i, n, o, s) {
          var a,
            c,
            l = 0,
            h = function (e) {
              ...
              var r = t.getButton(e) == i;
              return (
                (!r ||
                  Math.abs(e.clientX - a) > 5 ||
                  Math.abs(e.clientY - c) > 5) &&
                  (l = 0),
                l == n && ((l = 0), s(e)),
                r ? t.preventDefault(e) : void 0
              );
            };
          t.addListener(e, "mousedown", h),
            r.isIE && t.addListener(e, "dblclick", h);
        }),
          ...
          if (r.isOldGecko) {
            ...
            o(e, "keydown", function (e) {
              ...
              r.isMac &&
                r.isOpera &&
                o(e, "keypress", function (e) {
                  var t = e.keyIdentifier || e.keyCode;
                  return a !== t ? i(n, e, e.keyCode) : ((a = null), void 0);
                });
          }
        });
    }
  ...
  define(
    ...
    function (e, t) {
      e("pilot/fixoldbrowsers");
      var i = e("pilot/oop"),
        n = (e("pilot/event"), e("pilot/lang")),
        r = e("pilot/useragent"),
        o = e("ace/keyboard/textinput").TextInput,
        s = e("ace/mouse_handler").MouseHandler,
        a = e("ace/keyboard/keybinding").KeyBinding,
        c = e("ace/edit_session").EditSession,
        l = e("ace/search").Search,
        h = e("ace/range").Range,
        d = e("pilot/event_emitter").EventEmitter,
        u = function (e, t) {
          var i = e.getContainerElement();
          (this.container = i),
            (this.renderer = e),
            (this.textInput = new o(e.getTextAreaContainer(), this)),
            (this.keyBinding = new a(this)),
            r.isIPad || (this.$mouseHandler = new s(this)),
      ...
      (function () {
        i.implement(this, d),
          ...
          (this.addEventListener = function (e, t) {
            return this.$forwardEvents[e]
              ? this.renderer.addEventListener(e, t)
              : this.$originalAddEventListener(e, t);
          }),
          (this.removeEventListener = function (e, t) {
            return this.$forwardEvents[e]
              ? this.renderer.removeEventListener(e, t)
              : this.$originalRemoveEventListener(e, t);
          }),
          ...
          (this.setSession = function (e) {
            if (this.session != e) {
              ...
              (this.session = e),
                ...
                this.renderer.scrollToRow(e.getScrollTopRow()),
            ...
            if (
              ...
              (this.$highlightPending = !0),
                setTimeout(function () {
                  ...
                  if (t) {
                    var i = new h(t.row, t.column, t.row, t.column + 1);
          ...
          (this.$updateHighlightActiveLine = function () {
            ...
            if (
              (e.$highlightLineMarker && e.removeMarker(e.$highlightLineMarker),
              (e.$highlightLineMarker = null),
              this.getHighlightActiveLine() &&
                ("line" != this.getSelectionStyle() ||
                  !this.selection.isMultiLine()))
            ) {
              var t,
                i = this.getCursorPosition(),
                n = this.session.getFoldLine(i.row);
              (t = n
                ? new h(n.start.row, 0, n.end.row + 1, 0)
                : new h(i.row, 0, i.row + 1, 0)),
                (e.$highlightLineMarker = e.addMarker(
                  t,
                  "ace_active_line",
                  "background"
                ));
          ...
          (this.onSelectionChange = function () {
            var e = this.getSession();
            if (
              (e.$selectionMarker && e.removeMarker(e.$selectionMarker),
            ...
            if (!this.$readOnly) {
              ...
              if (
                ...
                if (this.session.getOverwrite()) {
                  var o = new h.fromPoints(n, n);
                  (o.end.column += e.length), this.session.remove(o);
                }
              } else {
                var n = this.session.remove(this.getSelectionRange());
                this.clearSelection();
              }
              this.clearSelection();
              var s = n.column,
                a = t.getState(n.row),
                c = i.checkOutdent(a, t.getLine(n.row), e),
                l = t.getLine(n.row),
                d = i.getNextLineIndent(
                  a,
                  l.slice(0, n.column),
                  t.getTabString()
                ),
              ...
              var a = t.getState(n.row);
              if (t.getDocument().isNewLine(e)) {
                this.moveCursorTo(n.row + 1, 0);
                for (
                  var g = t.getTabSize(), p = Number.MAX_VALUE, f = n.row + 1;
                  u.row >= f;
                  ++f
                ) {
                  var m = 0;
                ...
                for (var f = n.row + 1; u.row >= f; ++f) {
                  var C = p;
                  l = t.getLine(f);
                  for (var F = 0; l.length > F && C > 0; ++F)
                    "	" == l.charAt(F)
                      ? (C -= g)
                      : " " == l.charAt(F) && (C -= 1);
                  t.remove(new h(f, 0, f, F));
                }
                t.indentRows(n.row + 1, u.row, d);
              } else c && i.autoOutdent(a, t, n.row);
            }
          }),
          (this.onTextInput = function (e, t) {
            if (t && 1 == e.length) {
              var i = this.keyBinding.onCommandKey({}, 0, null, e);
              i || this.insert(e);
            } else this.keyBinding.onTextInput(e);
          }),
          ...
          (this.setSelectionStyle = function (e) {
            this.$selectionStyle != e &&
              ((this.$selectionStyle = e),
              this.onSelectionChange(),
              this._dispatchEvent("changeSelectionStyle", { data: e }));
          }),
          ...
          (this.setShowInvisibles = function (e) {
            this.getShowInvisibles() != e && this.renderer.setShowInvisibles(e);
          }),
          ...
          (this.removeLeft = function () {
            if (!this.$readOnly) {
              ...
              if (this.getBehavioursEnabled()) {
                var t = this.session,
                  i = t.getState(e.start.row),
                  n = t.getMode().transformAction(i, "deletion", this, t, e);
                n !== !1 && (e = n);
              }
          ...
          (this.transposeLetters = function () {
            if (!this.$readOnly) {
              ...
              if (i.length > t)
                var n = i.charAt(t) + i.charAt(t - 1),
                  r = new h(e.row, t - 1, e.row, t + 1);
              else
                var n = i.charAt(t - 1) + i.charAt(t - 2),
                  r = new h(e.row, t - 2, e.row, t);
          ...
          (this.removeLines = function () {
            if (!this.$readOnly) {
              ...
              if (0 == e.last || e.last + 1 < this.session.getLength())
                var t = new h(e.first, 0, e.last + 1, 0);
              else
                var t = new h(
                  e.first - 1,
                  this.session.getLine(e.first).length,
                  e.last,
          ...
          (this.$moveLines = function (e) {
            var t = this.$getSelectedRows(),
              i = e.call(this, t.first, t.last),
              n = this.selection;
            n.setSelectionAnchor(t.last + i + 1, 0),
              n.$moveSelection(function () {
                n.moveCursorTo(t.first + i, 0);
              });
          }),
          ...
          (this.isRowVisible = function (e) {
            return (
              e >= this.getFirstVisibleRow() && this.getLastVisibleRow() >= e
            );
          }),
          ...
          (this.$getPageUpRow = function () {
            var e = this.renderer.getScrollTopRow(),
              t = this.renderer.getScrollBottomRow();
            return e - (t - e);
          }),
          (this.selectPageDown = function () {
            ...
            var t = this.getSelection(),
              i = this.session.documentToScreenPosition(t.getSelectionLead()),
              n = this.session.screenToDocumentPosition(e, i.column);
            t.selectTo(n.row, n.column);
          }),
          (this.selectPageUp = function () {
            var e =
                this.renderer.getScrollTopRow() -
                this.renderer.getScrollBottomRow(),
              t = this.$getPageUpRow() + Math.round(e / 2);
            this.scrollPageUp();
            var i = this.getSelection(),
              n = this.session.documentToScreenPosition(i.getSelectionLead()),
              r = this.session.screenToDocumentPosition(t, n.column);
            i.selectTo(r.row, r.column);
          }),
          (this.gotoPageDown = function () {
            var e = this.$getPageDownRow(),
              t = this.getCursorPositionScreen().column;
            this.scrollToRow(e), this.getSelection().moveCursorToScreen(e, t);
          }),
          (this.gotoPageUp = function () {
            var e = this.$getPageUpRow(),
              t = this.getCursorPositionScreen().column;
            this.scrollToRow(e), this.getSelection().moveCursorToScreen(e, t);
          }),
          ...
          (this.scrollToLine = function (e, t) {
            this.renderer.scrollToLine(e, t);
          }),
          (this.centerSelection = function () {
            var e = this.getSelectionRange(),
              t = Math.floor(e.start.row + (e.end.row - e.start.row) / 2);
            this.renderer.scrollToLine(t, !0);
          }),
          ...
          (this.replaceAll = function (e, t) {
            ...
            if (i.length) {
              ...
              this.clearSelection(),
                ...
                (this.$blockScrolling += 1);
              for (var r = i.length - 1; r >= 0; --r) this.$tryReplace(i[r], e);
              this.selection.setSelectionRange(n), (this.$blockScrolling -= 1);
            }
          }),
          ...
          (this.findNext = function (e) {
            (e = e || {}),
              e.backwards === void 0 && (e.backwards = !1),
              this.$search.set(e),
              this.$find();
          }),
          (this.findPrevious = function (e) {
            (e = e || {}),
              e.backwards === void 0 && (e.backwards = !0),
              this.$search.set(e),
              this.$find();
          }),
          (this.$find = function (e) {
            this.selection.isEmpty() ||
              ...
              e !== void 0 && this.$search.set({ backwards: e });
            var t = this.$search.find(this.session);
            t &&
              (this.gotoLine(t.end.row + 1, t.end.column),
        ...
        o = function (e, t) {
          ...
          function s(e) {
            if (!h) {
              ...
              if (
                i &&
                (i.charCodeAt(i.length - 1) == c.charCodeAt(0)
                  ? ((i = i.slice(0, -1)), i && t.onTextInput(i, !d))
                  : t.onTextInput(i, !d),
                !o())
              )
                return !1;
            }
            (h = !1), (d = !1), (a.value = c), a.select();
          }
          var a = r.createElement("textarea");
          (a.style.left = "-10000px"), e.appendChild(a);
          ...
          var l = !1,
            ...
            p = function () {
              (n.isIE && a.value.charCodeAt(0) > 128) ||
                setTimeout(function () {
                  l || s();
                }, 0);
            },
            f = function () {
              (l = !0), t.onCompositionStart(), n.isGecko || setTimeout(m, 0);
            },
            m = function () {
              !l || t.onCompositionUpdate(a.value);
            },
            F = function () {
              (l = !1), t.onCompositionEnd();
            },
            C = function (e) {
              h = !0;
              var i = t.getCopyText();
              i ? (a.value = i) : e.preventDefault(),
                a.select(),
                setTimeout(function () {
                  s();
                }, 0);
            ...
            A = function (e) {
              h = !0;
              var i = t.getCopyText();
              i ? ((a.value = i), t.onCut()) : e.preventDefault(),
                a.select(),
                setTimeout(function () {
                  s();
                }, 0);
            };
          if ((i.addCommandKeyListener(a, t.onCommandKey.bind(t)), n.isIE)) {
            var b = { 13: 1, 27: 1 };
            i.addListener(a, "keyup", function (e) {
              l && (!a.value || b[e.keyCode]) && setTimeout(F, 0),
                129 > (0 | a.value.charCodeAt(0)) || (l ? m() : f());
            });
          }
          a.attachEvent
            ? i.addListener(a, "propertychange", p)
            : n.isChrome || n.isSafari
            ? i.addListener(a, "textInput", g)
            : n.isIE
            ? i.addListener(a, "textinput", g)
            : i.addListener(a, "input", g),
            i.addListener(a, "paste", function (e) {
              (d = !0),
            ...
            n.isIE
              ? (i.addListener(a, "beforecopy", function (e) {
                  var i = t.getCopyText();
                  i ? clipboardData.setData("Text", i) : e.preventDefault();
                }),
                i.addListener(e, "keydown", function (e) {
                  if (e.ctrlKey && 88 == e.keyCode) {
                    var n = t.getCopyText();
                    n && (clipboardData.setData("Text", n), t.onCut()),
                      i.preventDefault(e);
                  }
                }))
              : (i.addListener(a, "copy", C), i.addListener(a, "cut", A)),
            i.addListener(a, "compositionstart", f),
            n.isGecko && i.addListener(a, "text", m),
            n.isWebKit && i.addListener(a, "keyup", m),
            i.addListener(a, "compositionend", F),
            i.addListener(a, "blur", function () {
              t.onBlur();
            }),
            i.addListener(a, "focus", function () {
              t.onFocus(), a.select();
            }),
            (this.focus = function () {
              t.onFocus(), a.select(), a.focus();
            }),
            (this.blur = function () {
              a.blur();
            }),
            ...
            (this.onContextMenu = function (e, t) {
              e &&
                (u || (u = a.style.cssText),
                (a.style.cssText =
  ...
  define(
    ...
    function (e, t) {
      var i = e("pilot/event"),
        n = e("pilot/dom"),
        r = e("pilot/browser_focus").BrowserFocus,
        o = 0,
        s = 1,
        a = 2,
        c = 250,
        ...
        h = function (e) {
          (this.editor = e),
            (this.browserFocus = new r()),
            i.addListener(e.container, "mousedown", function (t) {
              return e.focus(), i.preventDefault(t);
            }),
            i.addListener(e.container, "selectstart", function (e) {
              return i.preventDefault(e);
            });
          var t = e.renderer.getMouseEventTarget();
          i.addListener(t, "mousedown", this.onMouseDown.bind(this)),
            ...
            i.addMouseWheelListener(t, this.onMouseWheel.bind(this));
        };
      (function () {
        (this.$scrollSpeed = 1),
          (this.setScrollSpeed = function (e) {
          ...
          (this.$getEventPosition = function (e) {
            var t = i.getDocumentX(e),
              n = i.getDocumentY(e),
              r = this.editor.renderer.screenToTextCoordinates(t, n);
            return (
              (r.row = Math.max(
                0,
                Math.min(r.row, this.editor.session.getLength() - 1)
              )),
              r
            );
          }),
          (this.$distance = function (e, t, i, n) {
            return Math.sqrt(Math.pow(i - e, 2) + Math.pow(n - t, 2));
          }),
          (this.onMouseDown = function (e) {
            function t(t) {
              e.shiftKey
                ? u.selection.selectToPosition(t)
                : g.$clickSelection ||
                  (u.moveCursorToPosition(t),
                  u.selection.clearSelection(t.row, t.column)),
                (m = s);
            }
            if (
              this.browserFocus.isFocused() &&
              !(20 > new Date().getTime() - this.browserFocus.lastFocus) &&
              this.editor.isFocused()
            ) {
              var r = i.getDocumentX(e),
                h = i.getDocumentY(e),
                d = this.$getEventPosition(e),
                u = this.editor,
                g = this,
                p = u.getSelectionRange(),
                f = p.isEmpty(),
                m = o,
                F = !1,
                C = i.getButton(e);
              if (0 !== C)
                return (
                  f && u.moveCursorToPosition(d),
                  2 == C &&
                    (u.textInput.onContextMenu({ x: r, y: h }, f),
                    i.capture(
                      u.container,
                      function () {},
                      u.textInput.onContextMenuClose
                    )),
                  void 0
                );
              var A = u.session.getFoldAt(d.row, d.column, 1);
              if (A) return u.selection.setSelectionRange(A.range), void 0;
              (F = !u.getReadOnly() && !f && p.contains(d.row, d.column)),
                F || t(d);
              var b,
                E,
                x,
                v,
                w = (u.getOverwrite(), new Date().getTime()),
                y = function (e) {
                  (b = i.getDocumentX(e)), (E = i.getDocumentY(e));
                },
                D = function () {
                  clearInterval(_),
                    m == o ? t(d) : m == a && B(),
                ...
                B = function () {
                  if (
                    (n.removeCssClass(u.container, "ace_dragging"),
                    u.session.removeMarker(dragSelectionMarker),
                    g.$clickSelection ||
                      x ||
                      (u.moveCursorToPosition(d),
                      u.selection.clearSelection(d.row, d.column)),
                    x)
                  ) {
                    if (v.contains(x.row, x.column)) return (x = null), void 0;
                    u.clearSelection();
                    var e = u.moveText(v, x);
                    if (!e) return (x = null), void 0;
                    u.selection.setSelectionRange(e);
                  }
                },
                S = function () {
                  if (void 0 !== b && void 0 !== E) {
                    if (m == o) {
                      var e = g.$distance(r, h, b, E),
                        i = new Date().getTime();
                      if (e > l) {
                        m = s;
                        var d = u.renderer.screenToTextCoordinates(b, E);
                        (d.row = Math.max(
                          0,
                          Math.min(d.row, u.session.getLength() - 1)
                        )),
                          t(d);
                      } else if (i - w > c) {
                        (m = a), (v = u.getSelectionRange());
                        var p = u.getSelectionStyle();
                        (dragSelectionMarker = u.session.addMarker(
                          v,
                          "ace_selection",
                          p
                        )),
                          u.clearSelection(),
                          n.addCssClass(u.container, "ace_dragging");
                      }
                    }
                    m == a ? k() : m == s && L();
                  }
                ...
                L = function () {
                  var e = u.renderer.screenToTextCoordinates(b, E);
                  if (
                    ((e.row = Math.max(
                      0,
                      Math.min(e.row, u.session.getLength() - 1)
                    )),
                    g.$clickSelection)
                  )
                    if (g.$clickSelection.contains(e.row, e.column))
                      u.selection.setSelectionRange(g.$clickSelection);
                    else {
                      if (-1 == g.$clickSelection.compare(e.row, e.column))
                        var t = g.$clickSelection.end;
                      else var t = g.$clickSelection.start;
                      u.selection.setSelectionAnchor(t.row, t.column),
                        u.selection.selectToPosition(e);
                    }
                  else u.selection.selectToPosition(e);
                  u.renderer.scrollCursorIntoView();
                },
                k = function () {
                  (x = u.renderer.screenToTextCoordinates(b, E)),
                    (x.row = Math.max(
                      0,
                      Math.min(x.row, u.session.getLength() - 1)
                    )),
                    u.moveCursorToPosition(x);
                };
              i.capture(u.container, y, D);
              var _ = setInterval(S, 20);
              return i.preventDefault(e);
            }
          }),
          (this.onMouseDoubleClick = function (e) {
            var t = this.editor,
              i = this.$getEventPosition(e),
              n = t.session.getFoldAt(i.row, i.column, 1);
            n
              ? t.session.expandFold(n)
              : (t.moveCursorToPosition(i),
                t.selection.selectWord(),
                (this.$clickSelection = t.getSelectionRange()));
          }),
          (this.onMouseTripleClick = function (e) {
            var t = this.$getEventPosition(e);
            this.editor.moveCursorToPosition(t),
              this.editor.selection.selectLine(),
              (this.$clickSelection = this.editor.getSelectionRange());
          }),
          (this.onMouseQuadClick = function () {
            this.editor.selectAll(),
              (this.$clickSelection = this.editor.getSelectionRange());
          }),
          (this.onMouseWheel = function (e) {
            var t = 2 * this.$scrollSpeed;
            return (
              this.editor.renderer.scrollBy(e.wheelX * t, e.wheelY * t),
              i.preventDefault(e)
            );
          });
      }.call(h.prototype),
  ...
  define(
    ...
    function (e, t) {
      var i = e("pilot/oop"),
        n = e("pilot/event"),
        r = e("pilot/event_emitter").EventEmitter,
        o = function (e) {
          (e = e || window),
            (this.lastFocus = new Date().getTime()),
            (this._isFocused = !0);
          var t = this;
          n.addListener(e, "blur", function () {
            t._setFocused(!1);
          }),
            n.addListener(e, "focus", function () {
              t._setFocused(!0);
            });
        };
      (function () {
        i.implement(this, r),
          ...
          (this._setFocused = function (e) {
            this._isFocused != e &&
              (e && (this.lastFocus = new Date().getTime()),
              (this._isFocused = e),
  ...
  define(
    ...
    function (e, t) {
      var i = (e("pilot/useragent"), e("pilot/keys")),
        n = e("pilot/event"),
        r = (e("pilot/settings").settings, e("pilot/canon"));
      e("ace/commands/default_commands");
      var o = function (e) {
        (this.$editor = e), (this.$data = {}), (this.$keyboardHandler = null);
      };
      (function () {
        (this.setKeyboardHandler = function (e) {
          this.$keyboardHandler != e &&
            ((this.$data = {}), (this.$keyboardHandler = e));
        }),
          (this.getKeyboardHandler = function () {
            return this.$keyboardHandler;
          }),
          (this.$callKeyboardHandler = function (e, t, i, o) {
            var s,
              a = { editor: this.$editor };
            this.$keyboardHandler &&
              (s = this.$keyboardHandler.handleKeyboard(
                this.$data,
                t,
                i,
                o,
              ...
              (s && s.command) ||
                (s =
                  0 != t || 0 != o
                    ? { command: r.findKeyCommand(a, "editor", t, i) }
                    : { command: "inserttext", args: { text: i } });
            var c = !1;
            return (
              s &&
                ((c = r.exec(s.command, a, "editor", s.args)),
                c && n.stopEvent(e)),
              c
            );
          }),
          (this.onCommandKey = function (e, t, n, r) {
            return (
              r || (r = i.keyCodeToString(n)),
              this.$callKeyboardHandler(e, t, r, n)
            );
          }),
          (this.onTextInput = function (e) {
            return this.$callKeyboardHandler({}, 0, e, 0);
          });
      }.call(o.prototype),
        (t.KeyBinding = o));
    }
  ...
  define(
    ...
    function (e) {
      function t(e, t) {
        return { win: e, mac: t, sender: "editor" };
      }
      var i = e("pilot/lang"),
        n = e("pilot/canon");
      n.addCommand({ name: "null", exec: function () {} }),
        n.addCommand({
          name: "selectall",
          bindKey: t("Ctrl-A", "Command-A"),
          exec: function (e) {
            e.editor.selectAll();
          },
        }),
        n.addCommand({
          name: "removeline",
          bindKey: t("Ctrl-D", "Command-D"),
          exec: function (e) {
            e.editor.removeLines();
          },
        }),
        n.addCommand({
          name: "gotoline",
          bindKey: t("Ctrl-L", "Command-L"),
          exec: function (e) {
            var t = parseInt(prompt("Enter line number:"));
            isNaN(t) || e.editor.gotoLine(t);
          },
        }),
        n.addCommand({
          name: "togglecomment",
          bindKey: t("Ctrl-7", "Command-7"),
          exec: function (e) {
            e.editor.toggleCommentLines();
          },
        }),
        n.addCommand({
          name: "findnext",
          bindKey: t("Ctrl-K", "Command-G"),
          exec: function (e) {
            e.editor.findNext();
          },
        }),
        n.addCommand({
          name: "findprevious",
          bindKey: t("Ctrl-Shift-K", "Command-Shift-G"),
          exec: function (e) {
            e.editor.findPrevious();
          },
        }),
        n.addCommand({
          name: "find",
          bindKey: t("Ctrl-F", "Command-F"),
          exec: function (e) {
            var t = prompt("Find:");
            e.editor.find(t);
          },
        ...
        n.addCommand({
          name: "replace",
          bindKey: t("Ctrl-R", "Command-Option-F"),
          exec: function (e) {
            var t = prompt("Find:");
            if (t) {
              var i = prompt("Replacement:");
              if (!i) return;
              e.editor.replace(i, { needle: t });
            }
          },
        }),
        n.addCommand({
          name: "replaceall",
          bindKey: t("Ctrl-Shift-R", "Command-Shift-Option-F"),
          exec: function (e) {
            var t = prompt("Find:");
            if (t) {
              var i = prompt("Replacement:");
              if (!i) return;
              e.editor.replaceAll(i, { needle: t });
            }
          },
        }),
        n.addCommand({
        ...
        n.addCommand({
          name: "overwrite",
          bindKey: t("Insert", "Insert"),
          exec: function (e) {
            e.editor.toggleOverwrite();
          },
        }),
        n.addCommand({
          name: "copylinesup",
          bindKey: t("Ctrl-Alt-Up", "Command-Option-Up"),
          exec: function (e) {
            e.editor.copyLinesUp();
          },
        }),
        n.addCommand({
          name: "movelinesup",
          bindKey: t("Alt-Up", "Option-Up"),
          exec: function (e) {
            e.editor.moveLinesUp();
          },
        }),
        n.addCommand({
          name: "selecttostart",
          bindKey: t("Ctrl-Shift-Home|Alt-Shift-Up", "Command-Shift-Up"),
          exec: function (e) {
            e.editor.getSelection().selectFileStart();
          },
        }),
        n.addCommand({
          name: "gotostart",
          bindKey: t("Ctrl-Home|Ctrl-Up", "Command-Home|Command-Up"),
          exec: function (e) {
            e.editor.navigateFileStart();
          },
        }),
        n.addCommand({
          name: "selectup",
          ...
          exec: function (e) {
            e.editor.getSelection().selectUp();
          },
        }),
        n.addCommand({
          name: "golineup",
          bindKey: t("Up", "Up|Ctrl-P"),
          exec: function (e, t) {
            e.editor.navigateUp(t.times);
          },
        }),
        n.addCommand({
          name: "copylinesdown",
          bindKey: t("Ctrl-Alt-Down", "Command-Option-Down"),
          exec: function (e) {
            e.editor.copyLinesDown();
          },
        }),
        n.addCommand({
          name: "movelinesdown",
          bindKey: t("Alt-Down", "Option-Down"),
          exec: function (e) {
            e.editor.moveLinesDown();
          },
        }),
        n.addCommand({
          name: "selecttoend",
          bindKey: t("Ctrl-Shift-End|Alt-Shift-Down", "Command-Shift-Down"),
          exec: function (e) {
            e.editor.getSelection().selectFileEnd();
          },
        }),
        n.addCommand({
          name: "gotoend",
          bindKey: t("Ctrl-End|Ctrl-Down", "Command-End|Command-Down"),
          exec: function (e) {
            e.editor.navigateFileEnd();
          },
        }),
        n.addCommand({
          name: "selectdown",
          ...
          exec: function (e) {
            e.editor.getSelection().selectDown();
          },
        }),
        n.addCommand({
          name: "golinedown",
          bindKey: t("Down", "Down|Ctrl-N"),
          exec: function (e, t) {
            e.editor.navigateDown(t.times);
          },
        }),
        n.addCommand({
          name: "selectwordleft",
          ...
          exec: function (e) {
            e.editor.getSelection().selectWordLeft();
          },
        }),
        n.addCommand({
          name: "gotowordleft",
        ...
        n.addCommand({
          ...
          exec: function (e) {
            e.editor.getSelection().selectLineStart();
          },
        }),
        n.addCommand({
          name: "gotolinestart",
          bindKey: t("Alt-Left|Home", "Command-Left|Home|Ctrl-A"),
          exec: function (e) {
        ...
        n.addCommand({
          ...
          exec: function (e) {
            e.editor.getSelection().selectLeft();
          },
        }),
        n.addCommand({
          name: "gotoleft",
          bindKey: t("Left", "Left|Ctrl-B"),
          exec: function (e, t) {
            e.editor.navigateLeft(t.times);
          },
        }),
        n.addCommand({
          ...
          exec: function (e) {
            e.editor.getSelection().selectWordRight();
          },
        }),
        n.addCommand({
          name: "gotowordright",
        ...
        n.addCommand({
          ...
          exec: function (e) {
            e.editor.getSelection().selectLineEnd();
          },
        }),
        n.addCommand({
          name: "gotolineend",
          bindKey: t("Alt-Right|End", "Command-Right|End|Ctrl-E"),
          exec: function (e) {
            e.editor.navigateLineEnd();
          },
        }),
        n.addCommand({
          name: "selectright",
          ...
          exec: function (e) {
            e.editor.getSelection().selectRight();
          },
        }),
        n.addCommand({
          name: "gotoright",
          bindKey: t("Right", "Right|Ctrl-F"),
          exec: function (e, t) {
            e.editor.navigateRight(t.times);
          },
        }),
        n.addCommand({
          name: "selectpagedown",
          bindKey: t("Shift-PageDown", "Shift-PageDown"),
          exec: function (e) {
            e.editor.selectPageDown();
          },
        }),
        n.addCommand({
          name: "pagedown",
          bindKey: t(null, "PageDown"),
          exec: function (e) {
            e.editor.scrollPageDown();
          },
        }),
        n.addCommand({
          name: "gotopagedown",
          bindKey: t("PageDown", "Option-PageDown|Ctrl-V"),
          exec: function (e) {
            e.editor.gotoPageDown();
          },
        }),
        n.addCommand({
          name: "selectpageup",
          bindKey: t("Shift-PageUp", "Shift-PageUp"),
          exec: function (e) {
            e.editor.selectPageUp();
          },
        }),
        n.addCommand({
          name: "pageup",
          bindKey: t(null, "PageUp"),
          exec: function (e) {
            e.editor.scrollPageUp();
          },
        }),
        n.addCommand({
          name: "gotopageup",
          bindKey: t("PageUp", "Option-PageUp"),
          exec: function (e) {
            e.editor.gotoPageUp();
          },
        }),
        n.addCommand({
          ...
          bindKey: t("Shift-Home", "Shift-Home"),
          exec: function (e) {
            e.editor.getSelection().selectLineStart();
          },
        }),
        ...
        n.addCommand({
          ...
          bindKey: t(null, "Option-Backspace"),
          exec: function (e) {
            e.editor.removeToLineStart();
          },
        }),
        n.addCommand({
          name: "removetolineend",
          bindKey: t(null, "Ctrl-K"),
          exec: function (e) {
            e.editor.removeToLineEnd();
          },
        }),
        n.addCommand({
          name: "removewordleft",
          ...
          exec: function (e) {
            e.editor.removeWordLeft();
          },
        }),
        n.addCommand({
          name: "removewordright",
          bindKey: t(null, "Alt-Delete"),
          exec: function (e) {
            e.editor.removeWordRight();
          },
        }),
        n.addCommand({
          name: "outdent",
        ...
        n.addCommand({
          name: "inserttext",
          exec: function (e, t) {
            e.editor.insert(i.stringRepeat(t.text || "", t.times || 1));
          },
        }),
        n.addCommand({
          name: "centerselection",
          bindKey: t(null, "Ctrl-L"),
          exec: function (e) {
            e.editor.centerSelection();
          },
        }),
        n.addCommand({
          name: "splitline",
          bindKey: t(null, "Ctrl-O"),
          exec: function (e) {
            e.editor.splitLine();
          },
        }),
        n.addCommand({
          ...
          bindKey: t("Ctrl-T", "Ctrl-T"),
          exec: function (e) {
            e.editor.transposeLetters();
          },
        });
    }
  ),
  define(
    ...
    function (e, t) {
      var n = e("pilot/oop"),
        r = e("pilot/lang"),
        o = e("pilot/event_emitter").EventEmitter,
        s = e("ace/selection").Selection,
        a = e("ace/mode/text").Mode,
        c = e("ace/range").Range,
        l = e("ace/document").Document,
        h = e("ace/background_tokenizer").BackgroundTokenizer,
        d = function (e, t) {
          (this.$modified = !0),
            (this.$breakpoints = []),
            (this.$frontMarkers = {}),
            ...
            e instanceof l ? this.setDocument(e) : this.setDocument(new l(e)),
            (this.selection = new s(this)),
            t ? this.setMode(t) : this.setMode(new a());
        };
      (function () {
        function t(e) {
          return 4352 > e
        ...
        n.implement(this, o),
          ...
          (this.$resetRowCache = function (e) {
            if (0 == e) this.$rowCache = [];
            else
              for (var t = this.$rowCache, i = 0; t.length > i; i++)
                if (t[i].docRow >= e) return t.splice(i, t.length), void 0;
          }),
          ...
          (this.onChange = function (e) {
            ...
            !this.$fromUndo &&
              ...
              i &&
                0 != i.length &&
                this.$deltasFold.push({ action: "removeFolds", folds: i }),
              this.$informUndoManager.schedule()),
              this.bgTokenizer.start(t.range.start.row),
          ...
          (this.getTokens = function (e, t) {
            return this.bgTokenizer.getTokens(e, t);
          }),
          (this.setUndoManager = function (e) {
            if (
              ...
              (this.$syncInformUndoManager = function () {
                ...
                (this.$informUndoManager = r.deferredCall(
          ...
          (this.setOverwrite = function (e) {
            this.$overwrite != e &&
              ((this.$overwrite = e), this._dispatchEvent("changeOverwrite"));
          }),
          (this.getOverwrite = function () {
          ...
          (this.setBreakpoints = function (e) {
            this.$breakpoints = [];
            for (var t = 0; e.length > t; t++) this.$breakpoints[e[t]] = !0;
          ...
          (this.setAnnotations = function (e) {
            ...
            for (var t = 0; e.length > t; t++) {
              var i = e[t],
                n = i.row;
              this.$annotations[n]
                ? this.$annotations[n].push(i)
                : (this.$annotations[n] = [i]);
            }
          ...
          (this.getWordRange = function (e, t) {
            ...
            var r = n ? this.tokenRe : this.nonTokenRe,
              o = t;
            if (o > 0) {
              do o--;
            ...
            for (var s = t; i.length > s && i.charAt(s).match(r); ) s++;
          ...
          (this.setMode = function (e) {
            if (this.$mode !== e) {
              ...
              var t = e.getTokenizer();
              if (void 0 !== t.addEventListener) {
                var i = this.onReloadTokenizer.bind(this);
                t.addEventListener("update", i);
              }
              if (this.bgTokenizer) this.bgTokenizer.setTokenizer(t);
              else {
                this.bgTokenizer = new h(t);
                var n = this;
                this.bgTokenizer.addEventListener("update", function (e) {
                  n._dispatchEvent("tokenizerUpdate", e);
                });
              }
          ...
          (this.$scrollTop = 0),
          (this.setScrollTopRow = function (e) {
            this.$scrollTop !== e &&
              ((this.$scrollTop = e), this._dispatchEvent("changeScrollTop"));
          }),
          ...
          (this.$computeWidth = function (e) {
            if (this.$modified || e) {
              this.$modified = !1;
              for (
                var t = this.doc.getAllLines(), i = 0, n = 0, r = 0;
                t.length > r;
                r++
              ) {
                var o,
                  s,
                  a = this.getFoldLine(r);
                if (((o = t[r]), a)) {
                  var c = a.range.end;
                  (o = this.getFoldDisplayLine(a)), (r = c.row);
                }
                (s = o.length),
                  (i = Math.max(i, s)),
                  this.$useWrapMode ||
                    (n = Math.max(n, this.$getStringScreenWidth(o)[0]));
              }
              (this.width = i),
                (this.screenWidth = this.$useWrapMode ? this.$wrapLimit : n);
            }
          }),
          ...
          (this.getTextRange = function (e) {
            return this.doc.getTextRange(e);
          }),
          ...
          (this.$findOpeningBracket = function (e, t) {
            for (
              ...
              for (; n >= 0; ) {
                var a = s.charAt(n);
                if (a == i) {
                  if (((o -= 1), 0 == o)) return { row: r, column: n };
                } else a == e && (o += 1);
                n -= 1;
              }
              if (((r -= 1), 0 > r)) break;
          ...
          (this.$findClosingBracket = function (e, t) {
            for (
              var i = this.$brackets[e],
                n = t.column,
                r = t.row,
                ...
                (delta = e[n]),
                  "doc" == delta.group
                    ? (this.doc.revertDeltas(delta.deltas),
                      (i = this.$getUndoSelection(delta.deltas, !0, i)))
                    : delta.deltas.forEach(function (e) {
                        this.addFolds(e.folds);
                      }, this);
              return (
                (this.$fromUndo = !1),
                i && !t && this.selection.setSelectionRange(i),
                i
              );
            }
          }),
          (this.redoChanges = function (e, t) {
            if (e.length) {
              this.$fromUndo = !0;
              for (var i = null, n = 0; e.length > n; n++)
                (delta = e[n]),
                  "doc" == delta.group &&
                    (this.doc.applyDeltas(delta.deltas),
                    (i = this.$getUndoSelection(delta.deltas, !1, i)));
              return (
                (this.$fromUndo = !1),
                i && !t && this.selection.setSelectionRange(i),
                i
          ...
          (this.$getUndoSelection = function (e, t, i) {
            ...
            n(s)
              ? ((r = s.range.clone()), (a = !0))
              : ((r = c.fromPoints(s.range.start, s.range.start)), (a = !1));
            for (var l = 1; e.length > l; l++)
              (s = e[l]),
                n(s)
                  ? ((o = s.range.start),
                    -1 == r.compare(o.row, o.column) &&
                      r.setStart(s.range.start),
                    (o = s.range.end),
                    1 == r.compare(o.row, o.column) && r.setEnd(s.range.end),
                    (a = !0))
                  : ((o = s.range.start),
                    -1 == r.compare(o.row, o.column) &&
                      (r = c.fromPoints(s.range.start, s.range.start)),
                    (a = !1));
            if (null != i) {
          ...
          (this.moveText = function (e, t) {
            ...
            if (
              (!e.isMultiLine() &&
                ...
                r > e.end.column &&
                (r -= i.length),
              e.isMultiLine() && n > e.end.row)
            ) {
              var o = this.doc.$split(i);
              n -= o.length - 1;
            }
            var s = n + e.end.row - e.start.row,
              a = e.isMultiLine()
                ? e.end.column
                : r + e.end.column - e.start.column,
              l = new c(n, r, s, a);
            return this.insert(l.start, i), l;
          }),
          ...
          (this.moveLinesUp = function (e, t) {
            if (0 >= e) return 0;
            var i = this.doc.removeLines(e, t);
            return this.doc.insertLines(e - 1, i), -1;
          }),
          ...
          (this.$constrainWrapLimit = function (e) {
            ...
            t && (e = Math.max(t, e));
            var i = this.$wrapLimitRange.max;
            return i && (e = Math.min(i, e)), Math.max(1, e);
          }),
          ...
          (this.$updateInternalDataOnChange = function (e) {
            ...
            if (
              (-1 != n.indexOf("Lines")
                ? ((o = "insertLines" == n ? r + e.data.lines.length : r),
                  (t = e.data.lines.length))
                : (t = o - r),
              0 != t)
            )
              if (-1 != n.indexOf("remove")) {
                i && this.$wrapData.splice(r, t);
                var l = this.$foldData;
                ...
                var l = this.$foldData,
                  ...
                  d = 0;
                if (h) {
                  var f = h.range.compareInside(s.row, s.column);
                  0 == f
              ...
              (t = Math.abs(
                ...
                -1 != n.indexOf("remove") &&
                  ((c = this.getFoldsInRange(e.data.range)),
                  this.removeFolds(c),
                  (t = -t));
              var h = this.getFoldLine(r);
              h && h.addRemoveChars(r, s.column, t);
            }
            return (
              i &&
          ...
          (this.$updateWrapData = function (e, t) {
            var i,
              ...
              c = this.$wrapLimit,
              h = e;
            for (t = Math.min(t, o.length - 1); t >= h; ) {
              if ((n = this.getFoldLine(h)))
                for (
                  i = [],
                    n.walk(
                      function (e, t, n, r) {
                        var s;
                        if (e) {
                          (s = this.$getDisplayTokens(e, i.length)), (s[0] = l);
                          for (var a = 1; s.length > a; a++) s[a] = d;
                        } else
                  ...
                  0 != i.length && i[i.length - 1] >= u;

                )
                  i.pop();
              else i = this.$getDisplayTokens(r.stringTrimRight(o[h]));
              (a[h] = this.$computeWrapSplits(i, c, s)),
                (h = this.getRowFoldEnd(h) + 1);
            }
          });
        var s = 1,
          a = 2,
        ...
        (this.$computeWrapSplits = function (e, t) {
          ...
          for (
            var n = (this.getTabSize(), []), r = e.length, o = 0, s = 0;
            r - o > t;
          ...
          (this.$getDisplayTokens = function (e, i) {
            ...
            for (var o = 0; e.length > o; o++) {
              ...
              if (9 == c) {
                (n = this.getScreenTabSize(r.length + i)), r.push(g);
                for (var l = 1; n > l; l++) r.push(p);
              } else 32 == c ? r.push(u) : t(c) ? r.push(s, a) : r.push(s);
            }
            return r;
          }),
          (this.$getStringScreenWidth = function (e, i, n) {
            if (0 == i) return [0, 0];
            null == i && (i = n + e.length * Math.max(this.getTabSize(), 2)),
              (n = n || 0);
            var r, o;
            for (
              o = 0;
              e.length > o &&
              ((r = e.charCodeAt(o)),
              (n += 9 == r ? this.getScreenTabSize(n) : t(r) ? 2 : 1),
              !(n > i));
              o++
            );
            return [n, o];
          ...
          (this.getScreenLastRowColumn = function (e) {
            return this.documentToScreenColumn(e, this.doc.getLine(e).length);
          }),
          ...
          (this.screenToDocumentPosition = function (e, t) {
            ...
            for (
              var i, n, r = 0, o = 0, s = 0, a = 0, c = this.$rowCache, l = 0;
              c.length > l && e > c[l].screenRow;
              l++
            )
              (s = c[l].screenRow), (r = c[l].docRow);
            for (
              var h = !c.length || l == c.length,
                d = this.getLength() - 1,
                u = this.getNextFold(r),
                g = u ? u.start.row : 1 / 0;
              e >= s &&
              ((a = this.getRowLength(r)), !(s + a - 1 >= e || r >= d));
              ...
              (s += a),
                ...
                r > g &&
                  ...
                  (u = this.getNextFold(r)),
                  (g = u ? u.start.row : 1 / 0)),
                h && c.push({ docRow: r, screenRow: s });
            u && r >= u.start.row
              ? (i = this.getFoldDisplayLine(u))
              : ((i = this.getLine(r)), (u = null));
            var p = [];
            return (
              this.$useWrapMode &&
                ((p = this.$wrapData[r]),
                p &&
                  ...
                  e > s &&
                    p.length &&
                    ((o = p[e - s - 1] || p[p.length - 1]),
                    (i = i.substring(o))))),
              (o += this.$getStringScreenWidth(i, t)[1]),
              e > s + p.length && (o = Number.MAX_VALUE),
              this.$useWrapMode
                ? o >= n && (o = n - 1)
                : (o = Math.min(o, i.length)),
              u ? u.idxToPosition(o) : { row: r, column: o }
            );
          }),
          (this.documentToScreenPosition = function (e, t) {
            ...
            var n;
            if (
              (this.$rowCache.length,
              this.$useWrapMode && ((n = this.$wrapData), e > n.length - 1))
            )
              return {
                row: this.getScreenLength(),
                column: 0 == n.length ? 0 : n[n.length - 1].length - 1,
              };
            var r = 0,
              o = null,
              s = null;
            ...
            for (
              var a, c = 0, l = this.$rowCache, h = 0;
              l.length > h && e > l[h].docRow;
              h++
            )
              (r = l[h].screenRow), (c = l[h].docRow);
            for (
              var d = !l.length || h == l.length,
                u = this.getNextFold(c),
                g = u ? u.start.row : 1 / 0;
              e > c;

            ) {
              if (c >= g) {
                if (((a = u.end.row + 1), a > e)) break;
                (u = this.getNextFold(a)), (g = u ? u.start.row : 1 / 0);
              } else a = c + 1;
              (r += this.getRowLength(c)),
                (c = a),
                d && l.push({ docRow: c, screenRow: r });
            }
            var p = "";
            if (
              (u && c >= g
                ? ((p = this.getFoldDisplayLine(u, e, t)), (o = u.start.row))
                : ((p = this.getLine(e).substring(0, t)), (o = e)),
              this.$useWrapMode)
            ) {
              for (var f = n[o], m = 0; p.length >= f[m]; ) r++, m++;
              p = p.substring(f[m - 1] || 0, p.length);
            }
            return { row: r, column: this.$getStringScreenWidth(p)[0] };
          }),
          ...
          (this.getScreenLength = function () {
            var e = 0,
              ...
              i = null;
            if (this.$useWrapMode)
              for (var n = 0; this.$wrapData.length > n; n++)
                (i = this.getFoldLine(n, t))
                  ? ((n = i.end.row), (e += 1))
                  : (e += this.$wrapData[n].length + 1);
            else {
              e = this.getLength();
              for (var r = this.$foldData, o = 0; r.length > o; o++)
                (i = r[o]), (e -= i.end.row - i.start.row);
            }
            return e;
          });
      }.call(d.prototype),
        e("ace/edit_session/folding").Folding.call(d.prototype),
        (t.EditSession = d));
    }
  ),
  define(
      ...
      var i = e("pilot/oop"),
        ...
        s = function (e) {
          ...
          this.selectionLead.on("change", function (e) {
            t._dispatchEvent("changeCursor"),
              t.$isEmpty || t._dispatchEvent("changeSelection"),
              !t.$preventUpdateDesiredColumnOnChange &&
                e.old.column != e.value.column &&
                t.$updateDesiredColumn();
          }),
      ...
      (function () {
        i.implement(this, r),
          ...
          (this.setSelectionAnchor = function (e, t) {
            this.selectionAnchor.setPosition(e, t),
              this.$isEmpty &&
          ...
          (this.selectWord = function () {
            var e = this.getCursor(),
              t = this.session.getWordRange(e.row, e.column);
            this.setSelectionRange(t);
          }),
          (this.selectLine = function () {
            var e,
              t = this.selectionLead.row,
              i = this.session.getFoldLine(t);
            i ? ((t = i.start.row), (e = i.end.row)) : (e = t),
              this.setSelectionAnchor(t, 0),
              this.$moveSelection(function () {
                this.moveCursorTo(e + 1, 0);
              });
          }),
          ...
          (this.moveCursorLeft = function () {
            var e,
              t = this.selectionLead.getPosition();
          ...
          (this.moveCursorLineStart = function () {
            var e = this.selectionLead.row,
              t = this.selectionLead.column,
            ...
            o[0].length == t
              ...
              : this.moveCursorTo(n.row, n.column + o[0].length);
          }),
          ...
          (this.moveCursorWordRight = function () {
            var e,
              t = this.selectionLead.row,
              i = this.selectionLead.column,
              n = this.doc.getLine(t),
              r = n.substring(i);
            (this.session.nonTokenRe.lastIndex = 0),
              (this.session.tokenRe.lastIndex = 0);
            var o;
            if ((o = this.session.getFoldAt(t, i, 1)))
              this.moveCursorTo(o.end.row, o.end.column);
            else {
              if (i == n.length) return this.moveCursorRight(), void 0;
          ...
          (this.moveCursorWordLeft = function () {
            ...
            if ((e = this.session.getFoldAt(t, i, -1)))
              ...
              if (0 == i) return this.moveCursorLeft(), void 0;
          ...
          (this.moveCursorBy = function (e, t) {
            var i = this.session.documentToScreenPosition(
              ...
              n = (0 == t && this.$desiredColumn) || i.column,
              r = this.session.screenToDocumentPosition(i.row + e, n);
          ...
          (this.moveCursorTo = function (e, t, i) {
            ...
            n && ((e = n.start.row), (t = n.start.column)),
              ...
              this.selectionLead.setPosition(e, t),
              (this.$preventUpdateDesiredColumnOnChange = !1),
              i || this.$updateDesiredColumn(this.selectionLead.column);
          }),
          (this.moveCursorToScreen = function (e, t, i) {
            var n = this.session.screenToDocumentPosition(e, t);
            (e = n.row), (t = n.column), this.moveCursorTo(e, t, i);
          });
      }.call(s.prototype),
        (t.Selection = s));
    }
    ...
    (function () {
      (this.toString = function () {
        ...
        (this.clipRows = function (e, t) {
          ...
          if (e > this.start.row) var r = { row: e, column: 0 };
          if (e > this.end.row) var n = { row: e, column: 0 };
          return i.fromPoints(r || this.start, n || this.end);
        }),
        (this.extend = function (e, t) {
          var n = this.compare(e, t);
          if (0 == n) return this;
          if (-1 == n) var r = { row: e, column: t };
  ...
  define(
    ...
    function (e, t) {
      var i = e("ace/tokenizer").Tokenizer,
        n = e("ace/mode/text_highlight_rules").TextHighlightRules,
        r = e("ace/mode/behaviour").Behaviour,
        o = e("ace/unicode"),
        s = function () {
          (this.$tokenizer = new i(new n().getRules())),
      ...
      (function () {
        (this.tokenRe = RegExp(
          ...
          (this.highlightSelection = function (e) {
            var t = e.session;
            t.$selectionOccurrences || (t.$selectionOccurrences = []),
              t.$selectionOccurrences.length && this.clearSelectionHighlight(e);
            var i = e.getSelectionRange();
            if (!i.isEmpty() && !i.isMultiLine()) {
              var n = i.start.column - 1,
                r = i.end.column + 1,
                o = t.getLine(i.start.row),
                s = o.length,
                a = o.substring(Math.max(n, 0), Math.min(r, s));
              if (
                (n >= 0 && /^[\w\d]/.test(a)) ||
                (s >= r && /[\w\d]$/.test(a))
              )
                return;
              if (
                ((a = o.substring(i.start.column, i.end.column)),
                !/^[\w\d]+$/.test(a))
              )
                return;
              var c = e.getCursorPosition(),
                l = { wrap: !0, wholeWord: !0, caseSensitive: !0, needle: a },
                h = e.$search.getOptions();
              e.$search.set(l);
              var d = e.$search.findAll(t);
              d.forEach(function (e) {
                if (!e.contains(c.row, c.column)) {
                  var i = t.addMarker(e, "ace_selected_word", "text");
                  t.$selectionOccurrences.push(i);
                }
              }),
                e.$search.set(h);
            }
          }),
          (this.clearSelectionHighlight = function (e) {
            !e.session.$selectionOccurrences ||
              (e.session.$selectionOccurrences.forEach(function (t) {
                e.session.removeMarker(t);
              }),
              (e.session.$selectionOccurrences = []));
          }),
          (this.createModeDelegates = function (e) {
            if (this.$embeds) {
              this.$modes = {};
              for (var t = 0; this.$embeds.length > t; t++)
                e[this.$embeds[t]] &&
          ...
          (this.$delegator = function (e, t, i) {
            for (var n = t[0], r = 0; this.$embeds.length > r; r++)
  ...
  define("ace/tokenizer", ["require", "exports", "module"], function (e, t) {
    var i = function (e) {
      (this.rules = e), (this.regExps = {}), (this.matchMappings = {});
      for (var t in this.rules) {
        for (
          ...
          var c = RegExp("(?:(" + n[a].regex + ")|(.))").exec("a").length - 2,
            l = n[a].regex.replace(/\\([0-9]+)/g, function (e, t) {
              return "\\" + (parseInt(t, 10) + o + 1);
            });
          (s[o] = { rule: a, len: c }), (o += c), r.push(l);
        }
        this.regExps[t] = RegExp("(?:(" + r.join(")|(") + ")|(.))", "g");
      }
    };
    (function () {
      this.getLineTokens = function (e, t) {
        var i = t,
          n = this.rules[i],
          r = this.matchMappings[i],
          o = this.regExps[i];
        o.lastIndex = 0;
        for (
          var s, a = [], c = 0, l = { type: null, value: "" };
          (s = o.exec(e));

        ) {
          for (
            var h = "text", d = null, u = [s[0]], g = 0;
            s.length - 2 > g;
            g++
          )
            if (void 0 !== s[g + 1]) {
              (d = n[r[g].rule]),
                r[g].len > 1 && (u = s.slice(g + 2, g + 1 + r[g].len)),
                (h =
                  "function" == typeof d.token
                    ? d.token.apply(this, u)
                    : d.token);
              var p = d.next;
              p &&
                p !== i &&
          ...
          if (u[0]) {
            "string" == typeof h && ((u = [u.join("")]), (h = [h]));
            for (var g = 0; u.length > g; g++)
              (d && !d.merge && "text" !== h[g]) || l.type !== h[g]
                ? (l.type && a.push(l), (l = { type: h[g], value: u[g] }))
                : (l.value += u[g]);
          }
          if (c == e.length) break;
          c = o.lastIndex;
        }
        return l.type && a.push(l), { tokens: a, state: i };
      };
    }.call(i.prototype),
      (t.Tokenizer = i));
  }),
    ...
    function (e, t) {
      ...
      (function () {
        (this.addRules = function (e, t) {
          for (var i in e) {
            for (var n = e[i], r = 0; n.length > r; r++) {
              var o = n[r];
              o.next = o.next ? t + o.next : t + i;
            }
            this.$rules[t + i] = n;
          }
        }),
          ...
          (this.embedRules = function (e, t, n, r) {
            var o = new e().getRules();
            if (r) for (var s = 0; r.length > s; s++) r[s] = t + r[s];
            else {
              r = [];
              for (var a in o) r.push(t + a);
            }
            this.addRules(o, t);
            for (var s = 0; r.length > s; s++)
              Array.prototype.unshift.apply(this.$rules[r[s]], i.deepCopy(n));
  ...
  define(
    ...
    function (e, t) {
      var i = e("pilot/oop"),
        n = e("pilot/event_emitter").EventEmitter,
        r = e("ace/range").Range,
        o = e("ace/anchor").Anchor,
        s = function (e) {
          (this.$lines = []),
            Array.isArray(e)
              ? this.insertLines(0, e)
              : 0 == e.length
              ? (this.$lines = [""])
      ...
      (function () {
        i.implement(this, n),
          ...
          (this.getTextRange = function (e) {
            ...
            var t = [];
            return (
              t.push(this.$lines[e.start.row].substring(e.start.column)),
              t.push.apply(t, this.getLines(e.start.row + 1, e.end.row - 1)),
          ...
          (this.insert = function (e, t) {
            ...
            var i = this.$split(t),
              n = i.splice(0, 1)[0],
              r = 0 == i.length ? null : i.splice(i.length - 1, 1)[0];
            return (
              (e = this.insertInLine(e, n)),
              null !== r &&
                ((e = this.insertNewLine(e)),
                (e = this.insertLines(e.row, i)),
          ...
          (this.insertLines = function (e, t) {
            ...
            var n = new r(e, 0, e + t.length, 0),
              o = { action: "insertLines", range: n, lines: t };
            return this._dispatchEvent("change", { data: o }), n.end;
          }),
          (this.insertNewLine = function (e) {
            ...
            return this._dispatchEvent("change", { data: n }), i;
          }),
          (this.insertInLine = function (e, t) {
            ...
            var n = { row: e.row, column: e.column + t.length },
              o = { action: "insertText", range: r.fromPoints(e, n), text: t };
            return this._dispatchEvent("change", { data: o }), n;
          }),
          (this.remove = function (e) {
            if (
          ...
          (this.removeInLine = function (e, t, i) {
            if (t != i) {
              ...
              var c = { action: "removeText", range: n, text: s };
              return this._dispatchEvent("change", { data: c }), n.start;
            }
          }),
          ...
          (this.removeNewLine = function (e) {
            ...
            this._dispatchEvent("change", { data: s });
          }),
          (this.replace = function (e, t) {
          ...
          (this.applyDeltas = function (e) {
            for (var t = 0; e.length > t; t++) {
              ...
              "insertLines" == i.action
                ...
                ? this.removeLines(n.start.row, n.end.row - 1)
          ...
          (this.revertDeltas = function (e) {
            for (var t = e.length - 1; t >= 0; t--) {
              ...
              "insertLines" == i.action
                ...
                : "removeLines" == i.action
                ? this.insertLines(n.start.row, i.lines)
                : "removeText" == i.action && this.insert(n.start, i.text);
            }
          });
      }.call(s.prototype),
        (t.Document = s));
      ...
      (function () {
        i.implement(this, n),
          ...
          (this.onChange = function (e) {
            var t = e.data,
              i = t.range;
            if (i.start.row != i.end.row || i.start.row == this.row) {
              if (i.start.row > this.row) return;
              if (i.start.row == this.row && i.start.column > this.column)
                return;
              var n = this.row,
                r = this.column;
              "insertText" === t.action
                ? i.start.row === n && r >= i.start.column
                  ? i.start.row === i.end.row
                    ? (r += i.end.column - i.start.column)
                    : ((r -= i.start.column), (n += i.end.row - i.start.row))
                  : i.start.row !== i.end.row &&
                    n > i.start.row &&
                    (n += i.end.row - i.start.row)
                : "insertLines" === t.action
                ? n >= i.start.row && (n += i.end.row - i.start.row)
                : "removeText" == t.action
                ? i.start.row == n && r > i.start.column
                  ? (r =
                      i.end.column >= r
                        ? i.start.column
                        : Math.max(0, r - (i.end.column - i.start.column)))
                  : i.start.row !== i.end.row && n > i.start.row
                  ? (i.end.row == n &&
                      (r = Math.max(0, r - i.end.column) + i.start.column),
                    (n -= i.end.row - i.start.row))
                  : i.end.row == n &&
                    ((n -= i.end.row - i.start.row),
                    (r = Math.max(0, r - i.end.column) + i.start.column))
          ...
          (this.setPosition = function (e, t, i) {
            ...
            if (
              ...
              (this.row = n.row),
                ...
                this._dispatchEvent("change", { old: r, value: n });
            }
          }),
          ...
          this.$worker = function () {
            if (t.running) {
              for (
                ...
                if (
                  ((t.lines[t.currentLine] = t.$tokenizeRows(
                    t.currentLine,
                    t.currentLine
                  )[0]),
                  t.currentLine++,
                  ...
                  return (
                    t.fireUpdateEvent(i, t.currentLine - 1),
                    (t.running = setTimeout(t.$worker, 20)),
                    void 0
                  );
              (t.running = !1), t.fireUpdateEvent(i, o - 1);
            }
          };
        };
      (function () {
        i.implement(this, n),
          (this.setTokenizer = function (e) {
            (this.tokenizer = e), (this.lines = []), this.start(0);
          }),
          (this.setDocument = function (e) {
            (this.doc = e), (this.lines = []), this.stop();
          }),
          (this.fireUpdateEvent = function (e, t) {
            var i = { first: e, last: t };
            this._dispatchEvent("update", { data: i });
          }),
          ...
          (this.getTokens = function (e, t) {
            return this.$tokenizeRows(e, t);
          }),
          (this.getState = function (e) {
            return this.$tokenizeRows(e, e)[0].state;
          }),
          (this.$tokenizeRows = function (e, t) {
            if (!this.doc) return [];
            var i = [],
              n = "start",
              r = !1;
            e > 0 && this.lines[e - 1]
              ? ((n = this.lines[e - 1].state), (r = !0))
              : 0 == e
              ? ((n = "start"), (r = !0))
              : this.lines.length > 0 &&
                (n = this.lines[this.lines.length - 1].state);
            for (var o = this.doc.getLines(e, t), s = e; t >= s; s++)
              if (this.lines[s]) {
                var a = this.lines[s];
                (n = a.state), i.push(a);
              } else {
                var a = this.tokenizer.getLineTokens(o[s - e] || "", n),
                  n = a.state;
                i.push(a), r && (this.lines[s] = a);
              }
            return i;
          });
      }.call(r.prototype),
    ...
    function (e, t) {
      function i() {
        (this.getFoldAt = function (e, t, i) {
          ...
          if (!n) return null;
          for (var r = n.folds, o = 0; r.length > o; o++) {
            var s = r[o];
          ...
          (this.getFoldsInRange = function (e) {
            ...
            for (var o = 0; n.length > o; o++) {
              ...
              if (2 != s) {
                if (-2 == s) break;
                for (var a = n[o].folds, c = 0; a.length > c; c++) {
                  var l = a[c];
                  if (((s = l.range.compareRange(e)), -2 == s)) break;
                  if (2 != s) {
                    if (42 == s) break;
                    r.push(l);
                  }
          ...
          (this.getFoldStringAt = function (e, t, i, n) {
            var n = n || this.getFoldLine(e);
            if (!n) return null;
            for (
              var r = { end: { column: 0 } }, o = 0;
              n.folds.length > o;
              o++
            ) {
              var s = n.folds[o],
                a = s.range.compareEnd(e, t);
              if (-1 == a) {
                var c = this.getLine(s.start.row).substring(
                  r.end.column,
                  s.start.column
                );
                break;
            ...
            return (
              c || (c = this.getLine(s.start.row).substring(r.end.column)),
              -1 == i
                ? c.substring(0, t - r.end.column)
                : 1 == i
                ? c.substring(t - r.end.column)
                : c
            );
          }),
          (this.getFoldLine = function (e, t) {
            ...
            for (
              ...
              var r = i[n];
              if (e >= r.start.row && r.end.row >= e) return r;
              if (r.end.row > e) return null;
            }
            return null;
          }),
          (this.getNextFold = function (e, t) {
            var i = this.$foldData,
              n = 0;
            for (
              t && (n = i.indexOf(t)), -1 == n && (n = 0), n;
          ...
          (this.getFoldedRowCount = function (e, t) {
            for (
              var i = this.$foldData, n = t - e + 1, r = 0;
              i.length > r;
              r++
            ) {
              var o = i[r],
          ...
          (this.addFold = function (e, t) {
            var i = this.$foldData,
              o = !1;
            if (e instanceof r) var s = e;
            else s = new r(t, e);
            var a = s.start.row,
              c = s.start.column,
              l = s.end.row,
              h = s.end.column;
            if (2 > s.placeholder.length)
              throw "Placeholder has to be at least 2 characters";
            if (a == l && 2 > h - c)
              throw "The range has to be at least 2 characters width";
            var d = this.getFoldAt(a, c, 1);
            if (d && d.range.isEnd(l, h) && d.range.isStart(a, c)) return s;
            if (((d = this.getFoldAt(a, c, 1)), d && !d.range.isStart(a, c)))
              throw "A fold can't start inside of an already existing fold";
            if (((d = this.getFoldAt(l, h, -1)), d && !d.range.isEnd(l, h)))
              throw "A fold can't end inside of an already existing fold";
            if (l >= this.doc.getLength())
              throw "End of fold is outside of the document.";
            if (h > this.getLine(l).length || c > this.getLine(a).length)
              throw "End of fold is outside of the document.";
            var u = this.getFoldsInRange(s.range);
            u.length > 0 && (this.removeFolds(u), (s.subFolds = u));
            for (var g = 0; i.length > g; g++) {
              ...
              if (a == p.end.row) {
                if (
                  ...
                  !s.sameRow &&
                    ((foldLineNext = i[g + 1]),
                    foldLineNext && foldLineNext.start.row == l))
                ) {
                  p.merge(foldLineNext);
                  break;
                }
                break;
              }
              if (p.start.row >= l) break;
            }
            return (
              o || (p = this.$addFoldLine(new n(this.$foldData, s))),
              this.$useWrapMode &&
                this.$updateWrapData(p.start.row, p.start.row),
              (this.$modified = !0),
              this._dispatchEvent("changeFold", { data: s }),
              s
            );
          }),
          ...
          (this.removeFold = function (e) {
            ...
            this.$useWrapMode && this.$updateWrapData(i, n),
              (this.$modified = !0),
              this._dispatchEvent("changeFold", { data: e });
          }),
          (this.removeFolds = function (e) {
            for (var t = [], i = 0; e.length > i; i++) t.push(e[i]);
              ...
              e.walk(
                function (e, t, i, a) {
                  if (!(n > t)) {
                    ...
                    s += e ? e : o.getLine(t).substring(a, i);
                  }
                }.bind(this),
                t,
                i
          ...
          (this.getDisplayLine = function (e, t, i, n) {
            ...
            if (!r) {
              var o;
              return (
                (o = this.doc.getLine(e)), o.substring(n || 0, t || o.length)
              );
            }
      ...
      var n = (e("ace/range").Range, e("ace/edit_session/fold_line").FoldLine),
        r = e("ace/edit_session/fold").Fold;
      t.Folding = i;
    }
  ),
  define(
        ...
        (this.shiftRow = function (e) {
            ...
            if (e.sameRow) {
              ...
              this.folds.push(e),
                ...
                this.range.compareEnd(e.start.row, e.start.column) > 0
                  ...
                  : 0 > this.range.compareStart(e.end.row, e.end.column) &&
          ...
          (this.walk = function (e, t, i) {
            ...
            for (var l = 0; a.length > l; l++) {
              if (((n = a[l]), (r = n.range.compareStart(t, i)), -1 == r))
                return e(null, t, i, s, c), void 0;
              if (
                ((o = e(null, n.start.row, n.start.column, s, c)),
                (o = !o && e(n.placeholder, n.start.row, n.start.column, s)),
                o || 0 == r)
              )
                return;
              (c = !n.sameRow), (s = n.end.column);
            }
            e(null, t, i, s, c);
          }),
          (this.getNextFoldTo = function (e, t) {
            for (var i, n, r = 0; this.folds.length > r; r++) {
              if (
                ((i = this.folds[r]), (n = i.range.compareEnd(e, t)), -1 == n)
              )
          ...
          (this.addRemoveChars = function (e, t, i) {
            ...
            if (o) {
              ...
              if (n.start.row == e) {
                r = this.folds;
                var s = r.indexOf(n);
                for (0 == s && (this.start.column += i), s; r.length > s; s++) {
          ...
          (this.merge = function (e) {
            for (var t = e.folds, i = 0; t.length > i; i++) this.addFold(t[i]);
            var n = this.foldData;
          ...
          (this.idxToPosition = function (e) {
            for (var t, i = 0, n = 0; this.folds.length > n; n++) {
              var t = this.folds[n];
          ...
          (this.set = function (e) {
            ...
            (this.find = function (e) {
              ...
              if (this.$options.backwards)
                var t = this.$backwardMatchIterator(e);
              else t = this.$forwardMatchIterator(e);
              var i = null;
              return (
                t.forEach(function (e) {
                  return (i = e), !0;
            ...
            (this.$forwardMatchIterator = function (e) {
              var t = this.$assembleRegExp(),
                i = this;
              return {
                forEach: function (n) {
                  i.$forwardLineIterator(e).forEach(function (e, r, o) {
                    r && (e = e.substring(r));
                    var s = [];
                    e.replace(t, function (e) {
                      var t = arguments[arguments.length - 2];
                      return s.push({ str: e, offset: r + t }), e;
                    });
                    for (var a = 0; s.length > a; a++) {
                      var c = s[a],
                        l = i.$rangeFromMatch(o, c.offset, c.str.length);
                      if (n(l)) return !0;
                    }
                  });
                },
            ...
            (this.$backwardMatchIterator = function (e) {
              var t = this.$assembleRegExp(),
                i = this;
              return {
                forEach: function (n) {
                  i.$backwardLineIterator(e).forEach(function (e, r, o) {
                    r && (e = e.substring(r));
                    var s = [];
            ...
            (this.$rangeFromMatch = function (e, t, i) {
              return new r(e, t, e, t + i);
            }),
            (this.$assembleRegExp = function () {
              if (this.$options.regExp) var e = this.$options.needle;
              else e = i.escapeRegExp(this.$options.needle);
              this.$options.wholeWord && (e = "\\b" + e + "\\b");
              var t = "g";
              this.$options.caseSensitive || (t += "i");
              var n = RegExp(e, t);
              return n;
            }),
            (this.$forwardLineIterator = function (e) {
              function t(t) {
                var o = e.getLine(t);
                return (
                  i && t == n.end.row && (o = o.substring(0, n.end.column)),
                  h && t == r.row && (o = o.substring(0, r.column)),
                  o
                );
              }
              var i = this.$options.scope == o.SELECTION,
                n = e.getSelection().getRange(),
                r = e.getSelection().getCursor(),
                s = i ? n.start.row : 0,
                a = i ? n.start.column : 0,
                c = i ? n.end.row : e.getLength() - 1,
                l = this.$options.wrap,
                h = !1;
              return {
                forEach: function (e) {
            ...
            (this.$backwardLineIterator = function (e) {
              var t = this.$options.scope == o.SELECTION,
                i = e.getSelection().getRange(),
                n = t ? i.end : i.start,
                r = t ? i.start.row : 0,
                s = t ? i.start.column : 0,
                a = t ? i.end.row : e.getLength() - 1,
                c = this.$options.wrap;
              return {
                forEach: function (o) {
                  for (
                    var l = n.row,
                      h = e.getLine(l).substring(0, n.column),
                      d = 0,
                      u = !1,
                      g = !1;
                    !o(h, d, l);
                    ...
                    l == n.row && (u = !0),
                      ...
                      t &&
                        (l == r
                          ? (d = s)
                          : l == a && (h = h.substring(0, i.end.column))),
                      g && l == n.row && (d = n.column);
                  }
                },
              };
            });
      ...
      (this.execute = function (e) {
        ...
        (this.undo = function (e) {
          var t = this.$undoStack.pop(),
            i = null;
          return (
            t && ((i = this.$doc.undoChanges(t, e)), this.$redoStack.push(t)), i
          );
        }),
        (this.redo = function (e) {
          var t = this.$redoStack.pop(),
            i = null;
          return (
            t && ((i = this.$doc.redoChanges(t, e)), this.$undoStack.push(t)), i
          );
        }),
        (this.reset = function () {
  ...
  define(
    ...
    function (e, t) {
      var i = e("pilot/oop"),
        ...
        r = e("pilot/event"),
        o = e("pilot/useragent"),
        s = e("ace/layer/gutter").Gutter,
        a = e("ace/layer/marker").Marker,
        c = e("ace/layer/text").Text,
        l = e("ace/layer/cursor").Cursor,
        h = e("ace/scrollbar").ScrollBar,
        d = e("ace/renderloop").RenderLoop,
        u = e("pilot/event_emitter").EventEmitter,
        g = e("text/ace/css/editor.css");
      n.importCssString(g);
      var p = function (e, t) {
        (this.container = e),
        ...
        (this.canvas = i.element),
          ...
          (this.characterWidth = i.getCharacterWidth()),
          (this.lineHeight = i.getLineHeight()),
          (this.$cursorLayer = new l(this.content)),
          (this.$cursorPadding = 8),
          (this.$horizScroll = !0),
          (this.$horizScrollAlwaysVisible = !0),
          (this.scrollBar = new h(e)),
          this.scrollBar.addEventListener("scroll", this.onScroll.bind(this)),
          (this.scrollTop = 0),
          (this.cursorPos = { row: 0, column: 0 });
        var o = this;
        this.$textLayer.addEventListener("changeCharaterSize", function () {
          (o.characterWidth = i.getCharacterWidth()),
            (o.lineHeight = i.getLineHeight()),
            o.$updatePrintMargin(),
            o.onResize(!0),
            o.$loop.schedule(o.CHANGE_FULL);
        }),
          r.addListener(this.$gutter, "click", this.$onGutterClick.bind(this)),
          r.addListener(
            this.$gutter,
            "dblclick",
          ...
          (this.$loop = new d(this.$renderChanges.bind(this))),
      ...
      (function () {
        (this.showGutter = !0),
          ...
          (this.onResize = function (e) {
            var t = this.CHANGE_SIZE,
              i = this.$size,
              r = n.getInnerHeight(this.container);
            (e || i.height != r) &&
              ((i.height = r),
              (this.scroller.style.height = r + "px"),
              (i.scrollerHeight = this.scroller.clientHeight),
              this.scrollBar.setHeight(i.scrollerHeight),
              this.session &&
                (this.scrollToY(this.getScrollTop()), (t |= this.CHANGE_FULL)));
            var o = n.getInnerWidth(this.container);
            if (e || i.width != o) {
              i.width = o;
              var s = this.showGutter ? this.$gutter.offsetWidth : 0;
              (this.scroller.style.left = s + "px"),
                (i.scrollerWidth = Math.max(
                  0,
                  o - s - this.scrollBar.getWidth()
                )),
                (this.scroller.style.width = i.scrollerWidth + "px"),
                ((this.session.getUseWrapMode() && this.adjustWrapLimit()) ||
                  e) &&
                  (t |= this.CHANGE_FULL);
            }
            this.$loop.schedule(t);
          }),
          (this.adjustWrapLimit = function () {
            var e = this.$size.scrollerWidth - 2 * this.$padding,
              t = Math.floor(e / this.characterWidth) - 1;
            return this.session.adjustWrapLimit(t);
          }),
          (this.$onGutterClick = function (e) {
            var t = r.getDocumentX(e),
              i = r.getDocumentY(e);
            this._dispatchEvent("gutter" + e.type, {
              row: this.screenToTextCoordinates(t, i).row,
              htmlEvent: e,
            });
          }),
          (this.setShowInvisibles = function (e) {
          ...
          (this.$updatePrintMargin = function () {
            ...
            if (this.$showPrintMargin || this.$printMarginEl) {
              this.$printMarginEl ||
                ...
                (e.className = "ace_print_margin_layer"),
                (this.$printMarginEl = n.createElement("div")),
                (this.$printMarginEl.className = "ace_print_margin"),
                e.appendChild(this.$printMarginEl),
                this.content.insertBefore(e, this.$textLayer.element));
          ...
          (this.moveTextAreaToCursor = function (e) {
            if (!o.isIE) {
              var t = this.$cursorLayer.getPixelPosition();
              if (!t) return;
              var i = this.content.getBoundingClientRect(),
                n = this.layerConfig.offset;
              (e.style.left = i.left + t.left + this.$padding + "px"),
                (e.style.top = i.top + t.top - this.scrollTop + n + "px");
            }
          }),
          (this.getFirstVisibleRow = function () {
          ...
          (this.$computeLayerConfig = function () {
            var e = this.session,
              ...
              n = this.$getLongestLine(),
              r =
                (this.layerConfig.width != n,
                this.$horizScrollAlwaysVisible ||
                  0 > this.$size.scrollerWidth - n),
              o = this.$horizScroll !== r;
            (this.$horizScroll = r),
              o && (this.scroller.style.overflowX = r ? "scroll" : "hidden");
            var s = this.session.getScreenLength() * this.lineHeight;
            this.scrollTop = Math.max(
              0,
              Math.min(this.scrollTop, s - this.$size.scrollerHeight)
            );
            var a,
              c,
              l = Math.ceil(i / this.lineHeight) - 1,
              h = Math.max(
                0,
                Math.round((this.scrollTop - t) / this.lineHeight)
              ),
              d = h + l,
              u = { lineHeight: this.lineHeight };
            h = e.screenToDocumentRow(h, 0);
            var g = e.getFoldLine(h);
            g && (h = g.start.row),
              (a = e.documentToScreenRow(h, 0)),
              (c = e.getRowHeight(u, h)),
              (d = Math.min(e.screenToDocumentRow(d, 0), e.getLength() - 1)),
              (i = this.$size.scrollerHeight + e.getRowHeight(u, d) + c),
              (t = this.scrollTop - a * this.lineHeight),
              (this.layerConfig = {
                width: n,
          ...
          (this.$updateLines = function () {
            ...
            if (i.width != this.$getLongestLine())
              return this.$textLayer.update(i);
            if (!(e > i.lastRow + 1)) {
              if (i.firstRow > t) return;
              if (1 / 0 === t)
                return (
          ...
          (this.$getLongestLine = function () {
            var e = this.session.getScreenWidth() + 1;
            return (
          ...
          (this.setBreakpoints = function (e) {
            this.$gutterLayer.setBreakpoints(e),
              this.$loop.schedule(this.CHANGE_GUTTER);
          }),
          (this.setAnnotations = function (e) {
          ...
          (this.scrollCursorIntoView = function () {
            if (0 !== this.$size.scrollerHeight) {
              var e = this.$cursorLayer.getPixelPosition(),
                t = e.left + this.$padding,
                i = e.top;
              this.scrollTop > i && this.scrollToY(i),
              ...
              n > t && this.scrollToX(t),
                n + this.$size.scrollerWidth < t + this.characterWidth &&
                  (t > this.layerConfig.width
                    ? (this.$desiredScrollLeft = t + 2 * this.characterWidth)
                    : this.scrollToX(
                        Math.round(
                          t + this.characterWidth - this.$size.scrollerWidth
                        )
                      ));
            }
          }),
          ...
          (this.scrollToRow = function (e) {
            this.scrollToY(e * this.lineHeight);
          }),
          (this.scrollToLine = function (e, t) {
            for (
              var i = { lineHeight: this.lineHeight }, n = 0, r = 1;
              e > r;
              r++
            )
              n += this.session.getRowHeight(i, r - 1);
            t && (n -= this.$size.scrollerHeight / 2), this.scrollToY(n);
          }),
          ...
          (this.scrollToX = function (e) {
            this.$padding >= e && (e = 0), (this.scroller.scrollLeft = e);
          }),
          (this.scrollBy = function (e, t) {
            t && this.scrollToY(this.scrollTop + t),
              e && this.scrollToX(this.scroller.scrollLeft + e);
          }),
          (this.screenToTextCoordinates = function (e, t) {
            var i = this.scroller.getBoundingClientRect(),
              ...
              o = Math.floor(
                (t + this.scrollTop - i.top - n.getPageScrollTop()) /
                  this.lineHeight
              );
          ...
          (this.textToScreenCoordinates = function (e, t) {
            ...
            return {
              pageX: i.left + r - this.getScrollLeft(),
              pageY: i.top + o - this.getScrollTop(),
            };
          }),
          ...
          (this.showComposition = function () {
            this.$composition ||
              ((this.$composition = n.createElement("div")),
              (this.$composition.className = "ace_composition"),
              this.content.appendChild(this.$composition)),
              (this.$composition.innerHTML = "&#160;");
            var e = this.$cursorLayer.getPixelPosition(),
              t = this.$composition.style;
            (t.top = e.top + "px"),
              (t.left = e.left + this.$padding + "px"),
              (t.height = this.lineHeight + "px"),
              this.hideCursor();
          }),
          (this.setCompositionText = function (e) {
            n.setInnerText(this.$composition, e);
          }),
          (this.hideComposition = function () {
            if ((this.showCursor(), this.$composition)) {
              var e = this.$composition.style;
              (e.top = "-10000px"), (e.left = "-10000px");
            }
          }),
          (this.setTheme = function (t) {
            function i(e) {
              r.$theme && n.removeCssClass(r.container, r.$theme),
                (r.$theme = e ? e.cssClass : null),
                r.$theme && n.addCssClass(r.container, r.$theme),
                r.$size && ((r.$size.width = 0), r.onResize());
            }
            var r = this;
            (this.$themeValue = t),
              t && "string" != typeof t
                ? i(t)
                : ((t = t || "ace/theme/textmate"),
                  e([t], function (e) {
                    i(e);
                  }));
          }),
          ...
          (this.setStyle = function (e) {
            n.addCssClass(this.container, e);
          }),
          (this.unsetStyle = function (e) {
      ...
      (function () {
        (this.setSession = function (e) {
          ...
          (this.setAnnotations = function (e) {
            ...
            for (var t in e)
              if (e.hasOwnProperty(t)) {
                ...
                if (!i) continue;
                for (
                  var n = (this.$annotations[t] = { text: [] }), r = 0;
                  i.length > r;
                  r++
                ) {
                  var o = i[r];
                  ...
                  "error" == s
                    ...
                    : "warning" == s && "ace_error" != n.className
                    ? (n.className = "ace_warning")
                    : "info" == s && !n.className && (n.className = "ace_info");
                }
              }
          }),
          (this.update = function (e) {
            this.$config = e;
            for (
              var t = { className: "", text: [] },
                n = [],
                r = e.firstRow,
                o = e.lastRow,
                s = this.session.getNextFold(r),
                a = s ? s.start.row : 1 / 0;
              r > a &&
                ((r = s.end.row + 1),
                (s = this.session.getNextFold(r)),
              ...
              var c = this.$annotations[r] || t;
              n.push(
                "<div class='ace_gutter-cell",
                this.$decorations[r] || "",
                this.$breakpoints[r] ? " ace_breakpoint " : " ",
                c.className,
                "' title='",
                c.text.join("\n"),
                "' style='height:",
              ...
              for (var l = this.session.getRowLength(r) - 1; l--; )
                n.push(
            ...
            (this.element = i.setInnerHtml(this.element, n.join(""))),
    ...
    function (e, t) {
      ...
      (function () {
        (this.$padding = 0),
            ...
            if (e) {
              ...
              for (var i in this.markers) {
                var r = this.markers[i],
                  o = r.range.clipRows(e.firstRow, e.lastRow);
                if (!o.isEmpty())
                  if (((o = o.toScreenRange(this.session)), r.renderer)) {
                    ...
                    o.isMultiLine()
                      ? "text" == r.type
                        ...
                        : this.drawMultiLineMarker(t, o, r.clazz, e, r.type)
          ...
          (this.drawTextMarker = function (e, t, n, r) {
            var o = t.start.row,
              s = new i(
                o,
                t.start.column,
            ...
            for (
              this.drawSingleLineMarker(e, s, n, r, 1, "text"),
                o = t.end.row,
                s = new i(o, 0, o, t.end.column),
                this.drawSingleLineMarker(e, s, n, r, 0, "text"),
                o = t.start.row + 1;
              t.end.row > o;
              o++
            )
              (s.start.row = o),
                (s.end.row = o),
                (s.end.column = this.session.getScreenLastRowColumn(o)),
                this.drawSingleLineMarker(e, s, n, r, 1, "text");
          }),
          (this.drawMultiLineMarker = function (e, t, i, n, r) {
            var o = "background" === r ? 0 : this.$padding,
              s = n.lineHeight,
              a = Math.round(n.width - t.start.column * n.characterWidth),
              c = this.$getTop(t.start.row, n),
              l = Math.round(o + t.start.column * n.characterWidth);
            e.push(
              "<div class='",
              i,
              "' style='",
              ...
              (a = Math.round(t.end.column * n.characterWidth)),
              e.push(
                "<div class='",
                i,
                "' style='",
          ...
          (this.drawSingleLineMarker = function (e, t, i, n, r, o) {
            var s = "background" === o ? 0 : this.$padding,
              a = n.lineHeight;
            if ("background" === o) var c = n.width;
            else
              c = Math.round(
                (t.end.column + (r || 0) - t.start.column) * n.characterWidth
              );
            var l = this.$getTop(t.start.row, n),
              h = Math.round(s + t.start.column * n.characterWidth);
            e.push(
              "<div class='",
              i,
              "' style='",
  ...
  define(
    ...
    function (e, t) {
      var i = e("pilot/oop"),
        ...
        r = e("pilot/lang"),
        o = e("pilot/useragent"),
        s = e("pilot/event_emitter").EventEmitter,
        a = function (e) {
          (this.element = n.createElement("div")),
        ...
        i.implement(this, s),
          ...
          (this.checkForSizeChanges = function () {
            ...
            e &&
              ...
              this._dispatchEvent("changeCharaterSize", { data: e }));
          }),
          ...
          (this.$measureSizes = function () {
            ...
            if (!this.$measureNode) {
              ...
              if (
                ...
                (i.left = i.top = 40 * -e + "px"),
                (i.visibility = "hidden"),
                (i.position = "absolute"),
                (i.overflow = "visible"),
                (i.whiteSpace = "nowrap"),
                (t.innerHTML = r.stringRepeat("Xy", e)),
                document.body)
              )
            ...
            var i = this.$measureNode.style,
              s = n.computedStyle(this.element);
            for (var a in this.$fontStyles) i[a] = s[a];
            var c = {
          ...
          (this.updateLines = function (e, t, i) {
            ...
            for (var h = r; o >= h; h++) {
              ...
              if (d) {
                var u = [],
                  g = this.session.getTokens(h, h);
                this.$renderLine(u, h, g[0].tokens, !0),
                  (d = n.setInnerHtml(d, u.join(""))),
                  (h = this.session.getRowFoldEnd(h));
              }
            }
          }),
          ...
          (this.$renderLinesFragment = function (e, t, i) {
            for (
              ...
              var c = n.createElement("div"),
                l = [],
                h = this.session.getTokens(o, o);
              1 == h.length && this.$renderLine(l, o, h[0].tokens, !1),
                (c.innerHTML = l.join(""));
              for (var d = c.childNodes; d.length; ) r.appendChild(d[0]);
              o++;
            }
            return r;
          }),
          (this.update = function (e) {
            ...
            for (
              ...
              var c = this.session.getTokens(o, o);
              1 == c.length && this.$renderLine(t, o, c[0].tokens, !1), o++;
            }
            this.element = n.setInnerHtml(this.element, t.join(""));
          }),
          ...
          (this.$renderToken = function (e, t, i, n) {
            var r = this,
              ...
              a = function (e, i, n, s) {
                ...
                if (
                  ...
                  if (r.showInvisibles) {
                    var c = Array(e.length + 1).join(r.SPACE_CHAR);
                    return "<span class='ace_invisible'>" + c + "</span>";
                  }
                  return "&#160;";
                }
                return (
            ...
            if (this.$textToken[i.type]) e.push(c);
              ...
              e.push("<span class='", l, "'>", c, "</span>");
            }
            return t + n.length;
          }),
          (this.$renderLineCore = function (e, t, i, n, r) {
            var o,
              s = 0,
              a = 0,
              c = (this.config.characterWidth, 0),
              l = this;
            (o = n && 0 != n.length ? n[0] : Number.MAX_VALUE),
              r ||
                e.push(
            ...
            for (var h = 0; i.length > h; h++) {
              var d = i[h],
                u = d.value;
              if (o > s + u.length)
                (c = l.$renderToken(e, c, d, u)), (s += u.length);
              else {
                for (; s + u.length >= o; )
                  (c = l.$renderToken(e, c, d, u.substring(0, o - s))),
                    (u = u.substring(o - s)),
                    (s = o),
                    r ||
                      e.push(
                    ...
                    a++,
                    (c = 0),
                    (o = n[a] || Number.MAX_VALUE);
                0 != u.length &&
                  ((s += u.length), (c = l.$renderToken(e, c, d, u)));
              }
            }
            this.showInvisibles &&
          ...
          (this.$renderLine = function (e, t, i, n) {
            if (this.session.isRowFolded(t)) this.$renderFoldLine(e, t, i, n);
            else {
              var r = this.session.getRowSplitData(t);
              this.$renderLineCore(e, t, i, r, n);
            }
          }),
          (this.$renderFoldLine = function (e, t, i, n) {
            function r(e, t, i) {
              for (var n = 0, r = 0; t > r + e[n].value.length; )
                if (((r += e[n].value.length), n++, n == e.length)) return;
              if (r != t) {
                var o = e[n].value.substring(t - r);
                o.length > i - t && (o = o.substring(0, i - t)),
                  a.push({ type: e[n].type, value: o }),
                  (r = t + o.length),
                  (n += 1);
              }
              for (; i > r; ) {
                var o = e[n].value;
                o.length + r > i && (o = o.substring(0, i - r)),
                  a.push({ type: e[n].type, value: o }),
                  (r += o.length),
                  (n += 1);
              }
            ...
            s.walk(
              function (e, t, n, o, s) {
                e
                  ? a.push({ type: "fold", value: e })
                  : (s && (i = this.session.getTokens(t, t)[0].tokens),
                    0 != i.length && r(i, o, n));
              }.bind(this),
              s.end.row,
              this.session.getLine(s.end.row).length
            );
            var c = this.session.$useWrapMode
              ? this.session.$wrapData[t]
              : null;
            this.$renderLineCore(e, t, a, c, n);
          }),
          (this.destroy = function () {
    ...
    function (e, t) {
      var i = e("pilot/dom"),
        n = function (e) {
          (this.element = i.createElement("div")),
            ...
            e.appendChild(this.element),
            (this.cursor = i.createElement("div")),
      ...
      (function () {
        (this.$padding = 0),
          ...
          (this.hideCursor = function () {
            (this.isVisible = !1),
              i.addCssClass(this.cursor, "ace_hidden"),
              clearInterval(this.blinkId);
          }),
          (this.showCursor = function () {
            (this.isVisible = !0),
              i.removeCssClass(this.cursor, "ace_hidden"),
              (this.cursor.style.visibility = "visible"),
              this.restartTimer();
          }),
          (this.restartTimer = function () {
            if ((clearInterval(this.blinkId), this.isVisible)) {
              var e = this.cursor;
          ...
          (this.getPixelPosition = function (e) {
            if (!this.config || !this.session) return { left: 0, top: 0 };
            var t = this.session.selection.getCursor(),
              i = this.session.documentToScreenPosition(t),
              n = Math.round(
                this.$padding + i.column * this.config.characterWidth
              ),
              r =
                (i.row - (e ? this.config.firstRowScreen : 0)) *
                this.config.lineHeight;
            return { left: n, top: r };
          }),
          (this.update = function (e) {
            ...
            t != this.overwrite &&
              ((this.overwrite = t),
              t
                ? i.addCssClass(this.cursor, "ace_overwrite")
                : i.removeCssClass(this.cursor, "ace_overwrite")),
              this.restartTimer();
          }),
          (this.destroy = function () {
            clearInterval(this.blinkId);
          ...
          this.setTimeoutZero
            ...
            ? ((this.messageName = "zero-timeout-message"),
              (this.setTimeoutZero = function (e) {
                if (!this.attached) {
                  var t = this;
                  i.addListener(window, "message", function (e) {
                    t.callback &&
                      e.data == t.messageName &&
                      (i.stopPropagation(e), t.callback());
                  }),
                    (this.attached = !0);
                }
                (this.callback = e), window.postMessage(this.messageName, "*");
              }))
            : (this.setTimeoutZero = function (e) {
                setTimeout(e, 0);
              });
  ...
  define(
    ...
    function (e, t) {
      ...
      i.importCssString(n), (t.cssClass = "ace-tm");
    }
  ),
  define(
    "pilot/environment",
    ...
    function (e, t) {
      ...
      var n = e("pilot/settings").settings;
      t.create = i;
    }
  ),
  define(
