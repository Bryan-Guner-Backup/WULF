  ...
  define(
    ...
    function (a, b, c) {
      ...
      function l(a, b, c, d, e) {
        ...
        if (typeof c == "number")
          (this.start = c), (this.end = d), (this.predictions = e);
        else {
          var f = c;
          (this.start = f.start),
            (this.end = f.end),
            (this.predictions = f.predictions);
        }
      }
      ...
      (b.startup = function (a, b) {
        ...
        (n.prototype = {
          merge: function (a) {
            if (a.emitter != this.emitter)
              throw new Error(
                "Can't merge Arguments from different EventEmitters"
              );
            return new n(
              this.emitter,
        ...
        (o.prototype = {
          ...
          getHint: function () {
            ...
            this.param.defaultValue === undefined &&
              !h &&
              ((c = i.INVALID), (b += "<strong>Required<strong>"));
          ...
          isPositionCaptured: function (a) {
            return this.arg
              ? this.arg.start === -1
                ...
                ? !1
                : a === this.arg.end
                ? this.conversion.status !== i.VALID ||
                  this.conversion.predictions.length !== 0
                : !0
              : !1;
          },
      ...
      (q.prototype = {
          ...
          a.push(this.commandAssignment.value.name),
            Object.keys(this._assignments).forEach(function (b) {
              var c = this._assignments[b],
                d = c.param.type;
              c.value !== c.param.defaultValue &&
                (a.push(" "), a.push(d.stringify(c.value)));
            }, this);
          return a.join("");
        },
      }),
        ...
        (function () {
          (r.prototype.update = function (a) {
            ...
            this._split(b),
              this.commandAssignment.value && this._assign(b),
              this._updateHints();
          }),
              ...
              for (;;) {
                ...
                switch (f) {
                  ...
                  case d:
                    if (p === "'") {
                      var l = g(a.substring(i, h));
                      k.push(new n(this, l, i - 1, h + 1, j, p)),
                        (f = b),
                        (i = h + 1),
                        (j = "");
                    }
                ...
                c.forEach(function (b) {
                  ...
                  for (;;) {
                    ...
                    b.param.type.name === "boolean"
                      ...
                      : f + 1 < a.length
                      ? this._hints.push(
                          new l(i.INCOMPLETE, "Missing value for: " + c, a[f])
                        )
    ...
    function (a, b, c) {
      var d = a("pilot/types"),
        ...
        h = {
          ...
          description:
            "Is the output window shown above or below the command line?",
          type: "direction",
          defaultValue: "above",
        },
        i = {
      ...
      (b.startup = function (a, b) {
        ...
        (n.prototype = {
          createElements: function () {
            function d() {
              f.removeCssClass(this.output, "cptFocusPopup"),
                f.removeCssClass(this.hinter, "cptFocusPopup");
            }
            var a = this.element;
            ...
            (this.completer = this.doc.createElement("div")),
              ...
              (this.completer.style.fontFamily = f.computedStyle(
                a,
                "fontFamily"
              )),
              (this.completer.style.fontWeight = f.computedStyle(
                a,
                "fontWeight"
              )),
              (this.completer.style.fontStyle = f.computedStyle(
                a,
                "fontStyle"
              )),
            ...
            e.addListener(this.win, "resize", c),
              ...
              this.cli.addEventListener(
                "argumentChange",
                this.onArgChange.bind(this)
              ),
              e.addListener(
                a,
                "focus",
                function () {
                  f.addCssClass(this.output, "cptFocusPopup"),
                    f.addCssClass(this.hinter, "cptFocusPopup");
                }.bind(this)
              ),
            ...
            (this.completer.style.width = c + "px"),
              this.hintDirection.get() === "below"
                ...
                : ((this.hinter.style.top = "auto"),
                  (this.hinter.style.bottom =
                    this.doc.documentElement.clientHeight - a.top + "px")),
          ...
          onCommandKey: function (a, b, c) {
            ...
            if (c === g.TAB || c === g.UP || c === g.DOWN) d = !0;
              ...
              d = h.execKeyCommand(this.env, "cli", b, c);
            d && e.stopEvent(a);
          },
          onKeyUp: function (a) {
            var b;
            if (a.keyCode === g.RETURN) {
              ...
              c.status === i.VALID
                ...
                : (f.setSelectionStart(this.element, c.start),
                  f.setSelectionEnd(this.element, c.end));
            }
            this.update();
          ...
          update: function () {
            ...
            var a = {
              ...
              cursor: {
                start: f.getSelectionStart(this.element),
                end: f.getSelectionEnd(this.element.selectionEnd),
              },
            };
            this.cli.update(a);
            ...
            (this.completer.innerHTML = c),
              f.addCssClass(
                this.completer,
                this.cli.getWorstHint().status.toString()
              );
            var g = "";
            this.element.value.length !== 0 &&
              ((g += b.message),
              ...
              g.length === 0
                ? f.addCssClass(this.hinter, "cptNoPopup")
                : f.removeCssClass(this.hinter, "cptNoPopup"),
              (this.isUpdating = !1);
          },
          markupStatusScore: function (a) {
            ...
            for (;;) {
              d !== a[c] &&
                ((b += "<span class=" + a[c].toString() + ">"), (d = a[c])),
      ...
      function l(a, b) {
        (this.request = a),
          ...
          this.request.addEventListener(
            "output",
            this.onRequestChange.bind(this)
          );
      }
      function k(b) {
        var d;
      ...
      (Templater.prototype.processNode = function (a, b) {
        ...
        try {
          if (a.attributes && a.attributes.length) {
            ...
            if (a.hasAttribute("if") && !this.processIf(a, b)) return;
            b.__element = a;
                ...
                if (f === "save")
                  ...
                  typeof g != "function" &&
                    this.handleError(
                      "Expected " +
                        e +
                        " to resolve to a function, but got " +
                        typeof g
                    ),
                    a.removeAttribute(f);
                  var h = a.hasAttribute("capture" + f.substring(2));
                  a.addEventListener(f.substring(2), g, h),
                    h && a.removeAttribute("capture" + f.substring(2));
                } else {
                  var i = this,
          ...
          d.length > 1 &&
            (d.forEach(function (c) {
              c !== null &&
                ...
                c !== "" &&
                (c.charAt(0) === "$" &&
                  (c = this.envEval(c.slice(1), b, a.data)),
                c === null && (c = "null"),
                c === undefined && (c = "undefined"),
                typeof c.cloneNode != "function" &&
                  (c = a.ownerDocument.createTextNode(c.toString())),
        ...
        (Templater.prototype.envEval = function (script, env, context) {
          with (env)
            try {
              ...
              this.handleError(
                "Template error evaluating '" + script + "'",
                ex
              );
              return script;
            } finally {
