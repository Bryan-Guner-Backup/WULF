define(
  ...
  function (e, t) {
    var i = e("pilot/oop"),
      ...
      o = e("ace/mode/clojure_highlight_rules").ClojureHighlightRules,
      s = e("ace/mode/matching_parens_outdent").MatchingParensOutdent,
      a = e("ace/range").Range,
      c = function () {
        ...
        (this.toggleCommentLines = function (e, t, i, n) {
          ...
          (this.getNextLineIndent = function (e, t) {
            var i = this.$getIndent(t),
              n = this.$tokenizer.getLineTokens(t, e),
              r = n.tokens;
            if ((n.state, r.length && "comment" == r[r.length - 1].type))
              return i;
            if ("start" == e) {
              var o = t.match(/[\(\[]/);
              o && (i += "  "), (o = t.match(/[\)]/)), o && (i = "");
  ...
  define(
    ...
    function (e, t) {
      var i = e("pilot/oop"),
        ...
        o = function () {
          var e = n.arrayToMap(
            ...
            i = n.arrayToMap("true false nil".split(" "));
          this.$rules = {
            start: [
              { token: "comment", regex: ";.*$" },
      ...
      i.inherits(o, r), (t.ClojureHighlightRules = o);
    }
  ),
  define(
    "ace/mode/matching_parens_outdent",
