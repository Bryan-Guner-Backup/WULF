define(
  ...
  function (e, t) {
    function i() {
      (this.$tokenizer = new n(new r().getRules())), (this.$outdent = new o());
    }
    var n = e("ace/tokenizer").Tokenizer,
      r = e("ace/mode/coffee_highlight_rules").CoffeeHighlightRules,
      o = e("ace/mode/matching_brace_outdent").MatchingBraceOutdent,
      s = e("ace/range").Range,
      ...
      function () {
        ...
        (this.getNextLineIndent = function (t, i, n) {
          var r = this.$getIndent(i),
            o = this.$tokenizer.getLineTokens(i, t).tokens;
          return (
          ...
          (this.toggleCommentLines = function (e, r, o, a) {
            console.log("toggle");
            for (var c = new s(0, 0, 0, 0), l = o; a >= l; ++l) {
              var h = r.getLine(l);
              i.test(h) ||
                ((h = t.test(h) ? h.replace(t, "$1") : h.replace(n, "$&#")),
                (c.end.row = c.start.row = l),
                (c.end.column = h.length + 1),
                r.replace(c, h));
            }
          }),
    ...
    function (e, t) {
      function i() {
        var e = "[$A-Za-z_\\x7f-\\uffff][$\\w\\x7f-\\uffff]*",
          t = "(?![$\\w]|\\s*:)",
          i = { token: "string", merge: !0, regex: ".+" };
        this.$rules = {
          start: [
            { token: "identifier", regex: "(?:@|(?:\\.|::)\\s*)" + e },
            {
              token: "keyword",
              regex:
            ...
            },
            {
              ...
              regex: "(?:true|false|null|undefined)" + t,
            },
            {
          ...
          qdoc: [{ token: "string", regex: ".*?'''", next: "start" }, i],
          qqdoc: [{ token: "string", regex: '.*?"""', next: "start" }, i],
          qstring: [
            {
              token: "string",
              regex: "[^\\\\']*(?:\\\\.[^\\\\']*)*'",
      ...
      e("pilot/oop").inherits(
        i,
        e("ace/mode/text_highlight_rules").TextHighlightRules
      ),
        (t.CoffeeHighlightRules = i);
    }
  ),
  define(
    "ace/mode/matching_brace_outdent",
