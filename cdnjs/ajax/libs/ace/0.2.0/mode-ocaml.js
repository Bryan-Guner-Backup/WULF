define(
  ...
  function (a, b, c) {
    var d = a("pilot/oop"),
      ...
      g = a("ace/mode/ocaml_highlight_rules").OcamlHighlightRules,
      ...
      (this.toggleCommentLines = function (a, b, c, d) {
        ...
        for (e = c; e <= d; e++)
          (f = b.getLine(e)),
            (j.start.row = e),
            (j.end.row = e),
            (j.end.column = f.length),
            b.replace(j, g ? f.match(h)[1] : "(*" + f + "*)");
      }),
  ...
  define(
    ...
    function (a, b, c) {
      var d = a("pilot/oop"),
        ...
        g = function () {
          var a = e.arrayToMap(
              "and|as|assert|begin|class|constraint|do|done|downto|else|end|exception|external|for|fun|function|functor|if|in|include|inherit|initializer|lazy|let|match|method|module|mutable|new|object|of|open|or|private|rec|sig|struct|then|to|try|type|val|virtual|when|while|with".split(
                "|"
              )
            ),
      ...
      d.inherits(g, f), (b.OcamlHighlightRules = g);
    }
  ),
  define(
    "ace/mode/matching_brace_outdent",
