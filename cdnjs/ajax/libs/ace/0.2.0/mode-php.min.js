define(
  ...
  function (e, t) {
    var i = e("pilot/oop"),
      ...
      o = e("ace/mode/php_highlight_rules").PhpHighlightRules,
      s = e("ace/mode/matching_brace_outdent").MatchingBraceOutdent,
      a = e("ace/range").Range,
      c = e("ace/mode/behaviour/cstyle").CstyleBehaviour,
      l = function () {
        ...
        (this.toggleCommentLines = function (e, t, i, n) {
          ...
          (this.getNextLineIndent = function (e, t, i) {
            var n = this.$getIndent(t),
              ...
              o = r.tokens;
            if ((r.state, o.length && "comment" == o[o.length - 1].type))
              return n;
            if ("start" == e) {
              var s = t.match(/^.*[\{\(\[\:]\s*$/);
              s && (n += i);
  ...
  define(
    ...
    function (e, t) {
      var i = e("pilot/oop"),
        ...
        s = function () {
          var e = n.arrayToMap(
            ...
            c = n.arrayToMap("cfunction|old_function".split("|")),
            l = n.arrayToMap([]);
          (this.$rules = {
            start: [
              { token: "support", regex: "<\\?(?:php|\\=)" },
              { token: "support", regex: "\\?>" },
              { token: "comment", regex: "\\/\\/.*$" },
              { token: "comment", regex: "#.*$" },
              ...
              },
              {
                token: function (n) {
                  return c.hasOwnProperty(n)
                    ...
                    : e.hasOwnProperty(n)
                    ? "support.function"
                    : n.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*|self|parent)$/)
                    ? "variable"
                    : "identifier";
                },
      ...
      i.inherits(s, o), (t.PhpHighlightRules = s);
    }
  ),
  define(
    "ace/mode/doc_comment_highlight_rules",
            ...
            if ("}" == r) {
              ...
              if ("}" == l) {
                ...
                var g = this.getNextLineIndent(
                  ...
                  p = this.$getIndent(n.doc.getLine(u.row));
                return {
                  text: "\n" + g + "\n" + p,
