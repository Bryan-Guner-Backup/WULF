define(
  ...
  function (a, b, c) {
    var d = a("pilot/oop"),
      ...
      g = a("ace/mode/scala_highlight_rules").ScalaHighlightRules,
  ...
  define(
    ...
    function (a, b, c) {
      var d = a("pilot/oop"),
        ...
        h = function () {
          var a = e.arrayToMap(
              "case|default|do|else|for|if|match|while|throw|return|try|catch|finally|yield|abstract|class|def|extends|final|forSome|implicit|implicits|import|lazy|new|object|override|package|private|protected|sealed|super|this|trait|type|val|var|with".split(
                "|"
              )
            ),
            b = e.arrayToMap("true|false".split("|")),
            c = e.arrayToMap(
