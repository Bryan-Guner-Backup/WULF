define(
  ...
  function (e, t) {
    var i = e("pilot/oop"),
      ...
      o = e("ace/mode/scss_highlight_rules").ScssHighlightRules,
  ...
  define(
    ...
    function (e, t) {
        ...
        o = function () {
          ...
          this.$rules = {
            start: [
              ...
              { token: "constant.numeric", regex: c + e("em") },
              { token: "constant.numeric", regex: c + e("ex") },
              { token: "constant.numeric", regex: c + e("px") },
              { token: "constant.numeric", regex: c + e("cm") },
              { token: "constant.numeric", regex: c + e("mm") },
              { token: "constant.numeric", regex: c + e("in") },
              { token: "constant.numeric", regex: c + e("pt") },
              { token: "constant.numeric", regex: c + e("pc") },
              { token: "constant.numeric", regex: c + e("deg") },
              { token: "constant.numeric", regex: c + e("rad") },
              { token: "constant.numeric", regex: c + e("grad") },
              { token: "constant.numeric", regex: c + e("ms") },
              { token: "constant.numeric", regex: c + e("s") },
              { token: "constant.numeric", regex: c + e("hz") },
              { token: "constant.numeric", regex: c + e("khz") },
              ...
              { token: "constant.numeric", regex: c },
              {
                token: function (e) {
                  return t.hasOwnProperty(e.toLowerCase())
                    ...
                    : a.hasOwnProperty(e.toLowerCase())
                    ? "variable.language"
                    : "text";
                },
      ...
      i.inherits(o, r), (t.ScssHighlightRules = o);
    }
  ),
  define(
    "ace/mode/matching_brace_outdent",
