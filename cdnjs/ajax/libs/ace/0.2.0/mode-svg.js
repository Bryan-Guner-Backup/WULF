define(
  ...
  function (a, b, c) {
    var d = a("pilot/oop"),
      ...
      g = a("ace/tokenizer").Tokenizer,
      h = a("ace/mode/svg_highlight_rules").SvgHighlightRules,
      i = a("ace/mode/behaviour/xml").XmlBehaviour,
      j = function () {
        (this.highlighter = new h()),
          (this.$tokenizer = new g(this.highlighter.getRules())),
          (this.$behaviour = new i()),
          (this.$embeds = this.highlighter.getEmbeds()),
          this.createModeDelegates({ "js-": f });
      };
    d.inherits(j, e),
      function () {
  ...
  define(
    ...
    function (a, b, c) {
      var d = a("pilot/oop"),
        e = a("ace/mode/javascript_highlight_rules").JavaScriptHighlightRules,
        f = a("ace/mode/xml_highlight_rules").XmlHighlightRules,
        g = function () {
          f.call(this),
      ...
      d.inherits(g, f), (b.SvgHighlightRules = g);
    }
  ),
  define(
    "ace/mode/xml_highlight_rules",
