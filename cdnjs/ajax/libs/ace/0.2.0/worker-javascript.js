...
(onmessage = function (a) {
      ...
      d.inherits(g, e),
        function () {
          this.onUpdate = function () {
            ...
            f(b, { undef: !1, onevar: !1, passfail: !1 }),
      ...
      var d = (function () {
        function bZ() {
          function b() {
            ...
            if (x.id !== "]")
              for (;;) {
                if (x.id === "(end)")
                  bg("Missing ']' to match '[' from line {a}.", x, a.line);
                else {
                  if (x.id === "]") {
          ...
          function a() {
            ...
            if (x.id !== "}")
              for (;;) {
                if (x.id === "(end)")
                  bg("Missing '}' to match '{' from line {a}.", x, b.line);
                else {
                  if (x.id === "}") {
                    be("Unexpected comma.", O);
                    break;
                  ...
                  x.id === ","
                    ? bg("Unexpected comma.", x)
                    : x.id !== "(string)" &&
                      be("Expected a string and instead saw {a}.", x, x.value);
                }
                a[x.value] === !0
                  ? be("Duplicate key '{a}'.", x, x.value)
                  : (x.value === "__proto__" && !A.proto) ||
                    (x.value === "__iterator__" && !A.iterator)
                  ? be(
          ...
          switch (x.id) {
            ...
            case "-":
              bm("-"),
                O.character !== x.from && be("Unexpected space after '-'.", O),
                bo(O, x),
                bm("(number)");
              break;
            default:
        ...
        function bV() {
          ...
          a ||
            (x.id === "(string)"
              ? ((a = x.value), bm())
              : x.id === "(number)" && ((a = x.value.toString()), bm()));
          return a;
        }
        function bU(a) {
          var b = a.value,
          ...
          typeof d == "function" && (d = !1),
            d ? d[d.length - 1] !== c && d.push(c) : ((d = [c]), (n[b] = d));
        }
        function bT(a) {
          v &&
            typeof v[a] != "boolean" &&
            be("Unexpected /*member '{a}'.", O, a),
            typeof u[a] == "number" ? (u[a] += 1) : (u[a] = 1);
        }
        function bS(a, b) {
          var c,
            d = o,
          ...
          if (x.id === "{") {
            ...
            if (x.id !== "}" || O.line !== x.line) {
              ...
              !a &&
                ...
                A.strict &&
                j["(context)"]["(global)"] &&
                be('Missing "use strict" statement.'),
                (c = bR()),
                (L = f),
                (p -= A.indent),
                bt();
            ...
            a
              ? ((!b || A.curly) &&
                  be("Expected '{a}' and instead saw '{b}'.", x, "{", x.value),
                (z = !0),
                (c = [bP()]),
                (z = !1))
              : bg("Expected '{a}' and instead saw '{b}'.", x, "{", x.value);
          (j["(verb)"] = null),
            (G = g),
            (o = d),
            a && A.noempty && (!c || c.length === 0) && be("Empty block.");
          return c;
        }
        function bR(a) {
          var b = [],
            c,
            d;
          while (!x.reach && x.id !== "(end)")
            x.id === ";"
              ? (be("Unnecessary semicolon."), bm(";"))
              : b.push(bP());
          return b;
        }
        function bQ() {
          if (x.value === "use strict") {
            L && be('Unnecessary "use strict".'),
              bm(),
              bm(";"),
              (L = !0),
              (A.newcap = !0),
        ...
        function bP(a) {
          var b = p,
            ...
            d = G,
            e = x;
          if (e.id === ";") be("Unnecessary semicolon.", e), bm(";");
          else {
            e.identifier &&
              !e.reserved &&
              bl().id === ":" &&
              ...
              bj(e.value, "label"),
              x.labelled ||
                be("Label '{a}' on {b} statement.", x, e.value, x.value),
              Z.test(e.value + ":") &&
                be("Label '{a}' looks like a javascript url.", e, e.value),
              (x.label = e.value),
              (e = x)),
              a || bt(),
              (c = bn(0, !0)),
              e.block ||
                (!A.expr && (!c || !c.exps)
                  ...
                  : A.nonew &&
                    c.id === "(" &&
                    c.left.id === "new" &&
                    be("Do not use 'new' for side effects."),
                x.id !== ";"
                  ? !A.asi &&
                    (!A.lastsemic || x.id != "}" || x.line != O.line) &&
                    bf("Missing semicolon.", O.line, O.from + O.value.length)
                  : (bo(O, x), bm(";"), br(O, x))),
              (p = b),
              (G = d);
            return c;
        ...
        function bN(a) {
          ...
          if (b) return b;
          O.id === "function" && x.id === "("
            ? be("Missing name in function declaration.")
            : bg("Expected an identifier and instead saw '{a}'.", x, x.value);
        }
        function bM(a) {
          if (x.identifier) {
            bm(),
        ...
        function bL(a, b) {
          ...
          c.led = function (a) {
            A.plusplus
              ? be("Unexpected use of '{a}'.", this, this.id)
        ...
        function bK(a) {
          ...
          return bF(
            a,
            function (a, b) {
              A.bitwise && be("Unexpected use of '{a}'.", b, b.id),
                br(D, O),
                br(O, x);
              if (a) {
                if (
          ...
          bA(d),
            (d.led =
              typeof b == "function"
                ? b
                : function (a) {
                    A.bitwise && be("Unexpected use of '{a}'.", this, this.id),
                      (this.left = a),
                      (this.right = bn(c));
                    return this;
                  });
        ...
        function bI(a, b) {
          ...
          return bF(
            ...
            function (a, b) {
              var c;
              (b.left = a),
                B[a.value] === !1 && G[a.value]["(global)"] === !0
                  ? be("Read only.", a)
                  : a["function"] && be("'{a}' is a function.", a, a.value);
              if (a) {
                if (a.id === "." || a.id === "[") {
                ...
                if (a.identifier && !a.reserved) {
                  j[a.value] === "exception" &&
                    be("Do not assign to the exception parameter.", a),
                    (b.right = bn(19));
                  return b;
                }
                a === M["function"] &&
        ...
        function bG(a, b) {
          ...
          c.led = function (a) {
            ...
            (a && a.id === "NaN") || (c && c.id === "NaN")
              ? be("Use the isNaN function to compare with NaN.", this)
              : b && b.apply(this, [a, c]),
              a.id === "!" && be("Confusing use of '{a}'.", a, "!"),
              c.id === "!" && be("Confusing use of '{a}'.", a, "!"),
              (this.left = a),
              (this.right = c);
            return this;
          };
        ...
        function bw(a, b) {
          ...
          if (!c || typeof c != "object")
            M[a] = c = { id: a, lbp: b, value: a };
          return c;
        }
        function bv() {
          O.line !== x.line
            ? A.laxbreak || be("Bad line breaking before '{a}'.", O, x.id)
            : O.character !== x.from &&
              A.white &&
              be("Unexpected space after '{a}'.", x, O.value),
            bm(","),
            br(O, x);
        }
        function bu(a) {
          (a = a || O),
            a.line !== x.line && be("Line breaking error '{a}'.", a, a.value);
        }
        function bt(a) {
          var b;
          A.white &&
        ...
        function bs(a, b) {
          (a = a || O),
            (b = b || x),
            !A.laxbreak && a.line !== b.line
              ? be("Bad line breaking before '{a}'.", b, b.id)
              : A.white &&
                ((a = a || O),
                (b = b || x),
                a.character === b.from &&
                  be("Missing space after '{a}'.", x, a.value));
        }
        function br(a, b) {
          A.white &&
            ((a = a || O),
        ...
        function bq(a, b) {
          (a = a || O),
            (b = b || x),
            A.white && !a.comment && a.line === b.line && bo(a, b);
        }
        function bp(a, b) {
          (a = a || O),
            (b = b || x),
            A.white &&
              ...
              be("Unexpected space before '{a}'.", b, b.value);
        }
        function bo(a, b) {
          (a = a || O),
            (b = b || x),
            A.white &&
              a.character !== b.from &&
              a.line === b.line &&
              be("Unexpected space after '{a}'.", b, a.value);
        }
        function bn(b, c) {
          var d,
            e = !1;
          x.id === "(end)" && bg("Unexpected early end of program.", O),
            bm(),
            c && ((a = "anonymous"), (j["(verb)"] = O.value));
          if (c === !0 && O.fud) d = O.fud();
          else {
            if (O.nud) d = O.nud();
            else {
              if (x.type === "(number)" && O.id === ".") {
                be(
            ...
            while (b < x.lbp)
              (e = O.value == "Array"),
                ...
                e &&
                  O.id == "(" &&
                  x.id == ")" &&
                  be("Use the array literal notation [].", O),
                O.led
                  ? (d = O.led(d))
                  : bg("Expected an operator and instead saw '{a}'.", O, O.id);
          }
          return d;
        }
        function bm(b, c) {
          ...
          b &&
            ...
            (c
              ...
              : (x.type !== "(identifier)" || x.value !== b) &&
                be("Expected '{a}' and instead saw '{b}'.", x, b, x.value)),
            (D = O),
            (O = x);
          for (;;) {
            x = t.shift() || bi.token();
          ...
          loop: for (;;) {
            ...
            f.type !== "(string)" &&
              ...
              g.id === ":"
                ? ((g = bi.token()),
                  b === v &&
                    bg("Expected '{a}' and instead saw '{b}'.", f, "*/", ":"),
        ...
        function bj(a, b) {
          a === "hasOwnProperty" &&
            be("'hasOwnProperty' is a really bad name."),
            ba(j, a) &&
              !j["(global)"] &&
              (j[a] === !0
                ? A.latedef && be("'{a}' was used before it was defined.", x, a)
                : A.shadow || be("'{a}' is already defined.", x, a)),
            (j[a] = b),
            j["(global)"]
              ? ((m[a] = j),
                ba(n, a) &&
                  (A.latedef &&
                    be("'{a}' was used before it was defined.", x, a),
                  delete n[a]))
              : (G[a] = j);
        }
        function bh(a, b, c, d, e, f, g) {
          return bg(a, { line: b, from: c }, d, e, f, g);
        }
        ...
        function bf(a, b, c, d, e, f, g) {
          return be(a, { line: b, from: c }, d, e, f, g);
        }
        function be(a, b, c, e, f, g) {
          ...
          (b = b || x),
            ...
            d.errors.push(j),
            A.passfail && bd("Stopping. ", i, h),
            (Q += 1),
            Q >= A.maxerr && bd("Too many errors.", i, h);
          return j;
        }
        function bd(a, b, c) {
        ...
        function bc() {
          A.couch && bb(B, f),
            ...
            A.mootools && bb(B, w),
            A.wsh && bb(B, R),
            A.globalstrict && A.strict !== !1 && (A.strict = !0);
        }
        function bb(a, b) {
          var c;
        ...
        var a,
          ...
          h = { dojo: !1, dijit: !1, dojox: !1, define: !1, require: !1 },
          i = {
            "\b": "\\b",
            "\t": "\\t",
            "\n": "\\n",
        ...
        var bi = (function () {
          function f(d, e) {
            ...
            d === "(color)" || d === "(range)"
              ? (g = { type: d })
              : d === "(punctuator)" || (d === "(identifier)" && ba(M, e))
              ? (g = M[e] || M["(error)"])
              : (g = M[d]),
              (g = Object.create(g)),
              (d === "(string)" || d === "(range)") &&
              ...
              d === "(identifier)" &&
                ((g.identifier = !0),
                e === "__proto__" && !A.proto
                  ? bf("The '{a}' property is deprecated.", c, b, e)
                  : e === "__iterator__" && !A.iterator
                  ? bf("'{a}' is only available in JavaScript 1.7.", c, b, e)
                  : A.nomen &&
                    (e.charAt(0) === "_" || e.charAt(e.length - 1) === "_") &&
                    bf("Unexpected {a} in '{b}'.", c, b, "dangling '_'", e)),
              (g.value = e),
              (g.line = c),
              (g.character = a),
              (g.from = b),
          ...
          function e() {
            ...
            (a = 1),
              ...
              (c += 1),
              (b = d.search(/ \t/)),
              b >= 0 && bf("Mixed spaces and tabs.", c, b + 1),
              (d = d.replace(/\t/g, N)),
              (b = d.search(T)),
              b >= 0 && bf("Unsafe character.", c, b),
              A.maxlen &&
                A.maxlen < d.length &&
                bf("Line too long.", c, d.length),
              (e = d.search(/\s+$/)),
              A.trailing &&
                ~e &&
                !~d.search(/^\s+$/) &&
                bf("Trailing whitespace.", c, e);
            return !0;
          }
          var a, b, c, d;
          return {
            ...
            token: function () {
              function t(g) {
                ...
                var h,
                  i,
                  j = "";
                q && g !== '"' && bf("Strings must use doublequote.", c, a),
                  (i = 0);
                for (;;) {
                  while (i >= d.length)
                    (i = 0), e() || bh("Unclosed string.", c, b);
                  h = d.charAt(i);
                  if (h === g) {
                    (a += 1), (d = d.substr(i + 1));
                    return f("(string)", j, g);
              ...
              for (;;) {
                ...
                if (!r) {
                  ...
                  if (h.isAlpha() || h === "_" || h === "$")
                    return f("(identifier)", r);
                  if (h.isDigit()) {
                    isFinite(Number(r)) || bf("Bad number '{a}'.", c, a, r),
                      d.substr(0, 1).isAlpha() &&
                        bf("Missing space after '{a}'.", c, a, r),
                      h === "0" &&
                        ((j = r.substr(1, 1)),
                        j.isDigit()
                          ? O.id !== "." &&
                            bf("Don't use extra leading zeros '{a}'.", c, a, r)
                          : q &&
                            (j === "x" || j === "X") &&
                            bf("Avoid 0x-. '{a}'.", c, a, r)),
                      r.substr(r.length - 1) === "." &&
                  ...
                  switch (r) {
                    ...
                    case "/*":
                      ...
                      (a += m + 2),
                        d.substr(m, 1) === "/" && bh("Nested comment.", c, a),
                        (d = d.substr(m + 2)),
                        (O.comment = !0);
                      break;
                    case "/*members":
                        ...
                        for (;;) {
                          ...
                          switch (h) {
                            case "":
                              ...
                              return;
                            case "/":
                              k > 0 && bf("Unescaped '{a}'.", c, b + n, "/"),
                                (h = d.substr(0, n - 1)),
                                (p = { g: !0, i: !0, m: !0 });
                              while (p[d.charAt(n)] === !0)
                                (p[d.charAt(n)] = !1), (n += 1);
                              (a += n),
                                (d = d.substr(n)),
                                (p = d.charAt(0)),
                                (p === "/" || p === "*") &&
                                  bh("Confusing regular expression.", c, b);
                              return f("(regexp)", h);
                            case "\\":
                              (h = d.charAt(n)),
                                h < " "
                            ...
                            case "[":
                              (h = d.charAt(n)),
                                h === "^" &&
                                  ((n += 1),
                                  A.regexp
                                    ? bf("Insecure '{a}'.", c, b + n, h)
                                    : d.charAt(n) === "]" &&
                                      bh("Unescaped '{a}'.", c, b + n, "^")),
                                (p = !1),
                                h === "]" &&
                                  (bf("Empty class.", c, b + n - 1), (p = !0));
                              klass: do {
                                (h = d.charAt(n)), (n += 1);
                                switch (h) {
                                  case "[":
        ...
        bC("(number)", function () {
                ...
                switch (j[b]) {
                  ...
                  default:
                    if (c === !0) j[b] = !0;
                      ...
                      be("'{a}' is not allowed.", O, b), bU(O);
                    else if (typeof c != "object")
                      a != "typeof" && a != "delete" && A.undef
                        ? be("'{a}' is not defined.", O, b)
                        : (j[b] = !0),
                        bU(O);
                    else
          ...
          bE("this", function (a) {
            L &&
              ((j["(statement)"] && j["(name)"].charAt(0) > "Z") ||
                j["(global)"]) &&
              be("Strict violation.", a);
          }),
          bE("true"),
          bE("undefined"),
          bI("=", "assign", 20),
          ...
          bK("|=", "assignbitor", 20),
          bK("^=", "assignbitxor", 20),
          bK("<<=", "assignshiftleft", 20),
          bK(">>=", "assignshiftright", 20),
          bK(">>>=", "assignshiftrightunsigned", 20),
          bF(
            "?",
            function (a, b) {
              (b.left = a), (b.right = bn(10)), bm(":"), (b["else"] = bn(10));
              return b;
            },
            30
          ),
          ...
          bG("==", function (a, b) {
            ...
            !c && A.eqeqeq
              ? be("Expected '{a}' and instead saw '{b}'.", this, "===", "==")
              : bH(a)
              ? be("Use '{a}' to compare with '{b}'.", this, "===", a.value)
              : bH(b) &&
                be("Use '{a}' to compare with '{b}'.", this, "===", b.value);
            return this;
          }),
          bG("==="),
          bG("!=", function (a, b) {
          ...
          bJ("<<", "shiftleft", 120),
          bJ(">>", "shiftright", 120),
          bJ(">>>", "shiftrightunsigned", 120),
          bF("in", "in", 120),
          bF("instanceof", "instanceof", 120),
          bF(
            "+",
            function (a, b) {
              var c = bn(130);
              if (a && c && a.id === "(string)" && c.id === "(string)") {
                (a.value += c.value),
                  ...
                  !A.scripturl && Z.test(a.value) && be("JavaScript URL.", a);
                return a;
              }
              (b.left = a), (b.right = c);
              return b;
          ...
          bF(
            "+++",
            function (a) {
              be("Confusing pluses."), (this.left = a), (this.right = bn(130));
              return this;
            },
            130
          ),
          ...
          bF(
            "---",
            function (a) {
              be("Confusing minuses."), (this.left = a), (this.right = bn(130));
              return this;
            },
            130
          ),
          ...
          (bB("delete", function () {
            var a = bn(0);
            (!a || (a.id !== "." && a.id !== "[")) &&
              be("Variables should not be deleted."),
              (this.first = a);
            return this;
          }).exps = !0),
          bB("~", function () {
            ...
            if (a && a.id !== "function")
              if (a.identifier) {
                ...
                a.id !== "." &&
                  a.id !== "[" &&
                  a.id !== "(" &&
                  be("Bad constructor.", O);
            else A.supernew || be("Weird construction. Delete 'new'.", this);
            bo(O, x),
              x.id !== "(" &&
                !A.supernew &&
                be("Missing '()' invoking a constructor."),
              (this.first = a);
            return this;
          }),
          (M["new"].exps = !0),
          ...
          bF(
            ...
            function (a, b) {
              ...
              typeof c == "string" && bT(c),
                ...
                a.value === "arguments" &&
                (c === "callee" || c === "caller")
                  ? be("Avoid arguments.{a}.", a, c)
                  : !A.evil &&
                    a &&
                    a.value === "document" &&
                    (c === "write" || c === "writeln") &&
                    be("document.write can be a form of eval.", a),
                !A.evil &&
                  (c === "eval" || c === "execScript") &&
                  be("eval is evil.");
              return b;
          ...
          (bF(
            ...
            function (a, b) {
              ...
              a &&
                ...
                a.value !== "Date" &&
                (a.value === "Math"
                  ? be("Math is not a function.", a)
                  : A.newcap &&
                    be("Missing 'new' prefix when invoking a constructor.", a));
              if (x.id !== ")")
                for (;;) {
          ...
          bB(
            ...
            function () {
              ...
              (this.first = []),
                a &&
                  ((p += A.indent), x.from === p + A.indent && (p += A.indent));
              while (x.id !== "(end)") {
          ...
          (function (a) {
            (a.nud = function () {
              ...
              for (;;) {
                if (x.id === "}") break;
                a && bt();
                if (x.value === "get" && bl().id !== ":")
                  bm("get"),
                    A.es5 || bg("get/set are ES5 features."),
                    (c = bV()),
                    c || bg("Missing property name."),
                    (g = x),
                    bo(O, x),
                    (b = bX()),
                    !A.loopfunc &&
                      j["(loopage)"] &&
                      be("Don't make functions within a loop.", g),
                    (e = b["(params)"]),
                    e &&
                      be(
                    ...
                    bm("set"),
                    (d = bV()),
                    c !== d && bg("Expected {a} and instead saw {b}.", O, c, d),
                    (g = x),
                    bo(O, x),
                    (b = bX()),
                    (e = b["(params)"]),
                    (!e || e.length !== 1 || e[0] !== "value") &&
                      be("Expected (value) in set {a} function.", g, c);
                else {
                  c = bV();
                  if (typeof c != "string") break;
                  bm(":"), br(O, x), bn(10);
                }
                f[c] === !0 && be("Duplicate member '{a}'.", x, c),
                  (f[c] = !0),
                  bT(c);
                if (x.id === ",")
                  bv(),
          ...
          for (;;) {
            ...
            (c = O),
              ...
              x.id === "=" &&
                ...
                bl(0).id === "=" &&
                  x.identifier &&
                  bg("Variable {a} was not declared correctly.", x, x.value),
                (d = bn(0)),
                (c.first = d));
            if (x.id !== ",") break;
            bv();
        ...
        (bY.exps = !0),
          ...
          bB("function", function () {
            ...
            a ? bo(O, x) : br(O, x),
              ...
              !A.loopfunc &&
                j["(loopage)"] &&
                be("Don't make functions within a loop.");
            return this;
          }),
          bz("if", function () {
            var a = x;
            bm("("),
              ...
              x.id === "else" &&
                (br(O, x),
                bm("else"),
                x.id === "if" || x.id === "switch" ? bP(!0) : bS(!0, !0));
            return this;
          }),
          bz("try", function () {
            var a, b, c;
            bS(!1),
              x.id === "catch" &&
                ...
                (b = x.value),
                x.type !== "(identifier)"
                  ? be("Expected an identifier and instead saw '{a}'.", x, b)
                  : bj(b, "exception"),
                bm(),
                bm(")"),
                bS(!1),
                (a = !0),
                (G = c));
            if (x.id === "finally") bm("finally"), bS(!1);
            else {
              a ||
                bg(
                  "Expected '{a}' and instead saw '{b}'.",
              ...
              switch (x.id) {
                case "case":
                  switch (j["(verb)"]) {
                    ...
                    default:
                      $.test(s[x.line - 2]) ||
                        be("Expected a 'break' statement before 'case'.", O);
                  }
                  bt(-A.indent),
                    bm("case"),
                    this.cases.push(bn(20)),
                    (b = !0),
                    bm(":"),
                    (j["(verb)"] = "case");
                  break;
                case "default":
                  switch (j["(verb)"]) {
                    ...
                    default:
                      $.test(s[x.line - 2]) ||
                        be("Expected a 'break' statement before 'default'.", O);
                  }
                ...
                case "}":
                  (p -= A.indent),
                    ...
                    (this.cases.length === 1 ||
                      ...
                      be("This 'switch' should be an 'if'.", this),
                    (j["(breakage)"] -= 1),
                    (j["(verb)"] = undefined);
                  return;
                case "(end)":
          ...
          (by("debugger", function () {
            A.debug || be("All 'debugger' statements should be removed.");
            return this;
          }).exps = !0),
          (function () {
          ...
          (bz("for", function () {
            ...
            bu(O),
              ...
              bm(";"),
              x.id === ";" &&
                bg("Expected '{a}' and instead saw '{b}'.", x, ")", ";");
            if (x.id !== ")")
              for (;;) {
                bn(0, "for");
                if (x.id !== ",") break;
          ...
          (by("break", function () {
            var a = x.value;
            j["(breakage)"] === 0 && be("Unexpected '{a}'.", x, this.value),
              bu(this),
              x.id !== ";" &&
                O.line === x.line &&
                (j[a] !== "label"
                  ? be("'{a}' is not a statement label.", x, a)
                  : G[a] !== j && be("'{a}' is out of scope.", x, a),
                (this.first = x),
                bm()),
              bO("break");
            return this;
          }).exps = !0),
          (by("continue", function () {
            var a = x.value;
            j["(breakage)"] === 0 && be("Unexpected '{a}'.", x, this.value),
              bu(this),
              x.id !== ";"
                ? O.line === x.line &&
                  ...
                  (this.first = x),
                  bm())
                : j["(loopage)"] || be("Unexpected '{a}'.", x, this.value),
              bO("continue");
            return this;
          }).exps = !0),
          (by("return", function () {
            bu(this),
              ...
              x.id !== ";" && !x.reach && (br(O, x), (this.first = bn(20))),
              bO("return");
            return this;
          }).exps = !0),
          (by("throw", function () {
            bu(this), br(O, x), (this.first = bn(20)), bO("throw");
            return this;
          }).exps = !0),
          bD("class"),
          bD("const"),
          ...
          try {
            ...
            switch (x.id) {
              ...
              default:
                x.value === "use strict" &&
                  (A.globalstrict ||
                    be('Use the function form of "use strict".'),
                  bQ()),
                  bR("lib");
            }
            bm("(end)");
        ...
        (b$.data = function () {
          ...
          for (i in n) ba(n, i) && d.push({ name: i, line: n[i] });
  ...
  define(
    ...
    [
      ...
      "module",
      "ace/narcissus/jslex",
      "ace/narcissus/jsdefs",
    ],
    function (require, exports, module) {
      function parseStdin(a, b) {
        for (;;)
          try {
            var c = new lexer.Tokenizer(a, "stdin", b.value),
              d = Script(c, !1);
            b.value = c.lineno;
            return d;
          } catch (e) {
          ...
          case LEFT_CURLY:
            ...
            object_init: if (!a.match(RIGHT_CURLY)) {
              do {
                e = a.get();
                if (
                  (a.token.value !== "get" && a.token.value !== "set") ||
                  a.peek() !== IDENTIFIER
                ) {
                  switch (e) {
                    case IDENTIFIER:
                    ...
                    case RIGHT_CURLY:
                      if (b.ecma3OnlyMode)
                        throw a.newSyntaxError("Illegal trailing ,");
                      break object_init;
                    default:
                  ...
                  if (a.match(COLON))
                    (d = new Node(a, { type: PROPERTY_INIT })),
                      d.push(f),
                      d.push(AssignExpression(a, b)),
                      c.push(d);
                  else {
                    if (a.peek() !== COMMA && a.peek() !== RIGHT_CURLY)
                      throw a.newSyntaxError("missing : after property");
                    c.push(f);
                  }
                } else {
                  if (b.ecma3OnlyMode)
                    throw a.newSyntaxError("Illegal property accessor");
      ...
      function ArgumentList(a, b) {
        ...
        do {
          ...
          if (d.type === YIELD && !d.parenthesized && a.peek() === COMMA)
            throw a.newSyntaxError("Yield expression must be parenthesized");
          if (a.match(FOR)) {
            d = GeneratorExpression(a, b, d);
            if (c.children.length > 1 || a.peek(!0) === COMMA)
              throw a.newSyntaxError(
      ...
      function MemberExpression(a, b, c) {
        ...
        a.match(NEW)
          ? ((d = new Node(a)),
            d.push(MemberExpression(a, b, !1)),
            a.match(LEFT_PAREN) &&
              ((d.type = NEW_WITH_ARGS), d.push(ArgumentList(a, b))))
          : (d = PrimaryExpression(a, b));
        while ((g = a.get()) !== END) {
          switch (g) {
            case DOT:
              (e = new Node(a)),
                e.push(d),
                a.mustMatch(IDENTIFIER),
                e.push(new Node(a));
              break;
            case LEFT_BRACKET:
              (e = new Node(a, { type: INDEX })),
                e.push(d),
                e.push(Expression(a, b)),
                a.mustMatch(RIGHT_BRACKET);
              break;
            case LEFT_PAREN:
              if (c) {
                (e = new Node(a, { type: CALL })),
                  e.push(d),
                  e.push(ArgumentList(a, b));
                break;
              }
            default:
              a.unget();
      ...
      function UnaryExpression(a, b) {
        ...
        switch ((e = a.get(!0))) {
          ...
          case MINUS:
            e === PLUS
              ? (c = new Node(a, { type: UNARY_PLUS }))
              : e === MINUS
              ? (c = new Node(a, { type: UNARY_MINUS }))
              : (c = new Node(a)),
              c.push(UnaryExpression(a, b));
            break;
          case INCREMENT:
          case DECREMENT:
          ...
          default:
            a.unget(),
              (c = MemberExpression(a, b, !0)),
              a.tokens[(a.tokenIndex + a.lookahead - 1) & 3].lineno ===
                a.lineno &&
                (a.match(INCREMENT) || a.match(DECREMENT)) &&
                ((d = new Node(a, { postfix: !0 })), d.push(c), (c = d));
        }
        return c;
      }
      function MultiplyExpression(a, b) {
        ...
        while (a.match(MUL) || a.match(DIV) || a.match(MOD))
          (d = new Node(a)), d.push(c), d.push(UnaryExpression(a, b)), (c = d);
        return c;
      }
      function AddExpression(a, b) {
        var c, d;
        c = MultiplyExpression(a, b);
        while (a.match(PLUS) || a.match(MINUS))
          (d = new Node(a)),
            d.push(c),
            d.push(MultiplyExpression(a, b)),
            (c = d);
        return c;
      }
      function ShiftExpression(a, b) {
        var c, d;
        c = AddExpression(a, b);
        while (a.match(LSH) || a.match(RSH) || a.match(URSH))
          (d = new Node(a)), d.push(c), d.push(AddExpression(a, b)), (c = d);
        return c;
      }
      function RelationalExpression(a, b) {
        var c,
          d,
          e = b.update({ inForLoopInit: !1 });
        ...
        while (
          ...
          a.match(GE) ||
          a.match(GT) ||
          (!b.inForLoopInit && a.match(IN)) ||
          a.match(INSTANCEOF)
        )
          (d = new Node(a)), d.push(c), d.push(ShiftExpression(a, e)), (c = d);
        return c;
      }
      function EqualityExpression(a, b) {
        ...
        while (
          ...
          (d = new Node(a)),
            d.push(c),
            d.push(RelationalExpression(a, b)),
            (c = d);
        return c;
      }
      function BitwiseAndExpression(a, b) {
        ...
        while (a.match(BITWISE_AND))
          (d = new Node(a)),
            d.push(c),
            d.push(EqualityExpression(a, b)),
            (c = d);
        return c;
      }
      function BitwiseXorExpression(a, b) {
        ...
        while (a.match(BITWISE_XOR))
          (d = new Node(a)),
            d.push(c),
            d.push(BitwiseAndExpression(a, b)),
            (c = d);
        return c;
      }
      function BitwiseOrExpression(a, b) {
        ...
        while (a.match(BITWISE_OR))
          (d = new Node(a)),
            d.push(c),
            d.push(BitwiseXorExpression(a, b)),
            (c = d);
        return c;
      }
      function AndExpression(a, b) {
        ...
        while (a.match(AND))
          (d = new Node(a)),
            d.push(c),
            d.push(BitwiseOrExpression(a, b)),
            (c = d);
        return c;
      }
      function OrExpression(a, b) {
        ...
        c = AndExpression(a, b);
        while (a.match(OR))
          (d = new Node(a)), d.push(c), d.push(AndExpression(a, b)), (c = d);
        return c;
      }
      function ConditionalExpression(a, b) {
        ...
        if (a.match(HOOK)) {
          (d = c),
            (c = new Node(a, { type: HOOK })),
            c.push(d),
            c.push(AssignExpression(a, b.update({ inForLoopInit: !1 })));
      ...
      function Expression(a, b) {
        ...
        if (a.match(COMMA)) {
          ...
          do {
            ...
            if (d.type === YIELD && !d.parenthesized)
              throw a.newSyntaxError("Yield expression must be parenthesized");
            c.push(AssignExpression(a, b));
          } while (a.match(COMMA));
        }
      ...
      function ParenExpression(a, b) {
        ...
        if (a.match(FOR)) {
          if (c.type === YIELD && !c.parenthesized)
            throw a.newSyntaxError("Yield expression must be parenthesized");
          if (c.type === COMMA && !c.parenthesized)
            throw a.newSyntaxError(
              "Generator expression must be parenthesized"
            );
      ...
      function HeadExpression(a, b) {
        ...
        if (c === END && !d.parenthesized) {
          var e = a.peek();
          if (e !== LEFT_CURLY && !definitions.isStatementStartCode[e])
            throw a.newSyntaxError(
      ...
      function ComprehensionTail(a, b) {
        ...
        do {
          (d = new Node(a, { type: FOR_IN, isLoop: !0 })),
            a.match(IDENTIFIER) &&
              (a.token.value === "each" ? (d.isEach = !0) : a.unget()),
            (g = MaybeLeftParen(a, b));
          switch (a.get()) {
            case LEFT_BRACKET:
            case LEFT_CURLY:
              ...
              break;
            case IDENTIFIER:
              (d.iterator = f = new Node(a, { type: IDENTIFIER })),
                (f.name = f.value),
                (d.varDecl = e = new Node(a, { type: VAR })),
                e.push(f),
                b.parentScript.varDecls.push(f);
              break;
            default:
              throw a.newSyntaxError("missing identifier");
          }
          a.mustMatch(IN),
            (d.object = Expression(a, b)),
            MaybeRightParen(a, g),
            c.push(d);
        } while (a.match(FOR));
      ...
      function checkDestructuring(a, b, c, d) {
        if (c.type === ARRAY_COMP)
          throw a.newSyntaxError("Invalid array comprehension left-hand side");
        if (c.type === ARRAY_INIT || c.type === OBJECT_INIT) {
          ...
          for (var l = 0, m = k.length; l < m; l++) {
            if (!(f = k[l])) continue;
            f.type === PROPERTY_INIT
              ? ((j = f.children), (i = j[1]), (h = j[0].value))
              : c.type === OBJECT_INIT
              ? ((i = f), (h = f.value))
              : ((i = f), (h = l));
            if (i.type === ARRAY_INIT || i.type === OBJECT_INIT)
              e[h] = checkDestructuring(a, b, i, d);
            else {
              if (d && i.type !== IDENTIFIER)
                throw a.newSyntaxError("missing name in pattern");
              e[h] = i;
            }
          }
          return e;
      ...
      function LetBlock(a, b, c) {
        var d, e;
        (d = new Node(a, { type: LET_BLOCK, varDecls: [] })),
          a.mustMatch(LEFT_PAREN),
          (d.variables = Variables(a, b, d)),
          a.mustMatch(RIGHT_PAREN),
          c &&
            a.peek() !== LEFT_CURLY &&
            ((e = new Node(a, { type: SEMICOLON, expression: d })), (c = !1)),
          c ? (d.block = Block(a, b)) : (d.expression = AssignExpression(a, b));
        return d;
      }
        ...
        do {
          ...
          if (i === LEFT_BRACKET || i === LEFT_CURLY) {
            ...
            (e = new Node(a, {
              ...
              d.push(e),
              pushDestructuringVarDecls(e.name.destructuredNames, h),
              d.destructurings.push({ exp: j, decl: e });
            if (b.inForLoopInit && a.peek() === IN) continue;
            a.mustMatch(ASSIGN);
            if (a.token.assignOp)
              throw a.newSyntaxError("Invalid variable initialization");
      ...
      function FunctionDefinition(a, b, c, d) {
        ...
        if (a.match(IDENTIFIER)) f.name = a.token.value;
        ...
        if (e !== LEFT_CURLY) {
          ...
          if (f.body.isGenerator)
            throw a.newSyntaxError("Generator returns a value");
        } else f.body = Script(a, !0);
        e === LEFT_CURLY && a.mustMatch(RIGHT_CURLY),
          (f.end = a.token.end),
          (f.functionForm = d),
          d === DECLARED_FORM && b.parentScript.funDecls.push(f);
        return f;
      }
        ...
        (c = new Node(a, { value: undefined })),
          ...
          (e !== YIELD ||
            (f !== e &&
              ...
              f !== COMMA))
            ? e === RETURN
              ? ((c.value = Expression(a, b)), (g.hasReturnWithValue = !0))
              : (c.value = AssignExpression(a, b))
            : e === RETURN && (g.hasEmptyReturn = !0);
        if (g.hasReturnWithValue && g.isGenerator)
          throw a.newSyntaxError("Generator returns a value");
        return c;
      }
      function MagicalSemicolon(a) {
        ...
        if (a.lineno === a.token.lineno) {
          ...
          if (
            ...
            throw a.newSyntaxError("missing ; before statement");
        }
        a.match(SEMICOLON);
      }
        ...
        switch (j) {
          case FUNCTION:
            return FunctionDefinition(
              ...
              b,
              !0,
              b.nesting !== NESTING_TOP ? STATEMENT_FORM : DECLARED_FORM
            );
          case LEFT_CURLY:
            (e = new Node(a, blockInit())),
              Statements(
                a,
                b
                  .update({ parentBlock: e })
                  .pushTarget(e)
                  .nest(NESTING_SHALLOW),
                e
              ),
              a.mustMatch(RIGHT_CURLY);
            return e;
          case IF:
            (e = new Node(a)),
              (e.condition = HeadExpression(a, b)),
              (l = b.pushTarget(e).nest(NESTING_DEEP)),
              (e.thenPart = Statement(a, l)),
              (e.elsePart = a.match(ELSE) ? Statement(a, l) : null);
            return e;
          case SWITCH:
            (e = new Node(a, { cases: [], defaultIndex: -1 })),
              (e.discriminant = HeadExpression(a, b)),
              (l = b.pushTarget(e).nest(NESTING_DEEP)),
            ...
            while ((j = a.get()) !== RIGHT_CURLY) {
              switch (j) {
                case DEFAULT:
                  if (e.defaultIndex >= 0)
                    throw a.newSyntaxError("More than one switch default");
                case CASE:
                  (f = new Node(a)),
                    j === DEFAULT
                      ? (e.defaultIndex = e.cases.length)
                      : (f.caseLabel = Expression(a, l, COLON));
                  break;
                default:
              ...
              while (
                ...
                f.statements.push(Statement(a, l));
              e.cases.push(f);
            }
            return e;
          case FOR:
            (e = new Node(a, LOOP_INIT)),
              a.match(IDENTIFIER) &&
                (a.token.value === "each" ? (e.isEach = !0) : a.unget()),
              b.parenFreeMode || a.mustMatch(LEFT_PAREN),
              (l = b.pushTarget(e).nest(NESTING_DEEP)),
              (m = b.update({ inForLoopInit: !0 })),
              (j = a.peek()) !== SEMICOLON &&
                (j === VAR || j === CONST
                  ? (a.get(), (f = Variables(a, m)))
                  : j === LET
                  ? (a.get(),
                    a.peek() === LEFT_PAREN
                      ? (f = LetBlock(a, m, !1))
            ...
            if (f && a.match(IN)) {
              ...
              if (f.type === VAR || f.type === LET) {
                h = f.children;
                if (h.length !== 1 && f.destructurings.length !== 1)
                  throw new SyntaxError(
                    "Invalid for..in left-hand side",
                    a.filename,
                    f.lineno
                  );
                f.destructurings.length > 0
                  ? (e.iterator = f.destructurings[0])
                  : (e.iterator = h[0]),
                  (e.varDecl = f);
              } else {
                if (f.type === ARRAY_INIT || f.type === OBJECT_INIT)
                  f.destructuredNames = checkDestructuring(a, m, f);
                e.iterator = f;
              }
            } else {
              (e.setup = f), a.mustMatch(SEMICOLON);
              if (e.isEach) throw a.newSyntaxError("Invalid for each..in loop");
              (e.condition = a.peek() === SEMICOLON ? null : Expression(a, m)),
                a.mustMatch(SEMICOLON),
                (k = a.peek()),
                (e.update = (
                  b.parenFreeMode
                    ? k === LEFT_CURLY || definitions.isStatementStartCode[k]
                    : k === RIGHT_PAREN
                )
                  ? null
                  : Expression(a, m));
            }
            b.parenFreeMode || a.mustMatch(RIGHT_PAREN),
              (e.body = Statement(a, l));
            return e;
          case WHILE:
            (e = new Node(a, { isLoop: !0 })),
              (e.condition = HeadExpression(a, b)),
              (e.body = Statement(a, b.pushTarget(e).nest(NESTING_DEEP)));
            return e;
          case DO:
            (e = new Node(a, { isLoop: !0 })),
              (e.body = Statement(a, b.pushTarget(e).nest(NESTING_DEEP))),
          ...
          case CONTINUE:
            (e = new Node(a)),
              (l = b.pushTarget(e)),
              a.peekOnSameLine() === IDENTIFIER &&
                (a.get(), (e.label = a.token.value)),
              (e.target = e.label
                ? l.labeledTargets.find(function (a) {
                    return a.labels.has(e.label);
                  })
                : l.defaultTarget);
            if (!e.target)
              throw a.newSyntaxError(
                "Invalid " + (j === BREAK ? "break" : "continue")
              );
            if (!e.target.isLoop && j === CONTINUE)
              throw a.newSyntaxError("Invalid continue");
            break;
          case TRY:
            ...
            while (a.match(CATCH)) {
              ...
              if (a.match(IF)) {
                if (b.ecma3OnlyMode)
                  throw a.newSyntaxError("Illegal catch guard");
                if (e.catchClauses.length && !e.catchClauses.top().guard)
                  throw a.newSyntaxError("Guarded catch after unguarded");
                f.guard = Expression(a, b);
              }
              MaybeRightParen(a, g),
                (f.block = Block(a, b)),
                e.catchClauses.push(f);
            }
            a.match(FINALLY) && (e.finallyBlock = Block(a, b));
            if (!e.catchClauses.length && !e.finallyBlock)
              throw a.newSyntaxError("Invalid try statement");
            return e;
          case CATCH:
          case FINALLY:
            throw a.newSyntaxError(
              definitions.tokens[j] + " without preceding try"
            );
          case THROW:
          ...
          default:
            if (j === IDENTIFIER) {
              ...
              if (j === COLON) {
                d = a.token.value;
                if (b.allLabels.has(d))
                  throw a.newSyntaxError("Duplicate label");
                a.get(),
                  (e = new Node(a, { type: LABEL, label: d })),
                  (e.statement = Statement(
                    a,
                    b.pushLabel(d).nest(NESTING_SHALLOW)
                  )),
                  (e.target =
                    e.statement.type === LABEL
                      ? e.statement.target
                      : e.statement);
                return e;
              }
            }
            (e = new Node(a, { type: SEMICOLON })),
              a.unget(),
              (e.expression = Expression(a, b)),
              (e.end = e.expression.end);
        }
        MagicalSemicolon(a);
        return e;
      }
      function Block(a, b) {
        ...
        Statements(a, b.update({ parentBlock: c }).pushTarget(c), c),
          a.mustMatch(RIGHT_CURLY);
        return c;
      }
      ...
      function MaybeLeftParen(a, b) {
        return b.parenFreeMode
          ? a.match(LEFT_PAREN)
            ? LEFT_PAREN
            : END
          : a.mustMatch(LEFT_PAREN).type;
      }
      function scriptInit() {
        return {
          type: SCRIPT,
      ...
      function Script(a, b) {
        var c = new Node(a, scriptInit()),
          d = new StaticContext(c, c, b, !1, NESTING_TOP);
        Statements(a, d, c);
        return c;
      }
      function StaticContext(a, b, c, d, e) {
        (this.parentScript = a),
          (this.parentBlock = b),
          (this.inFunction = c),
          (this.inForLoopInit = d),
          (this.nesting = e),
          (this.allLabels = new Stack()),
          (this.currentLabels = new Stack()),
          (this.labeledTargets = new Stack()),
          (this.defaultTarget = null),
          definitions.options.ecma3OnlyMode && (this.ecma3OnlyMode = !0),
          definitions.options.parenFreeMode && (this.parenFreeMode = !0);
      }
      ...
      (StaticContext.prototype = {
        ...
        pushTarget: function (a) {
          ...
          if (this.currentLabels.isEmpty())
            return b ? this.update({ defaultTarget: a }) : this;
          (a.labels = new StringMap()),
          ...
          return this.update({
            ...
            defaultTarget: b ? a : this.defaultTarget,
          });
        },
        nest: function (a) {
      ...
      (Tokenizer.prototype = {
        ...
        lexZeroNumber: function (a) {
          ...
          if (a === ".") {
            ...
            this.cursor--,
              this.lexExponent(),
              (b.value = parseFloat(b.start, this.cursor));
          } else if (a === "x" || a === "X") {
            do a = c[this.cursor++];
            while (
              (a >= "0" && a <= "9") ||
        ...
        get: function (a) {
          ...
          while (this.lookahead) {
            --this.lookahead,
              ...
              (b = this.tokens[this.tokenIndex]);
            if (b.type !== NEWLINE || this.scanNewlines) return b.type;
          }
          this.skip(),
            (this.tokenIndex = (this.tokenIndex + 1) & 3),
            (b = this.tokens[this.tokenIndex]),
            b || (this.tokens[this.tokenIndex] = b = {});
          var c = this.source;
          ...
          if (
            ...
            this.lexIdent(d);
          else if (a && d === "/") this.lexRegExp(d);
          else if (d in opTokens) this.lexOp(d);
          else if (d === ".") this.lexDot(d);
          else if (d >= "1" && d <= "9") this.lexNumber(d);
          else if (d === "0") this.lexZeroNumber(d);
          else if (d === '"' || d === "'") this.lexString(d);
          else if (this.scanNewlines && d === "\n")
