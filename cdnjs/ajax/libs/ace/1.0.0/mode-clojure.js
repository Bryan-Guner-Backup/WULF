define(
  ...
  function (a, b, c) {
    var d = a("../lib/oop"),
      ...
      g = a("./clojure_highlight_rules").ClojureHighlightRules,
      h = a("./matching_parens_outdent").MatchingParensOutdent,
      i = a("../range").Range,
      j = function () {
  ...
  define(
    ...
    function (a, b, c) {
        ...
        f = function () {
          var a =
            ...
            d = this.createKeywordMapper(
              { keyword: b, "constant.language": c, "support.function": a },
              "identifier",
              !1,
              " "
            );
      ...
      d.inherits(f, e), (b.ClojureHighlightRules = f);
    }
  ),
  define(
    "ace/mode/matching_parens_outdent",
