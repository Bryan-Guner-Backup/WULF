define(
  ...
  function (a, b, c) {
    var d = a("../lib/oop"),
      ...
      g = a("./golang_highlight_rules").GolangHighlightRules,
  ...
  define(
    ...
    function (a, b, c) {
      var d = a("../lib/oop"),
        ...
        g = function () {
          var a =
              "true|else|false|break|case|return|goto|if|const|continue|struct|default|switch|for|func|import|package|chan|defer|fallthrough|go|interface|map|rangeselect|type|var",
            b = "nil|true|false|iota",
      ...
      d.inherits(g, f), (b.GolangHighlightRules = g);
    }
  ),
  define(
    "ace/mode/doc_comment_highlight_rules",
