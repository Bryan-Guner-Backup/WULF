define(
  ...
  function (a, b, c) {
    var d = a("../lib/oop"),
      ...
      g = a("./jade_highlight_rules").JadeHighlightRules,
      h = function () {
        var a = new g();
        this.$tokenizer = new f(a.getRules());
      };
    d.inherits(h, e), function () {}.call(h.prototype), (b.Mode = h);
  }
),
  define(
    "ace/mode/jade_highlight_rules",
    ...
    function (a, b, c) {
      ...
      var d = a("../lib/oop"),
        ...
        f = a("./markdown_highlight_rules").MarkdownHighlightRules,
        g = a("./scss_highlight_rules").ScssHighlightRules,
        h = a("./less_highlight_rules").LessHighlightRules,
        i = a("./coffee_highlight_rules").CoffeeHighlightRules,
        j = a("./javascript_highlight_rules").JavaScriptHighlightRules,
        l = function () {
          var a =
          ...
          this.$rules = {
            ...
            comment_block: [
              ...
              { token: "comment.block.jade", merge: !0, regex: ".+" },
            ],
            tag_single: [
              {
      ...
      d.inherits(l, e), (b.JadeHighlightRules = l);
    }
  ),
  define(
    "ace/mode/markdown_highlight_rules",
    ...
    function (a, b, c) {
      ...
      var d = a("../lib/oop"),
        ...
        h = a("./html_highlight_rules").HtmlHighlightRules,
        i = a("./css_highlight_rules").CssHighlightRules,
        k = function () {
          (this.$rules = {
            start: [
