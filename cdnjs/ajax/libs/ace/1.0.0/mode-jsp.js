define(
  ...
  function (a, b, c) {
    var d = a("../lib/oop"),
      ...
      g = a("./jsp_highlight_rules").JspHighlightRules,
    ...
    d.inherits(n, e), function () {}.call(n.prototype), (b.Mode = n);
  }
),
  define(
    "ace/mode/jsp_highlight_rules",
    ...
    function (a, b, c) {
      var d = a("../lib/oop"),
        e = a("./html_highlight_rules").HtmlHighlightRules,
        f = a("./java_highlight_rules").JavaHighlightRules,
        g = function () {
          e.call(this);
          ...
          this.embedRules(f, "jsp-"),
            ...
            this.$rules["jsp-start"].unshift(
              { token: "meta.tag", regex: "%>|<\\/jsp:[^>]+>", next: "start" },
              { token: "variable.language", regex: b },
      ...
      d.inherits(g, e), (b.JspHighlightRules = g);
    }
  ),
  define(
    "ace/mode/html_highlight_rules",
  ...
  define(
    ...
    function (a, b, c) {
      ...
      d.inherits(g, f), (b.JavaHighlightRules = g);
    }
  ),
  define(
    "ace/mode/matching_brace_outdent",
