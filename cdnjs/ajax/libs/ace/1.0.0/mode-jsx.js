define(
  ...
  function (a, b, c) {
    ...
    var d = a("../lib/oop"),
      ...
      g = a("./jsx_highlight_rules").JsxHighlightRules,
  ...
  define(
    ...
    function (a, b, c) {
              ...
              },
              {
                token: function (d) {
                  return d == "this"
                    ...
                    : d == "function"
                    ? "storage.type"
                    : a.hasOwnProperty(d) || c.hasOwnProperty(d)
                    ? "keyword"
                    : b.hasOwnProperty(d)
                    ? "constant.language"
                    : /^_?[A-Z][a-zA-Z0-9_]*$/.test(d)
      ...
      d.inherits(h, g), (b.JsxHighlightRules = h);
    }
  ),
  define(
    "ace/mode/doc_comment_highlight_rules",
