define(
  ...
  function (a, b, c) {
    var d = a("../lib/oop"),
      ...
      g = a("./pgsql_highlight_rules").PgsqlHighlightRules,
      h = a("../range").Range,
      i = function () {
      ...
      function () {
        (this.toggleCommentLines = function (a, b, c, d) {
          ...
          (this.getNextLineIndent = function (a, b, c) {
            return a == "start" || a == "keyword.statementEnd"
              ? ""
              : this.$getIndent(b);
          });
      }.call(i.prototype),
  ...
  define(
    ...
    function (a, b, c) {
      var d = a("../lib/oop"),
        ...
        h = a("./perl_highlight_rules").PerlHighlightRules,
        i = a("./python_highlight_rules").PythonHighlightRules,
        j = function () {
          var a =
          ...
          (this.$rules = {
            ...
            this.embedRules(h, "perl-", [
              { token: "string", regex: "\\$perl\\$", next: "statement" },
            ]),
            this.embedRules(i, "python-", [
              { token: "string", regex: "\\$python\\$", next: "statement" },
            ]);
        };
      d.inherits(j, g), (b.PgsqlHighlightRules = j);
    }
  ),
  define(
    "ace/mode/doc_comment_highlight_rules",
