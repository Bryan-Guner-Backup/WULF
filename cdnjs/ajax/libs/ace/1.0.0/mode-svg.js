define(
  ...
  function (a, b, c) {
    var d = a("../lib/oop"),
      ...
      h = a("./svg_highlight_rules").SvgHighlightRules,
      i = a("./folding/mixed").FoldMode,
      j = a("./folding/xml").FoldMode,
      ...
      l = function () {
        e.call(this),
          ...
          (this.foldingRules = new i(new j({}), { "js-": new k() }));
      };
    d.inherits(l, e),
      function () {
  ...
  define(
    ...
    function (a, b, c) {
      var d = a("../lib/oop"),
        e = a("./javascript_highlight_rules").JavaScriptHighlightRules,
        f = a("./xml_highlight_rules").XmlHighlightRules,
        g = a("./xml_util"),
        h = function () {
          f.call(this),
            ...
            g.tag(this.$rules, "script", "js-start"),
