            ...
            get: function (a) {
              ...
              return (
                ...
                h.type > -1 &&
                  ...
                  (this._ltIndex = this._lt.length)),
                (i = b[h.type]),
                i && (i.hide || (i.channel !== undefined && a !== i.channel))
                  ? this.get(a)
                  : h.type
              );
            },
        ...
        (function () {
              ...
              var a = new EventTarget(),
                ...
                c = {
                        ...
                        switch (e) {
                          ...
                          case Tokens.UNKNOWN_SYM:
                            ...
                            this.fire({
                              ...
                              (c = 0);
                            while (
                              a.advance([Tokens.LBRACE, Tokens.RBRACE]) ==
                              Tokens.LBRACE
                            )
                              c++;
                  ...
                  _media_feature: function () {
                    var a = this._tokenStream;
                    return (
                      a.mustMatch(Tokens.IDENT), SyntaxUnit.fromToken(a.token())
                    );
                  },
                  _page: function () {
                    var a = this._tokenStream,
                  ...
                  _type_selector: function () {
                    ...
                    return c
                      ? (b && ((c.text = b + c.text), (c.col -= b.length)), c)
                      : (b && (a.unget(), b.length > 1 && a.unget()), null);
                  },
                  _class: function () {
                    var a = this._tokenStream,
                      b;
                    return a.match(Tokens.DOT)
                      ? (a.mustMatch(Tokens.IDENT),
                        (b = a.token()),
                        new SelectorSubPart(
                          "." + b.value,
                  ...
                  _attrib: function () {
                    var a = this._tokenStream,
                      ...
                      c,
                      d;
                    return a.match(Tokens.LBRACKET)
                      ? ((d = a.token()),
                        (b = d.value),
                  ...
                  _expr: function () {
                    ...
                    return b.length > 0
                      ? new PropertyValue(b, b[0].line, b[0].col)
                      : null;
                  },
                  _term: function () {
                    var a = this._tokenStream,
                    ...
                    return (
                      ...
                      b !== null &&
                        ((e = a.token().startLine), (f = a.token().startCol)),
                      a.peek() == Tokens.IE_FUNCTION && this.options.ieFilters
                        ...
                        : ((d = this._hexcolor()),
                          d === null
                            ...
                            : ((c = d.value),
                              b === null &&
                                ((e = d.startLine), (f = d.startCol)))),
                      c !== null
                        ? new PropertyValuePart(b !== null ? b + c : c, e, f)
                        : null
                    );
                  },
                  _function: function () {
                  ...
                  _readDeclarations: function (a, b) {
                    ...
                    try {
                      for (;;) {
                        if (
                          !(c.match(Tokens.SEMICOLON) || (b && this._margin()))
                        ) {
          ...
          var Properties = {
            ...
            azimuth: function (a) {
              var b = "<angle> | leftwards | rightwards | inherit",
                ...
                e = !1,
                f;
              ValidationTypes.isAny(a, b) ||
                (ValidationTypes.isAny(a, "behind") && ((d = !0), (e = !0)),
                ValidationTypes.isAny(a, c) &&
                  ((e = !0), d || ValidationTypes.isAny(a, "behind")));
              if (a.hasNext())
                throw (
                  ((f = a.next()),
                  e
            ...
            "border-image-slice": function (a) {
              ...
              if (a.hasNext())
                throw (
                  ...
                  b
                    ? new ValidationError(
                        "Expected end of value but found '" + g + "'.",
                        g.line,
                        g.col
                      )
                    : new ValidationError(
            ...
            "border-radius": function (a) {
              ...
              if (a.hasNext())
                throw (
                  ...
                  b
                    ? new ValidationError(
                        "Expected end of value but found '" + h + "'.",
                        h.line,
                        h.col
                      )
                    : new ValidationError(
                        "Expected (<'border-radius'>) but found '" + h + "'.",
                        h.line,
                        h.col
                      ))
                );
            ...
            "box-shadow": function (a) {
              ...
              if (!ValidationTypes.isAny(a, "none"))
                ...
                throw (
                  ((c = a.next()),
                  new ValidationError(
                    "Expected end of value but found '" + c + "'.",
                    c.line,
                    c.col
                  ))
                );
          ...
          (Pseudos.ELEMENT = 1),
            ...
            (Pseudos.isElement = function (a) {
              return (
                a.indexOf("::") === 0 ||
                Pseudos[a.toLowerCase()] == Pseudos.ELEMENT
              );
            }),
          ...
          TokenStream.prototype = mix(new TokenStreamBase(), {
            _getToken: function (a) {
              ...
              return (
                !d &&
                  b === null &&
                  (d = this.createToken(Tokens.EOF, null, e, f)),
                d
              );
            },
            ...
            htmlCommentStartToken: function (a, b, c) {
              ...
              return (
                ...
                (e += d.readCount(3)),
                e == "<!--"
                  ? this.createToken(Tokens.CDO, e, b, c)
                  : (d.reset(), this.charToken(a, b, c))
              );
            },
            htmlCommentEndToken: function (a, b, c) {
              ...
              return (
                ...
                (e += d.readCount(2)),
                e == "-->"
                  ? this.createToken(Tokens.CDC, e, b, c)
                  : (d.reset(), this.charToken(a, b, c))
              );
            },
            ...
            notToken: function (a, b, c) {
              ...
              return (
                ...
                (e += d.readCount(4)),
                e.toLowerCase() == ":not("
                  ? this.createToken(Tokens.NOT, e, b, c)
                  : (d.reset(), this.charToken(a, b, c))
              );
            },
            ...
            stringToken: function (a, b, c) {
              ...
              return (
                i === null && (h = Tokens.INVALID), this.createToken(h, e, b, c)
              );
            },
            ...
            validate: function (a, b) {
              ...
              if (!f) {
                ...
                typeof f != "number" &&
                  (typeof f == "string"
                    ? f.indexOf("||") > -1
                      ? this.groupProperty(f, e)
                      : this.singleProperty(f, e, 1)
                    : f.multi
                    ? this.multiProperty(f.multi, e, f.comma, f.max || Infinity)
            ...
            multiProperty: function (a, b, c, d) {
              ...
              if (!e)
                throw b.hasNext() && !b.isFirst()
                  ? ((i = b.peek()),
                    new ValidationError(
                      "Expected end of value but found '" + i + "'.",
                      i.line,
                      i.col
                    ))
                  : ((i = b.previous()),
            ...
            groupProperty: function (a, b, c) {
              ...
              if (!d)
                throw h && b.hasNext()
                  ? ((j = b.peek()),
                    new ValidationError(
                      "Expected end of value but found '" + j + "'.",
                      j.line,
                      j.col
                    ))
                  : new ValidationError(
          ...
          var ValidationTypes = {
            ...
            isType: function (a, b) {
              ...
              return (
                b.charAt(0) != "<"
                  ? ((d = this.isLiteral(c, b)), d && a.next())
                  : this.simple[b]
                  ? ((d = this.simple[b](c)), d && a.next())
                  : (d = this.complex[b](a)),
                d
              );
            },
            simple: {
              ...
              "<bg-image>": function (a) {
                return (
                  this["<image>"](a) || this["<gradient>"](a) || a == "none"
                );
              },
              "<gradient>": function (a) {
                return (
              ...
              "<border-width>": function (a) {
                return (
                  this["<length>"](a) ||
                  ValidationTypes.isLiteral(a, "thin | medium | thick")
                );
              },
              ...
              "<margin-width>": function (a) {
                return (
                  this["<length>"](a) ||
                  this["<percentage>"](a) ||
                  ValidationTypes.isLiteral(a, "auto")
                );
              },
            ...
            complex: {
              "<bg-position>": function (a) {
                var b = this,
                  ...
                  i;
                return (
                  ValidationTypes.isAny(a, "top | bottom")
                    ? (c = !0)
                    : ValidationTypes.isAny(a, d)
                    ? a.hasNext() &&
                      (c = ValidationTypes.isAny(a, d + " | " + f))
                    : ValidationTypes.isAny(a, e) &&
                      a.hasNext() &&
                      (ValidationTypes.isAny(a, f)
                        ? ((c = !0), ValidationTypes.isAny(a, d))
                        : ValidationTypes.isAny(a, d) &&
                          (ValidationTypes.isAny(a, f) &&
                            ValidationTypes.isAny(a, d),
                          (c = !0))),
              ...
              "<bg-size>": function (a) {
                var b = this,
                  ...
                  g;
                return (
                  ValidationTypes.isAny(a, "cover | contain")
                    ? (c = !0)
                    : ValidationTypes.isAny(a, d) &&
                      ((c = !0), ValidationTypes.isAny(a, d)),
                  c
              ...
              "<repeat-style>": function (a) {
                ...
                return (
                  a.hasNext() &&
                    ((d = a.next()),
                    ValidationTypes.isLiteral(d, "repeat-x | repeat-y")
                      ? (b = !0)
                      : ValidationTypes.isLiteral(d, c) &&
                        ((b = !0),
                        a.hasNext() &&
                          ValidationTypes.isLiteral(a.peek(), c) &&
                          a.next())),
                  b
                );
              },
              "<shadow>": function (a) {
                ...
                if (a.hasNext()) {
                  ...
                  a.hasNext() &&
                    (e || ValidationTypes.isAny(a, "<color>"),
                    d || ValidationTypes.isAny(a, "inset")),
                    (b = c >= 2 && c <= 4);
                }
                return b;
              },
        ...
        return (
          ...
          (c.verify = function (b, c) {
            ...
            try {
              ...
              f.error(
                "Fatal error, cannot continue: " + j.message,
                j.line,
                j.col,
                {}
              );
            ...
            return (
              (h = { messages: f.messages, stats: f.stats }),
      ...
      (Reporter.prototype = {
              ...
              a.addListener("endrule", function (a) {
                ...
                for (g = 0, h = e.length; g < h; g++) {
                  ...
                  for (j in d)
                    d.hasOwnProperty(j) &&
                      ((k = d[j]),
                      CSSLint.Util.indexOf(k, i.text) > -1 &&
                        (f[j] ||
                          (f[j] = {
                            full: k.slice(0),
                            actual: [],
                        ...
                        CSSLint.Util.indexOf(f[j].actual, i.text) === -1 &&
                          (f[j].actual.push(i.text),
                          f[j].actualNodes.push(i))));
                }
                for (j in f)
            ...
            a.addListener("property", function (a) {
              ...
              if (e.match(/background/i))
                for (g = 0, h = f.parts.length; g < h; g++)
                  f.parts[g].type == "uri" &&
                    (typeof d[f.parts[g].uri] == "undefined"
                      ? (d[f.parts[g].uri] = a)
                      : b.report(
                          "Background image '" +
                            f.parts[g].uri +
                            "' was used multiple times, first declared at line " +
                            d[f.parts[g].uri].line +
                            ", col " +
                            d[f.parts[g].uri].col +
                            ".",
                          a.line,
        ...
        CSSLint.addRule({
          ...
          init: function (a, b) {
            ...
            var c = this,
              d,
              e = { color: 1, background: 1, "background-color": 1 },
              f;
            a.addListener("startrule", g),
              a.addListener("startfontface", g),
              a.addListener("startpage", g),
              ...
              a.addListener("property", function (a) {
                ...
                if (e[g])
                  while (i < k)
                    h[i].type == "color" &&
                      ("alpha" in h[i] || "hue" in h[i]
                        ? (/([^\)]+)\(/.test(h[i]) &&
                            (j = RegExp.$1.toUpperCase()),
                          (!d ||
                            d.property.text.toLowerCase() != g ||
                            d.colorType != "compat") &&
                            b.report(
                              "Fallback " +
                                g +
            ...
            a.addListener("startrule", function () {
              ...
              a.addListener("property", function (a) {
                /\-(moz|ms|o|webkit)(?:\-(?:linear|radial))\-gradient/i.test(
                  ...
                  ? (d[RegExp.$1] = 1)
                  : /\-webkit\-gradient/i.test(a.value) && (d.oldWebkit = 1);
              }),
              a.addListener("endrule", function (a) {
                var e = [];
          ...
          init: function (a, b) {
            ...
            a.addListener("startrule", function (d) {
              ...
              for (j = 0; j < e.length; j++) {
                ...
                i == 1
                  ? b.report("Don't use IDs in selectors.", f.line, f.col, c)
                  : i > 1 &&
                    b.report(
                      i + " IDs in the selector, really?",
                      f.line,
                      f.col,
                      c
                    );
        ...
        CSSLint.addRule({
          ...
          init: function (a, b) {
            ...
            a.addListener("property", function (a) {
              a.important === !0 &&
                (d++, b.report("Use of !important", a.line, a.col, c));
            }),
              a.addListener("endstylesheet", function () {
                b.stat("important", d),
                  d >= 10 &&
        ...
        CSSLint.addRule({
          ...
          init: function (a, b) {
            ...
            function f(a) {
              d &&
                d.outline &&
                (d.selectors.toString().toLowerCase().indexOf(":focus") == -1
                  ? b.report(
        ...
        CSSLint.addRule({
          ...
          init: function (a, b) {
            ...
            for (d in i)
              if (i.hasOwnProperty(d))
                for (e = 0, f = i[d].length; e < f; e++) g[i[d][e]] = d;
          ...
          init: function (a, b) {
            ...
            a.addListener("startrule", e),
              ...
              a.addListener("property", function (a) {
                var b = a.property.toString().toLowerCase(),
                  c = a.value;
                b == "text-indent" && c.parts[0].value < -99
                  ? (d = a.property)
                  : b == "direction" && c == "ltr" && (d = !1);
              }),
              a.addListener("endrule", f),
              a.addListener("endfontface", f);
          },
          ...
          init: function (a, b) {
            ...
            a.addListener("startrule", function (a) {
              ...
              for (i = 0; i < e.length; i++) {
                ...
                if (
                  g.elementName &&
                  /(h[1-6])/i.test(g.elementName.toString())
                ) {
              ...
              a.addListener("endstylesheet", function (a) {
                ...
                f.length &&
                  b.rollupWarn(
                    "You have " + f.join(", ") + " defined in this stylesheet.",
                    c
                  );
              });
          },
            ...
            a.addListener("startrule", function (a) {
              ...
              for (h = 0; h < d.length; h++)
                (e = d[h]),
                  ...
                  f.elementName == "*" && b.report(c.desc, f.line, f.col, c);
            });
          },
        }),
        CSSLint.addRule({
              ...
              for (i = 0; i < e.length; i++) {
                ...
                if (g.type == a.SELECTOR_PART_TYPE)
                  for (k = 0; k < g.modifiers.length; k++)
                    (h = g.modifiers[k]),
                      h.type == "attribute" &&
                        (!g.elementName || g.elementName == "*") &&
                        b.report(c.desc, g.line, g.col, c);
              }
            });
          },
        }),
        ...
        CSSLint.addFormatter({
          ...
          formatResults: function (a, b, c) {
            var d = a.messages,
              ...
              f = function (a) {
                return !!a && "name" in a
                  ? "net.csslint." + a.name.replace(/\s/g, "")
                  : "";
              },
              g = function (a) {
          ...
          formatResults: function (a, b, c) {
            ...
            return d.length === 0
              ? c.quiet
                ? ""
                : b + ": Lint Free!"
              : (CSSLint.Util.forEach(d, function (a, c) {
                  a.rollup
                    ? (e += b + ": " + f(a.type) + " - " + a.message + "\n")
                    : (e +=
                        b +
                        ": " +
                        "line " +
