...
(onmessage = function (a) {
  ...
  define(
    ...
    function (a, b, c) {
      var d = a("../lib/oop"),
        ...
        f = a("../worker/jshint").JSHINT,
        g = a("../narcissus/parser"),
        h = (b.JavaScriptWorker = function (a) {
        ...
        function () {
          this.onUpdate = function () {
            ...
            try {
              ...
              var c = b.message.split(":"),
                d = c.pop().trim(),
                e = parseInt(c.pop().trim()) - 1;
            ...
            f(a, { undef: !1, onevar: !1, passfail: !1 }),
  ...
  define(
    ...
    function (a, b, c) {
      var d = (function () {
        ...
        function eb(a, b) {
          var c;
          for (c in b) cb(b, c) && (a[c] = b[c]);
        }
        function fb() {
          B.couch && eb(C, g),
            B.rhino && eb(C, G),
            B.prototypejs && eb(C, F),
            B.node && (eb(C, z), (B.globalstrict = !0)),
            B.devel && eb(C, h),
            B.dojo && eb(C, i),
            B.browser && eb(C, f),
            B.nonstandard && eb(C, K),
            B.jquery && eb(C, s),
            B.mootools && eb(C, x),
            B.wsh && eb(C, T),
            B.esnext && R(),
            B.globalstrict && B.strict !== !1 && (B.strict = !0);
        }
        function gb(a, b, c) {
          var d = Math.floor((b / t.length) * 100);
          throw {
            name: "JSHintError",
            line: b,
            character: c,
        ...
        function ib(a, b, c, e, f, g) {
          ...
          return (
            ...
            (j.reason = a.supplant(j)),
            d.errors.push(j),
            B.passfail && gb("Stopping. ", i, h),
            (S += 1),
            S >= B.maxerr && gb("Too many errors.", i, h),
            j
          );
        }
        function jb(a, b, c, d, e, f, g) {
          return ib(a, { line: b, from: c }, d, e, f, g);
        }
        function kb(a, b, c, d, e, f) {
          var g = ib(a, b, c, d, e, f);
        }
        function lb(a, b, c, d, e, f, g) {
          return kb(a, { line: b, from: c }, d, e, f, g);
        }
        function nb(a, b) {
          a === "hasOwnProperty" &&
            ib("'hasOwnProperty' is a really bad name."),
            cb(k, a) &&
              !k["(global)"] &&
              (k[a] === !0
                ? B.latedef && ib("'{a}' was used before it was defined.", y, a)
                : !B.shadow &&
                  b !== "exception" &&
                  ib("'{a}' is already defined.", y, a)),
            (k[a] = b),
            k["(global)"]
              ? ((n[a] = k),
                cb(o, a) &&
                  (B.latedef &&
                    ib("'{a}' was used before it was defined.", y, a),
                  delete o[a]))
              : (H[a] = k);
        }
        function ob() {
          ...
          a: for (;;) {
            for (;;) {
              if (f.type === "special" && f.value === "*/") break a;
            ...
            f.type !== "(string)" &&
              ...
              g.id === ":"
                ? ((g = mb.token()),
                  b === w &&
                    kb("Expected '{a}' and instead saw '{b}'.", f, "*/", ":"),
                  e === "/*jshint" && db(f.value, f),
                  f.value !== "indent" || (e !== "/*jshint" && e !== "/*jslint")
                    ? f.value !== "maxerr" ||
                      (e !== "/*jshint" && e !== "/*jslint")
                      ? f.value !== "maxlen" ||
                        (e !== "/*jshint" && e !== "/*jslint")
                        ? f.value === "validthis"
                          ? k["(global)"]
                            ...
                            : g.value === "true" || g.value === "false"
                            ? (b[f.value] = g.value === "true")
                            : kb("Bad option value.", g)
                          : g.value === "true"
                          ? (b[f.value] = !0)
                          : g.value === "false"
                          ? (b[f.value] = !1)
        ...
        function pb(a) {
          var b = a || 0,
            c = 0,
            d;
          while (c <= b) (d = u[c]), d || (d = u[c] = mb.token()), (c += 1);
          return d;
        }
        function qb(b, c) {
          switch (P.id) {
            case "(number)":
              ...
              break;
            case "-":
              (y.id === "-" || y.id === "--") && ib("Confusing minusses.");
              break;
            case "+":
              (y.id === "+" || y.id === "++") && ib("Confusing plusses.");
          }
          if (P.type === "(string)" || P.identifier) a = P.value;
          b &&
            y.id !== b &&
            (c
              ? y.id === "(end)"
                ? ib("Unmatched '{a}'.", c, c.id)
                : ib(
              ...
              : (y.type !== "(identifier)" || y.value !== b) &&
                ib("Expected '{a}' and instead saw '{b}'.", y, b, y.value)),
            (E = P),
            (P = y);
          for (;;) {
            y = u.shift() || mb.token();
            if (y.id === "(end)" || y.id === "(error)") return;
            if (y.type === "special") ob();
            else if (y.id !== "(endline)") break;
          }
        }
        function rb(b, c) {
          var d,
            e = !1,
            f = !1;
          y.id === "(end)" && kb("Unexpected early end of program.", P),
            qb(),
            c && ((a = "anonymous"), (k["(verb)"] = P.value));
          if (c === !0 && P.fud) d = P.fud();
          else {
            if (P.nud) d = P.nud();
            else {
              if (y.type === "(number)" && P.id === ".")
                return (
                  ib(
              ...
              kb("Expected an identifier and instead saw '{a}'.", P, P.id);
            }
            while (b < y.lbp)
              (e = P.value === "Array"),
                (f = P.value === "Object"),
                ...
                e &&
                  P.id === "(" &&
                  y.id === ")" &&
                  ib("Use the array literal notation [].", P),
                f &&
                  P.id === "(" &&
                  y.id === ")" &&
                  ib("Use the object literal notation {}.", P),
                P.led
                  ? (d = P.led(d))
                  : kb("Expected an operator and instead saw '{a}'.", P, P.id);
          }
          return d;
        }
        function sb(a, b) {
          (a = a || P),
            ...
            B.white &&
              a.character !== b.from &&
              a.line === b.line &&
              ((a.from += a.character - a.from),
              ib("Unexpected space after '{a}'.", a, a.value));
        }
        function tb(a, b) {
          (a = a || P),
            (b = b || y),
            B.white &&
              (a.character !== b.from || a.line !== b.line) &&
              ib("Unexpected space before '{a}'.", b, b.value);
        }
        function ub(a, b) {
          (a = a || P),
            (b = b || y),
            B.white && !a.comment && a.line === b.line && sb(a, b);
        }
        function vb(a, b) {
          B.white &&
            ((a = a || P),
            ...
            a.line === b.line &&
              a.character === b.from &&
              ((a.from += a.character - a.from),
              ib("Missing space after '{a}'.", a, a.value)));
        }
        function wb(a, b) {
          (a = a || P),
            (b = b || y),
            !B.laxbreak && a.line !== b.line
              ? ib("Bad line breaking before '{a}'.", b, b.id)
              : B.white &&
                ((a = a || P),
                (b = b || y),
                a.character === b.from &&
        ...
        function yb(a) {
          (a = a || P),
            a.line !== y.line && ib("Line breaking error '{a}'.", a, a.value);
        }
        function zb() {
          P.line !== y.line
            ? B.laxcomma ||
              (zb.first &&
                (ib("Comma warnings can be turned off with 'laxcomma'"),
                (zb.first = !1)),
              ib("Bad line breaking before '{a}'.", P, y.id))
            : !P.comment &&
              P.character !== y.from &&
              B.white &&
              ((P.from += P.character - P.from),
              ib("Unexpected space after '{a}'.", P, P.value)),
            qb(","),
            vb(P, y);
        }
        function Ab(a, b) {
          ...
          return (
            ...
            (c.nud =
              typeof b == "function"
                ? b
                : function () {
                    (this.right = rb(150)), (this.arity = "unary");
                    if (this.id === "++" || this.id === "--")
                      B.plusplus
                        ? ib("Unexpected use of '{a}'.", this, this.id)
          ...
          return (
            ...
            (e.led = function (e) {
              return (
                ...
                a === "in" &&
                  e.id === "!" &&
                  ib("Confusing use of '{a}'.", e, "!"),
                typeof b == "function"
                  ? b(e, this)
                  : ((this.left = e), (this.right = rb(c)), this)
              );
            }),
            e
          );
        ...
        function Kb(a, b) {
          ...
          return (
            (c.led = function (a) {
              ...
              var c = rb(100);
              return (
                (a && a.id === "NaN") || (c && c.id === "NaN")
                  ? ib("Use the isNaN function to compare with NaN.", this)
                  : b && b.apply(this, [a, c]),
                a.id === "!" && ib("Confusing use of '{a}'.", a, "!"),
                c.id === "!" && ib("Confusing use of '{a}'.", c, "!"),
                (this.left = a),
                (this.right = c),
                this
              );
          ...
          return (
            ...
            Jb(
              ...
              function (a, b) {
                var c;
                (b.left = a),
                  C[a.value] === !1 && H[a.value]["(global)"] === !0
                    ? ib("Read only.", a)
                    : a["function"] && ib("'{a}' is a function.", a, a.value);
                if (a) {
                  B.esnext &&
                    k[a.value] === "const" &&
                    ib(
                  ...
                  if (a.identifier && !a.reserved)
                    return (
                      k[a.value] === "exception" &&
                        ib("Do not assign to the exception parameter.", a),
                      (b.right = rb(19)),
                      b
                    );
                  a === N["function"] &&
        ...
        function Ob(a) {
          return (
            ...
            Jb(
              a,
              function (a, b) {
                B.bitwise && ib("Unexpected use of '{a}'.", b, b.id),
                  vb(E, P),
                  vb(P, y);
                if (a)
                  return a.id === "." ||
                    a.id === "[" ||
                    (a.identifier && !a.reserved)
                    ? (rb(19), b)
                    : (a === N["function"] &&
                        ib(
                          "Expected an identifier in an assignment, and instead saw a function invocation.",
        ...
        function Rb(a) {
          ...
          if (b) return b;
          P.id === "function" && y.id === "("
            ? ib("Missing name in function declaration.")
            : kb("Expected an identifier and instead saw '{a}'.", y, y.value);
        }
        function Sb(a) {
          var b = 0,
            c;
          ...
          for (;;) {
            ...
            if (c.id !== "(endline)") {
              ...
              ib("Unreachable '{a}' after '{b}'.", c, c.value, a);
              break;
            }
            b += 1;
          }
        ...
        function Tb(a) {
          ...
          e.identifier &&
            ...
            nb(e.value, "label"),
            y.labelled ||
              ib("Label '{a}' on {b} statement.", y, e.value, y.value),
            _.test(e.value + ":") &&
              ib("Label '{a}' looks like a javascript url.", e, e.value),
            (y.label = e.value),
            (e = y)),
            a || xb(),
            (c = rb(0, !0));
          if (!e.block) {
            !B.expr && (!c || !c.exps)
              ...
              : B.nonew &&
                c.id === "(" &&
                c.left.id === "new" &&
                ib("Do not use 'new' for side effects.");
            if (y.id === ",") return zb();
            y.id !== ";"
              ? B.asi ||
                ((!B.lastsemic || y.id !== "}" || y.line !== P.line) &&
                  jb("Missing semicolon.", P.line, P.character))
              : (sb(P, y), qb(";"), vb(P, y));
          }
          return (q = b), (H = d), c;
        }
        function Ub(a) {
          var b = [],
            c,
            d;
          while (!y.reach && y.id !== "(end)")
            y.id === ";"
              ? ((d = pb()),
                (!d || d.id !== "(") && ib("Unnecessary semicolon."),
                qb(";"))
              : b.push(Tb(a === y.line));
          return b;
        }
              ...
              if (b.id === "(endline)") {
                ...
                if (c.id !== ";") {
                  if (
                    ...
                    break;
                  ib("Missing semicolon.", y);
                } else b = c;
              } else if (b.id === "}") ib("Missing semicolon.", b);
              else if (b.id !== ";") break;
              xb(),
                qb(),
                M[P.value] && ib('Unnecessary directive "{a}".', P, P.value),
                P.value === "use strict" && ((B.newcap = !0), (B.undef = !0)),
                (M[P.value] = !0),
                b.id === ";" && qb(";");
              continue;
            }
        ...
        function Wb(a, b, c) {
          var d,
            ...
            l;
          p = a;
          if (!a || !B.funcscope) H = Object.create(H);
          vb(P, y), (i = y);
          if (y.id === "{") {
            qb("{"), (j = P.line);
            if (y.id !== "}") {
              q += B.indent;
              while (!a && y.from > q) q += B.indent;
              if (c) {
                g = {};
                for (l in M) cb(M, l) && (g[l] = M[l]);
                Vb(),
                  B.strict &&
                    k["(context)"]["(global)"] &&
                    !g["use strict"] &&
                    !M["use strict"] &&
                    ib('Missing "use strict" statement.');
              }
              (d = Ub(j)), c && (M = g), (q -= B.indent), j !== y.line && xb();
            } else j !== y.line && xb();
            qb("}", i), (q = f);
          } else
            a
              ? ((!b || B.curly) &&
                  ib("Expected '{a}' and instead saw '{b}'.", y, "{", y.value),
                (A = !0),
                (q += B.indent),
                (d = [Tb(y.line === P.line)]),
                (q -= B.indent),
                (A = !1))
              : kb("Expected '{a}' and instead saw '{b}'.", y, "{", y.value);
          k["(verb)"] = null;
          if (!a || !B.funcscope) H = h;
          return (
            (p = e),
            a && B.noempty && (!d || d.length === 0) && ib("Empty block."),
            d
          );
        }
        function Xb(a) {
          w &&
            typeof w[a] != "boolean" &&
            ib("Unexpected /*member '{a}'.", P, a),
            typeof v[a] == "number" ? (v[a] += 1) : (v[a] = 1);
        }
        function Yb(a) {
          var b = a.value,
            c = a.line,
            d = o[b];
          typeof d == "function" && (d = !1),
            d ? d[d.length - 1] !== c && d.push(c) : ((d = [c]), (o[b] = d));
        }
        function Zb() {
          var a = Qb(!0);
          return (
            a ||
              (y.id === "(string)"
                ? ((a = y.value), qb())
                : y.id === "(number)" && ((a = y.value.toString()), qb())),
            a
          );
        }
        function $b() {
          ...
          for (;;) {
            (a = Rb(!0)), c.push(a), nb(a, "parameter");
            if (y.id !== ",") return qb(")", b), ub(E, P), c;
            zb();
          }
        }
        function _b(b, c) {
        ...
        function bc() {
          function a() {
            ...
            if (y.id !== "}")
              for (;;) {
                if (y.id === "(end)")
                  kb("Missing '}' to match '{' from line {a}.", y, b.line);
                else {
                  if (y.id === "}") {
                    ib("Unexpected comma.", P);
                    break;
                  }
                  y.id === ","
                    ? kb("Unexpected comma.", y)
                    : y.id !== "(string)" &&
                      ib("Expected a string and instead saw {a}.", y, y.value);
                }
                a[y.value] === !0
                  ? ib("Duplicate key '{a}'.", y, y.value)
                  : (y.value === "__proto__" && !B.proto) ||
                    (y.value === "__iterator__" && !B.iterator)
                  ? ib(
          ...
          function b() {
            ...
            if (y.id !== "]")
              for (;;) {
                if (y.id === "(end)")
                  kb("Missing ']' to match '[' from line {a}.", y, a.line);
                else {
                  if (y.id === "]") {
                    ib("Unexpected comma.", P);
                    break;
                  }
                  y.id === "," && kb("Unexpected comma.", y);
                }
                bc();
                if (y.id !== ",") break;
                qb(",");
          ...
          switch (y.id) {
            ...
            case "-":
              qb("-"),
                P.character !== y.from && ib("Unexpected space after '-'.", P),
                sb(P, y),
                qb("(number)");
              break;
            default:
              kb("Expected a JSON value.", y);
          }
        }
        var a,
          b = {
          ...
          e = { maxlen: !1, indent: !1, maxerr: !1, predef: !1 },
          f = {
            ArrayBuffer: !1,
            ArrayBufferView: !1,
            Audio: !1,
          ...
          i = { dojo: !1, dijit: !1, dojox: !1, define: !1, require: !1 },
          j = {
            "\b": "\\b",
            "	": "\\t",
            "\n": "\\n",
        ...
        (function () {
          ...
          typeof Object.create != "function" &&
            (Object.create = function (a) {
              return (bb.prototype = a), new bb();
            }),
          typeof Object.keys != "function" &&
            (Object.keys = function (a) {
              var b = [],
                c;
              for (c in a) cb(a, c) && b.push(c);
              return b;
            }),
          typeof String.prototype.entityify != "function" &&
            (String.prototype.entityify = function () {
              return this.replace(/&/g, "&amp;")
                .replace(/</g, "&lt;")
                .replace(/>/g, "&gt;");
            }),
          typeof String.prototype.isAlpha != "function" &&
            (String.prototype.isAlpha = function () {
              return (
                (this >= "a" && this <= "z￿") || (this >= "A" && this <= "Z￿")
              );
            }),
          typeof String.prototype.isDigit != "function" &&
            (String.prototype.isDigit = function () {
              return this >= "0" && this <= "9";
            }),
          typeof String.prototype.supplant != "function" &&
          ...
          typeof String.prototype.name != "function" &&
            (String.prototype.name = function () {
              return $.test(this)
                ...
                : X.test(this)
                ? '"' +
                  this.replace(Y, function (a) {
                    var b = j[a];
                    return b
                      ? b
                      : "\\u" +
                          ("0000" + a.charCodeAt().toString(16)).slice(-4);
                  }) +
                  '"'
                : '"' + this + '"';
            });
        var mb = (function () {
          function f() {
            ...
            return d >= t.length
              ...
              : ((b = 1),
                (e = t[d]),
                (d += 1),
                B.smarttabs ? (a = e.search(/ \t/)) : (a = e.search(/ \t|\t /)),
                a >= 0 && jb("Mixed spaces and tabs.", d, a + 1),
                (e = e.replace(/\t/g, O)),
                (a = e.search(V)),
                a >= 0 && jb("Unsafe character.", d, a),
                B.maxlen &&
                  B.maxlen < e.length &&
                  jb("Line too long.", d, e.length),
                (c = B.trailing && e.match(/^(.*?)\s+$/)),
                c &&
                  !/^\s+$/.test(e) &&
                  jb("Trailing whitespace.", d, c[1].length + 1),
                !0);
          }
          function g(a, e) {
            var f, g;
            return (
              a === "(color)" || a === "(range)"
                ? (g = { type: a })
                : a === "(punctuator)" || (a === "(identifier)" && cb(N, e))
                ? (g = N[e] || N["(error)"])
                : (g = N[a]),
              (g = Object.create(g)),
              (a === "(string)" || a === "(range)") &&
              ...
              a === "(identifier)" &&
                ((g.identifier = !0),
                e === "__proto__" && !B.proto
                  ? jb("The '{a}' property is deprecated.", d, c, e)
                  : e === "__iterator__" && !B.iterator
                  ? jb("'{a}' is only available in JavaScript 1.7.", d, c, e)
                  : B.nomen &&
                    (e.charAt(0) === "_" || e.charAt(e.length - 1) === "_") &&
                    (!B.node ||
                      P.id === "." ||
                      (e !== "__dirname" && e !== "__filename")) &&
                    jb("Unexpected {a} in '{b}'.", d, c, "dangling '_'", e)),
              (g.value = e),
              (g.line = d),
              (g.character = b),
              (g.from = c),
          ...
          return {
            ...
            range: function (a, f) {
              ...
              for (;;) {
                (e = e.slice(1)), (b += 1), (h = e.charAt(0));
                switch (h) {
                  case "":
                    lb("Missing '{a}'.", d, b, h);
                    break;
                  case f:
                    return (e = e.slice(1)), (b += 1), g("(range)", i);
                  case "\\":
                    jb("Unexpected '{a}'.", d, b, h);
                }
                i += h;
              }
            },
            token: function () {
              ...
              function w(a) {
                function l(a) {
                  var c = parseInt(e.substr(i + 1, a), 16);
                  (i += a),
                    c >= 32 &&
                      c <= 126 &&
                      c !== 34 &&
                ...
                var h,
                  ...
                  j = "",
                  k = !1;
                r && a !== '"' && jb("Strings must use doublequote.", d, b),
                  (i = 0);
                a: for (;;) {
                  while (i >= e.length) {
                    i = 0;
                    var m = d,
                      n = c;
                    if (!f()) {
                      lb("Unclosed string.", m, n);
                      break a;
                    }
                    k ? (k = !1) : jb("Unclosed string.", m, n);
                  }
                  h = e.charAt(i);
                  if (h === a)
                    return (b += 1), (e = e.substr(i + 1)), g("(string)", j, a);
                  if (h < " ") {
                    if (h === "\n" || h === "\r") break;
                    jb(
                    ...
                    switch (h) {
                      ...
                      case "v":
                        ...
                        break;
                      case "x":
                        r && jb("Avoid \\x-.", d, b), l(2);
                        break;
                      case "":
                        k = !0;
                        if (B.multistr) {
                          r && jb("Avoid EOL escapement.", d, b),
                            (h = ""),
                            (b -= 1);
                          break;
                        }
                        ...
                        break;
                      default:
                        jb("Bad escapement.", d, b);
                    }
                  }
                  (j += h), (b += 1), (i += 1);
                }
              }
              var a, h, i, j, k, l, m, n, o, p, q, s, t, u;
              for (;;) {
                if (!e) return g(f() ? "(endline)" : "(end)", "");
                q = v(W);
                if (!q) {
                  (q = ""), (h = "");
                  while (e && e < "!") e = e.substr(1);
                  e &&
                    (lb("Unexpected '{a}'.", d, b, e.substr(0, 1)), (e = ""));
                } else {
                  if (h.isAlpha() || h === "_" || h === "$")
                    return g("(identifier)", q);
                  if (h.isDigit())
                    return (
                      isFinite(Number(q)) || jb("Bad number '{a}'.", d, b, q),
                      e.substr(0, 1).isAlpha() &&
                        jb("Missing space after '{a}'.", d, b, q),
                      h === "0" &&
                        ((j = q.substr(1, 1)),
                        j.isDigit()
                          ? P.id !== "." &&
                            jb("Don't use extra leading zeros '{a}'.", d, b, q)
                          : r &&
                            (j === "x" || j === "X") &&
                            jb("Avoid 0x-. '{a}'.", d, b, q)),
                      q.substr(q.length - 1) === "." &&
                  ...
                  switch (q) {
                    ...
                    case "/*":
                      for (;;) {
                        m = e.search(Z);
                        if (m >= 0) break;
                        f() || lb("Unclosed comment.", d, b);
                      }
                      (b += m + 2),
                        e.substr(m, 1) === "/" && lb("Nested comment.", d, b),
                        (e = e.substr(m + 2)),
                        (P.comment = !0);
                      break;
                    case "/*members":
                    ...
                    case "/":
                      ...
                      if (D) {
                        (k = 0), (i = 0), (n = 0);
                        for (;;) {
                          (a = !0), (h = e.charAt(n)), (n += 1);
                          switch (h) {
                            case "":
                              return (
                                lb("Unclosed regular expression.", d, c),
                                gb("Stopping.", d, c)
                              );
                            case "/":
                              k > 0 &&
                                jb(
                                  "{a} unterminated regular expression group(s).",
                                  d,
                                  c + n,
                                  k
                                ),
                              ...
                              return (
                                ...
                                (p = e.charAt(0)),
                                (p === "/" || p === "*") &&
                                  lb("Confusing regular expression.", d, c),
                                g("(regexp)", h)
                              );
                            case "\\":
                              (h = e.charAt(n)),
                            ...
                            case ")":
                              k === 0
                                ? jb("Unescaped '{a}'.", d, c + n, ")")
                                : (k -= 1);
                              break;
                            case " ":
                              p = 1;
                              while (e.charAt(n) === " ") (n += 1), (p += 1);
                              p > 1 &&
                                jb(
                            ...
                            case "[":
                              (h = e.charAt(n)),
                                h === "^" &&
                                  ((n += 1),
                                  B.regexp
                                    ? jb("Insecure '{a}'.", d, c + n, h)
                                    : e.charAt(n) === "]" &&
                                      lb("Unescaped '{a}'.", d, c + n, "^")),
                                h === "]" && jb("Empty class.", d, c + n - 1),
                                (s = !1),
                                (t = !1);
                              a: do {
                                (h = e.charAt(n)), (n += 1);
                              ...
                              break;
                            case ".":
                              B.regexp && jb("Insecure '{a}'.", d, c + n, h);
                              break;
                            case "]":
                            case "?":
                            case "{":
        ...
        Gb("(number)", function () {
          ...
          (N["(identifier)"] = {
              ...
              if (k === c)
                switch (k[b]) {
                  case "unused":
                    ...
                    break;
                  case "unction":
                    (k[b] = "function"), (this["function"] = !0);
                    break;
                  case "function":
                    this["function"] = !0;
                    break;
                  case "label":
                    ib("'{a}' is a statement label.", P, b);
                }
              else if (k["(global)"])
                B.undef &&
                  typeof C[b] != "boolean" &&
            ...
            led: function () {
              kb("Expected an operator and instead saw '{a}'.", y, y.value);
            },
          }),
          Gb("(regexp)", function () {
            return this;
          ...
          (Hb("default").reach = !0),
          Hb("finally"),
          Ib("arguments", function (a) {
            M["use strict"] && k["(global)"] && ib("Strict violation.", a);
          }),
          Ib("eval"),
          Ib("false"),
          Ib("Infinity"),
          ...
          Ib("this", function (a) {
            M["use strict"] &&
              !B.validthis &&
              ((k["(statement)"] && k["(name)"].charAt(0) > "Z") ||
                k["(global)"]) &&
              ib("Possible strict violation.", a);
          }),
          Ib("true"),
          Ib("undefined"),
          Mb("=", "assign", 20),
          ...
          Mb("-=", "assignsub", 20),
          Mb("*=", "assignmult", 20),
          (Mb("/=", "assigndiv", 20).nud = function () {
            kb("A regular expression literal can be confused with '/='.");
          }),
          Mb("%=", "assignmod", 20),
          Ob("&=", "assignbitand", 20),
          Ob("|=", "assignbitor", 20),
          Ob("^=", "assignbitxor", 20),
          Ob("<<=", "assignshiftleft", 20),
          Ob(">>=", "assignshiftright", 20),
          Ob(">>>=", "assignshiftrightunsigned", 20),
          Jb(
            "?",
            function (a, b) {
              return (
          ...
          Nb("&", "bitand", 90),
          Kb("==", function (a, b) {
            var c = B.eqnull && (a.value === "null" || b.value === "null");
            return (
              !c && B.eqeqeq
                ? ib("Expected '{a}' and instead saw '{b}'.", this, "===", "==")
                : Lb(a)
                ? ib("Use '{a}' to compare with '{b}'.", this, "===", a.value)
                : Lb(b) &&
                  ib("Use '{a}' to compare with '{b}'.", this, "===", b.value),
              this
            );
          }),
          Kb("==="),
          ...
          Nb("<<", "shiftleft", 120),
          Nb(">>", "shiftright", 120),
          Nb(">>>", "shiftrightunsigned", 120),
          Jb("in", "in", 120),
          Jb("instanceof", "instanceof", 120),
          Jb(
            "+",
            function (a, b) {
              var c = rb(130);
              return a && c && a.id === "(string)" && c.id === "(string)"
                ? ((a.value += c.value),
                  (a.character = c.character),
                  !B.scripturl && _.test(a.value) && ib("JavaScript URL.", a),
                  a)
                : ((b.left = a), (b.right = c), b);
            },
            130
          ),
          Fb("+", "num"),
          ...
          (Fb("delete", function () {
            ...
            return (
              (!a || (a.id !== "." && a.id !== "[")) &&
                ib("Variables should not be deleted."),
              (this.first = a),
              this
            );
          }).exps = !0),
          Fb("~", function () {
            return (
              B.bitwise && ib("Unexpected '{a}'.", this, "~"), rb(150), this
            );
          }),
          Fb("!", function () {
            return (
            ...
            if (a && a.id !== "function")
              if (a.identifier) {
                ...
                switch (a.value) {
                  ...
                  case "Math":
                  case "JSON":
                    ib("Do not use {a} as a constructor.", P, a.value);
                    break;
                  case "Function":
                    B.evil || ib("The Function constructor is eval.");
                    break;
                  case "Date":
                  case "RegExp":
                    break;
                ...
                a.id !== "." &&
                  a.id !== "[" &&
                  a.id !== "(" &&
                  ib("Bad constructor.", P);
            else B.supernew || ib("Weird construction. Delete 'new'.", this);
            return (
              sb(P, y),
              y.id !== "(" &&
                !B.supernew &&
                ib("Missing '()' invoking a constructor."),
              (this.first = a),
              this
            );
          }),
              ...
              return (
                ...
                (c !== "callee" && c !== "caller")
                  ? !B.evil &&
                    ...
                    a.value === "document" &&
                    (c === "write" || c === "writeln") &&
                    ib("document.write can be a form of eval.", a)
                  : B.noarg
                  ? ib("Avoid arguments.{a}.", a, c)
                  : M["use strict"] && kb("Strict violation."),
                !B.evil &&
                  (c === "eval" || c === "execScript") &&
                  ib("eval is evil."),
                b
          ...
          (Jb(
            ...
            function (a, b) {
              ...
              a &&
                a.type === "(identifier)" &&
                a.value.match(/^[A-Z]([A-Z0-9_$]*[a-z][A-Za-z0-9_$]*)?$/) &&
                a.value !== "Number" &&
                a.value !== "String" &&
                a.value !== "Boolean" &&
                a.value !== "Date" &&
                (a.value === "Math"
                  ? ib("Math is not a function.", a)
                  : B.newcap &&
                    ib("Missing 'new' prefix when invoking a constructor.", a));
              if (y.id !== ")")
                for (;;) {
                  (d[d.length] = rb(10)), (c += 1);
                  if (y.id !== ",") break;
                  zb();
                }
              return (
            ...
            function (a, b) {
              ...
              return (
                c &&
                  c.type === "(string)" &&
                  (!B.evil &&
                    (c.value === "eval" || c.value === "execScript") &&
                    ib("eval is evil.", b),
                  Xb(c.value),
                  !B.sub &&
                    $.test(c.value) &&
          ...
          Fb(
            ...
            function () {
              ...
              (this.first = []),
                a &&
                  ((q += B.indent), y.from === q + B.indent && (q += B.indent));
              while (y.id !== "(end)") {
                while (y.id === ",") ib("Extra comma."), qb(",");
                if (y.id === "]") break;
                a && P.line !== y.line && xb(), this.first.push(rb(10));
                if (y.id !== ",") break;
                zb();
                if (y.id === "]" && !B.es5) {
                  ib("Extra comma.", P);
              ...
              return a && ((q -= B.indent), xb()), qb("]", this), this;
            },
            160
          ),
          (function (a) {
            (a.nud = function () {
              ...
              for (;;) {
                if (y.id === "}") break;
                a && xb();
                if (y.value === "get" && pb().id !== ":")
                  qb("get"),
                    B.es5 || kb("get/set are ES5 features."),
                    (c = Zb()),
                    c || kb("Missing property name."),
                    j(c),
                    (f = y),
                    sb(P, y),
                    (b = _b()),
                ...
                zb(),
                  y.id === ","
                    ? ib("Extra comma.", P)
                    : y.id === "}" && !B.es5 && ib("Extra comma.", P);
              }
              a && ((q -= B.indent), xb()), qb("}", this);
              if (B.es5)
                for (var k in g)
                  cb(g, k) &&
                    g[k].setter &&
                    !g[k].getter &&
                    ib("Setter is defined without getter.", g[k].setterToken);
              return this;
            }),
              (a.fud = function () {
                kb("Expected to see a statement and instead saw a block.", P);
              });
          })(Bb("{")),
          (R = function () {
            var a = Cb("const", function (a) {
              var b, c, d;
              this.first = [];
              for (;;) {
                vb(P, y),
                  (b = Rb()),
                  k[b] === "const" &&
                    ib("const '" + b + "' has already been declared"),
                  k["(global)"] &&
                    C[b] === !1 &&
                    ib("Redefinition of '{a}'.", P, b),
                  nb(b, "const");
                if (a) break;
                (c = P),
                  this.first.push(P),
                  y.id !== "=" &&
                    ib("const '{a}' is initialized to 'undefined'.", P, b),
                  y.id === "=" &&
                    (vb(P, y),
                    qb("="),
                    vb(P, y),
        ...
        var ac = Cb("var", function (a) {
          var b, c, d;
          k["(onevar)"] && B.onevar
            ? ib("Too many var statements.")
            : k["(global)"] || (k["(onevar)"] = !0),
            (this.first = []);
          for (;;) {
            vb(P, y),
            ...
            (c = P),
              ...
              y.id === "=" &&
                ...
                pb(0).id === "=" &&
                  y.identifier &&
                  kb("Variable {a} was not declared correctly.", y, y.value),
                (d = rb(0)),
                (c.first = d));
            if (y.id !== ",") break;
            zb();
        ...
        (ac.exps = !0),
          Db("function", function () {
            ...
            return (
              B.esnext &&
                k[a] === "const" &&
                ib("const '" + a + "' has already been declared"),
              sb(P, y),
              nb(a, "unction"),
              _b(a, !0),
              y.id === "(" &&
          ...
          Fb("function", function () {
            ...
            return (
              ...
              !B.loopfunc &&
                k["(loopage)"] &&
                ib("Don't make functions within a loop."),
              this
            );
          }),
          Db("if", function () {
            ...
            return (
              ...
              y.id === "else" &&
                (vb(P, y),
                qb("else"),
                y.id === "if" || y.id === "switch" ? Tb(!0) : Wb(!0, !0)),
              this
            );
          }),
          Db("try", function () {
            ...
            Wb(!1),
              y.id === "catch" &&
                ...
                (b = y.value),
                y.type !== "(identifier)"
                  ? ib("Expected an identifier and instead saw '{a}'.", y, b)
                  : nb(b, "exception"),
                qb(),
                qb(")"),
                Wb(!1),
          ...
          Db("with", function () {
            ...
            return (
              M["use strict"]
                ? kb("'with' is not allowed in strict mode.", P)
                : B.withstmt || ib("Don't use 'with'.", P),
              qb("("),
              vb(this, a),
              ub(),
              rb(0),
              ...
              switch (y.id) {
                case "case":
                  switch (k["(verb)"]) {
                    ...
                    default:
                      ab.test(t[y.line - 2]) ||
                        ib("Expected a 'break' statement before 'case'.", P);
                  }
                  xb(-B.indent),
                    qb("case"),
                    this.cases.push(rb(20)),
                    (b = !0),
                    qb(":"),
                    (k["(verb)"] = "case");
                  break;
                case "default":
                  switch (k["(verb)"]) {
                    ...
                    default:
                      ab.test(t[y.line - 2]) ||
                        ib("Expected a 'break' statement before 'default'.", P);
                  }
                  xb(-B.indent), qb("default"), (b = !0), qb(":");
                  break;
                case "}":
                  (q -= B.indent), xb(), qb("}", a);
                  if (
                    ...
                    B.onecase || ib("This 'switch' should be an 'if'.", this);
                  (k["(breakage)"] -= 1), (k["(verb)"] = undefined);
                  return;
                case "(end)":
                  kb("Missing '{a}'.", y, "}");
                  return;
                default:
                  if (b)
                    switch (P.id) {
                      case ",":
                        kb("Each value should have its own case label.");
                        return;
                      case ":":
                        (b = !1), Ub();
                        break;
                      default:
                        kb("Missing ':' on a case clause.", P);
                        return;
                    }
                  else {
                    if (P.id !== ":") {
                    ...
                    qb(":"), kb("Unexpected '{a}'.", P, ":"), Ub();
                  }
              }
          }).labelled = !0),
          (Cb("debugger", function () {
            return (
              B.debug || ib("All 'debugger' statements should be removed."),
              this
            );
          }).exps = !0),
          (function () {
            var a = Cb("do", function () {
              (k["(breakage)"] += 1),
                (k["(loopage)"] += 1),
                (this.first = Wb(!0)),
                qb("while");
          ...
          (Db("for", function () {
            ...
            (k["(breakage)"] += 1),
              ...
              vb(this, b),
              ub();
            if (pb(y.id === "var" ? 1 : 0).id === "in") {
              if (y.id === "var") qb("var"), ac.fud.call(ac, !0);
              else {
                switch (k[y.value]) {
                  case "unused":
                    k[y.value] = "var";
                  ...
                  case "var":
                    break;
                  default:
                    ib("Bad for in variable '{a}'.", y, y.value);
                }
                qb();
              }
              return (
            ...
            if (y.id !== ";")
              if (y.id === "var") qb("var"), ac.fud.call(ac);
              else
                for (;;) {
                  rb(0, "for");
                  if (y.id !== ",") break;
            ...
            yb(P),
              ...
              qb(";"),
              y.id === ";" &&
                kb("Expected '{a}' and instead saw '{b}'.", y, ")", ";");
            if (y.id !== ")")
              for (;;) {
                rb(0, "for");
                if (y.id !== ",") break;
          ...
          (Cb("break", function () {
            var a = y.value;
            return (
              k["(breakage)"] === 0 && ib("Unexpected '{a}'.", y, this.value),
              B.asi || yb(this),
              y.id !== ";" &&
                P.line === y.line &&
                (k[a] !== "label"
                  ? ib("'{a}' is not a statement label.", y, a)
                  : H[a] !== k && ib("'{a}' is out of scope.", y, a),
                (this.first = y),
                qb()),
              Sb("break"),
              this
            ...
            return (
              ...
              y.id !== ";"
                ? P.line === y.line &&
                  ...
                  (this.first = y),
                  qb())
                : k["(loopage)"] || ib("Unexpected '{a}'.", y, this.value),
              Sb("continue"),
              this
            );
          }).exps = !0),
          ...
          (Cb("throw", function () {
            return yb(this), vb(P, y), (this.first = rb(20)), Sb("throw"), this;
          }).exps = !0),
          Hb("class"),
          Hb("const"),
          Hb("enum"),
        ...
        var cc = function (a, b, c) {
          ...
          if (b) {
            ...
            if (e)
              if (Array.isArray(e))
                for (f = 0; f < e.length; f += 1) C[e[f]] = !0;
              else if (typeof e == "object") {
                g = Object.keys(e);
                for (f = 0; f < g.length; f += 1) C[g[f]] = !!e[g[f]];
              }
            B = b;
          } else B = {};
          (B.indent = B.indent || 4), (B.maxerr = B.maxerr || 50), (O = "");
          for (f = 0; f < B.indent; f += 1) O += " ";
          (q = 1),
            (n = Object.create(C)),
            (H = n),
            (k = {
            ...
            (M = {}),
            (E = P = y = N["(begin)"]);
          for (var h in b) cb(b, h) && db(h, P);
          fb(), eb(C, c || {}), (zb.first = !0);
          try {
            qb();
            switch (y.id) {
              case "{":
              ...
              default:
                Vb(),
                  M["use strict"] &&
                    !B.globalstrict &&
                    ib('Use the function form of "use strict".', E),
                  Ub();
            }
            qb("(end)");
            var i = function (a, b) {
              ...
              j = function (a, b) {
                if (!o[a]) return;
                var c = [];
                for (var d = 0; d < o[a].length; d += 1)
                  o[a][d] !== b && c.push(o[a][d]);
                c.length === 0 ? delete o[a] : (o[a] = c);
              };
            for (f = 0; f < d.undefs.length; f += 1)
              (g = d.undefs[f].slice(0)),
                i(g[2].value, g[0])
                  ? j(g[2].value, g[2].line)
                  : ib.apply(ib, g.slice(1));
          } catch (l) {
            if (l) {
              var s = y || {};
              d.errors.push(
        ...
        return (
          (cc.data = function () {
            var a = { functions: [], options: B },
              ...
              j = [],
              k;
            cc.errors.length && (a.errors = cc.errors), r && (a.json = !0);
            for (i in o) cb(o, i) && d.push({ name: i, line: o[i] });
            d.length > 0 && (a.implieds = d),
              Q.length > 0 && (a.urls = Q),
              (c = Object.keys(H)),
              c.length > 0 && (a.globals = c);
            for (f = 1; f < m.length; f += 1) {
              (e = m[f]), (b = {});
              for (g = 0; g < l.length; g += 1) b[l[g]] = [];
              for (i in e)
                cb(e, i) &&
                  i.charAt(0) !== "(" &&
                  ((k = e[i]),
          ...
          (cc.report = function (a) {
            ...
            if (b.errors || b.implieds || b.unused) {
                  ...
                  (d = b.errors[h]),
                    d &&
                      ...
                      m.push(
                        "<p>Problem" +
                          (isFinite(d.line)
                            ? " at line " + d.line + " character " + d.character
                            : "") +
                          ": " +
                          d.reason.entityify() +
                          "</p><p class=evidence>" +
              ...
              if (b.implieds) {
                n = [];
                for (h = 0; h < b.implieds.length; h += 1)
                  n[h] =
                    "<code>" +
                    b.implieds[h].name +
                    "</code>&nbsp;<i>" +
            ...
            if (!a) {
              m.push("<br><div id=functions>"),
                b.urls && o("URLs<br>", b.urls, "<br>"),
                b.json && !f
                  ? m.push("<p>JSON: good.</p>")
                  : b.globals
                  ? m.push(
                      "<div><i>Global</i> " +
                        b.globals.sort().join(", ") +
                  ...
                  : m.push(
                      "<div><i>No new global variables introduced.</i></div>"
                    );
              for (h = 0; h < b.functions.length; h += 1)
                (g = b.functions[h]),
                  m.push(
                    "<br><div class=function><i>" +
                      ...
                      (g.name || "") +
                      "(" +
                      (g.param ? g.param.join(", ") : "") +
                      ")</div>"
                  ),
                  o("<big><b>Unused</b></big>", g.unused),
                  o("Closure", g.closure),
                  o("Variable", g["var"]),
                  o("Exception", g.exception),
                  o("Outer", g.outer),
                  o("Global", g.global),
                  o("Label", g.label);
              if (b.member) {
  ...
  define(
    ...
    [
      ...
      "module",
      "ace/narcissus/lexer",
      "ace/narcissus/definitions",
      "ace/narcissus/options",
    ],
    function (require, exports, module) {
      ...
      function Parser(a) {
        (a.parser = this),
          (this.t = a),
          (this.x = null),
          (this.unexpectedEOF = !1),
          options.mozillaMode && (this.mozillaMode = !0),
          options.parenFreeMode && (this.parenFreeMode = !0);
      }
      function StaticContext(a, b, c, d, e) {
        (this.parentScript = a),
          (this.parentBlock = b || a),
          (this.inModule = c || !1),
          (this.inFunction = d || !1),
          (this.inForLoopInit = !1),
          (this.topLevel = !0),
      ...
      function Pragma(a) {
        if (a.type === SEMICOLON) {
          var b = a.expression;
          if (b.type === STRING && b.value === "use strict")
            return (a.pragma = "strict"), !0;
        }
        return !1;
      }
      function Node(a, b) {
      ...
      function unevalableConst(a) {
        var b = definitions.tokens[a],
          c = definitions.opTypeNames.hasOwnProperty(b)
            ? definitions.opTypeNames[b]
            : b in definitions.keywords
            ? b.toUpperCase()
            : b;
        return {
          toSource: function () {
        ...
        switch (b.type) {
          ...
          case VAR:
            for (var d = 0; d < b.children.length; d++)
              c(b.children[d].name, new Export(b.children[d], !0));
            break;
          case LET:
          case CONST:
              ...
              switch (e.type) {
                case OBJECT_INIT:
                  for (var f = 0; f < e.children.length; f++) {
                    var g = e.children[f];
                    g.type === IDENTIFIER
                      ? c(g.value, new Export(g, !1))
                      : c(g.children[0].value, new Export(g.children[1], !1));
                  }
                  break;
                case DOT:
                ...
                default:
                  throw new Error(
                    "unexpected export path: " + definitions.tokens[e.type]
                  );
              }
            }
            break;
      ...
      function Module(a) {
        ...
        b.forEach(function (a, b) {
          ...
          (this.node = a),
          (this.exports = b),
          (this.exportedModules = d);
      }
      function isPragmaToken(a) {
        switch (a) {
          case IDENTIFIER:
          case STRING:
          case NUMBER:
      ...
      function parse(a, b, c) {
        var d = new Tokenizer(a, b, c, options.allowHTMLComments),
          e = new Parser(d);
        return e.Script(!1, !1, !0);
      }
      function parseFunction(a, b, c, d, e) {
        var f = new Tokenizer(a, d, e),
          g = new Parser(f);
        return (
          (g.x = new StaticContext(null, null, !1, !1, !1)),
          g.FunctionDefinition(b, c)
        );
      }
      function parseStdin(a, b, c, d) {
        if (a.match(/^[\s]*\.begin[\s]*$/))
          return ++b.value, parseMultiline(b, c);
        d(a.trim()) && (a = "");
        for (;;)
          try {
            var e = new Tokenizer(a, "stdin", b.value, !1),
              f = new Parser(e),
              g = f.Script(!1, !1);
            return (b.value = e.lineno), g;
          } catch (h) {
            if (!f.unexpectedEOF) throw h;
            var i;
            do {
              c && putstr(c), (i = readline());
              if (!i) throw h;
            } while (d(i.trim()));
            a += "\n" + i;
          }
      ...
      function parseMultiline(a, b) {
        ...
        var e = new Tokenizer(c, "stdin", a.value, !1),
          f = new Parser(e),
          g = f.Script(!1, !1);
        return (a.value = e.lineno), g;
      }
      ...
      eval(definitions.consts),
        (StaticContext.prototype = {
          ...
          pushTarget: function (a) {
            var b = a.isLoop,
              c = b || a.type === SWITCH;
            return this.currentLabels.isEmpty()
              ? (b && this.update({ defaultLoopTarget: a }),
                c && this.update({ defaultTarget: a }),
                this)
              : ((a.labels = new Dict()),
                this.currentLabels.forEach(function (b) {
                  a.labels.set(b, !0);
                }),
                this.update({
          ...
          nest: function () {
            return this.topLevel ? this.update({ topLevel: !1 }) : this;
          },
          canImport: function () {
      ...
      (Pp.mozillaMode = !1),
        (Pp.parenFreeMode = !1),
        (Pp.withContext = function (a, b) {
          var c = this.x;
          this.x = a;
          var d = b.call(this);
          return (this.x = c), d;
        }),
        (Pp.newNode = function (b) {
          return new Node(this.t, b);
        }),
        (Pp.fail = function (b) {
          throw this.t.newSyntaxError(b);
        }),
        (Pp.match = function (b, c, d) {
          return this.t.match(b, c, d);
        }),
        (Pp.mustMatch = function (b, c) {
          return this.t.mustMatch(b, c);
        }),
        (Pp.peek = function (b) {
          return this.t.peek(b);
        }),
        (Pp.peekOnSameLine = function (b) {
          return this.t.peekOnSameLine(b);
        }),
        (Pp.done = function () {
          return this.t.done;
        }),
        (Pp.Script = function (b, c, d) {
          var e = this.newNode(scriptInit()),
            f = new StaticContext(e, e, b, c);
          return (
            this.withContext(f, function () {
              this.Statements(e, !0);
            }),
            d && !this.done() && this.fail("expected end of input"),
            e
          );
        });
      ...
      (Np.toSource = function () {
        var b = {},
          c = this;
        b.type = unevalableConst(this.type);
        if (this.generatingSource) return b.toSource();
        (this.generatingSource = !0),
          "value" in this && (b.value = this.value),
          "lineno" in this && (b.lineno = this.lineno),
          "start" in this && (b.start = this.start),
          "end" in this && (b.end = this.end),
          this.assignOp && (b.assignOp = unevalableConst(this.assignOp));
        for (var d in this)
          this.hasOwnProperty(d) && !(d in TO_SOURCE_SKIP) && (b[d] = this[d]);
        try {
          return b.toSource();
        } finally {
        ...
        (Np.push = function (a) {
          return (
            a !== null &&
              (a.start < this.start && (this.start = a.start),
        ...
        (Np.synth = function (a) {
          var b = new SyntheticNode(a);
          return (
            (b.filename = this.filename),
            (b.lineno = this.lineno),
            (b.start = this.start),
            (b.end = this.end),
            b
          );
        });
      var LOOP_INIT = { isLoop: !0 };
      definitions.defineGetter(Np, "length", function () {
        ...
        (Pp.MaybeLeftParen = function () {
          return this.parenFreeMode
            ? this.match(LEFT_PAREN)
              ? LEFT_PAREN
              : END
            : this.mustMatch(LEFT_PAREN).type;
        }),
        (Pp.MaybeRightParen = function (b) {
          b === LEFT_PAREN && this.mustMatch(RIGHT_PAREN);
        }),
        (Pp.Statements = function (b, c) {
          var d = !!c;
          try {
            while (!this.done() && this.peek(!0) !== RIGHT_CURLY) {
              ...
              b.push(e),
                d && Pragma(e)
                  ? ((this.x.strictMode = !0), (b.strict = !0))
                  : (d = !1);
            }
          } catch (f) {
            try {
        ...
        (Pp.Block = function () {
          ...
          var b = this.newNode(blockInit()),
            c = this.x.update({ parentBlock: b }).pushTarget(b);
          return (
            this.withContext(c, function () {
              this.Statements(b);
            }),
      ...
      (Pp.Statement = function () {
        var b,
          ...
          l,
          m,
          n = this.t.blockComments;
        switch (i) {
          case IMPORT:
            this.x.canImport() ||
              this.fail("illegal context for import statement"),
              (d = this.newNode()),
              (d.pathList = this.ImportPathList()),
              this.x.parentScript.impDecls.push(d);
            break;
          case EXPORT:
            this.x.canExport() ||
            ...
            switch (this.peek()) {
              ...
              case CONST:
                return (
                  ...
                  (d.blockComments = n),
                  (d.exported = !0),
                  this.x.parentScript.expDecls.push(d),
                  registerExport(this.x.parentScript.exports, d),
                  d
                );
            }
            (d = this.newNode()),
              (d.pathList = this.ExportPathList()),
              this.x.parentScript.expDecls.push(d),
              registerExport(this.x.parentScript.exports, d);
            break;
          case FUNCTION:
          ...
          case LEFT_CURLY:
            return (
              (d = this.newNode(blockInit())),
              (l = this.x.update({ parentBlock: d }).pushTarget(d).nest()),
              this.withContext(l, function () {
                this.Statements(d);
              }),
              this.mustMatch(RIGHT_CURLY),
              d
          ...
          case IF:
            return (
              (d = this.newNode()),
              (d.condition = this.HeadExpression()),
              (l = this.x.pushTarget(d).nest()),
              this.withContext(l, function () {
                (d.thenPart = this.Statement()),
                  (d.elsePart = this.match(ELSE, !0) ? this.Statement() : null);
              }),
              d
            );
          case SWITCH:
            return (
              (d = this.newNode({ cases: [], defaultIndex: -1 })),
              (d.discriminant = this.HeadExpression()),
              (l = this.x.pushTarget(d).nest()),
              this.withContext(l, function () {
                this.mustMatch(LEFT_CURLY);
                while ((i = this.t.get()) !== RIGHT_CURLY) {
                  switch (i) {
                    case DEFAULT:
                      d.defaultIndex >= 0 &&
                    ...
                    case CASE:
                      (e = this.newNode()),
                        i === DEFAULT
                          ? (d.defaultIndex = d.cases.length)
                          : (e.caseLabel = this.Expression(COLON));
                      break;
                    default:
                      this.fail("Invalid switch case");
                  }
                  this.mustMatch(COLON),
                    (e.statements = this.newNode(blockInit()));
                  while (
                    (i = this.peek(!0)) !== CASE &&
                    i !== DEFAULT &&
                    i !== RIGHT_CURLY
                  )
                    e.statements.push(this.Statement());
                  d.cases.push(e);
                }
              }),
              d
          ...
          case FOR:
            return (
              (d = this.newNode(LOOP_INIT)),
              (d.blockComments = n),
              this.match(IDENTIFIER) &&
                (this.t.token.value === "each"
                  ? (d.isEach = !0)
                  : this.t.unget()),
              this.parenFreeMode || this.mustMatch(LEFT_PAREN),
              (l = this.x.pushTarget(d).nest()),
              (m = this.x.update({ inForLoopInit: !0 })),
              (e = null),
              (i = this.peek(!0)) !== SEMICOLON &&
                this.withContext(m, function () {
                  i === VAR || i === CONST
                    ? (this.t.get(), (e = this.Variables()))
                    : i === LET
                    ? (this.t.get(),
                      this.peek() === LEFT_PAREN
                        ? (e = this.LetBlock(!1))
                        : ((this.x.parentBlock = d),
                          (d.varDecls = []),
                          (e = this.Variables())))
                    : (e = this.Expression());
                }),
              e && this.match(IN)
                ? ((d.type = FOR_IN),
                  this.withContext(m, function () {
                    d.object = this.Expression();
                    if (e.type === VAR || e.type === LET) {
                      g = e.children;
                      if (g.length !== 1 && e.destructurings.length !== 1)
                        throw new SyntaxError(
                          "Invalid for..in left-hand side",
                          this.filename,
                          e.lineno
                        );
                      e.destructurings.length > 0
                        ? (d.iterator = e.destructurings[0])
                        : (d.iterator = g[0]),
                        (d.varDecl = e);
                    } else {
                      if (e.type === ARRAY_INIT || e.type === OBJECT_INIT)
                        e.destructuredNames = this.checkDestructuring(e);
                      d.iterator = e;
                    }
                  }))
                : ((m.inForLoopInit = !1),
                  ...
                  d.isEach && this.fail("Invalid for each..in loop"),
                  this.withContext(m, function () {
                    (d.condition =
                      this.peek(!0) === SEMICOLON ? null : this.Expression()),
                      this.mustMatch(SEMICOLON),
                      (j = this.peek(!0)),
                      (d.update = (
                        this.parenFreeMode
                          ? j === LEFT_CURLY ||
                            definitions.isStatementStartCode[j]
                          : j === RIGHT_PAREN
                      )
                        ? null
                        : this.Expression());
                  })),
              this.parenFreeMode || this.mustMatch(RIGHT_PAREN),
              this.withContext(l, function () {
                d.body = this.Statement();
              }),
              d
            );
          case WHILE:
            return (
              (d = this.newNode({ isLoop: !0 })),
              (d.blockComments = n),
              (d.condition = this.HeadExpression()),
              (l = this.x.pushTarget(d).nest()),
              this.withContext(l, function () {
          ...
          case CONTINUE:
            (d = this.newNode()),
              (d.blockComments = n),
              (l = this.x.pushTarget(d)),
              this.peekOnSameLine() === IDENTIFIER &&
                (this.t.get(), (d.label = this.t.token.value)),
              d.label
                ? (d.target = l.labeledTargets.find(function (a) {
                    return a.labels.has(d.label);
                  }))
                : i === CONTINUE
                ? (d.target = l.defaultLoopTarget)
                : (d.target = l.defaultTarget),
              d.target ||
                this.fail("Invalid " + (i === BREAK ? "break" : "continue")),
              !d.target.isLoop &&
                i === CONTINUE &&
                this.fail("Invalid continue");
            break;
          case TRY:
            (d = this.newNode({ catchClauses: [] })),
              (d.blockComments = n),
              (d.tryBlock = this.Block());
            while (this.match(CATCH)) {
              (e = this.newNode()), (f = this.MaybeLeftParen());
              switch (this.t.get()) {
                case LEFT_BRACKET:
                case LEFT_CURLY:
                  this.t.unget(),
                    (e.varName = this.DestructuringExpression(!0));
                  break;
                case IDENTIFIER:
                  e.varName = this.t.token.value;
                  break;
                default:
                  this.fail("missing identifier in catch");
              }
              this.match(IF) &&
                (this.mozillaMode || this.fail("Illegal catch guard"),
                d.catchClauses.length &&
                  !d.catchClauses.top().guard &&
                  this.fail("Guarded catch after unguarded"),
                (e.guard = this.Expression())),
                this.MaybeRightParen(f),
                (e.block = this.Block()),
                d.catchClauses.push(e);
            }
            return (
              this.match(FINALLY) && (d.finallyBlock = this.Block()),
              !d.catchClauses.length &&
                !d.finallyBlock &&
          ...
          case CATCH:
          case FINALLY:
            this.fail(definitions.tokens[i] + " without preceding try");
          case THROW:
            (d = this.newNode()), (d.exception = this.Expression());
            break;
          case RETURN:
            d = this.ReturnOrYield();
            break;
          case WITH:
            return (
              this.x.banWith() &&
                this.fail(
                  "with statements not allowed in strict code or modules"
                ),
              (d = this.newNode()),
              (d.blockComments = n),
              (d.object = this.HeadExpression()),
              (l = this.x.pushTarget(d).next()),
              this.withContext(l, function () {
                d.body = this.Statement();
              }),
          ...
          case CONST:
            ...
            break;
          case LET:
            if (this.peek() === LEFT_PAREN) return (d = this.LetBlock(!0)), d;
            d = this.Variables();
            break;
          case DEBUGGER:
            d = this.newNode();
          ...
          case MODULE:
            switch (this.t.token.value) {
              ...
              case "module":
                this.x.modulesAllowed() ||
                  this.fail("module declaration not at top level"),
                  (this.x.parentScript.hasModules = !0),
                  (i = this.peekOnSameLine());
                if (i !== IDENTIFIER && i !== LEFT_CURLY) {
                  this.t.unget();
                  break;
                }
                (d = this.newNode({ type: MODULE })),
                  (d.blockComments = n),
                  this.mustMatch(IDENTIFIER),
                  (c = this.t.token.value);
                if (this.match(LEFT_CURLY))
                  return (
                    (d.name = c),
                    (d.body = this.Script(!0, !1)),
                    (d.module = new Module(d)),
                    this.mustMatch(RIGHT_CURLY),
                    this.x.parentScript.modDefns.set(d.name, d),
                    d
                  );
                return this.t.unget(), this.ModuleVariables(d), d;
              default:
                i = this.peek();
                if (i === COLON)
                  return (
                    (c = this.t.token.value),
                    this.x.allLabels.has(c) &&
                      this.fail("Duplicate label: " + c),
                    this.t.get(),
                    (d = this.newNode({ type: LABEL, label: c })),
                    (d.blockComments = n),
                    (l = this.x.pushLabel(c).nest()),
                    this.withContext(l, function () {
                      d.statement = this.Statement();
                    }),
                    (d.target =
                      d.statement.type === LABEL
                        ? d.statement.target
                        : d.statement),
                    d
                  );
          ...
          default:
            (d = this.newNode({ type: SEMICOLON })),
              ...
              (d.end = d.expression.end);
        }
        return (d.blockComments = n), this.MagicalSemicolon(), d;
      }),
        (Pp.Pragmas = function () {
          var b = [];
          do b.push(this.Pragma());
          while (this.match(COMMA));
          return this.MagicalSemicolon(), b;
        }),
        (Pp.Pragma = function () {
          var b = [],
            c;
          do (c = this.t.get(!0)), b.push(this.t.token);
          while (isPragmaToken(this.peek()));
          return b;
        }),
        (Pp.MagicalSemicolon = function () {
          var b;
          this.t.lineno === this.t.token.lineno &&
            ((b = this.peekOnSameLine()),
            b !== END &&
              b !== NEWLINE &&
              b !== SEMICOLON &&
              b !== RIGHT_CURLY &&
        ...
        (Pp.ReturnOrYield = function () {
          var b,
            ...
            d = this.t.token.type,
            e,
            f = this.x.parentScript;
          return (
            d === RETURN
              ? this.x.inFunction || this.fail("Return not in function")
              : (this.x.inFunction || this.fail("Yield not in function"),
                (f.hasYield = !0)),
            (b = this.newNode({ value: undefined })),
            (e = d === RETURN ? this.peekOnSameLine(!0) : this.peek(!0)),
            e !== END &&
            e !== NEWLINE &&
            e !== SEMICOLON &&
            e !== RIGHT_CURLY &&
            (d !== YIELD ||
              (e !== d &&
                ...
                e !== COMMA))
              ? d === RETURN
                ? ((b.value = this.Expression()), (f.hasReturnWithValue = !0))
                : (b.value = this.AssignExpression())
              : d === RETURN && (f.hasEmptyReturn = !0),
            b
          );
        }),
        ...
        (Pp.ImportPathList = function () {
          var b = [];
          do b.push(this.ImportPath());
          while (this.match(COMMA));
          return b;
        }),
        (Pp.ImportPath = function () {
          var b = this.QualifiedPath();
          if (!this.match(DOT))
            return (
              b.type === IDENTIFIER &&
          ...
          var c = this.newNode();
          return c.push(b), c.push(this.ImportSpecifierSet()), c;
        }),
        (Pp.ExplicitSpecifierSet = function (b) {
          var c, d, e, f;
          (c = this.newNode({ type: OBJECT_INIT })), this.mustMatch(LEFT_CURLY);
          if (!this.match(RIGHT_CURLY))
            do
              (e = this.Identifier()),
                this.match(COLON)
                  ? ((d = this.newNode({ type: PROPERTY_INIT })),
                    d.push(e),
                    d.push(b()),
                    c.push(d))
                  : c.push(e);
        ...
        (Pp.Identifier = function () {
          return this.mustMatch(IDENTIFIER), this.newNode({ type: IDENTIFIER });
        }),
        (Pp.IdentifierName = function () {
          return (
            this.mustMatch(IDENTIFIER, !0), this.newNode({ type: IDENTIFIER })
          );
        }),
        (Pp.QualifiedPath = function () {
          ...
          while (this.match(DOT)) {
            ...
            (c = this.newNode()), c.push(b), c.push(this.Identifier()), (b = c);
          }
          return b;
        }),
        (Pp.ExportPath = function () {
          var b = this;
          return this.peek() === LEFT_CURLY
            ? this.ExplicitSpecifierSet(function () {
                return b.QualifiedPath();
              })
            : this.QualifiedPath();
        }),
        (Pp.ExportPathList = function () {
          var b = [];
          do b.push(this.ExportPath());
          while (this.match(COMMA));
          return b;
        }),
        (Pp.FunctionDefinition = function (b, c, d) {
          var e,
            f = this.newNode({ params: [], paramComments: [] });
          typeof d == "undefined" && (d = null),
            (f.blockComments = d),
            f.type !== FUNCTION &&
              (f.type = f.value === "get" ? GETTER : SETTER),
            this.match(MUL) && (f.isExplicitGenerator = !0),
            this.match(IDENTIFIER, !1, !0)
              ? (f.name = this.t.token.value)
              : b && this.fail("missing function identifier");
          var g = this.x.inModule;
          (x2 = new StaticContext(null, null, g, !0, this.x.strictMode)),
            this.withContext(x2, function () {
              ...
              (e = this.t.get(!0)),
                e !== LEFT_CURLY && this.t.unget(),
                e !== LEFT_CURLY
                  ? (f.body = this.AssignExpression())
                  : (f.body = this.Script(g, !0));
            }),
            e === LEFT_CURLY && this.mustMatch(RIGHT_CURLY),
            (f.end = this.t.token.end),
            (f.functionForm = c),
            c === DECLARED_FORM && this.x.parentScript.funDecls.push(f),
            this.x.inModule &&
              !f.isExplicitGenerator &&
              f.body.hasYield &&
        ...
        (Pp.ModuleVariables = function (b) {
          var c, d;
          do
            (c = this.Identifier()),
              this.match(ASSIGN) &&
                ((d = this.ModuleExpression()),
                (c.initializer = d),
                d.type === STRING
                  ? this.x.parentScript.modLoads.set(c.value, d.value)
                  : this.x.parentScript.modAssns.set(c.value, c)),
              b.push(c);
          while (this.match(COMMA));
        }),
        (Pp.Variables = function (b) {
          var c, d, e, f, g, h;
          h = this.t.token.type;
          switch (h) {
            case VAR:
            case CONST:
              g = this.x.parentScript;
              break;
            case LET:
              g = this.x.parentBlock;
              break;
            case LEFT_PAREN:
              (h = LET), (g = b);
          }
          c = this.newNode({ type: h, destructurings: [] });
          do {
            h = this.t.get();
            if (h === LEFT_BRACKET || h === LEFT_CURLY) {
              this.t.unget();
              var i = this.DestructuringExpression(!0);
              (d = this.newNode({
                type: IDENTIFIER,
                name: i,
                readOnly: c.type === CONST,
              })),
                c.push(d),
                pushDestructuringVarDecls(d.name.destructuredNames, g),
                c.destructurings.push({ exp: i, decl: d });
              if (this.x.inForLoopInit && this.peek() === IN) continue;
              this.mustMatch(ASSIGN),
                this.t.token.assignOp &&
                  this.fail("Invalid variable initialization"),
                (d.blockComment = this.t.lastBlockComment()),
                (d.initializer = this.AssignExpression());
              continue;
            }
            h !== IDENTIFIER && this.fail("missing variable name"),
              (d = this.newNode({
                type: IDENTIFIER,
            ...
            if (this.match(ASSIGN)) {
              var j = this.t.lastBlockComment();
              this.t.token.assignOp &&
                this.fail("Invalid variable initialization"),
                (d.initializer = this.AssignExpression());
            } else var j = this.t.lastBlockComment();
            d.blockComment = j;
          } while (this.match(COMMA));
          return c;
        }),
        (Pp.LetBlock = function (b) {
          var c, d;
          return (
            (c = this.newNode({ type: LET_BLOCK, varDecls: [] })),
            this.mustMatch(LEFT_PAREN),
            (c.variables = this.Variables(c)),
            this.mustMatch(RIGHT_PAREN),
            b &&
              this.peek() !== LEFT_CURLY &&
              ((d = this.newNode({ type: SEMICOLON, expression: c })),
              (b = !1)),
            b
              ? (c.block = this.Block())
              : (c.expression = this.AssignExpression()),
            c
          );
        }),
        (Pp.checkDestructuring = function (b, c) {
          b.type === ARRAY_COMP &&
            this.fail("Invalid array comprehension left-hand side");
          if (b.type !== ARRAY_INIT && b.type !== OBJECT_INIT) return;
          var d = {},
            e,
            f,
            g,
          ...
          for (var k = 0, l = j.length; k < l; k++) {
            if (!(e = j[k])) continue;
            e.type === PROPERTY_INIT
              ? ((i = e.children), (h = i[1]), (g = i[0].value))
              : b.type === OBJECT_INIT
              ? ((h = e), (g = e.value))
              : ((h = e), (g = k)),
              h.type === ARRAY_INIT || h.type === OBJECT_INIT
                ? (d[g] = this.checkDestructuring(h, c))
                : (c &&
                    h.type !== IDENTIFIER &&
        ...
        (Pp.DestructuringExpression = function (b) {
          var c = this.PrimaryExpression();
          return (c.destructuredNames = this.checkDestructuring(c, b)), c;
        }),
        (Pp.GeneratorExpression = function (b) {
          return this.newNode({
            type: GENERATOR,
            expression: b,
        ...
        (Pp.ComprehensionTail = function () {
          var b, c, d, e, f;
          b = this.newNode({ type: COMP_TAIL });
          do {
            (c = this.newNode({ type: FOR_IN, isLoop: !0 })),
              this.match(IDENTIFIER) &&
                (this.mozillaMode && this.t.token.value === "each"
                  ? (c.isEach = !0)
                  : this.t.unget()),
              (f = this.MaybeLeftParen());
            switch (this.t.get()) {
              case LEFT_BRACKET:
              case LEFT_CURLY:
                this.t.unget(), (c.iterator = this.DestructuringExpression());
                break;
              case IDENTIFIER:
                (c.iterator = e = this.newNode({ type: IDENTIFIER })),
                  (e.name = e.value),
                  (c.varDecl = d = this.newNode({ type: VAR })),
                  d.push(e),
                  this.x.parentScript.varDecls.push(e);
                break;
              default:
                this.fail("missing identifier");
            }
            this.mustMatch(IN),
              (c.object = this.Expression()),
              this.MaybeRightParen(f),
              b.push(c);
          } while (this.match(FOR));
          return this.match(IF) && (b.guard = this.HeadExpression()), b;
        }),
        (Pp.HeadExpression = function () {
          var b = this.MaybeLeftParen(),
            c = this.ParenExpression();
          this.MaybeRightParen(b);
          if (b === END && !c.parenthesized) {
            var d = this.peek();
            d !== LEFT_CURLY &&
              !definitions.isStatementStartCode[d] &&
        ...
        (Pp.ParenExpression = function () {
          var b = this.x.update({
              inForLoopInit:
                this.x.inForLoopInit && this.t.token.type === LEFT_PAREN,
            }),
            c = this.withContext(b, function () {
          ...
          return (
            this.match(FOR) &&
              ...
              (c = this.GeneratorExpression(c))),
            c
          );
        }),
        (Pp.Expression = function () {
          var b, c;
          b = this.AssignExpression();
          if (this.match(COMMA)) {
            (c = this.newNode({ type: COMMA })), c.push(b), (b = c);
            do
              (c = b.children[b.children.length - 1]),
                c.type === YIELD &&
                  !c.parenthesized &&
                  this.fail("Yield expression must be parenthesized"),
                b.push(this.AssignExpression());
            while (this.match(COMMA));
          }
          return b;
        }),
        (Pp.AssignExpression = function () {
          ...
          (b = this.newNode({ type: ASSIGN })),
            (c = this.ConditionalExpression());
          if (!this.match(ASSIGN)) return c;
          b.blockComment = this.t.lastBlockComment();
          switch (c.type) {
            case OBJECT_INIT:
            case ARRAY_INIT:
              c.destructuredNames = this.checkDestructuring(c);
            case IDENTIFIER:
            case DOT:
            case INDEX:
            case CALL:
          ...
          return (
            (b.assignOp = c.assignOp = this.t.token.assignOp),
            b.push(c),
            b.push(this.AssignExpression()),
            b
          );
        ...
        (Pp.ConditionalExpression = function () {
          ...
          b = this.OrExpression();
          if (this.match(HOOK)) {
            (c = b), (b = this.newNode({ type: HOOK })), b.push(c);
            var d = this.x.update({ inForLoopInit: !1 });
            this.withContext(d, function () {
              b.push(this.AssignExpression());
            }),
              this.match(COLON) || this.fail("missing : after ?"),
              b.push(this.AssignExpression());
          }
          return b;
        }),
        (Pp.OrExpression = function () {
          var b, c;
          b = this.AndExpression();
          while (this.match(OR))
            (c = this.newNode()),
              c.push(b),
              c.push(this.AndExpression()),
              (b = c);
          return b;
        }),
        (Pp.AndExpression = function () {
          var b, c;
          b = this.BitwiseOrExpression();
          while (this.match(AND))
            (c = this.newNode()),
              c.push(b),
              c.push(this.BitwiseOrExpression()),
              (b = c);
          return b;
        }),
        (Pp.BitwiseOrExpression = function () {
          var b, c;
          b = this.BitwiseXorExpression();
          while (this.match(BITWISE_OR))
            (c = this.newNode()),
              c.push(b),
              c.push(this.BitwiseXorExpression()),
              (b = c);
          return b;
        }),
        (Pp.BitwiseXorExpression = function () {
          var b, c;
          b = this.BitwiseAndExpression();
          while (this.match(BITWISE_XOR))
            (c = this.newNode()),
              c.push(b),
              c.push(this.BitwiseAndExpression()),
              (b = c);
          return b;
        }),
        (Pp.BitwiseAndExpression = function () {
          var b, c;
          b = this.EqualityExpression();
          while (this.match(BITWISE_AND))
            (c = this.newNode()),
              c.push(b),
              c.push(this.EqualityExpression()),
              (b = c);
          return b;
        }),
        (Pp.EqualityExpression = function () {
          var b, c;
          b = this.RelationalExpression();
          while (
            this.match(EQ) ||
            this.match(NE) ||
            ...
            (c = this.newNode()),
              c.push(b),
              c.push(this.RelationalExpression()),
              (b = c);
          return b;
        }),
        (Pp.RelationalExpression = function () {
          var b,
            c,
            d = this.x.update({ inForLoopInit: !1 });
          return (
            this.withContext(d, function () {
              b = this.ShiftExpression();
              while (
                this.match(LT) ||
                this.match(LE) ||
                this.match(GE) ||
        ...
        (Pp.ShiftExpression = function () {
          var b, c;
          b = this.AddExpression();
          while (this.match(LSH) || this.match(RSH) || this.match(URSH))
            (c = this.newNode()),
              c.push(b),
              c.push(this.AddExpression()),
              (b = c);
          return b;
        }),
        (Pp.AddExpression = function () {
          var b, c;
          b = this.MultiplyExpression();
          while (this.match(PLUS) || this.match(MINUS))
            (c = this.newNode()),
              c.push(b),
              c.push(this.MultiplyExpression()),
              (b = c);
          return b;
        }),
        (Pp.MultiplyExpression = function () {
          ...
          while (this.match(MUL) || this.match(DIV) || this.match(MOD))
            (c = this.newNode()),
              c.push(b),
              c.push(this.UnaryExpression()),
              (b = c);
          return b;
        }),
        (Pp.UnaryExpression = function () {
          var b, c, d;
          switch ((d = this.t.get(!0))) {
            case DELETE:
            case VOID:
            case TYPEOF:
            case NOT:
            ...
            case MINUS:
              d === PLUS
                ? (b = this.newNode({ type: UNARY_PLUS }))
                : d === MINUS
                ? (b = this.newNode({ type: UNARY_MINUS }))
                : (b = this.newNode()),
                b.push(this.UnaryExpression());
              break;
            case INCREMENT:
            case DECREMENT:
              (b = this.newNode()), b.push(this.MemberExpression(!0));
              break;
            default:
              this.t.unget(),
                (b = this.MemberExpression(!0)),
                this.t.tokens[(this.t.tokenIndex + this.t.lookahead - 1) & 3]
                  .lineno === this.t.lineno &&
                  (this.match(INCREMENT) || this.match(DECREMENT)) &&
                  ((c = this.newNode({ postfix: !0 })), c.push(b), (b = c));
          }
          return b;
        }),
        (Pp.MemberExpression = function (b) {
          var c, d, e, f;
          this.match(NEW)
            ? ((c = this.newNode()),
              c.push(this.MemberExpression(!1)),
              this.match(LEFT_PAREN) &&
                ((c.type = NEW_WITH_ARGS), c.push(this.ArgumentList())))
            : (c = this.PrimaryExpression());
          while ((f = this.t.get()) !== END) {
            switch (f) {
              case DOT:
                (d = this.newNode()), d.push(c), d.push(this.IdentifierName());
                break;
              case LEFT_BRACKET:
                (d = this.newNode({ type: INDEX })),
                  d.push(c),
              ...
              case LEFT_PAREN:
                if (b) {
                  (d = this.newNode({ type: CALL })),
                    d.push(c),
                    d.push(this.ArgumentList());
                  break;
                }
              default:
                return this.t.unget(), c;
            }
            c = d;
          }
          return c;
        ...
        (Pp.ArgumentList = function () {
          var b, c;
          b = this.newNode({ type: LIST });
          if (this.match(RIGHT_PAREN, !0)) return b;
          do
            (c = this.AssignExpression()),
              c.type === YIELD &&
                !c.parenthesized &&
                this.peek() === COMMA &&
                this.fail("Yield expression must be parenthesized"),
              this.match(FOR) &&
                ((c = this.GeneratorExpression(c)),
                (b.children.length > 1 || this.peek(!0) === COMMA) &&
                  this.fail("Generator expression must be parenthesized")),
              b.push(c);
          while (this.match(COMMA));
          return this.mustMatch(RIGHT_PAREN), b;
        }),
        (Pp.PrimaryExpression = function () {
          ...
          switch (d) {
            case FUNCTION:
              b = this.FunctionDefinition(!1, EXPRESSED_FORM);
              break;
            case LEFT_BRACKET:
              b = this.newNode({ type: ARRAY_INIT });
              while ((d = this.peek(!0)) !== RIGHT_BRACKET) {
                if (d === COMMA) {
                  this.t.get(), b.push(null);
                  continue;
                }
                b.push(this.AssignExpression());
                if (d !== COMMA && !this.match(COMMA)) break;
              }
              b.children.length === 1 &&
                this.match(FOR) &&
                ((c = this.newNode({
                  type: ARRAY_COMP,
                  expression: b.children[0],
                  tail: this.ComprehensionTail(),
                })),
                (b = c)),
                this.mustMatch(RIGHT_BRACKET);
            ...
            case LEFT_CURLY:
              var e, f;
              b = this.newNode({ type: OBJECT_INIT });
              a: if (!this.match(RIGHT_CURLY)) {
                do {
                  d = this.t.get();
                  if (
                    (this.t.token.value !== "get" &&
                      this.t.token.value !== "set") ||
                    this.peek() !== IDENTIFIER
                  ) {
                    var g = this.t.blockComments;
                    switch (d) {
                      case IDENTIFIER:
                      case NUMBER:
                      case STRING:
                        e = this.newNode({ type: IDENTIFIER });
                        break;
                      case RIGHT_CURLY:
                        break a;
                      default:
                    ...
                    this.match(COLON)
                      ? ((c = this.newNode({ type: PROPERTY_INIT })),
                        c.push(e),
                        c.push(this.AssignExpression()),
                        (c.blockComments = g),
                        b.push(c))
                      : (this.peek() !== COMMA &&
                          this.peek() !== RIGHT_CURLY &&
                          this.fail("missing : after property"),
                        b.push(e));
                  } else b.push(this.FunctionDefinition(!0, EXPRESSED_FORM));
                } while (this.match(COMMA));
                this.mustMatch(RIGHT_CURLY);
              }
              break;
            case LEFT_PAREN:
              (b = this.ParenExpression()),
                this.mustMatch(RIGHT_PAREN),
                (b.parenthesized = !0);
              break;
            case LET:
            ...
            case REGEXP:
              ...
              break;
            default:
              this.fail("missing operand; found " + definitions.tokens[d]);
          }
          return b;
        }),
        (exports.parse = parse),
  ...
  define(
    "ace/narcissus/lexer",
    ["require", "exports", "module", "ace/narcissus/definitions"],
    function (require, exports, module) {
      function isValidIdentifierChar(a, b) {
        if (a <= "")
          return (a >= "a" && a <= "z") ||
            (a >= "A" && a <= "Z") ||
            a === "$" ||
        ...
        var d = !1;
        try {
          d = Function("x", "return (x." + (b ? "" : "x") + a + ");")(c) === !0;
        } catch (e) {}
        return d;
      }
      function isIdentifier(a) {
        ...
        if (!isValidIdentifierChar(a[0], !0)) return !1;
        for (var b = 1; b < a.length; b++)
          if (!isValidIdentifierChar(a[b], !1)) return !1;
        return !0;
      }
      ...
      (Tokenizer.prototype = {
        ...
        match: function (a, b, c) {
          return this.get(b, c) === a || this.unget();
        },
        mustMatch: function (a, b) {
          if (!this.match(a, !1, b))
            throw this.newSyntaxError(
              "Missing " + definitions.tokens[a].toLowerCase()
            );
          return this.token;
        },
        peek: function (a) {
          ...
          return (
            this.lookahead
              ? ((c = this.tokens[(this.tokenIndex + this.lookahead) & 3]),
                (b =
                  this.scanNewlines && c.lineno !== this.lineno
                    ? NEWLINE
                    : c.type))
              : ((b = this.get(a)), this.unget()),
            b
          );
        },
        ...
        lexZeroNumber: function (a) {
          ...
          if (a === ".") {
            ...
            this.cursor--,
              this.lexExponent(),
              (b.value = parseFloat(c.substring(b.start, this.cursor)));
          } else if (a === "x" || a === "X") {
            do a = c[this.cursor++];
            while (
              (a >= "0" && a <= "9") ||
            ...
            this.cursor--,
              (b.value = parseInt(c.substring(b.start, this.cursor)));
          } else if (a >= "0" && a <= "7") {
            do a = c[this.cursor++];
            while (a >= "0" && a <= "7");
            this.cursor--,
        ...
        lexOp: function (a) {
          ...
          e in d &&
            ...
            this.cursor++,
            (e = c[this.cursor]),
            e in d && ((d = d[e]), this.cursor++, (e = c[this.cursor])));
          var f = d.op;
          definitions.assignOps[f] && c[this.cursor] === "="
            ? (this.cursor++,
              (b.type = ASSIGN),
              (b.assignOp = definitions.tokenIds[definitions.opTypeNames[f]]),
              (f += "="))
            : ((b.type = definitions.tokenIds[definitions.opTypeNames[f]]),
              (b.assignOp = null)),
            (b.value = f);
        },
        lexIdent: function (a, b) {
          var c = this.token,
            d = a;
          while ((a = this.getValidIdentifierChar(!1)) !== null) d += a;
          (c.type = IDENTIFIER), (c.value = d);
          if (b) return;
          var e;
          if (this.parser.mozillaMode) {
            e = definitions.mozillaKeywords[d];
            if (e) {
              c.type = e;
              return;
            }
          ...
          if (this.parser.x.strictMode) {
            e = definitions.strictKeywords[d];
            if (e) {
              c.type = e;
              return;
            }
          }
          (e = definitions.keywords[d]), e && (c.type = e);
        },
        get: function (a, b) {
          var c;
          while (this.lookahead) {
            ...
            if (c.type !== NEWLINE || this.scanNewlines) return c.type;
          }
          this.skip(),
            (this.tokenIndex = (this.tokenIndex + 1) & 3),
            (c = this.tokens[this.tokenIndex]),
            c || (this.tokens[this.tokenIndex] = c = {});
          var d = this.source;
          if (this.cursor >= d.length) return (c.type = END);
          (c.start = this.cursor), (c.lineno = this.lineno);
          var e = this.getValidIdentifierChar(!0),
            f = e === null ? d[this.cursor++] : null;
          if (e !== null) this.lexIdent(e, b);
          else if (a && f === "/") this.lexRegExp(f);
          else if (f in opTokens) this.lexOp(f);
          else if (f === ".") this.lexDot(f);
          else if (f >= "1" && f <= "9") this.lexNumber(f);
          else if (f === "0") this.lexZeroNumber(f);
          else if (f === '"' || f === "'") this.lexString(f);
          else {
            if (!this.scanNewlines || (f !== "\n" && f !== "\r"))
          ...
          return (c.end = this.cursor), c.type;
        },
        unget: function () {
        ...
        getValidIdentifierChar: function (a) {
          ...
          if (c === "\\" && b[this.cursor + 1] === "u") {
            try {
              c = String.fromCharCode(
                parseInt(b.substring(this.cursor + 2, this.cursor + 6), 16)
              );
            } catch (d) {
              return null;
            }
          ...
          var e = isValidIdentifierChar(c, a);
          return e && this.cursor++, e ? c : null;
        },
      }),
  ...
  define(
    ...
    function (require, exports, module) {
      ...
      function apply(a, b, c) {
        return Fpapply.call(a, [b].concat(c));
      }
      ...
      function getOwnProperties(a) {
        var b = {};
        for (var c in Object.getOwnPropertyNames(a))
          b[c] = Object.getOwnPropertyDescriptor(a, c);
        return b;
      }
      function blacklistHandler(a, b) {
        var c = Object.create(null, {}),
          d = Dict.create(b).mapObject(function (a) {
            return c;
          });
      ...
      function whitelistHandler(a, b) {
        var c = Object.create(null, {}),
          d = Dict.create(b).mapObject(function (b) {
            return a;
          });
      ...
      for (var i = 0; i < whitespaceChars.length; i++)
        whitespace[whitespaceChars[i]] = !0;
      var opTypeNames = {
          "\n": "NEWLINE",
          ";": "SEMICOLON",
          ",": "COMMA",
        ...
        mozillaKeywords = { __proto__: null },
        tokenIds = {},
        hostSupportsEvalConst = (function () {
          try {
            return eval(
              "(function(s) { eval(s); return x })('const x = true;')"
            );
          } catch (e) {
            return !1;
          }
      ...
      for (i = 0, j = statementStartTokens.length; i < j; i++)
        isStatementStartCode[keywords[statementStartTokens[i]]] = !0;
      var assignOps = [
        "|",
        "^",
        "&",
      ...
      for (i = 0, j = assignOps.length; i < j; i++)
        (t = assignOps[i]), (assignOps[t] = tokens[t]);
      var Fpapply = Function.prototype.apply,
        applyNew;
      Function.prototype.bind
        ? (applyNew = function (b, c) {
            return new (b.bind.apply(
              b,
              [,].concat(Array.prototype.slice.call(c))
            ))();
          })
      ...
      (Dict.create = function (a) {
        ...
        (Dict.prototype = {
          ...
          set: function (a, b) {
            hasOwnProperty.call(this.table, a) || this.size++,
              (this.table[a] = b);
          },
          get: function (a) {
            return this.table[a];
          ...
          getDef: function (a, b) {
            return (
              hasOwnProperty.call(this.table, a) ||
                (this.size++, (this.table[a] = b())),
              this.table[a]
            );
          },
          forEach: function (a) {
          ...
          remove: function (a) {
            hasOwnProperty.call(this.table, a) &&
              (this.size--, delete this.table[a]);
          },
          copy: function () {
            var a = Object.create(null, {});
            for (var b in this.table) a[b] = this.table[b];
            return new Dict(a, this.size);
          },
          keys: function () {
      ...
      (Stack.prototype = {
        push: function (a) {
          return new Stack({ top: a, rest: this.elts });
        },
        top: function () {
        ...
        Array.prototype.copy ||
          defineProperty(
            ...
            function () {
              var a = [];
              for (var b = 0, c = this.length; b < c; b++) a[b] = this[b];
              return a;
            },
            !1,
            !1,
  ...
  define(
    ...
    ["require", "exports", "module"],
    function (a, b, c) {
      (b.hiddenHostGlobals = { Narcissus: !0 }),
        (b.desugarExtensions = !1),
        (b.allowHTMLComments = !1),
        (b.mozillaMode = !0),
        (b.parenFreeMode = !1);
    }
  );
