ace.define(
  ...
  function (e, t, n) {
    var r = e("../lib/oop"),
      ...
      s = e("./html_ruby_highlight_rules").HtmlRubyHighlightRules,
      o = e("./html").Mode,
      u = e("./javascript").Mode,
      a = e("./css").Mode,
      f = e("./ruby").Mode,
      l = function () {
        o.call(this);
        var e = new s();
        (this.$tokenizer = new i(e.getRules())),
          (this.$embeds = e.getEmbeds()),
          this.createModeDelegates({ "js-": u, "css-": a, "ruby-": f });
      };
    r.inherits(l, o), function () {}.call(l.prototype), (t.Mode = l);
  }
),
  ace.define(
    "ace/mode/html_ruby_highlight_rules",
