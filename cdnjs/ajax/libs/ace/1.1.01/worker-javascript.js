    ...
    function (e, t, n) {
      var r = (function () {
        ...
        function c() {
          jt.couch && f(Ft, mt),
            jt.rhino && f(Ft, zt),
            jt.prototypejs && f(Ft, Rt),
            jt.node && (f(Ft, Ht), (jt.globalstrict = !0)),
            jt.devel && f(Ft, yt),
            jt.dojo && f(Ft, bt),
            jt.browser && f(Ft, vt),
            jt.nonstandard && f(Ft, $t),
            jt.jquery && f(Ft, Lt),
            jt.mootools && f(Ft, Dt),
            jt.worker && f(Ft, nn),
            jt.wsh && f(Ft, rn),
        ...
        function d(e, t, n, i, s, o) {
          ...
          return (
            ...
            (l.reason = a(e, l)),
            r.errors.push(l),
            jt.passfail && h("Stopping. ", f, u),
            (tn += 1),
            tn >= jt.maxerr && h("Too many errors.", f, u),
            l
          );
        }
        ...
        function b(e, n, r) {
          e === "hasOwnProperty" && d("'hasOwnProperty' is a really bad name."),
            n === "exception" &&
              ...
              wt[e] !== !0 &&
              !jt.node &&
              d("Value of '{a}' may be overwritten in IE.", Pt, e),
            t(wt, e) &&
              !wt["(global)"] &&
              (wt[e] === !0
                ? jt.latedef &&
        ...
        function w() {
          ...
          for (;;) {
            ...
            if (v.id === ":") {
              (v = vn.token()),
                a === _t &&
                  m("Expected '{a}' and instead saw '{b}'.", p, "*/", ":"),
        ...
        function S(e, t) {
          ...
          for (;;) {
            ...
            if (Pt.type === "special") w();
            else if (Pt.id !== "(endline)") break;
          }
        }
        function x(e, t) {
          var n,
            r = !1,
            i = !1;
          Pt.id === "(end)" && m("Unexpected early end of program.", Gt),
            S(),
            t && ((ft = "anonymous"), (wt["(verb)"] = Gt.value));
          if (t === !0 && Gt.fud) n = Gt.fud();
          else {
            if (Gt.nud) n = Gt.nud();
            else {
            ...
            (n.nud =
              typeof t == "function"
                ...
                : function () {
                    ...
                    if (this.id === "++" || this.id === "--")
                      jt.plusplus
                        ? d("Unexpected use of '{a}'.", this, this.id)
        ...
        function V(e) {
          return (
            ...
            R(
              e,
              function (e, t) {
                jt.bitwise && d("Unexpected use of '{a}'.", t, t.id),
                  k(qt, Gt),
                  k(Gt, Pt);
                if (e)
                  return e.id === "." ||
        ...
        function G(e) {
          ...
          if (!i.block) {
            ...
            Pt.id !== ";"
              ? jt.asi ||
                ((!jt.lastsemic || Pt.id !== "}" || Pt.line !== Gt.line) &&
        ...
        function Y(e) {
          ...
          while (!Pt.reach && Pt.id !== "(end)")
            Pt.id === ";"
              ? ((n = E()),
                (!n || n.id !== "(") && d("Unnecessary semicolon."),
                S(";"))
              : t.push(G(e === Pt.line));
          return t;
        }
        function Z() {
          ...
          for (;;) {
            if (Pt.id === "(string)") {
              ...
              } else if (t.id === "}") d("Missing semicolon.", t);
              else if (t.id !== ";") break;
              A(),
                S(),
              ...
              if (r) {
                ...
                Z(),
                  jt.strict &&
                    ...
                    !u["use strict"] &&
                    !Jt["use strict"] &&
                    d('Missing "use strict" statement.');
              }
              (i = Y(l)),
        ...
        function st(e, t) {
          ...
          return (
            ...
            et(!1, !1, !0),
            wt["(metrics)"].verifyMaxStatementsPerFunction(),
            wt["(metrics)"].verifyMaxComplexityPerFunction(),
            (Wt = i),
            (jt = r),
            (wt["(last)"] = Gt.line),
            (wt["(lastcharacter)"] = Gt.character),
            (wt = wt["(context)"]),
            n
          );
        }
        ...
        var ft,
          ...
          dt = { eqeq: "eqeqeq", vars: "onevar", windows: "wsh" },
          vt = {
            ArrayBuffer: !1,
            ArrayBufferView: !1,
            Audio: !1,
          ...
          bt = { dojo: !1, dijit: !1, dojox: !1, define: !1, require: !1 },
          wt,
          Et = [
            "closure",
            "exception",
          ...
          en,
          tn,
          nn = { importScripts: !0, postMessage: !0, self: !0 },
          rn = {
            ActiveXObject: !0,
            Enumerator: !0,
            GetObject: !0,
            ...
            token: function () {
                  ...
                  jt.quotmark &&
                    (jt.quotmark === "single" && t !== "'"
                      ...
                      : jt.quotmark === !0 &&
                        ((Ut = Ut || t),
                        Ut !== t &&
                          v("Mixed double and single quotes.", u, r))),
                  (f = 0);
                e: for (;;) {
                  while (f >= a.length) {
                    f = 0;
              ...
              for (;;) {
                ...
                if (!x) {
                  ...
                  if (o(c))
                    return (
                      isFinite(Number(x)) || v("Bad number '{a}'.", u, r, x),
                      s(a.substr(0, 1)) &&
                      ...
                      c === "0" &&
                        ...
                        o(d)
                          ? Gt.id !== "." &&
                            v("Don't use extra leading zeros '{a}'.", u, r, x)
                          : kt &&
                            (d === "x" || d === "X") &&
                            v("Avoid 0x-. '{a}'.", u, r, x)),
                      x.substr(x.length - 1) === "." &&
                      ...
                      if (It) {
                        ...
                        for (;;) {
                          ...
                          switch (c) {
                            case "":
                              return (
                                g("Unclosed regular expression.", u, i),
                                h("Stopping.", u, i)
                              );
                            case "/":
                              m > 0 &&
        ...
        F("(number)", function () {
          ...
          V("|=", "assignbitor", 20),
          V("^=", "assignbitxor", 20),
          V("<<=", "assignshiftleft", 20),
          V(">>=", "assignshiftright", 20),
          V(">>>=", "assignshiftrightunsigned", 20),
          R(
            "?",
            function (e, t) {
              return (
                (t.left = e), (t.right = x(10)), S(":"), (t["else"] = x(10)), t
              );
            },
            30
          ),
          ...
          U("==", function (e, t) {
            ...
            return (
              !n && jt.eqeqeq
                ...
                : z(e)
                ? d("Use '{a}' to compare with '{b}'.", this, "===", e.value)
                : z(t) &&
                  d("Use '{a}' to compare with '{b}'.", this, "===", t.value),
              this
            );
          }),
          U("==="),
          ...
          X("<<", "shiftleft", 120),
          X(">>", "shiftright", 120),
          X(">>>", "shiftrightunsigned", 120),
          R("in", "in", 120),
          R("instanceof", "instanceof", 120),
          R(
            "+",
            function (e, t) {
              var n = x(130);
              return e && n && e.id === "(string)" && n.id === "(string)"
                ? ((e.value += n.value),
                  ...
                  !jt.scripturl && pn.test(e.value) && d("JavaScript URL.", e),
                  e)
          ...
          j("~", function () {
            return (
              jt.bitwise && d("Unexpected '{a}'.", this, "~"), x(150), this
            );
          }),
          j("!", function () {
            return (
          ...
          j("new", function () {
            ...
            else jt.supernew || d("Weird construction. Delete 'new'.", this);
            return (
              T(Gt, Pt),
              Pt.id !== "(" &&
                !jt.supernew &&
            ...
            function (e, t) {
              ...
              e &&
                ...
                (e.value === "Math"
                  ...
                  : jt.newcap &&
                    d("Missing 'new' prefix when invoking a constructor.", e));
              if (Pt.id !== ")")
                for (;;) {
                  (r[r.length] = x(10)), (n += 1);
                  if (Pt.id !== ",") break;
            ...
            (e.nud = function () {
              ...
              for (;;) {
                ...
                if (Pt.value === "get" && E().id !== ":")
                  S("get"),
                    jt.es5 || m("get/set are ES5 features."),
                    (o = rt()),
                    o || m("Missing property name."),
                    r(o),
                    (a = Pt),
                    T(Gt, Pt),
                    (s = st()),
        ...
        (mn.exps = !0),
          ...
          H("with", function () {
            ...
            return (
              Jt["use strict"]
                ? m("'with' is not allowed in strict mode.", Gt)
          ...
          (P("debugger", function () {
            return (
              jt.debug || d("All 'debugger' statements should be removed."),
              this
            );
          }).exps = !0),
          (function () {
          ...
          (H("for", function () {
            ...
            if (E(Pt.id === "var" ? 1 : 0).id === "in") {
              if (Pt.id === "var") S("var"), mn.fud.call(mn, !0);
              else {
                switch (wt[Pt.value]) {
                  case "unused":
                    wt[Pt.value] = "var";
            ...
            if (Pt.id !== ";")
              if (Pt.id === "var") S("var"), mn.fud.call(mn);
              else
                for (;;) {
                  x(0, "for");
                  if (Pt.id !== ",") break;
          ...
          (P("break", function () {
            var e = Pt.value;
            return (
              wt["(breakage)"] === 0 && d("Unexpected '{a}'.", Pt, this.value),
              jt.asi || O(this),
              Pt.id !== ";" &&
                Gt.line === Pt.line &&
                (wt[e] !== "label"
        ...
        var gn = function (e, s, o) {
          ...
          (jt = m),
            (jt.indent = jt.indent || 4),
            (jt.maxerr = jt.maxerr || 50),
            (Qt = "");
          ...
          if (!i(e) && !Array.isArray(e))
            return (
              g("Input is neither a string nor an array of strings.", 0), !1
            );
          if (i(e) && /^\s*$/g.test(e))
          ...
          try {
            ...
            for (a = 0; a < r.undefs.length; a += 1)
              (l = r.undefs[a].slice(0)),
                b(l[2].value, l[0])
                  ? w(l[2].value, l[2].line)
                  : d.apply(d, l.slice(1));
            St.forEach(function (e) {
              for (var n in e) t(e, n) && x(e, n);
              if (!e["(params)"]) return;
              var r = e["(params)"].slice(),
                i = r.pop(),
                s;
              while (i) {
                s = e[i];
        ...
        return (
          (gn.data = function () {
            ...
            n.length > 0 && (e.implieds = n),
              Zt.length > 0 && (e.urls = Zt),
              (f = Object.keys(Wt)),
              f.length > 0 && (e.globals = f);
