      ...
      (function () {
            ...
            i &&
              ...
              (i.selection.length == 2
                ? this.selection.setSelectionRange(
                    new p(r.row, o + i.selection[0], r.row, o + i.selection[1])
                  )
                : this.selection.setSelectionRange(
                    new p(
                      r.row + i.selection[0],
        ...
        g.defineOptions(y.prototype, "editor", {
          selectionStyle: {
            set: function (e) {
              this.onSelectionChange(),
                this._emit("changeSelectionStyle", { data: e });
            },
            initialValue: "line",
          },
          highlightActiveLine: {
      ...
      var r = e("../lib/event"),
        ...
        a = function (e, t) {
            ...
            A = function (e) {
              k && ((e = k(e)), (k = null)),
                c
                  ? (b(), e && t.onPaste(e), (c = !1))
                  : e == a[0]
                  ? L && t.execCommand("del", { source: "ace" })
                  : (e.substring(0, 2) == a
                      ? (e = e.substr(2))
                      : e[0] == a[0]
                      ? (e = e.substr(1))
          ...
          r.addListener(n, "compositionstart", P),
            ...
            i.isGecko ||
              r.addListener(n, "contextmenu", function (e) {
      ...
      (function () {
        (this.onMouseDown = function (e) {
          ...
          (this.startSelect = function (e) {
            (e =
              ...
              this.mousedownEvent.getShiftKey()
                ...
                : this.$clickSelection ||
                  (this.editor.moveCursorToPosition(e),
          ...
          (this.startDrag = function () {
            ...
            (this.dragSelectionMarker = e.session.addMarker(
              this.dragRange,
              "ace_selection",
              t
            )),
          ...
          (this.drag = function () {
            var e = this.editor;
            (this.dragCursor = e.renderer.screenToTextCoordinates(
              this.x,
              this.y
            )),
        ...
        i = function (e) {
          ...
          r.addListener(l, "dragleave", function (e) {
            ...
            r.addListener(l, "drop", function (e) {
              if (!n) return;
              return (
                (u.end = t.session.insert(a, e.dataTransfer.getData("Text"))),
                (u.start = a),
                p(),
                t.focus(),
                r.preventDefault(e)
  ...
  define(
    ...
    function (e, t, n) {
      ...
      (t.get = function (e) {
        ...
        (t.init = function () {
          a.packaged =
            e.packaged || n.packaged || (u.define && define.packaged);
          ...
          wrap: {
            ...
            get: function () {
              return this.getUseWrapMode()
                ? this.getWrapLimitRange().min || "free"
                : "off";
            },
            handlesSet: !0,
          },
    ...
    function (e, t, n) {
      ...
      var m = function (e, t) {
        ...
        (this.canvas = r.element),
          (this.$markerFront = new f(this.content)),
          (this.$cursorLayer = new c(this.content)),
          (this.$horizScroll = !1),
          (this.scrollBar = new h(this.container)),
      ...
      (function () {
        (this.CHANGE_CURSOR = 1),
          ...
          (this.onGutterResize = function () {
            ...
            (this.scroller.style.left = t + "px"),
              (this.$size.scrollerWidth = Math.max(
                0,
                e - t - this.scrollBar.getWidth()
              )),
          ...
          (this.$getLongestLine = function () {
            ...
            return (
              this.$textLayer.showInvisibles && (e += 1),
              Math.max(
          ...
          (this.scrollCursorIntoView = function (e, t) {
            ...
            this.scrollTop > i
              ...
              : this.scrollTop + this.$size.scrollerHeight <
                ...
                (t && (i += t * this.$size.scrollerHeight),
                this.session.setScrollTop(
                  i + this.lineHeight - this.$size.scrollerHeight
                ));
          ...
          (this.animateScrolling = function (e, t) {
            ...
            if (this.$animatedScroll) {
              var r = this,
                i = r.$calcSteps(e, n);
              (this.$scrollAnimation = { from: e, to: n }),
          ...
          (this.setTheme = function (e) {
            function r(n) {
              ...
              i.importCssString(
                ...
                (t.$theme = n.cssClass),
                (t.theme = n),
                i.addCssClass(t.container, n.cssClass),
                i.setCssClass(t.container, "ace_dark", n.isDark);
              var r = n.padding || 4;
              t.$padding && r != t.$padding && t.setPadding(r),
                t.$size && ((t.$size.width = 0), t.onResize()),
                t._dispatchEvent("themeLoaded", { theme: n });
            }
            var t = this;
            (this.$themeValue = e),
              t._dispatchEvent("themeChange", { theme: e });
        ...
        u.defineOptions(m.prototype, "renderer", {
          ...
          hScrollBarAlwaysVisible: {
            set: function (e) {
              (this.$hScrollBarAlwaysVisible = e),
          ...
          (this.update = function (e) {
            ...
            for (;;) {
              ...
              n.push(
                ...
                p.className,
                "' style='height:",
                this.session.getRowLength(i) * e.lineHeight,
                "px;'>",
                (h = i + c)
              );
              if (a) {
            ...
            o.isIE || o.isOldGecko
              ...
              : function () {
                  ...
                  var r = this.$measureNode.getBoundingClientRect(),
                    s = { height: r.height, width: r.width };
          ...
          (this.renderIndentGuide = function (e, t) {
            ...
            return n <= 0
              ...
              ? ((n -= n % this.tabSize),
                ...
                t.substr(n))
              : t[0] == "	"
              ? (e.push(s.stringRepeat(this.$tabStrings["	"], n)), t.substr(n))
              : t;
          }),
                ...
                return o
                  ? r == null
                    ? ((r = o[1].length),
                      ...
                      (s = o[3].length),
                      o)
                    : (r + i + s != o[1].length + o[2].length + o[3].length &&
                        (n = !1),
                      r != o[1].length && (t = !1),
      ...
      (function () {
        (this.foldingStartMarker = null),
          ...
          (this.openingBracketBlock = function (e, t, n, i, s) {
            ...
            return (
              a == null && (a = this.getFoldWidget(e, u.row)),
              a == "start" &&
                u.row > o.row &&
