define(
  ...
  function (e, t, n) {
    var r = e("../lib/oop"),
      ...
      o = e("./velocity_highlight_rules").VelocityHighlightRules,
      u = e("./folding/velocity").FoldMode,
      ...
      var r = e("../lib/oop"),
        ...
        f = function () {
          ...
          (this.$rules = {
            ...
            s.tag(this.$rules, "tag", "start"),
            s.tag(this.$rules, "style", "css-start"),
            s.tag(this.$rules, "script", "js-start"),
