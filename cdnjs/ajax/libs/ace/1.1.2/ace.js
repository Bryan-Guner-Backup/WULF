  ...
  ace.define(
    ...
    function (e, t, n) {
      function o(e, t, n) {
        ...
        return !!s || n in r.FUNCTION_KEYS || n in r.PRINTABLE_KEYS
          ? e(t, s, n)
          : !1;
      }
      var r = e("./keys"),
            ...
            i &&
              ...
              (i.selection.length == 2
                ? this.selection.setSelectionRange(
                    new p(r.row, a + i.selection[0], r.row, a + i.selection[1])
                  )
                : this.selection.setSelectionRange(
                    new p(
                      r.row + i.selection[0],
        ...
        (this.CHANGE_CURSOR = 1),
          ...
          (this.$updateCachedSize = function (e, t, n, r) {
            ...
            r &&
              ...
              this.session && (i |= this.CHANGE_SCROLL));
            if (n && (e || s.width != n)) {
              (i = this.CHANGE_SIZE),
                (s.width = n),
                t == null &&
          ...
          (this.$updateScrollBarV = function () {
            this.scrollBarV.setInnerHeight(
          ...
          (this.$computeLayerConfig = function () {
            ...
            var e = this.session,
              ...
              u =
                ...
                (this.$hScrollBarAlwaysVisible ||
                  this.$size.scrollerWidth - o - 2 * this.$padding < 0),
              a = this.$horizScroll !== u;
            a && ((this.$horizScroll = u), this.scrollBarH.setVisible(u)),
              !this.$maxLines &&
                this.$scrollPastEnd &&
                this.scrollTop > r - this.$size.scrollerHeight &&
                (r += Math.min(
            ...
            l && ((this.$vScroll = f), this.scrollBarV.setVisible(f)),
              this.session.setScrollTop(
                Math.max(
                  ...
                  Math.min(
                    this.scrollTop,
                    r - this.$size.scrollerHeight + this.scrollMargin.v
                  )
                )
              ),
            ...
            var c = Math.ceil(s / this.lineHeight) - 1,
              h = Math.max(
                0,
                Math.round((this.scrollTop - i) / this.lineHeight)
              ),
              p = h + c,
              d,
              v,
          ...
          (this.scrollCursorIntoView = function (e, t) {
            ...
            s > i
              ? (t && (i -= t * this.$size.scrollerHeight),
                i == 0
                  ...
                  : i == 0 && (i = +this.scrollMargin.bottom),
                this.session.setScrollTop(i))
              : s + this.$size.scrollerHeight < i + this.lineHeight &&
                (t && (i += t * this.$size.scrollerHeight),
                this.session.setScrollTop(
            ...
            o > r
              ...
              : o + this.$size.scrollerWidth < r + this.characterWidth
              ? this.session.setScrollLeft(
            ...
            o.isIE || o.isOldGecko
              ...
              : function () {
                  ...
                  var r = this.$measureNode.getBoundingClientRect(),
                    o = { height: r.height, width: r.width / 100 };
          ...
          (this.setVisible = function (e) {
            e
              ? ((this.element.style.display = ""),
                ...
                this.fullHeight && (this.height = this.fullHeight))
