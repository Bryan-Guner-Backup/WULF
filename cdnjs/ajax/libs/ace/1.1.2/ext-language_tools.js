            ...
            return (
              ...
              u
                ? (e.session.doc.removeInLine(
                    t.row,
                    t.column - u.replaceBefore.length,
                    t.column + u.replaceAfter.length
                  ),
                  (this.variables.M__ = u.matchBefore),
                  (this.variables.T__ = u.matchAfter),
                  this.insertSnippet(e, u.content),
          ...
          return (
            ...
            (n.show = function (e, t, r) {
              var s = this.container,
                ...
                u = this.renderer,
                a = u.$maxLines * t * 1.4,
                f = e.top + this.$borderSize;
              f + a > o - t && !r
                ? ((s.style.top = ""),
                  (s.style.bottom = o - f + "px"),
                  (n.isTopdown = !1))
                : ((f += t),
                  (s.style.top = f + "px"),
                  (s.style.bottom = ""),
