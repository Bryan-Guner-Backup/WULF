          ...
          return (
            ...
            (e.prototype.detectEnd = function (e, t, n) {
              ...
              while ((i = u[e])) {
                ...
                if (((a = i[0]), E.call(o, a) >= 0)) r += 1;
                else if (((f = i[0]), E.call(s, f) >= 0)) r -= 1;
                e += 1;
              }
              return e - 1;
            }),
            ...
            (e.prototype.findTagsBackwards = function (e, t) {
              ...
              while (
                e >= 0 &&
                (n.length ||
                  (((u = this.tag(e)), E.call(t, u) < 0) &&
                    (((a = this.tag(e)), E.call(o, a) < 0) ||
                      this.tokens[e].generated) &&
                    ((f = this.tag(e)), E.call(h, f) < 0)))
              )
                ((r = this.tag(e)), E.call(s, r) >= 0) && n.push(this.tag(e)),
                  ((i = this.tag(e)), E.call(o, i) >= 0) && n.length && n.pop(),
                  (e -= 1);
                ...
                this.scanTokens(function (t, n, r) {
                  ...
                  (_ = t[0]),
                    ...
                    (A = function (t) {
                      ...
                      (i = t != null ? t : n),
                        e.push(["(", i, { ours: !0 }]),
                        r.splice(i, 0, v("CALL_START", "("));
                      if (t == null) return (n += 1);
                    }),
                    (i = function () {
                      return (
                        e.pop(), r.splice(n, 0, v("CALL_END", ")")), (n += 1)
                      );
                    }),
                    (O = function (t, i) {
                      var s;
                  ...
                  if (
                    ...
                    if (
                      ((E.call(f, _) >= 0 && t.spaced && !t.stringEnd) ||
                        (_ === "?" && n > 0 && !r[n - 1].spaced)) &&
                      (E.call(u, b) >= 0 ||
                        (E.call(l, b) >= 0 &&
                    ...
                    if (
                      ...
                      return A(n + 1), e.push(["INDENT", n + 2]), p(3);
                    if (_ === ":") {
                      this.tag(n - 2) === "@" ? (x = n - 2) : (x = n - 1);
                      while (this.tag(x - 2) === "HERECOMMENT") x -= 2;
                      M =
                        x === 0 ||
                        ((H = this.tag(x - 1)), E.call(h, H) >= 0) ||
                        r[x - 1].newLine;
                      if (k()) {
                        (B = k()), (C = B[0]), (N = B[1]);
                        if (
                ...
                this.scanTokens(function (s, o, u) {
                  ...
                  if (f === "ELSE" && this.tag(o - 1) !== "OUTDENT")
                    return (
                      u.splice.apply(
                        u,
                        [o, 0].concat(S.call(this.indentation()))
                      ),
                      2
                    );
                  if (f === "CATCH")
                    for (a = l = 1; l <= 2; a = ++l) {
                      ...
                      return (
                        u.splice.apply(
                          u,
                          [o + a, 0].concat(S.call(this.indentation()))
                        ),
                        2 + a
                      );
                    }
              ...
              return (
                ...
                (t = function (e, t) {
                  ...
                  return (
                    (r = e[0]),
                    (n = this.tokens[t - 1][0]),
                    r === "TERMINATOR" || (r === "INDENT" && E.call(d, n) < 0)
                  );
                }),
                (e = function (e, t) {
              ...
              this.lexer.showPosition
                ...
                : (k =
                    ...
                    (m == p
                      ? "end of input"
                      : "'" + (this.terminals_[m] || m) + "'")),
                this.lexer.yylloc.first_line !== d.first_line &&
                  (d = this.lexer.yylloc),
                this.parseError(k, {
            ...
            return (
              (e.prototype.toString = function () {
                return (
                  "" +
                  this.code +
                  (this.locationData ? ": " + at(this.locationData) : "")
                );
              }),
              e
            );
                ...
                return this.unfoldedSoak != null
                  ...
                  : (this.unfoldedSoak = (function () {
                      ...
                      if ((o = n.base.unfoldSoak(e)))
                        return (
                          (h = o.body.properties).push.apply(h, n.properties), o
                        );
                      p = n.properties;
          ...
          (function (e) {
            ...
            return (
              ...
              (t.prototype.compileExistence = function (e) {
                var t, n;
                return (
                  !e.isExistentialEquals && this.first.isComplex()
