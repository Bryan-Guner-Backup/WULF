  ...
  function (e, t, n) {
    ...
    e("../config").defineOptions(d.prototype, "editor", {
      enableBasicAutocompletion: {
        set: function (e) {
          e
            ? ((this.completers = f), this.commands.addCommand(i.startCommand))
        ...
        set: function (e) {
          e
            ? (this.commands.addCommand(l),
              this.on("changeMode", c),
              c(null, this))
            : (this.commands.removeCommand(l), this.off("changeMode", c));
        },
        value: !1,
      },
    });
    ...
    function (e, t, n) {
            ...
            return (
              ...
              o
                ? (e.session.doc.removeInLine(
                    t.row,
                    t.column - o.replaceBefore.length,
                    t.column + o.replaceAfter.length
                  ),
                  (this.variables.M__ = o.matchBefore),
                  (this.variables.T__ = o.matchAfter),
                  this.insertSnippet(e, o.content),
      ...
      var f = function (e) {
        ...
        (e.tabstopManager = this),
          ...
          (this.$onChangeSelection = r.delayedCall(
            ...
            for (var p = 0; p < h.length; p++) {
              ...
              d.start.row == s &&
                ...
                d.end.row == s &&
                  ...
                  (d.end.column += f),
                d.start.row >= s && (d.start.row += a),
                d.end.row >= s && (d.end.row += a),
            ...
            e.forEach(function (e) {
              for (var n = e.length; n--; ) {
                ...
                l(s.start, t),
                  ...
                  (e[n] = s),
                  r.fmtString
                    ? ((s.linked = !0), (e.hasLinkedRanges = !0))
                    : e.firstNonLinked || (e.firstNonLinked = s);
              }
      ...
      (function () {
        (this.$init = function () {
          ...
          (this.blurListener = function () {
            document.activeElement != this.editor.textInput.getElement() &&
              this.detach();
          }),
