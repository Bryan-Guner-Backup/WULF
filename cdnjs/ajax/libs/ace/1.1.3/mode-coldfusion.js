ace.define(
  ...
  function (e, t, n) {
    var r = e("../lib/oop"),
      ...
      f = e("./behaviour/coldfusion").CfmlBehaviour,
      l = function () {
        i.call(this),
            ...
            this.add("autoclosing", "insertion", function (e, t, n, r, i) {
              if (i == ">") {
                ...
                if (
                  l &&
                  a(l, "meta.tag.name") &&
                  /^cf+(abort|application|argument|associate|break|cache|collection|cookie|dbinfo|directory|dump|else|elseif|error|exchangecalendar|exchangeconnection|exchangecontact|exchangefilter|exchangetask|exit|feed|file|flush|ftp|header|htmlhead|httpparam|image|import|include|index|insert|invokeargument|location|log|mailparam|NTauthenticate|object|objectcache|param|pdfformparam|print|procparam|procresult|property|queryparam|registry|reportparam|rethrow|return|schedule|search|set|setting|throw|zipparam)$/gi.test(
                    l.value
                  )
                )
                  return;
                if (
                  a(l, "string") &&
                  f.getCurrentTokenColumn() + l.value.length > s.column
                )
                  return;
                var c = !1;
                if (
                  !l ||
                  (!a(l, "meta.tag") && (!a(l, "text") || !l.value.match("/")))
                ) {
                  do l = f.stepBackward();
                  while (
                    l &&
