      ...
      var r = (e = (function (t, n, r) {
      ...
      })(
        {
                ...
                if (h == "#") {
                  ...
                  if (d(h)) {
                    ...
                    if (v > 65535 && v < 1114111) {
                      var g = "";
                      (g += String.fromCharCode(a + (v >> 10))),
                        (g += String.fromCharCode(56320 + (v & 1023))),
                        (l = g);
                  ...
                  return (
                    e.unget(c), t._parseError("expected-numeric-entity"), !1
                  );
                }
                if ((h >= "a" && h <= "z") || (h >= "A" && h <= "Z")) {
                  var y = "";
                  ...
                  return y
                    ? ((l = o[y]),
                      h === ";" || !n || (!r(h) && h !== "=")
                        ? (c.length > y.length &&
                            e.unget(c.substring(y.length)),
                          h !== ";" &&
                            t._parseError("named-entity-without-semicolon"),
                          l)
                        : (e.unget(c), !1))
                    : (t._parseError("expected-named-entity"), e.unget(c), !1);
                }
              }),
          ...
          4: [
            function (e, t, n) {
              ...
              (r.prototype.isSpecial = function () {
                return (
                  this.namespaceURI in s &&
                  s[this.namespaceURI].indexOf(this.localName) > -1
                );
              }),
              ...
              (s.prototype._parseError = function (e, t) {
                ...
                (s.prototype.tokenize = function (e) {
                  function t(e) {
                    var t = e.char();
                    if (t === o.EOF)
                      return wt._emitToken({ type: "EOF", data: null }), !1;
                    if (t === "&") wt.setState(n);
                      ...
                      wt._emitToken({ type: "Characters", data: t + r }),
                        e.commit();
                    }
                    return !0;
                  }
                  function n(e) {
                    ...
                    return (
                      wt.setState(t),
                      wt._emitToken({ type: "Characters", data: n || "&" }),
                      !0
                    );
                  }
                  function a(e) {
                    ...
                    return (
                      n === o.EOF
                        ...
                        ? (wt._parseError(
                          ...
                          wt.setState(t))
                        : (wt._parseError("expected-closing-tag-but-got-char", {
                            data: n,
                          }),
                          e.unget(n),
                          wt.setState(K)),
                  ...
                  function F(e) {
                    ...
                    return (
                      n === o.EOF
                        ? (wt._parseError("eof-in-tag-name"),
                          e.unget(n),
                          wt.setState(t))
                        : r(n)
                        ? wt.setState(I)
                  ...
                  function I(e) {
                    var n = e.char();
                    if (n === o.EOF)
                      wt._parseError("expected-attribute-name-but-got-eof"),
                        e.unget(n),
                        wt.setState(t);
                    else {
                      if (r(n)) return !0;
                      i(n)
                        ? (wt._currentToken.data.push({
                  ...
                  function q(e) {
                    var n = e.char(),
                      ...
                      u = !1;
                    n === o.EOF
                      ? (wt._parseError("eof-in-attribute-name"),
                        e.unget(n),
                        wt.setState(t),
                        (u = !0))
                      : n === "="
                      ? wt.setState(U)
                      : i(n)
                      ? ((wt._currentAttribute().nodeName += n.toLowerCase()),
                        (s = !1))
                      : n === ">"
                      ? (u = !0)
                      : r(n)
                    ...
                    if (s) {
                      ...
                      for (var l = a.length - 2; l >= 0; l--)
                        if (f.nodeName === a[l].nodeName) {
                          wt._parseError("duplicate-attribute", {
                            name: f.nodeName,
                          }),
                            (f.nodeName = null);
                          break;
                  ...
                  function R(e) {
                    var n = e.char();
                    if (n === o.EOF)
                      wt._parseError("expected-end-of-tag-but-got-eof"),
                        e.unget(n),
                        wt.setState(t);
                    else {
                      if (r(n)) return !0;
                  ...
                  function U(e) {
                    var n = e.char();
                    if (n === o.EOF)
                      wt._parseError("expected-attribute-value-but-got-eof"),
                        e.unget(n),
                        wt.setState(t);
                    else {
                      if (r(n)) return !0;
                      n === '"'
                        ...
                        : n === "\0"
                        ? (wt._parseError("invalid-codepoint"),
                          (wt._currentAttribute().nodeValue += "�"))
                        : ((wt._currentAttribute().nodeValue += n),
                          wt.setState(X));
                    }
                    return !0;
                  ...
                  function z(e) {
                    var n = e.char();
                    if (n === o.EOF)
                      wt._parseError("eof-in-attribute-value-double-quote"),
                        e.unget(n),
                        wt.setState(t);
                  ...
                  function X(e) {
                    var n = e.char();
                    if (n === o.EOF)
                      wt._parseError("eof-after-attribute-value"),
                        e.unget(n),
                        wt.setState(t);
                      ...
                      i === o.EOF &&
                        (wt._parseError("eof-in-attribute-value-no-quotes"),
                        wt._emitCurrentToken()),
                        e.commit(),
                    ...
                    return (
                      n === o.EOF
                        ? (wt._parseError(
                          ...
                          wt.setState(t))
                        : n === ">"
                        ? ((wt._currentToken.selfClosing = !0),
                          wt.setState(t),
                          wt._emitCurrentToken())
                        : (wt._parseError(
                  ...
                  function Q(e) {
                    var t = e.shift(2);
                    if (t === "--")
                      (wt._currentToken = { type: "Comment", data: "" }),
                        wt.setState(Y);
                    else {
                      var n = e.shift(5);
                      if (n === o.EOF || t === o.EOF)
                        return (
                          wt._parseError("expected-dashes-or-doctype"),
                          wt.setState(K),
                          e.unget(t),
                          !0
                        );
                      (t += n),
                        t.toUpperCase() === "DOCTYPE"
                          ? ((wt._currentToken = {
                            ...
                            wt.setState(it))
                          : wt._tokenHandler.isCdataSectionAllowed() &&
                            t === "[CDATA["
                          ? wt.setState(G)
                          : (wt._parseError("expected-dashes-or-doctype"),
                            e.unget(t),
                  ...
                  function G(e) {
                    ...
                    return (
                      e.shift(3),
                      n && wt._emitToken({ type: "Characters", data: n }),
                      wt.setState(t),
                      !0
                    );
                  }
                  function Y(e) {
                    ...
                    return (
                      n === o.EOF
                        ...
                        ? wt.setState(Z)
                        : n === ">"
                        ? (wt._parseError("incorrect-comment"),
                          wt._emitToken(wt._currentToken),
                          wt.setState(t))
                        : n === "\0"
                        ? (wt._parseError("invalid-codepoint"),
                          (wt._currentToken.data += "�"))
                  ...
                  function it(e) {
                    ...
                    return (
                      n === o.EOF
                        ...
                        : r(n)
                        ? wt.setState(st)
                        : (wt._parseError("need-space-after-doctype"),
                          e.unget(n),
                          wt.setState(st)),
                      !0
                    );
              ...
              (function () {
                ...
                function a() {
                  ...
                  (n.base = {
                    ...
                    (n.initial = Object.create(n.base)),
                    (n.initial.processEOF = function () {
                    ...
                    (n.beforeHTML = Object.create(n.base)),
                    (n.beforeHTML.start_tag_handlers = {
                      html: "startTagHtml",
                      "-default": "startTagOther",
                    }),
                    (n.beforeHTML.processEOF = function () {
                    ...
                    (n.afterAfterBody = Object.create(n.base)),
                    (n.afterAfterBody.start_tag_handlers = {
                      html: "startTagHtml",
                      "-default": "startTagOther",
                    }),
                    (n.afterAfterBody.processComment = function (t) {
                      e.insertComment(t, e.document);
                    }),
                    ...
                    (n.afterBody = Object.create(n.base)),
                    (n.afterBody.end_tag_handlers = {
                      html: "endTagHtml",
                      "-default": "endTagOther",
                    }),
                    (n.afterBody.processComment = function (t) {
                    ...
                    (n.afterFrameset = Object.create(n.base)),
                    (n.afterFrameset.start_tag_handlers = {
                      html: "startTagHtml",
                      noframes: "startTagNoframes",
                      "-default": "startTagOther",
                    }),
                    (n.afterFrameset.end_tag_handlers = {
                      html: "endTagHtml",
                      "-default": "endTagOther",
                    }),
                    (n.afterFrameset.processCharacters = function (n) {
                      var r = n.takeRemaining(),
                        i = "";
                    ...
                    (n.beforeHead = Object.create(n.base)),
                    (n.beforeHead.start_tag_handlers = {
                      html: "startTagHtml",
                      head: "startTagHead",
                      "-default": "startTagOther",
                    }),
                    (n.beforeHead.end_tag_handlers = {
                    ...
                    (n.beforeHead.processEOF = function () {
                    ...
                    (n.inHead = Object.create(n.base)),
                    (n.inHead.start_tag_handlers = {
                      html: "startTagHtml",
                      head: "startTagHead",
                      title: "startTagTitle",
                    ...
                    (n.inHead.startTagScript = function (t, n) {
                      e.insertElement(t, n),
                        e.tokenizer.setState(d.SCRIPT_DATA),
                    ...
                    (n.inHead.endTagHead = function (t) {
                      e.openElements.item(e.openElements.length - 1)
                        .localName == "head"
                        ? e.openElements.pop()
                    ...
                    (n.afterHead = Object.create(n.base)),
                    (n.afterHead.start_tag_handlers = {
                      html: "startTagHtml",
                      head: "startTagHead",
                      body: "startTagBody",
                    ...
                    (n.afterHead.end_tag_handlers = {
                      body: "endTagBodyHtmlBr",
                      html: "endTagBodyHtmlBr",
                      br: "endTagBodyHtmlBr",
                      "-default": "endTagOther",
                    }),
                    (n.afterHead.processEOF = function () {
                      this.anythingElse(), e.insertionMode.processEOF();
                    }),
                    ...
                    (n.afterHead.startTagFromHead = function (t, r, i) {
                      e.parseError("unexpected-start-tag-out-of-my-head", {
                        ...
                        n.inHead.processStartTag(t, r, i),
                    ...
                    (n.inBody = Object.create(n.base)),
                    (n.inBody.start_tag_handlers = {
                      html: "startTagHtml",
                    ...
                    (n.inBody.processCharacters = function (t) {
                      ...
                      if (!n) return;
                      e.insertText(n),
                        e.framesetOk && !s(n) && (e.framesetOk = !1);
                    }),
                    ...
                    (n.inBody.startTagPlaintext = function (t, n) {
                      e.openElements.inButtonScope("p") && this.endTagP("p"),
                        e.insertElement(t, n),
                        e.tokenizer.setState(d.PLAINTEXT);
                    }),
                    ...
                    (n.inBody.startTagAppletMarqueeObject = function (t, n) {
                      e.reconstructActiveFormattingElements(),
                        e.insertElement(t, n),
                        e.activeFormattingElements.push(g),
                        (e.framesetOk = !1);
                    }),
                    ...
                    (n.inBody.startTagIsindex = function (t, n) {
                      ...
                      i.push({ nodeName: "name", nodeValue: "isindex" }),
                        ...
                        this.processCharacters(new u(s)),
                    ...
                    (n.inCaption = Object.create(n.base)),
                    (n.inCaption.start_tag_handlers = {
                      html: "startTagHtml",
                    ...
                    (n.inCaption.processCharacters = function (e) {
                    ...
                    (n.inCell = Object.create(n.base)),
                    (n.inCell.start_tag_handlers = {
                      html: "startTagHtml",
                    ...
                    (n.inCell.processCharacters = function (e) {
                      n.inBody.processCharacters(e);
                    }),
                    ...
                    (n.inColumnGroup = Object.create(n.base)),
                    (n.inColumnGroup.start_tag_handlers = {
                      html: "startTagHtml",
                      col: "startTagCol",
                      "-default": "startTagOther",
                    }),
                    (n.inColumnGroup.end_tag_handlers = {
                      colgroup: "endTagColgroup",
                      col: "endTagCol",
                      "-default": "endTagOther",
                    }),
                    (n.inColumnGroup.ignoreEndTagColgroup = function () {
                    ...
                    (n.inForeignContent = Object.create(n.base)),
                    (n.inForeignContent.processStartTag = function (t, n, r) {
                      if (
                        [
                          "b",
                          "big",
                    ...
                    (n.inHeadNoscript = Object.create(n.base)),
                    (n.inHeadNoscript.start_tag_handlers = {
                      html: "startTagHtml",
                    ...
                    (n.inHeadNoscript.end_tag_handlers = {
                      noscript: "endTagNoscript",
                      br: "endTagBr",
                      "-default": "endTagOther",
                    }),
                    (n.inHeadNoscript.processCharacters = function (t) {
                      var n = t.takeLeadingWhitespace();
                      n && e.insertText(n);
                      if (!t.length) return;
                    ...
                    (n.inHeadNoscript.startTagBasefontBgsoundLinkMetaNoframesStyle =
                      function (e, t) {
                        n.inHead.processStartTag(e, t);
                      }),
                    ...
                    (n.inFrameset = Object.create(n.base)),
                    (n.inFrameset.start_tag_handlers = {
                      html: "startTagHtml",
                      frameset: "startTagFrameset",
                      frame: "startTagFrame",
                      noframes: "startTagNoframes",
                    ...
                    (n.inFrameset.end_tag_handlers = {
                      frameset: "endTagFrameset",
                      noframes: "endTagNoframes",
                      "-default": "endTagOther",
                    }),
                    (n.inFrameset.processCharacters = function (t) {
                      e.parseError("unexpected-char-in-frameset");
                    }),
                    ...
                    (n.inTable = Object.create(n.base)),
                    (n.inTable.start_tag_handlers = {
                      html: "startTagHtml",
                    ...
                    (n.inTable.processCharacters = function (t) {
                    ...
                    (n.inTable.startTagOther = function (t, r, i) {
                      e.parseError(
                        ...
                        (e.redirectAttachToFosterParent = !0),
                        n.inBody.processStartTag(t, r, i),
                        (e.redirectAttachToFosterParent = !1);
                    }),
                    ...
                    (n.inTable.endTagOther = function (t) {
                      e.parseError("unexpected-end-tag-implies-table-voodoo", {
                        ...
                        (e.redirectAttachToFosterParent = !0),
                        n.inBody.processEndTag(t),
                        (e.redirectAttachToFosterParent = !1);
                    }),
                    (n.inTableText = Object.create(n.base)),
                    (n.inTableText.flushCharacters = function () {
                    ...
                    (n.inTableBody = Object.create(n.base)),
                    (n.inTableBody.start_tag_handlers = {
                      html: "startTagHtml",
                      tr: "startTagTr",
                    ...
                    (n.inTableBody.end_tag_handlers = {
                      table: "endTagTable",
                    ...
                    (n.inTableBody.processCharacters = function (e) {
                    ...
                    (n.inSelect = Object.create(n.base)),
                    (n.inSelect.start_tag_handlers = {
                      html: "startTagHtml",
                    ...
                    (n.inSelect.processCharacters = function (t) {
                      var n = t.takeRemaining();
                      n = n.replace(/\u0000/g, function (t, n) {
                        return e.parseError("invalid-codepoint"), "";
                      });
                    ...
                    (n.inSelectInTable = Object.create(n.base)),
                    (n.inSelectInTable.start_tag_handlers = {
                    ...
                    (n.inSelectInTable.end_tag_handlers = {
                      caption: "endTagTable",
                      table: "endTagTable",
                      tbody: "endTagTable",
                      tfoot: "endTagTable",
                    ...
                    (n.inSelectInTable.processCharacters = function (e) {
                    ...
                    (n.inRow = Object.create(n.base)),
                    (n.inRow.start_tag_handlers = {
                      html: "startTagHtml",
                      td: "startTagTableCell",
                      th: "startTagTableCell",
                      caption: "startTagTableOther",
                    ...
                    (n.inRow.processCharacters = function (e) {
                      n.inTable.processCharacters(e);
                    }),
                    ...
                    (n.afterAfterFrameset = Object.create(n.base)),
                    (n.afterAfterFrameset.start_tag_handlers = {
                      html: "startTagHtml",
                      noframes: "startTagNoFrames",
                      "-default": "startTagOther",
                    }),
                    (n.afterAfterFrameset.processEOF = function () {}),
                    ...
                    (n.text = Object.create(n.base)),
                    (n.text.start_tag_handlers = {
                      "-default": "startTagOther",
                    }),
                    (n.text.end_tag_handlers = {
                      script: "endTagScript",
                      "-default": "endTagOther",
                    }),
                    (n.text.processCharacters = function (t) {
                      e.shouldSkipLeadingNewline &&
                        ((e.shouldSkipLeadingNewline = !1),
                        t.skipAtMostOneLeadingNewline());
                      var n = t.takeRemaining();
                ...
                (u.prototype.skipAtMostOneLeadingNewline = function () {
                  ...
                  (a.prototype.adoptionAgencyEndTag = function (e) {
                    ...
                    while (s++ < n) {
                      ...
                      if (
                        !i ||
                        (this.openElements.contains(i) &&
                          !this.openElements.inScope(i.localName))
                      )
                        return (
                      ...
                      while (p++ < r) {
                        ...
                        if (l == i) break;
                        c == o &&
                          (f = this.activeFormattingElements.indexOf(l) + 1);
                      ...
                      this.detachFromParent(c.node),
                        a.isFosterParenting()
                          ? this.insertIntoFosterParent(c.node)
                          : this.attachNode(c.node, a.node);
                      var d = this.createElement(
                          "http://www.w3.org/1999/xhtml",
                          i.localName,
                          i.attributes
                        ),
                        g = new m(i.namespaceURI, i.localName, i.attributes, d);
                      this.reparentChildren(o.node, d),
                        this.attachNode(d, o.node),
                        this.removeElementFromActiveFormattingElements(i),
                        this.activeFormattingElements.splice(
                          Math.min(f, this.activeFormattingElements.length),
                          0,
                          g
                        ),
                  ...
                  (a.prototype.insertHtmlElement = function (e) {
                    ...
                    return (
                      ...
                      this.openElements.pushHtmlElement(
                        new m("http://www.w3.org/1999/xhtml", "html", e, t)
                      ),
                      t
                    );
                  }),
                  ...
                  (a.prototype.insertBodyElement = function (e) {
                    ...
                    return (
                      ...
                      this.openElements.pushBodyElement(
                        new m("http://www.w3.org/1999/xhtml", "body", e, t)
                      ),
                      t
                    );
                  }),
                  ...
                  (a.prototype.insertElement = function (e, t, n, r) {
                    ...
                    this.shouldFosterParent()
                      ...
                      r || this.openElements.push(new m(n, e, t, i));
                  }),
                  ...
                  (a.prototype.reconstructActiveFormattingElements =
                    function () {
                  ...
                  (a.prototype.appendElementToActiveFormattingElements =
                    function (e) {
                      this.ensureNoahsArkCondition(e),
                        this.activeFormattingElements.push(e);
                    }),
                  (a.prototype.removeElementFromActiveFormattingElements =
                    function (e) {
                      var t = this.activeFormattingElements.indexOf(e);
                      t >= 0 && this.activeFormattingElements.splice(t, 1);
                    }),
                  (a.prototype.elementInActiveFormattingElements = function (
                    e
                  ) {
                  ...
                  (a.prototype.clearActiveFormattingElements = function () {
                    while (
                      ...
                      this.activeFormattingElements.pop() != g
                    );
                  }),
                    ...
                    return (
                      e.forEach(function (e) {
                        (e.namespaceURI = "http://www.w3.org/1998/Math/MathML"),
                          h.MATHMLAttributeMap[e.nodeName] &&
                            (e.nodeName = h.MATHMLAttributeMap[e.nodeName]);
                      }),
                      e
                    );
                  }),
                    ...
                    return (
                      e.forEach(function (e) {
                        (e.namespaceURI = "http://www.w3.org/2000/svg"),
                          h.SVGAttributeMap[e.nodeName] &&
                            (e.nodeName = h.SVGAttributeMap[e.nodeName]);
                      }),
                      e
                    );
                  }),
                  (a.prototype.adjustForeignAttributes = function (e) {
                    for (var t = 0; t < e.length; t++) {
                      var n = e[t],
                        r = h.ForeignAttributeMap[n.nodeName];
                      r &&
          ...
          10: [
            function (e, t, n) {
              ...
              function c(e) {
                s.call(this),
                  (this.data = e),
                  (this.nodeType = w.IGNORABLE_WHITESPACE);
              }
              function h(e) {
              ...
              function v(e) {
                s.call(this),
                  (this.name = e),
                  (this.nodeType = w.SKIPPED_ENTITY);
              }
              function m(e, t) {
              ...
              (function () {
                ...
                function r(e, t) {
                  return t === undefined
                    ...
                    ? t.toString()
                    : typeof t == "function" || t instanceof RegExp
                    ? t.toString()
                    : t;
                }
                function i(e, t) {
                ...
                function h(e, t, n, r) {
                  ...
                  (r =
                    (n && n.name ? " (" + n.name + ")." : ".") +
                    (r ? " " + r : ".")),
                    e && !i && s("Missing expected exception" + r),
                    !e && c(i, n) && s("Got unwanted exception" + r);
                ...
                (m.AssertionError = function (e) {
                  ...
                  (m.AssertionError.prototype.toString = function () {
                    return this.message
                      ? [this.name + ":", this.message].join(" ")
                      : [
                          this.name + ":",
                          i(JSON.stringify(this.actual, r), 128),
                          this.operator,
                          i(JSON.stringify(this.expected, r), 128),
                        ].join(" ");
                  }),
                  (m.fail = s),
                  (m.ok = o),
          ...
          14: [
            function (e, t, n) {
              (function (e) {
                ...
                var r = (n.EventEmitter = e.EventEmitter),
                  i =
                ...
                (n.inspect = function (e, t, o, u) {
                  function a(e, o) {
                    ...
                    var w = d.map(function (t) {
                      var n, i;
                      e.__lookupGetter__ &&
                        (e.__lookupGetter__(t)
                          ? e.__lookupSetter__(t)
                            ? (i = h("[Getter/Setter]", "special"))
                            : (i = h("[Getter]", "special"))
                          : e.__lookupSetter__(t) &&
                            (i = h("[Setter]", "special"))),
                        p.indexOf(t) < 0 && (n = "[" + t + "]"),
          ...
          17: [
            function (e, t, n) {
              (function () {
                  ...
                  if (typeof i == "number")
                    ...
                    if (s(e))
                      for (var u = 0; u < this.length; u++)
                        e instanceof t
                          ? (this[u] = e.readUInt8(u))
                          : (this[u] = e[u]);
                    else if (o == "string") this.length = this.write(e, 0, n);
                    else if (o === "number")
                      for (var u = 0; u < this.length; u++) this[u] = 0;
                  }
                }
                function r(e) {
                ...
                function u(e) {
                  ...
                  for (var n = 0; n < e.length; n++)
                    if (e.charCodeAt(n) <= 127) t.push(e.charCodeAt(n));
                      ...
                      var r = encodeURIComponent(e.charAt(n))
                        .substr(1)
                        .split("%");
                ...
                function h(e, t, n, r) {
                  ...
                  return (
                    r ||
                      (k.ok(typeof n == "boolean", "missing or invalid endian"),
                      k.ok(t !== undefined && t !== null, "missing offset"),
                      k.ok(
                        t + 1 < e.length,
                    ...
                    t >= e.length
                      ...
                      : (n
                          ? ((i = e[t] << 8),
                            t + 1 < e.length && (i |= e[t + 1]))
                          : ((i = e[t]),
                            t + 1 < e.length && (i |= e[t + 1] << 8)),
                        i)
                  );
                }
                function p(e, t, n, r) {
                  ...
                  return (
                    ...
                    t >= e.length
                      ? 0
                      : (n
                          ? (t + 1 < e.length && (i = e[t + 1] << 16),
                            t + 2 < e.length && (i |= e[t + 2] << 8),
                            t + 3 < e.length && (i |= e[t + 3]),
                            (i += (e[t] << 24) >>> 0))
                          : (t + 2 < e.length && (i = e[t + 2] << 16),
                            t + 1 < e.length && (i |= e[t + 1] << 8),
                            (i |= e[t]),
                            t + 3 < e.length && (i += (e[t + 3] << 24) >>> 0)),
                        i)
                  );
                }
                function d(e, t, n, r) {
                ...
                function v(e, t, n, r) {
                  ...
                  return (
                    ...
                    (s = p(e, t, n, r)),
                    (i = s & 2147483648),
                    i ? (4294967295 - s + 1) * -1 : s
                  );
                }
                function m(t, n, r, i) {
                  return (
                    i ||
                      (k.ok(typeof r == "boolean", "missing or invalid endian"),
                      k.ok(
                        n + 3 < t.length,
                        "Trying to read beyond buffer length"
                      )),
                    e("./buffer_ieee754").readIEEE754(t, n, r, 23, 4)
                  );
                }
                function g(t, n, r, i) {
                  return (
                    ...
                    e("./buffer_ieee754").readIEEE754(t, n, r, 52, 8)
                  );
                }
                function y(e, t) {
                  k.ok(
                    ...
                    k.ok(e <= t, "value is larger than maximum value for type"),
                    k.ok(
                      Math.floor(e) === e,
                ...
                function b(e, t, n, r, i) {
                  i ||
                    (k.ok(t !== undefined && t !== null, "missing value"),
                    k.ok(typeof r == "boolean", "missing or invalid endian"),
                    k.ok(n !== undefined && n !== null, "missing offset"),
                    k.ok(
                      n + 1 < e.length,
                      "trying to write beyond buffer length"
                    ),
                    y(t, 65535));
                  for (var s = 0; s < Math.min(e.length - n, 2); s++)
                    e[n + s] =
                      (t & (255 << (8 * (r ? 1 - s : s)))) >>>
                      ((r ? 1 - s : s) * 8);
                }
                function w(e, t, n, r, i) {
                  i ||
                    ...
                    y(t, 4294967295));
                  for (var s = 0; s < Math.min(e.length - n, 4); s++)
                    e[n + s] = (t >>> ((r ? 3 - s : s) * 8)) & 255;
                }
                function E(e, t, n) {
                  k.ok(
                    typeof e == "number",
                    ...
                    k.ok(e <= t, "value larger than maximum allowed value"),
                    k.ok(e >= n, "value smaller than minimum allowed value"),
                    k.ok(
                      Math.floor(e) === e,
                      "value has a fractional component"
                    );
                ...
                function x(e, t, n, r, i) {
                  i ||
                    ...
                    E(t, 32767, -32768)),
                    t >= 0 ? b(e, t, n, r, i) : b(e, 65535 + t + 1, n, r, i);
                }
                function T(e, t, n, r, i) {
                  i ||
                    ...
                    E(t, 2147483647, -2147483648)),
                    t >= 0
                      ? w(e, t, n, r, i)
                      : w(e, 4294967295 + t + 1, n, r, i);
                }
                function N(t, n, r, i, s) {
                  s ||
                    (k.ok(n !== undefined && n !== null, "missing value"),
                    k.ok(typeof i == "boolean", "missing or invalid endian"),
                    k.ok(r !== undefined && r !== null, "missing offset"),
                    k.ok(
                      r + 3 < t.length,
                      "Trying to write beyond buffer length"
                    ),
                    S(n, 3.4028234663852886e38, -3.4028234663852886e38)),
                    e("./buffer_ieee754").writeIEEE754(t, n, r, i, 23, 4);
                }
                function C(t, n, r, i, s) {
                  s ||
                    ...
                    S(n, 1.7976931348623157e308, -1.7976931348623157e308)),
                    e("./buffer_ieee754").writeIEEE754(t, n, r, i, 52, 8);
                }
                var k = e("assert");
                (n.Buffer = t),
                  (n.SlowBuffer = t),
                  ...
                  (t.prototype.base64Write = function (e, n, r) {
                    var i, s;
                  ...
                  (t.prototype.utf8Slice = function () {
                    ...
                    while (r < e.length)
                      e[r] <= 127
                        ? ((t += c(n) + String.fromCharCode(e[r])), (n = ""))
                        : (n += "%" + e[r].toString(16)),
                        r++;
                    return t + c(n);
                  }),
                  ...
                  (t.prototype.toString = function (e, t, n) {
                    (e = String(e || "utf8").toLowerCase()),
                      (t = +t || 0),
                      typeof n == "undefined" && (n = this.length);
                    if (+n == t) return "";
                    switch (e) {
                      case "hex":
                  ...
                  (t.prototype.readUInt8 = function (e, t) {
                    var n = this;
                    t ||
                      (k.ok(e !== undefined && e !== null, "missing offset"),
                      k.ok(
                        e < n.length,
                        "Trying to read beyond buffer length"
                      ));
                  ...
                  (t.prototype.writeUInt8 = function (e, t, n) {
                    var r = this;
                    n ||
                      (k.ok(e !== undefined && e !== null, "missing value"),
                      k.ok(t !== undefined && t !== null, "missing offset"),
                      k.ok(
                        t < r.length,
                        "trying to write beyond buffer length"
            ...
            { "./buffer_ieee754": 16, assert: 13, "base64-js": 18 },
          ],
          18: [
            function (e, t, n) {
              (function (e) {
                function n(e) {
                  ...
                  for (t = 0, n = 0; t < r; t += 4, n += 3)
                    (s =
                      ...
                      (i.indexOf(e[t + 2]) << 6) |
                      i.indexOf(e[t + 3])),
                      u.push((s & 16711680) >> 16),
                      u.push((s & 65280) >> 8),
                      u.push(s & 255);
                  return (
                    o === 2
                      ? ((s =
                          (i.indexOf(e[t]) << 2) | (i.indexOf(e[t + 1]) >> 4)),
                        u.push(s & 255))
                      : o === 1 &&
                        ((s =
                          (i.indexOf(e[t]) << 10) |
