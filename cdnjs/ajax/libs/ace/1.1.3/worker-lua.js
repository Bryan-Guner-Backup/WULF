      ...
      (function (e, n, r) {
        ...
        function t(e) {
          if (Jt) {
            var t = $t.pop();
            t.complete(),
              bt.locations && (e.loc = t.loc),
              bt.ranges && (e.range = t.range);
          }
          return e;
        }
        function n(e, t, n) {
        ...
        function a() {
          f();
          while (45 === yt.charCodeAt(Bt) && 45 === yt.charCodeAt(Bt + 1))
            b(), f();
          if (Bt >= wt)
            return {
              type: St,
        ...
        function c(e) {
          return (
            (Bt += e.length),
            { type: kt, value: e, line: Ut, lineStart: zt, range: [Rt, Bt] }
          );
        }
        function h() {
          return (
            (Bt += 3),
            { type: Ot, value: "...", line: Ut, lineStart: zt, range: [Rt, Bt] }
          );
        }
        function p() {
          var e = yt.charCodeAt(Bt++),
          ...
          while (Bt < wt) {
            ...
            if (92 === r) (n += yt.slice(t, Bt - 1) + y()), (t = Bt);
              ...
              (n += yt.slice(t, Bt - 1)),
                s({}, Mt.unfinishedString, n + String.fromCharCode(r));
          }
          return (
            (n += yt.slice(t, Bt - 1)),
            { type: xt, value: n, line: Ut, lineStart: zt, range: [Rt, Bt] }
          );
        }
        function d() {
          var e = w();
        ...
        function m() {
          var e = 0,
            ...
            u;
          (u = Bt += 2),
            k(yt.charCodeAt(Bt)) || s({}, Mt.malformedNumber, yt.slice(Rt, Bt));
          ...
          if ("." === yt.charAt(Bt)) {
            ...
            while (k(yt.charCodeAt(Bt))) Bt++;
            (e = yt.slice(i, Bt)),
              (e = i === Bt ? 0 : parseInt(e, 16) / Math.pow(16, Bt - i));
          }
          if ("pP".indexOf(yt.charAt(Bt) || null) >= 0) {
            Bt++,
              "+-".indexOf(yt.charAt(Bt) || null) >= 0 &&
                (n = "+" === yt.charAt(Bt++) ? 1 : -1),
              (o = Bt),
              C(yt.charCodeAt(Bt)) ||
                s({}, Mt.malformedNumber, yt.slice(Rt, Bt));
        ...
        function y() {
          ...
          switch (yt.charAt(Bt)) {
            ...
            case "z":
              return Bt++, f(), "";
            case "x":
              if (k(yt.charCodeAt(Bt + 1)) && k(yt.charCodeAt(Bt + 2)))
                return (Bt += 3), "\\" + yt.slice(e, Bt);
              return "\\" + yt.charAt(Bt++);
            default:
        ...
        function b() {
          ...
          if (bt.comments) {
            ...
            bt.locations &&
              (o.loc = {
                start: { line: s, column: Rt - i },
                end: { line: Ut, column: Bt - zt },
              }),
        ...
        function K() {
          var e = jt.value,
            n = it();
          return (
            bt.scope && (n.isLabel = I("::" + e + "::")), t(_t.gotoStatement(n))
          );
        }
        function Q() {
          var e = X();
        ...
        function et() {
          ...
          while (S("elseif"))
            z(i),
              ...
              x("then"),
              (r = X()),
              e.push(t(_t.elseifClause(n, r))),
              Jt && (i = q());
          return (
            S("else") &&
              (Jt && ((i = new R(Ft)), $t.push(i)),
              (r = X()),
              e.push(t(_t.elseClause(r)))),
            x("end"),
            t(_t.ifStatement(e))
          );
        }
        function tt() {
          ...
          if (S("=")) {
            ...
            return (
              ...
              (n = X()),
              x("end"),
              t(_t.forNumericStatement(e, r, i, s, n))
            );
          }
          var o = [e];
          ...
          return (
            x("do"), (n = X()), x("end"), t(_t.forGenericStatement(o, u, n))
          );
        }
        function nt() {
          var e;
        ...
        function rt() {
          ...
          if (",=".indexOf(jt.value) >= 0) {
            var i = [n],
              ...
              a;
            while (S(","))
              (a = ht()), null == a && o("<expression>", jt), i.push(a);
            x("=");
            do (a = ft()), s.push(a);
            while (S(","));
          ...
          for (;;) {
            ...
            if (kt === jt.type && S("["))
              (n = ft()),
                ...
                x("="),
                (r = ft()),
                e.push(t(_t.tableKey(n, r)));
            else if (Nt === jt.type)
              (n = ft()),
                S("=")
                  ? ((r = ft()), e.push(t(_t.tableKeyString(n, r))))
                  : e.push(t(_t.tableValue(n)));
            else {
              if (null == (r = at())) {
                $t.pop();
                break;
        ...
        function ct(e) {
          ...
          if (M(jt)) {
            U(), E();
            var s = ct(8);
            s == null && o("<expression>", jt),
              (r = t(_t.unaryExpression(n, s)));
          }
          ...
          for (;;) {
            ...
            ("^" === n || ".." === n) && u--, E();
            var a = ct(u);
            null == a && o("<expression>", jt),
              Jt && $t.push(i),
              (r = t(_t.binaryExpression(n, r, a)));
          }
          return r;
        }
        function ht() {
          ...
          Jt && (r = q());
          if (Nt === jt.type)
            (n = jt.value), (e = it()), bt.scope && F(e, (i = I(n)));
          else {
            if (!S("(")) return null;
        ...
        function gt(e) {
          "undefined" != typeof e && mt(e),
            (wt = yt.length),
            (Jt = bt.locations || bt.ranges),
            (It = a());
          var t = W();
        ...
        (R.prototype.complete = function () {
          bt.locations &&
            ((this.loc.end.line = Ft.line),
            (this.loc.end.column = Ft.range[1] - Ft.lineStart)),
