              ...
              (p = s[o[g]]),
                ...
                p.next &&
                  (typeof p.next == "string"
                    ? (n.length && n[0] == i && n[1] == p.next && n.shift(),
                      (i = p.next))
                    : (i = p.next(i, n)),
                  (s = this.states[i]),
                  s ||
      ...
      (function () {
        ...
        (this.$computeWrapSplits = function (e, t) {
          ...
          while (i - s > t) {
            ...
            if (e[c] == n || e[c] == u) {
              for (c; c != s - 1; c--) if (e[c] == n) break;
              if (c > s) {
                f(c);
                continue;
              }
              c = s + t;
              for (c; c < e.length; c++) if (e[c] != u) break;
              if (c == e.length) break;
              f(c);
              continue;
            }
        ...
        r.implement(this, u),
          ...
          (this.$measureSizes = function () {
            if (a === 1) {
              ...
              var n = { height: e.height, width: e.width };
            } else
              var n = {
