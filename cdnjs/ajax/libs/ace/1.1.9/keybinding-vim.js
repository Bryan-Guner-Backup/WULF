define("ace/keyboard/vim", [
  ...
  function S(e) {
    e.setOption("disableInput", !0),
      ...
      e.on("cursorActivity", Xn),
      et(e),
      v.on(e.getInputField(), "paste", O(e));
  }
  function x(e) {
    e.setOption("disableInput", !1),
      e.off("cursorActivity", Xn),
      v.off(e.getInputField(), "paste", O(e)),
      (e.state.vim = null);
  }
  function T(e, t) {
  ...
  function A(e) {
    ...
    return r
      ? (W(n) && (t[t.length - 1] = n.toLowerCase()), "<" + t.join("-") + ">")
      : !1;
  }
  function O(e) {
    var t = e.state.vim;
    return (
      t.onPasteFn ||
        (t.onPasteFn = function () {
          t.insertMode ||
            (e.setCursor(wt(e.getCursor(), 0, 1)),
            mt.enterInsertMode(e, {}, t));
        }),
      t.onPasteFn
    );
  }
  ...
  function At(e, t) {
    return (
      arguments.length > 2 &&
        (t = At.apply(undefined, Array.prototype.slice.call(arguments, 1))),
      Lt(e, t) ? e : t
    );
  }
  function Ot(e, t) {
    return (
      arguments.length > 2 &&
        (t = Ot.apply(undefined, Array.prototype.slice.call(arguments, 1))),
      Lt(e, t) ? t : e
    );
  }
  function Mt(e, t, n) {
  ...
  function Ft(e, t, n) {
    for (var r = 0; r < e.length; r++) {
      var i = n != "head" && kt(e[r].anchor, t),
        s = n != "anchor" && kt(e[r].head, t);
      if (i || s) return r;
    }
    return -1;
  }
    ...
    var n = t.lastSelection,
      r = function () {
        var t = e.listSelections(),
          n = t[0],
          r = t[t.length - 1],
          i = Lt(n.anchor, n.head) ? n.anchor : n.head,
          s = Lt(r.anchor, r.head) ? r.head : r.anchor;
        return [i, s];
      },
      i = function () {
        var t = e.getCursor(),
        ...
        if (i) {
          ...
          (r = { line: r.line + d, ch: d ? r.ch : v + r.ch }),
            n.visualLine &&
              ((t = w(t.line, 0)), (r = w(r.line, _t(e, r.line)))),
            e.setSelection(t, r);
        }
        return [t, r];
      };
  ...
  function zt(e, t, n, r) {
    var i = Ct(t.head),
      s = Ct(t.anchor);
    if (n == "char") {
      var o = !r && !Lt(t.head, t.anchor) ? 1 : 0,
        u = Lt(t.head, t.anchor) ? 1 : 0;
      return (
        (i = wt(t.head, 0, o)),
        (s = wt(t.anchor, 0, u)),
    ...
    if (n == "block") {
      var f = Math.min(s.line, i.line),
        ...
        v = [];
      for (var m = 0; m < p; m++)
        v.push({ anchor: w(f + m, l), head: w(f + m, h) });
  ...
  function Wt(e) {
    ...
    return (
      e.getSelection().length == 1 && (t = At(t, e.getCursor("anchor"))), t
    );
  }
  function Xt(e, t) {
    var n = e.state.vim;
    t !== !1 && e.setCursor(yt(e, n.sel.head)),
      qt(e, n),
      (n.visualMode = !1),
      (n.visualLine = !1),
      (n.visualBlock = !1),
  ...
  function Gt(e, t) {
    (tt.lastChararacterSearch.increment = e),
      (tt.lastChararacterSearch.forward = t.forward),
      (tt.lastChararacterSearch.selectedCharacter = t.selectedCharacter);
  }
  function en(e, t, n, r) {
    var i = Ct(e.getCursor()),
      s = n ? 1 : -1,
      o = n ? e.lineCount() : -1,
      u = i.ch,
      a = i.line,
  ...
  function an(e, t, n, r, i) {
    ...
    for (l = s; l > o; l--)
      if (!i || c(l) == v || l == s) if (h(l, -1, !0)) break;
  ...
  function fn(e, t, n, r) {
    var i = t,
      ...
      l = f === a ? 1 : 0;
    (s = e.scanForBracket(w(i.line, i.ch + l), -1, null, { bracketRegex: u })),
      (o = e.scanForBracket(w(i.line, i.ch + l), 1, null, { bracketRegex: u }));
  ...
  function ln(e, t, n, r) {
    ...
    return !u || !a
      ? { start: i, end: i }
      : (r && (--u, ++a), { start: w(i.line, u), end: w(i.line, a) });
  }
  function cn() {}
  function hn(e) {
    var t = e.state.vim;
  ...
  function An(e) {
    var t = hn(e);
    e.removeOverlay(hn(e).getOverlay()),
      t.setOverlay(null),
  ...
  function On(e, t, n) {
    return (
      ...
      t instanceof Array ? V(e, t) : n ? e >= t && e <= n : e == t
    );
  }
  function Mn(e) {
  ...
  function jn(e) {
    var t = e.state.vim,
      n = tt.macroModeState,
      r = tt.registerController.getRegister("."),
      i = n.isPlaying,
    ...
    if (!i) {
      ...
      (s.changes = o),
        e.off("change", Wn),
        v.off(e.getInputField(), "keydown", Kn);
    }
    !i &&
      t.insertModeRepeat > 1 &&
      (Qn(e, t, t.insertModeRepeat - 1, !0),
  ...
  function qn(e, t, n, r) {
    var i = tt.registerController.getRegister(r),
      s = i.keyBuffer,
      o = 0;
    ...
    for (var u = 0; u < s.length; u++) {
      ...
      while (a) {
        ...
        if (t.insertMode) {
          ...
          (tt.macroModeState.lastInsertModeChanges.changes = c),
            Gn(e, c, 1),
            jn(e);
        }
      }
  ...
  function Rn(e, t) {
    ...
    var n = e.latestRegister,
      r = tt.registerController.getRegister(n);
    r && r.pushText(t);
  }
  function Un(e) {
    if (e.isPlaying) return;
    var t = e.latestRegister,
      n = tt.registerController.getRegister(t);
  ...
  function $n(e, t) {
    var n = e.getCursor("anchor"),
      r = e.getCursor("head");
    t.visualMode && kt(r, n) && _t(e, r.line) > r.ch
      ? Xt(e, !1)
      : !t.visualMode &&
        !t.insertMode &&
        e.somethingSelected() &&
  ...
  function Gn(e, t, n) {
    ...
    var i = e.getCursor("head"),
      s = tt.macroModeState.lastInsertModeChanges.inVisualBlock;
    if (s) {
      var o = e.state.vim,
        u = o.lastSelection,
        a = Et(u.anchor, u.head);
  ...
  function tr(e) {
    ...
    return (
      Object.keys(e).forEach(function (n) {
        ...
        Array.isArray(r)
          ? (r = r.slice())
          : r && typeof r == "object" && r.constructor != Object && (r = tr(r)),
          (t[n] = r);
      }),
      e.sel &&
        (t.sel = {
      ...
      e.operation(function () {
        e.ace.forEachSelection(function () {
          ...
          (s = wt(s, 0, a)),
            ...
            e.virtualSelectionMode() && (e.state.vim = tr(o));
        }),
  ...
  var k = { Shift: "S", Ctrl: "C", Alt: "A", Cmd: "D", Mod: "A" },
    L = { Enter: "CR", Backspace: "BS", Delete: "Del" },
    M = /[\d]/,
    _ = [
      v.isWordChar,
      function (e) {
  ...
  var tt,
    ...
    it = {
      ...
      defineEx: function (e, t, n) {
        ...
        (Pn[e] = n),
          (Hn.commandMap_[t] = { name: e, shortName: t, type: "api" });
      },
      ...
      findKey: function (e, t, n) {
        ...
        function u() {
          ...
          var n = (r.inputState.keyBuffer = r.inputState.keyBuffer + t),
            i = t.length == 1,
            o = lt.matchCommand(n, b, r.inputState, "insert");
          while (n.length > 1 && o.type != "full") {
            var n = (r.inputState.keyBuffer = n.slice(1)),
              u = lt.matchCommand(n, b, r.inputState, "insert");
            u.type != "none" && (o = u);
          }
        ...
        function a() {
          ...
          var u = r.visualMode ? "visual" : "normal",
            a = lt.matchCommand(o[2] || o[1], b, r.inputState, u);
    ...
    (at.prototype = {
      pushText: function (e, t, n, r, i) {
        ...
        if (!s) {
          switch (t) {
            ...
            case "change":
              n.indexOf("\n") == -1
                ? (this.registers["-"] = new ut(n, r))
                : (this.shiftNumericRegisters_(),
                  (this.registers[1] = new ut(n, r)));
          }
      ...
      getRegister: function (e) {
        return this.isValidRegister(e)
          ? ((e = e.toLowerCase()),
            this.registers[e] || (this.registers[e] = new ut()),
            this.registers[e])
  ...
  var lt = {
      matchCommand: function (e, t, n, r) {
        ...
        return (
          s.keys.slice(-11) == "<character>" && (n.selectedCharacter = Tt(e)),
          { type: "full", command: s }
        );
      },
      ...
      processMotion: function (e, t, n) {
        (t.inputState.motion = n.motion),
          (t.inputState.motionArgs = bt(n.motionArgs)),
          this.evalInput(e, t);
      },
      ...
      processSearch: function (e, t, n) {
        function a(r, i, s) {
          tt.searchHistoryController.pushInput(r),
            tt.searchHistoryController.reset();
          try {
            Nn(e, r, i, s);
          } catch (o) {
        ...
        function l(t, n, i) {
          ...
          s == "Up" || s == "Down"
            ? ((o = s == "Up" ? !0 : !1),
              (n = tt.searchHistoryController.nextMatch(n, o) || ""),
              i(n))
            : s != "Left" &&
              s != "Right" &&
              s != "Ctrl" &&
          ...
          a
            ? e.scrollIntoView(Ln(e, !r, a), 30)
            : (An(e), e.scrollTo(u.left, u.top));
        }
        function c(t, n, r) {
          var i = v.keyName(t);
          if (i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[")
            tt.searchHistoryController.pushInput(n),
              tt.searchHistoryController.reset(),
              Nn(e, o),
              An(e),
        ...
        switch (n.searchArgs.querySrc) {
          ...
          case "wordUnderCursor":
            ...
            m && i ? (p = "\\b" + p + "\\b") : (p = Pt(p)),
              (tt.jumpList.cachedCursor = e.getCursor()),
              e.setCursor(d.start),
              a(p, !0, !1);
        }
      },
      processEx: function (e, t, n) {
        function r(t) {
          tt.exCommandHistoryController.pushInput(t),
            tt.exCommandHistoryController.reset(),
            Hn.processCommand(e, t);
        }
        function i(t, n, r) {
          var i = v.keyName(t),
            s;
          if (i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[")
            tt.exCommandHistoryController.pushInput(n),
              tt.exCommandHistoryController.reset(),
              v.e_stop(t),
              ot(e),
              r(),
          ...
          i == "Up" || i == "Down"
            ? ((s = i == "Up" ? !0 : !1),
              (n = tt.exCommandHistoryController.nextMatch(n, s) || ""),
              r(n))
            : i != "Left" &&
              i != "Right" &&
              i != "Ctrl" &&
        ...
        n.type == "keyToEx"
          ? Hn.processCommand(e, n.exArgs.input)
          : t.visualMode
          ? xn(e, {
              onClose: r,
              prefix: ":",
      ...
      evalInput: function (e, t) {
        var n = t.inputState,
          ...
          u = n.registerName,
          a = t.sel,
          f = Ct(t.visualMode ? a.head : e.getCursor("head")),
          l = Ct(t.visualMode ? a.anchor : e.getCursor("anchor")),
          c = Ct(f),
          h = Ct(l),
          p,
          d,
        ...
        if (s) {
          ...
          var x, T, N, C, k;
          if (t.visualMode) {
            (x = At(a.head, a.anchor)),
              (T = Ot(a.head, a.anchor)),
              (N = t.visualLine || o.linewise),
              (C = t.visualBlock ? "block" : N ? "line" : "char"),
              (k = zt(e, { anchor: x, head: T }, C));
            if (N) {
              var L = k.ranges;
              if (C == "block")
    ...
    ct = {
        ...
        for (var s = 0; s < n.repeat; s++) {
          ...
          for (var u in r.marks) {
            ...
            var a = r.marks[u].find(),
              f = n.forward ? Lt(a, o) : Lt(o, a);
            if (f) continue;
            if (n.linewise && a.line == o.line) continue;
            var l = kt(o, i),
              c = n.forward ? Mt(o, a, i) : Mt(i, a, o);
            if (l || c) i = a;
          }
        }
      ...
      moveByLines: function (e, t, n, r) {
        ...
        return (
          l && (n.forward ? (u = l.end.row + 1) : (u = l.start.row - 1)),
          n.toFirstChar && ((s = Jt(e.getLine(u))), (r.lastHPos = s)),
          (r.lastHSPos = e.charCoords(w(u, s), "div").left),
          w(u, s)
        );
      },
      ...
      moveTillCharacter: function (e, t, n) {
        var r = n.repeat,
          i = rn(e, r, n.forward, n.selectedCharacter),
          s = n.forward ? -1 : 1;
      ...
      moveToEol: function (e, t, n, r) {
        var i = t;
        r.lastHPos = Infinity;
        var s = w(i.line + n.repeat - 1, Infinity),
          o = e.clipPos(s);
      ...
      repeatLastCharacterSearch: function (e, t, n) {
        var r = tt.lastChararacterSearch,
          i = n.repeat,
    ...
    dt = {
      change: function (e, t, n) {
        ...
        if (!s.visualMode) {
          ...
          e.replaceRange("", o, u),
            t.linewise && !f && (v.commands.newlineAndIndent(e), (o.ch = null)),
            (r = o);
        } else {
          i = e.getSelection();
          var l = pt("", n.length);
        ...
        tt.registerController.pushText(
          t.registerName,
          "change",
          i,
          t.linewise,
          ...
          mt.enterInsertMode(e, { head: r }, e.state.vim);
      },
      delete: function (e, t, n) {
        ...
        if (!s.visualBlock) {
          ...
          t.linewise &&
            ...
            (o.line == e.firstLine()
              ? (o.ch = 0)
              : (o = w(o.line - 1, _t(e, o.line - 1)))),
            (i = e.getRange(o, u)),
            e.replaceRange("", o, u),
            (r = o),
            t.linewise && (r = ct.moveToFirstNonWhiteSpaceCharacter(e, o));
        } else {
          i = e.getSelection();
          var a = pt("", n.length);
      ...
      changeCase: function (e, t, n, r, i) {
        ...
        return (
          ...
          t.shouldMoveCursor
            ...
            ? ct.moveToFirstNonWhiteSpaceCharacter(e, r)
            : t.linewise
            ? r
            : At(n[0].anchor, n[0].head)
        );
      },
      yank: function (e, t, n, r) {
        var i = e.state.vim,
          s = e.getSelection(),
          o = i.visualMode
            ? At(i.sel.anchor, i.sel.head, n[0].head, n[0].anchor)
            : r;
        return (
          tt.registerController.pushText(
            t.registerName,
    ...
    mt = {
      ...
      enterInsertMode: function (e, t, n) {
        ...
        e.setOption("keyMap", "vim-insert"),
          ...
          tt.macroModeState.isPlaying ||
            (e.on("change", Wn), v.on(e.getInputField(), "keydown", Kn)),
          n.visualMode && Xt(e),
          jt(e, s, o);
      },
      ...
      joinLines: function (e, t, n) {
        ...
        for (var a = r.line; a < i.line; a++) {
          u = _t(e, r.line);
          var s = w(r.line + 1, _t(e, r.line + 1)),
            f = e.getRange(r, s);
      ...
      paste: function (e, t, n) {
        var r = Ct(e.getCursor()),
          i = tt.registerController.getRegister(t.registerName),
          s = i.toString();
        if (!s) return;
        if (t.matchIndent) {
        ...
        if (p)
          n.visualMode
            ...
            : t.after
            ? ((s = "\n" + s.slice(0, s.length - 1)), (r.ch = _t(e, r.line)))
            : (r.ch = 0);
        else {
          if (d) {
            s = s.split("\n");
        ...
        if (n.visualMode) {
          ...
          n.lastSelection && (y = n.lastSelection.headMark.find()),
            tt.registerController.unnamedRegister.setText(x),
            d
              ? (e.replaceSelections(N),
                (S = w(E.line + s.length - 1, E.ch)),
                e.setCursor(E),
                Bt(e, S),
              ...
              ? (e.replaceSelections(N),
                e.setCursor(E),
                e.replaceRange(s, E, E),
                (m = E))
              : (e.replaceRange(s, E, S),
                (m = e.posFromIndex(e.indexFromPos(E) + s.length - 1))),
          ...
          e.setCursor(r),
            Bt(e, w(r.line + s.length - 1, r.ch)),
            e.replaceSelections(s),
            (m = r);
        } else
          e.replaceRange(s, r),
            p && t.after
              ? (m = w(r.line + 1, Jt(e.getLine(r.line + 1))))
              : p && !t.after
              ? (m = w(r.line, Jt(e.getLine(r.line))))
              : !p && t.after
              ? ((g = e.indexFromPos(r)),
      ...
      replace: function (e, t, n) {
        ...
        if (r == "\n")
          ...
          n.visualMode
            ? ((i = Lt(u[0].anchor, u[0].head) ? u[0].anchor : u[0].head),
              e.setCursor(i),
              Xt(e, !1))
            : e.setCursor(wt(o, 0, -1));
        }
      },
      incrementNumberToken: function (e, t) {
        ...
        (a = c.toString()),
          ...
          e.setCursor(w(n.line, o + a.length - 1));
      },
  ...
  Dn.prototype = {
    processCommand: function (e, t, n) {
      var r = e.state.vim,
        i = tt.registerController.getRegister(":"),
        s = i.toString();
      r.visualMode && Xt(e);
  ...
  var Pn = {
      ...
      registers: function (e, t) {
        var n = t.args,
          r = tt.registerController.registers,
          i = "----------Registers----------<br><br>";
        if (!n)
          for (var s in r) {
            var o = r[s].toString();
      ...
      substitute: function (e, t) {
        ...
        if (r.length)
          (i = r[0]),
            (s = r[1]),
            s !== undefined &&
              (Q("pcre") ? (s = yn(s)) : (s = gn(s)),
              (tt.lastSubstituteReplacePart = s)),
            (o = r[2] ? r[2].split(" ") : []);
        else if (n && n.length) {
      ...
      delmarks: function (e, t) {
        ...
        var n = e.state.vim,
          r = new v.StringStream(Dt(t.argString));
        while (!r.eol()) {
          r.eatSpace();
          var i = r.pos;
          if (!r.match(/[a-zA-Z]/, !1)) {
    ...
    Hn = new Dn();
  (v.keyMap.vim = { attach: N, detach: T, call: C }),
    ...
    attach: function (e) {
      ...
      (e.state.cm = t),
        ...
        t.on("vim-mode-change", function () {
          if (t.virtualSelectionMode()) return;
          t.ace.renderer.setStyle("normal-mode", !rr(t).insertMode),
    ...
    (mt.aceCommand = function (e, t, n) {
      (e.vimCmd = t),
        e.ace.inVirtualSelectionMode
          ? e.ace.on("beforeEndOperation", sr)
          : sr(null, e.ace);
    }),
