            ...
            function (e, t, n) {
              (function () {
                function x(e) {
                  ...
                  return function (n, r, i, s) {
                    ...
                    var o = !S(n) && m.keys(n),
                      ...
                      a = e > 0 ? 0 : u - 1;
                    return (
                      arguments.length < 3 && ((i = n[o ? o[a] : a]), (a += e)),
                      t(n, r, i, o, a, u)
                    );
                  };
                }
                ...
                function O(e, t) {
                  ...
                  while (n--)
                    (o = A[n]),
                      o in e && e[o] !== i[o] && !m.contains(t, o) && t.push(o);
                }
                var e = this,
                  r = e._,
                  i = Array.prototype,
                ...
                (m.each = m.forEach =
                  ...
                  (m.contains =
                    ...
                    m.include =
                      function (e, t, n) {
                        return (
                          S(e) || (e = m.values(e)),
                          m.indexOf(e, t, typeof n == "number" && n) >= 0
                        );
                      }),
                  ...
                  (m.sample = function (e, t, n) {
                    return t == null || n
                      ? (S(e) || (e = m.values(e)), e[m.random(e.length - 1)])
                ...
                (m.flatten = function (e, t) {
                    ...
                    function (e, t, n, r) {
                      ...
                      for (var o = 0, u = e.length; o < u; o++) {
                        ...
                        t
                          ? ((!o || s !== f) && i.push(a), (s = f))
                          : n
                          ? m.contains(s, f) || (s.push(f), i.push(a))
                  ...
                  (m.unzip = function (e) {
                    var t = (e && m.max(e, "length").length) || 0,
                      n = Array(t);
                ...
                (m.bind = function (e, t) {
                  ...
                  (m.memoize = function (e, t) {
                    var n = function (r) {
                      ...
                      return (
                        m.has(i, s) || (i[s] = e.apply(this, arguments)), i[s]
                      );
                    };
                    return (n.cache = {}), n;
                  }),
                ...
                (m.keys = function (e) {
                  ...
                  (m.extend = b(m.allKeys)),
                  (m.extendOwn = m.assign = b(m.keys)),
                ...
                (m.isEqual = function (e, t) {
                  ...
                  (m.isBoolean = function (e) {
                    return (
                      e === !0 || e === !1 || f.call(e) === "[object Boolean]"
                    );
                  }),
                  (m.isNull = function (e) {
                    return e === null;
                ...
                (m.escape = P(_)),
                  ...
                  (m.result = function (e, t, n) {
                    ...
                    return (
                      r === void 0 && (r = n), m.isFunction(r) ? r.call(e) : r
                    );
                  });
                var H = 0;
            ...
            function (e, t, n) {
              var r = e("underscore"),
                ...
                h = (function () {
                  ...
                  function q() {
                    I(),
                      f.option.es3 || F(N, s.ecmaIdentifiers[5]),
                      f.option.esnext && F(N, s.ecmaIdentifiers[6]),
                      f.option.couch && F(N, s.couch),
                      f.option.qunit && F(N, s.qunit),
                      f.option.rhino && F(N, s.rhino),
                      f.option.shelljs && (F(N, s.shelljs), F(N, s.node)),
                      f.option.typed && F(N, s.typed),
                      f.option.phantom && F(N, s.phantom),
                      f.option.prototypejs && F(N, s.prototypejs),
                      f.option.node && (F(N, s.node), F(N, s.typed)),
                      f.option.devel && F(N, s.devel),
                      f.option.dojo && F(N, s.dojo),
                      f.option.browser && (F(N, s.browser), F(N, s.typed)),
                      f.option.browserify &&
                        (F(N, s.browser), F(N, s.typed), F(N, s.browserify)),
                      f.option.nonstandard && F(N, s.nonstandard),
                      f.option.jasmine && F(N, s.jasmine),
                      f.option.jquery && F(N, s.jquery),
                      f.option.mootools && F(N, s.mootools),
                      f.option.worker && F(N, s.worker),
                      f.option.wsh && F(N, s.wsh),
                      f.option.globalstrict &&
                        f.option.strict !== !1 &&
                        (f.option.strict = !0),
                      f.option.yui && F(N, s.yui),
                      f.option.mocha && F(N, s.mocha),
                  ...
                  function W(e, t, n, r, i, s) {
                    ...
                    return (
                      ...
                      h.errors.push(l),
                      z(),
                      h.errors.length >= f.option.maxerr && R("E043", a, u),
                      l
                    );
                  }
                  ...
                  function K(e, t) {
                    ...
                    n === "exception" &&
                      ...
                      v[e] !== !0 &&
                      !f.option.node &&
                      W("W002", f.tokens.next, e),
                      r.has(v, e) &&
                        !v["(global)"] &&
                        (v[e] === !0
                          ? f.option.latedef &&
                            ((f.option.latedef === !0 &&
                              r.contains([v[e], n], "unction")) ||
                              !r.contains([v[e], n], "unction")) &&
                            W("W003", f.tokens.next, e)
                          : (((!f.option.shadow ||
                              r.contains(
                                ["inner", "outer"],
                                f.option.shadow
                              ...
                              n !== "exception") ||
                              v["(blockscope)"].getlabel(e)) &&
                            W("W004", f.tokens.next, e)),
                      v["(context)"] &&
                        r.has(v["(context)"], e) &&
                        n !== "function" &&
                        f.option.shadow === "outer" &&
                        W("W123", f.tokens.next, e),
                      s
                        ? (v["(blockscope)"].current.add(e, n, f.tokens.curr),
                          v["(blockscope)"].atTop() &&
                            p[e] &&
                            (f.tokens.curr.exported = !0))
                        : (v["(blockscope)"].shadow(e),
                          (v[e] = n),
                          i && (v["(tokens)"][e] = i),
                          $t(v, e, { unused: t.unused || !1 }),
                          v["(global)"]
                            ? ((g[e] = v),
                              r.has(y, e) &&
                                (f.option.latedef &&
                      ...
                      t.forEach(function (t) {
                        ...
                        if (r === "true" || r === "false") {
                          e.type === "jslint"
                            ? ((s = c.renamed[n] || n),
                              (f.option[s] = r === "true"),
                              c.inverted[s] !== undefined &&
                                (f.option[s] = !f.option[s]))
                            : (f.option[n] = r === "true"),
                            n === "newcap" &&
                    ...
                    e &&
                      ...
                      (t
                        ...
                        : (f.tokens.next.type !== "(identifier)" ||
                          ...
                          W("W116", f.tokens.next, e, f.tokens.next.value)),
                      (f.tokens.prev = f.tokens.curr),
                      (f.tokens.curr = f.tokens.next);
                    for (;;) {
                      (f.tokens.next = E.shift() || S.token()),
                        f.tokens.next || R("E041", f.tokens.curr.line);
                      if (
                        f.tokens.next.id === "(end)" ||
                  ...
                  function rt(e, t) {
                    ...
                    f.nameStack.push(),
                      !t &&
                        ...
                        G(0).value === "(" &&
                        (f.option.inMoz(!0) ||
                          W("W118", f.tokens.next, "let expressions"),
                        (o = !0),
                        v["(blockscope)"].stack(),
                        Z("let"),
                        Z("("),
                        f.tokens.prev.fud(),
                        Z(")")),
                      f.tokens.next.id === "(end)" && V("E006", f.tokens.curr);
                    var u =
                      f.option.asi &&
                      f.tokens.prev.line !== it(f.tokens.curr) &&
                      r.contains(["]", ")"], f.tokens.prev.id) &&
                      r.contains(["[", "("], f.tokens.curr.id);
                    u && W("W014", f.tokens.curr, f.tokens.curr.id),
                      Z(),
                      t &&
                        ((v["(verb)"] = f.tokens.curr.value),
                        (f.tokens.curr.beginsStmt = !0));
                    if (t === !0 && f.tokens.curr.fud) n = f.tokens.curr.fud();
                    else {
                      f.tokens.curr.nud
                        ? (n = f.tokens.curr.nud())
                        : V("E030", f.tokens.curr, f.tokens.curr.id);
                      while (
                        (e < f.tokens.next.lbp ||
                        ...
                        (i = f.tokens.curr.value === "Array"),
                          ...
                          i &&
                            f.tokens.curr.id === "(" &&
                            f.tokens.next.id === ")" &&
                            W("W009", f.tokens.curr),
                          s &&
                            f.tokens.curr.id === "(" &&
                            f.tokens.next.id === ")" &&
                            W("W010", f.tokens.curr),
                          n && f.tokens.curr.led
                            ? (n = f.tokens.curr.led(n))
                            : V("E033", f.tokens.curr, f.tokens.curr.id);
                    }
                    return (
                      o && v["(blockscope)"].unstack(), f.nameStack.pop(), n
                    );
                  }
                  function it(e) {
                  ...
                  function ot(e) {
                    (e = e || f.tokens.curr),
                      e.line !== it(f.tokens.next) && W("E022", e, e.value);
                  }
                  function ut(e, t) {
                    e.line !== it(t) &&
                      (f.option.laxcomma ||
                        (at.first && (W("I001"), (at.first = !1)),
                        W("W014", e, t.value)));
                  }
                  function at(e) {
                    (e = e || {}),
                      e.peek
                        ...
                        : (ut(f.tokens.curr, f.tokens.next), Z(","));
                    if (
                      ...
                      switch (f.tokens.next.value) {
                        ...
                        case "with":
                          return (
                            V("E024", f.tokens.next, f.tokens.next.value), !1
                          );
                      }
                          ...
                          : function () {
                              ...
                              if (this.id === "++" || this.id === "--")
                                f.option.plusplus
                                  ? W("W016", this, this.id)
                                  : this.right &&
                                    (!this.right.identifier || B(this.right)) &&
                                    this.right.id !== "." &&
                                    this.right.id !== "[" &&
                                    W("W017", this);
                              return this;
                  ...
                  function bt(e, t, n, r) {
                    ...
                    return (
                      ...
                      (i.led = function (i) {
                        return (
                          r || st(f.tokens.prev, f.tokens.curr),
                          e === "in" && i.id === "!" && W("W018", i, "!"),
                          typeof t == "function"
                            ? t(i, this)
                            : ((this.left = i), (this.right = rt(n)), this)
                        );
                      }),
                      i
                    );
                    ...
                    return (
                      (t.led = function (e) {
                        return (
                          ...
                          (this.left = e),
                          (this.right = Yt({ type: "arrow", loneArg: e })),
                          this
                        );
                      }),
                      t
                      ...
                      typeof t == "function"
                        ...
                        : function (e, t) {
                            ...
                            if (e) {
                              ...
                              N[e.value] === !1 && C[e.value]["(global)"] === !0
                                ? W("W020", e)
                                : e["function"] && W("W021", e, e.value),
                                v[e.value] === "const" && V("E013", e, e.value);
                              if (e.id === ".")
                                return (
                                  e.left
                              ...
                              if (e.identifier && !B(e))
                                return (
                                  v[e.value] === "exception" && W("W022", e),
                                  f.nameStack.set(e),
                                  (t.right = rt(10)),
                                  t
                                );
                              e === f.syntax["function"] &&
                                W("W023", f.tokens.curr);
                            }
                            V("E031", t);
                          },
                      n
                    ...
                    return (
                      ...
                      (r.led =
                        typeof t == "function"
                          ...
                          : function (e) {
                              return (
                                f.option.bitwise && W("W016", this, this.id),
                                (this.left = e),
                                (this.right = rt(n)),
                                this
                              );
                  ...
                  function Ot(e, t, n) {
                    ...
                    return B(r)
                      ? t && f.option.inES5()
                        ...
                        : e && i === "undefined"
                        ? i
                        : (W("W024", f.tokens.curr, f.tokens.curr.id), i)
                      : i;
                  }
                  function Mt(e, t) {
                    var n = Ot(e, t, !1);
                    ...
                    if (f.tokens.next.value === "...") {
                      f.option.esnext ||
                        W("W119", f.tokens.next, "spread/rest operator"),
                        Z();
                      if (mn(f.tokens.next, ["..."])) {
                    ...
                    V("E030", f.tokens.next, f.tokens.next.value),
                      f.tokens.next.id !== ";" && Z();
                  }
                  function _t(e) {
                    var t = 0,
                  ...
                  function Dt() {
                    if (f.tokens.next.id !== ";") {
                      ...
                      f.option.asi ||
                        ((!f.option.lastsemic ||
                          f.tokens.next.id !== "}" ||
                          it(f.tokens.next) !== f.tokens.curr.line) &&
                          X(
                            "W033",
                            f.tokens.curr.line,
                  ...
                  function Pt() {
                    ...
                    if (
                      ...
                      f.option.inESNext() || W("W119", f.tokens.curr, "module"),
                        Z("module");
                      var s = Mt();
                      K(s, { type: "unused", token: f.tokens.curr }),
                        Z("from"),
                        Z("(string)"),
                        Dt();
                      return;
                    ...
                    r.identifier &&
                      ...
                      Z(":"),
                      (C = Object.create(n)),
                      K(r.value, { type: "label" }),
                      !f.tokens.next.labelled &&
                        f.tokens.next.value !== "{" &&
                        W("W028", f.tokens.next, r.value, f.tokens.next.value),
                      (f.tokens.next.label = r.value),
                      (r = f.tokens.next));
                    if (r.id === "{") {
                      var o =
                        v["(verb)"] === "case" && f.tokens.curr.value === ":";
                      jt(!0, !0, !1, !1, o);
                      return;
                    }
                    return (
                    ...
                    while (f.tokens.next.id === "(string)") {
                      ...
                      Z(),
                        f.directive[f.tokens.curr.value] &&
                          W("W034", f.tokens.curr, f.tokens.curr.value),
                  ...
                  function jt(e, t, n, i, s) {
                    ...
                    if (f.tokens.next.id === "{") {
                      ...
                      (v["(nolet)"] = !0),
                        (!t || f.option.curly) &&
                          W("W116", f.tokens.next, "{", f.tokens.next.value),
                  ...
                  function Ft(e) {
                    T &&
                      typeof T[e] != "boolean" &&
                      W("W036", f.tokens.curr, e),
                      typeof x[e] == "number" ? (x[e] += 1) : (x[e] = 1);
                  }
                  function It(e) {
                    var t = e.value,
                      n = Object.getOwnPropertyDescriptor(y, t);
                  ...
                  function Ut() {
                    ...
                    return (
                      f.tokens.next.value !== "for" &&
                        ((t = !0),
                        f.option.inMoz(!0) ||
                          W("W116", f.tokens.next, "for", f.tokens.next.value),
                        v["(comparray)"].setState("use"),
                        (e.right = rt(10))),
                      Z("for"),
                      f.tokens.next.value === "each" &&
                        (Z("each"),
                        f.option.inMoz(!0) ||
                          W("W118", f.tokens.curr, "for each")),
                      Z("("),
                      v["(comparray)"].setState("define"),
                      (e.left = rt(130)),
                      r.contains(["in", "of"], f.tokens.next.value)
                        ? Z()
                        : V("E045", f.tokens.curr),
                      v["(comparray)"].setState("generate"),
                      rt(10),
                      Z(")"),
                      f.tokens.next.value === "if" &&
                        (Z("if"),
                        Z("("),
                        v["(comparray)"].setState("filter"),
                        (e.filter = rt(10)),
                        Z(")")),
                      t ||
                        (v["(comparray)"].setState("use"), (e.right = rt(10))),
                      Z("]"),
                      v["(comparray)"].unstack(),
                      e
                    );
                  ...
                  function zt() {
                    return (
                      (v["(statement)"] && v["(statement)"].type === "class") ||
                      (v["(context)"] && v["(context)"]["(verb)"] === "class")
                    );
                  }
                  function Wt(e) {
                    return (
                  ...
                  function Xt(e) {
                    ...
                    return (
                      ...
                      t
                        ...
                        ? ((t = f.tokens.next.value), n || Z())
                        : f.tokens.next.id === "(number)" &&
                          ((t = f.tokens.next.value.toString()), n || Z()),
                      t === "hasOwnProperty" && W("W001"),
                      t
                    );
                  }
                  function Vt(e) {
                    var t,
                      ...
                      l = e && e.loneArg;
                    if (l && l.identifier === !0)
                      return K(l.value, { type: "unused", token: l }), [l];
                      ...
                      if (r.contains(["{", "["], f.tokens.next.id)) {
                        ...
                        for (o in s)
                          (o = s[o]),
                            o.id &&
                              (n.push(o.id),
                              K(o.id, { type: "unused", token: o.token }));
                      } else {
                        mn(f.tokens.next, ["..."]) && (a = !0), (i = Mt(!0));
                        if (i)
                          n.push(i),
                            K(i, { type: "unused", token: f.tokens.curr });
                        else while (!mn(f.tokens.next, [",", ")"])) Z();
                      }
                      u &&
                        f.tokens.next.id !== "=" &&
                        V("E051", f.tokens.current),
                        f.tokens.next.id === "=" &&
                          (f.option.inESNext() ||
                            W("W119", f.tokens.next, "default parameters"),
                          Z("="),
                          (u = !0),
                          rt(10));
                  ...
                  function Yt(e) {
                    ...
                    return (
                      ...
                      (C = Object.create(C)),
                      (v = Kt(n || f.nameStack.infer(), f.tokens.next, C, {
                        "(statement)": i,
                        "(context)": v,
                        "(generator)": o,
                      })),
                      (t = v),
                      (f.tokens.curr.funct = v),
                      m.push(v),
                      n && K(n, { type: "function" }),
                      s && K(s, { type: "function" }),
                      (v["(params)"] = Vt(e)),
                      v["(metrics)"].verifyMaxParametersPerFunction(
                        v["(params)"]
                      ),
                      u &&
                        (f.option.esnext ||
                      ...
                      !f.option.noyield &&
                        o &&
                        v["(generator)"] !== "yielded" &&
                        W("W124", f.tokens.curr),
                      v["(metrics)"].verifyMaxStatementsPerFunction(),
                      v["(metrics)"].verifyMaxComplexityPerFunction(),
                      (v["(unusedOption)"] = f.option.unused),
                      (C = c),
                      (f.option = a),
                      (f.ignored = l),
                      (v["(last)"] = f.tokens.curr.line),
                      (v["(lastcharacter)"] = f.tokens.curr.character),
                      r.map(Object.keys(v), function (e) {
                        if (e[0] === "(") return;
                    ...
                    return {
                      ...
                      verifyMaxNestedBlockDepthPerFunction: function () {
                        f.option.maxdepth &&
                          ...
                          W("W073", null, this.nestedBlockDepth);
                      },
                  ...
                  function rn() {
                    var e,
                      ...
                      n = [];
                    f.option.inESNext() ||
                      W("W104", f.tokens.curr, "destructuring expression");
                    var r = function () {
                      var e;
                      if (mn(f.tokens.next, ["[", "{"])) {
                        t = rn();
                    ...
                    r.zip(e, Array.isArray(n) ? n : [n]).forEach(function (e) {
                      ...
                      t && n
                        ...
                        : t &&
                          t.first &&
                          !n &&
                          W("W080", t.first, t.first.value);
                    });
                  }
                  function fn(e) {
                    return (
                      f.option.inESNext() || W("W104", f.tokens.curr, "class"),
                      e
                        ? ((this.name = Mt()),
                          K(this.name, {
                            type: "unused",
                  ...
                  function cn(e) {
                    ...
                    for (var a = 0; f.tokens.next.id !== "}"; ++a) {
                        ...
                        if (t.identifier && t.value === "static") {
                          ...
                          if (Wt(f.tokens.next) || f.tokens.next.id === "[")
                            (u = f.tokens.next.id === "["),
                              (n = !0),
                              (t = f.tokens.next),
                              f.tokens.next.id === "[" ? (t = vn()) : Z();
                        }
                        t.identifier &&
                          (t.value === "get" || t.value === "set") &&
                          (Wt(f.tokens.next) || f.tokens.next.id === "[") &&
                          ((u = f.tokens.next.id === "["),
                          (i = t),
                          (t = f.tokens.next),
                          f.tokens.next.id === "[" ? (t = vn()) : Z());
                      ...
                      u ||
                        (i
                          ? dn(i.value, n ? o : s, t.value, t, !0, n)
                          : (t.value === "constructor"
                              ? f.nameStack.set(e)
                              : f.nameStack.set(t),
                            pn(n ? o : s, t.value, t, !0, n)));
                      if (i && t.value === "constructor") {
                        ...
                        t.value === "prototype" &&
                          V("E049", t, "class method", "prototype");
                      Xt(t),
                        Yt({
                          statement: e,
                  ...
                  function vn() {
                    Z("["),
                      f.option.esnext ||
                        W("W119", f.tokens.curr, "computed property names");
                    var e = rt(10);
                    return Z("]"), e;
                  }
                  function mn(e, t) {
                  ...
                  function gn() {
                    ...
                    e.notJson
                      ? (!f.option.inESNext() &&
                          e.isDestAssign &&
                          W("W104", f.tokens.curr, "destructuring assignment"),
                        Ht())
                      : ((f.option.laxbreak = !0), (f.jsonMode = !0), bn());
                  }
                  function bn() {
                    function e() {
                      var e = {},
                      ...
                      if (f.tokens.next.id !== "}")
                        for (;;) {
                          if (f.tokens.next.id === "(end)")
                            ...
                            f.tokens.next.id === ","
                              ? V("E028", f.tokens.next)
                              : f.tokens.next.id !== "(string)" &&
                                W("W095", f.tokens.next, f.tokens.next.value);
                          }
                          e[f.tokens.next.value] === !0
                            ...
                            : (f.tokens.next.value === "__proto__" &&
                              ...
                              (f.tokens.next.value === "__iterator__" &&
                                !f.option.iterator)
                            ? W("W096", f.tokens.next, f.tokens.next.value)
                            : (e[f.tokens.next.value] = !0),
                            Z(),
                            Z(":"),
                            bn();
                  ...
                  (f.syntax["(template)"] = r.extend(
                    { type: "(template)", nud: Gt, led: Gt, noSubst: !1 },
                    qt
                  )),
                  ...
                  bt(
                    ...
                    kt("<<", "shiftleft", 120),
                    kt(">>", "shiftright", 120),
                    kt(">>>", "shiftrightunsigned", 120),
                    bt("in", "in", 120),
                    bt("instanceof", "instanceof", 120),
                    bt(
                      "+",
                      function (e, t) {
                        var n;
                    ...
                    dt("...", function () {
                      return (
                        f.option.esnext ||
                          W("W119", this, "spread/rest operator"),
                        !f.tokens.next.identifier &&
                    ...
                    dt("!", function () {
                      return (
                        (this.arity = "unary"),
                        (this.right = rt(150)),
                        this.right || R("E041", this.line || 0),
                        t[this.right.id] === !0 && W("W018", this, "!"),
                        this
                      );
                    }),
                    dt("typeof", function () {
                            ...
                            default:
                              e.id !== "function" &&
                                ...
                                f.option.newcap &&
                                  (t < "A" || t > "Z") &&
                                  !r.has(g, e.value) &&
                                  W("W055", f.tokens.curr));
                          }
                        } else
                          e.id !== "." &&
                            e.id !== "[" &&
                            e.id !== "(" &&
                            W("W056", f.tokens.curr);
                      else f.option.supernew || W("W057", this);
                      return (
                        f.tokens.next.id !== "(" &&
                          !f.option.supernew &&
                          W("W058", f.tokens.curr, f.tokens.curr.value),
                        (this.first = e),
                        this
                      );
                    }),
                    ...
                    (bt(
                      ...
                      function (e, t) {
                        ...
                        e &&
                          ...
                          "Number String Boolean Date Object Error Symbol".indexOf(
                            e.value
                          ) === -1 &&
                          (e.value === "Math"
                            ? W("W063", e)
                            : f.option.newcap && W("W064", e));
                        if (f.tokens.next.id !== ")")
                          for (;;) {
                    ...
                    dt("(", function () {
                      ...
                      if (e.value === "=>")
                        return Yt({ type: "arrow", parsedOpening: !0 });
                      var h = [];
                      if (f.tokens.next.id !== ")")
                        for (;;) {
                          h.push(rt(10));
                    ...
                    dt("[", function () {
                      ...
                      if (e.isCompArray)
                        return (
                          f.option.inESNext() ||
                            W("W119", f.tokens.curr, "array comprehension"),
                          Ut()
                        );
                      e.isDestAssign &&
                        !f.option.inESNext() &&
                      ...
                      (this.first = []),
                        t &&
                          ((w += f.option.indent),
                          f.tokens.next.from === w + f.option.indent &&
                            (w += f.option.indent));
                    ...
                    (function (e) {
                      (e.nud = function () {
                        var e,
                          ...
                          o,
                          u = {};
                        (e = f.tokens.curr.line !== it(f.tokens.next)),
                          e &&
                            ((w += f.option.indent),
                            f.tokens.next.from === w + f.option.indent &&
                              (w += f.option.indent));
                        for (;;) {
                          ...
                          if (G().id === ":" || (o !== "get" && o !== "set")) {
                            f.tokens.next.value === "*" &&
                              ...
                              (f.option.inESNext() ||
                                W("W104", f.tokens.next, "generator functions"),
                              Z("*"),
                              (s = !0));
                            if (
                              !f.tokens.next.identifier ||
                              ...
                              if (f.tokens.next.id === "[")
                                ...
                                f.nameStack.set(f.tokens.next),
                                  (n = Xt()),
                                  pn(u, n, f.tokens.next);
                                if (typeof n != "string") break;
                              }
                              f.tokens.next.value === "("
                                ? (f.option.inESNext() ||
                                    W("W104", f.tokens.curr, "concise methods"),
                                  Yt({ type: s ? "generator" : null }))
                                : (Z(":"), rt(10));
                            } else
                              f.option.inESNext() ||
                                W(
                            ...
                            Z(o),
                              f.option.inES5() || V("E034"),
                              (n = Xt()),
                              !n && !f.option.inESNext() && V("E035"),
                              n && dn(o, u, n, f.tokens.curr),
                              (i = f.tokens.next),
                              (t = Yt()),
                              (r = t["(params)"]),
                              o === "get" && n && r
                        ...
                        return (
                          e && (w -= f.option.indent), Z("}", this), nn(u), this
                        );
                      }),
                        (e.fud = function () {
                  ...
                  var on = ct("const", function (e) {
                    var t = e && e.prefix,
                      ...
                      s,
                      o;
                    f.option.inESNext() || W("W104", f.tokens.curr, "const"),
                      (this.first = []);
                    for (;;) {
                      var u = [];
                      r.contains(["{", "["], f.tokens.next.value)
                        ? ((i = rn()), (o = !1))
                        : ((i = [{ id: Mt(), token: f.tokens.curr }]),
                          (o = !0),
                          n &&
                            ((p[f.tokens.curr.value] = !0),
                            (f.tokens.curr.exported = !0)));
                      for (var a in i)
                        i.hasOwnProperty(a) &&
                          ((a = i[a]),
                          v[a.id] === "const" && W("E011", null, a.id),
                          v["(global)"] &&
                            N[a.id] === !1 &&
                            W("W079", a.token, a.id),
                          a.id &&
                            ...
                            u.push(a.token)));
                      if (t) break;
                      (this.first = this.first.concat(u)),
                        f.tokens.next.id !== "=" &&
                          W("E012", f.tokens.curr, f.tokens.curr.value),
                        f.tokens.next.id === "=" &&
                          (Z("="),
                          f.tokens.next.id === "undefined" &&
                            W("W080", f.tokens.prev, f.tokens.prev.value),
                          G(0).id === "=" &&
                            f.tokens.next.identifier &&
                            W("W120", f.tokens.next, f.tokens.next.value),
                          (s = rt(10)),
                          o ? (i[0].first = s) : sn(u, s));
                      if (f.tokens.next.id !== ",") break;
                      at();
                    }
                    return this;
                          ...
                          v["(global)"] &&
                            (N[l.id] === !1
                              ...
                              : f.option.futurehostile === !1 &&
                                ...
                                W("W129", l.token, l.id)),
                          l.id &&
                            (K(l.id, { type: "unused", token: l.token }),
                            a.push(l.token)));
                      if (t) break;
                      (this.first = this.first.concat(a)),
                        f.tokens.next.id === "=" &&
                          ...
                          G(0).id === "=" &&
                            f.tokens.next.identifier &&
                            (!v["(params)"] ||
                              v["(params)"].indexOf(f.tokens.next.value) ===
                                -1) &&
                            W("W120", f.tokens.next, f.tokens.next.value),
                          (u = rt(10)),
                          o ? (i[0].first = u) : sn(a, u));
                      if (f.tokens.next.id !== ",") break;
                      at();
                    }
                    return this;
                  ...
                  var an = ct("let", function (e) {
                    var t = e && e.prefix,
                      ...
                      o,
                      u;
                    f.option.inESNext() || W("W104", f.tokens.curr, "let"),
                      f.tokens.next.value === "("
                        ? (f.option.inMoz(!0) ||
                            W("W118", f.tokens.next, "let block"),
                          Z("("),
                          v["(blockscope)"].stack(),
                          (u = !0))
                        : v["(nolet)"] && V("E048", f.tokens.curr),
                      (this.first = []);
                    for (;;) {
                      var a = [];
                      r.contains(["{", "["], f.tokens.next.value)
                        ? ((i = rn()), (s = !1))
                        : ((i = [{ id: Mt(), token: f.tokens.curr.value }]),
                          (s = !0),
                          n &&
                            ((p[f.tokens.curr.value] = !0),
                            (f.tokens.curr.exported = !0)));
                  ...
                  (an.exps = !0),
                    ...
                    ht("function", function () {
                      ...
                      f.tokens.next.value === "*" &&
                        ...
                        f.option.inESNext(!0)
                          ? (e = !0)
                          : W("W119", f.tokens.curr, "function*")),
                        b && W("W082", f.tokens.curr);
                      var t = Ot();
                      return (
                        t === undefined && W("W025"),
                        v[t] === "const" && W("E011", null, t),
                        K(t, { type: "unction", token: f.tokens.curr }),
                        Yt({
                          name: t,
                          statement: this,
                    ...
                    dt("function", function () {
                      ...
                      f.tokens.next.value === "*" &&
                        ...
                        (e = !0));
                      var t = Ot(),
                        n = Yt({ name: t, type: e ? "generator" : null });
                      return (
                        !f.option.loopfunc &&
                          v["(loopage)"] &&
                          r.some(n, function (e, t) {
                            return i(t) && !s(t);
                          }) &&
                          W("W083"),
                        this
                    ...
                    ht("try", function () {
                      function t() {
                        ...
                        Z("catch"),
                          ...
                          f.tokens.next.type !== "(identifier)" &&
                            ((t = null), W("E030", f.tokens.next, t)),
                          Z(),
                          (v = Kt("(catch)", f.tokens.next, C, {
                            "(context)": v,
                            "(breakage)": v["(breakage)"],
                            "(loopage)": v["(loopage)"],
                            "(statement)": !1,
                          ...
                          t && K(t, { type: "exception" }),
                          f.tokens.next.value === "if" &&
                            (f.option.inMoz(!0) ||
                              W("W118", f.tokens.curr, "catch filter"),
                            Z("if"),
                            rt(0)),
                          Z(")"),
                          (f.tokens.curr.funct = v),
                      ...
                      while (f.tokens.next.id === "catch")
                        en(),
                          e &&
                            !f.option.inMoz(!0) &&
                            W("W118", f.tokens.next, "multiple catch blocks"),
                          t(),
                          (e = !0);
                    ...
                    ht("with", function () {
                      ...
                      return (
                        f.directive["use strict"]
                          ? V("E010", f.tokens.curr)
                          : f.option.withstmt || W("W085", f.tokens.curr),
                        Z("("),
                        rt(0),
                        Z(")", e),
                        jt(!0, !0),
                          ...
                          case "case":
                            switch (v["(verb)"]) {
                              ...
                              default:
                                ...
                                ) || W("W086", f.tokens.curr, "case");
                            }
                            Z("case"),
                              this.cases.push(rt(0)),
                              en(),
                              (t = !0),
                              Z(":"),
                              (v["(verb)"] = "case");
                    ...
                    (ht("for", function () {
                      ...
                      if (r.contains(u, s.value)) {
                        ...
                        if (f.tokens.next.id === "var")
                          ...
                          switch (v[f.tokens.next.value]) {
                            ...
                            default:
                              ...
                              !v["(blockscope)"].getlabel(a) &&
                                !(C[a] || {})[a] &&
                                W("W088", f.tokens.next, f.tokens.next.value);
                          }
                          Z();
                        }
                        Z(s.value),
                        ...
                        ot(f.tokens.curr),
                          Z(";"),
                          f.tokens.next.id !== ";" && tn(rt(0)),
                          ot(f.tokens.curr),
                          Z(";"),
                          f.tokens.next.id === ";" &&
                            V("E021", f.tokens.next, ")", ";");
                        if (f.tokens.next.id !== ")")
                          for (;;) {
                            rt(0, "for");
                            if (f.tokens.next.id !== ",") break;
                    ...
                    (ct("break", function () {
                      ...
                      return (
                        v["(breakage)"] === 0 &&
                          W("W052", f.tokens.next, this.value),
                        f.option.asi || ot(this),
                        f.tokens.next.id !== ";" &&
                          !f.tokens.next.reach &&
                          f.tokens.curr.line === it(f.tokens.next) &&
                          (v[e] !== "label"
                            ? W("W090", f.tokens.next, e)
                            : C[e] !== v && W("W091", f.tokens.next, e),
                        ...
                        this.line === it(f.tokens.next)
                          ? f.tokens.next.id !== ";" &&
                            ...
                            this.first &&
                              ...
                              !this.first.paren &&
                              !f.option.boss &&
                              X("W093", this.first.line, this.first.character))
                          : f.tokens.next.type === "(punctuator)" &&
                    ...
                    (function (e) {
                      ...
                      dt("yield", function () {
                        var e = f.tokens.prev;
                        f.option.inESNext(!0) && !v["(generator)"]
                          ? ("(catch)" !== v["(name)"] ||
                              !v["(context)"]["(generator)"]) &&
                            V("E046", f.tokens.curr, "yield")
                          : f.option.inESNext() ||
                            W("W104", f.tokens.curr, "yield"),
                          (v["(generator)"] = "yielded");
                        var t = !1;
                        ...
                        if (
                          ...
                          if (
                            ...
                            st(f.tokens.curr, f.tokens.next),
                              (this.first = rt(10)),
                              this.first.type === "(punctuator)" &&
                                this.first.value === "=" &&
                                !this.first.paren &&
                        ...
                        for (;;) {
                          ...
                          f.tokens.next.type === "default"
                            ...
                            f.tokens.next.value === "as" &&
                              (Z("as"), (e = Mt())),
                            K(e, { type: "unused", token: f.tokens.curr });
                          if (f.tokens.next.value !== ",") {
                            if (f.tokens.next.value === "}") {
                              Z("}");
                              break;
                    ...
                    (ct("export", function () {
                      var e = !0,
                        ...
                        n;
                      f.option.inESNext() ||
                        (W("W119", f.tokens.curr, "export"), (e = !1));
                      ...
                      if (f.tokens.next.value === "{") {
                        ...
                        for (;;) {
                          f.tokens.next.identifier ||
                            V("E030", f.tokens.next, f.tokens.next.value),
                            Z(),
                            (f.tokens.curr.exported = e),
                            r.push(f.tokens.curr),
                            f.tokens.next.value === "as" &&
                              (Z("as"),
                              f.tokens.next.identifier ||
                                V("E030", f.tokens.next, f.tokens.next.value),
                          ...
                          f.tokens.next.value === "from"
                            ...
                            : e &&
                              r.forEach(function (e) {
                                v[e.value] || U(v, "W117", e, e.value),
                                  (p[e.value] = !0),
                                  v["(blockscope)"].setExported(e.value);
                              }),
                          this
                        );
                      }
                      return (
                        f.tokens.next.id === "var"
                          ? (Z("var"), f.tokens.curr.fud({ inexport: !0 }))
                          : f.tokens.next.id === "let"
                          ? (Z("let"), f.tokens.curr.fud({ inexport: !0 }))
                          : f.tokens.next.id === "const"
                          ? (Z("const"), f.tokens.curr.fud({ inexport: !0 }))
                          : f.tokens.next.id === "function"
                          ? ((this.block = !0),
                            Z("function"),
                            (p[f.tokens.next.value] = e),
                            (f.tokens.next.exported = !0),
                    ...
                    gt("float"),
                    gt("goto"),
                    gt("implements", { es5: !0, strictOnly: !0 }),
                    gt("import", { es5: !0 }),
                    gt("int"),
                    gt("interface", { es5: !0, strictOnly: !0 }),
                    gt("long"),
                    gt("native"),
                    gt("package", { es5: !0, strictOnly: !0 }),
                    gt("private", { es5: !0, strictOnly: !0 }),
                    gt("protected", { es5: !0, strictOnly: !0 }),
                    gt("public", { es5: !0, strictOnly: !0 }),
                    gt("short"),
                    gt("static", { es5: !0, strictOnly: !0 }),
                    gt("super", { es5: !0 }),
                    gt("synchronized"),
                    gt("transient"),
                    gt("volatile");
                      ...
                      return {
                        ...
                        unstack: function () {
                          n.variables.filter(function (e) {
                            e.unused &&
                              W("W098", e.token, e.raw_text || e.value),
                              e.undef && U(e.funct, "W117", e.token, e.value);
                          }),
                            t.splice(-1, 1),
                            (n = t[t.length - 1]);
                        },
                        ...
                        check: function (e) {
                          ...
                          return n && n.mode === "use"
                            ...
                            ? (i(e) ||
                              ...
                              !0)
                            : n && n.mode === "generate"
                            ? (U(v, "W117", f.tokens.curr, e), !0)
                            : n && n.mode === "filter"
                            ? (s(e) && U(v, "W117", f.tokens.curr, e), !0)
                            : !1;
                        },
                      };
                    },
                    ...
                    Sn = function (t, i, o) {
                      ...
                      try {
                        ...
                        var V = function (e, t) {
                          ...
                          K = function (e, t, n, r) {
                            ...
                            r &&
                              u[r] &&
                              u[r].indexOf(n) !== -1 &&
                              (t.exported || X("W098", i, s, o)),
                              L.push({ name: e, line: i, character: s });
                          },
                          Q = function (e, t) {
                            var n = e[t],
                              i = e["(tokens)"][t];
                        ...
                        for (a = 0; a < h.undefs.length; a += 1)
                          (l = h.undefs[a].slice(0)),
                            V(l[2].value, l[0]) || l[2].forgiveUndef
                              ? J(l[2].value, l[2].line)
                              : f.option.undef && W.apply(W, l.slice(1));
                  ...
                  return (
                    (Sn.addModule = function (e) {
                      O.push(e);
                    }),
                    Sn.addModule(l.register),
                    (Sn.data = function () {
                      var e = { functions: [], options: f.option },
                        ...
                        a,
                        l;
                      Sn.errors.length && (e.errors = Sn.errors),
                        f.jsonMode && (e.json = !0);
                      for (a in y)
                        r.has(y, a) && t.push({ name: a, line: y[a] });
