 ...
 */ var aight = (function () {
  var e = navigator.appName,
    ...
    n = e == "Microsoft Internet Explorer";
  if (n) {
    var r = navigator.userAgent.match(/MSIE ([0-9]{1,}[\.0-9]{0,})/);
    t = r ? parseFloat(r[1]) : 0;
  }
  return {
    browser: {
      name: e,
...
typeof document != "undefined" &&
  ...
  (function (e) {
    ...
    if (i.defineProperty) {
      ...
      try {
        ...
        p.number === -2146823252 &&
          ((h.enumerable = !1), i.defineProperty(r, t, h));
      }
  ...
  (function (e) {
        ...
        var i = r.call(arguments, 1),
          s = function () {
            if (this instanceof s) {
              ...
              var o = new e(),
                u = n.apply(o, i.concat(r.call(arguments)));
              return Object(u) === u ? u : o;
            }
    ...
    var e = Function.prototype.call,
      ...
      r = t.slice,
      i = e.bind(n.toString),
      s = e.bind(n.hasOwnProperty),
      o,
      u,
      a,
      f,
      l;
    if ((l = s(n, "__defineGetter__")))
      (o = e.bind(n.__defineGetter__)),
        (u = e.bind(n.__defineSetter__)),
        (a = e.bind(n.__lookupGetter__)),
        (f = e.bind(n.__lookupSetter__));
    Array.isArray ||
      (Array.isArray = function (t) {
        return i(t) == "[object Array]";
      }),
      Array.prototype.forEach ||
        (Array.prototype.forEach = function (t) {
          var n = A(this),
            ...
            s = -1,
            o = n.length >>> 0;
          if (i(t) != "[object Function]") throw new TypeError();
          while (++s < o) s in n && t.call(r, n[s], s, n);
        }),
      Array.prototype.map ||
        (Array.prototype.map = function (t) {
          var n = A(this),
            ...
            s = Array(r),
            o = arguments[1];
          if (i(t) != "[object Function]")
            throw new TypeError(t + " is not a function");
          for (var u = 0; u < r; u++) u in n && (s[u] = t.call(o, n[u], u, n));
          return s;
        }),
      Array.prototype.filter ||
        (Array.prototype.filter = function (t) {
          ...
          if (i(t) != "[object Function]")
            throw new TypeError(t + " is not a function");
          for (var a = 0; a < r; a++)
            a in n && ((o = n[a]), t.call(u, o, a, n) && s.push(o));
          return s;
        }),
      Array.prototype.every ||
        (Array.prototype.every = function (t) {
          ...
          if (i(t) != "[object Function]")
            throw new TypeError(t + " is not a function");
          for (var o = 0; o < r; o++)
            if (o in n && !t.call(s, n[o], o, n)) return !1;
          return !0;
        }),
      Array.prototype.some ||
        (Array.prototype.some = function (t) {
          ...
          if (i(t) != "[object Function]")
            throw new TypeError(t + " is not a function");
          for (var o = 0; o < r; o++)
            if (o in n && t.call(s, n[o], o, n)) return !0;
          return !1;
        }),
      Array.prototype.reduce ||
        (Array.prototype.reduce = function (t) {
          ...
          for (; s < r; s++) s in n && (o = t.call(void 0, o, n[s], s, n));
          return o;
        }),
      Array.prototype.reduceRight ||
        (Array.prototype.reduceRight = function (t) {
          ...
          do o in this && (s = t.call(void 0, s, n[o], o, n));
          while (o--);
          return s;
        }),
      Array.prototype.indexOf ||
        (Array.prototype.indexOf = function (t) {
          ...
          if (!r) return -1;
          var i = 0;
          arguments.length > 1 && (i = k(arguments[1])),
      ...
      Array.prototype.lastIndexOf ||
        (Array.prototype.lastIndexOf = function (t) {
          ...
          if (!r) return -1;
          var i = r - 1;
          arguments.length > 1 && (i = Math.min(i, k(arguments[1]))),
      ...
      Object.getPrototypeOf ||
        (Object.getPrototypeOf = function (t) {
          return t.__proto__ || (t.constructor ? t.constructor.prototype : n);
        });
      ...
      Object.getOwnPropertyDescriptor = function (t, r) {
        ...
        if (l) {
          ...
          var u = a(t, r),
            h = f(t, r);
          t.__proto__ = o;
          if (u || h) return u && (i.get = u), h && (i.set = h), i;
        }
        return (i.value = t[r]), i;
      };
    }
    ...
    if (Object.defineProperty) {
      var p = h({}),
        d = typeof document == "undefined" || h(document.createElement("div"));
      if (!p || !d) var v = Object.defineProperty;
    }
    if (!Object.defineProperty || v) {
      var m = "Property description must be an object: ",
        g = "Object.defineProperty called on non-object: ",
        y = "getters & setters can not be defined on this javascript engine";
      Object.defineProperty = function (t, r, i) {
        if ((typeof t != "object" && typeof t != "function") || t === null)
          throw new TypeError(g + t);
        if ((typeof i != "object" && typeof i != "function") || i === null)
          throw new TypeError(m + i);
        if (v)
          try {
            return v.call(Object, t, r, i);
          } catch (c) {}
        if (s(i, "value"))
          if (l && (a(t, r) || f(t, r))) {
            var h = t.__proto__;
            (t.__proto__ = n), delete t[r], (t[r] = i.value), (t.__proto__ = h);
          } else t[r] = i.value;
        else {
          if (!l) throw new TypeError(y);
          s(i, "get") && o(t, r, i.get), s(i, "set") && u(t, r, i.set);
        }
        return t;
      };
    }
    Object.defineProperties ||
      (Object.defineProperties = function (t, n) {
        for (var r in n)
          s(n, r) && r != "__proto__" && Object.defineProperty(t, r, n[r]);
        return t;
      }),
      Object.seal ||
    ...
    if (!Object.keys) {
      var w = !0,
        ...
        S = E.length;
      for (var x in { toString: null }) w = !1;
      Object.keys = function O(e) {
        if ((typeof e != "object" && typeof e != "function") || e === null)
          throw new TypeError("Object.keys called on a non-object");
        var O = [];
        for (var t in e) s(e, t) && O.push(t);
        if (w)
          for (var n = 0, r = S; n < r; n++) {
            var i = E[n];
            s(e, i) && O.push(i);
          }
        return O;
    ...
    if (
      ...
      Date.prototype.toISOString = function () {
        ...
        (t = [
          ...
          (i =
            (i < 0 ? "-" : i > 9999 ? "+" : "") +
            ("00000" + Math.abs(i)).slice(0 <= i && i <= 9999 ? -4 : -6)),
          (n = t.length);
        ...
        return (
          ...
          (t.parse = function (r) {
            ...
            if (i) {
              ...
              var l = +i[0];
              return 0 <= l && l <= 99
                ? ((i[0] = l + 400), e.UTC.apply(this, i) + f - 126227808e5)
                : e.UTC.apply(this, i) + f;
            }
    ...
    if (!String.prototype.trim || T.trim()) {
      ...
      String.prototype.trim = function () {
        ...
        return String(this).replace(N, "").replace(C, "");
      };
    }
    var k = function (e) {
        return (
      ...
      A = function (e) {
        ...
        return L && typeof e == "string" && e ? e.split("") : Object(e);
      };
  }),
  ...
  CSSStyleDeclaration.prototype.getProperty ||
    ...
    (CSSStyleDeclaration.prototype.setProperty = function (e, t) {
      return this.setAttribute(String(e), t);
    }),
  ...
  document.createElementNS ||
    (document.createElementNS = function (e, t) {
      if (e) throw "sorry, this browser does not support namespaces";
  ...
  Element.prototype.addEventListener ||
    ((Element.prototype.addEventListener = function (e, t, n) {
      ...
      return (
        (this[e + t] = function () {
          t.call(r, window.event);
        }),
        this.attachEvent("on" + e, this[e + t])
      );
    }),
    (Element.prototype.removeEventListener = function (e, t) {
      this["e" + e + t] = null;
      var n = this.detachEvent("on" + e, this[e + t]);
      return (this[e + t] = null), n;
    })),
