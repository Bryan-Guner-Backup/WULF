      ...
      (u[n] = Error[n]),
        ...
        (l.add = function () {
          var e = arguments,
            ...
            r,
            i = !1;
          do (r = e[t] + ""), a(this, r) === -1 && (this.push(r), (i = !0));
          while (++t < n);
    ...
    (this.getComputedStyle = (function () {
      ...
      function n(n) {
        var r = n.currentStyle,
          i = this,
          s = e(n, r, "fontSize", null);
        for (property in r)
          /width|height|margin.|padding.|border.+W/.test(property) &&
          i[property] !== "auto"
            ? (i[property] = e(n, r, property, s) + "px")
            : property === "styleFloat"
            ? (i["float"] = r[property])
            : (i[property] = r[property]);
        return (
          t(i, "margin"),
          t(i, "padding"),
          t(i, "border"),
