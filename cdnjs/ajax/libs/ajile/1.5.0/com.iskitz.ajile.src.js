...
(function (/*com.iskitz.ajile*/ VERSION, global, undefined) {
  ...
  function cloakModule(moduleName, container) {
    ...
    for (
      ...
      if (
        sys ||
        (moduleName ? (!src && id) || isCloaked || CLOAK : id && module)
      )
  ...
  function cloakObject(obj) {
    if (!obj || !obj.toString || obj === Function || obj === Object) return;
  ...
  function ensureFailSafe(owner, isOn) {
    ...
    if (onLoad != executeFailSafe.onLoad)
      //HACK: Need a set, could have multiple unique onload listeners.
