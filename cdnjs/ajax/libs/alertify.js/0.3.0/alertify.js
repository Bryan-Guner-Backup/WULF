    ...
    _alertify = {
      ...
      build: function (item) {
        ...
        switch (type) {
          case "confirm":
            html = html.replace(
              "{{buttons}}",
              dialogs.buttons.cancel + dialogs.buttons.ok
            );
            html = html
          ...
          case "prompt":
            html = html.replace(
              "{{buttons}}",
              dialogs.buttons.cancel + dialogs.buttons.submit
            );
            html = html
              .replace("{{ok}}", this.labels.ok)
              .replace("{{cancel}}", this.labels.cancel);
        ...
        elDialog.className =
          "alertify alertify-show alertify-" + type + " " + css;
      ...
      setup: function () {
        ...
        if (typeof item.placeholder === "string" && item.placeholder !== "")
          $("alertify-text").value = item.placeholder;
