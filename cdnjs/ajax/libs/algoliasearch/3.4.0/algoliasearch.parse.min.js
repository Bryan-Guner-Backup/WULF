module.exports = (function (e) {
  ...
  function (e, t, r) {
    ...
    function s(e, t) {
      function r() {
        return Date.now() < o + t ? void process.nextTick(r) : void e();
      }
      var o = Date.now();
      process.nextTick(r);
    }
    (e.exports = o), (process.env = {});
    var a = r(2)("algoliasearch:parse"),
      i = r(3),
      c = r(1);
    a("loaded the Parse client"),
      (o.version = r(5)),
      (o.ua = "Algolia for Parse " + o.version),
      i(n, c),
      (n.prototype._request = function (e, t) {
        function o(r) {
          a("error: %j  - %s %j", r, e, t),
            i.resolve({ statusCode: r.status, body: r.data });
        }
        function n(r) {
          a("success: %j  - %s %j", r, e, t),
            i.resolve({ statusCode: r.status, body: r.data });
        }
        var s = r(4),
          i = new Parse.Promise();
  ...
  function (e, t, r) {
    function o(e, t, r) {
      void 0 === r.protocol && (r.protocol = "https:"),
    ...
    var n = r(3),
      s = r(6);
    n(o, s),
      (o.prototype.enableRateLimitForward = function (e, t, r) {
        this._forward = { adminAPIKey: e, endUserIP: t, rateLimitAPIKey: r };
      }),
      (o.prototype.disableRateLimitForward = function () {
        this._forward = null;
      }),
      (o.prototype.useSecuredAPIKey = function (e, t, r) {
        this._secure = { apiKey: e, securityTags: t, userToken: r };
      }),
      (o.prototype.disableSecuredAPIKey = function () {
        this._secure = null;
      }),
      (o.prototype._computeRequestHeaders = function () {
        var e = o.super_.prototype._computeRequestHeaders.call(this);
        return (
          this._forward &&
  ...
  function (e, t, r) {
    function o(e, t, o) {
      ...
      if (!e)
        throw new h.AlgoliaSearchError(
          "Please provide an application ID. " + i
        );
      if (!t) throw new h.AlgoliaSearchError("Please provide an API key. " + i);
      ...
      if (
        ...
        throw new h.AlgoliaSearchError(
          "protocol must be `http:` or `https:` (was `" + o.protocol + "`)"
        );
      o.hosts
        ...
        (this.cache = {}),
        (this._ua = o._ua),
        (this._useCache = void 0 === o._useCache ? !0 : o._useCache),
    ...
    function a() {
      ...
      throw new h.AlgoliaSearchError(e);
    }
    function i(e, t) {
    ...
    (e.exports = o),
      "development" === process.env.APP_ENV && r(2).enable("algoliasearch*");
    var l = r(2)("algoliasearch"),
      d = r(9),
      h = r(8);
    (o.prototype = {
      ...
      listIndexes: function (e, t) {
        var r = "";
        return (
          void 0 === e || "function" == typeof e ? (t = e) : (r = "?page=" + e),
          this._jsonRequest({
            method: "GET",
            url: "/1/indexes" + r,
            hostType: "read",
      ...
      addUserKeyWithValidity: u(function (e, t, r) {
      ...
      updateUserKey: function (e, t, r, o) {
        ...
        return (
          r &&
            ...
            r.queryParameters &&
              (n.queryParameters = this._getSearchParams(
                r.queryParameters,
                ""
              )),
      ...
      addQueryInBatch: u(function (e, t, r) {
            ...
            requests: n(e, function (e) {
              ...
              return (
                  ...
                  (t += "query=" + encodeURIComponent(e.query)),
                {
                  ...
                  params: r._getSearchParams(e.params, t),
                }
              );
            }),
          };
      ...
      _sendQueriesBatch: function (e, t) {
        return this._jsonRequest({
          ...
          fallback: {
            ...
            body: {
              params: (function () {
                for (var t = "", r = 0; r < e.requests.length; ++r) {
                  var o =
                    "/1/indexes/" +
                    encodeURIComponent(e.requests[r].indexName) +
                    "?" +
                    e.requests[r].params;
      ...
      _jsonRequest: function (e) {
        function t(r, c) {
          ...
          function d(o) {
            return (
              n("error: %s, stack: %s", o.message, o.stack),
              o instanceof h.RequestTimeout
                ? (n("timedout"), l())
                : (o instanceof h.AlgoliaSearchError ||
                    (o = new h.Unknown(o && o.message, o)),
                  o instanceof h.Unknown ||
                  o instanceof h.UnparsableJSON ||
                  (!r.fallback && o instanceof h.Network)
                    ? a._promise.reject(o)
                    : (a.useFallback
                        ? ((a.hostIndex[e.hostType] =
                            ++a.hostIndex[e.hostType] %
                            a.hosts[e.hostType].length),
                          (i += 1))
          ...
          return (
            a._useCache && (p = e.url),
            a._useCache && o && (p += "_body_" + c.body),
            a._useCache && s && void 0 !== s[p]
              ? (n("serving response from cache"),
                a._promise.resolve(JSON.parse(JSON.stringify(s[p]))))
              : i >= a.hosts[e.hostType].length
                  ...
                  .then(function (e) {
                    ...
                    var t =
                      ...
                      o =
                        ...
                        4 !== Math.floor(t / 100) &&
                        1 !== Math.floor(t / 100);
                    if ((a._useCache && r && s && (s[p] = e.body), r))
                      return e.body;
                    if (o) return l();
                    var i = new h.AlgoliaSearchError(e.body && e.body.message);
                    return a._promise.reject(i);
                  }, d)
          );
        }
        var o,
          n = r(2)("algoliasearch:" + e.url),
          s = e.cache,
          a = this,
          i = 0,
          u = !1;
        void 0 !== e.body && (o = JSON.stringify(e.body)), n("request start");
        var l = a.useFallback && e.fallback,
          d = l ? e.fallback : e,
          p = t(l ? a._request.fallback : a._request, {
            url: d.url,
            method: d.method,
            body: o,
            jsonBody: e.body,
      ...
      (o.prototype.Index.prototype = {
        clearCache: function () {
          this.cache = {};
        },
        addObject: function (e, t, r) {
          var o = this;
          return (
            (1 === arguments.length || "function" == typeof t) &&
              ((r = t), (t = void 0)),
        ...
        addObjects: function (e, t) {
          for (var r = this, o = { requests: [] }, n = 0; n < e.length; ++n) {
        ...
        deleteObject: function (e, t) {
          if (
            ...
            var r = new h.AlgoliaSearchError(
        ...
        search: function (e, t, r) {
          ...
          var o = "";
          return (
            void 0 !== e && (o += "query=" + encodeURIComponent(e)),
            void 0 !== t && (o = this.as._getSearchParams(t, o)),
            this._search(o, r)
          );
        },
        browse: function (e, t, r) {
          ...
          return (
            ...
            this.as._jsonRequest({
              method: "GET",
              url:
                "/1/indexes/" + encodeURIComponent(o.indexName) + "/browse" + n,
              hostType: "read",
              callback: r,
            })
          );
        ...
        updateUserKey: function (e, t, r, o) {
          ...
          return (
            r &&
              ...
              (n.description = r.description),
              r.queryParameters &&
                (n.queryParameters = this.as._getSearchParams(
                  r.queryParameters,
                  ""
                )),
              (n.referers = r.referers)),
  ...
  function (e, t, r) {
    ...
    function n(e) {
      ...
      function n() {
        ...
        var i = 0;
        (a[0] = a[0].replace(/%([a-z%])/g, function (r, o) {
          if ("%%" === r) return r;
          i++;
          var n = t.formatters[o];
          if ("function" == typeof n) {
            var s = a[i];
            (r = n.call(e, s)), a.splice(i, 1), i--;
          }
          return r;
        })),
    ...
    function s(e) {
      t.save(e);
      for (var r = (e || "").split(/[\s,]+/), o = r.length, n = 0; o > n; n++)
        r[n] &&
          ((e = r[n].replace(/\*/g, ".*?")),
          "-" === e[0]
    ...
    function i(e) {
      var r, o;
      for (r = 0, o = t.skips.length; o > r; r++)
        if (t.skips[r].test(e)) return !1;
      for (r = 0, o = t.names.length; o > r; r++)
  ...
  function (e) {
    ...
    e.exports = function (e, o, n) {
      ...
      var s = e.length;
      if (s === +s) for (var a = 0; s > a; a++) o.call(n, e[a], a, e);
      else for (var i in e) t.call(e, i) && o.call(n, e[i], i, e);
    };
  },
  function (e) {
    function t(e) {
    ...
    e.exports = function (e, n) {
      return (n = n || {}), "string" == typeof e ? t(e) : n.long ? o(e) : r(e);
    };
  },
]);
