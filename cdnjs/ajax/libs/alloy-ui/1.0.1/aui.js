...
(function () {
  ...
  YUI.prototype = {
    ...
    _init: function () {
      ...
      Y.config.loaderPath =
        YUI.config.loaderPath || "loader/loader" + (filter || "-min.") + "js";
    },
      ...
      Y.Get = (function () {
        ...
        var _get,
          ...
          _queue = function (type, url, opts) {
            ...
            q.autopurge =
              "autopurge" in q ? q.autopurge : type === "script" ? true : false;

            q.attributes = q.attributes || {};
            q.attributes.charset =
              opts.charset || q.attributes.charset || "utf-8";
...
(function () {
  ...
  var guidExtensions = function (A) {
    A.Env._guidp = ["aui", A.version, A.Env._yidx]
      .join("-")
      .replace(/\./g, "-");
  };
    ...
    AUI,
    {
      ...
      html5shiv: function (frag) {
        ...
        if (UA.ie && doc && doc.createElement) {
          var elements = AUI.HTML5_ELEMENTS,
  ...
  AUI._uaExtensions = function (A) {
    ...
    UA.version.major = (/([^\.]+)/.exec(UA.version.string) ||
      versionDefaults)[1];
