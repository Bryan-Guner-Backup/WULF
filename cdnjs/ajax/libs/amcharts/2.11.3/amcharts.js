  ...
  draw: function () {
    ...
    if (0 < e || 0 < f)
      (x = s),
        ...
        0 < m &&
          (A = AmCharts.line(b, [0, e, c + e], [d, d + f, d + f], l, m, k));
    1 > Math.abs(d) && (d = 0);
    1 > Math.abs(c) && (c = 0);
    b =
      0 === d
        ...
        : 0 < r
        ? AmCharts.rect(b, c, d, g, h, k, l, m, r, p)
        : AmCharts.polygon(
            b,
            [0, 0, c, c, 0],
            [0, d, d, 0, 0],
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  arrangeEntries: function () {
    ...
    for (t = 0; t < v.length; t++) {
      ...
      var z;
      this.equalWidths
        ? (z = f + y * (r + m + this.markerLabelGap))
        : ((z = x), (x = x + u.width + f + m));
      z + u.width > p &&
        0 < t &&
        0 !== y &&
        (w++, (y = 0), (z = f), (x = z + u.width + f + m), (skipNewRow = !0));
      A.translate(z, (n + l) * w);
      y++;
      !isNaN(k) && y >= k && ((y = 0), w++);
      s.push(A);
  ...
  createEntry: function (a) {
    if (!1 !== a.visibleInLegend) {
      ...
      d &&
        ...
        (p = AmCharts.text(this.container, d, g, b.fontFamily, k, "start")),
  ...
  draw: function () {
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        var y;
        void 0 != m &&
          ((y = AmCharts.text(e, this.text, m, t, w, c, !1, 0.4)), f.push(y));
        t = d.getBBox();
        m = t.height + 2 * p;
        t = t.width + 2 * s;
        window.opera && (m += 2);
...
AmCharts.TrendLine = AmCharts.Class({
  ...
  draw: function () {
    ...
    n &&
      !t &&
      (isNaN(s) || (d = n.getCoordinate(s)),
      isNaN(q) || (e = n.getCoordinate(q)));
    r &&
      !t &&
      (isNaN(v) || (f = r.getCoordinate(v)),
  ...
  draw: function () {
    ...
    if (
      ...
      if (
        ...
        if (0 < y) {
          ...
          for (d = this.fillAlpha = 0; d < y; d++) {
            var A = w[d],
              ...
              H = A.above;
            isNaN(A.toValue) ||
              ((z = this.getCoordinate(A.toValue)),
              (t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, A)),
              this.pushAxisItem(t, H));
            var E = NaN;
            isNaN(A.value) ||
              ((E = this.getCoordinate(A.value)),
              ...
              this.pushAxisItem(t, H));
            isNaN(z - E) ||
              ((t = new this.guideFillRenderer(this, E, z, A)),
              this.pushAxisItem(t, H),
              (t = t.graphics()),
              (A.graphics = t),
        ...
        w = !1;
        for (d = n; d < s; d += r)
          (t = AmCharts.roundTo(this.step * d + this.min, c)),
            -1 != String(t).indexOf("e") && ((w = !0), String(t).split("e"));
        this.duration &&
          (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
        for (d = n; d < s; d += r)
          if (
            ((n = this.step * d + this.min),
            (n = AmCharts.roundTo(n, this.maxDecCount + 1)),
            !this.integersOnly || Math.round(n) == n)
          )
              ...
              w
                ...
                : (h &&
                  ...
                  (t = this.usePrefixes
                    ...
                    : AmCharts.formatNumber(n, u, u.precision)));
              this.duration &&
    ...
    if (AmCharts.ifArray(a)) {
      ...
      if (this.parseDates && !this.equalSpacing) {
        ...
        if (0 < this.gridCount)
          for (b = d; b <= g; b++) {
            ...
            q = !1;
            this.nextPeriod[n] &&
              (q = this.checkPeriodChange(this.nextPeriod[n], 1, a, m));
            t = !1;
            q && this.markPeriodChange
              ? ((m = this.dateFormatsObject[this.nextPeriod[n]]), (t = !0))
              : (m = this.dateFormatsObject[n]);
            u || (t = !1);
          ...
          for (
            ...
            if (
              ...
              "start" == this.gridPosition &&
                ((l -= this.cellWidth / 2), (v = this.cellWidth / 2));
        ...
        if (
          ...
          for (v = 0, w = m, b = l; b < s; b++)
            (a = this.data[b].time),
              this.checkPeriodChange(e, p, a, w) &&
                (v++, 2 <= v && ((l = b), (b = s)), (w = a));
        for (b = l; b < s; b++)
            ...
            r
              ...
              : (u || (t = !1),
                l - this.previousPos >
                  ...
                  this.pushAxisItem(m),
                  (v = v.getBBox().width),
                  AmCharts.isModern || (v -= l),
                  (this.previousPos = l + v)));
            m = a;
          }
      }
      ...
      for (b = 0; b < h; b++)
        (k = this.guides[b]),
          ...
          (d = k.above),
          k.toCategory &&
            ((v = c.getCategoryIndexByValue(k.toCategory)),
            isNaN(v) ||
              ((u = this.getCoordinate(v - f)),
              (m = new this.axisItemRenderer(this, u, "", !0, NaN, NaN, k)),
              this.pushAxisItem(m, d))),
          k.category &&
            ((v = c.getCategoryIndexByValue(k.category)),
            isNaN(v) ||
              ((g = this.getCoordinate(v - f)),
              (v = (u - g) / 2),
          ...
          k.date &&
            ...
            (m =
              "H" == this.orientation
                ? new this.axisItemRenderer(this, g, k.label, !1, 2 * v, NaN, k)
                : new this.axisItemRenderer(this, g, k.label, !1, NaN, v, k)),
            this.pushAxisItem(m, d)),
...
AmCharts.RecAxis = AmCharts.Class({
  construct: function (a) {
    var b = a.chart,
      ...
      r = b.container;
    "H" == a.orientation
      ? ((d = AmCharts.line(r, [0, p], [0, 0], d, e, c)),
  ...
  construct: function (a, b, c, d, e, f, g, h, k) {
    ...
    g
      ? ((H = !0),
        ...
        isNaN(g.lineThickness) || (w = g.lineThickness),
        !0 === g.inside && (K = !0),
    ...
    if ("H" == Fa) {
      if (
        ...
        1 == I &&
          ...
          (ka = d - ha),
          0 < ka &&
            ((fill = AmCharts.rect(r, ka, a.height, A, z)),
        ...
        "bottom" == da
          ...
          : ((B += Q + m / 2 - W),
            ...
            K
              ? 0 < E
                ? ((B = (ga / 2) * Math.sin(Y) + u + 3),
                  (G -= (ga / 2) * Math.cos(Y)))
                : (B += u + 3)
              : 0 < E
              ? ((B = -(ga / 2) * Math.sin(Y) - u - 6),
                (G += (ga / 2) * Math.cos(Y)))
              : (B -= u + m + 3 + s + 3)),
        "bottom" == da
          ? (ka = (K ? T - u - 1 : T + s - 1) + W)
      ...
      0 <= b &&
        ...
        (0 < u &&
          0 < v &&
          b + k <= T + 1 &&
          ((ma = AmCharts.line(r, [0, u], [b + k, b + k], q, v, w)),
          n.push(ma)),
        0 < t &&
          ((X = AmCharts.line(r, [0, S, R + S], [b, b + Q, b + Q], y, t, w, x)),
          n.push(X)));
      X = "end";
  ...
  construct: function (a) {
    ...
    if (b) {
      ...
      for (n = 0; n < r; n++) {
        ...
        0 < e &&
          ((q = AmCharts.line(b.container, [f, q], [g, v], d, e, c)),
          this.set.push(q));
        if (k) {
          var u = "start",
...
AmCharts.AmGraph = AmCharts.Class({
      ...
      if (sa) {
        ...
        p
          ? ((D = C),
            ...
            (Ka = za),
            (La = Aa))
          : ((P = D = na), isNaN(ia) && !this.fillToGraph && (N = da));
        V < ia &&
          ((F.isNegative = !0),
          Ga && (wa = Ga),
          Ia && (Ma = Ia),
        ...
        switch (g) {
          ...
          case "smoothedLine":
            isNaN(V)
              ? s ||
                (this.drawSmoothedGraph(q, v, ea, fa),
                (q = []),
                (v = []),
                (ea = []),
                (fa = []))
          ...
          case "column":
            ...
            if (!isNaN(V)) {
              ...
              if (!((V < rb && ia < rb) || (V > sb && ia > sb)))
                if (p) {
                  "3d" == E
                    ? ((M = C - 0.5 * (h + B) + B / 2 + H * T), (L = P + z * T))
                    : ((M = C - (r / 2 - T) * (h + B) + B / 2), (L = P));
                  J = h;
                  Z = D;
                  ca = M + h / 2;
                  oa = D;
                  ...
                  "3d" == E
                    ? ((L = D - 0.5 * (h + B) + B / 2 + z * T), (M = N + H * T))
                    : ((L = D - (r / 2 - T) * (h + B) + B / 2), (M = N));
                  J = h;
                  Z = L + h / 2;
                  ca = C;
                  oa = L + h / 2;
              ...
              if (p) {
                if (
                  ...
                  !isNaN(La) &&
                    ...
                    C < l &&
                    0 < C &&
                    ((Va = AmCharts.line(e, fb, [C, C], ja, W, R)),
                ...
                !isNaN(Aa) &&
                  ...
                  D < k &&
                  0 < D &&
                  ((Va = AmCharts.line(e, [D, D], hb, ja, W, R)),
          ...
          case "ohlc":
            if (!(isNaN(ia) || isNaN(cb) || isNaN(db) || isNaN(V))) {
              ...
              if (p) {
                ...
                0 < C &&
                  C < l &&
                  (jb = AmCharts.line(e, [Ka, La], [C, C], qa, W, R, X));
                ...
                0 < D &&
                  D < k &&
                  (jb = AmCharts.line(e, [D, D], [za, Aa], qa, W, R, X));
          ...
          if (this.end - this.start <= vb || 0 === vb) {
            ...
            if (("column" == g && "regular" == E) || "100%" == E) {
              ...
              if (zb) {
                ...
                Db && Db.remove();
                p
                  ? ((Pa = C), (Oa = 0 > V ? D - Bb / 2 - 2 : D + Bb / 2 + 3))
                  : ((Oa = D), (Pa = 0 > V ? C + Cb / 2 : C - Cb / 2 - 3));
                Ea.translate(Oa, Pa);
                f.totals[O] = Ea;
                p
                  ? (0 > Pa || Pa > l) && Ea.remove()
  ...
  drawLineGraph: function (a, b, c, d) {
    ...
    if (1 < a.length) {
      ...
      void 0 !== s &&
        ((l = AmCharts.line(g, a, b, s, l, m, p, !1, !0)), k.push(l));
      if (0 < f || 0 < v)
        if (
          ((l = a.join(";").split(";")),
          (m = b.join(";").split(";")),
  ...
  drawSmoothedGraph: function (a, b, c, d) {
    if (1 < a.length) {
      ...
      g.push(v.path);
      void 0 !== r &&
        ((k = new AmCharts.Bezier(f, a, b, r, k, l, p, 0, e)), h.push(k.path));
      0 < m &&
        ((l = a.join(";").split(";")),
        (v = b.join(";").split(";")),
        (k = ""),
        0 < c.length
          ? (c.reverse(), d.reverse(), (l = a.concat(c)), (v = b.concat(d)))
          : (this.rotate
              ? ((k += " L" + q + "," + b[b.length - 1]),
                (k += " L" + q + "," + b[0]))
              : ((k += " L" + a[a.length - 1] + "," + q),
  ...
  createCursor: function () {
    ...
    a
      ? (e && (g.pointerWidth = 0),
        "right" == d
          ? e
            ? g.setBounds(p, r + m, p + n + l, r + s + m)
            : g.setBounds(p + n + l + f, r + m, p + n + 1e3, r + s + m)
          : e
          ? g.setBounds(p, r, n + p, s + r)
          : g.setBounds(-1e3, -1e3, p - q - f, r + s + 15))
      : ((g.maxWidth = n),
        c.parseDates && ((q = 0), (g.pointerWidth = 0)),
        "top" == d
          ? e
            ? g.setBounds(p + l, r + m, n + l + p, s + r)
            : g.setBounds(p + l, -1e3, n + l + p, r + m - q - f)
          : e
          ? g.setBounds(p, r, n + p, s + r - q)
          : g.setBounds(p, r + s + q + f - 1, p + n, r + s + q + f));
    this.hideCursor();
  },
      ...
      if (r) {
        ...
        if (c.mouseIsOver || A || z || this.forceShow)
          if (((this.forceShow = !1), z)) {
            ...
            A &&
              (s
                ? this.updateSelectionSize(NaN, n)
                : this.updateSelectionSize(n, NaN));
            t = !0;
            A && (t = !1);
            this.categoryBalloonEnabled && t
              ? (s
                  ? (q &&
                      ("right" == x
                        ? u.setBounds(k, l + h, k + m + g, l + n + h)
                        : u.setBounds(k, l + h, k + m + g, l + n)),
                    "right" == x
                      ? q
                        ? u.setPosition(k + m + g, l + n + h)
                        : u.setPosition(k + m + g + E, l + n + h)
                      : q
                      ? u.setPosition(k, l + n)
                      : u.setPosition(k - E, l + n))
                  : "top" == x
                  ? q
                    ? u.setPosition(k + n + g, l + h)
                    : u.setPosition(k + n + g, l + h - E + 1)
                  : q
                  ? u.setPosition(k + n, l + p)
                  : u.setPosition(k + n, l + p + E - 1),
                (w = this.categoryBalloonFunction)
                  ? u.showBalloon(w(r.category))
                  : f.parseDates
                ...
                for (f = 0; f < H.length; f++)
                  (w = H[f]),
                    w.showBalloon &&
                      !w.hidden &&
                      w.balloonText &&
                      ((v = r.axes[w.valueAxis.id].graphs[w.id]),
                      (u = v.y),
                      isNaN(u) ||
                        (s
                          ? Math.abs(d - u) < h &&
              ...
              for (f = 0; f < H.length; f++)
                if (
                  ...
                  n &&
                    ...
                    (h = c.formatString(w.balloonText, v, w)),
                    (q = w.balloonFunction) && (h = q(v, w)),
                    "" !== h && n.showBalloon(h),
                    !s && n.set && n.set.hide(),
                    t.push({ yy: u, balloon: n }));
                }
    ...
    if (AmCharts.ifArray(b)) {
      if (0 < a.realWidth && 0 < a.realHeight) {
        ...
        n ||
          ...
          (f = f - l - m),
          (n = Math.min(e, f)),
          f < e && ((n /= 1 - a.angle / 90), n > e && (n = e)),
          (a.pullOutRadiusReal = AmCharts.toCoordinate(a.pullOutRadius, n)),
          (n =
            0 <= s
              ? n - 1.8 * (s + a.pullOutRadiusReal)
              : n - 1.8 * a.pullOutRadiusReal),
          (n /= 2));
