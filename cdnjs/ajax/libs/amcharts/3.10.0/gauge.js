AmCharts.GaugeAxis = AmCharts.Class({
  ...
  draw: function () {
    ...
    var r = this.axisThickness / 2,
      k = AmCharts.wedge(h, y, z, p, k - p, n + r, n + r, n - r, 0, J);
    b.push(k);
    ...
    for (n = 0; n < l; n++) {
      ...
      if (n < l - 1)
        for (w = 1; w < D; w++)
          (t = r + F * w),
            (v = k(y + A * Math.sin((t / 180) * Math.PI))),
            (B = k(z - A * Math.cos((t / 180) * Math.PI))),
            (x = k(y + (A - m) * Math.sin((t / 180) * Math.PI))),
            (t = k(z - (A - m) * Math.cos((t / 180) * Math.PI))),
            (v = AmCharts.line(h, [v, x], [B, t], q, u, C, 0, !1, !1, !0)),
            b.push(v);
    }
    if ((b = this.bands))
      for (c = 0; c < b.length; c++)
        if ((f = b[c]))
          (q = f.startValue),
            (u = f.endValue),
            (e = AmCharts.toCoordinate(f.radius, s)),
            isNaN(e) && (e = A),
            (l = AmCharts.toCoordinate(f.innerRadius, s)),
            isNaN(l) && (l = e - m),
            (g = p + d * (q - this.startValue)),
            (u = d * (u - q)),
            (C = f.outlineColor),
            void 0 == C && (C = this.bandOutlineColor),
            (D = f.outlineThickness),
            isNaN(D) && (D = this.bandOutlineThickness),
            (F = f.outlineAlpha),
            isNaN(F) && (F = this.bandOutlineAlpha),
            (q = f.alpha),
            isNaN(q) && (q = this.bandAlpha),
            (e = AmCharts.wedge(h, y, z, g, u, e, e, l, 0, {
              fill: f.color,
              stroke: C,
              "stroke-width": D,
              "stroke-opacity": F,
  ...
  drawChart: function () {
    ...
    if (0 < b || 0 < c)
      (g = AmCharts.circle(
        ...
        g.toBack(),
        (a = this.facePattern) && g.pattern(a);
    for (b = e = a = 0; b < this.axes.length; b++) {
      ...
      c.draw();
      if (-1 !== f.indexOf("%"))
        var h = 1 + (100 - Number(f.substr(0, f.length - 1))) / 100;
      c.width * h > a && (a = c.width * h);
      c.height * h > e && (e = c.height * h);
    }
    ...
    if (this.adjustSize && !this.chartCreated) {
      g &&
        ((g = g.getBBox()),
        g.width > a && (a = g.width),
        g.height > e && (e = g.height));
      g = 0;
      if (l > e || d > a) g = Math.min(l - e, d - a);
      0 < g &&
        ((this.extraHeight = l - e),
        (this.chartCreated = !0),
        this.validateNow());
    }
    this.dispDUpd();
      ...
      b.frame >= this.totalFrames
        ...
        : (b.frame++,
          b.clockWiseOnly &&
            ...
            ((d = b.axis), (b.previousValue -= d.endValue - d.startValue)),
          (d = AmCharts.getEffect(this.startEffect)),
          (d = AmCharts[d](
            0,
            b.frame,
            b.previousValue,
