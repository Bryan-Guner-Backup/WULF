    ...
    if (AmCharts.ifArray(e)) {
      if (0 < this.realWidth && 0 < this.realHeight) {
        ...
        var d = AmCharts.toCoordinate,
          ...
          x,
          g,
          v = AmCharts.toNumber(this.labelRadius),
        ...
        g = d(this.radius, b, h);
        g ||
          ((b = 0 <= v ? b - k - a - 2 * q : b - k - a),
          (h = h - t - m),
          (g = Math.min(b, h)),
          h < b && ((g /= 1 - this.angle / 90), g > b && (g = b)),
          (h = AmCharts.toCoordinate(this.pullOutRadius, g)),
          (g = (0 <= v ? g - 1.8 * (v + h) : g - 1.8 * h) / 2));
  ...
  checkOverlapping: function (e, f, c, b, h) {
    ...
    if (m) {
      ...
      !0 === d &&
        ...
        this.checkOverlapping(e, f, c, b, h + 1));
    }
  },
