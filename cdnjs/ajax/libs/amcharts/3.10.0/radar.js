    ...
    if (b) {
      ...
      for (t = 0; t < w; t++) {
        var k = 180 - (360 / w) * t,
          ...
          q = e + this.axisWidth * Math.cos((k / 180) * Math.PI);
        0 < m &&
          ((h = AmCharts.line(b.container, [p, h], [e, q], d, m, c)),
          this.set.push(h));
        if (n) {
          var u = "start",
...
AmCharts.RadItem = AmCharts.Class({
  construct: function (a, b, c, d, m, p, e, f) {
    ...
    e
      ? ((C = !0),
        isNaN(e.tickLength) || (k = e.tickLength),
        void 0 != e.lineColor && (u = e.lineColor),
        isNaN(e.lineAlpha) || (h = e.lineAlpha),
        isNaN(e.dashLength) || (A = e.dashLength),
        isNaN(e.lineThickness) || (q = e.lineThickness),
        !0 === e.inside && (D = !0),
        void 0 !== e.boldLabel && (f = e.boldLabel))
      : c || ((h /= 3), (k /= 2));
    var G = "end",
      z = -1;
    D && ((G = "start"), (z = 1));
    var v;
    C &&
      ((v = AmCharts.text(r, c, g, n, l, G, f)),
      v.translate(p + (k + 3 + H) * z, b),
      d.push(v),
      (this.label = v),
      (x = AmCharts.line(r, [p, p + k * z], [b, b], w, t, q)),
      d.push(x));
    b = Math.round(a.y - b);
    f = [];
    n = [];
    if (0 < h) {
      if ("polygons" == E) {
        ...
        for (l = 0; l < s; l++)
          (g = 180 - (360 / s) * l),
            f.push(b * Math.sin((g / 180) * Math.PI)),
            n.push(b * Math.cos((g / 180) * Math.PI));
        f.push(f[0]);
        n.push(n[0]);
    ...
    if (1 == m && 0 < y && !e && "" !== c) {
      ...
      if ("polygons" == E) {
        for (l = s; 0 <= l; l--)
          (g = 180 - (360 / s) * l),
            f.push(e * Math.sin((g / 180) * Math.PI)),
            n.push(e * Math.cos((g / 180) * Math.PI));
...
AmCharts.RadarFill = AmCharts.Class({
  construct: function (a, b, c, d) {
    ...
    if ("polygons" == a.gridType) {
      ...
      for (g = 0; g < l; g++)
        (f = 180 - (360 / l) * g),
          d.push(m * Math.sin((f / 180) * Math.PI)),
          n.push(m * Math.cos((f / 180) * Math.PI));
      d.push(d[0]);
      n.push(n[0]);
      for (g = l; 0 <= g; g--)
        (f = 180 - (360 / l) * g),
          d.push(b * Math.sin((f / 180) * Math.PI)),
          n.push(b * Math.cos((f / 180) * Math.PI));
