AmCharts.AmXYChart = AmCharts.Class({
  ...
  createValueAxes: function () {
    ...
    0 === c.length &&
      ((d = new AmCharts.ValueAxis(this.theme)),
      (d.rotate = !1),
      d.setOrientation(!1),
      b.push(d),
      c.push(d));
  ...
  dispatchAxisZoom: function () {
    ...
    for (c = 0; c < a.length; c++) {
      ...
      if (!isNaN(b.min) && !isNaN(b.max)) {
        var d, e;
        "V" == b.orientation
          ? ((d = b.coordinateToValue(-this.verticalPosition)),
            (e = b.coordinateToValue(
              -this.verticalPosition + this.plotAreaHeight
            )))
          : ((d = b.coordinateToValue(-this.horizontalPosition)),
            (e = b.coordinateToValue(
  ...
  addChartScrollbar: function (a) {
    ...
    if (a) {
      ...
      this.hideXScrollbar ||
        ((b = new AmCharts.SimpleChartScrollbar(this.theme)),
        (b.skipEvent = !0),
        (b.chart = this),
        this.listenTo(b, "zoomed", this.handleHSBZoom),
        AmCharts.copyProperties(a, b, c),
        (b.rotate = !1),
        (this.scrollbarH = b));
    }
  ...
  handleAxisSelfZoom: function (a) {
    if ("H" == a.valueAxis.orientation) {
      ...
      (c = this.fitMultiplier(a.multiplier)),
        (a = -a.position * c),
        (b = -(this.plotAreaHeight * c - this.plotAreaHeight)),
        a < b && (a = b),
        (this.verticalPosition = a),
        (this.heightMultiplier = c);
    this.zoomChart();
  ...
  handleCursorZoom: function (a) {
    ...
    this.horizontalPosition =
      ((this.horizontalPosition - a.selectionX) * c) / this.widthMultiplier;
    this.verticalPosition =
      ((this.verticalPosition - a.selectionY) * b) / this.heightMultiplier;
    this.widthMultiplier = c;
