    ...
    if (AmCharts.ifArray(e)) {
      if (0 < this.realWidth && 0 < this.realHeight) {
        ...
        var d = AmCharts.toCoordinate,
          ...
          y,
          g,
          w = AmCharts.toNumber(this.labelRadius),
        ...
        x =
          void 0 === this.pieX
            ? (b - l - a) / 2 + l
            : d(this.pieX, this.realWidth);
        y = void 0 === this.pieY ? (k - u - m) / 2 + u : d(this.pieY, k);
        g = d(this.radius, b, k);
        g ||
          ((b = 0 <= w ? b - l - a - 2 * q : b - l - a),
          (k = k - u - m),
          (g = Math.min(b, k)),
          k < b && ((g /= 1 - this.angle / 90), g > b && (g = b)),
          (k = AmCharts.toCoordinate(this.pullOutRadius, g)),
          (g = (0 <= w ? g - 1.8 * (w + k) : g - 1.8 * k) / 2));
        g < this.minRadius && (g = this.minRadius);
        k = d(this.pullOutRadius, g);
        u = AmCharts.toCoordinate(this.startRadius, g);
          ...
          if (((a = e[l]), !0 !== a.hidden && 0 < a.percents)) {
            ...
            if (
              ...
              "" != h &&
                ...
                AmCharts.setCN(this, h, "pie-label"),
                AmCharts.setCN(this, h, a.className, !0),
                h.translate(p + 1.5 * v, A),
            ...
            (0 === a.alpha || (0 < f && !this.chartCreated)) && n.hide();
  ...
  checkOverlapping: function (e, f, c, b, k) {
    ...
    if (m) {
      if (!0 === b)
        for (l = e + 1; l < u; l++)
          a[l].labelQuarter == c &&
            (d = this.checkOverlappingReal(f, a[l], c)) &&
            (l = u);
      else
        for (l = e - 1; 0 <= l; l--)
          a[l].labelQuarter == c &&
      ...
      !0 === d &&
        ...
        m.translate(f.tx2, d),
        f.hitRect &&
          ((m = m.getBBox()), f.hitRect.translate(f.tx2 + m.x, d + m.y)),
        this.checkOverlapping(e, f, c, b, k + 1));
    }
  },
