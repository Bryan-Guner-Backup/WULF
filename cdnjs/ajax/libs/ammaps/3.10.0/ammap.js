...
AmCharts.wrappedText = function (a, b, c, d, f, e, g, h, k) {
  ...
  if (l) {
    ...
    if (n.width > h) {
      l.remove();
      for (var l = [], q = 0; -1 < (index = b.indexOf(" ", q)); )
        l.push(index), (q = index + 1);
      for (
        var p = Math.round(b.length / 2), z = 1e3, A, q = 0;
        q < l.length;
        q++
      ) {
      ...
      if (isNaN(A)) {
        ...
        for (q = 1; q < h; q++)
          (A = Math.round((b.length / h) * q)),
            (b = b.substr(0, A) + m + b.substr(A));
        return AmCharts.text(a, b, c, d, f, e, g);
      }
      b = b.substr(0, A) + m + b.substr(A + 1);
...
AmCharts.AmChart = AmCharts.Class({
  ...
  measure: function () {
    ...
    if (a) {
      ...
      this.balloon.chart = this;
      if (a != this.previousWidth || e != this.previousHeight)
        (b.style.width = a + "px"),
          (b.style.height = e + "px"),
          f && f.setSize(a, e);
          ...
          case 0:
            (c = a.pageX - this.posX),
              ...
              window.opera
                ...
                : 0 != AmCharts.IEversion || isNaN(a.offsetX)
                ? ((c = a.layerX), (d = a.layerY))
                : ((c -= a.layerX - a.offsetX), (d -= a.layerY - a.offsetY));
        }
        a.touches &&
          ((a = a.touches.item(0)),
          (c = a.pageX - this.posX),
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        "H" != r
          ? ((v = a - x / 2),
            b < h + u + 10 && "down" != r
              ? ((D = !0), d && (b += w), (w = b + s), (this.deltaSignY = -1))
              : (d && (b -= w), (w = b - u - s), (this.deltaSignY = 1)))
          : (2 * s > u && (s = u / 2),
            (w = b - u / 2),
            a < g + (k - g) / 2
              ? ((v = a + s), (this.deltaSignX = -1))
              : ((v = a - x - s), (this.deltaSignX = 1)));
        w + u >= l && (w = l - u);
        w < h && (w = h);
        v < g && (v = g);
        v + x > k && (v = k - x);
        ...
        0 < y || 0 === s
          ? (0 < A &&
            ...
            this.showBullet &&
              ((C = AmCharts.circle(f, B, p, this.fillAlpha)), e.push(C)))
          : ((p = []),
            (y = []),
            "H" != r
              ? ((g = a - v),
              ...
              : ((p = b - w),
                p > u - s && (p = u - s),
                p < s && (p = s),
                (y = [0, p - s, b - w, p + s, u, u, 0, 0]),
                (p =
                  a < g + (k - g) / 2
                    ? [0, 0, v < a ? 0 : a - v, 0, 0, x, x, 0]
                    : [x, x, v + x > a ? x : a - v, x, x, 0, 0, x])),
            0 < A &&
              ((a = AmCharts.polygon(f, p, y, n, 0, z, E, A)),
              a.translate(1, 1),
              e.push(a)),
            (n = AmCharts.polygon(
              f,
        ...
        this.bottom = w + u + 1;
        this.yPos = n.y + w;
        C && C.translate(this.pointToX - v + f, b - w);
        b = this.animationDuration;
        0 < this.animationDuration &&
          !d &&
          !isNaN(this.prevX) &&
          (e.translate(this.prevX, this.prevY),
          e.animate({ translate: v - f + "," + w }, b, "easeOutSine"),
          m &&
...
AmCharts.handDrawnLine = function (a, b, c, d, f, e, g, h, k, l, m) {
  ...
  for (m = 1; m < b.length; m++)
    for (
      var q = [b[m - 1], b[m]],
        p = [c[m - 1], c[m]],
        p = AmCharts.makeHD(q, p, a.handDrawScatter),
        q = p[0],
        p = p[1],
        z = 1;
      z < q.length;
    ...
    (z
      ...
      : ((B =
        ...
        0 < h &&
          (B += " A" + h + "," + p + ",0," + D + ",0," + A + "," + (r + k))),
    (B += " Z"),
    (B = a.path(B, void 0, void 0, "1000,1000").attr(x)),
    d.push(B),
    (B = a
      .path(
        " M" +
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  drawLegend: function () {
    ...
    "outside" == b
      ? ((k = e.offsetWidth),
        (f = e.offsetHeight),
        e.clientHeight && ((k = e.clientWidth), (f = e.clientHeight)))
      : (isNaN(k) || (e.style.width = k + "px"),
  ...
  arrangeEntries: function () {
    ...
    for (y = 0; y < s.length; y++) {
      var x = s[y];
      this.reversedOrder && (x = s[s.length - y - 1]);
      r = x.getBBox();
      var D;
      this.equalWidths
        ? (D = e + u * (q + m + this.markerLabelGap))
        : ((D = w), (w = w + r.width + e + m));
      r.height > v && (v = r.height);
      D + r.width > n &&
        0 < y &&
        0 !== u &&
        (p++,
      ...
      x.translate(D, t);
      u++;
      !isNaN(k) && u >= k && ((u = 0), p++, (t = t + v + l), (v = 0));
      z.push(x);
    }
    r = z.getBBox();
    k = r.height + 2 * l - 1;
    "left" == a || "right" == a
      ? ((h = r.width + 2 * e), (g.style.width = h + b + c + "px"))
      : (h = h - b - c - 1);
    c = AmCharts.polygon(
      this.container,
      [0, h, h, 0],
    ...
    if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
      "center" == this.align
        ? (b = e + (h - r.width) / 2)
        : "right" == this.align && (b = e + h - r.width);
    z.translate(b, l + 1);
  ...
  createEntry: function (a) {
    if (!1 !== a.visibleInLegend) {
      ...
      (e = this.switchType) &&
        "none" != e &&
        ("x" == e
          ? ((p = this.createX()), p.translate(l / 2, l / 2))
          : (p = this.createV()),
        (p.dItem = a),
        !0 !== a.hidden
          ? "x" == e
      ...
      g &&
        l <= p &&
        g.translate(q, l / 2 + this.ly - p / 2 + (p + 2 - l) / 2 - n);
      var z;
      d &&
    ...
    if (!1 !== a.visibleInLegend) {
      ...
      if (b.valueText && 0 < b.valueWidth) {
        ...
        b.useMarkerColorForValues &&
          ((e = a.color), a.legendKeyColor && (e = a.legendKeyColor()));
...
AmCharts.AmMap = AmCharts.Class({
  ...
  handleMouseMove: function (a) {
    ...
    if (a && a.touches) {
      ...
      h &&
        ((b.mouse2X = h.pageX - AmCharts.findPosX(b.div)),
    ...
    b.isDragging &&
      (b.hideBalloon(),
      b.positionChanged(),
      h.translate(h.x + (f - c), h.y + (e - d), h.scale),
      b.updateSmallMap(),
      a && a.preventDefault && a.preventDefault());
    b.previuosMouseX = f;
    b.previuosMouseY = e;
  ...
  selectObject: function (a) {
    ...
    if ((f = a.displayObject)) {
      ...
      a.selectable ||
        (f.setAttr("cursor", "default"), c && c.setAttr("cursor", "default"));
...
AmCharts.ZoomControl = AmCharts.Class({
  ...
  init: function (a, b) {
    ...
    if (c.zoomControlEnabled) {
      ...
      y.setIcon(a.pathToImages + "plus.gif", c.iconSize);
      y.setClickHandler(a.zoomIn, a);
      y.init(b, f, f, e, g, h, k, l, m, n, s);
      r.push(y.set);
      y = new AmCharts.SimpleButton();
      y.setIcon(a.pathToImages + "minus.gif", c.iconSize);
      y.setClickHandler(a.zoomOut, a);
      y.init(b, f, f, e, g, h, k, l, m, n, s);
      y.set.translate(0, q + f);
      r.push(y.set);
      var u = Math.log(A / z) / Math.log(p) + 1,
        y = q / u,
        w;
      for (w = 1; w < u; w++) {
        var t = f + w * y,
      ...
      u.init(b, f, y, e, g, h, k, l, m, n);
      r.push(u.set);
      c.dragger = u.set;
      c.previousY = NaN;
      q -= y;
      z = Math.log(z / 100) / Math.log(p);
      p = Math.log(A / 100) / Math.log(p);
      c.realStepSize = q / (p - z);
      c.realGridHeight = q;
      c.stepMax = p;
    }
    c.panControlEnabled &&
...
AmCharts.SmallMap = AmCharts.Class({
  ...
  init: function (a, b) {
    ...
    isNaN(c.right) ||
      ((l = a.getX(c.right, !0) - c.width - e), (q = c.width - h + e / 2));
    e = b.set();
...
AmCharts.AreasProcessor = AmCharts.Class({
  ...
  process: function (a) {
    ...
    for (f = 0; f < d; f++) {
      ...
      void 0 == c.colorSolid ||
        isNaN(e.value) ||
        ((u = Math.floor((e.value - l) / ((k - l) / b.colorSteps))),
        u == b.colorSteps && u--,
        (colorPercent = (1 / (b.colorSteps - 1)) * u),
      ...
      if (
        ...
        v && !e.title && (e.title = v),
        (m = b.language)
          ? (v = AmCharts.mapTranslations) &&
            (m = v[m]) &&
            m[e.enTitle] &&
            (e.titleTr = m[e.enTitle])
          : (e.titleTr = void 0),
        c)
      ) {
        e.displayObject = c;
        ...
        c.setAttr("fill-opacity", x);
        z && c.pattern(z, b.mapScale);
      }
    }
  },
  ...
  createImage: function (a, b) {
    ...
    if (w) {
      ...
      "kilometers" == a.widthAndHeightUnits &&
        ((r = c.kilometersToPixels(a.width)),
        (l = c.kilometersToPixels(a.height)));
      "miles" == a.widthAndHeightUnits &&
        ((r = c.milesToPixels(a.width)), (l = c.milesToPixels(a.height)));
      if ("circle" == w || "bubble" == w) l = r;
      x = this.createPredefinedImage(v, n, q, w, r, l);
      s = A = 0;
      a.centeredReal
        ? (isNaN(a.right) || (A = r * g), isNaN(a.bottom) || (s = l * g))
        : ((A = (r * g) / 2), (s = (l * g) / 2));
      x.translate(A, s, g);
    } else
      u
        ? (isNaN(r) && (r = 10),
          ...
          x.setAttr("opacity", h),
          a.centeredReal &&
            ((A = isNaN(a.right) ? -r / 2 : r / 2),
            (s = isNaN(a.bottom) ? -l / 2 : l / 2),
            x.translate(A, s)))
        : p &&
          ((x = d.path(p)),
          (n = x.getBBox()),
    ...
    x &&
      (t.push(x),
      (a.image = x),
      x.setAttr("stroke-opacity", k),
      x.setAttr("fill-opacity", h),
      x.setAttr("fill", v));
    ...
    void 0 !== a.label &&
      ...
      (x = a.labelBackgroundAlpha),
      (h = a.labelBackgroundColor) &&
        0 < x &&
        ((k = v.getBBox()),
        (d = AmCharts.rect(d, k.width + 16, k.height + 10, h, x)),
        t.push(d),
        (a.labelBG = d)),
      (a.imageLabel = v),
      !a.labelInactive && a.mouseEnabled && c.addObjectEventListeners(v, a),
      t.push(v));
...
AmCharts.LinesProcessor = AmCharts.Class({
  ...
  process: function (a) {
    ...
    for (w = 0; w < b.length; w++) {
      ...
      t.mouseEnabled && c.addObjectEventListeners(v, t);
      if (t.remainVisible || c.selectedObject == t.parentObject) {
        ...
        if (0 < C.length) {
          AmCharts.dx = 0;
          AmCharts.dy = 0;
          M = AmCharts.line(u, C, G, E, 1, x, D, !1, !1, !0);
          D = AmCharts.line(u, C, G, E, 0.001, 3, D, !1, !1, !0);
          AmCharts.dx = 0.5;
          AmCharts.dy = 0.5;
          v.push(M);
          v.push(D);
          ...
          if ("none" != I) {
            ...
            if ("end" == I || "both" == I)
              (B = C[C.length - 1]),
                (E = G[G.length - 1]),
                1 < C.length
                  ? ((H = C[C.length - 2]), (F = G[G.length - 2]))
                  : ((H = B), (F = E)),
                (F = (180 * Math.atan((E - F) / (B - H))) / Math.PI),
                (O = B),
                (Q = E),
                (F = 0 > B - H ? F - 90 : F + 90);
            "both" == I &&
            ...
            if ("start" == I || "both" == I)
              (B = C[0]),
                (Q = G[0]),
                1 < C.length ? ((E = C[1]), (O = G[1])) : ((E = B), (O = Q)),
                (F = (180 * Math.atan((Q - O) / (B - E))) / Math.PI),
                (O = B),
                (F = 0 > B - E ? F - 90 : F + 90);
            "middle" == I &&
              ((B = C[C.length - 1]),
          ...
          t.fixedSize &&
            M &&
            (this.linesToResize.push({ line: M, thickness: x }),
            this.linesToResize.push({ line: D, thickness: 3 }));
          t.lineSvg = M;
          t.showAsSelected && !isNaN(R) && M.setAttr("stroke", R);
          0 < P.length ? e.push(v) : g.push(v);
        }
      }
    }
    a.parentObject && a.remainVisible && this.process(a.parentObject);
