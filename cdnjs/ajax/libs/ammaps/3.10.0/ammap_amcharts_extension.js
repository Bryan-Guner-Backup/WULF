AmCharts.AmMap = AmCharts.Class({
  ...
  handleMouseDown: function (a) {
    ...
    if (
      ...
      (this.dragMap &&
        ...
        this.panEventsEnabled || (a && a.preventDefault && a.preventDefault())),
      a || (a = window.event),
  ...
  handleMouseMove: function (a) {
    ...
    if (a && a.touches) {
      ...
      k &&
        ((b.mouse2X = k.pageX - AmCharts.findPosX(b.div)),
        (b.mouse2Y = k.pageY - AmCharts.findPosY(b.div)));
    }
    ...
    if (!isNaN(h)) {
      ...
      5 > Math.abs(m - h) && (b.isDragging = !0);
      if (!isNaN(m)) {
        var n = (5 * Math.abs(m - h)) / l,
          l = k.scale,
          l = AmCharts.fitToBounds(
            m < h ? l + l * n : l - l * n,
            g.minZoomLevel,
            g.maxZoomLevel
          ),
    ...
    b.isDragging &&
      (b.hideBalloon(),
      b.positionChanged(),
      k.translate(k.x + (e - c), k.y + (f - d), k.scale),
      b.updateSmallMap(),
  ...
  selectObject: function (a) {
    ...
    "MapArea" == a.objectType &&
      (a.autoZoomReal && (e = !0), (f = b.areasSettings.selectedOutlineColor));
    if (
      c &&
      !e &&
      ("string" == typeof c && (c = b.getObjectById(c)),
    ...
    c = b.zoomDuration;
    !e && isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY)
    ...
    if ((e = a.displayObject)) {
      ...
      a.selectable ||
        (e.setAttr("cursor", "default"), c && c.setAttr("cursor", "default"));
    } else b.returnInitialColorReal(a);
    if ((e = a.groupId))
      for (c = b.getGroupById(e), l = 0; l < c.length; l++)
        if (((h = c[l]), (h.isOver = !1), (e = h.displayObject)))
          if (
            ((k = h.selectedColorReal),
            void 0 !== f && e.setAttr("stroke", f),
            void 0 !== k ? e.setAttr("fill", k) : b.returnInitialColor(h),
            "MapLine" == h.objectType &&
              ((k = h.lineSvg) && k.setAttr("stroke", g), (h = h.arrowSvg)))
          )
            h.setAttr("fill", g), h.setAttr("stroke", g);
    ...
    "MapArea" == a.objectType &&
      ...
      (k =
        a.autoZoomReal && isNaN(a.zoomLevel)
          ...
          : a.zoomLevel),
      (h = this.zoomControl),
      (k = AmCharts.fitToBounds(k, h.minZoomLevel, h.maxZoomLevel)),
      isNaN(a.zoomX) &&
        isNaN(a.zoomY) &&
        isNaN(a.zoomLatitude) &&
        isNaN(a.zoomLongitude) &&
        ((a = this.mapSet.getBBox()),
        this.zoomToMapXY(k, -a.x * b + c + e / 2, -a.y * b + d + f / 2)));
  },
  ...
  zoomTo: function (a, b, c, d) {
    ...
    isNaN(b) &&
      ...
      (b = (this.zoomX() - 0.5 * b) * (a / e) + 0.5 * b));
    isNaN(c) &&
      ((c = this.realHeight / this.mapHeight),
      (c = (this.zoomY() - 0.5 * c) * (a / e) + 0.5 * c));
    this.stopAnimation();
    isNaN(a) ||
      ((e = this.mapContainer),
      (this.initialX = e.x),
  ...
  processObjects: function () {
    ...
    this.linesAboveImages
      ? (d.toFront(), b.toFront(), e.toFront(), c.toFront())
      : (e.toFront(), c.toFront(), d.toFront(), b.toFront());
    ...
    if (this.chartCreated) {
      ...
      if (!this.preventHover) {
        ...
        if (this.showDescriptionOnHover) this.showDescription(a);
          ...
          (b = a.colorReal),
          (d = ""),
          (void 0 !== b && this.useObjectColorForBalloon) || (b = e.fillColor),
          (e = a.balloonTextReal) && (d = this.formatString(e, a)),
          ...
          "MapArea" == a.objectType &&
            ...
            (f = this.getAreaCenterLongitude(a)),
            (g = this.latitudeToY(g)),
            (f = this.longitudeToX(f)));
  ...
  showDescription: function (a) {
    ...
    if (a.description) {
      ...
      isNaN(e) &&
        ((e = this.mouseX), (e = e > this.realWidth / 2 ? e - c - 20 : e + 20));
      isNaN(f) && (f = this.mouseY);
      b.maxHeight = d;
      var g = a.title;
      a.titleTr && (g = a.titleTr);
      b.show(this, this.descriptionsDiv, a.description, g);
      a = b.div.style;
      a.width = c + "px";
      a.maxHeight = d + "px";
      a.left = e + "px";
      ...
      "mercator" == c.projection
        ? ((c = this.mercatorLatitudeToCoordinate(d)),
          ...
          (a =
            2 *
              Math.atan(
                Math.exp((2 * ((a * (c - e)) / b + e) * Math.PI) / 180)
              ) -
            0.5 * Math.PI),
            ...
            void 0 !== a[b][h]
              ? void 0 === a[b][h].length
                ? ((n = a[b][h]),
                  ...
                  (n = a[b][h][1]))
                : "object" == typeof a[b][h] &&
                  (a[b][h].push({}), (n = a[b][h][a[b][h].length - 1]))
              : ((a[b][h] = {}), (n = a[b][h]));
            if (f.attributes && f.attributes.length)
              for (l = 0; l < f.attributes.length; l++)
                n[f.attributes[l].name] = f.attributes[l].value;
            void 0 !== a[b][h].length
              ? this.parseXMLNode(a[b][h], a[b][h].length - 1, f, d + "  ")
              : this.parseXMLNode(a[b], h, f, d + "  ");
          }
      }
      f = 0;
      c = "";
  ...
  processObject: function (a, b, c) {
    if (a) {
      ...
      for (d = 0; d < a.length; d++) {
        ...
        "image" == c &&
          (e = AmCharts.extend(e, new AmCharts.MapImage(this.theme), !0));
        "line" == c &&
          (e = AmCharts.extend(e, new AmCharts.MapLine(this.theme), !0));
        a[d] = e;
...
AmCharts.ZoomControl = AmCharts.Class({
  ...
  init: function (a, b) {
    ...
    var e = c.buttonSize,
      f = c.buttonFillColor,
      g = c.buttonFillAlpha,
      k = c.buttonBorderThickness,
      h = c.buttonBorderColor,
    ...
    if (c.zoomControlEnabled) {
      ...
      s.init(b, e, e, f, g, k, h, l, m, n, t);
      p.push(s.set);
      s = new AmCharts.SimpleButton();
      s.setIcon(a.pathToImages + "minus.gif", c.iconSize);
      s.setClickHandler(a.zoomOut, a);
      s.init(b, e, e, f, g, k, h, l, m, n, t);
      s.set.translate(0, u + e);
      p.push(s.set);
      var x = Math.log(z / D) / Math.log(r) + 1,
        s = u / x,
        A;
      for (A = 1; A < x; A++) {
        var q = e + A * s,
          q = AmCharts.line(b, [1, e - 2], [q, q], c.gridColor, c.gridAlpha, 1);
        p.push(q);
      }
      x = new AmCharts.SimpleButton();
      x.setDownHandler(c.draggerDown, c);
      x.setClickHandler(c.draggerUp, c);
      x.init(b, e, s, f, g, k, h, l, m, n);
      p.push(x.set);
      c.dragger = x.set;
      c.previousY = NaN;
      u -= s;
      D = Math.log(D / 100) / Math.log(r);
      r = Math.log(z / 100) / Math.log(r);
      c.realStepSize = u / (r - D);
      c.realGridHeight = u;
      c.stepMax = r;
    }
    c.panControlEnabled &&
      ...
      p.setIcon(a.pathToImages + "panLeft.gif", c.iconSize),
      p.setClickHandler(a.moveLeft, a),
      p.init(b, e, e, f, g, k, h, l, m, n, t),
      p.set.translate(0, e),
      r.push(p.set),
      (p = new AmCharts.SimpleButton()),
      p.setIcon(a.pathToImages + "panRight.gif", c.iconSize),
      p.setClickHandler(a.moveRight, a),
      p.init(b, e, e, f, g, k, h, l, m, n, t),
      p.set.translate(2 * e, e),
      r.push(p.set),
      (p = new AmCharts.SimpleButton()),
      p.setIcon(a.pathToImages + "panUp.gif", c.iconSize),
      p.setClickHandler(a.moveUp, a),
      p.init(b, e, e, f, g, k, h, l, m, n, t),
      p.set.translate(e, 0),
      r.push(p.set),
      (p = new AmCharts.SimpleButton()),
      p.setIcon(a.pathToImages + "panDown.gif", c.iconSize),
      p.setClickHandler(a.moveDown, a),
      p.init(b, e, e, f, g, k, h, l, m, n, t),
      p.set.translate(e, 2 * e),
      r.push(p.set),
      (g = new AmCharts.SimpleButton()),
      g.setIcon(a.pathToImages + c.homeIconFile, c.iconSize),
      g.setClickHandler(a.goHome, a),
      g.init(b, e, e, f, 0, 0, h, 0, m, n, t),
      g.set.translate(e, e),
      r.push(g.set),
      d.push(r));
  },
  ...
  update: function () {
    ...
    this.isDragging
      ? (g.stopDrag(),
        (a = e.y + (g.mouseY - this.previousY)),
        (a = AmCharts.fitToBounds(a, f, this.realGridHeight + f)),
        (c = 100 * Math.pow(b, d - (a - f) / c)),
...
AmCharts.SmallMap = AmCharts.Class({
  ...
  init: function (a, b) {
    ...
    d.push(g);
    var u, r;
    isNaN(c.top) || ((h = a.getY(c.top) + f), (r = 0));
    isNaN(c.bottom) ||
      ((h = a.getY(c.bottom, !0) - c.height - f), (r = c.height - k + f / 2));
    isNaN(c.left) || ((l = a.getX(c.left) + f), (u = -f / 2));
    isNaN(c.right) ||
      ((l = a.getX(c.right, !0) - c.width - f), (u = c.width - k + f / 2));
    f = b.set();
...
AmCharts.AreasProcessor = AmCharts.Class({
  ...
  process: function (a) {
    ...
    for (e = 0; e < d; e++) {
      ...
      void 0 == c.colorSolid ||
        isNaN(f.value) ||
        ((x = Math.floor((f.value - l) / ((h - l) / b.colorSteps))),
        x == b.colorSteps && x--,
        (colorPercent = (1 / (b.colorSteps - 1)) * x),
        (f.colorReal = AmCharts.getColorFade(g, c.colorSolid, colorPercent)));
      void 0 != f.color && (f.colorReal = f.color);
      void 0 == f.selectable && (f.selectable = A);
      void 0 == f.colorReal && (f.colorReal = n);
      n = f.outlineColor;
      void 0 == n && (n = p);
      p = f.outlineAlpha;
      isNaN(p) && (p = s);
      s = f.outlineThickness;
      isNaN(s) && (s = r);
      r = f.rollOverOutlineColor;
      void 0 == r && (r = y);
      f.alphaReal = v;
      f.rollOverColorReal = t;
      f.rollOverAlphaReal = u;
      f.balloonTextReal = z;
      f.selectedColorReal = q;
      f.outlineColorReal = n;
      f.outlineAlphaReal = p;
      f.rollOverOutlineColorReal = r;
      f.outlineThicknessReal = s;
      f.patternReal = D;
      ...
      if (
        ...
        y && !f.title && (f.title = y),
        (m = b.language)
          ? (y = AmCharts.mapTranslations) &&
            (m = y[m]) &&
            m[f.enTitle] &&
            (f.titleTr = m[f.enTitle])
          : (f.titleTr = void 0),
        c)
      ) {
        f.displayObject = c;
        ...
        void 0 != f.colorReal &&
          (H =
            f.showAsSelected || b.selectedObject == f
              ? f.selectedColorReal
              : f.colorReal);
        c.setAttr("fill", H);
        c.setAttr("stroke", n);
        c.setAttr("stroke-opacity", p);
        c.setAttr("stroke-width", s);
        c.setAttr("fill-opacity", v);
        D && c.pattern(D, b.mapScale);
      }
    }
  },
  updateAllAreas: function () {
    ...
    for (m = 0; m < g.length; m++)
      if (
        ((h = g[m]),
        void 0 != c && h.setAttr("fill", c),
        isNaN(d) || h.setAttr("fill-opacity", d),
        void 0 != e && h.setAttr("stroke", e),
        isNaN(f) || h.setAttr("stroke-opacity", f),
        h.setAttr("stroke-width", b.outlineThickness),
        k.getAreasFromMap && !l[h.id])
      ) {
...
AmCharts.ImagesProcessor = AmCharts.Class({
  ...
  createImage: function (a, b) {
    ...
    var k = g.color,
      ...
      u = g.outlineColor,
      r = g.outlineAlpha,
      D = g.outlineThickness,
      z = g.selectedScale,
      t = g.labelPosition,
      p = g.labelColor,
      s = g.labelFontSize,
      x = g.labelRollOverColor,
    ...
    isNaN(u) && (u = D);
    (D = a.labelPosition) || (D = t);
    t = a.labelColor;
    void 0 == t && (t = p);
    p = a.labelRollOverColor;
    void 0 == p && (p = x);
    ...
    var v;
    x || A || r || ((A = "circle"), (p = 1), (h = k = 0));
    t = z = 0;
    s = a.selectedColorReal;
    if (A) {
      isNaN(p) && (p = 10);
      isNaN(l) && (l = 10);
      "kilometers" == a.widthAndHeightUnits &&
        ((p = c.kilometersToPixels(a.width)),
        (l = c.kilometersToPixels(a.height)));
      "miles" == a.widthAndHeightUnits &&
        ((p = c.milesToPixels(a.width)), (l = c.milesToPixels(a.height)));
      if ("circle" == A || "bubble" == A) l = p;
      v = this.createPredefinedImage(y, n, u, A, p, l);
      t = z = 0;
      a.centeredReal
        ? (isNaN(a.right) || (z = p * g), isNaN(a.bottom) || (t = l * g))
        : ((z = (p * g) / 2), (t = (l * g) / 2));
      v.translate(z, t, g);
    } else
      x
        ? (isNaN(p) && (p = 10),
          isNaN(l) && (l = 10),
          (v = d.image(x, 0, 0, p, l)),
          v.node.setAttribute("preserveAspectRatio", "none"),
          v.setAttr("opacity", k),
          a.centeredReal &&
            ((z = isNaN(a.right) ? -p / 2 : p / 2),
            (t = isNaN(a.bottom) ? -l / 2 : l / 2),
            v.translate(z, t)))
        : r &&
          ((v = d.path(r)),
          (n = v.getBBox()),
    ...
    v &&
      (q.push(v),
      (a.image = v),
      v.setAttr("stroke-opacity", h),
      v.setAttr("fill-opacity", k),
      v.setAttr("fill", y));
    ...
    void 0 !== a.label &&
      ...
      (v = a.labelBackgroundAlpha),
      (k = a.labelBackgroundColor) &&
        0 < v &&
        ((h = y.getBBox()),
        (d = AmCharts.rect(d, h.width + 16, h.height + 10, k, v)),
        q.push(d),
        (a.labelBG = d)),
      (a.imageLabel = y),
      !a.labelInactive && a.mouseEnabled && c.addObjectEventListeners(y, a),
      q.push(y));
    isNaN(a.latitude) || isNaN(a.longitude) ? f.push(q) : e.push(q);
  ...
  updateSizeAndPosition: function (a) {
    ...
    if (!isNaN(d) && !isNaN(e)) c.translate(d, e);
      ...
      (e = b.latitudeToCoordinate(k)),
      c.translate(d, e, NaN, !0),
      a.fixedSize)
    ) {
      d = 1;
  ...
  positionLabel: function (a, b, c) {
    if (a) {
      ...
      b.labelBG &&
        b.labelBG.translate(
          e - d.width / 2 + b.labelShiftX - 9,
          f + b.labelShiftY - d.height / 2 - 3
        );
    }
  },
  ...
  process: function (a) {
    ...
    for (A = 0; A < b.length; A++) {
      ...
      if (q.remainVisible || c.selectedObject == q.parentObject) {
        ...
        var w = q.alpha;
        isNaN(w) && (w = D);
        var B = q.rollOverAlpha;
        isNaN(B) && (B = p);
        isNaN(B) && (B = w);
        var F = q.rollOverColor;
        void 0 == F && (F = z);
        var R = q.selectedColor;
        void 0 == R && (R = t);
        var P = q.balloonText;
        P || (P = s);
        var I = q.arrow;
        ...
        q.alphaReal = w;
        q.colorReal = E;
        q.rollOverColorReal = F;
        q.rollOverAlphaReal = B;
        q.balloonTextReal = P;
        q.selectedColorReal = R;
        q.thicknessReal = v;
        AmCharts.processDescriptionWindow(d, q);
        var B = this.processCoordinates(q.x, c.realWidth),
          F = this.processCoordinates(q.y, c.realHeight),
          M = q.longitudes,
          P = q.latitudes,
          G = M.length,
          N;
        if (0 < G)
          for (B = [], N = 0; N < G; N++) B.push(c.longitudeToCoordinate(M[N]));
        G = P.length;
        if (0 < G)
          for (F = [], N = 0; N < G; N++) F.push(c.latitudeToCoordinate(P[N]));
        if (0 < B.length) {
          AmCharts.dx = 0;
          AmCharts.dy = 0;
          M = AmCharts.line(x, B, F, E, 1, v, H, !1, !1, !0);
          H = AmCharts.line(x, B, F, E, 0.001, 3, H, !1, !1, !0);
          AmCharts.dx = 0.5;
          AmCharts.dy = 0.5;
          y.push(M);
          y.push(H);
          ...
          if ("none" != I) {
            ...
            if ("end" == I || "both" == I)
              (w = B[B.length - 1]),
                (E = F[F.length - 1]),
                1 < B.length
                  ? ((G = B[B.length - 2]), (C = F[F.length - 2]))
                  : ((G = w), (C = E)),
                (C = (180 * Math.atan((E - C) / (w - G))) / Math.PI),
                (O = w),
                (Q = E),
                (C = 0 > w - G ? C - 90 : C + 90);
            "both" == I &&
              ...
              w.translate(O, Q),
              w.rotate(C),
              q.fixedSize && e.push(w));
            if ("start" == I || "both" == I)
              (w = B[0]),
                (Q = F[0]),
                1 < B.length ? ((E = B[1]), (O = F[1])) : ((E = w), (O = Q)),
                (C = (180 * Math.atan((Q - O) / (w - E))) / Math.PI),
                (O = w),
                (C = 0 > w - E ? C - 90 : C + 90);
            "middle" == I &&
              ((w = B[B.length - 1]),
          ...
          q.fixedSize &&
            M &&
            (this.linesToResize.push({ line: M, thickness: v }),
            this.linesToResize.push({ line: H, thickness: 3 }));
          q.lineSvg = M;
          q.showAsSelected && !isNaN(R) && M.setAttr("stroke", R);
          0 < P.length ? f.push(y) : g.push(y);
        }
      }
    }
    a.parentObject && a.remainVisible && this.process(a.parentObject);
...
AmCharts.ValueLegend = AmCharts.Class({
  ...
  init: function (a, b) {
    ...
    void 0 !== k &&
      ((g = AmCharts.text(b, k, m, l, h, "left")),
      g.translate(0, h / 2 - 1),
      f.push(g),
      (g = g.getBBox().height));
    k = this.maxValue;
    ...
    void 0 !== k &&
      ((g = AmCharts.text(b, k, m, l, h, "right")),
      g.translate(this.width, h / 2 - 1),
      f.push(g),
      (g = g.getBBox().height));
    if (this.showAsGradient)
      ...
      for (h = this.width / e, l = 0; l < e; l++)
        (m = AmCharts.getColorFade(c, d, (1 * l) / (e - 1))),
          (m = AmCharts.rect(
            b,
            h,
            this.height,
