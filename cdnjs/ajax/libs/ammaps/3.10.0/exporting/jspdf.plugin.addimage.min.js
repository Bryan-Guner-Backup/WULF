(function (f) {
  ...
  var e = function (m) {
      ...
      while (k < g) {
        ...
        if (
          m.charCodeAt(k + 1) === 192 ||
          m.charCodeAt(k + 1) === 193 ||
          m.charCodeAt(k + 1) === 194 ||
          m.charCodeAt(k + 1) === 195 ||
          m.charCodeAt(k + 1) === 196 ||
          m.charCodeAt(k + 1) === 197 ||
          m.charCodeAt(k + 1) === 198 ||
          m.charCodeAt(k + 1) === 199
        ) {
  ...
  f.addImage = function (g, s, q, p, t, l) {
    ...
    if (s.toUpperCase() !== "JPEG") {
      throw new Error(
        "addImage currently only supports format 'JPEG', not '" + s + "'"
      );
    }
    var i,
      n = this.internal.collections[c + "images"],
