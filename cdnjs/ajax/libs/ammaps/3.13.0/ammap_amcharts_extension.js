    ...
    if ((a = b.mapContainer)) {
      ...
      b.isDragging &&
        ...
        b.preventDragOut &&
          ((u = -u * k + l / 2),
          (l /= 2),
          (c = AmCharts.fitToBounds(c, -m * k + p / 2, p / 2)),
          (d = AmCharts.fitToBounds(d, u, l))),
        a.translate(c, d, k),
        b.updateSmallMap());
      b.previuosMouseX = e;
      b.previuosMouseY = f;
  ...
  buildSVGMap: function () {
    ...
    for (d = 0; d < a.length; d++) {
      ...
      if (this.areasSettings.preserveOriginalAttributes) {
        f.customAttr = {};
        for (var k in e)
          "d" != k && "id" != k && "title" != k && (f.customAttr[k] = e[k]);
      }
            ...
            void 0 !== a[b][h]
              ? void 0 === a[b][h].length
                ? ((m = a[b][h]),
                  ...
                  (m = a[b][h][1]))
                : "object" == typeof a[b][h] &&
                  (a[b][h].push({}), (m = a[b][h][a[b][h].length - 1]))
              : ((a[b][h] = {}), (m = a[b][h]));
            if (f.attributes && f.attributes.length)
              for (l = 0; l < f.attributes.length; l++)
                m[f.attributes[l].name] = f.attributes[l].value;
            void 0 !== a[b][h].length
...
AmCharts.ZoomControl = AmCharts.Class({
  ...
  init: function (a, b) {
    ...
    if (f) {
      ...
      r.push(q.set);
      var G = Math.log(F / w) / Math.log(v) + 1,
        f = A / G,
        n;
      for (n = 1; n < G; n++)
        (q = e + n * f),
    ...
    g &&
      ...
      r.setIcon(a.pathToImages + "panLeft.gif", c.iconSize),
      r.setClickHandler(a.moveLeft, a),
      r.init(b, e, e, k, h, l, p, m, u, t, B),
      r.set.translate(0, e),
      AmCharts.setCN(a, r.set, "pan-left"),
      g.push(r.set),
      (r = new AmCharts.SimpleButton()),
      r.setIcon(a.pathToImages + "panRight.gif", c.iconSize),
      r.setClickHandler(a.moveRight, a),
      r.init(b, e, e, k, h, l, p, m, u, t, B),
      r.set.translate(2 * e, e),
      AmCharts.setCN(a, r.set, "pan-right"),
      g.push(r.set),
      (r = new AmCharts.SimpleButton()),
      r.setIcon(a.pathToImages + "panUp.gif", c.iconSize),
      r.setClickHandler(a.moveUp, a),
      r.init(b, e, e, k, h, l, p, m, u, t, B),
      r.set.translate(e, 0),
      AmCharts.setCN(a, r.set, "pan-up"),
      g.push(r.set),
      (r = new AmCharts.SimpleButton()),
      r.setIcon(a.pathToImages + "panDown.gif", c.iconSize),
      r.setClickHandler(a.moveDown, a),
      r.init(b, e, e, k, h, l, p, m, u, t, B),
      r.set.translate(e, 2 * e),
      AmCharts.setCN(a, r.set, "pan-down"),
      g.push(r.set),
      (h = new AmCharts.SimpleButton()),
      h.setIcon(a.pathToImages + c.homeIconFile, c.iconSize),
      h.setClickHandler(a.goHome, a),
      h.init(b, e, e, k, 0, 0, p, 0, u, t, B),
      h.set.translate(e, e),
      AmCharts.setCN(a, h.set, "pan-home"),
      g.push(h.set),
      d.push(g));
  },
...
AmCharts.SmallMap = AmCharts.Class({
  ...
  init: function (a, b) {
    ...
    if (c.enabled) {
      ...
      AmCharts.setCN(a, p.set, "small-map-down");
      p = p.set;
      c.downButtonSet = p;
      d.push(p);
      ...
      isNaN(c.bottom) ||
        ((h = a.getY(c.bottom, !0) - c.height - f), (t = c.height - k + f / 2));
  ...
  update: function () {
    ...
    0 < c &&
      0 < b &&
      (e.setAttr("width", Math.ceil(c + 1)),
      e.setAttr("height", Math.ceil(b + 1)));
    this.rWidth = c;
    this.rHeight = b;
  },
...
AmCharts.AreasProcessor = AmCharts.Class({
  ...
  process: function (a) {
    ...
    for (e = 0; e < d; e++) {
      ...
      void 0 == c.colorSolid ||
        isNaN(f.value) ||
        ((q = Math.floor((f.value - l) / ((h - l) / b.colorSteps))),
        q == b.colorSteps && q--,
        (colorPercent = (1 / (b.colorSteps - 1)) * q),
        h == l && (colorPercent = 1),
      ...
      void 0 == f.preserveOriginalAttributes &&
        (f.preserveOriginalAttributes = M);
      f.alphaReal = p;
      f.rollOverColorReal = F;
      f.rollOverAlphaReal = t;
      f.balloonTextReal = w;
      f.selectedColorReal = n;
      f.outlineColorReal = u;
      ...
      if (
        ...
        f.preserveOriginalAttributes ||
          ...
          c.setAttr("stroke-width", G),
          c.setAttr("fill-opacity", p));
  ...
  updateAllAreas: function () {
    var a = this.chart,
      ...
      l = {},
      p;
    for (p = 0; p < h.length; p++) l[h[p].id] = h[p];
  ...
  createImage: function (a, b) {
    ...
    if (r) {
      ...
      "kilometers" == a.widthAndHeightUnits &&
        ((t = c.kilometersToPixels(a.width)),
        (w = c.kilometersToPixels(a.height)));
      "miles" == a.widthAndHeightUnits &&
        ((t = c.milesToPixels(a.width)), (w = c.milesToPixels(a.height)));
      if ("circle" == r || "bubble" == r) w = t;
      z = this.createPredefinedImage(x, m, u, r, t, w);
      l = v = 0;
      a.centeredReal
        ? (isNaN(a.right) || (v = t * g), isNaN(a.bottom) || (l = w * g))
        : ((v = (t * g) / 2), (l = (w * g) / 2));
      z.translate(v, l, g);
    } else
      q
        ? (isNaN(t) && (t = 10),
          isNaN(w) && (w = 10),
          (z = d.image(q, 0, 0, t, w)),
          z.node.setAttribute("preserveAspectRatio", "none"),
          z.setAttr("opacity", k),
          a.centeredReal &&
            ((v = isNaN(a.right) ? -t / 2 : t / 2),
            (l = isNaN(a.bottom) ? -w / 2 : w / 2),
            z.translate(v, l)))
        : F &&
          ((z = d.path(F)),
          (m = z.getBBox()),
    ...
    z &&
      (n.push(z),
      (a.image = z),
      z.setAttr("stroke-opacity", h),
      z.setAttr("fill-opacity", k),
      z.setAttr("fill", x),
      AmCharts.setCN(c, z, "map-image"),
      void 0 != a.id && AmCharts.setCN(c, z, "map-image-" + a.id));
    ...
    void 0 !== a.label &&
      ...
      (z = a.labelBackgroundAlpha),
      (k = a.labelBackgroundColor) &&
        0 < z &&
        ((h = x.getBBox()),
        (d = AmCharts.rect(d, h.width + 16, h.height + 10, k, z)),
      ...
      (a.imageLabel = x),
      n.push(x),
      AmCharts.setCN(c, n, "map-image-container"),
      void 0 != a.id && AmCharts.setCN(c, n, "map-image-container-" + a.id));
    ...
    for (r = 0; r < b.length; r++) {
      ...
      if (n.remainVisible || c.selectedObject == n.parentObject) {
        ...
        if (0 < C.length) {
          ...
          M = AmCharts.line(q, C, H, D, 0.001, 3, M, !1, !1, !0);
          AmCharts.dx = 0.5;
          AmCharts.dy = 0.5;
          x.push(J);
          x.push(M);
          ...
          if ("none" != K) {
            ...
            if ("end" == K || "both" == K)
              (y = C[C.length - 1]),
                (D = H[H.length - 1]),
                1 < C.length
                  ? ((I = C[C.length - 2]), (E = H[H.length - 2]))
                  : ((I = y), (E = D)),
                (E = (180 * Math.atan((D - E) / (y - I))) / Math.PI),
                (Q = y),
                (S = D),
                (E = 0 > y - I ? E - 90 : E + 90);
            "both" == K &&
            ...
            if ("start" == K || "both" == K)
              (y = C[0]),
                (S = H[0]),
                1 < C.length ? ((D = C[1]), (Q = H[1])) : ((D = y), (Q = S)),
                (E = (180 * Math.atan((S - Q) / (y - D))) / Math.PI),
                (Q = y),
                (E = 0 > y - D ? E - 90 : E + 90);
            "middle" == K &&
              ((y = C[C.length - 1]),
          ...
          n.fixedSize &&
            J &&
            (this.linesToResize.push({ line: J, thickness: z }),
            this.linesToResize.push({ line: M, thickness: 3 }));
          n.lineSvg = J;
...
AmCharts.ValueLegend = AmCharts.Class({
  ...
  init: function (a, b) {
    if (this.enabled) {
      ...
      var f = b.set();
      this.set = f;
      AmCharts.setCN(a, f, "value-legend");
      var g = 0,
        k = this.minValue,
        h = this.fontSize,
        l = a.fontFamily,
      ...
      void 0 !== k &&
        ((g = AmCharts.text(b, k, p, l, h, "left")),
        g.translate(0, h / 2 - 1),
      ...
      void 0 !== k &&
        ((g = AmCharts.text(b, k, p, l, h, "right")),
      ...
      if (this.showAsGradient)
        ...
        for (h = this.width / e, l = 0; l < e; l++)
          (p = AmCharts.getColorFade(c, d, (1 * l) / (e - 1))),
            (p = AmCharts.rect(
              b,
              h,
              this.height,
            ...
            AmCharts.setCN(a, p, "value-legend-color"),
            AmCharts.setCN(a, p, "value-legend-color-" + l),
            p.translate(h * l, g),
            f.push(p);
      d = c = 0;
      e = f.getBBox();
