...
(function (a, b) {
    ...
    e = (a.amplify = {
      ...
      subscribe: function (a, b, c, e) {
        ...
        for (; f < h; f++) {
          (a = g[f]), (i = !1), d[a] || (d[a] = []);
          var j = d[a].length - 1,
            k = { callback: c, context: b, priority: e };
          for (; j >= 0; j--)
            if (d[a][j].priority <= e) {
  ...
  (function (a, b) {
      ...
      c.addType(a, function (f, g, h) {
        ...
        if (!f) {
          ...
          try {
            ...
            while ((f = e.key(k++)))
              d.test(f) &&
                ((j = JSON.parse(e.getItem(f))),
                j.expires && j.expires <= n
                  ? l.push(f)
                  : (m[f.replace(d, "")] = j.data));
        ...
        f = "__amplify__" + f;
        if (g === b) {
          (i = e.getItem(f)), (j = i ? JSON.parse(i) : { expires: -1 });
    ...
    var d = /^__amplify__/;
    for (var f in { localStorage: 1, sessionStorage: 1 })
      try {
  ...
  (function (a, b) {
    ...
    (a.request = function (b, f, g) {
      ...
      typeof h == "string" &&
        (d(f) && ((g = f), (f = {})),
        (h = { resourceId: b, data: f || {}, success: g }));
      var i = { abort: c },
  ...
  (function (a, b, c) {
    ...
    a.store &&
      (b.each(a.store.types, function (b) {
        f[b] = function (c, d, e, g) {
          ...
          g.success = function (d) {
            a.store[b](h, d, { expires: c.cache.expires }),
      ...
      (a.request.decoders = {
        jsend: function (a, b, c, d, e) {
          a.status === "success"
            ...
            : a.status === "fail"
            ? e(a.data, "fail")
            : a.status === "error" && (delete a.status, e(a, "error"));
        },
      }),
      a.subscribe("request.before.ajax", function (c, d, e, f) {
        ...
        var g = f.success,
          h = f.error,
          i = b.isFunction(c.decoder)
            ? c.decoder
            : c.decoder in a.request.decoders
            ? a.request.decoders[c.decoder]
            : a.request.decoders._default;
        !i ||
