...
(function (amplify, $, undefined) {
  ...
  amplify.request.types.ajax = function (defnSettings) {
    ...
    return function (settings, request) {
      var xhr,
        ...
        abort = request.abort,
        ajaxSettings = $.extend(true, {}, defnSettings, {
          data: settings.data,
        }),
        aborted = false,
        ampXHR = {
      ...
      $.extend(ajaxSettings, {
        ...
        beforeSend: function (_xhr, _ajaxSettings) {
          ...
          var ret = defnSettings.beforeSend
            ? defnSettings.beforeSend.call(this, ampXHR, ajaxSettings)
            : true;
          return (
            ret &&
            amplify.publish(
  ...
  amplify.subscribe(
    "request.ajax.preprocess",
    function (defnSettings, settings, ajaxSettings) {
      var mappedKeys = [],
  ...
  var cache = (amplify.request.cache = {
    ...
    _default: (function () {
      ...
      return function (resource, settings, ajaxSettings, ampXHR) {
        ...
        var cacheKey = cache._key(
            settings.resourceId,
            ajaxSettings.cacheURL(),
            ajaxSettings.data
          ),
  ...
  amplify.subscribe("request.before.ajax", function (resource) {
    ...
    if (cacheType) {
      ...
      return cache[cacheType in cache ? cacheType : "_default"].apply(
        this,
        arguments
      );
    }
  ...
  amplify.subscribe(
    "request.before.ajax",
    function (resource, settings, ajaxSettings, ampXHR) {
