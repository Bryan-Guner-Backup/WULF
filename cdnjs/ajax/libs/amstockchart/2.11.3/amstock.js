...
document.attachEvent &&
  ((AmCharts.isNN = !1),
  (AmCharts.isIE = !0),
  9 > AmCharts.IEversion && ((AmCharts.dx = 0), (AmCharts.dy = 0)));
...
AmCharts.AmChart = AmCharts.Class({
  ...
  initChart: function () {
    ...
    this.mouseMode = a;
    this.container = new AmCharts.AmDraw(
      this.chartDiv,
      this.realWidth,
      this.realHeight
    );
...
AmCharts.Cuboid = AmCharts.Class({
  ...
  draw: function () {
    ...
    var q, t, u, v, x, A, z, C, w;
    if (0 < e || 0 < f)
      (z = s),
        (s = AmCharts.adjustLuminosity(p, -0.2)),
        (s = AmCharts.adjustLuminosity(p, -0.2)),
        (q = AmCharts.polygon(
          b,
          [0, e, c + e, c, 0],
        ...
        0 < m && (w = AmCharts.line(b, [0, e, c + e], [0, f, f], l, m, k)),
        (t = AmCharts.polygon(
          b,
          [0, 0, c, c, 0],
          [0, d, d, 0, 0],
        ...
        (s = AmCharts.adjustLuminosity(z, 0.2)),
        (z = AmCharts.polygon(
          b,
          [0, e, c + e, c, 0],
          [d, d + f, d + f, d, d],
        ...
        0 < m &&
          (C = AmCharts.line(b, [0, e, c + e], [d, d + f, d + f], l, m, k));
    1 > Math.abs(d) && (d = 0);
    1 > Math.abs(c) && (c = 0);
    b =
      0 === d
        ? AmCharts.line(b, [0, c], [0, 0], l, m, k)
        : 0 === c
        ? AmCharts.line(b, [0, 0], [0, d], l, m, k)
        : 0 < r
        ? AmCharts.rect(b, c, d, g, h, k, l, m, r, n)
        : AmCharts.polygon(
            b,
            [0, 0, c, c, 0],
            [0, d, d, 0, 0],
    ...
    d = 0 > d ? [q, w, t, u, v, x, A, z, C, b] : [z, C, t, u, v, x, q, w, A, b];
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  arrangeEntries: function () {
    ...
    for (v = 0; v < t.length; v++) {
      ...
      var w;
      this.equalWidths
        ? (w = f + A * (r + m + this.markerLabelGap))
        : ((w = z), (z = z + u.width + f + m));
      w + u.width > n &&
        0 < v &&
        0 !== A &&
        (x++, (A = 0), (w = f), (z = w + u.width + f + m), (skipNewRow = !0));
      C.translate(w, (p + l) * x);
      A++;
      !isNaN(k) && A >= k && ((A = 0), x++);
      s.push(C);
  ...
  createEntry: function (a) {
    if (!1 !== a.visibleInLegend) {
      ...
      var d = AmCharts.massReplace(this.labelText, { "[[title]]": a.title }),
        k = this.fontSize,
        l = this.markerSize;
      if (f && l <= k) {
        var m = 0;
      ...
      var n;
      d &&
        ((d = AmCharts.fixNewLines(d)),
        (n = AmCharts.text(this.container, d, g, b.fontFamily, k, "start")),
  ...
  draw: function () {
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        d = AmCharts.text(e, this.text, this.color, v, x, c);
        f.push(d);
        var A;
        void 0 != m &&
          ((A = AmCharts.text(e, this.text, m, v, x, c, !1, 0.4)), f.push(A));
        v = d.getBBox();
        m = v.height + 2 * n;
        v = v.width + 2 * s;
        window.opera && (m += 2);
        ...
        d.translate(z, x);
        A && A.translate(z + 1, x + 1);
        "H" != t
          ? ((z = a - v / 2),
            (c = b < h + m + 10 && "down" != t ? b + q : b - m - q))
          : (2 * q > m && (q = m / 2),
            (c = b - m / 2),
            (z = a < g + (k - g) / 2 ? a + q : a - v - q));
        c + m >= l && (c = l - m);
        c < h && (c = h);
        z < g && (z = g);
        z + v > k && (z = k - v);
        0 < u || 0 === q
          ? ((p = AmCharts.rect(
            ...
            this.showBullet &&
              ((e = AmCharts.circle(e, this.bulletSize, r, this.fillAlpha)),
              e.translate(a, b),
              (this.pointer = e)))
          : ((l = []),
            (u = []),
            "H" != t
              ...
              : ((h = b - c),
                ...
                (l =
                  a < g + (k - g) / 2
                    ? [0, 0, z < a ? 0 : a - z, 0, 0, v, v, 0]
                    : [v, v, z + v > a ? v : a - z, v, v, 0, 0, v])),
            (p = AmCharts.polygon(
              e,
              l,
              u,
...
AmCharts.AmCoordinateChart = AmCharts.Class({
        ...
        for (t = 0; t < q.length; t++) {
          ...
          for (v = 0; v < a.length; v++) {
            ...
            if (b.valueAxis.id == u) {
              ...
              var C = s;
              b.dataProvider && (C = c);
              z.values = this.processValues(C, b, A);
              this.processFields(b, z, C);
  ...
  processFields: function (a, b, c) {
    ...
    d =
      "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor".split(
        " "
      );
...
AmCharts.AmRectangularChart = AmCharts.Class({
  ...
  drawZoomOutButton: function () {
    ...
    void 0 !== a.pathToImages &&
      ((e = a.container.image(a.pathToImages + "lens.png", 0, 0, 16, 16)),
  ...
  updateChartScrollbar: function (a, b) {
    if (a) {
      ...
      "top" == a.position
        ...
        : ((a.y = c + this.plotAreaHeight + 1), (a.x = this.marginLeftReal));
    }
  },
  showZB: function (a) {
    var b = this.zbSet;
...
AmCharts.TrendLine = AmCharts.Class({
  ...
  draw: function () {
    ...
    h &&
      (k && (d = h.dateToCoordinate(k)),
      l && (d = h.categoryToCoordinate(l)),
      m && (e = h.dateToCoordinate(m)),
      n && (e = h.categoryToCoordinate(n)));
    p &&
      !v &&
      (isNaN(s) || (d = p.getCoordinate(s)),
      isNaN(q) || (e = p.getCoordinate(q)));
    r &&
      !v &&
      (isNaN(t) || (f = r.getCoordinate(t)),
...
AmCharts.AmSerialChart = AmCharts.Class({
  ...
  getClosestIndex: function (a, b, c, d, e, f) {
    ...
    return c == h
      ? g
      : c < h
      ? this.getClosestIndex(a, b, c, d, e, g)
    ...
    if (-1 != a.indexOf("[[category]]")) {
      ...
      if (this.categoryAxis.parseDates) {
        ...
        -1 != a.indexOf("[[category]]") &&
          ((e = AmCharts.formatDate(d, e)),
          -1 != e.indexOf("fff") && (e = AmCharts.formatMilliseconds(e, d)),
          (d = e));
      }
...
AmCharts.AxisBase = AmCharts.Class({
  ...
  draw: function () {
    ...
    this.autoGridCount &&
      ("V" == this.orientation
        ? ((a = this.height / 35), 3 > a && (a = 3))
        : (a = this.width / this.minGap),
...
AmCharts.ValueAxis = AmCharts.Class({
  ...
  draw: function () {
    ...
    if (
      ...
      if (
        ...
        !0 === h
          ? ((q =
            ...
            2 < q &&
              ((s = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1),
        ...
        if (0 < A) {
          ...
          for (d = this.fillAlpha = 0; d < A; d++) {
            var C = x[d],
              ...
              y = C.above;
            isNaN(C.toValue) ||
              ((w = this.getCoordinate(C.toValue)),
              (v = new this.axisItemRenderer(this, w, "", !0, NaN, NaN, C)),
              this.pushAxisItem(v, y));
            var B = NaN;
            isNaN(C.value) ||
              ((B = this.getCoordinate(C.value)),
              (v = new this.axisItemRenderer(
                this,
                B,
                C.label,
                !0,
              ...
              this.pushAxisItem(v, y));
            isNaN(w - B) ||
              ((v = new this.guideFillRenderer(this, B, w, C)),
              this.pushAxisItem(v, y),
              (v = v.graphics()),
              (C.graphics = v),
              C.balloonText && this.addEventListeners(v, C));
          }
          this.fillAlpha = z;
        }
        x = !1;
        for (d = p; d < s; d += r)
          (v = AmCharts.roundTo(this.step * d + this.min, c)),
            -1 != String(v).indexOf("e") && ((x = !0), String(v).split("e"));
        this.duration &&
          (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
        for (d = p; d < s; d += r)
          if (
            ((p = this.step * d + this.min),
            ...
            if (isNaN(t) || Number(AmCharts.toFixed(p, t)) == p) {
              ...
              x
                ...
                : (h &&
                  ...
                  (v = this.usePrefixes
                    ...
                    : AmCharts.formatNumber(p, u, u.precision)));
              this.duration &&
              ...
              this.recalculateToPercents
                ? (v += "%")
                : (c = this.unit) &&
                  (v = "left" == this.unitPosition ? c + v : v + c);
      ...
      this.positionTitle();
      "radar" != k
        ? ((k = this.viX), (d = this.viY), b.translate(k, d), a.translate(k, d))
        : h.toFront();
      !this.visible || g
        ? (b.hide(), h.hide(), a.hide())
        : (b.show(), h.show(), a.show());
    }
  },
...
AmCharts.CategoryAxis = AmCharts.Class({
    ...
    if (AmCharts.ifArray(a)) {
      ...
      var t = this.firstDayOfWeek,
        ...
        a = AmCharts.resetDateToMin(
          new Date(a[a.length - 1].time + 1.05 * l),
          this.minPeriod,
          1,
          t
        ).getTime(),
      ...
      if (this.parseDates && !this.equalSpacing) {
        ...
        if (0 < this.gridCount)
          for (b = d; b <= g; b++) {
            a = A + r * (b + 0.1 + Math.floor((x - A) / r));
            a = AmCharts.resetDateToMin(new Date(a), e, n, t).getTime();
            l = (a - this.startTime) * this.stepWidth;
            q = !1;
            this.nextPeriod[p] &&
              (q = this.checkPeriodChange(this.nextPeriod[p], 1, a, m));
            v = !1;
            q && this.markPeriodChange
              ? ((m = this.dateFormatsObject[this.nextPeriod[p]]), (v = !0))
              : (m = this.dateFormatsObject[p]);
            u || (v = !1);
            m = AmCharts.formatDate(new Date(a), m);
            if ((b == d && !h) || (b == g && !k)) m = " ";
            this.labelFunction &&
              (m = this.labelFunction(m, new Date(a), this));
          ...
          for (
            ...
            if (
              (0 <= b && b < this.data.length
                ? ((p = this.data[b]), (m = p.category))
                : (m = ""),
              b / u == Math.round(b / u) || p.forceShow)
            ) {
        ...
        if (
          ...
          AmCharts.resetDateToMin(
            new Date(this.data[l].time),
            e,
            n,
            t
          ).getTime()
        )
          for (t = 0, x = m, b = l; b < s; b++)
            (a = this.data[b].time),
              this.checkPeriodChange(e, n, a, x) &&
                (t++, 2 <= t && ((l = b), (b = s)), (x = a));
        for (b = l; b < s; b++)
          if (((a = this.data[b].time), this.checkPeriodChange(e, n, a, m))) {
            ...
            r
              ...
              : (u || (v = !1),
                l - this.previousPos >
                  ...
                  this.pushAxisItem(m),
                  (t = t.getBBox().width),
                  AmCharts.isModern || (t -= l),
                  (this.previousPos = l + t)));
            m = a;
          }
      }
        ...
        if ((h = this.data[b]))
          (k =
            this.parseDates && !this.equalSpacing
              ? Math.round(
                  (h.time - this.startTime) * this.stepWidth +
                    this.cellWidth / 2
                )
          ...
          k.toDate &&
            (this.equalSpacing
              ? ((t = c.getClosestIndex(
                ...
                isNaN(t) || (u = this.getCoordinate(t - f)))
              : (u = (k.toDate.getTime() - this.startTime) * this.stepWidth),
            (m = new this.axisItemRenderer(this, u, "", !0, NaN, NaN, k)),
            this.pushAxisItem(m, d)),
          k.date &&
            (this.equalSpacing
              ? ((t = c.getClosestIndex(
                ...
                isNaN(t) || (g = this.getCoordinate(t - f)))
              : (g = (k.date.getTime() - this.startTime) * this.stepWidth),
            (t = (u - g) / 2),
            (m =
              "H" == this.orientation
                ? new this.axisItemRenderer(this, g, k.label, !1, 2 * t, NaN, k)
                : new this.axisItemRenderer(this, g, k.label, !1, NaN, t, k)),
            this.pushAxisItem(m, d)),
  ...
  checkPeriodChange: function (a, b, c, d) {
    ...
    return "DD" == a && c - b <= AmCharts.getPeriodDuration(a, d)
      ? !1
      : c != b
      ? !0
      : !1;
...
AmCharts.RecAxis = AmCharts.Class({
  construct: function (a) {
    var b = a.chart,
      ...
      r = b.container;
    "H" == a.orientation
      ? ((d = AmCharts.line(r, [0, n], [0, 0], d, e, c)),
      ...
      : ((this.axisWidth = a.height),
        "right" == a.position
          ? ((d = AmCharts.line(r, [0, 0, -g], [0, m, m - h], d, e, c)),
            (a = l + h),
            (c = c / 2 + f + g + n + k - 1))
          : ((d = AmCharts.line(r, [0, 0], [0, m], d, e, c)),
            (a = l),
            (c = -c / 2 - f + k)));
    d.translate(c, a);
    b.axesSet.push(d);
  ...
  construct: function (a, b, c, d, e, f, g, h, k) {
    ...
    g
      ? ((y = !0),
        ...
        void 0 != g.color && (n = g.color),
        isNaN(g.lineAlpha) || (v = g.lineAlpha),
        isNaN(g.dashLength) || (z = g.dashLength),
        isNaN(g.lineThickness) || (x = g.lineThickness),
        !0 === g.inside && (J = !0),
        isNaN(g.labelRotation) || (B = g.labelRotation),
        isNaN(g.fontSize) || (m = g.fontSize),
        g.position && (da = g.position))
      : "" === c && (u = 0);
    X = "start";
    e && (X = "middle");
    var Y = (B * Math.PI) / 180,
    ...
    if ("H" == Fa) {
      if (
        (0 <= b &&
          ...
          (0 < u &&
            0 < t &&
            b + k <= R + 1 &&
            ((ma = AmCharts.line(r, [b + k, b + k], [0, u], q, t, x)),
            p.push(ma)),
          0 < v &&
            ((X = AmCharts.line(
              r,
        ...
        !1 === d
          ? ((X = "start"),
            (D = "bottom" == da ? (J ? D + u : D - u) : J ? D - u : D + u),
            (H += 3),
            e && ((H += e / 2), (X = "middle")),
            0 < B && (X = "middle"))
          : (X = "middle"),
        1 == I &&
          ...
          !g &&
          ha < R &&
          ((d = AmCharts.fitToBounds(b, 0, R)),
          (ha = AmCharts.fitToBounds(ha, 0, R)),
          (ka = d - ha),
          0 < ka &&
            ((fill = AmCharts.rect(r, ka, a.height, C, w)),
        ...
        "bottom" == da
          ...
          : ((D += Q + m / 2 - W),
            ...
            J
              ? 0 < B
                ? ((D = (ga / 2) * Math.sin(Y) + u + 3),
                  (H -= (ga / 2) * Math.cos(Y)))
                : (D += u + 3)
              : 0 < B
              ? ((D = -(ga / 2) * Math.sin(Y) - u - 6),
                (H += (ga / 2) * Math.cos(Y)))
              : (D -= u + m + 3 + s + 3)),
        "bottom" == da
          ? (ka = (J ? T - u - 1 : T + s - 1) + W)
        ...
        f && (H += f),
        (Q = H),
        0 < B && (Q += (ga / 2) * Math.cos(Y)),
        U &&
          ((da = 0),
          J && (da = (ga / 2) * Math.cos(Y)),
          Q + da > R + 2 || 0 > Q))
      )
        U.remove(), (U = null);
    } else {
      0 <= b &&
        ...
        (0 < u &&
          0 < t &&
          b + k <= T + 1 &&
          ((ma = AmCharts.line(r, [0, u], [b + k, b + k], q, t, x)),
          p.push(ma)),
        0 < v &&
          ((X = AmCharts.line(r, [0, S, R + S], [b, b + Q, b + Q], A, v, x, z)),
          p.push(X)));
      X = "end";
      if ((!0 === J && "left" == da) || (!1 === J && "right" == da))
        X = "start";
      D = b - m / 2;
      1 == I &&
        0 < w &&
  ...
  construct: function (a) {
    ...
    if (b) {
      ...
      for (p = 0; p < r; p++) {
        ...
        0 < e &&
          ((q = AmCharts.line(b.container, [f, q], [g, t], d, e, c)),
          this.set.push(q));
        if (k) {
          var u = "start",
...
AmCharts.RadItem = AmCharts.Class({
  construct: function (a, b, c, d, e, f, g) {
    ...
    g
      ? ((A = !0),
        isNaN(g.tickLength) || (p = g.tickLength),
        void 0 != g.lineColor && (t = g.lineColor),
        isNaN(g.lineAlpha) || (s = g.lineAlpha),
        isNaN(g.dashLength) || (u = g.dashLength),
        isNaN(g.lineThickness) || (q = g.lineThickness),
        !0 === g.inside && (z = !0))
      : c || ((s /= 3), (p /= 2));
    var I = "end",
      J = -1;
    ...
    var S;
    A &&
      ((S = AmCharts.text(m, c, l, h, k, I)),
      S.translate(f + (p + 3) * J, b),
      d.push(S),
      (this.label = S),
      (y = AmCharts.line(m, [f, f + p * J], [b, b], n, r, q)),
      d.push(y));
    b = a.y - b;
    c = [];
    h = [];
    ...
    if (1 == e && 0 < x && !g) {
      ...
      if ("polygons" == C) {
        ...
        w = AmCharts.polygon(m, c, h, v, x);
      } else
        w = AmCharts.wedge(m, 0, 0, 0, -360, b, b, g, 0, {
          fill: v,
          "fill-opacity": x,
          stroke: 0,
          "stroke-opacity": 0,
...
AmCharts.AmGraph = AmCharts.Class({
  ...
  createGraph: function () {
    ...
    void 0 === a.bulletColor &&
      ((a.bulletColor = a.lineColor),
  ...
  createSerialGraph: function () {
    ...
    var ka = I,
      H = 270;
    "horizontal" == this.gradientOrientation && (H = 0);
    ...
    if (
      ...
      n
        ? ((Ya = l),
          ...
          (bb = Math.abs(Ua - ua)),
          (Ta = $a = 0),
          f.reversed ? ((Ra = 0), (Sa = ua)) : ((Ra = ua), (Sa = 0)))
        : ((Za = k),
          (Ya = Math.abs(qb - ua)),
          (bb = k),
          (ab = Math.abs(Ua - ua)),
          (Sa = Ra = 0),
          f.reversed ? ((Ta = m), ($a = ua)) : (Ta = ua + 1));
    }
    var va = Math.round;
    this.pmx = va(Ra);
    this.pmy = va($a);
    ...
    for (O = J; O <= S; O++) {
      ...
      var L,
        ...
        ja,
        ra;
      void 0 != G.color && (wa = G.color);
      G.fillColors && (wa = G.fillColors);
      isNaN(G.alpha) || (Ma = G.alpha);
      var sa = G.values;
      f.recalculateToPercents && (sa = G.percents);
      if (sa) {
        V = this.stackable && "none" != B && "3d" != B ? sa.close : sa.value;
        ...
        n
          ? ((F = E),
            ...
            (Ka = za),
            (La = Aa))
          : ((P = F = na), isNaN(ia) && !this.fillToGraph && (N = da));
        V < ia &&
          ((G.isNegative = !0),
          Ga && (wa = Ga),
          Ia && (Ma = Ia),
        ...
        switch (g) {
          case "line":
            isNaN(V)
              ? s ||
                (this.drawLineGraph(q, t, ea, fa),
                (q = []),
                (t = []),
                (ea = []),
                (fa = []))
              : ((G.isNegative = V < ha ? !0 : !1),
                q.push(F),
                t.push(E),
                (Z = F),
                (ca = E),
                (oa = F),
                (pa = E),
                !Ja || isNaN(N) || isNaN(P) || (ea.push(P), fa.push(N)));
            break;
          case "smoothedLine":
            isNaN(V)
              ? s ||
                (this.drawSmoothedGraph(q, t, ea, fa),
                (q = []),
                (t = []),
                (ea = []),
                (fa = []))
          ...
          case "column":
            ja = qa;
            void 0 != G.lineColor && (ja = G.lineColor);
            if (!isNaN(V)) {
              V < ha
                ? ((G.isNegative = !0),
                  Ga && (wa = Ga),
              ...
              if (!((V < rb && ia < rb) || (V > sb && ia > sb)))
                if (n) {
                  "3d" == B
                    ? ((M = E - 0.5 * (h + D) + D / 2 + y * T), (L = P + w * T))
                    : ((M = E - (r / 2 - T) * (h + D) + D / 2), (L = P));
                  K = h;
                  Z = F;
                  ca = M + h / 2;
                  oa = F;
                  ...
                  aa += Fb - L;
                  aa = AmCharts.fitToBounds(aa, -L, k - L + w * T);
                  if (
                    M < l &&
                    0 < K &&
                    ((la = new AmCharts.Cuboid(
                      e,
                      aa,
                      K,
                      w - a.d3x,
                    ...
                    else if ("regular" == B || "100%" == B) Z += this.dx;
                } else {
                  "3d" == B
                    ? ((L = F - 0.5 * (h + D) + D / 2 + w * T), (M = N + y * T))
                    : ((L = F - (r / 2 - T) * (h + D) + D / 2), (M = N));
                  K = h;
                  Z = L + h / 2;
                  ca = E;
                  oa = L + h / 2;
              ...
              if (
                ...
                (G.url || this.showHandOnHover) &&
                  ra.setAttr("cursor", "pointer"),
                !Q)
              ) {
                "none" == B && (C = n ? (this.end + 1 - O) * z - c : z * O + c);
                "3d" == B &&
                  (n
                    ? ((C = (z - c) * (this.end + 1 - O)),
                      (Z += w * this.columnIndex),
                      (oa += w * this.columnIndex),
                      (G.y += w * this.columnIndex))
                    : ((C = (z - c) * (O + 1)),
                      (Z += 3),
                      (ca += y * this.columnIndex + 7),
                      (pa += y * this.columnIndex),
                      (G.y += y * this.columnIndex)));
                if ("regular" == B || "100%" == B)
                  (I = "middle"),
                    (C = n
                      ? 0 < sa.value
                      ...
                      ? z * O + c
                      : z * O - c);
                this.columnsArray.push({ column: la, depth: C });
                G.x = n ? M + K / 2 : L + K / 2;
                this.ownColumns.push(la);
                this.animateColumns(la, O, F, P, E, N);
                this.addListeners(ra, G);
              }
            }
            break;
          case "candlestick":
              ...
              if (n) {
                if (
                  ...
                  !isNaN(La) &&
                    ...
                    E < l &&
                    0 < E &&
                    ((Va = AmCharts.line(e, fb, [E, E], ja, W, R)),
                    (eb = AmCharts.line(e, gb, [E, E], ja, W, R)));
                  aa = F - P;
                  la = new AmCharts.Cuboid(
                    e,
                    aa,
                ...
                !isNaN(Aa) &&
                  ...
                  F < k &&
                  0 < F &&
                  ((Va = AmCharts.line(e, [F, F], hb, ja, W, R)),
                  (eb = AmCharts.line(e, [F, F], ib, ja, W, R)));
              }
              la &&
                ((ra = la.set),
                Y.push(ra),
                ra.translate(L, M - R / 2),
                (G.url || this.showHandOnHover) &&
                  ra.setAttr("cursor", "pointer"),
                Va && (Y.push(Va), Y.push(eb)),
                (Z = F),
                (ca = E),
                (oa = F),
                (pa = E),
          ...
          case "ohlc":
            if (!(isNaN(ia) || isNaN(cb) || isNaN(db) || isNaN(V))) {
              V < ia && ((G.isNegative = !0), void 0 != ya && (qa = ya));
              var jb, kb, lb;
              if (n) {
                var mb = E - h / 2,
                ...
                0 < E &&
                  E < l &&
                  (jb = AmCharts.line(e, [Ka, La], [E, E], qa, W, R, X));
                lb = AmCharts.line(e, [F, F], [tb, nb], qa, W, R, X);
              } else {
                var ob = F - h / 2,
                  ob = AmCharts.fitToBounds(ob, 0, k),
                  ub = AmCharts.fitToBounds(F, 0, k),
                  pb = F + h / 2,
                  pb = AmCharts.fitToBounds(pb, 0, k);
                kb = AmCharts.line(e, [ob, ub], [N, N], qa, W, R, X);
                0 < F &&
                  F < k &&
                  (jb = AmCharts.line(e, [F, F], [za, Aa], qa, W, R, X));
        ...
        if (!Q && !isNaN(V)) {
          ...
          if (this.end - this.start <= vb || 0 === vb) {
            var Da = this.createBullet(G, oa, pa, O);
            Da || (Da = 0);
            var wb = this.labelText;
            if (wb) {
              var ba = this.createLabel(G, 0, 0, wb),
                xa = 0,
                Ba = 0,
                xb = ba.getBBox(),
                Wa = xb.width,
              ...
              switch (I) {
                ...
                case "bottom":
                  n && "column" == g
                    ? ((Z = da),
                      0 > V
                        ? ((xa = -6), ba.attr({ "text-anchor": "end" }))
                        : ((xa = 6), ba.attr({ "text-anchor": "start" })))
                    : ((Ba = Da / 2 + Xa / 2), (ba.x = -(Wa / 2 + 2)));
                  break;
                case "middle":
                  "column" == g &&
                    (n
                      ? ((Ba = -(Xa / 2) + this.fontSize / 2),
                        (xa = -(F - P) / 2 - w),
                        0 > aa && (xa += w),
                        Math.abs(F - P) < Wa &&
            ...
            if (("column" == g && "regular" == B) || "100%" == B) {
              var zb = f.totalText;
              if (zb) {
                var Ea = this.createLabel(G, 0, 0, zb, f.totalTextColor);
                ...
                Db && Db.remove();
                n
                  ? ((Pa = E), (Oa = 0 > V ? F - Bb / 2 - 2 : F + Bb / 2 + 3))
                  : ((Oa = F), (Pa = 0 > V ? E + Cb / 2 : E - Cb / 2 - 3));
                Ea.translate(Oa, Pa);
                f.totals[O] = Ea;
                n
                  ? (0 > Pa || Pa > l) && Ea.remove()
  ...
  drawLineGraph: function (a, b, c, d) {
    ...
    if (1 < a.length) {
      ...
      void 0 !== s &&
        ((l = AmCharts.line(g, a, b, s, l, m, n, !1, !0)), k.push(l));
      if (0 < f || 0 < t)
        if (
          ((l = a.join(";").split(";")),
          (m = b.join(";").split(";")),
          "serial" == e.chartType &&
            (0 < c.length
              ? (c.reverse(), d.reverse(), (l = a.concat(c)), (m = b.concat(d)))
              : e.rotate
              ? (m.push(m[m.length - 1]),
                l.push(u),
                m.push(m[0]),
  ...
  drawSmoothedGraph: function (a, b, c, d) {
    if (1 < a.length) {
      ...
      g.push(t.path);
      void 0 !== r &&
        ((k = new AmCharts.Bezier(f, a, b, r, k, l, n, 0, e)), h.push(k.path));
      0 < m &&
        ((l = a.join(";").split(";")),
        (t = b.join(";").split(";")),
        (k = ""),
        0 < c.length
          ? (c.reverse(), d.reverse(), (l = a.concat(c)), (t = b.concat(d)))
          : (this.rotate
              ? ((k += " L" + q + "," + b[b.length - 1]),
                (k += " L" + q + "," + b[0]))
              : ((k += " L" + a[a.length - 1] + "," + q),
                (k += " L" + a[0] + "," + q)),
            (k += " L" + a[0] + "," + b[0])),
        (c = new AmCharts.Bezier(f, l, t, NaN, 0, 0, n, m, e, k)),
        g.push(c.path),
        p || void 0 !== r) &&
        (s || (s = m),
        p || (p = r),
        (a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, p, s, e, k)),
        h.push(a.path));
      this.applyMask(h, g);
    }
  },
  ...
  createBullet: function (a, b, c, d) {
    ...
    if ("none" != this.bullet || a.bullet) {
      ...
      switch (g) {
        case "round":
          h = AmCharts.circle(d, f / 2, k, r, l, m, n);
          break;
        case "square":
          h = AmCharts.polygon(d, [0, f, f, 0], [0, 0, f, f], k, r, l, m, n);
          b -= f / 2;
          c -= f / 2;
          e = -f / 2;
          break;
        case "triangleUp":
          h = AmCharts.triangle(d, f, 0, k, r, l, m, n);
          break;
        case "triangleDown":
          h = AmCharts.triangle(d, f, 180, k, r, l, m, n);
          break;
        case "triangleLeft":
          h = AmCharts.triangle(d, f, 270, k, r, l, m, n);
          break;
        case "triangleRight":
          h = AmCharts.triangle(d, f, 90, k, r, l, m, n);
          break;
        case "bubble":
          h = AmCharts.circle(d, f / 2, k, r, l, m, n, !0);
      }
    }
    l = g = 0;
  ...
  handleRollOver: function (a) {
    if (a) {
      ...
      b.chartCursor &&
        "serial" == this.chartType &&
        ((c = !1),
        !b.chartCursor.valueBalloonsEnabled && this.showBalloon && (c = !0));
      if (c) {
...
AmCharts.ChartCursor = AmCharts.Class({
  ...
  createCursor: function () {
    ...
    a
      ? (e && (g.pointerWidth = 0),
        "right" == d
          ? e
            ? g.setBounds(n, r + m, n + p + l, r + s + m)
            : g.setBounds(n + p + l + f, r + m, n + p + 1e3, r + s + m)
          : e
          ? g.setBounds(n, r, p + n, s + r)
          : g.setBounds(-1e3, -1e3, n - q - f, r + s + 15))
      : ((g.maxWidth = p),
        c.parseDates && ((q = 0), (g.pointerWidth = 0)),
        "top" == d
          ? e
            ? g.setBounds(n + l, r + m, p + l + n, s + r)
            : g.setBounds(n + l, -1e3, p + l + n, r + m - q - f)
          : e
          ? g.setBounds(n, r, p + n, s + r - q)
          : g.setBounds(n, r + s + q + f - 1, n + p, r + s + q + f));
    this.hideCursor();
  },
  ...
  arrangeBalloons2: function () {
    ...
    for (e = 0; e < a.length; e++) {
      ...
      0 < e &&
        b - g < d + 3 &&
        (f.setBounds(c, d + 3, c + this.width, d + g + 3), f.draw());
      f.set && f.set.show();
      d = f.bottom;
    }
  },
      ...
      if (!d.hidden && d.balloonText) {
        ...
        if (!isNaN(f)) {
          ...
          d = AmCharts.circle(
            a,
            this.bulletSize / 2,
            this.chart.getBalloonColor(d, e),
            d.cursorBulletAlpha
          );
          d.translate(h, f);
    ...
    if (this.enabled) {
      ...
      if (r) {
        var p = r.x[f.id],
          ...
          y = c.graphs,
          B = f.axisThickness;
        if (c.mouseIsOver || C || w || this.forceShow)
          if (((this.forceShow = !1), w)) {
            ...
            0 !== d &&
              ...
              f.parseDates && !f.equalSpacing
                ? (c + d > x && (d = x - c),
                  ...
                  (g.end = c + d),
                  this.fire(g.type, g))
                : I + d >= this.data.length ||
                  0 > k + d ||
                  ((g.start = k + d), (g.end = I + d), this.fire(g.type, g)));
          } else {
            "start" == A && (p -= f.cellWidth / 2);
            "mouse" == A && c.mouseIsOver && (p = s ? e - 2 : d - 2);
            if (s) {
              if (0 > p)
                if (C) p = 0;
                else {
            ...
            0 < this.cursorAlpha &&
              ((v = this.line),
              s ? v.translate(0, p + h) : v.translate(p, 0),
              v.show());
            this.linePos = s ? p + h : p;
            C &&
              (s
                ? this.updateSelectionSize(NaN, p)
                : this.updateSelectionSize(p, NaN));
            v = !0;
            C && (v = !1);
            this.categoryBalloonEnabled && v
              ? (s
                  ? (q &&
                      ("right" == z
                        ? u.setBounds(k, l + h, k + m + g, l + p + h)
                        : u.setBounds(k, l + h, k + m + g, l + p)),
                    "right" == z
                      ? q
                        ? u.setPosition(k + m + g, l + p + h)
                        : u.setPosition(k + m + g + B, l + p + h)
                      : q
                      ? u.setPosition(k, l + p)
                      : u.setPosition(k - B, l + p))
                  : "top" == z
                  ? q
                    ? u.setPosition(k + p + g, l + h)
                    : u.setPosition(k + p + g, l + h - B + 1)
                  : q
                  ? u.setPosition(k + p, l + n)
                  : u.setPosition(k + p, l + n + B - 1),
                (x = this.categoryBalloonFunction)
                  ? u.showBalloon(x(r.category))
                  : f.parseDates
                  ? ((f = AmCharts.formatDate(
                    ...
                    -1 != f.indexOf("fff") &&
                      (f = AmCharts.formatMilliseconds(f, r.category)),
                    u.showBalloon(f))
                  : u.showBalloon(r.category))
              : u.hide();
            ...
            if (y && this.valueBalloonsEnabled && v && c.balloon.enabled) {
                ...
                for (f = 0; f < y.length; f++)
                  (x = y[f]),
                    x.showBalloon &&
                      !x.hidden &&
                      x.balloonText &&
                      ((t = r.axes[x.valueAxis.id].graphs[x.id]),
                      (u = t.y),
                      isNaN(u) ||
                        (s
                          ? Math.abs(d - u) < h &&
              ...
              for (f = 0; f < y.length; f++)
                if (
                  ...
                  p &&
                    ((p = x.valueBalloon),
                    (z = c.getBalloonColor(x, t)),
                    p.setBounds(k, l, k + m, l + n),
                    (p.pointerOrientation = "H"),
                    p.changeColor(z),
                    void 0 !== x.balloonAlpha && (p.fillAlpha = x.balloonAlpha),
                    void 0 !== x.balloonTextColor &&
                      (p.color = x.balloonTextColor),
                    p.setPosition(h + k, q + l),
                    (h = c.formatString(x.balloonText, t, x)),
                    (q = x.balloonFunction) && (h = q(t, x)),
                    "" !== h && p.showBalloon(h),
                    !s && p.set && p.set.hide(),
                    v.push({ yy: u, balloon: p }));
                }
...
AmCharts.ChartScrollbar = AmCharts.Class({
  ...
  init: function () {
    ...
    this.graph &&
      ((a = this.valueAxis),
      a ||
        ((this.valueAxis = a = new AmCharts.ValueAxis()),
        (a.visible = !1),
        (a.scrollbar = !0),
        (a.axisItemRenderer = AmCharts.RecItem),
        (a.axisRenderer = AmCharts.RecAxis),
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m) {
  ...
  var q = (1 / 180) * Math.PI,
    ...
    A = c + Math.sin((-d - e) * q) * g,
    z = b + Math.cos((d + e) * q) * h,
    q = c + Math.sin((-d - e) * q) * r,
    C = { fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0 },
    w = 0;
  180 < Math.abs(e) && (w = 1);
  d = a.set();
  var y;
    ...
    p
      ...
      : ((path = " M" + s + "," + (t + k) + " L" + u + "," + (v + k)),
        (path +=
          ...
          (q + k)),
        0 < h &&
          (path += " A" + h + "," + r + ",0," + w + ",0," + s + "," + (t + k)));
    path += " Z";
    var B = a.path(path, void 0, void 0, "1000,1000").attr(C);
    d.push(B);
    B = a
      .path(
        " M" +
...
AmCharts.AmPieChart = AmCharts.Class({
  ...
  drawChart: function () {
    ...
    if (AmCharts.ifArray(b)) {
      if (0 < a.realWidth && 0 < a.realHeight) {
        ...
        p ||
          ((e = 0 <= s ? e - h - k - 2 * q : e - h - k),
          (f = f - l - m),
          (p = Math.min(e, f)),
          f < e && ((p /= 1 - a.angle / 90), p > e && (p = e)),
          (a.pullOutRadiusReal = AmCharts.toCoordinate(a.pullOutRadius, p)),
          (p =
            0 <= s
              ? p - 1.8 * (s + a.pullOutRadiusReal)
              : p - 1.8 * a.pullOutRadiusReal),
          (p /= 2));
        ...
        for (m = 0; m < b.length; m++)
          if (((e = b[m]), !0 !== e.hidden && 0 < e.percents)) {
            ...
            if (
              a.labelsEnabled &&
              a.labelText &&
              e.percents >= a.hideLabelsPercent
            ) {
              var v = f + k / 2;
              0 >= v && (v += 360);
              k = s;
              ...
              if (0 <= k) {
                ...
                90 >= v && 0 <= v
                  ...
                  : 270 >= v && 180 < v
                  ? ((A = 2), (x = "end"), (u = -8))
                  : 180 >= v && 90 < v && ((A = 3), (x = "end"), (u = -8));
                e.labelQuarter = A;
              } else x = "middle";
              var v = a.formatString(a.labelText, e),
                z = e.labelColor;
              void 0 === z && (z = a.color);
              v = AmCharts.text(d, v, z, a.fontFamily, a.fontSize, x);
  ...
  setDepths: function () {
    ...
    for (b = 0; b < a.length; b++) {
      var c = a[b],
        d = c.wedge,
        c = c.startAngle;
      (90 >= c && 0 <= c) || (360 >= c && 270 < c)
        ? d.toFront()
        : ((270 >= c && 180 < c) || (180 >= c && 90 < c)) && d.toBack();
    }
  },
  addEventListeners: function (a, b) {
    var c = this;
    ...
    for (b = 0; b < a.length; b++)
      if (this.chartDataLabels[b]) {
        var c = a[b],
          ...
          d = AmCharts.line(
            this.container,
            [this.pieXReal + c.ix * e, c.tx, c.tx2],
            [this.pieYReal + c.iy * e, d, d],
            this.labelTickColor,
            this.labelTickAlpha
          );
        c.wedge.push(d);
  ...
  parseData: function () {
    ...
    if (void 0 !== b) {
      ...
      for (e = 0; e < a.length; e++)
        this.pieBaseColor
          ? (g = AmCharts.adjustLuminosity(
              this.pieBaseColor,
              (e * this.pieBrightnessStep) / 100
            ))
          : ((g = this.colors[e]),
...
AmCharts.AmXYChart = AmCharts.Class({
  ...
  drawChart: function () {
    ...
    AmCharts.ifArray(this.chartData)
      ? (this.chartScrollbar && this.updateScrollbars(), this.zoomChart())
      : this.cleanChart();
  ...
  dispatchAxisZoom: function () {
    ...
    for (b = 0; b < a.length; b++) {
      ...
      if (!isNaN(c.min) && !isNaN(c.max)) {
        var d, e;
        "V" == c.orientation
          ? ((d = c.coordinateToValue(-this.verticalPosition)),
            (e = c.coordinateToValue(
              -this.verticalPosition + this.plotAreaHeight
            )))
          : ((d = c.coordinateToValue(-this.horizontalPosition)),
            (e = c.coordinateToValue(
              -this.horizontalPosition + this.plotAreaWidth
            )));
        if (!isNaN(d) && !isNaN(e)) {
          if (d > e) {
            var f = e;
  ...
  addChartScrollbar: function (a) {
    ...
    if (a) {
      ...
      var b =
        "backgroundColor backgroundAlpha selectedBackgroundColor selectedBackgroundAlpha scrollDuration resizeEnabled hideResizeGrips scrollbarHeight updateOnReleaseOnly".split(
          " "
        );
      if (!this.hideYScrollbar) {
  ...
  updateMargins: function () {
    ...
    a &&
      (this.getScrollbarPosition(a, !0, this.yAxes[0].position),
  ...
  zoomScrollbars: function () {
    ...
    (a = this.scrollbarV) &&
      a.relativeZoom(
        ...
        -this.verticalPosition / this.heightMultiplier
      );
  },
  ...
  handleCursorZoom: function (a) {
    ...
    this.horizontalPosition =
      ((this.horizontalPosition - a.selectionX) * b) / this.widthMultiplier;
    this.verticalPosition =
      ((this.verticalPosition - a.selectionY) * c) / this.heightMultiplier;
    this.widthMultiplier = b;
...
AmCharts.AmStockChart = AmCharts.Class({
  ...
  updateDataSets: function () {
    ...
    for (b = 0; b < a.length; b++) {
      ...
      void 0 === c.color &&
        (c.color =
          this.colors.length - 1 > b ? this.colors[b] : AmCharts.randomColor());
    }
  },
  ...
  measurePanels: function () {
    ...
    for (e = 0; e < a.length; e++)
      (f = a[e]),
        (f.percentHeight = 100 * (f.percentHeight / d)),
        f.panelBox &&
          (f.panelBox.style.height =
            Math.round((f.percentHeight * this.panelsHeight) / 100) + "px");
  },
  ...
  addChartScrollbar: function () {
    ...
    if (a.enabled) {
      ...
      (d = this.periodSelector)
        ? "bottom" == d.position
          ? this.centerContainer.insertBefore(f, a)
          : this.centerContainer.appendChild(f)
        : this.centerContainer.appendChild(f);
      b.write(f);
    }
  },
      ...
      switch (a.position) {
        ...
        case "bottom":
          (e.style.marginTop = c + "px"),
            "bottom" == d ? h.insertBefore(e, b) : h.appendChild(e);
      }
  ...
  zoomChart: function (a, b) {
    ...
    if (d && e) {
      ...
      if (f) {
        ...
        a.getTime() == b.getTime() &&
          s != h &&
          ((b = AmCharts.changeDate(b, s.period, s.count)),
      ...
      h = new Date(a);
      h.getTime() == d.getTime() &&
        (h = AmCharts.resetDateToMin(a, g.period, g.count, p));
      for (d = 0; d < m.length; d++) {
        ...
        if (f != e) {
          ...
          if ((q = s.chartCursor))
            (q.categoryBalloonDateFormat =
              c.chartCursorSettings.categoryBalloonDateFormat(g.period)),
              s.showCategoryAxis || (q.categoryBalloonEnabled = !1);
        ...
        q ||
          ((s.startTime = void 0), (s.endTime = void 0), s.zoomToDates(h, b));
        0 < k.startDuration && c.animationPlayed
          ? ((s.startDuration = 0), s.animateAgain())
          : 0 < k.startDuration && s.animateAgain();
      }
      c.animationPlayed = !0;
        ...
        for (g = 0; g < f.length; g++) {
          ...
          if (h.comparable) {
            ...
            for (p = 0; p < r; p++) {
              ...
              q ||
                ((q = new AmCharts.AmGraph()),
                (q.id = "comparedGraph" + p + "_" + s.id));
              ...
              var u = !1,
                v = s.fieldMappings,
                x;
              for (x = 0; x < v.length; x++) v[x].toField == t && (u = !0);
              if (u) {
                q.valueField = t;
                q.title = s.title;
                q.lineColor = s.color;
                ...
                if ((t = h.compareGraphNegativeFillColors))
                  q.negativeFillColors = t;
                if ((t = h.compareGraphFillAlphas)) q.fillAlphas = t;
                if ((t = h.compareGraphNegativeFillAlphas))
                  q.negativeFillAlphas = t;
                ...
                l &&
                  (k && m
                    ? (q.legendValueText = m)
                    : n && (q.legendValueText = n));
                c.addGraph(q);
                this.comparedGraphs.push({ graph: q, dataSet: s });
              }
            }
          }
          l &&
            (k && m ? (h.legendValueText = m) : n && (h.legendValueText = n));
        }
      }
    }
  },
...
AmCharts.PeriodSelector = AmCharts.Class({
  ...
  write: function (a) {
    ...
    if (b.inputFieldsEnabled) {
      ...
      AmCharts.isIE &&
        h.attachEvent("onkeypress", function (a) {
          b.handleCalendarChange.call(b, a);
        });
      f.appendChild(h);
      b.startDateField = h;
    ...
    h &&
      ...
      ("MAX" == e
        ...
        ? ((f = new Date()),
          f.setMonth(0, 1),
          f.setHours(0, 0, 0, 0),
          0 === d && f.setDate(f.getDate() - 1),
          (g = this.lastDate))
        : ((l = AmCharts.getPeriodDuration(e, d)),
          this.selectFromStart
            ? ((f = h), (g = new Date(h.getTime() + l)))
            : ((f = new Date(k.getTime() - l)), (g = k))),
      (a.startTime = f.getTime()),
      this.hideOutOfScopePeriods &&
        (b && a.startTime < h.getTime()
          ? (c.style.display = "none")
          : (c.style.display = "inline")),
      f.getTime() > k.getTime() &&
        ((l = AmCharts.getPeriodDuration("DD", 1)),
        (f = new Date(k.getTime() - l))),
      f.getTime() < h.getTime() && (f = h),
      "YTD" == e && (a.startTime = f.getTime()),
      (a.endTime = g.getTime()),
      b ||
        ((this.skipMark = !0),
    ...
    if (!this.skipMark) {
      ...
      for (d = b.length - 1; 0 <= d; d--) {
        ...
        e.startTime &&
          ...
          c == e.startTime &&
          a == e.endTime &&
          (this.unselectButtons(), (f.className = "amChartsButtonSelected"));
      }
    }
    this.skipMark = !1;
  },
...
AmCharts.StockPanel = AmCharts.Class({
  ...
  initChart: function (a) {
    ...
    if ((a = this.chartCursor))
      this.removeListener(a, "draw", this.handleDraw),
        this.listenTo(a, "draw", this.handleDraw);
  },
  ...
  if (g) {
    ...
    for (l = 0; l < m; l++) {
      var t = f[l],
        ...
        v = u.getTime(),
        x = {};
      for (n = 0; n < q; n++) x[s[n].toField] = t[s[n].fromField];
      var A;
      for (A = h; A < k; A++) {
        n = c[A];
        ...
        if (A == h || v >= r[n] || !r[n]) {
          p[n] = {};
          p[n][g] = new Date(u);
          p[n].amCategoryIdField = String(
            AmCharts.resetDateToMin(u, C, z, d).getTime()
          );
          var I;
          for (I = 0; I < q; I++)
            (y = s[I].toField),
          ...
          A > h &&
            ((w = new Date(u)),
            (w = AmCharts.changeDate(w, C, z, !0)),
            (w = AmCharts.resetDateToMin(w, C, z, d)),
            (r[n] = w.getTime()));
          if (A == h) for (var J in t) t.hasOwnProperty(J) && (p[n][J] = t[J]);
        } else
          for (C = 0; C < q; C++)
            (y = s[C].toField),
              (w = p[n]),
              l == m - 1 && (w[g] = new Date(u)),
              (B = Number(x[y])),
              isNaN(B) ||
                (isNaN(w[y + "Low"]) && (w[y + "Low"] = B),
                B < w[y + "Low"] && (w[y + "Low"] = B),
                isNaN(w[y + "High"]) && (w[y + "High"] = B),
                B > w[y + "High"] && (w[y + "High"] = B),
                (w[y + "Close"] = B),
                (w[y + "Sum"] += B),
                w[y + "Count"]++,
                (w[y + "Average"] = w[y + "Sum"] / w[y + "Count"]));
      }
    }
  }
  a.agregatedDataProviders = e;
...
AmCharts.parseEvents = function (a, b, c, d, e) {
  var f = a.stockEvents,
    ...
    s;
  for (k = 0; k < h; k++)
    for (p = b[k], r = p.graphs, m = r.length, l = 0; l < m; l++)
      (n = r[l]),
        (n.customBulletField = "amCustomBullet" + n.id + "_" + p.id),
        (n.bulletConfigField = "amCustomBulletConfig" + n.id + "_" + p.id);
  for (var q in g)
      ...
      for (x = 0; x < v; x++) {
        ...
        C =
          "fff" == l
            ? k.getTime() + 1
            : AmCharts.resetDateToMin(
                AmCharts.changeDate(new Date(k), u.period, u.count),
                l,
                m,
                d
              ).getTime();
          ...
          for (p = b[k], r = p.graphs, m = r.length, l = 0; l < m; l++) {
            ...
            for (s = 0; s < f.length; s++) {
              ...
              n == y.graph &&
                B >= z &&
                B < C &&
                (w.eventObjects.push(y),
                w.letters.push(y.text),
                w.descriptions.push(y.description),
                y.type ? w.shapes.push(y.type) : w.shapes.push(c.type),
                void 0 !== y.backgroundColor
                  ? w.backgroundColors.push(y.backgroundColor)
                  : w.backgroundColors.push(c.backgroundColor),
                isNaN(y.backgroundAlpha)
                  ? w.backgroundAlphas.push(c.backgroundAlpha)
                  : w.backgroundAlphas.push(y.backgroundAlpha),
                isNaN(y.borderAlpha)
                  ? w.borderAlphas.push(c.borderAlpha)
                  : w.borderAlphas.push(y.borderAlpha),
                void 0 !== y.borderColor
                  ? w.borderColors.push(y.borderColor)
                  : w.borderColors.push(c.borderColor),
                void 0 !== y.rollOverColor
                  ? w.rollOverColors.push(y.rollOverColor)
                  : w.rollOverColors.push(c.rollOverColor),
                w.colors.push(y.color),
                !y.panel && y.graph && (y.panel = y.graph.chart),
                w.showOnAxis.push(y.showOnAxis),
                (w.date = new Date(y.date)));
            }
            0 < w.shapes.length &&
              ((s = "amCustomBullet" + n.id + "_" + p.id),
              (n = "amCustomBulletConfig" + n.id + "_" + p.id),
              (A[s] = AmCharts.StackedBullet),
              (A[n] = w));
          }
      }
    }
...
AmCharts.DataSetSelector = AmCharts.Class({
  ...
  write: function (a) {
    ...
    if (1 < b.countDataSets("showInSelect")) {
      ...
      AmCharts.isIE &&
        k.attachEvent("onchange", function (a) {
          b.handleDataSetChange.call(b, a);
        });
    ...
    if (0 < b.countDataSets("showInCompare") && 1 < d.length)
      if (
        ...
        for (c = 0; c < d.length; c++)
          (g = d[c]),
            !0 === g.showInCompare &&
              ...
              (e.name = "amCBContainer"),
              (e.dataSet = g),
              (e.style.height = h + "px"),
              g.compared &&
                (e.style.backgroundColor = b.selectedBackgroundColor),
              f.appendChild(e),
              (k = document.createElement("div")),
              (k.style.width = h + "px"),
              (k.style.height = h + "px"),
              (k.style.position = "absolute"),
              (k.style.backgroundColor = g.color),
              e.appendChild(k),
              (k = document.createElement("div")),
              (k.style.width = "100%"),
              (k.style.position = "absolute"),
              (k.style.left = h + 10 + "px"),
              e.appendChild(k),
              (g = document.createTextNode(g.title)),
              (k.style.whiteSpace = "nowrap"),
              (k.style.cursor = "default"),
              k.appendChild(g),
              b.addEventListeners(e));
        AmCharts.addBr(a);
        AmCharts.addBr(a);
      } else {
        ...
        for (c = 0; c < d.length; c++)
          if (
            ((g = d[c]), !0 === g.showInCompare && g != b.chart.mainDataSet)
          ) {
            h = document.createElement("option");
            h.text = g.title;
            h.value = c;
...
AmCharts.StackedBullet = AmCharts.Class({
  ...
  addLetter: function (a, b, c) {
    ...
    this.bullets[c] = l;
    this.showOnAxis
      ? ((l = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY),
        (k = g * e),
        (this.nextAxisY = l + e * d))
      : ((l = this.nextY), (k = g * e));
    a.translate(h, k);
    b.push(a);
    b.translate(0, l);
...
AmCharts.AmDraw = AmCharts.Class({
  ...
  easeOutElastic: function (a, b, c, d, e) {
    ...
    return (
      g * Math.pow(2, -10 * b) * Math.sin((2 * (b * e - a) * Math.PI) / f) +
      d +
      c
    );
  },
  ...
  rotate: function (a, b) {
    if (0 !== Number(b)) {
      ...
      var e = (b * Math.PI) / 180,
        ...
        m = b / Math.abs(b);
      d.left =
        h + l / 2 - (l / 2) * Math.cos(e) - ((m * c) / 2) * Math.sin(e) + 3;
      ...
      d <= c
          ...
          "translate" == f
            ? ((g = b.from.split(",")),
              ...
              (k =
                0 === k - f
                  ? k
                  : Math.round(this.D[b.effect](0, d, f, k - f, c))),
              (b =
                0 === h - g
                  ? h
                  : Math.round(this.D[b.effect](0, d, g, h - g, c))),
              (f = "transform"),
              (b = "translate(" + k + "," + b + ")"))
            : ((g = Number(b.from)),
              (k = Number(b.to)),
        ...
        : ("translate" == f
            ? ((h = b.to.split(",")),
              ...
              (h = Number(h[1])),
              e.translate(k, h))
            : ((k = Number(b.to)), this.setAttr(e, f, k)),
