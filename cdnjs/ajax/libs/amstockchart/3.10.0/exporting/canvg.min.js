(function () {
  this.canvg = function (j, m, b) {
    ...
    var h = a();
    if (!(j.childNodes.length == 1 && j.childNodes[0].nodeName == "OBJECT")) {
      j.svg = h;
    }
    h.opts = b;
    var l = j.getContext("2d");
    if (typeof m.documentElement != "undefined") {
      h.loadXmlDoc(l, m);
    } else {
      if (m.substr(0, 1) == "<") {
        h.loadXml(l, m);
  ...
  function a() {
    ...
    b.Property.prototype.valueOrDefault = function (c) {
      if (this.hasValue()) {
        return this.value;
      }
      return c;
    };
    b.Property.prototype.numValueOrDefault = function (c) {
      if (this.hasValue()) {
    ...
    b.Property.prototype.addOpacity = function (d) {
      var e = this.value;
      if (d != null && d != "" && typeof this.value == "string") {
        var c = new RGBColor(this.value);
        if (c.ok) {
          e = "rgba(" + c.r + ", " + c.g + ", " + c.b + ", " + d + ")";
        }
      }
    ...
    b.Property.prototype.getFillStyleDefinition = function (g, f) {
      var c = this.getDefinition();
      if (c != null && c.createGradient) {
        return c.createGradient(b.ctx, g, f);
      }
      if (c != null && c.createPattern) {
        if (c.getHrefAttribute().hasValue()) {
          var d = c.attribute("patternTransform");
          c = c.getHrefAttribute().getDefinition();
          if (d.hasValue()) {
            c.attribute("patternTransform", true).value = d.value;
          }
        }
        return c.createPattern(b.ctx, g);
      }
      return null;
    };
    b.Property.prototype.getDPI = function (c) {
      return 96;
    };
    b.Property.prototype.getEM = function (e) {
      var c = 12;
    ...
    b.Property.prototype.toPixels = function (e, c) {
      if (!this.hasValue()) {
        return 0;
      }
      var d = this.value + "";
      ...
      if (d.match(/%$/)) {
        return this.numValue() * b.ViewPort.ComputeSize(e);
      }
      var f = this.numValue();
      if (c && f < 1) {
        return f * b.ViewPort.ComputeSize(e);
      }
      return f;
    };
    ...
    b.ToNumberArray = function (e) {
      var c = b.trim(b.compressSpaces((e || "").replace(/,/g, " "))).split(" ");
    ...
    b.Point.prototype.angleTo = function (c) {
      return Math.atan2(c.y - this.y, c.x - this.x);
    };
    b.Point.prototype.applyTransform = function (c) {
      var d = this.x * c[0] + this.y * c[2] + c[4];
      var e = this.x * c[1] + this.y * c[3] + c[5];
      this.x = d;
      this.y = e;
    };
      ...
      this.addBezierCurve = function (v, u, l, j, q, o, x, w) {
        ...
        for (i = 0; i <= 1; i++) {
          var y = function (C) {
            return (
              Math.pow(1 - C, 3) * m[i] +
              3 * Math.pow(1 - C, 2) * C * k[i] +
              3 * (1 - C) * Math.pow(C, 2) * h[i] +
              Math.pow(C, 3) * g[i]
            );
          };
    ...
    b.Transform = function (c) {
      ...
      this.Type.translate = function (k) {
        ...
        this.unapply = function (l) {
          l.translate(-1 * this.p.x || 0, -1 * this.p.y || 0);
        };
        this.applyToPoint = function (l) {
          l.applyTransform([1, 0, 0, 1, this.p.x || 0, this.p.y || 0]);
        };
      };
      this.Type.rotate = function (l) {
        ...
        this.apply = function (m) {
          ...
          m.rotate(this.angle.toRadians());
          m.translate(-this.cx, -this.cy);
        };
        this.unapply = function (m) {
          m.translate(this.cx, this.cy);
          m.rotate(-1 * this.angle.toRadians());
          m.translate(-this.cx, -this.cy);
        };
        this.applyToPoint = function (n) {
          var m = this.angle.toRadians();
      ...
      this.Type.scale = function (k) {
        ...
        this.unapply = function (l) {
          l.scale(1 / this.p.x || 1, 1 / this.p.y || this.p.x || 1);
        };
        this.applyToPoint = function (l) {
          l.applyTransform([this.p.x || 0, 0, 0, this.p.y || 0, 0, 0]);
        };
      };
      ...
      this.unapply = function (k) {
        for (var l = this.transforms.length - 1; l >= 0; l--) {
          this.transforms[l].unapply(k);
        }
      };
      this.applyToPoint = function (l) {
      ...
      var j = b
        .trim(b.compressSpaces(c))
        .replace(/\)(\s?,\s?)/g, ") ")
        .split(/\s(?=[a-z])/);
      for (var e = 0; e < j.length; e++) {
        var g = b.trim(j[e].split("(")[0]);
    ...
    b.AspectRatio = function (s, q, d, k, r, c, g, f, p, o) {
      ...
      if (p.hasValue() && o.hasValue()) {
        s.translate(-h * p.toPixels("x"), -h * o.toPixels("y"));
      } else {
        if (
          j.match(/^xMid/) &&
    ...
    b.Element.ElementBase = function (g) {
      ...
      this.styles = {};
      this.children = [];
      this.attribute = function (p, q) {
        var j = this.attributes[p];
        if (j != null) {
          return j;
        }
        if (q == true) {
      ...
      this.style = function (q, v) {
        var r = this.styles[q];
        if (r != null) {
          return r;
        }
        var j = this.attribute(q);
      ...
      this.render = function (p) {
        ...
        if (this.attribute("mask").hasValue()) {
          var j = this.attribute("mask").getDefinition();
          if (j != null) {
            j.apply(p, this);
          }
        } else {
          if (this.style("filter").hasValue()) {
            var q = this.style("filter").getDefinition();
            if (q != null) {
              q.apply(p, this);
            }
          } else {
      ...
      this.renderChildren = function (j) {
        for (var p = 0; p < this.children.length; p++) {
          this.children[p].render(j);
        }
      };
      this.addChild = function (p, j) {
        var q = p;
        if (j) {
          q = b.CreateElement(p);
        }
      ...
      if (g != null && g.nodeType == 1) {
        for (var l = 0; l < g.childNodes.length; l++) {
          ...
          if (this.captureTextNodes && c.nodeType == 3) {
            var n = c.nodeValue || c.text || "";
            if (b.trim(b.compressSpaces(n)) != "") {
        ...
        for (var l = 0; l < g.attributes.length; l++) {
          ...
          this.attributes[f.nodeName] = new b.Property(f.nodeName, f.nodeValue);
        }
        var o = b.Styles[g.nodeName];
        if (o != null) {
          for (var e in o) {
            this.styles[e] = o[e];
          }
        ...
        if (this.attribute("class").hasValue()) {
          var h = b.compressSpaces(this.attribute("class").value).split(" ");
        ...
        if (this.attribute("id").hasValue()) {
          var o = b.Styles["#" + this.attribute("id").value];
          if (o != null) {
            for (var e in o) {
              this.styles[e] = o[e];
            }
        ...
        if (this.attribute("style").hasValue()) {
          var o = this.attribute("style").value.split(";");
    ...
    b.Element.RenderedElementBase = function (c) {
      ...
      this.base(c);
      this.setContext = function (m) {
        if (this.style("fill").isUrlDefinition()) {
          var j = this.style("fill").getFillStyleDefinition(
            this,
          ...
          if (this.style("fill").hasValue()) {
            var l = this.style("fill");
            if (l.value == "currentColor") {
              l.value = this.style("color").value;
            }
            m.fillStyle = l.value == "none" ? "rgba(0,0,0,0)" : l.value;
          }
        }
        if (this.style("fill-opacity").hasValue()) {
          var l = new b.Property("fill", m.fillStyle);
          l = l.addOpacity(this.style("fill-opacity").value);
          m.fillStyle = l.value;
        }
        if (this.style("stroke").isUrlDefinition()) {
          var j = this.style("stroke").getFillStyleDefinition(
            this,
          ...
          if (this.style("stroke").hasValue()) {
            var k = this.style("stroke");
            if (k.value == "currentColor") {
              k.value = this.style("color").value;
            }
            m.strokeStyle = k.value == "none" ? "rgba(0,0,0,0)" : k.value;
          }
        }
        if (this.style("stroke-opacity").hasValue()) {
          var k = new b.Property("stroke", m.strokeStyle);
          k = k.addOpacity(this.style("stroke-opacity").value);
          m.strokeStyle = k.value;
        }
        if (this.style("stroke-width").hasValue()) {
          var h = this.style("stroke-width").toPixels();
          m.lineWidth = h == 0 ? 0.001 : h;
        }
        if (this.style("stroke-linecap").hasValue()) {
          m.lineCap = this.style("stroke-linecap").value;
        }
        if (this.style("stroke-linejoin").hasValue()) {
          m.lineJoin = this.style("stroke-linejoin").value;
        }
        if (this.style("stroke-miterlimit").hasValue()) {
          m.miterLimit = this.style("stroke-miterlimit").value;
        }
        if (this.style("stroke-dasharray").hasValue()) {
          var f = b.ToNumberArray(this.style("stroke-dasharray").value);
          if (typeof m.setLineDash != "undefined") {
            m.setLineDash(f);
          } else {
            if (typeof m.webkitLineDash != "undefined") {
              m.webkitLineDash = f;
            } else {
              if (typeof m.mozDash != "undefined") {
                m.mozDash = f;
              }
            }
          }
          var g = this.style("stroke-dashoffset").numValueOrDefault(1);
          if (typeof m.lineDashOffset != "undefined") {
            m.lineDashOffset = g;
          } else {
            if (typeof m.webkitLineDashOffset != "undefined") {
              m.webkitLineDashOffset = g;
            } else {
              if (typeof m.mozDashOffset != "undefined") {
                m.mozDashOffset = g;
              }
            }
          }
        }
        if (typeof m.font != "undefined") {
          m.font = b.Font.CreateFont(
        ...
        if (this.attribute("transform").hasValue()) {
          var d = new b.Transform(this.attribute("transform").value);
          d.apply(m);
        }
        if (this.style("clip-path").hasValue()) {
          var e = this.style("clip-path").getDefinition();
          if (e != null) {
            e.apply(m);
          }
        }
        if (this.style("opacity").hasValue()) {
          m.globalAlpha = this.style("opacity").numValue();
        }
      };
    };
      ...
      this.renderChildren = function (e) {
        ...
        if (g != null) {
          ...
          if (this.style("marker-mid").isUrlDefinition()) {
            var d = this.style("marker-mid").getDefinition();
    ...
    b.Element.svg = function (c) {
      ...
      this.setContext = function (g) {
        ...
        if (typeof this.root == "undefined") {
          h = this.attribute("width").toPixels("x");
    ...
    b.Element.rect = function (c) {
      ...
      this.path = function (f) {
        ...
        var k = this.attribute("y").toPixels("y");
        var g = this.attribute("width").toPixels("x");
        var d = this.attribute("height").toPixels("y");
        var j = this.attribute("rx").toPixels("x");
        var h = this.attribute("ry").toPixels("y");
        if (
    ...
    b.Element.circle = function (c) {
      ...
      this.path = function (e) {
        var d = this.attribute("cx").toPixels("x");
        var g = this.attribute("cy").toPixels("y");
        var f = this.attribute("r").toPixels();
        if (e != null) {
          e.beginPath();
    ...
    b.Element.ellipse = function (c) {
      ...
      this.path = function (e) {
        ...
        var h = this.attribute("rx").toPixels("x");
        ...
        if (e != null) {
          e.beginPath();
          e.moveTo(d, j - f);
          e.bezierCurveTo(d + g * h, j - f, d + h, j - g * f, d + h, j);
          e.bezierCurveTo(d + h, j + g * f, d + g * h, j + f, d, j + f);
          e.bezierCurveTo(d - g * h, j + f, d - h, j + g * f, d - h, j);
          e.bezierCurveTo(d - h, j - g * f, d - g * h, j - f, d, j - f);
          e.closePath();
        }
    ...
    b.Element.polyline = function (c) {
      ...
      this.getMarkers = function () {
        ...
        for (var d = 0; d < this.points.length - 1; d++) {
          e.push([this.points[d], this.points[d].angleTo(this.points[d + 1])]);
        }
    ...
    b.Element.path = function (c) {
      ...
      this.PathParser = new (function (f) {
        ...
        this.addMarker = function (g, h, d) {
          ...
          this.addMarkerAngle(g, h == null ? null : h.angleTo(g));
        };
        ...
        while (!K.isEnd()) {
          ...
          switch (K.command) {
            ...
            case "m":
              ...
              K.start = K.current;
              while (!K.isCommandOrEnd()) {
                var F = K.getAsCurrentPoint();
                K.addMarker(F, K.start);
                t.addPoint(F.x, F.y);
                if (I != null) {
                  I.lineTo(F.x, F.y);
                }
            ...
            case "h":
              while (!K.isCommandOrEnd()) {
                var g = new b.Point(
                  (K.isRelativeCommand() ? K.current.x : 0) + K.getScalar(),
                  K.current.y
                );
                K.addMarker(g, K.current);
                K.current = g;
                t.addPoint(K.current.x, K.current.y);
                if (I != null) {
                  I.lineTo(K.current.x, K.current.y);
                }
              }
              break;
            case "V":
            case "v":
              while (!K.isCommandOrEnd()) {
                var g = new b.Point(
                  K.current.x,
                  (K.isRelativeCommand() ? K.current.y : 0) + K.getScalar()
                );
                K.addMarker(g, K.current);
                K.current = g;
                t.addPoint(K.current.x, K.current.y);
            ...
            case "c":
              while (!K.isCommandOrEnd()) {
                var M = K.current;
                var j = K.getPoint();
                var k = K.getAsControlPoint();
                var x = K.getAsCurrentPoint();
                K.addMarker(x, k, j);
                t.addBezierCurve(M.x, M.y, j.x, j.y, k.x, k.y, x.x, x.y);
                if (I != null) {
                  I.bezierCurveTo(j.x, j.y, k.x, k.y, x.x, x.y);
                }
              }
              break;
            case "S":
            case "s":
              while (!K.isCommandOrEnd()) {
                var M = K.current;
                var j = K.getReflectedControlPoint();
                var k = K.getAsControlPoint();
                var x = K.getAsCurrentPoint();
                K.addMarker(x, k, j);
                t.addBezierCurve(M.x, M.y, j.x, j.y, k.x, k.y, x.x, x.y);
            ...
            case "q":
              while (!K.isCommandOrEnd()) {
                ...
                var x = K.getAsCurrentPoint();
                K.addMarker(x, k, k);
                t.addQuadraticCurve(M.x, M.y, k.x, k.y, x.x, x.y);
                if (I != null) {
                  I.quadraticCurveTo(k.x, k.y, x.x, x.y);
                }
              }
              break;
            case "T":
            case "t":
              while (!K.isCommandOrEnd()) {
                var M = K.current;
                var k = K.getReflectedControlPoint();
                K.control = k;
                var x = K.getAsCurrentPoint();
                K.addMarker(x, k, k);
                t.addQuadraticCurve(M.x, M.y, k.x, k.y, x.x, x.y);
            ...
            case "a":
              while (!K.isCommandOrEnd()) {
                ...
                var q = K.getScalar();
                var o = K.getScalar();
                var f = K.getScalar() * (Math.PI / 180);
                var w = K.getScalar();
                var n = K.getScalar();
                var x = K.getAsCurrentPoint();
                var R = new b.Point(
                  (Math.cos(f) * (M.x - x.x)) / 2 +
                    (Math.sin(f) * (M.y - x.y)) / 2,
                  (-Math.sin(f) * (M.x - x.x)) / 2 +
                    (Math.cos(f) * (M.y - x.y)) / 2
                );
                var J =
                  Math.pow(R.x, 2) / Math.pow(q, 2) +
                  Math.pow(R.y, 2) / Math.pow(o, 2);
                if (J > 1) {
                  q *= Math.sqrt(J);
                  o *= Math.sqrt(J);
                }
                var B =
                  (w == n ? -1 : 1) *
                  Math.sqrt(
                    (Math.pow(q, 2) * Math.pow(o, 2) -
                      Math.pow(q, 2) * Math.pow(R.y, 2) -
                      Math.pow(o, 2) * Math.pow(R.x, 2)) /
                      (Math.pow(q, 2) * Math.pow(R.y, 2) +
                        Math.pow(o, 2) * Math.pow(R.x, 2))
                  );
                if (isNaN(B)) {
                ...
                var A = new b.Point((B * q * R.y) / o, (B * -o * R.x) / q);
                var h = new b.Point(
                  (M.x + x.x) / 2 + Math.cos(f) * A.x - Math.sin(f) * A.y,
                  (M.y + x.y) / 2 + Math.sin(f) * A.x + Math.cos(f) * A.y
                );
                var H = function (l) {
                  return Math.sqrt(Math.pow(l[0], 2) + Math.pow(l[1], 2));
                };
                var D = function (m, l) {
                  return (m[0] * l[0] + m[1] * l[1]) / (H(m) * H(l));
                };
                var P = function (m, l) {
                  return (
                    (m[0] * l[1] < m[1] * l[0] ? -1 : 1) * Math.acos(D(m, l))
                  );
                };
                var Q = P([1, 0], [(R.x - A.x) / q, (R.y - A.y) / o]);
                var z = [(R.x - A.x) / q, (R.y - A.y) / o];
                var y = [(-R.x - A.x) / q, (-R.y - A.y) / o];
                var N = P(z, y);
                if (D(z, y) <= -1) {
                  N = Math.PI;
                }
                ...
                K.addMarkerAngle(d, L - (G * Math.PI) / 2);
                K.addMarkerAngle(x, L - G * Math.PI);
                t.addPoint(x.x, x.y);
                if (I != null) {
                  var D = q > o ? q : o;
                  var E = q > o ? 1 : q / o;
    ...
    b.Element.pattern = function (c) {
      this.base = b.Element.ElementBase;
      this.base(c);
      this.createPattern = function (n, f) {
        var d = this.attribute("width").toPixels("x", true);
        var m = this.attribute("height").toPixels("y", true);
        var k = new b.Element.svg();
        k.attributes.viewBox = new b.Property(
          "viewBox",
          this.attribute("viewBox").value
        );
        k.attributes.width = new b.Property("width", d + "px");
        k.attributes.height = new b.Property("height", m + "px");
        k.attributes.transform = new b.Property(
          "transform",
        ...
        for (var l = -1; l <= 1; l++) {
          for (var j = -1; j <= 1; j++) {
            e.save();
            e.translate(l * h.width, j * h.height);
            k.render(e);
            e.restore();
          }
        }
    ...
    b.Element.marker = function (c) {
      ...
      this.render = function (e, d, g) {
        ...
        f.attributes.viewBox = new b.Property(
          "viewBox",
          this.attribute("viewBox").value
        );
        f.attributes.refX = new b.Property(
          "refX",
          this.attribute("refX").value
        );
        f.attributes.refY = new b.Property(
          "refY",
          this.attribute("refY").value
        );
        f.attributes.width = new b.Property(
          "width",
          this.attribute("markerWidth").value
        );
        f.attributes.height = new b.Property(
          "height",
          this.attribute("markerHeight").value
        );
        f.attributes.fill = new b.Property(
          "fill",
          this.attribute("fill").valueOrDefault("black")
        );
        f.attributes.stroke = new b.Property(
          "stroke",
    ...
    b.Element.GradientBase = function (d) {
      ...
      this.createGradient = function (t, k, f) {
        var s = this;
        ...
        var j = function (g) {
          if (f.hasValue()) {
            var u = new b.Property("color", g);
            return u.addOpacity(f.value).value;
          }
          return g;
        };
        var m = this.getGradient(t, k);
        if (m == null) {
          return j(s.stops[s.stops.length - 1].color);
        }
        for (var l = 0; l < s.stops.length; l++) {
          m.addColorStop(s.stops[l].offset, j(s.stops[l].color));
        }
        if (this.attribute("gradientTransform").hasValue()) {
          var o = b.ViewPort.viewPorts[0];
          var p = new b.Element.rect();
          p.attributes.x = new b.Property("x", -b.MAX_VIRTUAL_PIXELS / 3);
          p.attributes.y = new b.Property("y", -b.MAX_VIRTUAL_PIXELS / 3);
          p.attributes.width = new b.Property("width", b.MAX_VIRTUAL_PIXELS);
          p.attributes.height = new b.Property("height", b.MAX_VIRTUAL_PIXELS);
          var r = new b.Element.g();
          r.attributes.transform = new b.Property(
            "transform",
          ...
          q.attributes.width = new b.Property("width", o.width);
          q.attributes.height = new b.Property("height", o.height);
          q.children = [r];
          ...
          h.fillStyle = m;
          q.render(h);
          return h.createPattern(n, "no-repeat");
        }
        return m;
      };
    };
      ...
      this.getGradient = function (d, h) {
        ...
        var f =
          this.gradientUnits == "objectBoundingBox"
            ? k.x() + k.width() * this.attribute("x1").numValue()
            : this.attribute("x1").toPixels("x");
        var j =
          this.gradientUnits == "objectBoundingBox"
            ? k.y() + k.height() * this.attribute("y1").numValue()
            : this.attribute("y1").toPixels("y");
        var e =
          this.gradientUnits == "objectBoundingBox"
            ? k.x() + k.width() * this.attribute("x2").numValue()
            : this.attribute("x2").toPixels("x");
        var g =
          this.gradientUnits == "objectBoundingBox"
            ? k.y() + k.height() * this.attribute("y2").numValue()
            : this.attribute("y2").toPixels("y");
        if (f == e && j == g) {
          return null;
        }
        return d.createLinearGradient(f, j, e, g);
      };
    };
    ...
    b.Element.radialGradient = function (c) {
      this.base = b.Element.GradientBase;
      this.base(c);
      this.getGradient = function (e, f) {
        var k = f.getBoundingBox();
        ...
        var d =
          this.gradientUnits == "objectBoundingBox"
            ? k.x() + k.width() * this.attribute("cx").numValue()
            : this.attribute("cx").toPixels("x");
        var l =
          this.gradientUnits == "objectBoundingBox"
            ? k.y() + k.height() * this.attribute("cy").numValue()
        ...
        if (this.attribute("fx").hasValue()) {
          j =
            this.gradientUnits == "objectBoundingBox"
              ? k.x() + k.width() * this.attribute("fx").numValue()
              : this.attribute("fx").toPixels("x");
        }
        if (this.attribute("fy").hasValue()) {
          g =
            this.gradientUnits == "objectBoundingBox"
              ? k.y() + k.height() * this.attribute("fy").numValue()
              : this.attribute("fy").toPixels("y");
        }
        var h =
          this.gradientUnits == "objectBoundingBox"
            ? ((k.width() + k.height()) / 2) * this.attribute("r").numValue()
            : this.attribute("r").toPixels();
        return e.createRadialGradient(j, g, 0, d, l, h);
      };
    };
    ...
    b.Element.AnimateBase = function (c) {
      ...
      this.progress = function () {
        ...
        if (this.values.hasValue()) {
          var g = e.progress * (this.values.value.length - 1);
          var f = Math.floor(g),
            d = Math.ceil(g);
          e.from = new b.Property("from", parseFloat(this.values.value[f]));
          e.to = new b.Property("to", parseFloat(this.values.value[d]));
          e.progress = (g - f) / (d - f);
        } else {
          e.from = this.from;
          e.to = this.to;
    ...
    b.Element.animate = function (c) {
      ...
      this.calcValue = function () {
        ...
        var d =
          e.from.numValue() +
          (e.to.numValue() - e.from.numValue()) * e.progress;
        return d + this.initialUnits;
      };
    };
    ...
    b.Element.animateColor = function (c) {
      ...
      this.calcValue = function () {
        var h = this.progress();
        var k = new RGBColor(h.from.value);
        var j = new RGBColor(h.to.value);
        if (k.ok && j.ok) {
          var f = k.r + (j.r - k.r) * h.progress;
          var e = k.g + (j.g - k.g) * h.progress;
          var d = k.b + (j.b - k.b) * h.progress;
          return (
            "rgb(" +
            parseInt(f, 10) +
            "," +
    ...
    b.Element.animateTransform = function (c) {
      ...
      this.calcValue = function () {
        var f = this.progress();
        var h = b.ToNumberArray(f.from.value);
        var g = b.ToNumberArray(f.to.value);
        var e = "";
        for (var d = 0; d < h.length; d++) {
          e += h[d] + (g[d] - h[d]) * f.progress + " ";
        }
        return e;
      };
    };
    b.Element.animateTransform.prototype = new b.Element.animate();
    b.Element.font = function (d) {
      this.base = b.Element.ElementBase;
      this.base(d);
      ...
      for (var c = 0; c < this.children.length; c++) {
        ...
        if (e.type == "font-face") {
          this.fontFace = e;
          if (e.style("font-family").hasValue()) {
            b.Definitions[e.style("font-family").value] = this;
          }
        } else {
          if (e.type == "missing-glyph") {
            this.missingGlyph = e;
          } else {
            if (e.type == "glyph") {
              if (e.arabicForm != "") {
                this.isRTL = true;
                this.isArabic = true;
                if (typeof this.glyphs[e.unicode] == "undefined") {
                  this.glyphs[e.unicode] = [];
                }
                this.glyphs[e.unicode][e.arabicForm] = e;
              } else {
                this.glyphs[e.unicode] = e;
              }
            }
          }
        }
    ...
    b.Element.text = function (c) {
      ...
      this.setContext = function (d) {
        ...
        if (this.style("dominant-baseline").hasValue()) {
          d.textBaseline = this.style("dominant-baseline").value;
        }
        if (this.style("alignment-baseline").hasValue()) {
          d.textBaseline = this.style("alignment-baseline").value;
        }
      };
      this.getBoundingBox = function () {
        return new b.BoundingBox(
      ...
      this.renderChildren = function (d) {
        ...
        this.x += this.getAnchorDelta(d, this, 0);
        for (var e = 0; e < this.children.length; e++) {
          this.renderChild(d, this, e);
        }
      };
      this.getAnchorDelta = function (e, j, h) {
        var d = this.style("text-anchor").valueOrDefault("start");
        if (d != "start") {
          var g = 0;
          for (var f = h; f < j.children.length; f++) {
            var k = j.children[f];
            if (f > h && k.attribute("x").hasValue()) {
              break;
            }
            g += k.measureTextRecursive(e);
          }
          return -1 * (d == "end" ? g : g / 2);
        }
        return 0;
      };
      this.renderChild = function (d, f, e) {
        var g = f.children[e];
        if (g.attribute("x").hasValue()) {
          g.x = g.attribute("x").toPixels("x") + this.getAnchorDelta(d, f, e);
        } else {
          if (this.attribute("dx").hasValue()) {
            this.x += this.attribute("dx").toPixels("x");
          }
          if (g.attribute("dx").hasValue()) {
            this.x += g.attribute("dx").toPixels("x");
          }
          g.x = this.x;
        }
        this.x = g.x + g.measureText(d);
        if (g.attribute("y").hasValue()) {
          g.y = g.attribute("y").toPixels("y");
        } else {
          if (this.attribute("dy").hasValue()) {
            this.y += this.attribute("dy").toPixels("y");
          }
          if (g.attribute("dy").hasValue()) {
            this.y += g.attribute("dy").toPixels("y");
          }
          g.y = this.y;
        }
        this.y = g.y;
    ...
    b.Element.TextElementBase = function (c) {
      ...
      this.getGlyph = function (d, h, e) {
        ...
        if (d.isArabic) {
          ...
          if (e > 0 && h[e - 1] != " " && e < h.length - 2 && h[e + 1] != " ") {
            g = "medial";
          }
          if (
            e > 0 &&
          ...
          if (typeof d.glyphs[j] != "undefined") {
            f = d.glyphs[j][g];
            if (f == null && d.glyphs[j].type == "glyph") {
              f = d.glyphs[j];
            }
          }
        } else {
      ...
      this.renderChildren = function (l) {
        var j = this.parent.style("font-family").getDefinition();
        if (j != null) {
          var m = this.parent
            .style("font-size")
            .numValueOrDefault(b.Font.Parse(b.ctx.font).fontSize);
          var f = this.parent
            .style("font-style")
            .valueOrDefault(b.Font.Parse(b.ctx.font).fontStyle);
          var k = this.getText();
          if (j.isRTL) {
            k = k.split("").reverse().join("");
          }
          var n = b.ToNumberArray(this.parent.attribute("dx").value);
          for (var g = 0; g < k.length; g++) {
            var h = this.getGlyph(j, k, g);
            var e = m / j.fontFace.unitsPerEm;
            l.translate(this.x, this.y);
            l.scale(e, -e);
            var d = l.lineWidth;
            l.lineWidth = (l.lineWidth * j.fontFace.unitsPerEm) / m;
            if (f == "italic") {
              l.transform(1, 0, 0.4, 1, 0, 0);
            }
            h.render(l);
            if (f == "italic") {
              l.transform(1, 0, -0.4, 1, 0, 0);
            ...
            l.translate(-this.x, -this.y);
            this.x +=
              (m * (h.horizAdvX || j.horizAdvX)) / j.fontFace.unitsPerEm;
            if (typeof n[g] != "undefined" && !isNaN(n[g])) {
              this.x += n[g];
            }
          }
          return;
        ...
        if (l.fillStyle != "") {
          l.fillText(b.compressSpaces(this.getText()), this.x, this.y);
        }
        if (l.strokeStyle != "") {
          l.strokeText(b.compressSpaces(this.getText()), this.x, this.y);
        }
      };
      this.getText = function () {};
      this.measureTextRecursive = function (d) {
        var f = this.measureText(d);
        for (var e = 0; e < this.children.length; e++) {
          f += this.children[e].measureTextRecursive(d);
        }
        return f;
      };
      this.measureText = function (l) {
        ...
        if (j != null) {
          ...
          for (var g = 0; g < k.length; g++) {
            var h = this.getGlyph(j, k, g);
            e += ((h.horizAdvX || j.horizAdvX) * m) / j.fontFace.unitsPerEm;
            if (typeof n[g] != "undefined" && !isNaN(n[g])) {
              e += n[g];
            }
          }
        ...
        var d = b.compressSpaces(this.getText());
        if (!l.measureText) {
          return d.length * 10;
        }
        l.save();
        this.setContext(l);
        var f = l.measureText(d).width;
        l.restore();
        return f;
      };
    };
    ...
    b.Element.a = function (d) {
      ...
      this.renderChildren = function (e) {
        if (this.hasText) {
          ...
          var h = new b.Property("fontSize", b.Font.Parse(b.ctx.font).fontSize);
    ...
    b.Element.image = function (e) {
      this.base = b.Element.RenderedElementBase;
      this.base(e);
      var d = this.getHrefAttribute().value;
      var f = d.match(/\.svg$/);
      b.Images.push(this);
      this.loaded = false;
      if (!f) {
        ...
        this.img.onerror = function () {
          if (typeof console != "undefined") {
            console.log('ERROR: image "' + d + '" not found');
            c.loaded = true;
          }
        };
        this.img.src = d;
      ...
      this.renderChildren = function (j) {
        var h = this.attribute("x").toPixels("x");
        var l = this.attribute("y").toPixels("y");
        var k = this.attribute("width").toPixels("x");
        var g = this.attribute("height").toPixels("y");
        if (k == 0 || g == 0) {
          return;
        }
        j.save();
        if (f) {
          j.drawSvg(this.img, h, l, k, g);
        } else {
          j.translate(h, l);
          b.AspectRatio(
            j,
      ...
      this.getBoundingBox = function () {
        ...
        var g = this.attribute("height").toPixels("y");
        return new b.BoundingBox(h, k, h + j, k + g);
      };
    };
    ...
    b.Element.style = function (w) {
      this.base = b.Element.ElementBase;
      this.base(w);
      var r = "";
      for (var z = 0; z < w.childNodes.length; z++) {
        r += w.childNodes[z].nodeValue;
      }
      r = r.replace(
        /(\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\/)|(^[\s]*\/\/.*)/gm,
        ""
      );
      r = b.compressSpaces(r);
      var q = r.split("}");
          ...
          for (var y = 0; y < g.length; y++) {
            ...
            if (o != "") {
              ...
              for (var x = 0; x < c.length; x++) {
                var d = c[x].indexOf(":");
                var E = c[x].substr(0, d);
                var v = c[x].substr(d + 1, c[x].length - d);
                if (E != null && v != null) {
                  e[b.trim(E)] = new b.Property(b.trim(E), b.trim(v));
                }
              }
              b.Styles[o] = e;
              if (o == "@font-face") {
                var B = e["font-family"].value.replace(/"/g, "");
                var p = e.src.value.split(",");
                for (var t = 0; t < p.length; t++) {
                  if (p[t].indexOf('format("svg")') > 0) {
                    var m = p[t].indexOf("url");
                    var l = p[t].indexOf(")", m);
                    var h = p[t].substr(m + 5, l - m - 6);
                    var C = b.parseXml(b.ajax(h));
                    var n = C.getElementsByTagName("font");
                    for (var A = 0; A < n.length; A++) {
                      var u = b.CreateElement(n[A]);
                      b.Definitions[B] = u;
                    }
                  }
                }
    ...
    b.Element.use = function (c) {
      ...
      this.setContext = function (d) {
        this.baseSetContext(d);
        if (this.attribute("x").hasValue()) {
          d.translate(this.attribute("x").toPixels("x"), 0);
        }
        if (this.attribute("y").hasValue()) {
          d.translate(0, this.attribute("y").toPixels("y"));
        }
      };
      this.getDefinition = function () {
        ...
        if (this.attribute("height").hasValue()) {
          d.attribute("height", true).value = this.attribute("height").value;
        }
        return d;
      };
      this.path = function (d) {
    ...
    b.Element.mask = function (c) {
      this.base = b.Element.ElementBase;
      this.base(c);
      this.apply = function (o, f) {
        var m = this.attribute("x").toPixels("x");
        var l = this.attribute("y").toPixels("y");
        var d = this.attribute("width").toPixels("x");
        var n = this.attribute("height").toPixels("y");
        if (d == 0 && n == 0) {
          var h = new b.BoundingBox();
          for (var g = 0; g < this.children.length; g++) {
            h.addBoundingBox(this.children[g].getBoundingBox());
          }
          var m = Math.floor(h.x1);
          var l = Math.floor(h.y1);
          var d = Math.floor(h.width());
          var n = Math.floor(h.height());
        }
        var q = f.attribute("mask").value;
        ...
        e.fillStyle = p.createPattern(k, "no-repeat");
        e.fillRect(0, 0, m + d, l + n);
        o.fillStyle = e.createPattern(j, "no-repeat");
        o.fillRect(0, 0, m + d, l + n);
        f.attribute("mask").value = q;
      };
      this.render = function (d) {};
    };
      ...
      this.apply = function (d) {
        for (var f = 0; f < this.children.length; f++) {
          ...
          if (typeof g.path != "undefined") {
            var e = null;
            if (g.attribute("transform").hasValue()) {
              e = new b.Transform(g.attribute("transform").value);
              e.apply(d);
            }
            g.path(d);
            d.clip();
    ...
    b.Element.filter = function (c) {
      this.base = b.Element.ElementBase;
      this.base(c);
      this.apply = function (r, j) {
        var k = j.getBoundingBox();
        var o = Math.floor(k.x1);
        var m = Math.floor(k.y1);
        var e = Math.floor(k.width());
        var q = Math.floor(k.height());
        var f = j.style("filter").value;
        j.style("filter").value = "";
        var p = 0,
          n = 0;
        for (var h = 0; h < this.children.length; h++) {
          var d = this.children[h].extraFilterDistance || 0;
          p = Math.max(p, d);
          n = Math.max(n, d);
        }
        ...
        j.render(g);
        for (var h = 0; h < this.children.length; h++) {
          this.children[h].apply(g, 0, 0, e + 2 * p, q + 2 * n);
        }
        r.drawImage(
          l,
          0,
    ...
    b.Element.feMorphology = function (c) {
      this.base = b.Element.ElementBase;
      this.base(c);
      this.apply = function (f, e, h, g, d) {};
    };
    b.Element.feMorphology.prototype = new b.Element.ElementBase();
    b.Element.feColorMatrix = function (e) {
      this.base = b.Element.ElementBase;
      this.base(e);
      function d(h, g, l, k, f, j) {
        return h[l * k * 4 + g * 4 + j];
      }
      function c(h, g, m, k, f, j, l) {
        h[m * k * 4 + g * 4 + j] = l;
      }
      this.apply = function (q, n, m, h, p) {
        var k = q.getImageData(0, 0, h, p);
        for (var m = 0; m < p; m++) {
          for (var n = 0; n < h; n++) {
            var f = d(k.data, n, m, h, p, 0);
            var j = d(k.data, n, m, h, p, 1);
            var l = d(k.data, n, m, h, p, 2);
            var o = (f + j + l) / 3;
            c(k.data, n, m, h, p, 0, o);
            c(k.data, n, m, h, p, 1, o);
            c(k.data, n, m, h, p, 2, o);
          }
        }
        q.clearRect(0, 0, h, p);
        q.putImageData(k, 0, 0);
      };
    };
    ...
    b.Element.feGaussianBlur = function (c) {
      ...
      this.apply = function (f, e, h, g, d) {
        ...
        f.canvas.id = b.UniqueId();
        f.canvas.style.display = "none";
        document.body.appendChild(f.canvas);
        stackBlurCanvasRGBA(f.canvas.id, e, h, g, d, this.blurRadius);
        document.body.removeChild(f.canvas);
      };
    };
    ...
    b.Element.MISSING = function (c) {
      if (typeof console != "undefined") {
        console.log("ERROR: Element '" + c.nodeName + "' not yet implemented.");
      }
    };
    ...
    b.loadXml = function (c, d) {
      b.loadXmlDoc(c, b.parseXml(d));
    };
    b.loadXmlDoc = function (g, k) {
      b.init(g);
      var f = function (m) {
        var l = g.canvas;
        while (l) {
      ...
      if (b.opts.ignoreMouse != true) {
        g.canvas.onclick = function (m) {
          var l = f(
            new b.Point(
              m != null ? m.clientX : event.clientX,
              m != null ? m.clientY : event.clientY
            )
          );
          b.Mouse.onclick(l.x, l.y);
        };
        g.canvas.onmousemove = function (m) {
          var l = f(
            new b.Point(
              m != null ? m.clientX : event.clientX,
              m != null ? m.clientY : event.clientY
      ...
      var j = b.CreateElement(k.documentElement);
      j.root = true;
      var h = true;
      var d = function () {
        b.ViewPort.Clear();
        if (g.canvas.parentNode) {
          b.ViewPort.SetCurrent(
            g.canvas.parentNode.clientWidth,
            g.canvas.parentNode.clientHeight
          );
        }
        if (b.opts.ignoreDimensions != true) {
          if (j.style("width").hasValue()) {
            g.canvas.width = j.style("width").toPixels("x");
            g.canvas.style.width = g.canvas.width + "px";
          }
          if (j.style("height").hasValue()) {
            g.canvas.height = j.style("height").toPixels("y");
            g.canvas.style.height = g.canvas.height + "px";
          }
        }
        var m = g.canvas.clientWidth || g.canvas.width;
        var l = g.canvas.clientHeight || g.canvas.height;
        if (
          b.opts.ignoreDimensions == true &&
          j.style("width").hasValue() &&
          j.style("height").hasValue()
        ) {
          m = j.style("width").toPixels("x");
          l = j.style("height").toPixels("y");
        }
        b.ViewPort.SetCurrent(m, l);
        if (b.opts.offsetX != null) {
          j.attribute("x", true).value = b.opts.offsetX;
        }
        if (b.opts.offsetY != null) {
          j.attribute("y", true).value = b.opts.offsetY;
        }
        if (b.opts.scaleWidth != null && b.opts.scaleHeight != null) {
          var n = 1,
            e = 1,
            o = b.ToNumberArray(j.attribute("viewBox").value);
          if (j.attribute("width").hasValue()) {
            n = j.attribute("width").toPixels("x") / b.opts.scaleWidth;
          } else {
            if (!isNaN(o[2])) {
              n = o[2] / b.opts.scaleWidth;
            }
          }
          if (j.attribute("height").hasValue()) {
            e = j.attribute("height").toPixels("y") / b.opts.scaleHeight;
          } else {
            if (!isNaN(o[3])) {
              e = o[3] / b.opts.scaleHeight;
            }
          }
          j.attribute("width", true).value = b.opts.scaleWidth;
          j.attribute("height", true).value = b.opts.scaleHeight;
          j.attribute("viewBox", true).value = "0 0 " + m * n + " " + l * e;
          j.attribute("preserveAspectRatio", true).value = "none";
        }
        if (b.opts.ignoreClear != true) {
          g.clearRect(0, 0, m, l);
        }
        j.render(g);
        if (h) {
          h = false;
          if (typeof b.opts.renderCallback == "function") {
            b.opts.renderCallback(k);
          }
        }
      };
      var c = true;
      ...
      b.intervalID = setInterval(function () {
        ...
        if (b.opts.ignoreMouse != true) {
          l = l | b.Mouse.hasEvents();
        }
        if (b.opts.ignoreAnimation != true) {
          for (var e = 0; e < b.Animations.length; e++) {
            l = l | b.Animations[e].update(1000 / b.FRAMERATE);
          }
        }
        if (typeof b.opts.forceRedraw == "function") {
