AmCharts.AmSerialChart = AmCharts.Class({
  ...
  handleWheelReal: function (a, b) {
    if (!this.wheelBusy) {
      ...
      0 > a
        ? c
          ? ((h = this.endTime - this.startTime),
            (c = this.startTime + d * e),
            (e = this.endTime + f * e),
            0 < f && 0 < d && e >= n && ((e = n), (c = n - h)),
            this.zoomToDates(new Date(c), new Date(e)))
          : (0 < f && 0 < d && this.end >= h - 1 && (d = f = 0),
            (c = this.start + d),
            (e = this.end + f),
            this.zoomToIndexes(c, e))
        : c
        ? ((h = this.endTime - this.startTime),
          (c = this.startTime - d * e),
          (e = this.endTime - f * e),
          0 < f && 0 < d && c <= g && ((c = g), (e = g + h)),
          this.zoomToDates(new Date(c), new Date(e)))
        : (0 < f && 0 < d && 1 > this.start && (d = f = 0),
          (c = this.start - d),
          (e = this.end - f),
          this.zoomToIndexes(c, e));
    }
  ...
  updateData: function () {
    ...
    0 < d.length &&
      ((this.firstTime = this.getStartTime(d[0].time)),
  ...
  timeZoom: function (a, b) {
    ...
    isNaN(d) ||
      (b != this.endTime &&
        b - a > d &&
        ((a = b - d), (this.updateScrollbar = !0)),
      a != this.startTime &&
        b - a > d &&
        ((b = a + d), (this.updateScrollbar = !0)));
  ...
  indexZoom: function (a, b) {
    ...
    isNaN(d) ||
      (b != this.end && b - a > d && ((a = b - d), (this.updateScrollbar = !0)),
      a != this.start &&
        b - a > d &&
        ((b = a + d), (this.updateScrollbar = !0)));
  ...
  updateGraphs: function () {
    ...
    for (b = 0; b < a.length; b++) {
      ...
      AmCharts.isString(d.fillToGraph) &&
        (d.fillToGraph = this.getGraphById(d.fillToGraph));
    }
  },
  ...
  updateTrendLines: function () {
    ...
    for (b = 0; b < a.length; b++) {
      ...
      AmCharts.isString(d.valueAxis) &&
        (d.valueAxis = this.getValueAxisById(d.valueAxis));
        ...
        for (f = !1, h = 0; h < d; h++)
          (c = this.graphs[h]),
            ...
            c.valueAxis == e &&
              "column" == c.type &&
              (!f && c.stackable && (a++, (f = !0)),
              ((!c.stackable && c.clustered) || c.newStack) && a++,
              (c.columnIndex = a - 1),
              c.clustered || (c.columnIndex = 0));
      if ("none" == g || "3d" == g) {
        f = !1;
        for (h = 0; h < d; h++)
          (c = this.graphs[h]),
            c.valueAxis == e &&
              ...
              (c.clustered
                ? ((c.tcc = 1),
                  c.newStack && (a = 0),
                  c.hidden || ((c.columnIndex = a), a++))
                : c.hidden || ((f = !0), (c.tcc = 1), (c.columnIndex = 0)));
        f && 0 == a && (a = 1);
      }
      if ("3d" == g) {
        e = 1;
  ...
  updateLegendValues: function (a) {
    ...
    for (d = 0; d < b.length; d++) {
      var c = b[d];
      isNaN(a)
        ? (c.currentDataItem = void 0)
        : (c.currentDataItem =
            this.chartData[a].axes[c.valueAxis.id].graphs[c.id]);
    }
  ...
  getClosestIndex: function (a, b, d, c, e, f) {
    ...
    return d == n
      ? h
      : d < n
      ? this.getClosestIndex(a, b, d, c, e, h)
      : this.getClosestIndex(a, b, d, c, h, f);
  },
    ...
    if (d) {
      ...
      0 < c &&
        ...
        c.parseDates && !c.equalSpacing
          ? this.zoom(d[a].time, this.getEndTime(d[b].time))
          : this.zoom(a, b));
    }
  },
    ...
    if (b) {
      ...
      for (var n = 0; n < d.length; n++) {
        ...
        a = AmCharts.formatValue(
          a,
          { open: m, close: u, high: t, low: w, average: p, sum: k, count: l },
          c,
          h,
          g + "\\.",
          this.usePrefixes,
    ...
    if (-1 != a.indexOf("[[category]]")) {
      ...
      if (this.categoryAxis.parseDates) {
        ...
        -1 != a.indexOf("[[category]]") &&
          ((f = AmCharts.formatDate(e, f, this)),
...
AmCharts.Cuboid = AmCharts.Class({
  ...
  draw: function () {
    ...
    if (0 < Math.abs(f) || 0 < Math.abs(h))
      if (isNaN(x))
        (F = q),
          (q = AmCharts.adjustLuminosity(A, -0.2)),
          (q = AmCharts.adjustLuminosity(A, -0.2)),
          (v = AmCharts.polygon(
            b,
            [0, f, c + f, c, 0],
          ...
          0 < m && (L = AmCharts.line(b, [0, f, c + f], [0, h, h], l, m, k, t)),
          (y = AmCharts.polygon(
            b,
            [0, 0, c, c, 0],
            [0, e, e, 0, 0],
          ...
          y.translate(f, h),
          0 < m && (C = AmCharts.line(b, [f, f], [h, h + e], l, m, k, t)),
          (D = AmCharts.polygon(
            b,
            [0, 0, f, f, 0],
            [0, e, e + h, h, 0],
          ...
          (q = AmCharts.adjustLuminosity(F, 0.2)),
          (F = AmCharts.polygon(
            b,
            [0, f, c + f, c, 0],
            [e, e + h, e + h, e, e],
        ...
        0.1 < E &&
          0.1 < E &&
          ((v = AmCharts.circle(b, E, A, g, k, l, m, !1, G)),
          v.translate(q, M));
        0.1 < H &&
          0.1 < H &&
          ((F = AmCharts.circle(
            b,
            H,
            AmCharts.adjustLuminosity(A, 0.5),
            g,
            k,
            l,
            m,
    ...
    1 > Math.abs(e) && (e = 0);
    1 > Math.abs(c) && (c = 0);
    !isNaN(x) && (0 < Math.abs(f) || 0 < Math.abs(h))
      ? ((n = [A]),
        (n = {
          fill: n,
          stroke: l,
        ...
        b.gradient(
          ...
          [
            A,
            AmCharts.adjustLuminosity(A, -0.3),
            AmCharts.adjustLuminosity(A, -0.3),
            A,
          ],
          E
        ),
        J ? b.translate(f / 2, 0) : b.translate(0, h / 2))
      : (b =
          0 === e
            ? AmCharts.line(b, [0, c], [0, 0], l, m, k, t)
            : 0 === c
            ? AmCharts.line(b, [0, 0], [0, e], l, m, k, t)
            : 0 < w
            ? AmCharts.rect(b, c, e, n, g, k, l, m, w, u, t)
            : AmCharts.polygon(
                b,
                [0, 0, c, c, 0],
                [0, e, e, 0, 0],
...
AmCharts.CategoryAxis = AmCharts.Class({
  ...
  draw: function () {
    ...
    if (AmCharts.ifArray(a)) {
      var b,
        d = this.chart;
      "scrollbar" != this.id
        ? (AmCharts.setCN(d, this.set, "category-axis"),
          AmCharts.setCN(d, this.labelsSet, "category-axis"),
          AmCharts.setCN(d, this.axisLine.axisSet, "category-axis"))
        : (this.bcn = this.id + "-");
      var c = this.start,
      ...
      var A = this.firstDayOfWeek,
        ...
        a = AmCharts.resetDateToMin(
          new Date(a[a.length - 1].time + 1.05 * k),
          this.minPeriod,
          1,
          A
        ).getTime(),
      ...
      if (this.parseDates && !this.equalSpacing) {
        ...
        var h = Math.ceil(this.timeDifference / w) + 5,
          D = (l = AmCharts.resetDateToMin(
            new Date(this.startTime - w),
            e,
            u,
            A
          ).getTime());
        ...
        r &&
          1 < u &&
          ((y = this.chooseMinorFrequency(u)),
          (C = AmCharts.getPeriodDuration(e, y)));
        if (0 < this.gridCountR)
          for (b = c; b <= h; b++) {
            ...
            "MM" == e &&
              ((r = (m - l) / w),
              1.5 <= (m - l) / w &&
                ((m = m - (r - 1) * w + AmCharts.getPeriodDuration("DD", 3)),
                (m = AmCharts.resetDateToMin(new Date(m), e, 1).getTime()),
                (B += w)));
            k = (m - this.startTime) * this.stepWidth;
            r = !1;
            this.nextPeriod[t] &&
              (r = this.checkPeriodChange(this.nextPeriod[t], 1, m, l, t));
            v = !1;
            r && this.markPeriodChange
              ? ((r = this.dateFormatsObject[this.nextPeriod[t]]),
                this.twoLineMode &&
                  ((r = this.dateFormatsObject[t] + "\n" + r),
                  (r = AmCharts.fixBrakes(r))),
                (v = !0))
              : (r = this.dateFormatsObject[t]);
            q || (v = !1);
            ...
            if (!isNaN(y))
              for (k = 1; k < u; k += y)
                (this.gridAlpha = this.minorGridAlpha),
                  (r = m + C * k),
                  (r = AmCharts.resetDateToMin(new Date(r), e, y, A).getTime()),
                  (r = new this.axisItemRenderer(
                    this,
                    (r - this.startTime) * this.stepWidth
                  )),
                  this.pushAxisItem(r);
            this.gridAlpha = a;
          }
        ...
        if (
          ...
          for (
            q = Math.floor(b / h),
              y = this.chooseMinorFrequency(q),
              k = f,
              k / 2 == Math.round(k / 2) && k--,
              0 > k && (k = 0),
              h = 0,
              this.end - k + 1 >= this.autoRotateCount &&
            ...
            0 <= b && b < this.data.length
              ? ((t = this.data[b]), (l = t.category), (p = t.forceShow))
              : (l = "");
            if (r && !isNaN(y))
              if (b / y == Math.round(b / y) || p)
                b / q == Math.round(b / q) ||
                  p ||
                  ((this.gridAlpha = this.minorGridAlpha), (l = void 0));
              else continue;
            else if (b / q != Math.round(b / q) && !p) continue;
            k = this.getCoordinate(b - f);
            p = 0;
            "start" == this.gridPosition &&
              ((k -= this.cellWidth / 2), (p = this.cellWidth / 2));
            A = !0;
            D = p;
        ...
        if (
          ...
          for (A = 0, v = l, b = k; b < x; b++)
            (m = this.data[b].time),
              this.checkPeriodChange(e, u, m, v) &&
                (A++, 2 <= A && ((w = b), (b = x)), (v = m));
        r &&
          1 < u &&
          ((y = this.chooseMinorFrequency(u)),
          AmCharts.getPeriodDuration(e, y));
        if (0 < this.gridCountR)
          for (b = k; b < x; b++)
            if (
              ((m = this.data[b].time),
              this.checkPeriodChange(e, u, m, l) && b >= w)
            ) {
              ...
              v = !1;
              r && this.markPeriodChange
                ? ((r = this.dateFormatsObject[this.nextPeriod[t]]), (v = !0))
                : (r = this.dateFormatsObject[t]);
              l = AmCharts.formatDate(new Date(m), r, d);
              if ((b == c && !n) || (b == h && !g)) l = " ";
              C
                ...
                : (q || (v = !1),
                  k - this.previousPos >
                    ...
                    (this.labelFunction &&
                      (l = this.labelFunction(l, new Date(m), this, e, u, p)),
                    this.boldLabels && (v = !0),
                    (p = new this.axisItemRenderer(
                      this,
                      k,
                    ...
                    this.pushAxisItem(p),
                    (p = r.getBBox().width),
                    AmCharts.isModern || (p -= k),
                    (this.previousPos = k + p)));
              p = l = m;
            } else
              isNaN(y) ||
                (this.checkPeriodChange(e, y, m, D) &&
                  ((this.gridAlpha = this.minorGridAlpha),
                  (k = this.getCoordinate(b - this.start)),
                  (r = new this.axisItemRenderer(this, k)),
                  this.pushAxisItem(r),
                  (D = m)),
                (this.gridAlpha = a));
      }
      ...
      for (b = 0; b < n; b++)
        (g = this.guides[b]),
          ...
          (y = g.above),
          g.toCategory &&
            ((q = d.getCategoryIndexByValue(g.toCategory)),
            isNaN(q) ||
              ((c = this.getCoordinate(q - f)),
              g.expand && (c += this.cellWidth / 2),
              (p = new this.axisItemRenderer(this, c, "", !0, NaN, NaN, g)),
              this.pushAxisItem(p, y))),
          g.category &&
            ((q = d.getCategoryIndexByValue(g.category)),
            isNaN(q) ||
              ((a = this.getCoordinate(q - f)),
              g.expand && (a -= this.cellWidth / 2),
              (q = (c - a) / 2),
              (p = new this.axisItemRenderer(this, a, g.label, !0, NaN, q, g)),
              this.pushAxisItem(p, y))),
          g.toDate &&
            (g.toDate instanceof Date ||
              (g.toDate = AmCharts.stringToDate(g.toDate, d.dataDateFormat)),
            this.equalSpacing
              ? ((q = d.getClosestIndex(
                  this.data,
                  "time",
                ...
                isNaN(q) || (c = this.getCoordinate(q - f)))
              : (c = (g.toDate.getTime() - this.startTime) * this.stepWidth),
            (p = new this.axisItemRenderer(this, c, "", !0, NaN, NaN, g)),
            this.pushAxisItem(p, y)),
          g.date &&
            (g.date instanceof Date ||
              (g.date = AmCharts.stringToDate(g.date, d.dataDateFormat)),
            this.equalSpacing
              ? ((q = d.getClosestIndex(
                  this.data,
                  "time",
                ...
                isNaN(q) || (a = this.getCoordinate(q - f)))
              : (a = (g.date.getTime() - this.startTime) * this.stepWidth),
            (q = (c - a) / 2),
            (p =
              "H" == this.orientation
                ? new this.axisItemRenderer(this, a, g.label, !1, 2 * q, NaN, g)
                : new this.axisItemRenderer(this, a, g.label, !1, NaN, q, g)),
            this.pushAxisItem(p, y)),
          (0 < c || 0 < a) &&
            (c < this.width || a < this.width) &&
            ((c = new this.guideFillRenderer(this, a, c, g)),
            (a = c.graphics()),
            this.pushAxisItem(c, y),
            (g.graphics = a),
            (a.index = b),
            g.balloonText && this.addEventListeners(a, g));
    }
    this.axisCreated = !0;
    d = this.x;
    f = this.y;
  ...
  checkPeriodChange: function (a, b, d, c, e) {
    ...
    return "DD" == a && "hh" != e && d - b <= AmCharts.getPeriodDuration(a, c)
      ? !1
      : d != b
      ? !0
      : !1;
  ...
  xToIndex: function (a) {
    ...
    this.parseDates && !this.equalSpacing
      ? ((a = this.startTime + Math.round(a / e) - this.minDuration() / 2),
        (d = d.getClosestIndex(b, "time", a, !1, this.start, this.end + 1)))
      : (this.startOnAxis || (a -= e / 2),
        (d = this.start + Math.round(a / e)));
