  ...
  require.register(
    ...
    function (exports, require, module) {
      ...
      AdWords.prototype.track = function (track) {
        ...
        return exports.load(
          { value: track.revenue() || 0, label: events[event], script: 0 },
          { id: id }
        );
      };
    }
    ...
    function (exports, require, module) {
      ...
      Intercom.prototype.identify = function (identify) {
        ...
        if (this.options.inbox) {
          traits.widget = { activator: this.options.activator };
        }
  ...
  require.register(
    ...
    function (exports, require, module) {
      ...
      Quantcast.prototype.page = function (page) {
        var settings = { event: "refresh", qacct: this.options.pCode };
        if (user.id()) settings.uid = user.id();
        push(settings);
      };
      ...
      Quantcast.prototype.track = function (track) {
        var settings = { event: "click", qacct: this.options.pCode };
        if (user.id()) settings.uid = user.id();
        push(settings);
      };
    }
