...
})(
  {
    ...
    27: [
      ...
      },
      {
        ...
        "./lib/frontleaf": 53,
        "./lib/gauges": 54,
        "./lib/get-satisfaction": 55,
        "./lib/google-analytics": 56,
        "./lib/google-tag-manager": 57,
        "./lib/gosquared": 58,
        "./lib/heap": 59,
        "./lib/hellobar": 60,
        "./lib/hittail": 61,
        ...
        "./lib/uservoice": 97,
        "./lib/vero": 98,
        "./lib/visual-website-optimizer": 99,
        "./lib/webengage": 100,
        "./lib/woopra": 101,
        "./lib/yandex-metrica": 102,
      },
    ],
    ...
    52: [
      function (require, module, exports) {
        ...
        FoxMetrics.prototype.load = function (callback) {
          ...
          load(
            "//d35tca7vmefkrc.cloudfront.net/scripts/" + id + ".js",
            callback
          );
        };
    ...
    57: [
      function (require, module, exports) {
        ...
        GTM.prototype.load = function (fn) {
          ...
          load(
            "//www.googletagmanager.com/gtm.js?id=" + id + "&l=dataLayer",
            fn
          );
        };
    ...
    85: [
      function (require, module, exports) {
        ...
        Qualaroo.prototype.load = function (callback) {
          ...
          load(
            "//s3.amazonaws.com/ki.js/" + id + "/" + token + ".js",
            callback
          );
        };
    ...
    161: [
      ...
      },
      {
        "to-camel-case": 170,
        "to-capital-case": 171,
        "to-constant-case": 172,
        "to-dot-case": 173,
        "to-no-case": 162,
        "to-pascal-case": 174,
        "to-sentence-case": 175,
        "to-slug-case": 176,
        "to-snake-case": 177,
        "to-space-case": 178,
        "to-title-case": 179,
