    ...
    2: [
      function (require, module, exports) {
        ...
        Analytics.prototype.identify = function (id, traits, options, fn) {
          ...
          this._invoke(
            "identify",
            message(Identify, { options: options, traits: traits, userId: id })
          );
        ...
        Analytics.prototype.group = function (id, traits, options, fn) {
          ...
          this._invoke(
            "group",
            message(Group, { options: options, traits: traits, groupId: id })
          );
        ...
        Analytics.prototype.alias = function (to, from, options, fn) {
          ...
          this._invoke(
            "alias",
            message(Alias, { options: options, from: from, to: to })
          );
      ...
      function (require, module, exports) {
        ...
        AdWords.prototype.track = function (track) {
          ...
          each(events, function (label) {
            self.conversion({ conversionId: id, value: revenue, label: label });
          });
        };
    ...
    150: [
      function (require, module, exports) {
        ...
        TwitterAds.prototype.track = function (track) {
          ...
          var self = this;
          each(events, function (event) {
            var el = self.load("pixel", { event: event });
          });
        };
      },
      { "analytics.js-integration": 159, each: 5 },
