  ...
  })(
    {
      ...
      6: [
        ...
        },
        {
          ...
          "./lib/uservoice": 84,
          "./lib/vero": 85,
          "./lib/visual-website-optimizer": 86,
          "./lib/webengage": 87,
          "./lib/woopra": 88,
          "./lib/yandex-metrica": 89,
        },
      ],
      8: [
        function (require, module, exports) {
      ...
      21: [
        function (require, module, exports) {
          ...
          Chameleon.prototype.initialize = function (page) {
            var chmln = window.chmln || (window.chmln = {}),
              names = "setup alias track set".split(" ");
