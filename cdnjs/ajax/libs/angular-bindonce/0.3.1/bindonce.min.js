                ...
                for (; this.binders.length > 0; ) {
                  ...
                  if (!this.group || this.group == r.group) {
                    ...
                    switch (r.attr) {
                      case "boIf":
                        e(a) &&
                          r.transclude(r.scope.$new(), function (e) {
                            var t = r.element.parent(),
                              a = r.element && r.element[r.element.length - 1],
                              n = (t && t[0]) || (a && a.parentNode),
                              i = (a && a.nextSibling) || null;
                          ...
                          angular.forEach(n, function (e) {
                            e.transclude(r.scope.$new(), function (t) {
                              var r = e.element.parent(),
                                a =
                                  e.element && e.element[e.element.length - 1],
                                n = (r && r[0]) || (a && a.parentNode),
                                i = (a && a.nextSibling) || null;
