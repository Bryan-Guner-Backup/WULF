      ...
      function (require, module, exports) {
        ...
        module.exports = function get(key, options) {
          ...
          if (
            ...
            _this
              .$$storage()
              .setItem(_this.$$prefix + ".data." + key, JSON.stringify(item));
          }
            ...
            if (_this.$$storage) {
              ...
              if (itemJson) {
                ...
                return {
                  ...
                  isExpired:
                    new Date().getTime() - item.created > _this.$$maxAge,
                };
              } else {
                return undefined;
              }
      ...
      function (require, module, exports) {
        ...
        module.exports = function put(key, value, options) {
          ...
          if (_this.$$storage) {
            ...
            _this
              .$$storage()
              .setItem(_this.$$prefix + ".keys", JSON.stringify(keys));
          } else {
            // Remove existing
            if (_this.$$data[key]) {
              _this.remove(key);
      ...
      function (require, module, exports) {
        ...
        module.exports = function removeAll() {
          ...
          if (_this.$$storage) {
            ...
            _this
              .$$storage()
              .setItem(_this.$$prefix + ".keys", JSON.stringify([]));
          } else {
            _this.$$lruHeap.removeAll();
            _this.$$expiresHeap.removeAll();
    ...
    11: [
      function (require, module, exports) {
        ...
        module.exports = function removeExpired() {
          ...
          while (
            (expiredItem = _this.$$expiresHeap.peek()) &&
      ...
      function (require, module, exports) {
        ...
        module.exports = function setCapacity(capacity) {
          ...
          while (_this.$$lruHeap.size() > _this.$$capacity) {
            removed[_this.$$lruHeap.peek().key] = _this.remove(
              _this.$$lruHeap.peek().key
            );
          }
          return removed;
        };
          ...
          if (_this.$$storage) {
            ...
            for (i = 0; i < keys.length; i++) {
              ...
              if (_this.$$maxAge === Number.MAX_VALUE) {
                ...
                _this.$$data[key].expires =
                  _this.$$data[key].created + _this.$$maxAge;
              }
