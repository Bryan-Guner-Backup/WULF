...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["angularCacheModuleName"] = factory(root["angular"]);
              ...
              var createCache = function (cacheId, options) {
                ...
                var cache = (caches[cacheId] = {
                  ...
                  put: function put(key, value, options) {
                    ...
                    var storeOnResolve =
                      "storeOnResolve" in options
                        ? !!options.storeOnResolve
                        : this.$$storeOnResolve;
                    var storeOnReject =
                      "storeOnReject" in options
                        ? !!options.storeOnReject
                        : this.$$storeOnReject;
                    ...
                    var item = {
                      key: key,
                      value: _isPromiseLike(value)
                        ? value.then(
                            getHandler(storeOnResolve, false),
                            getHandler(storeOnReject, true)
                          )
                        : value,
                      created: now,
                      accessed: now,
                  ...
                  setCacheFlushInterval: function setCacheFlushInterval(
                    cacheFlushInterval
                  ) {
                    if (cacheFlushInterval === null) {
                      ...
                      throw new Error(
                        "cacheFlushInterval must be greater than zero!"
                      );
                    } else if (
                      cacheFlushInterval !== this.$$cacheFlushInterval
                    ) {
                  ...
                  setCapacity: function setCapacity(capacity) {
                    ...
                    while ($$lruHeap.size() > this.$$capacity) {
                      removed[$$lruHeap.peek().key] = this.remove(
                        $$lruHeap.peek().key
                      );
                    }
                    return removed;
                  ...
                  setDeleteOnExpire: function setDeleteOnExpire(
                    deleteOnExpire,
                    setRecycleFreq
                  ) {
                  ...
                  setOptions: function setOptions(cacheOptions, strict) {
                    ...
                    if (
                      "storageMode" in cacheOptions ||
                      "storageImpl" in cacheOptions
                    ) {
                      this.setStorageMode(
                        cacheOptions.storageMode,
                        cacheOptions.storageImpl
                      );
                    } else if (strict) {
                      this.setStorageMode(
                        defaults.storageMode,
                        defaults.storageImpl
                      );
                    }
                    ...
                    if ("deleteOnExpire" in cacheOptions) {
                      this.setDeleteOnExpire(
                        cacheOptions.deleteOnExpire,
                        false
                      );
                    } else if (strict) {
                    ...
                    if ("cacheFlushInterval" in cacheOptions) {
                      this.setCacheFlushInterval(
                        cacheOptions.cacheFlushInterval
                      );
                    } else if (strict) {
                  ...
                  setStorageMode: function setStorageMode(
                    storageMode,
                    storageImpl
                  ) {
                    ...
                    if (
                      typeof this.$$storageMode === "string" &&
                    ...
                    if (storageImpl) {
                      if (!angular.isObject(storageImpl)) {
                        ...
                        throw new Error(
                          'storageImpl must implement "getItem(key)"!'
                        );
                      } else if (
                        ...
                        throw new Error(
                          'storageImpl must implement "removeItem(key)"!'
                        );
                      }
                      $$storage = function () {
                        return storageImpl;
