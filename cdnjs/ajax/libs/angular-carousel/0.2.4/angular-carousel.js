      ...
      function ($swipe, $window, $document, $parse, $compile, $rootScope) {
        ...
        return {
          ...
          compile: function (tElement, tAttributes) {
            ...
            ["ng-repeat", "data-ng-repeat", "x-ng-repeat"].every(function (
              attr
            ) {
            ...
            return function (scope, iElement, iAttributes, containerCtrl) {
              ...
              if (
                ...
                angular.isDefined(iAttributes.rnCarouselControl)
              ) {
              ...
              if (angular.isDefined(iAttributes.rnCarouselIndicator)) {
                var indicator = $compile(
                  "<div id='carousel-" +
                    carouselId +
                    "-indicator' index='indicatorIndex' items='carouselIndicatorArray' rn-carousel-indicators class='rn-carousel-indicator'></div>"
                )(scope);
              ...
              if (angular.isDefined(iAttributes.rnCarouselControl)) {
                var controls = $compile(
                  "<div id='carousel-" +
                    carouselId +
                    "-controls' index='indicatorIndex' items='carouselIndicatorArray' rn-carousel-controls class='rn-carousel-controls'></div>"
                )(scope);
              ...
              function scroll(x) {
                ...
                if (!is3dAvailable) {
                  carousel[0].style[transformProperty] =
                    "translate(" + move + "px, 0)";
                } else {
                  carousel[0].style[transformProperty] =
              ...
              function updateBufferIndex() {
                ...
                if (isBuffered) {
                  if (scope.carouselIndex <= bufferEdgeSize) {
                    ...
                    scope.carouselIndex >
                    slidesCount - scope.carouselBufferSize
                  ) {
              ...
              function capPosition(x) {
                ...
                if (scope.carouselIndex === 0) {
                  ...
                  position = Math.min(
                    (slidesCount - 1) * containerWidth + getAbsMoveTreshold(),
                    position
                  );
                }
                return position;
              ...
              function swipeEnd(coords, event, forceAnimation) {
                ...
                destination =
                  (moveOffset + scope.carouselIndex) * containerWidth;
