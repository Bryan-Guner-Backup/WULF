      ...
      return {
        ...
        link: function (b, c, d) {
          ...
          b.carouselExposedIndex || (b.carouselExposedIndex = 0),
            ...
            (increment = function () {
              b.carouselExposedIndex =
                b.carouselExposedIndex < g - 1 ? b.carouselExposedIndex + 1 : 0;
            }),
          ...
          return {
            ...
            compile: function (l, m) {
              ...
              return (
                ...
                function (l, m, n) {
                  function p() {
                    return m[0].querySelectorAll(":scope > li");
                  }
                  function q(a) {
                    (K = !0), z({ x: a.clientX, y: a.clientY }, a);
                  }
                  function t(a) {
                    var b = 100 * l.carouselBufferIndex + a;
                  ...
                  function u(a, b) {
                    if (
                      (void 0 === a && (a = l.carouselIndex),
                      (b = b || {}),
                      b.animate === !1 || "none" === H.transitionType)
                    )
                      return (
                        (N = !1),
                        (J = -100 * a),
                    ...
                    c.tween({
                      ...
                      finish: function () {
                        (N = !1),
                          l.$apply(function () {
                            (l.carouselIndex = a), (J = -100 * a), A();
                          });
                      },
                    });
                  }
                  function v() {
                    return m[0].getBoundingClientRect().width;
                  }
                  function w() {
                    L = v();
                  }
                  ...
                  function z(a, b) {
                    if (
                      ...
                      if (((J += (100 * -E) / L), H.isSequential)) {
                        var d = H.moveTreshold * L,
                          e = -E,
                          f = -Math[e >= 0 ? "ceil" : "floor"](e / L),
                          g = Math.abs(e) > d;
                        F &&
                          f + l.carouselIndex >= F.length &&
                          (f = F.length - 1 - l.carouselIndex),
                          f + l.carouselIndex < 0 && (f = -l.carouselIndex);
                        var h = g ? f : 0;
                        (E = l.carouselIndex + h), u(E);
                      } else
                        l.$apply(function () {
                          (l.carouselIndex = parseInt(-J / 100, 10)), A();
                        });
                  }
                  function A() {
                    var a = 0,
                    ...
                    s
                      ? ((a =
                          l.carouselIndex <= b
                            ? 0
                            : F && F.length < l.carouselBufferSize
                            ? 0
                            : F &&
                              l.carouselIndex > F.length - l.carouselBufferSize
                            ? F.length - l.carouselBufferSize
                            : l.carouselIndex - b),
                  ...
                  if (void 0 !== n.rnCarouselAutoSlide) {
                    var R =
                      parseInt(n.rnCarouselAutoSlide, 10) ||
                      H.autoSlideDuration;
                    Q = g(function () {
                      N || C || l.nextSlide();
                    }, 1e3 * R);
                  ...
                  if (n.rnCarouselIndex) {
                    ...
                    angular.isFunction(T.assign)
                      ...
                      : isNaN(n.rnCarouselIndex) ||
                        u(parseInt(n.rnCarouselIndex, 10), { animate: !1 });
                  } else u(0, { animate: !P }), (P = !1);
                  n.rnCarouselLocked &&
                    l.$watch(n.rnCarouselLocked, function (a) {
                      N = a === !0 ? !0 : !1;
                    }),
                    r &&
                    ...
                    (l.carouselBufferSize = H.bufferSize);
                  var U = angular.element(b);
                  U.bind("orientationchange", B),
                    U.bind("resize", B),
                    l.$on("$destroy", function () {
                      c.unbind("mouseup", q),
                        U.unbind("orientationchange", B),
                        U.unbind("resize", B);
                    });
                }
              );
          ...
          var c = (function () {
            ...
            function g(a, b, c, d, e, f, g) {
              var i,
                j = (a - f) / e;
              for (i in b)
                b.hasOwnProperty(i) && (b[i] = h(c[i], d[i], m[g[i]], j));
              return b;
            }
            function h(a, b, c, d) {
              return a + (b - a) * c(d);
            ...
            return (
              ...
              (l.prototype.setConfig = function (a) {
                (a = a || {}),
                  ...
                  (this._start = a.start || c),
                  (this._step = a.step || c),
                  (this._finish = a.finish || c),
                  (this._duration = a.duration || p),
              ...
              (l.prototype.stop = function (a) {
                return (
                  ...
                  a &&
                    (e(this._currentState, this._targetState),
                    i(this, "afterTweenEnd"),
              ...
              "function" == typeof SHIFTY_DEBUG_NOW && (a.timeoutHandler = j),
              "object" == typeof exports
                ...
                : "undefined" == typeof a.Tweenable && (a.Tweenable = l),
              l
            );
          })();
          (b.Tweenable = c),
            ...
            (function () {
              ...
              var b = new c();
              (b._filterArgs = []),
                (c.interpolate = function (d, e, f, g) {
                  ...
                  (j.length = 0),
                    ...
                    (j[2] = e),
                    (j[3] = i),
                    c.applyFilter(b, "tweenCreated"),
                    c.applyFilter(b, "beforeTween");
                  var k = a(d, h, e, f, i);
