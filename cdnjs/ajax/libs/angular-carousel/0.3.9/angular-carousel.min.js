                ...
                function (m, n, o) {
                  ...
                  function v(a, b) {
                    if (
                      ...
                      (b = b || {}),
                      b.animate === !1 || "none" === J.transitionType)
                    )
                      return (
                        (R = !1),
                        (L = -100 * a),
                  ...
                  function C(a, b) {
                    if (
                      (!b || M) &&
                      (z(), (F = !1), (M = !1), (H = G - a.x), 0 !== H && !R)
                    )
                      if (((L += (100 * -H) / O), J.isSequential)) {
                        var c = J.moveTreshold * O,
                          d = -H,
                          e = -Math[d >= 0 ? "ceil" : "floor"](d / O),
                          f = Math.abs(d) > c;
                        N &&
                          e + m.carouselIndex >= N.length &&
                          (e = N.length - 1 - m.carouselIndex),
                          e + m.carouselIndex < 0 && (e = -m.carouselIndex);
                        var g = f ? e : 0;
                  ...
                  function D() {
                    ...
                    t
                      ? ((a =
                          m.carouselIndex <= b
                            ? 0
                            : N && N.length < m.carouselBufferSize
                            ? 0
                            : N &&
                              m.carouselIndex > N.length - m.carouselBufferSize
                            ? N.length - m.carouselBufferSize
                            : m.carouselIndex - b),
                  ...
                  var F,
                    ...
                    I = {
                      ...
                      transitionDuration:
                        parseInt(o.rnCarouselDuration, 10) || 300,
                      isSequential: !0,
                      autoSlideDuration: 3,
                      bufferSize: 5,
                      moveTreshold: 0.1,
                  ...
                  m.$on("$destroy", function () {
                    ...
                    (m.carouselBufferSize = J.bufferSize);
                  var Z = angular.element(b);
                  Z.bind("orientationchange", E),
                    Z.bind("resize", E),
                    m.$on("$destroy", function () {
                      z(),
                        Z.unbind("orientationchange", E),
                        Z.unbind("resize", E);
                    });
                }
              );
