...
require = (function e(t, n, r) {
...
})(
  {
            ...
            deferred.reject(
              new errors.RuntimeError(
                "DS.create(resourceName, attrs): " +
                  resourceName +
                  " is not a registered resource!"
              )
            );
          } else if (!utils.isObject(attrs)) {
            deferred.reject(
              new errors.IllegalArgumentError(
                "DS.create(resourceName, attrs): attrs: Must be an object!",
    ...
    29: [
      function (require, module, exports) {
        ...
        function destroy(resourceName, id) {
          ...
          if (!store[resourceName]) {
            ...
            deferred.reject(
              new errors.IllegalArgumentError(
                "DS.destroy(resourceName, id): id: Must be a string or a number!",
      ...
      { errors: "hIh4e1", store: "hT1bCX", utils: "uE/lJt" },
    ],
    30: [
      function (require, module, exports) {
        var utils = require("utils"),
        ...
        function find(resourceName, id, forceRefresh) {
          ...
          if (!store[resourceName]) {
            deferred.reject(
              new errors.RuntimeError(
                "DS.find(resourceName, id[, forceRefresh]): " +
                  resourceName +
                  " is not a registered resource!"
              )
            );
            ...
            deferred.reject(
              new errors.IllegalArgumentError(
                "DS.find(resourceName, id[, forceRefresh]): id: Must be a string or a number!",
                { id: { actual: typeof id, expected: "string|number" } }
              )
            );
          }
      ...
      function (require, module, exports) {
        ...
        function _findAll(deferred, resourceName, params, forceRefresh) {
          ...
          if (!(queryHash in resource.completedQueries)) {
            ...
            if (!resource.pendingQueries[queryHash]) {
              ...
              resource.pendingQueries[queryHash] = GET(resource.url, {
                params: params,
              }).then(function (data) {
                try {
                  deferred.resolve(
        ...
        function findAll(resourceName, params, forceRefresh) {
          ...
          if (!store[resourceName]) {
            deferred.reject(
              new errors.RuntimeError(
                "DS.findAll(resourceName[, params]): " +
                  resourceName +
                  " is not a registered resource!"
              )
            );
            ...
            deferred.reject(
              new errors.IllegalArgumentError(
                "DS.findAll(resourceName[, params]): params: Must be an object!",
    ...
    33: [
      ...
      { "../../HTTP": 27, errors: "hIh4e1", store: "hT1bCX", utils: "uE/lJt" },
    ],
    34: [
      function (require, module, exports) {
        var utils = require("utils"),
        ...
        function _save(deferred, resource, id, attrs) {
          var _this = this;
          PUT(utils.makePath(resource.url, id), attrs, null).then(function (
            data
          ) {
            var saved = _this.inject(resource.name, data);
            resource.saved[saved[resource.idAttribute]] = utils.saveTimestamp(
              resource.saved[saved[resource.idAttribute]]
            );
        ...
        function save(resourceName, id) {
          ...
          if (!store[resourceName]) {
            ...
            deferred.reject(
              new errors.IllegalArgumentError(
                "DS.save(resourceName, id, attrs): id: Must be a string or a number!",
                { id: { actual: typeof id, expected: "string|number" } }
              )
            );
          }
          ...
          try {
            ...
            if (resource.validate) {
              resource.validate(
                resource.index[resource.idAttribute || "id"],
                function (err) {
                  if (err) {
                    deferred.reject(err);
                  } else {
      ...
      function (require, module, exports) {
        ...
        function changes(resourceName, id) {
          if (!store[resourceName]) {
            ...
            throw new errors.IllegalArgumentError(
              "DS.changes(resourceName, id): id: Must be a string or a number!",
              { id: { actual: typeof id, expected: "string|number" } }
            );
          }
      ...
      function (require, module, exports) {
        ...
        function defineResource(definition) {
          ...
          if (!utils.isObject(definition)) {
            throw new errors.IllegalArgumentError(
              "DS.defineResource(definition): definition: Must be an object!",
              { definition: { actual: typeof definition, expected: "object" } }
            );
          } else if (!utils.isString(definition.name)) {
            throw new errors.IllegalArgumentError(
              "DS.defineResource(definition): definition.name: Must be a string!",
              {
                definition: {
            ...
            throw new errors.IllegalArgumentError(
              "DS.defineResource(definition): definition.idAttribute: Must be a string!",
              {
                definition: {
                  idAttribute: {
      ...
      function (require, module, exports) {
        ...
        function eject(resourceName, id) {
          if (!store[resourceName]) {
            ...
            throw new errors.IllegalArgumentError(
              "DS.eject(resourceName, id): id: Must be a string or a number!",
              { id: { actual: typeof id, expected: "string|number" } }
            );
          }
          ...
          if (
            ...
            if (params.query.orderBy) {
              ...
              if (utils.isArray(params.query.orderBy)) {
                ...
                throw new errors.IllegalArgumentError(
                  errorPrefix + "params.query.orderBy: Must be an array!",
                  {
                    params: {
                      query: {
                        orderBy: {
            ...
            if (
              ...
              utils.isNumber(params.query.offset)
            ) {
      ...
      function (require, module, exports) {
        ...
        function get(resourceName, id) {
          if (!store[resourceName]) {
            ...
            throw new errors.IllegalArgumentError(
              "DS.get(resourceName, id): id: Must be a string or a number!",
              { id: { actual: typeof id, expected: "string|number" } }
            );
          }
      ...
      function (require, module, exports) {
        ...
        function hasChanges(resourceName, id) {
          if (!store[resourceName]) {
            ...
            throw new errors.IllegalArgumentError(
              "DS.hasChanges(resourceName, id): id: Must be a string or a number!",
              { id: { actual: typeof id, expected: "string|number" } }
            );
          }
    ...
    49: [
      function (require, module, exports) {
        ...
        function inject(resourceName, attrs) {
          if (!store[resourceName]) {
            throw new errors.RuntimeError(
              "DS.inject(resourceName, attrs): " +
                resourceName +
                " is not a registered resource!"
            );
          } else if (!utils.isObject(attrs) && !utils.isArray(attrs)) {
            throw new errors.IllegalArgumentError(
              "DS.inject(resourceName, attrs): attrs: Must be an object or an array!",
          ...
          if (!attrs[idAttribute]) {
            throw new errors.RuntimeError(
              "DS.inject(resourceName, attrs): attrs: Must contain the property specified by `idAttribute` in the resource definition!"
            );
          } else {
            try {
              if (!services.$rootScope.$$phase) {
      ...
      function (require, module, exports) {
        ...
        function lastModified(resourceName, id) {
          if (!store[resourceName]) {
            ...
            throw new errors.IllegalArgumentError(
              "DS.lastModified(resourceName[, id]): id: Must be a string or number!",
              { id: { actual: typeof id, expected: "string|number" } }
            );
          }
          try {
      ...
      function (require, module, exports) {
        ...
        function lastSaved(resourceName, id) {
          if (!store[resourceName]) {
            ...
            throw new errors.IllegalArgumentError(
              "DS.lastSaved(resourceName[, id]): id: Must be a string or number!",
              { id: { actual: typeof id, expected: "string|number" } }
            );
          }
          try {
      ...
      function (require, module, exports) {
        ...
        function previous(resourceName, id) {
          if (!store[resourceName]) {
            ...
            throw new errors.IllegalArgumentError(
              "DS.previous(resourceName, id): id: Must be a string or a number!",
              { id: { actual: typeof id, expected: "string|number" } }
            );
          }
