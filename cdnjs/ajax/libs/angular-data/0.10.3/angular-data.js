      ...
      function (require, module, exports) {
        ...
        function create(resourceName, attrs, options) {
          ...
          try {
            ...
            promise = promise
              .then(function (attrs) {
                return _this.$q.promisify(definition.beforeValidate)(
                  resourceName,
                  attrs
                );
              })
              .then(function (attrs) {
                return _this.$q.promisify(definition.validate)(
                  resourceName,
                  attrs
                );
              })
              .then(function (attrs) {
                return _this.$q.promisify(definition.afterValidate)(
                  resourceName,
                  attrs
                );
              })
              .then(function (attrs) {
                return _this.$q.promisify(definition.beforeCreate)(
                  resourceName,
                  attrs
                );
              })
              ...
              .then(function (res) {
                return _this.$q.promisify(definition.afterCreate)(
                  resourceName,
              ...
              .then(function (data) {
                if (options.cacheResponse) {
                  ...
                  resource.previousAttributes[id] = _this.utils.deepMixIn(
                    {},
                    created
                  );
                  resource.saved[id] = _this.utils.updateTimestamp(
                    resource.saved[id]
                  );
      ...
      function (require, module, exports) {
        ...
        function destroy(resourceName, id, options) {
          ...
          try {
            ...
            promise = promise
              .then(function (attrs) {
                return _this.$q.promisify(definition.beforeDestroy)(
                  resourceName,
                  attrs
                );
              })
              ...
              .then(function () {
                return _this.$q.promisify(definition.afterDestroy)(
                  resourceName,
                  item
                );
              })
          ...
          try {
            ...
            if (!(id in resource.completedQueries)) {
              if (!(id in resource.pendingQueries)) {
                promise = resource.pendingQueries[id] = _this.adapters[
                  options.adapter || definition.defaultAdapter
                ]
        ...
        function _findAll(utils, resourceName, params, options) {
          ...
          if (!(queryHash in resource.completedQueries)) {
            ...
            if (!(queryHash in resource.pendingQueries)) {
              ...
              resource.pendingQueries[queryHash] = _this.adapters[
                options.adapter || definition.defaultAdapter
              ]
        ...
        function loadRelations(resourceName, instance, relations, options) {
          ...
          try {
            ...
            if (!this.definitions[resourceName]) {
              ...
              throw new IA(
                errorPrefix + "relations: Must be a string or an array!"
              );
            } else if (!this.utils.isObject(options)) {
              throw new IA(errorPrefix + "options: Must be an object!");
            }
        ...
        function save(resourceName, id, options) {
          ...
          try {
            ...
            promise = promise
              ...
              .then(function (attrs) {
                return _this.$q.promisify(definition.beforeUpdate)(
                  resourceName,
                  attrs
                );
              })
              ...
              .then(function (res) {
                return _this.$q.promisify(definition.afterUpdate)(
                  resourceName,
                  definition.deserialize(resourceName, res)
                );
              })
      ...
      function (require, module, exports) {
        ...
        function changes(resourceName, id) {
          ...
          if (item) {
            ...
            return this.utils.diffObjectFromOldObject(
              item,
              this.store[resourceName].previousAttributes[id]
            );
          }
        }
    ...
    53: [
      function (require, module, exports) {
        ...
        function createInstance(resourceName, attrs, options) {
          ...
          if (options.useClass) {
            var Func =
              this.definitions[resourceName][
                this.definitions[resourceName].class
              ];
            item = new Func();
          } else {
            item = {};
      ...
      function (require, module, exports) {
        ...
        function defineResource(definition) {
          ...
          if (!this.utils.isObject(definition)) {
            ...
            !this.utils.isString(definition.idAttribute)
          ) {
            throw new IA(
            ...
            definition.endpoint &&
            !this.utils.isString(definition.endpoint)
          ) {
            throw new IA(
            ...
            if (def.computed) {
              DS.utils.forOwn(def.computed, function (fn, field) {
                ...
                if (angular.isFunction(fn)) {
                  ...
                  DS.$log.warn(
                    errorPrefix +
                      "Use the computed property array for compatibility with minified code!"
                  );
                } else {
        ...
        function eject(resourceName, id) {
          ...
          if (!this.$rootScope.$$phase) {
            this.$rootScope.$apply(function () {
              ...
              resource.collectionModified = _this.utils.updateTimestamp(
                resource.collectionModified
              );
            });
          } else {
    ...
    57: [
      function (require, module, exports) {
        ...
        function ejectAll(resourceName, params) {
          ...
          if (!this.$rootScope.$$phase) {
            this.$rootScope.$apply(function () {
              _ejectAll.apply(_this, [
                _this.definitions[resourceName],
                resource,
                params,
              ]);
              resource.collectionModified = _this.utils.updateTimestamp(
      ...
      function (require, module, exports) {
        ...
        function _inject(definition, resource, attrs) {
          ...
          function _react(added, removed, changed, oldValueFn) {
            ...
            resource.modified[innerId] = _this.utils.updateTimestamp(
          ...
          if (_this.utils.isArray(attrs)) {
            ...
            if (
              definition.computed &&
              definition.computed[definition.idAttribute]
            ) {
              var args = [];
              angular.forEach(
                definition.computed[definition.idAttribute].deps,
                function (dep) {
                  args.push(attrs[dep]);
                }
              );
              attrs[definition.idAttribute] = definition.computed[
                definition.idAttribute
              ].apply(attrs, args);
            }
            if (!(definition.idAttribute in attrs)) {
              var error = new _this.errors.R(
                errorPrefix +
          ...
          _this.utils.forOwn(definition.relations, function (relation, type) {
            _this.utils.forOwn(relation, function (def, relationName) {
              if (_this.definitions[relationName] && injected[def.localField]) {
                try {
                  injected[def.localField] = _this.inject(
                    relationName,
        ...
        function inject(resourceName, attrs, options) {
          ...
          if (!this.definitions[resourceName]) {
            ...
            !this.utils.isObject(attrs) &&
            !this.utils.isArray(attrs)
          ) {
      ...
      function (require, module, exports) {
        ...
        function lastModified(resourceName, id) {
          if (!this.definitions[resourceName]) {
            ...
            id &&
            !this.utils.isString(id) &&
            !this.utils.isNumber(id)
          ) {
            throw new this.errors.IA(
              errorPrefix + "id: Must be a string or a number!"
            );
