...
require = (function e(t, n, r) {
...
})(
  {
    ...
    11: [
      ...
      { "../object/deepMatches": 20, "./identity": 10, "./prop": 12 },
    ],
    12: [
      function (require, module, exports) {
        /**
    ...
    21: [
      ...
      { "../lang/isPlainObject": 17, "./forOwn": 23 },
    ],
    22: [
      function (require, module, exports) {
        ...
        function create(resourceName, attrs) {
          ...
          if (!services.store[resourceName]) {
            ...
            try {
              ...
              promise = promise
                .then(function (attrs) {
                  return services.$q.promisify(resource.beforeValidate)(
                    resourceName,
                    attrs
                  );
                })
                .then(function (attrs) {
                  return services.$q.promisify(resource.validate)(
                    resourceName,
                    attrs
                  );
                })
                .then(function (attrs) {
                  return services.$q.promisify(resource.afterValidate)(
                    resourceName,
                    attrs
                  );
                })
                .then(function (attrs) {
                  return services.$q.promisify(resource.beforeCreate)(
                    resourceName,
                    attrs
                  );
                })
                .then(function (attrs) {
                  return services.adapters[resource.defaultAdapter].POST.apply(
                    _this,
                    [
                      utils.makePath(resource.baseUrl, resource.endpoint),
                      attrs,
                      null,
                    ]
                  );
                ...
                .then(function (data) {
                  return services.$q.promisify(resource.afterCreate)(
                    resourceName,
                    data
                  );
                })
      ...
      function (require, module, exports) {
        ...
        function destroy(resourceName, id) {
          ...
          if (!services.store[resourceName]) {
            ...
            promise = promise
              .then(function (attrs) {
                return services.$q.promisify(resource.beforeDestroy)(
                  resourceName,
                  attrs
                );
              })
              .then(function () {
                return services.adapters[resource.defaultAdapter].DEL(
                  utils.makePath(resource.baseUrl, resource.endpoint, id),
                  null
                );
              })
              .then(function () {
                return services.$q.promisify(resource.afterDestroy)(
                  resourceName,
                  resource.index[id]
                );
              })
            ...
            try {
              ...
              if (!(id in resource.completedQueries)) {
                if (!(id in resource.pendingQueries)) {
                  promise = resource.pendingQueries[id] = services.adapters[
                    resource.defaultAdapter
                  ]
                    .GET(
                      utils.makePath(resource.baseUrl, resource.endpoint, id),
                      null
        ...
        function _findAll(resourceName, params, options) {
          ...
          if (!(queryHash in resource.completedQueries)) {
            ...
            if (!(queryHash in resource.pendingQueries)) {
              ...
              resource.pendingQueries[queryHash] = services.adapters[
                resource.defaultAdapter
              ]
                .GET(utils.makePath(resource.baseUrl, resource.endpoint), {
                  params: params,
                })
                .then(function (data) {
                  try {
                    return processResults.apply(_this, [
                      data,
                      resourceName,
                      queryHash,
                    ]);
        ...
        function save(resourceName, id, options) {
          ...
          if (!services.store[resourceName]) {
            ...
            promise = promise
              ...
              .then(function (attrs) {
                return services.$q.promisify(resource.beforeUpdate)(
                  resourceName,
                  attrs
                );
              })
              .then(function (attrs) {
                return services.adapters[resource.defaultAdapter].PUT(
                  utils.makePath(resource.baseUrl, resource.endpoint, id),
                  attrs,
                  null
                );
              ...
              .then(function (data) {
                return services.$q.promisify(resource.afterUpdate)(
                  resourceName,
                  data
                );
              })
      ...
      function (require, module, exports) {
        ...
        function config(options) {
          ...
          if (!utils.isObject(options)) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options: Must be an object!",
              { actual: typeof options, expected: "object" }
            );
          } else if ("baseUrl" in options && !utils.isString(options.baseUrl)) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.baseUrl: Must be a string!",
              {
                baseUrl: { actual: typeof options.baseUrl, expected: "string" },
              }
            );
          } else if (
            "idAttribute" in options &&
            !utils.isString(options.idAttribute)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.idAttribute: Must be a string!",
              {
                idAttribute: {
                  actual: typeof options.idAttribute,
                  expected: "string",
                },
              }
            );
          } else if (
            "mergeStrategy" in options &&
            !utils.isString(options.mergeStrategy)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.mergeStrategy: Must be a string!",
              {
                mergeStrategy: {
                  actual: typeof options.mergeStrategy,
                  expected: "string",
                },
              }
            );
          } else if (
            "beforeValidate" in options &&
            !utils.isFunction(options.beforeValidate)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.beforeValidate: Must be a function!",
              {
                beforeValidate: {
                  actual: typeof options.beforeValidate,
                  expected: "function",
                },
              }
            );
            ...
            "validate" in options &&
            !utils.isFunction(options.validate)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.validate: Must be a function!",
              {
                validate: {
                  actual: typeof options.validate,
                  expected: "function",
                },
              }
            );
          } else if (
            "afterValidate" in options &&
            !utils.isFunction(options.afterValidate)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.afterValidate: Must be a function!",
              {
                afterValidate: {
                  actual: typeof options.afterValidate,
                  expected: "function",
                },
              }
            );
          } else if (
            "beforeCreate" in options &&
            !utils.isFunction(options.beforeCreate)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.beforeCreate: Must be a function!",
              {
                beforeCreate: {
                  actual: typeof options.beforeCreate,
                  expected: "function",
                },
              }
            );
          } else if (
            "afterCreate" in options &&
            !utils.isFunction(options.afterCreate)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.afterCreate: Must be a function!",
              {
                afterCreate: {
                  actual: typeof options.afterCreate,
                  expected: "function",
                },
              }
            );
          } else if (
            "beforeUpdate" in options &&
            !utils.isFunction(options.beforeUpdate)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.beforeUpdate: Must be a function!",
              {
                beforeUpdate: {
                  actual: typeof options.beforeUpdate,
                  expected: "function",
                },
              }
            );
          } else if (
            "afterUpdate" in options &&
            !utils.isFunction(options.afterUpdate)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.afterUpdate: Must be a function!",
              {
                afterUpdate: {
                  actual: typeof options.afterUpdate,
                  expected: "function",
                },
              }
            );
          } else if (
            "beforeDestroy" in options &&
            !utils.isFunction(options.beforeDestroy)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.beforeDestroy: Must be a function!",
              {
                beforeDestroy: {
                  actual: typeof options.beforeDestroy,
                  expected: "function",
                },
              }
            );
          } else if (
            "afterDestroy" in options &&
            !utils.isFunction(options.afterDestroy)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.afterDestroy: Must be a function!",
              {
                afterDestroy: {
                  actual: typeof options.afterDestroy,
                  expected: "function",
                },
              }
            );
          } else if (
            "defaultAdapter" in options &&
            !utils.isString(options.defaultAdapter)
          ) {
            throw new errors.IllegalArgumentError(
              configErrorPrefix + "options.defaultAdapter: Must be a function!",
              {
                defaultAdapter: {
                  actual: typeof options.defaultAdapter,
                  expected: "string",
                },
              }
            );
        ...
        function registerAdapter(name, adapter) {
          if (!utils.isString(name)) {
            throw new errors.IllegalArgumentError(
              registerAdapterErrorPrefix + "name: Must be a string!",
              { actual: typeof name, expected: "string" }
            );
          } else if (!utils.isObject(adapter)) {
            throw new errors.IllegalArgumentError(
              registerAdapterErrorPrefix + "adapter: Must be an object!",
              { actual: typeof adapter, expected: "object" }
            );
          } else if (services.adapters[name]) {
            throw new errors.RuntimeError(
              registerAdapterErrorPrefix + name + " is already registered!"
            );
          }
      ...
      function (require, module, exports) {
        ...
        function defineResource(definition) {
          ...
          if (!utils.isObject(definition)) {
            ...
            definition.endpoint &&
            !utils.isString(definition.endpoint)
          ) {
            throw new errors.IllegalArgumentError(
              errorPrefix + "definition.endpoint: Must be a string!",
              {
                definition: {
                  endpoint: {
                    actual: typeof definition.endpoint,
                    expected: "string",
                  },
                },
              }
    ...
    53: [
      function (require, module, exports) {
        (function (window, angular, undefined) {
          ...
          angular
            .module("jmdobry.angular-data", ["ng" /*, 'jmdobry.binary-heap'*/])
            .config([
              "$provide",
              function ($provide) {
    ...
    "uE/lJt": [
      ...
      {
        "mout/array/contains": 3,
        "mout/array/filter": 4,
        "mout/array/slice": 7,
        "mout/array/sort": 8,
        "mout/array/toLookup": 9,
        "mout/lang/isEmpty": 14,
        "mout/object/deepMixIn": 21,
        "mout/object/forOwn": 23,
        "mout/string/makePath": 25,
        "mout/string/upperCase": 26,
      },
    ],
    utils: [
      function (require, module, exports) {
