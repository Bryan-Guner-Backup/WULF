...
require = (function e(t, n, r) {
...
})(
  {
            ...
            function ($http, $log, DSUtils) {
              ...
              function findAll(resourceConfig, params, options) {
                ...
                if (options.params.query) {
                  options.params.query = defaults.queryTransform(
      ...
      function (require, module, exports) {
        ...
        function BinaryHeap(weightFunc) {
          if (weightFunc && typeof weightFunc !== "function") {
            throw new Error(
              "BinaryHeap(weightFunc): weightFunc: must be a function!"
            );
          }
          weightFunc =
            defaults.userProvidedDefaultWeightFunc ||
            defaults.defaultWeightFunc;
        ...
        function BinaryHeapProvider() {
          ...
          function setDefaultWeightFunction(weightFunc) {
            if (!angular.isFunction(weightFunc)) {
              throw new Error(
                "BinaryHeapProvider.setDefaultWeightFunction(weightFunc): weightFunc: Must be a function!"
              );
            }
      ...
      function (require, module, exports) {
        ...
        function processResults(utils, data, resourceName, queryHash) {
          ...
          resource.index = utils.toLookup(
            resource.collection,
            this.definitions[resourceName].idAttribute
          );
          ...
          if (!(queryHash in resource.completedQueries)) {
            ...
            if (!(queryHash in resource.pendingQueries)) {
              ...
              resource.pendingQueries[queryHash] = _this.adapters[
                ...
                .findAll(definition, { params: params }, options)
                .then(function (data) {
                  try {
    ...
    34: [
      function (require, module, exports) {
        ...
        function refresh(resourceName, id, options) {
          ...
          if (!this.definitions[resourceName]) {
            throw new this.errors.RuntimeError(
              errorPrefix + resourceName + " is not a registered resource!"
            );
          } else if (!this.utils.isString(id) && !this.utils.isNumber(id)) {
            throw new this.errors.IllegalArgumentError(
              errorPrefix + "id: Must be a string or a number!",
              { id: { actual: typeof id, expected: "string|number" } }
            );
          } else if (!this.utils.isObject(options)) {
          ...
          if (!this.definitions[resourceName]) {
            ...
            promise = promise
              ...
              .then(function (attrs) {
                return _this.adapters[
                  options.adapter || definition.defaultAdapter
                ].update(definition, attrs, options);
              })
              .then(function (data) {
    ...
    36: [
      ...
      { "../utils": "uE/lJt", "./async_methods": 33, "./sync_methods": 44 },
    ],
    37: [
      function (require, module, exports) {
      ...
      function (require, module, exports) {
        ...
        function filter(resourceName, params, options) {
          ...
          try {
            ...
            var filtered = this.utils.filter(
              resource.collection,
              function (attrs) {
                var keep = true,
            ...
            if (
              this.utils.isNumber(params.query.limit) &&
              this.utils.isNumber(params.query.skip)
            ) {
      ...
      function (require, module, exports) {
        ...
        function get(resourceName, id, options) {
          ...
          try {
            ...
            if (
              !(id in this.store[resourceName].index) &&
              options.loadFromServer
            ) {
        ...
        function hasChanges(resourceName, id) {
          ...
          try {
            ...
            if (id in this.store[resourceName].changes) {
              return diffIsEmpty(
                this.utils,
                this.store[resourceName].changes[id]
              );
            } else {
              return false;
            }
        ...
        function _inject(definition, resource, attrs) {
          ...
          function _react(added, removed, changed, getOldValueFn) {
            try {
              ...
              resource.changes[innerId] = _this.utils.diffObjectFromOldObject(
                resource.index[innerId],
                resource.previousAttributes[innerId]
              );
          ...
          if (_this.utils.isArray(attrs)) {
            ...
            if (!(definition.idAttribute in attrs)) {
              throw new _this.errors.RuntimeError(
                errorPrefix +
    ...
    51: [
      function (require, module, exports) {
        (function (window, angular, undefined) {
          ...
          angular
            .module("angular-data.BinaryHeap", [])
            .provider("BinaryHeap", require("./binaryHeap"));
          angular
            .module("angular-data.DS", ["ng", "angular-data.BinaryHeap"])
