...
require = (function e(t, n, r) {
...
})(
  {
    ...
    12: [
      ...
      { "../object/deepMatches": 21, "./identity": 11, "./prop": 13 },
    ],
    13: [
      function (require, module, exports) {
        /**
              ...
              function destroyAll(resourceConfig, params, options) {
                ...
                if (params) {
                  params.query = params.query
                    ? defaults.queryTransform(resourceConfig.name, params.query)
                    : params.query;
    ...
    43: [
      ...
      { "../utils": "K0yknU", "./async_methods": 38, "./sync_methods": 54 },
    ],
    44: [
      function (require, module, exports) {
        ...
        function bindOne(scope, expr, resourceName, params) {
          if (!this.utils.isObject(scope)) {
            throw new this.errors.IllegalArgumentError(
              errorPrefix + "scope: Must be an object!"
            );
          } else if (!this.utils.isString(expr)) {
            throw new this.errors.IllegalArgumentError(
              errorPrefix + "expr: Must be a string!"
            );
            ...
            return scope.$watch(
              ...
              function () {
                _this.utils.set(
                  scope,
                  expr,
                  _this.filter(resourceName, params)
                );
              }
            );
          } catch (err) {
