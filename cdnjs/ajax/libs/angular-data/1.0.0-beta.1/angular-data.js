...
(function e(t, n, r) {
...
})(
  {
        ...
        function create(resourceName, attrs, options) {
          ...
          try {
            ...
            if (options.upsert && attrs[definition.idAttribute]) {
              ...
              promise = promise
                .then(function (attrs) {
                  return DS.$q.promisify(definition.beforeValidate)(
                    resourceName,
                    attrs
                  );
                })
                .then(function (attrs) {
                  return DS.$q.promisify(definition.validate)(
                    resourceName,
                    attrs
                  );
                })
                .then(function (attrs) {
                  return DS.$q.promisify(definition.afterValidate)(
                    resourceName,
                    attrs
                  );
                })
                .then(function (attrs) {
                  return DS.$q.promisify(definition.beforeCreate)(
                    resourceName,
                    attrs
                  );
                })
                ...
                .then(function (res) {
                  return DS.$q.promisify(definition.afterCreate)(
                    resourceName,
      ...
      function (require, module, exports) {
        ...
        function destroy(resourceName, id, options) {
          ...
          try {
            ...
            promise = promise
              .then(function (attrs) {
                return DS.$q.promisify(definition.beforeDestroy)(
                  resourceName,
                  attrs
                );
              })
              ...
              .then(function () {
                return DS.$q.promisify(definition.afterDestroy)(
                  resourceName,
                  item
                );
              })
              ...
              resource.pendingQueries[queryHash] = DS.adapters[
                ...
                .then(
                  function (res) {
                    ...
                    if (options.cacheResponse) {
                      try {
                        return processResults.apply(DS, [
                          data,
                          resourceName,
                          queryHash,
                        ]);
        ...
        function save(resourceName, id, options) {
          ...
          try {
            ...
            promise = promise
              ...
              .then(function (attrs) {
                return DS.$q.promisify(definition.beforeUpdate)(
                  resourceName,
                  attrs
                );
              })
              ...
              .then(function (res) {
                return DS.$q.promisify(definition.afterUpdate)(
                  resourceName,
                  definition.deserialize(resourceName, res)
                );
              })
    ...
    49: [
      ...
      { "../utils": 68, "./async_methods": 43, "./sync_methods": 61 },
    ],
    50: [
      function (require, module, exports) {
        function errorPrefix(resourceName) {
                ...
                if (DS.definitions[relationName] && injected[def.localField]) {
                  ...
                  if (type === "belongsTo") {
                    if (DS.utils.isArray(injected)) {
                      ...
                      var parent = injected[def.localKey]
                        ? DS.get(relationName, injected[def.localKey])
                        : null;
                      if (parent) {
