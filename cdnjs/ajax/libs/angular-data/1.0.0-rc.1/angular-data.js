...
(function e(t, n, r) {
...
})(
  {
    ...
    11: [
      ...
      { "../object/deepMatches": 21, "./identity": 10, "./prop": 12 },
    ],
    12: [
      function (require, module, exports) {
        /**
    ...
    22: [
      ...
      { "../lang/isPlainObject": 18, "./forOwn": 24 },
    ],
    23: [
      function (require, module, exports) {
    ...
    32: [
      ...
      { "../lang/toString": 20, "./camelCase": 29, "./upperCase": 35 },
    ],
    33: [
      function (require, module, exports) {
        var toString = require("../lang/toString");
          ...
          this.$get = [
            ...
            function ($q, DSUtils, DSErrors) {
              ...
              return {
                ...
                findAll: function () {
                  throw new Error(
                    "DSLocalStorageAdapter.findAll is not supported!"
                  );
                },
                ...
                create: function (resourceConfig, attrs, options) {
                  if (!(resourceConfig.idAttribute in attrs)) {
                    throw new DSErrors.IA(
                      "DSLocalStorageAdapter.create: You must provide a primary key in the attrs object!"
                    );
                  }
                  options = options || {};
                  return this.PUT(
                ...
                updateAll: function () {
                  throw new Error(
                    "DSLocalStorageAdapter.updateAll is not supported!"
                  );
                },
    ...
    49: [
      ...
      { "../utils": 73, "./async_methods": 43, "./sync_methods": 62 },
    ],
    50: [
      function (require, module, exports) {
        function errorPrefix(resourceName) {
      ...
      function (require, module, exports) {
        ...
        function defineResource(definition) {
          ...
          if (!DS.utils.isObject(definition)) {
            ...
            !DS.utils.isString(definition.idAttribute)
          ) {
            throw new IA(
            ...
            definition.endpoint &&
            !DS.utils.isString(definition.endpoint)
          ) {
            throw new IA(
    ...
    63: [
        ...
        function _injectRelations(definition, injected, options) {
          ...
          function _process(def, relationName, injected) {
            ...
            if (
              ...
              !data.injectedSoFar[
                relationName + injected[def.localField][relationDef.idAttribute]
              ]
            ) {
              try {
                data.injectedSoFar[
                  relationName +
                    injected[def.localField][relationDef.idAttribute]
                ] = 1;
      ...
      { "../../../lib/observe-js/observe-js": 1, "./compute": 53 },
    ],
    64: [
      function (require, module, exports) {
        function errorPrefix(resourceName, id) {
    ...
    73: [
      ...
      },
      {
        ...
        "mout/array/slice": 7,
        "mout/array/sort": 8,
        "mout/array/toLookup": 9,
        "mout/lang/isBoolean": 14,
        "mout/lang/isEmpty": 15,
        "mout/object/deepMixIn": 22,
        "mout/object/forOwn": 24,
        "mout/object/pick": 27,
        "mout/object/set": 28,
        "mout/string/makePath": 31,
        "mout/string/pascalCase": 32,
        "mout/string/upperCase": 35,
      },
    ],
  },
  {},
