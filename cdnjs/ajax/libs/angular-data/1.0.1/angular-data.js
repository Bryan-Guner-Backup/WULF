...
(function e(t, n, r) {
...
})(
  {
        ...
        function create(resourceName, attrs, options) {
          ...
          try {
            ...
            if (options.upsert && attrs[definition.idAttribute]) {
              ...
              return deferred.promise
                .then(function (attrs) {
                  var func = options.beforeValidate
                    ? DS.$q.promisify(options.beforeValidate)
                    : definition.beforeValidate;
                  return func.call(attrs, resourceName, attrs);
                })
                .then(function (attrs) {
                  var func = options.validate
                    ? DS.$q.promisify(options.validate)
                    : definition.validate;
                  return func.call(attrs, resourceName, attrs);
                })
                .then(function (attrs) {
                  var func = options.afterValidate
                    ? DS.$q.promisify(options.afterValidate)
                    : definition.afterValidate;
                  return func.call(attrs, resourceName, attrs);
                })
                .then(function (attrs) {
                  var func = options.beforeCreate
                    ? DS.$q.promisify(options.beforeCreate)
                ...
                .then(function (res) {
                  var func = options.afterCreate
                    ? DS.$q.promisify(options.afterCreate)
                ...
                .then(function (attrs) {
                  ...
                  if (options.cacheResponse) {
                    ...
                    resource.previousAttributes[id] = DS.utils.deepMixIn(
                      {},
                      created
                    );
      ...
      function (require, module, exports) {
        ...
        function destroy(resourceName, id, options) {
          ...
          try {
            ...
            return deferred.promise
              .then(function (attrs) {
                var func = options.beforeDestroy
                  ? DS.$q.promisify(options.beforeDestroy)
              ...
              .then(function () {
                var func = options.afterDestroy
                  ? DS.$q.promisify(options.afterDestroy)
        ...
        function save(resourceName, id, options) {
          ...
          try {
            ...
            return deferred.promise
              ...
              .then(function (attrs) {
                var func = options.beforeUpdate
                  ? DS.$q.promisify(options.beforeUpdate)
              ...
              .then(function (res) {
                var func = options.afterUpdate
                  ? DS.$q.promisify(options.afterUpdate)
    ...
    64: [
      ...
      { "../utils": 89, "./async_methods": 58, "./sync_methods": 78 },
    ],
    65: [
      function (require, module, exports) {
        function errorPrefix(resourceName) {
      ...
      function (require, module, exports) {
        ...
        function changes(resourceName, id) {
          ...
          if (item) {
            ...
            var diff = DS.utils.diffObjectFromOldObject(
              item,
    ...
    79: [
      ...
      { "../../../lib/observe-js/observe-js": 1, "./compute": 69 },
    ],
    80: [
      function (require, module, exports) {
        function errorPrefix(resourceName, id) {
