...
})(
  {
                ...
                if (_this.utils.isObject(clause)) {
                  _this.utils.forEach(clause, function (val, op) {
                    if (op === "==") {
                      ...
                      keep = first
                        ? _this.utils.contains(val, attrs[field])
                        : keep && _this.utils.contains(val, attrs[field]);
                    } else if (op === "notIn") {
                      keep = first
                        ? !_this.utils.contains(val, attrs[field])
                        : keep && !_this.utils.contains(val, attrs[field]);
    ...
    74: [
      function (require, module, exports) {
        ...
        var instanceMethods = ["save", "update", "destroy", "refresh"];
