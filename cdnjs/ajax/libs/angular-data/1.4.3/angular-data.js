...
(function e(t, n, r) {
...
})(
  {
    ...
    14: [
      ...
      { "../object/deepMatches": 30, "./identity": 13, "./prop": 15 },
    ],
    15: [
      function (require, module, exports) {
        /**
    ...
    16: [
      ...
      { "../object/mixIn": 37, "./isPlainObject": 24, "./kindOf": 26 },
    ],
    17: [
      function (require, module, exports) {
    ...
    31: [
      ...
      { "../lang/isPlainObject": 24, "./forOwn": 33 },
    ],
    32: [
      function (require, module, exports) {
    ...
    36: [
      ...
      { "../lang/deepClone": 17, "../lang/isObject": 23, "./hasOwn": 34 },
    ],
    37: [
      function (require, module, exports) {
        var forOwn = require("./forOwn");
    ...
    43: [
      ...
      { "../number/MAX_INT": 28, "../number/MIN_INT": 29, "./random": 46 },
    ],
    44: [
      function (require, module, exports) {
        var choice = require("./choice");
    ...
    45: [
      ...
      { "../number/MAX_INT": 28, "../number/MIN_INT": 29, "./rand": 43 },
    ],
    46: [
      function (require, module, exports) {
        /**
    ...
    50: [
      ...
      { "../lang/toString": 27, "./camelCase": 47, "./upperCase": 53 },
    ],
    51: [
      function (require, module, exports) {
        var toString = require("../lang/toString");
            ...
            function ($http, $log, DSUtils) {
              ...
              return {
                ...
                findAll: function (resourceConfig, params, options) {
                  ...
                  if (params) {
                    params = defaults.queryTransform(
                      resourceConfig.name,
                      params
                    );
                  ...
                  return this.GET(
                    DSUtils.makePath(
                      options.baseUrl || resourceConfig.baseUrl,
                      resourceConfig.getEndpoint(null, options)
                    ),
                    options
                  );
                },
                ...
                create: function (resourceConfig, attrs, options) {
                  ...
                  return this.POST(
                    DSUtils.makePath(
                      options.baseUrl || resourceConfig.baseUrl,
                      resourceConfig.getEndpoint(attrs, options)
                    ),
                    attrs,
                    options
                  );
            ...
            function ($q, DSUtils) {
              ...
              return {
                ...
                findAll: function (resourceConfig, params, options) {
                  ...
                  var items = [];
                  var ids = DSUtils.keys(
                    _this.getIds(resourceConfig.name, options)
                  );
                  DSUtils.forEach(ids, function (id) {
                    var itemJson = localStorage.getItem(
                      DSUtils.makePath(
                        options.baseUrl || resourceConfig.baseUrl,
                        resourceConfig.getEndpoint(id, options),
                        id
                  ...
                  deferred.resolve(
                    _this.DS.defaults.defaultFilter.call(
                      _this.DS,
                      items,
                      resourceConfig.name,
                      params,
                ...
                create: function (resourceConfig, attrs, options) {
                  var _this = this;
                  attrs[resourceConfig.idAttribute] =
                    attrs[resourceConfig.idAttribute] || DSUtils.guid();
                  options = options || {};
                  return this.PUT(
                    DSUtils.makePath(
                      options.baseUrl || resourceConfig.baseUrl,
                    ...
                    _this.ensureId(
                      item[resourceConfig.idAttribute],
                      resourceConfig.name,
                      options
                    );
                    return item;
                ...
                updateAll: function (resourceConfig, attrs, params, options) {
                  var _this = this;
                  return this.findAll(resourceConfig, params, options).then(
                    function (items) {
                      var tasks = [];
        ...
        function create(resourceName, attrs, options) {
          ...
          try {
            ...
            if (!definition) {
              ...
              throw new DS.errors.IA(
                errorPrefix(resourceName) + "attrs: Must be an object!"
              );
            }
            ...
            if (options.upsert && attrs[definition.idAttribute]) {
              ...
              return deferred.promise
                .then(function (attrs) {
                  return options.beforeValidate.call(
                    attrs,
                    resourceName,
                    attrs
                  );
                ...
                .then(function (attrs) {
                  ...
                  if (options.eagerInject && options.cacheResponse) {
                    attrs[definition.idAttribute] =
                      attrs[definition.idAttribute] || DSUtils.guid();
                    injected = DS.inject(resourceName, attrs);
                  }
                  return DS.adapters[
                    options.adapter || definition.defaultAdapter
                  ].create(
                    definition,
                    options.serialize
                      ? options.serialize(resourceName, attrs)
                      : definition.serialize(resourceName, attrs),
                    options
                  );
                })
                .then(function (res) {
                  var attrs = options.deserialize
                    ? options.deserialize(resourceName, res)
                    : definition.deserialize(resourceName, res);
                ...
                .then(function (attrs) {
                  ...
                  if (options.cacheResponse) {
                    ...
                    if (options.eagerInject) {
                      ...
                      resource.previousAttributes[newId] =
                        resource.previousAttributes[prevId];
                      resource.changeHistories[newId] =
                    ...
                    resource.previousAttributes[id] = DSUtils.deepMixIn(
                      {},
                      created
                    );
                    resource.saved[id] = DSUtils.updateTimestamp(
                      resource.saved[id]
                    );
                ...
                ["catch"](function (err) {
                  if (options.eagerInject && options.cacheResponse) {
                    DS.eject(resourceName, injected[definition.idAttribute], {
                      notify: false,
                    });
                  }
      ...
      function (require, module, exports) {
        ...
        function destroy(resourceName, id, options) {
          ...
          try {
            ...
            if (!definition) {
              throw new DS.errors.NER(
                errorPrefix(resourceName, id) + resourceName
              );
            } else if (!DSUtils.isString(id) && !DSUtils.isNumber(id)) {
              throw new DS.errors.IA(
                errorPrefix(resourceName, id) +
            ...
            if (!item) {
              throw new DS.errors.R(
                errorPrefix(resourceName, id) + 'id: "' + id + '" not found!'
              );
            }
        ...
        function destroyAll(resourceName, params, options) {
          ...
          try {
            ...
            if (!definition) {
              ...
              throw new IA(
                errorPrefix(resourceName) + "params: Must be an object!"
              );
            } else if (!DSUtils.isObject(options)) {
              throw new IA(
                errorPrefix(resourceName) + "options: Must be an object!"
              );
            }
        ...
        function find(resourceName, id, options) {
          ...
          try {
            ...
            if (!definition) {
              ...
              throw new IA(
                errorPrefix(resourceName, id) + "options: Must be an object!"
              );
            }
            ...
            if (!(id in resource.completedQueries)) {
              if (!(id in resource.pendingQueries)) {
                promise = resource.pendingQueries[id] = DS.adapters[
                  options.adapter || definition.defaultAdapter
                ]
                  .find(definition, id, options)
                  .then(
                    function (res) {
                      var data = options.deserialize
                        ? options.deserialize(resourceName, res)
                        : definition.deserialize(resourceName, res);
    ...
    60: [
      function (require, module, exports) {
        ...
        function processResults(data, resourceName, queryHash, options) {
          ...
          resource.collectionModified = DSUtils.updateTimestamp(
          ...
          if (DSUtils.isArray(injected)) {
            ...
            DS.$log.warn(
              errorPrefix(resourceName) + "response is expected to be an array!"
            );
        ...
        function _findAll(resourceName, params, options) {
          ...
          if (!(queryHash in resource.completedQueries)) {
            ...
            if (!(queryHash in resource.pendingQueries)) {
              ...
              resource.pendingQueries[queryHash] = DS.adapters[
                options.adapter || definition.defaultAdapter
              ]
        ...
        function loadRelations(resourceName, instance, relations, options) {
          ...
          try {
            ...
            if (!definition) {
              ...
              throw new IA(
                errorPrefix(resourceName) +
                  "instance(Id): Must be a string, number or object!"
              );
            } else if (!DSUtils.isArray(relations)) {
              throw new IA(
                errorPrefix(resourceName) +
                  "relations: Must be a string or an array!"
              );
            } else if (!DSUtils.isObject(options)) {
              throw new IA(
                errorPrefix(resourceName) + "options: Must be an object!"
              ...
              if (DSUtils.contains(relations, relationName)) {
                ...
                if (def.type === "hasMany" && params[def.foreignKey]) {
                  ...
                  if (def.localKey && instance[def.localKey]) {
                    task = DS.find(
                      relationName,
                      instance[def.localKey],
                      options
                    );
                  } else if (def.foreignKey && params[def.foreignKey]) {
                    task = DS.findAll(relationName, params, options).then(
                      function (hasOnes) {
        ...
        function update(resourceName, id, attrs, options) {
          ...
          try {
            ...
            if (!definition) {
              ...
              throw new IA(
                errorPrefix(resourceName, id) + "attrs: Must be an object!"
              );
            } else if (!DSUtils.isObject(options)) {
              throw new IA(
                errorPrefix(resourceName, id) + "options: Must be an object!"
    ...
    67: [
      function (require, module, exports) {
        ...
        Defaults.prototype.defaultFilter = function (
          collection,
          resourceName,
          params,
          options
            ...
            filtered = DSUtils.filter(filtered, function (attrs) {
              ...
              DSUtils.forEach(where, function (clause, field) {
                if (DSUtils.isString(clause)) {
                  ...
                  DSUtils.isNumber(clause) ||
                  DSUtils.isBoolean(clause)
                ) {
                  clause = {
                    "==": clause,
                  };
                  ...
                  DSUtils.forEach(clause, function (val, op) {
                    if (op === "==") {
                      ...
                      if (DSUtils.isString(val)) {
                        keep = first
                          ? val.indexOf(attrs[field]) !== -1
                          : keep && val.indexOf(attrs[field]) !== -1;
                      } else {
                        keep = first
                          ? DSUtils.contains(val, attrs[field])
                          : keep && DSUtils.contains(val, attrs[field]);
                      }
                    } else if (op === "notIn") {
                      if (DSUtils.isString(val)) {
                        keep = first
          ...
          if (orderBy) {
            ...
            angular.forEach(orderBy, function (def, i) {
              if (DSUtils.isString(def)) {
                ...
                throw new _this.errors.IllegalArgumentError(
      ...
      function (require, module, exports) {
        ...
        function bindAll(scope, expr, resourceName, params, cb) {
          ...
          if (!DS.utils.isObject(scope)) {
            throw new IA(
              errorPrefix(resourceName) + "scope: Must be an object!"
            );
      ...
      function (require, module, exports) {
        ...
        function bindOne(scope, expr, resourceName, id, cb) {
          ...
          if (!DS.utils.isObject(scope)) {
            ...
            throw new IA(
              errorPrefix(resourceName) + "id: Must be a string or a number!"
            );
          }
      ...
      function (require, module, exports) {
        ...
        function changeHistory(resourceName, id) {
          ...
          if (!definition.keepChangeHistory) {
            DS.$log.warn(
              errorPrefix(resourceName) +
                "changeHistory is disabled for this resource!"
            );
          } else {
            if (resourceName) {
              var item = DS.get(resourceName, id);
      ...
      function (require, module, exports) {
        ...
        function changes(resourceName, id, options) {
          ...
          if (item) {
            ...
            var diff = DSUtils.diffObjectFromOldObject(
              item,
              DS.store[resourceName].previousAttributes[id],
              options.ignoredChanges
            );
            ...
            DSUtils.forEach(
              DS.definitions[resourceName].relationFields,
              function (field) {
      ...
      function (require, module, exports) {
        ...
        function compute(resourceName, instance) {
          ...
          if (!definition) {
            ...
            !DS.utils.isObject(instance) &&
            !DS.utils.isString(instance) &&
            !DS.utils.isNumber(instance)
          ) {
            throw new IA(
              errorPrefix(resourceName) +
                "instance: Must be an object, string or number!"
            );
          }
        ...
        function defineResource(definition) {
          ...
          try {
            ...
            if (def.relations) {
              ...
              if (def.relations.belongsTo) {
                DSUtils.forEach(
                  ...
                  function (relatedModel, modelName) {
            ...
            def.getEndpoint = function (attrs, options) {
              ...
              if (
                ...
                if (DSUtils.isObject(attrs) && parentKey in attrs) {
                  ...
                  endpoint = DSUtils.makePath(
                    definitions[parent].getEndpoint(attrs, options),
                    attrs[parentKey],
                    thisEndpoint
                  );
            ...
            DSUtils.forEach(instanceMethods, function (name) {
              def[def["class"]].prototype["DS" + DSUtils.pascalCase(name)] =
                function () {
      ...
      function (require, module, exports) {
        ...
        function _eject(definition, resource, id, options) {
          ...
          if (found) {
            ...
            resource.collectionModified = this.utils.updateTimestamp(
              resource.collectionModified
            );
    ...
    77: [
      function (require, module, exports) {
        ...
        function _ejectAll(definition, resource, params, options) {
          ...
          delete resource.completedQueries[queryHash];
          resource.collectionModified = DS.utils.updateTimestamp(
            resource.collectionModified
          );
    ...
    78: [
      function (require, module, exports) {
        ...
        function filter(resourceName, params, options) {
          ...
          return definition.defaultFilter.call(
            DS,
            resource.collection,
            resourceName,
            params,
      ...
      function (require, module, exports) {
        ...
        function getAll(resourceName, ids) {
          ...
          if (!DS.definitions[resourceName]) {
            ...
            throw new IA(
              errorPrefix(resourceName, ids) + "ids: Must be an array!"
            );
          }
    ...
    83: [
      function (require, module, exports) {
        ...
        function _inject(definition, resource, attrs, options) {
          ...
          function _react(added, removed, changed, oldValueFn, firstTime) {
            ...
            var item;
            var innerId =
              oldValueFn && oldValueFn(definition.idAttribute)
                ? oldValueFn(definition.idAttribute)
                : target[definition.idAttribute];
            ...
            if (
              !DSUtils.isEmpty(added) ||
              !DSUtils.isEmpty(removed) ||
              !DSUtils.isEmpty(changed) ||
              firstTime
            ) {
              item = DS.get(definition.name, innerId);
              resource.modified[innerId] = DSUtils.updateTimestamp(
            ...
            if (definition.relations) {
              ...
              DSUtils.forEach(definition.relationList, function (def) {
                if (
                  item[def.localField] &&
                  (def.localKey in added ||
                    def.localKey in removed ||
                    def.localKey in changed)
                ) {
                  DS.link(definition.name, item[definition.idAttribute], [
                    def.relation,
                  ]);
                }
              });
            ...
            if (definition.idAttribute in changed) {
              $log.error(
                "Doh! You just changed the primary key of an object! " +
                  "I don't know how to handle this yet, so your data for the \"" +
                  definition.name +
          ...
          if (DSUtils.isArray(attrs)) {
            ...
            for (var i = 0; i < attrs.length; i++) {
              injected.push(
                _inject.call(DS, definition, resource, attrs[i], options)
              );
            }
          } else {
            ...
            if (!(idA in attrs)) {
              var error = new DS.errors.R(
                errorPrefix(definition.name) +
              ...
              try {
                DSUtils.forEach(definition.relationList, function (def) {
                  ...
                  if (toInject) {
                    if (!relationDef) {
                      throw new DS.errors.R(
                        definition.name +
                          "relation is defined but the resource is not!"
                      );
                    }
                    if (DSUtils.isArray(toInject)) {
                      ...
                      DSUtils.forEach(toInject, function (toInjectItem) {
                        if (
                          toInjectItem !==
                          DS.store[relationName][
                            toInjectItem[relationDef.idAttribute]
                          ]
                        ) {
                          try {
                            var injectedItem = DS.inject(
                              relationName,
                              toInjectItem,
                              options
                            );
                            if (def.foreignKey) {
                              injectedItem[def.foreignKey] =
                                attrs[definition.idAttribute];
                            }
                      ...
                      if (
                        toInject !==
                        DS.store[relationName][
                          toInject[relationDef.idAttribute]
                        ]
                      ) {
                        try {
                          attrs[def.localField] = DS.inject(
                            relationName,
                            attrs[def.localField],
                            options
                          );
                          if (def.foreignKey) {
                            attrs[def.localField][def.foreignKey] =
                              attrs[definition.idAttribute];
                          }
                        } catch (err) {
                          DS.$log.error(
                ...
                if (!item) {
                  ...
                  if (definition.resetHistoryOnInject) {
                    ...
                    if (resource.changeHistories[id].length) {
                      ...
                      resource.changeHistories[id].splice(
                        0,
                ...
                resource.modified[id] =
                  initialLastModified &&
                  resource.modified[id] === initialLastModified
                    ? DSUtils.updateTimestamp(resource.modified[id])
                    : resource.modified[id];
        ...
        function _link(definition, injected, options) {
          ...
          DS.utils.forEach(definition.relationList, function (def) {
            if (
              options.findBelongsTo &&
              def.type === "belongsTo" &&
              injected[definition.idAttribute]
            ) {
              DS.link(definition.name, injected[definition.idAttribute], [
                def.relation,
              ]);
            } else if (
              (options.findHasMany && def.type === "hasMany") ||
              (options.findHasOne && def.type === "hasOne")
            ) {
              DS.link(definition.name, injected[definition.idAttribute], [
                def.relation,
              ]);
        ...
        function inject(resourceName, attrs, options) {
          ...
          if (!definition) {
            ...
            throw new IA(
              errorPrefix(resourceName) +
                "attrs: Must be an object or an array!"
            );
          } else if (!DS.utils.isObject(options)) {
            throw new IA(
              errorPrefix(resourceName) + "options: Must be an object!"
          ...
          if (options.linkInverse && typeof options.linkInverse === "boolean") {
            ...
            if (DS.utils.isArray(injected)) {
              if (injected.length) {
                DS.linkInverse(
                  definition.name,
                  injected[0][definition.idAttribute]
                );
              }
            } else {
      ...
      { "../../../lib/observe-js/observe-js": 1, "./compute": 72 },
    ],
    84: [
      function (require, module, exports) {
        function errorPrefix(resourceName, id) {
      ...
      function (require, module, exports) {
        ...
        function _link(definition, linked, relations) {
          ...
          DS.utils.forEach(definition.relationList, function (def) {
            ...
            if (
              relations.length &&
              !DS.utils.contains(relations, relationName)
            ) {
              return;
            }
            var params = {};
            if (def.type === "belongsTo") {
              var parent = linked[def.localKey]
                ? DS.get(relationName, linked[def.localKey])
                : null;
              if (parent) {
              ...
              linked[def.localField] =
                DS.defaults.constructor.prototype.defaultFilter.call(
                  DS,
                  DS.store[relationName].collection,
                  relationName,
                  params,
        ...
        function link(resourceName, id, relations) {
          ...
          if (!definition) {
            ...
            throw new IA(
              errorPrefix(resourceName) + "relations: Must be an array!"
            );
          }
          ...
          DS.utils.forEach(definition.relationList, function (def) {
            ...
            if (def.type === "belongsTo") {
              DS.utils.forEach(linked, function (injectedItem) {
                var parent = injectedItem[def.localKey]
                  ? DS.get(relationName, injectedItem[def.localKey])
                  : null;
                if (parent) {
    ...
    91: [
      function (require, module, exports) {
        ...
        function NonexistentResourceError(resourceName) {
           ...
           */
          this.message =
            (resourceName || "") + " is not a registered resource!";
        }

        NonexistentResourceError.prototype = new Error();
        NonexistentResourceError.prototype.constructor =
          NonexistentResourceError;
    ...
    93: [
          ...
          function ($q) {
            return {
              ...
              resolveItem: function (resource, idOrInstance) {
                if (
                  resource &&
                  (this.isString(idOrInstance) || this.isNumber(idOrInstance))
                ) {
      ...
      },
      {
        ...
        "mout/array/slice": 10,
        "mout/array/sort": 11,
        "mout/array/toLookup": 12,
        "mout/lang/isBoolean": 19,
        "mout/lang/isEmpty": 20,
        "mout/lang/isRegExp": 25,
        "mout/object/deepMixIn": 31,
        "mout/object/keys": 35,
        "mout/object/merge": 36,
        "mout/object/mixIn": 37,
        "mout/object/pick": 39,
        "mout/object/set": 40,
        "mout/random/guid": 42,
        "mout/string/makePath": 49,
        "mout/string/pascalCase": 50,
        "mout/string/upperCase": 53,
      },
    ],
  },
  {},
