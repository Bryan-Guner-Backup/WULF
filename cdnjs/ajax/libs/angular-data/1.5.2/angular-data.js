...
(function e(t, n, r) {
...
})(
  {
        ...
        (function (global) {
          ...
          function isBlacklisted(prop, bl) {
            ...
            for (var i = 0; i < bl.length; i++) {
              if (
                (Object.prototype.toString.call(bl[i]) === "[object RegExp]" &&
                  bl[i].test(prop)) ||
                bl[i] === prop
              ) {
                return (matches = prop);
          ...
          function diffObjectFromOldObject(object, oldObject, equals, bl) {
            ...
            for (var prop in oldObject) {
              ...
              if (isBlacklisted(prop, bl)) continue;

              if (
                newValue !== undefined &&
                (equals
                  ? equals(newValue, oldObject[prop])
    ...
    12: [
      ...
      { "../object/deepMatches": 28, "./identity": 11, "./prop": 13 },
    ],
    13: [
      function (require, module, exports) {
        /**
    ...
    14: [
      ...
      { "../object/mixIn": 35, "./isPlainObject": 22, "./kindOf": 24 },
    ],
    15: [
      function (require, module, exports) {
    ...
    29: [
      ...
      { "../lang/isPlainObject": 22, "./forOwn": 31 },
    ],
    30: [
      function (require, module, exports) {
    ...
    34: [
      ...
      { "../lang/deepClone": 15, "../lang/isObject": 21, "./hasOwn": 32 },
    ],
    35: [
      function (require, module, exports) {
        var forOwn = require("./forOwn");
    ...
    41: [
      ...
      { "../number/MAX_INT": 26, "../number/MIN_INT": 27, "./random": 44 },
    ],
    42: [
      function (require, module, exports) {
        var choice = require("./choice");
    ...
    43: [
      ...
      { "../number/MAX_INT": 26, "../number/MIN_INT": 27, "./rand": 41 },
    ],
    44: [
      function (require, module, exports) {
        /**
    ...
    48: [
      ...
      { "../lang/toString": 25, "./camelCase": 45, "./upperCase": 51 },
    ],
    49: [
      function (require, module, exports) {
        var toString = require("../lang/toString");
    ...
    81: [
      ...
      { "../../../lib/observe-js/observe-js": 1, "./compute": 70 },
    ],
    82: [
      function (require, module, exports) {
        function errorPrefix(resourceName, id) {
    ...
    91: [
      ...
      },
      {
        ...
        "mout/lang/isRegExp": 23,
        "mout/object/deepMixIn": 29,
        "mout/object/keys": 33,
        "mout/object/merge": 34,
        "mout/object/mixIn": 35,
        "mout/object/pick": 37,
        "mout/object/set": 38,
        "mout/random/guid": 40,
        "mout/string/makePath": 47,
        "mout/string/pascalCase": 48,
        "mout/string/upperCase": 51,
      },
    ],
  },
  {},
