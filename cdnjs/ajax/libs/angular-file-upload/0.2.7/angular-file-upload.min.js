      ...
      function (b, c) {
        ...
        function d(b) {
          a.extend(
            ...
            this.bind("beforeupload", e.prototype._beforeupload),
            this.bind("in:progress", e.prototype._progress),
            this.bind("in:success", e.prototype._success),
            this.bind("in:error", e.prototype._error),
            this.bind("in:complete", e.prototype._complete),
        ...
        return (
          (d.prototype = {
            ...
            uploadItem: function (b) {
              if (!this.isUploading) {
                ...
                (this.isUploading = !0), this[e](d);
              }
            },
            uploadAll: function () {
              var a = this.getNotUploadedItems()[0];
              (this._uploadNext = !!a), this._uploadNext && this.uploadItem(a);
            },
            ...
            _xhrTransport: function (b) {
              ...
              a.forEach(b.formData, function (b) {
                ...
                c.addEventListener(
                  "load",
                  function () {
                    200 === c.status && e.trigger("in:success", c, b),
                      200 !== c.status && e.trigger("in:error", c, b),
          ...
          (e.prototype = {
            ...
            _success: function (a, b, c) {
              (c.isUploaded = !0),
                (c.isUploading = !1),
                c.uploader.trigger("success", b, c);
            },
            _error: function (a, b, c) {
              (c.isUploaded = !0),
                (c.isUploading = !1),
                c.uploader.trigger("error", b, c);
            },
            _complete: function (a, b, c) {
              (c.isUploaded = !0),
                (c.isUploading = !1),
                c.uploader.trigger("complete", b, c),
