!(function (a, b) {
  return "function" == typeof define && define.amd
    ? (define("angular-file-upload", ["angular"], function (a) {
        return b(a);
      }),
      void 0)
    : b(a);
  ...
  return (
    b.directive("ngFileDrop", function () {
      "use strict";
      return {
        link: window.File
          ? function (a, b, c) {
              b.bind("drop", function (b) {
                ...
                b.preventDefault(),
                  ...
                  a.$emit("file:add", d.files, a.$eval(c.ngFileDrop));
              })
    ...
    b.directive("ngFileSelect", function () {
      "use strict";
      return {
        link: function (a, b, c) {
          (window.File && window.FormData) || b.removeAttr("multiple"),
            b.bind("change", function () {
              a.$emit(
                "file:add",
                this.files ? this.files : this,
                a.$eval(c.ngFileSelect)
              ),
                window.File && b.prop("value", null);
            });
        },
      };
    }),
      ...
      function (b, c, d) {
        ...
        function e(b) {
          a.extend(
            ...
            (this._observer = this.scope.$new(!0)),
            ...
            this.bind("beforeupload", f.prototype._beforeupload),
            this.bind("in:progress", f.prototype._progress),
            this.bind("in:success", f.prototype._success),
            this.bind("in:error", f.prototype._error),
            this.bind("in:complete", f.prototype._complete),
            this.bind("changedqueue", this._changedQueue),
            this.bind("in:progress", this._progress),
            this.bind("in:complete", this._complete);
        }
        function f(c) {
          if (a.isElement(c.file)) {
            var d = a.element(c.file),
              e = b(d.clone())(c.uploader.scope.$new(!0)),
              f = a.element('<form style="display: none;" />'),
              g = a.element(
          ...
          a.extend(
            this,
            { progress: null, isUploading: !1, isUploaded: !1 },
            c
          );
        }
        return (
          (e.prototype = {
            ...
            bind: function (a, b) {
              return (
                this._observer.$on(this._timestamp + ":" + a, b.bind(this)),
                this
              );
            },
            trigger: function (a) {
              ...
              return (
                b.unshift(this._timestamp + ":" + a),
                this._observer.$emit.apply(this._observer, b),
                this
              );
            },
            hasHTML5: function () {
            ...
            addToQueue: function (b, c) {
              ...
              return (
                a.forEach(
                  "length" in b ? b : [b],
                  function (b) {
                    var d = this.filters.length
                      ? this.filters.every(function (a) {
                    ...
                    d &&
                      ...
                      this.queue.push(b),
                      this.trigger("afteraddingfile", b));
                  },
                  this
                ),
                this.queue.length !== d &&
            ...
            removeFromQueue: function (b) {
              var c = a.isObject(b) ? this.getIndexOfItem(b) : b,
                d = this.queue.splice(c, 1)[0];
              return (
                d.file._form && d.file._form.remove(),
                this.trigger("changedqueue", d),
                this
              );
            },
            clearQueue: function () {
              return (
                a.forEach(
                  this.queue,
                  function (a) {
                    a.file._form && a.file._form.remove();
                  },
                  this
                ),
                (this.queue.length = 0),
            ...
            getIndexOfItem: function (a) {
              return this.queue.indexOf(a);
            },
            ...
            uploadItem: function (b) {
              if (this.isUploading) return this;
              var c = a.isObject(b) ? this.getIndexOfItem(b) : b,
                d = this.queue[c],
                e = d.file._form ? "_iframeTransport" : "_xhrTransport";
              return (this.isUploading = !0), this[e](d), this;
            },
            uploadAll: function () {
              var a = this.getNotUploadedItems()[0];
              return (
                (this._uploadNext = !!a),
                this._uploadNext && this.uploadItem(a),
                this
              );
            },
              ...
              a.forEach(b.formData, function (b) {
                ...
                c.addEventListener(
                  ...
                  function () {
                    ...
                    200 === c.status && e.trigger("in:success", c, b, a),
                      200 !== c.status && e.trigger("in:error", c, b, a),
                      e.trigger("in:complete", c, b, a);
                  },
                  !1
                ),
                c.addEventListener(
                ...
                c.addEventListener(
                  "abort",
                  function () {
                    e.trigger("in:complete", c, b);
                  },
                  !1
                ),
                this.trigger("beforeupload", b),
                c.open("POST", b.url, !0),
                a.forEach(b.headers, function (a, b) {
            ...
            _iframeTransport: function (b) {
              ...
              a.forEach(e, function (a) {
                "file" !== a.type && a.parentNode.removeChild(a);
              }),
                e.prop("name", b.alias),
                a.forEach(b.formData, function (b) {
                ...
                d.unbind().bind("load", function () {
                  ...
                  f.trigger("in:complete", a, b, c);
                }),
                this.trigger("beforeupload", b),
                c[0].submit();
            },
            _transformResponse: function (b) {
              return (
                a.forEach(d.defaults.transformResponse, function (a) {
                  b = a(b);
                }),
                b
              );
          ...
          (f.prototype = {
            ...
            _beforeupload: function (a, b) {
              (b.isUploaded = !1), (b.isUploading = !0), (b.progress = null);
            },
            _progress: function (a, b, c) {
            ...
            _success: function (a, b, c, d) {
              (c.isUploaded = !0),
                (c.isUploading = !1),
                c.uploader.trigger("success", b, c, d);
            },
            _error: function (a, b, c, d) {
              (c.isUploaded = !0),
                (c.isUploading = !1),
                c.uploader.trigger("error", b, c, d);
            },
            _complete: function (a, b, c, d) {
              (c.isUploaded = !0),
                (c.isUploading = !1),
                c.uploader.trigger("complete", b, c, d),
                c.removeAfterUpload && c.remove();
            },
          }),
          {
            create: function (a) {
