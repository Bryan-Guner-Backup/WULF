    ...
    b.factory("$fileUploader", [
      ...
      function (b, c, d) {
        ...
        function f(c) {
          ...
          a.extend(
            this,
            { progress: null, isUploading: !1, isUploaded: !1, method: "POST" },
            c
          );
        }
        return (
          (e.prototype = {
            ...
            removeFromQueue: function (b) {
              ...
              return (
                d.file && d.file._form && d.file._form.remove(),
                ...
                c.addEventListener(
                  ...
                  function () {
                    var a = e._transformResponse(c.response),
                      d = ~[200, 201].indexOf(c.status)
                        ? "in:success"
                        : "in:error";
                    e.trigger(d, c, b, a), e.trigger("in:complete", c, b, a);
                  },
                  !1
                ),
                c.addEventListener(
            ...
            _iframeTransport: function (b) {
              ...
              this.trigger("beforeupload", b),
                a.forEach(e, function (b) {
                  "file" !== b.type && a.element(b).remove();
                }),
                e.prop("name", b.alias),
                a.forEach(b.formData, function (b) {
