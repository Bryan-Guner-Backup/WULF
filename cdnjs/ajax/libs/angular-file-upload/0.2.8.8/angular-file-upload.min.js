  ...
  return (
    ...
    b.directive("ngFileSelect", [
      ...
      function (a) {
        ...
        return {
          link: function (b, c, d) {
            a.hasHTML5 || c.removeAttr("multiple"),
              c.bind("change", function () {
                b.$emit(
                  "file:add",
                  this.files ? this.files : this,
                  b.$eval(d.ngFileSelect)
                ),
                  a.hasHTML5 && c.prop("value", null);
              });
          },
        };
      },
      ...
      function (b, c, d, e) {
        ...
        function f(b) {
          a.extend(
            ...
            this.bind("beforeupload", g.prototype._beforeupload),
            this.bind("in:progress", g.prototype._progress),
            this.bind("in:success", g.prototype._success),
            this.bind("in:error", g.prototype._error),
            this.bind("in:complete", g.prototype._complete),
