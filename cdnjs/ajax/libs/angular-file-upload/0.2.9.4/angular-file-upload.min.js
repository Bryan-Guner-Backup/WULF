      ...
      function (b, c, d, e) {
        ...
        return (
          (f.prototype = {
            ...
            bind: function (a, b) {
              return (
                this.scope.$on(this._timestamp + ":" + a, b.bind(this)), this
              );
            },
            trigger: function (a) {
              return (
                (arguments[0] = this._timestamp + ":" + a),
            ...
            removeFromQueue: function (b) {
              ...
              return d._destroyForm(), this.trigger("changedqueue", d), this;
            },
            clearQueue: function () {
              return (
            ...
            uploadItem: function (b) {
              var c = a.isObject(b) ? this.getIndexOfItem(b) : b,
                d = this.queue[c],
                e = d._hasForm() ? "_iframeTransport" : "_xhrTransport";
              return (
                (d.index = d.index || this._nextIndex++),
                (d.isReady = !0),
                this.isUploading
                  ? this
                  : ((this.isUploading = !0), this[e](d), this)
              );
            },
            uploadAll: function () {
            ...
            _transformResponse: function (a) {
              return (
                d.defaults.transformResponse.forEach(function (b) {
                  a = b(a);
                }),
                a
              );
          ...
          (g.prototype = {
            ...
            _complete: function (a, b, c, d) {
              (c.isUploaded = c.uploader._isSuccessCode(b.status)),
                (c.isUploading = !1),
                (c.isComplete = !0),
                (c.isReady = !1),
                (c.index = null),
