  ...
  return (
    ...
    b.directive("ngFileSelect", [
      ...
      function (a) {
        ...
        return {
          link: function (b, c, d) {
            a.isHTML5 || c.removeAttr("multiple"),
              c.bind("change", function () {
                var e = a.isHTML5 ? this.files : this,
                  f = b.$eval(d.ngFileSelect);
                b.$emit("file:add", e, f),
                  a.isHTML5 && c.attr("multiple") && c.prop("value", null);
              }),
              c.prop("value", null);
          },
        };
      ...
      function (b, c, d, e) {
        ...
        function f(b) {
          a.extend(
            ...
            this.bind("in:cancel", g.prototype._cancel),
        ...
        return (
          (f.prototype = {
              ...
              a.forEach(
                ...
                function (b) {
                  ...
                  d
                    ...
                    : this.trigger("whenaddingfilefailed", e);
                },
                this
              ),
                this.queue.length !== d &&
            ...
            uploadItem: function (a) {
              ...
              (c.index = c.index || this._nextIndex++),
                (c.isReady = !0),
              ...
              b._form && b._form.replaceWith(e),
                ...
                d.bind("load", function () {
                  var a = d[0].contentDocument.body.innerHTML,
                    c = { response: a, status: 200, dummy: !0 },
                    e = f._transformResponse(c.response);
                  f.trigger("in:success", c, b, e),
                    f.trigger("in:complete", c, b, e);
                }),
                (c.abort = function () {
                  var a = { status: 0, dummy: !0 };
                  d.unbind("load").prop("src", "javascript:false;"),
                    c.replaceWith(e),
                    f.trigger("in:cancel", a, b),
