...
!(function (a, b) {
  return "function" == typeof define && define.amd
    ? (define("angular-file-upload", ["angular"], function (a) {
      ...
      void 0)
    : b(a);
})("undefined" == typeof angular ? null : angular || null, function (a) {
        ...
        function (b, c, d, e, f) {
          ...
          function h(a) {
            ...
            (this.lastModifiedDate = null),
              (this.size = null),
              (this.type =
                "like/" + b.slice(b.lastIndexOf(".") + 1).toLowerCase()),
              (this.name = b.slice(
                b.lastIndexOf("/") + b.lastIndexOf("\\") + 2
              ));
          }
          function i(b, c, d, e) {
            (c = b._getFileOrFileLikeObject(c)),
              a.extend(
                this,
                {
                  url: b.url,
              ...
              e &&
                ((this._input = a.element(e)), this._replaceNode(this._input));
          }
          function j(b) {
            a.extend(this, b),
          ...
          return (
            (g.prototype.isHTML5 = !(!e.File || !e.FormData)),
            (g.prototype.addToQueue = function (b, c, d) {
              var e = a.isElement(b) ? [b] : b,
              ...
              a.forEach(
                e,
                function (a) {
                  var b = this._getFileOrFileLikeObject(a);
                  if (this._isValidFile(b, f, c)) {
                    var d = this.isFile(b) ? null : a,
                      e = new g.FileItem(this, b, c, d);
                    i.push(e), this.queue.push(e), this._onAfterAddingFile(e);
                  } else {
                    var h = this.filters[this._failFilterIndex];
                    this._onWhenAddingFileFailed(b, h, c);
                  }
                },
                this
              ),
                this.queue.length !== h &&
                  (this._onAfterAddingAll(i),
            ...
            (g.prototype._getFileOrFileLikeObject = function (a) {
              return this.isFile(a) || this.isFileLikeObject(a)
                ? a
                : new g.FileLikeObject(a.value);
            }),
            ...
            (g.prototype._xhrTransport = function (b) {
              ...
              e._onBeforeUploadItem(b),
                ...
                d.append(b.alias, b._file),
                (c.upload.onprogress = function (a) {
                  var c = Math.round(
                    a.lengthComputable ? (100 * a.loaded) / a.total : 0
                  );
            ...
            (k.prototype.onChange = function () {
              ...
              this.uploader.isHTML5 || this.destroy(),
                ...
                this.uploader.isHTML5 && this.element.prop("value", null);
            }),
            g.inherit(l, j),
            (l.prototype.events = {
              $destroy: "destroy",
