    ...
    .factory("FileUploader", [
      ...
      function (fileUploaderOptions, $rootScope, $http, $window, $compile) {
        ...
        FileUploader.prototype.addToQueue = function (files, options, filters) {
          ...
          angular.forEach(
            list,
            function (some /*{File|HTMLInputElement|Object}*/) {
         ...
         * @private
         */
        FileUploader.prototype.onWhenAddingFileFailed = function (
          item,
          filter,
          options
        ) {};
         ...
         */
        FileUploader.prototype.onSuccessItem = function (
          item,
          response,
          status,
          headers
         ...
         * @param {Object} headers
         */
        FileUploader.prototype.onErrorItem = function (
          item,
          response,
          status,
          headers
         ...
         * @param {Object} headers
         */
        FileUploader.prototype.onCancelItem = function (
          item,
          response,
          status,
          headers
         ...
         * @param {Object} headers
         */
        FileUploader.prototype.onCompleteItem = function (
          item,
          response,
          status,
          headers
         ...
         * @private
         */
        FileUploader.prototype._isValidFile = function (
          file,
          filters,
          options
        ) {
         ...
         * @private
         */
        FileUploader.prototype._transformResponse = function (
          response,
          headers
        ) {
         ...
         * @private
         */
        FileUploader.prototype._onSuccessItem = function (
          item,
          response,
          status,
          headers
         ...
         * @private
         */
        FileUploader.prototype._onErrorItem = function (
          item,
          response,
          status,
          headers
         ...
         * @private
         */
        FileUploader.prototype._onCancelItem = function (
          item,
          response,
          status,
          headers
         ...
         * @private
         */
        FileUploader.prototype._onCompleteItem = function (
          item,
          response,
          status,
          headers
         ...
         */
        FileUploader.isArrayLikeObject =
        ...
        function FileLikeObject(fileOrInput) {
          ...
          var postfix = angular.isString(fakePathOrObject)
            ? "FakePath"
            : "Object";
        ...
        FileSelect.prototype.onChange = function () {
          var files = this.uploader.isHTML5
