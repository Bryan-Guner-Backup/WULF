  ...
  String.prototype.contains ||
      ...
      function (a, b) {
        return function (c, d) {
          ...
          return (
            ...
            b.memoize("groupBy", arguments, this, e(c, f))
          );
        };
      },
    ]),
    ...
    b.module("a8m.filter-watcher", []).provider("filterWatcher", function () {
      this.$get = [
        ...
        function (a, b) {
          function c(a, b) {
            return [a, JSON.stringify(b)].join("#").replace(/"/g, "");
          }
          function d(a) {
          ...
          function f(a, b) {
            var c = a.$id;
            return y(j[c]) && (a.$on("$destroy", d), (j[c] = [])), j[c].push(b);
          }
          function g(a, b) {
            var d = c(a, b);
            return i[d];
          ...
          function h(a, b, d, g) {
            var h = c(a, b);
            return (i[h] = g), k(d) ? f(d, h) : e(), g;
          }
          var i = {},
            j = {},
            l = a.setTimeout;
          return { isMemoized: g, memoize: h };
        },
      ];
    }),
