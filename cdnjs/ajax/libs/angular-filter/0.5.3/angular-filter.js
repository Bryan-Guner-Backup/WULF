...
(function (window, angular, undefined) {
   ...
   * 1024 bytes => 1 KB
   */
  angular.module("a8m.math.byteFmt", ["a8m.math"]).filter("byteFmt", [
    "$math",
    function ($math) {
   ...
   */
  angular.module("a8m.math.degrees", ["a8m.math"]).filter("degrees", [
    "$math",
    function ($math) {
   ...
   * 1024 kilobytes => 1 MB
   */
  angular.module("a8m.math.kbFmt", ["a8m.math"]).filter("kbFmt", [
    "$math",
    function ($math) {
      return function (bytes, decimal) {
        if (
   ...
   */
  angular.module("a8m.math.max", ["a8m.math"]).filter("max", [
    "$math",
    "$parse",
    function ($math, $parse) {
   ...
   */
  angular.module("a8m.math.min", ["a8m.math"]).filter("min", [
    "$math",
    "$parse",
    function ($math, $parse) {
      return function (input, expression) {
   ...
   */
  angular.module("a8m.math.percent", ["a8m.math"]).filter("percent", [
    "$math",
    "$window",
   ...
   */
  angular.module("a8m.math.radians", ["a8m.math"]).filter("radians", [
    "$math",
    function ($math) {
   ...
   */
  angular.module("a8m.math.shortFmt", ["a8m.math"]).filter("shortFmt", [
    "$math",
    function ($math) {
