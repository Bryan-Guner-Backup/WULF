...
(function (root, factory) {
  ...
  angular.module("formlyBootstrap").run([
    "$templateCache",
    function ($templateCache) {
      "use strict";

      $templateCache.put(
        "fields/formly-field-checkbox.html",
      ...
      $templateCache.put(
        "fields/formly-field-email.html",
      ...
      $templateCache.put(
        "fields/formly-field-hidden.html",
        '<input type=hidden ng-model="model[options.key || index]">'
      );

      $templateCache.put(
        "fields/formly-field-number.html",
      ...
      $templateCache.put(
        "fields/formly-field-password.html",
      ...
      $templateCache.put(
        "fields/formly-field-radio.html",
      ...
      $templateCache.put(
        "fields/formly-field-select.html",
      ...
      $templateCache.put(
        "fields/formly-field-textarea.html",
  ...
  angular.module("formlyBootstrap").config([
    ...
    function (formlyConfigProvider) {
      ...
      angular.forEach(fields, function (field) {
        formlyConfigProvider.setTemplateUrl(
          field,
          "fields/formly-field-" + field + ".html"
        );
      });
    },
  ]);
