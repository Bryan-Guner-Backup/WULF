    ...
    a.module(
      ...
      [
        ...
        function (b) {
          "use strict";
          function c(a) {
            return "fields/formly-field-" + a + ".html";
          }
          b.setWrapper([
            {
              name: "bootstrapLabel",
          ...
          var d = ["bootstrapLabel", "bootstrapHasError"];
          a.forEach(["radio", "select"], function (a) {
            b.setType({ name: a, templateUrl: c(a), wrapper: d });
          }),
            b.setType({
              name: "input",
              template:
            ...
            b.setType({
              ...
              wrapper: d,
              defaultOptions: {
                data: { ngModelAttributes: { rows: "rows", cols: "cols" } },
              },
            }),
            b.setType({
              name: "checkbox",
              templateUrl: c("checkbox"),
              wrapper: ["bootstrapHasError"],
            }),
            b.templateManipulators.preWrapper.push(function (b, c, d) {
              if (
                c.templateOptions &&
                a.isDefined(c.templateOptions.description) &&
                "radio" !== c.type &&
                "checkbox" !== c.type
              ) {
                var e = a.element("<a></a>");
                e.append(b);
                var f = a.element(e[0].querySelectorAll("[ng-model]"));
                return f
                  ? (e.append(
                      '<p id="' +
                        d.id +
                        '_description"class="help-block"ng-if="options.templateOptions.description">{{options.templateOptions.description}}</p>'
                    ),
                    f.attr("aria-describedby", d.id + "_description"),
                    e.html())
                  : b;
              }
              return b;
