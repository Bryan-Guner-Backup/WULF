...
(function (root, factory) {
  ...
  angular.module(
    ...
    [
      ...
      function configFormlyVanilla(formlyConfigProvider) {
        "use strict";
        ...
        formlyConfigProvider.templateManipulators.preWrapper.push(
  ...
  angular.module("formlyBootstrap").run([
    ...
    function ($templateCache) {
      ...
      $templateCache.put(
        "wrappers/formly-wrappers-bootstrap-has-error.html",
      ...
      $templateCache.put(
        "wrappers/formly-wrappers-bootstrap-label.html",
