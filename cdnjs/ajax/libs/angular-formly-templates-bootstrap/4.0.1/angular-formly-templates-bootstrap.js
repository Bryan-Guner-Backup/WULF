          ...
          module.exports = function (ngModule) {
            ...
            function addWrappers(formlyConfigProvider) {
              formlyConfigProvider.setWrapper([
                { name: "bootstrapLabel", template: __webpack_require__(17) },
                {
            ...
            function addCheckboxType(
              ...
              formlyConfigProvider.setType({
                ...
                validateOptions: function validateOptions(options) {
                  formlyBootstrapApiCheck.warn(
                    formlyBootstrapApiCheck.shape({
              ...
              formlyConfigProvider.setType({
                ...
                validateOptions: function validateOptions(options) {
                  formlyBootstrapApiCheck.warn(
                    formlyBootstrapApiCheck.shape({
                      templateOptions: formlyBootstrapApiCheck.shape({
                        options: formlyBootstrapApiCheck.arrayOf(
                          formlyBootstrapApiCheck.object
                        ),
            ...
            function addDescriptionManipulator(formlyConfig) {
              formlyConfig.templateManipulators.preWrapper.push(
                function ariaDescribedBy(template, options, scope) {
                  if (
                    angular.isDefined(options.templateOptions.description) &&
                    options.type !== "radio" &&
