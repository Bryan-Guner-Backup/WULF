    ...
    function (a, b) {
      ...
      return {
        ...
        compile: function () {
          return {
            post: function (e, f, g) {
              (e.options = angular.extend(a.getOptions(), e.options)),
                e.options.submitButtonTemplate &&
                  f
                    .find("button")
                    .replaceWith(b(e.options.submitButtonTemplate)(e));
              var h = d;
              e.options.useNgIfToHide &&
                (h = h.replace(c, 'ng-if="!field.hide"')),
                f.find("div").replaceWith(b(h)(e)),
                (e.formOnParentScope = e[g.name]);
            },
          };
        },
        controller: [
          ...
          function (a, b, c) {
            angular.forEach(a.fields, function (b) {
              if (
                ...
                angular.isDefined(b.watch.expression) &&
                angular.isDefined(b.watch.listener)
              ) {
                ...
                function () {
                  angular.forEach(a.fields, function (b) {
                    b.hideExpression &&
                      ...
                      b.requiredExpression &&
                        (b.required = c(b.requiredExpression)(a.result));
                  });
                },
                !0
              );
