      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = function (ngModule) {
          ...
          var typeOptionsApi = apiCheck.shape({
            ...
            defaultOptions: apiCheck.oneOfType([apiCheck.func, fieldOptionsApi])
              .optional,
          ...
          ngModule.constant("formlyApiTypes", {
            typeOptionsApi: typeOptionsApi,
            fieldOptionsApi: fieldOptionsApi,
          });
        };
	  ...
	  \*********************/
              /***/ function (module, exports, __webpack_require__) {
                ...
                function apiCheck(api, args, output) {
                  ...
                  if (!args) {
                    throw new Error(
                      "apiCheck failed: Must pass arguments to check"
                    );
                  }
                  args = Array.prototype.slice.call(args);
                  if (checkers.array(api)) {
                    success =
                      checkEnoughArgs(api, args) && checkMultiArgApi(api, args);
                  } else if (checkers.func(api)) {
                    success = api(args[0]);
                  } else {
                    throw new Error(
                      "apiCheck failed: Must pass an array or a function"
                    );
                  }
                  return success
                    ? null
                    : module.exports.getErrorMessage(api, args, output);
                }
                ...
                function getErrorMessage(api, args) {
                  ...
                  var url =
                    gOut.docsBaseUrl &&
                    output.url &&
                    ("" + gOut.docsBaseUrl + "" + output.url).trim();
                  return (
                    "" +
                    prefix +
                    " " +
                ...
                function buildMessageFromApiAndArgs(api, args) {
                  ...
                  var apiTypes = api
                    ...
                    .join(", ");
                  var passedTypes = args.length
                    ? "`" + args.map(getArgDisplay).join(", ") + "`"
                    : "nothing";
                  return (
                    "apiCheck failed! You passed: " +
                    passedTypes +
	  ...
	  \*************************/
              /***/ function (module, exports, __webpack_require__) {
                ...
                function getCheckerDisplay(checker) {
                  return (
                    (checker.type || checker.displayName || checker.name) +
	  ...
	  \*********************/
              /***/ function (module, exports, __webpack_require__) {
                ...
                each(checkers, function (checker) {
                  checker.displayName =
                    "apiCheck `" + checker.type + "` type checker";
                });
                ...
                function oneOfTypeCheckGetter(checkers) {
                  ...
                  oneOfTypeChecker.type = checkers
                    .map(getCheckerDisplay)
                    .join(" or ");
                ...
                function getShapeCheckGetter() {
                  function shapeCheckGetter(shape) {
                    ...
                    shapeChecker.type =
                      "shape(" + JSON.stringify(copiedShape) + ")";
                    makeOptional(shapeChecker);
                    return shapeChecker;
                  }

                  shapeCheckGetter.ifNot = function ifNot(
                    otherProps,
                    propChecker
                  ) {
                    ...
                    function ifNotChecker(prop, propName, obj) {
                      ...
                      var otherPropsExist = otherProps.some(function (
                        otherProp
                      ) {
                        return obj && obj.hasOwnProperty(otherProp);
                      });
                      return (
                        propExists !== otherPropsExist &&
                        (!propExists ||
                          (propExists && propChecker(prop) && !otherPropsExist))
                      );
                    }
                  ...
                  shapeCheckGetter.onlyIf = function onlyIf(
                    otherProps,
                    propChecker
                  ) {
                    if (!Array.isArray(otherProps)) {
                    ...
                    function onlyIfChecker(prop, propName, obj) {
                      return (
                        otherProps.every(function (prop) {
                          return obj.hasOwnProperty(prop);
                        }) && propChecker(prop)
                      );
                    }
                    onlyIfChecker.type =
                      "onlyIf[" + otherProps.join(", ") + "]";
