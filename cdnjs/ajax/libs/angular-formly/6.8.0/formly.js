...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  this,
  function (__WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_17__) {
    return /******/ (function (modules) {
      ...
      /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var formlyErrorAndWarningsUrlPrefix = _interopRequire(
          ...
          var formlyValidationMessages = _interopRequire(
          ...
          var formlyNgModelAttrsManipulator = _interopRequire(
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var fieldOptionsApiShape = {
            ...
            validation: apiCheck.shape({
              show: apiCheck.oneOfType([apiCheck.bool, apiCheck.oneOf([null])])
                .optional,
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function formlyCustomValidation(formlyUtil, $q) {
            return {
              restrict: "A",
              require: "ngModel",
              link: function formlyCustomValidationLink(
                scope,
                el,
                attrs,
                ctrl
                ...
                angular.forEach(
                  opts.validators,
                  function addValidatorToPipeline(validator, name) {
                    ...
                    function setupWithParsers() {
                      ...
                      ctrl.$parsers.unshift(function evalValidityOfParser(
                        viewValue
                      ) {
          ...
          function formlyField(
            ...
            function FormlyFieldController(
                ...
                $timeout(function runExpressionsOnNextTick() {
                  ...
                  angular.forEach(
                    ...
                    function runExpression(expression, prop) {
                      ...
                      var promise = $q.when(
                        formlyUtil.formlyEval($scope, expression, currentValue)
                      );
              ...
              function setDefaultValue() {
                if (
                  angular.isDefined($scope.options.defaultValue) &&
                  !angular.isDefined($scope.model[$scope.options.key])
                ) {
                ...
                angular.forEach(
                  ...
                  function createFunctionForMessage(expression, name) {
                    if (!options.validation.messages[name]) {
                      options.validation.messages[name] =
            ...
            function fieldLink(scope, el) {
              ...
              getFieldTemplate(scope.options)
                .then(
                  runManipulators(formlyConfig.templateManipulators.preWrapper)
                )
                .then(transcludeInWrappers(scope.options))
                .then(
                  runManipulators(formlyConfig.templateManipulators.postWrapper)
                )
              ...
              function watchFormControl(templateString) {
                ...
                var ngModelNode = templateEl[0].querySelector(
                    ...
                    function watchShowValidationChange() {
                      ...
                      if (!fc.$invalid) {
                        ...
                        var noTouchedButDirty =
                          angular.isUndefined(fc.$touched) && fc.$dirty;
                        return scope.fc.$touched || noTouchedButDirty;
                      }
                    },
                    function onShowValidationChange(show) {
                      scope.options.validation.errorExistsAndShouldBeVisible =
                        show;
            ...
            return {
              ...
              template: function formlyFormGetTemplate(el, attrs) {
                ...
                if (
                  ...
                  el.parent().parent().hasClass("formly")
                ) {
                ...
                function copyAttributes(attributes) {
                  ...
                  angular.forEach(attributes, function (_ref) {
                    ...
                    if (
                      ...
                      arrayAttrs.push(
                        "" + toKebabCase(nodeName) + '="' + nodeValue + '"'
                      );
                    }
                  });
              ...
              controller: /* @ngInject */ [
                "$scope",
                "formlyUtil",
                function FormlyFormController($scope, formlyUtil) {
                  setupOptions();
                    ...
                    angular.forEach(
                      ...
                      function runFieldExpressionProperties(field, index) {
                        ...
                        if (field.hideExpression) {
                          ...
                          field.hide = formlyUtil.formlyEval(
                            $scope,
                  ...
                  function setupWatchers(field, index) {
                    if (
                      isFieldGroup(field) ||
                      !angular.isDefined(field.watcher)
                    ) {
                      return;
                    }
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function addFormlyNgModelAttrsManipulator(formlyConfig) {
            ...
            function ngModelAttrsManipulator(template, options, scope) {
              ...
              var modelNodes = el.querySelectorAll(
                "[ng-model], [data-ng-model]"
              );
