    ...
    return {
      ...
      controller: [
        ...
        function ($scope, $element) {
          ...
          $scope.$watch(
            "viewScale+columnWidth+columnSubScale+fromDate+toDate+firstDayOfWeek+weekendDays+showWeekends+workHours+showNonWorkHours",
...
gantt.directive("ganttLabelResizable", [
  "$document",
  "debounce",
  "mouseOffset",
