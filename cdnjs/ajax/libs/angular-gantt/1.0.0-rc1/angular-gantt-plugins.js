...
angular
  .module("gantt.history.templates", [])
  .run(["$templateCache", function ($templateCache) {}]);
            ...
            api.directives.on.new(
              ...
              function (directiveName, taskScope, taskElement) {
                if (directiveName === "ganttTask") {
                  ...
                  taskElement.append(
                    $compile("<gantt-task-bounds></gantt-bounds>")(boundsScope)
                  );
                ...
                var moveTask = function (mode, evt) {
                  ...
                  if (mode === "M") {
                    ...
                    if (allowRowSwitching) {
                      ...
                      var targetScope = utils.scopeFromPoint(
                        scrollRect.left,
                        evt.clientY
                      );
            ...
            api.directives.on.new(
              ...
              function (directiveName, taskScope, taskElement) {
                if (directiveName === "ganttTask") {
                  ...
                  taskElement.append(
                    $compile(
                      '<gantt-task-progress ng-if="task.model.progress !== undefined"></gantt-task-progress>'
                    )(progressScope)
                  );
            ...
            api.directives.on.new(
              ...
              function (directiveName, taskScope, taskElement) {
                if (directiveName === "ganttTask") {
                  ...
                  taskElement.append(
                    $compile('<gantt-tooltip ng-model="task"></gantt-tooltip>')(
                      tooltipScope
                    )
                  );
      ...
      return {
        ...
        controller: [
          ...
          function ($scope, $element) {
            ...
            $scope.$watchGroup(
              ["task.model.est", "task.model.lct", "task.left", "task.width"],
              function () {
                if (
                  ...
                  $scope.bounds = {};
                  $scope.bounds.left =
                    $scope.task.rowsManager.gantt.getPositionByDate(
            ...
            $scope.getCss = function () {
              if ($scope.bounds !== undefined) {
                ...
                if (
                  $scope.task.isMilestone() === true ||
                  $scope.task.width === 0
                ) {
                  css.left =
                    $scope.bounds.left - ($scope.task.left - 0.3) + "px";
                } else {
        ...
        controller: [
          ...
          function ($scope, $element) {
            $scope.getClasses = function () {
              ...
              if (
                $scope.task.model.progress !== undefined &&
                typeof $scope.task.model.progress !== "object"
              ) {
