    ...
    function (moment) {
      ...
      Column.prototype.getMagnetDate = function (date) {
        if (this.columnMagnetValue > 0 && this.columnMagnetUnit !== undefined) {
          ...
          var magnetValue =
            Math.round(value / this.columnMagnetValue) * this.columnMagnetValue;
    ...
    function (Column, moment) {
      var ColumnGenerator = function (columnsManager) {
        ...
        if (columnsManager.gantt.$scope.columnMagnet) {
          var splittedColumnMagnet = columnsManager.gantt.$scope.columnMagnet
            .trim()
            .split(" ");
    ...
    function (ColumnGenerator, HeaderGenerator, $filter, $timeout, layout, bs) {
      ...
      ColumnsManager.prototype.updateColumnsMeta = function () {
        ...
        if (this.gantt.$scope.columnWidth === undefined) {
          var newWidth =
            this.gantt.$scope.ganttElementWidth -
            (this.gantt.$scope.showLabelsColumn
              ? this.gantt.$scope.labelsWidth
              : 0);
      ...
      ColumnsManager.prototype.updateVisibleColumns = function () {
        this.visibleColumns = $filter("ganttColumnLimit")(
          this.columns,
          this.gantt.$scope.scrollLeft,
          this.gantt.$scope.scrollWidth
        );
...
(function () {
  "use strict";
  angular.module("gantt").directive("ganttLabelsResize", [
    "$document",
    "ganttDebounce",
    "ganttMouseOffset",
...
(function () {
  "use strict";
  angular.module("gantt").directive("ganttLimitUpdater", [
    "$timeout",
    "ganttDebounce",
        ...
        if (firstColumn !== undefined && lastColumn !== undefined) {
          for (var i = 0, l = input.length; i < l; i++) {
            ...
            if (task.active) {
              ...
              if (
                task.model.to > gantt.columnsManager.getFirstColumn().date &&
                task.model.from < gantt.columnsManager.getLastColumn().endDate
              ) {
        ...
        controller: [
          ...
          function ($scope, $element) {
            ...
            var updateListeners = function () {
              ...
              for (
                i = 0, l = $scope.scrollManager.vertical.length;
                i < l;
                i++
              ) {
            ...
            $scope.$watchGroup(
              ["labelsWidth", "bodyRowsWidth", "bodyRowsHeight"],
              function (newValues) {
