    ...
    function (moment) {
      return {
        initialize: function (options) {
          ...
          options.allowSideResizing =
            options.allowSideResizing !== undefined
              ? !!options.allowSideResizing
              : true;
    ...
    function () {
      ...
      Task.prototype.moveTo = function (x, magnetEnabled) {
        if (x > this.left) {
          ...
          var newTaskRight = this.rowsManager.gantt.getPositionByDate(
            this.model.to
          );
          this.model.from = this.rowsManager.gantt.getDateByPosition(
            newTaskRight - this.modelWidth,
            false
          );
        } else {
        ...
        if (firstColumn !== undefined && lastColumn !== undefined) {
          ...
          for (var i = 0, l = input.length; i < l; i++) {
            ...
            if (task.active) {
              ...
              if (
                task.model.to > firstColumn.date &&
...
(function () {
  ...
  angular.module("gantt").directive("ganttScrollable", [
    ...
    "ganttDebounce",
    "moment",
    function (Builder, debounce, moment) {
...
(function () {
  "use strict";
  angular.module("gantt").directive("ganttElementLeftListener", [
    function () {
      return {
        restrict: "A",
        controller: [
    ...
    function (Builder) {
      ...
      builder.controller = function ($scope, $element) {
        ...
        $scope.getHeaderCss = function () {
          ...
          if (
            $scope.gantt.width - $scope.gantt.side.getWidth() >
            $scope.gantt.width
          ) {
