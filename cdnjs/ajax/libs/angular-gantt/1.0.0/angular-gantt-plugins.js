            ...
            function (directiveName, taskScope, taskElement) {
              if (directiveName === "ganttTask") {
                ...
                var getMoveMode = function (x) {
                  ...
                  if (allowResizing) {
                    distance =
                      taskElement[0].offsetWidth < taskWithSmallWidth
                ...
                var disableMoveMode = function () {
                  var styleElement =
                    taskScope.task.getStyleElement(taskElement);
...
(function () {
  ...
  angular.module("gantt").directive("ganttRowHeader", [
    ...
    function (Builder) {
      var builder = new Builder(
        "ganttRowHeader",
        "plugins/labels/rowHeader.tmpl.html"
      );
      return builder.build();
    },
  ]);
...
(function () {
  ...
  angular.module("gantt").directive("ganttRowLabel", [
    ...
    function (Builder) {
      var builder = new Builder(
        "ganttRowLabel",
        "plugins/labels/rowLabel.tmpl.html"
      );
      return builder.build();
    },
  ]);
...
(function () {
  "use strict";
  angular.module("gantt").directive("ganttRowLabels", [
    "GanttDirectiveBuilder",
    function (Builder) {
      var builder = new Builder(
        "ganttRowLabels",
        "plugins/labels/rowLabels.tmpl.html"
      );
      return builder.build();
    },
  ]);
...
(function () {
  "use strict";
  angular.module("gantt").directive("ganttSideContentLabels", [
    "GanttDirectiveBuilder",
    function (Builder) {
      var builder = new Builder(
