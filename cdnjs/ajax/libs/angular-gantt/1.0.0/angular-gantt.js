    ...
    function (
      ...
      ColumnsManager.prototype.getHeaderFormat = function (unit) {
        ...
        if (format === undefined) {
          ...
          if (
            ["millisecond", "second", "minute", "hour"].indexOf(viewScale) > -1
          ) {
          ...
          function (newValues, oldValues) {
            if (newValues !== oldValues) {
              ...
              if (
                ...
                self.shiftColumnMagnetValue = parseFloat(
                  splittedColumnMagnet[0]
                );
    ...
    function () {
      ...
      Task.prototype.getStyleElement = function () {
        if (this.$element !== undefined) {
          var styleElement = this.$element[0].querySelector(
