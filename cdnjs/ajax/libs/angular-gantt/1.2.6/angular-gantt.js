...
(function () {
  ...
  angular
    ...
    .directive("gantt", [
      ...
      "$timeout",
      "$templateCache",
      function (Gantt, enableNgAnimate, $timeout, $templateCache) {
        return {
          restrict: "A",
          transclude: true,
  ...
  angular.module("gantt").factory("GanttApi", [
    ...
    function ($q, $rootScope, utils) {
      ...
      GanttApi.prototype.suppressEvents = function (listenerFuncs, callBackFn) {
        var self = this;
        var listeners = angular.isArray(listenerFuncs)
          ? listenerFuncs
          : [listenerFuncs];
        ...
        foundListeners.forEach(function (l) {
          l.dereg = registerEventWithAngular(
            l.eventId,
            l.handler,
            self.gantt,
            l._this
      ...
      GanttApi.prototype.registerEvent = function (featureName, eventName) {
        ...
        var eventId =
          "event:gantt:" + this.apiId + ":" + featureName + ":" + eventName;

        // Creating raise event method featureName.raise.eventName
        feature.raise[eventName] = function () {
          $rootScope.$emit.apply(
            $rootScope,
        ...
        feature.on[eventName] = function (scope, handler, _this) {
          var deregAngularOn = registerEventWithAngular(
            eventId,
            handler,
            self.gantt,
            _this
       ...
       */
      GanttApi.prototype.registerMethod = function (
        featureName,
        methodName,
        callBackFn,
        _this
        ...
        feature[methodName] = utils.createBoundedWrapper(
          _this || this.gantt,
          callBackFn
        );
      };
       ...
       */
      GanttApi.prototype.registerMethodsFromObject = function (
        methodMap,
        _this
      ) {
        var self = this;
  ...
  angular.module("gantt").factory("GanttCalendar", [
    ...
    function ($filter, moment) {
      ...
      Calendar.prototype.registerTimeFrameMappings = function (mappings) {
        angular.forEach(
          mappings,
          function (timeFrameMapping, name) {
            this.timeFrameMappings[name] = new TimeFrameMapping(
              timeFrameMapping
            );
          },
          this
        ...
        angular.forEach(
          ...
          function (dateFrame) {
            if (dateFrame !== undefined) {
              angular.forEach(
                dateFrame.targets,
                function (timeFrameMappingName) {
                  var timeFrameMapping =
                    this.timeFrameMappings[timeFrameMappingName];
...
(function () {
  ...
  angular.module("gantt").factory("GanttCurrentDateManager", [
    ...
    function (moment) {
      ...
      GanttCurrentDateManager.prototype.setCurrentDate = function (
        currentDate
      ) {
        ...
        if (
          this.date !== undefined &&
          this.gantt.options.value("currentDate") === "column"
        ) {
          var column = this.gantt.columnsManager.getColumnByDate(
            this.date,
            true
          );
...
(function () {
  ...
  angular.module("gantt").factory("GanttColumn", [
    ...
    function (moment) {
            ...
            if (timeFramesWidth !== self.width) {
              ...
              angular.forEach(self.timeFrames, function (timeFrame) {
                if (
                  ...
                  timeFrame.left =
                    (timeFrame.left - croppedWidth) * croppedRatio;
      ...
      Column.prototype.getMagnetDate = function (
        date,
        magnetValue,
        magnetUnit,
        timeFramesMagnet
        ...
        if (magnetValue > 0 && magnetUnit !== undefined) {
          ...
          if (timeFramesMagnet) {
            var maxTimeFrameDiff = Math.abs(
              initialDate.diff(date, "milliseconds")
            );
            ...
            for (var i = 0; i < this.timeFrames.length; i++) {
              ...
              if (timeFrame.magnet) {
                ...
                if (
                  ...
                  previousTimeFrame.working !== timeFrame.working
                ) {
                  timeFrameDiff = Math.abs(
                    initialDate.diff(timeFrame.start, "milliseconds")
                  );
                  if (
                    timeFrameDiff < maxTimeFrameDiff &&
                    (currentTimeFrameDiff === undefined ||
                      timeFrameDiff < currentTimeFrameDiff)
                  ) {
                ...
                if (
                  nextTimeFrame === undefined ||
                  nextTimeFrame.working !== timeFrame.working
                ) {
                  timeFrameDiff = Math.abs(
                    initialDate.diff(timeFrame.end, "milliseconds")
                  );
                  if (
                    timeFrameDiff < maxTimeFrameDiff &&
                    (currentTimeFrameDiff === undefined ||
      ...
      Column.prototype.getDateByPosition = function (
        position,
        magnetValue,
        magnetUnit,
        timeFramesMagnet
        ...
        if (
          this.timeFramesNonWorkingMode === "cropped" ||
          this.timeFramesWorkingMode === "cropped"
        ) {
...
(function () {
  "use strict";
  angular.module("gantt").factory("GanttColumnGenerator", [
    "GanttColumn",
    "moment",
    function (Column, moment) {
      var ColumnGenerator = function (columnsManager) {
        ...
        self.generate = function (from, to, maximumWidth, leftOffset, reverse) {
          ...
          var timeFramesWorkingMode = self.columnsManager.gantt.options.value(
            "timeFramesWorkingMode"
          );
          var timeFramesNonWorkingMode =
            self.columnsManager.gantt.options.value("timeFramesNonWorkingMode");
  ...
  angular.module("gantt").factory("GanttColumnHeader", [
    ...
    function (moment, Column) {
      ...
      var ColumnHeader = function (
        ...
        column.label = angular.isFunction(labelFormat)
          ? labelFormat(column)
          : startDate.format(labelFormat);
  ...
  angular.module("gantt").factory("GanttColumnsManager", [
    ...
    function (
      ...
      var ColumnsManager = function (gantt) {
        ...
        this.gantt.$scope.$watchGroup(
          ["ganttElementWidth", "showSide", "sideWidth", "maxHeight", "daily"],
          function (newValues, oldValues) {
            if (newValues !== oldValues && self.gantt.rendered) {
      ...
      ColumnsManager.prototype.updateColumnsMeta = function () {
        ...
        var columnsWidthChanged = this.updateColumnsWidths(
          this.columns,
          this.headers,
          this.previousColumns,
          this.nextColumns
      ...
      ColumnsManager.prototype.getColumnByDate = function (
        date,
        disableExpand
      ) {
        if (!disableExpand) {
        ...
        var extendedColumns = this.previousColumns.concat(
          this.columns,
          this.nextColumns
        );
        var columns = bs.get(
      ...
      ColumnsManager.prototype.getColumnByPosition = function (
        x,
        disableExpand
      ) {
        if (!disableExpand) {
      ...
      ColumnsManager.prototype.updateColumnsWidths = function (
        columns,
        headers,
        previousColumns,
        nextColumns
        ...
        if (columnWidth === undefined || expandToFit || shrinkToFit) {
          ...
          if (lastColumn !== undefined) {
            ...
            if (
              (expandToFit && currentWidth < newWidth) ||
      ...
      ColumnsManager.prototype.expandExtendedColumnsForPosition = function (x) {
        if (x < 0) {
          ...
          if (!firstExtendedColumn || firstExtendedColumn.left > x) {
            this.previousColumns = new ColumnGenerator(this).generate(
              from,
              undefined,
              -x,
              -this.getColumnsWidth(),
          ...
          if (
            ...
            this.nextColumns = new ColumnGenerator(this).generate(
              endDate,
              undefined,
              x - this.gantt.width,
              this.gantt.width,
      ...
      ColumnsManager.prototype.updateVisibleColumns = function (includeViews) {
        this.visibleColumns = $filter("ganttColumnLimit")(
          this.columns,
          this.gantt
        );
        ...
        angular.forEach(
          ...
          function (header) {
            this.visibleHeaders.push(
              $filter("ganttColumnLimit")(header, this.gantt)
            );
          },
          this
        );
      ...
      ColumnsManager.prototype.getHeaderFormat = function (unit) {
        ...
        if (format === undefined) {
          ...
          if (
            ["millisecond", "second", "minute", "hour"].indexOf(viewScaleUnit) >
            -1
          ) {
      ...
      ColumnsManager.prototype.getDateRange = function (visibleOnly) {
        ...
        return firstColumn && lastColumn
          ? [firstColumn.date, lastColumn.endDate]
          : undefined;
      };
...
(function () {
  "use strict";
  angular.module("gantt").factory("GanttHeaderGenerator", [
    "GanttColumnHeader",
  ...
  angular.module("gantt").factory("Gantt", [
    ...
    function (
      ...
      var Gantt = function ($scope, $element) {
        ...
        $scope.$watch("columnMagnet", function () {
          ...
          if (splittedColumnMagnet && splittedColumnMagnet.length > 1) {
            ...
            self.columnMagnetUnit = moment.normalizeUnits(
        ...
        $scope.$watchGroup(["shiftColumnMagnet", "viewScale"], function () {
          ...
          if (
            splittedColumnMagnet !== undefined &&
            splittedColumnMagnet.length > 1
          ) {
            self.shiftColumnMagnetValue = parseFloat(splittedColumnMagnet[0]);
            self.shiftColumnMagnetUnit = moment.normalizeUnits(
              splittedColumnMagnet[splittedColumnMagnet.length - 1]
            );
          } else {
            self.shiftColumnMagnetValue = 1;
            self.shiftColumnMagnetUnit =
              moment.normalizeUnits(shiftColumnMagnet);
          }
        });
      ...
      Gantt.prototype.getDateByPosition = function (x, magnet, disableExpand) {
        ...
        if (column !== undefined) {
          ...
          if (magnet) {
            if (this.shiftKey) {
              if (
                this.shiftColumnMagnetValue !== undefined &&
                this.shiftColumnMagnetUnit !== undefined
              ) {
                ...
                if (splittedViewScale && splittedViewScale.length > 1) {
                  viewScaleValue = parseFloat(splittedViewScale[0]);
                  viewScaleUnit = moment.normalizeUnits(
                    splittedViewScale[splittedViewScale.length - 1]
                  );
                } else {
                  viewScaleValue = 1;
          ...
          return column.getDateByPosition(
            x - column.left,
            magnetValue,
            magnetUnit,
      ...
      Gantt.prototype.getBodyAvailableWidth = function () {
        ...
        var availableWidth =
          scrollWidth -
          (borderWidth !== undefined ? this.scroll.getBordersWidth() : 0);
      ...
      Gantt.prototype.removeData = function (data) {
        ...
        if (this.$scope.data !== undefined) {
          for (var i = 0, l = data.length; i < l; i++) {
            ...
            if (j > -1) {
              if (
                rowToRemove.tasks === undefined ||
                rowToRemove.tasks.length === 0
              ) {
                // Remove complete row
    ...
    function (Task, moment, $filter) {
      ...
      Row.prototype.updateVisibleTasks = function () {
        ...
        if (filterTask) {
          ...
          var filterTaskComparator = this.rowsManager.gantt.options.value(
            "filterTaskComparator"
          );
          ...
          this.filteredTasks = $filter("filter")(
            this.tasks,
            filterTask,
            filterTaskComparator
          );
        ...
        this.visibleTasks = $filter("ganttTaskLimit")(
          this.filteredTasks,
        ...
        if (taskId in this.tasksMap) {
          ...
          for (i = this.tasks.length - 1; i >= 0; i--) {
            ...
            if (task.model.id === taskId) {
              ...
              if (
                this.from - task.model.from === 0 ||
                this.to - task.model.to === 0
              ) {
                this.setFromTo();
              }
...
(function () {
  ...
  angular.module("gantt").factory("GanttRowsManager", [
    ...
    "$timeout",
    "moment",
    function (Row, arrays, $filter, $timeout, moment) {
      var RowsManager = function (gantt) {
        ...
        this._defaultFilterImpl = function (
          sortedRows,
          filterRow,
          filterRowComparator
        ) {
        ...
        this.gantt.$scope.$watchGroup(
          ...
          function (newValue, oldValue) {
            if (newValue !== oldValue) {
              $timeout(function () {
                var newVScrollbarVisible =
                  self.gantt.scroll.isVScrollbarVisible();
        ...
        this.gantt.api.registerMethod(
          "rows",
          "sort",
          RowsManager.prototype.sortRows,
          this
        );
        this.gantt.api.registerMethod(
          "rows",
          "applySort",
          RowsManager.prototype.applySort,
          this
        );
        this.gantt.api.registerMethod(
          "rows",
          "refresh",
          RowsManager.prototype.updateVisibleObjects,
          this
        );
        ...
        this.gantt.api.registerMethod(
          "rows",
          "removeRowSorter",
          RowsManager.prototype.removeCustomRowSorter,
          this
        );
        this.gantt.api.registerMethod(
          "rows",
          "addRowSorter",
          RowsManager.prototype.addCustomRowSorter,
          this
        );
        ...
        this.gantt.api.registerMethod(
          "rows",
          "removeRowFilter",
          RowsManager.prototype.removeCustomRowFilter,
          this
        );
        this.gantt.api.registerMethod(
          "rows",
          "addRowFilter",
          RowsManager.prototype.addCustomRowFilter,
          this
        );
        ...
        this.gantt.api.registerMethod(
          "rows",
          "setFilterImpl",
          RowsManager.prototype.setFilterImpl,
          this
        );
      ...
      RowsManager.prototype.addRow = function (rowModel, modelOrderChanged) {
        ...
        if (rowModel.id in this.rowsMap) {
          ...
          var toRemoveIds = arrays.getRemovedIds(
            rowModel.tasks,
            row.model.tasks
          );
        ...
        if (!isUpdate) {
          var watcher = this.gantt.$scope.$watchCollection(
            function () {
      ...
      RowsManager.prototype.removeRow = function (rowId) {
        if (rowId in this.rowsMap) {
          ...
          if (indexOf > -1) {
            ...
            var deregisterFunction = this.rowsTaskWatchers.splice(
              indexOf,
              1
            )[0]; // Remove watcher
            deregisterFunction();
      ...
      RowsManager.prototype.updateVisibleRows = function () {
        ...
        if (filterRow) {
          ...
          var filterRowComparator = this.gantt.options.value(
            "filterRowComparator"
          );
          if (typeof filterRowComparator === "function") {
            ...
            filterRowComparator = function (actual, expected) {
              ...
              return gantt.options.value("filterRowComparator")(
                actual,
                expected
              );
            };
          ...
          this.filteredRows = this.filterImpl(
            this.sortedRows,
            filterRow,
            filterRowComparator
          );
  ...
  angular.module("gantt").factory("GanttTask", [
    ...
    function (moment) {
      ...
      Task.prototype.isOutOfRange = function () {
        var firstColumn =
          this.rowsManager.gantt.columnsManager.getFirstColumn();
        var lastColumn = this.rowsManager.gantt.columnsManager.getLastColumn();

        return (
          firstColumn === undefined ||
          this.model.to < firstColumn.date ||
          lastColumn === undefined ||
          this.model.from > lastColumn.endDate
        );
      };
      ...
      Task.prototype.updatePosAndSize = function () {
        ...
        if (this.rowsManager.gantt.options.value("daily")) {
          modelLeft = this.rowsManager.gantt.getPositionByDate(
            moment(this.model.from).startOf("day")
          );
          modelWidth =
            this.rowsManager.gantt.getPositionByDate(
              moment(this.model.to).endOf("day")
            ) - modelLeft;
        }
      ...
      Task.prototype.getBackgroundElement = function () {
        if (this.$element !== undefined) {
          var backgroundElement = this.$element[0].querySelector(
      ...
      Task.prototype.getContentElement = function () {
        if (this.$element !== undefined) {
          var contentElement = this.$element[0].querySelector(
            ".gantt-task-content"
          );
      ...
      Task.prototype.getForegroundElement = function () {
        if (this.$element !== undefined) {
          var foregroundElement = this.$element[0].querySelector(
      ...
      Task.prototype.moveTo = function (x, magnetEnabled) {
        ...
        if (x > this.modelLeft) {
          ...
          newTaskRight = this.rowsManager.gantt.getPositionByDate(
            this.model.to
          );
          ...
          newTaskLeft = this.rowsManager.gantt.getPositionByDate(
            this.model.from
          );
...
(function () {
  ...
  angular.module("gantt").factory("GanttBody", [
    ...
    "GanttBodyBackground",
    "GanttBodyForeground",
    function (BodyColumns, BodyRows, BodyBackground, BodyForeground) {
    ...
    function () {
      var Scroll = function (gantt) {
        ...
        this.gantt.api.registerMethod(
          "scroll",
          "to",
          Scroll.prototype.scrollTo,
          this
        );
        this.gantt.api.registerMethod(
          "scroll",
          "toDate",
          Scroll.prototype.scrollToDate,
          this
        );
        this.gantt.api.registerMethod(
          "scroll",
          "left",
          Scroll.prototype.scrollToLeft,
          this
        );
        this.gantt.api.registerMethod(
          "scroll",
          "right",
          Scroll.prototype.scrollToRight,
          this
        );
      ...
      Scroll.prototype.scrollToDate = function (date) {
        ...
        if (position !== undefined) {
          this.$element[0].scrollLeft =
            position - this.$element[0].offsetWidth / 2;
        }
      };
  ...
  angular.module("gantt").factory("GanttTimespan", [
    function () {
      ...
      Timespan.prototype.updatePosAndSize = function () {
        ...
        if (
          this.modelLeft + this.modelWidth < 0 ||
          this.modelLeft > maxModelLeft
        ) {
          this.left = undefined;
          this.width = undefined;
        } else {
              ...
              if (task.model.to >= fromDate && task.model.from <= toDate) {
                ...
                if (
                  ...
                  (task.left >= scrollLeft &&
                    task.left <= scrollLeft + scrollContainerWidth) ||
                  (task.left + task.width >= scrollLeft &&
                    task.left + task.width <=
                      scrollLeft + scrollContainerWidth) ||
                  (task.left < scrollLeft &&
                    task.left + task.width > scrollLeft + scrollContainerWidth)
                ) {
                  res.push(task);
                }
              }
...
(function () {
  ...
  angular.module("gantt").directive("ganttResizer", [
    ...
    "$timeout",
    "ganttMouseOffset",
    function ($document, $parse, $timeout, mouseOffset) {
      return {
        restrict: "A",
        require: "^gantt",
        scope: {
        ...
        link: function ($scope, $element, $attrs, ganttCtrl) {
          ...
          function mousemove(event) {
            $scope.$evalAsync(function () {
              var offset = mouseOffset.getOffsetForElement(
                $scope.targetElement[0],
                event
              );
              var maxWidth =
                ganttCtrl.gantt.getWidth() -
                ganttCtrl.gantt.scroll.getBordersWidth();
    ...
    function (Builder, $timeout, debounce, moment) {
      ...
      builder.controller = function ($scope, $element) {
        ...
        $element.bind(
          ...
          debounce(function () {
            ...
            if (currentScrollLeft < lastScrollLeft && currentScrollLeft === 0) {
              ...
              el.offsetWidth + currentScrollLeft >= el.scrollWidth - 1
            ) {
              direction = "right";
        ...
        $scope.getScrollableCss = function () {
          ...
          if (maxHeight > 0) {
            css["max-height"] =
              maxHeight - $scope.gantt.header.getHeight() + "px";
            css["overflow-y"] = "auto";
          ...
          var columnWidth = this.gantt.options.value("columnWidth");
          var bodySmallerThanGantt =
            $scope.gantt.width === 0
              ? false
              : $scope.gantt.width <
                $scope.gantt.getWidth() - $scope.gantt.side.getWidth();
          if (columnWidth !== undefined && bodySmallerThanGantt) {
            css.width =
              $scope.gantt.width + this.gantt.scroll.getBordersWidth() + "px";
          }
      ...
      builder.controller = function ($scope) {
        ...
        $scope.getScrollableHeaderCss = function () {
          ...
          if (columnWidth !== undefined && bodySmallerThanGantt) {
            ...
            css.width =
              $scope.gantt.getWidth() -
              $scope.gantt.side.getWidth() -
              vScrollbarWidth +
              "px";
          }
    ...
    function (Builder, layout) {
      ...
      builder.controller = function ($scope) {
        ...
        $scope.getMaxHeightCss = function () {
          ...
          if ($scope.maxHeight) {
            var bodyScrollBarHeight = $scope.gantt.scroll.isHScrollbarVisible()
              ? hScrollBarHeight
              : 0;
            css["max-height"] =
              $scope.maxHeight -
              bodyScrollBarHeight -
              $scope.gantt.header.getHeight() +
              "px";
          }
  ...
  angular.module("gantt").directive("ganttTask", [
    ...
    function (Builder, moment) {
      ...
      builder.controller = function ($scope, $element) {
        ...
        $scope.$watchGroup(
          ["simplifyMoment(task.model.from)", "simplifyMoment(task.model.to)"],
          function () {
...
(function () {
  ...
  angular.module("gantt").service("GanttDirectiveBuilder", [
    ...
    function ($templateCache) {
      var DirectiveBuilder = function DirectiveBuilder(
        directiveName,
        templateUrl,
        require,
        restrict
        ...
        this.templateUrl =
          templateUrl === undefined
            ? "template/" + directiveName + ".tmpl.html"
            : templateUrl;
          ...
          var directive = {
            ...
            compile: function () {
              return {
                pre: function preLink(scope, iElement, iAttrs, controller) {
                  scope.gantt.api.directives.raise.preLink(
                    directiveName,
                    scope,
                    iElement,
                    iAttrs,
                ...
                post: function postLink(scope, iElement, iAttrs, controller) {
                  scope.gantt.api.directives.raise.postLink(
                    directiveName,
                    scope,
                    iElement,
                    iAttrs,
            ...
            controller: [
              ...
              function ($scope, $element, $attrs) {
                ...
                $scope.gantt.api.directives.raise.controller(
                  directiveName,
                  $scope,
                  $element,
                  $attrs,
    ...
    function ($document) {
      return {
        ...
        elementsFromPoint: function (x, y, depth) {
          ...
          while (
            (current = this.elementFromPoint(x, y)) &&
  ...
  angular.module("gantt").service("ganttLayout", [
    ...
    function ($document) {
      return {
        ...
        setColumnsWidthFactor: function (
          columns,
          widthFactor,
          originalLeftOffset
        ) {
          ...
          angular.forEach(columns, function (column) {
            column.left =
              widthFactor * (column.originalSize.left + originalLeftOffset) -
              originalLeftOffset;
