...
(function () {
      ...
      return (this.MarkerManager = (function (b) {
        ...
        return (
          ...
          (d.prototype.handleOptDraw = function (a, b, c) {
            return b === !0
              ? (c ? a.setMap(this.gMap) : a.setMap(null), (a.isDrawn = !0))
    ...
    this.ngGmapModule("directives.api.models.child", function () {
      return (this.WindowChildModel = (function (b) {
        ...
        return (
          c(d, b),
          d.include(directives.api.utils.GmapUtil),
          (d.prototype.createGWin = function (a) {
            var b = this;
            return (
              null == a && (a = !1),
              null == this.gWin &&
                  ...
                  return (
                    ...
                    i.scope.$watch(
                      ...
                      function (a, b) {
                        return a !== b
                          ? ((i.doShow = a),
                            a ? i.layer.setMap(i.gMap) : i.layer.setMap(null))
                          : void 0;
                      },
                      !0
                    ),
        ...
        return (
          ...
          (d.prototype.setEvents = function (a, b) {
            ...
            if (
              ...
              for (d in e)
                (c = e[d]),
                  b.events.hasOwnProperty(d) && angular.isFunction(b.events[d])
                    ? f.push(
          ...
          (d.prototype.link = function (a, b, c, d) {
            ...
            return this.$timeout(function () {
              ...
              return (
                ...
                (l = g ? e.createWindowOptions(j, a, b.html(), f) : void 0),
                null != i &&
          ...
          (b = { mapTypeId: google.maps.MapTypeId.ROADMAP }),
          {
            ...
            link: function (d, e, f) {
              ...
              if (!angular.isDefined(d.zoom))
                return (
                  a.error("angular-google-maps: map zoom property not set"),
                  void 0
                );
              if (
                ((h = angular.element(e)),
          ...
          (c = {}),
          {
            ...
            link: function (h, i, j, k) {
              return angular.isUndefined(h.path) ||
                ...
                h.path.length < 2 ||
                !g(h.path)
                ? (a.error("polyline: no valid path attribute found"), void 0)
                : b(function () {
                    var a, b, g, i, l, m, n, o;
                    return (
                      (a = k.getMap()),
  ...
  (Cluster.prototype.updateIcon_ = function () {
    ...
    if (null !== b && this.map_.getZoom() > b)
      return this.clusterIcon_.hide(), void 0;
