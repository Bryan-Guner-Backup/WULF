            ...
            (e = a(b, {
              set_at: function (a) {
                ...
                return (
                  (c = b.getAt(a)),
                  c && c.lng && c.lat
                    ? ((f[a].latitude = c.lat()), (f[a].longitude = c.lng()))
                    : void 0
                );
              },
              insert_at: function (a) {
                ...
                return (
                  (c = b.getAt(a)),
                  c && c.lng && c.lat
                    ? f.splice(a, 0, { latitude: c.lat(), longitude: c.lng() })
                    : void 0
                );
              },
              ...
              function (a) {
                ...
                if (((g = b), a)) {
                  for (
                    ...
                    (i = g.getAt(c)),
                      (f = a[c]),
                      (i.lat() !== f.latitude || i.lng() !== f.longitude) &&
                        g.setAt(
                          c,
                  ...
                  for (; e > c; )
                    (f = a[c]),
                      g.push(new google.maps.LatLng(f.latitude, f.longitude)),
                      c++;
        ...
        return (
              ...
              ? google.maps.event.addListener(
                  ...
                  function () {
                    ...
                    return (
                      ...
                      null != a.gWin &&
                        (a.gWin.setPosition(b), a.gWin.open(a.mapCtrl)),
          ...
          (d.prototype.showWindow = function () {
            ...
            if (this.scope.templateUrl) {
              if (this.gWin)
                return this.$http
                  .get(this.scope.templateUrl, { cache: this.$templateCache })
                  .then(function (b) {
                    var c, d;
                    return (
                      (d = a.scope.$new()),
        ...
        return (
          ...
          (b = { mapTypeId: google.maps.MapTypeId.ROADMAP }),
          {
            ...
            link: function (d, e, f) {
              var g, h, i, j, k, l, m, n;
              if (
                !angular.isDefined(d.center) ||
                !angular.isDefined(d.center.latitude) ||
                !angular.isDefined(d.center.longitude)
              )
                return void a.error(
                  "angular-google-maps: could not find a valid center property"
                );
              if (!angular.isDefined(d.zoom))
                return void a.error(
              ...
              if (
                ...
                (k = { options: {} }),
                f.options && (k.options = d.options),
                f.styles && (k.styles = d.styles),
                f.type &&
                  ((m = f.type.toUpperCase()),
                  google.maps.MapTypeId.hasOwnProperty(m)
                    ? (k.mapTypeId =
                        google.maps.MapTypeId[f.type.toUpperCase()])
                    : a.error(
                        'angular-google-maps: invalid map type "' + f.type + '"'
                      )),
                ...
                google.maps.event.addListener(n, "zoom_changed", function () {
                  return d.zoom !== n.zoom
                    ? _.defer(function () {
                        return d.$apply(function (a) {
                          return (a.zoom = n.zoom);
                        });
                      })
                    : void 0;
                }),
                (l = !1),
                google.maps.event.addListener(n, "center_changed", function () {
                  var a;
                  return (
                    (a = n.center),
                    l
                ...
                angular.isDefined(d.events) &&
                  null !== d.events &&
                  angular.isObject(d.events))
              ) {
                j = function (a) {
                  return function () {
                    return d.events[a].apply(d, [n, a, arguments]);
                  };
                };
                for (i in d.events)
                  d.events.hasOwnProperty(i) &&
                    angular.isFunction(d.events[i]) &&
                    google.maps.event.addListener(n, i, j(i));
              }
              return (
                (d.map = n),
                google.maps.event.trigger(n, "resize"),
                angular.isUndefined(d.refresh()) ||
                  d.$watch("refresh()", function (a, b) {
                    var d;
                    return a && !b
                      ? ((d = new google.maps.LatLng(a.latitude, a.longitude)),
                        c(f.pan) ? n.panTo(d) : n.setCenter(d))
                      : void 0;
                  }),
                d.$watch(
                  "center",
                      ...
                      return (
                        ...
                        g ||
                          ((null == b.latitude || null == b.longitude) &&
                            a.error(
                              "Invalid center for newVa;ue: " +
                                JSON.stringify(b)
                            ),
                          (e = new google.maps.LatLng(b.latitude, b.longitude)),
                          c(f.pan) ? n.panTo(e) : n.setCenter(e)),
                        (l = !1)
                      );
                  },
                  !0
                ),
                d.$watch("zoom", function (a, b) {
                  return a !== b ? n.setZoom(a) : void 0;
                }),
                d.$watch("bounds", function (b, c) {
                  var d, e, f;
                  if (b !== c)
                ...
                d.$watch(
                  "options",
                  function (a, b) {
                    return _.isEqual(a, b) || ((k.options = a), null == n)
                      ? void 0
                      : n.setOptions(k);
                  },
                  !0
                ...
                d.$watch(
                  "styles",
                  function (a, b) {
                    return _.isEqual(a, b) || ((k.styles = a), null == n)
                      ? void 0
                      : n.setOptions(k);
                  },
                  !0
