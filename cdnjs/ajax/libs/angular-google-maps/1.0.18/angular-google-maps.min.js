...
(function () {
  ...
  function () {
    this.ngGmapModule = function (a, b) {
      ...
      return (
        ...
        (c = this[(d = a.shift())] || (this[d] = {})),
        c.ngGmapModule || (c.ngGmapModule = this.ngGmapModule),
        a.length ? c.ngGmapModule(a, b) : b.call(c)
      );
    };
  }.call(this),
  function () {
        ...
        return (b = function (b, c, d) {
          ...
          return (
            ...
            (f = a(b, {
              set_at: function (a) {
                var c;
                if (!e && ((c = b.getAt(a)), c && c.lng && c.lat))
                  return (g[a].latitude = c.lat()), (g[a].longitude = c.lng());
              },
              ...
              remove_at: function (a) {
                return e ? void 0 : g.splice(a, 1);
              },
            })),
            (h = c.$watchCollection(d, function (a) {
              var c, d, f, g, h, i, j;
              if (((e = !0), (h = b), a)) {
                for (
                  c = 0,
                  ...
                  (j = h.getAt(c)),
                    (g = a[c]),
                    (j.lat() !== g.latitude || j.lng() !== g.longitude) &&
                      h.setAt(
                        c,
                ...
                for (; f > c; )
                  (g = a[c]),
                    h.push(new google.maps.LatLng(g.latitude, g.longitude)),
                    c++;
                for (; i > c; ) h.pop(), c++;
              }
              return (e = !1);
            ...
            function () {
              return f && (f(), (f = null)), h ? (h(), (h = null)) : void 0;
            }
          );
        });
      },
                ...
                function () {
                  return (
                    angular.forEach(e, function (a) {
                      return (
                        _.isFunction(a) && a(),
                        null !== a.e && _.isFunction(a.e) ? a.e() : void 0
                      );
                    }),
                    (e = null)
                  );
      ...
      return (this.ClustererMarkerManager = (function (b) {
        function d(b, c, e) {
          ...
          d.__super__.constructor.call(this),
            ...
            (this.clusterer =
              null != e && void 0 === c
                ? new MarkerClusterer(b, void 0, e)
                : null != e && null != c
                ? new MarkerClusterer(b, c, e)
                : new MarkerClusterer(b)),
  ...
  function () {
    this.ngGmapModule("directives.api.utils", function () {
      return (this.AsyncProcessor = {
        handleLargeArray: function (a, b, c, d, e, f) {
          var g;
          return (
            null == e && (e = 100),
            null == f && (f = 0),
      ...
      return (this.GmapUtil = {
        getLabelPositionPoint: function (a) {
          ...
          return void 0 === a
            ...
            : ((a = /^([\d\.]+)\s([\d\.]+)$/.exec(a)),
              (b = a[1]),
              (c = a[2]),
              b && c ? new google.maps.Point(b, c) : void 0);
        },
        createMarkerOptions: function (a, b, c, d) {
          ...
          return (
            ...
            (e = angular.extend({}, c, {
              ...
              icon: null != c.icon ? c.icon : b,
              visible:
                null != c.visible
                  ? c.visible
                  : null != a.latitude && null != a.longitude,
            })),
            null != d && (e.map = d),
            e
          );
        ...
        createWindowOptions: function (a, b, c, d) {
          return null != c && null != d
            ? angular.extend({}, d, {
                content: null != d.content ? d.content : c,
                position:
                  null != d.position
                    ? d.position
                    : angular.isObject(a)
  ...
  function () {
    this.ngGmapModule("directives.api.utils", function () {
      return (this.ModelsWatcher = {
        didModelsChange: function (a, b) {
          var c, d;
          return _.isArray(a)
            ? a === b
              ? !1
              : ((d = _.intersectionObjects(a, b).length !== b.length),
                (c = !0),
                d || (c = a.length !== b.length),
                c)
  ...
  function () {
    ...
    this.ngGmapModule("directives.api.models.child", function () {
      return (this.MarkerLabelChildModel = (function (b) {
        ...
        return (
          c(d, b),
          d.include(directives.api.utils.GmapUtil),
          (d.prototype.getSharedCross = function (a) {
      ...
      return (this.MarkerChildModel = (function (b) {
        function d(b, c, d, e, f, g, h, i, j) {
          ...
          (this.index = b),
            ...
            (this.myScope = this.parentScope.$new(!1)),
            (this.$injector = j),
            ...
            this.myScope.$watch(
              "model",
              function (a, b) {
                return a !== b ? l.setMyScope(a, b) : void 0;
              },
              !0
            ),
            (this.$log = directives.api.utils.Logger),
        ...
        return (
          c(d, b),
          d.include(directives.api.utils.GmapUtil),
          (d.prototype.setMyScope = function (a, b, c) {
            var d = this;
            return (
              null == b && (b = void 0),
              null == c && (c = !1),
              ...
              _.isFunction(this.clickKey) && this.$injector
                ? (this.myScope.click = function () {
                    return d.$injector.invoke(d.clickKey, void 0, {
                      $markerModel: a,
                    });
                  })
                : this.maybeSetScopeValue(
              ...
              this.maybeSetScopeValue(
                ...
                function (a, b) {
                  ...
                  return void 0 === a
                    ...
                    : ((c = "self" === b ? a : a[b]),
                      void 0 === c
                        ? (c = void 0 === b ? d.defaults : d.myScope.options)
                        : c);
                },
                c,
                this.setOptions
          ...
          (d.prototype.maybeSetScopeValue = function (a, b, c, d, e, f, g) {
            ...
            return (
              null == g && (g = void 0),
              void 0 === c
                ? ((this.myScope[a] = e(b, d)),
                  void (f || (null != g && g(this.myScope))))
                : ((i = e(c, d)),
                  (h = e(b, d)),
                  h === i || this.myScope[a] === h || ((this.myScope[a] = h), f)
                    ? void 0
                    : (null != g && g(this.myScope),
          ...
          (d.prototype.setCoords = function (a) {
            return a.$id === this.myScope.$id && void 0 !== this.gMarker
              ? null != a.coords
                ? null == this.scope.coords.latitude ||
                  null == this.scope.coords.longitude
                  ? void this.$log.error(
                  ...
                  : (this.gMarker.setPosition(
                    ...
                    this.gMarker.setVisible(
                      null != a.coords.latitude && null != a.coords.longitude
                    ),
          ...
          (d.prototype.setIcon = function (a) {
            return a.$id === this.myScope.$id && void 0 !== this.gMarker
              ? (this.gMarkerManager.remove(this.gMarker),
                ...
                this.gMarker.setVisible(
                  a.coords.latitude && null != a.coords.longitude
                ))
              : void 0;
          }),
          (d.prototype.setOptions = function (a) {
            var b,
              c = this;
            if (
              a.$id === this.myScope.$id &&
              (null != this.gMarker &&
                (this.gMarkerManager.remove(this.gMarker), delete this.gMarker),
              null != (b = a.coords)
                ? b
              ...
              return (
                ...
                google.maps.event.addListener(
                  ...
                  "click",
                  function () {
                    return c.doClick && null != c.myScope.click
                      ? c.myScope.click()
                      : void 0;
                  }
                )
          ...
          (d.prototype.watchDestroy = function (a) {
            ...
            return a.$on("$destroy", function () {
              ...
              return (
                null != b.gMarker &&
                  (b.gMarkerManager.remove(b.gMarker), delete b.gMarker),
                (a = void 0)
              );
            });
          }),
      ...
      return (this.WindowChildModel = (function (b) {
        function d(b, c, d, e, f, g, h, i, j, k) {
          (this.element = j),
            ...
            (this.mapCtrl = e),
            (this.markerCtrl = f),
            (this.isIconVisibleOnClick = d),
            (this.initialMarkerVisibility =
              null != this.markerCtrl ? this.markerCtrl.getVisible() : !1),
            (this.$log = directives.api.utils.Logger),
            (this.$http = g),
            (this.$templateCache = h),
            (this.$compile = i),
            this.createGWin(),
            ...
            this.watchShow(),
            this.watchCoords(),
            (this.needToManualDestroy = k),
            this.$log.info(this);
        }
        return (
          c(d, b),
          d.include(directives.api.utils.GmapUtil),
          (d.prototype.createGWin = function () {
            var a,
              b,
              c = this;
            return (
              null == this.gWin &&
                ...
                ((a = null != this.opts ? this.opts : {}),
                (b =
                  null != this.element && _.isFunction(this.element.html)
                    ? this.element.html()
                    : this.element),
                (this.opts =
                  null != this.markerCtrl
                  ...
                  this.googleMapsHandles.push(
                    google.maps.event.addListener(
                      ...
                      function () {
                        return (
                          null != c.markerCtrl &&
                            c.markerCtrl.setVisible(c.initialMarkerVisibility),
                          c.gWin.isOpen(!1),
          ...
          (d.prototype.watchShow = function () {
            var a = this;
            return this.scope.$watch("show", function (b) {
              return b ? a.showWindow() : a.hideWindow();
            });
          }),
          (d.prototype.watchCoords = function () {
            var a,
              b = this;
            return (
              (a = null != this.markerCtrl ? this.scope.$parent : this.scope),
              a.$watch(
                "coords",
                function (a, c) {
                  return a !== c
                  ...
                  google.maps.event.addListener(
                    ...
                    function () {
                      ...
                      return (
                        ...
                        null != a.gWin &&
                          (a.gWin.setPosition(b), a.showWindow()),
                  ...
                  ? this.$http
                      ...
                      .then(function (c) {
                        ...
                        return (
                          ...
                          (d = b.$compile(c.data)(e)),
                          b.gWin.setContent(d[0]),
                          a()
                        );
                      })
                  : void 0
    ...
    this.ngGmapModule("directives.api.models.parent", function () {
      return (this.IMarkerParentModel = (function (b) {
        function d(b, c, d, e, f) {
          ...
          (this.scope = b),
            ...
            this.validateScope(b) &&
              ((this.doClick = angular.isDefined(d.click)),
        ...
        return (
          ...
          (d.prototype.isFalse = function (a) {
            return (
  ...
  function () {
    ...
    this.ngGmapModule("directives.api.models.parent", function () {
      return (this.IWindowParentModel = (function (a) {
        ...
        return (
          b(c, a),
          c.include(directives.api.utils.GmapUtil),
      ...
      return (this.LayerParentModel = (function (b) {
        function d(b, c, d, e, f, g, h) {
          ...
          return (
            ...
            (this.$log = null != h ? h : directives.api.utils.Logger),
            ...
            null == this.attrs.type
              ...
              : (this.createGoogleLayer(),
                ...
                void this.$timeout(function () {
                  return (
                    (i.gMap = e.getMap()),
                    angular.isDefined(i.attrs.show) &&
                      (i.doShow = i.scope.show),
                    null !== i.doShow &&
                      i.doShow &&
                      null !== i.gMap &&
                      i.layer.setMap(i.gMap),
                    i.scope.$watch(
                      "show",
                      function (a, b) {
                        return a !== b
        ...
        return (
          c(d, b),
          (d.prototype.createGoogleLayer = function () {
            var a = this;
            return (
              (this.layer =
    ...
    this.ngGmapModule("directives.api.models.parent", function () {
      return (this.MarkerParentModel = (function (b) {
        ...
        return (
          c(d, b),
          d.include(directives.api.utils.GmapUtil),
          (d.prototype.onTimeOut = function (a) {
            var b,
              c = this;
            return (
              ...
              (this.scope.gMarker = new google.maps.Marker(b)),
              google.maps.event.addListener(
                this.scope.gMarker,
                "click",
                function () {
              ...
              this.setEvents(this.scope.gMarker, a),
              this.$log.info(this)
            );
          }),
          (d.prototype.onWatch = function (a, b) {
            switch (a) {
              case "coords":
                return null != b.coords && null != this.scope.gMarker
                  ? (this.scope.gMarker.setMap(this.mapCtrl.getMap()),
                    ...
                    this.scope.gMarker.setVisible(
                      null != b.coords.latitude && null != b.coords.longitude
                    ),
              ...
              case "icon":
                if (
                  ...
                  return (
                    ...
                    this.scope.gMarker.setVisible(
                      b.coords.latitude && null != b.coords.longitude
                    )
                  );
                break;
              case "options":
                if (null != b.coords && null != b.icon && b.options)
                  return (
                    ...
                    (this.scope.gMarker = new google.maps.Marker(
          ...
          (d.prototype.onDestroy = function () {
            var a;
            return void 0 === this.scope.gMarker
              ? void (a = void 0)
              : (this.scope.gMarker.setMap(null),
                delete this.scope.gMarker,
                (a = void 0));
          ...
          (d.prototype.setEvents = function (a, b) {
            return angular.isDefined(b.events) &&
              ...
              ? _.compact(
                  _.each(b.events, function (c, d) {
                    return b.events.hasOwnProperty(d) &&
                      angular.isFunction(b.events[d])
                      ? google.maps.event.addListener(a, d, function () {
      ...
      return (this.MarkersParentModel = (function (b) {
        function d(b, c, e, f, g, h) {
          (this.fit = a(this.fit, this)),
            ...
            (this.createMarkers = a(this.createMarkers, this)),
            (this.validateScope = a(this.validateScope, this)),
            (this.onTimeOut = a(this.onTimeOut, this));
          var i;
          d.__super__.constructor.call(this, b, c, e, f, g, h),
            (i = this),
            (this.markersIndex = 0),
        ...
        return (
          c(d, b),
          d.include(directives.api.utils.ModelsWatcher),
          (d.prototype.onTimeOut = function (a) {
            return (
              this.watch("models", a),
          ...
          (d.prototype.validateScope = function (a) {
            ...
            return (
              ...
              d.__super__.validateScope.call(this, a) || b
            );
          }),
          (d.prototype.createMarkers = function (a) {
            var b,
              c = this;
            return (
              null != a.doCluster && a.doCluster === !0
                ? null != a.clusterOptions
                  ? void 0 === this.gMarkerManager
                    ...
                    : this.gMarkerManager.opt_options !== a.clusterOptions &&
                      (this.gMarkerManager =
                        new directives.api.managers.ClustererMarkerManager(
                          this.mapCtrl.getMap(),
                          void 0,
                ...
                : (this.gMarkerManager =
                    new directives.api.managers.MarkerManager(
                      this.mapCtrl.getMap()
                    )),
              (b = []),
              (a.isMarkerModelsReady = !1),
              this.bigGulp.handleLargeArray(
                a.models,
                function (d) {
                  var e;
                  return (
                    (a.doRebuild = !0),
                    (e = new directives.api.models.child.MarkerChildModel(
                      c.markersIndex,
                      d,
                      a,
                      c.mapCtrl,
                ...
                function () {
                  return (
                    ...
                    (a.markerModels = b),
                    angular.isDefined(c.attrs.fit) &&
                      null != a.fit &&
                      a.fit &&
                      c.fit(),
                    (a.isMarkerModelsReady = !0),
                    null != a.onMarkerModelsReady
                      ? a.onMarkerModelsReady(a)
                      : void 0
                  );
                }
              )
          ...
          (d.prototype.reBuildMarkers = function (a) {
            if (a.doRebuild || void 0 === a.doRebuild)
              return (
                _.each(a.markerModels, function (a) {
                  return a.destroy();
                }),
                (this.markersIndex = 0),
                null != this.gMarkerManager && this.gMarkerManager.clear(),
                this.createMarkers(a)
              );
          }),
          (d.prototype.onWatch = function (a, b, c, d) {
            return "models" !== a || this.didModelsChange(c, d)
              ? "options" === a && null != c
                ? void (this.DEFAULTS = c)
          ...
          (d.prototype.onDestroy = function (a) {
            ...
            for (e = a.markerModels, c = 0, d = e.length; d > c; c++)
              (b = e[c]), b.destroy();
            return null != this.gMarkerManager
          ...
          (d.prototype.fit = function () {
            var a, b;
            return this.mapCtrl &&
              null != this.scope.markerModels &&
              this.scope.markerModels.length > 0 &&
              ((a = new google.maps.LatLngBounds()),
              (b = !1),
              _.each(this.scope.markerModels, function (c) {
                return null != c.gMarker
                  ? (b || (b = !0), a.extend(c.gMarker.getPosition()))
                  : void 0;
              }),
              b)
              ? this.mapCtrl.getMap().fitBounds(a)
              : void 0;
          }),
          d
        );
      ...
      return (this.WindowsParentModel = (function (b) {
        function d(b, c, e, f, g, h, i, j, k) {
          (this.interpolateContent = a(this.interpolateContent, this)),
            ...
            (this.onMarkerModelsReady = a(this.onMarkerModelsReady, this)),
          ...
          var l,
            ...
            q = this;
          for (
            d.__super__.constructor.call(this, b, c, e, f, g, h, i, j, k),
              m = this,
              this.$interpolate = k,
              this.windows = [],
              this.windwsIndex = 0,
          ...
          (this.linked = new directives.api.utils.Linked(b, c, e, f)),
            (this.models = void 0),
        ...
        return (
          c(d, b),
          d.include(directives.api.utils.ModelsWatcher),
          (d.prototype.watch = function (a, b, c) {
            var d = this;
            return a.$watch(
              b,
              function (a, e) {
          ...
          (d.prototype.watchModels = function (a) {
            ...
            return a.$watch("models", function (a, c) {
              return b.didModelsChange(a, c)
                ? (b.destroy(), b.createChildScopesWindows())
                : void 0;
            });
          }),
          (d.prototype.watchDestroy = function (a) {
          ...
          (d.prototype.destroy = function () {
            return (
              _.each(this.windows, function (a) {
                return a.destroy();
              }),
              delete this.windows,
              (this.windows = []),
          ...
          (d.prototype.onMarkerModelsReady = function (a) {
            ...
            return (
              ...
              this.firstTime && this.watchDestroy(a),
          ...
          (d.prototype.createChildScopesWindows = function () {
            ...
            if (
              ...
              (a =
                this.linked.ctrls.length > 1 && null != this.linked.ctrls[1]
                  ? this.linked.ctrls[1].getMarkersScope()
                  : void 0),
              (b = angular.isUndefined(this.linked.scope.models)),
              b &&
                (void 0 === a ||
                  (void 0 === a.markerModels && void 0 === a.models)))
            )
            ...
            if (null != this.gMap) {
              ...
              if (
                ((a.onMarkerModelsReady = this.onMarkerModelsReady),
                a.isMarkerModelsReady)
              )
          ...
          (d.prototype.createWindow = function (a, b, c) {
            ...
            return (
              ...
              (f = this.interpolateContent(this.linked.element.html(), a)),
              (e = this.createWindowOptions(b, d, f, this.DEFAULTS)),
              this.windows.push(
  ...
  function () {
    ...
    this.ngGmapModule("directives.api", function () {
      return (this.IWindow = (function (b) {
        ...
        return (
          c(d, b),
          d.include(directives.api.utils.ChildEvents),
          (d.prototype.link = function () {
            throw new Exception("Not Implemented!!");
          }),
          d
          ...
          (d.prototype.link = function (a, b, c, d) {
            return this.$timeout(function () {
              ...
              return (
                ...
                null != c &&
                  (b = new directives.api.models.child.MarkerLabelChildModel(
                    c,
                    a
                  )),
        ...
        return (
          ...
          (d.prototype.link = function (a, b, c, d) {
            return null != c.oncreated
              ? new directives.api.models.parent.LayerParentModel(
                  a,
                  b,
                  c,
                  d,
    ...
    this.ngGmapModule("directives.api", function () {
      return (this.Window = (function (b) {
        function d(b, c, e, f) {
          this.link = a(this.link, this);
          var g;
          d.__super__.constructor.call(this, b, c, e, f),
            (g = this),
          ...
          (d.prototype.link = function (a, b, c, d) {
            ...
            return this.$timeout(function () {
              ...
              return (
                ...
                (j =
                  d.length > 1 && null != d[1]
                    ? d[1].getMarkerScope().gMarker
                    : void 0),
                (f = null != a.options ? a.options : {}),
                (g =
                  null != a &&
                  null != a.coords &&
                  null != a.coords.latitude &&
                  null != a.coords.longitude),
                (l = g ? e.createWindowOptions(j, a, b.html(), f) : f),
                null != i &&
                  (m = new directives.api.models.child.WindowChildModel(
                    a,
                    l,
                    h,
                    i,
    ...
    angular.module("google-maps").directive("googleMap", [
      ...
      function (a) {
        ...
        return (
          ...
          (directives.api.utils.Logger.logger = a),
          ...
          }),
          {
            ...
            link: function (e, f, g) {
              ...
              if (
                ...
                !angular.isDefined(e.center.latitude) ||
                !angular.isDefined(e.center.longitude)
              )
                return void a.error(
              ...
              if (
                ((i = angular.element(f)),
                i.addClass("angular-google-map"),
                (l = { options: {} }),
                g.options && (l.options = e.options),
                g.styles && (l.styles = e.styles),
                g.type &&
                  ((n = g.type.toUpperCase()),
                  google.maps.MapTypeId.hasOwnProperty(n)
                    ? (l.mapTypeId =
                        google.maps.MapTypeId[g.type.toUpperCase()])
                    : a.error(
                        'angular-google-maps: invalid map type "' + g.type + '"'
                      )),
                  ...
                  return (
                    ...
                    _.defer(function () {
                      return e.$apply(function (b) {
                        return (
                          (b.center.latitude = a.lat()),
                          (b.center.longitude = a.lng())
                        );
                      });
                    })
                  );
                ...
                angular.isDefined(e.events) &&
                  null !== e.events &&
                  angular.isObject(e.events))
              ) {
                k = function (a) {
                  return function () {
                ...
                for (j in e.events)
                  e.events.hasOwnProperty(j) &&
                    angular.isFunction(e.events[j]) &&
                    google.maps.event.addListener(o, j, k(j));
              }
              return (
                (e.map = o),
                null != g.control &&
                  null != e.control &&
                  ((e.control.refresh = function (a) {
                    var b;
                    if (null != o)
                      return (
                        ...
                        null != (null != a ? a.latitude : void 0)
                          ? ((b = c(a)), d(g.pan) ? o.panTo(b) : o.setCenter(b))
                          : void 0
                      );
                  }),
                ...
                e.$watch(
                  ...
                  function (b, f) {
                    ...
                    return (
                      (i = c(b)),
                      b === f ||
                      (i.lat() === o.center.lat() && i.lng() === o.center.lng())
                        ? void 0
                        : ((m = !0),
                          h ||
                            ((null == b.latitude || null == b.longitude) &&
                              a.error(
                                "Invalid center for newValue: " +
                                  JSON.stringify(b)
                              ),
                            d(g.pan) && e.zoom === o.zoom
                              ? o.panTo(i)
                              : o.setCenter(i)),
                          (m = !1))
                    );
                ...
                e.$watch("bounds", function (b, c) {
                  var d, e, f;
                  if (b !== c)
                    return null == b.northeast.latitude ||
                      null == b.northeast.longitude ||
                      null == b.southwest.latitude ||
                      null == b.southwest.longitude
                      ? void a.error(
                      ...
                      : ((e = new google.maps.LatLng(
                        ...
                        (d = new google.maps.LatLngBounds(f, e)),
                        o.fitBounds(d));
                }),
                e.$watch(
                  "options",
                  function (a, b) {
                    return _.isEqual(a, b) || ((l.options = a), null == o)
                      ? void 0
                      : o.setOptions(l);
                  },
                  !0
                ...
                e.$watch(
                  "styles",
                  function (a, b) {
                    return _.isEqual(a, b) || ((l.styles = a), null == o)
                      ? void 0
                      : o.setOptions(l);
                  },
                  !0
  ...
  function () {
    angular.module("google-maps").directive("markers", [
      ...
      "$injector",
      function (a, b) {
        return new directives.api.Markers(a, b);
      },
    ]);
  }.call(this),
  function () {
      ...
      function (a, b) {
        ...
        return (
          (g = function (a) {
            ...
            for (b = 0; b < a.length; ) {
              if (
                angular.isUndefined(a[b].latitude) ||
                angular.isUndefined(a[b].longitude)
              )
                return !1;
              b++;
            }
          ...
          (d = function (a) {
            ...
            for (c = new google.maps.MVCArray(), b = 0; b < a.length; )
              c.push(new google.maps.LatLng(a[b].latitude, a[b].longitude)),
                b++;
            return c;
          }),
          (e = function (a, b) {
          ...
          (c = {}),
          {
            ...
            link: function (h, i, j, k) {
              return angular.isUndefined(h.path) ||
                null === h.path ||
                h.path.length < 2 ||
                !g(h.path)
                ? void a.error("polyline: no valid path attribute found")
                : b(function () {
                    var a, b, g, i, l, m, n, o;
                    return (
                      (a = k.getMap()),
                      ...
                      (m = google.maps.event.addListener(
                        ...
                        function (a) {
                          ...
                          return (
                            (b = n.getAt(a)),
                            b && b.lng && b.lat
                              ? ((h.path[a].latitude = b.lat()),
                                (h.path[a].longitude = b.lng()),
                                h.$apply())
                              : void 0
                          );
                        }
                      )),
                      (g = google.maps.event.addListener(
                        n,
                        "insert_at",
                        function (a) {
                          var b;
                      ...
                      (l = google.maps.event.addListener(
                        n,
                        "remove_at",
                        function (a) {
        ...
        return (
          ...
          (d = {}),
          {
            ...
            link: function (i, j, k, l) {
              return angular.isUndefined(i.path) ||
                null === i.path ||
                i.path.length < 2 ||
                !h(i.path)
                ? void a.error("polyline: no valid path attribute found")
                : b(function () {
                    ...
                    return (
                      (b = function (a) {
                        ...
                        return (
                          (b = angular.extend({}, d, {
                            map: h,
                            path: a,
                            strokeColor: i.stroke && i.stroke.color,
                            strokeOpacity: i.stroke && i.stroke.opacity,
                            strokeWeight: i.stroke && i.stroke.weight,
                          })),
                          angular.forEach(
                            {
                              clickable: !0,
                            ...
                            function (a, c) {
                              return (b[c] =
                                angular.isUndefined(i[c]) || null === i[c]
                                  ? a
                                  : i[c]);
                            }
                          ),
                      ...
                      (h = l.getMap()),
                      (j = new google.maps.Polyline(b(e(i.path)))),
                      g(k.fit) && f(h, pathPoints),
                      angular.isDefined(i.editable) &&
                        i.$watch("editable", function (a) {
                          return j.setEditable(a);
                        }),
                      angular.isDefined(i.draggable) &&
                        i.$watch("draggable", function (a) {
                          return j.setDraggable(a);
                        }),
                      angular.isDefined(i.visible) &&
                        i.$watch("visible", function (a) {
                          return j.setVisible(a);
                        }),
                      angular.isDefined(i.geodesic) &&
                        i.$watch("geodesic", function () {
                          return j.setOptions(b(j.getPath()));
                        }),
                      angular.isDefined(i.stroke) &&
                        angular.isDefined(i.stroke.weight) &&
                        i.$watch("stroke.weight", function () {
                          return j.setOptions(b(j.getPath()));
                        }),
                      angular.isDefined(i.stroke) &&
                        angular.isDefined(i.stroke.color) &&
                        i.$watch("stroke.color", function () {
                          return j.setOptions(b(j.getPath()));
                        }),
                      (a = c(j.getPath(), i, "path")),
