...
!(function () {
  var a = angular.module("google-maps", []);
  a.factory("debounce", [
    "$timeout",
    function (a) {
      return function (b) {
        ...
        createMarkerOptions: function (a, b, c, d) {
          ...
          return (
            ...
            (e = angular.extend({}, c, {
              ...
              icon: b,
              visible: null != a.latitude && null != a.longitude,
            })),
            null != d && (e.map = d),
            e
          );
      ...
      return (this.LayerParentModel = (function (b) {
        function d(b, c, d, e, f, g) {
          ...
          return (
            ...
            (this.mapCtrl = e),
            (this.$timeout = f),
            (this.$log = null != g ? g : directives.api.utils.Logger),
            ...
            null == this.attrs.type
              ...
              : (this.createGoogleLayer(),
                ...
                this.$timeout(function () {
                  return (
                    (h.gMap = e.getMap()),
                    angular.isDefined(h.attrs.show) &&
                      (h.doShow = h.scope.show),
                    null !== h.doShow &&
                      h.doShow &&
                      null !== h.Map &&
                      h.layer.setMap(h.gMap),
                    h.scope.$watch(
                      "show",
                      function (a, b) {
                        return a !== b
                          ? ((h.doShow = a),
                            a ? h.layer.setMap(h.gMap) : h.layer.setMap(null))
                          : void 0;
                      },
                      !0
                    ),
        ...
        return (
          ...
          (d.prototype.onTimeOut = function (a) {
            ...
            return (
              ...
              (this.gMarker = new google.maps.Marker(b)),
          ...
          (d.prototype.onWatch = function (a, b) {
            switch (a) {
              case "coords":
                return null != b.coords && null != this.gMarker
                  ? (this.gMarker.setMap(this.mapCtrl.getMap()),
                    ...
                    this.gMarker.setOptions(b.options))
                  : this.gMarker.setMap(null);
              case "icon":
                if (null != b.icon && null != b.coords && null != this.gMarker)
                  return (
                    this.gMarker.setOptions(b.options),
                    this.gMarker.setIcon(b.icon),
                    this.gMarker.setMap(null),
                    this.gMarker.setMap(this.mapCtrl.getMap()),
                    this.gMarker.setPosition(
                      new google.maps.LatLng(
          ...
          (d.prototype.onDestroy = function () {
            var a;
            return void 0 === this.gMarker
              ? ((a = void 0), void 0)
              : (this.gMarker.setMap(null), delete this.gMarker, (a = void 0));
          }),
          d
        );
      ...
      return (this.MarkersParentModel = (function (b) {
        ...
        return (
            ...
            return (
              ...
              this.bigGulp.handleLargeArray(
                ...
                function (c) {
                  ...
                  return (
                    (a.doRebuild = !0),
                    (d = new directives.api.models.child.MarkerChildModel(
                      b.markersIndex,
                      c,
                      a,
                      b.mapCtrl,
          ...
          (d.prototype.onWatch = function (a, b, c, d) {
            return "models" !== a || c !== d || c.length !== d.length
              ? "options" === a && null != c
          ...
          (d.prototype.onDestroy = function () {
            var a, b, c, d;
            for (d = this.markers, b = 0, c = d.length; c > b; b++)
              (a = d[b]), a.destroy();
          ...
          (d.prototype.fit = function () {
            ...
            return this.mapCtrl &&
              ...
              (b = !1),
              _.each(this.markers, function (c) {
          ...
          (d.prototype.link = function (a, b, c, d) {
            ...
            return this.$timeout(function () {
              ...
              return (
                ...
                (i = d[0].getMap()),
                (j = d.length > 1 && null != d[1] ? d[1].getMarker() : void 0),
                ...
                (k = g ? e.createWindowOptions(j, a, b.html(), f) : void 0),
                null != i &&
                  (l = new directives.api.models.child.WindowChildModel(
                    a,
                    k,
                    h,
                    i,
  ...
  angular.module("google-maps").controller("PolylineDisplayController", [
    "$scope",
    function (a) {
      a.toggleStrokeColor = function () {
        a.stroke.color = "#6060FB" == a.stroke.color ? "red" : "#6060FB";
      };
    },
  ]),
          ...
          f = a(b, {
            set_at: function (a) {
              ...
              c &&
                c.lng &&
                c.lat &&
                ((e[a].latitude = c.lat()), (e[a].longitude = c.lng()));
            },
            insert_at: function (a) {
              ...
              c &&
                c.lng &&
                c.lat &&
                e.splice(a, 0, { latitude: c.lat(), longitude: c.lng() });
            },
            ...
            function (a) {
              ...
              if (a) {
                for (
                  ...
                  var i = c.getAt(e);
                  (d = a[e]),
                    (i.lat() != d.latitude || i.lng() != d.longitude) &&
                      c.setAt(
                        e,
                ...
                for (; g > e; e++)
                  (d = a[e]),
                    c.push(new google.maps.LatLng(d.latitude, d.longitude));
                for (; f > e; e++) c.pop();
              }
            },
            !0
    ...
    function (a) {
      function b(b, c, d) {
        return google.maps.event.addListener(b, c, function () {
          d.apply(this, arguments), a(function () {}, !0);
        });
      }
      function c(a, c, d) {
        if (d) return b(a, c, d);
        ...
        return (
          angular.forEach(c, function (c, d) {
            console.log(
              "adding listener: " + d + ": " + c.toString() + " to : " + a
            ),
              e.push(b(a, d, c));
          }),
          function () {
      ...
      return {
        ...
        link: function (e, f, g) {
          ...
          if (!angular.isDefined(e.zoom))
            return (
              a.error("angular-google-maps: map zoom property not set"), void 0
            );
          var h = angular.element(f);
          h.addClass("angular-google-map");
          var i = { options: {} };
          if ((g.options && (i.options = e.options), g.type)) {
            var j = g.type.toUpperCase();
            google.maps.MapTypeId.hasOwnProperty(j)
              ? (i.mapTypeId = google.maps.MapTypeId[g.type.toUpperCase()])
              : a.error(
                  'angular-google-maps: invalid map type "' + g.type + '"'
                );
          }
          var k = new google.maps.Map(
              h.find("div")[1],
              angular.extend({}, d, i, {
            ...
            l = !1;
          google.maps.event.addListener(k, "dragstart", function () {
            (l = !0),
              b(function () {
                e.$apply(function (a) {
                  a.dragging = l;
            ...
            google.maps.event.addListener(k, "drag", function () {
              var a = k.center;
              b(function () {
                e.$apply(function (b) {
                  (b.center.latitude = a.lat()), (b.center.longitude = a.lng());
                });
              });
            }),
            google.maps.event.addListener(k, "zoom_changed", function () {
              e.zoom != k.zoom &&
                b(function () {
                  e.$apply(function (a) {
                    a.zoom = k.zoom;
          ...
          var m = !1;
          if (
            (google.maps.event.addListener(k, "center_changed", function () {
              var a = k.center;
              m ||
                b(function () {
                  e.$apply(function (b) {
            ...
            google.maps.event.addListener(k, "idle", function () {
              var a = k.getBounds(),
                c = a.getNorthEast(),
                d = a.getSouthWest();
              b(function () {
            ...
            var n = function (a) {
              return function () {
                e.events[a].apply(e, [k, a, arguments]);
              };
            };
            for (var o in e.events)
              e.events.hasOwnProperty(o) &&
                angular.isFunction(e.events[o]) &&
                google.maps.event.addListener(k, o, n(o));
          }
          (e.map = k),
            ...
            angular.isUndefined(e.refresh()) ||
              e.$watch("refresh()", function (a, b) {
                if (a && !b) {
                  var d = new google.maps.LatLng(a.latitude, a.longitude);
                  c(g.pan) ? k.panTo(d) : k.setCenter(d);
                }
              }),
            e.$watch(
              "center",
            ...
            e.$watch("bounds", function (a, b) {
              if (a !== b) {
                var c = new google.maps.LatLng(
                  ...
                  e = new google.maps.LatLngBounds(d, c);
                k.fitBounds(e);
              }
            });
        },
  ...
  angular.module("google-maps").directive("polygon", [
    ...
    function (a, b) {
      ...
      function d(a) {
        for (var b = new google.maps.MVCArray(), c = 0; c < a.length; c++)
          b.push(new google.maps.LatLng(a[c].latitude, a[c].longitude));
        return b;
      }
      function e(a, b) {
        for (var c = new google.maps.LatLngBounds(), d = 0; d < b.length; d++)
          c.extend(b.getAt(d));
        a.fitBounds(c);
      }
      function f(a) {
          ...
          return angular.isUndefined(h.path) ||
            ...
            : (b(function () {
                ...
                angular.forEach(
                  ...
                  function (a, b) {
                    c[b] =
                      angular.isUndefined(h[b]) || null === h[b] ? a : h[b];
                  }
                );
                var i = new google.maps.Polyline(c);
                f(j.fit) && e(a, b),
                ...
                var l,
                  ...
                  n,
                  o = i.getPath();
                (l = google.maps.event.addListener(o, "set_at", function (a) {
                  var b = o.getAt(a);
                  b &&
                    b.lng &&
                    b.lat &&
                  ...
                  (n = google.maps.event.addListener(
                    o,
                    "remove_at",
                    function (a) {
                      h.path.splice(a, 1), h.$apply();
                    }
                  )),
                  h.$watch(
                    "path",
        ...
        link: function (i, j, k, l) {
          return angular.isUndefined(i.path) ||
            ...
            : (b(function () {
                function a(a) {
                  ...
                  return (
                    angular.forEach(
                      ...
                      function (a, b) {
                        c[b] =
                          angular.isUndefined(i[b]) || null === i[b] ? a : i[b];
                      }
                    ),
                    c
                  );
                ...
                var b = l.getMap(),
                  d = new google.maps.Polyline(a(e(i.path)));
                g(k.fit) && f(b, pathPoints),
                ...
                var j = c(d.getPath(), i, "path");
                i.$on("$destroy", function () {
                  d.setMap(null), j && (j(), (j = null));
                });
              }),
              void 0);
        },
