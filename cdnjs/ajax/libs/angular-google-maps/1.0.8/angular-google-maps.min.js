              ...
              this.bigGulp.handleLargeArray(
                ...
                function () {
                  return (
                    ...
                    (a.markerModels = b),
                    angular.isDefined(c.attrs.fit) && null != a.fit && a.fit
                      ? c.fit()
                      : void 0
                  );
                }
      ...
      return (this.WindowsParentModel = (function (b) {
        ...
        return (
          ...
          (d.prototype.watchDestroy = function (a) {
            var b = this;
            return a.$on("$destroy", function () {
              return b.bigGulp.handleLargeArray(
                b.windows,
                function (a) {
                  return a.destroy();
                },
                ...
                function () {
                  return (
                    delete b.windows, (b.windows = []), (b.windowsIndex = 0)
                  );
                }
              );
            });
          ...
          (d.prototype.watchOurScope = function (a) {
            var b,
              ...
              g = this;
            for (
              e = this.scopePropNames, f = [], c = 0, d = e.length;
              d > c;
              c++
            )
              (b = e[c]),
                f.push(
                  (function (b) {
                    ...
                    return (
                      (c = b + "Key"),
                      (g[c] = "function" == typeof a[b] ? a[b]() : a[b]),
                      g.watch(a, b, c)
                    );
                  })(b)
                );
          ...
          (d.prototype.createChildScopesWindows = function () {
            ...
            return (
              ...
              c &&
              (void 0 === b ||
                (void 0 === b.markerModels && void 0 === b.models))
                ? (this.$log.info(
                ...
                ? null != this.linked.scope.models
                  ...
                  : ((this.models = b.models),
                    this.firstTime &&
                      (this.watchModels(b), this.watchDestroy(b)),
                    this.setContentKeys(b.models),
                    this.bigGulp.handleLargeArray(
                      b.markerModels,
                      function (b) {
