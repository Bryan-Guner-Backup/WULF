              ...
              (this.scope = b),
                ...
                !b["static"] &&
                  ...
                  b.$watch("editable", function (a, b) {
                    return a !== b ? this.polyline.setEditable(a) : void 0;
                  }),
                angular.isDefined(b.draggable) &&
                  b.$watch("draggable", function (a, b) {
                    return a !== b ? this.polyline.setDraggable(a) : void 0;
                  }),
                angular.isDefined(b.visible) &&
                  b.$watch("visible", function (a, b) {
                    return a !== b ? this.polyline.setVisible(a) : void 0;
                  }),
        ...
        return (
          ...
          (e = {}),
          {
            ...
            link: function (g, h, i, j) {
              return angular.isUndefined(g.path) ||
                null === g.path ||
                !d.validatePath(g.path)
                ...
                : b(function () {
                    ...
                    if (
                      ((b = function (a) {
                        ...
                        return (
                          ...
                          angular.forEach(
                            ...
                            function (a, c) {
                              return (b[c] =
                                angular.isUndefined(g[c]) || null === g[c]
                                  ? a
                                  : g[c]);
                            }
                          ),
                      ...
                      (l = j.getMap()),
                      (m = new google.maps.Polygon(
                        b(d.convertPathPoints(g.path))
                      )),
                      f(i.fit) && d.extendMapBounds(l, pathPoints),
                      !g["static"] &&
                        angular.isDefined(g.editable) &&
                        g.$watch("editable", function (a, b) {
                          return a !== b ? m.setEditable(a) : void 0;
                        }),
                      angular.isDefined(g.draggable) &&
                        g.$watch("draggable", function (a, b) {
                          return a !== b ? m.setDraggable(a) : void 0;
                        }),
                      angular.isDefined(g.visible) &&
                        g.$watch("visible", function (a, b) {
                          return a !== b ? m.setVisible(a) : void 0;
                        }),
                      angular.isDefined(g.geodesic) &&
                        g.$watch("geodesic", function (a, c) {
                          return a !== c
                            ? m.setOptions(b(m.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(g.stroke) &&
                        angular.isDefined(g.stroke.opacity) &&
                        g.$watch("stroke.opacity", function () {
                          return m.setOptions(b(m.getPath()));
                        }),
                      angular.isDefined(g.stroke) &&
                        angular.isDefined(g.stroke.weight) &&
                        g.$watch("stroke.weight", function (a, c) {
                          return a !== c
                            ? m.setOptions(b(m.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(g.stroke) &&
                        ...
                        g.$watch("stroke.color", function (a, c) {
                          return a !== c
                            ? m.setOptions(b(m.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(g.fill) &&
                        ...
                        g.$watch("fill.color", function (a, c) {
                          return a !== c
                            ? m.setOptions(b(m.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(g.fill) &&
                        ...
                        g.$watch("fill.opacity", function (a, c) {
                          return a !== c
                            ? m.setOptions(b(m.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(g.zIndex) &&
                        g.$watch("zIndex", function (a, c) {
                          return a !== c
                            ? m.setOptions(b(m.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(g.events) &&
                        null !== g.events &&
                        angular.isObject(g.events))
                    ) {
                      k = function (a) {
                        return function () {
                          return g.events[a].apply(g, [m, a, arguments]);
                        };
                      };
                      for (h in g.events)
                        g.events.hasOwnProperty(h) &&
                          angular.isFunction(g.events[h]) &&
                          m.addListener(h, k(h));
                    }
                    return (
                      (a = c(m.getPath(), g, "path")),
                      g.$on("$destroy", function () {
                        return m.setMap(null), a ? (a(), (a = null)) : void 0;
                      })
                    );
                  });
            },
