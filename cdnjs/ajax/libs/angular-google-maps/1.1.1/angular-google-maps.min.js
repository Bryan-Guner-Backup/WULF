          ...
          return {
            setEvents: function (b, c, d) {
              return angular.isDefined(c.events) &&
                ...
                ? _.compact(
                    _.map(c.events, function (e, f) {
                      return c.events.hasOwnProperty(f) &&
                        angular.isFunction(c.events[f])
                        ? google.maps.event.addListener(b, f, function () {
                            return e.apply(c, [b, f, d, arguments]);
                          })
                        : a.info(
                            "MarkerEventHelper: invalid event listener " + f
                          );
                    })
                  )
                : void 0;
        ...
        return (d = (function (b) {
          ...
          return (
            ...
            (d.prototype.modelKeyComparison = function (a, b) {
              ...
              return (
                this.evalModelHandle(a, c.coords).latitude ===
                  this.evalModelHandle(b, c.coords).latitude &&
                this.evalModelHandle(a, c.coords).longitude ===
                  this.evalModelHandle(b, c.coords).longitude
              );
            }),
                    ...
                    return _async.each(
                      ...
                      function (c) {
                        ...
                        return null == c
                          ...
                          : ((d = c.model[b]),
                            null == h[d] ? i.push(c.model[b]) : void 0);
                      },
                      function () {
  ...
  function () {
    ...
    angular
      ...
      .factory("PropMap", function () {
        var b, c;
        return (
          (c = ["get", "put", "remove", "values", "keys", "length"]),
          (b = (function () {
            function b() {
          ...
          return (e = (function (d) {
            function e(c, d, f, g) {
              ...
              (this.opt_events = g),
                ...
                (this.clusterer =
                  null != f && void 0 === d
                    ? new MarkerClusterer(c, void 0, f)
                    : null != f && null != d
                    ? new MarkerClusterer(c, d, f)
                    : new MarkerClusterer(c)),
            ...
            return (
              ...
              (f.prototype.remove = function (a, b) {
                ...
                return (
                  ...
                  b
                    ? ((c = void 0),
                      null != this.gMarkers.indexOf
                        ? (c = this.gMarkers.indexOf(a))
                        : ((d = 0),
                          _.find(this.gMarkers, function (b) {
                            (d += 1), b === a && (c = d);
                          })),
                      null != c ? this.gMarkers.splice(c, 1) : void 0)
                    : void 0
                );
              }),
              ...
              (f.prototype.draw = function () {
                ...
                return (
                  (a = []),
                  this.gMarkers.forEach(function (c) {
                    return c.isDrawn
                      ? void 0
                      : c.doAdd
                      ? c.setMap(b.gMap)
            ...
            c["static"] ||
              ((i = {
                set_at: function (a) {
                  ...
                  if (!h && (c = b.getAt(a)))
                    return c.lng && c.lat
                      ? ((l[a].latitude = c.lat()), (l[a].longitude = c.lng()))
                      : (l[a] = c);
                },
              ...
              "Polygon" === l.type
                ? (e = l.coordinates[0])
                : "LineString" === l.type && (e = l.coordinates),
              (f = {
                set_at: function (a) {
                  var c;
                  if (!h && ((c = b.getAt(a)), c && c.lng && c.lat))
                    return (e[a][1] = c.lat()), (e[a][0] = c.lng());
                },
                insert_at: function (a) {
                  var c;
                  if (!h && ((c = b.getAt(a)), c && c.lng && c.lat))
                    return e.splice(a, 0, [c.lng(), c.lat()]);
                },
                remove_at: function (a) {
                  return h ? void 0 : e.splice(a, 1);
                },
              }),
              (k = a(b, angular.isUndefined(l.type) ? i : f))),
            (j = function (a) {
              var c, d, e, f, g, i, j;
              if (((h = !0), (g = b), a)) {
                for (
                  ...
                  (j = g.getAt(c)),
                    (f = a[c]),
                    "function" == typeof f.equals
                      ? f.equals(j) || g.setAt(c, f)
                      : (j.lat() !== f.latitude || j.lng() !== f.longitude) &&
                        g.setAt(
                          c,
                          new google.maps.LatLng(f.latitude, f.longitude)
                        ),
                    c++;
                for (; e > c; )
                  (f = a[c]),
                    g.push(
                      "function" == typeof f.lat && "function" == typeof f.lng
                        ? f
                        : new google.maps.LatLng(f.latitude, f.longitude)
                    ),
                    c++;
            ...
            (g = function (a) {
              ...
              if (((h = !0), (i = b), a)) {
                for (
                  "Polygon" === l.type
                    ? (c = a.coordinates[0])
                    : "LineString" === l.type && (c = a.coordinates),
                    d = 0,
                    j = i.getLength(),
                    f = c.length,
                    e = Math.min(j, f),
                  ...
                  (k = i.getAt(d)),
                    (g = c[d]),
                    (k.lat() !== g[1] || k.lng() !== g[0]) &&
                      i.setAt(d, new google.maps.LatLng(g[1], g[0])),
                    d++;
                for (; f > d; )
                  (g = c[d]), i.push(new google.maps.LatLng(g[1], g[0])), d++;
                for (; j > d; ) i.pop(), d++;
              }
              return (h = !1);
            }),
            c["static"] ||
              (m = angular.isUndefined(l.type)
                ? c.$watchCollection(d, j)
                : c.$watch(d, g, !0)),
            function () {
        ...
        function (b, d) {
          ...
          return (e = (function (b) {
            function e(b, c) {
              (this.destroy = a(this.destroy, this)),
                (this.draw = a(this.draw, this)),
                (this.setPosition = a(this.setPosition, this)),
                (this.setZIndex = a(this.setZIndex, this)),
                (this.setVisible = a(this.setVisible, this)),
                (this.setAnchor = a(this.setAnchor, this)),
                (this.setMandatoryStyles = a(this.setMandatoryStyles, this)),
                (this.setStyles = a(this.setStyles, this)),
                (this.setContent = a(this.setContent, this)),
                (this.setTitle = a(this.setTitle, this)),
                (this.getSharedCross = a(this.getSharedCross, this));
              var d, f, g;
              e.__super__.constructor.call(this),
                (d = this),
                (this.marker = b),
                this.marker.set("labelContent", c.labelContent),
                this.marker.set(
                  "labelAnchor",
                  this.getLabelPositionPoint(c.labelAnchor)
                ),
                this.marker.set("labelClass", c.labelClass || "labels"),
                this.marker.set("labelStyle", c.labelStyle || { opacity: 100 }),
                this.marker.set("labelInBackground", c.labelInBackground || !1),
                c.labelVisible || this.marker.set("labelVisible", !0),
                c.raiseOnDrag || this.marker.set("raiseOnDrag", !0),
                c.clickable || this.marker.set("clickable", !0),
                c.draggable || this.marker.set("draggable", !1),
                c.optimized || this.marker.set("optimized", !1),
                (c.crossImage =
                  null != (f = c.crossImage)
                    ? f
                ...
                this.marker.set("setMap", function (a) {
                  return (
                    google.maps.Marker.prototype.setMap.apply(this, arguments),
                    d.markerLabel.setMap(a)
                  );
                }),
            ...
            return (
              c(e, b),
              e.include(d),
              (e.prototype.getSharedCross = function (a) {
              ...
              (e.prototype.destroy = function () {
                return null != this.markerLabel.labelDiv_.parentNode &&
                  null != this.markerLabel.eventDiv_.parentNode
                  ? this.markerLabel.onRemove()
                  : void 0;
              }),
              e
            );
          ...
          return (h = (function (b) {
            function h(b, c, d, f, g, i, j, k) {
              ...
              (this.model = b),
                ...
                (this.isLabelDefined = a(this.isLabelDefined, this)),
            ...
            return (
                  ...
                  this.maybeSetScopeValue(
                    ...
                    function (a, b) {
                      ...
                      return void 0 === a
                        ...
                        : ((c = "self" === b ? a : a[b]),
                          void 0 === c
                            ? (c = void 0 === b ? d.defaults : d.scope.options)
                            : c);
                    },
                    c,
                    this.setOptions
              ...
              (h.prototype.maybeSetScopeValue = function (a, b, c, d, e, f, g) {
                ...
                return (
                  ...
                  void 0 === c
                    ...
                    : ((i = e(c, d)),
                      (h = e(b, d)),
                      h === i || this.scope[a] === h || ((this.scope[a] = h), f)
                        ? void 0
                        : (null != g && g(this.scope),
              ...
              (h.prototype.setOptions = function (a) {
                ...
                if (
                  ...
                  return (
                    ...
                    delete this.gMarker,
                    (this.gMarker = this.isLabelDefined(a)
                      ? new MarkerWithLabel(this.setLabelOptions(this.opts, a))
                      : new google.maps.Marker(this.opts)),
                    this.setEvents(this.gMarker, this.parentScope, this.model),
                    this.id && (this.gMarker.key = this.id),
                    this.gMarkerManager.add(this.gMarker),
                    google.maps.event.addListener(
                      this.gMarker,
                      "click",
                      function () {
                        return c.doClick && null != c.scope.click
                          ? c.scope.click()
                          : void 0;
                      }
                    )
              ...
              (h.prototype.setLabelOptions = function (a, b) {
                return (
                  (a.labelAnchor = this.getLabelPositionPoint(b.labelAnchor)),
                  (a.labelClass = b.labelClass),
                  (a.labelContent = b.labelContent),
                  a
                );
              }),
              (h.prototype.watchDestroy = function (a) {
                ...
                return a.$on("$destroy", function () {
                  ...
                  return (
                    null != b.gMarker &&
                      (google.maps.event.clearListeners(b.gMarker, "click"),
                      (null != (c = b.parentScope) ? c.events : void 0) &&
                        _.isArray(b.parentScope.events) &&
                        b.parentScope.events.forEach(function (a, b) {
                          return google.maps.event.clearListeners(
                            this.gMarker,
                            b
                          );
                        }),
                      b.gMarkerManager.remove(b.gMarker, !0),
                      delete b.gMarker),
                    (a = void 0)
                  );
                });
          ...
          (i = (function (b) {
            function d(b, c, d, e, g) {
              ...
              (this.scope = b),
                ...
                (j = this.convertPathPoints(this.scope.path)),
                (this.polyline = new google.maps.Polyline(this.buildOpts(j))),
                this.isTrue(this.attrs.fit) && extendMapBounds(d, j),
                !b["static"] &&
                  angular.isDefined(b.editable) &&
                  b.$watch("editable", function (a, b) {
                    return a !== b ? k.polyline.setEditable(a) : void 0;
                  }),
                angular.isDefined(b.draggable) &&
                  b.$watch("draggable", function (a, b) {
                    return a !== b ? k.polyline.setDraggable(a) : void 0;
                  }),
                angular.isDefined(b.visible) &&
                  b.$watch("visible", function (a, b) {
                    return a !== b ? k.polyline.setVisible(a) : void 0;
                  }),
                angular.isDefined(b.geodesic) &&
                  b.$watch("geodesic", function (a, b) {
                    return a !== b
                      ? k.polyline.setOptions(k.buildOpts(k.polyline.getPath()))
                      : void 0;
                  }),
                ...
                (i = f(this.polyline.getPath(), b, "path")),
                b.$on("$destroy", function () {
                  return (
                    k.polyline.setMap(null),
                    (k.polyline = null),
                    (k.scope = null),
                    i ? (i(), (i = null)) : void 0
                  );
            ...
            return (
              c(d, b),
              d.include(g),
              (d.prototype.buildOpts = function (a) {
                var b,
                  c = this;
                return (
                  (b = angular.extend({}, this.defaults, {
                    ...
                    strokeOpacity:
                      this.scope.stroke && this.scope.stroke.opacity,
          ...
          return (i = (function (b) {
            ...
            return (
                      ...
                      this.googleMapsHandles.push(
                        google.maps.event.addListener(
                          ...
                          function () {
                            ...
                            return (
                              null != (a = b.markerCtrl) &&
                                a.setVisible(b.markerIsVisibleAfterWindowClose),
                              b.gWin.isOpen(!1),
              ...
              (i.prototype.getLatestPosition = function () {
                return null != this.gWin && null != this.markerCtrl
          ...
          return (e = (function (b) {
            function e(b, c, f, g, h) {
              ...
              if (
                ...
                (this.mapCtrl = g),
                (this.$timeout = h),
                (this.linkInit = a(this.linkInit, this)),
                ...
                (this.onTimeOut = a(this.onTimeOut, this)),
              ...
              (this.doClick = angular.isDefined(f.click)),
                ...
                this.$timeout(function () {
                  return (
                    j.onTimeOut(b),
                    j.watch("coords", j.scope),
                    j.watch("icon", j.scope),
                    j.watch("options", j.scope),
                    b.$on("$destroy", function () {
              ...
              return (
                ...
                null == this.attrs.type
                  ...
                  : (this.createGoogleLayer(),
                    (this.gMap = void 0),
                    (this.doShow = !0),
                    void this.$timeout(function () {
                      return (
                        (j.gMap = f.getMap()),
                        angular.isDefined(j.attrs.show) &&
                          (j.doShow = j.scope.show),
                        j.doShow && null != j.gMap && j.layer.setMap(j.gMap),
                        j.scope.$watch(
                          "show",
                          function (a, b) {
                            return a !== b
                              ? ((j.doShow = a),
                                j.layer.setMap(a ? j.gMap : null))
                              : void 0;
                          },
                          !0
                        ),
              ...
              (e.prototype.createGoogleLayer = function () {
                ...
                return (
                  ...
                  this.$timeout(function () {
                    var b;
                    return null != a.layer &&
                      null != a.onLayerCreated &&
                      (b = a.onLayerCreated(a.scope, a.layer))
                      ? b(a.layer)
                      : void 0;
                  })
                );
        ...
        function (b, d, e) {
          ...
          return (f = (function (b) {
            ...
            return (
              ...
              f.include(d),
              f.include(e),
              (f.prototype.onTimeOut = function (a) {
                var b,
                  c = this;
                return (
                  (b = this.createMarkerOptions(
                    a.coords,
                    a.icon,
                    a.options,
                    this.mapCtrl.getMap()
                  )),
                  this.setGMarker(new google.maps.Marker(b)),
                  google.maps.event.addListener(
                    this.scope.gMarker,
                    "click",
                    function () {
                      return c.doClick && null != a.click
                        ? c.$timeout(function () {
                  ...
                  this.setEvents(this.scope.gMarker, a, a),
                  this.$log.info(this)
                );
              }),
              (f.prototype.onWatch = function (a, b) {
                switch (a) {
                  case "coords":
                    return this.validateCoords(b.coords) &&
                      ...
                      ? (this.scope.gMarker.setMap(this.mapCtrl.getMap()),
                        ...
                        this.scope.gMarker.setOptions(b.options))
              ...
              (f.prototype.setGMarker = function (a) {
                return (
                  ...
                  this.scope.gMarker &&
                  (this.gMarkerManager.add(this.scope.gMarker, !1), this.doFit)
          ...
          return (i = (function (b) {
            function i(b, c, d, f, g) {
              (this.onDestroy = a(this.onDestroy, this)),
                ...
                (this.pieceMealMarkers = a(this.pieceMealMarkers, this)),
            ...
            return (
              c(i, b),
              i.include(d),
              (i.prototype.onTimeOut = function (a) {
                return (
                  this.watch("models", a),
                  this.watch("doCluster", a),
                  this.watch("clusterOptions", a),
                  this.watch("clusterEvents", a),
                  this.watch("fit", a),
                  this.watch("idKey", a),
              ...
              (i.prototype.onWatch = function (a, b, c, d) {
                return (
                  ...
                  this.doRebuildAll
                    ? this.reBuildMarkers(b)
                    : this.pieceMealMarkers(b)
                );
              }),
                  ...
                  a.doCluster
                    ? (a.clusterEvents &&
                      ...
                      a.clusterOptions || a.clusterEvents
                        ...
                        : (this.gMarkerManager = new g(this.mapCtrl.getMap())))
                    : (this.gMarkerManager = new h(this.mapCtrl.getMap())),
                  _async.each(
                    a.models,
                    function (c) {
                            ...
                            function () {
                              return _async.each(
                                ...
                                function () {
                                  return (
                                    b.gMarkerManager.draw(),
                                    (a.markerModels = b.scope.markerModels)
                                  );
                                }
                              );
                            }
          ...
          return (i = (function (e) {
            function i(c, e, f, h, j) {
              ...
              (this.scope = c),
                ...
                (this.watch = a(this.watch, this)),
                i.__super__.constructor.call(this, c),
                (k = this),
                (this.$log = d),
                (this.plurals = new g()),
                (this.scopePropNames = [
            ...
            return (
              c(i, e),
              i.include(f),
              (i.prototype.watch = function (a, b, c) {
                var d = this;
              ...
              (this.$interpolate = m),
                ...
                this.$timeout(function () {
                  return (
                    o.watchOurScope(b),
                    (o.doRebuildAll =
                      null != o.scope.doRebuildAll ? o.scope.doRebuildAll : !0),
                    b.$watch("doRebuildAll", function (a, b) {
                        ...
                        function (b) {
                          ...
                          return (
                            ...
                            _async.each(
                              ...
                              function (a) {
                                return null != a
                                  ? (a.destroy(), e.windows.remove(a.id))
                                  : void 0;
                              },
                              function () {
                                return _async.each(
      ...
      function (a, c, d) {
        ...
        return (e = (function (c) {
          ...
          return (
            b(e, c),
            e.include(a),
            (e.prototype.restrict = "ECA"),
            (e.prototype.replace = !0),
            (e.prototype.require = "^googleMap"),
            (e.prototype.scope = {
              path: "=",
              stroke: "=",
              clickable: "=",
  ...
  function () {
    ...
    angular.module("google-maps.directives.api").factory("Map", [
      ...
      function (b, d, e, f) {
        ...
        return (
          (g = d),
          (h = { mapTypeId: google.maps.MapTypeId.ROADMAP }),
          (i = (function (b) {
            function d() {
              this.link = a(this.link, this);
              var b;
            ...
            return (
              ...
              (d.prototype.link = function (a, b, c) {
                var d,
                  ...
                  m,
                  n = this;
                if (!this.validateCoords(a.center))
                  return void g.error(
                ...
                if (
                  ...
                  (j = { options: {} }),
                  c.options && (j.options = a.options),
                  c.styles && (j.styles = a.styles),
                  c.type &&
                    ((l = c.type.toUpperCase()),
                    google.maps.MapTypeId.hasOwnProperty(l)
                      ? (j.mapTypeId =
                  ...
                  for (f in a.events)
                    a.events.hasOwnProperty(f) &&
                      ...
                      google.maps.event.addListener(m, f, i(f));
                }
                return (
                  (a.map = m),
                  null != c.control &&
                    ...
                    ((a.control.refresh = function (a) {
                      ...
                      if (null != m)
                        return (
                          ...
                          null != (null != a ? a.latitude : void 0)
                            ? ((b = n.getCoords(a)),
                              n.isTrue(c.pan) ? m.panTo(b) : m.setCenter(b))
                            : void 0
                        );
                    }),
                  ...
                  a.$watch(
                    ...
                    function (b) {
                      ...
                      return (
                        (e = n.getCoords(b)),
                        e.lat() !== m.center.lat() || e.lng() !== m.center.lng()
                          ? ((k = !0),
                            d ||
                              (n.validateCoords(b) ||
                                g.error(
                  ...
                  a.$watch(
                    "options",
                    function (a, b) {
                      return _.isEqual(a, b) || ((j.options = a), null == m)
                        ? void 0
                        : m.setOptions(j);
                    },
                    !0
                  ...
                  a.$watch(
                    "styles",
                    function (a, b) {
                      return _.isEqual(a, b) || ((j.styles = a), null == m)
                        ? void 0
                        : m.setOptions(j);
                    },
                    !0
          ...
          return (
            ...
            (f.prototype.link = function (a, b, c, f) {
              ...
              return (
                a.fit && (g = !0),
                this.gMarkerManager ||
                  (this.gMarkerManager = new e(f.getMap())),
                new d(a, b, c, f, this.$timeout, this.gMarkerManager, g)
              );
            }),
            f
          );
            ...
            (f.prototype.link = function (a, b, c, f) {
              ...
              return this.$timeout(function () {
                ...
                return (
                  ...
                  (k =
                    f.length > 1 && null != f[1]
                      ? f[1].getMarkerScope().gMarker
                      : void 0),
                  (d = null != a.options ? a.options : {}),
                  (h = null != a && g.validateCoords(a.coords)),
                  (m = h ? g.createWindowOptions(k, a, b.html(), d) : d),
                  null != j && (n = new e({}, a, m, i, j, k, b)),
                  a.$on("$destroy", function () {
                    return n.destroy();
                  }),
                  null != f[1] &&
                    ((l = f[1].getMarkerScope()),
                    l.$watch(
                      "coords",
                      function (a, b) {
                        return g.validateCoords(a)
                          ? angular.equals(a, b)
                            ? void 0
                            : n.getLatestPosition()
                          : n.hideWindow();
        ...
        return (
          ...
          (e = {}),
          {
            ...
            link: function (f, g, h, i) {
              return angular.isUndefined(f.path) ||
                null === f.path ||
                !d.validatePath(f.path)
                ...
                : b(function () {
                    ...
                    if (
                      ...
                      (j = i.getMap()),
                      (k = d.convertPathPoints(f.path)),
                      (l = new google.maps.Polygon(b(k))),
                      f.fit && d.extendMapBounds(j, k),
                      !f["static"] &&
                        angular.isDefined(f.editable) &&
                        f.$watch("editable", function (a, b) {
                          return a !== b ? l.setEditable(a) : void 0;
                        }),
                      angular.isDefined(f.draggable) &&
                        f.$watch("draggable", function (a, b) {
                          return a !== b ? l.setDraggable(a) : void 0;
                        }),
                      angular.isDefined(f.visible) &&
                        f.$watch("visible", function (a, b) {
                          return a !== b ? l.setVisible(a) : void 0;
                        }),
                      angular.isDefined(f.geodesic) &&
                        f.$watch("geodesic", function (a, c) {
                          return a !== c
                            ? l.setOptions(b(l.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(f.stroke) &&
                        angular.isDefined(f.stroke.opacity) &&
                        f.$watch("stroke.opacity", function () {
                          return l.setOptions(b(l.getPath()));
                        }),
                      angular.isDefined(f.stroke) &&
                        angular.isDefined(f.stroke.weight) &&
                        f.$watch("stroke.weight", function (a, c) {
                          return a !== c
                            ? l.setOptions(b(l.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(f.stroke) &&
                        angular.isDefined(f.stroke.color) &&
                        f.$watch("stroke.color", function (a, c) {
                          return a !== c
                            ? l.setOptions(b(l.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(f.fill) &&
                        angular.isDefined(f.fill.color) &&
                        f.$watch("fill.color", function (a, c) {
                          return a !== c
                            ? l.setOptions(b(l.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(f.fill) &&
                        angular.isDefined(f.fill.opacity) &&
                        f.$watch("fill.opacity", function (a, c) {
                          return a !== c
                            ? l.setOptions(b(l.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(f.zIndex) &&
                        f.$watch("zIndex", function (a, c) {
                          return a !== c
                            ? l.setOptions(b(l.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(f.events) &&
                        null !== f.events &&
                        angular.isObject(f.events))
                    ) {
                      h = function (a) {
                        return function () {
                      ...
                      for (g in f.events)
                        f.events.hasOwnProperty(g) &&
                          angular.isFunction(f.events[g]) &&
                          l.addListener(g, h(g));
                    }
                    return (
                      (a = c(l.getPath(), f, "path", function (a) {
            ...
            link: function (e, f, g, h) {
              return b(function () {
                ...
                return (
                  (f = function () {
                    var b;
                    return c.validateCoords(e.center)
                      ? ((b = angular.extend({}, d, {
                          map: i,
                          center: c.getCoords(e.center),
                          radius: e.radius,
                          strokeColor: e.stroke && e.stroke.color,
                          strokeOpacity: e.stroke && e.stroke.opacity,
                          strokeWeight: e.stroke && e.stroke.weight,
                          fillColor: e.fill && e.fill.color,
                          fillOpacity: e.fill && e.fill.opacity,
                        })),
                        angular.forEach(
                          {
                            clickable: !0,
                          ...
                          function (a, c) {
                            return (b[c] =
                              angular.isUndefined(e[c]) || null === e[c]
                                ? a
                                : e[c]);
                          }
                        ),
                  ...
                  (i = h.getMap()),
                  (g = new google.maps.Circle(f())),
                  e.$watchCollection("center", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  e.$watchCollection("stroke", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  e.$watchCollection("fill", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  e.$watch("radius", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  e.$watch("clickable", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  e.$watch("editable", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  e.$watch("draggable", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  e.$watch("visible", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  e.$watch("geodesic", function (a, b) {
                    return a !== b ? g.setOptions(f()) : void 0;
                  }),
                  google.maps.event.addListener(
                    g,
                  ...
                  google.maps.event.addListener(
                    ...
                    function () {
                      return (
                        angular.isDefined(e.center.type)
                          ? ((e.center.coordinates[1] = g.getCenter().lat()),
                            (e.center.coordinates[0] = g.getCenter().lng()))
                          : ((e.center.latitude = g.getCenter().lat()),
                            (e.center.longitude = g.getCenter().lng())),
                        b(function () {
                          return e.$apply();
                        })
                      );
        ...
        return (
          ...
          (c = {}),
          {
            ...
            link: function (h, i, j, k) {
              return angular.isUndefined(h.bounds) ||
                null === h.bounds ||
                angular.isUndefined(h.bounds.sw) ||
                null === h.bounds.sw ||
                angular.isUndefined(h.bounds.ne) ||
                null === h.bounds.ne ||
                !g(h.bounds)
                ...
                : b(function () {
                    ...
                    return (
                      (b = function (a) {
                        ...
                        return (
                          ...
                          angular.forEach(
                            ...
                            function (a, c) {
                              return (b[c] =
                                angular.isUndefined(h[c]) || null === h[c]
                                  ? a
                                  : h[c]);
                            }
                          ),
                      ...
                      (i = k.getMap()),
                      (l = new google.maps.Rectangle(b(d(h.bounds)))),
                      f(j.fit) && e(i, bounds),
                      (g = !1),
                      google.maps.event.addListener(
                        l,
                      ...
                      angular.isDefined(h.editable) &&
                        h.$watch("editable", function (a) {
                          return l.setEditable(a);
                        }),
                      angular.isDefined(h.draggable) &&
                        h.$watch("draggable", function (a) {
                          return l.setDraggable(a);
                        }),
                      angular.isDefined(h.visible) &&
                        h.$watch("visible", function (a) {
                          return l.setVisible(a);
                        }),
                      angular.isDefined(h.stroke) &&
                        (angular.isDefined(h.stroke.color) &&
                          h.$watch("stroke.color", function () {
                            return l.setOptions(b(l.getBounds()));
                          }),
                        angular.isDefined(h.stroke.weight) &&
                          h.$watch("stroke.weight", function () {
                            return l.setOptions(b(l.getBounds()));
                          }),
                        angular.isDefined(h.stroke.opacity) &&
                          h.$watch("stroke.opacity", function () {
                            return l.setOptions(b(l.getBounds()));
                          })),
                      angular.isDefined(h.fill) &&
                        (angular.isDefined(h.fill.color) &&
                          h.$watch("fill.color", function () {
                            return l.setOptions(b(l.getBounds()));
                          }),
                        angular.isDefined(h.fill.opacity) &&
                          h.$watch("fill.opacity", function () {
                            return l.setOptions(b(l.getBounds()));
                          })),
        ...
        return new (e = (function () {
          ...
          return (
            (b.prototype.link = function (a, b, c, e) {
              return null != c.oncreated
                ? new d(a, b, c, e, this.$timeout, a.onCreated)
                : new d(a, b, c, e, this.$timeout);
            }),
            b
          );
        })())(b);
