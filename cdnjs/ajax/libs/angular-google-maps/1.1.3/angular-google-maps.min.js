          ...
          (i = (function (b) {
            function d(b, c, d, e, i) {
              ...
              (this.scope = b),
                ...
                (k = this.convertPathPoints(b.path)),
                (this.polyline = new google.maps.Polyline(this.buildOpts(k))),
                b.fit && g.extendMapBounds(d, k),
                !b["static"] &&
                ...
                angular.isDefined(b.geodesic) &&
                  b.$watch("geodesic", function (a, b) {
                    return a !== b
                      ? l.polyline.setOptions(l.buildOpts(l.polyline.getPath()))
                      : void 0;
                  }),
