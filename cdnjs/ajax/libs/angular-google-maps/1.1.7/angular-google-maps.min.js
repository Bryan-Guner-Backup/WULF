              ...
              (this.$interpolate = m),
                ...
                this.$timeout(function () {
                  return (
                    o.watchOurScope(b),
                    (o.doRebuildAll =
                      null != o.scope.doRebuildAll ? o.scope.doRebuildAll : !1),
                    ...
                    function () {
                      return (
                        angular.isDefined(f.center.type)
                          ? ((f.center.coordinates[1] = h.getCenter().lat()),
                            (f.center.coordinates[0] = h.getCenter().lng()))
                          : ((f.center.latitude = h.getCenter().lat()),
                            (f.center.longitude = h.getCenter().lng())),
                        b(function () {
                          return f.$apply();
                        })
                      );
