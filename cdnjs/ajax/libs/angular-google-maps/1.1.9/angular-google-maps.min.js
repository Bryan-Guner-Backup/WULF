                    ...
                    return null == c[b]
                      ...
                      : ((h[c[b]] = {}),
                        null == d[c[b]]
                          ? g.push(c)
                          : ((f = d[c[b]]),
                            e(c, f.model) ? void 0 : (g.push(c), i.push(f))));
                  },
                  function () {
                    return _async.each(
                      d.values(),
          ...
          return (e = (function (e) {
            ...
            return (
              ...
              (f.prototype.add = function (a, b, c) {
                return (
                  null == c && (c = !0),
                  this.handleOptDraw(a, b, c),
                  this.gMarkers.push(a)
                );
              }),
                ...
                switch (a) {
                  ...
                  case "options":
                    if (
                      ...
                      return this.onDestroy(b), this.onTimeOut(b);
                }
              }),
  ...
  function () {
    ...
    angular.module("google-maps.directives.api").factory("Map", [
      ...
      function (b, d, e, f, g, h, i) {
        ...
        return (
          (j = e),
          (k = { mapTypeId: google.maps.MapTypeId.ROADMAP }),
          (l = (function (b) {
            function d() {
              this.link = a(this.link, this);
              var b;
            ...
            return (
              ...
              (d.prototype.link = function (a, b, c) {
                ...
                if (
                  ...
                  (h = { options: {} }),
                  c.options && (h.options = a.options),
                  c.styles && (h.styles = a.styles),
                  c.type &&
                  ...
                  for (f in a.events)
                    a.events.hasOwnProperty(f) &&
                      ...
                      google.maps.event.addListener(m, f, g(f));
                }
                return (
                  (a.map = m),
                  null != c.control &&
                  ...
                  a.$watch(
                    "options",
                    function (a, b) {
                      return _.isEqual(a, b) || ((h.options = a), null == m)
                        ? void 0
                        : m.setOptions(h);
                    },
                    !0
                  ...
                  a.$watch(
                    "styles",
                    function (a, b) {
                      return _.isEqual(a, b) || ((h.styles = a), null == m)
                        ? void 0
                        : m.setOptions(h);
                    },
                    !0
          ...
          return (
            ...
            (g.prototype.link = function (a, b, c, f) {
              var h,
                i = this;
              return (
                g.__super__.link.call(this, a, b, c, f),
                a.fit && (h = !0),
                this.mapPromise(a, f).then(function (f) {
                  return (
                    i.gMarkerManager || (i.gMarkerManager = new e(f)),
                    new d(a, b, c, f, i.$timeout, i.gMarkerManager, h),
                    a.deferred.resolve()
                  );
                })
              );
      ...
      function (b, d, e, f) {
        ...
        return (g = (function (b) {
          function d() {
            return (
              (this.link = a(this.link, this)),
              (h = d.__super__.constructor.apply(this, arguments))
            );
          }
          return (
            c(d, b),
            (d.prototype.link = function (a, b, c, d) {
              ...
              return angular.isUndefined(a.path) ||
                ...
                : d.getScope().deferred.promise.then(function (b) {
                  ...
                  f.$watch(
                    ...
                    function (a, b) {
                      return (
                        null == f.gMarker ||
                          k.markerCtrl ||
                          ((k.markerCtrl = f.gMarker), k.handleClick(!0)),
                        l.validateCoords(a)
                          ? angular.equals(a, b)
                            ? void 0
