            ...
            return (
              ...
              (h.prototype.destroy = function () {
                ...
                return null != this.gMarker
                  ? (_(this.internalEvents()).each(function (a, c) {
                      return google.maps.event.clearListeners(b.gMarker, c);
                    }),
                    (null != (a = this.parentScope) ? a.events : void 0) &&
                      _.isArray(this.parentScope.events) &&
                      _(this.parentScope.events).each(function (a, c) {
                        return google.maps.event.clearListeners(b.gMarker, c);
                      }),
                      ...
                      this.googleMapsHandles.push(
                        google.maps.event.addListener(
                          ...
                          function () {
                            return (
                              b.markerCtrl &&
                                (b.markerCtrl.setAnimation(
                                  b.oldMarkerAnimation
                                ),
                                b.markerIsVisibleAfterWindowClose &&
                                  _.delay(function () {
                                    return (
                                      b.markerCtrl.setVisible(!1),
                                      b.markerCtrl.setVisible(
                                        b.markerIsVisibleAfterWindowClose
                                      )
                                    );
                                  }, 250)),
                              b.gWin.isOpen(!1),
                              null != b.scope.closeClick
                                ? b.scope.closeClick()
                                : void 0
                            );
                          }
