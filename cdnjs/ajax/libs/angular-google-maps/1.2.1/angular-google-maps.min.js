            ...
            return (
              ...
              (i.prototype.showWindow = function () {
                ...
                return (
                  (a = function () {
                    return !b.gWin ||
                      (!b.scope.show && null != b.scope.show) ||
                      b.gWin.isOpen()
                      ? void 0
                      : b.gWin.open(b.mapCtrl);
                  }),
                    ...
                    ? (this.gWin &&
                        g
                          ...
                          .then(function (a) {
                            ...
                            return (
                              (d = b.scope.$new()),
                              angular.isDefined(b.scope.templateParameter) &&
                                (d.parameter = b.scope.templateParameter),
                              (c = f(a.data)(d)),
                              b.gWin.setContent(c[0])
                            );
                          }),
                      a())
                    : a()
