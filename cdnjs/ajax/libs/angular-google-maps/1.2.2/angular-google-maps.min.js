...
function InfoBox(a) {
  (a = a || {}),
    ...
    "undefined" == typeof a.visible &&
      (a.visible = "undefined" == typeof a.isHidden ? !0 : !a.isHidden),
...
(InfoBox.prototype = new google.maps.OverlayView()),
  ...
  (MarkerLabel_.getSharedCross = function (a) {
    var b;
    return (
      "undefined" == typeof MarkerLabel_.getSharedCross.crossDiv &&
    ...
    this.getPanes().overlayImage.appendChild(this.labelDiv_),
      ...
      (this.listeners_ = [
        google.maps.event.addDomListener(
          ...
          "mouseover",
          function (a) {
            (h.marker_.getDraggable() || h.marker_.getClickable()) &&
              ((this.style.cursor = "pointer"),
              google.maps.event.trigger(h.marker_, "mouseover", a));
          }
        ),
        google.maps.event.addDomListener(
          this.eventDiv_,
          ...
          function (a) {
            (!h.marker_.getDraggable() && !h.marker_.getClickable()) ||
              j ||
              ((this.style.cursor = h.marker_.getCursor()),
              google.maps.event.trigger(h.marker_, "mouseout", a));
          }
        ),
        google.maps.event.addDomListener(
          this.eventDiv_,
          ...
          function (a) {
            (j = !1),
              h.marker_.getDraggable() && ((i = !0), (this.style.cursor = l)),
              (h.marker_.getDraggable() || h.marker_.getClickable()) &&
                (google.maps.event.trigger(h.marker_, "mousedown", a), m(a));
          }
        ),
        google.maps.event.addDomListener(document, "mouseup", function (b) {
          ...
          if (
            (i &&
              ((i = !1),
              (h.eventDiv_.style.cursor = "pointer"),
              google.maps.event.trigger(h.marker_, "mouseup", b)),
            j)
          ) {
            if (e) {
              (c = h
                .getProjection()
                .fromLatLngToDivPixel(h.marker_.getPosition())),
                (c.y += k),
                h.marker_.setPosition(
                  h.getProjection().fromDivPixelToLatLng(c)
                );
              try {
                h.marker_.setAnimation(google.maps.Animation.BOUNCE),
                  setTimeout(n, 1406);
              } catch (f) {}
            }
            (h.crossDiv_.style.display = "none"),
              h.marker_.setZIndex(a),
              (d = !0),
              (j = !1),
              (b.latLng = h.marker_.getPosition()),
              google.maps.event.trigger(h.marker_, "dragend", b);
          }
        }),
        google.maps.event.addListener(
          h.marker_.getMap(),
            ...
            i &&
              (j
                ? ((d.latLng = new google.maps.LatLng(
                  ...
                  (l = h.getProjection().fromLatLngToDivPixel(d.latLng)),
                  e &&
                    ((h.crossDiv_.style.left = l.x + "px"),
                    (h.crossDiv_.style.top = l.y + "px"),
                    (h.crossDiv_.style.display = ""),
                    (l.y -= k)),
                  h.marker_.setPosition(
                    h.getProjection().fromDivPixelToLatLng(l)
                  ),
                  e && (h.eventDiv_.style.top = l.y + k + "px"),
                  google.maps.event.trigger(h.marker_, "drag", d))
                : ((b = d.latLng.lat() - h.marker_.getPosition().lat()),
                  (c = d.latLng.lng() - h.marker_.getPosition().lng()),
                  (a = h.marker_.getZIndex()),
                  (f = h.marker_.getPosition()),
                  (g = h.marker_.getMap().getCenter()),
                  (e = h.marker_.get("raiseOnDrag")),
                  (j = !0),
                  h.marker_.setZIndex(1e6),
                  (d.latLng = h.marker_.getPosition()),
                  google.maps.event.trigger(h.marker_, "dragstart", d)));
          }
        ),
        google.maps.event.addDomListener(document, "keydown", function (a) {
          j &&
            27 === a.keyCode &&
            ((e = !1),
            h.marker_.setPosition(f),
            h.marker_.getMap().setCenter(g),
        ...
        google.maps.event.addDomListener(this.eventDiv_, "click", function (a) {
          (h.marker_.getDraggable() || h.marker_.getClickable()) &&
            (d
              ? (d = !1)
              : (google.maps.event.trigger(h.marker_, "click", a), m(a)));
        }),
        google.maps.event.addDomListener(
          this.eventDiv_,
          "dblclick",
          function (a) {
            (h.marker_.getDraggable() || h.marker_.getClickable()) &&
              (google.maps.event.trigger(h.marker_, "dblclick", a), m(a));
          }
        ),
  ...
  (MarkerLabel_.prototype.setStyles = function () {
    ...
    for (a in b)
      b.hasOwnProperty(a) &&
        ((this.labelDiv_.style[a] = b[a]), (this.eventDiv_.style[a] = b[a]));
              ...
              (MarkerLabel_.prototype.setContent = function () {
                ...
                (a = this.marker_.get("labelContent")),
                  a &&
                    ...
                    ("undefined" == typeof (null != a ? a.nodeType : void 0)
                      ? ((this.labelDiv_.innerHTML = a),
                        (this.eventDiv_.innerHTML = this.labelDiv_.innerHTML),
                        (this.oldContent = a))
                      : ((this.labelDiv_.innerHTML = ""),
  ...
  function () {
    (_.intersectionObjects = function (a, b, c) {
      ...
      (_.containsObject = _.includeObject =
        function (a, b, c) {
          return (
            null == c && (c = void 0),
            null === a
  ...
  function () {
    ...
    (a = {
      each: function (a, b, c, d, e, f, g) {
        ...
        return void 0 === a || (null != a ? a.length : void 0) <= 0
          ? void c()
          : (h = function () {
              var i, j;
              for (i = e, j = f; i-- && j < (a ? a.length : j + 1); )
                b(a[j], j), ++j;
              if (a) {
                if (j < a.length)
                  return (f = j), null != d && d(), setTimeout(h, g);
                if (c) return c();
              }
            })();
      },
        ...
        return {
          setEvents: function (b, c, d, e) {
            return angular.isDefined(c.events) &&
              null != c.events &&
              angular.isObject(c.events)
              ? _.compact(
                  _.map(c.events, function (f, g) {
                    var h;
                    return (
                      e && (h = _(e).contains(g)),
                      c.events.hasOwnProperty(g) &&
                      angular.isFunction(c.events[g]) &&
                      !h
                        ? google.maps.event.addListener(b, g, function () {
          ...
          (f = function (a, b) {
            return a
              ? (Array.isArray(a) && 2 === a.length
                  ? ((a[1] = b.lat()), (a[0] = b.lng()))
                  : angular.isDefined(a.type) && "Point" === a.type
                  ? ((a.coordinates[1] = b.lat()), (a.coordinates[0] = b.lng()))
    ...
    angular.module("google-maps.directives.api.utils").factory("ModelKey", [
      ...
      function (b, d) {
        ...
        return (e = (function (b) {
          ...
          return (
            c(e, b),
            (e.prototype.evalModelHandle = function (a, b) {
      ...
      (window.PropMap = (function () {
        function c() {
          (this.removeAll = b(this.removeAll, this)),
            ...
            (this.length = 0),
            (this.didValueStateChange = !1),
            (this.didKeyStateChange = !1),
            (this.allVals = []),
            (this.allKeys = []);
        }
        return (
          ...
          (c.prototype.stateChanged = function () {
            return (
              (this.didValueStateChange = !0), (this.didKeyStateChange = !0)
            );
          }),
          ...
          (c.prototype.values = function () {
            var b,
              c = this;
            return this.didValueStateChange
              ? ((b = []),
          ...
          return (f = (function (d) {
            ...
            return (
              ...
              (f.prototype.add = function (a) {
                ...
                return (
                  this.checkKey(a),
                  (b = null != this.propMapGMarkers.get(a.key)),
          ...
          return (f = (function (f) {
            ...
            return (
              ...
              (g.prototype.add = function (a, c) {
                ...
                return (
                  (d = null != this.gMarkers.get(a.key)),
                  d
                    ? void 0
              ...
              (g.prototype.draw = function () {
                ...
                return (
                  (a = []),
                  this.gMarkers.values().forEach(function (c) {
                    return c.isDrawn
                      ? void 0
                      : c.doAdd
              ...
              (g.prototype.clear = function () {
                return (
                  this.gMarkers.values().forEach(function (a) {
            ...
            (d = function (d) {
              ...
              return (
                ...
                (f = function () {
                  var a;
                  return (
                    null != (a = g.deferred) && a.resolve(),
                    g.map.setOptions(g.oldOptions)
                  );
                }),
                (e = function () {
                  return (
                    a.info("disabling map move"),
                    (g.oldOptions = d.getOptions()),
                    g.map.setOptions({
                      draggable: !1,
                      zoomControl: !1,
                      scrollwheel: !1,
          ...
          return (e = (function (b) {
            function e(b, c, d) {
              ...
              e.__super__.constructor.call(this),
                ...
                this.gMarker.set("setMap", function (a) {
                  return (
                    f.gMarkerLabel.setMap(a),
                    google.maps.Marker.prototype.setMap.apply(this, arguments)
                  );
                }),
            ...
            return (
              c(e, b),
              e.include(d),
              (e.prototype.setOption = function (a, b) {
                return this.gMarker.set(a, b);
              }),
              (e.prototype.setOptions = function (a) {
                var b, c;
                return (
                  (null != a ? a.labelContent : void 0) &&
                    this.gMarker.set("labelContent", a.labelContent),
                  (null != a ? a.labelAnchor : void 0) &&
                    this.gMarker.set(
                      "labelAnchor",
                      this.getLabelPositionPoint(a.labelAnchor)
                    ),
                  this.gMarker.set("labelClass", a.labelClass || "labels"),
                  this.gMarker.set(
                    "labelStyle",
                    a.labelStyle || { opacity: 100 }
                  ),
                  this.gMarker.set(
                    "labelInBackground",
                    a.labelInBackground || !1
                  ),
                  a.labelVisible || this.gMarker.set("labelVisible", !0),
                  a.raiseOnDrag || this.gMarker.set("raiseOnDrag", !0),
                  a.clickable || this.gMarker.set("clickable", !0),
                  a.draggable || this.gMarker.set("draggable", !1),
                  a.optimized || this.gMarker.set("optimized", !1),
                  (a.crossImage =
                    null != (b = a.crossImage)
                      ? b
              ...
              (e.prototype.destroy = function () {
                return null != this.gMarkerLabel.labelDiv_.parentNode &&
                  null != this.gMarkerLabel.eventDiv_.parentNode
                  ? this.gMarkerLabel.onRemove()
                  : void 0;
              }),
              e
            );
          ...
          return (h = (function (b) {
            function h(b, c, d, f, g, i, j, k, l) {
              ...
              (this.model = b),
                ...
                (this.idKey = null != k ? k : "id"),
                (this.doDrawSelf = null != l ? l : !0),
                ...
                (this.needRedraw = !1),
                h.__super__.constructor.call(this, this.parentScope.$new(!1)),
                (this.scope.model = this.model),
                this.setMyScope(this.model, void 0, !0),
                this.createMarker(this.model),
                this.scope.$watch(
                  "model",
                  function (a, b) {
                    return a !== b
                      ? (m.setMyScope(a, b), (m.needRedraw = !0))
                      : void 0;
                  },
                  !0
                ),
            ...
            return (
              ...
              h.include(d),
              h.include(g),
              (h.prototype.setMyScope = function (a, b, c) {
                var d = this;
                return (
                  null == b && (b = void 0),
                  null == c && (c = !1),
                  ...
                  _.isFunction(this.clickKey) && f
                    ? (this.scope.click = function () {
                        return f.invoke(d.clickKey, void 0, {
                          $markerModel: a,
                        });
                      })
                    : (this.maybeSetScopeValue(
              ...
              (h.prototype.createMarker = function (a, b, c) {
                return (
                  ...
                  this.parentScope.options && !this.scope.options
                    ? e.error("Options not found on model!")
                    : void 0
                );
              }),
              (h.prototype.maybeSetScopeValue = function (a, b, c, d, e, f, g) {
                ...
                return (
                  ...
                  void 0 === c
                    ? ((this.scope[a] = e(b, d)),
                      void (f || (null != g && g(this.scope))))
                    : ((i = e(c, d)),
                      (h = e(b, d)),
                      h !== i &&
                      ((this.scope[a] = h),
                      !f && (null != g && g(this.scope), this.doDrawSelf))
                        ? this.gMarkerManager.draw()
                        : void 0)
                );
              }),
              (h.prototype.destroy = function () {
                return null == this.gMarker ||
                  (this.removeEvents(this.externalListeners),
                  this.removeEvents(this.internalListeners),
                  this.gMarkerManager.remove(this.gMarker, !0),
                  delete this.gMarker,
              ...
              (h.prototype.setCoords = function (a) {
                return a.$id === this.scope.$id && void 0 !== this.gMarker
                  ? null != a.coords
                    ? this.validateCoords(this.scope.coords)
                      ? (this.gMarker.setPosition(this.getCoords(a.coords)),
                        this.gMarker.setVisible(this.validateCoords(a.coords)),
              ...
              (h.prototype.setOptions = function (a) {
                ...
                if (
                  ...
                  null != (c = a.coords)
                    ? c
                    : "function" == typeof a.icon
                    ? a.icon(null != a.options)
                    : void 0)
                )
                  return (
                    ...
                    delete this.gMarker,
                    (this.gMarker = a.isLabel
                      ? new MarkerWithLabel(this.setLabelOptions(this.opts))
                      : new google.maps.Marker(this.opts)),
                    ...
                    null != this.id && (this.gMarker.key = this.id),
                    this.gMarkerManager.add(this.gMarker)
                  );
              }),
              (h.prototype.setLabelOptions = function (a) {
                return (
                  (a.labelAnchor = this.getLabelPositionPoint(a.labelAnchor)), a
                );
              }),
              (h.prototype.internalEvents = function () {
                ...
                return {
                  dragend: function (b, c, d, e) {
                    var f, g, h;
                    return (
                      (f = a.setCoordsFromEvent(
                        a.modelOrKey(a.scope.model, a.coordsKey),
                        a.gMarker.getPosition()
                      )),
                      (a.scope.model = a.setVal(d, a.coordsKey, f)),
                      null !=
                        (null != (g = a.parentScope.events)
                          ? g.dragend
                          : void 0) &&
                        null != (h = a.parentScope.events) &&
                        h.dragend(b, c, a.scope.model, e),
                      a.scope.$apply()
                    );
                  },
                  click: function () {
                    return a.doClick && null != a.scope.click
                      ? (a.scope.click(), a.scope.$apply())
                      : void 0;
                  },
                };
              }),
        ...
        return (i = (function (b) {
          function e(b, c, e, g, h) {
            ...
            (this.scope = b),
              ...
              b.$watch("path", function (a, c) {
                var d;
                return (_.isEqual(a, c) && i.polyline) ||
                  ((d = i.convertPathPoints(b.path)),
                  d.length > 0 &&
                    (i.polyline = new google.maps.Polyline(i.buildOpts(d))),
                  !i.polyline)
                  ? void 0
                  : (b.fit && i.extendMapBounds(e, d),
                    f(i.polyline.getPath(), b, "path", function (a) {
                      return b.fit ? i.extendMapBounds(e, a) : void 0;
                    }),
                    (i.listeners = i.model
                      ? i.setEvents(i.polyline, b, i.model)
                      : i.setEvents(i.polyline, b, b)));
              }),
              !b["static"] &&
                angular.isDefined(b.editable) &&
                b.$watch("editable", function (a, b) {
                  var c;
                  return a !== b && null != (c = i.polyline)
                    ? c.setEditable(a)
                    : void 0;
                }),
              angular.isDefined(b.draggable) &&
                b.$watch("draggable", function (a, b) {
                  var c;
                  return a !== b && null != (c = i.polyline)
                    ? c.setDraggable(a)
                    : void 0;
              ...
              angular.isDefined(b.geodesic) &&
                b.$watch("geodesic", function (a, b) {
                  var c;
                  return a !== b && null != (c = i.polyline)
                    ? c.setOptions(i.buildOpts(i.polyline.getPath()))
                    : void 0;
                }),
              angular.isDefined(b.stroke) &&
                angular.isDefined(b.stroke.weight) &&
                b.$watch("stroke.weight", function (a, b) {
                  var c;
                  return a !== b && null != (c = i.polyline)
                    ? c.setOptions(i.buildOpts(i.polyline.getPath()))
                    : void 0;
              ...
              angular.isDefined(b.stroke) &&
                ...
                b.$watch("stroke.color", function (a, b) {
                  var c;
                  return a !== b && null != (c = i.polyline)
                    ? c.setOptions(i.buildOpts(i.polyline.getPath()))
                    : void 0;
              ...
              angular.isDefined(b.stroke) &&
                ...
                b.$watch("stroke.opacity", function (a, b) {
                  var c;
                  return a !== b && null != (c = i.polyline)
                    ? c.setOptions(i.buildOpts(i.polyline.getPath()))
                    : void 0;
          ...
          return (
            ...
            e.include(g),
            e.include(h),
            (e.prototype.buildOpts = function (a) {
              var b,
                c = this;
              return (
                (b = angular.extend({}, this.defaults, {
                  map: this.map,
                  path: a,
                ...
                angular.forEach(
                  ...
                  function (a, d) {
                    return (b[d] =
                      angular.isUndefined(c.scope[d]) || null === c.scope[d]
                        ? a
                        : c.scope[d]);
                  }
                ),
                b["static"] && (b.editable = !1),
                b
              );
            }),
          ...
          return (i = (function (b) {
            function i(b, c, d, f, g, h, i, j, k) {
              ...
              (this.model = b),
                ...
                (this.watchShow = a(this.watchShow, this)),
                (this.getGWin = a(this.getGWin, this)),
                (this.createGWin = a(this.createGWin, this)),
                (this.watchElement = a(this.watchElement, this)),
                (this.googleMapsHandles = []),
                (this.$log = e),
                this.createGWin(),
                null != this.markerCtrl && this.markerCtrl.setClickable(!0),
                this.watchElement(),
                this.watchOptions(),
                this.watchShow(),
                this.watchCoords(),
            ...
            return (
              c(i, b),
              i.include(d),
              (i.prototype.watchElement = function () {
                var a = this;
                ...
                return (
                  ...
                  null == this.opts || this.gWin
                    ...
                    : ((this.gWin =
                      ...
                      this.gWin && this.handleClick(),
                      this.googleMapsHandles.push(
                        google.maps.event.addListener(
                          this.gWin,
                          "closeclick",
                          function () {
                            return (
                              c.markerCtrl &&
                                (c.markerCtrl.setAnimation(
                                  c.oldMarkerAnimation
                                ),
                                c.markerIsVisibleAfterWindowClose &&
                                  _.delay(function () {
                                    return (
                                      c.markerCtrl.setVisible(!1),
                                      c.markerCtrl.setVisible(
                                        c.markerIsVisibleAfterWindowClose
                                      )
                                    );
                                  }, 250)),
                              c.gWin.isOpen(!1),
                              null != c.scope.closeClick
                                ? c.scope.closeClick()
                                : void 0
                            );
                          }
              ...
              (i.prototype.watchCoords = function () {
                ...
                return (
                  (a =
                    null != this.markerCtrl ? this.scope.$parent : this.scope),
                  a.$watch(
                    "coords",
                    function (a, c) {
                      var d;
                      if (a !== c) {
                        ...
                        if (!b.validateCoords(a))
                          return void b.$log.error(
                            "WindowChildMarker cannot render marker as scope.coords as no position on marker: " +
                              JSON.stringify(b.model)
                          );
                        if (
                          ((d = b.getCoords(a)), b.gWin.setPosition(d), b.opts)
                        )
                          return (b.opts.position = d);
                      }
                    },
                    !0
                  )
              ...
              (i.prototype.watchOptions = function () {
                ...
                return (
                  ...
                  a.$watch(
                    "options",
                    function (a, c) {
                      return a !== c && ((b.opts = a), null != b.gWin)
                        ? b.gWin.setOptions(b.opts)
                        : void 0;
                    },
                    !0
                  )
              ...
              (i.prototype.handleClick = function (a) {
                ...
                return (
                  (b = function () {
                    var a;
                    return (
                      null == c.gWin && c.createGWin(),
                      (a = c.markerCtrl.getPosition()),
                      null != c.gWin &&
                        (c.gWin.setPosition(a),
                        c.opts && (c.opts.position = a),
                        c.showWindow()),
                      (c.initialMarkerVisibility = c.markerCtrl.getVisible()),
                      (c.oldMarkerAnimation = c.markerCtrl.getAnimation()),
                      c.markerCtrl.setVisible(c.isIconVisibleOnClick)
                    );
                  }),
                  null != this.markerCtrl
                    ? (a && b(),
                      this.googleMapsHandles.push(
                        google.maps.event.addListener(
                          this.markerCtrl,
              ...
              (i.prototype.showWindow = function () {
                ...
                return (
                  (b = function () {
                    return !d.gWin ||
                      (!d.scope.show && null != d.scope.show) ||
                      d.gWin.isOpen()
                      ? void 0
                      : d.gWin.open(d.mapCtrl);
                  }),
                  this.scope.templateUrl
                    ? this.gWin &&
                      g
                        .get(this.scope.templateUrl, { cache: h })
                        .then(function (a) {
                          var b, c;
                          return (
                            (c = d.scope.$new()),
                            angular.isDefined(d.scope.templateParameter) &&
                              (c.parameter = d.scope.templateParameter),
                            (b = f(a.data)(c)),
                            d.gWin.setContent(b[0])
                          );
                        })
                    : this.scope.template &&
                      this.gWin &&
              ...
              (i.prototype.showHide = function () {
                return this.scope.show || null == this.scope.show
                  ? this.showWindow()
                  : this.hideWindow();
              }),
              (i.prototype.getLatestPosition = function (a) {
                return null == this.gWin || null == this.markerCtrl || a
                  ? a
              ...
              (i.prototype.remove = function () {
                return (
                  this.hideWindow(),
                  _.each(this.googleMapsHandles, function (a) {
                    return google.maps.event.removeListener(a);
                  }),
                ...
                null == this.attrs.type
                  ...
                  : (this.createGoogleLayer(),
                    ...
                    this.scope.$watch(
                      ...
                      function (a, b) {
                        return a !== b
                          ? ((i.doShow = a), i.layer.setMap(a ? i.gMap : null))
                          : void 0;
                      },
                      !0
                    ),
                    ...
                    void this.scope.$on("$destroy", function () {
            ...
            return (
              ...
              (e.prototype.createGoogleLayer = function () {
                ...
                return (
                  ...
                  (a = this.onLayerCreated(this.scope, this.layer))
                    ? a(this.layer)
                    : void 0
                );
              }),
          ...
          return (e = (function (b) {
            ...
            return (
              ...
              (e.prototype.hideOverlay = function () {
                ...
                return (
                  (a = !1),
                  this.gMap.overlayMapTypes.forEach(function (c, d) {
                    a ||
                      c.layerId !== b.id ||
        ...
        function (b, d, e) {
          ...
          return (f = (function (b) {
            function f(b, c, d, e, g, h, i) {
              var j,
                k = this;
              (this.gMarkerManager = h),
                (this.doFit = i),
                (this.onDestroy = a(this.onDestroy, this)),
                (this.setGMarker = a(this.setGMarker, this)),
                (this.onWatch = a(this.onWatch, this)),
                f.__super__.constructor.call(this, b, c, d, e, g),
                (j = this.createMarkerOptions(
                  b.coords,
                  b.icon,
                  b.options,
                  this.map
                )),
                this.setGMarker(new google.maps.Marker(j)),
                (this.listener = google.maps.event.addListener(
                  this.scope.gMarker,
                  "click",
                  function () {
                    return k.doClick && null != b.click
                      ? k.scope.click()
                      : void 0;
                  }
                )),
                this.setEvents(this.scope.gMarker, b, b),
                this.$log.info(this);
            }
            return (
              c(f, b),
              ...
              (f.prototype.onWatch = function (a, b) {
                ...
                switch (a) {
                  case "coords":
                    if (
                      this.validateCoords(b.coords) &&
                      null != this.scope.gMarker
                    ) {
                      if (
                        ((d =
                          null != (e = this.scope.gMarker)
                            ? e.getPosition()
                            : void 0),
                        d.lat() === this.scope.coords.latitude &&
                          this.scope.coords.longitude === d.lng())
                      )
                        return;
                      return (
                        (c = this.scope.gMarker.getAnimation()),
                        this.scope.gMarker.setMap(this.map),
                        this.scope.gMarker.setPosition(
                          this.getCoords(b.coords)
                        ),
                        this.scope.gMarker.setVisible(
                          this.validateCoords(b.coords)
                        ),
                        this.scope.gMarker.setAnimation(c)
                      );
                    }
                  ...
                  case "icon":
                    if (
                      ...
                      return (
                        this.scope.gMarker.setIcon(b.icon),
                    ...
                    break;
                  case "options":
                    if (this.validateCoords(b.coords) && b.options)
                      return (
                        null != this.scope.gMarker &&
                          this.scope.gMarker.setMap(null),
                        this.setGMarker(
              ...
              (f.prototype.setGMarker = function (a) {
                ...
                return (
                  this.scope.gMarker &&
                    ((b = this.gMarkerManager.remove(this.scope.gMarker, !1)),
                    delete this.scope.gMarker),
                  (this.scope.gMarker = a),
                  this.scope.gMarker &&
                  ((this.scope.gMarker.key = this.scope.idKey),
                  this.gMarkerManager.add(this.scope.gMarker, !1),
                  this.doFit)
              ...
              (f.prototype.onDestroy = function () {
                var a;
                return this.scope.gMarker
                  ? (this.scope.gMarker.setMap(null),
                    google.maps.event.removeListener(this.listener),
                    (this.listener = null),
                    this.gMarkerManager.remove(this.scope.gMarker, !1),
                    delete this.scope.gMarker,
                    (a = void 0))
                  : void (a = void 0);
              }),
        ...
        function (b, d, e, f, g, h) {
          ...
          return (i = (function (b) {
            function i(b, c, d, f, g) {
              ...
              var h,
                j = this;
              i.__super__.constructor.call(this, b, c, d, f, g),
                (h = this),
                ...
                (this.doRebuildAll =
                  null != this.scope.doRebuildAll
                    ...
                    : !1),
                this.setIdKey(b),
                this.scope.$watch("doRebuildAll", function (a, b) {
            ...
            return (
              ...
              (i.prototype.validateScope = function (a) {
                ...
                return (
                  ...
                  i.__super__.validateScope.call(this, a) || b
                );
              }),
                  ...
                  a.doCluster
                    ? (a.clusterEvents &&
                      ...
                      a.clusterOptions || a.clusterEvents
                        ...
                        : (this.gMarkerManager = new g(this.map)))
              ...
              (i.prototype.reBuildMarkers = function (a) {
                return a.doRebuild || void 0 === a.doRebuild
                  ? (this.onDestroy(a), this.createMarkersFromScratch(a))
                  : void 0;
              }),
              (i.prototype.pieceMeal = function (a) {
                var b = this;
                return null != this.scope.models &&
                            ...
                            function (a) {
                              return null != a
                                ? (null != a.destroy && a.destroy(),
                                  b.scope.markerModels.remove(a.id))
                                : void 0;
                            },
                            function () {
                              return _async.each(
                                ...
                                function () {
                                  return _async.each(
                                    ...
                                    function () {
                                      return d.adds.length > 0 ||
                                        d.removals.length > 0 ||
                                        d.updates.length > 0
                                        ? (b.gMarkerManager.draw(),
                                          (a.markerModels =
                                            b.scope.markerModels))
                                        : void 0;
                                    }
                                  );
                                }
              ...
              (i.prototype.onDestroy = function () {
                return (
                  _.each(this.scope.markerModels.values(), function (a) {
          ...
          return (i = (function (b) {
            function e(b, c, f, h, i) {
              ...
              (this.scope = b),
                ...
                _.each(this.scopePropNames, function (a) {
            ...
            return (
              ...
              (e.prototype.setChildScope = function (a, b) {
                var c = this;
                return (
                  _.each(this.scopePropNames, function (d) {
                    var e, f;
                    return (
                      (e = d + "Key"),
                      (f = "self" === c[e] ? b : b[c[e]]),
          ...
          return (h = (function (b) {
            function h(b, c, d, f, i, j, k, l, m) {
              ...
              (this.$interpolate = m),
                ...
                h.__super__.constructor.call(this, b, c, d, f, i, j, k, l),
                (o = this),
                (this.windows = new e()),
                (this.scopePropNames = [
                  "show",
                ...
                (n = f[0].getScope()),
                n.deferred.promise.then(function (a) {
                  var c;
                  return (
                    (p.gMap = a),
                    (c = f.length > 1 && null != f[1] ? f[1] : void 0),
                    c
                      ? c.getScope().deferred.promise.then(function () {
            ...
            return (
                ...
                return (
                  ...
                  (this.doRebuildAll =
                    null != this.scope.doRebuildAll
                      ? this.scope.doRebuildAll
                      : !1),
                  a.$watch("doRebuildAll", function (a, c) {
                ...
                return _async.each(
                  ...
                  function () {
                    return (
                      c && delete d.windows,
                      (d.windows = new e()),
                      b ? d.createChildScopesWindows() : void 0
                    );
                  }
                );
              }),
              ...
              (h.prototype.createChildScopesWindows = function (a) {
                ...
                return (
                  ...
                  (b = this.markerScope),
                  (c = angular.isUndefined(this.linked.scope.models)),
                  !c ||
                  (void 0 !== b &&
                    void 0 !== b.markerModels &&
                    void 0 !== b.models)
                    ? null != this.gMap
                      ? null != this.linked.scope.models
                        ...
                        : ((this.parentScope = b),
                          ...
                          a
                            ...
                            : this.pieceMealWindows(b, !0, "markerModels", !1))
                      : void 0
                    : void this.$log.error(
                ...
                return (
                  ...
                  _async.each(
                    ...
                    function (d) {
                      var f;
                      return (
                        (f = b ? a[c][[d[e.idKey]]].gMarker : void 0),
                        e.createWindow(d, f, e.gMap)
                      );
                    },
                    function () {
                              ...
                              function () {
                                return _async.each(
                                  ...
                                  function (b) {
                                    var d;
                                    return (
                                      (d = a[c][b[e.idKey]].gMarker),
                                      e.createWindow(b, d, e.gMap)
                                    );
                                  },
                                  function () {}
                                );
              ...
              (h.prototype.createWindow = function (a, b, c) {
                ...
                return (
                  ...
                  e.$watch(
                    "model",
                    function (a, b) {
                      return a !== b && (i.setChildScope(e, a), i.markerScope)
                        ? (i.windows[a[i.idKey]].markerCtrl =
                            i.markerScope.markerModels[a[i.idKey]].gMarker)
                        : void 0;
                    },
                    !0
                  ),
    ...
    angular.module("google-maps.directives.api").factory("Control", [
      ...
      function (a, c, d, e, f) {
        ...
        return (g = (function (g) {
          ...
          return (
            b(h, g),
            (h.prototype.link = function (b, g, h, i) {
              var j,
                k,
                l = this;
              return angular.isUndefined(b.template)
                ? void this.$log.error(
                    "mapControl: could not find a valid template property"
                  )
                : ((j = angular.isDefined(b.index && !isNaN(parseInt(b.index)))
                    ? parseInt(b.index)
                    : void 0),
                  (k = angular.isDefined(b.position)
                    ? b.position.toUpperCase().replace(/-/g, "_")
                    : "TOP_CENTER"),
                  google.maps.ControlPosition[k]
                    ? a.mapPromise(b, i).then(function (a) {
                        var g, h;
                        return (
                          (g = void 0),
                          (h = angular.element("<div></div>")),
                          c
                            .get(b.template, { cache: d })
                            .success(function (a) {
                              var c, d;
                              return (
                                (d = b.$new()),
                                h.append(a),
                                j && (h[0].index = j),
                                angular.isDefined(b.controller) &&
                                  ((c = f(b.controller, { $scope: d })),
                                  h
                                    .children()
        ...
        return (g = (function (d) {
          function g() {
            return (
              ...
              (h = g.__super__.constructor.apply(this, arguments))
            );
          }
          return (
            c(g, d),
            g.include(e),
            (g.prototype.restrict = "EA"),
            (g.prototype.replace = !0),
            (g.prototype.require = "^googleMap"),
            (g.prototype.scope = { polygons: "=", draw: "=" }),
            (g.prototype.link = function (a, c, d, e) {
              return this.mapPromise(a, e).then(function (c) {
                var d, e;
                return a.polygons
                  ? _.isArray(a.polygons)
                    ? ((d = new f(c, a.originalMapOpts)),
                      (e = void 0),
                      (a.draw = function () {
                        return (
                          "function" == typeof e && e(),
      ...
      function (a, c, d, e) {
        ...
        return (f = (function (c) {
          ...
          return (
            ...
            f.include(a),
            f.extend(e),
            (f.prototype.restrict = "EA"),
            (f.prototype.replace = !0),
            (f.prototype.require = "^googleMap"),
            (f.prototype.scope = {
              path: "=",
              stroke: "=",
              clickable: "=",
  ...
  function () {
    ...
    angular.module("google-maps.directives.api").factory("Map", [
      ...
      function (b, d, e, f, g, h, i, j, k) {
        ...
        return (
          (l = e),
          (m = { mapTypeId: google.maps.MapTypeId.ROADMAP }),
          (n = (function (b) {
            function d() {
              this.link = a(this.link, this);
              var b, c;
            ...
            return (
              c(d, b),
              d.include(f),
              (d.prototype.restrict = "EMA"),
              (d.prototype.transclude = !0),
              (d.prototype.replace = !1),
              (d.prototype.template =
              ...
              (d.prototype.link = function (a, b, c) {
                ...
                if (
                  ((e = angular.element(b)),
                  e.addClass("angular-google-map"),
                  (i = { options: {} }),
                  c.options && (i.options = a.options),
                  c.styles && (i.styles = a.styles),
                  c.type &&
                    ((q = c.type.toUpperCase()),
                    google.maps.MapTypeId.hasOwnProperty(q)
                      ? (i.mapTypeId =
                          google.maps.MapTypeId[c.type.toUpperCase()])
                      : l.error(
                          'angular-google-maps: invalid map type "' +
                            c.type +
                            '"'
                        )),
                  (h = angular.extend({}, m, i, {
                    center: this.getCoords(a.center),
                    draggable:
                      null != c.draggable ? this.isTrue(a.draggable) : !0,
                    zoom: a.zoom,
                    bounds: a.bounds,
                  })),
                  (r = new google.maps.Map(e.find("div")[1], h)),
                  (r.nggmap_id = k.generate()),
                  (d = !1),
                  r
                    ? (a.deferred.resolve(r), n())
                    : google.maps.event.addListener(
                        r,
                        "tilesloaded ",
                        function (b) {
                  ...
                  google.maps.event.addListener(r, "drag", function () {
                    ...
                    return (
                      ...
                      _.defer(function () {
                        return a.$apply(function (a) {
                          return angular.isDefined(a.center.type)
                            ? ((a.center.coordinates[1] = b.lat()),
                              (a.center.coordinates[0] = b.lng()))
                            : ((a.center.latitude = b.lat()),
                              (a.center.longitude = b.lng()));
                        });
                      })
                    );
                  }),
                      ...
                      return (
                        ...
                        o
                          ...
                          : _.defer(function () {
                              return a.$apply(function (a) {
                                if (!r.dragging)
                                  if (angular.isDefined(a.center.type)) {
                                    if (
                                      (a.center.coordinates[1] !== b.lat() &&
                                        (a.center.coordinates[1] = b.lat()),
                                      a.center.coordinates[0] !== b.lng())
                                    )
                                      return (a.center.coordinates[0] =
                                        b.lng());
                                  } else if (
                                    (a.center.latitude !== b.lat() &&
                                      (a.center.latitude = b.lat()),
                                    ...
                                    return (a.center.longitude = b.lng());
                              });
                            })
                      );
                    }
                  ...
                  for (f in a.events)
                    a.events.hasOwnProperty(f) &&
                      angular.isFunction(a.events[f]) &&
                      google.maps.event.addListener(r, f, g(f));
                }
                return (
                    ...
                    ((a.control.refresh = function (a) {
                      ...
                      if (null != r)
                        return (
                          ...
                          null != (null != a ? a.latitude : void 0)
                            ? ((b = s.getCoords(a)),
                              s.isTrue(c.pan) ? r.panTo(b) : r.setCenter(b))
                            : void 0
                        );
                    }),
                  ...
                  a.$watch(
                    ...
                    function (b) {
                      ...
                      return (
                        (e = s.getCoords(b)),
                        e.lat() !== r.center.lat() || e.lng() !== r.center.lng()
                          ? ((o = !0),
                            d ||
                              (s.validateCoords(b) ||
                                l.error(
                    ...
                    if (a !== b)
                      return null == a.northeast.latitude ||
                        ...
                        : ((d = new google.maps.LatLng(
                          ...
                          (c = new google.maps.LatLngBounds(e, d)),
                          r.fitBounds(c));
                  }),
                  a.$watch(
                    "options",
                    function (a, b) {
                      return _.isEqual(a, b) || ((i.options = a), null == r)
                        ? void 0
                        : r.setOptions(i);
                    },
                    !0
                  ...
                  a.$watch(
                    "styles",
                    function (a, b) {
                      return _.isEqual(a, b) || ((i.styles = a), null == r)
                        ? void 0
                        : r.setOptions(i);
                    },
                    !0
            ...
            (g.prototype.link = function (a, c, f, g) {
              ...
              return (
                ...
                b.mapPromise(a, g).then(function (b) {
                  return (
                    i.gMarkerManager || (i.gMarkerManager = new e(b)),
                    new d(a, c, f, b, i.$timeout, i.gMarkerManager, h),
                    a.deferred.resolve(),
                    null != a.control
                      ? (a.control.getGMarkers = i.gMarkerManager.getGMarkers)
                      : void 0
                  );
                })
              );
          ...
          return (
            ...
            (f.prototype.link = function (a, c, e, f) {
              ...
              return b.mapPromise(a, f).then(function (b) {
                var f;
                return (
                  (f = new d(a, c, e, b, g.$timeout)),
                  a.deferred.resolve(),
                  null != a.control
                    ? ((a.control.getGMarkers = function () {
                        var a;
                        return null != (a = f.gMarkerManager)
                          ? a.getGMarkers()
                          : void 0;
                      }),
          ...
          return (
            ...
            (e.prototype.link = function (a, c, d, e) {
              ...
              return angular.isUndefined(a.path) ||
                ...
                : b.mapPromise(a, e).then(function (b) {
          ...
          return (
            ...
            (d.prototype.link = function (a, b, c, d) {
              ...
              return angular.isUndefined(a.path) || null === a.path
                ...
                : a.models
                ? d.getScope().deferred.promise.then(function (d) {
        ...
        return (f = (function (b) {
          function f(b, c, d, e) {
            (this.init = a(this.init, this)),
              (this.link = a(this.link, this)),
              f.__super__.constructor.call(this, b, c, d, e),
          ...
          return (
            ...
            (f.prototype.link = function (a, b, c, d) {
              ...
              return (
                (e = d[0].getScope()),
                e.deferred.promise.then(function (e) {
                  var g, h, i;
                  return (
                    (g = !0),
                    angular.isDefined(c.isiconvisibleonclick) &&
                      (g = a.isIconVisibleOnClick),
                    (h = d.length > 1 && null != d[1] ? d[1] : void 0)
                      ? ((i = h.getScope()),
            ...
            (f.prototype.init = function (a, b, c, d, f) {
              var g,
                ...
                l = this;
              return (
                (g = null != a.options ? a.options : {}),
                (i = null != a && this.validateCoords(a.coords)),
                null != f &&
                  ((h = f.gMarker),
                  f.$watch(
                    "coords",
                    function (a, b) {
                      return (
                        null == f.gMarker ||
                          k.markerCtrl ||
                          ((k.markerCtrl = h), k.handleClick(!0)),
                        l.validateCoords(a)
                          ? angular.equals(a, b)
                            ? void 0
                            : k.getLatestPosition(l.getCoords(a))
                          : k.hideWindow()
                      );
                    },
                    !0
                  )),
                (j = i ? this.createWindowOptions(h, a, b.html(), g) : g),
                null != d &&
                  ((k = new e({}, a, j, c, d, h, b)),
                  this.childWindows.push(k),
                  a.$on("$destroy", function () {
                    return (l.childWindows = _.withoutObjects(
                      l.childWindows,
                      [k],
                      function (a, b) {
                ...
                null != this.onChildCreation && null != k
                  ? this.onChildCreation(k)
                  : void 0
              );
            }),
            f
      ...
      function (b, d) {
        ...
        return (e = (function (b) {
          function e(b, c, d, f, g) {
            this.link = a(this.link, this);
            var h;
            e.__super__.constructor.call(this, b, c, d, f),
              (h = this),
              (this.$interpolate = g),
          ...
          return (
            ...
            (d.prototype.link = function (a, b, c, d) {
              ...
              return (
                (e = d.getScope()),
                e
                  ? e.deferred.promise.then(function () {
                      return f.init(e, a);
                    })
                  : void 0
              );
                  ...
                  return (
                    null != a.gMarker &&
                      ((i = new g(function () {
                        return (
                          c(),
                          b.labelContent && null != f
                            ? f.setOption("labelContent", b.labelContent)
                            : void 0
                        );
                      }, d)),
                      (e = new g(function () {
                        return (
                          c(),
                          null != f
                            ? f.setOption("labelAnchor", b.labelAnchor)
                            : void 0
                        );
                      }, d)),
                      (h = new g(function () {
                        return (
                          c(),
                          null != f
                            ? f.setOption("labelClass", b.labelClass)
                            : void 0
                        );
                      }, d)),
                      (j = new g(function () {
                        return (
                          c(),
                          null != f
                            ? f.setOption("labelStyle", b.labelStyle)
                            : void 0
                        );
                      }, d)),
                      b.$watch("labelContent", i.sic),
                      b.$watch("labelAnchor", e.sic),
                      b.$watch("labelClass", h.sic),
                      b.$watch("labelStyle", j.sic),
                      (d = !1)),
                    b.$on("$destroy", function () {
        ...
        return (
          ...
          (e = {}),
          {
            ...
            link: function (b, f, g, h) {
              return angular.isUndefined(b.path) ||
                null === b.path ||
                !d.validatePath(b.path)
                ? void a.error("polygon: no valid path attribute found")
                : h.getScope().deferred.promise.then(function (a) {
                    var f, g, h, i, j, k;
                    if (
                      ((g = function (c) {
                        var d;
                        return (
                          ...
                          angular.forEach(
                            ...
                            function (a, c) {
                              return (d[c] =
                                angular.isUndefined(b[c]) || null === b[c]
                                  ? a
                                  : b[c]);
                            }
                          ),
                          d["static"] && (d.editable = !1),
                          d
                        );
                      }),
                      (j = d.convertPathPoints(b.path)),
                      (k = new google.maps.Polygon(g(j))),
                      b.fit && d.extendMapBounds(a, j),
                      !b["static"] &&
                        angular.isDefined(b.editable) &&
                        b.$watch("editable", function (a, b) {
                      ...
                      angular.isDefined(b.geodesic) &&
                        b.$watch("geodesic", function (a, b) {
                          return a !== b
                            ? k.setOptions(g(k.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(b.stroke) &&
                        angular.isDefined(b.stroke.opacity) &&
                        b.$watch("stroke.opacity", function () {
                      ...
                      angular.isDefined(b.fill) &&
                        angular.isDefined(b.fill.color) &&
                        b.$watch("fill.color", function (a, b) {
                          return a !== b
                            ? k.setOptions(g(k.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(b.fill) &&
                        angular.isDefined(b.fill.opacity) &&
                        b.$watch("fill.opacity", function (a, b) {
                          return a !== b
                            ? k.setOptions(g(k.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(b.zIndex) &&
                        b.$watch("zIndex", function (a, b) {
                          return a !== b
                            ? k.setOptions(g(k.getPath()))
                            : void 0;
                        }),
                      angular.isDefined(b.events) &&
                        null !== b.events &&
                      ...
                      for (h in b.events)
                        b.events.hasOwnProperty(h) &&
                          angular.isFunction(b.events[h]) &&
                          k.addListener(h, i(h));
                    }
                    return (
                      (f = c(k.getPath(), b, "path", function (c) {
            ...
            link: function (f, g, h, i) {
              return i.getScope().deferred.promise.then(function (g) {
                ...
                return (
                  (h = function () {
                    var b;
                    return c.validateCoords(f.center)
                      ? ((b = angular.extend({}, e, {
                          map: g,
                        ...
                        angular.forEach(
                          ...
                          function (a, c) {
                            return (b[c] =
                              angular.isUndefined(f[c]) || null === f[c]
                                ? a
                                : f[c]);
                          }
                        ),
                        b)
                      : void a.error("circle: no valid center attribute found");
                  }),
                  (i = new google.maps.Circle(h())),
                  f.$watchCollection("center", function (a, b) {
                  ...
                  google.maps.event.addListener(
                    ...
                    function () {
                      return (
                        angular.isDefined(f.center.type)
                          ? ((f.center.coordinates[1] = i.getCenter().lat()),
                            (f.center.coordinates[0] = i.getCenter().lng()))
                          : ((f.center.latitude = i.getCenter().lat()),
                            (f.center.longitude = i.getCenter().lng())),
                        b(function () {
                          return f.$apply();
                        })
                      );
        ...
        return (
          ...
          (b = {}),
          {
            ...
            link: function (g, h, i, j) {
              return angular.isUndefined(g.bounds) ||
                null === g.bounds ||
                angular.isUndefined(g.bounds.sw) ||
                null === g.bounds.sw ||
                angular.isUndefined(g.bounds.ne) ||
                null === g.bounds.ne ||
                !f(g.bounds)
                ? void a.error("rectangle: no valid bound attribute found")
                : j.getScope().deferred.promise.then(function (f) {
                    var h, j, k, l;
                    return (
                      (h = function (a) {
                        var c;
                        return (
                          ...
                          angular.forEach(
                            ...
                            function (a, b) {
                              return (c[b] =
                                angular.isUndefined(g[b]) || null === g[b]
                                  ? a
                                  : g[b]);
                            }
                          ),
                      ...
                      (k = new google.maps.Rectangle(h(c(g.bounds)))),
                      e(i.fit) && d(f, bounds),
                      (j = !1),
                      google.maps.event.addListener(
                        k,
                      ...
                      angular.isDefined(g.editable) &&
                        g.$watch("editable", function (a) {
                          return k.setEditable(a);
                        }),
                      angular.isDefined(g.draggable) &&
                        g.$watch("draggable", function (a) {
                          return k.setDraggable(a);
                        }),
                      angular.isDefined(g.visible) &&
                        g.$watch("visible", function (a) {
                          return k.setVisible(a);
                        }),
                      angular.isDefined(g.stroke) &&
                        (angular.isDefined(g.stroke.color) &&
                          g.$watch("stroke.color", function () {
                            return k.setOptions(h(k.getBounds()));
                          }),
                        angular.isDefined(g.stroke.weight) &&
                          g.$watch("stroke.weight", function () {
                            return k.setOptions(h(k.getBounds()));
                          }),
                        angular.isDefined(g.stroke.opacity) &&
                          g.$watch("stroke.opacity", function () {
                            return k.setOptions(h(k.getBounds()));
                          })),
                      angular.isDefined(g.fill) &&
                        (angular.isDefined(g.fill.color) &&
                          g.$watch("fill.color", function () {
                            return k.setOptions(h(k.getBounds()));
                          }),
                        angular.isDefined(g.fill.opacity) &&
                          g.$watch("fill.opacity", function () {
                            return k.setOptions(h(k.getBounds()));
                          })),
  ...
  function () {
    ...
    (window.NgMapCluster = (function (a) {
        ...
        (c.prototype.addMarker = function (a) {
          ...
          return (
            ...
            null !== c && this.map_.getZoom() > c
              ...
              ? a.getMap() !== this.map_ && a.setMap(this.map_)
              : b === this.minClusterSize_
              ? this.markers_.values().forEach(function (a) {
                  a.setMap(null);
                })
              : a.setMap(null),
            !0
      ...
      (window.NgMapMarkerClusterer = (function (a) {
        function c(a, b, d) {
          c.__super__.constructor.call(this, a, b, d),
            (this.markers_ = new window.PropMap());
        }
        return (
          b(c, a),
          ...
          (c.prototype.resetViewport_ = function (a) {
            ...
            (this.clusters_ = []),
              this.markers_.values().forEach(function (b) {
