              ...
              (this.model = b),
                ...
                this.scope.$watch(
                  ...
                  (function (a) {
                    return function (b, c) {
                      return b !== c
                        ? (a.setMyScope(b, c), (a.needRedraw = !0))
                        : void 0;
                    };
                  })(this),
                  !0
              ...
              (h.prototype.setMyScope = function (a, b, c) {
                return (
                  ...
                  _.isFunction(this.clickKey) && f
                    ? (this.scope.click = (function (b) {
                        return function () {
                          return f.invoke(b.clickKey, void 0, {
                            $markerModel: a,
                          });
                        };
                      })(this))
            ...
            (this.scope = b),
              ...
              b.$watch(
                ...
                (function (a) {
                  return function (c, d) {
                    var g;
                    return (_.isEqual(c, d) && a.polyline) ||
                      ((g = a.convertPathPoints(b.path)),
                      null != a.polyline && a.clean(),
                      g.length > 0 &&
                        (a.polyline = new google.maps.Polyline(a.buildOpts(g))),
                      !a.polyline)
                      ? void 0
                      : (b.fit && a.extendMapBounds(e, g),
                        f(a.polyline.getPath(), b, "path", function (c) {
                          return b.fit ? a.extendMapBounds(e, c) : void 0;
                        }),
                        (a.listeners = a.model
                          ? a.setEvents(a.polyline, b, a.model)
                          : a.setEvents(a.polyline, b, b)));
                  };
                })(this)
              ),
              !b["static"] &&
              ...
              return (
                ...
                angular.forEach(
                  ...
                  (function (a) {
                    return function (c, d) {
                      return (b[d] =
                        angular.isUndefined(a.scope[d]) || null === a.scope[d]
                          ? c
                          : a.scope[d]);
                    };
                  })(this)
              ...
              (i.prototype.watchOptions = function () {
                ...
                return (
                  ...
                  a.$watch(
                    ...
                    (function (a) {
                      return function (b, c) {
                        return b !== c && ((a.opts = b), null != a.gWin)
                    ...
                    return function () {
                      ...
                      return (
                        ...
                        null != a.gWin &&
                          ...
                          a.showWindow()),
                        (a.initialMarkerVisibility = a.markerCtrl.getVisible()),
              ...
              (i.prototype.showWindow = function () {
                ...
                return (
                  (b = (function (a) {
                    return function () {
                      return !a.gWin ||
                        (!a.scope.show && null != a.scope.show) ||
                        a.gWin.isOpen()
                        ? void 0
                        : a.gWin.open(a.mapCtrl);
                    };
                  })(this)),
                ...
                n.deferred.promise.then(
                  (function (a) {
                    return function (c) {
                      ...
                      return (
                        (a.gMap = c),
                        (d = f.length > 1 && null != f[1] ? f[1] : void 0),
                        d
                          ? d.getScope().deferred.promise.then(function () {
                              return (a.markerScope = d.getScope()), a.go(b);
                            })
                          : void a.go(b)
                      );
                    };
                  ...
                  (function (a) {
                    return function () {
                      return (
                        c && delete a.windows,
                        (a.windows = new e()),
                        b ? a.createChildScopesWindows() : void 0
                      );
                    };
                  })(this)
                );
                  ...
                  _async.each(
                    ...
                    (function (d) {
                      return function (e) {
                        var f;
                        return (
                          (f = b ? a[c][[e[d.idKey]]].gMarker : void 0),
                                ...
                                function () {
                                  return _async.each(
                                    ...
                                    function (d) {
                                      var e;
                                      return (
                                        (e = a[c][d[b.idKey]].gMarker),
                                        b.createWindow(d, e, b.gMap)
                                      );
                                    },
                                    function () {}
                                  );
              ...
              (h.prototype.createWindow = function (a, b, c) {
                ...
                return (
                  ...
                  e.$watch(
                    ...
                    (function (a) {
                      return function (b, c) {
                        return b !== c && (a.setChildScope(e, b), a.markerScope)
                          ? (a.windows[b[a.idKey]].markerCtrl =
                              a.markerScope.markerModels[b[a.idKey]].gMarker)
                          : void 0;
                      };
                    })(this),
                    !0
          ...
          (n = (function (b) {
            ...
            return (
              ...
              (d.prototype.link = function (a, b, c) {
                var d, e, f, g, h, i, n, o, p, q, r;
                if (
                  ((p = j.spawn()),
                  (n = (function () {
                    return function () {
                      return p.deferred.resolve({
                        instance: p.instance,
                        map: r,
                      });
                    };
                      ...
                      return function (b) {
                        ...
                        if (null != r)
                          return (
                            ...
                            null != (null != b ? b.latitude : void 0) &&
                            null != (null != b ? b.latitude : void 0)
                              ? ((d = a.getCoords(b)),
                                a.isTrue(c.pan) ? r.panTo(d) : r.setCenter(d))
                              : void 0
                          );
                      };
                    })(this)),
        ...
        return (f = (function (f) {
          ...
          return (
            ...
            (g.prototype.controller = [
              ...
              "$element",
              function (a, c) {
                return (a.ctrlType = "Marker"), _.extend(g, b.handle(a, c));
              },
            ]),
            (g.prototype.link = function (a, c, f, g) {
              ...
              return (
                a.fit && (h = !0),
                b.mapPromise(a, g).then(
                  (function (b) {
                    return function (g) {
                      return (
                        b.gMarkerManager || (b.gMarkerManager = new e(g)),
                        new d(a, c, f, g, b.$timeout, b.gMarkerManager, h),
                        a.deferred.resolve(),
                        null != a.control
                          ? (a.control.getGMarkers =
                              b.gMarkerManager.getGMarkers)
                          : void 0
                      );
                    };
                  })(this)
        ...
        return (e = (function (e) {
          ...
          return (
            ...
            (f.prototype.link = function (a, c, e, f) {
              return b.mapPromise(a, f).then(
                (function (b) {
                  return function (f) {
                    var g;
                    return (
                      (g = new d(a, c, e, f, b.$timeout)),
                      a.deferred.resolve(),
                      null != a.control
              ...
              return (
                      ...
                      return function (b, c) {
                        return (
                          ...
                          a.validateCoords(b)
                            ? angular.equals(b, c)
                              ? void 0
                              : k.getLatestPosition(a.getCoords(b))
                            : k.hideWindow()
                        );
                      };
                    })(this),
                ...
                null != d &&
                  ...
                  a.$on(
                    ...
                    (function (a) {
                      return function () {
                        return (a.childWindows = _.withoutObjects(
                          a.childWindows,
                          [k],
                          function (a, b) {
          ...
          (e = {}),
          {
            ...
            link: function (b, f, g, h) {
              return angular.isUndefined(b.path) ||
                ...
                : h.getScope().deferred.promise.then(
                    (function () {
                      return function (a) {
                        var f, g, h, i, j, k;
                        if (
                        ...
                        return (
                          ...
                          b.$on("$destroy", function () {
                            return (
                              k.setMap(null), f ? (f(), (f = null)) : void 0
                            );
                          })
                        );
                      };
        ...
        return (
          (e = {}),
          {
            ...
            link: function (f, g, h, i) {
              return i.getScope().deferred.promise.then(
                (function () {
                  return function (g) {
                    var h, i;
                    return (
                      (h = function () {
                        ...
                        return c.validateCoords(f.center)
                          ? ((b = angular.extend({}, e, {
                            ...
                            b)
                          : void a.error(
                              "circle: no valid center attribute found"
                            );
                      }),
