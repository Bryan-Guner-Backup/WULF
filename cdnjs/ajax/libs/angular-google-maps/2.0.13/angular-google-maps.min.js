          ...
          function (c, d) {
            ...
            return (
              ...
              (f = function (a) {
                var b, c;
                return (
                  (b = _.map(a, function (a, b) {
                    return b + "=" + a;
                  })),
                  h && document.getElementById(h).remove(),
                  (b = b.join("&")),
                  (c = document.createElement("script")),
                  (c.id = h = "ui_gmap_map_load_" + d.generate()),
        ...
        [
          ...
          function (a, c) {
            ...
            return (
              ...
              (h = function (a) {
                return i(a, !1, ["false", "FALSE", 0, "n", "N", "no", "NO"]);
              }),
              (e = function (a) {
              ...
              }),
              {
                ...
                defaultDelay: 50,
                isTrue: function (a) {
                  return i(a, !0, ["true", "TRUE", 1, "y", "Y", "yes", "YES"]);
                },
                isFalse: h,
                isFalsy: function (a) {
                  return i(a, !1, [void 0, null]) || h(a);
                },
                getCoords: d,
                validateCoords: g,
              ...
              return (
                ...
                (e.prototype.evalModelHandle = function (a, b) {
                  return null != a && null != b
                    ? "self" === b
                      ? a
                      : (_.isFunction(b) && (b = b()), c.getPath(a, b))
                    : void 0;
                }),
                (e.prototype.modelKeyComparison = function (a, b) {
                  var d, e, f;
                  if (
                    ((d = _.contains(this["interface"].scopeKeys, "coords")),
                    ((d && null != this.scope.coords) || !d) &&
                      (f = this.scope),
                    null == f)
                  )
                    throw "No scope set!";
                  return d &&
                    ((e = c.equalCoords(
                      this.evalModelHandle(a, f.coords),
                      this.evalModelHandle(b, f.coords)
                    )),
                    !e)
                    ? e
                    : (e = _.every(
                        ...
                        (function (c) {
                          return function (d) {
                            return (
                              c.evalModelHandle(a, f[d]) ===
                              c.evalModelHandle(b, f[d])
                            );
                          };
                        })(this)
                      ));
                ...
                (e.prototype.updateChild = function (a, b) {
                  ...
                  (this.scope = c),
                    ...
                    (k = (function (a) {
                      return function () {
                        ...
                        if (!a.isDragging)
                          return (
                            (d = a.convertPathPoints(a.scope.path)),
                            null != a.gObject && a.clean(),
                            d.length > 0 && (a.gObject = e(a.buildOpts(d))),
                            a.gObject
                              ? (a.scope.fit && a.extendMapBounds(g, d),
                                f(
                                  a.gObject.getPath(),
                                  a.scope,
                                  "path",
              ...
              return (
                ...
                (l.prototype.renderGMarker = function (a, b) {
                  ...
                  if (
                    ...
                    if ((null != b && b(), a && this.gObject))
                      return this.gManager.add(this.gObject);
                  } else if (a && this.gObject)
                ...
                l.doDrawSelf && doDraw && l.gManager.draw(),
                          ...
                          (function (a) {
                            return function () {
                              ...
                              return (
                                ...
                                b.lng() !== d.lng() ||
                                b.lat() !== d.lat()
                                  ? (a.gObject.setPosition(b),
                                    a.gObject.setVisible(a.validateCoords(c)))
                                  : void 0
                              );
                            };
                          })(this)
                              ...
                              return (
                                ...
                                d !== c
                                  ? (a.gObject.setIcon(c),
                                    ...
                                    a.gObject.setPosition(a.getCoords(b)),
                                    a.gObject.setVisible(a.validateCoords(b)))
                                  : void 0
                              );
                            };
                          })(this)
                  ...
                  if ((null == b && (b = !0), !this.isNotValid(a, !1))) {
                    if (
                        ...
                        (function (a) {
                          return function () {
                            ...
                            return (
                              ...
                              a.isLabel(a.gObject) !== a.isLabel(a.opts) &&
                                null != a.gObject &&
                                (a.gManager.remove(a.gObject),
                                (a.gObject = void 0)),
                              null != a.gObject &&
                                a.gObject.setOptions(a.setLabelOptions(a.opts)),
                              a.gObject ||
                                ((a.gObject = a.isLabel(a.opts)
                                  ? new MarkerWithLabel(
                                      a.setLabelOptions(a.opts)
                                    )
                                  : new google.maps.Marker(a.opts)),
                                _.extend(a.gObject, { model: a.model })),
                              a.externalListeners &&
                                a.removeEvents(a.externalListeners),
                              a.internalListeners &&
                                a.removeEvents(a.internalListeners),
                              ...
                              null != a.id ? (a.gObject.key = a.id) : void 0
                            );
                          };
                        })(this)
                      ),
                      ...
                      ((null != (c = this.gObject) ? c.getMap() : 0) &&
                        this.gManager.type === j.type) ||
                        (e.debug("gObject has no map yet"),
                        this.deferred.resolve(this.gObject));
                    }
            ...
            return (m = (function (d) {
              ...
              return (
                ...
                (m.prototype.updateModel = function (a) {
                  return (
                    (this.clonedModel = _.extend({}, a)),
                    _.extend(this.model, this.clonedModel)
                  );
                }),
                m
              );
            ...
            return (h = (function (d) {
              function g(c, d, f, g, h) {
                ...
                (this.scope = c),
                  ...
                  this.watchProps(),
                  i(),
                  (this.listeners = this.setEvents(j, c, c, [
                    "radius_changed",
                  ])),
                  null != this.listeners &&
                    this.listeners.push(
                        ...
                        function () {
                          return c.$evalAsync(function () {
                            return b.isDefined(c.center.type)
                              ? ((c.center.coordinates[1] = j
                                  .getCenter()
                                  .lat()),
                                (c.center.coordinates[0] = j.getCenter().lng()))
                              : ((c.center.latitude = j.getCenter().lat()),
                                (c.center.longitude = j.getCenter().lng()));
                          });
                        }
                      )
                    ),
                      ...
                      this.scope.$watch(
                        ...
                        (function (a) {
                          return function (b, c) {
                            return b !== c
                              ? ((a.doShow = b),
                                a.gObject.setMap(b ? a.gMap : null))
                              : void 0;
                          };
                        })(this),
                        !0
                    ...
                    a.doCluster
                      ? (a.clusterEvents &&
                          ...
                          this.origClusterEvents
                            ? b.extend(a.clusterEvents, this.origClusterEvents)
                            : (this.origClusterEvents = {
                                click:
                                ...
                                mouseout:
                                  null != (f = a.clusterEvents)
                                    ...
                                    : void 0,
                                mouseover:
                                  null != (g = a.clusterEvents)
                                    ? g.mouseover
                                    : void 0,
                              }),
                          b.extend(a.clusterEvents, {
                            click: function (a) {
                              return d.maybeExecMappedEvent(a, "click");
                            },
                            mouseout: function (a) {
                              return d.maybeExecMappedEvent(a, "mouseout");
                            },
                            mouseover: function (a) {
                              return d.maybeExecMappedEvent(a, "mouseover");
                            },
                          })),
                        (this.gManager = new i(
                          this.map,
                    ...
                    (function (a) {
                      return function () {
                        return h
                          ...
                          .then(function () {
                            return (
                              delete a.scope.plurals,
                              null != a.gManager && a.gManager.clear(),
                              (a.scope.plurals = new f()),
            ...
            return (m = (function (c) {
              ...
              return (
                      ...
                      return function () {
                        return j
                          .each(
                            ...
                            j.chunkSizeFrom(b.scope.cleanchunk, !1)
                          )
                          .then(function () {
                ...
                (f.prototype.createChild = function (a, b) {
                  ...
                  return (
                    (d = this.scope.$new(!1)),
                    this.setChildScope(l.scopeKeys, d, a),
                    d.$watch(
                      "model",
                      (function (a) {
                        return function (b, c) {
            ...
            return (f = (function (e) {
              function f(b, c, d, e, f) {
                ...
                (this.scope = b),
                    ...
                    return function () {
                      ...
                      return null != b.bounds &&
                        ...
                        ? ((g = c.convertBoundPoints(b.bounds)),
                          a.info("new new bounds created: " + rectangle))
                  ...
                  a.info("gObject (rectangle) created: " + l),
                  (p = !1),
                  (q = (function () {
                    return function () {
                      var a, c, d;
                ...
                return (
                  ...
                  null == this.attrs.template
                    ...
                    : (b.isUndefined(this.scope.options) &&
                      ...
                      (this.autocomplete = c.options.autocomplete),
                      (k = b.element("<div></div>")),
              ...
              return (
                ...
                (g.prototype.init = function () {
                  return (
                    ...
                    (this.listener = this.autocomplete
                      ? google.maps.event.addListener(
                          this.gObject,
                          "place_changed",
                          (function (a) {
                ...
                (g.prototype.createSearchBox = function () {
                  return (this.gObject = this.autocomplete
    ...
    function () {
      ...
      b.module("uiGmapgoogle-maps.directives.api.models.parent").factory(
        ...
        [
          ...
          "uiGmapIWindow",
          "uiGmapGmapUtil",
          function (c, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
            var s;
            return (s = (function (c) {
                      ...
                      return function () {
                        return i
                          .each(
                            ...
                            i.chunkSizeFrom(b.scope.cleanchunk, !1)
                          )
                          .then(function () {
                            return a && delete b.plurals, (b.plurals = new f());
                          });
                      };
                    })(this)
                  );
                          ...
                          (function (i) {
                            return function (j) {
                              ...
                              if (
                                ...
                                f.type &&
                                  ((A = f.type.toUpperCase()),
                                  google.maps.MapTypeId.hasOwnProperty(A)
                                    ? (w.mapTypeId =
                                ...
                                (D = new google.maps.Map(p.find("div")[1], u)),
                                (D.uiGmap_id = l.generate()),
                                (o = !1),
                                h.push(
                                  ...
                                  (B = function (c, d) {
                                    if (
                                      ...
                                      if (b.isDefined(d.center.type)) {
                                        ...
                                        return (d.center.longitude = c.lng());
                                  }),
                                  (y = !1),
                                  v("idle", function () {
                                    var b, d, e;
                                ...
                                for (s in a.events)
                                  a.events.hasOwnProperty(s) &&
                                    ...
                                    m.push(
                                      google.maps.event.addListener(D, s, t(s))
                                    );
                                h.concat(m);
                              }
                              return (
                                ...
                                a.$watch("bounds", function (a, b) {
                                  ...
                                  if (a !== b)
                                    return null ==
                                      (null != a && null != (f = a.northeast)
                                        ? f.latitude
                                        : void 0) ||
                                      null ==
                                        (null != a && null != (h = a.northeast)
                                          ? h.longitude
                                          : void 0) ||
                                      null ==
        ...
        function (a, b, d, e, f) {
          ...
          return (g = (function (e) {
            ...
            return (
              ...
              (g.prototype.link = function (c, e, f, g) {
                var h, i;
                return (
                  (h = void 0),
                  (i = function () {
                  ...
                  a.mapPromise(c, g).then(function (a) {
                    var j;
                    return (
                      (j = g.getScope()),
                      ...
                      b.link(c, h),
                      null != c.control &&
                        ((c.control.getGMarkers = function () {
                          var a;
                          return null != (a = h.gManager)
                            ? a.getGMarkers()
                            : void 0;
                        }),
                        (c.control.getChildMarkers = function () {
                          return h.plurals;
                        })),
        ...
        function (b, c, e, f, g) {
          ...
          return (h = (function (b) {
            ...
            return (
              ...
              (h.prototype.init = function (a, b, d, f, g, h) {
                var i;
                return (
                  (i = new e(a, b, d, f, g, h)),
                  c.link(a, i),
