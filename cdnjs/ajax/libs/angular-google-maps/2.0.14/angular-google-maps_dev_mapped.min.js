        ...
        .service("uiGmap_async", [
          ...
          function (a, c, d, e, f, g) {
            ...
            return (
              ...
              (m = function (a, b) {
                return a.promiseType === w.create &&
                  b.promiseType !== w["delete"] &&
                  b.promiseType !== w.init
                  ? (d.debug(
              ...
              (u = function (a, b, c) {
                var e;
                return b.promiseType === w["delete"] &&
                  c.promiseType !== w["delete"] &&
                  null != c.cancelCb &&
              ...
              (i = function (a, b, c) {
                var d, e;
                if (a.existingPieces) {
                  if (((d = _.last(a.existingPieces._content)), m(b, d)))
                    return;
                  return (
                    u(a.existingPieces, b, d),
                    (e = h(
                      d["finally"](function () {
                        return q(b, c);
                      })
                ...
                return (
                  ...
                  a.existingPieces.enqueue(q(b, c))
                );
              }),
              ...
              (r = function (a, b, c, e) {
                ...
                return (
                  (g = x(a, b, e)),
                  g === o &&
                    ((f = "error within chunking iterator: " + o.value),
                    d.error(f),
                    c.reject(f)),
                  "cancel safe" === g ? !1 : !0
                );
              ...
              (y = function (a, c, d, e) {
                ...
                return (
                  b.isArray(a)
                    ? (f = a)
                    : ((f = c ? c : Object.keys(_.omit(a, "length"))), (c = f)),
                  null == e && (e = d),
                  b.isArray(f) &&
                  (void 0 === f || (null != f ? f.length : void 0) <= 0) &&
                  e !== d
                    ? d()
                    : e(f, c)
                );
              }),
              (l = function (b, c, d, e, f, g, h, i) {
                return y(b, i, function (i, j) {
                  var k, m, n;
                  for (
                    k = c && c < i.length ? c : i.length, m = h, n = !0;
                    n && k-- && m < (i ? i.length : m + 1);

                  )
                    (n = r(e, void 0, g, [z(b, i, m), m])), ++m;
                  if (i) {
                    if (!(n && m < i.length)) return g.resolve();
                    if (((h = m), c))
                      return (
                        null != f && _.isFunction(f) && r(f, void 0, g, []),
                        a(
                          function () {
                            return l(b, c, d, e, f, g, h, j);
                          },
                          d,
                          !1
                        )
            ...
            return (f = (function (c) {
              ...
              return (
                ...
                (f.prototype.modelKeyComparison = function (a, b) {
                  var c, d, f;
                  if (
                    ((c = _.contains(this["interface"].scopeKeys, "coords")),
                    ((c && null != this.scope.coords) || !c) &&
                      (f = this.scope),
                    null == f)
                  )
                    throw "No scope set!";
                ...
                (f.prototype.modelsLength = function () {
                  var a;
                  return (
                    (a = 0),
                    null == this.scope.models
                      ? a
                      : (a =
                          b.isArray(this.scope.models) ||
                          null != this.scope.models.length
                            ? this.scope.models.length
                            : Object.keys(this.scope.models).length)
                  );
                }),
                f
              );
            ...
            return (b = (function (a) {
              ...
              return (
                ...
                (b.prototype.buildOpts = function (a, c) {
                  return b.__super__.buildOpts.call(this, { path: a }, c, {
                    geodesic: !1,
                  });
                }),
                b
          ...
          function (a) {
            ...
            return (b = (function (a) {
              ...
              return (
                c(b, a),
                (b.prototype.buildOpts = function (a, c) {
                  return b.__super__.buildOpts.call(this, { bounds: a }, c);
                }),
                b
              );
            })(a));
        ...
        .factory("uiGmapCircleOptionsBuilder", [
          ...
          function (a) {
            ...
            return (b = (function (a) {
              ...
              return (
                c(b, a),
                (b.prototype.buildOpts = function (a, c, d) {
                  ...
                  (this.scope = c),
                    ...
                    (k = (function (a) {
                      return function () {
                        ...
                        if (!a.isDragging)
                          return (
                            (i = a.convertPathPoints(a.scope.path)),
                            null != a.gObject && a.clean(),
                            null != c.model && (d = c),
                            i.length > 0 && (a.gObject = e(a.buildOpts(i, d))),
                            a.gObject
                              ? (a.scope.fit && a.extendMapBounds(g, i),
                                f(
                                  a.gObject.getPath(),
                                  a.scope,
                                  "path",
          ...
          function (c, e, f, g, h, i, j, k, l) {
            ...
            return (m = (function (c) {
              ...
              return (
                ...
                (f.prototype.onDestroy = function () {
                  return (
                    f.__super__.onDestroy.call(this, this.scope),
                    j.promiseLock(
                      this,
                        ...
                        return function () {
                          return j
                            .each(
                              ...
                              j.chunkSizeFrom(a.scope.cleanchunk, !1)
                            )
                            .then(function () {
                              var b;
                      ...
                      return null != b.bounds &&
                        ...
                        ? a.error(
                            "Invalid bounds for newValue: " +
                              JSON.stringify(null != b ? b.bounds : void 0)
                          )
                        : void 0;
                    };
                  })(this)),
