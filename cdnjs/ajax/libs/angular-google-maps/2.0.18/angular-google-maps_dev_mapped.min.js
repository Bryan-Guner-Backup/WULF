        ...
        .service("uiGmap_async", [
          ...
          function (a, c, d, e, f, g) {
            ...
            return (
              ...
              (o = function (a, b) {
                return a.promiseType === y.create &&
                  b.promiseType !== y["delete"] &&
                  b.promiseType !== y.init
                  ? (d.debug(
              ...
              (w = function (a, b, c) {
                var e;
                return b.promiseType === y["delete"] &&
                  c.promiseType !== y["delete"] &&
                  null != c.cancelCb &&
              ...
              (i = function (a, b, c) {
                ...
                return (
                  ...
                  a.existingPieces.enqueue(s(b, c))
                );
              }),
              ...
              (n = function (c, d, e, f, g, h, i, j) {
                return k(c, j, function (j, k) {
                  ...
                  for (
                    ...
                    (q = l(c, j, o)),
                      (p = b.isFunction(q) ? !0 : t(f, void 0, h, [q, o])),
                      ++o;
                  if (j) {
                    if (!(p && o < j.length)) return h.resolve();
                    if (((i = o), d))
                      return (
                        null != g && _.isFunction(g) && t(g, void 0, h, []),
                        a(
                          function () {
                  ...
                  if (b.isDefined(a) && null != a && b.isObject(a)) {
                    ...
                    for (f in a)
                      (e = a[f]),
                        a.hasOwnProperty(f) && b.isFunction(a[f])
                          ? (c.info(
                              d + ": Clearing event: " + f + " to clusterer"
                            ),
                            g.push(
                      ...
                      return function () {
                        ...
                        if (!a.isDragging)
                          return (
                            ...
                            d.length > 0 && (a.gObject = e(a.buildOpts(d, c))),
                            a.gObject
                              ? (a.scope.fit && a.extendMapBounds(map, d),
                                f(
                                  a.gObject.getPath(),
                                  a.scope,
                                  "path",
                  ...
                  (f = (function (b) {
                    return function () {
                      return (
                        ...
                        (b.oldOptions = map.getOptions()),
                        (b.oldOptions.center = map.getCenter()),
                        b.map.setOptions({
                          draggable: !1,
                          zoomControl: !1,
                          scrollwheel: !1,
                      ...
                      (this.renderGMarker(
                        ...
                        (function (a) {
                          return function () {
                            ...
                            return (
                              (c = a.getProp(a.coordsKey, a.model)),
                              (d = a.getProp(a.iconKey, a.model)),
                              (b = a.getProp(a.optionsKey, a.model)),
                              (a.opts = a.createOptions(c, d, b)),
                ...
                return (
                  ...
                  (m.prototype.createChild = function (a, b) {
                    ...
                    return (
                      ...
                      (c = new k(e, this.attrs, b, this.defaults, a)),
                      null == a[this.idKey]
                        ? void this.$log.error(
                            l +
            ...
            return (h = (function (d) {
              function g(a, d, f, g, h) {
                ...
                (this.attrs = f),
                  ...
                  this.watchProps(),
                  i(),
                  (this.listeners = this.setEvents(j, a, a, [
                    "radius_changed",
                  ])),
                  null != this.listeners &&
                    this.listeners.push(
                        ...
                        function () {
                          return a.$evalAsync(function () {
                            return b.isDefined(a.center.type)
                              ? ((a.center.coordinates[1] = j
                                  .getCenter()
                                  .lat()),
                                (a.center.coordinates[0] = j.getCenter().lng()))
                              : ((a.center.latitude = j.getCenter().lat()),
                                (a.center.longitude = j.getCenter().lng()));
                          });
                        }
                      )
                    ),
      ...
      b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapControl", [
        ...
        function (d, e, f, g, h, i) {
          ...
          return (j = (function (j) {
            ...
            return (
              c(k, j),
              (k.prototype.link = function (a, c, j, k) {
                return i.then(
                  (function (c) {
                    return function (i) {
                      var j, l;
                          ...
                          (function (i) {
                            return function (j) {
                              ...
                              if (
                                ...
                                (x = { options: {} }),
                                f.options && (x.options = a.options),
                                f.styles && (x.styles = a.styles),
                                f.type &&
                                  ((C = f.type.toUpperCase()),
                                ...
                                (m = new google.maps.Map(s.find("div")[1], v)),
                                ...
                                for (t in a.events)
                                  a.events.hasOwnProperty(t) &&
                                    ...
                                    n.push(
                                      google.maps.event.addListener(m, t, u(t))
                                    );
                                h.concat(n);
                              }
                              return (
