                ...
                return (
                  ...
                  a.InfoBox &&
                    ...
                    (b = (function (b) {
                      ...
                      return (
                        e(d, b),
                        (d.prototype.getCloseBoxDiv_ = function () {
                          return this.closeBoxDiv_;
                        }),
                        (d.prototype.getCloseBoxImg_ = function () {
                          var a, b;
                          return (
                        ...
                        (d.prototype.getOrigCloseBoxImg_ = function () {
                          var a;
                          return (
                            (a = ""),
                            "" !== this.closeBoxURL_ &&
            ...
            return (e = (function (b) {
              ...
              return (
                ...
                (e.prototype.modelKeyComparison = function (a, b) {
                  ...
                  return d &&
                    ((e = c.equalCoords(
                      this.scopeOrModelVal("coords", f, a),
                      this.scopeOrModelVal("coords", f, b)
                    )),
                    !e)
                    ? e
                    : (e = _.every(
                        ...
                        (function (c) {
                          return function (d) {
                            return (
                              c.scopeOrModelVal(f[d], f, a) ===
                              c.scopeOrModelVal(f[d], f, b)
                            );
                          };
                        })(this)
                      ));
                ...
                (e.prototype.getProp = function (a, b, c) {
            ...
            return (l = (function (b) {
              ...
              return (
                ...
                (l.prototype.renderGMarker = function (a, b) {
                  ...
                  if (
                    (null == a && (a = !0),
                    (c = this.getProp("coords", this.scope, this.model)),
                    null != c)
                  ) {
                        ...
                        (function (b) {
                          return function () {
                            ...
                            return (
                              (c = b.getProp("coords", a, b.model)),
                              (d = b.getProp("icon", a, b.model)),
                              (e = b.getProp("options", a, b.model)),
                              (b.opts = b.createOptions(c, d, e)),
                              ...
                              b.gObject ||
                                ((b.gObject = b.isLabel(b.opts)
                                  ? new MarkerWithLabel(
                                      b.setLabelOptions(b.opts)
                                    )
                                  : new google.maps.Marker(b.opts)),
                  ...
                  return {
                    ...
                    click: (function (a) {
                      return function (b, c, d, e) {
                        var f;
                        return (
                          (f = a.getProp("click", a.scope, a.model)),
                          a.doClick && null != f
                      ...
                      return (
                        ...
                        (a = function () {
                          return (
                            e.removeEvents(m),
                            null != o &&
                              (o.unbind("position"), o.setVisible(!1)),
                            null != q
                              ? (null != (null != q ? q.setVisible : void 0) &&
                                  q.setVisible(!1),
                                (q = void 0))
                              : void 0
                          );
                        ...
                        (i = function () {
                          ...
                          return g.focalcoord
                            ? g.radius
                              ? (a(),
                                null == q &&
                                  (q = new google.maps.StreetViewService()),
                                g.events && (m = e.setEvents(q, g, g)),
                                (b = d.getCoords(g.focalcoord)),
                                q.getPanoramaByLocation(
                                  b,
                                  g.radius,
                                  function (a, c) {
                                    var d, e, f;
