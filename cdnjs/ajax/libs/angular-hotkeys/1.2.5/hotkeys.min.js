  ...
  angular
    ...
    .provider("hotkeys", function () {
      (this.includeCheatSheet = !0),
        (this.template =
          '<div class="cfp-hotkeys-container fade" ng-class="{in: helpVisible}"><div class="cfp-hotkeys"><h4 class="cfp-hotkeys-title">{{ title }}</h4><table><tbody><tr ng-repeat="hotkey in hotkeys | filter:{ description: \'!$$undefined$$\' }"><td class="cfp-hotkeys-keys"><span ng-repeat="key in hotkey.format() track by $index" class="cfp-hotkeys-key">{{ key }}</span></td><td class="cfp-hotkeys-text">{{ hotkey.description }}</td></tr></tbody></table><div class="cfp-hotkeys-close" ng-click="helpVisible = false">×</div></div></div>'),
        (this.$get = [
          "$rootElement",
          "$rootScope",
          "$compile",
          ...
          function (a, b, c, d, e) {
            ...
            function i() {
              (n.helpVisible = !n.helpVisible),
                n.helpVisible
                  ? ((r = l("esc")), k("esc"), j("esc", r.description, i))
                  : (k("esc"), r !== !1 && j(r));
            }
            function j(a, b, c, d, e) {
              a instanceof Object &&
                ...
                void 0 === e && (e = !0),
                "string" == typeof d
                  ? Mousetrap.bind(a, m(c), d)
                  : Mousetrap.bind(a, m(c)),
                n.hotkeys.push(new g(a, b, c, d, e));
            }
            function k(a) {
              var b = a instanceof g ? a.combo : a;
              Mousetrap.unbind(b);
              for (var c = 0; c < n.hotkeys.length; c++)
                n.hotkeys[c].combo === b && n.hotkeys.splice(c, 1);
            }
            function l(a) {
              for (var b = 0; b < n.hotkeys.length; b++)
                if (n.hotkeys[b].combo === a) return n.hotkeys[b];
              return !1;
            }
            function m(a) {
              return function (c, d) {
            ...
            g.prototype.format = function () {
              for (var a = this.combo.split(/[\s]/), b = 0; b < a.length; b++)
                a[b] = f(a[b]);
              return a;
            };
            var n = b.$new();
            if (
              ...
              var o = e[0],
                p = a[0],
                q = angular.element(this.template);
              j("?", "Show / hide this help menu", i),
                (p === o || p === o.documentElement) && (p = o.body),
                angular.element(p).append(c(q)(n));
            }
            var r = !1,
              s = {
                add: j,
        ...
        return {
          ...
          link: function (b, c, d) {
            ...
            angular.forEach(b.$eval(d.hotkey), function (b, c) {
              (e = c), a.add(c, d.hotkeyDescription, b, d.hotkeyAction);
            }),
