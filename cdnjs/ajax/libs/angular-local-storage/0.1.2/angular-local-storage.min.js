      ...
      (this.$get = [
        ...
        function (a, b, l, m) {
          ...
          var t = function (a) {
            ...
            v = function (b, c) {
              if (
                (e(c) ? (c = null) : (g(c) || h(c) || f(+c || c)) && (c = j(c)),
            ...
            A = function () {
              try {
                return (
                  ...
                  ("cookie" in l &&
                    (l.cookie.length > 0 ||
                      (l.cookie = "test").indexOf.call(l.cookie, "test") > -1))
                );
              } catch (b) {
                return (
                  a.$broadcast(
            ...
            B = function (b, c) {
              ...
              try {
                ...
                if (
                  (null === c
                    ? (f.setTime(f.getTime() + -864e5),
                      (d = "; expires=" + f.toGMTString()),
                      (c = ""))
                    : 0 !== q.expiry &&
                      (f.setTime(f.getTime() + 24 * q.expiry * 60 * 60 * 1e3),
                      (d = "; expires=" + f.toGMTString())),
                  b)
                ) {
                  var k = "; path=" + q.path;
                  q.domain && (i = "; domain=" + q.domain),
                    (l.cookie = t(b) + "=" + encodeURIComponent(c) + d + k + i);
                }
              } catch (m) {
                return (
                  a.$broadcast(
            ...
            C = function (b) {
              ...
              for (
                var c = (l.cookie && l.cookie.split(";")) || [], d = 0;
                d < c.length;
                d++
              ) {
            ...
            E = function () {
              for (
                var a = null, b = p.length, c = l.cookie.split(";"), d = 0;
                d < c.length;
                d++
              ) {
            ...
            G = function (a, b, c, e) {
              ...
              var f = w(e);
              return (
                null === f && d(c) ? (f = c) : g(f) && g(c) && (f = i(c, f)),
                m(b).assign(a, f),
                a.$watchCollection(b, function (a) {
                  v(e, a);
                })
              );
            },
          ...
          return {
            ...
            deriveKey: t,
            length: H,
            cookie: { set: B, add: B, get: C, remove: D, clearAll: E },
          };
        },
      ]);
  });
