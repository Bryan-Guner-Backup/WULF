      ...
      (this.$get = [
        ...
        function (a, b, c, l) {
          ...
          var t = function (a) {
            ...
            v = function (b, c) {
              if (
                (f(c) ? (c = null) : (h(c) || i(c) || g(+c || c)) && (c = k(c)),
                !u || "cookie" === o.storageType)
              )
                return (
                  u ||
                    a.$broadcast(
            ...
            x = function () {
              ...
              for (b = 0; b < arguments.length; b++)
                if (((c = arguments[b]), u && "cookie" !== o.storageType))
                  try {
                    n.removeItem(t(c)),
                      r.removeItem &&
                        a.$broadcast(
            ...
            A = (function () {
              try {
                return (
                  ...
                  ("cookie" in c &&
                    (c.cookie.length > 0 ||
                      (c.cookie = "test").indexOf.call(c.cookie, "test") > -1))
                );
              } catch (d) {
                return (
                  a.$broadcast(
                ...
                if (
                  (null === d
                    ? (l.setTime(l.getTime() + -864e5),
                      (j = "; expires=" + l.toGMTString()),
                      (d = ""))
                    : g(e) && 0 !== e
                    ? (l.setTime(l.getTime() + 24 * e * 60 * 60 * 1e3),
                      (j = "; expires=" + l.toGMTString()))
                    : 0 !== q.expiry &&
                      (l.setTime(l.getTime() + 24 * q.expiry * 60 * 60 * 1e3),
                      (j = "; expires=" + l.toGMTString())),
                  b)
                ) {
                  var n = "; path=" + q.path;
                  q.domain && (m = "; domain=" + q.domain),
                    (c.cookie = t(b) + "=" + encodeURIComponent(d) + j + n + m);
                }
              } catch (o) {
                return (
                  a.$broadcast(
            ...
            C = function (b) {
              ...
              for (
                var d = (c.cookie && c.cookie.split(";")) || [], e = 0;
                e < d.length;
                e++
              ) {
                ...
                if (0 === f.indexOf(t(b) + "=")) {
                  var g = decodeURIComponent(
                    f.substring(p.length + b.length + 1, f.length)
                  );
                  try {
            ...
            E = function () {
              for (
                var a = null, b = p.length, d = c.cookie.split(";"), e = 0;
                e < d.length;
                e++
              ) {
            ...
            G = function (a, b, c, d) {
              ...
              var f = w(d);
              return (
                null === f && e(c) ? (f = c) : h(f) && h(c) && (f = j(c, f)),
                l(b).assign(a, f),
                a.$watch(
                  b,
                  function (a) {
