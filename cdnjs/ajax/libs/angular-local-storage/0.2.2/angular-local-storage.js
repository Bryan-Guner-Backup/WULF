    ...
    this.$get = [
      ...
      function ($rootScope, $window, $document, $parse) {
        ...
        var browserSupportsLocalStorage = (function () {
          try {
            var supported =
              storageType in $window && $window[storageType] !== null;
            ...
            var key = deriveQualifiedKey(
              "__" + Math.round(Math.random() * 1e7)
            );
            if (supported) {
        ...
        var getFromLocalStorage = function (key) {
          ...
          var item = webStorage
            ? webStorage.getItem(deriveQualifiedKey(key))
            : null;
        ...
        var clearAllFromLocalStorage = function (regularExpression) {
          ...
          var testRegex = !!regularExpression
          ...
          for (var key in webStorage) {
            ...
            if (
              ...
              testRegex.test(key.substr(prefixLength))
            ) {
              try {
        ...
        var addToCookies = function (key, value, daysToExpiry) {
          ...
          try {
            ...
            if (value === null) {
              ...
              expiryDate.setTime(
                expiryDate.getTime() + daysToExpiry * 24 * 60 * 60 * 1000
              );
              expiry = "; expires=" + expiryDate.toGMTString();
