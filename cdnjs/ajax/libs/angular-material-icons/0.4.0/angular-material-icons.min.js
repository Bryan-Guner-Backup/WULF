angular.module("ngMdIcons", []).directive("ngMdIcon", function () {
  var e = {
    ...
    keyboard_alt:
      '<path d="M15.5 10c.83 0 1.5-.67 1.5-1.5S16.33 7 15.5 7 14 7.67 14 8.5s.67 1.5 1.5 1.5z"/><path d="M8.5 10c.83 0 1.5-.67 1.5-1.5S9.33 7 8.5 7 7 7.67 7 8.5 7.67 10 8.5 10z"/><path d="M12 17c2.61 0 4.83-1.67 5.65-4H6.35c.82 2.33 3.04 4 5.65 4z"/><path d="M12 19c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm-.01-18C6.47 1 2 5.48 2 11s4.47 10 9.99 10C17.52 21 22 16.52 22 11S17.52 1 11.99 1z"/>',
    keyboard_arrow_down:
    ...
    timer_auto:
      '<path d="M12 4C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"/><path d="M12 14c-2.67 0-8 1.34-8 4v2h16v-2c0-2.67-5.33-4-8-4z"/>',
    timer_off:
    ...
    unfold_less:
      '<path d="M7.41 18.59L8.83 20 12 16.83 15.17 20l1.41-1.41L12 14l-4.59 4.59z"/><path d="M16.59 5.41L15.17 4 12 7.17 8.83 4 7.41 5.41 12 10l4.59-4.59z"/>',
    unfold_more:
      '<path d="M12 5.83L15.17 9l1.41-1.41L12 3 7.41 7.59 8.83 9 12 5.83z"/><path d="M12 18.17L8.83 15l-1.41 1.41L12 21l4.59-4.59L15.17 15 12 18.17z"/>',
  ...
  return {
    ...
    link: function (g, f, d) {
        ...
        if (a != c) {
          try {
            f.html(
              ...
              new SVGMorpheus(f.children()[0]).to(
                a,
                JSON.parse(d.options || null)
              );
          } catch (g) {
            f.html(
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="' +
      ...
      var h = function (a) {
        a != b &&
          (f.children()[0].setAttribute("width", a),
          f.children()[0].setAttribute("height", a),
          (b = a));
      };
      (function () {
        if (void 0 !== d.icon) {
          c = d.icon;
          var a = c.match(/ic_(.*)_([0-9]+)px.svg/m);
          null !== a && ((c = a[1]), (b = a[2]));
        } else c = "help";
        void 0 === e[c] && (c = "help");
        void 0 !== d.size ? (b = d.size) : null !== b && (b = 24);
        f.html(
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="' +
            b +
            '" height="' +
      ...
      void 0 !== d.icon && d.$observe("icon", g);
      void 0 !== d.size && d.$observe("size", h);
    },
  };
});
