...
(function () {
   ...
   */
  angular
    .module("material.components.button", ["material.animations"])
    .directive("materialButton", ["ngHrefDirective", MaterialButtonDirective]);
   ...
   */
  angular
    .module("material.components.checkbox", ["material.animations"])
  ...
  angular
    ...
    .directive("materialDialog", [MaterialDialogDirective])
  ...
  angular
    ...
    .directive("input", [groupInputDirective]);
   ...
   */
  angular
    .module("material.components.radioButton", ["material.animations"])
    ...
    function link(scope, element, attr) {
      ...
      if (input.attr("step")) {
        ...
        var tickMarkersEle = angular.element(
          '<div class="material-tick-markers material-display-flex"></div>'
        );
        for (var i = 0; i < tickCount; i++) {
          tickMarkersEle.append(
            '<div class="material-tick material-flex"></div>'
          );
        }
