...
(function () {
   ...
   */
  angular
    .module("material.core", ["ngAria"])
    .run(function validateEnvironment() {
      if (angular.isUndefined(window.Hammer)) {
        throw new Error("$mdSwipe requires HammerJS to be preloaded.");
      }
    });
})();
...
(function () {
  ...
  angular
    ...
    .directive("mdDialog", ["$$rAF", MdDialogDirective])
    .factory("$mdDialog", [
      "$timeout",
      "$rootElement",
      "$mdEffects",
...
(function () {
  ...
  angular
    ...
    .directive("mdRadioButton", ["$mdAria", "$mdUtil", mdRadioButtonDirective]);
...
(function () {
  ...
  angular
    ...
    .directive("mdSubheader", ["$mdSticky", "$compile", MdSubheaderDirective]);
...
(function () {
  angular
    ...
    .service("$mdAria", ["$log", AriaService]);
...
(function () {
  angular
     ...
     *
     */
    .directive("mdTabs", ["$parse", TabsDirective]);
