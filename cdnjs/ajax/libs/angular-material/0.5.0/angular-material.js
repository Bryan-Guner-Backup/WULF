...
(function () {
   ...
   * requirements.
   */
  angular.module("material.core", []).run(function validateEnvironment() {
...
(function () {
   ...
   */
  angular
    .module("material.animations", ["material.core"])
    .service("$mdEffects", [
      "$rootElement",
      "$$rAF",
      "$sniffer",
...
(function () {
  angular
    ...
    .directive("inkRipple", ["$mdInkRipple", InkRippleDirective])
...
(function () {
   ...
   */
  angular
    .module("material.components.backdrop", ["material.services.theming"])
    .directive("mdBackdrop", ["$mdTheming", BackdropDirective]);
...
(function () {
  ...
  angular
    ...
    .directive("mdContent", ["$mdTheming", mdContentDirective]);
...
(function () {
  ...
  angular
    ...
    .directive("mdDialog", ["$$rAF", "$mdTheming", MdDialogDirective])
    .factory("$mdDialog", [
      "$timeout",
      "$rootElement",
      "$compile",
  ...
  function MdDialogService(
    ...
    function onShow(scope, element, options) {
      ...
      if (options.hasBackdrop) {
        options.backdrop = $compile('<md-backdrop class="md-opaque ng-enter">')(
          scope
        );
...
(function () {
  ...
  angular
    ...
    .directive("mdDivider", ["$mdTheming", MdDividerDirective]);
  ...
  function MdProgressLinearDirective($$rAF, $mdEffects, $mdTheming) {
    ...
    function postLink(scope, element, attr) {
      ...
      attr.$observe("secondaryvalue", function (value) {
        bar1Style[$mdEffects.TRANSFORM] =
          progressLinearTransforms[clamp(value)];
      });
...
(function () {
  ...
  angular
    ...
    .factory("$mdSidenav", ["$mdComponentRegistry", mdSidenavService])
    .directive("mdSidenav", [
      "$timeout",
      "$animate",
      "$parse",
...
(function () {
  ...
  angular
    ...
    .directive("mdSlider", ["$mdTheming", SliderDirective]);
    ...
    function compile(element, attr) {
      ...
      return function (scope, element, attr, ngModelCtrl) {
        ...
        var thumb = angular.element(
          element[0].querySelector(".md-switch-thumb")
        );
...
(function () {
  angular
    ...
    .service("$mdAria", ["$$rAF", "$log", AriaService]);
...
(function () {
  angular
    ...
    .factory("$attrBind", ["$parse", "$interpolate", MdAttrBind]);
...
(function () {
  ...
  angular
    .module("material.services.interimElement", [
      "material.services.compiler",
      "material.services.theming",
    ])
...
(function () {
  angular
    .module("material.services.media", ["material.core"])

    .factory("$mdMedia", ["$window", "$mdUtil", "$timeout", mdMediaFactory]);
  ...
  function mdMediaFactory($window, $mdUtil, $timeout) {
    ...
    function validate(query) {
      return (
        presets[query] || (query.charAt(0) != "(" ? "(" + query + ")" : query)
      );
    }
...
(function () {
  ...
  angular
    ...
    .factory("$mdComponentRegistry", ["$log", mdComponentRegistry]);
...
(function () {
  ...
  angular
    .module("material.services.theming", [])
    .directive("mdTheme", ["$interpolate", ThemingDirective])
    .directive("mdThemable", ["$mdTheming", ThemableDirective])
...
(function () {
  angular
    ...
    .controller("$mdTabs", ["$scope", "$element", "$mdUtil", MdTabsController]);
...
(function () {
  angular
     ...
     *
     */
    .directive("mdTabs", ["$parse", "$mdTheming", TabsDirective]);
