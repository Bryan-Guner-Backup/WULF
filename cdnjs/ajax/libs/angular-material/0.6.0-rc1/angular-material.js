    ...
    function attach(element, options) {
      ...
      function createRipple(left, top, positionsAreAbsolute) {
        ...
        var containerWidth = rippleContainer.prop("offsetWidth"),
          ...
          diagonalWidth =
            Math.max(containerWidth, containerHeight) * multiplier;
        ...
        $timeout(
          function () {
            ...
            rippleEl.addClass(
              "md-ripple-placed md-ripple-visible md-ripple-scaled md-ripple-full"
            );
            ...
            $timeout(
              function () {
                ...
                if (rippleContainer && options.dimBackground) {
                  ...
                  if (!rippleContainer.hasClass("md-ripple-visible"))
                    rippleContainer.css({ backgroundColor: "" });
                }
              },
              225,
              false
      ...
      function onInput(ev) {
        if (
          ...
          if (rippleContainer && options.dimBackground) {
            ...
            if (!rippleContainer.hasClass("md-ripple-full"))
              rippleContainer.css({ backgroundColor: "" });
          }
        }
      }
    ...
    function dialogDefaultOptions(
      ...
      function onShow(scope, element, options) {
        ...
        if (options.hasBackdrop) {
          options.backdrop = $compile(
            '<md-backdrop class="md-opaque ng-enter">'
          )(scope);
      ...
      function dialogPopIn(element, parentElement, clickElement) {
        ...
        element.css($mdConstant.CSS.TRANSFORM, startPos).css("opacity", 0);
