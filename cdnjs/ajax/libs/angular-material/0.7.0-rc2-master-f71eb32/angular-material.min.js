 ...
 */,
      ...
      function (t, n, r) {
        function o(e, t) {
          ...
          var u,
            s,
            f,
            p = "mousedown touchstart pointerdown",
      ...
      function a(n, r, o) {
        ...
        function i(e, n) {
          p.splice(p.indexOf(e), 1),
            0 === p.length && m && m.css({ backgroundColor: "" }),
            t(
              function () {
                e.remove();
              },
        ...
        function d(n, i) {
          function d(e) {
            var t = angular.element(
              '<div class="md-ripple" data-counter="' + f++ + '">'
            );
            return (
              p.unshift(t),
  ...
  (function () {
      ...
      function r(n, r, o, a) {
        ...
        function c() {
          function e(e) {
            ...
            a.scrollTop = 0;
            var n = a.offsetHeight + (t > 0 ? t : 0);
            return (a.style.height = n + "px"), e;
          }
          function o() {
            a.scrollTop = 0;
    ...
    function r() {
      function e(e, t, n, r) {
        function o(e) {
          return d.text(t.val().length + "/" + a), e;
        }
        var a,
          i = r[0],
          c = r[1],
        ...
        c.element.append(d),
          i.$formatters.push(o),
          t.on("input", o),
          e.$watch(n.mdMaxlength, function (e) {
            (a = e),
          ...
          (i.$validators["md-maxlength"] = function (e, t) {
            var n = e || t;
            return !angular.isNumber(a) || 0 > a ? !0 : (n || "").length < a;
          });
      }
      return {
        restrict: "A",
  ...
  (function () {
    ...
    function t(e, t, n, r, o, a, i, c) {
      this.init = function (d) {
        ...
        function b(n) {
          if (!t[0].hasAttribute("disabled")) {
            ...
            n.keyCode === c.KEY_CODE.LEFT_ARROW
              ? (r = -V)
              : n.keyCode === c.KEY_CODE.RIGHT_ARROW && (r = V),
              r &&
        ...
        function A(e) {
          R.css("width", 100 * e + "%"),
            O.css(c.CSS.TRANSFORM, "translate3d(" + g().width * e + "px,0,0)"),
        ...
        function w(e) {
          z &&
            (G ? C(e.center.x) : y(e.center.x),
            e.preventDefault(),
            e.srcEvent.stopPropagation());
        }
        function N(e) {
          if (G && !t[0].hasAttribute("disabled")) {
            var n = H(_(e.center.x)),
              o = $(M(n));
            A(x(o)),
              r(function () {
                E(o);
        ...
        var S = angular.element(t[0].querySelector(".md-thumb")),
          ...
          R = angular.element(t[0].querySelector(".md-track-fill")),
        ...
        var P = angular.noop;
        n.ngDisabled && (P = e.$parent.$watch(n.ngDisabled, f)),
          ...
          function (e, t, c, d) {
            ...
            function m(e, t) {
              ...
              (r = Math.max(0, Math.min(1, r))),
                f.css(o.CSS.TRANSFORM, "translate3d(" + 100 * r + "%,0,0)"),
                (t.translate = r);
            }
            function u(n, r) {
              if (s(e)) return !1;
            ...
            var s = a(c.ngDisabled),
              ...
              p = angular.element(t[0].querySelector(".md-container"));
            i(function () {
              t.removeClass("md-dragging");
            }),
              (c.mdNoClick = !0),
              r(e, t, c, d),
              n.attachDragBehavior(e, p),
              p.on("$md.dragstart", l).on("$md.drag", m).on("$md.dragend", u);
          }
        );
      }
      var d = e[0];
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a, i) {
      function c(c, m, u) {
        ...
        angular.isDefined(u.mdDelay) || (c.delay = d),
          m.detach(),
          m.attr("role", "tooltip"),
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a) {
      function i(i, d, l, m) {
        ...
        function s(e) {
          var t = A.tabData,
            n = Math.max(0, Math.min(t.pages.length - 1, A.page + e)),
    ...
    function e(e, t, n, r, o, a, i, c) {
      ...
      function l(t, n) {
        p.content.length &&
          ...
          (p.contentScope = e.$parent.$new()),
          t.append(p.contentContainer),
          r(p.contentContainer)(p.contentScope),
          n === !0 &&
            c(
              function () {
      ...
      function m() {
        p.hammertime.destroy(),
          o.leave(p.contentContainer).then(function () {
            p.contentScope && p.contentScope.$destroy(),
              (p.contentScope = null);
          });
      }
      function u(e) {
      ...
      function s(n) {
        a.reconnectScope(p.contentScope),
          p.hammertime.on("swipeleft swiperight", e.onSwipe),
          t.addClass("active"),
          t.attr("aria-selected", !0),
          t.attr("tabIndex", 0),
          u(n),
          o.removeClass(p.contentContainer, "ng-hide"),
          e.onSelect();
      }
      function f(n) {
        a.disconnectScope(p.contentScope),
          p.hammertime.off("swipeleft swiperight", e.onSwipe),
          t.removeClass("active"),
          t.attr("aria-selected", !1),
          t.attr("tabIndex", -1),
          u(n),
          o.addClass(p.contentContainer, "ng-hide"),
          e.onDeselect();
      }
      var p = this;
      (p.contentContainer = angular.element(
        '<div class="md-tab-content ng-hide">'
      )),
        (p.hammertime = new Hammer(p.contentContainer[0])),
        (p.element = t),
        (p.isDisabled = d),
        (p.onAdd = l),
        (p.onRemove = m),
