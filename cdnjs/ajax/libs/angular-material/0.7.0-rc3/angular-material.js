...
(function () {
  ...
  function Iterator(items, reloop) {
    ...
    function findSubsequentItem(backwards, item, validate, limit) {
      ...
      return validate(foundItem)
        ? foundItem
        : findSubsequentItem(backwards, foundItem, validate, limit);
    }
  }
})();
    ...
    function postLink(scope, element, attr, ctrls) {
      ...
      function checkHasValue(value) {
        containerCtrl.setHasValue(
          !isEmpty(value) || (element[0].validity || {}).badInput // allow badInput to count as having a value.
        );
        return value;
      }
  ...
  function mdMaxlengthDirective() {
    ...
    function postLink(scope, element, attr, ctrls) {
      ...
      ngModelCtrl.$validators["md-maxlength"] = function (
        ...
        return (
          (element.val() || modelValue || viewValue || "").length <= maxlength
        );
      };
...
(function () {
  ...
  function TabItemController(
    ...
    function toggleAnimationClass(rightToLeft) {
      self.contentContainer[rightToLeft ? "addClass" : "removeClass"](
        "md-transition-rtl"
      );
    }
...
(function () {
  ...
  function MdTabsController($scope, $element, $mdUtil, $timeout) {
    ...
    var contentArea = (self.contentArea = angular.element(
    ...
    function add(tab, index) {
      ...
      if (
        !angular.isDefined(tab.element.attr("md-active")) &&
