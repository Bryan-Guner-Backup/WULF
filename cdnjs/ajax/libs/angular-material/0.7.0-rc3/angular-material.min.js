    ...
    function n(e, t) {
      ...
      function r(n, r, o, a) {
        ...
        function c() {
          ...
          var c = r[0],
            d = e.debounce(a, 1);
          l ? (l.$formatters.push(o), l.$viewChangeListeners.push(o)) : d(),
    ...
    function r() {
      function e(e, t, n, r) {
        ...
        n.$set("ngTrim", "false"),
          c.element.append(d),
          i.$formatters.push(o),
          i.$viewChangeListeners.push(o),
          t.on("input keydown", o),
          ...
          (i.$validators["md-maxlength"] = function (e, n) {
            return !angular.isNumber(a) || 0 > a
              ? !0
              : (t.val() || e || n || "").length <= a;
          });
      }
