            ...
            if (!this.state.dragPointer) {
              if (this.state.options.horizontal) {
                ...
                shouldCancel =
                  ...
                  this.state.options.minDistance * 1.5;
              } else {
                shouldStartDrag =
...
(function () {
  ...
  function placeholderDirective() {
    ...
    function postLink(scope, element, attr, inputContainer) {
      ...
      inputContainer.element.append(
        '<div class="md-placeholder">' + placeholderText + "</div>"
      );
    }
  }
})();
