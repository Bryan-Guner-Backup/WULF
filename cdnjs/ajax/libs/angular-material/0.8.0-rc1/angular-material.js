      ...
      return function createInterimElementService() {
        ...
        function InterimElement(options) {
          ...
          return (self = {
            ...
            show: function () {
              showFailed = false;
              return $mdCompiler.compile(options).then(
      ...
      function getTileSpans() {
        return ctrl.tiles.map(function (tileAttrs) {
          return {
            row:
              parseInt(
                $mdMedia.getResponsiveAttribute(tileAttrs, "md-rowspan"),
                10
              ) || 1,
            col:
              parseInt(
                $mdMedia.getResponsiveAttribute(tileAttrs, "md-colspan"),
                10
              ) || 1,
          };
        });
