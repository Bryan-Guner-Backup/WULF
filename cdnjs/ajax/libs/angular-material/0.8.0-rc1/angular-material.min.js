...
function mdMediaFactory(e, t, n) {
  function r(e) {
    var t = u[e];
    angular.isUndefined(t) && (t = u[e] = o(e));
    var n = f[t];
 ...
 */,
    ...
    angular
      ...
      .run([
        ...
        function (e) {
          ...
          t.forEach(function (t) {
            n.icon(t.id, t.url), e.put(t.url, t.svg);
          }),
            (n = null);
        },
      ]),
      (e.$inject = ["$provide", "$mdThemingProvider", "$mdIconProvider"]);
  })()
  /*!
   * Angular Material Design
   * https://github.com/angular/material
  ...
  (function () {
    function e(e, t) {
      ...
      function l(e, t) {
        return e
          ? (angular.isNumber(t) || (t = b.length), b.splice(t, 0, e), u(e))
          : -1;
      }
      function m(e) {
        s(e) && b.splice(u(e), 1);
      ...
      function (t, n, r, o, a) {
        ...
        return (c = {
          ...
          clientRect: function (e, t, n) {
            var r = i(e);
            t = i(t || r.offsetParent || document.body);
          ...
          transitionEndPromise: function (e) {
            function t(r) {
              r.target === e[0] && (e.off(a.CSS.TRANSITIONEND, t), n.resolve());
            }
            var n = o.defer();
            return e.on(a.CSS.TRANSITIONEND, t), n.promise;
          },
  ...
  (function () {
    ...
    var s = navigator.userAgent || navigator.vendor || window.opera,
      f = s.match(/iPad/i) || s.match(/iPhone/i) || s.match(/iPod/i),
      p = s.match(/Android/i),
      h = f || p;
    h &&
      document.addEventListener(
    ...
    function n(e, t, n, r, o) {
      function a(t) {
        return function (n) {
          var r = e[t];
          return (
            (n = u(n) ? n : new s(n, r)), (n = d(n)), (f[t] = n), n.clone()
          );
        };
      }
      function i(t) {
      ...
      function c(t) {
        function r(e) {
          var r = t.slice(t.lastIndexOf(":") + 1),
            o = e.querySelector("#" + r);
          return o ? new s(o, a) : n.reject(t);
        }
        var o = t.substring(0, t.lastIndexOf(":")) || "$default",
          a = e[o];
        return a ? l(a.url).then(r) : n.reject(t);
      }
      function d(t) {
        var n = t.config ? t.config.iconSize : e.defaultIconSize,
          r = angular.element(t.element);
        return r
          .attr({
            fit: "",
            height: "100%",
            ...
            viewBox: r.attr("viewBox") || "0 0 " + n + " " + n,
          })
        ...
        return (
          ...
          f[e]
            ...
            : (-1 == e.indexOf(":") && (e = "$default:" + e),
              i(e).catch(c).catch(m).then(a(e)))
        );
      };
    }
    angular.module("material.core").provider("$mdIcon", e);
    ...
    function e() {
      function e(e) {
        ...
        function o(t, n, r) {
          ...
          var d,
            l,
            m = t(),
            u = { hide: m.hide, cancel: m.cancel, show: o };
          return (
            (d = c.methods || []),
      ...
      function t(e, t, n, r, o, a, i, c, d) {
        ...
        var m = i.startSymbol(),
          u = i.endSymbol(),
          s = "{{" === m && "}}" === u,
          f = s ? angular.identity : l;
        return function () {
          function i(e) {
            if (p.length)
              return s.cancel().then(function () {
                return i(e);
              });
            var t = new u(e);
            return (
          ...
          function u(i) {
            ...
            return (l = {
              ...
              remove: function () {
                ...
                var e;
                return (
                  (e = p ? !0 : i.onRemove(i.scope, u, i)),
                  t.when(e).then(function () {
                    i.preserveScope || i.scope.$destroy();
                  })
                );
              },
            });
  ...
  (function () {
    ...
    function t(e, t) {
      ...
      function a(n, r, o) {
        ...
        function l(n, c) {
          ...
          function m(e, t) {
            var n,
              r,
              a,
              i = s.prop("offsetWidth"),
              c = s.prop("offsetHeight");
            return (
              o.isMenuItem
          ...
          function u(e, t, n) {
            ...
            return (
              ...
              o.center
                ...
                : ((a = M.getBoundingClientRect()),
                  (i.left =
                    Math.round(((t - a.left) / s.prop("offsetWidth")) * 100) +
                    "%"),
                  (i.top =
                    Math.round(((n - a.top) / s.prop("offsetHeight")) * 100) +
                    "%")),
              i
            );
          }
          ...
          return (
            ...
            t(
              function () {
                o.dimBackground && s.css({ backgroundColor: T }),
        ...
        return (
          o.mousedown && r.on("$md.pressdown", m).on("$md.pressup", u),
          (p.createRipple = l),
          E &&
          ...
          function () {
            r.off("$md.pressdown", m).off("$md.pressup", u), a().remove();
          }
        );
      }
      return {
      ...
      function i(e) {
        function t(e) {
          if (((e = 0 === arguments.length ? !0 : !!e), e !== n.isDark)) {
            (n.isDark = e),
              (n.foregroundPalette = n.isDark ? f : s),
  ...
  (function () {
    ...
    function t(e) {
      function t(e, t, o, a, i, c, d, l, m, u) {
        function s(n, r, a) {
        ...
        function p(e, a) {
          ...
          var m = u.register(a, "drag", { horizontal: !1 });
          return (
    ...
    function e(e, t, n, r, o, a) {
      function i(t, i) {
        return (
          ...
          function (t, i, d, l) {
            function m(e) {
              e.which === r.KEY_CODE.SPACE && (e.preventDefault(), u(e));
            }
            function u(e) {
      ...
      function a(t, a, i, c) {
        ...
        function u() {
          var e = f(),
            ...
            c = r(n, p(), f())
              .map(function (t, r, c) {
                var d = angular.element(e[c]);
                return (
                  (d.scope().$mdGridPosition = t),
                  { element: d, styles: s(t.position, t.spans, n, r, i, o, a) }
                );
              })
              .reflow()
              .performance();
        ...
        function s(e, t, n, r, o, a, i) {
          var c = (1 / n) * 100,
            d = 1 === n ? 0 : (n - 1) / n,
            l = A({ share: c, gutterShare: d, gutter: o }),
            m = {
              left: T({ unit: l, offset: e.col, gutter: o }),
              width: w({ unit: l, span: t.col, gutter: o }),
              paddingTop: "",
              marginTop: "",
              top: "",
              height: "",
          ...
          switch (a) {
            case "fixed":
              (m.top = T({ unit: i, offset: e.row, gutter: o })),
                (m.height = w({ unit: i, span: t.row, gutter: "0px" }));
              break;
            case "ratio":
              var u = c * (1 / i),
                s = A({ share: u, gutterShare: d, gutter: o });
              (m.paddingTop = w({ unit: s, span: t.row, gutter: o })),
                (m.marginTop = T({ unit: s, offset: e.row, gutter: o }));
              break;
            case "fit":
              var f = 1 === r ? 0 : (r - 1) / r,
                u = (1 / r) * 100,
                s = A({ share: u, gutterShare: f, gutter: o });
              (m.top = T({ unit: s, offset: e.row, gutter: o })),
                (m.height = w({ unit: s, span: t.row, gutter: o }));
          }
          return m;
        }
        function f() {
        ...
        function p() {
          return c.tiles.map(function (e) {
            return {
              row: parseInt(o.getResponsiveAttribute(e, "md-rowspan"), 10) || 1,
              col: parseInt(o.getResponsiveAttribute(e, "md-colspan"), 10) || 1,
            };
          });
        }
        function h() {
          return parseInt(o.getResponsiveAttribute(i, "md-cols"), 10);
        }
        function g() {
          return v(o.getResponsiveAttribute(i, "md-gutter") || 1);
        }
        function b() {
        ...
        var $ = angular.bind(c, c.invalidateLayout),
          M = d();
        t.$on("$destroy", l());
        var A = e("{{ share }}% - ({{ gutter }} * {{ gutterShare }})"),
          T = e(
        ...
        return (
          ...
          (a = {
            ...
            map: function (t) {
              return (
                (l = e.time(function () {
                  c = i.positioning.map(function (e, n) {
                    return t(e, a.layoutInfo().rowCount, n);
                  });
                })),
                a
              );
      ...
      (t.prototype = {
        addTile: function (e, t) {
          angular.isUndefined(t)
            ? this.tiles.push(e)
            : this.tiles.splice(t, 0, e),
            this.invalidateLayout();
        },
        removeTile: function (e) {
          var t = this.tiles.indexOf(e);
          -1 !== t && (this.tiles.splice(t, 1), this.invalidateLayout());
        },
  ...
  (function () {
    ...
    function e(e, t) {
      ...
      function r(n, r, o) {
        ...
        var i = o.alt || n.fontIcon || n.svgIcon,
          c = o.$normalize(o.$attr.mdSvgIcon || o.$attr.mdSvgSrc || "");
        "" == o.alt || a()
          ? t.expect(r, "aria-hidden", "true")
          : (t.expect(r, "aria-label", i), t.expect(r, "role", "img")),
          c &&
            o.$observe(c, function (t) {
              r.empty(),
                t &&
                  e(t).then(function (e) {
                    r.append(e);
  ...
  (function () {
    ...
    function n(e, t) {
      function n(n, r, o, a) {
        ...
        function d() {
          ...
          var c = r[0],
            d = e.debounce(a, 1);
          m ? (m.$formatters.push(o), m.$viewChangeListeners.push(o)) : d(),
            r.on("keydown input", d),
            r.on("scroll", i),
        ...
        var l = a[0],
          m = a[1] || e.fakeNgModel(),
          u = angular.isDefined(o.readonly);
        if (l) {
          if (l.input)
            throw new Error(
    ...
    angular
      ...
      (n.$inject = ["$mdUtil", "$window", "$compile", "$animate"]),
      (r.$inject = ["$animate"]);
  })()
  /*!
   * Angular Material Design
    ...
    function e(e, t, n) {
      ...
      function o(e, r, o) {
        ...
        var d,
          ...
          u,
          s = r[0],
          f = s.querySelectorAll(".md-fill, .md-mask.md-full"),
          p = s.querySelectorAll(".md-fill.md-fix"),
          h = o.mdDiameter || 48,
          g = h / 48;
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a, i, c) {
      ...
      function l(n, d, l, m) {
        ...
        function s(e) {
          (G = parseFloat(e)), d.attr("aria-valuemin", e), u();
        }
        function f(e) {
          (z = parseFloat(e)), d.attr("aria-valuemax", e), u();
        }
        function p(e) {
          (W = parseFloat(e)), g();
        }
        ...
        function M() {
          ...
          var e = (m.$viewValue - G) / (z - G);
          (n.modelValue = m.$viewValue),
            d.attr("aria-valuenow", m.$viewValue),
            w(e),
            F.text(m.$viewValue);
        }
        function A(e) {
        ...
        var O = l.ngDisabled && c(l.ngDisabled),
          P = O
            ? function () {
                return O(n.$parent);
              }
          ...
          L = j.parent(),
          q = angular.element(d[0].querySelector(".md-track-container")),
          B = angular.element(d[0].querySelector(".md-track-fill")),
          U = angular.element(d[0].querySelector(".md-track-ticks")),
          Y = r.throttle(b, 5e3);
        l.min ? l.$observe("min", s) : s(0),
    ...
    function e(e, t, n, r, o) {
      function a(e) {
        ...
        function o() {
          ...
          for (
            var e, t = u.prop("scrollTop"), n = f.items.length - 1;
            n >= 0;
            n--
          )
            if (t > f.items[n].top) {
        ...
        return (
          ...
          function (e, t, d, l) {
            ...
            i(function () {
              ...
              c.register(g, "drag"),
              g.on("$md.dragstart", m).on("$md.drag", u).on("$md.dragend", s);
            var b;
          }
        );
      }
        ...
        link: function (o, a, i) {
          function c() {
            ...
            function d(e) {
              ...
              h(),
                (u = Math.min(l / f, Math.max(0, u + n - s))),
                a.css(t.CSS.TRANSFORM, "translate3d(0," + -u * f + "px,0)"),
                m.css(
                  t.CSS.TRANSFORM,
                  "translate3d(0," + (l - u) * f + "px,0)"
                ),
                (s = n);
            }
            var l,
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a, i, c, d) {
      function l(l, s, f) {
        ...
        function h() {
          E.attr("aria-describedby", s.attr("id")),
            A.append(s),
            b(),
            c.addClass(s, "md-show"),
            c.addClass(v, "md-show");
        }
        function g() {
          E.removeAttr("aria-describedby"),
            d
              .all([c.removeClass(v, "md-show"), c.removeClass(s, "md-show")])
              .then(function () {
                l.visible || s.detach();
              });
        }
        function b() {
          ...
          (a.left = Math.min(a.left, A.prop("scrollWidth") - t.width - u)),
            (a.left = Math.max(a.left, u)),
            a.top + t.height > A.prop("scrollHeight") &&
        ...
        for (
          var E = s.parent(),
            v = angular.element(
              s[0].getElementsByClassName("md-background")[0]
            ),
            $ = f.mdDirection;
        ...
        for (
          ...
          M !== i[0] &&
          M !== document.body &&
          (!M.tagName || "md-content" != M.tagName.toLowerCase());

        )
          M = M.parentNode;
        var A = angular.element(M || document.body);
        angular.isDefined(f.mdDelay) || (l.delay = m),
          s.detach(),
          s.attr("role", "tooltip"),
          s.attr("id", f.id || "tooltip_" + o.nextUid()),
        ...
        angular.element(t).on("resize", T),
          l.$on("$destroy", function () {
            (l.visible = !1), s.remove(), angular.element(t).off("resize", T);
          });
      }
      var m = 0,
        u = 8;
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a) {
      ...
      function c() {
        var e = angular.element(v.ul),
          t = angular.element(v.input),
          n = e.attr("id") || "ul_" + o.nextUid();
        e.attr("id", n), t.attr("aria-owns", n);
      }
      function d() {
        e.$watch("searchText", function (e) {
          if (!e) return (g.loading = !1), (g.matches = []);
          var t = e.toLowerCase();
          $ && $.cancel && ($.cancel(), ($ = null)),
            M[t]
              ? (g.matches = M[t])
              : g.hidden || ((g.loading = !0), g.fetch(e));
        });
      }
      function l(t) {
        var n = e.$parent.$eval(E),
          o = t.toLowerCase();
        $ = r.when(n).then(function (n) {
          (M[o] = n),
            t === e.searchText &&
              (($ = null), (g.loading = !1), (g.matches = n));
        });
      }
      function m(e) {
        switch (e.keyCode) {
          case a.KEY_CODE.DOWN_ARROW:
            if (g.loading) return;
            e.preventDefault(),
              (g.index = Math.min(g.index + 1, g.matches.length - 1)),
              h();
            break;
          case a.KEY_CODE.UP_ARROW:
            if (g.loading) return;
            e.preventDefault(), (g.index = Math.max(0, g.index - 1)), h();
            break;
          case a.KEY_CODE.ENTER:
            if (g.loading) return;
            e.preventDefault(), p(g.index);
            break;
          case a.KEY_CODE.ESCAPE:
            (g.matches = []), (g.hidden = !0), (g.index = -1);
            break;
          default:
            (g.index = -1),
              (g.hidden = !1),
      ...
      function s() {
        return 1 === g.matches.length && e.searchText === f(g.matches[0]);
      }
      function f(t) {
        return t && e.itemText ? t[e.itemText] : t;
      }
      function p(t) {
        (e.selectedItem = g.matches[t]),
          (e.searchText = f(e.selectedItem) || e.searchText),
          (g.hidden = !0),
          (g.index = -1),
          (g.matches = []);
      }
      function h() {
        ...
        e < v.ul.scrollTop
          ? (v.ul.scrollTop = e)
          : t > v.ul.scrollTop + n && (v.ul.scrollTop = t - n);
      }
      var g = this,
