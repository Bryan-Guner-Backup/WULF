 ...
 */,
  (function () {
    ...
    angular.module("material.core", ["material.core.theming"]).config(e),
  ...
  (function () {
    function e(e, t) {
      ...
      function l(e, t) {
        return e
          ? (angular.isNumber(t) || (t = b.length), b.splice(t, 0, e), m(e))
          : -1;
      }
      function s(e) {
        u(e) && b.splice(m(e), 1);
    ...
    function e(e, t, n, r, o, a) {
      this.compile = function (i) {
        ...
        return (
          ...
          angular.extend(m, u),
          (m.$template = c
            ? t.get(c, { cache: a }).then(function (e) {
                return e.data;
              })
            : e.when(d)),
  ...
  (function () {
    ...
    function r(t) {
      g &&
        o(t, g) &&
        (i(t, g), (g.endTime = +Date.now()), e("end", t), (b = g), (g = null));
    }
    function o(e, t) {
    ...
    var d,
      l = "mousedown touchstart pointerdown",
      ...
      .factory("$mdGesture", [
        ...
        function (e, t, n) {
          ...
          (d = {}),
            ...
            r("drag", {
              options: { minDistance: 6, horizontal: !0 },
              onStart: function () {
                    ...
                    : (this.state.options.horizontal
                        ? ((n =
                          ...
                          (r =
                            ...
                            1.5 * this.state.options.minDistance))
                        : ((n =
                            Math.abs(t.distanceY) >
                            this.state.options.minDistance),
                          (r =
                            ...
                            1.5 * this.state.options.minDistance)),
                      n
                        ? ((this.state.dragPointer = c(e)),
                          i(e, this.state.dragPointer),
                          this.dispatchEvent(
                            e,
                            "$md.dragstart",
                            this.state.dragPointer
      ...
      function e(e) {
        ...
        function o(t, n, r) {
          ...
          var d,
            l,
            s = t(),
            m = { hide: s.hide, cancel: s.cancel, show: o };
          return (
            (d = c.methods || []),
        ...
        var a = ["onHide", "onShow", "onRemove"],
          i = {},
          c = { presets: {} },
          d = { setDefaults: t, addPreset: r, addMethod: n, $get: o };
        return (
          d.addPreset("build", {
            methods: [
              "controller",
    ...
    function t(e, t) {
      ...
      function o(e, t, n) {
        return a(
          e,
          t,
          angular.extend({ center: !1, dimBackground: !0, outline: !0 }, n)
        );
      }
      function a(n, r, o) {
        function a() {
        ...
        function l(n, c) {
          ...
          function s(e, t) {
            ...
            return (
              o.isMenuItem
                ? (r = Math.sqrt(Math.pow(i, 2) + Math.pow(c, 2)))
                : o.outline
                ? ((a = M.getBoundingClientRect()),
                  ...
                  (i = Math.max(e, i - e)),
                  (c = Math.max(t, c - t)),
                  (r = 2 * Math.sqrt(Math.pow(i, 2) + Math.pow(c, 2))))
                : ((n = o.isFAB ? 1.1 : 0.8),
                  (r = Math.sqrt(Math.pow(i, 2) + Math.pow(c, 2)) * n),
                  o.fitRipple && (r = Math.min(c, i, r))),
              r
            );
          }
          function m(e, t, n) {
        ...
        return (
          o.mousedown && r.on("$md.pressdown", s).on("$md.pressup", m),
          (p.createRipple = l),
          E &&
  ...
  (function () {
      ...
      function i(e) {
        function t(e) {
          if (((e = 0 === arguments.length ? !0 : !!e), e !== n.isDark)) {
            (n.isDark = e),
              (n.foregroundPalette = n.isDark ? f : u),
              (n.foregroundShadow = n.isDark ? p : h);
            var t = n.isDark ? A : M,
              r = n.isDark ? M : A;
            return (
    ...
    function o(e) {
      ...
      o.forEach(function (e) {
        for (var t, n = (e.match(c), 0); (t = v[n]); n++)
  ...
  (function () {
    ...
    function t(e) {
      function t(e, t, o, a, i, c, d, l, s, m) {
        function u(n, r, a) {
          (h = i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(
            n
          )),
            h.on("click", function () {
              o(d.cancel);
            }),
            c.inherit(h, a.parent),
            e.enter(h, a.parent, null);
          var s = new p(r, a.parent);
          return (
            (a.bottomSheet = s),
            a.targetEvent && angular.element(a.targetEvent.target).blur(),
            c.inherit(s.element, a.parent),
            a.disableParentScroll &&
              ((a.lastOverflow = a.parent.css("overflow")),
              a.parent.css("overflow", "hidden")),
            e.enter(s.element, a.parent).then(function () {
              var e = angular.element(
              ...
              e.focus(),
                a.escapeToClose &&
                  ((a.rootElementKeyupCallback = function (e) {
        ...
        function p(e, a) {
          ...
          function l(r) {
            if (
              ...
              var a = e.prop("offsetHeight") - r.pointer.distanceY,
                i = Math.min((a / r.pointer.velocityY) * 0.75, 500);
          ...
          return (
            a.on("$md.dragstart", i).on("$md.drag", c).on("$md.dragend", l),
            {
              element: e,
              cleanup: function () {
                s(),
  ...
  (function () {
    ...
    function e(e, t, n) {
      ...
      function a(o, a, i) {
        ...
        d || n.expect(a, "aria-label"),
          r(i) &&
            angular.isDefined(i.ngDisabled) &&
            o.$watch(i.ngDisabled, function (e) {
    ...
    angular
      ...
      (e.$inject = ["$mdInkRipple", "$mdTheming", "$mdAria"]);
  })()
  /*!
   * Angular Material Design
   * https://github.com/angular/material
      ...
      function i(t, i) {
        return (
          ...
          function (t, i, d, l) {
            ...
            o(i),
              d.ngChecked &&
                t.$watch(t.$eval.bind(t, d.ngChecked), l.$setViewValue.bind(l)),
              n.expectWithText(i, "aria-label"),
              e.link.pre(t, { on: angular.noop, 0: {} }, d, [l]),
              i.on("click", m).on("keypress", s),
              (l.$render = u);
          }
        );
      }
    ...
    function t(e) {
      ...
      function n(e, t, n, r, o, a, i, c, d, l, s, m) {
        function u(n, o, i) {
          ...
          (i.parent = angular.element(i.parent)),
            (i.popInTarget = angular.element((i.targetEvent || {}).target));
          var s = l();
          if ((p(o.find("md-dialog")), i.hasBackdrop)) {
            var u =
                ...
                a[0].documentElement &&
                a[0].scrollTop
                  ? angular.element(a[0].documentElement)
                  : i.parent,
              f = u.prop("scrollTop");
            (i.backdrop = angular.element(
              '<md-backdrop class="md-dialog-backdrop md-opaque">'
            )),
              d.inherit(i.backdrop, i.parent),
              r.enter(i.backdrop, i.parent),
              o.css("top", f + "px");
          }
          return (
            i.disableParentScroll &&
              ((i.lastOverflow = i.parent.css("overflow")),
              i.parent.css("overflow", "hidden")),
            h(
              o,
              i.parent,
              i.popInTarget && i.popInTarget.length && i.popInTarget
            ).then(function () {
              i.escapeToClose &&
                ((i.rootElementKeyupCallback = function (t) {
                  t.keyCode === c.KEY_CODE.ESCAPE && e(m.cancel);
                }),
                t.on("keyup", i.rootElementKeyupCallback)),
                i.clickOutsideToClose &&
                  ((i.dialogClickOutsideCallback = function (t) {
                    t.target === o[0] && e(m.cancel);
                  }),
                  o.on("click", i.dialogClickOutsideCallback)),
                s.focus();
            })
          );
        }
        function f(e, n, o) {
          return (
            o.backdrop && r.leave(o.backdrop),
            o.disableParentScroll &&
              (o.parent.css("overflow", o.lastOverflow), delete o.lastOverflow),
            o.escapeToClose && t.off("keyup", o.rootElementKeyupCallback),
            ...
            g(
              ...
              o.scope.$destroy(),
                n.remove(),
                o.popInTarget && o.popInTarget.focus();
            })
          );
        }
        function p(e) {
        ...
        function b(e, t) {
          if (t) {
            var n = t[0].getBoundingClientRect(),
              ...
              o = Math.min(0.5, n.width / r.width),
              a = Math.min(0.5, n.height / r.height);
            e.css(
              c.CSS.TRANSFORM,
              "translate3d(" +
    ...
    function e(e, n, r, o) {
      function a(t, a, i, c) {
        ...
        function m() {
          var e = p(),
            ...
            d = r(n, h(), p())
              .map(function (t, r) {
                return {
                  grid: { element: a, style: f(n, r, c, o, i) },
        ...
        function u(e, t, n, r, o, a, i) {
          var c = (1 / n) * 100,
            d = 1 === n ? 0 : (n - 1) / n,
            l = T({ share: c, gutterShare: d, gutter: o }),
            s = {
          ...
          switch (a) {
            case "fixed":
              (s.top = w({ unit: i, offset: e.row, gutter: o })),
                (s.height = k({ unit: i, span: t.row, gutter: o }));
              break;
            case "ratio":
              var m = c * (1 / i),
                u = T({ share: m, gutterShare: d, gutter: o });
              (s.paddingTop = k({ unit: u, span: t.row, gutter: o })),
                (s.marginTop = w({ unit: u, offset: e.row, gutter: o }));
              break;
            case "fit":
              var f = 1 === r ? 0 : (r - 1) / r,
                m = (1 / r) * 100,
                u = T({ share: m, gutterShare: f, gutter: o });
              (s.top = w({ unit: u, offset: e.row, gutter: o })),
                (s.height = k({ unit: u, span: t.row, gutter: o }));
          }
          return s;
        }
          ...
          switch (r) {
            ...
            case "ratio":
              var i = 1 === e ? 0 : (e - 1) / e,
                c = (1 / e) * 100,
                d = c * (1 / o),
                l = T({ share: d, gutterShare: i, gutter: n });
    ...
    function e(e, t, n) {
      ...
      function o(r, o, a) {
        ...
        "" == a.alt || i()
          ...
          : (n.expect(o, "aria-label", c), n.expect(o, "role", "img")),
          d &&
            a.$observe(d, function (t) {
              o.empty(),
                t &&
                  e(t).then(function (e) {
                    o.append(e);
    ...
    function n(e, t, n, r, o) {
      ...
      function u(e, t) {
        "svg" != e.tagName &&
          (e = angular
            ...
            .append(e)[0]),
          (e = angular.element(e)),
          e.attr("xmlns") || e.attr("xmlns", "http://www.w3.org/2000/svg"),
          (this.element = e),
          (this.config = t),
          this.prepare();
      }
      function f() {
        ...
        n
          ...
          .css({ "pointer-events": "none", display: "block" }),
          (this.element = n);
      }
      function p() {
          ...
          return (
            ...
            h[e]
              ...
              : (-1 == e.indexOf(":") && (e = "$default:" + e),
                i(e).catch(c).catch(l).catch(s).then(a(e)))
          );
        }
      );
    }
    ...
    function n(e, t) {
      function n(n, r, o, a) {
        ...
        function d() {
          ...
          var d = r[0],
            l = e.debounce(a, 1);
          s ? (s.$formatters.push(o), s.$viewChangeListeners.push(o)) : l(),
        ...
        if (l) {
          ...
          (l.input = r),
            ...
            "textarea" === r[0].tagName.toLowerCase() && d();
          var u =
            l.isErrorGetter ||
            function () {
          ...
          n.$watch(u, l.setInvalid),
            ...
            m ||
              r
                .on("focus", function () {
                  l.setFocused(!0), s.$setTouched(), u() && l.setInvalid(!0);
                })
                .on("blur", function () {
                  l.setFocused(!1), c();
                }),
              ...
              angular.isNumber(t) && t > 0
                ? (l.parent().length ||
                    e.enter(
                      l,
                      d.element,
                      angular.element(d.element[0].lastElementChild)
                    ),
                  a())
                : e.leave(l);
          }),
      ...
      function e(e, t, n, r) {
        if (r) {
          ...
          t.removeAttr("placeholder"),
            r.element.append('<div class="md-placeholder">' + o + "</div>");
        }
      }
    ...
    function e(e, t, n) {
      ...
      function o(e, r, o) {
        ...
        var d,
          ...
          h = o.mdDiameter || 48,
          g = h / 48;
        (u.style[t.CSS.TRANSFORM] = "scale(" + g.toString() + ")"),
          o.$observe("value", function (e) {
            for (
              l = a(e), s = i[l], m = c[l], r.attr("aria-valuenow", l), d = 0;
              d < f.length;
              d++
            )
              f[d].style[t.CSS.TRANSFORM] = s;
      ...
      for (var i = new Array(101), c = new Array(101), d = 0; 101 > d; d++) {
        var l = d / 100,
          s = Math.floor(180 * l);
        (i[d] = "rotate(" + s.toString() + "deg)"),
          (c[d] = "rotate(" + (2 * s).toString() + "deg)");
      }
      return {
        restrict: "E",
        template:
  ...
  (function () {
      ...
      function r(r, a, i, c) {
        ...
        function l() {
          ...
          e !== m &&
            ...
            e
              ? (a.addClass(o), c.setActiveDescendant(a.attr("id")))
              : a.removeClass(o));
        }
        function s(n, r) {
          function o() {
        ...
        n(a),
          ...
          c.add(l),
          i.$observe("value", l),
          a.on("click", d).on("$destroy", function () {
            c.remove(l);
          });
      }
      var o = "md-checked";
    ...
    angular
      ...
      (e.$inject = ["$mdUtil", "$mdConstant", "$mdTheming"]),
    ...
    function t(e, t, n, r, o, a, i, c, d) {
      function l(l, s, m, u) {
        ...
        function p(e) {
          var n = s.parent();
          return (
            n[e ? "on" : "off"]("keydown", g),
            A[e ? "on" : "off"]("click", b),
            e && (E = d[0].activeElement),
            (v = c.all([
              t[e ? "enter" : "leave"](A, n),
        ...
        var E = null,
          ...
          A = a('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(
            l
          );
        s.on("$destroy", u.destroy),
          i.inherit(A, s),
          l.$watch(M, f),
          l.$watch("isOpen", p),
          (u.$toggleOpen = h);
  ...
  (function () {
    ...
    function e(e, t, n) {
      function r(r, o) {
        ...
        a.length ||
          ...
          a.append('<span class="md-select-icon" aria-hidden="true"></span>'),
          a.addClass("md-select-label"),
          a.addClass("{{ " + o.ngModel + " ? '' : 'md-placeholder'}}"),
          a.attr("id", "select_label_" + t.nextUid()),
        ...
        var i =
          '<div class="md-select-menu-container"><md-select-menu ng-model="$parent.' +
          o.ngModel +
          '" ' +
          (angular.isDefined(o.multiple) ? "multiple" : "") +
          ">" +
          r.html() +
          "</md-select-menu></div>";
        return (
    ...
    function t(e, t, n) {
      function r(e, r, o, a) {
        ...
        var l = a[0],
          s = a[1];
        n(r), r.on("click", d), r.on("keypress", c), l.init(s), i();
      }
      function o(t, n) {
        function r() {
          var e = a.ngModel.$modelValue || a.ngModel.$viewValue;
          if (angular.isArray(e)) {
            var t = Object.keys(a.selected),
              n = e.map(a.hashGetter),
              r = t.filter(function (e) {
                return -1 === n.indexOf(e);
              });
            r.forEach(a.deselect),
        ...
        function o() {
          ...
          Object.keys(a.selected).forEach(a.deselect),
            a.select(a.hashGetter(e), e);
        }
        var a = this;
        (a.isMultiple = angular.isDefined(n.multiple)),
          (a.selected = {}),
          (a.options = {}),
          (a.init = function (c) {
            function d(e, t) {
            ...
            if (((a.ngModel = c), c.$options && c.$options.trackBy)) {
              var l = {},
                s = e(c.$options.trackBy);
              a.hashGetter = function (e, n) {
                return (l.$value = e), s(n || t, l);
              };
            } else
              a.hashGetter = function (e) {
                return angular.isObject(e)
                  ? "$$object_" + (e.$$mdSelectId || (e.$$mdSelectId = ++i))
                  : e;
              };
            a.isMultiple
              ? ((c.$validators["md-multiple"] = d),
                (c.$render = r),
          ...
          (a.addOption = function (e, t) {
            if (angular.isDefined(a.options[e]))
              throw new Error(
            ...
            (a.options[e] = t),
              angular.isDefined(a.selected[e]) &&
                (a.select(e, t.value), a.refreshViewValue());
          }),
          ...
          (a.refreshViewValue = function () {
            var e,
              t = [];
            for (var n in a.selected)
              (e = a.options[n]) ? t.push(e.value) : t.push(a.selected[n]);
            a.ngModel.$setViewValue(a.isMultiple ? t : t[0]);
          });
      }
      return (
        (o.$inject = ["$scope", "$attrs"]),
        {
          restrict: "E",
    ...
    function o(e) {
      function t(e, t, o, i, c, d) {
        function l(n, r, a) {
          function l() {
            a.selectEl.attr("aria-labelledby", a.target.attr("id")),
              a.target.attr("aria-owns", a.selectEl.attr("id")),
              a.target.attr("aria-expanded", "true");
          }
          function s() {
            function o() {
              var e;
              -1 == (e = f.call(u, a.focusedNode))
                ? (e = Math.floor((u.length - 1) / 2))
                : e < u.length - 1 && ++e,
                (a.focusedNode = u[e]),
                u[e].focus();
            }
              ...
              r.addClass("md-clickable"),
                a.backdrop &&
                  a.backdrop.on("click", function () {
                    (a.restoreFocus = !1), n.$apply(e.cancel);
                  }),
          ...
          angular.extend(a, {
            ...
            backdrop: a.hasBackdrop && angular.element("<md-backdrop>"),
          });
          var u = a.selectEl[0].getElementsByTagName("md-option"),
            f = [].indexOf;
          return (
            l(),
            a.loadingAsync &&
              a.loadingAsync.then &&
              a.loadingAsync.then(function () {
            ...
            a.disableParentScroll &&
              ((a.disableTarget = a.parent.find("md-content")),
              a.disableTarget.length || (a.disableTarget = a.parent),
              (a.lastOverflow = a.disableTarget.css("overflow")),
              a.disableTarget.css("overflow", "hidden")),
            d(s, 75, !1),
            a.backdrop &&
              (c.inherit(a.backdrop, a.parent), a.parent.append(a.backdrop)),
            a.parent.append(r),
            o(function () {
              o(function () {
                a.isRemoved || m(n, r, a);
            ...
            i.transitionEndPromise(a.selectEl)
          );
        }
        function s(e, t, n) {
          return (
            ...
            n.disableParentScroll &&
              i.floatingScrollbars() &&
              (n.disableTarget.css("overflow", n.lastOverflow),
              delete n.lastOverflow,
              delete n.disableTarget),
            i.transitionEndPromise(t).then(function () {
              t.remove(),
        ...
        function m(e, c, d) {
          var l,
            ...
            E = {
              left: u.scrollLeft + a,
              top: u.scrollTop + a,
              bottom: h.height + u.scrollTop - a,
              right: h.width - u.scrollLeft - a,
            },
            v = { top: g.top - E.top, left: g.left - E.bottom },
            $ = h.width - 2 * a,
          ...
          (l = A
            ...
            : p.firstElementChild),
            p.offsetWidth > $ && (p.style["max-width"] = $ + "px"),
            b && (p.style["min-width"] = g.width + "px"),
            M && f.classList.add("md-overflow");
          var k = f.getBoundingClientRect(),
            y = r(l);
          if (l) {
            var x = window.getComputedStyle(l);
            (y.paddingLeft = parseInt(x["padding-left"], 10)),
              (y.paddingRight = parseInt(x["padding-right"], 10));
          }
          var C = l || T[0];
          if ((C && ((d.focusedNode = C), C.focus()), M)) {
            var N = p.offsetHeight / 2;
            (p.scrollTop = y.top + y.height / 2 - N),
              v.top < N
                ? (p.scrollTop = Math.min(y.top, p.scrollTop + N - v.top))
                : v.bottom < N &&
                  (p.scrollTop = Math.max(
                    y.top + y.height - k.height,
          ...
          b
            ? ((_ = g.left),
              ...
              (H = "50% 0"),
              S + k.height > E.bottom &&
                ((S = g.top - k.height), (H = "50% 100%")))
            : ((_ = g.left + y.left - y.paddingLeft),
              (S = g.top + g.height / 2 - y.height / 2 - y.top + p.scrollTop),
              (H =
                y.left +
                g.width / 2 +
                "px " +
                (y.top + y.height / 2 - p.scrollTop) +
                "px 0px"),
              (s.style["min-width"] =
                g.width + y.paddingLeft + y.paddingRight + "px")),
            (s.style.left = n(E.left, _, E.right) + "px"),
            (s.style.top = n(E.top, S, E.bottom) + "px"),
            (f.style[t.CSS.TRANSFORM_ORIGIN] = H),
            (f.style[t.CSS.TRANSFORM] =
              "scale(" +
              Math.min(g.width / k.width, 1) +
              "," +
              Math.min(g.height / k.height, 1) +
              ")"),
            o(function () {
              c.addClass("md-active"), (f.style[t.CSS.TRANSFORM] = "");
            });
        }
        return {
          parent: "body",
          ...
          onRemove: s,
          hasBackdrop: !0,
          disableParentScroll: i.floatingScrollbars(),
          themable: !0,
        };
      }
      function n(e, t, n) {
    ...
    angular
      ...
      .provider("$mdSelect", o),
      (e.$inject = ["$mdSelect", "$mdUtil", "$mdTheming"]),
    ...
    function e(e, t, n, r, o, a, i, c) {
      ...
      function l(n, d, l, s) {
        ...
        function v(e) {
          if (!d[0].hasAttribute("disabled")) {
            ...
            e.keyCode === o.KEY_CODE.LEFT_ARROW
              ? (t = -W)
              : e.keyCode === o.KEY_CODE.RIGHT_ARROW && (t = W),
              t &&
        ...
        function M() {
          ...
          (n.modelValue = s.$viewValue),
            d.attr("aria-valuenow", s.$viewValue),
            w(e),
            F.text(s.$viewValue);
        }
        function A(e) {
        ...
        var R = l.ngDisabled && c(l.ngDisabled),
          ...
          F = angular.element(d[0].querySelector(".md-thumb-text")),
          L = P.parent(),
    ...
    function e(e, t, n, r, o) {
      function a(e) {
        ...
        function o() {
          ...
          for (
            var e, t = m.prop("scrollTop"), n = f.items.length - 1;
            n >= 0;
            n--
          )
            if (t > f.items[n].top) {
              ...
              ? f.next.top - e <= 0
                ...
                : f.current &&
                  (f.next.top - e <= f.next.height
                    ? s(f.current, f.next.top - f.next.height - e)
                    : s(f.current, null))
              : !t &&
                f.current &&
                (e < f.current.top && d(f.prev),
                f.current &&
                  f.next &&
        ...
        function d(e) {
          if (f.current !== e) {
            f.current && (s(f.current, null), l(f.current, null)),
              e && l(e, "active"),
              (f.current = e);
  ...
  (function () {
    ...
    function e(e, t, n) {
      return {
        ...
        transclude: !0,
        template:
          '<h2 class="md-subheader"><span class="md-subheader-content"></span></h2>',
        ...
        return (
          ...
          function (e, t, d, l) {
            ...
            i(function () {
              ...
              c.register(g, "drag"),
              g.on("$md.dragstart", s).on("$md.drag", m).on("$md.dragend", u);
            var b;
          }
        );
      }
      ...
      function t(e, t, r) {
        function o(o, a, c) {
          return (
            ...
            c.parent.addClass(i(c.position)),
        ...
        function a(e, n, r) {
          return (
            ...
            r.parent.removeClass(i(r.position)),
            t.leave(n)
          );
        }
        function i(e) {
          ...
          function c() {
            ...
            function c() {
              (l = a.prop("offsetHeight")),
                s.css("margin-top", -l * f + "px"),
                d();
            }
            function d(e) {
              var n = e ? e.target.scrollTop : u;
              h(),
                (m = Math.min(l / f, Math.max(0, m + n - u))),
                a.css(t.CSS.TRANSFORM, "translate3d(0," + -m * f + "px,0)"),
                s.css(
                  t.CSS.TRANSFORM,
                  "translate3d(0," + (l - m) * f + "px,0)"
                ),
                (u = n);
            }
            var l,
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a, i, c, d) {
      function l(l, u, f) {
        ...
        function h() {
          E.attr("aria-describedby", u.attr("id")),
            T.append(u),
            b(),
            c.addClass(u, "md-show"),
            c.addClass(v, "md-show"),
            c.addClass($, "md-show");
        }
        function g() {
          E.removeAttr("aria-describedby"),
            d
              .all([
                c.removeClass($, "md-show"),
                c.removeClass(v, "md-show"),
                c.removeClass(u, "md-show"),
              ])
              .then(function () {
                l.visible || u.detach();
              });
        ...
        function b() {
          function e() {
            var e =
                "left" === M || "right" === M
                  ? 2 *
                    Math.sqrt(Math.pow(t.width, 2) + Math.pow(t.height / 2, 2))
                  : 2 *
                    Math.sqrt(Math.pow(t.width / 2, 2) + Math.pow(t.height, 2)),
              n =
                "left" === M
                  ? { left: 100, top: 50 }
                  : "right" === M
          ...
          (a.left = Math.min(a.left, T.prop("scrollWidth") - t.width - m)),
            (a.left = Math.max(a.left, m)),
            a.top + t.height > T.prop("scrollHeight") &&
              ((a.top = n.top - t.height), (r = "top")),
            u.css({ top: a.top + "px", left: a.left + "px" }),
            e();
        }
        a(u);
        for (
          var E = u.parent(),
            v = angular.element(
              u[0].getElementsByClassName("md-background")[0]
            ),
            $ = angular.element(u[0].getElementsByClassName("md-content")[0]),
            M = f.mdDirection;
        ...
        for (
          ...
          A !== i[0] &&
          A !== document.body &&
          (!A.tagName || "md-content" != A.tagName.toLowerCase());
        ...
        angular.isDefined(f.mdDelay) || (l.delay = s),
          u.detach(),
          u.attr("role", "tooltip"),
          u.attr("id", f.id || "tooltip_" + o.nextUid()),
          E.on("focus mouseenter touchstart", function () {
            p(!0);
          }),
          E.on("blur mouseleave touchend touchcancel", function () {
            r[0].activeElement !== E[0] && p(!1);
          }),
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a) {
      ...
      function c() {
        var e = angular.element(A.ul),
          t = angular.element(A.input),
          n = e.attr("id") || "ul_" + o.nextUid();
        e.attr("id", n), t.attr("aria-owns", n);
      }
      function d(t) {
        if (t) {
          var n = {};
          return v.itemName && (n[v.itemName] = e.selectedItem), n;
        }
      }
      function l() {
        e.$watch("searchText", function (t) {
          if (((v.index = -1), !t))
            return (v.loading = !1), (v.matches = []), (v.hidden = p()), void 0;
          var n = t.toLowerCase();
          T && T.cancel && (T.cancel(), (T = null)),
            !e.noCache && w[n] ? (v.matches = w[n]) : v.fetch(t),
            (v.hidden = p()),
            e.textChange && e.textChange(d(e.selectedItem));
        }),
          e.$watch("selectedItem", function (t) {
            e.itemChange && e.itemChange(d(t));
          });
      }
      function s(t) {
        function n(n) {
          (w[a] = n),
            t === e.searchText &&
              ((T = null), (v.loading = !1), (v.matches = n), (v.hidden = p()));
        }
        var o = e.$parent.$eval(M),
          a = t.toLowerCase();
        angular.isArray(o) ? n(o) : ((v.loading = !0), (T = r.when(o).then(n)));
      }
      function m() {
        v.hidden = !0;
      }
      function u(e) {
        switch (e.keyCode) {
          case a.KEY_CODE.DOWN_ARROW:
            if (v.loading) return;
            e.preventDefault(),
              (v.index = Math.min(v.index + 1, v.matches.length - 1)),
              E();
            break;
          case a.KEY_CODE.UP_ARROW:
            if (v.loading) return;
            e.preventDefault(), (v.index = Math.max(0, v.index - 1)), E();
            break;
          case a.KEY_CODE.ENTER:
            if (v.loading || v.index < 0) return;
            e.preventDefault(), b(v.index);
            break;
          case a.KEY_CODE.ESCAPE:
            (v.matches = []), (v.hidden = !0), (v.index = -1);
            break;
          case a.KEY_CODE.TAB:
        }
      }
      ...
      function p() {
        return 1 === v.matches.length && e.searchText === g(v.matches[0]);
      }
      function h() {
        return g(v.matches[v.index]);
      }
      function g(t) {
        return t && e.itemText ? e.itemText(d(t)) : t;
      }
      function b(t) {
        (e.selectedItem = v.matches[t]),
          (e.searchText = g(e.selectedItem) || e.searchText),
          (v.hidden = !0),
          (v.index = -1),
          (v.matches = []);
      }
      function E() {
        ...
        e < A.ul.scrollTop
          ? (A.ul.scrollTop = e)
          : t > A.ul.scrollTop + n && (A.ul.scrollTop = t - n);
      }
      var v = this,
        $ = e.itemsExpr.split(/ in /i),
        M = $[1],
        A = {
          main: t[0],
      ...
      return (
        ...
        (v.clear = f),
        (v.select = b),
        (v.getCurrentDisplayValue = h),
        (v.fetch = o.debounce(s)),
        i()
      );
    }
    angular
  ...
  (function () {
      ...
      function t(t, r, o, a) {
        function i() {
          var e = d.getSelectedItem(),
            o = !e || d.count() < 2 || c;
          if (
            (r.css("display", o ? "none" : "block"),
            !o && t.pagination && t.pagination.tabData)
          ) {
    ...
    angular.module("material.components.tabs").directive("mdTabsInkBar", e),
      (e.$inject = ["$$rAF"]);
  })()
  /*!
   * Angular Material Design
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a) {
      function i(i, d, l, s) {
        ...
        function p(t) {
          ...
          return (
            (s.$$pagingOffset = t),
            M.css(e.CSS.TRANSFORM, "translate3d(" + t + "px,0,0)"),
            M.on(e.CSS.TRANSITIONEND, n),
            o.promise
          );
        }
        function h() {
          ...
          return (
            ...
            angular.forEach(v, function (e, t) {
              var a = Math.min(o, e.offsetWidth),
                c = { element: e, left: i, width: a, right: i + a, filler: 0 };
              (c.page =
                Math.ceil(
                  c.right / (1 === m.length && t === v.length - 1 ? r : o)
                ) - 1),
                c.page >= m.length
                  ? ((c.filler = o * c.page - c.left),
                    (c.right += c.filler),
                    (c.left += c.filler),
                    (n = {
                      left: c.left,
                    ...
                    m.push(n))
                  : ((n.lastTabIndex = t), n.tabs.push(c)),
                (i = c.right),
                (l = Math.max(l, a)),
                s.push(c);
            }),
            a.css("max-width", o + "px"),
            !e && h()
              ? t()
              : { width: i, max: l, tabs: s, pages: m, tabElements: v }
          );
        }
        function b(e) {
          var t = s.indexOf(e);
        ...
        function E(e) {
          if (e !== T.page) {
            ...
            return (
              ...
              (T.page = e),
              i.$broadcast("$mdTabsPaginationChanged"),
              p(-T.tabData.pages[e].left)
            );
          }
        }
        var v = d[0].getElementsByTagName("md-tab"),
          $ = n.throttle(f),
          M = d.children(),
          A = !1,
          T = (i.pagination = {
    ...
    angular.module("material.components.tabs").directive("mdTabsPagination", e),
      (e.$inject = [
        "$mdConstant",
        "$window",
        "$$rAF",
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a, i, c) {
      ...
      function l(t, n) {
        h.content.length &&
          ...
          (h.contentScope = e.$parent.$new()),
          t.append(h.contentContainer),
          r(h.contentContainer)(h.contentScope),
          n === !0 &&
            c(
              function () {
      ...
      function u(n) {
        a.reconnectScope(h.contentScope),
          t
            .addClass("active")
            .attr({ "aria-selected": !0, tabIndex: 0 })
            .on("$md.swipeleft $md.swiperight", p),
          m(n),
          o.removeClass(h.contentContainer, "ng-hide"),
          e.onSelect();
      }
      function f(n) {
        a.disconnectScope(h.contentScope),
          t
            ...
            .off("$md.swipeleft $md.swiperight", p),
          m(n),
          o.addClass(h.contentContainer, "ng-hide"),
          e.onDeselect();
      }
      function p(t) {
        e.$apply(function () {
      ...
      (h.contentContainer = angular.element(
    ...
    angular.module("material.components.tabs").controller("$mdTab", e),
      (e.$inject = [
        "$scope",
        "$element",
        "$attrs",
  ...
  (function () {
    ...
    function e(e, t, n, r, o) {
      function a(a, i) {
        ...
        c.length
          ? c.remove()
          : (c = angular.isDefined(i.label)
              ? angular.element("<md-tab-label>").html(i.label)
              : angular
                  .element("<md-tab-label>")
                  .append(a.contents().remove()));
        var d = a.contents().remove();
        return function (a, i, l, s) {
          function m() {
            var e = c.clone();
            i.append(e), t(e)(a.$parent), (E.content = d.clone());
          }
          function u() {
            a.$apply(function () {
          ...
          function f(e) {
            e.keyCode == r.KEY_CODE.SPACE || e.keyCode == r.KEY_CODE.ENTER
              ? (i.triggerHandler("click"), e.preventDefault())
              : e.keyCode === r.KEY_CODE.LEFT_ARROW
              ? a.$evalAsync(function () {
                  v.focus(v.previous(E));
                })
              : e.keyCode === r.KEY_CODE.RIGHT_ARROW &&
                a.$evalAsync(function () {
                  v.focus(v.next(E));
                });
          }
          ...
          function b() {
            ...
            if ((i.attr({ id: e, role: "tab", tabIndex: -1 }), d.length)) {
              var t = "content_" + e;
              i.attr("aria-controls") || i.attr("aria-controls", t),
                E.contentContainer.attr({
                  id: t,
                  role: "tabpanel",
                  "aria-labelledby": e,
                });
          ...
          var E = s[0],
            v = s[1];
          o(i.addClass.bind(i, "md-tab-themed"), 0, !1),
            a.$watch(
              function () {
                return l.label;
              },
            ...
            m(),
            b(),
            e.attachTabBehavior(a, i, { colorElement: v.inkBarElement }),
            v.add(E),
            ...
            angular.isDefined(l.ngClick) || i.on("click", u),
            i.on("keydown", f),
            angular.isNumber(a.$parent.$index) && p(),
            angular.isDefined(l.mdActive) && h(),
            g();
        };
      }
      return {
  ...
  (function () {
    ...
    function e(e, t, n) {
      ...
      function a(t, n) {
        p.add(t, n),
          angular.isDefined(t.element.attr("md-active")) ||
          (-1 !== e.selectedIndex &&
            angular.isNumber(e.selectedIndex) &&
            e.selectedIndex !== h.indexOf(t))
            ? t.onAdd(h.contentArea, !0)
            : (t.onAdd(h.contentArea, !1), h.select(t)),
      ...
      function d(t, n) {
        !t ||
          ...
          t.isDisabled() ||
          (p.contains(t) &&
            (angular.isDefined(n) || (n = g(t) < e.selectedIndex),
            s(r(), n),
            (e.selectedIndex = g(t)),
            (t.isSelected = !0),
            t.onSelect(n),
      ...
      function s(t, n) {
        t &&
          t.isSelected &&
          p.contains(t) &&
          ((e.selectedIndex = -1), (t.isSelected = !1), t.onDeselect(n));
      }
      function m(e, t) {
      ...
      var g =
          ((h.contentArea = angular.element(
            t[0].querySelector(".md-tabs-content")
          )),
          (h.inRange = p.inRange),
          (h.indexOf = p.indexOf)),
        b = (h.itemAt = p.itemAt);
    ...
    angular.module("material.components.tabs").controller("$mdTabs", e),
      (e.$inject = ["$scope", "$element", "$mdUtil", "$timeout"]);
  })()
  /*!
   * Angular Material Design
   * https://github.com/angular/material
          ...
          t.$watch("selectedIndex", function (e, t) {
            if (t != e) {
              ...
              if ((o.deselect(o.itemAt(t), n), o.inRange(e))) {
                for (var r = o.itemAt(e); r && r.isDisabled(); )
                  r = e > t ? o.next(r) : o.previous(r);
                o.select(r, n);
              }
            }
          });
        }
        (t.stretchTabs = r.hasOwnProperty("mdStretchTabs")
          ? r.mdStretchTabs || "always"
          : "auto"),
          e(n),
          i(),
          c(),
          a(t.$parent, function (e) {
