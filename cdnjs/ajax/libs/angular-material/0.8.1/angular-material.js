        ...
        floatingScrollbars: function () {
          if (this.floatingScrollbars.cached === undefined) {
            var tempNode = angular.element(
              '<div style="z-index: -1; position: absolute; height: 1px; overflow-y: scroll"><div style="height: 2px;"></div></div>'
            );
  ...
  function mdCompilerService(
    ...
    this.compile = function (options) {
      ...
      return $q.all(resolve).then(function (locals) {
        ...
        var element =
          options.element ||
          angular.element("<div>").html(template.trim()).contents();
      ...
      return function createInterimElementService() {
        ...
        function InterimElement(options) {
          ...
          return (self = {
            ...
            deferred: $q.defer(),
            show: function () {
              return (showDone = $mdCompiler.compile(options).then(
      ...
      function getTileSpans() {
        return ctrl.tiles.map(function (tile) {
          return {
            row:
              parseInt(
                $mdMedia.getResponsiveAttribute(tile.attrs, "md-rowspan"),
                10
              ) || 1,
            col:
              parseInt(
                $mdMedia.getResponsiveAttribute(tile.attrs, "md-colspan"),
                10
              ) || 1,
          };
        });
    ...
    function selectDefaultOptions(
      ...
      function onShow(scope, element, opts) {
        ...
        angular.extend(opts, {
          ...
          backdrop:
            opts.hasBackdrop &&
            angular.element('<md-backdrop class="md-select-backdrop">'),
        });
          ...
          opts.loadingAsync.then(function () {
            ...
            $$rAF(function () {
              $$rAF(function () {
                ...
                optionNodes = nodesToArray(
                  opts.selectEl[0].getElementsByTagName("md-option")
                );
              });
            });
          });
        ...
        $$rAF(function () {
          $$rAF(function () {
            ...
            animateSelect(scope, element, opts);
            optionNodes = nodesToArray(
              element[0].querySelectorAll("md-option")
            );
          });
        });
      ...
      function animateSelect(scope, element, opts) {
        var containerNode = element[0],
          ...
          bounds = {
            ...
            bottom:
              parentRect.height + parentNode.scrollTop - SELECT_EDGE_MARGIN,
            right:
              parentRect.width - parentNode.scrollLeft - SELECT_EDGE_MARGIN,
          },
          spaceAvailable = {
          ...
          optionNodes = nodesToArray(
            selectNode.getElementsByTagName("md-option")
          ),
        ...
        if (centeredNode) {
          ...
          centeredRect.paddingLeft = parseInt(
            centeredStyle["padding-left"],
            10
          );
          centeredRect.paddingRight = parseInt(
            centeredStyle["padding-right"],
            10
          );
        }
        ...
        containerNode.style.left =
          clamp(bounds.left, left, bounds.right) + "px";
  ...
  function MdAutocompleteCtrl(
    ...
    function configureWatchers() {
      $scope.$watch("searchText", function (searchText) {
        ...
        if (
          !searchText ||
          searchText.length < Math.max(parseInt($scope.minLength, 10), 1)
        ) {
          self.loading = false;
          self.matches = [];
