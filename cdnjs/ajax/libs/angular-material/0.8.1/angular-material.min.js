 ...
 */,
            ...
            t(
              function () {
                o.dimBackground && u.css({ backgroundColor: T }),
                  E.addClass("md-ripple-placed md-ripple-scaled"),
                  o.outline
                    ? E.css({
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a) {
      function i(r, i) {
        var l = r.find("md-select-label").remove();
        l.length ||
          (l = angular.element(
          ...
          l.addClass(
            c + i.ngModel + " !== undefined ? '' : 'md-placeholder'" + d
          ),
          l.attr("id", "select_label_" + t.nextUid()),
        ...
        return (
          ...
          function (n, r, i, c) {
            function d() {
              if (a(i.ngModel)(n)) {
                var e = angular.element(s).find("md-select-menu");
                e.data("$ngModelController", c);
                var t = n.$new();
                e = o(e)(t);
                var r = e.controller("mdSelectMenu");
                t.$$postDigest(function () {
                  c.$render(), l(r.selectedLabels()), e.scope().$destroy();
                });
              } else l();
            }
            function l(e) {
            ...
            function m(e) {
              var t = [32, 13, 38, 40];
              -1 != t.indexOf(e.keyCode) && (e.preventDefault(), u(e));
            }
            function u() {
              n.$evalAsync(function () {
                var t = s.clone();
                t.find("md-select-menu").data("$ngModelController", c),
                  (f = !0),
                  e
                    .show({
                      scope: n.$new(),
            ...
            h || (p = p.children().eq(0)),
              ...
              void 0 === i.disabled && (r.on("click", u), r.on("keydown", m)),
              r.attr({
                role: "combobox",
                id: "select_" + t.nextUid(),
                "aria-haspopup": !0,
                "aria-expanded": "false",
                "aria-labelledby": p.attr("id"),
              }),
              n.$on("$destroy", function () {
                f && e.cancel();
              });
      ...
      var c = r.startSymbol(),
        d = r.endSymbol();
      return { restrict: "E", require: "?ngModel", compile: i };
    }
    function t(e, t, n) {
      function r(e, r, o, a) {
        function i() {
      ...
      function o(t, n, r) {
        ...
        function i() {
          ...
          Object.keys(d.selected).forEach(d.deselect),
            d.select(d.hashGetter(e), e);
        }
        var d = this;
        (d.isMultiple = angular.isDefined(n.multiple)),
          (d.selected = {}),
          (d.options = {}),
          (d.init = function (r) {
            function a(e, t) {
          ...
          (d.addOption = function (e, t) {
            if (angular.isDefined(d.options[e]))
              throw new Error(
            ...
            (d.options[e] = t),
              angular.isDefined(d.selected[e]) &&
                (d.select(e, t.value), d.refreshViewValue());
          }),
          ...
          (d.refreshViewValue = function () {
            var e,
              t = [];
            for (var n in d.selected)
              (e = d.options[n]) ? t.push(e.value) : t.push(d.selected[n]);
      ...
      function t(e, t, o, c, d, l) {
        function s(n, r, i) {
          ...
          function m() {
            function o() {
              var e;
              -1 == (e = f.indexOf(i.focusedNode))
                ? (e = Math.floor((f.length - 1) / 2))
                : e < f.length - 1 && ++e,
                (i.focusedNode = f[e]),
                f[e].focus();
            }
            ...
            if (!i.isRemoved) {
              var d = i.selectEl.controller("mdSelectMenu") || {};
                  ...
                  o(function () {
                    o(function () {
                      i.isRemoved ||
                        (u(n, r, i),
                        (f = a(
                          i.selectEl[0].getElementsByTagName("md-option")
                        )));
                    });
                  });
              }),
            i.disableParentScroll &&
              ((i.disableTarget = i.parent.find("md-content")),
              i.disableTarget.length || (i.disableTarget = i.parent),
              (i.lastOverflow = i.disableTarget.css("overflow")),
              i.disableTarget.css("overflow", "hidden")),
            l(m, 75, !1),
            i.backdrop &&
              (d.inherit(i.backdrop, i.parent), i.parent.append(i.backdrop)),
            i.parent.append(r),
            o(function () {
              o(function () {
                i.isRemoved ||
                  (u(n, r, i), (f = a(r[0].querySelectorAll("md-option"))));
              });
            }),
        ...
        function m(e, t, n) {
          return (
            ...
            c.transitionEndPromise(t).then(function () {
              t.remove(),
        ...
        function u(e, d, l) {
          var s,
            ...
            E = {
              left: f.scrollLeft + i,
              top: f.scrollTop + i,
              bottom: g.height + f.scrollTop - i,
              right: g.width - f.scrollLeft - i,
            },
            $ = {
              top: b.top - E.top,
              left: b.left - E.left,
              right: E.right - (b.left + b.width),
              bottom: E.bottom - (b.top + b.height),
            },
            M = g.width - 2 * i,
            A = h.scrollHeight > h.offsetHeight,
            T = p.querySelector("md-option[selected]"),
            w = a(p.getElementsByTagName("md-option")),
            k = p.getElementsByTagName("md-optgroup");
          (s = T
            ? T
            : k.length
            ? w[0]
            ...
            h.offsetWidth > M && (h.style["max-width"] = M + "px"),
            v && (h.style["min-width"] = b.width + "px"),
            A && p.classList.add("md-overflow");
          var y = p.getBoundingClientRect(),
            x = r(s);
          if (s) {
            var C = window.getComputedStyle(s);
            (x.paddingLeft = parseInt(C["padding-left"], 10)),
              (x.paddingRight = parseInt(C["padding-right"], 10));
          }
          var N = s || w[0];
          if ((N && ((l.focusedNode = N), N.focus()), A)) {
            var _ = h.offsetHeight / 2;
            (h.scrollTop = x.top + x.height / 2 - _),
              $.top < _
                ? (h.scrollTop = Math.min(x.top, h.scrollTop + _ - $.top))
                : $.bottom < _ &&
                  (h.scrollTop = Math.max(
                    x.top + x.height - y.height,
                    h.scrollTop - _ + $.bottom
                  ));
          }
          var S, H, D;
          v
            ? ((S = b.left),
              ...
              (D = "50% 0"),
              H + y.height > E.bottom &&
                ((H = b.top - y.height), (D = "50% 100%")))
            : ((S = b.left + x.left - x.paddingLeft),
              (H = b.top + b.height / 2 - x.height / 2 - x.top + h.scrollTop),
              (D =
                x.left +
                b.width / 2 +
                "px " +
                (x.top + x.height / 2 - h.scrollTop) +
                "px 0px"),
              (m.style["min-width"] =
                b.width + x.paddingLeft + x.paddingRight + "px")),
            (m.style.left = n(E.left, S, E.right) + "px"),
            (m.style.top = n(E.top, H, E.bottom) + "px"),
            (p.style[t.CSS.TRANSFORM_ORIGIN] = D),
            (p.style[t.CSS.TRANSFORM] =
              ...
              ")"),
            o(function () {
              d.addClass("md-active"), (p.style[t.CSS.TRANSFORM] = "");
            });
        }
        return {
          parent: "body",
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a, i, c, d) {
      function l(l, u, f) {
        ...
        function h() {
          v.attr("aria-describedby", u.attr("id")),
            T.append(u),
            b(),
        ...
        for (
          var v = u.parent(),
            ...
            M = f.mdDirection;
          "none" == t.getComputedStyle(v[0])["pointer-events"];
        ...
        angular.isDefined(f.mdDelay) || (l.delay = s),
          ...
          v.on("focus mouseenter touchstart", function () {
            p(!0);
          }),
  ...
  (function () {
    ...
    function e(e, t, n, r, o, a) {
      ...
      function d(t) {
        if (t) {
          var n = {};
          return E.itemName && (n[E.itemName] = e.selectedItem), n;
        }
      }
      function l() {
        e.$watch("searchText", function (t) {
          if (
            ((E.index = -1),
            !t || t.length < Math.max(parseInt(e.minLength, 10), 1))
          )
            return (E.loading = !1), (E.matches = []), (E.hidden = p()), void 0;
          var n = t.toLowerCase();
          T && T.cancel && (T.cancel(), (T = null)),
            !e.noCache && w[n] ? (E.matches = w[n]) : E.fetch(t),
            (E.hidden = p()),
      ...
      function s(t) {
        function n(n) {
          (w[a] = n),
            t === e.searchText &&
              ((T = null), (E.loading = !1), (E.matches = n), (E.hidden = p()));
        }
        var o = e.$parent.$eval(M),
          a = t.toLowerCase();
        angular.isArray(o) ? n(o) : ((E.loading = !0), (T = r.when(o).then(n)));
      }
      function m() {
        E.hidden = !0;
      }
      function u(e) {
        switch (e.keyCode) {
          case a.KEY_CODE.DOWN_ARROW:
            if (E.loading) return;
            e.preventDefault(),
              (E.index = Math.min(E.index + 1, E.matches.length - 1)),
              v();
            break;
          case a.KEY_CODE.UP_ARROW:
            if (E.loading) return;
            e.preventDefault(), (E.index = Math.max(0, E.index - 1)), v();
            break;
          case a.KEY_CODE.ENTER:
            if (E.loading || E.index < 0) return;
            e.preventDefault(), b(E.index);
            break;
          case a.KEY_CODE.ESCAPE:
            (E.matches = []), (E.hidden = !0), (E.index = -1);
            break;
          case a.KEY_CODE.TAB:
        }
      }
      ...
      function p() {
        return 1 === E.matches.length && e.searchText === g(E.matches[0]);
      }
      function h() {
        return g(E.matches[E.index]);
      }
      function g(t) {
        return t && e.itemText ? e.itemText(d(t)) : t;
      }
      function b(t) {
        (e.selectedItem = E.matches[t]),
      ...
      return (
        ...
        (E.clear = f),
        (E.select = b),
        (E.getCurrentDisplayValue = h),
        (E.fetch = o.debounce(s)),
        i()
      );
    }
    angular
        ...
        function g(e) {
          ...
          return (
            ...
            angular.forEach(E, function (e, t) {
              ...
              (c.page =
                Math.ceil(
                  c.right / (1 === m.length && t === E.length - 1 ? r : o)
                ) - 1),
                c.page >= m.length
            ...
            !e && h()
              ? t()
              : { width: i, max: l, tabs: s, pages: m, tabElements: E }
          );
        }
        function b(e) {
          var t = s.indexOf(e);
      ...
      function a(a, i) {
        ...
        return function (a, i, l, s) {
          ...
          o(i.addClass.bind(i, "md-tab-themed"), 0, !1),
            ...
            m(),
            b(),
            e.attachTabBehavior(a, i, { colorElement: E.inkBarElement }),
            E.add(v),
