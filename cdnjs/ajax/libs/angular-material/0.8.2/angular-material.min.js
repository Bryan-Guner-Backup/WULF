        ...
        return (
          ...
          function (n, r, a, i) {
            function d() {
              ...
              e.data("$ngModelController", h),
                e.data("$mdSelectController", p),
                (f = n.$new()),
                (u = o(u)(f));
            }
            function l(e) {
            ...
            (h.$render = function () {
              ...
              (p.setIsPlaceholder = function (e) {
                e
                  ? g.addClass("md-placeholder")
                  : g.removeClass("md-placeholder");
              }),
              ...
              void 0 === a.disabled && (r.on("click", s), r.on("keydown", l)),
              r.attr({
                role: "combobox",
      ...
      function t(e, t, o, c, d, l) {
        ...
        function u(e, a, d) {
          ...
          b
            ...
            (s.style.left = n(v.left, _, v.right) + "px"),
            (s.style.top = n(v.top, S, v.bottom) + "px"),
