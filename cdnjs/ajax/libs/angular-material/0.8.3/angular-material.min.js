    ...
    function e(e, t, n, r, o) {
      function a(r, a) {
        ...
        i.length ||
          ...
          i.append('<span class="md-select-icon" aria-hidden="true"></span>'),
          i.addClass("md-select-label"),
          i.attr("id", "select_label_" + t.nextUid()),
        ...
        var c =
          ...
          (angular.isDefined(a.multiple) ? "multiple" : "") +
          ">" +
          r.html() +
          "</md-select-menu></div>";
        return (
          ...
          function (n, r, a, i) {
            ...
            function l() {
              ...
              e.data("$ngModelController", g),
                e.data("$mdSelectController", h),
                (p = n.$new()),
                (f = o(f)(p));
            }
            function s(e) {
            ...
            (g.$render = function () {
              ...
              (h.setIsPlaceholder = function (e) {
                e
                  ? b.addClass("md-placeholder")
                  : b.removeClass("md-placeholder");
              }),
              n.$$postDigest(d),
              ...
              a.disabled ||
                a.ngDisabled ||
                (r.attr("tabindex", 0), r.on("click", m), r.on("keydown", s)),
              r.attr({
                role: "combobox",
          ...
          angular.isDefined(e) &&
            (e
              ? (l.isMultiple || l.deselect(Object.keys(l.selected)[0]),
                l.select(d.hashKey, d.value))
              : l.deselect(d.hashKey),
            l.refreshViewValue(),
            l.ngModel.$render());
        }),
      ...
      function t(e, t, o, c, d, l) {
        ...
        function m(e, t, n) {
          ...
          return (
            ...
            c.transitionEndPromise(t, { timeout: 350 }).then(function () {
        ...
        function u(e, a, d) {
          ...
          if (l) {
            ...
            (y.paddingLeft = parseInt(x.paddingLeft, 10) || 0),
              (y.paddingRight = parseInt(x.paddingRight, 10) || 0);
          }
          var C = l;
          if (
            ("MD-OPTGROUP" === (C.tagName || "").toUpperCase() &&
              (C = T[0] || p.firstElementChild || p),
            C && ((d.focusedNode = C), C.focus()),
            M)
          ) {
            var N = p.offsetHeight / 2;
            (p.scrollTop = y.top + y.height / 2 - N),
              E.top < N
                ? (p.scrollTop = Math.min(y.top, p.scrollTop + N - E.top))
                : E.bottom < N &&
                  (p.scrollTop = Math.max(
                    y.top + y.height - k.height,
                    p.scrollTop - N + E.bottom
                  ));
          }
          var _, S, H;
          b
          ...
          (s.style.left = n(v.left, _, v.right - D.width) + "px"),
    ...
    function t(e, t, n, r, o, a, i, c, d, l) {
      function s(s, m, u, f) {
        function p(e, n) {
          (s.isLockedOpen = e),
            e === n
              ? m.toggleClass("md-locked-open", !!e)
              : t[e ? "addClass" : "removeClass"](m, "md-locked-open"),
            T.toggleClass("md-locked-open", !!e);
        }
        function h(e) {
          var n = m.parent();
          return (
            n[e ? "on" : "off"]("keydown", b),
            T[e ? "on" : "off"]("click", v),
            e && (E = l[0].activeElement),
            ($ = d.all([
              t[e ? "enter" : "leave"](T, n),
              t[e ? "removeClass" : "addClass"](m, "md-closed").then(
                function () {
                  s.isOpen && m.focus();
                }
              ),
        ...
        var E = null,
          ...
          T = i('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(
            s
          );
        m.on("$destroy", f.destroy),
          c.inherit(T, m),
          s.$watch(A, p),
          s.$watch("isOpen", h),
          (f.$toggleOpen = g);
      ...
      function l(l, u, f) {
        ...
        function b() {
          ...
          function t(e) {
            ...
            return (
              (t.left = Math.min(t.left, T.prop("scrollWidth") - r.width - m)),
              (t.left = Math.max(t.left, m)),
              (t.top = Math.min(t.top, T.prop("scrollHeight") - r.height - m)),
              (t.top = Math.max(t.top, m)),
              t
            );
          }
          function n(e) {
          ...
          M
            ? (i = t(i))
            : i.top > T.prop("scrollHeight") - r.height - m &&
              (i = t(n("top"))),
  ...
  (function () {
    ...
    function e(e, t, n, r, o) {
      ...
      function d() {
        ...
        e.$watch("searchText", t ? r.debounce(l, t) : l),
          e.$watch("selectedItem", function (t, n) {
      ...
      function l(t, n) {
        if (
          ...
          return (
            (M.loading = !1), (M.matches = []), (M.hidden = g()), m(), void 0
          );
        var r = t.toLowerCase();
        k && k.cancel && (k.cancel(), (k = null)),
          !e.noCache && y[r] ? ((M.matches = y[r]), m()) : M.fetch(t),
          (M.hidden = g()),
          e.textChange && t !== n && e.textChange(c(e.selectedItem));
      }
      function s(t) {
        function r(n) {
          (y[a] = n),
        ...
        if (!M.hidden)
          switch (M.matches.length) {
            ...
            default:
              return M.messages.push({
                display:
                  "There are " + M.matches.length + " matches available.",
              });
          }
      }
      function u() {
      ...
      function E(t) {
        (e.selectedItem = M.matches[t]),
          (e.searchText = v(e.selectedItem) || e.searchText),
          (M.hidden = !0),
          (M.index = -1),
          (M.matches = []);
      }
      function $() {
        ...
        e < w.ul.scrollTop
          ? (w.ul.scrollTop = e)
          : t > w.ul.scrollTop + n && (w.ul.scrollTop = t - n);
      }
      var M = this,
      ...
      return (
        ...
        (M.clear = h),
        (M.select = E),
        (M.getCurrentDisplayValue = b),
        (M.fetch = r.debounce(s)),
        (M.messages = []),
    ...
    angular
      ...
      (e.$inject = ["$scope", "$element", "$q", "$mdUtil", "$mdConstant"]);
  })()
  /*!
   * Angular Material Design
   * https://github.com/angular/material
