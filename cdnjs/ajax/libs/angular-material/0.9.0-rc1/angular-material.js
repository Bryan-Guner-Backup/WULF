    ...
    function ($cacheFactory, $document, $timeout, $q, $window, $mdConstant) {
      ...
      return (Util = {
        ...
        disableScrollAround: function (element) {
          ...
          while (
            (parentContent = this.getClosest(
              parentContent.parentNode,
              "MD-CONTENT"
            ))
          ) {
          ...
          var scrollBarsShowing =
            !Util.floatingScrollbars() &&
...
(function (jQuery) {
  ...
  function MdGesture($$MdGestureHandler, $$rAF, $timeout) {
    ...
    var self = {
      ...
      isHijackingClicks:
        (isIos || isAndroid) && !jQuery && !forceSkipClickHijack,
    };
    ...
    function postLink(scope, element, attrs, ctrl) {
      ...
      function layoutDelegate(tilesAdded) {
        ...
        var tiles = getTileElements(),
          performance = $mdGridLayout(props.colCount, props.tileSpans, tiles)
...
(function () {
  ...
  function placeholderDirective() {
    ...
    function postLink(scope, element, attr, inputContainer) {
      ...
      var placeholder =
        '<div class="md-placeholder" ng-click="delegateClick()">' +
        placeholderText +
        "</div>";
      ...
      compile: function (tEl, tAttrs) {
        ...
        function wrapIn(type) {
          ...
          if (type == "div") {
            ...
            container = angular.element(
              '<button tabindex="0" class="md-no-style"><div class="md-list-item-inner"></div></button>'
            );
            container[0].setAttribute(
              "ng-click",
              tEl[0].getAttribute("ng-click")
            );
        ...
        function postLink($scope, $element, $attr) {
          ...
          function computeProxies() {
            if (!$element.children()[0].hasAttribute("ng-click")) {
              angular.forEach(proxiedTypes, function (type) {
                angular.forEach(
                  $element[0].firstElementChild.querySelectorAll(type),
                  function (child) {
                    proxies.push(child);
                  }
                );
          ...
          function computeClickable() {
            if (
              proxies.length ||
              $element[0].firstElementChild.hasAttribute("ng-click")
            ) {
          ...
          if (
            ...
            $element[0].firstElementChild.addEventListener(
              "keypress",
              function (e) {
  ...
  function MdChips($mdTheming, $compile, $timeout) {
    ...
    function compile(element, attr) {
      ...
      var chipRemoveTemplate =
          getTemplateByQuery("[md-chip-remove]") || CHIP_REMOVE_TEMPLATE,
        chipContentsTemplate =
          getTemplateByQuery("md-chip-template") || CHIP_DEFAULT_TEMPLATE,
        chipInputTemplate =
          getTemplateByQuery("md-autocomplete") ||
...
(function () {
  ...
  MdContactChipsCtrl.prototype.queryContact = function (searchText) {
    ...
    return this.filterSelected
      ? results.filter(this.filterSelectedContacts.bind(this))
      : results;
  };
...
(function () {
  ...
  function MdTabsController(
    ...
    function getElements() {
      ...
      elements.canvas =
        elements.wrapper.getElementsByTagName("md-tabs-canvas")[0];
      ...
      elements.contents =
        elements.contentsWrapper.getElementsByTagName("md-tab-content");
