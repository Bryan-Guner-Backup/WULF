 ...
 */,
      ...
      function (t, n, o, r, a, i) {
        ...
        return (c = {
          ...
          disableScrollAround: function (e) {
            function t() {
              f ? i.attr("style", f) : i[0].removeAttribute("style"),
                h.css("position", "static");
              var e = a.getComputedStyle(i[0]);
              o(e);
              var t = parseFloat(e.width, 10);
              "border-box" == e.boxSizing &&
                ((t -= parseFloat(e.paddingLeft, 10)),
                (t -= parseFloat(e.paddingRight, 10))),
                h.css({ "max-width": t + "px" }),
                i.css("position", "relative"),
                h.css("position", "fixed");
            }
            function o(e) {
              var t =
                !c.floatingScrollbars() && r(d) && "hidden" != e.overflowY;
              t && i.css("overflow-y", "scroll");
              var n = parseFloat(e.height, 10);
              "border-box" == e.boxSizing &&
                ((n -= parseFloat(e.paddingTop, 10)),
                (n -= parseFloat(e.paddingBottom, 10))),
                r(d)
                  ? h.css("min-height", "100%")
                  : (h.css("max-height", n + "px"), h.css("height", "100%")),
                i.css("height", n + "px");
            }
            function r(e) {
              return (e = e[0] || e), e.scrollHeight > e.offsetHeight;
            }
            for (
              var i, d, l, m = e[0] || e;
              (m = this.getClosest(m.parentNode, "MD-CONTENT", !0));

            )
              r(m) && (i = angular.element(m));
            i || (i = angular.element(n[0].body)),
              "BODY" == i[0].nodeName && n[0].documentElement.scrollTop
                ? ((d = n[0].documentElement), (l = !0))
                : (d = i[0]);
            var s = d.scrollTop,
              u = s;
            l || (s -= i[0].offsetTop);
            var f = i.attr("style"),
              p = a.getComputedStyle(i[0]),
              h = angular.element("<div>");
            return (
              i.addClass("md-overflow-wrapper-shown"),
              h.append(i.children()),
              i.append(h),
              o(p),
              h.attr("layout-margin", i.attr("layout-margin")),
              h.css({
                overflow: "hidden",
                position: "fixed",
                display: p.display,
                "-webkit-flex-direction": p.webkitFlexDirection,
                "-ms-flex-direction": p.msFlexDirection,
                "flex-direction": p.flexDirection,
                "-webkit-align-items": p.webkitAlignItems,
                "-ms-flex-align": p.msFlexAlign,
                "align-items": p.alignItems,
                "-webkit-justify-content": p.webkitJustifyContent,
                "-ms-flex-pack": p.msFlexPack,
                "justify-content": p.justifyContent,
                "-webkit-flex": p.webkitFlex,
                "-ms-flex": p.msFlex,
                flex: p.flex,
          ...
          e.all(s).then(function (e) {
            ...
            return {
              ...
              link: function (t) {
                if (((e.$scope = t), l)) {
                  var o = r(l, e);
                  p && angular.extend(o, e),
                    n.data("$ngControllerController", o),
                    n.children().data("$ngControllerController", o),
                    m && (t[m] = o);
                }
                return a(t);
              },
        ...
        return function () {
          ...
          function s(i) {
            ...
            return (
              ...
              i.template && (i.template = f(i.template)),
              (l = {
                options: i,
                deferred: t.defer(),
                show: function () {
                    ...
                    (p = n.then(
                      function (n) {
                        ...
                        angular.extend(n.locals, l.options),
                          ...
                          (i.parent || {}).length ||
                            ((i.parent = r.find("body")),
                            i.parent.length || (i.parent = r),
                            "#comment" == i.parent[0].nodeName &&
                              (i.parent = e.find("body"))),
                          i.themable && c(s);
      ...
      function i(n, o, r) {
        ...
        function l(n, d) {
          ...
          return (
            ...
            t(
              function () {
                r.dimBackground && u.css({ backgroundColor: T }),
                  v.addClass("md-ripple-placed md-ripple-scaled"),
                  r.outline
                    ? v.css({
                        borderWidth: 0.5 * p + "px",
                        marginLeft: p * -0.5 + "px",
                        marginTop: p * -0.5 + "px",
                      })
        ...
        function t(e) {
          if (((e = 0 === arguments.length ? !0 : !!e), e !== n.isDark)) {
            (n.isDark = e),
              ...
              (n.foregroundShadow = n.isDark ? f : p);
            var t = n.isDark ? $ : M,
              o = n.isDark ? M : $;
            return (
      ...
      function t(e, t, r, a, i, d, c, l, m) {
        function s(n, o, m) {
          (o = r.extractElementByName(o, "md-bottom-sheet")),
            (p = i('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(
              n
            )),
            p.on("click", function () {
              a(c.cancel);
            }),
            d.inherit(p, m.parent),
            e.enter(p, m.parent, null);
          var s = new f(o, m.parent);
          return (
            (m.bottomSheet = s),
          ...
          return (
            ...
            e.leave(r.element).then(function () {
              o.disableParentScroll &&
                (o.parent.css("overflow", o.lastOverflow),
                delete o.lastOverflow),
                r.cleanup(),
        ...
        function f(e, r) {
          ...
          function l(o) {
            if (
              ...
              e.css(t.CSS.TRANSITION_DURATION, ""), e.css(t.CSS.TRANSFORM, "");
          }
  ...
  (function () {
    ...
    angular
      ...
      (e.$inject = ["$mdInkRipple", "$mdTheming", "$mdAria", "$timeout"]);
  })()
  /*!
   * Angular Material Design
   * https://github.com/angular/material
  ...
  (function () {
    ...
    function e(e) {
      ...
      return {
        ...
        link: function (n, o) {
          o[0];
          e(o), n.$broadcast("$mdContentLoaded", o), t(o[0]);
        },
      };
    }
    function t(e) {
    ...
    function t(e) {
      ...
      function n(e, t, n, o, r, a, i, d, c, l, m) {
        ...
        function u(e, l, m) {
          ...
          return (
            "alert" === m.$type &&
              ((v = "alertdialog"), (M = l.find("md-content"))),
            p(l.find("md-dialog"), v, m),
        ...
        function f(e, t, n) {
          return (
            ...
            n.clickOutsideToClose &&
              t.off("click", n.dialogClickOutsideCallback),
            g(t, !1),
  ...
  (function () {
    ...
    function e(e, n, o, r) {
      function a(t, a, i, d) {
        function c() {
          for (var e in n.MEDIA) r(e), r.getQuery(n.MEDIA[e]).addListener(A);
        ...
        function l() {
          T();
          for (var e in n.MEDIA) r.getQuery(n.MEDIA[e]).removeListener(A);
        }
        function m(e) {
        ...
        function s(e) {
          ...
          if (e || !angular.equals(n, C)) {
            var r = h(),
              i = o(n.colCount, n.tileSpans, r)
                .map(function (e, t) {
                  return {
                    grid: {
                      element: a,
                      style: p(n.colCount, t, n.gutter, n.rowMode, n.rowHeight),
                    },
                    tiles: e.map(function (e, t) {
                      return {
                        element: angular.element(r[t]),
                        style: f(
                          e.position,
                          e.spans,
                          n.colCount,
                ...
                .reflow()
                .performance();
            t.mdOnLayout({ $event: { performance: i } }), (C = n);
          }
        }
        function u(e) {
          return w + e + k;
        ...
        function f(e, t, n, o, r, a, i) {
          var d = (1 / n) * 100,
            c = (n - 1) / n,
            l = y({ share: d, gutterShare: c, gutter: r }),
            m = {
              left: x({ unit: l, offset: e.col, gutter: r }),
              width: N({ unit: l, span: t.col, gutter: r }),
              paddingTop: "",
              marginTop: "",
              top: "",
              height: "",
          ...
          switch (a) {
            case "fixed":
              (m.top = x({ unit: i, offset: e.row, gutter: r })),
                (m.height = N({ unit: i, span: t.row, gutter: r }));
              break;
            case "ratio":
              var s = d / i,
                u = y({ share: s, gutterShare: c, gutter: r });
              (m.paddingTop = N({ unit: u, span: t.row, gutter: r })),
                (m.marginTop = x({ unit: u, offset: e.row, gutter: r }));
              break;
            case "fit":
              var f = (o - 1) / o,
                s = (1 / o) * 100,
                u = y({ share: s, gutterShare: f, gutter: r });
              (m.top = x({ unit: u, offset: e.row, gutter: r })),
                (m.height = N({ unit: u, span: t.row, gutter: r }));
          }
          return m;
        }
        function p(e, t, n, o, r) {
          ...
          switch (o) {
            case "fixed":
              a.height = N({ unit: r, span: t, gutter: n });
              break;
            case "ratio":
              var i = 1 === e ? 0 : (e - 1) / e,
                d = (1 / e) * 100,
                c = d * (1 / r),
                l = y({ share: c, gutterShare: i, gutter: n });
              a.paddingBottom = N({ unit: l, span: t, gutter: n });
              break;
            case "fit":
          }
          return a;
        ...
        function g() {
          return d.tiles.map(function (e) {
            return {
              row:
                parseInt(r.getResponsiveAttribute(e.attrs, "md-rowspan"), 10) ||
                1,
              col:
                parseInt(r.getResponsiveAttribute(e.attrs, "md-colspan"), 10) ||
                1,
            };
          });
        }
        ...
        r.addTile(n, o, t.$parent.$index),
          ...
          angular.isDefined(t.$parent.$index) &&
            t.$watch(
              ...
              function (e) {
                r.removeTile(n, o), r.addTile(n, o, e);
              }
            );
      }
      return {
    ...
    angular
      ...
      (t.prototype = {
        addTile: function (e, t, n) {
          var o = { element: e, attrs: t };
          angular.isUndefined(n)
            ? this.tiles.push(o)
            : this.tiles.splice(n, 0, o),
            (this.tilesAdded = !0),
  ...
  (function () {
    ...
    function e() {}
    function t(e, t) {
      (this.url = e), (this.iconSize = t || o.defaultIconSize);
    }
        ...
        angular.forEach(
          {
            ...
            viewBox:
              this.element.getAttribute("viewBox") || "0 0 " + t + " " + t,
          },
          function (e, t) {
    ...
    e.prototype = {
      ...
      iconSet: function (e, n, r) {
        return (o[e] = new t(n, r)), this;
      },
      defaultIconSet: function (e, n) {
        var r = "$default";
        return (
          o[r] || (o[r] = new t(e, n)),
          (o[r].iconSize = n || o.defaultIconSize),
          this
        );
      },
      ...
      $get: [
        ...
        "$templateCache",
        function (e, t, r, a) {
          return this.preloadIcons(a), new n(o, e, t, r, a);
        },
      ],
    };
  })()
  ...
  (function () {
      ...
      return {
        ...
        compile: function (r, a) {
          ...
          function l(e, r, a, i) {
            function d() {
              ...
              e.length &&
                ...
                angular.forEach(o, function (e) {
                  angular.forEach(
                    r[0].firstElementChild.querySelectorAll(e),
                    function (e) {
                      l.push(e);
                    }
                  );
            ...
            function c() {
              (l.length || r[0].firstElementChild.hasAttribute("ng-click")) &&
            ...
            d(),
              ...
              r[0].firstElementChild.hasAttribute("ng-click") ||
                l.length ||
                r[0].firstElementChild.addEventListener(
                  "keypress",
                  function (e) {
                    "INPUT" != e.target.nodeName &&
                      e.keyCode == t.KEY_CODE.SPACE &&
                      (r[0].firstElementChild.click(),
                      e.preventDefault(),
                      e.stopPropagation());
                  }
                ),
              ...
              l.length &&
                r
                  ...
                  .eq(0)
                  .on("click", function (e) {
                    r[0].firstElementChild.contains(e.target) &&
                      angular.forEach(l, function (t) {
                        e.target === t ||
                          t.contains(e.target) ||
          ...
          if ((r[0].setAttribute("role", "listitem"), a.ngClick)) d("button");
            ...
            for (var f, p = 0; (f = o[p]); ++p)
              if ((s = r[0].querySelector(f))) {
                m = !0;
                break;
              }
    ...
    angular
      ...
      (e.$inject = ["$mdTheming"]),
      (t.$inject = ["$mdAria", "$mdConstant", "$timeout"]),
      (n.$inject = ["$scope", "$element", "$mdInkRipple"]);
  })()
  /*!
   * Angular Material Design
   * https://github.com/angular/material
    ...
    function e(e, n, o) {
      ...
      function a(r, a, d) {
        ...
        d.$observe("value", function (e) {
          if ("query" != d.mdMode) {
            var o = i(e);
            a.attr("aria-valuenow", o), (l[n.CSS.TRANSFORM] = t[o]);
          }
        }),
  ...
  (function () {
    ...
    function e(e, t, n, o, r, a) {
      function i(o, i) {
        var d = o.find("md-select-label").remove();
        if (d.length) {
        ...
        if (
          ...
          o.find("md-content").length ||
            o.append(angular.element("<md-content>").append(o.contents())),
          i.mdOnOpen &&
            o
              .find("md-content")
              .prepend(
        ...
        return (
          ...
          function (n, o, i, d) {
            ...
            var f,
              ...
              v = d[1],
              M = d[2],
              $ = o.find("md-select-label"),
              A = 0 !== $.text().length;
            if ((l(), i.name && M)) {
              var T = o
                .parent()[0]
                .querySelector('select[name=".' + i.name + '"]');
            ...
            i.$observe("ngMultiple", function (e) {
              ...
              i.$observe("disabled", function (e) {
                "string" == typeof e && (e = !0),
                  (void 0 === p || p !== e) &&
                    ((p = e),
                    e
                      ? (o.attr({ tabindex: -1, "aria-disabled": "true" }),
                        o.off("click", u),
                        o.off("keydown", m))
                      : (o.attr({
                          tabindex: i.tabindex,
              ...
              i.disabled ||
                i.ngDisabled ||
                (o.attr({ tabindex: i.tabindex, "aria-disabled": "false" }),
                o.on("click", u),
                o.on("keydown", m)),
              o.attr({
                role: "combobox",
      ...
      function r(t, n, o) {
        function r() {
          ...
          if (angular.isArray(e)) {
            var t = Object.keys(c.selected),
              n = e.map(c.hashGetter),
        ...
        var c = this;
        (c.isMultiple = angular.isDefined(n.multiple)),
          (c.selected = {}),
          (c.options = {});
        var l;
        ...
        (c.optNodeForKeyboardSearch = function (e) {
            ...
            if (((c.ngModel = n), n.$options && n.$options.trackBy)) {
              ...
              c.hashGetter = function (e) {
                return angular.isObject(e)
                  ? "$$object_" + (e.$$mdSelectId || (e.$$mdSelectId = ++d))
                  : e;
              };
            c.setMultiple(c.isMultiple);
          }),
          (c.selectedLabels = function () {
            var e = a(o[0].querySelectorAll("md-option[selected]"));
            return e.length
              ? e
                  .map(function (e) {
          ...
          (c.addOption = function (e, t) {
            if (angular.isDefined(c.options[e]))
              throw new Error(
            ...
            (c.options[e] = t),
              angular.isDefined(c.selected[e]) &&
                (c.select(e, t.value), c.refreshViewValue());
          }),
    ...
    function n(e, t) {
      function n(e, t) {
        return (
          e.append(
            angular.element('<div class="md-text">').append(e.contents())
          ),
    ...
    function r(e) {
      function t(e, t, r, d, c, l, m) {
        function s(n, o, i) {
          function s() {
            i.selectEl.attr("aria-labelledby", i.target.attr("id")),
          ...
          function u() {
            ...
            if (!i.isRemoved) {
              ...
              o.addClass("md-clickable"),
                ...
                i.selectEl.on("keydown", function (o) {
                  switch (o.keyCode) {
                    case t.KEY_CODE.SPACE:
                    case t.KEY_CODE.ENTER:
                      var r = d.getClosest(o.target, "md-option");
                      r &&
          ...
          angular.extend(i, {
            ...
            angular.element(m).on("resize", i.resizeFn),
            angular.element(m).on("orientationchange", i.resizeFn),
            s(),
          ...
          return (
            ...
            i.disableParentScroll && !d.getClosest(i.target, "MD-DIALOG")
              ? (i.restoreScroll = d.disableScrollAround(i.target))
              : (i.disableParentScroll = !1),
            l(u, 75, !1),
            i.backdrop &&
              (c.inherit(i.backdrop, i.parent), i.parent.append(i.backdrop)),
            i.parent.append(o),
            r(function () {
              r(function () {
                i.isRemoved || f(n, o, i);
        ...
        function u(e, t, n) {
          (n.isRemoved = !0),
            ...
            angular.element(m).off("resize", n.resizefn),
            angular.element(m).off("orientationchange", n.resizefn),
            (n.resizeFn = void 0);
          ...
          return (
            ...
            d.transitionEndPromise(t, { timeout: 350 }).then(function () {
              t.removeClass("md-active"),
                n.backdrop && n.backdrop.remove(),
                n.parent[0].removeChild(t[0]),
        ...
        function f(e, a, c) {
          var l,
            ...
            E = {
              ...
              top: i,
              bottom: h.height - i,
              right: h.width - i - (d.floatingScrollbars() ? 16 : 0),
            },
            v = {
              top: g.top - E.top,
              left: g.left - E.left,
            ...
            C = f.getElementsByTagName("md-optgroup");
          (l = A
            ? A
            : C.length
            ? C[0]
            ...
            p.offsetWidth > M && (p.style["max-width"] = M + "px"),
            b && (p.style["min-width"] = g.width + "px"),
            $ && f.classList.add("md-overflow");
          var w = f.getBoundingClientRect(),
            k = o(l);
          if (l) {
            var y = window.getComputedStyle(l);
            (k.paddingLeft = parseInt(y.paddingLeft, 10) || 0),
              (k.paddingRight = parseInt(y.paddingRight, 10) || 0);
          }
          var x = l;
          if (
            ("MD-OPTGROUP" === (x.tagName || "").toUpperCase() &&
              (x = T[0] || p.firstElementChild || p),
            $)
          ) {
            var N = p.offsetHeight / 2;
            (p.scrollTop = k.top + k.height / 2 - N),
              v.top < N
                ? (p.scrollTop = Math.min(k.top, p.scrollTop + N - v.top))
                : v.bottom < N &&
                  (p.scrollTop = Math.max(
                    k.top + k.height - w.height,
                    p.scrollTop - N + v.bottom
                  ));
          }
          var _, H, S;
          b
            ? ((_ = g.left),
              ...
              (S = "50% 0"),
              H + w.height > E.bottom &&
                ((H = g.top - w.height), (S = "50% 100%")))
            : ((_ = g.left + k.left - k.paddingLeft),
              (H = g.top + g.height / 2 - k.height / 2 - k.top + p.scrollTop),
              (S =
                k.left +
                g.width / 2 +
                "px " +
                (k.top + k.height / 2 - p.scrollTop) +
                "px 0px"),
              (m.style.minWidth =
                g.width + k.paddingLeft + k.paddingRight + "px"));
          var I = m.getBoundingClientRect();
          (m.style.left = n(E.left, _, E.right - I.width) + "px"),
            (m.style.top = n(E.top, H, E.bottom - I.height) + "px"),
            (f.style[t.CSS.TRANSFORM_ORIGIN] = S),
            (f.style[t.CSS.TRANSFORM] =
              "scale(" +
    ...
    angular
      ...
      (t.$inject = ["$parse", "$mdUtil", "$mdTheming"]),
      (n.$inject = ["$mdInkRipple", "$mdUtil"]),
  ...
  (function () {
    ...
    function n(e, t, n, o, r, a, i, d, c, l) {
      function m(m, s, u, f) {
        function p(e, n) {
          (m.isLockedOpen = e),
            e === n
        ...
        function h(e) {
          ...
          n[e ? "on" : "off"]("keydown", E),
            w[e ? "on" : "off"]("click", v),
            e && ($ = l[0].activeElement);
          var o = f.focusElement();
          return (
            g(e),
            (A = c
              .all([
                e ? t.enter(w, n) : t.leave(w),
        ...
        var M,
          ...
          w = i('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(
            m
          );
        s.on("$destroy", f.destroy),
          d.inherit(w, s),
          m.$watch(C, p),
          m.$watch("isOpen", h),
          (f.$toggleOpen = b),
          f.focusElement(f.focusElement() || s);
      }
      return {
        restrict: "E",
    ...
    angular
      ...
      .factory("$mdSidenav", e)
      .directive("mdSidenav", n)
      .directive("mdSidenavFocus", t)
      .controller("$mdSidenavController", o),
  ...
  (function () {
    ...
    function e(e, t, n, o, r, a, i, d) {
      ...
      function l(n, c, l, m) {
        ...
        function u(e) {
          (W = parseFloat(e)), c.attr("aria-valuemin", e), s();
        }
        function f(e) {
          (z = parseFloat(e)), c.attr("aria-valuemax", e), s();
        }
        function p(e) {
          (G = parseFloat(e)), g();
        }
        ...
        function v(e) {
          if (!c[0].hasAttribute("disabled")) {
            ...
            e.keyCode === r.KEY_CODE.LEFT_ARROW
              ? (t = -G)
              : e.keyCode === r.KEY_CODE.RIGHT_ARROW && (t = G),
              t &&
        ...
        function M(e) {
          m.$setViewValue(A(T(e)));
        }
        function $() {
          isNaN(m.$viewValue) && (m.$viewValue = m.$modelValue);
          var e = (m.$viewValue - W) / (z - W);
        ...
        function A(e) {
          return angular.isNumber(e) ? Math.max(W, Math.min(z, e)) : void 0;
        }
        function T(e) {
          return angular.isNumber(e) ? Math.round(e / G) * G : void 0;
        }
        function C(e) {
          q.css("width", 100 * e + "%"),
            F.css("left", 100 * e + "%"),
        ...
        var R = l.ngDisabled && d(l.ngDisabled),
          L = R
            ? function () {
                return R(n.$parent);
              }
          ...
          j = angular.element(c[0].querySelector(".md-thumb-text")),
          F = P.parent(),
          B = angular.element(c[0].querySelector(".md-track-container")),
          q = angular.element(c[0].querySelector(".md-track-fill")),
          U = angular.element(c[0].querySelector(".md-track-ticks")),
          K = o.throttle(b, 5e3);
        l.min ? l.$observe("min", u) : u(0),
          l.max ? l.$observe("max", f) : f(100),
          l.step ? l.$observe("step", p) : p(1);
        var V = angular.noop;
        l.ngDisabled && (V = n.$parent.$watch(l.ngDisabled, h)),
          ...
          setTimeout(s);
        var Y = e.throttle(s);
        angular.element(t).on("resize", Y),
          n.$on("$destroy", function () {
            angular.element(t).off("resize", Y), V();
          }),
          (m.$render = $),
    ...
    function e(e, t, n, o, r) {
      function a(e) {
        ...
        function r() {
          ...
          for (
            var e, t = s.prop("scrollTop"), n = f.items.length - 1;
            n >= 0;
            n--
          )
            if (t > f.items[n].top) {
          ...
          (i.prevScrollTop = e),
            0 === e
              ...
              ? f.next.top - e <= 0
                ? c(f.next)
                : f.current &&
                  (f.next.top - e <= f.next.height
                    ? m(f.current, f.next.top - f.next.height - e)
                    : m(f.current, null))
              : !t &&
                f.current &&
                (e < f.current.top && c(f.prev),
                f.current &&
                  f.next &&
                  (e >= f.next.top - f.current.height
                    ? m(f.current, f.next.top - e - f.current.height)
                    : m(f.current, null)));
        }
        function c(e) {
          if (f.current !== e) {
            f.current && (m(f.current, null), l(f.current, null)),
              e && l(e, "active"),
              (f.current = e);
      ...
      function i() {
        ...
        for (var o = ["sticky", "-webkit-sticky"], r = 0; r < o.length; ++r)
          if (
            (n.css({ position: o[r], top: 0, "z-index": 2 }),
            n.css("position") == o[r])
          ) {
            t = o[r];
            break;
          ...
          return function (o, r) {
            ...
            n(r),
              ...
              r.hasClass("md-no-sticky") ||
                a(o, function (a) {
                  var c = t(angular.element(i))(o);
                  n(c), d(c).append(a), e(o, r, c);
                });
          };
        },
      };
      ...
      return {
        ...
        link: function (r, a, i) {
          function d() {
            ...
            function d() {
              (l = a.prop("offsetHeight")),
                m.css("margin-top", -l * f + "px"),
                c();
            }
            function c(e) {
              var n = e ? e.target.scrollTop : u;
              h(),
                (s = Math.min(l / f, Math.max(0, s + n - u))),
                a.css(t.CSS.TRANSFORM, "translate3d(0," + -s * f + "px,0)"),
                m.css(
                  t.CSS.TRANSFORM,
                  "translate3d(0," + (l - s) * f + "px,0)"
                ),
                (u = n);
            }
            var l,
              ...
              s = 0,
              u = 0,
              f = i.mdShrinkSpeedFactor || 0.5,
              p = e.throttle(c),
              h = n.debounce(d, 5e3);
            r.$on("$mdContentLoaded", o);
          }
          o(a), angular.isDefined(i.mdScrollShrink) && d();
        },
      };
    }
    angular
  ...
  (function () {
    "use strict";
    function e(e, t, n, o, r, a, i, d, c) {
      function l(l, u, f) {
        function p() {
          h(), b(), M(), g();
        }
        function h() {
          angular.isDefined(f.mdDelay) || (l.delay = m);
        }
        function g() {
        ...
        function b() {
          u.detach(),
            u.attr("role", "tooltip"),
            u.attr("id", f.id || "tooltip_" + r.nextUid());
        }
        function E() {
          for (
            var e = u.parent();
        ...
        function M() {
          var e = l.hasOwnProperty("autohide")
            ? l.autohide
            : f.hasOwnProperty("mdAutohide");
          w.on("focus mouseenter touchstart", function () {
            $(!0);
          }),
            w.on("blur mouseleave touchend touchcancel", function () {
              (o[0].activeElement !== w[0] || e) && $(!1);
            }),
        ...
        function A() {
          w.attr("aria-describedby", u.attr("id")),
            _.append(u),
            C(),
            angular.forEach([u, k, y], function (e) {
        ...
        function C() {
          function e() {
            var e =
                "left" === x || "right" === x
                  ? 2 *
                    Math.sqrt(Math.pow(o.width, 2) + Math.pow(o.height / 2, 2))
                  : 2 *
                    Math.sqrt(Math.pow(o.width / 2, 2) + Math.pow(o.height, 2)),
              t =
                "left" === x
                  ? { left: 100, top: 50 }
                  : "right" === x
        ...
        a(u);
        var w = E(),
          k = angular.element(u[0].getElementsByClassName("md-background")[0]),
          y = angular.element(u[0].getElementsByClassName("md-content")[0]),
          x = f.mdDirection,
          N = v(),
          _ = angular.element(N || document.body),
  ...
  (function () {
    ...
    function e(e, r, a, i, d, c, l) {
      ...
      function s() {
        function e() {
          var e = U.ul.getBoundingClientRect(),
            n = {};
          e.right > a.right - o && (n.left = t.right - e.width + "px"),
            U.$.ul.css(n);
        }
        if (!U) return d(s, 0, !1);
        var t = U.wrap.getBoundingClientRect(),
          r = U.snap.getBoundingClientRect(),
          a = U.root.getBoundingClientRect(),
          i = r.bottom - a.top,
          c = a.bottom - r.top,
          l = t.left - a.left,
          m = t.width,
          u = {
            left: l + "px",
            minWidth: m + "px",
            maxWidth: Math.max(t.right - a.left, a.right - t.left) - o + "px",
          };
        i > c && a.height - t.bottom - o < n
          ? ((u.top = "auto"),
            (u.bottom = c + "px"),
            (u.maxHeight = Math.min(n, t.top - a.top - o) + "px"))
          : ((u.top = i + "px"),
            (u.bottom = "auto"),
            (u.maxHeight = Math.min(n, a.bottom - t.bottom - o) + "px")),
          U.$.ul.css(u),
          d(e, 0, !1);
      }
      function u() {
        U.$.root.length &&
          (c(U.$.ul), U.$.ul.detach(), U.$.root.append(U.$.ul));
      }
      function f() {
        e.autofocus && U.input.focus();
      }
      function p() {
        var t = parseInt(e.delay, 10) || 0;
        e.$watch("searchText", t ? a.debounce(A, t) : A),
          M(E),
          e.$watch("selectedItem", v),
          e.$watch("$mdAutocompleteCtrl.hidden", function (e, t) {
            !e && t && s();
          }),
          angular.element(l).on("resize", s);
      }
      function h() {
        (U = {
          main: r[0],
      ...
      function E(t, n) {
        t && (e.searchText = y(t)),
          e.itemChange && t !== n && e.itemChange(x(t));
      }
      function v(e, t) {
      ...
      function A(t, n) {
        (F.index = N()),
          (t || t !== n) &&
            t !== y(e.selectedItem) &&
            ((e.selectedItem = null),
            e.textChange && t !== n && e.textChange(x(e.selectedItem)),
            S()
              ? j()
              : ((F.loading = !1), (F.matches = []), (F.hidden = _()), R()));
      }
      function T() {
        Y || (F.hidden = !0);
      }
      function C() {
        return angular.isString(e.searchText)
          ? ((F.hidden = _()), F.hidden || j(), void 0)
          : (e.searchText = "");
      }
      function w(e) {
        switch (e.keyCode) {
          ...
          case i.KEY_CODE.ENTER:
            if (F.hidden || F.loading || F.index < 0) return;
            e.preventDefault(), I(F.index);
            break;
      ...
      function y(t) {
        return t && e.itemText ? e.itemText(x(t)) : t;
      }
      function x(e) {
        if (e) {
          var t = {};
      ...
      function _() {
        return S()
          ? 1 === F.matches.length &&
              e.searchText === y(F.matches[0]) &&
              e.selectedItem === F.matches[0]
          : !0;
      }
      function H() {
        return y(F.matches[F.index]);
      }
      function S() {
        return e.searchText.length >= k();
      }
      function I(t) {
        (e.selectedItem = F.matches[t]),
          (e.searchText = y(e.selectedItem) || e.searchText),
          (F.hidden = !0),
          (F.index = 0),
          (F.matches = []);
      }
      function D() {
        (e.searchText = ""), I(-1), U.input.focus();
      }
      function O(t) {
        function n(n) {
          (V[r] = n),
        ...
        if (!F.hidden)
          switch (F.matches.length) {
            ...
            default:
              return F.messages.push({
                display:
                  "There are " + F.matches.length + " matches available.",
              });
          }
      }
      function L() {
        F.messages.push({ display: H() });
      }
      function P() {
        var e = t * F.index,
          n = e + t,
        ...
        e < U.ul.scrollTop
          ? (U.ul.scrollTop = e)
          : n > U.ul.scrollTop + o && (U.ul.scrollTop = n - o);
      }
      function j() {
        var t = e.searchText,
          n = t.toLowerCase();
        K && K.cancel && (K.cancel(), (K = null)),
          !e.noCache && V[n] ? ((F.matches = V[n]), R()) : O(t),
          (F.hidden = _());
      }
      var F = this,
      ...
      return (
        ...
        (F.clear = D),
        (F.select = I),
        (F.getCurrentDisplayValue = H),
        (F.registerSelectedItemWatcher = M),
        (F.unregisterSelectedItemWatcher = $),
  ...
  (function () {
    ...
    function e(e) {
      function t(t, n, o) {
        (t.contents = o.$mdAutocompleteTemplate),
          delete o.$mdAutocompleteTemplate,
          angular.forEach(t.$$isolateBindings, function (e, n) {
            e.optional &&
              angular.isUndefined(t[n]) &&
              (t[n] = o.hasOwnProperty(o.$normalize(e.attrName)));
          }),
          e(n);
      }
      return {
  ...
  (function () {
    ...
    function e(e, t) {
      function n(n, o, r) {
        ...
        (i[d] = n.item),
          o.html(a.scope.$eval(r.mdAutocompleteListItemTemplate)),
          e(o.contents())(i),
  ...
  (function () {
    ...
    angular.module("material.components.chips").controller("MdChipsCtrl", e),
  ...
  (function () {
    ...
    function e(e, a, i) {
      function d(t, d) {
        function c(e) {
          if (d.ngModel) {
            var t = l[0].querySelector(e);
            return t && t.outerHTML;
          }
        }
        var l = d.$mdUserTemplate;
        d.$mdUserTemplate = null;
        var m = c("[md-chip-remove]") || r,
          s = c("md-chip-template") || o,
          u = c("md-autocomplete") || c("input") || n,
          f = l.find("md-chip");
        return function (t, o, r, c) {
          angular.forEach(t.$$isolateBindings, function (e, n) {
            e.optional &&
              angular.isUndefined(t[n]) &&
              (t[n] = d.hasOwnProperty(d.$normalize(e.attrName)));
          }),
            e(o);
          var l = c[0];
          if (
            ((l.chipContentsTemplate = s),
            (l.chipRemoveTemplate = m),
            (l.chipInputTemplate = u),
            o.attr({ ariaHidden: !0, tabindex: -1 }).on("focus", function () {
              l.onFocus();
            }),
            d.ngModel &&
              (l.configureNgModel(o.controller("ngModel")),
              r.mdOnAppend && l.useMdOnAppendExpression(),
              u != n &&
                i(function () {
                  0 === u.indexOf("<md-autocomplete") &&
                    ...
                    l.configureUserInput(o.find("input"));
                })),
            f.length > 0)
          ) {
            var p = a(f)(t.$parent);
            i(function () {
              o.find("md-chips-wrap").prepend(p);
            });
          }
        };
      }
    ...
    var t =
        '      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          ng-class="{ \'md-focused\': $mdChipsCtrl.hasFocus() }"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index}">          <div class="md-chip-content"              tabindex="-1"              aria-hidden="true"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div class="md-chip-remove-container"              md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',
      n =
  ...
  (function () {
    ...
    angular
      .module("material.components.chips")
      .controller("MdContactChipsCtrl", e),
      ...
      function n(t, n) {
        return function (t, o) {
          angular.forEach(t.$$isolateBindings, function (e, o) {
            e.optional &&
              angular.isUndefined(t[o]) &&
              (t[o] = n.hasOwnProperty(n.$normalize(e.attrName)));
          }),
            e(o),
            o.attr("tabindex", "-1");
        };
  ...
  (function () {
      ...
      function t(t, n, o, r) {
        if (r) {
          ...
          t.$watch("template", function (t) {
            n.html(t), e(n.contents())(r.tabs[a].parent);
          });
        }
      }
      return {
    ...
    angular.module("material.components.tabs").directive("mdLabelTemplate", e),
      (e.$inject = ["$compile"]);
  })()
  /*!
   * Angular Material Design
  ...
  (function () {
    ...
    function e(e) {
      ...
      return {
        terminal: !0,
        scope: { tab: "=mdTabData", active: "=mdActive" },
        link: t,
      };
    }
    angular.module("material.components.tabs").directive("mdTabContent", e),
      (e.$inject = ["$compile", "$mdUtil"]);
  })()
  /*!
   * Angular Material Design
  ...
  (function () {
    ...
    angular.module("material.components.tabs").directive("mdTabScroll", e),
      (e.$inject = ["$parse"]);
  })()
  /*!
   * Angular Material Design
  ...
  (function () {
    ...
    function e(e, t, n, o, r, a, i, d) {
      function c() {
        e.$watch("selectedIndex", T),
          e.$watch("$mdTabsCtrl.focusIndex", p),
          e.$watch("$mdTabsCtrl.offsetLeft", f),
      ...
      function s(t) {
        switch (t.keyCode) {
          ...
          case r.KEY_CODE.ENTER:
            t.preventDefault(), B || (e.selectedIndex = F.focusIndex);
        }
        F.lastClick = !1;
      }
      function u(t, n) {
      ...
      function g() {
        if (!_()) {
          var e = q.tabs[F.focusIndex],
            t = e.offsetLeft,
            n = e.offsetWidth + t;
          (F.offsetLeft = Math.max(F.offsetLeft, D(n - q.canvas.clientWidth))),
            (F.offsetLeft = Math.min(F.offsetLeft, D(t)));
        }
      }
      function b() {
        (F.lastSelectedIndex = e.selectedIndex),
          k(),
          (F.offsetLeft = D(F.offsetLeft));
      }
      function E() {
      ...
      function v(t, n) {
        var o = {
            ...
            hasFocus: function () {
              return (
                !F.lastClick && F.hasFocus && this.getIndex() === F.focusIndex
              );
            },
            id: i.nextUid(),
          },
      ...
      function $(e) {
        F.tabs.splice(e.getIndex(), 1),
          A(),
          o(function () {
            k(), (F.offsetLeft = D(F.offsetLeft));
          });
      }
      function A() {
        (e.selectedIndex = x(e.selectedIndex)),
          (F.focusIndex = x(F.focusIndex));
      }
      function T(t, n) {
        t !== n &&
          ((e.selectedIndex = x(t)),
          ...
          (C.watcher = e.$watch(function () {
            o(
              function () {
                C.watcher &&
                  t.prop("offsetParent") &&
                  (C.watcher(), (C.watcher = null), e.$apply(b));
              },
              0,
              !1
            );
      ...
      function w() {
        ...
        if (!F.tabs.length) return U.push(w);
      ...
      function k() {
        if (!F.tabs.length) return U.push(k);
        if (!t.prop("offsetParent")) return C();
        var n = e.selectedIndex,
          o = q.paging.offsetWidth,
          r = q.tabs[n],
          a = r.offsetLeft,
          i = o - a - r.offsetWidth;
        y(), angular.element(q.inkBar).css({ left: a + "px", right: i + "px" });
      }
      function y() {
      ...
      function S(t) {
        B || (F.focusIndex = e.selectedIndex = t), (F.lastClick = !0);
      }
      function I(e) {
        H() &&
          (e.preventDefault(), (F.offsetLeft = D(F.offsetLeft - e.wheelDelta)));
      }
      function D(e) {
        ...
        return (
          (e = Math.max(0, e)), (e = Math.min(n - q.canvas.clientWidth, e))
        );
      }
      function O() {
        var e,
      ...
      function R() {
        ...
        F.offsetLeft = D(t.offsetLeft + t.offsetWidth - q.canvas.clientWidth);
      }
      function L() {
      ...
      function P() {
        ...
        return (
          e &&
          e.offsetLeft + e.offsetWidth > q.canvas.clientWidth + F.offsetLeft
        );
      }
      function j(e, t) {
      ...
      (F.scope = e),
        ...
        (F.updateInkBarStyles = k),
        c();
    }
    angular
      .module("material.components.tabs")
      .controller("MdTabsController", e),
      (e.$inject = [
        "$scope",
        "$element",
        "$window",
  ...
  (function () {
      ...
      return {
        ...
        link: function (t, n, o) {
          angular.forEach(t.$$isolateBindings, function (e, n) {
            ...
            (t.selectedIndex = angular.isNumber(t.selectedIndex)
              ? t.selectedIndex
              : 0),
            e(n);
        },
    ...
    angular.module("material.components.tabs").directive("mdTabs", e),
      (e.$inject = ["$mdTheming"]);
  })(),
  (function () {
    angular
