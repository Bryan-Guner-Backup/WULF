/* angular-moment.js / v0.9.1 / (c) 2013, 2014, 2015 Uri Shaked / MIT Licence */
      ...
      angular
          ...
          function (
            ...
            return function (scope, element, attr) {
              ...
              function updateTime(momentInstance) {
                ...
                if (!isBindOnce) {
                  var howOld = Math.abs(
                    getNow().diff(momentInstance, "minute")
                  );
              ...
              function updateMoment() {
                cancelTimer();
                if (currentValue) {
                  var momentValue = amMoment.preprocessDate(
                    currentValue,
                    preprocess,
                    currentFormat
                  );
            ...
            this.applyTimezone = function (aMoment) {
              ...
              if (aMoment && timezone) {
                if (aMoment.tz) {
                  ...
                  $log.warn(
                    "angular-moment: timezone specified but moment.tz() is undefined. Did you forget to include moment-timezone.js?"
                  );
                }
              }
              return aMoment;
          ...
          function (moment, amMoment, angularMomentConfig) {
            function amDifferenceFilter(
              ...
              if (typeof otherValue === "undefined" || otherValue === null) {
                ...
                otherValue = amMoment.preprocessDate(
                  otherValue,
                  preprocessOtherValue
                );
              ...
              return amMoment
                .applyTimezone(date)
                .diff(amMoment.applyTimezone(date2), unit, usePrecision);
            }
        ...
        .filter("amDurationFormat", [
          ...
          function (moment, angularMomentConfig) {
            ...
            amDurationFormatFilter.$stateful =
