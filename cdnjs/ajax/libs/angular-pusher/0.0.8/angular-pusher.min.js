...
angular
  ...
  .provider("PusherService", function () {
    function createScript($document, protocol, callback) {
      var tag = $document.createElement("script");
      (tag.type = "text/javascript"),
        (tag.async = !0),
        (tag.id = scriptId),
        (tag.src = "https" == protocol ? secureScriptUrl : scriptUrl),
    ...
    var scriptUrl = "//js.pusher.com/2.2/pusher.min.js",
      secureScriptUrl = "//d3dy5gmtp8yhk7.cloudfront.net/2.2/pusher.min.js",
      scriptId = "pusher-sdk",
      apiKey = "",
      initOptions = {};
    (this.setPusherUrl = function (url) {
      return url && (scriptUrl = secureScriptUrl = url), this;
    }),
      ...
      (this.$get = [
        ...
        function ($document, $timeout, $q, $rootScope, $window, $location) {
          ...
          return (
            createScript($document[0], protocol, onScriptLoad), deferred.promise
          );
        },
      ]);
  })
