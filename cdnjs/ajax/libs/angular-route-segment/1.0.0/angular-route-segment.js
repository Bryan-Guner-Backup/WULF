            ...
            if (route && route.segment) {
              ...
              $q.all(updates).then(function () {
                ...
                if ($routeSegment.chain.length > segmentNameChain.length) {
                  for (
                    var i = segmentNameChain.length;
                    i < $routeSegment.chain.length;
                    i++
                  )
                    updateSegment(i, null);
                  $routeSegment.chain.splice(
                    -1,
            ...
            return function ($scope, element, attrs) {
              ...
              function update(segment) {
                ...
                if (template) {
                  ...
                  if (animate)
                    animate.enter(
                      angular.element("<div></div>").html(template).contents(),
                      element
                    );
                  else element.html(template);
