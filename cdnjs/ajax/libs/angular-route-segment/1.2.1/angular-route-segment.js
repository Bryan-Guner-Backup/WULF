      ...
      this.$get = [
        ...
        function (
          ...
          var $routeSegment = {
            ...
            contains: function (val) {
              for (var i = 0; i < this.chain.length; i++)
                if (this.chain[i].name == val) return true;
              return false;
            },
          };
              ...
              for (var i = 0; i < segmentNameChain.length; i++) {
                ...
                if (
                  ...
                  if (
                    ...
                    resolvingSemaphoreChain[i] = newSegment.name;
                  else updates.push({ index: i, newSegment: newSegment });
                }
              }
          ...
          function resolve(index, name, params) {
            ...
            if (params.template) locals.$template = params.template;

            if (options.autoLoadTemplates && params.templateUrl)
              locals.$template = $http
                .get(params.templateUrl, { cache: $templateCache })
