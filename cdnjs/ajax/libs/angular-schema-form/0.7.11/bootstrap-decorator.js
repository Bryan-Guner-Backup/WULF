angular.module("schemaForm").run([
  ...
  function ($templateCache) {
    ...
    $templateCache.put(
      ...
      '<div class="schema-form-section {{form.htmlClass}}" ng-if="!form.condition || evalExpr(form.condition,{ model: model, \'arrayIndex\': arrayIndex })"><sf-decorator ng-repeat="item in form.items" form="item"></sf-decorator></div>'
    );
    $templateCache.put(
