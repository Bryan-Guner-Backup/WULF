angular.module("schemaForm").run([
  ...
  angular
    ...
    .config([
      ...
      function (e) {
        var s = "directives/decorators/bootstrap/";
        e.createDecorator(
          "bootstrapDecorator",
          {
            textarea: s + "textarea.html",
            fieldset: s + "fieldset.html",
            array: s + "array.html",
            tabarray: s + "tabarray.html",
            tabs: s + "tabs.html",
            section: s + "section.html",
            conditional: s + "section.html",
            actions: s + "actions.html",
            select: s + "select.html",
            checkbox: s + "checkbox.html",
            checkboxes: s + "checkboxes.html",
            number: s + "default.html",
            password: s + "default.html",
            submit: s + "submit.html",
            button: s + "submit.html",
            radios: s + "radios.html",
            "radios-inline": s + "radios-inline.html",
            radiobuttons: s + "radio-buttons.html",
            help: s + "help.html",
            default: s + "default.html",
          },
          []
        ),
          e.createDirectives({
            ...
            date: s + "default.html",
            password: s + "default.html",
            datepicker: s + "datepicker.html",
            input: s + "default.html",
            radios: s + "radios.html",
            "radios-inline": s + "radios-inline.html",
            radiobuttons: s + "radio-buttons.html",
          });
