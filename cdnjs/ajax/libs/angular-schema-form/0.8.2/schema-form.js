      ...
      var build = function (items, decorator, templateFn, slots, path) {
        ...
        items.reduce(function (frag, f, index) {
          ...
          if (!field.replace) {
            ...
            var template =
              templateFn(field.template) ||
              templateFn([decorator["default"].template]);
            if (f.key) {
              var key = f.key
  ...
  angular.module("schemaForm").provider("schemaFormDecorators", [
    ...
    function ($compileProvider, sfPathProvider) {
      ...
      this.createDecorator = function (name, templates) {
        console.warn(
          "schemaFormDecorators.createDecorator is DEPRECATED, use defineDecorator instead."
        );
      ...
      return {
        ...
        link: function (scope, element, attrs, ngModel) {
          ...
          var once = scope.$watch(attrs.sfArray, function (form) {
            ...
            scope.$watch(
              "model" + sfPath.normalize(form.key),
              function (value) {
