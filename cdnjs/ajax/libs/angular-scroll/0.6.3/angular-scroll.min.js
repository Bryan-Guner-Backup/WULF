  ...
  angular.module("duScroll.scrollHelpers", ["duScroll.requestAnimation"]).run([
    ...
    function (e, t, n, r, o, l, u) {
      ...
      i.duScrollTo = function (t, n, r) {
        ...
        return c(l)
          ? e.scrollTo(t, n)
          : ((l.scrollLeft = t), (l.scrollTop = n), void 0);
      };
      var d, f;
      (i.duScrollToAnimated = function (e, l, u, i) {
        ...
        var c = this.duScrollLeft(),
          ...
          v = function (e) {
            (!e || e.which > 0) &&
              (S.unbind(g, v), n(d), f.reject(), (d = null));
          };
        if ((d && v(), (f = t.defer()), !s && !p))
          return f.resolve(), f.promise;
        var h = function (e) {
          null === m && (m = e);
          var t = e - m,
            n = t >= u ? 1 : i(t / u);
          S.scrollTo(c + Math.ceil(s * n), a + Math.ceil(p * n)),
            1 > n ? (d = r(h)) : (S.unbind(g, v), (d = null), f.resolve());
        };
        return S.duScrollTo(c, a), S.bind(g, v), (d = r(h)), f.promise;
      }),
        ...
        var l = function (n) {
            var l = !1,
              ...
              i = function () {
                ...
                var i, c, a, s, d, f;
                for (
                  s = n.spies, c = n.currentlyActive, a = void 0, i = 0;
                  i < s.length;
                  i++
                )
                  (d = s[i]),
          ...
          a = i(e),
          s = function (e) {
            return u[e.$id] ? u[e.$id] : e.$parent ? s(e.$parent) : u[a];
          },
          d = function (e) {
            var t,
              n,
              r = e.$element.scope();
            if (r) return s(r);
            for (n in u) if (((t = u[n]), -1 !== t.spies.indexOf(e))) return t;
          },
          f = function (e) {
            for (; e.parentNode; )
