    ...
    function (e, t, n, r, o, l, u) {
      ...
      (i.duScrollToAnimated = function (e, l, u, i) {
        ...
        var c = this.duScrollLeft(),
          ...
          v = function (e) {
            (!e || (g && e.which > 0)) &&
              (S.unbind(h, v), n(d), f.reject(), (d = null));
          };
        if ((d && v(), (f = t.defer()), 0 === u || (!s && !p)))
          return 0 === u && S.duScrollTo(e, l), f.resolve(), f.promise;
        var y = function (e) {
          null === m && (m = e), (g = e - m);
          var t = g >= u ? 1 : i(g / u);
          S.scrollTo(c + Math.ceil(s * t), a + Math.ceil(p * t)),
            1 > t ? (d = r(y)) : (S.unbind(h, v), (d = null), f.resolve());
        };
