    ...
    function ($parse, $timeout) {
      ...
      return {
        ...
        link: function postLink(scope, element, attr, ctrl) {
          ...
          element.on(
            isTouch
              ? "touchstart.bsButtonSelect.data-api"
              : "click.bsButtonSelect.data-api",
            function (ev) {
              values = getter(scope);
  ...
  .directive("bsDatepicker", [
    ...
    function ($timeout) {
      ...
      var isTouch =
        ...
        !window.navigator.userAgent.match(/PhantomJS/i);
      ...
      return {
        ...
        link: function postLink(scope, element, attrs, controller) {
          ...
          var dateFormatRegexp = isTouch
            ? "yyyy/mm/dd"
            : regexpForDateFormat(
                attrs.dateFormat || "mm/dd/yyyy" /*, {mask: !!attrs.uiMask}*/
              );
      ...
      var linkSubmenu = function (items, parent, scope) {
        ...
        for (var i = 0, l = items.length; i < l; i++) {
          if ((subitems = items[i].submenu)) {
            ...
            submenu = submenu.appendTo(
              parent.children("li:nth-child(" + (i + 1) + ")")
            );
    ...
    function ($parse, $compile, $http, $timeout, $q, $templateCache) {
      ...
      return {
        ...
        link: function postLink(scope, element, attr, ctrl) {
          ...
          $q.when(
            $templateCache.get(value) || $http.get(value, { cache: true })
        ...
        link: function postLink(scope, element, attr, ctrl) {
          ...
          $q.when(
            ...
            popover.show = function () {
              if (!$.fn.tooltip.Constructor.prototype.applyPlacement) {
                // Implemented in bootstrap 2.3.0
                var e = $.Event("show");
              ...
              var r = $.fn.popover.Constructor.prototype.show.apply(
                this,
                arguments
              );
            ...
            popover.hide = function () {
              ...
              return $.fn.popover.Constructor.prototype.hide.apply(
                this,
                arguments
              );
            };
      ...
      return {
        ...
        link: function postLink(scope, element, attrs, ctrl) {
          ...
          tooltip.hide = function () {
            ...
            return $.fn.tooltip.Constructor.prototype.hide.apply(
              this,
              arguments
            );
          };
