...
angular.module("$strap.config", []).value("$strap.config", {}),
            ...
            ? e.$watch(
                ...
                function (t, o) {
                  (r = t),
                    ...
                    n(a.contents())(e),
                    (t.type || o.type) &&
                      (o.type && a.removeClass("alert-" + o.type),
                      t.type && a.addClass("alert-" + t.type)),
                    (angular.isUndefined(i.closeButton) ||
          ...
          a.on("close", function (t) {
            ...
            s
              ? (t.preventDefault(),
                ...
                $.support.transition && a.hasClass("fade")
                  ? a.on($.support.transition.end, n)
                  : n())
              : r &&
                (t.preventDefault(),
                a.removeClass("in"),
        ...
        return {
          ...
          link: function (e, n, a, i) {
            if (i) {
              ...
              o && n.addClass("active"),
                e.$watch(a.ngModel, function (t, e) {
                  var a = !!t,
                    i = !!e;
                  a !== i
                    ? $.fn.button.Constructor.prototype.toggle.call(r)
                    : a && !o && n.addClass("active");
                });
            }
            n.hasClass("btn") ||
            ...
            r.toggle = function () {
              ...
              a.length
                ? (n.siblings("[ng-model]").each(function (n, a) {
                    t($(a).attr("ng-model")).assign(e, !1);
                  }),
                  e.$digest(),
                  i.$modelValue ||
                    (i.$setViewValue(!i.$modelValue), e.$digest()))
                : e.$apply(function () {
            ...
            return (
              ...
              function (t, e, n, a) {
                a &&
                  ...
                  t.$watch(n.ngModel, function (a, i) {
                    if (a !== i) {
      ...
      return {
        ...
        link: function (e, n, a, i) {
          ...
          n.bind("click", function () {
            (r = o(e)),
              (s = i ? e.$eval(a.ngModel) : n.text()),
              (u = r.indexOf(s)),
              (c = u > r.length - 2 ? r[0] : r[u + 1]),
              console.warn(r, c),
              e.$apply(function () {
                n.text(c), i && i.$setViewValue(c);
              });
          });
        },
      };
    ...
    function (t, e) {
      ...
      return {
        ...
        link: function (t, a, o, r) {
          var s = e.datepicker || {},
            u = o.language || s.language || "en",
            c =
              o.dateFormat ||
              s.format ||
              ($.fn.datepicker.dates[u] && $.fn.datepicker.dates[u].format) ||
              "mm/dd/yyyy",
            l = n ? "yyyy/mm/dd" : i(c, u);
          if (
            (r &&
              r.$parsers.unshift(function (t) {
                return !t || l.test(t)
                  ? (r.$setValidity("date", !0), t)
                  : (r.$setValidity("date", !1), void 0);
              }),
            n && "text" === a.prop("type"))
          )
            a.prop("type", "date"),
  ...
  angular.module("$strap.directives").directive("bsDaterangepicker", [
    "$timeout",
    function () {
      "use strict";
      return (
          ...
          !window.navigator.userAgent.match(/PhantomJS/i),
        {
          ...
          link: function (t, e) {
            console.log("postLink", this, arguments),
              (window.element = e),
              e.attr("data-toggle", "daterangepicker"),
              e.daterangepicker({});
          },
        }
      );
      ...
      var a = function (t, e) {
        return (
          ...
          angular.forEach(t, function (t, n) {
            if (t.divider)
              return e.splice(n + 1, 0, '<li class="divider"></li>');
            var i =
              "<li" +
              (t.submenu && t.submenu.length
    ...
    function (t, e, n, a, i, o) {
      ...
      return {
        ...
        link: function (r, s, u) {
          var c = t(u.bsModal),
            l = (c.assign, c(r));
          i.when(o.get(l) || n.get(l, { cache: !0 })).then(function (t) {
            ...
            var n =
              ...
              i = $('<div class="modal hide" tabindex="-1"></div>')
                .attr("id", n)
                .attr("data-backdrop", u.backdrop || !0)
                .attr("data-keyboard", u.keyboard || !0)
                .addClass(u.modalClass ? "fade " + u.modalClass : "fade")
                .html(t);
            $("body").append(i),
        ...
        }),
        {
          ...
          link: function (a, r, s) {
            var u = t(s.bsPopover),
              c = (u.assign, u(a)),
              l = {};
            angular.isObject(c) && (l = c),
              i
                .when(l.content || o.get(c) || n.get(c, { cache: !0 }))
                .then(function (t) {
                  angular.isObject(t) && (t = t.data),
                    s.unique &&
                      r.on("show", function () {
                    ...
                    s.hide &&
                      a.$watch(s.hide, function (t, e) {
                        t ? n.hide() : t !== e && n.show();
                      }),
                    r.popover(angular.extend({}, l, { content: t, html: !0 }));
      ...
      return {
        ...
        link: function (a, i, o, r) {
          var s = t(o.bsTabs),
            ...
            l = ['<div class="tab-content">', "</div>"];
          i.hide();
          var d = 0;
          n(function () {
            angular.isArray(u) ||
              ((u = []),
              i.children("[data-title], [data-tab]").each(function () {
                var t = angular.element(this);
                u.push({
                  title: a.$eval(t.data("title") || t.data("tab")),
                  content: this.innerHTML,
                  active: t.hasClass("active"),
                  fade: t.hasClass("fade"),
                });
              })),
              angular.forEach(u, function (t, e) {
                t.active && (d = e);
              }),
              angular.forEach(u, function (t, e) {
                var n = "tab-" + a.$id + "-" + e,
              ...
              i.html(c.join("") + l.join("")).show(),
              e(i.children("div.tab-content"))(a);
          }),
            r &&
              (i.on("show", function (t) {
                var e = $(t.target);
                a.$apply(function () {
                  r.$setViewValue(e.data("index"));
                });
              }),
              a.$watch(o.ngModel, function (t) {
    ...
    function (t) {
      ...
      return {
        ...
        link: function (n, a, i, o) {
          o &&
            a.on("changeTime.timepicker", function () {
              t(function () {
          ...
          o.$parsers.unshift(function (t) {
            return !t || r.test(t)
              ? (o.$setValidity("time", !0), t)
              : (o.$setValidity("time", !1), void 0);
          }),
            a.attr("data-toggle", "timepicker"),
            a.parent().addClass("bootstrap-timepicker"),
            a.timepicker();
        },
      };
    },
