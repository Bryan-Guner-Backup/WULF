...
angular
  ...
  .directive("bsDatepicker", [
    ...
    function ($timeout, config) {
      ...
      var isAppleTouch = navigator.userAgent.match(/(iPad|iPhone|iPod)/g)
        ? true
        : false;
      ...
      return {
        ...
        link: function postLink(scope, element, attrs, controller) {
          ...
          var dateFormatRegexp = isAppleTouch
            ? regexpForDateFormat("yyyy-mm-dd", language)
            : regexpForDateFormat(format, language);
          ...
          if (controller) {
            ...
            controller.$render = function ngModelRender() {
              return (
                ...
                element.datepicker("update", controller.$modelValue)
              );
            };
          }
