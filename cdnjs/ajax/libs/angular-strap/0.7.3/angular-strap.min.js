...
angular.module("$strap.config", []).constant("$strapConfig", {}),
  ...
  angular.module("$strap.directives").directive("bsDatepicker", [
    ...
    function (t, e) {
      "use strict";
      var n = /(iPad|iPho(ne|d))/g.test(navigator.userAgent),
        a = function a(t) {
          return (
            (t = t || "en"),
            {
        ...
        link: function (t, a, o, r) {
          ...
          var l = s.language || "en",
            c = n
              ...
              : o.dateFormat ||
                s.format ||
                ($.fn.datepicker.dates[l] && $.fn.datepicker.dates[l].format) ||
                "yyyy-mm-dd",
            d = i(c, l);
          r &&
            (r.$formatters.unshift(function (t) {
              return "date" === u && angular.isString(t) ? new Date(t) : t;
            }),
            r.$parsers.unshift(function (t) {
              return t
                ? "date" === u && angular.isDate(t)
                  ? (r.$setValidity("date", !0), t)
                  : angular.isString(t) && d.test(t)
            ...
            (r.$render = function () {
              if (n) {
                var t = $.fn.datepicker.DPGlobal.formatDate(
                  r.$viewValue,
                  $.fn.datepicker.DPGlobal.parseFormat(c),
                  l
                );
              ...
              return r.$viewValue && a.datepicker("update", r.$viewValue);
            })),
            n
              ...
              : (r &&
                  a.on("changeDate", function (e) {
                    t.$apply(function () {
                      r.$setViewValue("string" === u ? a.val() : e.date);
                    });
                  }),
                a.attr("data-toggle", "datepicker"),
                a.datepicker(angular.extend(s, { format: c, language: l })),
    ...
    .factory("$modal", [
      ...
      function (t, e, n, a, i, o) {
        ...
        var r = function r(r) {
          function s(r) {
            r || (r = {});
            var s = r.scope ? r.scope.$new() : t.$new(),
              u = r.template;
            return i
              .when(
                o.get(u) ||
                  n.get(u, { cache: !0 }).then(function (t) {
                    return t.data;
                  })
              )
              .then(function (t) {
                var n =
                    u.replace(".html", "").replace(/[\/|\.|:]/g, "-") +
                    "-" +
                    s.$id,
                  i = $('<div class="modal hide" tabindex="-1"></div>')
                    ...
                    .html(t);
                return (
                  r.modalClass && i.addClass(r.modalClass),
                  $("body").append(i),
                  a(function () {
                    e(i)(s);
                  }),
        ...
        }),
        {
          ...
          link: function (a, r, s) {
            var u = t(s.bsPopover),
              l = (u.assign, u(a)),
              c = {};
            angular.isObject(l) && (c = l),
              i
                .when(c.content || o.get(l) || n.get(l, { cache: !0 }))
                .then(function (t) {
          ...
          return function (e, a, i, o) {
            ...
            n(function () {
              d.find("[data-title], [data-tab]").each(function (t) {
                ...
                (s = "tab-" + e.$id + "-" + t),
                  (u = n.data("title") || n.data("tab")),
                  (l = !l && n.hasClass("active")),
