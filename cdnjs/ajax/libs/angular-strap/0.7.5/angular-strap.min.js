            ...
            ? a.$watch(
                ...
                function (t, e) {
                  (s = t),
                    ...
                    n(i.contents())(a),
                    (t.type || e.type) &&
                      (e.type && i.removeClass("alert-" + e.type),
                      t.type && i.addClass("alert-" + t.type)),
                    angular.isDefined(t.closeAfter)
                      ? l(t.closeAfter)
                      : o.closeAfter && l(o.closeAfter),
                    (angular.isUndefined(o.closeButton) ||
                      ("0" !== o.closeButton && "false" !== o.closeButton)) &&
                      i.prepend(
            ...
            u
              ? (t.preventDefault(),
                ...
                (e = function () {
                  i.trigger("closed"),
                    a.$parent &&
                      a.$parent.$apply(function () {
                        for (
                          var t = u.split("."), e = a.$parent, n = 0;
                          t.length > n;
                          ++n
                        )
                          e && (e = e[t[n]]);
      ...
      function (t) {
        return {
          ...
          compile: function (e, n) {
            return (
              e.attr("data-toggle", "buttons-radio"),
              n.ngModel ||
                e.find("a, button").each(function (t, e) {
                  $(e).attr("bs-button", "");
                }),
              function (e, n, a, i) {
                i &&
                  ...
                  n.on("click.button.data-api", function (t) {
                    e.$apply(function () {
                      i.$setViewValue(
                        $(t.target).closest("button").attr("value")
                      );
                    });
                  }),
    ...
    function (t, e) {
      ...
      return {
        ...
        link: function (t, a, o, r) {
          var s = angular.extend({ autoclose: !0 }, e.datepicker || {}),
          ...
          r &&
            (r.$formatters.unshift(function (t) {
              return "date" === l && angular.isString(t) && t
                ? $.fn.datepicker.DPGlobal.parseDate(
                    t,
                    $.fn.datepicker.DPGlobal.parseFormat(c),
                    u
                  )
                : t;
            }),
            r.$parsers.unshift(function (t) {
              return t
                ? "date" === l && angular.isDate(t)
                  ? (r.$setValidity("date", !0), t)
                  : angular.isString(t) && p.test(t)
                  ? (r.$setValidity("date", !0),
                    n
                      ? new Date(t)
                      : "string" === l
                      ? t
            ...
            (r.$render = function () {
              ...
              return (
                r.$viewValue || a.val(""), a.datepicker("update", r.$viewValue)
              );
            })),
            n
              ? a.prop("type", "date").css("-webkit-appearance", "textfield")
              : (r &&
                ...
                a.datepicker(angular.extend(s, { format: d, language: u })),
  ...
  angular
    ...
    .factory("$modal", [
      ...
      function (t, e, n, a, i, o, r) {
        var s = function s(s) {
          function l(s) {
            var l = angular.extend({ show: !0 }, r.modal, s),
              u = l.scope ? l.scope : t.$new(),
              c = l.template;
            return i
              .when(
                o.get(c) ||
                  n.get(c, { cache: !0 }).then(function (t) {
                    return t.data;
                  })
              )
              .then(function (t) {
                var n =
                    c.replace(".html", "").replace(/[\/|\.|:]/g, "-") +
                    "-" +
                    u.$id,
          ...
          link: function (n, a, i) {
            ...
            angular.forEach(
              ...
              t.when(e(o)).then(function (t) {
                a.attr("data-target", "#" + t.attr("id")).attr(
                  "data-toggle",
                  "modal"
                );
              });
            ...
            function (t) {
              $("li[data-match-route]", n).each(function (e, n) {
                var a = angular.element(n),
                  ...
                  o = RegExp("^" + i + "$", ["i"]);
                o.test(t)
                  ? a.addClass("active").find(".collapse.in").collapse("hide")
        ...
        }),
        {
          ...
          link: function (r, s, l) {
            var u = t(l.bsPopover),
              c = (u.assign, u(r)),
              d = {};
            angular.isObject(c) && (d = c),
              i
                .when(d.content || o.get(c) || n.get(c, { cache: !0 }))
                .then(function (t) {
                  angular.isObject(t) && (t = t.data),
                    ...
                    l.hide &&
                      r.$watch(l.hide, function (t, e) {
                        t ? n.hide() : t !== e && n.show();
                      }),
                    l.show &&
                      r.$watch(l.show, function (t, e) {
                        t
                          ? a(function () {
                              n.show();
                            })
          ...
          return function (e, a, i, o) {
            ...
            n(function () {
              d.find("[data-title], [data-tab]").each(function (t) {
                ...
                (s = "tab-" + e.$id + "-" + t),
                  (l = n.data("title") || n.data("tab")),
                  (u = !u && n.hasClass("active")),
                  n.attr("id", s).addClass("tab-pane"),
                  i.fade && n.addClass("fade"),
                  e.panes.push({
                    id: s,
                    title: l,
                ...
                e.panes.length &&
                  ...
                  (d
                    ...
                    .addClass("active" + (i.fade ? " in" : "")),
                  (e.panes[0].active = !0));
            }),
              o &&
                (a.on("show", function (t) {
                  var n = $(t.target);
                  e.$apply(function () {
      ...
      return {
        ...
        link: function (a, i, o, r) {
          if (r) {
            ...
            r.$parsers.unshift(function (t) {
              return !t || s.test(t)
                ? (r.$setValidity("time", !0), t)
                : (r.$setValidity("time", !1), void 0);
            });
          }
          i.attr("data-toggle", "timepicker"),
            i.parent().addClass("bootstrap-timepicker"),
            i.timepicker(e.timepicker || {});
