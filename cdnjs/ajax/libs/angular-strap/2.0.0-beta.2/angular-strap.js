...
(function (window, document, $, undefined) {
  ...
  angular
    .module("mgcrea.ngStrap.affix", ["mgcrea.ngStrap.jqlite.dimensions"])
  ...
  angular
    .module("mgcrea.ngStrap.jqlite.debounce", [])
  ...
  angular
    .module("mgcrea.ngStrap.tooltip", ["mgcrea.ngStrap.jqlite.dimensions"])
    .run([
      "$templateCache",
      function ($templateCache) {
        var template =
        ...
        function (
          ...
          function TooltipFactory(element, config) {
            ...
            var scope = ($tooltip.$scope =
              options.scope.$new() || $rootScope.$new());
  ...
  angular
    .module("mgcrea.ngStrap.typeahead", ["mgcrea.ngStrap.tooltip"])
    .run([
      "$templateCache",
      function ($templateCache) {
        var template =
