        ...
        this.$get = [
          ...
          function (c, d, e, f, g, h, i, j, k) {
            function l(b, c) {
              ...
              var s = (q.$scope = r.scope.$new() || d.$new());
              r.delay &&
          ...
          return {
            ...
            link: function (a, g, h, i) {
              ...
              angular.forEach(
                ...
                function (a) {
                  angular.isDefined(h[a]) && (k[a] = h[a]);
                }
              );
              var l = k.limit || e.limit,
                m = h.ngOptions + " | filter:$viewValue | limitTo:" + l,
                n = m.match(f),
                o = b(n[2] || n[1]),
                p = n[4] || n[6],
                q = (n[5], b(n[3] || ""), b(n[2] ? n[1] : p)),
                r = b(n[7]),
                s = d(g, k);
              a.$watch(h.ngModel, function () {
                c.when(r(a, i)).then(function (a) {
                  a.length > l && (a = a.slice(0, l));
                  var b = j(a);
                  s.update(b);
                });
              }),
                a.$on("$destroy", function () {
                  s.destroy(), (k = null), (s = null);
                });
            },
          };
        },
