  ...
  angular.module("mgcrea.ngStrap", [
        ...
        this.$get = [
          ...
          function (b, c) {
            function d(d) {
              ...
              (e = b(f)),
                f.scope ||
                  angular.forEach(["type"], function (a) {
                    f[a] && (e.$scope[a] = f[a]);
                  });
              var g = e.show;
              return (
    ...
    angular
      ...
      .run([
        ...
        function (a) {
          var b =
            '<div class="aside" tabindex="-1" role="dialog"><div class="aside-dialog"><div class="aside-content"><div class="aside-header" ng-show="title"><button type="button" class="close" ng-click="$hide()">&times;</button><h4 class="aside-title" ng-bind="title"></h4></div><div class="aside-body" ng-show="content" ng-bind="content"></div><div class="aside-footer"><button type="button" class="btn btn-default" ng-click="$hide()">Close</button></div></div></div></div>';
          a.put("$aside", b);
        },
      ])
            ...
            function j(b, c, d) {
              ...
              (l.$select = function (a) {
                ...
                (f.$updateSelected = function () {
                  for (var a = 0, b = l.rows.length; b > a; a++)
                    angular.forEach(l.rows[a], e);
                }),
                ...
                q(),
                  setTimeout(function () {
                    f.$element.on(
                      ...
                      j.keyboard && b.on("keydown", f.$onKeyDown);
                  });
              };
              var r = f.hide;
              return (
                (f.hide = function () {
                  f.$element.off(
                    ...
                    j.keyboard && b.off("keydown", f.$onKeyDown),
                    r();
                }),
                f
              );
      ...
      .provider("$dateParser", [
        ...
        function () {
          var b = Date.prototype,
            c = (this.defaults = { format: "shortDate" });
          this.$get = [
            "$locale",
            function (d) {
              c.lang || (c.lang = d.id);
              var e = function (c) {
                ...
                var h,
                  ...
                  j = {
                    ...
                    MMM:
                      "((?:" + d.DATETIME_FORMATS.SHORTMONTH.join("|") + "))",
                    MM: "((?:[0]?[1-9]|[1][012]))",
                    M: "((?:[0]?[1-9]|[1][012]))",
                  ...
                  k = {
                    ...
                    MMMM: function (a) {
                      return this.setUTCMonth(
                        d.DATETIME_FORMATS.MONTH.indexOf(a)
                      );
                    },
                    MMM: function (a) {
                      return this.setUTCMonth(
                        d.DATETIME_FORMATS.SHORTMONTH.indexOf(a)
                      );
                    },
                    MM: function (a) {
                ...
                return (
                  (g.init = function () {
                    (g.$format = d.DATETIME_FORMATS[c.format] || c.format),
                      (h = f(g.$format)),
                      (i = e(g.$format));
                  }),
            ...
            link: function (a, b, c, d) {
              ...
              (e = j.$options),
                angular.forEach(["minDate", "maxDate"], function (a) {
                  c[a] &&
                    c.$observe(a, function (b, c) {
                      ("now" === b || "today" === b) && (b = null),
                        (j.$options[a] = +new Date(b)),
                        angular.isDefined(c) &&
                          i(function () {
                            j && j.$build();
                          });
              ...
              d.$parsers.unshift(function (a) {
                ...
                if (!b || isNaN(b.getTime()))
                  return void d.$setValidity("date", !1);
                var c = b.getTime() >= e.minDate && b.getTime() <= e.maxDate;
                return (
                  d.$setValidity("date", c),
                  (d.$dateValue = b),
                  "string" === e.dateType
                    ? f(a, e.dateFormat)
                    : "number" === e.dateType
                ...
                d.$formatters.push(function (a) {
                  return (
                    (d.$dateValue = angular.isDate(a) ? a : new Date(a)),
                    d.$dateValue
                  );
                }),
                (d.$render = function () {
                  b.val(
                    d.$isEmpty(d.$viewValue)
                      ? ""
                      : f(d.$viewValue, e.dateFormat)
                  );
                }),
                a.$on("$destroy", function () {
                ...
                m = [
                  {
                    ...
                    update: function (a, b) {
                      b ||
                      a.getUTCFullYear() !== l.year ||
                      a.getUTCMonth() !== l.month
                        ? (angular.extend(l, {
                    ...
                    build: function () {
                      for (
                        var b,
                          c = [],
                          e = new Date(Date.UTC(l.year, l.month, 1)),
                          h = new Date(
                            +e - 864e5 * (e.getUTCDay() + 1 - g.weekStart)
                          ),
                          i = 0;
                        35 > i;
                        i++
                      )
                        (b = new Date(+h + 864e5 * i)),
                          c.push({
                            date: b,
                    ...
                    isSelected: function (a) {
                      return (
                        a.getUTCFullYear() === e.$date.getUTCFullYear() &&
                        a.getUTCMonth() === e.$date.getUTCMonth() &&
                        a.getUTCDate() === e.$date.getUTCDate()
                      );
                    },
                  ...
                  },
                  {
                    ...
                    build: function () {
                      for (var b, c = [], g = 0; 12 > g; g++)
                        (b = new Date(Date.UTC(l.year, g, 1))),
                          c.push({
                            date: b,
                            label: d(b, this.format),
                  ...
                  },
                  {
                    ...
                    steps: { year: 12 },
                    update: function (a) {
                      parseInt(a.getUTCFullYear() / 20, 10) !==
    ...
    angular
      ...
      .run([
        ...
        function (a) {
          var b =
            '<div class="modal" tabindex="-1" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" ng-show="title"><button type="button" class="close" ng-click="$hide()">&times;</button><h4 class="modal-title" ng-bind="title"></h4></div><div class="modal-body" ng-show="content" ng-bind="content"></div><div class="modal-footer"><button type="button" class="btn btn-default" ng-click="$hide()">Close</button></div></div></div></div>';
          a.put("$modal", b);
        },
      ])
    ...
    angular
      ...
      .run([
        ...
        function (a) {
          var b =
            '<div class="popover" tabindex="-1" ng-show="content" ng-class="{\'in\': $visible}"><div class="arrow"></div><h3 class="popover-title" ng-bind="title" ng-show="title"></h3><div class="popover-content" ng-bind="content"></div></div>';
          a.put("$popover", b);
        },
      ])
              ...
              (i.$matches = []),
                ...
                (e.$isVisible = function () {
                  return f.minLength && g
                    ? i.$matches.length && g.$viewValue.length >= f.minLength
                    : !!i.$matches.length;
                }),
