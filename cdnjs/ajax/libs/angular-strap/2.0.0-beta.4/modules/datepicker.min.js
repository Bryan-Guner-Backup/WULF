...
angular
      ...
      function (b, c, d, e, f, g, h, i) {
        function j(b, c, d) {
          ...
          f.show = function () {
            q(),
              setTimeout(function () {
                f.$element.on(k ? "touchstart" : "mousedown", f.$onMouseDown),
          ...
          return (
            (f.hide = function () {
              f.$element.off(k ? "touchstart" : "mousedown", f.$onMouseDown),
  ...
  .provider("$dateParser", [
    ...
    function () {
      var a = Date.prototype,
        b = (this.defaults = { format: "shortDate" });
      this.$get = [
        "$locale",
        function (c) {
          b.lang || (b.lang = c.id);
          var d = function (b) {
            function d(a) {
              ...
              for (b = 0; b < c.length; b++)
                if (
                  ...
                  var f = a.search(c[b]);
                  (a = a.split(c[b]).join("")), j[c[b]] && (d[f] = j[c[b]]);
                }
              return (
            ...
            var g,
              ...
              j = {
                ...
                d: a.setUTCDate,
                MMMM: function (a) {
                  return this.setUTCMonth(c.DATETIME_FORMATS.MONTH.indexOf(a));
                },
                MMM: function (a) {
            ...
            return (
              (f.init = function () {
                (f.$format = c.DATETIME_FORMATS[b.format] || b.format),
                  (g = e(f.$format)),
                  (h = d(f.$format));
              }),
              (f.isValid = function (a) {
                return angular.isDate(a) ? !isNaN(a.getTime()) : g.test(a);
              }),
  ...
  .directive("bsDatepicker", [
    ...
    function (a, b, c, d, e, f, g) {
      {
        var h = a.requestAnimationFrame || a.setTimeout;
        window.moment;
      }
      return {
        restrict: "EAC",
        ...
        link: function (a, b, c, d) {
          ...
          d.$parsers.unshift(function (a) {
            ...
            (d.$render = function () {
              b.val(
                d.$isEmpty(d.$viewValue) ? "" : e(d.$viewValue, i.dateFormat)
              );
            }),
            ...
            m = [
              {
                ...
                update: function (a, b) {
                  ...
                  a.getUTCMonth() !== l.month
                    ? (angular.extend(l, {
                      ...
                      e.$build())
                    : a.getUTCDate() !== l.date &&
                      ((l.date = e.$date.getUTCDate()), e.$updateSelected());
                },
                build: function () {
                  for (
                    var b,
                ...
                onKeyDown: function (a) {
                  ...
                  37 === a.keyCode
                    ...
                    : 39 === a.keyCode
                    ? e.select(new Date(b + 864e5), !0)
                    : 40 === a.keyCode && e.select(new Date(b + 6048e5), !0);
                },
              },
              {
                name: "month",
                ...
                onKeyDown: function (a) {
                  ...
                  37 === a.keyCode
                    ...
                    : 39 === a.keyCode
                    ? e.select(e.$date.setMonth(b + 1), !0)
                    : 40 === a.keyCode && e.select(e.$date.setMonth(b + 4), !0);
                },
              },
              {
                name: "year",
                ...
                onKeyDown: function (a) {
                  ...
                  37 === a.keyCode
                    ...
                    : 39 === a.keyCode
                    ? e.select(e.$date.setYear(b + 1), !0)
                    : 40 === a.keyCode && e.select(e.$date.setYear(b + 4), !0);
                },
              },
            ];
          return {
