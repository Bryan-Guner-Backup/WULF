    ...
    .provider("$datepicker", function () {
      ...
      this.$get = [
        ...
        function (
          ...
          var isAppleTouch = /(iP(a|o)d|iPhone)/g.test(
          ...
          function DatepickerFactory(element, controller, config) {
            ...
            $datepicker.select = function (date, keepMode) {
              ...
              controller.$dateValue.setFullYear(
                date.getFullYear(),
                date.getMonth(),
                date.getDate()
              );
        ...
        return {
          ...
          link: function postLink(scope, element, attr, controller) {
            ...
            controller.$formatters.push(function (modelValue) {
              var date = angular.isDate(modelValue)
                ? modelValue
                : new Date(modelValue);
          ...
          function ModalFactory(config) {
            ...
            if (options.contentTemplate) {
              $modal.$promise = $modal.$promise.then(function (template) {
                ...
                return $q
                  .when(
                    $templateCache.get(options.contentTemplate) ||
                      $http.get(options.contentTemplate, {
                        cache: $templateCache,
                      })
                  )
            ...
            $timepicker.$moveIndex = function (value, index) {
              ...
              if (index === 0) {
                ...
                targetDate = new Date(
                  ...
                  1,
                  viewDate.hour,
                  viewDate.minute + value * options.length * 5
                );
      ...
      function (
        ...
        return {
          ...
          link: function postLink(scope, element, attr, controller) {
            ...
            controller.$parsers.unshift(function (viewValue) {
              var parsedTime = dateParser.parse(
                viewValue,
                controller.$dateValue
              );
              ...
              $tooltip.$promise = $tooltip.$promise.then(function (template) {
                ...
                return $q
                  ...
                  .then(function (contentTemplate) {
                    if (angular.isObject(contentTemplate))
                      contentTemplate = contentTemplate.data;
                    findElement('[ng-bind="content"]', templateEl[0])
                      .removeAttr("ng-bind")
                      .html(contentTemplate);
                    return templateEl[0].outerHTML;
                  });
