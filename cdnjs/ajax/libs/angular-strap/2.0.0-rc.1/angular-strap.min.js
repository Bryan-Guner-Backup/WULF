              ...
              g.init = function () {
                return l && m.useNative
                  ...
                  : (k &&
                      ...
                      b.on("click", f)),
                    c.$dateValue && ((g.$date = c.$dateValue), g.$build()),
                    void r());
              };
              var s = g.destroy;
              g.destroy = function () {
                      ...
                      build: function () {
                        for (
                          var b,
                            ...
                            h = new Date(
                              +c - 864e5 * (c.getUTCDay() + 1 - g.weekStart)
                            ),
                            i = [],
                            k = 0;
                          35 > k;
        ...
        this.$get = [
          ...
          function (c, d, e, f, g, h, i) {
            function j(b) {
              ...
              q.element || q.container || (q.container = "body"),
                ...
                q.contentTemplate &&
                  (j.$promise = j.$promise.then(function (a) {
                    ...
                    return f
                      .when(
                        g.get(q.contentTemplate) ||
                          h.get(q.contentTemplate, { cache: g })
                      )
                      .then(function (a) {
                        angular.isObject(a) && (a = a.data);
              ...
              var s,
                t,
                u = l('<div class="' + q.prefixClass + '-backdrop"/>');
              return (
                ...
                (j.show = function () {
                  ...
                  (t = j.$element = s(r, function () {})),
                    ...
                    q.animation &&
                      (q.backdrop && u.addClass("animation-fade"),
