...
!(function (a, b) {
  ...
  angular.module("mgcrea.ngStrap", [
        ...
        this.$get = [
          ...
          function (b, c) {
            function d(d, g) {
              function h(a, c, d) {
                var e = b.pageYOffset,
                  f = b.document.body.scrollHeight;
                return r >= e
                  ? "top"
                  : null !== a && e + a <= c.top
                  ? "middle"
                  : null !== s && c.top + d + l >= f - s
                  ? "bottom"
                  : "middle";
              }
              var i = {},
                ...
                p = d.parent();
              if (j.offsetParent)
                if (j.offsetParent.match(/^\d+$/))
                  for (var q = 0; q < 1 * j.offsetParent - 1; q++)
                    p = p.parent();
                else p = angular.element(j.offsetParent);
              var r = 0;
              j.offsetTop &&
                ("auto" === j.offsetTop && (j.offsetTop = "+0"),
                j.offsetTop.match(/^[-+]\d+$/)
                  ? ((l -= 1 * j.offsetTop),
                    (r = j.offsetParent
                      ? c.offset(p[0]).top + 1 * j.offsetTop
                      : c.offset(d[0]).top -
                        c.css(d[0], "marginTop", !0) +
                        1 * j.offsetTop))
                  : (r = 1 * j.offsetTop));
              var s = 0;
              return (
                j.offsetBottom &&
                  (s =
                    j.offsetParent && j.offsetBottom.match(/^[-+]\d+$/)
                      ? b.document.body.scrollHeight -
                        (c.offset(p[0]).top + c.height(p[0])) +
                        1 * j.offsetBottom +
                        1
                      : 1 * j.offsetBottom),
                (i.init = function () {
                  (m = c.offset(d[0]).top + l),
                    e.on("scroll", this.checkPosition),
                    e.on("click", this.checkPositionWithEventLoop),
                    this.checkPosition(),
                    this.checkPositionWithEventLoop();
                }),
                (i.destroy = function () {
                  e.off("scroll", this.checkPosition),
                    e.off("click", this.checkPositionWithEventLoop);
                }),
                ...
                (i.checkPosition = function () {
                  ...
                  n !== i &&
                    ...
                    d
                      .removeClass(k)
                      .addClass("affix" + ("middle" !== i ? "-" + i : "")),
                    "top" === i
                      ? ((o = null),
                        d.css("position", j.offsetParent ? "" : "relative"),
                        d.css("top", ""))
                      : "bottom" === i
                      ? ((o = j.offsetUnpin ? -(1 * j.offsetUnpin) : e.top - a),
                        d.css("position", j.offsetParent ? "" : "relative"),
                        d.css(
                          "top",
                          j.offsetParent
                            ? ""
                            : f[0].offsetHeight - s - g - m + "px"
                        ))
                      : ((o = null),
            ...
            var e = angular.element(b),
              f = angular.element(b.document.body);
            return d;
          },
        ];
      })
        ...
        function (a) {
          ...
          return {
            ...
            link: function (a, d, e, f) {
              var g = b,
                h = "INPUT" === d[0].nodeName,
                i = h ? d.parent() : d,
                j = angular.isDefined(e.trueValue) ? e.trueValue : !0;
              ...
              l &&
                ...
                d.bind(g.toggleEvent, function () {
                  a.$apply(function () {
                    h || f.$setViewValue(!i.hasClass("active")),
                      l || f.$render();
                  });
                });
            },
          ...
          return {
            ...
            link: function (a, d, e, f) {
              var g = b,
                h = "INPUT" === d[0].nodeName,
                i = h ? d.parent() : d,
                j = c.test(e.value) ? a.$eval(e.value) : e.value;
              (f.$render = function () {
                var a = angular.equals(f.$modelValue, j);
                h && (d[0].checked = a), i.toggleClass(g.activeClass, a);
              }),
      ...
      .provider("$datepicker", function () {
        ...
        this.$get = [
          ...
          function (b, c, d, e, f, g, h, i) {
            function j(b, c, d) {
              ...
              (n.$select = function (a) {
                ...
                (g.update = function (a) {
                  isNaN(a.getTime())
                    ? q.built || g.$build()
                    : ((g.$date = a), q.update.call(q, a));
                }),
                (g.select = function (a, b) {
                  angular.isDate(a) || (a = new Date(a)),
                    c.$dateValue.setFullYear(
                      a.getFullYear(),
                      a.getMonth(),
                      a.getDate()
                    ),
                    !n.$mode || b
                      ? (c.$setViewValue(c.$dateValue),
                        c.$render(),
                        m.autoclose && !b && g.hide(!0))
                      : (angular.extend(p, {
                          year: a.getFullYear(),
                          month: a.getMonth(),
                          date: a.getDate(),
                ...
                (g.$onMouseDown = function (a) {
                  if ((a.preventDefault(), a.stopPropagation(), k)) {
                    ...
                    "button" !== b[0].nodeName.toLowerCase() &&
                      (b = b.parent()),
              ...
              var r = g.init;
              g.init = function () {
                return l && m.useNative
                  ? (b.prop("type", "date"),
                    void b.css("-webkit-appearance", "textfield"))
                  : (k &&
                      (b.prop("type", "text"),
                ...
                t(),
                  setTimeout(function () {
                    g.$element.on(
                      ...
                      m.keyboard && b.on("keydown", g.$onKeyDown);
                  });
              };
              var u = g.hide;
              return (
                (g.hide = function (a) {
                  g.$element.off(
                    ...
                    m.keyboard && b.off("keydown", g.$onKeyDown),
                    u(a);
                }),
                g
              );
            ...
            var k =
                (angular.element(b.document.body), "createTouch" in b.document),
              l = /(iP(a|o)d|iPhone)/g.test(b.navigator.userAgent);
            ...
            link: function (a, b, c, d) {
              ...
              (i = j.$options),
                angular.forEach(["minDate", "maxDate"], function (a) {
                  angular.isDefined(c[a]) &&
                    c.$observe(a, function (b) {
                      if ("today" === b) {
                        var c = new Date();
                        j.$options[a] = +new Date(
                          c.getFullYear(),
                          c.getMonth(),
                          c.getDate() + ("maxDate" === a ? 1 : 0),
                          0,
                          0,
                          0,
                          "minDate" === a ? 0 : -1
              ...
              var k = g({ format: i.dateFormat, lang: i.lang });
              d.$parsers.unshift(function (a) {
                var b = k.parse(a, d.$dateValue);
                if (!b || isNaN(b.getTime())) d.$setValidity("date", !1);
                else {
                ...
                (d.$render = function () {
                  b.val(
                    isNaN(d.$dateValue.getTime())
                      ? ""
                      : e(d.$dateValue, i.dateFormat)
                  );
                }),
                a.$on("$destroy", function () {
        ...
        this.$get = [
          ...
          function (b, c, d) {
            return function (e) {
              var f = e.$scope,
                g = e.$options,
                h = b.DATETIME_FORMATS.SHORTDAY,
                i = h.slice(g.weekStart).concat(h.slice(0, g.weekStart)),
                j = c.trustAsHtml(
                  '<th class="dow text-center">' +
                    i.join('</th><th class="dow text-center">') +
                    "</th>"
                ),
                k = e.$date || new Date(),
                l = {
                ...
                m =
                  ...
                  [
                      ...
                      update: function (a, b) {
                        ...
                        a.getMonth() !== l.month
                          ? (angular.extend(l, {
                            ...
                            e.$build())
                          : a.getDate() !== l.date &&
                            ((l.date = e.$date.getDate()), e.$updateSelected());
                      },
                      build: function () {
                        for (
                          var b,
                        ...
                        (f.title = d(c, "MMMM yyyy")),
                          (f.labels = j),
                          (f.rows = a(i, this.split)),
                          (this.built = !0);
                      },
                      isSelected: function (a) {
                        return (
                          e.$date &&
                          a.getFullYear() === e.$date.getFullYear() &&
                          a.getMonth() === e.$date.getMonth() &&
                          a.getDate() === e.$date.getDate()
                        );
                      },
                      isDisabled: function (a) {
                        return (
                          a.getTime() < g.minDate || a.getTime() > g.maxDate
                        );
                      },
                      onKeyDown: function (a) {
                        var b = e.$date.getTime();
                        37 === a.keyCode
                          ? e.select(new Date(b - 864e5), !0)
                          : 38 === a.keyCode
                          ? e.select(new Date(b - 6048e5), !0)
                          : 39 === a.keyCode
                          ? e.select(new Date(b + 864e5), !0)
                          : 40 === a.keyCode &&
                            e.select(new Date(b + 6048e5), !0);
                    ...
                    },
                    {
                      ...
                      steps: { year: 1 },
                      update: function (a) {
                        this.built && a.getFullYear() === l.year
                          ? a.getMonth() !== l.month &&
                            (angular.extend(l, {
                              month: e.$date.getMonth(),
                              date: e.$date.getDate(),
                      ...
                      build: function () {
                        for (
                          var b, c = (new Date(l.year, 0, 1), []), g = 0;
                          12 > g;
                          g++
                        )
                          (b = new Date(l.year, g, 1)),
                            c.push({
                              date: b,
                              label: d(b, this.format),
                      ...
                      onKeyDown: function (a) {
                        ...
                        37 === a.keyCode
                          ? e.select(e.$date.setMonth(b - 1), !0)
                          : 38 === a.keyCode
                          ? e.select(e.$date.setMonth(b - 4), !0)
                          : 39 === a.keyCode
                          ? e.select(e.$date.setMonth(b + 1), !0)
                          : 40 === a.keyCode &&
                            e.select(e.$date.setMonth(b + 4), !0);
                    ...
                    },
                    {
                      ...
                      update: function (a, b) {
                        !this.built ||
                        b ||
                        parseInt(a.getFullYear() / 20, 10) !==
                          parseInt(l.year / 20, 10)
                          ? (angular.extend(l, {
                              year: e.$date.getFullYear(),
                              month: e.$date.getMonth(),
                              date: e.$date.getDate(),
                      ...
                      build: function () {
                        ...
                        (f.title = g[0].label + "-" + g[g.length - 1].label),
                          (f.labels = !1),
                          (f.rows = a(g, this.split)),
                          (this.built = !0);
                      },
                      isSelected: function (a) {
                        return (
                          e.$date && a.getFullYear() === e.$date.getFullYear()
                        );
                      },
                      isDisabled: function (a) {
                      ...
                      onKeyDown: function (a) {
                        ...
                        37 === a.keyCode
                          ? e.select(e.$date.setYear(b - 1), !0)
                          : 38 === a.keyCode
                          ? e.select(e.$date.setYear(b - 4), !0)
                          : 39 === a.keyCode
                          ? e.select(e.$date.setYear(b + 1), !0)
                          : 40 === a.keyCode &&
                            e.select(e.$date.setYear(b + 4), !0);
          ...
          function (b, c) {
            function d(b, d) {
              ...
              h.show = function () {
                j(),
                  setTimeout(function () {
                    i.keyboard && h.$element.on("keydown", h.$onKeyDown),
                      e.on("click", g);
                  });
              };
              var k = h.hide;
              return (
                (h.hide = function () {
                  i.keyboard && h.$element.off("keydown", h.$onKeyDown),
                    e.off("click", g),
                    k();
                }),
                h
      ...
      .provider("$dateParser", [
        ...
        function () {
          var a = Date.prototype,
            b = (this.defaults = { format: "shortDate", strict: !1 });
          this.$get = [
            "$locale",
            function (c) {
              var d = function (d) {
                ...
                function g(a) {
                  ...
                  for (b = 0; b < c.length; b++)
                    d = d.split("${" + b + "}").join("(" + l[c[b]] + ")");
                  return (a = f(a)), new RegExp("^" + d + "$", ["i"]);
                }
                var h,
                  i,
                  j = angular.extend({}, b, d),
                  k = {},
                  l = {
                    sss: "[0-9]{3}",
                    ss: "[0-5][0-9]",
                  ...
                  m = {
                    ...
                    MMM: function (a) {
                      return this.setMonth(
                        c.DATETIME_FORMATS.SHORTMONTH.indexOf(a)
                      );
                    },
                    MM: function (a) {
                ...
                return (
                  (k.init = function () {
                    (k.$format = c.DATETIME_FORMATS[j.format] || j.format),
                      (h = g(k.$format)),
                      (i = e(k.$format));
                  }),
                  ...
                  (k.parse = function (a, b) {
                    ...
                    var c = h.exec(a);
                    if (!c) return !1;
                    for (var d = b || new Date(0), e = 0; e < c.length - 1; e++)
                      i[e] && i[e].call(d, c[e + 1]);
                    return d;
                  }),
                  k.init(),
                  k
    ...
    angular
      ...
      .constant("debounce", function (a, b, c) {
        var d, e, f, g, h;
        return function () {
          ...
          (b.css = function (b, c, d) {
            ...
            (b.offset = function (b) {
              ...
              return {
                ...
                top:
                  c.top +
                  (a.pageYOffset || d.documentElement.scrollTop) -
                  (d.documentElement.clientTop || 0),
                left:
                  c.left +
                  (a.pageXOffset || d.documentElement.scrollLeft) -
          ...
          return (
            (b.height = function (a, c) {
              ...
              return (
                c
                  ? (d +=
                      b.css(a, "marginTop", !0) + b.css(a, "marginBottom", !0))
                  : (d -=
                      b.css(a, "paddingTop", !0) +
                      b.css(a, "paddingBottom", !0) +
                      b.css(a, "borderTopWidth", !0) +
                      b.css(a, "borderBottomWidth", !0)),
                d
              );
            }),
            (b.width = function (a, c) {
              ...
              return (
                c
                  ? (d +=
                      b.css(a, "marginLeft", !0) + b.css(a, "marginRight", !0))
                  : (d -=
                      b.css(a, "paddingLeft", !0) +
                      b.css(a, "paddingRight", !0) +
                      b.css(a, "borderLeftWidth", !0) +
                      b.css(a, "borderRightWidth", !0)),
                d
              );
            }),
            b
              ...
              function f(a) {
                return a.map(function (a) {
                  var b,
                    ...
                    d = {};
                  return (
                    (d[k] = a), (b = j(d)), (c = n(d)), { label: b, value: c }
                  );
                });
              }
              var g = {},
      ...
      .provider("$modal", function () {
        ...
        this.$get = [
          ...
          function (c, d, e, f, g, h, i) {
            function j(b) {
              function c(a) {
                a.target === a.currentTarget &&
                  ("static" === q.backdrop ? j.focus() : j.hide());
              }
              var j = {},
                q = angular.extend({}, a, b);
              j.$promise = f.when(g.get(q.template) || h.get(q.template));
              var r = (j.$scope = (q.scope && q.scope.$new()) || d.$new());
              q.element || q.container || (q.container = "body"),
                q.scope ||
                  k(["title", "content"], function (a) {
                    q[a] && (r[a] = q[a]);
                  }),
                (r.$hide = function () {
                ...
                q.contentTemplate &&
                  (j.$promise = j.$promise.then(function (a) {
                    angular.isObject(a) && (a = a.data);
                    var c = angular.element(a);
                    return f
                      .when(
                        g.get(q.contentTemplate) || h.get(q.contentTemplate)
                      )
                      .then(function (a) {
                        angular.isObject(a) && (a = a.data);
                        var d = p('[ng-bind="content"]', c[0])
                          .removeAttr("ng-bind")
                          .html(a);
              ...
              var s,
                t,
                u = angular.element(
                  '<div class="' + q.prefixClass + '-backdrop"/>'
                );
              return (
                j.$promise.then(function (a) {
                  angular.isObject(a) && (a = a.data),
                    q.html && (a = a.replace(o, 'ng-bind-html="')),
                    (a = l.apply(a)),
                    (s = e(a)),
                    j.init();
                }),
                ...
                (j.show = function () {
                  var a = q.container ? p(q.container) : null,
                    b = q.container ? null : q.element;
                  (t = j.$element = s(r, function () {})),
                    t.css({ display: "block" }).addClass(q.placement),
                    q.animation &&
                      (q.backdrop && u.addClass("am-fade"),
                      t.addClass(q.animation)),
                    q.backdrop && i.enter(u, n, null, function () {}),
                  ...
                  m(function () {
                    ...
                    n.addClass(q.prefixClass + "-open"),
                    q.backdrop && (t.on("click", c), u.on("click", c)),
                    q.keyboard && t.on("keyup", j.$onKeyUp);
                }),
                (j.hide = function () {
                  i.leave(t, function () {
                    ...
                    r.$$phase || r.$digest(),
                    (r.$isShown = !1),
                    q.backdrop && (t.off("click", c), u.off("click", c)),
                    q.keyboard && t.off("keyup", j.$onKeyUp);
                }),
                (j.toggle = function () {
            ...
            var k = angular.forEach,
              l = String.prototype.trim,
              m = c.requestAnimationFrame || c.setTimeout,
              n = angular.element(c.document.body),
              o = /ng-bind="/gi,
              p = function (a, c) {
                  ...
                  function (a) {
                    ...
                    angular.forEach(b, function (b) {
                      var c = angular.element(b),
                        d = c.attr(f.routeAttr),
                        e = new RegExp("^" + d.replace("/", "\\/") + "$", [
                          "i",
                        ]);
                      e.test(a)
      ...
      .provider("$scrollspy", function () {
        ...
        this.$get = [
          ...
          function (d, e, f, g, h, i) {
            function j(a, b) {
              return (
                a[0].nodeName && a[0].nodeName.toLowerCase() === b.toLowerCase()
              );
            }
            function k(e) {
              ...
              return (
                (x.init = function () {
                  (this.$$count = 1),
                    (s = h(this.checkPosition, k.debounce)),
                    (t = i(this.checkPosition, k.throttle)),
                    p.on("click", this.checkPositionWithEventLoop),
                    l.on("resize", s),
                    p.on("scroll", t),
                    (u = h(this.checkOffsets, k.debounce)),
                    f.$on("$viewContentLoaded", u),
                    f.$on("$includeContentLoaded", u),
                    u(),
                    q && (a[q] = x);
                }),
                (x.destroy = function () {
                  this.$$count--,
                    this.$$count > 0 ||
                      ...
                      l.off("resize", s),
                      p.off("scroll", s),
                      f.$off("$viewContentLoaded", u),
                      f.$off("$includeContentLoaded", u));
                }),
                (x.checkPosition = function () {
                  if (z.length) {
                    if (
                      ((w = (o ? d.pageYOffset : p.prop("scrollTop")) || 0),
                      (v = Math.max(d.innerHeight, m.prop("clientHeight"))),
                      w < z[0].offsetTop && r !== z[0].target)
                    )
                      return x.$activateElement(z[0]);
                    for (var a = z.length; a--; )
                      if (
                        !angular.isUndefined(z[a].offsetTop) &&
                        null !== z[a].offsetTop &&
                        r !== z[a].target &&
                        !(
                          w < z[a].offsetTop ||
                          (z[a + 1] && w > z[a + 1].offsetTop)
                        )
                      )
                        return x.$activateElement(z[a]);
                  }
                }),
                ...
                (x.$activateElement = function (a) {
                  if (r) {
                    ...
                    b &&
                      (b.source.removeClass("active"),
                      j(b.source, "li") &&
                        j(b.source.parent().parent(), "li") &&
                        b.source.parent().parent().removeClass("active"));
                  }
                  (r = a.target),
                    a.source.addClass("active"),
                    j(a.source, "li") &&
                      j(a.source.parent().parent(), "li") &&
                      a.source.parent().parent().addClass("active");
                }),
                ...
                (x.untrackElement = function (a, b) {
                  for (var c, d = y.length; d--; )
                    if (y[d].target === a && y[d].source === b) {
                      c = d;
                      break;
                    }
                  y = y.splice(c, 1);
          ...
          function (b, c, d, e) {
            function f(b, c, d) {
              ...
              (j.$matches = []),
                ...
                (f.update = function (a) {
                  (j.$matches = a),
                    c.$modelValue && a.length
                      ? (j.$activeIndex =
                          h.multiple && angular.isArray(c.$modelValue)
                            ? c.$modelValue.map(function (a) {
                                return f.$getIndex(a);
                              })
                            : f.$getIndex(c.$modelValue))
                      : j.$activeIndex >= a.length &&
                        (j.$activeIndex = h.multiple ? [] : 0);
                }),
                (f.activate = function (a) {
                  return (
                    h.multiple
                      ? (j.$activeIndex.sort(),
                        f.$isActive(a)
                          ? j.$activeIndex.splice(j.$activeIndex.indexOf(a), 1)
                          : j.$activeIndex.push(a),
                        h.sort && j.$activeIndex.sort())
                      : (j.$activeIndex = a),
                    j.$activeIndex
                  );
                }),
                ...
                (f.$isVisible = function () {
                  return h.minLength && c
                    ? j.$matches.length && c.$viewValue.length >= h.minLength
                    : j.$matches.length;
                }),
                (f.$isActive = function (a) {
                  return h.multiple
                    ? -1 !== j.$activeIndex.indexOf(a)
                    : j.$activeIndex === a;
                }),
                ...
                (f.$onKeyDown = function (a) {
                  if (/(38|40|13)/.test(a.keyCode)) {
                    ...
                    38 === a.keyCode && j.$activeIndex > 0
                      ? j.$activeIndex--
                      : 40 === a.keyCode &&
                        j.$activeIndex < j.$matches.length - 1
                      ? j.$activeIndex++
                      : angular.isUndefined(j.$activeIndex) &&
                        (j.$activeIndex = 0),
                      j.$digest();
                  }
                });
              ...
              f.init = function () {
                k(),
                  b.on(g ? "touchstart" : "mousedown", f.$onElementMouseDown);
              };
              var l = f.destroy;
              f.destroy = function () {
                l(),
                  b.off(g ? "touchstart" : "mousedown", f.$onElementMouseDown);
              };
              var m = f.show;
              f.show = function () {
                m(),
                  h.multiple && f.$element.addClass("select-multiple"),
                  setTimeout(function () {
                    f.$element.on(
                      g ? "touchstart" : "mousedown",
                      f.$onMouseDown
                    ),
                      h.keyboard && b.on("keydown", f.$onKeyDown);
                  });
              };
              var n = f.hide;
              return (
                (f.hide = function () {
                  f.$element.off(
                    ...
                    h.keyboard && b.off("keydown", f.$onKeyDown),
                    n();
                }),
                f
              );
          ...
          return {
            ...
            link: function (a, b, c, g) {
              ...
              a.$watch(k, function () {
                ...
                (g.$render = function () {
                  var a, d;
                  h.multiple && angular.isArray(g.$modelValue)
                    ? (a = g.$modelValue
                        .map(function (a) {
                          return (
                            (d = j.$getIndex(a)),
                            angular.isDefined(d)
                              ? j.$scope.$matches[d].label
                              : !1
                          );
                        })
                        .filter(angular.isDefined)
                        .join(", "))
                    : ((d = j.$getIndex(g.$modelValue)),
                      (a = angular.isDefined(d)
                        ? j.$scope.$matches[d].label
                        : !1)),
                    b.html(
                      (a ? a : c.placeholder || f.placeholder) + f.caretHtml
                    );
                }),
                a.$on("$destroy", function () {
          ...
          return {
            ...
            link: function (a, b, c, e) {
              ...
              angular.forEach(["animation"], function (a) {
                ...
                b.addClass("tabs"),
                f.animation && b.addClass(f.animation),
                (a.active = a.activePane = 0),
      ...
      .provider("$timepicker", function () {
        ...
        this.$get = [
          ...
          function (b, c, d, e, f, g, h) {
            function i(b, c, d) {
              function e(a, c) {
                if (b[0].createTextRange) {
                  ...
                  b[0].setSelectionRange
                    ? b[0].setSelectionRange(a, c)
                    : angular.isUndefined(b[0].selectionStart) &&
                      ((b[0].selectionStart = a), (b[0].selectionEnd = c));
              }
              function i() {
                b[0].focus();
              }
              var l = h(b, angular.extend({}, a, d)),
                m = d.scope,
                n = l.$options,
                o = l.$scope,
                p = 0,
                q = c.$dateValue || new Date(),
                r = {
                  hour: q.getHours(),
                ...
                s = f.DATETIME_FORMATS[n.timeFormat] || n.timeFormat,
                t = /(h+)[:]?(m+)[ ]?(a?)/i.exec(s).slice(1);
              (o.$select = function (a, b) {
                ...
                (l.select = function (a, b, d) {
                  angular.isDate(a) || (a = new Date(a)),
                    0 === b
                      ? c.$dateValue.setHours(a.getHours())
                      : 1 === b && c.$dateValue.setMinutes(a.getMinutes()),
                    c.$setViewValue(c.$dateValue),
                    c.$render(),
                    n.autoclose && !d && l.hide(!0);
                }),
                ...
                (l.$build = function () {
                  var a,
                    b,
                    c = (o.midIndex = parseInt(n.length / 2, 10)),
                    d = [];
                  for (a = 0; a < n.length; a++)
                    (b = new Date(1970, 0, 1, r.hour - (c - a) * n.hourStep)),
                      d.push({
                        date: b,
                        label: g(b, t[0]),
                  ...
                  (o.rows = h),
                    (o.showAM = !!t[2]),
                    (o.isAM = (l.$date || d[c].date).getHours() < 12),
                    (l.$isBuilt = !0);
                }),
                (l.$isSelected = function (a, b) {
                  return l.$date
                    ? 0 === b
                      ? a.getHours() === l.$date.getHours()
                      : 1 === b
                      ? a.getMinutes() === l.$date.getMinutes()
                      : void 0
                    : !1;
                }),
                (l.$isDisabled = function (a, b) {
                  ...
                  return (
                    0 === b
                      ? (c = a.getTime() + 6e4 * r.minute)
                      : 1 === b && (c = a.getTime() + 36e5 * r.hour),
                ...
                (l.$moveIndex = function (a, b) {
                  ...
                  0 === b
                    ? ((c = new Date(
                      ...
                      angular.extend(r, { hour: c.getHours() }))
                    : 1 === b &&
                      ((c = new Date(
                        1970,
                        0,
                        1,
                        r.hour,
                        r.minute + a * n.length * 5
                      )),
                      angular.extend(r, { minute: c.getMinutes() })),
                    l.$build();
                }),
                  ...
                  if (
                    ...
                    if (
                      (i &&
                        (37 === a.keyCode
                          ? (p = 1 > p ? j - 1 : p - 1)
                          : 39 === a.keyCode && (p = j - 1 > p ? p + 1 : 0)),
                      0 === p)
                    ) {
                      if (i) return e(0, d);
                      38 === a.keyCode
                        ? b.setHours(c - n.hourStep)
                        : 40 === a.keyCode && b.setHours(c + n.hourStep);
                    } else if (1 === p) {
                      if (i) return e(d + 1, d + 1 + h);
                      38 === a.keyCode
                        ? b.setMinutes(f - n.minuteStep)
                        : 40 === a.keyCode && b.setMinutes(f + n.minuteStep);
                    } else if (2 === p) {
                ...
                w(),
                  setTimeout(function () {
                    l.$element.on(
                      ...
                      n.keyboard && b.on("keydown", l.$onKeyDown);
                  });
              };
              var x = l.hide;
              return (
                (l.hide = function (a) {
                  l.$element.off(
                    ...
                    n.keyboard && b.off("keydown", l.$onKeyDown),
                    x(a);
                }),
                l
              );
            ...
            var j =
                (angular.element(b.document.body), "createTouch" in b.document),
              k = /(iP(a|o)d|iPhone)/g.test(b.navigator.userAgent);
        ...
        function (a, b, c, d, e, f, g) {
          ...
          return {
            ...
            link: function (a, b, c, d) {
              ...
              var i = f(b, d, h);
              h = i.$options;
              var j = g({ format: h.timeFormat, lang: h.lang });
              angular.forEach(["minTime", "maxTime"], function (a) {
                  ...
                  c.$observe(a, function (b) {
                    (i.$options[a] =
                      "now" === b
                        ...
                        : angular.isString(b) && b.match(/^".+"$/)
                        ? +new Date(b.substr(1, b.length - 2))
                        : j.parse(b)),
                ...
                d.$parsers.unshift(function (a) {
                  ...
                  if (!b || isNaN(b.getTime())) d.$setValidity("date", !1);
                    ...
                    var c =
                      b.getTime() >= h.minTime && b.getTime() <= h.maxTime;
                    d.$setValidity("date", c), c && (d.$dateValue = b);
                  }
                  return "string" === h.timeType
                    ? e(a, h.timeFormat)
                    : "number" === h.timeType
                    ? d.$dateValue.getTime()
                    : "iso" === h.timeType
                ...
                d.$formatters.push(function (a) {
                  ...
                  return (
                    isNaN(b.getTime()) &&
                      (b = new Date(new Date().setMinutes(0) + 36e5)),
                    (d.$dateValue = b),
                    d.$dateValue
                  );
                }),
        ...
        this.$get = [
          ...
          function (c, d, e, f, g, h, i, j, k) {
            function l(b, c) {
              ...
              var t, u;
              r.contentTemplate &&
                (q.$promise = q.$promise.then(function (a) {
                  angular.isObject(a) && (a = a.data);
                  var b = angular.element(a);
                  return f
                    .when(
                      g.get(r.contentTemplate) ||
                        h.get(r.contentTemplate, { cache: g })
                    )
                    .then(function (a) {
                      return (
                        angular.isObject(a) && (a = a.data),
                        p('[ng-bind="content"]', b[0])
                          .removeAttr("ng-bind")
                          .html(a),
                        b[0].outerHTML
                      );
              ...
              return (
                q.$promise.then(function (a) {
                  angular.isObject(a) && (a = a.data),
                    r.html && (a = a.replace(o, 'ng-bind-html="')),
                    (a = m.apply(a)),
                    (x = a),
                    (v = e(a)),
                    q.init();
                ...
                (q.init = function () {
                  ...
                  for (var a = r.trigger.split(" "), c = a.length; c--; ) {
                    ...
                    "click" === d
                      ? b.on("click", q.toggle)
                      : "manual" !== d &&
                        (b.on("hover" === d ? "mouseenter" : "focus", q.enter),
                ...
                (q.destroy = function () {
                  for (var a = r.trigger.split(" "), c = a.length; c--; ) {
                    var d = a[c];
                    "click" === d
                      ? b.off("click", q.toggle)
                      : "manual" !== d &&
                        (b.off("hover" === d ? "mouseenter" : "focus", q.enter),
                ...
                (q.show = function () {
                  var a = r.container ? p(r.container) : null,
                    c = r.container ? null : b;
                  (w = q.$element = v(s, function () {})),
                    w
                      .css({ top: "0px", left: "0px", display: "block" })
                      .addClass(r.placement),
                    r.animation && w.addClass(r.animation),
                    r.type && w.addClass(r.prefixClass + "-" + r.type),
                    i.enter(w, a, c, function () {}),
                    (q.$isShown = !0),
                    s.$$phase || s.$digest(),
                    n(q.$applyPlacement),
                    r.keyboard &&
                      ("focus" !== r.trigger
                        ? (q.focus(), w.on("keyup", q.$onKeyUp))
                        : b.on("keyup", q.$onFocusKeyUp));
                }),
                (q.leave = function () {
                  return q.$isShown
                    ? (clearTimeout(t),
                      (u = "out"),
                      r.delay && r.delay.hide
                        ? void (t = setTimeout(function () {
                            "out" === u && q.hide();
                          }, r.delay.hide))
                        : q.hide())
                ...
                (q.hide = function (a) {
                  return (
                    ...
                    s.$$phase || s.$digest(),
                    (q.$isShown = !1),
                    r.keyboard && w.off("keyup", q.$onKeyUp),
                ...
                (q.$applyPlacement = function () {
                  if (w) {
                    var a = j(),
                      b = w.prop("offsetWidth"),
                      c = w.prop("offsetHeight"),
                      d = l(r.placement, a, b, c);
            ...
            var m = String.prototype.trim,
              ...
              o = ("createTouch" in c.document, /ng-bind="/gi),
              p = function (a, c) {
                return angular.element((c || b).querySelectorAll(a));
              };
            return l;
          ...
          function (b, c, d) {
            function e(b, c) {
              ...
              (i.$matches = []),
                ...
                (e.update = function (a) {
                  (i.$matches = a),
                    i.$activeIndex >= a.length && (i.$activeIndex = 0);
                }),
                ...
                (e.select = function (a) {
                  ...
                  g && (g.$setViewValue(c), g.$render(), h && h.$digest()),
                    "focus" === f.trigger
                      ? b[0].blur()
                      : e.$isShown && e.hide(),
                    (i.$activeIndex = 0),
                    i.$emit("$typeahead.select", c, a);
                }),
                (e.$isVisible = function () {
                  return f.minLength && g
                    ? i.$matches.length &&
                        angular.isString(g.$viewValue) &&
                        g.$viewValue.length >= f.minLength
                    : !!i.$matches.length;
                }),
                ...
                (e.$onKeyDown = function (a) {
                  if (/(38|40|13)/.test(a.keyCode)) {
                    ...
                    38 === a.keyCode && i.$activeIndex > 0
                      ? i.$activeIndex--
                      : 40 === a.keyCode &&
                        i.$activeIndex < i.$matches.length - 1
                      ? i.$activeIndex++
                      : angular.isUndefined(i.$activeIndex) &&
                        (i.$activeIndex = 0),
                      i.$digest();
                  }
                });
              ...
              e.show = function () {
                j(),
                  setTimeout(function () {
                    e.$element.on("mousedown", e.$onMouseDown),
                      f.keyboard && b.on("keydown", e.$onKeyDown);
                  });
              };
              var k = e.hide;
              return (
                (e.hide = function () {
                  e.$element.off("mousedown", e.$onMouseDown),
                    f.keyboard && b.off("keydown", e.$onKeyDown),
                    k();
                }),
                e
              );
        ...
        function (a, b, c, d, e) {
          ...
          return {
            ...
            link: function (a, b, c, g) {
              ...
              var i = h.limit || f.limit,
                j = e(c.ngOptions + " | filter:$viewValue | limitTo:" + i),
                k = d(b, h);
