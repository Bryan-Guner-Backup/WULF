          ...
          function (b, c) {
            function d(d, f) {
              ...
              var j = {},
                ...
                r = d.parent();
              if (k.offsetParent)
                if (k.offsetParent.match(/^\d+$/))
                  for (var s = 0; s < 1 * k.offsetParent - 1; s++)
                    r = r.parent();
                else r = angular.element(k.offsetParent);
              var t = 0;
              k.offsetTop &&
                ("auto" === k.offsetTop && (k.offsetTop = "+0"),
                k.offsetTop.match(/^[-+]\d+$/)
                  ? ((n -= 1 * k.offsetTop),
                    (t = k.offsetParent
                      ? c.offset(r[0]).top + 1 * k.offsetTop
                      : c.offset(d[0]).top -
              ...
              return (
                k.offsetBottom &&
                  (u =
                    k.offsetParent && k.offsetBottom.match(/^[-+]\d+$/)
                      ? i() -
                        (c.offset(r[0]).top + c.height(r[0])) +
                        1 * k.offsetBottom +
                        1
                      : 1 * k.offsetBottom),
                (j.init = function () {
                  (o = c.offset(d[0]).top + n),
                    l.on("scroll", this.checkPosition),
                    l.on("click", this.checkPositionWithEventLoop),
                    this.checkPosition(),
                    this.checkPositionWithEventLoop();
                }),
                (j.destroy = function () {
                  l.off("scroll", this.checkPosition),
                    l.off("click", this.checkPositionWithEventLoop);
                }),
                ...
                (j.checkPosition = function () {
                  ...
                  p !== i &&
                    ...
                    "top" === i
                      ? ((q = null),
                        d.css("position", k.offsetParent ? "" : "relative"),
                        d.css("top", ""))
                      : "bottom" === i
                      ? ((q = k.offsetUnpin ? -(1 * k.offsetUnpin) : b.top - a),
                        d.css("position", k.offsetParent ? "" : "relative"),
                        d.css(
                          "top",
                          k.offsetParent
                            ? ""
                            : e[0].offsetHeight - u - f - o + "px"
                        ))
                      : ((q = null),
      ...
      .directive("bsAlert", [
        ...
        function (a, b, c, d) {
          ...
          return {
            ...
            scope: !0,
            link: function (a, b, e) {
              var f = { scope: a, element: b, show: !1 };
              angular.forEach(
                [
                  "template",
                  "placement",
        ...
        this.$get = [
          ...
          function (b, c, d, e, f, g, h, i) {
            ...
            var k =
              ...
              l = /(ip(a|o)d|iphone|android)/gi.test(b.navigator.userAgent);
          ...
          function (b, c, d) {
            return function (e) {
              var f = e.$scope,
                ...
                i = h.slice(g.startWeek).concat(h.slice(0, g.startWeek)),
                j = c.trustAsHtml(
        ...
        this.$get = [
          ...
          function (c, d, e, f, g, h, i) {
            function j(b) {
              function c(a) {
                a.target === a.currentTarget &&
                  ("static" === g.backdrop ? f.focus() : f.hide());
              }
              var f = {},
                g = angular.extend({}, a, b);
              f.$promise = l(g.template);
              var h = (f.$scope = (g.scope && g.scope.$new()) || d.$new());
              g.element || g.container || (g.container = "body"),
                g.scope ||
              ...
              var j,
                r,
                s = angular.element(
                  '<div class="' + g.prefixClass + '-backdrop"/>'
                );
              return (
                f.$promise.then(function (a) {
                  angular.isObject(a) && (a = a.data),
                    g.html && (a = a.replace(q, 'ng-bind-html="')),
                    (a = n.apply(a)),
                    (j = e(a)),
                    f.init();
                }),
                ...
                (f.show = function () {
                  var a = g.container ? k(g.container) : null,
                    b = g.container ? null : g.element;
                  (r = f.$element = j(h, function () {})),
                    r.css({ display: "block" }).addClass(g.placement),
                    g.animation &&
                      (g.backdrop && s.addClass(g.backdropAnimation),
                      r.addClass(g.animation)),
                    g.backdrop && i.enter(s, p, null, function () {}),
                    i.enter(r, a, b, function () {}),
                    (h.$isShown = !0),
                    h.$$phase || h.$digest();
                  var d = r[0];
                  o(function () {
                    ...
                    p.addClass(g.prefixClass + "-open"),
                    g.backdrop && (r.on("click", c), s.on("click", c)),
                ...
                (f.hide = function () {
                  i.leave(r, function () {
                    ...
                    g.backdrop && i.leave(s, function () {}),
                    (h.$isShown = !1),
                    h.$$phase || h.$digest(),
                    g.backdrop && (r.off("click", c), s.off("click", c)),
                    g.keyboard && r.off("keyup", f.$onKeyUp);
                }),
                (f.toggle = function () {
            ...
            var m = angular.forEach,
              ...
              o = c.requestAnimationFrame || c.setTimeout,
              p = angular.element(c.document.body),
              q = /ng-bind="/gi;
            return j;
          },
        ];
              ...
              (j.$matches = []),
                ...
                (f.$updateActiveIndex = function () {
                  c.$modelValue && j.$matches.length
                    ...
                    : j.$activeIndex >= j.$matches.length &&
                    ...
                    ? (a = g.$modelValue
                        .map(function (a) {
                          return (
                            (d = k.$getIndex(a)),
                            angular.isDefined(d)
                              ? k.$scope.$matches[d].label
                              : !1
                          );
                        })
                        .filter(angular.isDefined)
                        .join(", "))
                    : ((d = k.$getIndex(g.$modelValue)),
      ...
      .provider("$timepicker", function () {
        ...
        this.$get = [
          ...
          function (b, c, d, e, f, g, h) {
            function i(b, c, d) {
              ...
              (o.$select = function (a, b) {
                ...
                (l.select = function (a, b, d) {
                  isNaN(c.$dateValue.getTime()) &&
                    (c.$dateValue = new Date(1970, 0, 1)),
            ...
            var j =
                (angular.element(b.document.body), "createTouch" in b.document),
              k = /(ip(a|o)d|iphone|android)/gi.test(b.navigator.userAgent);
        ...
        function (a, b, c, d, e, f, g) {
          ...
          return {
            ...
            link: function (a, b, c, d) {
              ...
              var j = f(b, d, i);
              i = j.$options;
              var k = g({ format: i.timeFormat, lang: i.lang });
              angular.forEach(["minTime", "maxTime"], function (a) {
                ...
                d.$parsers.unshift(function (a) {
                  ...
                  if (!b || isNaN(b.getTime())) d.$setValidity("date", !1);
                    ...
                    var c =
                      b.getTime() >= i.minTime && b.getTime() <= i.maxTime;
                    d.$setValidity("date", c), c && (d.$dateValue = b);
                  }
                  return "string" === i.timeType
                    ? e(a, i.timeFormat)
                    : "number" === i.timeType
                    ? d.$dateValue.getTime()
                    : "iso" === i.timeType
        ...
        this.$get = [
          ...
          function (c, d, e, f, g, h, i, j, k, l) {
            function m(b, c) {
              ...
              var r, s;
              j.contentTemplate &&
                (h.$promise = h.$promise.then(function (a) {
                  var b = angular.element(a);
                  return o(j.contentTemplate).then(function (a) {
                    return (
                      n('[ng-bind="content"]', b[0])
                        .removeAttr("ng-bind")
                        .html(a),
                      b[0].outerHTML
                    );
              ...
              return (
                h.$promise.then(function (a) {
                  angular.isObject(a) && (a = a.data),
                    j.html && (a = a.replace(q, 'ng-bind-html="')),
                    (a = p.apply(a)),
                    (v = a),
                    (t = e(a)),
                    h.init();
                ...
                (h.init = function () {
                  j.delay &&
                    angular.isNumber(j.delay) &&
                    (j.delay = { show: j.delay, hide: j.delay }),
                    "self" === j.container
                      ? (w = b)
                      : j.container && (w = n(j.container));
                  var a = j.trigger.split(" ");
                  angular.forEach(a, function (a) {
                    "click" === a
                      ? b.on("click", h.toggle)
                      : "manual" !== a &&
                        (b.on("hover" === a ? "mouseenter" : "focus", h.enter),
                ...
                (h.destroy = function () {
                  for (var a = j.trigger.split(" "), c = a.length; c--; ) {
                    var d = a[c];
                    "click" === d
                      ? b.off("click", h.toggle)
                      : "manual" !== d &&
                        (b.off("hover" === d ? "mouseenter" : "focus", h.enter),
                ...
                (h.show = function () {
                  var a = j.container ? w : null,
                    c = j.container ? null : b;
                  u && u.remove(),
                    (u = h.$element = t(m, function () {})),
                    u
                      .css({ top: "0px", left: "0px", display: "block" })
                      .addClass(j.placement),
                    j.animation && u.addClass(j.animation),
                    j.type && u.addClass(j.prefixClass + "-" + j.type),
                    i.enter(u, a, c, function () {}),
                    (h.$isShown = !0),
                    m.$$phase || m.$digest(),
                    l(h.$applyPlacement),
                    j.keyboard &&
                      ("focus" !== j.trigger
                        ? (h.focus(), u.on("keyup", h.$onKeyUp))
                        : b.on("keyup", h.$onFocusKeyUp));
                }),
                (h.leave = function () {
                  return (
                    clearTimeout(r),
                    (s = "out"),
                    j.delay && j.delay.hide
                      ? void (r = setTimeout(function () {
                          "out" === s && h.hide();
                        }, j.delay.hide))
                      : h.hide()
                ...
                (h.hide = function (a) {
                  return h.$isShown
                    ? (i.leave(u, function () {
                      ...
                      m.$$phase || m.$digest(),
                      (h.$isShown = !1),
                      j.keyboard && u.off("keyup", h.$onKeyUp),
                      a && "focus" === j.trigger ? b[0].blur() : void 0)
                    : void 0;
                }),
                (h.toggle = function () {
                ...
                (h.$applyPlacement = function () {
                  if (u) {
                    var a = f(),
                      b = u.prop("offsetWidth"),
                      c = u.prop("offsetHeight"),
                      d = g(j.placement, a, b, c);
            ...
            var p = String.prototype.trim,
              q = ("createTouch" in c.document, /ng-bind="/gi);
            return m;
          },
        ];
      })
