          ...
          return {
            ...
            link: function (a, b, c, d) {
              ...
              d.$parsers.unshift(function (a) {
                ...
                (d.$render = function () {
                  b.val(
                    !d.$dateValue || isNaN(d.$dateValue.getTime())
                      ? ""
          ...
          function (b, c, d) {
            function e(b, e) {
                ...
                (i.$onKeyDown = function (a) {
                  if (/(38|40)/.test(a.keyCode)) {
                    ...
                    var b = angular.element(
                      i.$element[0].querySelectorAll("li:not(.divider) a")
                    );
                    if (b.length) {
                      var c;
              ...
              i.show = function () {
                k(),
                  setTimeout(function () {
                    j.keyboard && i.$element.on("keydown", i.$onKeyDown),
                      f.on("click", h);
                  });
              };
              var l = i.hide;
              return (
                (i.hide = function () {
                  j.keyboard && i.$element.off("keydown", i.$onKeyDown),
                    f.off("click", h),
                    l();
                }),
                i
              ...
              return (
                ...
                (f.show = function () {
                  ...
                  o(function () {
                    ...
                    g.animation &&
                      p.addClass(g.prefixClass + "-with-" + g.animation),
            ...
            function k(e) {
              ...
              return (
                ...
                (z.checkPosition = function () {
                  if (B.length) {
                    if (
                      ((y = (o ? d.pageYOffset : p.prop("scrollTop")) || 0),
                    ...
                    for (var a = B.length; a--; )
                      if (
                        !angular.isUndefined(B[a].offsetTop) &&
                        null !== B[a].offsetTop &&
                        t !== B[a].target &&
                        !(
                          y < B[a].offsetTop ||
                          (B[a + 1] && y > B[a + 1].offsetTop)
                        )
                      )
                ...
                (g.$render = function () {
                  ...
                  h.multiple && angular.isArray(g.$modelValue)
                    ? ((a = g.$modelValue
                      ...
                      (a =
                        a.length > (h.maxLength || f.maxLength)
                          ? a.length +
                            " " +
                            (h.maxLengthHtml || f.maxLengthHtml)
                          : a.join(", ")))
        ...
        function (a, b, c, d, e, f, g) {
          ...
          return {
            ...
            link: function (a, b, c, d) {
              ...
              var k = f(b, d, j);
              j = k.$options;
              var l = g({ format: j.timeFormat, lang: j.lang });
              angular.forEach(["minTime", "maxTime"], function (a) {
                ...
                d.$parsers.unshift(function (a) {
                  if (!a) return void d.$setValidity("date", !0);
                  var b = l.parse(a, d.$dateValue);
                  if (!b || isNaN(b.getTime())) d.$setValidity("date", !1);
                  else {
                    var c =
                      b.getTime() >= j.minTime && b.getTime() <= j.maxTime;
                    d.$setValidity("date", c), c && (d.$dateValue = b);
                  }
                  return "string" === j.timeType
                    ? e(a, j.timeFormat)
                    : "number" === j.timeType
                    ? d.$dateValue.getTime()
                    : "iso" === j.timeType
                ...
                (d.$render = function () {
                  b.val(
                    isNaN(d.$dateValue.getTime())
                      ? ""
                      : e(d.$dateValue, j.timeFormat)
                  );
                }),
                a.$on("$destroy", function () {
                  k.destroy(), (j = null), (k = null);
                });
            },
          };
        },
            ...
            function m(b, c) {
              ...
              return (
                h.$promise.then(function (a) {
                  angular.isObject(a) && (a = a.data),
                    j.html && (a = a.replace(r, 'ng-bind-html="')),
                    (a = p.apply(a)),
                    (w = a),
                    (u = e(a)),
                    h.init();
                ...
                (h.show = function () {
                  var a = j.container ? x : null,
                    c = j.container ? null : b;
                  v && v.remove(),
                    (v = h.$element = u(m, function () {})),
                    v
                      .css({ top: "0px", left: "0px", display: "block" })
                      .addClass(j.placement),
                    j.animation && v.addClass(j.animation),
                    j.type && v.addClass(j.prefixClass + "-" + j.type),
                    i.enter(v, a, c, function () {}),
                    (h.$isShown = m.$isShown = !0),
                    m.$$phase || m.$digest(),
                    l(h.$applyPlacement),
                    j.keyboard &&
                      ("focus" !== j.trigger
                        ? (h.focus(), v.on("keyup", h.$onKeyUp))
                ...
                (h.hide = function (a) {
                  return h.$isShown
                    ? (i.leave(v, function () {
                      ...
                      (h.$isShown = m.$isShown = !1),
                      m.$$phase || m.$digest(),
                      j.keyboard && v.off("keyup", h.$onKeyUp),
                ...
                (h.$applyPlacement = function () {
                  if (v) {
                    var a = f(),
                      b = v.prop("offsetWidth"),
                      c = v.prop("offsetHeight"),
                      d = g(j.placement, a, b, c);
                    (d.top += "px"), (d.left += "px"), v.css(d);
                  }
                }),
                ...
                (h.$onFocusElementMouseDown = function (a) {
                  a.preventDefault(),
                    a.stopPropagation(),
                    h.$isShown ? b[0].blur() : b[0].focus();
                }),
                h
              );
            }
            ...
            link: function (a, b, c, g) {
              ...
              a.$watch(c.ngModel, function () {
                l.valuesFn(a, g).then(function (a) {
                  a.length > j && (a = a.slice(0, j)), m.update(a);
                });
              }),
                a.$on("$destroy", function () {
                  m.destroy(), (h = null), (m = null);
                });
            },
          };
        },
