        ...
        function f(b, c, d) {
            ...
            (f.$onKeyDown = function (a) {
              if (/(38|40|13)/.test(a.keyCode)) {
                ...
                38 === a.keyCode && j.$activeIndex > 0
                  ? j.$activeIndex--
                  : 40 === a.keyCode && j.$activeIndex < j.$matches.length - 1
                  ? j.$activeIndex++
                  : angular.isUndefined(j.$activeIndex) && (j.$activeIndex = 0),
                  j.$digest();
              }
            });
          var k = f.show;
          f.show = function () {
            k(),
              ...
              setTimeout(function () {
                f.$element.on(g ? "touchstart" : "mousedown", f.$onMouseDown),
          ...
          return (
            (f.hide = function () {
              f.$element.off(g ? "touchstart" : "mousedown", f.$onMouseDown),
              ...
              h.multiple && angular.isArray(g.$modelValue)
                ? ((a = g.$modelValue
                    .map(function (a) {
                      return (
                        (d = k.$getIndex(a)),
                        angular.isDefined(d) ? k.$scope.$matches[d].label : !1
                      );
                    })
                    .filter(angular.isDefined)),
                  (a =
                    a.length > (h.maxLength || f.maxLength)
                      ? a.length + " " + (h.maxLengthHtml || f.maxLengthHtml)
                      : a.join(", ")))
                : ((d = k.$getIndex(g.$modelValue)),
                  (a = angular.isDefined(d) ? k.$scope.$matches[d].label : !1)),
