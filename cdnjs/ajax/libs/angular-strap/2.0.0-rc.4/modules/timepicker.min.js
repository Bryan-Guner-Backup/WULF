  ...
  .provider("$timepicker", function () {
    ...
    this.$get = [
      ...
      function (b, c, d, e, f, g, h) {
        function i(b, c, d) {
          ...
          (o.$select = function (a, b) {
            ...
            (l.$moveIndex = function (a, b) {
              var c;
              0 === b
                ? ((c = new Date(1970, 0, 1, r.hour + a * n.length, r.minute)),
          ...
          l.show = function () {
            w(),
              setTimeout(function () {
                l.$element.on(j ? "touchstart" : "mousedown", l.$onMouseDown),
          ...
          return (
            (l.hide = function (a) {
              l.$element.off(j ? "touchstart" : "mousedown", l.$onMouseDown),
        ...
        var j = (angular.element(b.document.body), "createTouch" in b.document),
          ...
          angular.forEach(["minTime", "maxTime"], function (a) {
            ...
            d.$parsers.unshift(function (a) {
              ...
              if (!b || isNaN(b.getTime())) d.$setValidity("date", !1);
                ...
                var c = b.getTime() >= j.minTime && b.getTime() <= j.maxTime;
