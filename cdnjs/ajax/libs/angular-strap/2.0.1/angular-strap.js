            ...
            var views = [
              {
                ...
                build: function () {
                  ...
                  var firstDate = new Date(
                      +firstDayOfMonth -
                        mod(firstDayOfMonth.getDay() - options.startWeek, 6) *
                          86400000
                    ),
                  ...
                  if (firstDateOffset !== firstDayOfMonthOffset)
                    firstDate = new Date(
                      +firstDate +
                        (firstDateOffset - firstDayOfMonthOffset) * 60000
                    );
                  var days = [],
                    day;
                  for (var i = 0; i < 42; i++) {
              ...
              },
              {
                ...
                onKeyDown: function (evt) {
                  ...
                  if (evt.keyCode === 37)
                    picker.select(
                      new Date(picker.$date.setMonth(actualMonth - 1)),
                      true
                    );
                  else if (evt.keyCode === 38)
                    picker.select(
                      new Date(picker.$date.setMonth(actualMonth - 4)),
                      true
                    );
                  else if (evt.keyCode === 39)
                    picker.select(
              ...
              },
              {
                ...
                onKeyDown: function (evt) {
                  ...
                  if (evt.keyCode === 37)
                    picker.select(
                      new Date(picker.$date.setYear(actualYear - 1)),
                      true
                    );
                  else if (evt.keyCode === 38)
                    picker.select(
                      new Date(picker.$date.setYear(actualYear - 4)),
                      true
                    );
                  else if (evt.keyCode === 39)
                    picker.select(
