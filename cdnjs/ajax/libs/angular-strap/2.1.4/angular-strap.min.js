                ...
                (d.checkPosition = function () {
                  ...
                  w !== r &&
                    ...
                    "top" === r
                      ...
                      : ((b = null),
                        g && o.css("width", o[0].offsetWidth + "px"),
        ...
        this.$get = [
          ...
          function (t, n, a, o, i, r, s, l) {
            function u(t, n, a) {
              ...
              var $ = g.viewDate;
              (m.$mode = p.startView),
                (m.$iconLeft = p.iconLeft),
                (m.$iconRight = p.iconRight);
              ...
              (m.$select = function (e) {
                ...
                (u.updateDisabledDates = function (e) {
                  ...
                  for (var t = 0, n = m.rows.length; n > t; t++)
                    angular.forEach(m.rows[t], u.$setDisabledEl);
                }),
          ...
          return {
            ...
            link: function (e, t, n, s) {
              ...
              function u(e) {
                if (angular.isDate(e)) {
                  var t =
                      isNaN(f.$options.minDate) ||
                      e.getTime() >= f.$options.minDate,
                    n =
                      isNaN(f.$options.maxDate) ||
                      e.getTime() <= f.$options.maxDate,
                    a = t && n;
              ...
              angular.forEach(["minDate", "maxDate"], function (e) {
                angular.isDefined(n[e]) &&
                  n.$observe(e, function (t) {
                    (f.$options[e] = g.getDateForAttribute(e, t)),
                  ...
                  return !t || isNaN(t.getTime())
                    ...
                    : (u(t),
                      "string" === d.dateType
                        ...
                        ? s.$dateValue.getTime()
                        : "iso" === d.dateType
                        ? s.$dateValue.toISOString()
                        : new Date(s.$dateValue));
                }),
                  ...
                  return (
                    (t =
                      angular.isUndefined(e) || null === e
                        ...
                        ? e
                        : "string" === d.dateType
                        ? g.parse(e, null, d.modelDateFormat)
                        : new Date(e)),
                    (s.$dateValue = t),
                    c()
                  );
                      ...
                      update: function (e, t) {
                        ...
                        e.getMonth() !== g.month
                          ? (angular.extend(g, {
                            ...
                            i.$build())
                          : e.getDate() !== g.date &&
                            ((g.date = i.$date.getDate()), i.$updateSelected());
                      },
                      build: function () {
        ...
        this.$get = [
          ...
          function (t, n, a, o) {
            function i(t, i) {
              ...
              u.hide = function () {
                u.$isShown &&
                  (c.keyboard && u.$element.off("keydown", u.$onKeyDown),
                  r.off("click", l),
        ...
        this.$get = [
          ...
          function (n, a, o, i, r, s, l, u, c) {
            function d(t) {
              ...
              function i() {
                d.$emit(u.prefixEvent + ".hide", s),
                  v.removeClass(u.prefixClass + "-open"),
                  u.animation &&
                    v.removeClass(u.prefixClass + "-with-" + u.animation);
              }
              function r(e) {
              ...
              return (
                s.$promise.then(function (e) {
                  angular.isObject(e) && (e = e.data),
                    u.html && (e = e.replace(y, 'ng-bind-html="')),
                    (e = $.apply(e)),
                    (w = o(e)),
                    s.init();
                }),
                ...
                (s.show = function () {
                  if (
                    ...
                    var e, t;
                    angular.isElement(u.container)
                      ? ((e = u.container),
                        (t = u.container[0].lastChild
                          ? angular.element(u.container[0].lastChild)
                          : null))
                      : u.container
                      ? ((e = p(u.container)),
                        (t = e[0].lastChild
                          ...
                          : null))
                      : ((e = null), (t = u.element)),
                      (b = s.$element = w(d, function () {})),
                      b.css({ display: "block" }).addClass(u.placement),
                      u.animation &&
                        (u.backdrop && D.addClass(u.backdropAnimation),
                        b.addClass(u.animation)),
                      u.backdrop && l.enter(D, v, null);
                    var a = l.enter(b, e, t, n);
                    a && a.then && a.then(n),
                      (s.$isShown = d.$isShown = !0),
                      f(d);
                    var o = b[0];
                    h(function () {
                      o.focus();
                    }),
                      v.addClass(u.prefixClass + "-open"),
                      u.animation &&
                        v.addClass(u.prefixClass + "-with-" + u.animation),
                      u.backdrop && (b.on("click", r), D.on("click", r)),
                      u.keyboard && b.on("keyup", s.$onKeyUp);
                  }
                }),
                (s.hide = function () {
                  if (
                    ...
                    var e = l.leave(b, i);
                    e && e.then && e.then(i),
                      u.backdrop && l.leave(D),
                      (s.$isShown = d.$isShown = !1),
                      f(d),
                      u.backdrop && (b.off("click", r), D.off("click", r)),
                      u.keyboard && b.off("keyup", s.$onKeyUp);
                  }
                }),
                (s.toggle = function () {
            ...
            function m(e) {
              return w[e]
                ? w[e]
                : (w[e] = i.when(r.get(e) || s.get(e)).then(function (t) {
                ...
                (T.checkPosition = function () {
                  if (x.length) {
                    if (
                      ...
                      S < x[0].offsetTop && y !== x[0].target)
                    )
                      return T.$activateElement(x[0]);
                    for (var e = x.length; e--; )
                      if (
                        !angular.isUndefined(x[e].offsetTop) &&
                        null !== x[e].offsetTop &&
                        y !== x[e].target &&
                        !(
                          S < x[e].offsetTop ||
                          (x[e + 1] && S > x[e + 1].offsetTop)
                        )
                      )
                        return T.$activateElement(x[e]);
                  }
                }),
          ...
          function (t, n, a, o, i, r, s) {
            function l(t, n, a) {
              ...
              var d = r(t, angular.extend({}, e, a)),
                ...
                w = i.getDatetimeFormat(p.timeFormat, g),
                b = i.hoursFormat(w),
                D = i.timeSeparator(w),
                k = i.minutesFormat(w),
                S = i.showAM(w);
              (m.$iconUp = p.iconUp),
                ...
                (d.$build = function () {
                  ...
                  for (e = 0; e < p.length; e++)
                    (t = new Date(1970, 0, 1, y.hour - (n - e) * p.hourStep)),
                      a.push({
                        date: t,
                        label: $(t, b),
                ...
                (d.$isDisabled = function (e, t) {
                  ...
                  return (
                    0 === t
                      ? (n = e.getTime() + 6e4 * y.minute)
                      : 1 === t && (n = e.getTime() + 36e5 * y.hour),
                ...
                (d.$moveIndex = function (e, t) {
                  ...
                  0 === t
                    ? ((n = new Date(
                      ...
                      angular.extend(y, { hour: n.getHours() }))
                    : 1 === t &&
                      ((n = new Date(
                        1970,
                        0,
                        1,
                        y.hour,
                        y.minute + e * p.length * p.minuteStep
                      )),
                      angular.extend(y, { minute: n.getMinutes() })),
                    d.$build();
                }),
          ...
          return {
            ...
            link: function (e, t, n, l) {
              ...
              angular.forEach(["minTime", "maxTime"], function (e) {
                angular.isDefined(n[e]) &&
                  n.$observe(e, function (t) {
                    (f.$options[e] = g.getTimeForAttribute(e, t)),
                  ...
                  return !t || isNaN(t.getTime())
                    ...
                    : (u(t),
                      "string" === d.timeType
                        ...
                        ? l.$dateValue.getTime()
                        : "iso" === d.timeType
                        ? l.$dateValue.toISOString()
                        : new Date(l.$dateValue));
                }),
                  ...
                  return (
                    (t =
                      angular.isUndefined(e) || null === e
                        ...
                        ? e
                        : "string" === d.timeType
                        ? g.parse(e, null, d.modelTimeFormat)
                        : new Date(e)),
                    (l.$dateValue = t),
                    c()
                  );
        ...
        this.$get = [
          ...
          function (n, a, o, i, r, s, l, u, c, d, f) {
            function p(t, n) {
              ...
              function r() {
                return (
                  V.$emit(F.prefixEvent + ".hide", E),
                  Y && "focus" === F.trigger ? t[0].blur() : void M()
                );
              }
              function s() {
                ...
                angular.forEach(e, function (e) {
                  "click" === e
                    ? t.on("click", E.toggle)
                    : "manual" !== e &&
                      (t.on("hover" === e ? "mouseenter" : "focus", E.enter),
                      t.on("hover" === e ? "mouseleave" : "blur", E.leave),
                      "button" === A &&
                        "hover" !== e &&
                        t.on(
                          v ? "touchstart" : "mousedown",
                          E.$onFocusElementMouseDown
                        ));
                });
              }
              function p() {
                for (var e = F.trigger.split(" "), n = e.length; n--; ) {
                  var a = e[n];
                  "click" === a
                    ? t.off("click", E.toggle)
                    : "manual" !== a &&
                      (t.off("hover" === a ? "mouseenter" : "focus", E.enter),
                      t.off("hover" === a ? "mouseleave" : "blur", E.leave),
                      "button" === A &&
                        "hover" !== a &&
                        t.off(
                          v ? "touchstart" : "mousedown",
              ...
              function b() {
                "focus" !== F.trigger
                  ? O.on("keyup", E.$onKeyUp)
                  : t.on("keyup", E.$onFocusKeyUp);
              }
              function D() {
                "focus" !== F.trigger
                  ? O.off("keyup", E.$onKeyUp)
                  : t.off("keyup", E.$onFocusKeyUp);
              }
              function k() {
                f(
                  function () {
              ...
              function C() {
                return "body" === F.container
                  ? c.offset(F.target[0] || t[0])
                  : c.position(F.target[0] || t[0]);
              }
              function x(e, t, n, a) {
                var o,
                  i = e.split("-");
              ...
              function M() {
                clearTimeout(H),
                  E.$isShown &&
                    null !== O &&
                    (F.autoClose && S(), F.keyboard && D()),
                  q && (q.$destroy(), (q = null)),
                  O && (O.remove(), (O = E.$element = null));
              }
              var E = {},
                A = t[0].nodeName.toLowerCase(),
                F = (E.$options = angular.extend({}, e, n));
              ...
              F.title && (V.title = u.trustAsHtml(F.title)),
                (V.$setEnabled = function (e) {
              ...
              E.$promise.then(function (e) {
                angular.isObject(e) && (e = e.data),
                  F.html && (e = e.replace(y, 'ng-bind-html="')),
                  (e = h.apply(e)),
                  (L = e),
                  (N = o(e)),
                  E.init();
                ...
                (E.init = function () {
                  F.delay &&
                    ...
                    "self" === F.container
                      ? (R = t)
                      : angular.isElement(F.container)
                      ? (R = F.container)
                      : F.container && (R = g(F.container)),
                    s(),
                    F.target &&
                      (F.target = angular.isElement(F.target)
                        ? F.target
                        : g(F.target)),
                    F.show &&
                      V.$$postDigest(function () {
                ...
                (E.show = function () {
                  if (F.bsEnabled) {
                    ...
                    F.container
                      ...
                      F.animation && O.addClass(F.animation),
                      F.type && O.addClass(F.prefixClass + "-" + F.type),
                      F.customClass && O.addClass(F.customClass);
                    var a = l.enter(O, e, n, i);
                    a && a.then && a.then(i),
                      (E.$isShown = V.$isShown = !0),
                      m(V),
                      d(function () {
                        E.$applyPlacement(),
                          O && O.css({ visibility: "visible" });
                      }),
                      F.keyboard && ("focus" !== F.trigger && E.focus(), b()),
                      F.autoClose && k();
                  }
                }),
                (E.leave = function () {
                ...
                (E.$applyPlacement = function () {
                  if (O) {
                    var e = C(),
                      ...
                      n = O.prop("offsetHeight"),
                      a = x(F.placement, e, t, n);
            ...
            function $(e) {
              return b[e]
                ? b[e]
                : (b[e] = i.when(r.get(e) || s.get(e)).then(function (t) {
                    return angular.isObject(t) ? (r.put(e, t.data), t.data) : t;
                  }));
            }
            ...
            link: function (e, t, a, s) {
              ...
              e.$watch(a.ngModel, function (t) {
                ...
                (s.$render = function () {
                  ...
                  var e = m.$getIndex(s.$modelValue),
                    n = angular.isDefined(e)
                      ? m.$scope.$matches[e].label
                      : s.$viewValue;
