            ...
            function d(t) {
              ...
              return (
                ...
                (u.show = function () {
                  if (
                    !u.$isShown &&
                    !w.$emit(d.prefixEvent + ".show.before", u).defaultPrevented
                  ) {
                    var e, t;
                    ...
                    h(function () {
                      ...
                      d.backdrop &&
                        (D.on("click", r), k.on("click", r), k.on("wheel", s)),
              ...
              angular.forEach(["minTime", "maxTime"], function (e) {
                ...
                l.$parsers.unshift(function (e) {
                  ...
                  return !t || isNaN(t.getTime())
                    ...
                    : (u(t),
                      "string" === d.timeType
                        ? g(t, d.modelTimeFormat || d.timeFormat)
                        : "number" === d.timeType
                        ? l.$dateValue.getTime()
                        : "unix" === d.timeType
                        ? l.$dateValue.getTime() / 1e3
                        : "iso" === d.timeType
                  ...
                  return (
                    (t =
                      angular.isUndefined(e) || null === e
                        ...
                        ? e
                        : "string" === d.timeType
                        ? m.parse(e, null, d.modelTimeFormat)
        ...
        this.$get = [
          ...
          function (n, a, o, i, r, s, l, u, c, d, f) {
            function p(n, i) {
              ...
              function s() {
                if ((O.$emit(P.prefixEvent + ".hide", F), R === W)) {
                  if (U && "focus" === P.trigger) return n[0].blur();
                  A();
                }
              }
              function p() {
                ...
                angular.forEach(e, function (e) {
                  "click" === e
                    ? n.on("click", F.toggle)
                    : "manual" !== e &&
                      (n.on("hover" === e ? "mouseenter" : "focus", F.enter),
                      n.on("hover" === e ? "mouseleave" : "blur", F.leave),
                      "button" === V &&
                        "hover" !== e &&
                        n.on(
              ...
              function b() {
                for (var e = P.trigger.split(" "), t = e.length; t--; ) {
                  var a = e[t];
                  "click" === a
                    ? n.off("click", F.toggle)
                    : "manual" !== a &&
                      (n.off("hover" === a ? "mouseenter" : "focus", F.enter),
                      n.off("hover" === a ? "mouseleave" : "blur", F.leave),
                      "button" === V &&
                        "hover" !== a &&
                        n.off(
                          v ? "touchstart" : "mousedown",
              ...
              function D() {
                "focus" !== P.trigger
                  ? R.on("keyup", F.$onKeyUp)
                  : n.on("keyup", F.$onFocusKeyUp);
              }
              function k() {
                "focus" !== P.trigger
                  ? R.off("keyup", F.$onKeyUp)
                  : n.off("keyup", F.$onFocusKeyUp);
              }
              function T() {
                f(
                  function () {
                    R.on("click", x), w.on("click", F.hide), (j = !0);
                  },
                  0,
                  !1
                );
              ...
              function S() {
                j && (R.off("click", x), w.off("click", F.hide), (j = !1));
              }
              function x(e) {
                e.stopPropagation();
              }
              function C(e) {
                ...
                var o;
                return (
                  (o = "body" === P.container ? c.offset(t) : c.position(t)),
                  angular.extend({}, a, o)
                );
              }
              function M(e, t, n, a) {
              ...
              if (P.delay && angular.isString(P.delay)) {
                var I = P.delay.split(",").map(parseFloat);
                P.delay = I.length > 1 ? { show: I[0], hide: I[1] } : I[0];
              }
              (F.$id = P.id || n.attr("id") || ""),
              ...
              var H, N;
              P.contentTemplate &&
                (F.$promise = F.$promise.then(function (e) {
                  var t = angular.element(e);
              ...
              F.$promise.then(function (e) {
                ...
                (F.init = function () {
                  P.delay &&
                    ...
                    (P.delay = { show: P.delay, hide: P.delay }),
                    "self" === P.container
                      ? (Y = n)
                      : angular.isElement(P.container)
                      ? (Y = P.container)
                      : P.container && (Y = m(P.container)),
                    p(),
                    P.target &&
                      (P.target = angular.isElement(P.target)
                        ? P.target
                        : m(P.target)),
                    P.show &&
                      O.$$postDigest(function () {
              ...
              (F.hide = function (e) {
                if (F.$isShown) {
                  O.$emit(P.prefixEvent + ".hide.before", F), (U = e), (W = R);
                  var t = l.leave(R, s);
                  t && t.then && t.then(s),
                    (F.$isShown = O.$isShown = !1),
                    g(O),
                ...
                (F.$applyPlacement = function () {
                  if (R) {
                    ...
                    if (i) {
                      var u = a,
                        c = P.container
                          ? angular.element(t.querySelector(P.container))
                          : n.parent(),
                        d = C(c);
                      u.indexOf("bottom") >= 0 && r.bottom + l > d.bottom
                        ? (a = u.replace("bottom", "top"))
                        : u.indexOf("top") >= 0 &&
                          r.top - l < d.top &&
                          (a = u.replace("top", "bottom")),
                        ("right" === u ||
                          "bottom-left" === u ||
                          "top-left" === u) &&
                        r.right + s > d.width
