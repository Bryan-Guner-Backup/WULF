          ...
          t = (this.controller = function (t, n, a) {
            ...
            (l.$options = angular.copy(e)),
              ...
              (l.$setActive = t.$setActive =
                function (e) {
                  angular.isArray(e)
                    ? (l.$targets.$active = angular.copy(e))
            ...
            link: function (e, t, n, s) {
              ...
              angular.forEach(["minDate", "maxDate"], function (e) {
                ...
                s.$parsers.unshift(function (e) {
                  ...
                  var n = m.parse(e, s.$dateValue);
                  return !n || isNaN(n.getTime())
                    ? void s.$setValidity("date", !1)
                    : (u(n),
                      "string" === d.dateType
                        ? ((t = m.timezoneOffsetAdjust(n, d.timezone, !0)),
                          g(t, d.modelDateFormat || d.dateFormat))
                        : ((t = m.timezoneOffsetAdjust(
                            s.$dateValue,
                            d.timezone,
                            !0
                          )),
                  ...
                  return (
                    (t =
                      angular.isUndefined(e) || null === e
                        ...
                        ? e
                        : "string" === d.dateType
                        ? m.parse(e, null, d.modelDateFormat)
                        : new Date("unix" === d.dateType ? 1e3 * e : e)),
                    (s.$dateValue = m.timezoneOffsetAdjust(t, d.timezone)),
                    c()
                  );
                }),
                (s.$render = function () {
            ...
            function (r, s) {
              var l = function (l) {
                ...
                return (
                  ...
                  (m.parse = function (t, n, a, o) {
                    a && (a = r.DATETIME_FORMATS[a] || a),
                      angular.isDate(t) && (t = s(t, a || m.$format, o));
                    var i = a ? d(a) : f,
                      l = a ? u(a) : p,
                      c = i.exec(t);
                    if (!c) return !1;
                    for (
                      var g = new e().fromDate(
            ...
            (t.setOffset = function (e, n, a) {
              ...
              "static" === d && (e.style.position = "relative"),
                ...
                (c =
                  ...
                  (r + u).indexOf("auto") > -1),
                c
                  ? ((o = t.position(e)), (s = o.top), (i = o.left))
                  : ((s = parseFloat(r) || 0), (i = parseFloat(u) || 0)),
                angular.isFunction(n) && (n = n.call(e, a, l)),
                null !== n.top && (p.top = n.top - l.top + s),
                null !== n.left && (p.left = n.left - l.left + i),
                "using" in n
                  ? n.using.call(f, p)
        ...
        this.$get = [
          ...
          function (n, a, o, i, r, s, l, u, c) {
            function d(t) {
              ...
              function i() {
                w.$emit(d.prefixEvent + ".hide", u),
                  ...
                  d.animation &&
                    v.removeClass(d.prefixClass + "-with-" + d.animation);
              }
              function r(e) {
              ...
              return (
                ...
                (u.show = function () {
                  if (!u.$isShown) {
                    ...
                    if (
                      ...
                      !w.$emit(d.prefixEvent + ".show.before", u)
                        .defaultPrevented)
                    ) {
                ...
                (u.hide = function () {
                  if (
                    u.$isShown &&
                    !w.$emit(d.prefixEvent + ".hide.before", u).defaultPrevented
                  ) {
                    var e = l.leave(D, i);
                    e && e.then && e.then(i),
            ...
            function g(e) {
              return w[e]
                ? w[e]
                : (w[e] = s.get(e, { cache: r }).then(function (e) {
                    return e.data;
                  }));
            }
        ...
        function (e, t, n) {
          return {
            ...
            link: function (e, a, o) {
              ...
              var r = /^(false|0|)$/;
              angular.forEach(["keyboard", "html"], function (e) {
                angular.isDefined(o[e]) && (i[e] = !r.test(o[e]));
              }),
                angular.isDefined(o.backdrop) &&
                  (i.backdrop = r.test(o.backdrop) ? !1 : o.backdrop),
                angular.forEach(["title", "content"], function (n) {
                  o[n] &&
                    o.$observe(n, function (a) {
                      e[n] = t.trustAsHtml(a);
        ...
        this.$get = [
          ...
          function (t, n, a, o, i) {
            function r(t, n, a) {
              ...
              (s.sort = s.sort.toString().match(/true|1/i)), (r = o(t, s));
              var u = r.$scope;
              (u.$matches = []),
                (u.$activeIndex = -1),
          ...
          function (t, n, a, o, i, r, s) {
            function l(t, n, a) {
              ...
              var f = r(t, angular.extend({}, e, a)),
                ...
                v = 0,
                y = g.roundDisplay ? o(new Date()) : new Date(),
                w = n.$dateValue || y,
                b = {
                  hour: w.getHours(),
              ...
              (m.$iconUp = g.iconUp),
                ...
                (f.$build = function () {
                  ...
                  var r = [];
                  for (e = 0; e < g.length; e++) r.push([a[e], i[e]]);
                  (m.rows = r),
                    (m.showAM = T),
                ...
                (f.$isDisabled = function (e, t) {
                  ...
                  return (
                    0 === t
                      ? (n = e.getTime() + 6e4 * b.minute)
                      : 1 === t && (n = e.getTime() + 36e5 * b.hour),
                ...
                (f.$onKeyDown = function (e) {
                  if (
                    ...
                    var t = new Date(f.$date),
                      ...
                      o = t.getMinutes(),
                      i = h(t, x).length,
                      r = /(37|39)/.test(e.keyCode),
                      s = 2 + 1 * T;
                    r &&
                      (37 === e.keyCode
                        ? (v = 1 > v ? s - 1 : v - 1)
                        : 39 === e.keyCode && (v = s - 1 > v ? v + 1 : 0));
                    var u = [0, a];
                    0 === v
                      ? (38 === e.keyCode
        ...
        function (e, t, n, a, o, i) {
          ...
          return {
            ...
            link: function (e, t, n, l) {
              ...
              var f = /^(false|0|)$/;
              angular.forEach(["roundDisplay"], function (e) {
                angular.isDefined(n[e]) && (d[e] = !f.test(n[e]));
              }),
                n.bsShow &&
                  e.$watch(n.bsShow, function (e) {
                    p &&
      ...
      .provider("$tooltip", function () {
        ...
        this.$get = [
          ...
          function (n, a, o, i, r, s, l, u, c, d, f) {
            function p(i, r) {
              function s() {
                N.$emit(H.prefixEvent + ".show", P);
              }
              function p() {
                if ((N.$emit(H.prefixEvent + ".hide", P), z === B)) {
              ...
              function b() {
                ...
                angular.forEach(e, function (e) {
                  "click" === e
                    ? i.on("click", P.toggle)
                    : "manual" !== e &&
                      (i.on("hover" === e ? "mouseenter" : "focus", P.enter),
                      i.on("hover" === e ? "mouseleave" : "blur", P.leave),
                      "button" === I &&
                        "hover" !== e &&
                        i.on(
              ...
              function D() {
                for (var e = H.trigger.split(" "), t = e.length; t--; ) {
                  var n = e[t];
                  "click" === n
                    ? i.off("click", P.toggle)
                    : "manual" !== n &&
                      (i.off("hover" === n ? "mouseenter" : "focus", P.enter),
                      i.off("hover" === n ? "mouseleave" : "blur", P.leave),
                      "button" === I &&
                        "hover" !== n &&
                        i.off(
                          v ? "touchstart" : "mousedown",
              ...
              function k() {
                "focus" !== H.trigger
                  ? z.on("keyup", P.$onKeyUp)
                  : i.on("keyup", P.$onFocusKeyUp);
              }
              function S() {
                "focus" !== H.trigger
                  ? z.off("keyup", P.$onKeyUp)
                  : i.off("keyup", P.$onFocusKeyUp);
              }
              function x() {
                f(
                  function () {
                    z.on("click", C), w.on("click", P.hide), (_ = !0);
                  },
                  0,
                  !1
                );
              ...
              function T() {
                _ && (z.off("click", C), w.off("click", P.hide), (_ = !1));
              }
              function C(e) {
                e.stopPropagation();
              }
              ...
              function O() {
                clearTimeout(R),
                  ...
                  j && (j.$destroy(), (j = null)),
                  z && (z.remove(), (z = P.$element = null));
              }
              var P = {},
                I = i[0].nodeName.toLowerCase(),
                H = (P.$options = angular.extend({}, e, r));
              P.$promise = $(H.template);
              var N = (P.$scope = (H.scope && H.scope.$new()) || a.$new());
              ...
              (P.$id = H.id || i.attr("id") || ""),
                ...
                (P.$isShown = N.$isShown = !1);
              var R, Y;
              H.contentTemplate &&
                (P.$promise = P.$promise.then(function (e) {
                  var t = angular.element(e);
              ...
              var q, z, K, U, j;
              P.$promise.then(function (e) {
                angular.isObject(e) && (e = e.data),
                  H.html && (e = e.replace(y, 'ng-bind-html="')),
                  (e = h.apply(e)),
                  (K = e),
                  (q = o(e)),
                  P.init();
                ...
                (P.init = function () {
                  H.delay &&
                    ...
                    H.show &&
                      N.$$postDigest(function () {
                        "focus" === H.trigger ? i[0].focus() : P.show();
                      });
                }),
                (P.destroy = function () {
                  D(), O(), N.$destroy();
                ...
                (P.show = function () {
                  if (H.bsEnabled && !P.$isShown) {
                    N.$emit(H.prefixEvent + ".show.before", P);
                    var e, t;
                    H.container
                      ? ((e = U),
                        (t = U[0].lastChild
                      ...
                      (P.$isShown = N.$isShown = !0),
                      g(N),
                      P.$applyPlacement();
                    var n = l.enter(z, e, t, s);
                    n && n.then && n.then(s),
                      g(N),
                      d(function () {
                        z && z.css({ visibility: "visible" });
                      }),
                      H.keyboard && ("focus" !== H.trigger && P.focus(), k()),
                      H.autoClose && x();
                  }
                }),
                (P.leave = function () {
              ...
              (P.hide = function (e) {
                if (P.$isShown) {
                  N.$emit(H.prefixEvent + ".hide.before", P), (W = e), (B = z);
                  var t = l.leave(z, p);
                  t && t.then && t.then(p),
                    (P.$isShown = N.$isShown = !1),
                    g(N),
                ...
                (P.$onKeyUp = function (e) {
                  27 === e.which &&
                    P.$isShown &&
                    (P.hide(), e.stopPropagation());
                }),
                (P.$onFocusKeyUp = function (e) {
                  27 === e.which && (i[0].blur(), e.stopPropagation());
                }),
                (P.$onFocusElementMouseDown = function (e) {
                  e.preventDefault(),
                    e.stopPropagation(),
                    P.$isShown ? i[0].blur() : i[0].focus();
                });
              var _ = !1;
              return P;
            }
          ...
          return {
            ...
            link: function (e, t, i) {
              ...
              angular.forEach(
                ...
                t.attr("data-target") && (r.target = t.attr("data-target")),
                e.hasOwnProperty("title") || (e.title = ""),
