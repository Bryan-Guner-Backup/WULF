            ...
            function f(t) {
              ...
              return (
                ...
                (u.hide = function () {
                  if (
                    u.$isShown &&
                    !f.$emit(d.prefixEvent + ".hide.before", u).defaultPrevented
                  ) {
                    var e = l.leave(D, i);
                    e && e.then && e.then(i),
        ...
        this.$get = [
          ...
          function (n, a, o, i, r, s, l, u, c, d, f) {
            function p(i, r) {
              ...
              (I.hide = function (e) {
                if (I.$isShown) {
                  N.$emit(H.prefixEvent + ".hide.before", I), (W = e), (B = z);
                  var t = l.leave(z, p);
                  t && t.then && t.then(p),
                    (I.$isShown = N.$isShown = !1),
                    g(N),
        ...
        function (e, t, a, o, i) {
          ...
          return {
            ...
            link: function (e, t, a, s) {
              ...
              var c = l.filter || r.filter,
                d = l.limit || r.limit,
                f = l.comparator || r.comparator,
                p = a.bsOptions;
              c && (p += " | " + c + ":$viewValue"),
                f && (p += ":" + f),
                d && (p += " | limitTo:" + d);
              ...
              if (l.watchOptions) {
                var $ = g.$match[7]
                  ...
                  .replace(/\(.*\)/g, "")
                  .trim();
                e.$watchCollection($, function (t, n) {
                  g.valuesFn(e, s).then(function (e) {
                    m.update(e), s.$render();
                  });
                });
              }
              e.$watch(a.ngModel, function (t, n) {
                (e.$modelValue = t),
                  g.valuesFn(e, s).then(function (e) {
                ...
                (s.$render = function () {
                  ...
                  var e = m.$getIndex(s.$modelValue),
                    n = angular.isDefined(e)
                      ...
                      : s.$viewValue;
                  n = angular.isObject(n) ? g.displayValue(n) : n;
