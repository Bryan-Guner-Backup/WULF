          ...
          var DateParserFactory = function (config) {
            ...
            var setFnMap = {
              ...
              MMMM: function (value) {
                return this.setMonth(
                  indexOfCaseInsensitive($locale.DATETIME_FORMATS.MONTH, value)
                );
              },
              MMM: function (value) {
                return this.setMonth(
            ...
            $dateParser.getTimeForAttribute = function (key, value) {
              ...
              if (value === "now") {
                ...
                time = new Date(value.substr(1, value.length - 2)).setFullYear(
                  1970,
                  0,
                  1
                );
            ...
            $dateParser.timezoneOffsetAdjust = function (date, timezone, undo) {
              ...
              if (timezone && timezone === "UTC") {
                ...
                date.setMinutes(
                  date.getMinutes() + (undo ? -1 : 1) * date.getTimezoneOffset()
                );
              }
              return date;
            };
