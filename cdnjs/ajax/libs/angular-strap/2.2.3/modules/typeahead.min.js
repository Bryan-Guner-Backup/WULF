      ...
      function (t, n, a, i) {
        function o(t, n, o) {
          ...
          (u.$resetMatches = function () {
            (u.$matches = []), (u.$activeIndex = l.autoSelect ? 0 : -1);
          }),
            u.$resetMatches(),
            ...
            (r.update = function (e) {
              (u.$matches = e),
                u.$activeIndex >= e.length &&
                  (u.$activeIndex = l.autoSelect ? 0 : -1),
                /^(bottom|bottom-left|bottom-right)$/.test(l.placement) ||
                  i(r.$applyPlacement);
            }),
            ...
            (r.select = function (e) {
              if (-1 !== e) {
                ...
                n.$setViewValue(t),
                  ...
                  u.$resetMatches(),
                  c && c.$digest(),
                  u.$emit(l.prefixEvent + ".select", t, e, r);
              }
            }),
              ...
              i(
                function () {
                  r.$element.on("mousedown", r.$onMouseDown),
                    l.keyboard && t.on("keydown", r.$onKeyDown);
                },
                0,
                !1
              );
          ...
          return (
            (r.hide = function () {
              r.$element.off("mousedown", r.$onMouseDown),
                l.keyboard && t.off("keydown", r.$onKeyDown),
                l.autoSelect || r.activate(-1),
                $();
            }),
            r
          );
      ...
      return {
        ...
        link: function (e, t, n, r) {
          ...
          angular.forEach(["html", "container", "trimValue"], function (e) {
            angular.isDefined(n[e]) && c.test(n[e]) && (l[e] = !1);
          }),
            t.attr("autocomplete", "off");
          var u = l.filter || o.filter,
            s = l.limit || o.limit,
            $ = l.comparator || o.comparator,
            d = n.bsOptions;
          u && (d += " | " + u + ":$viewValue"),
            $ && (d += ":" + $),
            s && (d += " | limitTo:" + s);
          ...
          if (l.watchOptions) {
            ...
            e.$watchCollection(m, function (t, n) {
              f.valuesFn(e, r).then(function (e) {
                p.update(e), r.$render();
              });
            });
          }
              ...
              f.valuesFn(e, r).then(function (e) {
                ...
                n && p.update(e),
                  (1 !== e.length || e[0].value !== t) &&
                    (!n && p.update(e), r.$render());
              });
          }),
            r.$formatters.push(function (e) {
              var t = f.displayValue(e);
              return void 0 === t ? "" : t;
            }),
            (r.$render = function () {
              if (r.$isEmpty(r.$viewValue)) return t.val("");
              var e = p.$getIndex(r.$modelValue),
                n = angular.isDefined(e)
                  ? p.$scope.$matches[e].label
                  : r.$viewValue;
              n = angular.isObject(n) ? f.displayValue(n) : n;
              var a = n ? n.toString().replace(/<(?:.|\n)*?>/gm, "") : "";
              t.val(l.trimValue === !1 ? a : a.trim());
            }),
            e.$on("$destroy", function () {
              p && p.destroy(), (l = null), (p = null);
            });
        },
      };
    },
