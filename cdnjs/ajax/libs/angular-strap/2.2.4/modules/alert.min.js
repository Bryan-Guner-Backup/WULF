  ...
  .provider("$alert", function () {
    ...
    this.$get = [
      ...
      function (e, n) {
        function a(a) {
          var r = {},
            i = angular.extend({}, t, a);
          (r = e(i)),
            (r.$scope.dismissable = !!i.dismissable),
            i.type && (r.$scope.type = i.type);
          var l = r.show;
          return (
            i.duration &&
              (r.show = function () {
  ...
  .directive("bsAlert", [
    ...
    function (t, e, n) {
      ...
      return {
        restrict: "EAC",
        scope: !0,
        link: function (t, a, r, i) {
          var l = { scope: t, element: a, show: !1 };
          angular.forEach(
            [
              "template",
              "placement",
