          ...
          if (c) {
            ...
            for (var h in c)
              if (
                ...
                ((g = c[h]), b.indexOf(angular.lowercase(g)) > -1)
              )
                return g;
          }
          var i = a.split("_");
          return i.length > 1 && b.indexOf(angular.lowercase(i[0])) > -1
            ? i[0]
            : void 0;
        },
        z = function (a, b) {
        ...
        (this.$get = [
          ...
          function (a, c, i, q) {
            var w,
              x,
              y,
              D = c.get(k || "$translateDefaultInterpolation"),
              E = !1,
              F = {},
              G = {},
              H = function (a, c, e) {
              ...
              s.length &&
                angular.forEach(s, function (a) {
                  ...
                  d.setLocale(b || f),
                    angular.isFunction(d.useSanitizeValueStrategy) &&
                      d.useSanitizeValueStrategy(t),
                    (F[d.getInterpolationIdentifier()] = d);
                });
            var M = function (a) {
                var b = q.defer();
              ...
              T = function (a, b, e) {
                ...
                if (h && h.hasOwnProperty(a)) {
                  var k = h[a];
                  "@:" === k.substr(0, 2)
                    ? H(k.substr(2), b, e).then(g.resolve, g.reject)
                    : g.resolve(i.interpolate(k, b));
                } else
                  j && !E && c.get(j)(a, f),
                    f && d && d.length
                      ? R(a, b, i).then(
            ...
            if (
              ...
              (H.refresh = function (a) {
                ...
                if ((i.$emit("$translateRefreshStart"), a))
                  ...
                  var g = [];
                  if (d && d.length)
                    for (var h = 0, j = d.length; j > h; h++) g.push(L(d[h]));
                  f && g.push(L(f)),
              ...
              (H.instant = function (a, e, g) {
                if (angular.isArray(a)) {
                  for (var h = {}, i = 0, k = a.length; k > i; i++)
                    h[a[i]] = H.instant(a[i], e, g);
                  return h;
                }
                ...
                b && m.push(b),
                  f && m.push(f),
                  d && d.length && (m = m.concat(d));
                for (var n = 0, o = m.length; o > n; n++) {
                  var q = m[n];
                  if (
                    (p[q] && "undefined" != typeof p[q][a] && (l = U(a, e, g)),
                    "undefined" != typeof l)
                  )
                    break;
                }
              ...
              l && (angular.equals(p, {}) && H.use(H.use()), d && d.length))
            )
              for (var V = 0, W = d.length; W > V; V++) G[d[V]] = L(d[V]);
            return H;
          },
        ]);
    },
      ...
      return {
        ...
        compile: function (b, g) {
          ...
          return function (b, k, l) {
            if (
              ((b.interpolateParams = {}),
              l.$observe("translate", function (a) {
                b.translationId =
                  angular.equals(a, "") || !angular.isDefined(a)
                    ? c(k.text().replace(/^\s+|\s+$/g, ""))(b.$parent)
                    : a;
              }),
              ...
              h &&
                l.$observe("translateValues", function (a) {
                  a &&
