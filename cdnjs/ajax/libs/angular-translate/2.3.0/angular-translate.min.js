...
angular.module("pascalprecht.translate", ["ng"]).run([
  ...
  angular.module("pascalprecht.translate").provider("$translate", [
    ...
    function (a) {
      var b,
        ...
        A = function (a) {
          for (
            var b = [], d = angular.lowercase(a), e = 0, f = q.length;
            f > e;
            e++
          )
          ...
          if (c) {
            ...
            for (var h in c) {
              ...
              if (
                ...
                (j || i) && ((g = c[h]), y(b, angular.lowercase(g)) > -1))
              )
                return g;
            }
          }
          var k = a.split("_");
          return k.length > 1 && y(b, angular.lowercase(k[0])) > -1 ? k[0] : a;
        },
        B = function (a, b) {
          if (!a && !b) return p;
          if (a && !b) {
            ...
            angular.isObject(p[a]) || (p[a] = {}), angular.extend(p[a], C(b));
          return this;
        };
      (this.translations = B),
      ...
      var E = function (a) {
        return a
          ? (angular.isString(a)
              ? ((e = !0), (d = [a]))
              : angular.isArray(a) && ((e = !1), (d = a)),
            angular.isString(b) && y(d, b) < 0 && d.push(b),
            this)
          : e
          ? d[0]
          : d;
        ...
        (this.$get = [
          ...
          function (a, c, i, q) {
            var w,
              x,
              G,
              H = c.get(k || "$translateDefaultInterpolation"),
              I = !1,
              J = {},
              K = {},
              L = function (a, c, e) {
                    ...
                    for (
                      var b = {},
                        ...
                        f = function (a) {
                          ...
                          return L(a, c, e).then(f, f), d.promise;
                        },
                        g = 0,
                        h = a.length;
                      h > g;
                ...
                return (
                  j
                    ? j.then(function () {
                        X(a, c, e).then(i.resolve, i.reject);
                      }, i.reject)
                    : X(a, c, e).then(i.resolve, i.reject),
                  i.promise
                );
              ...
              M = function (a) {
                return (
                  n && (a = [n, a].join(" ")), o && (a = [a, o].join(" ")), a
                );
              },
              N = function (a) {
                (f = a),
                  i.$emit("$translateChangeSuccess"),
                  h && w.set(L.storageKey(), f),
                  H.setLocale(f),
                        ...
                        i.$emit("$translateLoadingSuccess"),
                          angular.isArray(c)
                            ? angular.forEach(c, function (a) {
                                angular.extend(d, C(a));
                              })
                            : angular.extend(d, C(c)),
                          (I = !1),
            ...
            if (h && ((w = c.get(h)), !w.get || !w.set))
              throw new Error(
                "Couldn't use storage '" +
                  h +
                  "', missing get() or set() method!"
              );
            angular.isFunction(H.useSanitizeValueStrategy) &&
              H.useSanitizeValueStrategy(t),
              s.length &&
                angular.forEach(s, function (a) {
                  var d = c.get(a);
                  d.setLocale(b || f),
                    angular.isFunction(d.useSanitizeValueStrategy) &&
                      d.useSanitizeValueStrategy(t),
                    (J[d.getInterpolationIdentifier()] = d);
                });
            var P = function (a) {
                var b = q.defer();
                return Object.prototype.hasOwnProperty.call(p, a)
                  ? (b.resolve(p[a]), b.promise)
                  : (K[a].then(function (a) {
                      B(a.key, a.table), b.resolve(a.table);
                    }, b.reject),
                    b.promise);
              },
              Q = function (a, b, c, d) {
              ...
              U = function (a, b, c, e) {
                ...
                if (a < d.length) {
                  var g = d[a];
                  (f = R(g, b, c, e)), f || (f = U(a + 1, b, c, e));
                }
                return f;
              },
              V = function (a, b, c) {
                return T(G > 0 ? G : x, a, b, c);
              },
              W = function (a, b, c) {
                return U(G > 0 ? G : x, a, b, c);
              },
              X = function (a, b, c) {
                var e = q.defer(),
                  g = f ? p[f] : p,
                ...
                if (g && Object.prototype.hasOwnProperty.call(g, a)) {
                  var i = g[a];
                  "@:" === i.substr(0, 2)
                    ? L(i.substr(2), b, c).then(e.resolve, e.reject)
                    : e.resolve(h.interpolate(i, b));
                } else {
                  var k;
                  j && !I && (k = S(a)),
                    f && d && d.length
            ...
            if (
              ((L.preferredLanguage = function (a) {
                return a && D(a), b;
              }),
              (L.cloakClassName = function () {
                return u;
              }),
              (L.fallbackLanguage = function (a) {
                if (void 0 !== a && null !== a) {
                  if ((E(a), l && d && d.length))
              ...
              (L.useFallbackLanguage = function (a) {
                if (void 0 !== a && null !== a)
                  if (a) {
                    var b = y(d, a);
                    b > -1 && (G = b);
              ...
              (L.storageKey = function () {
                return F();
              }),
              (L.isPostCompilingEnabled = function () {
                return v;
              }),
              (L.refresh = function (a) {
                ...
                var e = q.defer();
                if ((i.$emit("$translateRefreshStart"), a))
                  p[a]
                    ? O(a).then(function (c) {
                        B(c.key, c.table), a === f && N(f), b();
                      }, c)
                    : c();
                else {
                  var g = [];
                  if (d && d.length)
                    for (var h = 0, j = d.length; j > h; h++) g.push(O(d[h]));
                  f && g.push(O(f)),
                    q.all(g).then(function (a) {
                      angular.forEach(a, function (a) {
                        p[a.key] && delete p[a.key], B(a.key, a.table);
                      }),
                        f && N(f),
                        b();
                    });
              ...
              (L.instant = function (a, c, e) {
                ...
                for (var m = 0, n = l.length; n > m; m++) {
                  var o = l[m];
                  if (
                    (p[o] && "undefined" != typeof p[o][a] && (k = Y(a, c, e)),
                    "undefined" != typeof k)
                  )
                    break;
                }
                return k || "" === k || ((k = a), j && !I && (k = S(a))), k;
              }),
              l && (angular.equals(p, {}) && L.use(L.use()), d && d.length))
            )
              for (
                var Z = function (a) {
                    B(a.key, a.table);
            ...
            escaped: function (a) {
              ...
              for (var c in a)
                Object.prototype.hasOwnProperty.call(a, c) &&
                  (b[c] = angular.element("<div></div>").text(a[c]).html());
              return b;
            },
          },
          g = function (a) {
            ...
            if (
              ...
              m.$observe("translate", function (a) {
                if (angular.equals(a, "") || !angular.isDefined(a)) {
                  ...
                  angular.isArray(d)
                    ? ((b.preText = d[1]),
                      (b.postText = d[3]),
                      (b.translationId = c(d[2])(b.$parent)))
              ...
              var n = function (a) {
                m.$observe(a, function (c) {
                  b.interpolateParams[
                    angular.lowercase(a.substr(14, 1)) + a.substr(15)
                  ] = c;
                });
              };
              for (var o in m)
              ...
              q = (function () {
                return h || j
                  ? function () {
                      ...
                      b.$watch("interpolateParams", c, !0),
                        b.$watch("translationId", c);
                    }
                  : function () {
                      var c = b.$watch(
                        "translationId",
  ...
  angular.module("pascalprecht.translate").directive("translateCloak", [
    ...
    function (a, b) {
      return {
        compile: function (c) {
          var d = a.$on("$translateChangeEnd", function () {
            c.removeClass(b.cloakClassName()), d(), (d = null);
          });
