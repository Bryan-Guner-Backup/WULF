  ...
  angular.module("pascalprecht.translate").provider("$translate", [
    ...
    function (a) {
      ...
      var B = function (a, b) {
        ...
        D = function (a) {
          for (
            var b = [], d = angular.lowercase(a), e = 0, f = r.length;
            f > e;
            e++
          )
          ...
          if (c) {
            ...
            for (var h in c) {
              ...
              if (
                ...
                (j || i) && ((g = c[h]), B(b, angular.lowercase(g)) > -1))
              )
                return g;
            }
          }
      ...
      var H = function (a) {
        return a
          ? (angular.isString(a)
            ...
            angular.isString(b) && B(d, b) < 0 && d.push(b),
            this)
          : e
          ? d[0]
          : d;
            ...
            var R = function (a) {
              ...
              Z = function (a, b, c) {
                ...
                if (g && Object.prototype.hasOwnProperty.call(g, a)) {
                  var i = g[a];
                  "@:" === i.substr(0, 2)
                    ? N(i.substr(2), b, c).then(e.resolve, e.reject)
            ...
            if (
              ...
              (N.instant = function (a, c, e) {
                ...
                for (var m = 0, n = l.length; n > m; m++) {
                  var o = l[m];
                  if (
                    (q[o] && "undefined" != typeof q[o][a] && (k = $(a, c, e)),
                    "undefined" != typeof k)
                  )
                    break;
                }
              ...
              for (
                var _ = function (a) {
                    return (
                      E(a.key, a.table),
                      i.$emit("$translateChangeEnd", { language: a.key }),
                      a
                    );
                  },
                  ab = 0,
              ...
              o = function (a) {
                if (angular.equals(a, "") || !angular.isDefined(a)) {
                  ...
                  angular.isArray(d)
                    ? ((b.preText = d[1]),
                      (b.postText = d[3]),
                      (n.translate = c(d[2])(b.$parent)))
                    : (n.translate = l.text().replace(/^\s+|\s+$/g, ""));
                } else n.translate = a;
                t();
              },
              p = function (a) {
                m.$observe(a, function (b) {
                  (n[a] = b), t();
                });
              };
            ...
            var t = function () {
              ...
              v = function (b, c, e, f) {
                if ("translate" === f) {
                  ...
                  ((h && !i) || j) && d(l.contents())(c);
                } else {
                  e ||
                    "undefined" == typeof c.defaultText ||
                    (b = c.defaultText);
                  var k = m.$attr[f].substr(15);
                  l.attr(k, b);
                }
              };
            b.$watch("interpolateParams", t, !0);
            var w = f.$on("$translateChangeSuccess", t);
            l.text().length && o(""), t(), b.$on("$destroy", w);
          };
        },
      };
    },
