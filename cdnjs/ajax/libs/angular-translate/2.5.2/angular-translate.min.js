      ...
      return {
        ...
        compile: function (b, g) {
          ...
          return function (b, m, n) {
              ...
              p = function (a) {
                if (angular.equals(a, "") || !angular.isDefined(a)) {
                  ...
                  angular.isArray(d)
                    ? ((b.preText = d[1]),
                      (b.postText = d[3]),
                      (o.translate = c(d[2])(b.$parent)),
                      (watcherMatches = m.text().match(l)),
                      angular.isArray(watcherMatches) &&
                        watcherMatches[2] &&
                        watcherMatches[2].length &&
                        b.$watch(watcherMatches[2], function (a) {
                          (o.translate = a), u();
                        }))
            ...
            for (var r in n)
              n.hasOwnProperty(r) &&
                "translateAttr" === r.substr(0, 13) &&
                q(r);
            if (
              (n.$observe("translateDefault", function (a) {
                b.defaultText = a;
              }),
              h &&
                n.$observe("translateValues", function (a) {
                  a &&
