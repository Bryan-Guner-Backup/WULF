  ...
  angular.module("pascalprecht.translate").provider("$translate", [
    ...
    function (a, b) {
      ...
      var D = function (a, b) {
        ...
        F = function (a) {
          for (
            var b = [], c = angular.lowercase(a), e = 0, f = s.length;
            f > e;
            e++
          )
          ...
          if (d) {
            ...
            for (var h in d) {
              ...
              if (
                ...
                (j || i) && ((g = d[h]), D(b, angular.lowercase(g)) > -1))
              )
                return g;
            }
          }
      ...
      var J = function (a) {
        return a
          ? (angular.isString(a)
              ? ((f = !0), (e = [a]))
              : angular.isArray(a) && ((f = !1), (e = a)),
            angular.isString(c) && D(e, c) < 0 && e.push(c),
            this)
          : f
          ? e[0]
          : e;
        ...
        (this.$get = [
          ...
          function (a, b, d, j) {
            var s,
              y,
              B,
              C = b.get(l || "$translateDefaultInterpolation"),
              L = !1,
              M = {},
              N = {},
              O = function (a, b, d, f) {
              ...
              P = function (a) {
                return (
                  o && (a = [o, a].join(" ")), p && (a = [a, p].join(" ")), a
                );
              },
              Q = function (a) {
                (g = a),
                  d.$emit("$translateChangeSuccess", { language: a }),
                  i && s.put(O.storageKey(), g),
                  C.setLocale(g),
                ...
                return (
                  b
                    ...
                    .then(
                      function (b) {
                        var e = {};
                        d.$emit("$translateLoadingSuccess", { language: a }),
                          angular.isArray(b)
                            ? angular.forEach(b, function (a) {
                                angular.extend(e, H(a));
                              })
                            : angular.extend(e, H(b)),
                          (L = !1),
                          c.resolve({ key: a, table: e }),
                          d.$emit("$translateLoadingEnd", { language: a });
                      },
                      function (a) {
                        d.$emit("$translateLoadingError", { language: a }),
                          c.reject(a),
                          d.$emit("$translateLoadingEnd", { language: a });
                      }
                    ),
            ...
            angular.isFunction(C.useSanitizeValueStrategy) &&
              C.useSanitizeValueStrategy(v),
              u.length &&
                angular.forEach(u, function (a) {
                  var d = b.get(a);
                  d.setLocale(c || g),
                    angular.isFunction(d.useSanitizeValueStrategy) &&
                      d.useSanitizeValueStrategy(v),
            ...
            var S = function (a) {
                ...
                return (
                  S(a).then(function (f) {
                    if (Object.prototype.hasOwnProperty.call(f, b)) {
                      ...
                      var h = f[b];
                      "@:" === h.substr(0, 2)
                        ? T(a, h.substr(2), c, d).then(e.resolve, e.reject)
                        : e.resolve(d.interpolate(f[b], c)),
                        d.setLocale(g);
                    } else e.reject();
                  }, e.reject),
                  e.promise
              ...
              $ = function (a, b, c, d) {
                ...
                if (h && Object.prototype.hasOwnProperty.call(h, a)) {
                  var l = h[a];
                  "@:" === l.substr(0, 2)
                    ? O(l.substr(2), b, c, d).then(f.resolve, f.reject)
                    : f.resolve(i.interpolate(l, b));
                } else {
                  var m;
                  k && !L && (m = V(a)),
                    g && e && e.length
            ...
            if (
              ((O.preferredLanguage = function (a) {
                return a && I(a), c;
              }),
                  ...
                  r[a] || !m || N[a]
                    ...
                    : ((h = a),
                      (N[a] = R(a).then(
                        ...
                        function (a) {
                          h === a && (h = void 0),
                            d.$emit("$translateChangeError", { language: a }),
                            b.reject(a),
                            d.$emit("$translateChangeEnd", { language: a });
                        }
                      ))),
              ...
              (O.instant = function (a, b, d) {
                ...
                c && l.push(c),
                  g && l.push(g),
                  e && e.length && (l = l.concat(e));
                for (var m = 0, n = l.length; n > m; m++) {
                  var q = l[m];
                  if (
                    (r[q] &&
                      ("undefined" != typeof r[q][a]
                        ? (j = _(a, b, d))
                        : (o || p) && (j = P(a))),
                    "undefined" != typeof j)
                  )
              ...
              for (
                var ab = function (a) {
                    return (
                      G(a.key, a.table),
                      d.$emit("$translateChangeEnd", { language: a.key }),
                      a
                    );
                  },
                  bb = 0,
            ...
            escaped: function (a) {
              ...
              for (var c in a)
                Object.prototype.hasOwnProperty.call(a, c) &&
                  (b[c] = angular.isNumber(a[c])
                    ? a[c]
                    : angular.element("<div></div>").text(a[c]).html());
              return b;
            },
          },
          g = function (a) {
        ...
        compile: function (b, h) {
          ...
          return function (b, n, o) {
            ...
            var p = {},
              q = function (a) {
                if (
                  (angular.isFunction(q._unwatchOld) &&
                    (q._unwatchOld(), (q._unwatchOld = void 0)),
                  ...
                  if (angular.isArray(d)) {
                    ...
                    angular.isArray(e) &&
                      e[2] &&
                      e[2].length &&
                      (q._unwatchOld = b.$watch(e[2], function (a) {
                        (p.translate = a), w();
                      }));
            ...
            var w = function () {
                for (var a in p)
                  p.hasOwnProperty(a) &&
                    x(a, p[a], b, b.interpolateParams, b.defaultText);
              },
