        ...
        link: function (b, c, d) {
          function e() {
            c.removeClass("collapse").addClass("collapsing"),
              a
                .addClass(c, "in", { to: { height: c[0].scrollHeight + "px" } })
                .then(f);
          }
          function f() {
          ...
          function g() {
            c
              .css({ height: c[0].scrollHeight + "px" })
              .removeClass("collapse")
              .addClass("collapsing"),
              a.removeClass(c, "in", { to: { height: "0" } }).then(h);
          }
          function h() {
            c.css({ height: "0" }),
      ...
      function (a, b, c) {
        ...
        (j.select = a.select =
          function (b, d) {
            function f() {
              m ||
                (angular.extend(b, { direction: d, active: !0 }),
            ...
            void 0 === d && (d = g > j.getCurrentIndex() ? "next" : "prev"),
              b && b !== j.currentSlide && f();
          }),
          a.$on("$destroy", function () {
            m = !0;
          }),
          (j.getCurrentIndex = function () {
            return j.currentSlide && angular.isDefined(j.currentSlide.index)
              ? +j.currentSlide.index
              : l;
          }),
    ...
    function (a, b) {
      function c(a) {
        var c = [],
          d = a.split("");
        return (
          angular.forEach(f, function (b, e) {
            var f = a.indexOf(e);
            if (f > -1) {
          ...
          link: function (b, c, d, e) {
            ...
            (e._refreshView = function () {
              ...
              if (
                ...
                b.weekNumbers = [];
                for (
                  var o = (11 - e.startingDay) % 7, p = b.rows.length, q = 0;
                  p > q;
                  q++
                )
      ...
      function (a, b, c, d, e, f, g) {
        return {
          ...
          link: function (h, i, j, k) {
            ...
            var o,
              p = angular.isDefined(j.closeOnDateSelection)
                ? h.$parent.$eval(j.closeOnDateSelection)
                : g.closeOnDateSelection,
              q = angular.isDefined(j.datepickerAppendToBody)
            ...
            if (
              (g.html5Types[j.type]
                ? ((o = g.html5Types[j.type]), (r = !0))
                : ((o = j.datepickerPopup || g.datepickerPopup),
            ...
            (h.watchData = {}),
              ...
              j.showWeeks && t.attr("show-weeks", j.showWeeks),
              j.customClass &&
                t.attr(
                  "custom-class",
              ...
              (h.dateSelection = function (a) {
                ...
                i.val(b),
                  k.$setViewValue(b),
                  p && ((h.isOpen = !1), i[0].focus());
              }),
              k.$viewChangeListeners.push(function () {
                h.date =
                  f.parse(k.$viewValue, o, h.date) || new Date(k.$viewValue);
              });
            var v = function (a) {
                h.isOpen &&
                  a.target !== i[0] &&
              ...
              h.$watch("isOpen", function (a) {
                a
                  ? (h.$broadcast("datepicker.focus"),
                    (h.position = q ? d.offset(i) : d.position(i)),
            ...
            var x = a(s)(h);
            s.remove(),
              q ? c.find("body").append(x) : i.after(x),
        ...
        (this.init = function (d) {
          (j.$element = d),
            b.isOpen &&
              ((i = c(b.isOpen)),
              (m = i.assign),
              a.$watch(i, function (a) {
                k.isOpen = !!a;
              })),
            (o = angular.isDefined(b.dropdownAppendToBody)),
            o &&
              j.dropdownMenu &&
              (h.find("body").append(j.dropdownMenu),
          ...
          k.$watch("isOpen", function (b, c) {
            ...
            f[b ? "addClass" : "removeClass"](j.$element, l),
              b ? (k.focusToggleElement(), e.open(k)) : e.close(k),
              m(a, b),
              angular.isDefined(b) && b !== c && n(a, { open: !!b });
          }),
      ...
      function (a, b, c, d, e, f) {
        ...
        function h(a) {
          var b = c.find("body").eq(0),
            d = o.get(a).value;
          o.remove(a),
            j(d.modalDomEl, d.modalScope, function () {
        ...
        function j(c, d, f) {
          ...
          (d.animate = !1),
            c.attr("modal-animation") && a.enabled()
              ? c.one("$animate:close", function () {
                  e.$evalAsync(g);
                })
              : b(g);
        }
        ...
        return (
          ...
          (p.open = function (a, b) {
            ...
            var p = d(k)(b.scope);
            (o.top().value.modalDomEl = p),
              (o.top().value.modalOpener = f),
              h.append(p),
              h.addClass(n);
          }),
                  ...
                  m.then(
                    function (a) {
                      ...
                      b.controller &&
                        ...
                        (h = f(b.controller, i)),
                        b.controllerAs && (d[b.controllerAs] = h)),
                        g.open(l, {
                          scope: d,
                          deferred: e,
                          renderDeferred: k,
                  ...
                  return function (b, c, d) {
                    ...
                    function o() {
                      return (
                        (A = null),
                        z && (g.cancel(z), (z = null)),
                        (m.useContentExp ? E.contentExp() : E.content)
                          ? (q(),
                    ...
                    function w() {
                      ...
                      G(),
                        ...
                        C.show === C.hide
                          ? c.bind(C.show, f)
                          : (c.bind(C.show, j), c.bind(C.hide, l));
                    }
                    var x,
                      y,
                      z,
                      A,
                      B = angular.isDefined(m.appendToBody)
                        ? m.appendToBody
                        : !1,
                      C = n(void 0),
      ...
      function (a, b, c, d) {
        return {
          link: function (e, f, g) {
            ...
            e.$watch(
              b.parseAsResourceUrl(g.tooltipTemplateTransclude),
              function (b) {
                var g = ++l;
                b
                  ? (d(b, !0).then(
          ...
          compile: function (c, d, e) {
            return function (c, d, f, g) {
              c.$watch("active", function (a) {
                ...
                (c.disabled = !1),
                f.disable &&
                  c.$parent.$watch(a(f.disable), function (a) {
                    c.disabled = !!a;
                  }),
                f.disabled &&
                  (b.warn(
    ...
    .controller("TimepickerController", [
      ...
      function (a, b, c, d, e, f) {
        ...
        this.init = function (c, d) {
          ...
          var i = angular.isDefined(b.arrowkeys)
            ? a.$parent.$eval(b.arrowkeys)
            : f.arrowkeys;
  ...
  angular
    ...
    .factory("$transition", [
      ...
      function (a, b, c, d, e) {
        ...
        var g = function (d, e, f) {
            ...
            return (
              ...
              b(function () {
                angular.isString(e)
                  ? d.addClass(e)
                  : angular.isFunction(e)
                  ? e(d)
                  : angular.isObject(e) && d.css(e),
                  i || h.resolve(d);
              }),
        ...
        return (
          (g.transitionEndEventName = f(i)), (g.animationEndEventName = f(j)), g
        );
      },
    ]),
  angular
