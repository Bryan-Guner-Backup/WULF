      ...
      function (e) {
        ...
        return {
          ...
          link: function (e, r, i, s) {
            ...
            (o = angular.isDefined(o) ? o : !0),
              (u = angular.isDefined(u) ? u : !1),
              e.$watch(
                function () {
                  return s.$modelValue;
                },
        ...
        (i.currentSlide = null),
          (i.select = function (r, u) {
            function l() {
              ...
              r.$element
                ? (r.$element.addClass(u),
                  (r.$element[0].offsetWidth = r.$element[0].offsetWidth),
                  ...
                  angular.extend(r, { direction: u, active: !0, entering: !0 }),
            ...
            u === undefined && (u = a > o ? "next" : "prev"),
              r &&
                r !== i.currentSlide &&
                (e.$currentTransition
                  ? (e.$currentTransition.cancel(), t(l))
                  : l());
          }),
          ...
          (i.addSlide = function (t, n) {
            (t.$element = n),
              s.push(t),
              s.length === 1 || t.active
                ? (i.select(s[s.length - 1]), s.length == 1 && e.play())
                : (t.active = !1);
          }),
          (i.removeSlide = function (e) {
            ...
            s.splice(t, 1),
              s.length > 0 &&
                e.active &&
                (t >= s.length ? i.select(s[t - 1]) : i.select(s[t]));
          });
      },
    ])
    .directive("carousel", [
          ...
          link: function (n, r, i) {
            ...
            n.$watch(
              ...
              function (e) {
                r[0].scrollHeight !== 0 &&
                  (s ||
                    (o ? t(n, r, r[0].scrollHeight + "px") : t(n, r, "auto")));
              }
            ),
            ...
            var u,
              ...
              f = function () {
                o
                  ? ((o = !1), s || t(n, r, "auto"))
                  : a({ height: r[0].scrollHeight + "px" }).then(function () {
                      s || t(n, r, "auto");
                    }),
                  (s = !1);
              },
              l = function () {
                (s = !0),
                  o
                    ? ((o = !1), t(n, r, 0))
                    : (t(n, r, r[0].scrollHeight + "px"), a({ height: "0" }));
              };
          },
        };
      },
...
dialogModule.controller("MessageBoxController", [
        ...
        function (r, i, s, o, u, a, f, l, c) {
          ...
          return (
            ...
            (d.prototype.open = function (e, t) {
              ...
              return (
                this._loadResolves().then(function (e) {
                  ...
                  s(n.modalEl)(t),
                    n._addElementsToDom(),
                    h.addClass(n.options.dialogOpenClass),
                    setTimeout(function () {
            ...
            (d.prototype._bindEvents = function () {
              this.options.keyboard && h.bind("keydown", this.handledEscapeKey),
            ...
            (d.prototype._unbindEvents = function () {
              this.options.keyboard &&
                h.unbind("keydown", this.handledEscapeKey),
                this.options.backdrop &&
                  this.options.backdropClick &&
            ...
            (d.prototype._addElementsToDom = function () {
              h.append(this.modalEl),
                this.options.backdrop &&
                  (n.value === 0 && h.append(this.backdropEl), n.value++),
                (this._open = !0);
            }),
            (d.prototype._removeElementsFromDom = function () {
              this.modalEl.remove(),
                this.options.backdrop &&
                  (n.value--, n.value === 0 && this.backdropEl.remove()),
                (this._open = !1);
            }),
            (d.prototype._loadResolves = function () {
              ...
              return (
                this.options.template
                  ? (n = f.when(this.options.template))
                  : this.options.templateUrl &&
                    (n = r
                      .get(this.options.templateUrl, { cache: a })
                      .then(function (e) {
                        return e.data;
                      })),
                angular.forEach(this.options.resolve || [], function (n, r) {
                  t.push(r),
                    e.push(angular.isString(n) ? c.get(n) : c.invoke(n));
                }),
                t.push("$template"),
                e.push(n),
                f.all(e).then(function (e) {
                  var n = {};
                  return (
  ...
  angular
    ...
    .directive("modal", [
      ...
      function (e, t) {
        var n,
          r = angular.element(document.getElementsByTagName("body")[0]);
        return {
          restrict: "EA",
          terminal: !0,
          link: function (n, r, i) {
      ...
      function (e) {
        return {
          ...
          link: function (t, n, r) {
            ...
            var i = angular.isDefined(r.boundaryLinks)
                ? t.$eval(r.boundaryLinks)
                : e.boundaryLinks,
              s = angular.isDefined(r.directionLinks)
                ? t.$eval(r.directionLinks)
                : e.directionLinks,
              o = angular.isDefined(r.firstText) ? r.firstText : e.firstText,
              u = angular.isDefined(r.previousText)
                ? r.previousText
                : e.previousText,
            ...
            t.$watch("numPages + currentPage + maxSize", function () {
              t.pages = [];
              var e =
                  t.maxSize && t.maxSize < t.numPages ? t.maxSize : t.numPages,
                n = t.currentPage - Math.floor(e / 2);
              n < 1 && (n = 1),
                n + e - 1 > t.numPages && (n -= n + e - 1 - t.numPages);
              ...
              (t.selectPage = function (e) {
                !t.isActive(e) &&
                  e > 0 &&
                  e <= t.numPages &&
                  ((t.currentPage = e), t.onSelectPage({ page: e }));
              });
          },
        };
      },
        ...
        return {
          ...
          link: function (s, o, u) {
            ...
            function c() {
              var e, n, r, i;
              f && t.cancel(f),
                a.css({ top: 0, left: 0, display: "block" }),
                o.after(a),
                (e = l()),
                (n = a.prop("offsetWidth")),
                (r = a.prop("offsetHeight"));
            ...
            function h() {
              (s.tt_isOpen = !1),
                angular.isDefined(s.tt_animation) && s.tt_animation()
                  ? (f = t(function () {
                      a.remove();
                    }, 500))
                  : a.remove();
          ...
          link: function (t, n, r, i) {
            ...
            (t.selected = !1),
              r.active &&
                ...
                (t.selected = s ? s(t.$parent) : !1)),
              t.$watch("selected", function (e) {
  ...
  angular
    ...
    .directive("tooltip", [
      ...
      function (e, t, n, r) {
        var i =
          '<tooltip-popup tooltip-title="{{tt_tooltip}}" placement="{{tt_placement}}" animation="tt_animation()" is-open="tt_isOpen"></tooltip-popup>';
        return {
          scope: !0,
          link: function (s, o, u) {
            function l() {
    ...
    function (e, t, n) {
      ...
      var r = function (i, s, o) {
          ...
          var u = e.defer(),
            a =
              r[
                o.animation ? "animationEndEventName" : "transitionEndEventName"
              ],
            f = function (e) {
              n.$apply(function () {
          ...
          return (
            ...
            t(function () {
              angular.isString(s)
                ? i.addClass(s)
                : angular.isFunction(s)
                ? s(i)
                : angular.isObject(s) && i.css(s),
                a || u.resolve(i);
            }),
      ...
      return (
        (r.transitionEndEventName = u(s)), (r.animationEndEventName = u(o)), r
      );
    },
  ]),
  angular
          ...
          link: function (i, s, o, u) {
            ...
            h(),
              ...
              (u.$render = function () {
                var e = {};
                (e[l.itemName] = a),
                  s.val(l.viewMapper(c, e) || u.$viewValue),
                  (a = undefined);
              }),
              (c.select = function (e) {
                var t = {};
                (t[l.itemName] = a = c.matches[e].model),
                  u.$setViewValue(l.modelMapper(c, t)),
                  u.$render();
              }),
              s.bind("keydown", function (e) {
                ...
                e.preventDefault(),
                  e.which === 40
                    ? ((c.activeIdx = (c.activeIdx + 1) % c.matches.length),
                      c.$digest())
                    : e.which === 38
                    ? ((c.activeIdx =
                        (c.activeIdx ? c.activeIdx : c.matches.length) - 1),
                      c.$digest())
            ...
            var d = e(
              "<typeahead-popup matches='matches' active='activeIdx' select='select(activeIdx)' query='query'></typeahead-popup>"
            )(c);
            s.after(d);
          },
        };
    ...
    .directive("typeaheadPopup", function () {
      return {
        restrict: "E",
        scope: { matches: "=", query: "=", active: "=", select: "&" },
        replace: !0,
  ...
  angular.module("template/accordion/accordion-group.html", []).run([
    ...
    function (e) {
      e.put(
        "template/accordion/accordion-group.html",
        '<div class="accordion-group">  <div class="accordion-heading" ><a class="accordion-toggle" ng-click="isOpen = !isOpen" accordion-transclude="heading">{{heading}}</a></div>  <div class="accordion-body" collapse="!isOpen">    <div class="accordion-inner" ng-transclude></div>  </div></div>'
      );
    },
  ]),
  ...
  angular.module("template/alert/alert.html", []).run([
    ...
    function (e) {
      e.put(
        "template/alert/alert.html",
        "<div class='alert' ng-class='type && \"alert-\" + type'>    <button type='button' class='close' ng-click='close()'>&times;</button>    <div ng-transclude></div></div>"
      );
    },
  ]),
  angular.module("template/carousel/carousel.html", []).run([
    ...
    function (e) {
      e.put(
        "template/carousel/carousel.html",
        '<div ng-mouseenter="pause()" ng-mouseleave="play()" class="carousel">    <ol class="carousel-indicators">        <li ng-repeat="slide in slides()" ng-class="{active: isActive(slide)}" ng-click="select(slide)"></li>    </ol>    <div class="carousel-inner" ng-transclude></div>    <a ng-click="prev()" class="carousel-control left">&lsaquo;</a>    <a ng-click="next()" class="carousel-control right">&rsaquo;</a></div>'
      );
    },
  ]),
  angular.module("template/carousel/slide.html", []).run([
    ...
    function (e) {
      e.put(
        "template/carousel/slide.html",
        "<div ng-class=\"{    'active': leaving || (active && !entering),    'prev': (next || active) && direction=='prev',    'next': (next || active) && direction=='next',    'right': direction=='prev',    'left': direction=='next'  }\" class=\"item\" ng-transclude></div>"
      );
    },
  ]),
  angular.module("template/dialog/message.html", []).run([
    ...
    function (e) {
      e.put(
        "template/dialog/message.html",
        '<div class="modal-header">	<h1>{{ title }}</h1></div><div class="modal-body">	<p>{{ message }}</p></div><div class="modal-footer">	<button ng-repeat="btn in buttons" ng-click="close(btn.result)" class=btn ng-class="btn.cssClass">{{ btn.label }}</button></div>'
      );
    },
  ]),
  angular.module("template/pagination/pagination.html", []).run([
    ...
    function (e) {
      e.put(
        "template/pagination/pagination.html",
        '<div class="pagination"><ul>  <li ng-repeat="page in pages" ng-class="{active: page.active, disabled: page.disabled}"><a ng-click="selectPage(page.number)">{{page.text}}</a></li>  </ul></div>'
      );
    },
  ]),
  angular.module("template/popover/popover.html", []).run([
    ...
    function (e) {
      e.put(
        "template/popover/popover.html",
        '<div class="popover {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">  <div class="arrow"></div>  <div class="popover-inner">      <h3 class="popover-title" ng-bind="popoverTitle" ng-show="popoverTitle"></h3>      <div class="popover-content" ng-bind="popoverContent"></div>  </div></div>'
      );
    },
  ]),
  ...
  angular.module("template/tabs/tabs.html", []).run([
    ...
    function (e) {
      e.put(
        "template/tabs/tabs.html",
        '<div class="tabbable">  <ul class="nav nav-tabs">    <li ng-repeat="pane in panes" ng-class="{active:pane.selected}">      <a href="" ng-click="select(pane)">{{pane.heading}}</a>    </li>  </ul>  <div class="tab-content" ng-transclude></div></div>'
      );
    },
  ]),
  angular.module("template/tooltip/tooltip-popup.html", []).run([
    ...
    function (e) {
      e.put(
        "template/tooltip/tooltip-popup.html",
        '<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">  <div class="tooltip-arrow"></div>  <div class="tooltip-inner" ng-bind="tooltipTitle"></div></div>'
      );
    },
  ]),
  angular.module("template/typeahead/typeahead.html", []).run([
    ...
    function (e) {
      e.put(
        "template/typeahead/typeahead.html",
        '<div class="dropdown clearfix" ng-class="{open: isOpen()}">    <ul class="typeahead dropdown-menu">        <li ng-repeat="match in matches" ng-class="{active: isActive($index) }" ng-mouseenter="selectActive($index)">            <a tabindex="-1" ng-click="selectMatch($index)" ng-bind-html-unsafe="match.label | typeaheadHighlight:query"></a>        </li>    </ul></div>'
      );
    },
  ]);
