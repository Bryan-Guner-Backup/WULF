angular.module("ui.bootstrap", [
  ...
  angular.module("ui.bootstrap.transition", []).factory("$transition", [
    ...
    function (t, e, n) {
      ...
      return (
        (a.transitionEndEventName = o(r)), (a.animationEndEventName = o(l)), a
      );
    },
  ]),
  angular
          ...
          link: function (n, o, a) {
            ...
            var l,
              ...
              c = function () {
                r
                  ? ((r = !1), i || e(n, o, "auto"))
                  : s({ height: o[0].scrollHeight + "px" }).then(function () {
                      i || e(n, o, "auto");
                    }),
                  (i = !1);
              },
              u = function () {
                (i = !0),
                  r
                    ? ((r = !1), e(n, o, 0))
                    : (e(n, o, o[0].scrollHeight + "px"), s({ height: "0" }));
              };
          },
        };
      },
      ...
      function (t, e, n) {
        (this.groups = []),
          (this.closeOthers = function (o) {
            var a = angular.isDefined(e.closeOthers)
    ...
    .controller("CarouselController", [
      ...
      function (t, e, n) {
        ...
        var a,
          ...
          s = -1;
        (r.currentSlide = null),
          (r.select = function (a, i) {
            function c() {
              r.currentSlide &&
              angular.isString(i) &&
              !t.noTransition &&
              a.$element
                ? (a.$element.addClass(i),
                  (a.$element[0].offsetWidth = a.$element[0].offsetWidth),
                  ...
                  angular.extend(a, { direction: i, active: !0, entering: !0 }),
                  angular.extend(r.currentSlide || {}, {
                    direction: i,
                    leaving: !0,
                  }),
                  (t.$currentTransition = n(a.$element, {})),
                  (function (e, n) {
          ...
          (r.addSlide = function (e, n) {
            (e.$element = n),
              l.push(e),
              1 === l.length || e.active
                ? (r.select(l[l.length - 1]), 1 == l.length && t.play())
                : (e.active = !1);
          }),
          (r.removeSlide = function (t) {
            ...
            l.splice(e, 1),
              l.length > 0 &&
                t.active &&
                (e >= l.length ? r.select(l[e - 1]) : r.select(l[e]));
          });
      },
    ])
    .directive("carousel", [
      ...
      (this.$get = [
        ...
        function (o, a, i, r, l, s, c, u, p) {
          ...
          function f(n) {
            ...
            (this._open = !1),
              (this.backdropEl = d(a.backdropClass)),
              a.backdropFade &&
                (this.backdropEl.addClass(a.transitionClass),
                this.backdropEl.removeClass(a.triggerClass)),
              (this.modalEl = d(a.dialogClass)),
              a.dialogFade &&
                (this.modalEl.addClass(a.transitionClass),
                this.modalEl.removeClass(a.triggerClass)),
            ...
            (f.prototype.open = function (t, e) {
              ...
              return (
                this._loadResolves().then(function (t) {
                  ...
                  i(n.modalEl)(e),
                    n._addElementsToDom(),
                    g.addClass(n.options.dialogOpenClass),
                    setTimeout(function () {
        ...
        return {
          ...
          link: function (n, o, a) {
            var i,
              r = angular.extend(
                {},
                n.$eval(a.uiOptions || a.bsOptions || a.options)
              ),
              l = a.modal || a.show;
            r = angular.extend(r, {
              template: o.html(),
      ...
      function (t) {
        return {
          ...
          link: function (e, n, o) {
            ...
            var i = angular.isDefined(o.boundaryLinks)
              ...
              s = angular.isDefined(o.previousText)
                ? o.previousText
                : t.previousText,
    ...
    function (t, e) {
      ...
      return {
        position: function (e) {
          ...
          return (
            i != t[0] &&
              ((o = this.offset(angular.element(i))),
              (o.top += i.clientTop),
              (o.left += i.clientLeft)),
            {
                ...
                link: function (t, e, n) {
                  ...
                  function v() {
                    ...
                    if (t.tt_content) {
                      switch (
                        ($ && r.cancel($),
                        C.css({ top: 0, left: 0, display: "block" }),
                        f.appendToBody
                          ? ((k = k || s.find("body")), k.append(C))
                          : e.after(C),
                        (n = c.position(e)),
                        (o = C.prop("offsetWidth")),
                  ...
                  (t.tt_isOpen = !1),
                    ...
                    n.$observe(u + "Trigger", function (t) {
                      e.unbind(m.show),
                        ...
                        m.show === m.hide
                          ? e.bind(m.show, o)
                          : (e.bind(m.show, p), e.bind(m.hide, g));
                    });
                },
              };
            };
        ...
        return {
          ...
          link: function (n, o, a) {
            ...
            (n.rate = function (t) {
              ...
              (n.readonly = !1),
              a.readonly &&
                n.$parent.$watch(e(a.readonly), function (t) {
                  n.readonly = !!t;
                });
          },
        };
      ...
      function (t, e, n, o, a, i) {
        ...
        return {
          ...
          link: function (l, s, c, u) {
            var p,
              d = l.$eval(c.typeaheadMinLength) || 1,
                    ...
                    function (n) {
                      if (t === u.$viewValue) {
                        if (n.length > 0) {
                          ...
                          (v.query = t),
                            (v.position = a.position(s)),
                            (v.position.top =
                              v.position.top + s.prop("offsetHeight"));
                        } else b();
                        m(l, !1);
                      }
                    },
            ...
            b(),
              ...
              u.$parsers.push(function (t) {
                return (
                  b(), p ? t : (t && t.length >= d && $(t), g ? t : void 0)
                );
              }),
              (u.$render = function () {
                var t = {};
                (t[f.itemName] = p || u.$viewValue),
                  s.val(f.viewMapper(v, t) || u.$viewValue),
                  (p = void 0);
              }),
              (v.select = function (t) {
                var e = {};
