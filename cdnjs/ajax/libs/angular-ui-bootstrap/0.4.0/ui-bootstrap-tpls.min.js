        ...
        return {
          ...
          link: function (a, o, r) {
            ...
            var p,
              ...
              g = new Date(),
              f = {};
            (f.day = angular.isDefined(r.dayFormat)
              ? a.$eval(r.dayFormat)
              : n.dayFormat),
              (f.month = angular.isDefined(r.monthFormat)
                ? a.$eval(r.monthFormat)
                : n.monthFormat),
              (f.year = angular.isDefined(r.yearFormat)
                ? a.$eval(r.yearFormat)
                : n.yearFormat),
              (f.dayHeader = angular.isDefined(r.dayHeaderFormat)
                ? a.$eval(r.dayHeaderFormat)
                : n.dayHeaderFormat),
              (f.dayTitle = angular.isDefined(r.dayTitleFormat)
                ? a.$eval(r.dayTitleFormat)
                : n.dayTitleFormat),
              (f.monthTitle = angular.isDefined(r.monthTitleFormat)
              ...
              y = {
                day: function () {
                  ...
                  var s = h - r.getDay(),
                    c = s > 0 ? 7 - s : -s;
                  for (
                    c > 0 && (r.setDate(-c + 1), t(r, c, !1)),
                      t(o || r, $(g.getFullYear(), g.getMonth()), !0),
                ...
                year: function () {
                  for (
                    var t = [],
                      n = parseInt((g.getFullYear() - 1) / v, 10) * v + 1,
                      a = 0;
                    v > a;
                    a++
                  ) {
            ...
            a.$watch("model", function (e, t) {
              angular.isDate(e) && (g = angular.copy(e)),
              ...
              (a.select = function (e) {
                (g = new Date(e)),
                  "year" === a.mode
                    ? ((a.mode = "month"), g.setFullYear(e.getFullYear()))
                    : "month" === a.mode
                    ? ((a.mode = "day"), g.setMonth(e.getMonth()))
                    : "day" === a.mode && (a.model = new Date(g));
              }),
              (a.move = function (e) {
                "day" === a.mode
                  ? g.setMonth(g.getMonth() + e)
                  : "month" === a.mode
                  ? g.setFullYear(g.getFullYear() + e)
                  : "year" === a.mode && g.setFullYear(g.getFullYear() + e * v),
                  w();
              }),
          ...
          link: function (t, n, a) {
            ...
            var i = angular.isDefined(a.boundaryLinks)
              ...
              s = angular.isDefined(a.previousText)
                ...
                : e.previousText,
              c = angular.isDefined(a.nextText)
                ? t.$parent.$eval(a.nextText)
                : e.nextText,
              u = angular.isDefined(a.lastText)
                    ...
                    if (e.tt_content) {
                      switch (
                        ...
                        x
                          ...
                          : t.after(k),
                        (n = g.appendToBody ? c.offset(t) : c.position(t)),
                  ...
                  (e.tt_isOpen = !1),
                    ...
                    n.$observe(p + "Trigger", function (e) {
                      t.unbind(h.show),
                        ...
                        h.show === h.hide
                          ? t.bind(h.show, a)
                          : (t.bind(h.show, u), t.bind(h.hide, d));
                    }),
        ...
        return {
          ...
          link: function (a, o, i) {
            ...
            function s(e) {
              ...
              t.getDate() !== c.getDate() && t.setDate(t.getDate() - 1),
                c.setTime(t.getTime()),
                (a.model = new Date(c));
            }
            var c = new Date(),
      ...
      function (e, t, n, a, o, i, r) {
        ...
        return {
          ...
          link: function (s, c, u, p) {
            var d,
              m = s.$eval(u.typeaheadMinLength) || 1,
                    ...
                    function (n) {
                      if (e === p.$viewValue) {
                        if (n.length > 0) {
                          ...
                          (y.query = e),
                            (y.position = i.position(c)),
                            (y.position.top =
                              y.position.top + c.prop("offsetHeight"));
                        } else w();
                        v(s, !1);
                      }
                    },
            ...
            w(),
              ...
              (p.$render = function () {
                var e = {};
                (e[f.itemName] = d || p.$viewValue),
                  c.val(f.viewMapper(y, e) || p.$viewValue),
                  (d = void 0);
              }),
              (y.select = function (e) {
                var t,
                  n,
                  a = {};
                (a[f.itemName] = n = d = y.matches[e].model),
                  (t = f.modelMapper(y, a)),
                  p.$setViewValue(t),
                  p.$render(),
                  b(y, { $item: n, $model: t, $label: f.viewMapper(y, a) }),
                  c[0].focus();
              }),
