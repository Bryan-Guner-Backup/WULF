angular.module("ui.bootstrap", [
  ...
  angular.module("ui.bootstrap.transition", []).factory("$transition", [
    ...
    function (e, t, n) {
      ...
      return (
        (o.transitionEndEventName = a(r)), (o.animationEndEventName = a(l)), o
      );
    },
  ]),
  angular
        ...
        return {
          ...
          link: function (e, a, o, i) {
            (i.$render = function () {
              a.toggleClass(
                t,
                angular.equals(i.$modelValue, e.$eval(o.btnRadio))
              );
            }),
              a.bind(n, function () {
                a.hasClass(t) ||
      ...
      function (e) {
        ...
        return {
          ...
          link: function (e, a, o, i) {
            ...
            (r = angular.isDefined(r) ? r : !0),
              (l = angular.isDefined(l) ? l : !1),
              (i.$render = function () {
      ...
      function (e, t, n) {
        ...
        (r.currentSlide = null),
          (r.select = function (o, i) {
            function u() {
              ...
              o.$element
                ? (o.$element.addClass(i),
                  (o.$element[0].offsetWidth = o.$element[0].offsetWidth),
                  ...
                  angular.extend(o, { direction: i, active: !0, entering: !0 }),
            ...
            var p = l.indexOf(o);
            void 0 === i && (i = p > s ? "next" : "prev"),
              o &&
                o !== r.currentSlide &&
                (e.$currentTransition
                  ? (e.$currentTransition.cancel(), t(u))
                  : u());
          }),
          ...
          link: function (a, o, r) {
            ...
            function c(e) {
              return (
                (d && u(e, d) > 0) ||
                (f && 0 > u(e, f)) ||
                (a.dateDisabled && a.dateDisabled({ date: e, mode: a.mode }))
              );
            }
            a.mode = "day";
            var p,
              ...
              m = new Date(),
              g = {};
            (g.day = angular.isDefined(r.dayFormat)
              ? a.$eval(r.dayFormat)
              : n.dayFormat),
              (g.month = angular.isDefined(r.monthFormat)
                ? a.$eval(r.monthFormat)
                : n.monthFormat),
              (g.year = angular.isDefined(r.yearFormat)
                ? a.$eval(r.yearFormat)
                : n.yearFormat),
              (g.dayHeader = angular.isDefined(r.dayHeaderFormat)
                ? a.$eval(r.dayHeaderFormat)
                : n.dayHeaderFormat),
              (g.dayTitle = angular.isDefined(r.dayTitleFormat)
                ? a.$eval(r.dayTitleFormat)
                : n.dayTitleFormat),
              (g.monthTitle = angular.isDefined(r.monthTitleFormat)
                ? a.$eval(r.monthTitleFormat)
                : n.monthTitleFormat);
            var h = angular.isDefined(r.startingDay)
                ? a.$eval(r.startingDay)
                : n.startingDay,
              v = angular.isDefined(r.yearRange)
                ? a.$eval(r.yearRange)
                : n.yearRange;
            r.showWeeks
              ? a.$parent.$watch(t(r.showWeeks), function (e) {
                  (p = !!e), s();
                })
              : ((p = n.showWeeks), s()),
              r.min &&
              ...
              y = {
                day: function () {
                  ...
                  var s = h - r.getDay(),
                    u = s > 0 ? 7 - s : -s;
                  for (
                    u > 0 && (r.setDate(-u + 1), t(r, u, !1)),
                      t(o || r, b(m.getFullYear(), m.getMonth()), !0),
                      t(o, (7 - (n.length % 7)) % 7, !1),
                      i = 0;
                    7 > i;
                    i++
                  )
                    a.push(e(n[i].date, g.dayHeader));
                ...
                year: function () {
                  for (
                    var t = [],
                      n = parseInt((m.getFullYear() - 1) / v, 10) * v + 1,
                      a = 0;
                    v > a;
                    a++
                  ) {
              ...
              k = function (e) {
                if (a.model && a.model.getFullYear() === e.getFullYear()) {
                  ...
                  if (a.model.getMonth() === e.getMonth())
                    return (
                      "month" === a.mode ||
                      ("day" === a.mode && a.model.getDate() === e.getDate())
                    );
                }
                return !1;
              };
            a.$watch("model", function (e, t) {
              angular.isDate(e) && (m = angular.copy(e)),
                angular.equals(e, t) || w();
            }),
              ...
              (a.select = function (e) {
                (m = new Date(e)),
                  "year" === a.mode
                    ? ((a.mode = "month"), m.setFullYear(e.getFullYear()))
                    : "month" === a.mode
                    ? ((a.mode = "day"), m.setMonth(e.getMonth()))
                    : "day" === a.mode && (a.model = new Date(m));
              }),
              (a.move = function (e) {
                "day" === a.mode
                  ...
                  : "year" === a.mode && m.setFullYear(m.getFullYear() + e * v),
                  w();
              }),
              ...
              (a.getWeekNumber = function (e) {
                if ("day" === a.mode && a.showWeekNumbers && 7 === e.length) {
                  ...
                  return (
                    n.setHours(0, 0, 0),
                    Math.ceil(
                      ((n - new Date(n.getFullYear(), 0, 1)) / 864e5 + 1) / 7
                    )
                  );
                }
              });
      ...
      (this.$get = [
        ...
        function (a, o, i, r, l, s, u, c, p) {
          ...
          function f(n) {
            ...
            (this._open = !1),
              (this.backdropEl = d(o.backdropClass)),
              o.backdropFade &&
                (this.backdropEl.addClass(o.transitionClass),
                this.backdropEl.removeClass(o.triggerClass)),
              (this.modalEl = d(o.dialogClass)),
              o.dialogFade &&
                (this.modalEl.addClass(o.transitionClass),
                this.modalEl.removeClass(o.triggerClass)),
          ...
          return (
            ...
            (f.prototype.close = function (e) {
              ...
              if (o.length > 0)
                for (var i = o.length - 1; i >= 0; i--) c(o[i], t).then(n);
            ...
            (f.prototype._loadResolves = function () {
              ...
              return (
                this.options.template
                  ? (e = u.when(this.options.template))
        ...
        return {
          ...
          link: function (n, a, o) {
            var i,
              r = angular.extend(
                {},
                n.$eval(o.uiOptions || o.bsOptions || o.options)
              ),
              l = o.modal || o.show;
            r = angular.extend(r, {
              template: a.html(),
      ...
      function (e) {
        return {
          ...
          link: function (t, n, a) {
            ...
            var i = angular.isDefined(a.boundaryLinks)
                ? t.$eval(a.boundaryLinks)
                : e.boundaryLinks,
              r = angular.isDefined(a.directionLinks)
                ? t.$eval(a.directionLinks)
                : e.directionLinks,
              l = angular.isDefined(a.firstText)
                ? t.$parent.$eval(a.firstText)
                : e.firstText,
              s = angular.isDefined(a.previousText)
                ? t.$parent.$eval(a.previousText)
                : e.previousText,
              u = angular.isDefined(a.nextText)
                ? t.$parent.$eval(a.nextText)
                : e.nextText,
              c = angular.isDefined(a.lastText)
                ? t.$parent.$eval(a.lastText)
                : e.lastText,
            ...
            t.$watch("numPages + currentPage + maxSize", function () {
              ...
              a &&
                (p
                  ? ((e = Math.max(
                      t.currentPage - Math.floor(t.maxSize / 2),
                      1
                    )),
                    (n = e + t.maxSize - 1),
                    n > t.numPages &&
                  ...
                  : ((e =
                      (Math.ceil(t.currentPage / t.maxSize) - 1) * t.maxSize +
                      1),
      ...
      function (e) {
        return {
          ...
          link: function (t, n, a) {
            ...
            var i = angular.isDefined(a.previousText)
                ? t.$parent.$eval(a.previousText)
                : e.previousText,
              r = angular.isDefined(a.nextText)
                ? t.$parent.$eval(a.nextText)
                : e.nextText,
              l = angular.isDefined(a.align)
    ...
    function (e, t) {
      ...
      return {
        position: function (t) {
          ...
          return (
            o != e[0] &&
              ((a = this.offset(angular.element(o))),
              (a.top += o.clientTop),
              (a.left += o.clientLeft)),
            {
    ...
    .provider("$tooltip", function () {
      ...
      (this.options = function (e) {
        ...
        (this.$get = [
          ...
          "$position",
          "$interpolate",
          function (o, i, r, l, s, u, c) {
            return function (o, p, d) {
              function f(e) {
                var t, a;
                return (
                  (t = e || m.trigger || d),
                  (a = angular.isDefined(m.trigger)
                    ? n[m.trigger] || t
                    : n[t] || t),
                  { show: t, hide: a }
                );
                ...
                link: function (e, t, n) {
                  ...
                  function g() {
                    ...
                    if (e.tt_content) {
                      switch (
                        ($ && r.cancel($),
                        k.css({ top: 0, left: 0, display: "block" }),
                        x
                          ? ((w = w || s.find("body")), w.append(k))
                          : t.after(k),
                        (n = m.appendToBody ? u.offset(t) : u.position(t)),
                        (a = k.prop("offsetWidth")),
                        (o = k.prop("offsetHeight")),
                        e.tt_placement)
                      ) {
                        case "mouse":
                          var l = u.mouse();
                  ...
                  var $,
                    ...
                    w,
                    k = i(b)(e),
                    x = angular.isDefined(m.appendToBody) ? m.appendToBody : !1;
                  (e.tt_isOpen = !1),
                    ...
                    n.$observe(p + "Trigger", function (e) {
                      t.unbind(h.show),
                        ...
                        h.show === h.hide
                          ? t.bind(h.show, a)
                          : (t.bind(h.show, c), t.bind(h.hide, d));
                    }),
        ...
        return {
          ...
          link: function (n, a, o) {
            ...
            (n.rate = function (e) {
              ...
              (n.readonly = !1),
              o.readonly &&
                n.$parent.$watch(t(o.readonly), function (e) {
                  n.readonly = !!e;
                });
          },
        };
  ...
  angular
    ...
    .directive("tabset", function () {
      return {
        ...
        link: function (e, t, n) {
          (e.vertical = angular.isDefined(n.vertical)
            ? e.$eval(n.vertical)
            : !1),
            (e.type = angular.isDefined(n.type)
              ? e.$parent.$eval(n.type)
              : "tabs");
        },
      };
    })
          ...
          compile: function (t, n, a) {
            return function (t, n, o, i) {
              ...
              (t.active = !1),
                ...
                (t.disabled = !1),
                o.disabled &&
                  t.$parent.$watch(e(o.disabled), function (e) {
                    t.disabled = !!e;
                  }),
                (t.select = function () {
                ...
                a(t.$parent, function (e) {
                  ...
                  angular.forEach(e, function (e) {
                    ...
                    n && (t.headingElement = angular.element(n)),
                    (t.contentElement = angular.element(a));
                });
            };
          },
        };
        ...
        return {
          ...
          link: function (a, o, i) {
            ...
            function s(e) {
              ...
              t.getDate() !== u.getDate() && t.setDate(t.getDate() - 1),
                u.setTime(t.getTime()),
                (a.model = new Date(u));
            }
            var u = new Date(),
              ...
              p = n.hourStep;
            i.hourStep &&
              a.$parent.$watch(t(i.hourStep), function (e) {
                p = parseInt(e, 10);
              });
            var d = n.minuteStep;
            i.minuteStep &&
              a.$parent.$watch(t(i.minuteStep), function (e) {
                d = parseInt(e, 10);
              }),
              (a.showMeridian = n.showMeridian),
              i.showMeridian &&
                a.$parent.$watch(t(i.showMeridian), function (e) {
            ...
            var f = o.find("input"),
              m = f.eq(0),
              g = f.eq(1),
              h = angular.isDefined(i.mousewheel)
                ? a.$eval(i.mousewheel)
                : n.mousewheel;
            if (h) {
              var v = function (e) {
            ...
            var $ = !1;
            (a.readonlyInput = angular.isDefined(i.readonlyInput)
              ? a.$eval(i.readonlyInput)
              : n.readonlyInput),
              a.readonlyInput
                ...
                : ((a.updateHours = function () {
                    ...
                    angular.isDefined(e)
                      ? (($ = "h"),
                        null === a.model && (a.model = new Date(u)),
                        a.model.setHours(e))
  ...
  angular
    ...
    .directive("typeahead", [
      ...
      function (e, t, n, a, o, i, r) {
        ...
        return {
          require: "ngModel",
          link: function (s, u, c, p) {
            var d,
              f = s.$eval(c.typeaheadMinLength) || 1,
              m = s.$eval(c.typeaheadWaitMs) || 0,
              g = r.parse(c.typeahead),
              h = s.$eval(c.typeaheadEditable) !== !1,
              v = t(c.typeaheadLoading).assign || angular.noop,
              $ = t(c.typeaheadOnSelect),
                      ...
                      if (e === p.$viewValue) {
                        if (n.length > 0) {
                          ...
                          for (var a = 0; n.length > a; a++)
                            (t[g.itemName] = n[a]),
                              y.matches.push({
                                label: g.viewMapper(y, t),
                                model: n[a],
                              });
                          (y.query = e),
                            (y.position = i.position(u)),
                            (y.position.top =
                              y.position.top + u.prop("offsetHeight"));
                        } else w();
                        v(s, !1);
                      }
                    },
            ...
            w(),
              ...
              (p.$render = function () {
                var e = {};
                (e[g.itemName] = d || p.$viewValue),
                  u.val(g.viewMapper(y, e) || p.$viewValue),
                  (d = void 0);
              }),
              (y.select = function (e) {
                var t,
                  n,
                  a = {};
                (a[g.itemName] = n = d = y.matches[e].model),
                  (t = g.modelMapper(y, a)),
                  p.$setViewValue(t),
                  p.$render(),
                  $(y, { $item: n, $model: t, $label: g.viewMapper(y, a) }),
                  u[0].focus();
              }),
              u.bind("keydown", function (e) {
                0 !== y.matches.length &&
                  ...
                  (e.preventDefault(),
                  40 === e.which
                    ? ((y.activeIdx = (y.activeIdx + 1) % y.matches.length),
                      y.$digest())
                    : 38 === e.which
                    ? ((y.activeIdx =
                        (y.activeIdx ? y.activeIdx : y.matches.length) - 1),
                      y.$digest())
