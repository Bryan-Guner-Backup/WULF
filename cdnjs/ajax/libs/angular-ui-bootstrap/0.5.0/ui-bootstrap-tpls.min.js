    ...
    function (e, t, n) {
      ...
      var i = function (a, o, r) {
          ...
          var l = e.defer(),
            s =
              i[
                r.animation ? "animationEndEventName" : "transitionEndEventName"
              ],
            c = function () {
              n.$apply(function () {
      ...
      return (
        (i.transitionEndEventName = a(r)), (i.animationEndEventName = a(l)), i
      );
    },
  ]),
  angular
          ...
          link: function (n, a, i) {
            ...
            n.$watch(
              ...
              function () {
                0 !== a[0].scrollHeight &&
                  (o ||
                    (r ? t(n, a, a[0].scrollHeight + "px") : t(n, a, "auto")));
              }
            ),
            ...
            var l,
              ...
              c = function () {
                r
                  ? ((r = !1), o || t(n, a, "auto"))
                  : s({ height: a[0].scrollHeight + "px" }).then(function () {
                      o || t(n, a, "auto");
                    }),
                  (o = !1);
              },
              u = function () {
                (o = !0),
                  r
                    ? ((r = !1), t(n, a, 0))
                    : (t(n, a, a[0].scrollHeight + "px"), s({ height: "0" }));
              };
          },
        };
      },
      ...
      function (e, t, n) {
        (this.groups = []),
          (this.closeOthers = function (a) {
            var i = angular.isDefined(t.closeOthers)
        ...
        return {
          ...
          link: function (e, a, i, o) {
            (o.$render = function () {
              a.toggleClass(
                t,
                angular.equals(o.$modelValue, e.$eval(i.btnRadio))
              );
            }),
              a.bind(n, function () {
                a.hasClass(t) ||
      ...
      function (e, t, n) {
        ...
        (r.currentSlide = null),
          (r.select = function (i, o) {
            function c() {
              ...
              i.$element
                ? (i.$element.addClass(o),
                  (i.$element[0].offsetWidth = i.$element[0].offsetWidth),
                  ...
                  angular.extend(i, { direction: o, active: !0, entering: !0 }),
            ...
            var p = l.indexOf(i);
            void 0 === o && (o = p > s ? "next" : "prev"),
              i &&
                i !== r.currentSlide &&
                (e.$currentTransition
                  ? (e.$currentTransition.cancel(), t(c))
                  : c());
          }),
          ...
          (r.addSlide = function (t, n) {
            (t.$element = n),
              l.push(t),
              1 === l.length || t.active
                ? (r.select(l[l.length - 1]), 1 == l.length && e.play())
                : (t.active = !1);
          }),
    ...
    function (e, t) {
      ...
      return {
        position: function (t) {
          ...
          return (
            i != e[0] &&
              ((a = this.offset(angular.element(i))),
              (a.top += i.clientTop - i.scrollTop),
  ...
  angular
    ...
    .controller("DatepickerController", [
      ...
      function (e, t, n, a) {
        ...
        (this.minDate = a.minDate ? new Date(a.minDate) : null),
          (this.maxDate = a.maxDate ? new Date(a.maxDate) : null),
          (this.modes = [
            {
              name: "day",
            ...
            },
            {
              ...
              getVisibleDates: function (e, t) {
                for (
                  var a = Array(12), i = e.getFullYear(), o = 0;
                  12 > o;
                  o++
                ) {
                  ...
                  a[o] = l(
                    r,
                    s.month,
                    t && t.getMonth() === o && t.getFullYear() === i
                  );
                }
          ...
          (this.isDisabled = function (t, n) {
            ...
            return (
              (this.minDate && 0 > a.compare(t, this.minDate)) ||
              (this.maxDate && a.compare(t, this.maxDate) > 0) ||
              (e.dateDisabled && e.dateDisabled({ date: t, mode: a.name }))
            );
          });
      },
    ])
          ...
          link: function (e, i, o, r) {
            ...
            function c(t) {
              ...
              m.$modelValue &&
                ...
                isNaN(n)
                  ...
                  : t && (f = n)),
                m.$setValidity("date", i);
              var o = d.modes[g],
                r = o.getVisibleDates(f, n);
              angular.forEach(r.objects, function (e) {
                e.disabled = d.isDisabled(e.date, g);
              }),
                m.$setValidity("date-disabled", !n || !d.isDisabled(n)),
                (e.rows = s(r.objects, o.split)),
                (e.labels = r.labels || []),
                (e.title = r.title);
            }
            function u(e) {
            ...
            if (m) {
              var g = 0,
                ...
                h = n.showWeeks;
              o.showWeeks
                ? e.$parent.$watch(t(o.showWeeks), function (e) {
                    (h = !!e), l();
                  })
                : l(),
                o.min &&
                  e.$parent.$watch(t(o.min), function (e) {
                    (d.minDate = e ? new Date(e) : null), c();
                  }),
                o.max &&
                  e.$parent.$watch(t(o.max), function (e) {
                ...
                (e.move = function (e) {
                  ...
                  f.setMonth(f.getMonth() + e * (t.months || 0)),
                    f.setFullYear(f.getFullYear() + e * (t.years || 0)),
                    c();
                }),
                ...
                (e.getWeekNumber = function (t) {
                  return 0 === g && e.showWeekNumbers && 7 === t.length
                    ? p(t[0].date)
                    : null;
                });
            }
      ...
      function (e, t, n, a, i, o) {
        return {
          ...
          link: function (r, l, s, c) {
            ...
            function m(e, n, a) {
              e &&
                (r.$watch(t(e), function (e) {
                  v[n] = e;
                }),
                D.attr(a || n, n));
            }
            function g() {
              (v.position = a.position(l)),
                (v.position.top = v.position.top + l.prop("offsetHeight"));
            }
            var f = angular.isDefined(s.closeOnDateSelection)
                ? v.$eval(s.closeOnDateSelection)
                : o.closeOnDateSelection,
              h = s.datepickerPopup || o.dateFormat,
              v = r.$new();
            ...
            (v.dateSelection = function () {
                ...
                function (e) {
                  if (angular.isString(e)) {
                    ...
                    if (e && !t)
                      throw (
                        (x(r, null),
                        Error(e + " cannot be parsed to a date object."))
                      );
                    e = t;
                  }
                  (v.date = e), g();
              ...
              m(s.max, "max"),
              s.showWeeks
                ? m(s.showWeeks, "showWeeks", "show-weeks")
                : ((v.showWeeks = !0), D.attr("show-weeks", "showWeeks")),
              s.dateDisabled && D.attr("date-disabled", s.dateDisabled),
              v.$watch("isOpen", function (e) {
                e
                  ? (g(), n.bind("click", y), l.unbind("focus", w), l.focus())
                  : (n.unbind("click", y), l.bind("focus", w)),
                  $ && $(r, e);
              }),
              (v.today = function () {
                x(r, new Date());
      ...
      (this.$get = [
        ...
        function (a, i, o, r, l, s, c, u, p) {
          ...
          function m(n) {
            ...
            (this._open = !1),
              (this.backdropEl = d(i.backdropClass)),
              i.backdropFade &&
                (this.backdropEl.addClass(i.transitionClass),
                this.backdropEl.removeClass(i.triggerClass)),
              (this.modalEl = d(i.dialogClass)),
              i.dialogFade &&
                (this.modalEl.addClass(i.transitionClass),
                this.modalEl.removeClass(i.triggerClass)),
          ...
          return (
              ...
              return (
                this._loadResolves().then(function (e) {
                  ...
                  o(n.modalEl)(t),
                    n._addElementsToDom(),
                    setTimeout(function () {
                      n.options.dialogFade &&
                        n.modalEl.addClass(n.options.triggerClass),
                        n.options.backdropFade &&
            ...
            (m.prototype.close = function (e) {
              ...
              var a = this,
                i = this._getFadingElements();
              if (i.length > 0)
                for (var o = i.length - 1; o >= 0; o--) u(i[o], t).then(n);
              else this._onCloseComplete(e);
            }),
            (m.prototype._getFadingElements = function () {
              var e = [];
              return (
                this.options.dialogFade && e.push(this.modalEl),
                this.options.backdropFade && e.push(this.backdropEl),
                e
              );
            }),
            (m.prototype._bindEvents = function () {
              this.options.keyboard && g.bind("keydown", this.handledEscapeKey),
            ...
            (m.prototype._unbindEvents = function () {
              this.options.keyboard &&
                g.unbind("keydown", this.handledEscapeKey),
                this.options.backdrop &&
                  this.options.backdropClick &&
            ...
            (m.prototype._addElementsToDom = function () {
              g.append(this.modalEl),
                this.options.backdrop &&
                  (0 === n.value && g.append(this.backdropEl), n.value++),
                (this._open = !0);
            }),
            (m.prototype._removeElementsFromDom = function () {
              this.modalEl.remove(),
                this.options.backdrop &&
                  (n.value--, 0 === n.value && this.backdropEl.remove()),
                (this._open = !1);
            }),
            (m.prototype._loadResolves = function () {
              ...
              return (
                this.options.template
                  ? (e = c.when(this.options.template))
                  : this.options.templateUrl &&
                    (e = a
                      .get(this.options.templateUrl, { cache: s })
                      .then(function (e) {
                        return e.data;
                      })),
                angular.forEach(this.options.resolve || [], function (e, a) {
                  n.push(a),
                    t.push(angular.isString(e) ? p.get(e) : p.invoke(e));
                }),
                n.push("$template"),
                t.push(e),
                c.all(t).then(function (e) {
                  var t = {};
                  return (
        ...
        return {
          ...
          link: function (n, a, i) {
            var o,
              r = angular.extend(
                {},
                n.$eval(i.uiOptions || i.bsOptions || i.options)
              ),
              l = i.modal || i.show;
            r = angular.extend(r, {
              template: a.html(),
    ...
    .controller("PaginationController", [
      ...
      function (e, t) {
        (this.currentPage = 1),
          ...
          (this.reset = function () {
            (e.pages = []),
              (this.currentPage = parseInt(e.currentPage, 10)),
              this.currentPage > e.numPages && e.selectPage(e.numPages);
          });
        var n = this;
        (e.selectPage = function (t) {
          !n.isActive(t) &&
            t > 0 &&
            e.numPages >= t &&
            ((e.currentPage = t), e.onSelectPage({ page: t }));
        }),
      ...
      function (e) {
        return {
          ...
          link: function (t, n, a, i) {
            ...
            var r = i.getAttributeValue(a.boundaryLinks, e.boundaryLinks),
              l = i.getAttributeValue(a.directionLinks, e.directionLinks),
              s = i.getAttributeValue(a.firstText, e.firstText, !0),
              c = i.getAttributeValue(a.previousText, e.previousText, !0),
              u = i.getAttributeValue(a.nextText, e.nextText, !0),
              p = i.getAttributeValue(a.lastText, e.lastText, !0),
              d = i.getAttributeValue(a.rotate, e.rotate);
            t.$watch("numPages + currentPage + maxSize", function () {
              ...
              a &&
                (d
                  ? ((e = Math.max(
                      i.currentPage - Math.floor(t.maxSize / 2),
                      1
                    )),
                    (n = e + t.maxSize - 1),
                    n > t.numPages &&
                      ((n = t.numPages), (e = n - t.maxSize + 1)))
                  : ((e =
                      (Math.ceil(i.currentPage / t.maxSize) - 1) * t.maxSize +
                      1),
                    (n = Math.min(e + t.maxSize - 1, t.numPages))));
              for (var m = e; n >= m; m++) {
      ...
      function (e) {
        return {
          ...
          link: function (t, n, a, i) {
            ...
            var r = i.getAttributeValue(a.previousText, e.previousText, !0),
              ...
              return {
                ...
                link: function (e, t, n) {
                  ...
                  function f() {
                    ...
                    if (e.tt_content) {
                      switch (
                        ...
                        k
                          ? ((y = y || s.find("body")), y.append(w))
                          : t.after(w),
                        (n = k ? c.offset(t) : c.position(t)),
                        (a = w.prop("offsetWidth")),
                        (i = w.prop("offsetHeight")),
                        e.tt_placement)
                      ) {
                        case "mouse":
                          var l = c.mouse();
                  ...
                  function h() {
                    (e.tt_isOpen = !1),
                      r.cancel($),
                      angular.isDefined(e.tt_animation) && e.tt_animation()
                        ? (v = r(function () {
                            w.remove();
                          }, 500))
                        : w.remove();
                  ...
                  var v,
                    ...
                    y,
                    w = o(b)(e),
                    k = angular.isDefined(g.appendToBody) ? g.appendToBody : !1,
                    D = m(void 0),
                    x = !1;
                  (e.tt_isOpen = !1),
                    ...
                    n.$observe(p + "Animation", function (t) {
                      e.tt_animation = angular.isDefined(t)
                        ? l(t)
                        : function () {
                            return g.animation;
                          };
                    ...
                    n.$observe(p + "Trigger", function (e) {
                      x && (t.unbind(D.show, u), t.unbind(D.hide, d)),
                        (D = m(e)),
                        D.show === D.hide
                          ? t.bind(D.show, a)
                          : (t.bind(D.show, u), t.bind(D.hide, d)),
                        (x = !0);
                    }),
    ...
    .controller("ProgressBarController", [
      ...
      function (e, t, n) {
        ...
        var i = angular.isDefined(t.animate) ? e.$eval(t.animate) : n.animate,
          o = angular.isDefined(t.autoType) ? e.$eval(t.autoType) : n.autoType,
          r = angular.isDefined(t.stackedTypes)
            ? e.$eval("[" + t.stackedTypes + "]")
            : n.stackedTypes;
        (this.makeBar = function (e, t, n) {
          var r = angular.isObject(e) ? e.value : e || 0,
            l = angular.isObject(t) ? t.value : t || 0,
            s =
              angular.isObject(e) && angular.isDefined(e.type)
                ? e.type
                : o
                ? a(n || 0)
                : null;
        ...
        return {
          ...
          link: function (n, a, i) {
            ...
            (n.rate = function (e) {
              ...
              (n.readonly = !1),
              i.readonly &&
                n.$parent.$watch(t(i.readonly), function (e) {
                  n.readonly = !!e;
                });
          },
        };
  ...
  angular
    ...
    .directive("tabset", function () {
      return {
        ...
        compile: function (e, t, n) {
          return function (e, t, a, i) {
            (e.vertical = angular.isDefined(a.vertical)
              ? e.$eval(a.vertical)
              : !1),
              (e.type = angular.isDefined(a.type)
                ? e.$parent.$eval(a.type)
                : "tabs"),
              (e.direction = angular.isDefined(a.direction)
                ? e.$parent.$eval(a.direction)
                : "top"),
              (e.tabsAbove = "below" != e.direction),
              (i.$scope = e),
              (i.$transcludeFn = n);
          };
        },
          ...
          compile: function (t, n, a) {
            return function (t, n, i, o) {
              ...
              i.active
                ...
                t.$watch("active", function (e) {
                  l(t.$parent, e),
                    e ? (o.select(t), t.onSelect()) : t.onDeselect();
                }),
                (t.disabled = !1),
                i.disabled &&
                  t.$parent.$watch(e(i.disabled), function (e) {
                    t.disabled = !!e;
                  }),
                (t.select = function () {
    ...
    .directive("tabsetTitles", function () {
      return {
        ...
        replace: !0,
        link: function (e, t, n, a) {
          e.$eval(n.tabsetTitles)
            ? a.$transcludeFn(a.$scope.$parent, function (e) {
                t.append(e);
              })
            : t.remove();
        },
        ...
        return {
          ...
          link: function (a, i, o) {
            ...
            var c = new Date(),
              ...
              p = n.hourStep;
            o.hourStep &&
              a.$parent.$watch(t(o.hourStep), function (e) {
                p = parseInt(e, 10);
              });
            var d = n.minuteStep;
            o.minuteStep &&
              a.$parent.$watch(t(o.minuteStep), function (e) {
                d = parseInt(e, 10);
              }),
              (a.showMeridian = n.showMeridian),
              o.showMeridian &&
                a.$parent.$watch(t(o.showMeridian), function (e) {
                  if (((a.showMeridian = !!e), a.model)) l();
                  else {
                    var t = new Date(c),
                      n = r();
                    angular.isDefined(n) && t.setHours(n),
                      (a.model = new Date(t));
                  }
                });
            var m = i.find("input"),
              g = m.eq(0),
              f = m.eq(1),
              h = angular.isDefined(o.mousewheel)
                ? a.$eval(o.mousewheel)
                : n.mousewheel;
            if (h) {
              var v = function (e) {
              ...
              g.bind("mousewheel wheel", function (e) {
                a.$apply(v(e) ? a.incrementHours() : a.decrementHours()),
                  e.preventDefault();
              }),
                f.bind("mousewheel wheel", function (e) {
                  a.$apply(v(e) ? a.incrementMinutes() : a.decrementMinutes()),
                    e.preventDefault();
                });
            }
            var b = !1;
            (a.readonlyInput = angular.isDefined(o.readonlyInput)
              ? a.$eval(o.readonlyInput)
              : n.readonlyInput),
              a.readonlyInput
                ...
                : ((a.updateHours = function () {
                    ...
                    angular.isDefined(e)
                      ? ((b = "h"),
                        null === a.model && (a.model = new Date(c)),
                        a.model.setHours(e))
                      : ((a.model = null), (a.validHours = !1));
                  }),
                  ...
                  (a.updateMinutes = function () {
                    ...
                    e >= 0 && 60 > e
                      ? ((b = "m"),
                        null === a.model && (a.model = new Date(c)),
                        a.model.setMinutes(e))
                      : ((a.model = null), (a.validMinutes = !1));
                  }),
        ...
        return {
          ...
          link: function (s, c, u, p) {
            var d = s.$eval(u.typeaheadMinLength) || 1,
              ...
              g = s.$eval(u.typeaheadEditable) !== !1,
              f = t(u.typeaheadLoading).assign || angular.noop,
              h = t(u.typeaheadOnSelect),
              v = u.typeaheadInputFormatter
                ? t(u.typeaheadInputFormatter)
                : void 0,
            ...
            y.attr({
              ...
              angular.isDefined(u.typeaheadTemplateUrl) &&
                y.attr("template-url", u.typeaheadTemplateUrl);
            var w = s.$new();
                    ...
                    function (n) {
                      if (e === p.$viewValue) {
                        if (n.length > 0) {
                          ...
                          (w.query = e),
                            (w.position = o.position(c)),
                            (w.position.top =
                              w.position.top + c.prop("offsetHeight"));
                        } else k();
                        f(s, !1);
                      }
                    },
            ...
            p.$parsers.push(function (e) {
              ...
              (w.select = function (e) {
                var t,
                  n,
                  a = {};
                (a[$.itemName] = n = w.matches[e].model),
                  (t = $.modelMapper(s, a)),
                  b(s, t),
                  h(s, { $item: n, $model: t, $label: $.viewMapper(s, a) }),
                  k(),
                  c[0].focus();
              }),
