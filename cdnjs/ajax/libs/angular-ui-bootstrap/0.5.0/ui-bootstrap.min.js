            ...
            function c(t) {
              ...
              f.$modelValue &&
                ...
                isNaN(n)
                  ...
                  : t && (g = n)),
                f.$setValidity("date", i);
              var o = d.modes[m],
                r = o.getVisibleDates(g, n);
              angular.forEach(r.objects, function (e) {
                e.disabled = d.isDisabled(e.date, m);
              }),
                f.$setValidity("date-disabled", !n || !d.isDisabled(n)),
            ...
            if (f) {
              ...
              o.showWeeks
                ...
                (e.move = function (e) {
                  ...
                  g.setMonth(g.getMonth() + e * (t.months || 0)),
                    g.setFullYear(g.getFullYear() + e * (t.years || 0)),
                    c();
                }),
                ...
                (e.getWeekNumber = function (t) {
                  return 0 === m && e.showWeekNumbers && 7 === t.length
                    ? p(t[0].date)
                    : null;
                });
            }
      ...
      function (e, t, n, a, i, o) {
        return {
          ...
          link: function (r, l, s, c) {
            ...
            var g = angular.isDefined(s.closeOnDateSelection)
        ...
        function (a, i, o, r, l, s, c, u, p) {
          ...
          return (
            ...
            (f.prototype._bindEvents = function () {
              this.options.keyboard && m.bind("keydown", this.handledEscapeKey),
            ...
            (f.prototype._unbindEvents = function () {
              this.options.keyboard &&
                m.unbind("keydown", this.handledEscapeKey),
                this.options.backdrop &&
                  this.options.backdropClick &&
            ...
            (f.prototype._addElementsToDom = function () {
              m.append(this.modalEl),
                this.options.backdrop &&
                  (0 === n.value && m.append(this.backdropEl), n.value++),
                (this._open = !0);
            }),
