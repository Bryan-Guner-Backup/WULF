angular.module("ui.bootstrap", [
  ...
  angular.module("ui.bootstrap.transition", []).factory("$transition", [
    ...
    function (e, t, n) {
      ...
      return (
        (i.transitionEndEventName = a(o)), (i.animationEndEventName = a(l)), i
      );
    },
  ]),
  angular
          ...
          link: function (n, a, i) {
            ...
            n.$watch(
              ...
              function () {
                0 !== a[0].scrollHeight &&
                  (r ||
                    (o ? t(n, a, a[0].scrollHeight + "px") : t(n, a, "auto")));
              }
            ),
            ...
            var l,
              ...
              s = function () {
                o
                  ? ((o = !1), r || t(n, a, "auto"))
                  : c({ height: a[0].scrollHeight + "px" }).then(function () {
                      r || t(n, a, "auto");
                    }),
                  (r = !1);
              },
              u = function () {
                (r = !0),
                  o
                    ? ((o = !1), t(n, a, 0))
                    : (t(n, a, a[0].scrollHeight + "px"), c({ height: "0" }));
              };
          },
        };
      },
        ...
        return {
          ...
          link: function (e, a, i, r) {
            (r.$render = function () {
              a.toggleClass(
                t,
                angular.equals(r.$modelValue, e.$eval(i.btnRadio))
              );
            }),
              a.bind(n, function () {
                a.hasClass(t) ||
      ...
      function (e, t, n) {
        ...
        (o.currentSlide = null),
          (o.select = function (i, r) {
            function s() {
              ...
              i.$element
                ? (i.$element.addClass(r),
                  ...
                  angular.extend(i, { direction: r, active: !0, entering: !0 }),
            ...
            var p = l.indexOf(i);
            void 0 === r && (r = p > c ? "next" : "prev"),
              i &&
                i !== o.currentSlide &&
                (e.$currentTransition
                  ? (e.$currentTransition.cancel(), t(s))
                  : s());
          }),
          ...
          (o.addSlide = function (t, n) {
            (t.$element = n),
              l.push(t),
              1 === l.length || t.active
                ? (o.select(l[l.length - 1]), 1 == l.length && e.play())
                : (t.active = !1);
          }),
        ...
        offset: function (n) {
          ...
          return {
            ...
            left:
              ...
              (t.pageXOffset ||
                e[0].body.scrollLeft ||
                e[0].documentElement.scrollLeft),
          };
        },
      };
    },
        ...
        (this.minDate = a.minDate ? new Date(a.minDate) : null),
          ...
          (this.modes = [
            ...
            },
            {
              ...
              getVisibleDates: function (e, t) {
                for (
                  var a = Array(12), i = e.getFullYear(), r = 0;
                  12 > r;
                  r++
                ) {
                  ...
                  a[r] = l(
                    o,
                    c.month,
                    t && t.getMonth() === r && t.getFullYear() === i
                  );
                }
          ...
          link: function (e, i, r, o) {
            ...
            if (f) {
              var m = 0,
                ...
                h = n.showWeeks;
              r.showWeeks
                ? e.$parent.$watch(t(r.showWeeks), function (e) {
                    (h = !!e), l();
                  })
                : l(),
                r.min &&
                  e.$parent.$watch(t(r.min), function (e) {
                    (d.minDate = e ? new Date(e) : null), s();
                  }),
                r.max &&
                  e.$parent.$watch(t(r.max), function (e) {
      ...
      function (e, t, n, a, i, r) {
        return {
          ...
          link: function (o, l, c, s) {
            ...
            function p(e) {
              if (e) {
                ...
                if (angular.isString(e)) {
                  var t = new Date(e);
                  return isNaN(t)
                    ? (s.$setValidity("date", !1), void 0)
                    : (s.$setValidity("date", !0), t);
                }
            ...
            var g = angular.isDefined(c.closeOnDateSelection)
                ? v.$eval(c.closeOnDateSelection)
                : r.closeOnDateSelection,
            ...
            c.datepickerOptions &&
              D.attr(angular.extend({}, o.$eval(c.datepickerOptions))),
              s.$parsers.unshift(p),
              ...
              f(c.max, "max"),
              c.showWeeks
                ? f(c.showWeeks, "showWeeks", "show-weeks")
                : ((v.showWeeks = !0), D.attr("show-weeks", "showWeeks")),
              c.dateDisabled && D.attr("date-disabled", c.dateDisabled);
            var x = !1,
              T = !1;
            v.$watch("isOpen", function (e) {
              e
                ? (m(),
                  ...
                  l[0].focus(),
                  (x = !0))
                : (x && n.unbind("click", y), l.bind("focus", w), (T = !0)),
                b && b(o, e);
            });
      ...
      function (e, t, n, a) {
        ...
        return (
          ...
          (p.open = function (e, n) {
            ...
            a.attr("window-class", n.windowClass),
              a.attr("index", u.length() - 1),
              a.html(n.content);
            var r = t(a)(n.scope);
            (u.top().value.modalDomEl = r),
              s.append(r),
              i() >= 0 &&
                !l &&
                ((o = angular.element("<div modal-backdrop></div>")),
                (l = t(o)(c)),
                s.append(l));
          }),
        ...
        $get: [
          ...
          function (t, n, a, i, r, o, l) {
            function c(e) {
              return e.template
                ? a.when(e.template)
                : i.get(e.templateUrl, { cache: r }).then(function (e) {
                    return e.data;
                  });
            }
            function s(e) {
        ...
        (this.init = function (a) {
          ...
          (e.selectPage = function (t) {
            !i.isActive(t) &&
              t > 0 &&
              e.totalPages >= t &&
              ((e.page = t), e.onSelectPage({ page: t }));
          }),
          e.$watch("totalItems", function () {
            e.totalPages = i.calculateTotalPages();
          }),
          e.$watch("totalPages", function (n) {
            t.numPages && (e.numPages = n),
              i.page > n ? e.selectPage(n) : i.render();
          }),
      ...
      function (e, t) {
        return {
          ...
          link: function (n, a, i, r) {
            ...
            var l,
              c = r.getAttributeValue(i.boundaryLinks, t.boundaryLinks),
            ...
            r.init(t.itemsPerPage),
              ...
              (r.getPages = function (e, t) {
                ...
                g &&
                  (m
                    ? ((a = Math.max(e - Math.floor(l / 2), 1)),
                      (i = a + l - 1),
                      i > t && ((i = t), (a = i - l + 1)))
                    : ((a = (Math.ceil(e / l) - 1) * l + 1),
                      (i = Math.min(a + l - 1, t))));
                for (var h = a; i >= h; h++) {
                  ...
                  function g() {
                    ...
                    if (e.tt_content) {
                      switch (
                        ...
                        k
                          ? ((y = y || c.find("body")), y.append(w))
                          : t.after(w),
                        (n = k ? s.offset(t) : s.position(t)),
    ...
    .controller("ProgressBarController", [
      ...
      function (e, t, n) {
        ...
        var i = angular.isDefined(t.animate) ? e.$eval(t.animate) : n.animate,
          ...
          o = angular.isDefined(t.stackedTypes)
  ...
  angular
    ...
    .controller("RatingController", [
      ...
      "ratingConfig",
      function (e, t, n, a) {
        (this.maxRange = angular.isDefined(t.max)
          ? e.$parent.$eval(t.max)
          : a.max),
          ...
          (this.stateOff = angular.isDefined(t.stateOff)
            ...
            : a.stateOff),
          (this.createDefaultRange = function (e) {
            for (
              var t = { stateOn: this.stateOn, stateOff: this.stateOff },
                n = Array(e),
                a = 0;
              e > a;
              a++
          ...
          (this.normalizeRange = function (e) {
            for (var t = 0, n = e.length; n > t; t++)
              (e[t].stateOn = e[t].stateOn || this.stateOn),
                (e[t].stateOff = e[t].stateOff || this.stateOff);
            return e;
          }),
          (e.range = angular.isDefined(t.ratingStates)
            ? this.normalizeRange(angular.copy(e.$parent.$eval(t.ratingStates)))
          ...
          compile: function (t, n, a) {
            return function (t, n, i, r) {
              ...
              i.active
                ...
                t.$watch("active", function (e) {
                  l(t.$parent, e),
                    e ? (r.select(t), t.onSelect()) : t.onDeselect();
                }),
                (t.disabled = !1),
                i.disabled &&
          ...
          link: function (a, i, r, o) {
            ...
            function d(e) {
              ...
              a.showMeridian && (t = 0 === t || 12 === t ? 12 : t % 12),
                (a.hours = "h" === e ? t : s(t)),
                (a.minutes = "m" === e ? n : s(n)),
                (a.meridian = 12 > m.getHours() ? g[0] : g[1]);
            }
            function f(e) {
            ...
            if (o) {
              var m = new Date(),
                ...
                h = n.hourStep;
              r.hourStep &&
                a.$parent.$watch(e(r.hourStep), function (e) {
                  h = parseInt(e, 10);
                });
              var v = n.minuteStep;
              r.minuteStep &&
                a.$parent.$watch(e(r.minuteStep), function (e) {
                  v = parseInt(e, 10);
                }),
                (a.showMeridian = n.showMeridian),
                r.showMeridian &&
                  a.$parent.$watch(e(r.showMeridian), function (e) {
              ...
              var $ = i.find("input"),
                b = $.eq(0),
                y = $.eq(1),
                w = angular.isDefined(r.mousewheel)
                  ? a.$eval(r.mousewheel)
                  : n.mousewheel;
              if (w) {
                var k = function (e) {
                ...
                b.bind("mousewheel wheel", function (e) {
                  a.$apply(k(e) ? a.incrementHours() : a.decrementHours()),
                    e.preventDefault();
                }),
                  y.bind("mousewheel wheel", function (e) {
                    a.$apply(
                      k(e) ? a.incrementMinutes() : a.decrementMinutes()
                    ),
                      e.preventDefault();
                  });
              }
              if (
                ((a.readonlyInput = angular.isDefined(r.readonlyInput)
                  ? a.$eval(r.readonlyInput)
                  : n.readonlyInput),
                a.readonlyInput)
              )
                ...
                var D = function (e, t) {
                  o.$setViewValue(null),
                    ...
                    angular.isDefined(e) && (a.invalidHours = e),
                    angular.isDefined(t) && (a.invalidMinutes = t);
                };
                    ...
                    function (n) {
                      if (e === p.$viewValue) {
                        if (n.length > 0) {
                          ...
                          (w.query = e),
                            (w.position = r.position(s)),
                            (w.position.top =
                              w.position.top + s.prop("offsetHeight"));
                        } else k();
                        g(c, !1);
                      }
                    },
            ...
            p.$parsers.unshift(function (e) {
              return (
                ...
                e &&
                  ...
                  (f > 0
                    ...
                    : D(e)),
                m ? e : (p.$setValidity("editable", !1), void 0)
              );
            }),
              ...
              (w.select = function (e) {
                var t,
                  n,
                  a = {};
                (a[b.itemName] = n = w.matches[e].model),
                  (t = b.modelMapper(c, a)),
                  $(c, t),
                  p.$setValidity("editable", !0),
                  h(c, { $item: n, $model: t, $label: b.viewMapper(c, a) }),
                  k(),
                  s[0].focus();
              }),
