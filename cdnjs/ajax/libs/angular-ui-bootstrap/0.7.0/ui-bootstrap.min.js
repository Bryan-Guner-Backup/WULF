        ...
        return {
          link: function (c, d, e) {
            ...
            var h,
              ...
              j = function () {
                g
                  ? ((g = !1), f || (b(c, d, "auto"), d.addClass("in")))
                  : i({ height: d[0].scrollHeight + "px" }).then(function () {
              ...
              k = function () {
                (f = !0),
                  ...
                  g
                    ? ((g = !1), b(c, d, 0))
                    : (b(c, d, d[0].scrollHeight + "px"), i({ height: "0" }));
              };
          },
        };
      },
        ...
        return {
          ...
          link: function (a, d, e, f) {
            (f.$render = function () {
              d.toggleClass(
                b,
                angular.equals(f.$modelValue, a.$eval(e.btnRadio))
              );
            }),
              d.bind(c, function () {
                d.hasClass(b) ||
      ...
      function (a, b, c) {
        ...
        (g.currentSlide = null),
          (g.select = function (e, f) {
            ...
            var l = h.indexOf(e);
            void 0 === f && (f = l > i ? "next" : "prev"),
              e &&
                e !== g.currentSlide &&
                (a.$currentTransition
                  ? (a.$currentTransition.cancel(), b(j))
                  : j());
          }),
          ...
          (g.addSlide = function (b, c) {
            (b.$element = c),
              h.push(b),
              1 === h.length || b.active
                ? (g.select(h[h.length - 1]), 1 == h.length && a.play())
                : (b.active = !1);
          }),
        ...
        (this.minDate = d.minDate ? new Date(d.minDate) : null),
          ...
          (this.modes = [
            ...
            },
            {
              ...
              getVisibleDates: function (a, b) {
                for (
                  var d = new Array(12), e = a.getFullYear(), f = 0;
                  12 > f;
                  f++
                ) {
                  ...
                  d[f] = h(
                    g,
                    i.month,
                    b && b.getMonth() === f && b.getFullYear() === e
                  );
                }
          ...
          (this.isDisabled = function (b, c) {
            ...
            return (
              (this.minDate && d.compare(b, this.minDate) < 0) ||
              (this.maxDate && d.compare(b, this.maxDate) > 0) ||
              (a.dateDisabled && a.dateDisabled({ date: b, mode: d.name }))
            );
          });
      },
    ])
          ...
          link: function (a, e, f, g) {
            ...
            if (n) {
              var o = 0,
                ...
                q = c.showWeeks;
              f.showWeeks
                ? a.$parent.$watch(b(f.showWeeks), function (a) {
                    (q = !!a), h();
                  })
                : h(),
                f.min &&
                  a.$parent.$watch(b(f.min), function (a) {
                    (m.minDate = a ? new Date(a) : null), j();
                  }),
                f.max &&
                  a.$parent.$watch(b(f.max), function (a) {
                ...
                (a.getWeekNumber = function (b) {
                  return 0 === o && a.showWeekNumbers && 7 === b.length
                    ? l(b[0].date)
                    : null;
                });
            }
      ...
      function (a, b, c, d, e, f, g) {
        return {
          ...
          link: function (h, i, j, k) {
            ...
            function o(a, c, d) {
              a &&
                (h.$watch(b(a), function (a) {
                  t[c] = a;
                }),
                z.attr(d || c, c));
            }
            function p() {
              (t.position = s ? d.offset(i) : d.position(i)),
                (t.position.top = t.position.top + i.prop("offsetHeight"));
            }
            var q;
            j.$observe("datepickerPopup", function (a) {
              (q = a || f.dateFormat), k.$render();
            });
            var r = angular.isDefined(j.closeOnDateSelection)
            ...
            h.$on("$destroy", function () {
              ...
              j.$observe("toggleWeeksText", function (a) {
                t.toggleWeeksText = angular.isDefined(a)
                  ? a
                  : f.toggleWeeksText;
              }),
            ...
            j.datepickerOptions &&
              z.attr(angular.extend({}, h.$eval(j.datepickerOptions))),
              k.$parsers.unshift(m),
              (t.dateSelection = function () {
              ...
              o(j.max, "max"),
              j.showWeeks
                ? o(j.showWeeks, "showWeeks", "show-weeks")
                : ((t.showWeeks = g.showWeeks),
                  z.attr("show-weeks", "showWeeks")),
              j.dateDisabled && z.attr("date-disabled", j.dateDisabled);
            var A = !1,
              B = !1;
            t.$watch("isOpen", function (a) {
              a
                ? (p(),
                  ...
                  i[0].focus(),
                  (A = !0))
                : (A && c.unbind("click", w), i.bind("focus", x), (B = !0)),
                v && v(h, a);
            });
    ...
    .factory("$modalStack", [
      ...
      function (a, b, c, d) {
        ...
        function f(a) {
          ...
          k.remove(a),
            b.modalDomEl.remove(),
            h && -1 == e() && (h.remove(), (h = void 0)),
            b.modalScope.$destroy();
        }
        var g,
          h,
          i = c.$new(!0),
        ...
        return (
          ...
          (l.open = function (a, c) {
            ...
            d.attr("window-class", c.windowClass),
              d.attr("index", k.length() - 1),
              d.html(c.content);
            var f = b(d)(c.scope);
            (k.top().value.modalDomEl = f),
              j.append(f),
              e() >= 0 &&
                !h &&
                ((g = angular.element("<div modal-backdrop></div>")),
                (h = b(g)(i)),
                j.append(h));
          }),
            ...
            return function (e, l, m) {
              ...
              var o = angular.extend({}, b, d),
                ...
                s =
                  ...
                  "tt_placement" +
                  r +
                  '" animation="tt_animation" is-open="tt_isOpen"></' +
                  p +
                  "-popup>";
              return {
                restrict: "EA",
                ...
                link: function (a, b, c) {
                  ...
                  function p() {
                    ...
                    if (a.tt_content) {
                      switch (
                        ...
                        w ? v.append(u) : b.after(u),
                        (c = w ? j.offset(b) : j.position(b)),
                        (d = u.prop("offsetWidth")),
                        (e = u.prop("offsetHeight")),
                        a.tt_placement)
                      ) {
                        case "right":
                          f = {
                  ...
                  var r,
                    ...
                    u = f(s)(a),
                    v = i.find("body"),
                    w = angular.isDefined(o.appendToBody) ? o.appendToBody : !1,
                    x = n(void 0),
                    y = !1,
                    z = angular.isDefined(c[l + "Enable"]);
                  (a.tt_isOpen = !1),
                    c.$observe(e, function (b) {
                    ...
                    c.$observe(l + "Trigger", function (a) {
                      y && (b.unbind(x.show, k), b.unbind(x.hide, m)),
                        (x = n(a)),
                        x.show === x.hide
                          ? b.bind(x.show, d)
                          : (b.bind(x.show, k), b.bind(x.hide, m)),
                        (y = !0);
                    }),
    ...
    .controller("ProgressBarController", [
      ...
      function (a, b, c) {
        ...
        var e = angular.isDefined(b.animate) ? a.$eval(b.animate) : c.animate,
          ...
          g = angular.isDefined(b.stackedTypes)
            ? a.$eval("[" + b.stackedTypes + "]")
            : c.stackedTypes;
        (this.makeBar = function (a, b, c) {
          var g = angular.isObject(a) ? a.value : a || 0,
            h = angular.isObject(b) ? b.value : b || 0,
            i =
              angular.isObject(a) && angular.isDefined(a.type)
                ? a.type
                : f
                ? d(c || 0)
                : null;
    ...
    .controller("RatingController", [
      ...
      function (a, b, c, d) {
        (this.maxRange = angular.isDefined(b.max)
          ...
          (a.range = angular.isDefined(b.ratingStates)
  ...
  angular
    ...
    .directive("tabset", function () {
      return {
        ...
        compile: function (a, b, c) {
          return function (a, b, d, e) {
            (a.vertical = angular.isDefined(d.vertical)
              ? a.$parent.$eval(d.vertical)
              : !1),
              (a.type = angular.isDefined(d.type)
                ? a.$parent.$eval(d.type)
                : "tabs"),
              (a.direction = angular.isDefined(d.direction)
                ? a.$parent.$eval(d.direction)
                : "top"),
              (a.tabsAbove = "below" != a.direction),
              (e.$scope = a),
              (e.$transcludeFn = c);
          };
        },
    ...
    .directive("tabsetTitles", function () {
      return {
        ...
        replace: !0,
        link: function (a, b, c, d) {
          a.$eval(c.tabsetTitles)
            ? d.$transcludeFn(d.$scope.$parent, function (a) {
                b.append(a);
              })
            : b.remove();
        },
          ...
          link: function (d, e, f, g) {
            ...
            if (g) {
              var o = new Date(),
                ...
                q = c.hourStep;
              f.hourStep &&
                d.$parent.$watch(a(f.hourStep), function (a) {
                  q = parseInt(a, 10);
                });
              var r = c.minuteStep;
              f.minuteStep &&
                d.$parent.$watch(a(f.minuteStep), function (a) {
                  r = parseInt(a, 10);
                }),
                (d.showMeridian = c.showMeridian),
                f.showMeridian &&
                  d.$parent.$watch(a(f.showMeridian), function (a) {
              ...
              if (v) {
                ...
                t.bind("mousewheel wheel", function (a) {
                  d.$apply(w(a) ? d.incrementHours() : d.decrementHours()),
                    a.preventDefault();
                }),
                  u.bind("mousewheel wheel", function (a) {
                    d.$apply(
                      w(a) ? d.incrementMinutes() : d.decrementMinutes()
                    ),
                      a.preventDefault();
                  });
              }
              if (
                ...
                var x = function (a, b) {
                  g.$setViewValue(null),
                    g.$setValidity("time", !1),
                    angular.isDefined(a) && (d.invalidHours = a),
                    angular.isDefined(b) && (d.invalidMinutes = b);
                };
          ...
          link: function (i, j, k, l) {
            var m,
              ...
              s = k.typeaheadInputFormatter
                ...
                : void 0,
              t = b(k.ngModel).assign,
              u = g.parse(k.typeahead),
              v = angular.element("<div typeahead-popup></div>");
            v.attr({
              matches: "matches",
              active: "activeIdx",
              ...
              angular.isDefined(k.typeaheadTemplateUrl) &&
                v.attr("template-url", k.typeaheadTemplateUrl);
            var w = i.$new();
            ...
            l.$parsers.unshift(function (a) {
              return (
                ...
                p
                  ? a
                  : a
                  ? (l.$setValidity("editable", !1), void 0)
              ...
              (w.select = function (a) {
                var b,
                  c,
                  d = {};
                (d[u.itemName] = c = w.matches[a].model),
                  (b = u.modelMapper(i, d)),
                  t(i, b),
                  l.$setValidity("editable", !0),
                  r(i, { $item: c, $model: b, $label: u.viewMapper(i, d) }),
                  x(),
                  j[0].focus();
              }),
              j.bind("keydown", function (a) {
                return 0 === w.matches.length || -1 === h.indexOf(a.which)
                  ? (13 === a.which && a.preventDefault(), void 0)
                  : (a.preventDefault(),
                    40 === a.which
