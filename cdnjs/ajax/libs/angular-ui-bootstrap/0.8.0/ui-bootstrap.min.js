            ...
            var i,
              ...
              l = function () {
                (g = !0),
                  ...
                  h
                    ? ((h = !1), b(c, d, 0))
                    : (b(c, d, d[0].scrollHeight + "px"), j({ height: "0" }));
              };
          },
        };
      },
      ...
      function (a, b, c, d, e, f, g) {
        return {
          ...
          link: function (h, i, j, k) {
            ...
            var p,
              q = h.$new(),
              r = angular.isDefined(j.closeOnDateSelection)
            ...
            j.$observe("datepickerPopup", function (a) {
              ...
              (q.showButtonBar = angular.isDefined(j.showButtonBar)
                ? h.$eval(j.showButtonBar)
                : f.showButtonBar),
              ...
              j.$observe("toggleWeeksText", function (a) {
                q.toggleWeeksText = angular.isDefined(a)
                  ? a
                  : f.toggleWeeksText;
              }),
            ...
            j.datepickerOptions &&
              y.attr(angular.extend({}, h.$eval(j.datepickerOptions))),
              k.$parsers.unshift(m),
              ...
              n(j.max, "max"),
              j.showWeeks
                ? n(j.showWeeks, "showWeeks", "show-weeks")
                : ((q.showWeeks = g.showWeeks),
            ...
            q.$watch("isOpen", function (a) {
              a
                ? (o(),
                  ...
                  i[0].focus(),
                  (z = !0))
                : (z && c.unbind("click", v), i.bind("focus", w), (A = !0)),
                u && u(h, a);
            }),
              (q.today = function () {
      ...
      function (a, b, c, d) {
        ...
        return (
          ...
          (l.open = function (c, d) {
            ...
            l.attr("window-class", d.windowClass),
              l.attr("index", k.length() - 1),
              l.html(d.content);
            var m = b(l)(d.scope);
                ...
                link: function (a, b, c) {
                  ...
                  function p() {
                    ...
                    if (a.tt_content) {
                      switch (
                        ...
                        v ? i.find("body").append(u) : b.after(u),
                        (c = v ? j.offset(b) : j.position(b)),
                  ...
                  c.$observe(l + "Trigger", function (a) {
                    z(),
                      ...
                      w.show === w.hide
                        ? b.bind(w.show, d)
                        : (b.bind(w.show, k), b.bind(w.hide, m)),
                      (x = !0);
                  });
                  var A = a.$eval(c[l + "Animation"]);
                  (a.tt_animation = angular.isDefined(A) ? !!A : o.animation),
      ...
      function (a, b, c, d) {
        return {
          ...
          link: function (e, f, g, h) {
            ...
            if (h) {
              var p = new Date(),
                q = angular.isDefined(g.meridians)
                  ? e.$parent.$eval(g.meridians)
                  : c.meridians || d.DATETIME_FORMATS.AMPMS,
                r = c.hourStep;
              g.hourStep &&
                e.$parent.$watch(a(g.hourStep), function (a) {
                  r = parseInt(a, 10);
                });
              var s = c.minuteStep;
              g.minuteStep &&
                e.$parent.$watch(a(g.minuteStep), function (a) {
                  s = parseInt(a, 10);
                }),
                (e.showMeridian = c.showMeridian),
                g.showMeridian &&
                  e.$parent.$watch(a(g.showMeridian), function (a) {
              ...
              var t = f.find("input"),
                u = t.eq(0),
                v = t.eq(1),
                w = angular.isDefined(g.mousewheel)
                  ? e.$eval(g.mousewheel)
                  : c.mousewheel;
              if (w) {
                var x = function (a) {
                ...
                u.bind("mousewheel wheel", function (a) {
                  ...
                  v.bind("mousewheel wheel", function (a) {
                    e.$apply(
                      x(a) ? e.incrementMinutes() : e.decrementMinutes()
                    ),
                      a.preventDefault();
                  });
              }
              if (
                ((e.readonlyInput = angular.isDefined(g.readonlyInput)
                  ? e.$eval(g.readonlyInput)
                  : c.readonlyInput),
                e.readonlyInput)
              )
