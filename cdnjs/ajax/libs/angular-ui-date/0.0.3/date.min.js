          ...
          link: function (r, n, a, u) {
            var i = function () {
              ...
              o = function () {
                var e = i();
                if (u) {
                  var a = u.$setViewValue,
                    o = !1;
                  u.$setViewValue = function () {
                    o ||
                      ((o = !0),
                      n.datepicker("setDate", n.datepicker("getDate")),
                      a.call(u, n.datepicker("getDate")),
                      t(function () {
                        o = !1;
                      }));
                  };
                ...
                n.datepicker("destroy"), n.datepicker(e), u && u.$render();
              };
            r.$watch(i, o, !0);
          },
        }
    ...
    function (e) {
      var t = {
        ...
        link: function (t, r, n, a) {
          var u = n.uiDateFormat || e;
          u
            ? (a.$formatters.push(function (e) {
                return angular.isString(e)
                  ? jQuery.datepicker.parseDate(u, e)
                  : null;
              }),
              a.$parsers.push(function (e) {
                return e ? jQuery.datepicker.formatDate(u, e) : null;
              }))
            : (a.$formatters.push(function (e) {
