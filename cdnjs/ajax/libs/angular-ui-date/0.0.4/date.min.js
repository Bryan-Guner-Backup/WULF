      ...
      return (
        ...
        angular.extend(t, e),
        {
          ...
          link: function (t, n, r, a) {
            var i = function () {
                return angular.extend({}, e, t.$eval(r.uiDate));
              },
              u = function () {
                var e = !1,
                  r = i();
                if (a) {
                  var u = r.onSelect || angular.noop;
                  (r.onSelect = function (r, i) {
                    t.$apply(function () {
                      (e = !0),
                        a.$setViewValue(n.datepicker("getDate")),
                        u(r, i),
                        n.blur();
                    });
                  }),
                ...
                n.datepicker("destroy"), n.datepicker(r), a && a.$render();
              };
            t.$watch(i, u, !0);
          },
        }
          ...
          i
            ? (a.$formatters.push(function (e) {
                return angular.isString(e)
                  ? jQuery.datepicker.parseDate(i, e)
                  : null;
              }),
              a.$parsers.push(function (e) {
                return e ? jQuery.datepicker.formatDate(i, e) : null;
              }))
            : (a.$formatters.push(function (e) {
