...
angular
  ...
  .directive("uiDate", [
    "uiDateConfig",
    "uiDateConverter",
    function (uiDateConfig, uiDateConverter) {
      "use strict";
      var options;
      options = {};
              ...
              controller.$render = function () {
                ...
                if (
                  ...
                  if (angular.isString(controller.$modelValue)) {
                    date = uiDateConverter.stringToDate(
                      attrs.uiDateFormat,
                      controller.$modelValue
                    );
                  } else {
                    throw new Error(
                      "ng-Model value must be a Date, or a String object with a date formatter - currently it is a " +
                        typeof date +
