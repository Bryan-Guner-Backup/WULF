            ...
            var u = function () {
              ...
              o = function () {
                var e = !1,
                  o = u();
                if (i) {
                  var c = o.onSelect || angular.noop;
                  (o.onSelect = function (t, a) {
                    r.$apply(function () {
                      (e = !0),
                        i.$setViewValue(n.datepicker("getDate")),
                        c(t, a);
                    });
                  }),
                    ...
                    n.off("blur.datepicker").on("blur.datepicker", function () {
                      e ||
                        r.$apply(function () {
                          n.datepicker("setDate", n.datepicker("getDate")),
                            i.$setViewValue(n.datepicker("getDate"));
                        });
                    }),
                    (i.$render = function () {
                      ...
                      if (
                        ...
                        if (!angular.isString(i.$modelValue))
                          throw new Error(
                ...
                n.datepicker("destroy"), n.datepicker(o), i && i.$render();
              };
            r.$watch(u, o, !0);
          },
        }
  ...
  .factory("uiDateConverter", [
    ...
    function (e) {
      function t(t, r) {
        return r
          ? t || e
            ? jQuery.datepicker.formatDate(t, r)
            : r.toISOString()
          : null;
      }
      function r(t, r) {
        if (angular.isString(r)) {
          if (t || e) return jQuery.datepicker.parseDate(t, r);
          var n = new Date(r);
