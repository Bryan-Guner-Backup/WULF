...
(function (r, t, e) {
  "use strict";
  function n(r, t) {
    return P(new (P(function () {}, { prototype: r }))(), t);
  }
  function a(r) {
    return (
      y(arguments, function (t) {
        t !== r &&
          y(t, function (t, e) {
  ...
  function u(r, t) {
    var n = 1,
      ...
      u = [],
      s = i,
      l = P(r.when(i), { $$promises: i, $$values: i });
    (this.study = function (i) {
      function c(r, e) {
        if (v[e] !== o) {
          if ((p.push(e), v[e] === n))
            throw (
              (p.splice(0, p.indexOf(e)),
              Error("Cyclic dependency: " + p.join(" -> ")))
            );
          if (((v[e] = n), b(r)))
            h.push(
              e,
        ...
        function (n, o, i) {
          ...
          function p(e, a, o) {
            ...
            function l() {
              if (!g($.$$failure))
                try {
                  f.resolve(t.invoke(a, i, d)),
                    f.promise.then(function (r) {
                      (d[e] = r), u();
                    }, s);
                } catch (r) {
                  s(r);
  ...
  function s(r, t, e) {
    (this.fromConfig = function (r, t, e) {
      return g(r.template)
        ? this.fromString(r.template, t)
        : g(r.templateUrl)
        ? this.fromUrl(r.templateUrl, t)
        : g(r.templateProvider)
        ? this.fromProvider(r.templateProvider, t, e)
        : null;
    }),
      ...
      (this.fromUrl = function (e, n) {
        return (
          ...
          null == e
            ? null
            : r.get(e, { cache: t }).then(function (r) {
                return r.data;
              })
        );
      }),
  ...
  function l(r) {
    function t(t) {
      if (!/^\w+(-+\w+)*$/.test(t))
        throw Error(
          "Invalid parameter name '" + t + "' in pattern '" + r + "'"
        );
      if (o[t])
        throw Error(
          "Duplicate parameter name '" + t + "' in pattern '" + r + "'"
        );
      (o[t] = !0), l.push(t);
    }
    function e(r) {
    ...
    if (p >= 0) {
      ...
      (h = h.substring(0, p)),
        (this.sourcePath = r.substring(0, u + p)),
        y(v.substring(1).split(/[&?]/), t);
  ...
  function h(r, a, o) {
      ...
      if (o) {
        ...
        for (var i = a.split("."), u = 0, s = i.length, l = t; s > u; u++)
          if ("" !== i[u] || 0 !== u) {
            ...
            if (!l.parent)
              throw Error(
                "Path '" + a + "' not valid for state '" + t.name + "'"
              );
            l = l.parent;
          } else l = t;
    ...
    function c(r, t, a, s, l, c, m) {
      function d(r, e, n, o, i) {
        var u = n ? e : p(r.params, e),
          s = { $stateParams: u };
        i.resolve = l.resolve(r.resolve, s, i.resolve, r);
        var c = [
          i.resolve.then(function (r) {
            i.globals = r;
          }),
        ];
        return (
          o && c.push(o),
          y(r.views, function (t, e) {
            var n = t.resolve && t.resolve !== r.resolve ? t.resolve : {};
            (n.$template = [
              function () {
                return (
                  a.load(e, { view: t, locals: s, params: u, notify: !1 }) || ""
                );
              },
            ]),
              c.push(
                l.resolve(n, s, i.resolve, r).then(function (n) {
      ...
      var w = t.reject(Error("transition superseded")),
        b = t.reject(Error("transition prevented"));
      return (
        (v.locals = { resolve: null, globals: { $stateParams: {} } }),
        ($ = { params: {}, current: v.self, $current: v, transition: null }),
        ($.go = function (r, t, e) {
          return this.transitionTo(
            r,
            t,
            P({ inherit: !0, relative: $.$current }, e)
          );
        }),
        ($.transitionTo = function (e, a, o) {
          g(o) || (o = o === !0 || o === !1 ? { location: o } : {}),
            (a = a || {}),
            (o = P({ location: !0, inherit: !1, relative: null }, o));
          ...
          var U = ($.transition = I.then(
            function () {
              ...
              for (t = S.length - 1; t >= p; t--)
                (i = S[t]),
                  i.self.onExit &&
                    s.invoke(i.self.onExit, i.self, i.locals.globals),
                  (i.locals = null);
              for (t = p; x.length > t; t++)
                (n = x[t]),
                  (n.locals = k[t]),
                  n.self.onEnter &&
                    s.invoke(n.self.onEnter, n.self, n.locals.globals);
              ($.$current = e),
                ($.current = e.self),
                ($.params = a),
                j($.params, c),
              ...
              return (
                o.location &&
                  u &&
                  m.url(u.url.format(u.locals.globals.$stateParams)),
                r.$broadcast("$stateChangeSuccess", e.self, a, y.self, C),
                $.current
              );
            },
            function (n) {
              return $.transition !== U
                ? w
                : (($.transition = null),
                  r.$broadcast("$stateChangeError", e.self, a, y.self, C, n),
                  t.reject(n));
            }
          ));
          return U;
        ...
        ($.href = function (r, t, e) {
          ...
          if (!g(n)) return null;
          t = i(c, t || {}, $.$current, n);
          var a = n && e.lossy ? n.navigable : n,
            s = a && a.url ? a.url.format(f(n.params, t || {})) : null;
      ...
      d = {
        ...
        data: function (r) {
          return (
            r.parent &&
              r.parent.data &&
              (r.data = r.self.data = t.extend({}, r.parent.data, r.data)),
            r.data
          );
        },
        url: function (r) {
          ...
          if (b(t))
            return "^" == t.charAt(0)
              ? a.compile(t.substring(1))
              : (r.parent.navigable || v).url.concat(t);
        ...
        views: function (r) {
          var t = {};
          return (
            y(g(r.views) ? r.views : { "": r }, function (e, n) {
    ...
    (v = s({ name: "", url: "^", views: null, abstract: !0 })),
      (v.navigable = null),
      (this.state = l),
      (this.$get = c),
      (c.$inject = [
    ...
    function r(r, t) {
      return {
        load: function (e, n) {
          ...
          return (
            (n = P(o, n)),
            n.view && (a = t.fromConfig(n.view, n.params, n.locals)),
            a && n.notify && r.$broadcast("$viewContentLoading", n),
            a
          );
        },
      };
      ...
      l = {
        ...
        compile: function (a, u, c) {
          return function (a, u, f) {
            ...
            a.$on("$stateChangeSuccess", x),
              a.$on("$viewContentLoading", x),
              h(!1);
          };
        },
      };
    ...
    return {
      ...
      link: function (t, n, a) {
        var o = $(a.uiSref),
          ...
          l = s ? "action" : "href",
          c = !0,
          f = n.parent().inheritedData("$uiView");
  ...
  function d(r, t) {
    ...
    function u(r, t, n) {
      ...
      return (
        t.$on("$stateChangeStart", function (r, e, n, o) {
          t.$broadcast("$routeChangeStart", a(e), a(o));
        }),
        t.$on("$stateChangeSuccess", function (r, e, n, i) {
          (o.current = a(e)),
            t.$broadcast("$routeChangeSuccess", a(e), a(i)),
            j(n, o.params);
        }),
  ...
  t.module("ui.router.util", ["ng"]),
    ...
    (u.$inject = ["$q", "$injector"]),
    t.module("ui.router.util").service("$resolve", u),
    (s.$inject = ["$http", "$templateCache", "$injector"]),
    t.module("ui.router.util").service("$templateFactory", s),
    (l.prototype.concat = function (r) {
    ...
    (l.prototype.format = function (r) {
      ...
      for (n = 0; i > n; n++)
        (o = r[e[n]]),
          null != o && (s += encodeURIComponent(o)),
          (s += t[n + 1]);
      for (; u > n; n++)
        (o = r[e[n]]),
          null != o &&
            ((s += (a ? "&" : "?") + e[n] + "=" + encodeURIComponent(o)),
            (a = !0));
      return s;
    }),
    t.module("ui.router.util").provider("$urlMatcherFactory", c),
    (f.$inject = ["$urlMatcherFactoryProvider"]),
    t.module("ui.router.router").provider("$urlRouter", f),
    (h.$inject = [
      "$urlRouterProvider",
      "$urlMatcherFactoryProvider",
      "$locationProvider",
    ]),
    t.module("ui.router.state").value("$stateParams", {}).provider("$state", h),
    (p.$inject = []),
    t.module("ui.router.state").provider("$view", p),
    (v.$inject = [
      "$state",
      "$compile",
      "$controller",
    ...
    t.module("ui.router.state").directive("uiView", v),
    (m.$inject = ["$state"]),
    t.module("ui.router.state").directive("uiSref", m),
    (d.$inject = ["$stateProvider", "$urlRouterProvider"]),
