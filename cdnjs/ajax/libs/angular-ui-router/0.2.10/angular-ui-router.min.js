...
"undefined" != typeof module &&
  ...
  (function (a, b, c) {
    "use strict";
    function d(a, b) {
      return I(new (I(function () {}, { prototype: a }))(), b);
    }
    function e(a) {
      return (
    ...
    function l(a, b) {
      var d = 1,
        ...
        h = [],
        i = g,
        j = I(a.when(g), { $$promises: g, $$values: g });
    ...
    function p(a) {
      ...
      (this.rule = function (a) {
        ...
        (this.when = function (e, f) {
          var g,
            h = E(f);
          if ((E(e) && (e = a.compile(e)), !h && !D(f) && !G(f)))
    ...
    function q(a, e, f) {
        ...
        if (
          ...
          !b[y] &&
            ...
            a.when(b.url, [
              ...
              "$stateParams",
              function (a, c) {
                (v.$current.navigable == b && j(a, c)) ||
                  v.transitionTo(b, a, { location: !1 });
              },
            ]),
          x[c])
        )
      ...
      function q(a, b) {
        return E(a) && !C(b)
          ? z[a]
          : D(b) && E(a)
          ? (z[a] && !z.$delegates[a] && (z.$delegates[a] = z[a]),
            (z[a] = b),
            this)
          : this;
      }
      ...
      function s(a, e, g, m, n, q, r, s, x) {
        ...
        function A(a, c, d, f, h) {
          ...
          var l = [
            h.resolve.then(function (a) {
              h.globals = a;
            }),
          ];
          return (
            f && l.push(f),
            H(a.views, function (c, d) {
              var e = c.resolve && c.resolve !== a.resolve ? c.resolve : {};
              (e.$template = [
                function () {
                  return (
                    g.load(d, { view: c, locals: j, params: i, notify: !1 }) ||
                    ""
                  );
                },
              ]),
                l.push(
                  n.resolve(e, j, h.resolve, a).then(function (f) {
        ...
        var B = e.reject(new Error("transition superseded")),
          ...
          N = x.baseHref();
        return (
          (u.locals = { resolve: null, globals: { $stateParams: {} } }),
          (v = { params: {}, current: u.self, $current: u, transition: null }),
          (v.reload = function () {
          ...
          (v.go = function (a, b, c) {
            return this.transitionTo(
              a,
              b,
              I({ inherit: !0, relative: v.$current }, c)
            );
          }),
          (v.transitionTo = function (b, c, f) {
            ...
            if (!C(p)) {
              ...
              if (
                ((g = a.$broadcast("$stateNotFound", s, k.self, n)),
                g.defaultPrevented)
              )
                return z(), K;
              if (g.retry) {
                ...
                return (
                  w.then(
                    function () {
                      return w !== v.transition
                        ? B
                        : ((s.options.$retry = !0),
                          v.transitionTo(s.to, s.toParams, s.options));
                    },
                    function () {
                      return K;
                    }
            ...
            for (
              x = 0, D = E[x];
              D && D === o[x] && j(c, n, D.ownParams) && !f.reload;
              x++, D = E[x]
            )
              G = H[x] = D.locals;
            if (t(b, k, G, f))
              return (
                b.self.reloadOnSearch !== !1 && z(),
                (v.transition = null),
                e.when(v.current)
              );
            if (
              ((c = i(b.params, c || {})),
              f.notify &&
                ((g = a.$broadcast("$stateChangeStart", b.self, c, k.self, n)),
                g.defaultPrevented))
            )
              return z(), F;
            for (var N = e.when(G), O = x; O < E.length; O++, D = E[O])
              (G = H[O] = d(G)), (N = A(D, c, D === b, N, G));
            var P = (v.transition = N.then(
              function () {
                var d, e, g;
                if (v.transition !== P) return B;
                for (d = o.length - 1; d >= x; d--)
                  (g = o[d]),
                    g.self.onExit &&
                      m.invoke(g.self.onExit, g.self, g.locals.globals),
                    (g.locals = null);
                for (d = x; d < E.length; d++)
                  (e = E[d]),
                    (e.locals = H[d]),
                    e.self.onEnter &&
                      m.invoke(e.self.onEnter, e.self, e.locals.globals);
                if (v.transition !== P) return B;
                (v.$current = b),
                  (v.current = b.self),
                  (v.params = c),
                ...
                return (
                  f.location &&
                    h &&
                    (r.url(h.url.format(h.locals.globals.$stateParams)),
                    "replace" === f.location && r.replace()),
                  f.notify &&
                    a.$broadcast("$stateChangeSuccess", b.self, c, k.self, n),
                  (M = r.url()),
                  v.current
                );
              },
              function (d) {
                return v.transition !== P
                  ? B
                  : ((v.transition = null),
                    a.$broadcast("$stateChangeError", b.self, c, k.self, n, d),
                    z(),
                    e.reject(d));
              }
            ));
          ...
          (v.href = function (a, b, c) {
            c = I(
              { lossy: !0, inherit: !1, absolute: !1, relative: v.$current },
              c || {}
            );
            ...
            return (
              !f.html5Mode() && g && (g = "#" + f.hashPrefix() + g),
              "/" !== N &&
                (f.html5Mode()
                  ? (g = N.slice(0, -1) + g)
                  : c.absolute && (g = N.slice(1) + g)),
              c.absolute &&
                g &&
                (g =
                  r.protocol() +
        ...
        z = {
          ...
          data: function (a) {
            return (
              a.parent &&
                a.parent.data &&
                (a.data = a.self.data = I({}, a.parent.data, a.data)),
              a.data
            );
          },
          url: function (a) {
            ...
            if (E(b))
              return "^" == b.charAt(0)
                ? e.compile(b.substring(1))
                : (a.parent.navigable || u).url.concat(b);
          ...
          params: function (a) {
            ...
            if (a.url)
              throw new Error(
                "Both params and url specicified in state '" + a + "'"
              );
            return a.params;
          },
          views: function (a) {
            var b = {};
            return (
              H(C(a.views) ? a.views : { "": a }, function (c, d) {
            ...
            return function (c, e, h) {
              ...
              function j(f) {
                ...
                if (f || k !== n) {
                  ...
                  (n = a.$current.locals[r.data("$uiViewName")]),
                    (l = r),
                    (m = h),
      ...
      return {
        ...
        compile: function (d) {
          ...
          return function (d, f, g) {
            ...
            h.indexOf("@") < 0 && (h = h + "@" + (i ? i.state.name : "")),
              f.data("$uiViewName", h);
            var j = c.$current,
              k = j && j.locals[h];
            if (k) {
              f.data("$uiView", { name: h, state: k.$$state }),
                f.html(k.$template ? k.$template : e);
              var l = a(f.contents());
              if (k.$$controller) {
                k.$scope = d;
                var m = b(k.$$controller, k);
                k.$$controllerAs && (d[k.$$controllerAs] = m),
        ...
        link: function (e, f, g, h) {
          ...
          var q = function (b) {
            if ((b && (j = b), n)) {
              ...
              return (
                h && h.$$setStateInfo(i.state, j),
                c ? void (f[0][m] = c) : ((n = !1), !1)
              );
            }
          };
          i.paramExpr &&
    ...
    function B(a, b) {
      ...
      function h(a, b, d) {
        ...
        return (
          b.$on("$stateChangeStart", function (a, c, d, f) {
    ...
    b.module("ui.router.util", ["ng"]),
      ...
      (n.prototype.format = function (a) {
        ...
        for (d = 0; g > d; d++)
          (f = a[c[d]]),
            null != f && (i += encodeURIComponent(f)),
            (i += b[d + 1]);
        for (; h > d; d++)
          (f = a[c[d]]),
            null != f &&
              ((i += (e ? "&" : "?") + c[d] + "=" + encodeURIComponent(f)),
              (e = !0));
        return i;
      }),
      ...
      b.module("ui.router.state").provider("$uiViewScroll", s),
      (t.$inject = ["$state", "$injector", "$uiViewScroll"]),
      (u.$inject = ["$compile", "$controller", "$state"]),
      ...
      b
        .module("ui.router.state")
        .directive("uiSref", x)
        .directive("uiSrefActive", y),
      (z.$inject = ["$state"]),
      (A.$inject = ["$state"]),
      b
        .module("ui.router.state")
        .filter("isState", z)
        .filter("includedByState", A),
