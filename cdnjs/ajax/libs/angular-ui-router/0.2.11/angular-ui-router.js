  ...
  function UrlMatcher(pattern, config) {
    ...
    function $value(value) {
      ...
      return isDefined(value)
        ...
        : $UrlMatcherFactory.$$getDefaultValue(this);
    }
  ...
  UrlMatcher.prototype.format = function (values) {
    ...
    for (; /**/ i < nTotal; i++) {
      ...
      result +=
        ...
        param +
        "=" +
        (array ? value : encodeURIComponent(value));
      search = true;
    }
    return result;
  };
    ...
    function flushTypeQueue() {
      forEach(typeQueue, function (type) {
        if (UrlMatcher.prototype.$types[type.name]) {
          throw new Error(
            "A type named '" + type.name + "' has already been defined."
          );
        }
        var def = new Type(
          isInjectable(type.def) ? injector.invoke(type.def) : type.def
        );
  ...
  function $StateProvider($urlRouterProvider, $urlMatcherFactory) {
    ...
    function doesStateMatchGlob(glob) {
      ...
      if (globSegments[globSegments.length - 1] === "**") {
        segments.splice(
          segments.indexOf(globSegments[globSegments.length - 2]) + 1,
          Number.MAX_VALUE
        );
        segments.push("**");
      }
    ...
    function $get(
      ...
      $state.is = function is(stateOrName, params) {
        ...
        return isDefined(params) && params !== null
