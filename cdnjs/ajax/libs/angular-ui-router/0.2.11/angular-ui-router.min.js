  ...
  (function (a, b, c) {
      ...
      (this.study = function (g) {
        function k(a, c) {
          if (o[c] !== f) {
            if ((n.push(c), o[c] === d))
              throw (
                (n.splice(0, n.indexOf(c)),
                new Error("Cyclic dependency: " + n.join(" -> ")))
              );
            if (((o[c] = d), F(a)))
              m.push(
                c,
        ...
        return (
          ...
          function (d, f, g) {
            ...
            f.$$inheritedValues && e(r, f.$$inheritedValues),
              f.$$values
                ? ((t = e(r, f.$$values)),
                  (p.$$inheritedValues = f.$$values),
                  h())
                : (f.$$inheritedValues &&
                    (p.$$inheritedValues = f.$$inheritedValues),
                  J(q, f.$$promises),
                  f.then(h, k));
      ...
      (this.fromConfig = function (a, b, c) {
        ...
        (this.fromUrl = function (c, d) {
          return (
            ...
            null == c
              ? null
              : a.get(c, { cache: b }).then(function (a) {
                  return a.data;
                })
          );
        }),
    ...
    function n(a, d) {
      ...
      for (
        ...
        ((q = i[2] || i[3]),
        (r = i[4] || ("*" == i[1] ? ".*" : "[^/]*")),
        (s = a.substring(l, i.index)),
        (t = this.$types[r] || new o({ pattern: new RegExp(r) })),
        (u = h(q)),
        !(s.indexOf("?") >= 0));

      )
        (k += g(s, t.$subPattern(), D(u.value))),
          f(q, t, u),
          m.push(s),
          (l = j.lastIndex);
      s = a.substring(l);
      ...
      if (v >= 0) {
        ...
        (s = s.substring(0, v)),
          (this.sourcePath = a.substring(0, l + v)),
          I(w.substring(1).split(/[&?]/), function (a) {
            f(a, null, h(a));
          });
      } else (this.sourcePath = a), (this.sourceSearch = "");
      (k += g(s) + (d.strict === !1 ? "/?" : "") + "$"),
        m.push(s),
        (this.regexp = new RegExp(k, d.caseInsensitive ? "i" : c)),
        (this.prefix = m[0]);
    }
    function o(a) {
      J(this, a);
    ...
    function p() {
      ...
      function c() {
        I(h, function (a) {
          if (n.prototype.$types[a.name])
            throw new Error(
              "A type named '" + a.name + "' has already been defined."
            );
    ...
    function q(a, b) {
        ...
        return (
          k || l(),
          {
            ...
            update: function (a) {
              return a
                ? void (n = b.url())
                : void (b.url() !== n && (b.url(n), b.replace()));
            },
            push: function (a, c, d) {
      ...
      (this.rule = function (a) {
        ...
        (this.when = function (a, c) {
          var g,
            h = F(c);
          if ((F(a) && (a = b.compile(a)), !h && !E(c) && !H(c)))
        ...
        (this.$get = g),
        (g.$inject = ["$location", "$rootScope", "$injector", "$browser"]);
    }
    function r(a, e) {
      function f(a) {
        ...
        if (
          ...
          !b[x] &&
            ...
            a.when(b.url, [
              ...
              "$stateParams",
              function (a, c) {
                (u.$current.navigable == b && j(a, c)) ||
                  u.transitionTo(b, a, { location: !1 });
              },
            ]),
          w[c])
        )
      ...
      function o(a) {
        ...
        if (
          ("**" === b[0] && ((c = c.slice(c.indexOf(b[1]))), c.unshift("**")),
          "**" === b[b.length - 1] &&
            (c.splice(c.indexOf(b[b.length - 2]) + 1, Number.MAX_VALUE),
            c.push("**")),
          b.length != c.length)
        )
          return !1;
      ...
      function p(a, b) {
        return F(a) && !D(b)
          ? y[a]
          : E(b) && F(a)
          ? (y[a] && !y.$delegates[a] && (y.$delegates[a] = y[a]),
            (y[a] = b),
            this)
          : this;
      }
      ...
      function r(a, e, f, l, m, p, q) {
        function r(b, c, d, f) {
          ...
          return (
            h.then(
              function () {
                return h !== u.transition
                  ? y
                  : ((b.options.$retry = !0),
                    u.transitionTo(b.to, b.toParams, b.options));
              },
              function () {
                return A;
              }
        ...
        return (
          (t.locals = { resolve: null, globals: { $stateParams: {} } }),
          (u = { params: {}, current: t.self, $current: t, transition: null }),
          (u.reload = function () {
          ...
          (u.go = function (a, b, c) {
            return u.transitionTo(
              a,
              b,
              J({ inherit: !0, relative: u.$current }, c)
            );
          }),
          (u.transitionTo = function (b, c, f) {
            ...
            var E = b.path,
              ...
              I = [];
            if (!f.reload)
              for (; G && G === v[F] && j(c, o, G.ownParams); )
                (H = I[F] = G.locals), F++, (G = E[F]);
            if (s(b, n, H, f))
              return (
                b.self.reloadOnSearch !== !1 && q.update(),
                (u.transition = null),
                e.when(u.current)
              );
            if (
              ((c = k(g(b.params), c || {})),
              f.notify &&
                a.$broadcast("$stateChangeStart", b.self, c, n.self, o)
                  .defaultPrevented)
            )
              return q.update(), z;
            for (var L = e.when(H), M = F; M < E.length; M++, G = E[M])
              (H = I[M] = d(H)), (L = w(G, c, G === b, L, H));
            var N = (u.transition = L.then(
              function () {
                var d, e, g;
                if (u.transition !== N) return y;
                for (d = v.length - 1; d >= F; d--)
                  (g = v[d]),
                    g.self.onExit &&
                      l.invoke(g.self.onExit, g.self, g.locals.globals),
                    (g.locals = null);
                for (d = F; d < E.length; d++)
                  (e = E[d]),
                    (e.locals = I[d]),
                    e.self.onEnter &&
                      l.invoke(e.self.onEnter, e.self, e.locals.globals);
                return u.transition !== N
                  ? y
                  : ((u.$current = b),
                    (u.current = b.self),
                    (u.params = c),
                    ...
                    f.notify &&
                      a.$broadcast("$stateChangeSuccess", b.self, c, n.self, o),
                    q.update(!0),
                    u.current);
              },
              function (d) {
          ...
          (u.href = function (a, b, c) {
            c = J(
              { lossy: !0, inherit: !0, absolute: !1, relative: u.$current },
              c || {}
            );
            ...
            return e && e.url
              ? q.href(e.url, k(g(d.params), b || {}), { absolute: c.absolute })
              : null;
          }),
          (u.get = function (a, b) {
            if (0 === arguments.length)
              return g(v).map(function (a) {
                return v[a].self;
              });
            var c = h(a, b);
        ...
        y = {
          ...
          data: function (a) {
            return (
              a.parent &&
                a.parent.data &&
                (a.data = a.self.data = J({}, a.parent.data, a.data)),
              a.data
            );
          },
          url: function (a) {
            ...
            if (F(b))
              return "^" == b.charAt(0)
                ...
                : (a.parent.navigable || t).url.concat(b, c);
          ...
          views: function (a) {
            var b = {};
            return (
              I(D(a.views) ? a.views : { "": a }, function (c, d) {
        ...
        compile: function (d) {
          ...
          return function (d, f, g) {
            var h = c.$current,
              ...
              j = h && h.locals[i];
            if (j) {
              f.data("$uiView", { name: i, state: j.$$state }),
                f.html(j.$template ? j.$template : e);
              var k = a(f.contents());
              if (j.$$controller) {
                j.$scope = d;
                var l = b(j.$$controller, j);
                j.$$controllerAs && (d[j.$$controllerAs] = l),
                  f.data("$ngControllerController", l),
      ...
      return {
        ...
        controller: [
          ...
          function (d, e, f) {
            ...
            function h() {
              return "undefined" != typeof f.uiSrefActiveEq
                ? a.$current.self === k && i()
                : a.includes(k.name) && i();
            }
            function i() {
            ...
            var k, l, m;
            (m = c(f.uiSrefActiveEq || f.uiSrefActive || "", !1)(d)),
    ...
    b.module("ui.router.util", ["ng"]),
      ...
      (n.prototype.concat = function (a, b) {
      ...
      (n.prototype.exec = function (a, b) {
        ...
        for (d = 0; i > d; d++)
          (f = g[d]), (e = this.params[f]), (j[f] = e.$value(c[d + 1]));
        for (; h > d; d++)
          (f = g[d]), (e = this.params[f]), (j[f] = e.$value(b[f]));
        return j;
      }),
      ...
      (n.prototype.format = function (a) {
        ...
        for (d = 0; j > d; d++)
          (g = c[d]),
            ...
            (h = this.params[g]),
            (D(f) || ("/" !== b[d] && "/" !== b[d + 1])) &&
              (null != f && (l += encodeURIComponent(h.type.encode(f))),
              (l += b[d + 1]));
        for (; k > d; d++)
          (g = c[d]),
            (f = a[g]),
            null != f &&
              ((i = H(f)),
              i && (f = f.map(encodeURIComponent).join("&" + g + "=")),
              (l +=
                (e ? "&" : "?") + g + "=" + (i ? f : encodeURIComponent(f))),
              (e = !0));
        return l;
      }),
      (n.prototype.$types = {}),
      ...
      (o.prototype.pattern = /.*/),
      b.module("ui.router.util").provider("$urlMatcherFactory", p),
      (q.$inject = ["$locationProvider", "$urlMatcherFactoryProvider"]),
      b.module("ui.router.router").provider("$urlRouter", q),
      (r.$inject = ["$urlRouterProvider", "$urlMatcherFactoryProvider"]),
      b
        .module("ui.router.state")
        .value("$stateParams", {})
        .provider("$state", r),
      (s.$inject = []),
      b.module("ui.router.state").provider("$view", s),
      b.module("ui.router.state").provider("$uiViewScroll", t),
      (u.$inject = ["$state", "$injector", "$uiViewScroll"]),
      (v.$inject = ["$compile", "$controller", "$state"]),
      b.module("ui.router.state").directive("uiView", u),
      b.module("ui.router.state").directive("uiView", v),
      (z.$inject = ["$state", "$timeout"]),
      (A.$inject = ["$state", "$stateParams", "$interpolate"]),
      b
        .module("ui.router.state")
        .directive("uiSref", z)
        .directive("uiSrefActive", A)
        .directive("uiSrefActiveEq", A),
      (B.$inject = ["$state"]),
      (C.$inject = ["$state"]),
      b
        .module("ui.router.state")
        .filter("isState", B)
        .filter("includedByState", C);
