  ...
  (function (a, b, c) {
    ...
    function l(a, b) {
      var d = 1,
        ...
        h = [],
        i = g,
        j = E(a.when(g), { $$promises: g, $$values: g });
        ...
        return (
          ...
          (t.go = function (a, b, c) {
            return this.transitionTo(
              a,
              b,
              E({ inherit: !0, relative: t.$current }, c)
            );
          }),
          (t.transitionTo = function (b, c, f) {
            ...
            if (!y(z)) {
              ...
              if (
                ((g = a.$broadcast("$stateNotFound", C, k.self, n)),
                g.defaultPrevented)
              )
                return q(), B;
              if (g.retry) {
                ...
                return (
                  D.then(
                    function () {
                      return D !== t.transition
                        ? x
                        : ((C.options.$retry = !0),
                          t.transitionTo(C.to, C.toParams, C.options));
                    },
                    function () {
                      return B;
                    }
            ...
            for (
              I = 0, J = K[I];
              J && J === u[I] && j(c, n, J.ownParams) && !f.reload;
              I++, J = K[I]
            )
              L = M[I] = J.locals;
            if (r(b, k, L, f))
        ...
        x = {
          ...
          data: function (a) {
            return (
              a.parent &&
                a.parent.data &&
                (a.data = a.self.data = E({}, a.parent.data, a.data)),
              a.data
            );
          },
          url: function (a) {
          ...
          views: function (a) {
            var b = {};
            return (
              D(y(a.views) ? a.views : { "": a }, function (c, d) {
