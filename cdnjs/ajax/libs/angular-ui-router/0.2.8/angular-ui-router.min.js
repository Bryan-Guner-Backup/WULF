...
"undefined" != typeof module &&
  ...
  (function (a, b, c) {
    "use strict";
    function d(a, b) {
      return H(new (H(function () {}, { prototype: a }))(), b);
    }
    function e(a) {
      return (
    ...
    function q(a, e, f) {
        ...
        if (
          ...
          !b[w] &&
            ...
            a.when(b.url, [
              ...
              "$stateParams",
              function (a, c) {
                (t.$current.navigable == b && j(a, c)) ||
                  t.transitionTo(b, a, { location: !1 });
              },
            ]),
          v[c])
        )
      ...
      function o(a, b) {
        return D(a) && !B(b)
          ? x[a]
          : C(b) && D(a)
          ? (x[a] && !x.$delegates[a] && (x.$delegates[a] = x[a]),
            (x[a] = b),
            this)
          : this;
      }
      ...
      function q(a, e, g, m, n, o, p) {
        ...
        return (
          ...
          (t = { params: {}, current: s.self, $current: s, transition: null }),
          (t.reload = function () {
          ...
          (t.go = function (a, b, c) {
            return this.transitionTo(
              a,
              b,
              H({ inherit: !0, relative: t.$current }, c)
            );
          }),
          (t.transitionTo = function (b, c, f) {
            ...
            if (!B(C)) {
              ...
              if (
                ((g = a.$broadcast("$stateNotFound", E, k.self, n)),
                g.defaultPrevented)
              )
                return q(), z;
              if (g.retry) {
                ...
                return (
                  F.then(
                    function () {
                      return F !== t.transition
                        ? x
                        : ((E.options.$retry = !0),
                          t.transitionTo(E.to, E.toParams, E.options));
                    },
                    function () {
                      return z;
                    }
            ...
            for (
              G = 0, J = K[G];
              J && J === u[G] && j(c, n, J.ownParams) && !f.reload;
              G++, J = K[G]
            )
              L = M[G] = J.locals;
            if (r(b, k, L, f))
              return (
                b.self.reloadOnSearch !== !1 && q(),
                (t.transition = null),
                e.when(t.current)
              );
            if (
            ...
            var P = (t.transition = N.then(
              function () {
                ...
                return (
                  f.location &&
                    h &&
                    (p.url(h.url.format(h.locals.globals.$stateParams)),
                    "replace" === f.location && p.replace()),
                  f.notify &&
          ...
          (t.href = function (a, b, c) {
            c = H(
              { lossy: !0, inherit: !1, absolute: !1, relative: t.$current },
              c || {}
            );
        ...
        x = {
          ...
          data: function (a) {
            return (
              a.parent &&
                a.parent.data &&
                (a.data = a.self.data = H({}, a.parent.data, a.data)),
              a.data
            );
          },
          url: function (a) {
            ...
            if (D(b))
              return "^" == b.charAt(0)
                ...
                : (a.parent.navigable || s).url.concat(b);
          ...
          views: function (a) {
            var b = {};
            return (
              G(B(a.views) ? a.views : { "": a }, function (c, d) {
              ...
              function (g) {
                ...
                function q(h) {
                  ...
                  if (i !== t) {
                    p(),
                      (s = e.clone()),
                      s.html(i.$template ? i.$template : k),
                      y(!0).enter(s, o, m),
                      s.data("$uiView", z),
                      (t = i),
                      (z.state = i.$$state);
                    ...
                    j(r),
                      r.$emit("$viewContentLoaded"),
                      w && r.$eval(w),
                      (b.isDefined(x) && x && !g.$eval(x)) || f(s);
                  }
                }
                var r,
                  s,
                  t,
                  u = o.inheritedData("$uiView"),
                  v = h[n.name] || h.name || "",
                  w = h.onload || "",
                  x = h.autoscroll,
                  y = i(e, h, g);
                v.indexOf("@") < 0 && (v = v + "@" + (u ? u.state.name : ""));
                var z = { name: v, state: null },
                  A = function () {
                    if (!j) {
                      j = !0;
                      try {
                ...
                g.$on("$stateChangeSuccess", A),
                  g.$on("$viewContentLoading", A),
                  q(!1);
              }
            );
          },
    ...
    b.module("ui.router.util", ["ng"]),
      ...
      (x.$inject = ["$state", "$stateParams", "$interpolate"]),
      b
        .module("ui.router.state")
        .directive("uiSref", w)
        .directive("uiSrefActive", x),
      (y.$inject = ["$state"]),
      (z.$inject = ["$state"]),
      b
        .module("ui.router.state")
        .filter("isState", y)
        .filter("includedByState", z),
