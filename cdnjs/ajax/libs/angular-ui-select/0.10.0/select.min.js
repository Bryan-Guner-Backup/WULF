      ...
      function (t, c, i, l, s) {
        return {
          ...
          link: function (a, n, r, o, u) {
            ...
            (p.generatedId = c.generateId()),
              (p.baseTitle = r.title || "Select box"),
              (p.focusserTitle = p.baseTitle + " focus"),
              (p.focusserId = "focusser-" + p.generatedId),
              (p.multiple =
                ...
                if (p.multiple) {
                  for (var i = [], l = p.selected.length - 1; l >= 0; l--)
                    (c = {}),
                      ...
                      (t = p.parserResult.modelMapper(a, c)),
                      i.unshift(t);
                  return i;
                }
                return (
              ...
              g.$formatters.unshift(function (e) {
                var t,
                  c = p.parserResult.source(a, { $select: { search: "" } }),
                  i = {};
                if (c) {
                  if (p.multiple) {
                    var l = [],
                      s = function (e, c) {
                        ...
                        for (var s = e.length - 1; s >= 0; s--) {
                          if (
                            ...
                            (t = p.parserResult.modelMapper(a, i)),
                            p.parserResult.trackByExp)
                          ) {
                            var n = /\.(.+)/.exec(p.parserResult.trackByExp);
                            if (n.length > 0 && t[n[1]] == c[n[1]])
            ...
            r.tabindex &&
              r.$observe("tabindex", function (e) {
                p.multiple ? h.attr("tabindex", e) : f.attr("tabindex", e),
              ...
              p.multiple ||
                ...
                f.bind("keyup input", function (t) {
                  t.which === e.TAB ||
                    ...
                    t.which == e.ENTER ||
                    t.which === e.BACKSPACE ||
                    (p.activate(f.val()), f.val(""), a.$digest());
                })),
              a.$watch("searchEnabled", function () {
                var e = a.$eval(r.searchEnabled);
                p.searchEnabled = void 0 !== e ? e : c.searchEnabled;
              }),
              a.$watch("sortable", function () {
                var e = a.$eval(r.sortable);
                p.sortable = void 0 !== e ? e : c.sortable;
              }),
              ...
              p.multiple
                ? (a.$watchCollection(
                  ...
                  (p.firstPass = !0),
                  a.$watchCollection("$select.selected", function () {
                    p.firstPass
                      ? (p.firstPass = !1)
                      : g.$setViewValue(Date.now());
                  }),
                  f.prop("disabled", !0))
                : a.$watch("$select.selected", function (e) {
                    g.$viewValue !== e && g.$setViewValue(e);
                  }),
              (g.$render = function () {
                if (p.multiple && !angular.isArray(g.$viewValue)) {
                  if (
                    !angular.isUndefined(g.$viewValue) &&
                    null !== g.$viewValue
                  )
                    throw i(
                      "multiarr",
