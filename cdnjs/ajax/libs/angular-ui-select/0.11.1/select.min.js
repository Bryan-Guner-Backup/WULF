...
!(function () {
  ...
  c.service("RepeatParser", [
        ...
        return {
          ...
          compile: function (l, s) {
            ...
            return function (l, s, a, n, r) {
              var o = a.groupBy;
              if (
                (n.parseRepeatAttr(a.repeat, o),
                (n.disableChoiceExpression = a.uiDisableChoice),
                (n.onHighlightCallback = a.onHighlight),
                o)
              ) {
              ...
              d.attr(
                ...
                .attr(
                  "ng-mouseenter",
                  "$select.setActiveItem(" + n.parserResult.itemName + ")"
                )
                .attr(
                  "ng-click",
                  "$select.select(" + n.parserResult.itemName + ",false,$event)"
                );
              ...
              p.attr("uis-transclude-append", ""),
                i(s, r)(l),
                l.$watch("$select.search", function (e) {
                  e && !n.open && n.multiple && n.activate(!1, !0),
                    (n.activeIndex = n.tagging.isActivated ? -1 : 0),
                    n.refresh(a.refresh);
                }),
    ...
    c.controller("uiSelectCtrl", [
      ...
      "uiSelectMinErr",
      "uiSelectConfig",
      function (t, c, i, l, s, a, n) {
        function r() {
          (f.resetSearchInput ||
            (void 0 === f.resetSearchInput && n.resetSearchInput)) &&
            ((f.search = v),
            f.selected &&
              f.items.length &&
              !f.multiple &&
              (f.activeIndex = f.items.indexOf(f.selected)));
        }
        function o(t) {
          var c = !0;
          switch (t) {
            case e.DOWN:
              !f.open && f.multiple
                ? f.activate(!1, !0)
                : f.activeIndex < f.items.length - 1 && f.activeIndex++;
              break;
            case e.UP:
              !f.open && f.multiple
                ? f.activate(!1, !0)
            ...
            case e.TAB:
              ...
              break;
            case e.ENTER:
              f.open && f.activeIndex >= 0
                ? f.select(f.items[f.activeIndex])
                : f.activate(!1, !0);
              break;
            case e.ESC:
              f.close();
        ...
        function u(t) {
          function c() {
            switch (t) {
              ...
              case e.DELETE:
                return ~f.activeMatchIndex
                  ? (f.removeChoice(f.activeMatchIndex), n)
                  : !1;
            }
          }
          var i = g(m[0]),
            ...
            s = 0,
            a = l - 1,
            n = f.activeMatchIndex,
            r = f.activeMatchIndex + 1,
            o = f.activeMatchIndex - 1,
            u = n;
          return i > 0 || (f.search.length && t == e.RIGHT)
            ? !1
            : (f.close(),
              (u = c()),
              (f.activeMatchIndex =
                f.selected.length && u !== !1
                  ? Math.min(a, Math.max(s, u))
                  : -1),
              !0);
        }
        function d(e) {
          ...
          var t =
            e.filter(function (e) {
              return void 0 === f.search.toUpperCase() || void 0 === e
                ? !1
                : e.toUpperCase() === f.search.toUpperCase();
            }).length > 0;
          return t;
        }
        function p(e, t) {
          ...
          if (angular.isArray(e))
            for (var i = angular.copy(e), l = 0; l < i.length; l++)
              if (void 0 === f.tagging.fct)
                i[l] + " " + f.taggingLabel === t && (c = l);
              else {
                var s = i[l];
        ...
        function h() {
          ...
          if (!(f.activeIndex < 0)) {
            var i = t[f.activeIndex],
              l = i.offsetTop + i.clientHeight - e[0].scrollTop,
              s = e[0].offsetHeight;
            l > s
              ? (e[0].scrollTop += l - s)
              : l < i.clientHeight &&
                (f.isGrouped && 0 === f.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= i.clientHeight - l));
          }
        }
        var f = this,
          v = "";
        (f.placeholder = n.placeholder),
          ...
          (f.focusser = void 0),
          (f.disabled = !1),
          (f.searchEnabled = n.searchEnabled),
          (f.sortable = n.sortable),
          (f.resetSearchInput = !0),
          (f.multiple = void 0),
          (f.refreshDelay = n.refreshDelay),
          (f.disableChoiceExpression = void 0),
          (f.tagging = { isActivated: !1, fct: void 0 }),
          (f.taggingTokens = { isActivated: !1, tokens: void 0 }),
          (f.lockChoiceExpression = void 0),
          (f.closeOnSelect = !0),
          (f.clickTriggeredSelect = !1),
          (f.$filter = l),
          (f.isEmpty = function () {
            return (
              angular.isUndefined(f.selected) ||
              null === f.selected ||
              "" === f.selected
            );
          });
        ...
        (f.activate = function (e, t) {
          f.disabled ||
            f.open ||
            (t || r(),
            f.focusser.prop("disabled", !0),
            (f.open = !0),
            (f.activeMatchIndex = -1),
            (f.activeIndex =
              f.activeIndex >= f.items.length ? 0 : f.activeIndex),
            -1 === f.activeIndex &&
              f.taggingLabel !== !1 &&
              (f.activeIndex = 0),
            i(function () {
          ...
          (f.parseRepeatAttr = function (e, c) {
            function i(e) {
              (f.groups = []),
                angular.forEach(e, function (e) {
                  var i = t.$eval(c),
                    l = angular.isFunction(i) ? i(e) : e[i],
                    s = f.findGroupByName(l);
            ...
            var n = c ? i : l;
            (f.parserResult = s.parse(e)),
              (f.isGrouped = !!c),
              (f.itemProperty = f.parserResult.itemName),
              t.$watchCollection(f.parserResult.source, function (e) {
        ...
        (f.refresh = function (e) {
          ...
          (f.isActive = function (e) {
            ...
            var t = f.items.indexOf(e[f.itemProperty]),
              c = t === f.activeIndex;
            return !c ||
              (0 > t && f.taggingLabel !== !1) ||
              (0 > t && f.taggingLabel === !1)
              ? !1
              : (c &&
                  !angular.isUndefined(f.onHighlightCallback) &&
                  e.$eval(f.onHighlightCallback),
                c);
          }),
          (f.isDisabled = function (e) {
            if (f.open) {
              var t,
                c = f.items.indexOf(e[f.itemProperty]),
                i = !1;
              return (
                c >= 0 &&
                  !angular.isUndefined(f.disableChoiceExpression) &&
                  ((t = f.items[c]),
                  (i = !!e.$eval(f.disableChoiceExpression)),
                  (t._uiSelectChoiceDisabled = i)),
                i
              );
            }
          }),
                ...
                if (f.tagging.isActivated) {
                  if (f.taggingLabel === !1)
                    if (f.activeIndex < 0) {
                      if (
                        ((e =
                          void 0 !== f.tagging.fct
                            ? f.tagging.fct(f.search)
                            : f.search),
                        !e || angular.equals(f.items[0], e))
                      )
                        return;
                    ...
                    if (void 0 !== f.tagging.fct && "string" == typeof e) {
                      ...
                      "string" == typeof e &&
                        (e = e.replace(f.taggingLabel, "").trim());
                  }
                  if (
                    f.selected &&
                    angular.isArray(f.selected) &&
                    f.selected.filter(function (t) {
                      return angular.equals(t, e);
                    }).length > 0
                  )
                    return f.close(c), void 0;
                }
                var s = {};
                (s[f.parserResult.itemName] = e),
                  f.multiple
                    ? (f.selected.push(e), f.sizeSearchInput())
                    : (f.selected = e),
                  i(function () {
                    f.onSelectCallback(t, {
                      $item: e,
                      $model: f.parserResult.modelMapper(t, s),
                    });
                  }),
                  (!f.multiple || f.closeOnSelect) && f.close(c),
                  l && "click" === l.type && (f.clickTriggeredSelect = !0);
              }
            }
          }),
          (f.close = function (e) {
            f.open &&
              (f.ngModel && f.ngModel.$setTouched && f.ngModel.$setTouched(),
              r(),
              (f.open = !1),
              f.multiple ||
                i(
          ...
          (f.setFocus = function () {
            f.focus || f.multiple || f.focusser[0].focus(),
              !f.focus && f.multiple && m[0].focus();
          }),
          (f.clear = function (e) {
          ...
          (f.isLocked = function (e, t) {
            ...
            return (
              i &&
                !angular.isUndefined(f.lockChoiceExpression) &&
                ((c = !!e.$eval(f.lockChoiceExpression)),
                (i._uiSelectChoiceLocked = c)),
              c
            );
          }),
          (f.removeChoice = function (e) {
            ...
            if (!c._uiSelectChoiceLocked) {
              var l = {};
              (l[f.parserResult.itemName] = c),
                f.selected.splice(e, 1),
                (f.activeMatchIndex = -1),
                f.sizeSearchInput(),
                i(function () {
                  f.onRemoveCallback(t, {
                    $item: c,
        ...
        (f.sizeSearchInput = function () {
          var e = m[0],
            ...
            s = function (t) {
              ...
              return 50 > c && (c = t), m.css("width", c + "px"), !0;
            };
          m.css("width", "10px"),
            i(function () {
              null !== b ||
                s(l()) ||
                (b = t.$watch(l, function (e) {
                  s(e) && (b(), (b = null));
                }));
            });
        }),
          m.on("keydown", function (c) {
            ...
            t.$apply(function () {
              var t = !1,
                s = !1;
              if (
                (f.multiple && e.isHorizontalMovement(l) && (t = u(l)),
                !t &&
                  (f.items.length > 0 || f.tagging.isActivated) &&
                  ((t = o(l)), f.taggingTokens.isActivated))
              ) {
                for (var a = 0; a < f.taggingTokens.tokens.length; a++)
                  f.taggingTokens.tokens[a] === e.MAP[c.keyCode] &&
                    f.search.length > 0 &&
                    (s = !0);
                s &&
                  i(function () {
                    ...
                    f.tagging.fct && (t = f.tagging.fct(t)),
                      t && f.select(t, !0);
                  });
              }
          ...
          m.on("keyup", function (c) {
            if (
              ...
              var i,
                ...
                s,
                a,
                n = angular.copy(f.items),
                r = angular.copy(f.items),
                o = !1,
                u = -1;
              if (void 0 !== f.tagging.fct) {
                if (
                  ((s = f.$filter("filter")(n, { isTag: !0 })),
                  s.length > 0 && (a = s[0]),
                  n.length > 0 &&
                    a &&
                    ((o = !0),
                ...
                if (
                  ((s = f.$filter("filter")(n, function (e) {
                  ...
                  void 0 !== l &&
                    ...
                    (n = n.slice(1, n.length)),
                    (r = r.slice(1, r.length))),
                  (i = f.search + " " + f.taggingLabel),
                  p(f.selected, f.search) > -1)
                )
                  return;
                if (d(r.concat(f.selected)))
                  return (
                    o &&
                      ((n = r),
                      t.$evalAsync(function () {
              ...
              o && (u = p(f.selected, i)),
                u > -1
                  ? (n = n.slice(u + 1, n.length - 1))
                  : ((n = []), n.push(i), (n = n.concat(r))),
                t.$evalAsync(function () {
                  (f.activeIndex = 0), (f.items = n);
                });
            }
    ...
    c.directive("uiSelect", [
      ...
      function (t, c, i, l, s, a) {
        return {
          ...
          controllerAs: "$select",
          link: function (n, r, o, u, d) {
            function p(e) {
              if (g.open) {
                var t = !1;
                if (
                  ((t = window.jQuery
                    ? window.jQuery.contains(r[0], e.target)
                  ...
                  l || (l = ~c.indexOf(e.target.tagName.toLowerCase())),
                    g.close(l),
                    n.$digest();
                }
            ...
            var g = u[0],
              h = u[1],
              f = r.querySelectorAll("input.ui-select-search");
            (g.generatedId = c.generateId()),
              (g.baseTitle = o.title || "Select box"),
              (g.focusserTitle = g.baseTitle + " focus"),
              (g.focusserId = "focusser-" + g.generatedId),
              (g.multiple =
                angular.isDefined(o.multiple) &&
                ("" === o.multiple ||
                  "multiple" === o.multiple.toLowerCase() ||
                  "true" === o.multiple.toLowerCase())),
              (g.closeOnSelect = (function () {
                return angular.isDefined(o.closeOnSelect)
                  ? s(o.closeOnSelect)()
                  : c.closeOnSelect;
              })()),
              (g.onSelectCallback = s(o.onSelect)),
              (g.onRemoveCallback = s(o.onRemove)),
              h.$parsers.unshift(function (e) {
                var t,
                  c = {};
                if (g.multiple) {
                  for (var i = [], l = g.selected.length - 1; l >= 0; l--)
                    (c = {}),
                      (c[g.parserResult.itemName] = g.selected[l]),
                      (t = g.parserResult.modelMapper(n, c)),
                      i.unshift(t);
                  return i;
                }
                return (
                  (c = {}),
                  (c[g.parserResult.itemName] = e),
                  (t = g.parserResult.modelMapper(n, c))
                );
              }),
              h.$formatters.unshift(function (e) {
                var t,
                  c = g.parserResult.source(n, { $select: { search: "" } }),
                  i = {};
                if (c) {
                  if (g.multiple) {
                    var l = [],
                      s = function (e, c) {
                        ...
                        for (var s = e.length - 1; s >= 0; s--) {
                          if (
                            ((i[g.parserResult.itemName] = e[s]),
                            (t = g.parserResult.modelMapper(n, i)),
                            g.parserResult.trackByExp)
                          ) {
                            var a = /\.(.+)/.exec(g.parserResult.trackByExp);
                            if (a.length > 0 && t[a[1]] == c[a[1]])
                              return l.unshift(e[s]), !0;
                          }
                    ...
                    for (var a = e.length - 1; a >= 0; a--)
                      s(g.selected, e[a]) || s(c, e[a]);
                    return l;
                  }
                  var r = function (c) {
                    return (
                      (i[g.parserResult.itemName] = c),
                      (t = g.parserResult.modelMapper(n, i)),
                      t == e
                    );
                  };
                  if (g.selected && r(g.selected)) return g.selected;
            ...
            o.tabindex &&
              o.$observe("tabindex", function (e) {
                g.multiple ? f.attr("tabindex", e) : v.attr("tabindex", e),
              ...
              g.multiple ||
                ...
                v.bind("keyup input", function (t) {
                  t.which === e.TAB ||
                    ...
                    t.which == e.ENTER ||
                    t.which === e.BACKSPACE ||
                    (g.activate(v.val()), v.val(""), n.$digest());
                })),
              n.$watch("searchEnabled", function () {
                var e = n.$eval(o.searchEnabled);
                g.searchEnabled = void 0 !== e ? e : c.searchEnabled;
              }),
              n.$watch("sortable", function () {
                var e = n.$eval(o.sortable);
                g.sortable = void 0 !== e ? e : c.sortable;
              }),
              o.$observe("disabled", function () {
                (g.disabled = void 0 !== o.disabled ? o.disabled : !1),
                  g.sizeSearchInput();
              }),
              o.$observe("resetSearchInput", function () {
                var e = n.$eval(o.resetSearchInput);
                g.resetSearchInput = void 0 !== e ? e : !0;
              }),
              o.$observe("tagging", function () {
                if (void 0 !== o.tagging) {
                  var e = n.$eval(o.tagging);
                  g.tagging = { isActivated: !0, fct: e !== !0 ? e : void 0 };
                } else g.tagging = { isActivated: !1, fct: void 0 };
              }),
              o.$observe("taggingLabel", function () {
                void 0 !== o.tagging &&
                  (g.taggingLabel =
                    "false" === o.taggingLabel
                      ? !1
                      : void 0 !== o.taggingLabel
                      ? o.taggingLabel
                      : "(new)");
              }),
              o.$observe("taggingTokens", function () {
                if (void 0 !== o.tagging) {
                  var e =
                    void 0 !== o.taggingTokens
                      ? o.taggingTokens.split("|")
                      : [",", "ENTER"];
                  g.taggingTokens = { isActivated: !0, tokens: e };
                }
              }),
              angular.isDefined(o.autofocus) &&
                a(function () {
                  g.setFocus();
                }),
              angular.isDefined(o.focusOn) &&
                n.$on(o.focusOn, function () {
                  a(function () {
                    g.setFocus();
                  });
                }),
              g.multiple
                ? (n.$watchCollection(
                  ...
                  v.prop("disabled", !0))
                : n.$watch("$select.selected", function (e) {
                    h.$viewValue !== e && h.$setViewValue(e);
                  }),
              (h.$render = function () {
                if (g.multiple && !angular.isArray(h.$viewValue)) {
                  if (
                    !angular.isUndefined(h.$viewValue) &&
                    null !== h.$viewValue
                  )
                    throw i(
                      "multiarr",
              ...
              d(n, function (e) {
                ...
                r.querySelectorAll(".ui-select-match").replaceWith(c);
                var l = t.querySelectorAll(".ui-select-choices");
                if (
                  (l.removeAttr("ui-select-choices"),
                  l.removeAttr("data-ui-select-choices"),
                  1 !== l.length)
                )
                  throw i(
                    "transcluded",
                ...
                r.querySelectorAll(".ui-select-choices").replaceWith(l);
              });
          },
        };
      },
    ]),
    c.directive("uiSelectMatch", [
      "uiSelectConfig",
      function (e) {
        return {
          restrict: "EA",
          ...
          link: function (t, c, i, l) {
            (l.lockChoiceExpression = i.uiLockChoice),
              i.$observe("placeholder", function (t) {
                l.placeholder = void 0 !== t ? t : e.placeholder;
              }),
              (l.allowClear = angular.isDefined(i.allowClear)
                ? "" === i.allowClear
                  ? !0
                  : "true" === i.allowClear.toLowerCase()
                : !1),
    ...
    c.directive("uiSelectSort", [
      ...
      function (e, t, c) {
        return {
          require: "^uiSelect",
          link: function (t, i, l, s) {
            if (null === t[l.uiSelectSort])
              throw c("sort", "Expected a list to sort");
            ...
            var p,
              ...
              h = function (e) {
                ...
                t < this["vertical" === n ? "offsetHeight" : "offsetWidth"] / 2
                  ? (i.removeClass(d), i.addClass(u))
                  : (i.removeClass(u), i.addClass(d));
              },
              f = function (t) {
                t.preventDefault();
                var c = parseInt(
            ...
            i.on("dragenter", function () {
              i.hasClass(r) ||
                (i.addClass(o), i.on("dragover", h), i.on("drop", f));
            }),
