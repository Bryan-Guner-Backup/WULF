  ...
  c.directive("uiSelectChoices", [
        ...
        compile: function (s, l) {
          ...
          return function (s, l, n, a, r) {
            ...
            p.attr("uis-transclude-append", ""),
              i(l, r)(s),
              s.$watch("$select.search", function (e) {
    ...
    c.controller("uiSelectCtrl", [
      ...
      function (t, c, i, s, l, n, a) {
        function r() {
          (d.resetSearchInput ||
            (void 0 === d.resetSearchInput && a.resetSearchInput)) &&
            ((d.search = p),
            d.selected &&
              d.items.length &&
              !d.multiple &&
        ...
        function o(t) {
          ...
          switch (t) {
            ...
            case e.TAB:
              ...
              break;
            case e.ENTER:
              d.open && d.activeIndex >= 0
                ? d.select(d.items[d.activeIndex])
                : d.activate(!1, !0);
              break;
            case e.ESC:
              d.close();
            ...
            s > l
              ...
              : s < i.clientHeight &&
                (d.isGrouped && 0 === d.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= i.clientHeight - s));
          }
        }
        var d = this,
          p = "";
        if (
          ...
          (d.searchEnabled = a.searchEnabled),
          (d.sortable = a.sortable),
          (d.refreshDelay = a.refreshDelay),
          (d.removeSelected = !1),
          (d.closeOnSelect = !0),
          (d.search = p),
          (d.activeIndex = 0),
          ...
          (d.selected = void 0),
          (d.focusser = void 0),
          (d.resetSearchInput = !0),
          (d.multiple = void 0),
          (d.disableChoiceExpression = void 0),
          (d.tagging = { isActivated: !1, fct: void 0 }),
          (d.taggingTokens = { isActivated: !1, tokens: void 0 }),
          (d.lockChoiceExpression = void 0),
          (d.clickTriggeredSelect = !1),
          (d.$filter = s),
          (d.searchInput = c.querySelectorAll("input.ui-select-search")),
          1 !== d.searchInput.length)
        )
          throw n(
            "searchInput",
            "Expected 1 input.ui-select-search but got '{0}'.",
            d.searchInput.length
          );
        (d.isEmpty = function () {
          return (
          ...
          (d.parseRepeatAttr = function (e, c) {
            ...
            (d.setItemsFn = c ? i : s),
              ...
              (d.refreshItems = function (e) {
                e = e || d.parserResult.source(t);
                var c = d.selected;
                if ((angular.isArray(c) && !c.length) || !d.removeSelected)
                  d.setItemsFn(e);
                else if (void 0 !== e) {
        ...
        (d.refresh = function (e) {
          ...
          (d.isActive = function (e) {
            ...
            var t = d.items.indexOf(e[d.itemProperty]),
              c = t === d.activeIndex;
            return !c ||
              (0 > t && d.taggingLabel !== !1) ||
              (0 > t && d.taggingLabel === !1)
              ? !1
              : (c &&
                  !angular.isUndefined(d.onHighlightCallback) &&
                  e.$eval(d.onHighlightCallback),
                c);
          }),
            ...
            if (d.open) {
              ...
              return (
                c >= 0 &&
                  ...
                  ((t = d.items[c]),
                  (i = !!e.$eval(d.disableChoiceExpression)),
                ...
                if (d.tagging.isActivated) {
                  if (d.taggingLabel === !1)
                    if (d.activeIndex < 0) {
                      if (
                        ((e =
                          void 0 !== d.tagging.fct
                            ? d.tagging.fct(d.search)
                            : d.search),
                        !e || angular.equals(d.items[0], e))
                      )
                        return;
                    ...
                    if (void 0 !== d.tagging.fct && "string" == typeof e) {
                      ...
                      "string" == typeof e &&
                        (e = e.replace(d.taggingLabel, "").trim());
                  }
                  if (
                    d.selected &&
                    angular.isArray(d.selected) &&
                    d.selected.filter(function (t) {
                      return angular.equals(t, e);
                    }).length > 0
                  )
                    return d.close(c), void 0;
                }
                t.$broadcast("uis:select", e);
                var l = {};
                (l[d.parserResult.itemName] = e),
                  i(function () {
                  ...
                  d.closeOnSelect && d.close(c),
                  s && "click" === s.type && (d.clickTriggeredSelect = !0);
              }
            }
          }),
          (d.close = function (e) {
            d.open &&
              (d.ngModel && d.ngModel.$setTouched && d.ngModel.$setTouched(),
              r(),
              (d.open = !1),
          ...
          (d.toggle = function (e) {
            d.open
              ? (d.close(), e.preventDefault(), e.stopPropagation())
              : d.activate();
          }),
          (d.isLocked = function (e, t) {
            ...
            return (
              i &&
                !angular.isUndefined(d.lockChoiceExpression) &&
                ((c = !!e.$eval(d.lockChoiceExpression)),
        ...
        (d.sizeSearchInput = function () {
          var e = d.searchInput[0],
            ...
            l = function (t) {
              ...
              return (
                50 > c && (c = t), d.searchInput.css("width", c + "px"), !0
              );
            };
          d.searchInput.css("width", "10px"),
            i(function () {
              null !== g ||
                l(s()) ||
                (g = t.$watch(s, function (e) {
                  l(e) && (g(), (g = null));
                }));
            });
        }),
          d.searchInput.on("keydown", function (c) {
            ...
            t.$apply(function () {
              var t = !1;
              if (
                (d.items.length > 0 || d.tagging.isActivated) &&
                (o(s), d.taggingTokens.isActivated)
              ) {
                for (var l = 0; l < d.taggingTokens.tokens.length; l++)
                  d.taggingTokens.tokens[l] === e.MAP[c.keyCode] &&
                    d.search.length > 0 &&
                    (t = !0);
                t &&
                  i(function () {
                    ...
                    d.tagging.fct && (t = d.tagging.fct(t)),
                      t && d.select(t, !0);
                  });
              }
            }),
              ...
              function (s, a, r, o, u) {
                ...
                (g.generatedId = t.generateId()),
                  ...
                  u(s, function (e) {
                    ...
                    if (
                      (i.removeAttr("ui-select-match"),
                      i.removeAttr("data-ui-select-match"),
                      1 !== i.length)
                    )
                      throw c(
                        "transcluded",
          ...
          controller: [
            ...
            function (e, t) {
              ...
              e.$evalAsync(function () {
                ...
                (i.activeMatchIndex = -1),
                (i.updateModel = function () {
          ...
          link: function (i, s, l, n) {
            ...
            function r(t) {
              ...
              var i = a(d.searchInput[0]),
                ...
                p = r;
              return i > 0 || (d.search.length && t == e.RIGHT)
                ? !1
                : (d.close(),
                  (p = c()),
                  (h.activeMatchIndex =
                    d.selected.length && p !== !1
                      ? Math.min(n, Math.max(l, p))
                      : -1),
                  !0);
            }
            function o(e) {
            ...
            (d.multiple = !0),
              ...
              p.$parsers.unshift(function () {
                for (
                  var e, t = {}, c = [], s = d.selected.length - 1;
                  s >= 0;
                  s--
                )
                  (t = {}),
                    (t[d.parserResult.itemName] = d.selected[s]),
                    (e = d.parserResult.modelMapper(i, t)),
                    c.unshift(e);
                return c;
              }),
              p.$formatters.unshift(function (e) {
                var t,
                  c = d.parserResult.source(i, { $select: { search: "" } }),
                  s = {};
                if (!c) return e;
                var l = [],
                  n = function (e, c) {
                    if (e && e.length) {
                      for (var n = e.length - 1; n >= 0; n--) {
                        if (
                          ...
                          (t = d.parserResult.modelMapper(i, s)),
                ...
                for (var a = e.length - 1; a >= 0; a--)
                  n(d.selected, e[a]) || n(c, e[a]) || l.unshift(e[a]);
                return l;
              }),
              i.$watchCollection(
                function () {
              ...
              d.searchInput.on("keydown", function (t) {
                ...
                i.$apply(function () {
                  var i = !1;
                  e.isHorizontalMovement(c) && (i = r(c)),
                    i &&
                      c != e.TAB &&
              ...
              d.searchInput.on("keyup", function (t) {
                if (
                  ...
                  if (void 0 !== d.tagging.fct) {
                    ...
                    if (o(r))
                      return p && (d.items = r.slice(1, r.length)), void 0;
                  }
                  p && (h = u(d.selected, c)),
                    h > -1
                      ? (a = a.slice(h + 1, a.length - 1))
                      : ((a = []), a.push(c), (a = a.concat(r))),
                    i.$evalAsync(function () {
                      (d.activeIndex = 0), (d.items = a);
                    });
                }
          ...
          link: function (i, s, l, n) {
            ...
            r.$parsers.unshift(function (e) {
              ...
              return (
                ...
                (t = a.parserResult.modelMapper(i, c))
              );
            }),
              r.$formatters.unshift(function (e) {
                var t,
                  c = a.parserResult.source(i, { $select: { search: "" } }),
                  s = {};
                if (c) {
                  var l = function (c) {
                    return (
                      (s[a.parserResult.itemName] = c),
                      (t = a.parserResult.modelMapper(i, s)),
                      t == e
                    );
                  };
            ...
            c(o)(i),
              ...
              o.bind("keyup input", function (t) {
                t.which === e.TAB ||
                  ...
                  t.which == e.ENTER ||
                  t.which === e.BACKSPACE ||
                  (a.activate(o.val()), o.val(""), i.$digest());
              });
          },
        };
      },
          ...
          link: function (t, i, s, l) {
            ...
            var p,
              ...
              g = function (e) {
                ...
                t < this["vertical" === a ? "offsetHeight" : "offsetWidth"] / 2
            ...
            i.on("dragenter", function () {
              i.hasClass(r) ||
                (i.addClass(o), i.on("dragover", g), i.on("drop", f));
            }),
