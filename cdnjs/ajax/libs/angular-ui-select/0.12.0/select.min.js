...
!(function () {
  ...
  i.directive("uiSelectChoices", [
        ...
        compile: function (l, s) {
          ...
          return function (l, s, n, a, r) {
            var o = n.groupBy,
              u = n.groupFilter;
            if (
              (a.parseRepeatAttr(n.repeat, o, u),
    ...
    i.controller("uiSelectCtrl", [
      ...
      "uiSelectMinErr",
      "uiSelectConfig",
      function (t, i, c, l, s, n, a) {
        function r() {
          (p.resetSearchInput ||
            (void 0 === p.resetSearchInput && a.resetSearchInput)) &&
            ((p.search = g),
            p.selected &&
              p.items.length &&
              !p.multiple &&
        ...
        function u(t) {
          ...
          switch (t) {
            ...
            case e.TAB:
              ...
              break;
            case e.ENTER:
              p.open && (p.tagging.isActivated || p.activeIndex >= 0)
                ? p.select(p.items[p.activeIndex])
                : p.activate(!1, !0);
              break;
            case e.ESC:
              p.close();
            ...
            l > s
              ...
              : l < c.clientHeight &&
                (p.isGrouped && 0 === p.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= c.clientHeight - l));
          }
        }
        var p = this,
          g = "";
        if (
          ((p.placeholder = a.placeholder),
          (p.searchEnabled = a.searchEnabled),
          (p.sortable = a.sortable),
          (p.refreshDelay = a.refreshDelay),
          (p.removeSelected = !1),
          (p.closeOnSelect = !0),
          (p.search = g),
          (p.activeIndex = 0),
          ...
          (p.$filter = l),
          (p.searchInput = i.querySelectorAll("input.ui-select-search")),
        ...
        (p.isEmpty = function () {
          ...
          (p.parseRepeatAttr = function (e, i, c) {
            function l(e) {
              ...
              if (
                ...
                angular.isFunction(s)
                  ? (p.groups = s(p.groups))
                  : angular.isArray(s) && (p.groups = o(p.groups, s));
              }
              (p.items = []),
            ...
            (p.setItemsFn = i ? l : a),
              (p.parserResult = s.parse(e)),
              (p.isGrouped = !!i),
              (p.itemProperty = p.parserResult.itemName),
              (p.refreshItems = function (e) {
                e = e || p.parserResult.source(t);
                var i = p.selected;
                if ((angular.isArray(i) && !i.length) || !p.removeSelected)
                  p.setItemsFn(e);
                else if (void 0 !== e) {
        ...
        (p.refresh = function (e) {
          ...
          (p.isActive = function (e) {
            ...
            var t = p.items.indexOf(e[p.itemProperty]),
              i = t === p.activeIndex;
            return !i ||
              (0 > t && p.taggingLabel !== !1) ||
              (0 > t && p.taggingLabel === !1)
              ? !1
              : (i &&
                  !angular.isUndefined(p.onHighlightCallback) &&
                  e.$eval(p.onHighlightCallback),
                i);
          }),
          (p.isDisabled = function (e) {
            if (p.open) {
              var t,
                i = p.items.indexOf(e[p.itemProperty]),
                c = !1;
              return (
                i >= 0 &&
                  !angular.isUndefined(p.disableChoiceExpression) &&
                  ((t = p.items[i]),
                  (c = !!e.$eval(p.disableChoiceExpression)),
            ...
            if (void 0 === e || !e._uiSelectChoiceDisabled) {
              ...
              if (!e || !e._uiSelectChoiceDisabled) {
                if (p.tagging.isActivated) {
                  if (p.taggingLabel === !1)
                    ...
                    if (void 0 !== p.tagging.fct && "string" == typeof e) {
                      ...
                      "string" == typeof e &&
                        (e = e.replace(p.taggingLabel, "").trim());
                  }
                  if (
                    p.selected &&
                    angular.isArray(p.selected) &&
                    p.selected.filter(function (t) {
                      return angular.equals(t, e);
                    }).length > 0
                  )
                    return p.close(i), void 0;
                }
                ...
                (s[p.parserResult.itemName] = e),
                  ...
                  p.closeOnSelect && p.close(i),
                  l && "click" === l.type && (p.clickTriggeredSelect = !0);
              }
            }
          }),
          (p.close = function (e) {
            p.open &&
              (p.ngModel && p.ngModel.$setTouched && p.ngModel.$setTouched(),
              r(),
              (p.open = !1),
          ...
          (p.toggle = function (e) {
            p.open
              ? (p.close(), e.preventDefault(), e.stopPropagation())
              : p.activate();
          }),
          (p.isLocked = function (e, t) {
            ...
            return (
              c &&
                !angular.isUndefined(p.lockChoiceExpression) &&
        ...
        (p.sizeSearchInput = function () {
          var e = p.searchInput[0],
            ...
            s = function (t) {
              ...
              return (
                50 > i && (i = t), p.searchInput.css("width", i + "px"), !0
              );
            };
          p.searchInput.css("width", "10px"),
            c(function () {
              null !== f ||
                s(l()) ||
                (f = t.$watch(l, function (e) {
                  s(e) && (f(), (f = null));
                }));
            });
        }),
          p.searchInput.on("keydown", function (i) {
            ...
            t.$apply(function () {
              ...
              if (
                ...
                (u(l), p.taggingTokens.isActivated)
              ) {
                for (var s = 0; s < p.taggingTokens.tokens.length; s++)
                  p.taggingTokens.tokens[s] === e.MAP[i.keyCode] &&
                    p.search.length > 0 &&
                    (t = !0);
                t &&
                  c(function () {
                    ...
                    p.tagging.fct && (t = p.tagging.fct(t)),
                      t && p.select(t, !0);
                  });
              }
            }),
              e.isVerticalMovement(l) && p.items.length > 0 && d(),
              (l === e.ENTER || l === e.ESC) &&
          ...
          compile: function (l, a) {
            return (
              angular.isDefined(a.multiple)
                ? l.append("<ui-select-multiple/>").removeAttr("multiple")
                : l.append("<ui-select-single/>"),
              function (l, a, r, o, u) {
                function d(e) {
                  if (h.open) {
                    var t = !1;
                ...
                (h.generatedId = t.generateId()),
                  (h.baseTitle = r.title || "Select box"),
                  (h.focusserTitle = h.baseTitle + " focus"),
                  (h.focusserId = "focusser-" + h.generatedId),
                  (h.closeOnSelect = (function () {
                ...
                (void 0 !== v ? v : t.appendToBody) &&
                  (l.$watch("$select.open", function (e) {
                    e ? p() : g();
                  }),
                  l.$on("$destroy", function () {
                    g();
      ...
      function (e) {
        return {
          ...
          link: function (t, i, c, l) {
            function s(e) {
              l.allowClear = angular.isDefined(e)
                ? "" === e
                  ? !0
                  : "true" === e.toLowerCase()
                : !1;
            }
            (l.lockChoiceExpression = c.uiLockChoice),
              c.$observe("placeholder", function (t) {
                l.placeholder = void 0 !== t ? t : e.placeholder;
              }),
              c.$observe("allowClear", s),
              s(c.allowClear),
              ...
              e.$evalAsync(function () {
                ...
                (c.removeChoice = function (i) {
                  ...
                  if (!s._uiSelectChoiceLocked) {
                    var n = {};
                    (n[l.parserResult.itemName] = s),
                      l.selected.splice(i, 1),
                      (c.activeMatchIndex = -1),
                      l.sizeSearchInput(),
                      t(function () {
          ...
          link: function (c, l, s, n) {
                ...
                switch (t) {
                  ...
                  case e.DELETE:
                    return ~g.activeMatchIndex
                      ? (g.removeChoice(g.activeMatchIndex), r)
                      : !1;
                }
              }
            ...
            (d.multiple = !0),
              ...
              p.$parsers.unshift(function () {
                for (
                  var e, t = {}, i = [], l = d.selected.length - 1;
                  l >= 0;
                  l--
                )
                  (t = {}),
                    (t[d.parserResult.itemName] = d.selected[l]),
              ...
              p.$formatters.unshift(function (e) {
                var t,
                  i = d.parserResult.source(c, { $select: { search: "" } }),
                  l = {};
                if (!i) return e;
                var s = [],
                  n = function (e, i) {
                    if (e && e.length) {
                      for (var n = e.length - 1; n >= 0; n--) {
                        if (
                          ...
                          if (a.length > 0 && t[a[1]] == i[a[1]])
                            return s.unshift(e[n]), !0;
                        }
                ...
                for (var a = e.length - 1; a >= 0; a--)
                  n(d.selected, e[a]) || n(i, e[a]) || s.unshift(e[a]);
                return s;
              }),
              c.$watchCollection(
                function () {
              ...
              d.searchInput.on("keyup", function (t) {
                if (
                  ...
                  if (void 0 !== d.tagging.fct) {
                    ...
                    if (
                      ((s = d.$filter("filter")(a, function (e) {
          ...
          link: function (c, l, s, n) {
            ...
            r.$parsers.unshift(function (e) {
              ...
              r.$formatters.unshift(function (e) {
                var t,
                  i = a.parserResult.source(c, { $select: { search: "" } }),
                  l = {};
                if (i) {
                  var s = function (i) {
                    return (
                      (l[a.parserResult.itemName] = i),
                      (t = a.parserResult.modelMapper(c, l)),
                      t == e
                    );
                  };
        ...
        return {
          ...
          link: function (t, c, l, s) {
            ...
            var p,
              ...
              h = function (e) {
                ...
                t < this["vertical" === a ? "offsetHeight" : "offsetWidth"] / 2
                  ? (c.removeClass(d), c.addClass(u))
                  : (c.removeClass(u), c.addClass(d));
              },
              f = function (t) {
                t.preventDefault();
                var i = parseInt(
            ...
            c.on("dragenter", function () {
              c.hasClass(r) ||
                (c.addClass(o), c.on("dragover", h), c.on("drop", f));
            }),
