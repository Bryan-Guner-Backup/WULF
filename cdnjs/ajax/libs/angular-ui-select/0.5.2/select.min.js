              ...
              function l(t) {
                (o.groups = {}),
                  angular.forEach(t, function (t) {
                    var s = e.$eval(c),
                      i = angular.isFunction(s) ? s(t) : t[s];
                    o.groups[i] ? o.groups[i].push(t) : (o.groups[i] = [t]);
                  }),
                  (o.items = []),
          ...
          return {
            ...
            link: function (t, i, l, r, n) {
                ...
                u.$formatters.unshift(function (e) {
                  ...
                  if (c)
                    for (var s = c.length - 1; s >= 0; s--) {
                      var i = {};
                      i[a.parserResult.itemName] = c[s];
                      var l = a.parserResult.modelMapper(t, i);
                      if (l == e) return c[s];
                    }
                  return e;
                });
              ...
              l.$observe("disabled", function () {
                a.disabled = void 0 !== l.disabled ? l.disabled : !1;
              }),
            ...
            compile: function (i, l) {
              ...
              return function (i, l, r, n, o) {
                ...
                p
                  ...
                  o(function (e) {
                    var t = l.querySelectorAll(".ui-select-choices-row-inner");
                    if (1 !== t.length)
                      throw c(
                        "rows",
