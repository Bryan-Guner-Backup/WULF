      ...
      .controller("uiSelectCtrl", [
        ...
        function (e, t, c, s, l) {
          ...
          (o.placeholder = void 0),
            ...
            (o.isEmpty = function () {
              return (
                angular.isUndefined(o.selected) ||
                null === o.selected ||
                "" === o.selected
              );
            });
          ...
          (o.refresh = function (t) {
            ...
            (o.select = function (t) {
              var c = {};
              (c[o.parserResult.itemName] = t),
                o.onSelectCallback(e, {
                  $item: t,
                  $model: o.parserResult.modelMapper(e, c),
                }),
                (o.selected = t),
                o.close();
            }),
      ...
      .directive("uiSelect", [
        ...
        function (e, t, c, s, l) {
          return {
            ...
            controller: "uiSelectCtrl",
            controllerAs: "$select",
            link: function (t, i, r, n, o) {
              function a(e) {
                var c = !1;
                (c = window.jQuery
                  ? window.jQuery.contains(i[0], e.target)
                  : i[0].contains(e.target)),
                  c || (u.close(), t.$digest());
              }
              var u = n[0],
                p = n[1];
              (u.onSelectCallback = l(r.onSelect)),
                p.$parsers.unshift(function (e) {
                  var c = {};
                  c[u.parserResult.itemName] = e;
                  var s = u.parserResult.modelMapper(t, c);
                  return s;
                }),
                p.$formatters.unshift(function (e) {
                  var c = u.parserResult.source(t);
                  if (c)
                    for (var s = c.length - 1; s >= 0; s--) {
                      var l = {};
                      l[u.parserResult.itemName] = c[s];
                      var i = u.parserResult.modelMapper(t, l);
                      if (i == e) return c[s];
                    }
                  return e;
                }),
              ...
              s(d)(t),
                ...
                d.bind("keyup input", function (e) {
                  e.which === h.TAB ||
                    ...
                    e.which == h.ENTER ||
                    e.which === h.BACKSPACE ||
                    (u.activate(d.val()), d.val(""), t.$digest());
                });
              var h = {
                TAB: 9,
                ENTER: 13,
              ...
              r.$observe("disabled", function () {
                u.disabled = void 0 !== r.disabled ? r.disabled : !1;
              }),
                r.$observe("resetSearchInput", function () {
                  var e = t.$eval(r.resetSearchInput);
                  u.resetSearchInput = void 0 !== e ? e : !0;
                }),
                t.$watch("$select.selected", function (e) {
                  p.$viewValue !== e && p.$setViewValue(e);
                }),
                (p.$render = function () {
                  u.selected = p.$viewValue;
                }),
                e.on("click", a),
                ...
                o(t, function (e) {
                  ...
                  i.querySelectorAll(".ui-select-match").replaceWith(s);
                  ...
                  i.querySelectorAll(".ui-select-choices").replaceWith(l);
                });
            },
          };
        },
