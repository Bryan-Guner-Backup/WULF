        ...
        function (t, c, s, l, i) {
          function n() {
            d.resetSearchInput &&
              ...
              d.selected &&
                d.items.length &&
                !d.multiple &&
                (d.activeIndex = d.items.indexOf(d.selected)));
          }
          function a(t) {
            var c = !0;
            switch (t) {
              case e.DOWN:
                !d.open && d.multiple
                  ? d.activate(!1, !0)
                  : d.activeIndex < d.items.length - 1 && d.activeIndex++;
                break;
              case e.UP:
                !d.open && d.multiple
                  ? d.activate(!1, !0)
                  : d.activeIndex > 0 && d.activeIndex--;
                break;
              case e.TAB:
                d.multiple || d.select(d.items[d.activeIndex]);
                break;
              case e.ENTER:
                d.open ? d.select(d.items[d.activeIndex]) : d.activate(!1, !0);
                break;
              case e.ESC:
                d.close();
                break;
          ...
          function r(t) {
            function c() {
              switch (t) {
                case e.LEFT:
                  return ~d.activeMatchIndex ? u : n;
                case e.RIGHT:
                  return ~d.activeMatchIndex && a !== n
                    ? r
                    : (d.activate(), !1);
                case e.BACKSPACE:
                  return ~d.activeMatchIndex ? (d.removeChoice(a), u) : n;
                case e.DELETE:
                  return ~d.activeMatchIndex
                    ? (d.removeChoice(d.activeMatchIndex), a)
                    : !1;
              }
            }
            var s = o(h[0]),
              ...
              i = 0,
              n = l - 1,
              a = d.activeMatchIndex,
              r = d.activeMatchIndex + 1,
              u = d.activeMatchIndex - 1,
              p = a;
            return s > 0 || (d.search.length && t == e.RIGHT)
              ? !1
              : (d.close(),
                (p = c()),
                (d.activeMatchIndex =
                  d.selected.length && p !== !1
                    ? Math.min(n, Math.max(i, p))
                    : -1),
                !0);
          }
          function o(e) {
          ...
          function u() {
            ...
            var s = t[d.activeIndex],
              l = s.offsetTop + s.clientHeight - e[0].scrollTop,
              n = e[0].offsetHeight;
            l > n
              ? (e[0].scrollTop += l - n)
              : l < s.clientHeight &&
                (d.isGrouped && 0 === d.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= s.clientHeight - l));
          }
          var d = this,
            p = "";
          (d.placeholder = void 0),
            (d.search = p),
            (d.activeIndex = 0),
            (d.activeMatchIndex = -1),
            (d.items = []),
            (d.selected = void 0),
            (d.open = !1),
            (d.focus = !1),
            (d.focusser = void 0),
            (d.disabled = void 0),
            (d.searchEnabled = void 0),
            (d.resetSearchInput = void 0),
            (d.refreshDelay = void 0),
            (d.multiple = !1),
            (d.disableChoiceExpression = void 0),
            (d.isEmpty = function () {
              return (
                angular.isUndefined(d.selected) ||
                null === d.selected ||
                "" === d.selected
              );
            });
          ...
          (d.activate = function (e, t) {
            d.disabled ||
              ...
              (d.activeMatchIndex = -1),
              (d.activeIndex =
                d.activeIndex >= d.items.length ? 0 : d.activeIndex),
              s(function () {
                (d.search = e || d.search), h[0].focus();
              }));
          }),
            (d.findGroupByName = function (e) {
              return (
                d.groups &&
                d.groups.filter(function (t) {
                  return t.name === e;
                })[0]
              );
            }),
            (d.parseRepeatAttr = function (e, c) {
                ...
                (d.groups = []),
                  angular.forEach(e, function (e) {
                    var s = t.$eval(c),
                      ...
                      i = d.findGroupByName(l);
                    i
                      ? i.items.push(e)
                      : d.groups.push({ name: l, items: [e] });
                  }),
                  (d.items = []),
              ...
              var a = c ? s : n;
              (d.parserResult = l.parse(e)),
                (d.isGrouped = !!c),
                (d.itemProperty = d.parserResult.itemName),
                  ...
                  if (void 0 === e || null === e) d.items = [];
                    ...
                    if (d.multiple) {
                      var t = e.filter(function (e) {
                        return d.selected.indexOf(e) < 0;
                      });
                      a(t);
                    } else a(e);
                    d.ngModel.$modelValue = null;
                  }
                }),
                d.multiple &&
                  t.$watchCollection("$select.selected", function (e) {
                    if (e.length) {
                      var c = d.parserResult.source(t),
                        s = c.filter(function (t) {
                          return e.indexOf(t) < 0;
                        });
                      a(s), d.sizeSearchInput();
                    }
                  });
            });
          var v;
          (d.refresh = function (e) {
            ...
            (d.isActive = function (e) {
              return d.items.indexOf(e[d.itemProperty]) === d.activeIndex;
            }),
            (d.isDisabled = function (e) {
              var t,
                c = d.items.indexOf(e[d.itemProperty]),
                s = !1;
              return (
                c >= 0 &&
                  !angular.isUndefined(d.disableChoiceExpression) &&
                  ((t = d.items[c]),
                  (s = !!e.$eval(d.disableChoiceExpression)),
                  (t._uiSelectChoiceDisabled = s)),
                s
              );
            }),
            (d.select = function (e) {
              if (!e._uiSelectChoiceDisabled) {
                var c = {};
                (c[d.parserResult.itemName] = e),
                  d.onSelectCallback(t, {
                    $item: e,
                    $model: d.parserResult.modelMapper(t, c),
                  }),
                  d.multiple
                    ? (d.selected.push(e), d.sizeSearchInput())
                    : (d.selected = e),
                  d.close();
              }
            }),
            ...
            (d.toggle = function (e) {
              d.open ? d.close() : d.activate(),
                e.preventDefault(),
                e.stopPropagation();
            }),
            (d.removeChoice = function (e) {
              d.selected.splice(e, 1),
                (d.activeMatchIndex = -1),
                d.sizeSearchInput();
            }),
            (d.getPlaceholder = function () {
              return d.multiple && d.selected.length ? void 0 : d.placeholder;
            }),
            ...
            h.on("keydown", function (c) {
              ...
              t.$apply(function () {
                var t = !1;
                d.multiple && e.isHorizontalMovement(s) && (t = r(s)),
                  !t && d.items.length > 0 && (t = a(s)),
            ...
            h.on("blur", function () {
              s(function () {
                (d.activeMatchIndex = -1), (d.activeIndex = 0);
              });
            }),
        ...
        function (t, c, s, l, i) {
          return {
            ...
            link: function (c, n, a, r, o) {
              ...
              (d.multiple = angular.isDefined(a.multiple)),
                (d.onSelectCallback = i(a.onSelect)),
                p.$parsers.unshift(function (e) {
                  var t,
                    s = {};
                  if (d.multiple) {
                    for (var l = [], i = d.selected.length - 1; i >= 0; i--)
                      (s = {}),
                        (s[d.parserResult.itemName] = d.selected[i]),
                  ...
                  return (
                    (s = {}),
                    (s[d.parserResult.itemName] = e),
                    (t = d.parserResult.modelMapper(c, s))
                  );
                }),
                p.$formatters.unshift(function (e) {
                  var t,
                    s = d.parserResult.source(c, { $select: { search: "" } }),
                    l = {};
                  if (s) {
                    if (d.multiple) {
                      var i = [],
                        n = function (e, s) {
                          if (e && e.length) {
                            for (var n = e.length - 1; n >= 0; n--)
                              if (
                                ((l[d.parserResult.itemName] = e[n]),
                                (t = d.parserResult.modelMapper(c, l)),
                                t == s)
                              )
                      ...
                      for (var a = e.length - 1; a >= 0; a--)
                        n(d.selected, e[a]) || n(s, e[a]);
                      return i;
                    }
                    var r = function (s) {
                      return (
                        (l[d.parserResult.itemName] = s),
                        (t = d.parserResult.modelMapper(c, l)),
                        t == e
                      );
                    };
                    if (d.selected && r(d.selected)) return d.selected;
              ...
              a.tabindex &&
                a.$observe("tabindex", function (e) {
                  d.multiple ? h.attr("tabindex", e) : v.attr("tabindex", e),
          ...
          return {
            ...
            compile: function (l, i) {
              ...
              return function (l, i, n, a, r) {
                ...
                var d = i.querySelectorAll(".ui-select-choices-row");
                if (1 !== d.length)
                  throw c(
                    "rows",
                ...
                var p = i.querySelectorAll(".ui-select-choices-row-inner");
                if (1 !== p.length)
                  throw c(
                    "rows",
