        ...
        function (t, c, l, s, i) {
          ...
          function r(t) {
            ...
            var l = o(h[0]),
              ...
              d = a;
            return l > 0 || (p.search.length && t == e.RIGHT)
              ? !1
              : (p.close(),
                (d = c()),
                (p.activeMatchIndex =
            ...
            s > n
              ...
              : s < l.clientHeight &&
                (p.isGrouped && 0 === p.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= l.clientHeight - s));
          }
          var p = this,
            d = "";
          ...
          (p.refresh = function (e) {
            ...
            (p.isActive = function (e) {
              return (
                p.open && p.items.indexOf(e[p.itemProperty]) === p.activeIndex
              );
            }),
              ...
              if (p.open) {
                ...
                return (
                  c >= 0 &&
                    ...
                    ((t = p.items[c]),
                    (l = !!e.$eval(p.disableChoiceExpression)),
            ...
            (p.close = function (e) {
              p.open &&
                ...
                p.multiple ||
                  l(
                    function () {
                      p.focusser.prop("disabled", !1),
                        e || p.focusser[0].focus();
                    },
                    0,
                    !1
                  ));
          ...
          (p.sizeSearchInput = function () {
            ...
            h.on("keydown", function (c) {
              ...
              t.$apply(function () {
                var t = !1;
                p.multiple && e.isHorizontalMovement(l) && (t = r(l)),
                  !t && p.items.length > 0 && (t = a(l)),
          ...
          return {
            ...
            link: function (c, n, a, r, o) {
              ...
              (p.multiple = angular.isDefined(a.multiple)
                ? "" === a.multiple
                  ? !0
                  : "true" === a.multiple.toLowerCase()
                : !1),
                (p.onSelectCallback = i(a.onSelect)),
                (p.onRemoveCallback = i(a.onRemove)),
                d.$parsers.unshift(function (e) {
                  ...
                  if (p.multiple) {
                    for (var s = [], i = p.selected.length - 1; i >= 0; i--)
                      (l = {}),
                        (l[p.parserResult.itemName] = p.selected[i]),
              ...
              a.tabindex &&
                a.$observe("tabindex", function (e) {
                  p.multiple ? h.attr("tabindex", e) : v.attr("tabindex", e),
                ...
                p.multiple ||
                  ...
                  v.bind("keyup input", function (t) {
                    t.which === e.TAB ||
                      ...
                      t.which == e.ENTER ||
                      t.which === e.BACKSPACE ||
                      (p.activate(v.val()), v.val(""), c.$digest());
                  })),
