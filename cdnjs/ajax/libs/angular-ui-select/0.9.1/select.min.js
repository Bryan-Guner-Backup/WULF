    ...
    angular
      ...
      .controller("uiSelectCtrl", [
        ...
        function (t, c, l, i, s, n, a) {
          function r() {
            (g.resetSearchInput ||
              (void 0 === g.resetSearchInput && a.resetSearchInput)) &&
              ((g.search = f),
              g.selected &&
                g.items.length &&
                !g.multiple &&
                (g.activeIndex = g.items.indexOf(g.selected)));
          }
          function o(t) {
            var c = !0;
            switch (t) {
              case e.DOWN:
                !g.open && g.multiple
                  ? g.activate(!1, !0)
                  : g.activeIndex < g.items.length - 1 && g.activeIndex++;
                break;
              case e.UP:
                !g.open && g.multiple
                  ? g.activate(!1, !0)
                  : (g.activeIndex > 0 ||
                      (0 === g.search.length && g.tagging.isActivated)) &&
                    g.activeIndex--;
                break;
              case e.TAB:
          ...
          function u(t) {
            function c() {
              switch (t) {
                ...
                case e.RIGHT:
                  return ~g.activeMatchIndex && a !== n
                    ? r
                    : (g.activate(), !1);
                case e.BACKSPACE:
                  return ~g.activeMatchIndex ? (g.removeChoice(a), o) : n;
                case e.DELETE:
                  return ~g.activeMatchIndex
                    ? (g.removeChoice(g.activeMatchIndex), a)
                    : !1;
              }
            }
            var l = p(v[0]),
              ...
              u = a;
            return l > 0 || (g.search.length && t == e.RIGHT)
              ? !1
              : (g.close(),
                (u = c()),
                (g.activeMatchIndex =
                  g.selected.length && u !== !1
          ...
          function h() {
            ...
            i > s
              ? (e[0].scrollTop += i - s)
              : i < l.clientHeight &&
                (g.isGrouped && 0 === g.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= l.clientHeight - i));
          }
          var g = this,
            f = "";
          (g.placeholder = void 0),
            (g.search = f),
            (g.activeIndex = 0),
            ...
            (g.focusser = void 0),
            (g.disabled = void 0),
            (g.searchEnabled = void 0),
            (g.resetSearchInput = void 0),
            (g.refreshDelay = void 0),
            (g.multiple = !1),
            (g.disableChoiceExpression = void 0),
            (g.tagging = { isActivated: !1, fct: void 0 }),
            (g.taggingTokens = { isActivated: !1, tokens: void 0 }),
            (g.lockChoiceExpression = void 0),
            (g.closeOnSelect = !0),
            (g.clickTriggeredSelect = !1),
            (g.$filter = i),
            (g.isEmpty = function () {
              return (
                angular.isUndefined(g.selected) ||
                null === g.selected ||
                "" === g.selected
              );
            });
          ...
          (g.activate = function (e, t) {
            g.disabled ||
              g.open ||
              (t || r(),
              g.focusser.prop("disabled", !0),
              (g.open = !0),
              (g.activeMatchIndex = -1),
              (g.activeIndex =
                g.activeIndex >= g.items.length ? 0 : g.activeIndex),
              -1 === g.activeIndex &&
                g.taggingLabel !== !1 &&
                (g.activeIndex = 0),
              l(function () {
            ...
            (g.parseRepeatAttr = function (e, c) {
              function l(e) {
                (g.groups = []),
                  angular.forEach(e, function (e) {
                    ...
                    s
                      ? s.items.push(e)
                      : g.groups.push({ name: i, items: [e] });
                  }),
                  (g.items = []),
                  g.groups.forEach(function (e) {
              ...
              var a = c ? l : i;
              (g.parserResult = s.parse(e)),
                (g.isGrouped = !!c),
                (g.itemProperty = g.parserResult.itemName),
                t.$watchCollection(g.parserResult.source, function (e) {
          ...
          (g.refresh = function (e) {
            ...
            (g.isActive = function (e) {
              ...
              var t = g.items.indexOf(e[g.itemProperty]),
                c = t === g.activeIndex;
              return !c ||
                (0 > t && g.taggingLabel !== !1) ||
                (0 > t && g.taggingLabel === !1)
                ? !1
                : (c &&
                    !angular.isUndefined(g.onHighlightCallback) &&
                    e.$eval(g.onHighlightCallback),
                  c);
            }),
            (g.isDisabled = function (e) {
              if (g.open) {
                var t,
                  c = g.items.indexOf(e[g.itemProperty]),
                  l = !1;
                return (
                  c >= 0 &&
                    !angular.isUndefined(g.disableChoiceExpression) &&
                    ((t = g.items[c]),
                    (l = !!e.$eval(g.disableChoiceExpression)),
                  ...
                  if (g.tagging.isActivated) {
                    if (g.taggingLabel === !1)
                      if (g.activeIndex < 0) {
                        if (
                          ((e =
                            void 0 !== g.tagging.fct
                              ? g.tagging.fct(g.search)
                              : g.search),
                          angular.equals(g.items[0], e))
                        )
                          return;
                      ...
                      e =
                        void 0 !== g.tagging.fct
                          ? g.tagging.fct(g.search)
                          : e.replace(g.taggingLabel, "");
                    }
                    if (
                      g.selected &&
                      g.selected.filter(function (t) {
                        return angular.equals(t, e);
                      }).length > 0
                    )
                      return g.close(c), void 0;
                  }
                  var i = {};
                  (i[g.parserResult.itemName] = e),
                    g.onSelectCallback(t, {
                      $item: e,
                      $model: g.parserResult.modelMapper(t, i),
                    }),
                    g.multiple
                      ? (g.selected.push(e), g.sizeSearchInput())
                      : (g.selected = e),
                    (!g.multiple || g.closeOnSelect) && g.close(c),
                    l && "click" === l.type && (g.clickTriggeredSelect = !0);
                }
              }
            }),
            (g.close = function (e) {
              g.open &&
                ...
                g.multiple ||
                  l(
                    function () {
                      g.focusser.prop("disabled", !1),
                        e || g.focusser[0].focus();
                    },
                    0,
                    !1
                  ));
            ...
            (g.isLocked = function (e, t) {
              ...
              return (
                l &&
                  !angular.isUndefined(g.lockChoiceExpression) &&
                  ((c = !!e.$eval(g.lockChoiceExpression)),
            ...
            (g.removeChoice = function (e) {
              ...
              if (!c._uiSelectChoiceLocked) {
                var l = {};
                (l[g.parserResult.itemName] = c),
                  g.selected.splice(e, 1),
                  (g.activeMatchIndex = -1),
                  g.sizeSearchInput(),
                  g.onRemoveCallback(t, {
                    $item: c,
          ...
          (g.sizeSearchInput = function () {
            ...
            v.on("keydown", function (c) {
              ...
              t.$apply(function () {
                var t = !1;
                if (
                  (g.multiple && e.isHorizontalMovement(l) && (t = u(l)),
                  !t &&
                    (g.items.length > 0 || g.tagging.isActivated) &&
                    ((t = o(l)), g.taggingTokens.isActivated))
                )
                  for (var i = 0; i < g.taggingTokens.tokens.length; i++)
                    g.taggingTokens.tokens[i] === e.MAP[c.keyCode] &&
                      g.search.length > 0 &&
                      (g.select(null, !0), v.triggerHandler("tagged"));
            ...
            v.on("keyup", function (c) {
              if (
                ...
                var l,
                  ...
                  s,
                  n,
                  a = angular.copy(g.items),
                  r = angular.copy(g.items),
                  o = !1,
                  u = -1;
                if (void 0 !== g.tagging.fct) {
                  if (
                    ((s = g.$filter("filter")(a, { isTag: !0 })),
                    s.length > 0 && (n = s[0]),
                    a.length > 0 &&
                      n &&
                      ((o = !0),
                  ...
                  if (
                    ((s = g.$filter("filter")(a, function (e) {
                    ...
                    void 0 !== i &&
                      ...
                      (a = a.slice(1, a.length)),
                      (r = r.slice(1, r.length))),
                    (l = g.search + " " + g.taggingLabel),
                    d(g.selected, g.search) > -1)
                  )
                    return;
                  if (
                    r.filter(function (e) {
                  ...
                  if (
                    g.selected.filter(function (e) {
                      return e.toUpperCase() === g.search.toUpperCase();
                    }).length > 0
                  )
                    return o && (g.items = r.slice(1, r.length)), void 0;
                }
                o && (u = d(g.selected, l)),
                  u > -1
          ...
          return {
            ...
            link: function (n, a, r, o, u) {
              ...
              (p.multiple =
                ...
                (p.closeOnSelect =
                  angular.isDefined(r.closeOnSelect) &&
                  "false" === r.closeOnSelect.toLowerCase()
                    ? !1
                    : c.closeOnSelect),
