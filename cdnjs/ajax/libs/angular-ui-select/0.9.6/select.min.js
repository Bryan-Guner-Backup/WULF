  ...
  void 0 === angular.element.prototype.querySelectorAll &&
    ...
    angular
      ...
      .controller("uiSelectCtrl", [
        ...
        "uiSelectMinErr",
        "uiSelectConfig",
        function (t, c, l, i, s, n, a) {
          function r() {
            (f.resetSearchInput ||
              (void 0 === f.resetSearchInput && a.resetSearchInput)) &&
              ((f.search = v),
              f.selected &&
                f.items.length &&
                !f.multiple &&
            ...
            switch (t) {
              ...
              case e.UP:
                !f.open && f.multiple
                  ? f.activate(!1, !0)
                  : (f.activeIndex > 0 ||
                      (0 === f.search.length && f.tagging.isActivated)) &&
                    f.activeIndex--;
                break;
              case e.TAB:
              ...
              switch (t) {
                ...
                case e.DELETE:
                  return ~f.activeMatchIndex
                    ? (f.removeChoice(f.activeMatchIndex), a)
                    : !1;
              }
            }
            var l = h(m[0]),
              ...
              u = a;
            return l > 0 || (f.search.length && t == e.RIGHT)
              ? !1
              : (f.close(),
                (u = c()),
                (f.activeMatchIndex =
          ...
          function d(e) {
            ...
            var t =
              e.filter(function (e) {
                return void 0 === f.search.toUpperCase()
                  ? !1
            ...
            i > s
              ...
              : i < l.clientHeight &&
                (f.isGrouped && 0 === f.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= l.clientHeight - i));
          }
          var f = this,
            v = "";
          (f.placeholder = void 0),
            (f.search = v),
            (f.activeIndex = 0),
            ...
            (f.focusser = void 0),
            (f.disabled = void 0),
            (f.searchEnabled = void 0),
            (f.resetSearchInput = void 0),
            (f.refreshDelay = void 0),
            (f.multiple = !1),
              ...
              if (f.open) {
                ...
                return (
                  c >= 0 &&
                    ...
                    ((t = f.items[c]),
                    (l = !!e.$eval(f.disableChoiceExpression)),
                    (t._uiSelectChoiceDisabled = l)),
                  l
                );
              }
            }),
              ...
              if (void 0 === e || !e._uiSelectChoiceDisabled) {
                ...
                if (!e || !e._uiSelectChoiceDisabled) {
                        ...
                        if (
                          ((e =
                            void 0 !== f.tagging.fct
                              ...
                              : f.search),
                          angular.equals(f.items[0], e))
                        )
                          return;
                      } else e = f.items[f.activeIndex];
                    else if (0 === f.activeIndex) {
                      if (void 0 === e) return;
                      void 0 !== f.tagging.fct && "string" == typeof e
                        ? (e = f.tagging.fct(f.search))
                        : "string" == typeof e &&
                  ...
                  (s[f.parserResult.itemName] = e),
                    ...
                    i && "click" === i.type && (f.clickTriggeredSelect = !0);
                }
              }
            }),
            (f.close = function (e) {
              f.open &&
                ...
                f.multiple ||
                  l(
                    function () {
                      f.focusser.prop("disabled", !1),
                        e || f.focusser[0].focus();
                    },
                    0,
                    !1
                  ));
            ...
            m.on("keydown", function (c) {
              ...
              t.$apply(function () {
                var t = !1,
                  s = !1;
                if (
                  (f.multiple && e.isHorizontalMovement(i) && (t = u(i)),
                  !t &&
                    (f.items.length > 0 || f.tagging.isActivated) &&
                    ((t = o(i)), f.taggingTokens.isActivated))
                ) {
                  for (var n = 0; n < f.taggingTokens.tokens.length; n++)
                    f.taggingTokens.tokens[n] === e.MAP[c.keyCode] &&
                      f.search.length > 0 &&
                      (s = !0);
                  s &&
                    l(function () {
            ...
            m.on("keyup", function (c) {
              if (
                ...
                var l,
                  ...
                  s,
                  n,
                  a = angular.copy(f.items),
                  r = angular.copy(f.items),
                  o = !1,
                  u = -1;
                if (void 0 !== f.tagging.fct) {
                  if (
                    ((s = f.$filter("filter")(a, { isTag: !0 })),
                    s.length > 0 && (n = s[0]),
                    a.length > 0 &&
                      n &&
                      ((o = !0),
                  ...
                  if (
                    ((s = f.$filter("filter")(a, function (e) {
                  ...
                  if (d(r))
                    return o && (f.items = r.slice(1, r.length)), void 0;
                }
                o && (u = p(f.selected, l)),
                  u > -1
                    ? (a = a.slice(u + 1, a.length - 1))
                    : ((a = []), a.push(l), (a = a.concat(r))),
                  t.$evalAsync(function () {
                    (f.activeIndex = 0), (f.items = a);
                  });
              }
            ...
            link: function (n, a, r, o, u) {
              function d(e) {
                ...
                (t = window.jQuery
                  ...
                  t ||
                    p.clickTriggeredSelect ||
                    (p.close(
                      angular
                        .element(e.target)
                        .closest(".ui-select-container.open").length > 0
                    ),
                    n.$digest()),
              ...
              (p.multiple =
                ...
                h.$parsers.unshift(function (e) {
                  var t,
                    c = {};
                  if (p.multiple) {
                    for (var l = [], i = p.selected.length - 1; i >= 0; i--)
                      (c = {}),
                        (c[p.parserResult.itemName] = p.selected[i]),
                        ...
                        s = function (e, c) {
                          if (e && e.length) {
                            for (var s = e.length - 1; s >= 0; s--)
                              if (
                                ((l[p.parserResult.itemName] = e[s]),
                                (t = p.parserResult.modelMapper(n, l)),
                                t == c)
                              )
                                return i.unshift(e[s]), !0;
                            return !1;
                          }
                        };
                      if (!e) return i;
              ...
              r.tabindex &&
                r.$observe("tabindex", function (e) {
                  p.multiple ? g.attr("tabindex", e) : f.attr("tabindex", e),
                ...
                p.multiple ||
                  ...
                  f.bind("keyup input", function (t) {
                    t.which === e.TAB ||
                      ...
                      t.which == e.ENTER ||
                      t.which === e.BACKSPACE ||
                      (p.activate(f.val()), f.val(""), n.$digest());
                  })),
                ...
                u(n, function (e) {
                  ...
                  if ((i.removeAttr("ui-select-choices"), 1 !== i.length))
                    throw l(
                      "transcluded",
            ...
            compile: function (i, s) {
              ...
              return function (i, s, n, a, r) {
                ...
                p.attr("uis-transclude-append", ""),
                  l(s, r)(i),
                  i.$watch("$select.search", function (e) {
        ...
        function (e) {
          return {
            ...
            link: function (t, c, l, i) {
              (i.lockChoiceExpression = l.uiLockChoice),
                l.$observe("placeholder", function (t) {
                  i.placeholder = void 0 !== t ? t : e.placeholder;
                }),
                (i.allowClear = angular.isDefined(l.allowClear)
                  ? "" === l.allowClear
                    ? !0
                    : "true" === l.allowClear.toLowerCase()
                  : !1),
                i.multiple && i.sizeSearchInput();
            },
          };
        },
      ])
