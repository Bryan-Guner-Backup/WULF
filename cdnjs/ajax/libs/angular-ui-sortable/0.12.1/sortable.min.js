    ...
    function (a, b, c) {
      return {
        ...
        link: function (d, e, f, g) {
          ...
          angular.extend(j, a),
            g
              ? (d.$watch(f.ngModel + ".length", function () {
                  b(function () {
                    e.sortable("refresh");
                  });
                }),
                ...
                (k.update = function (a, b) {
                  b.item.sortable.received ||
                    ...
                    e.sortable("cancel")),
                    "clone" === e.sortable("option", "helper") &&
                      (i = i.not(i.last())),
                    i.appendTo(e),
                    b.item.sortable.received &&
                  ...
                  !b.item.sortable.isCanceled()
                    ? d.$apply(function () {
                        g.$modelValue.splice(
                          b.item.sortable.dropindex,
                          0,
                          g.$modelValue.splice(b.item.sortable.index, 1)[0]
                        );
                      })
                    : ("dropindex" in b.item.sortable &&
                        !b.item.sortable.isCanceled()) ||
                ...
                (k.remove = function (a, b) {
                  b.item.sortable.isCanceled() ||
                    d.$apply(function () {
                      b.item.sortable.moved = g.$modelValue.splice(
