...
(function () {
  ...
  angular
    ...
    .provider("vertxEventBus", function () {
      ...
      this.enable.displayName =
        "" + CONSTANTS.MODULE + "/" + CONSTANTS.COMPONENT + ": provider.enable";
      ...
      this.useUrlServer.displayName =
        "" +
        CONSTANTS.MODULE +
        "/" +
        CONSTANTS.COMPONENT +
        ": provider.useUrlServer";
      ...
      this.useReconnect.displayName =
        "" +
        CONSTANTS.MODULE +
        "/" +
        CONSTANTS.COMPONENT +
        ": provider.useReconnect";
      ...
      this.useSockJsStateInterval.displayName =
        "" +
        CONSTANTS.MODULE +
        "/" +
        CONSTANTS.COMPONENT +
        ": provider.useSockJsStateInterval";
      ...
      this.useSockJsReconnectInterval.displayName =
        "" +
        CONSTANTS.MODULE +
        "/" +
        CONSTANTS.COMPONENT +
        ": provider.useSockJsReconnectInterval";
      ...
      this.useSockJsOptions.displayName =
        "" +
        CONSTANTS.MODULE +
        "/" +
        CONSTANTS.COMPONENT +
        ": provider.useSockJsOptions";
      ...
      this.useMessageBuffer.displayName =
        "" +
        CONSTANTS.MODULE +
        "/" +
        CONSTANTS.COMPONENT +
        ": provider.useMessageBuffer";
     ...
     */
      this.$get = [
        ...
        function ($timeout, $log) {
          ...
          if (enabled && EventBusOriginal) {
            ...
            EventBusStub = {
              ...
              registerHandler: function (address, handler) {
                ...
                deconstructor.displayName =
                  ...
                  "/" +
                  CONSTANTS.COMPONENT +
                  ": EventBusStub.registerHandler (deconstructor)";
            ...
            EventBusStub.reconnect.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.reconnect";
            EventBusStub.close.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.close";
            EventBusStub.login.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.login";
            EventBusStub.send.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.send";
            EventBusStub.publish.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.publish";
            EventBusStub.registerHandler.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.registerHandler";
            EventBusStub.unregisterHandler.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.unregisterHandler";
            EventBusStub.readyState.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.readyState";
            EventBusStub.getOptions.displayName =
              "" +
              CONSTANTS.MODULE +
              "/" +
              CONSTANTS.COMPONENT +
              ": EventBusStub.getOptions";
          } else {
            if (debugEnabled) {
      ...
      this.$get.displayName =
        "" + CONSTANTS.MODULE + "/" + CONSTANTS.COMPONENT + ": Factory.get";
    });
  ...
  angular
     ...
     */
      ...
      this.$get = [
        ...
        "vertxEventBus",
        "$log",
        function ($rootScope, $q, $interval, $timeout, vertxEventBus, $log) {
          var callbackMap,
          ...
          util = {
            registerHandler: function (address, callback) {
              ...
              callbackWrapper.displayName =
                ...
                "/" +
                CONSTANTS.COMPONENT +
                ": util.registerHandler (callback wrapper)";
          ...
          wrapped = {
            ...
            registerHandler: function (address, callback) {
              ...
              deconstructor.displayName =
                ...
                "/" +
                CONSTANTS.COMPONENT +
                ": wrapped.registerHandler (deconstructor)";
              return deconstructor;
            },
            unregisterHandler: function (address, callback) {
              var index;
