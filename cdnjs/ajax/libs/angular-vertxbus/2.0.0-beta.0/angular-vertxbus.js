            ...
            },
            {
              ...
              value: function registerHandler(address, callback) {
                ...
                if (this.delegate.isConnectionOpen()) {
                  unregisterFn = this.delegate.registerHandler(
                    address,
                    callback
                  );
                }
                ...
                deconstructor.displayName =
                  "" +
                  this.CONSTANTS.MODULE +
                  "/" +
                  this.CONSTANTS.COMPONENT +
                  ": registerHandler (deconstructor)";
              ...
              value: function login() {
                ...
                var next = function next(reply) {
                  if (reply && reply.status === "ok") {
                    ...
                    _this5.$rootScope.$broadcast(
                      "" + _this5.options.prefix + "system.login.failed",
                      { status: reply.status }
                    );
                  }
                };
        ...
        angular
          ...
          .provider("vertxEventBus", function () {
            ...
            this.useReconnect = function () {
              var value =
                arguments[0] === undefined
                  ? DEFAULT_OPTIONS.reconnectEnabled
                  : arguments[0];
            ...
            this.useSockJsStateInterval = function () {
              var value =
                arguments[0] === undefined
                  ? DEFAULT_OPTIONS.sockjsStateInterval
                  : arguments[0];
            ...
            this.useSockJsReconnectInterval = function () {
              var value =
                arguments[0] === undefined
                  ? DEFAULT_OPTIONS.sockjsReconnectInterval
                  : arguments[0];
