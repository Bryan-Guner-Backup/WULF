...
(function (y, K, D) {
  ...
  function N(a, b) {
    ...
    return t(b) && !(b instanceof RegExp)
      ? c.length
        ? function () {
            return arguments.length
              ? b.apply(a, c.concat(ea.call(arguments, 0)))
              : b.apply(a, c);
          }
        : function () {
  ...
  function Cb() {
    (ga = y.jQuery)
      ? ((o = ga),
        w(ga.fn, { scope: Ya.scope, inheritedData: Ya.inheritedData }),
        Za("remove", !0),
        Za("empty"),
        Za("html"))
      : (o = $a);
  ...
  function ia(a, b) {
    function c(a) {
      if (s(a) && a.length === Db) return aa.toDate(a);
      else
        (M(a) || L(a)) &&
          k(a, function (b, d) {
            a[d] = c(b);
  ...
  function cb(a) {
    ...
    if (!a.$inject) {
      var b = (a.$inject = []),
        c = a.toString().replace(wc, "").match(xc);
      k(c[1].split(yc), function (a) {
        a.replace(zc, function (a, c) {
          b.push(c);
        });
      });
    }
  ...
  function Ac(a, b) {
    ...
    for (
      ...
      if (c("\"'")) l(k);
        ...
        if (
          (i(), "{,".indexOf(B) != -1 && I[0] == "{" && (E = n[n.length - 1]))
        )
          E.json = E.text.indexOf(".") == -1;
      } else if (c("(){}[].,;:"))
        n.push({
          index: q,
          text: k,
        ...
        var J = k + d(),
          ...
          t = db[J];
        t
          ? (n.push({ index: q, text: J, fn: t }), (q += 2))
          : o
          ? (n.push({
              index: q,
              text: k,
  ...
  function Da(a, b, c) {
    ...
    for (var b = b.split("."), d, e = a, f = b.length, g = 0; g < f; g++)
      if (((d = b[g]), a && (a = (e = a)[d]), r(a) && d.charAt(0) == "$")) {
        var h = Z.typeOf(e);
        if (
  ...
  function Dc(a, b, c, d, e, f) {
    ...
    i.xhr = function (b, e, f, h, j) {
      ...
      if (z(b) == "json") {
        ...
        var n = i.addJs(e.replace("JSON_CALLBACK", m), function () {
  ...
  function vb(a, b) {
    ...
    for (
      ...
      if (!g.last() || !Ub[g.last()]) {
        ...
        } else if (Gc.test(a) && (e = a.match(Wb)))
    ...
    function c() {
      ...
      for (var a = [this], c = b, g, h, j, i, l, m, n; a.length; ) {
        ...
        for (j = g.length; h < j; h++) {
          i = o(g[h]);
          c
            ? (n = (l = i.data("events")) && l.$destroy) &&
              k(n, function (a) {
                a.handler();
              })
            : (c = !c);
          l = 0;
          for (e = (m = i.children()).length, i = e; l < i; l++)
            a.push(ga(m[l]));
        }
      }
  ...
  function Ha(a, b, c) {
    var d = a[Fa],
      d = Ga[d || -1];
    if (p(c)) d || ((a[Fa] = d = Nc++), (d = Ga[d] = {})), (d[b] = c);
  ...
  function cc(a, b, c, d, e) {
    ...
    if (g.indexOf("e") !== -1) h = g;
      ...
      var g = Math.pow(10, e),
        ...
        m = b.gSize;
      if (g.length >= l + m)
        for (var i = g.length - l, n = 0; n < i; n++)
          (i - n) % m === 0 && n !== 0 && (h += c), (h += g.charAt(n));
      for (n = i; n < g.length; n++)
        (g.length - n) % l === 0 && n !== 0 && (h += c), (h += g.charAt(n));
      for (; a.length < e; ) a += "0";
      e && (h += d + a.substr(0, e));
    }
    ...
    return function (b) {
      return function (c) {
        this.$watch(b, function (b, e, f) {
          a(b.$index) &&
            (f && c.removeClass(M(f) ? f.join(" ") : f),
            e && c.addClass(M(e) ? e.join(" ") : e));
        });
      };
    };
  }
  ...
  var z = function (a) {
    ...
    Ta = "undefined",
    u = y.Error,
    O = parseInt((/msie (\d+)/.exec(z(navigator.userAgent)) || [])[1], 10),
    o,
    ga,
    ea = [].slice,
    la = [].push,
    tc = y.console ? N(y.console, y.console.error || v) : v,
    x = y.angular || (y.angular = {}),
    Xa = X(x, "markup"),
    Ab = X(x, "attrMarkup"),
    C = X(x, "directive"),
    G = X(x, "widget", function (a) {
      a = z(a);
  ...
  bb.prototype = {
    link: function (a, b) {
      var c = b;
      this.newScope &&
        ((c = t(this.newScope) ? b.$new(this.newScope(b)) : b.$new()),
        a.data("$scope", c));
  ...
  zb.prototype = {
    ...
    templatize: function (a, b) {
      ...
      Aa(a, function (b, e) {
        if (!d && (d = c.widgets("@" + e)))
          a.addClass("ng-attr-widget"), (d = N(m, d, b, a));
      });
      if (!d && (d = c.widgets(j)))
        i && a.addClass("ng-widget"), (d = N(m, d, a));
      d &&
        ((h = g = !1),
        (j = a.parent()),
        l.addLinkFn(d.call(m, a)),
        j && j[0] && (a = o(j[0].childNodes[b])));
      if (g)
        for (var n = 0, E = a[0].childNodes; n < E.length; n++)
          oa(E[n]) == "#text" &&
      ...
      h &&
        ...
        Aa(a, function (b, c) {
          if ((e = f[c]))
            a.addClass("ng-directive"), l.addLinkFn(f[c].call(m, b, a));
        }));
      g &&
        vc(a, function (a, b) {
  ...
  Fb.prototype = {
    ...
    $watch: function (a, b) {
      var c = Hb(a, "watch"),
        d = this.$$watchers,
        e = { fn: Hb(b || v, "listener"), last: Number.NaN, get: c, exp: a };
    ...
    $emit: function (a, b) {
      var c = [],
        ...
        h = [g].concat(ea.call(arguments, 1)),
        j,
        i;
      do {
        d = f.$$listeners[a] || c;
  ...
  var Sc =
    ...
    Lc = /^((ftp|https?):\/\/|mailto:|#)/,
    Jc = /([^\#-~| |!])/g,
    Tb = T("area,br,col,hr,img,wbr"),
    Qa = T("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),
    ta = T("rp,rt"),
    Sb = w({}, ta, Qa),
    Qb = w(
      {},
    ...
    Ub = T("script,style"),
    Yb = w({}, Tb, Qb, Rb, Sb),
    Zb = T("background,cite,href,longdesc,src,usemap"),
    Kc = w(
      {},
      Zb,
      T(
    ...
    Nc = 1,
    Tc = y.document.addEventListener
      ? function (a, b, c) {
    ...
    ib = y.document.removeEventListener
      ? function (a, b, c) {
  ...
  var Z = {
    ...
    la = { copy: A, size: xb, equals: P },
    Qa = { extend: w },
    Pa = {
      indexOf: yb,
      sum: function (a, b) {
        for (var c = pb.compile(b), d = 0, e = 0; e < a.length; e++) {
          var f = 1 * c(a[e]);
          isNaN(f) || (d += f);
        }
        return d;
  ...
  V.date = function (a, b) {
    ...
    for (; b; )
      (g = Wc.exec(b))
        ? ((e = e.concat(ea.call(g, 1))), (b = e.pop()))
        : (e.push(b), (b = null));
    k(e, function (b) {
      f = Vc[b];
      d += f
  ...
  V.linky = function (a) {
    if (!a) return a;
    for (var b = a, c = [], d = wb(c), e, f; (a = b.match(Yc)); )
      (e = a[0]),
        a[2] == a[3] && (e = "mailto:" + e),
        (f = a.index),
        d.chars(b.substr(0, f)),
        d.start("a", { href: e }),
        d.chars(a[0].replace(Zc, "")),
        d.end("a"),
  ...
  F(
    ...
    function (a) {
      ...
      this.$watch(function () {
        var b, e, f;
        for (b in d) r(c[b]) && a.cookies(b, D);
        for (b in c)
          (e = c[b]),
            s(e)
        ...
        if (f)
          for (b in ((e = a.cookies()), c))
            c[b] !== e[b] && (r(e[b]) ? delete c[b] : (c[b] = e[b]));
      });
      return c;
    },
    ["$browser"]
      ...
      if (c.html5Mode) {
        ...
        d.bind("click", function (a) {
          if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
            for (var b = o(a.target); b.length && z(b[0].nodeName) !== "a"; )
              b = b.parent();
            var c = b.attr("href");
            c &&
  ...
  F(
    ...
    function (a, b) {
      function c() {
        ...
        k(e, function (d, e) {
          if (!c && (b = f(a.path(), e)))
            (c = ua(d, { params: w({}, a.search(), b), pathParams: b })),
              (c.$route = d);
        });
              ...
              a(
                ...
                function (a, d) {
                  k(d, function (a, d) {
                    try {
                      a.status == 200
                        ? (j[d].success || v)(a.status, a.response)
                        : t(j[d].error)
        ...
        if (a == "GET") {
          ...
          if ((E = e.data[h]))
            if (
              ...
              return;
          (m = f[h])
            ? (m.successes.push(i), m.errors.push(l))
                  ...
                  k(i, function (f, i) {
                    try {
                      t(f)
                        ? f(b, A(e))
                        : c(
                            { method: a, url: h, data: j, success: l[i] },
                            { status: b, body: e }
                          );
                    } catch (n) {
                      d.error(n);
    ...
    function (a, b, c) {
      function d(d, h, j, i, l) {
        ...
        a.xhr(
          ...
          w({ "X-XSRF-TOKEN": a.cookies()["XSRF-TOKEN"] }, f.common, f[z(d)])
        );
      }
      var e = this,
        f = {
  ...
  Ab("{{}}", function (a, b, c) {
    if (!C(b) && !C("@" + b)) {
      ...
      var d = Ma(a);
      if (d.length > 1 || Na(d[0]) !== null || qb[b])
        c.removeAttr(b),
          (d = ia(c.attr("ng:bind-attr") || "{}")),
          (d[qb[b] || b] = a),
  ...
  G("ng:switch", function (a) {
    ...
    for (; g--; )
      (h = o(f[g])),
        ...
        s(j)
          ? (d[j] = this.compile(h))
          : s(h.attr("ng:switch-default")) && (e = this.compile(h));
    f = null;
    a.html("");
    return function (a) {
      var f = 0,
    ...
    return function (b) {
      ...
      this.$watch(function (a) {
        ...
        if (M(f)) r = f || [];
          ...
          r = [];
          for (B in f) f.hasOwnProperty(B) && B.charAt(0) != "$" && r.push(B);
          r.sort();
        }
        e = 0;
        ...
        for (B in l)
          if (l.hasOwnProperty(B))
            for (r = l[B]; r.length; )
              (p = r.pop()), p.element.remove(), p.scope.$destroy();
        l = t;
      });
    };
  });
  ...
  $("list", function () {
    ...
    this.$parseModel = function () {
      ...
      if (M(b) && (!s(this.$viewValue) || !P(a(this.$viewValue), b)))
    ...
    return (
      ...
      pa("$defer", "$formFactory", function (a, d, e) {
        var d = d.forElement(e),
          ...
          j,
          i,
          l = S(e.attr("ng:pattern")),
          m = parseInt(e.attr("ng:minlength"), 10),
          n = parseInt(e.attr("ng:maxlength"), 10);
        g = f.match(/^\s*\@\s*(.*)/);
        l
          ? l.match(/^\/(.*)\/$/)
            ...
            : (j = function (a) {
                var b = h.$eval(l);
                if (!b || !b.test)
                  throw new u("Expected " + l + " to be a RegExp but was " + b);
                return b.test(a);
              })
          : (j = Sa(!0));
        f = z(f);
        ...
        function f() {
          function a() {
            ...
            for (q = e.length; u < q; u++) {
              ...
              k = d[i];
              if (x.length <= u)
                (n = { element: w.clone().attr("label", i), label: k.label }),
                  (o = [n]),
                  x.push(o),
                  c.append(n.element);
              else if (((o = x[u]), (n = o[0]), n.label != i))
                n.element.attr("label", (n.label = i));
              A = null;
              v = 0;
              for (z = k.length; v < z; v++)
                if (((i = k[v]), (p = o[v + 1]))) {
                  ...
                  i.id === "" && y
                    ...
                    A ? A.after(C) : n.element.append(C),
                    (A = C);
          ...
          var e = this,
            ...
            r = Y(d[2] ? d[1] : h),
            s = Y(d[7]),
            t = o(K.createElement("option")),
            w = o(K.createElement("optgroup")),
            y = !1,
            x = [[{ element: c, label: "" }]];
          k(c.children(), function (a) {
            ...
            e.$apply(function () {
              ...
              if (j) {
                ...
                for (q = x.length; m < q; m++) {
                  a = x[m];
                  n = 1;
                  for (o = a.length; n < o; n++)
                    if ((k = a[n].element)[0].selected)
  ...
  var dd = (function (a) {
    Cb();
    var a = a.getElementsByTagName("script"),
      a = a[a.length - 1],
      b = a.src,
      c = {},
      d;
    ...
    Aa(o(a), function (a, b) {
      /^ng:/.exec(b) &&
        ((b = b.substring(3).replace(/-/g, "_")), (c[b] = a || !0));
    });
    return c;
  })(K);
  $a(K).ready(function () {
