  ...
  forEach(
    ...
    function (fn, name) {
      ...
      JQLite.prototype[name] = function (arg1, arg2) {
        ...
        if (
          (fn.length == 2 && fn !== JQLiteHasClass ? arg1 : arg2) === undefined
        ) {
          if (isObject(arg1)) {
       ...
       */
        ...
        Compiler.prototype = {
          compile: function (templateElement) {
            ...
            template =
              this.templatize(templateElement, index) || new Template();
          ...
          templatize: function (element, elementIndex) {
            ...
            if (descend) {
              ...
              for (
                var i = 0, child = element[0].childNodes;
                i < child.length;
                i++
              ) {
            ...
            if (directives) {
              ...
              eachAttribute(element, function (value, name) {
                ...
                if (fn) {
                  ...
                  template.addLinkFn(
                    isArray(fn) || fn.$inject
                      ? $injector.invoke(fn, selfApi, {
                          $value: value,
                          $element: element,
                        })
      ...
      function ($rootScope, $browser, $sniffer, $document) {
        ...
        if (html5Mode) {
          ...
          $document.bind("click", function (event) {
            ...
            if (
              !href ||
              isDefined(elm.attr("ng:ext-link")) ||
              elm.attr("target")
            )
              return;
 ...
 */
  angularDirective("ng:bind", function (expression, element) {
    ...
    return [
      ...
      "$parse",
      "$element",
      function ($exceptionHandler, $parse, element) {
 ...
 */
  angularWidget("form", function (form) {
    ...
    return [
      "$formFactory",
      "$element",
      function ($formFactory, formElement) {
            ...
            function render() {
              ...
              for (index = 0; (length = keys.length), index < length; index++) {
                optionScope[valueName] =
                  values[
                    keyName ? (optionScope[keyName] = keys[index]) : index
                  ];
      ...
      api.path = function () {
        return this.addFutureAction(
          ...
          function ($window, $document, done) {
              ...
              null,
              $window.angular.injector(["ng"]).get("$location").path()
            );
          }
        );
      };
      ...
      api.search = function () {
        return this.addFutureAction(
          ...
          function ($window, $document, done) {
              ...
              null,
              $window.angular.injector(["ng"]).get("$location").search()
            );
          }
        );
      };
      ...
      api.hash = function () {
        return this.addFutureAction(
          ...
          function ($window, $document, done) {
              ...
              null,
              $window.angular.injector(["ng"]).get("$location").hash()
            );
          }
        );
      };
