...
(function (bL, r, a8) {
            ...
            if (cT === Q) {
              ...
              if (cT === aK) {
                if (cP instanceof Array) {
                  ...
                  if (cP instanceof Date) {
                    cN.push(ax.String["quoteUnicode"](ax.Date["toString"](cP)));
                  } else {
                    cN.push("{");
                    if (cS) {
                      cN.push(cS);
  ...
  a4.prototype = {
    ...
    templatize: function (cR, cN, cV) {
      var cZ = this,
        ...
        cY,
        cX = {
          compile: bu(cZ, cZ.compile),
          comment: function (c0) {
            return cb(r.createComment(c0));
          },
          element: function (c0) {
            return cb(r.createElement(c0));
          },
          text: function (c0) {
            return cb(r.createTextNode(c0));
          },
          descend: function (c0) {
            if (cm(c0)) {
              cU = c0;
          ...
          scope: function (c0) {
            if (cm(c0)) {
              cY.newScope = cY.newScope || c0;
            }
            return cY.newScope;
          },
        };
      try {
        cV = cR.attr("ng:eval-order") || cV || 0;
      } catch (cT) {
        cV = cV || 0;
      }
      if (b9(cV)) {
        cV = aH[bx(cV)] || parseInt(cV, 10);
      }
      cY = new cn(cV);
      aZ(cR, function (c1, c0) {
        if (!cS) {
          if ((cS = cZ.widgets("@" + c0))) {
            cS = bu(cX, cS, c1, cR);
          }
      ...
      if (cS) {
        ...
        cP = false;
        var cW = cR.parent();
        cY.addInit(cS.call(cX, cR));
        if (cW && cW[0]) {
          cR = cb(cW[0].childNodes[cN]);
        }
      }
      if (cU) {
        for (var cQ = 0, cM = cR[0].childNodes; cQ < cM.length; cQ++) {
          if (t(cM[cQ])) {
            aN(cZ.markup, function (c0) {
              if (cQ < cM.length) {
                var c1 = cb(cM[cQ]);
                c0.call(cX, c1.text(), c1, cR);
              }
            });
          }
        }
      ...
      if (cP) {
        aZ(cR, function (c1, c0) {
          aN(cZ.attrMarkup, function (c2) {
            c2.call(cX, c1, c0, cR);
          });
        });
        aZ(cR, function (c1, c0) {
          cY.addInit((cO[c0] || j).call(cX, c1, cR));
        });
      }
      if (cU) {
        aS(cR, function (c1, c0) {
          cY.addChild(c0, cZ.templatize(c1, c0, cV));
        });
      }
      return cY.empty() ? a1 : cY;
    },
  };
  function aS(cN, cO) {
    var cM,
  ...
  cl.linky = function (cT) {
    ...
    function cU(cV) {
      return cV.replace(/([\/\.\*\+\?\|\(\)\[\]\{\}\\])/g, "\\$1");
    }
    var cR = /(ftp|http|https|mailto):\/\/([^\(\)|\s]+)/;
    var cQ;
    var cS = cT;
    var cP = [];
    var cN = a0(cP);
    var cM;
    var cO;
    while ((cQ = cS.match(cR))) {
      cM = cQ[0].replace(/[\.\;\,\(\)\{\}\<\>]$/, "");
      cO = cS.indexOf(cM);
      cN.chars(cS.substr(0, cO));
      cN.start("a", { href: cM });
      cN.chars(cM);
      cN.end("a");
      cS = cS.substring(cO + cM.length);
    }
    cN.chars(cS);
    return new aR(cP.join(""));
  };
  function aV(cM, cN) {
  ...
  cc(
    ...
    function (cS) {
      var cZ = this,
        cW = { toString: cN, update: cR, updateHash: cV },
        cP = cS.getUrl(),
        cT;
      ...
      function cR(c0) {
        if (b9(c0)) {
          ...
          bY(cW, c0);
          if (cm(c0.hashPath || c0.hashSearch)) {
            cW.hash = cO(cW);
          }
          cW.href = cX(cW);
        }
      ...
      function cU() {
        cM();
        if (cW.href != cP) {
          cS.setUrl((cP = cW.href));
          cT = cW.hash;
        }
      }
      function cX(c2) {
        var c1 = O(c2.search);
        var c0 = c2.port == cr[c2.protocol] ? a1 : c2.port;
        return (
          c2.protocol +
          "://" +
          c2.host +
      ...
      function cO(c1) {
        var c0 = O(c1.hashSearch);
        return escape(c1.hashPath) + (c0 ? "?" + c0 : "");
      }
      function cY(c0) {
        var c2 = {};
        var c1 = I.exec(c0);
        if (c1) {
          ...
          c2.protocol = c1[1];
          c2.host = c1[3] || "";
          c2.port = c1[5] || cr[c2.protocol] || a1;
          c2.path = c1[6] || "";
          c2.search = af(c1[8]);
          c2.hash = c1[10] || "";
          bY(c2, cQ(c2.hash));
      ...
      function cQ(c2) {
        ...
        if (c0) {
          c1.hash = c2;
          c1.hashPath = unescape(c0[1] || "");
          c1.hashSearch = af(c0[3]);
        }
        return c1;
      }
    },
    ...
    return function (cO) {
      ...
      this.$onEval(function () {
        var cR,
          ...
          cT,
          cU,
          cQ = this.hasOwnProperty(bo) ? this.$element : cI;
        this.$element = cO;
        cV = this.$tryEval(cM, function (cW) {
          cR = cd(cW);
        });
        this.$element = cQ;
        if ((cT = cV instanceof aR)) {
          cV = (cS = cV).html;
        }
        if (cN === cV && cP == cR) {
          return;
  ...
  aa("ng:bind-template", function (cM) {
    var cN = cJ(cM);
    return function (cP) {
      var cO;
      this.$onEval(function () {
        var cQ = cN.call(this, cP);
        if (cQ != cO) {
          cP.text(cQ);
          cO = cQ;
        }
  ...
  function i(cQ, cP) {
    var cM = bZ(r.body);
    var cN = [];
    if (cP.scenario_output) {
      cN = cP.scenario_output.split(",");
    }
    ax.foreach(ax.scenario.output, function (cU, cS) {
      if (!cN.length || cE(cN, cS) != -1) {
        var cT = cM.append("<div></div>").find("div:last");
        cT.attr("id", cS);
        cU.call({}, cT, cQ);
      }
    });
    var cR = cM.append('<div id="application"></div>').find("#application");
    var cO = new ax.scenario.Application(cR);
    cQ.on("RunnerEnd", function () {
      cR.css("display", "none");
      cR.find("iframe").attr("src", "about:blank");
    });
    cQ.on("RunnerError", function (cS) {
      if (bL.console) {
        console.log(W(cS));
      } else {
        alert(cS);
  ...
  ax.scenario.Application.prototype.navigateTo = function (cO, cN) {
    var cM = this;
    var cP = this.getFrame_();
    if (cO.charAt(0) === "#") {
      cO = cP.attr("src").split("#")[0] + cO;
      cP.attr("src", cO);
      this.executeAction(cN);
    } else {
    ...
    this.context.find("> h2 a").attr("href", cO).text(cO);
  };
  ...
  ax.scenario.SpecRunner.prototype.run = function (cN, cQ) {
    var cM = this;
    var cO = 0;
    this.spec = cN;
    ...
    try {
      ...
      this.emit("SpecError", cN, cP);
      this.emit("SpecEnd", cN);
      cQ();
      return;
    }
    var cR = function (cT, cS) {
      if (cM.error) {
        return cS();
      }
      cM.error = true;
      cS(null, cM.afterIndex);
    };
    X(
      this.futures,
      function (cS, cT) {
        cM.step = cS;
        cM.emit("StepBegin", cN, cS);
        try {
          cS.execute(function (cV) {
            if (cV) {
              cM.emit("StepFailure", cN, cS, cV);
              cM.emit("StepEnd", cN, cS);
              return cR(cV, cT);
            }
            cM.emit("StepEnd", cN, cS);
            if (cO++ % 10 === 0) {
  ...
  ax.scenario.dsl("navigateTo", function () {
    return function (cN, cO) {
      var cM = this.application;
      return this.addFuture("navigate to " + cN, function (cP) {
        if (cO) {
          cN = cO.call(this, cN);
        }
        cM.navigateTo(cN, function () {
          cP(null, cN);
        });
      });
    };
  ...
  ax.scenario.dsl("using", function () {
    return function (cM) {
      this.selector = (this.selector || "") + " " + cM;
      return this.dsl;
    };
  });
    ...
    return function (cM) {
      return this.addFutureAction(
        ...
        function (cR, cQ, cN) {
          var cO;
          try {
            cO = cQ.elements('[ng\\:bind-template*="{{$1}}"]', cM);
          } catch (cP) {
            if (cP.type !== "selector") {
              throw cP;
            }
            cO = cQ.elements('[ng\\:bind="$1"]', cM);
          }
          cN(null, cO.text());
        }
      );
  ...
  ax.scenario.dsl("repeater", function () {
    ...
    cM.column = function (cN) {
      return this.addFutureAction(
        "repeater " + this.selector + " column " + cN,
        function (cR, cQ, cO) {
          var cP = [];
  ...
  ax.scenario.dsl("element", function () {
    ...
    cM.click = function () {
      return this.addFutureAction(
        ...
        function (cR, cQ, cN) {
          ...
          var cO = cP.attr("href");
          cP.trigger("click");
          if (cO && cP[0].nodeName.toUpperCase() === "A") {
            this.application.navigateTo(cO, function () {
              cN();
            });
          } else {
            cN();
    ...
    cM.attr = function (cN, cP) {
      var cO = "element " + this.selector + " get attribute " + cN;
      if (cP) {
        cO = "element " + this.selector + " set attribute " + cN + " to " + cP;
      }
      return this.addFutureAction(cO, function (cS, cR, cQ) {
        cQ(null, cR.elements().attr(cN, cP));
      });
    };
    cM.val = function (cO) {
      var cN = "element " + this.selector + " value";
      if (cO) {
        cN = "element " + this.selector + " set value to " + cO;
      }
      return this.addFutureAction(cN, function (cR, cQ, cP) {
        cP(null, cQ.elements().val(cO));
      });
    };
    cM.query = function (cN) {
      return this.addFutureAction(
        "element " + this.selector + " custom query",
        function (cQ, cP, cO) {
          cN.call(this, cP.elements(), cO);
        }
      );
    };
    return function (cN) {
