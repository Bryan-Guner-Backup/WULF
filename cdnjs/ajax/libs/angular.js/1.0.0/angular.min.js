...
(function (T, $, p) {
  ...
  function bb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && s(a.length) && !na(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
          ...
          function e(a, c, d, g) {
            for (var j, i, n, k, l, o = 0, r = 0, q = f.length; o < q; r++)
              (n = c[r]),
                ...
                j
                  ? (j.scope
                      ? ((k = a.$new(J(j.scope))), u(n).data("$scope", k))
                      : (k = a),
                    (l = j.transclude) || (!g && b)
                      ? j(
                          i,
                      ...
                      : j(i, k, n, p, g))
                  : i && i(a, n.childNodes, p, g);
          }
          for (var f = [], g, j, i, n = 0; n < a.length; n++)
            (j = new ca()),
              (g = fa(a[n], [], j, d)),
              (j =
                (g = g.length ? A(g, a[n], j, b, c) : null) && g.terminal
                  ? null
                  : t(a[n].childNodes, g ? g.transclude : b)),
              f.push(g),
              f.push(j),
              (i = i || g || j);
          return i ? e : null;
              ...
              N("transclusion", x, E, F),
                ...
                B == "element"
                  ? ((Z = u(b)),
                    ...
                    Ga(e, u(Z[0]), b),
                    (v = w(Z, d, l)))
                  : ((Z = u(cb(b)).contents()), F.html(""), (v = w(Z, d)));
            if ((B = E.template))
              if (
                (N("template", H, E, F),
                (H = E),
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((i = d.baseHref() || "/"),
            ...
            (f = e.history
              ? new fb(Ec(k, i, b), j, l)
              : new Hb(Fc(k, i, b), b, l, i.substr(j.length + 1))))
          : ((l =
    ...
    this.$get = [
      ...
      function (a, c, d, e, g, h, f) {
        ...
        function j() {
          ...
          m(b, function (b, e) {
            if (!d && (a = l(c.path(), e)))
              (d = xa(b, { params: D({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
