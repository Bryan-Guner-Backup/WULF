...
(function (window, angular, undefined) {
  ...
  var DEPENDENCIES = {
    "angular.js":
      "http://code.angularjs.org/angular-" + angular.version.full + ".min.js",
    "angular-resource.js":
      "http://code.angularjs.org/angular-resource-" +
      angular.version.full +
      ".min.js",
    "angular-sanitize.js":
      "http://code.angularjs.org/angular-sanitize-" +
      angular.version.full +
      ".min.js",
    "angular-cookies.js":
      "http://code.angularjs.org/angular-cookies-" +
      angular.version.full +
      ".min.js",
  };
    ...
    function (reindentCode) {
      return {
        ...
        compile: function (element) {
          element.html(
            window.prettyPrintOne(reindentCode(element.html()), undefined, true)
          );
        },
      };
    },
    ...
    function (getEmbeddedTemplate) {
      return {
        ...
        compile: function (element, attr) {
          setHtmlIe8SafeWay(
            element,
            escape(getEmbeddedTemplate(attr.ngSetText))
          );
        },
      };
    },
      ...
      return {
        compile: function (element, attr) {
          ...
          angular.forEach((attr.ngHtmlWrap || "").split(" "), function (dep) {
            ...
            if (ext == "css") {
              properties.head +=
                '<link rel="stylesheet" href="' + dep + '" type="text/css">\n';
            } else if (ext == "js") {
