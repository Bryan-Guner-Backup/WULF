...
(function (V, aa, p) {
  ...
  function Zb(b, a, c) {
    for (var d = ib(b), e = 0; e < d.length; e++) a.call(c, b[d[e]], d[e]);
    return d;
  }
  function jb(b) {
    return function (a, c) {
  ...
  function Oa(b, a) {
    return C(new (C(function () {}, { prototype: b }))(), a);
  }
  function r() {}
  function ua(b) {
    return b;
  ...
  function ka(b) {
    return Pa.apply(b) == "[object Date]";
  }
  function M(b) {
    return Pa.apply(b) == "[object Array]";
  }
  function P(b) {
  ...
  function R(b) {
    return J(b) ? b.replace(/^\s*/, "").replace(/\s*$/, "") : b;
  }
  function $b(b) {
  ...
  function W(b, a) {
    ...
    if (a) {
      if (b === a) throw B("Can't copy equivalent objects or arrays");
      if (M(b)) {
        for (; a.length; ) a.pop();
  ...
  function ea(b, a) {
    ...
    if (c == typeof a && c == "object")
      if (M(b)) {
      ...
      } else if (ka(b)) return ka(a) && b.getTime() == a.getTime();
      else {
        if (
        ...
        c = {};
        for (d in b) {
          if (d.charAt(0) !== "$" && !P(b[d]) && !ea(b[d], a[d])) return !1;
          c[d] = !0;
        }
        for (d in a) if (!c[d] && d.charAt(0) !== "$" && !P(a[d])) return !1;
        return !0;
      }
    return !1;
  }
  ...
  function Ya(b, a) {
    function c() {
      var e;
      for (var b = [this], c = a, i, f, h, j, k, n, m; b.length; ) {
        i = b.shift();
        f = 0;
  ...
  function N(b) {
    ...
    if (!(this instanceof N)) {
      if (J(b) && b.charAt(0) != "<") throw B("selectors not implemented");
      return new N(b);
    }
    if (J(b)) {
  ...
  function oa(b) {
    pb(b);
    for (var a = 0, b = b.childNodes || []; a < b.length; a++) oa(b[a]);
  }
  function qb(b, a, c) {
    var d = ca(b, "events");
    ca(b, "handle") &&
  ...
  function pb(b) {
    var a = b[xa],
      c = ya[a];
    c &&
      (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), qb(b)),
      delete ya[a],
      (b[xa] = p));
  }
  function ca(b, a, c) {
    var d = b[xa],
      d = ya[d || -1];
    if (u(c)) d || ((b[xa] = d = ++ic), (d = ya[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function sb(b, a, c) {
    var d = ca(b, "data"),
  ...
  function Za(b, a) {
    if (a)
      for (
        var a = !a.nodeName && u(a.length) && !la(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
  ...
  function wb(b, a) {
    return xb[b.nodeName] && Ba[a.toLowerCase()];
  }
  function jc(b, a) {
    var c = function (c, e) {
      if (!c.preventDefault)
    ...
    function g(a, b) {
      function c(d) {
        ...
        if (a.hasOwnProperty(d)) {
          if (a[d] === i) throw B("Circular dependency: " + h.join(" <- "));
          return a[d];
        } else
          try {
      ...
      function d(a, b, e) {
        ...
        typeof a == "function"
          ? ((j = kc(a)), (g = j.length))
          : (M(a) && ((j = a), (g = j.length - 1), (a = j[g])), na(a, "fn"));
        for (var m = 0; m < g; m++)
          (i = j[m]), f.push(e && e.hasOwnProperty(i) ? e[i] : c(i, h));
        switch (b ? -1 : f.length) {
          case 0:
            return a();
          case 1:
  ...
  function qc(b, a, c, d) {
        ...
        ? ((G = a),
          d.history
            ? b
              ...
              : (k.pushState(null, "", a), H.attr("href", H.attr("href")))
            : b
            ? j.replace(a)
            : (j.href = a),
          f)
    ...
    f.onUrlChange = function (a) {
      T ||
        (d.history && t(b).bind("popstate", i),
        d.hashchange ? t(b).bind("hashchange", i) : f.addPollFn(i),
        (T = !0));
      z.push(a);
      return a;
    };
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (J(b))
            (d =
              (h.cookie = escape(a) + "=" + escape(b) + ";path=" + K).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        if (h.cookie !== x) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (j = e.indexOf("=")),
              j > 0 &&
                (X[unescape(e.substring(0, j))] = unescape(e.substring(j + 1)));
        }
        return X;
      }
    };
    ...
    f.defer.cancel = function (a) {
      return s[a] ? (delete s[a], m(a), e(r), !0) : !1;
    };
  }
  function rc() {
    this.$get = [
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            var c = k[a] || (k[a] = { key: a });
            e(c);
            v(b) || (a in h || i++, (h[a] = b), i > j && this.remove(m.key));
          },
          get: function (a) {
            var b = k[a];
            if (b) return e(b), h[a];
  ...
  function yb(b) {
    ...
    this.$get = [
      ...
      function (b, h, j, k, n, m, s) {
        ...
        function w(a, b, c, d) {
          function e(a, c, d, j) {
            for (var g, m, h, k, n, S = 0, s = 0, o = f.length; S < o; s++)
              (h = c[s]),
                (g = f[S++]),
                (m = f[S++]),
                g
                  ? (g.scope
                      ? ((k = a.$new(L(g.scope))), t(h).data("$scope", k))
                      : (k = a),
                    (n = g.transclude) || (!j && b)
                      ? g(
                          m,
                      ...
                      : g(m, k, h, p, j))
                  : m && m(a, h.childNodes, p, j);
          }
          for (var f = [], j, g, h, m = 0; m < a.length; m++)
            (g = new v()),
              (j = G(a[m], [], g, d)),
              (g =
                (j = j.length ? H(j, a[m], g, b, c) : null) && j.terminal
                  ? null
                  : w(a[m].childNodes, j ? j.transclude : b)),
              f.push(j),
              f.push(g),
              (h = h || j || g);
          return h ? e : null;
        ...
        function G(a, b, c, f) {
          ...
          switch (a.nodeType) {
            case 1:
              z(b, da(zb(a).toLowerCase()), "E", f);
              var m, h, k;
              g = a.attributes;
              for (var n = 0, s = g && g.length; n < s; n++)
                if (((m = g[n]), m.specified))
                  (h = m.name),
                    (k = da(h.toLowerCase())),
                    (j[k] = h),
                    (c[k] = m =
                      R(
                        $ && h == "href"
                          ? decodeURIComponent(a.getAttribute(h, 2))
                          : m.value
                      )),
                    wb(a, k) && (c[k] = !0),
                    Y(a, b, m, k),
        ...
        function H(a, b, c, d, e) {
          function f(a, b) {
            if (a) (a.require = y.require), n.push(a);
            if (b) (b.require = y.require), w.push(b);
          }
          function m(a, b) {
            var c,
              d = "data",
          ...
          function h(a, d, e, f, g) {
            var k, S, o, q, T;
            k = b === e ? c : bc(c, new v(t(e), c.$attr));
            S = k.$$element;
            x &&
              L(x.scope) &&
              l(x.scope, function (a, b) {
                (fa[a] || O)(b, a, d.$parent || d, d, k);
              });
            A &&
              l(A, function (a) {
                var b = { $scope: d, $element: S, $attrs: k, $transclude: g };
                l(a.inject || {}, function (a, c) {
                  (fa[a] || O)(c, a, x ? d.$parent || d : d, b, k);
                });
                T = a.controller;
                T == "@" && (T = k[a.name]);
                S.data("$" + a.name + "Controller", s(T, b));
              });
            f = 0;
            for (o = n.length; f < o; f++)
              try {
                (q = n[f]), q(d, S, k, q.require && m(q.require, S));
              } catch (vc) {
                j(vc, wa(S));
              }
            a && a(d, e.childNodes, p, g);
            f = 0;
            for (o = w.length; f < o; f++)
              try {
                (q = w[f]), q(d, S, k, q.require && m(q.require, S));
              } catch (uc) {
                j(uc, wa(S));
              }
          }
          for (
            ...
            y = a[I];
            r = p;
            if (k > y.priority) break;
            if ((D = y.scope))
              K("isolated scope", H, y, F),
                L(D) && (q(F, "ng-isolate-scope"), (H = y)),
                q(F, "ng-scope"),
                (x = x || y);
            Y = y.name;
            if ((D = y.controller))
              (A = A || {}),
                K("'" + Y + "' controller", A[Y], y, F),
                (A[Y] = y);
            if ((D = y.transclude))
              K("transclusion", C, y, F),
                (C = y),
                (k = y.priority),
                D == "element"
                  ? ((r = t(b)),
                    ...
                    Da(e, t(r[0]), b),
                    (u = o(r, d, k)))
                  : ((r = t($a(b)).contents()), F.html(""), (u = o(r, d)));
            if ((D = y.template))
              if (
                (K("template", z, y, F),
                (z = y),
                (r = t("<div>" + R(D) + "</div>").contents()),
                (b = r[0]),
                y.replace)
              ) {
                if (r.length != 1 || b.nodeType !== 1) throw new B(g + D);
                Da(e, F, b);
                Y = { $attr: {} };
                a = a.concat(G(b, a.splice(I + 1, a.length - (I + 1)), Y));
                T(c, Y);
                N = a.length;
              } else F.html(D);
            if (y.templateUrl)
              K("template", z, y, F),
                (z = y),
                (h = X(a.splice(I, a.length - I), h, F, c, e, y.replace, u)),
                (N = a.length);
            else if (y.compile)
              try {
                (E = y.compile(F, c, u)),
                  P(E) ? f(null, E) : E && f(E.pre, E.post);
              } catch (Q) {
                j(Q, wa(F));
              }
            if (y.terminal) (h.terminal = !0), (k = Math.max(k, y.priority));
          }
          h.scope = x && x.scope;
          h.transclude = C && u;
          return h;
        ...
        function z(d, e, g, h) {
          ...
          if (a.hasOwnProperty(e))
            for (var k, e = b.get(e + c), n = 0, s = e.length; n < s; n++)
              try {
                if (
                  ((k = e[n]),
                  (h === p || h > k.priority) && k.restrict.indexOf(g) != -1)
                )
                  d.push(k), (m = !0);
              } catch (q) {
                j(q);
        ...
        function X(a, b, c, d, e, f, j) {
          ...
          c.html("");
          k.get(o.templateUrl, { cache: n })
            .success(function (k) {
              var n, o;
              if (f) {
                o = t("<div>" + R(k) + "</div>").contents();
                n = o[0];
                if (o.length != 1 || n.nodeType !== 1) throw new B(g + k);
                k = { $attr: {} };
                Da(e, c, n);
                G(n, a, k);
                T(d, k);
              ...
              a.unshift(O);
              m = H(a, c, d, j);
              for (s = w(c.contents(), j); h.length; ) {
                var l = h.pop(),
                  k = h.pop();
                o = h.pop();
                var x = h.pop(),
                  K = n;
                o !== q && ((K = $a(n)), Da(k, t(o), K));
                m(
                  function () {
                    b(s, x, K, e, l);
                  },
            ...
            accessor: function (a, b, c, d, e) {
              ...
              j &&
                ...
                (g =
                  f.assign ||
                  function () {
                    throw B("Expression '" + j + "' not assignable.");
                  }));
              d[a] = function (a) {
        ...
        v.prototype = {
          ...
          $set: function (a, b, c, d) {
            var e = wb(this.$$element[0], a.toLowerCase());
            e && (this.$$element.prop(a, b), (d = e));
            this[a] = b;
            d
              ? (this.$attr[a] = d)
              : (d = this.$attr[a]) || (this.$attr[a] = d = Xa(a, "-"));
            c !== !1 &&
              (b === null || b === p
  ...
  function yc() {
    this.$get = [
      ...
      function (b, a, c) {
        ...
        c.warn("$defer service has been deprecated, migrate to $timeout");
        d.cancel = function (b) {
    ...
    this.$get = [
      ...
      function (c) {
        var d = b.length,
          e = a.length;
        return function (g, i) {
          for (var f, h, j = 0, k = [], n = g.length, m = !1, s = []; j < n; )
            (f = g.indexOf(b, j)) != -1 && (h = g.indexOf(a, f + d)) != -1
              ? (j != f && k.push(g.substring(j, f)),
                k.push((j = c((m = g.substring(f + d, h))))),
                (j.exp = m),
                (j = h + e),
                (m = !0))
  ...
  function Ab(b) {
    for (var b = b.split("/"), a = b.length; a--; ) b[a] = Wa(b[a]);
    return b.join("/");
  }
  function Ea(b, a) {
    var c = Bb.exec(b),
  ...
  function Dc(b, a, c) {
    ...
    if (decodeURIComponent(d.path) == a) return b;
      ...
      if (d.path.indexOf(i) !== 0)
        throw 'Invalid url "' + b + '", missing path prefix "' + i + '" !';
      return ra(d.protocol, d.host, d.port) + a + "#" + c + f + e + g;
    }
  }
  function cb(b, a) {
    a = a || "";
    this.$$parse = function (b) {
      ...
      this.$$search = Ua(d.search);
      this.$$hash = (d.hash && decodeURIComponent(d.hash)) || "";
      this.$$compose();
    };
    this.$$compose = function () {
      var b = lb(this.$$search),
        d = this.$$hash ? "#" + Wa(this.$$hash) : "";
      this.$$url = Ab(this.$$path) + (b ? "?" + b : "") + d;
      this.$$absUrl =
  ...
  function db(b, a) {
    ...
    this.$$parse = function (b) {
      ...
      e = Ec.exec((e.hash || "").substr(a.length));
      this.$$path = e[1]
      ...
      function (c, d, e, g) {
        ...
        if (a) {
          var e = (i = e.history
              ? new cb(Cc(j, f, b), h)
              : new db(Dc(j, f, b), b)),
            k = ra(e.protocol(), e.host(), e.port()) + h;
          g.bind("click", function (a) {
            if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
              for (var b = t(a.target); b.length && D(b[0].nodeName) !== "a"; )
                b = b.parent();
              var d = b.prop("href");
              if (d && !(b.attr("target") || d.indexOf(k) !== 0))
                i.url(d.substr(k.length)),
                  c.$apply(),
                  a.preventDefault(),
  ...
  function Hc(b, a) {
    ...
    function k() {
      ...
      d = { index: d, text: c };
      if (Ga.hasOwnProperty(c)) d.fn = d.json = Ga[c];
      else {
        var n = Eb(c, a);
        d.fn = C(
          function (a, b) {
      ...
      h &&
        ...
        m.push({ index: f + 1, text: h, json: !1 }));
    }
    function n(a) {
      var c = o;
      o++;
      for (var d = "", e = a, f = !1; o < b.length; ) {
        ...
        if (f)
          j == "u"
            ? ((j = b.substring(o + 1, o + 5)),
              j.match(/[\da-f]{4}/i) ||
                h("Invalid unicode escape [\\u" + j + "]"),
              (o += 4),
              (d += String.fromCharCode(parseInt(j, 16))))
            : ((f = Ic[j]), (d += f ? f : j)),
            (f = !1);
        else if (j == "\\") f = !0;
        else if (j == a) {
    ...
    for (var m = [], s, o = 0, l = [], q, w = ":"; o < b.length; ) {
      q = b.charAt(o);
      if (c("\"'")) n(q);
      else if (e(q) || (c(".") && e(d()))) j();
      else if (i(q)) {
        if (
          (k(), "{,".indexOf(w) != -1 && l[0] == "{" && (s = m[m.length - 1]))
        )
        ...
        var G = q + d(),
          ...
          z = Ga[G];
        z
          ? (m.push({ index: o, text: G, fn: z }), (o += 2))
          : H
          ? (m.push({
              index: o,
              text: q,
  ...
  function Jc(b, a, c, d) {
    ...
    function g() {
      if (K.length === 0) throw B("Unexpected end of expression: " + b);
      return K[0];
    }
    function i(a, b, c, d) {
      if (K.length > 0) {
    ...
    function f(b, c, d, f) {
      return (b = i(b, c, d, f))
        ? (a && !b.json && e("is not valid json", b), K.shift(), b)
        : !1;
    }
    function h(a) {
    ...
    function q() {
      var a;
      a = w();
      for (var b; (b = f("+", "-")); ) a = k(a, b.fn, w());
      if ((b = f("<", ">", "<=", ">="))) a = k(a, b.fn, q());
      return a;
    }
    function w() {
      for (var a = G(), b; (b = f("*", "/", "%")); ) a = k(a, b.fn, G());
      return a;
    }
    function G() {
      var a;
  ...
  function Eb(b, a) {
    if (eb.hasOwnProperty(b)) return eb[b];
    var c = b.split("."),
      d = c.length,
      e;
    if (a)
      e =
        d < 6
          ? Gb(c[0], c[1], c[2], c[3], c[4])
          : function (a, b) {
              var e = 0,
                j;
              do
                (j = Gb(c[e++], c[e++], c[e++], c[e++], c[e++])(a, b)),
                  (b = p),
                  (a = j);
              while (e < d);
              return j;
    ...
    this.$get = [
      ...
      function (a, c) {
        return function (d) {
          switch (typeof d) {
            case "string":
              return b.hasOwnProperty(d) ? b[d] : (b[d] = Jc(d, !1, a, c.csp));
            case "function":
              return d;
            default:
              return r;
    ...
    this.$get = [
      ...
      function (a, c, d) {
        function e() {
          ...
          l(b, function (b, e) {
            if (!d && (a = i(c.path(), e)))
              (d = Oa(b, { params: C({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
          return d || (b[null] && Oa(b[null], { params: {}, pathParams: {} }));
        }
        function g(a, b) {
          var c = [];
        ...
        e.prototype = {
                        ...
                        (l = !0),
                          ...
                          q < 5 &&
                            ...
                            (z = P(a.exp)
                              ...
                              : a.exp),
                            (z += "; newVal: " + ba(d) + "; oldVal: " + ba(e)),
                            G[H].push(z));
                    } catch (X) {
                      c(X);
                    }
                if (!(i = w.$$childHead || (w !== this && w.$$nextSibling)))
                  for (; w !== this && !(i = w.$$nextSibling); ) w = w.$parent;
              } while ((w = i));
              if (l && !q--)
                throw (
                  ((h.$$phase = null),
          ...
          $emit: function (a, b) {
            var d = [],
              ...
              i = [h].concat(ga.call(arguments, 1)),
              l,
              G;
            do {
              e = f.$$listeners[a] || d;
              ...
              for (G = e.length; l < G; l++)
                try {
                  if ((e[l].apply(null, i), g)) return h;
                } catch (H) {
                  c(H);
                }
              f = f.$parent;
  ...
  function Qc() {
    this.$get = [
      ...
      function (b) {
        var a = {},
          c = E((/android (\d+)/.exec(D(b.navigator.userAgent)) || [])[1]);
        return {
  ...
  function Sc() {
      ...
      d = (this.defaults = {
        transformResponse: [
          function (d) {
            J(d) &&
              ((d = d.replace(c, "")),
              b.test(d) && a.test(d) && (d = kb(d, !0)));
            return d;
          },
        ],
        transformRequest: [
          function (a) {
            return L(a) && Pa.apply(a) !== "[object File]" ? ba(a) : a;
          },
        ],
        headers: {
          common: {
    ...
    this.$get = [
      ...
      function (a, b, c, h, j, k) {
        function n(a) {
          function c(a) {
            var b = C({}, a, { data: Jb(a.data, a.headers, f) });
            return 200 <= a.status && a.status < 300 ? b : j.reject(b);
          }
          a.method = ja(a.method);
        ...
        function m(b, c, d) {
          function e(a, b, c) {
            l && (200 <= a && a < 300 ? l.put(O, [a, b, Hb(c)]) : l.remove(O));
            f(b, a, c);
            h.$apply();
          }
          function f(a, c, d) {
          ...
          m.then(i, i);
          b.cache && b.method == "GET" && (l = L(b.cache) ? b.cache : o);
          if (l)
            if ((p = l.get(O)))
              if (p.then) return p.then(i, i), p;
              else M(p) ? f(p[1], p[0], W(p[2])) : f(p, 200, {});
            else l.put(O, m);
          p || a(b.method, O, c, e, d, b.timeout, b.withCredentials);
          return m;
        }
        function s(a, b) {
          if (!b) return a;
        ...
        var o = c("$http"),
          O = [];
        l(e, function (a) {
          O.push(J(a) ? k.get(a) : k.invoke(a));
        });
        n.pendingRequests = [];
        (function (a) {
          l(arguments, function (a) {
            n[a] = function (b, c) {
              return n(C(c || {}, { method: a, url: b }));
            };
          });
        ...
        (function (a) {
          l(arguments, function (a) {
            n[a] = function (b, c, d) {
              return n(C(d || {}, { method: a, url: b, data: c }));
            };
          });
        })("post", "put");
        n.defaults = d;
  ...
  function Uc(b, a, c, d, e, g) {
    ...
    return function (e, h, j, k, n, m, s) {
      function o(a, c, d, e) {
        c = (h.match(Bb) || ["", g])[1] == "file" ? (d ? 200 : 404) : c;
        a(c == 1223 ? 204 : c, d, e);
        b.$$completeOutstandingRequest(r);
      }
      ...
      if (D(e) == "jsonp") {
        ...
        q.onreadystatechange = function () {
          q.readyState == 4 &&
            o(k, w || q.status, q.responseText, q.getAllResponseHeaders());
        };
        if (s) q.withCredentials = !0;
        q.send(j || "");
        m > 0 &&
          c(function () {
            w = -1;
  ...
  function Pb(b, a, c, d, e) {
    ...
    if (i.indexOf("e") !== -1) f = i;
      ...
      i = (i.split(Qb)[1] || "").length;
      v(e) && (e = Math.min(Math.max(a.minFrac, i), a.maxFrac));
      var i = Math.pow(10, e),
        b = Math.round(b * i) / i,
        b = ("" + b).split(Qb),
        i = b[0],
        ...
        n = a.gSize;
      if (i.length >= k + n)
        for (var j = i.length - k, m = 0; m < j; m++)
          (j - m) % n === 0 && m !== 0 && (f += c), (f += i.charAt(m));
      for (m = j; m < i.length; m++)
        (i.length - m) % k === 0 && m !== 0 && (f += c), (f += i.charAt(m));
      for (; b.length < e; ) b += "0";
      e && (f += d + b.substr(0, e));
    }
  ...
  function Mb(b) {
    ...
    return function (c, e) {
      ...
      J(c) && (c = cd.test(c) ? E(c) : a(c));
      sa(c) && (c = new Date(c));
      if (!ka(c)) return c;
      for (; e; )
        (h = dd.exec(e))
          ? ((i = i.concat(ga.call(h, 1))), (e = i.pop()))
          : (i.push(e), (e = null));
      l(i, function (a) {
        f = ed[a];
        g += f
  ...
  function Rb(b, a) {
    function c(a, c) {
      c = c ? "-" + Xa(c, "-") : "";
      b.removeClass((a ? Ia : Ja) + c).addClass((a ? Ja : Ia) + c);
    }
    var d = this,
      e = b.parent().controller("form") || Ka,
      g = 0,
      i = (d.$error = {});
    d.$name = a.name;
    d.$dirty = !1;
        ...
        function (b, e) {
          if (a === !0 || c.$index % 2 === a)
            e &&
              ...
              d.removeClass(M(e) ? e.join(" ") : e)),
              L(b) &&
                !M(b) &&
                (b = Qa(b, function (a, b) {
                  if (a) return b;
                })),
              b && d.addClass(M(b) ? b.join(" ") : b);
        },
        !0
      );
    });
  ...
  var D = function (b) {
    ...
    B = V.Error,
    $ = E((/msie (\d+)/.exec(D(navigator.userAgent)) || [])[1]),
    t,
    ha,
    ga = [].slice,
    Na = [].push,
  ...
  var ec = /[A-Z]/g,
    ...
    ya = (N.cache = {}),
    xa = (N.expando = "ng-" + new Date().getTime()),
    ic = 1,
    gd = V.document.addEventListener
      ? function (b, a, c) {
    ...
    rb = V.document.removeEventListener
      ? function (b, a, c) {
  ...
  l(
    {
      ...
      attr: function (b, a, c) {
        ...
        if (Ba[d])
          if (u(c))
            ...
            return b[a] || (b.attributes.getNamedItem(a) || r).specified
              ? d
              : p;
      ...
      html: function (b, a) {
        ...
        for (var c = 0, d = b.childNodes; c < d.length; c++) oa(d[c]);
        b.innerHTML = a;
      },
    },
    function (b, a) {
  ...
  var Qb = ".",
    ed = {
      ...
      Z: function (a) {
        ...
        return fb(a / 60, 2) + fb(Math.abs(a % 60), 2);
      },
    },
    dd =
        ...
        compile: function () {
          return function (d, e, g) {
            ...
            d == p
              ...
              : (g.$set(a, d), e.prop(a, d));
          };
        },
      };
    };
  });
  var Ka = { $addControl: r, $removeControl: r, $setValidity: r, $setDirty: r };
  ...
  var Na = {
    ...
    id = A(Na),
    jd = A(C(W(Na), { restrict: "EAC" })),
    kd =
      /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
    ld = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/,
    md = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
    Vb = {
      text: Ma,
      ...
      function (a, c) {
        return {
          ...
          link: function (d, e, g, i) {
            i && (Vb[D(g.type)] || Vb.text)(d, e, g, i, c, a);
          },
        };
      },
    ],
    ...
    nd = [
      ...
      function (a, c, d, e, g) {
        function i(a, c) {
          c = c ? "-" + Xa(c, "-") : "";
          g.removeClass((a ? Ia : Ja) + c).addClass((a ? Ja : Ia) + c);
        }
        ...
        this.$render = r;
        this.$name = d.name;
        var f = g.inheritedData("$formController") || Ka,
          h = 0,
          j = (this.$error = {});
        g.addClass(La);
        i(!0);
        this.$setValidity = function (a, c) {
          if (j[a] !== !c) {
            ...
            } else i(!1), (this.$invalid = !0), (this.$valid = !1), h++;
            j[a] = !c;
            i(c, a);
    ...
    qd = function () {
      return {
        ...
        link: function (a, c, d, e) {
          ...
          e.$parsers.push(i);
          e.$formatters.push(function (a) {
            return M(a) && !ea(i(e.$viewValue), a) ? a.join(", ") : p;
          });
        },
      };
    },
  ...
  var Cd = Q(function (a, c, d) {
        ...
        return function (a, c, i) {
          ...
          a.$watch(function (a) {
            ...
            if (M(i)) v = i || [];
              ...
              v = [];
              for (r in i)
                i.hasOwnProperty(r) && r.charAt(0) != "$" && v.push(r);
              v.sort();
            }
            e = 0;
            for (f = v.length; e < f; e++) {
              ...
              if ((u = n.shift(z))) {
                p = u.scope;
                t.push(z, u);
                if (e !== u.index) (u.index = e), x.after(u.element);
                x = u.element;
              } else p = a.$new();
              p[j] = z;
              k && (p[k] = r);
            ...
            for (r in n)
              if (n.hasOwnProperty(r))
                for (v = n[r]; v.length; )
                  (z = v.pop()), z.element.remove(), z.scope.$destroy();
            n = t;
          });
        };
      },
        ...
        return {
          ...
          link: function (e, i, f, h) {
            ...
            function k(a, c, d) {
              ...
              a.$watch(function () {
                ea(e, d.$viewValue) || ((e = W(d.$viewValue)), d.$render());
              });
              c.bind("change", function () {
                a.$apply(function () {
                  var a = [];
            ...
            function n(e, f, g) {
              function i() {
                ...
                if (o) t = new Ca(r);
                  ...
                  a[""].push({ selected: r === null, id: "", label: "" }),
                    (t = !0);
                for (x = 0; (z = w.length), x < z; x++) {
                  y[k] = u[l ? (y[l] = w[x]) : x];
                  d = m(e, y) || "";
                ...
                for (w = c.length; y < w; y++) {
                  ...
                  if (v.length <= y)
                    (r = {
                      ...
                      v.push(u),
                      f.append(r.element);
                  else if (((u = v[y]), (r = u[0]), r.label != d))
                    r.element.attr("label", (r.label = d));
                  A = null;
                  x = 0;
                  for (z = h.length; x < z; x++)
                    if (((d = h[x]), (t = u[x + 1]))) {
                      A = t.element;
                      if (t.label !== d.label) A.text((t.label = d.label));
                      if (t.id !== d.id) A.val((t.id = d.id));
                      if (t.element.selected !== d.selected)
                        A.prop("selected", (t.selected = d.selected));
                    } else
                      d.id === "" && q
                        ? (B = q)
                        : (B = C.clone())
                        ...
                        A ? A.after(B) : r.element.append(B),
                        (A = B);
            ...
            if (h[1]) {
              for (
                var m = h[0],
                  ...
                  q = !1,
                  w,
                  C = t(aa.createElement("option")),
                  D = t(aa.createElement("optgroup")),
                  z = C.clone(),
                  h = 0,
                  A = i.children(),
                  E = A.length;
              ...
              if (o && (f.required || f.ngRequired)) {
                ...
                s.$parsers.push(x);
                s.$formatters.unshift(x);
                f.$observe("required", function () {
                  x(s.$viewValue);
                });
              }
              r ? n(e, i, s) : o ? k(e, i, s) : j(e, i, s, m);
            }
          },
        };
      },
    ...
    Td = [
      "$interpolate",
      function (a) {
        var c = { addOption: r, removeOption: r };
        return {
          restrict: "E",
          priority: 100,
          require: "^select",
  ...
  (function (a) {
    ...
    try {
      ...
      pa("ngLocale", []).provider("$locale", Wc);
    }
    pa(
      "ng",
      ["ngLocale"],
