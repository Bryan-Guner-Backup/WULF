...
(function (T, $, p) {
  ...
  function aa(b, a) {
    return JSON.stringify(b, gc, a ? "  " : null);
  }
  function mb(b) {
  ...
  function rb(b) {
    var a = b[ya],
      c = za[a];
    c &&
      (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), sb(b)),
      delete za[a],
      (b[ya] = p));
  }
  function ba(b, a, c) {
    var d = b[ya],
      d = za[d || -1];
    if (s(c)) d || ((b[ya] = d = ++mc), (d = za[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function ub(b, a, c) {
    var d = ba(b, "data"),
  ...
  function wb(b, a) {
    a &&
      m(a.split(" "), function (a) {
        if (!Aa(b, a)) b.className = Q(b.className + " " + Q(a));
      });
  }
  function ab(b, a) {
    if (a)
      for (
        var a = !a.nodeName && s(a.length) && !ma(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
    ...
    function g(a, b) {
      ...
      function d(a, b, e) {
        ...
        for (g = j.length; h < g; h++)
          (o = j[h]), f.push(e && e.hasOwnProperty(o) ? e[o] : c(o, i));
        a.$inject || (a = a[g]);
        switch (b ? -1 : f.length) {
          case 0:
            return a();
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (G(b))
            (d =
              (i.cookie = escape(a) + "=" + escape(b) + ";path=" + N).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        if (i.cookie !== H) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (j = e.indexOf("=")),
              j > 0 &&
                (V[unescape(e.substring(0, j))] = unescape(e.substring(j + 1)));
        }
        return V;
      }
    };
  ...
  function Bb(b) {
    ...
    this.$get = [
      ...
      function (b, i, j, k, l, n, r, o) {
        ...
        function t(a, b, c, d) {
          function e(a, c, d, j) {
            for (var g, i, n, k, o, r = 0, l = 0, q = f.length; r < q; l++)
              (n = c[l]),
                (g = f[r++]),
                (i = f[r++]),
                g
                  ? (g.scope
                      ? ((k = a.$new(J(g.scope))), u(n).data("$scope", k))
                      : (k = a),
                    (o = g.transclude) || (!j && b)
                      ? g(
                          i,
                      ...
                      : g(i, k, n, p, j))
                  : i && i(a, n.childNodes, p, j);
          }
          for (var f = [], j, g, i, n = 0; n < a.length; n++)
            (g = new ca()),
              (j = fa(a[n], [], g, d)),
              (g =
                (j = j.length ? z(j, a[n], g, b, c) : null) && j.terminal
                  ? null
                  : t(a[n].childNodes, j ? j.transclude : b)),
              f.push(j),
              f.push(g),
              (i = i || j || g);
          return i ? e : null;
        ...
        function fa(a, b, c, f) {
          ...
          switch (a.nodeType) {
            case 1:
              y(b, da(Cb(a).toLowerCase()), "E", f);
              var i, n, k;
              g = a.attributes;
              for (var o = 0, r = g && g.length; o < r; o++)
                if (((i = g[o]), i.specified))
                  (n = i.name),
                    (k = da(n.toLowerCase())),
                    (j[k] = n),
                    (c[k] = i =
        ...
        function z(a, b, c, d, e) {
          function f(a, b) {
            ...
            if (b) (b.require = C.require), t.push(b);
          }
          function i(a, b) {
            var c,
              d = "data",
          ...
          function k(a, d, e, f, g) {
            var o, q, x, L, Fa;
            o = b === e ? c : fc(c, new ca(u(e), c.$attr));
            q = o.$$element;
            if (z && J(z.scope)) {
              var xc = /^\s*([@=&])\s*(\w*)\s*$/,
                ja = d.$parent || d;
              m(z.scope, function (a, b) {
                var c = a.match(xc) || [],
                  e = c[2] || b,
                  f,
                  g,
                ...
                switch (c[1]) {
                  ...
                  case "=":
                    ...
                    j =
                      ...
                      function () {
                        f = d[b] = g(ja);
                        throw w(Db + o[e] + " (directive: " + z.name + ")");
                      };
                    f = d[b] = g(ja);
                    d.$watch(function () {
                      var a = g(ja);
                      a !== d[b] &&
                        (a !== f ? (f = d[b] = a) : j(ja, (f = d[b])));
                      return a;
                    });
                    break;
                  case "&":
            ...
            s &&
              m(s, function (a) {
                ...
                Fa = a.controller;
                Fa == "@" && (Fa = o[a.name]);
                q.data("$" + a.name + "Controller", r(Fa, b));
              });
            f = 0;
            for (x = l.length; f < x; f++)
              try {
                (L = l[f]), L(d, q, o, L.require && i(L.require, q));
              } catch (y) {
                j(y, na(q));
              }
            a && a(d, e.childNodes, p, g);
            f = 0;
            for (x = t.length; f < x; f++)
              try {
                (L = t[f]), L(d, q, o, L.require && i(L.require, q));
              } catch (H) {
                j(H, na(q));
              }
          }
          for (
            ...
            if ((B = C.scope))
              N("isolated scope", y, C, F),
                J(B) && (q(F, "ng-isolate-scope"), (y = C)),
                q(F, "ng-scope"),
                (z = z || C);
            W = C.name;
            if ((B = C.controller))
              (s = s || {}),
                N("'" + W + "' controller", s[W], C, F),
                (s[W] = C);
            if ((B = C.transclude))
              N("transclusion", A, C, F),
                (A = C),
                (o = C.priority),
                B == "element"
                  ? ((Z = u(b)),
                    ...
                    Ea(e, u(Z[0]), b),
                    (v = x(Z, d, o)))
                  : ((Z = u(bb(b)).contents()), F.html(""), (v = x(Z, d)));
            if ((B = C.template))
              if (
                (N("template", H, C, F),
                (H = C),
                (Z = u("<div>" + Q(B) + "</div>").contents()),
                (b = Z[0]),
                C.replace)
              ) {
                if (Z.length != 1 || b.nodeType !== 1) throw new w(g + B);
                Ea(e, F, b);
                W = { $attr: {} };
                a = a.concat(fa(b, a.splice(E + 1, a.length - (E + 1)), W));
                L(c, W);
                I = a.length;
              } else F.html(B);
            if (C.templateUrl)
              N("template", H, C, F),
                (H = C),
                (k = V(a.splice(E, a.length - E), k, F, c, e, C.replace, v)),
                (I = a.length);
            else if (C.compile)
              try {
                (D = C.compile(F, c, v)),
            ...
            if (C.terminal) (k.terminal = !0), (o = Math.max(o, C.priority));
          }
          k.scope = z && z.scope;
          k.transclude = A && v;
          return k;
        ...
        function y(d, e, g, i) {
          ...
          if (a.hasOwnProperty(e))
            for (var k, e = b.get(e + c), o = 0, l = e.length; o < l; o++)
              try {
                if (
                  ((k = e[o]),
          ...
          k.get(q.templateUrl, { cache: l })
            .success(function (k) {
              ...
              if (f) {
                ...
                l = q[0];
                if (q.length != 1 || l.nodeType !== 1) throw new w(g + k);
                k = { $attr: {} };
                Ea(e, c, l);
                fa(l, a, k);
                L(d, k);
      ...
      function (c) {
        ...
        return function (g, h) {
          for (var f, i, j = 0, k = [], l = g.length, n = !1, r = []; j < l; )
            (f = g.indexOf(b, j)) != -1 && (i = g.indexOf(a, f + d)) != -1
              ? (j != f && k.push(g.substring(j, f)),
                k.push((j = c((n = g.substring(f + d, i))))),
                (j.exp = n),
                (j = i + e),
                (n = !0))
              : (j != l && k.push(g.substring(j)), (j = l));
  ...
  function fb(b, a) {
    ...
    this.$$parse = function (b) {
      ...
      e = Gc.exec((e.hash || "").substr(a.length));
      this.$$path = e[1]
      ...
      function (c, d, e, g) {
        ...
        f = a
          ? e.history
            ...
            : new fb(Fc(k, i, b), b)
          : new fb(k, b);
        l = ta(f.protocol(), f.host(), f.port()) + j;
        g.bind("click", function (a) {
          if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
            for (var b = u(a.target); b.length && E(b[0].nodeName) !== "a"; )
              b = b.parent();
            var d = b.prop("href");
            if (d && !(b.attr("target") || d.indexOf(l) !== 0))
              f.url(d.substr(l.length)),
                c.$apply(),
                a.preventDefault(),
  ...
  function Jc(b, a) {
    ...
    for (var n = [], r, o = 0, x = [], q, t = ":"; o < b.length; ) {
      q = b.charAt(o);
      if (c("\"'")) l(q);
      else if (e(q) || (c(".") && e(d()))) j();
      else if (h(q)) {
        if (
          (k(), "{,".indexOf(t) != -1 && x[0] == "{" && (r = n[n.length - 1]))
        )
        ...
        var m = q + d(),
          ...
          y = Ia[m];
        y
          ? (n.push({ index: o, text: m, fn: y }), (o += 2))
          : z
          ? (n.push({
              index: o,
              text: q,
  ...
  function Lc(b, a, c, d) {
    ...
    function g() {
      if (N.length === 0) throw w("Unexpected end of expression: " + b);
      return N[0];
    }
    function h(a, b, c, d) {
      if (N.length > 0) {
  ...
  function Ib(b, a) {
    ...
    if (a)
      e =
        d < 6
          ? Kb(c[0], c[1], c[2], c[3], c[4])
          : function (a, b) {
              var e = 0,
                g;
              do
                (g = Kb(c[e++], c[e++], c[e++], c[e++], c[e++])(a, b)),
                  (b = p),
                  (a = g);
              while (e < d);
              return g;
    ...
    this.$get = [
      ...
      function (a, c, d, e, g, h, f) {
        ...
        function j() {
          ...
          m(b, function (b, e) {
            if (!d && (a = l(c.path(), e)))
              (d = Qa(b, { params: D({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
  ...
  function Rc() {
    ...
    this.$get = [
      ...
      function (a, c, d) {
        ...
        function g(a) {
          if (i.$$phase) throw w(i.$$phase + " already in progress");
          i.$$phase = a;
        }
        function h(a, b) {
          var c = d(a);
  ...
  function Sc() {
    this.$get = [
      ...
      function (b) {
        var a = {},
          c = I((/android (\d+)/.exec(E(b.navigator.userAgent)) || [])[1]);
        return {
  ...
  function Uc() {
    var b = /^\s*(\[|\{[^\{])/,
      ...
      d = (this.defaults = {
        ...
        transformRequest: [
          function (a) {
            return J(a) && Ra.apply(a) !== "[object File]" ? aa(a) : a;
          },
        ],
        headers: {
          common: {
    ...
    this.$get = [
      ...
      function (a, b, c, i, j, k) {
        function l(a) {
          function c(a) {
            var b = D({}, a, { data: Nb(a.data, a.headers, f) });
        ...
        function n(b, c, d) {
          function e(a, b, c) {
            m && (200 <= a && a < 300 ? m.put(x, [a, b, Lb(c)]) : m.remove(x));
            f(b, a, c);
            i.$apply();
          }
          function f(a, c, d) {
          ...
          p || a(b.method, x, c, e, d, b.timeout, b.withCredentials);
          return k;
        }
        function r(a, b) {
          if (!b) return a;
    ...
    return function (e, i, j, k, l, n, r) {
      ...
      if (E(e) == "jsonp") {
        ...
        q.onreadystatechange = function () {
          q.readyState == 4 &&
            o(k, t || q.status, q.responseText, q.getAllResponseHeaders());
        };
  ...
  function Pb(b) {
    ...
    return function (b, d) {
      ...
      return Tb(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  function Rb(b) {
    var a = b.NUMBER_FORMATS;
    return function (b, d) {
      return Tb(b, a.PATTERNS[0], a.GROUP_SEP, a.DECIMAL_SEP, d);
    };
  }
  ...
  function Qb(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (i = fd.exec(e))
          ? ((h = h.concat(ga.call(i, 1))), (e = h.pop()))
          : (h.push(e), (e = null));
      m(h, function (a) {
        f = gd[a];
        g += f
  ...
  var E = function (b) {
    ...
    w = T.Error,
    Y = I((/msie (\d+)/.exec(E(navigator.userAgent)) || [])[1]),
    u,
    ha,
    ga = [].slice,
    Pa = [].push,
    Ra = Object.prototype.toString,
    Xb = T.angular || (T.angular = {}),
    ra,
    Cb,
    X = ["0", "0", "0"];
  A.$inject = [];
  ...
  var ic = /[A-Z]/g,
    ...
    za = (P.cache = {}),
    ya = (P.expando = "ng-" + new Date().getTime()),
    mc = 1,
    id = T.document.addEventListener
      ? function (b, a, c) {
    ...
    tb = T.document.removeEventListener
      ? function (b, a, c) {
  ...
  var Ma = { $addControl: A, $removeControl: A, $setValidity: A, $setDirty: A };
  Vb.$inject = ["$element", "$attrs", "$scope"];
  var Pa = {
      name: "form",
      restrict: "E",
      controller: Vb,
      ...
      function (a, c) {
        return {
          ...
          link: function (d, e, g, h) {
            h && (Zb[E(g.type)] || Zb.text)(d, e, g, h, c, a);
          },
        };
      },
    ],
    ...
    pd = [
      ...
      function (a, c, d, e, g) {
        ...
        var g = g(d.ngModel),
          f = g.assign;
        if (!f) throw w(Db + d.ngModel + " (" + na(e) + ")");
        this.$render = A;
        ...
        return function (a, c, h) {
          ...
          a.$watch(function (a) {
            ...
            if (K(h)) v = h || [];
              ...
              v = [];
              for (z in h)
                h.hasOwnProperty(z) && z.charAt(0) != "$" && v.push(z);
              v.sort();
            }
            e = 0;
            ...
            if (i[1]) {
              for (
                var n = i[0],
                  ...
                  q = !1,
                  t,
                  D = u($.createElement("option")),
                  z = u($.createElement("optgroup")),
                  y = D.clone(),
                  i = 0,
                  A = h.children(),
                  B = A.length;
  ...
  (function (a) {
    ...
    try {
      ...
      ra("ngLocale", []).provider("$locale", Yc);
    }
    ra(
      "ng",
      ["ngLocale"],
