...
(function (T, $, p) {
        ...
        ? ((fa = a),
          d.history
            ? b
              ...
              : (k.pushState(null, "", a), A.attr("href", A.attr("href")))
            : b
            ? j.replace(a)
            : (j.href = a),
          f)
        ...
        if (i.cookie !== H) {
          ...
          for (e = 0; e < d.length; e++)
            (f = d[e]),
              (j = f.indexOf("=")),
              j > 0 &&
                (V[unescape(f.substring(0, j))] = unescape(f.substring(j + 1)));
        }
        return V;
      }
    };
  ...
  function Bb(b) {
    ...
    this.$get = [
      ...
      function (b, i, j, k, l, n, r, o) {
        ...
        function t(a, b, c, d) {
          function f(a, c, d, j) {
            for (var g, i, n, k, o, r = 0, l = 0, q = e.length; r < q; l++)
              (n = c[l]),
                (g = e[r++]),
                (i = e[r++]),
                g
          ...
          for (var e = [], j, g, i, n = 0; n < a.length; n++)
            (g = new ca()),
              (j = fa(a[n], [], g, d)),
              (g =
                (j = j.length ? A(j, a[n], g, b, c) : null) && j.terminal
                  ? null
        ...
        function A(a, b, c, d, f) {
          function e(a, b) {
            if (a) (a.require = E.require), l.push(a);
            ...
            if (G(a)) {
              for (; (c = a.charAt(0)) == "^" || c == "?"; )
                (a = a.substr(1)),
                  ...
                  (f = f || c == "?");
              c = b[d]("$" + a + "Controller");
              if (!c && !f) throw z("No controller: " + a);
            } else
              K(a) &&
                ((c = []),
                m(a, function (a) {
          ...
          function k(a, d, f, e, g) {
            var o, q, w, L, Fa;
            o = b === f ? c : fc(c, new ca(u(f), c.$attr));
            q = o.$$element;
            if (A && J(A.scope)) {
              var xc = /^\s*([@=&])\s*(\w*)\s*$/,
                ja = d.$parent || d;
              m(A.scope, function (a, b) {
                ...
                switch (c[1]) {
                  case "@":
                    o.$observe(f, function (a) {
                      d[b] = a;
                    });
                    o.$$observers[f].$$scope = ja;
                    break;
                  case "=":
                    g = n(o[f]);
                    j =
                      ...
                      function () {
                        e = d[b] = g(ja);
                        throw z(Db + o[f] + " (directive: " + A.name + ")");
                      };
                    e = d[b] = g(ja);
                    d.$watch(function () {
                      var a = g(ja);
                      a !== d[b] &&
                        (a !== e ? (e = d[b] = a) : j(ja, (e = d[b])));
                      return a;
                    });
                    break;
                  case "&":
            ...
            for (w = l.length; e < w; e++)
              try {
                (L = l[e]), L(d, q, o, L.require && i(L.require, q));
              } catch (y) {
                j(y, na(q));
              }
            a && a(d, f.childNodes, p, g);
            e = 0;
            for (w = t.length; e < w; e++)
              try {
                (L = t[e]), L(d, q, o, L.require && i(L.require, q));
              } catch (H) {
                j(H, na(q));
              }
          }
          for (
            ...
            E = a[C];
            Z = p;
            if (o > E.priority) break;
            if ((B = E.scope))
              N("isolated scope", y, E, F),
                J(B) && (q(F, "ng-isolate-scope"), (y = E)),
                q(F, "ng-scope"),
                (A = A || E);
            W = E.name;
            if ((B = E.controller))
              ...
              N("transclusion", x, E, F),
                ...
                B == "element"
                  ? ((Z = u(b)),
                    ...
                    Ea(f, u(Z[0]), b),
                    (v = w(Z, d, o)))
                  : ((Z = u(bb(b)).contents()), F.html(""), (v = w(Z, d)));
            if ((B = E.template))
              if (
                (N("template", H, E, F),
                (H = E),
                ...
                if (Z.length != 1 || b.nodeType !== 1) throw new z(g + B);
                Ea(f, F, b);
                W = { $attr: {} };
            ...
            if (E.templateUrl)
              N("template", H, E, F),
                (H = E),
                (k = V(a.splice(C, a.length - C), k, F, c, f, E.replace, v)),
                (I = a.length);
            else if (E.compile)
              try {
                (D = E.compile(F, c, v)),
                  M(D) ? e(null, D) : D && e(D.pre, D.post);
              } catch (O) {
                j(O, na(F));
              }
            if (E.terminal) (k.terminal = !0), (o = Math.max(o, E.priority));
          }
          k.scope = A && A.scope;
          k.transclude = x && v;
          return k;
        ...
        function L(a, b) {
          ...
          m(b, function (b, e) {
            e == "class"
              ...
              : e == "style"
              ? f.attr("style", f.attr("style") + ";" + b)
              : e.charAt(0) != "$" &&
                !a.hasOwnProperty(e) &&
                ((a[e] = b), (d[e] = c[e]));
          });
        }
        function V(a, b, c, d, f, e, j) {
          var i = [],
            n,
            o,
            r = c[0],
          ...
          return function (a, c, d, f, e) {
            i
              ? (i.push(c), i.push(d), i.push(f), i.push(e))
              : n(
                  function () {
                    b(o, c, d, f, e);
                  },
  ...
  function fb(b, a) {
    ...
    this.$$parse = function (b) {
      ...
      e = Fc.exec((e.hash || "").substr(a.length));
      this.$$path = e[1]
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((i = d.baseHref() || "/"),
            ...
            (f = e.history ? new eb(Dc(k, i, b), j) : new fb(Ec(k, i, b), b)),
            (l = ta(f.protocol(), f.host(), f.port()) + j))
          : ((f = new fb(k, b)), (l = f.absUrl().split("#")[0]));
        g.bind("click", function (a) {
          if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
            for (var b = u(a.target); b.length && C(b[0].nodeName) !== "a"; )
              b = b.parent();
            var d = b.prop("href");
  ...
  function Ic(b, a) {
    ...
    for (var n = [], r, o = 0, w = [], q, t = ":"; o < b.length; ) {
      ...
      if (c("\"'")) l(q);
        ...
        if (
          (k(), "{,".indexOf(t) != -1 && w[0] == "{" && (r = n[n.length - 1]))
        )
  ...
  function Kc(b, a, c, d) {
    ...
    var V = B(0),
      ...
      u = function (a, b) {
        ...
        i(")");
        return function (d, f) {
          for (var e = [], g = b ? b(d, f) : d, j = 0; j < c.length; j++)
            e.push(c[j](d, f));
          j = a(d, f) || x;
          return j.apply ? j.apply(g, e) : j(e[0], e[1], e[2], e[3], e[4]);
        };
      },
      s = function (a) {
        var b = f().text,
        ...
        e.prototype = {
          ...
          $emit: function (a, b) {
            ...
            do {
              ...
              for (p = f.length; m < p; m++)
                try {
                  if ((f[m].apply(null, h), g)) return i;
                } catch (A) {
                  c(A);
                }
              e = e.$parent;
          ...
          $broadcast: function (a, b) {
            var d = this,
              ...
              g = [e].concat(ga.call(arguments, 1));
            do
              if (
                ((d = f),
                (e.currentScope = d),
                ...
                !(f = d.$$childHead || (d !== this && d.$$nextSibling)))
              )
                for (; d !== this && !(f = d.$$nextSibling); ) d = d.$parent;
            while ((d = f));
            return e;
          },
        };
  ...
  function Tc() {
    ...
    this.$get = [
      ...
      function (a, b, c, i, j, k) {
        function l(a) {
          function c(a) {
            var b = D({}, a, { data: Nb(a.data, a.headers, e) });
            return 200 <= a.status && a.status < 300 ? b : j.reject(b);
          }
          a.method = ka(a.method);
          var f = a.transformRequest || d.transformRequest,
            e = a.transformResponse || d.transformResponse,
            g = d.headers,
            g = D(
        ...
        function n(b, c, d) {
          function f(a, b, c) {
            m && (200 <= a && a < 300 ? m.put(w, [a, b, Lb(c)]) : m.remove(w));
            e(b, a, c);
            i.$apply();
          }
          function e(a, c, d) {
          ...
          if (m)
            if ((p = m.get(w)))
              ...
              else K(p) ? e(p[1], p[0], U(p[2])) : e(p, 200, {});
            else m.put(w, k);
          p || a(b.method, w, c, f, d, b.timeout, b.withCredentials);
          return k;
        }
        function r(a, b) {
          if (!b) return a;
  ...
  function Vc(b, a, c, d, e, g) {
    ...
    return function (f, e, j, k, l, n, r) {
      function o(a, c, d, f) {
        c = (e.match(Fb) || ["", g])[1] == "file" ? (d ? 200 : 404) : c;
        a(c == 1223 ? 204 : c, d, f);
      ...
      if (C(f) == "jsonp") {
        ...
        h(e.replace("JSON_CALLBACK", "angular.callbacks." + p), function () {
          ...
          c = Sa(c, function (a) {
            ...
            return e(function (a, b) {
              ...
              var f = d(b),
                ...
                g = typeof f;
              e == g
                ? (e == "string" && (c = c.toLowerCase()),
                  e == "string" && (f = f.toLowerCase()),
                  (c = c === f ? 0 : c < f ? -1 : 1))
                : (c = e < g ? -1 : 1);
              return c;
            }, c);
  ...
  var ic = /[A-Z]/g,
    ...
    mc = 1,
    hd = T.document.addEventListener
      ? function (b, a, c) {
  ...
  var Ma = { $addControl: x, $removeControl: x, $setValidity: x, $setDirty: x };
  ...
  var Pa = {
      ...
      function (a, c) {
        return {
          ...
          link: function (d, e, g, h) {
            h && (Zb[C(g.type)] || Zb.text)(d, e, g, h, c, a);
          },
        };
      },
    ],
    ...
    od = [
      ...
      function (a, c, d, e, g) {
        ...
        var g = g(d.ngModel),
          f = g.assign;
        if (!f) throw z(Db + d.ngModel + " (" + na(e) + ")");
        this.$render = x;
  ...
  (function (a) {
    ...
    try {
      ...
      ra("ngLocale", []).provider("$locale", Xc);
    }
    ra(
      "ng",
      ["ngLocale"],
