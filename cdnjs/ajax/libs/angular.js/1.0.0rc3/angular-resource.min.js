  ...
  function (u, v) {
    ...
    function s(b, c, a) {
      ...
      var x = new h(b),
        a = q({}, y, a);
      j(a, function (d, f) {
        var h = d.method == "POST" || d.method == "PUT";
        e[f] = function (a, b, c, f) {
          var i = {},
            g,
            k = n,
            o = null;
          ...
          var m = this instanceof e ? this : d.isArray ? [] : new e(g);
          u({
            method: d.method,
            url: x.url(q({}, r(g), d.params || {}, i)),
            data: g,
          }).then(function (a) {
            var b = a.data;
            if (b)
        ...
        e.prototype["$" + f] = function (a, b, c) {
          ...
          e[f].call(this, d, h ? this : void 0, i, g);
        };
      });
      return e;
    }
    ...
    h.prototype = {
      url: function (b) {
        ...
        j(this.urlParams, function (e, d) {
          h = f(b[d] || c.defaults[d] || "", !0)
            .replace(/%26/gi, "&")
            .replace(/%3D/gi, "=")
            .replace(/%2B/gi, "+");
          a = a.replace(RegExp(":" + d + "(\\W)"), h + "$1");
        });
        var a = a.replace(/\/?#$/, ""),
          e = [];
        j(b, function (a, b) {
          c.urlParams[b] || e.push(f(b) + "=" + f(a));
        });
        e.sort();
        a = a.replace(/\/*$/, "");
