    ...
    function (u, v) {
      ...
      function s(b, c, a) {
        ...
        var x = new l(b),
          a = r({}, y, a);
        j(a, function (d, g) {
          var l = d.method == "POST" || d.method == "PUT";
          ...
          e.prototype["$" + g] = function (a, b, c) {
            ...
            e[g].call(this, d, l ? this : void 0, i, h);
          };
        });
        return e;
      }
