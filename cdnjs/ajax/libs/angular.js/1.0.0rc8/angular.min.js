...
(function (V, $, p) {
  ...
  function ca(b, a) {
    ...
    if (c == typeof a && c == "object")
      if (K(b)) {
      ...
      } else if (la(b)) return la(a) && b.getTime() == a.getTime();
      else {
        if (
        ...
        c = {};
        for (d in b) {
          if (d.charAt(0) !== "$" && !N(b[d]) && !ca(b[d], a[d])) return !1;
          c[d] = !0;
        }
  ...
  function Ua(b) {
    ...
    m((b || "").split("&"), function (b) {
      b &&
        ...
        (a[d] = t(c[1]) ? decodeURIComponent(c[1]) : !0));
    });
    return a;
  }
  function ob(b) {
  ...
  function Ya(b, a) {
    function c() {
      var e;
      for (var b = [this], c = a, i, f, h, k, j, n, l; b.length; ) {
        i = b.shift();
        f = 0;
  ...
  function M(b) {
    ...
    if (!(this instanceof M)) {
      if (H(b) && b.charAt(0) != "<") throw y("selectors not implemented");
      return new M(b);
    }
    if (H(b)) {
  ...
  function pa(b) {
    sb(b);
    for (var a = 0, b = b.childNodes || []; a < b.length; a++) pa(b[a]);
  }
  function sb(b) {
    var a = b[ha],
      c = da[a];
  ...
  function qa(b, a, c) {
    var d = b[ha],
      e = da[d || -1];
    if (t(c)) e || ((b[ha] = d = ++bb), (e = da[d] = {})), (e[a] = c);
    else if (t(a))
      if (J(a)) d || (b[ha] = d = ++bb), (da[d] = e = da[d] || {}), D(e, a);
      else return e ? e[a] : p;
    else return d || (b[ha] = d = ++bb), e ? e : (da[d] = {});
  }
  function Aa(b, a) {
    return (
      (" " + b.className + " ").replace(/[\n\t]/g, " ").indexOf(" " + a + " ") >
  ...
  function ub(b, a) {
    a &&
      m(a.split(" "), function (a) {
        if (!Aa(b, a)) b.className = S(b.className + " " + S(a));
      });
  }
  function Za(b, a) {
    if (a)
      for (
        var a = !a.nodeName && t(a.length) && !ma(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
  ...
  function wb(b, a) {
    return xb[b.nodeName] && Ca[a.toLowerCase()];
  }
  function cb(b) {
    var a = function (c) {
      if (!c.preventDefault)
  ...
  function ic(b) {
    ...
    if (!b.$inject) {
      var a = (b.$inject = []),
        c = b.toString().replace(jc, "").match(kc);
      m(c[1].split(lc), function (b) {
        b.replace(mc, function (b, c, d) {
          a.push(d);
        });
      });
    }
  ...
  function qb(b) {
    ...
    function g(a, b) {
      ...
      function d(a, b, e) {
        ...
        typeof a == "function"
          ? ((g = ic(a)), (i = g.length))
          : (K(a) && ((g = a), (i = g.length - 1), (a = g[i])), oa(a, "fn"));
        for (var l = 0; l < i; l++)
          (k = g[l]), f.push(e && e.hasOwnProperty(k) ? e[k] : c(k, h));
        switch (b ? -1 : f.length) {
          case 0:
            return a();
          case 1:
  ...
  function oc(b, a, c, d) {
    ...
    f.onUrlChange = function (a) {
      O ||
        (d.history && v(b).bind("popstate", i),
        d.hashchange ? v(b).bind("hashchange", i) : f.addPollFn(i),
        (O = !0));
      I.push(a);
      return a;
    };
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (H(b))
            (d =
              (h.cookie = escape(a) + "=" + escape(b) + ";path=" + F).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        if (h.cookie !== ea) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (g = e.indexOf("=")),
              g > 0 &&
                (w[unescape(e.substring(0, g))] = unescape(e.substring(g + 1)));
        }
        return w;
      }
    };
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            var c = j[a] || (j[a] = { key: a });
            e(c);
            u(b) || (a in h || i++, (h[a] = b), i > k && this.remove(l.key));
          },
          get: function (a) {
            var b = j[a];
            if (b) return e(b), h[a];
  ...
  function yb(b) {
            ...
            b.factory(d + c, [
              ...
              function (b, c) {
                ...
                m(a[d], function (a) {
                  try {
                    var f = b.invoke(a);
                    if (N(f)) f = { compile: E(f) };
                    else if (!f.compile && f.link) f.compile = E(f.link);
    ...
    this.$get = [
      ...
      "$parse",
      "$controller",
      function (b, h, k, j, n, l, s) {
        function o(a, b, c) {
          a instanceof v || (a = v(a));
          m(a, function (b, c) {
            b.nodeType == 3 && (a[c] = v(b).wrap("<span>").parent()[0]);
          });
          var d = A(a, b, a, c);
          return function (b, c) {
            na(b, "scope");
        ...
        function A(a, b, c, d) {
          function e(a, c, d, h) {
            for (var g, l, k, j, T, n = 0, s = 0, q = f.length; n < q; s++)
              (k = c[s]),
                (g = f[n++]),
                (l = f[n++]),
                g
                  ? (g.scope
                      ? ((j = a.$new(J(g.scope))), v(k).data("$scope", j))
                      : (j = a),
                    (T = g.transclude) || (!h && b)
                      ? g(
                          l,
                      ...
                      : g(l, j, k, p, h))
                  : l && l(a, k.childNodes, p, h);
          }
          for (var f = [], h, g, k, l = 0; l < a.length; l++)
            (g = new u()),
              (h = P(a[l], [], g, d)),
              (g =
                (h = h.length ? I(h, a[l], g, b, c) : null) && h.terminal
                  ? null
                  : A(a[l].childNodes, h ? h.transclude : b)),
              f.push(h),
              f.push(g),
              (k = k || h || g);
          return k ? e : null;
        ...
        function P(a, b, c, f) {
          ...
          switch (a.nodeType) {
            case 1:
              O(b, ba(zb(a).toLowerCase()), "E", f);
              var l, k, j;
              g = a.attributes;
              for (var n = 0, s = g && g.length; n < s; n++)
                if (((l = g[n]), l.specified))
                  (k = l.name),
                    (j = ba(k.toLowerCase())),
                    (h[j] = k),
                    (c[j] = l =
        ...
        function I(a, b, c, d, e) {
          function f(a, b) {
            if (a) (a.require = x.require), n.push(a);
            if (b) (b.require = x.require), A.push(b);
          }
          function h(a, b) {
            var c,
              d = "data",
          ...
          function l(a, d, e, f, g) {
            var j, T, q, o, w;
            j = b === e ? c : bc(c, new u(v(e), c.$attr));
            T = j.$$element;
            F &&
              J(F.scope) &&
              m(F.scope, function (a, b) {
                (sa[a] || L)(b, a, d.$parent || d, d, j);
              });
            E &&
              m(E, function (a) {
                var b = { $scope: d, $element: T, $attrs: j, $transclude: g };
                m(a.inject || {}, function (a, c) {
                  (sa[a] || L)(c, a, F ? d.$parent || d : d, b, j);
                });
                w = a.controller;
                w == "@" && (w = j[a.name]);
                T.data("$" + a.name + "Controller", s(w, b));
              });
            f = 0;
            for (q = n.length; f < q; f++)
              try {
                (o = n[f]), o(d, T, j, o.require && h(o.require, T));
              } catch (tc) {
                k(tc, za(T));
              }
            ...
            for (q = A.length; f < q; f++)
              try {
                (o = A[f]), o(d, T, j, o.require && h(o.require, T));
              } catch (sc) {
                k(sc, za(T));
              }
          }
          for (
            ...
            x = a[B];
            r = p;
            if (j > x.priority) break;
            if ((z = x.scope))
              R("isolated scope", I, x, C),
                J(z) && (q(C, "ng-isolate-scope"), (I = x)),
                q(C, "ng-scope"),
                (F = F || x);
            X = x.name;
            if ((z = x.controller))
              (E = E || {}),
                R("'" + X + "' controller", E[X], x, C),
                (E[X] = x);
            if ((z = x.transclude))
              R("transclusion", D, x, C),
                (D = x),
                (j = x.priority),
                z == "element"
                  ? ((r = v(b)),
                    ...
                    ja(e, v(r[0]), b),
                    (t = o(r, d, j)))
                  : ((r = v($a(b)).contents()), C.html(""), (t = o(r, d)));
            if ((z = x.template))
              if (
                (R("template", O, x, C),
                (O = x),
                (r = v("<div>" + S(z) + "</div>").contents()),
                (b = r[0]),
                x.replace)
              ) {
                if (r.length != 1 || b.nodeType !== 1) throw new y(g + z);
                ja(e, C, b);
                X = { $attr: {} };
            ...
            if (x.templateUrl)
              R("template", O, x, C),
                (O = x),
                (l = ea(a.splice(B, a.length - B), l, C, c, e, x.replace, t)),
                (M = a.length);
            else if (x.compile)
              try {
                (G = x.compile(C, c, t)),
            ...
            if (x.terminal) (l.terminal = !0), (j = Math.max(j, x.priority));
          }
          l.scope = F && F.scope;
          l.transclude = D && t;
          return l;
          ...
          if (a.hasOwnProperty(e))
            for (var j, e = b.get(e + c), n = 0, s = e.length; n < s; n++)
              try {
                if (
                  ((j = e[n]),
                  (h === p || h > j.priority) && j.restrict.indexOf(g) != -1)
                )
                  d.push(j), (l = !0);
              } catch (q) {
                k(q);
        ...
        function ea(a, b, c, d, e, f, h) {
          ...
          j.get(o.templateUrl, { cache: n })
            .success(function (j) {
              var n, o;
              if (f) {
                o = v("<div>" + S(j) + "</div>").contents();
                n = o[0];
                if (o.length != 1 || n.nodeType !== 1) throw new y(g + j);
                j = { $attr: {} };
                ja(e, c, n);
                P(n, a, j);
                w(d, j);
              ...
              a.unshift(m);
              k = I(a, c, d, h);
              for (s = A(c.contents(), h); l.length; ) {
                var L = l.pop(),
                  j = l.pop();
                o = l.pop();
                var F = l.pop(),
                  C = n;
                o !== q && ((C = $a(n)), ja(j, v(o), C));
                k(
                  function () {
                    b(s, F, C, e, L);
                  },
            ...
            accessor: function (a, b, c, d, e) {
              ...
              g &&
                ...
                (h =
                  f.assign ||
                  function () {
                    throw y("Expression '" + g + "' not assignable.");
                  }));
              d[a] = function (a) {
                return arguments.length ? h(c, a) : f(c);
              };
            },
    ...
    this.$get = [
      ...
      function (c) {
        var d = b.length,
          e = a.length;
        return function (g, i) {
          for (var f, h, k = 0, j = [], n = g.length, l = !1, s = []; k < n; )
            (f = g.indexOf(b, k)) != -1 && (h = g.indexOf(a, f + d)) != -1
              ? (k != f && j.push(g.substring(k, f)),
                j.push((k = c((l = g.substring(f + d, h))))),
                (k.exp = l),
                (k = h + e),
                (l = !0))
  ...
  function Bc(b, a, c) {
    ...
    if (decodeURIComponent(d.path) == a) return b;
      ...
      return ua(d.protocol, d.host, d.port) + a + "#" + c + f + e + g;
    }
  }
  function fb(b, a) {
    a = a || "";
      ...
      function (c, d, e, g) {
        ...
        if (a) {
          var e = (i = e.history
              ? new fb(Ac(k, f, b), h)
              : new gb(Bc(k, f, b), b)),
            j = ua(e.protocol(), e.host(), e.port()) + h;
          g.bind("click", function (a) {
            if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
              for (var b = v(a.target); b.length && z(b[0].nodeName) !== "a"; )
                b = b.parent();
              var d = b.prop("href");
              if (d && !(b.attr("target") || d.indexOf(j) !== 0))
                i.url(d.substr(j.length)),
                  c.$apply(),
                  a.preventDefault(),
  ...
  function Fc(b, a) {
    ...
    function j() {
      for (var c = "", d = o, f, h, j; o < b.length; ) {
        var k = b.charAt(o);
    ...
    for (var l = [], s, o = 0, m = [], q, A = ":"; o < b.length; ) {
      q = b.charAt(o);
      if (c("\"'")) n(q);
      else if (e(q) || (c(".") && e(d()))) k();
      else if (i(q)) {
        if (
          (j(), "{,".indexOf(A) != -1 && m[0] == "{" && (s = l[l.length - 1]))
        )
  ...
  function Hc(b, a, c, d) {
    ...
    function g() {
      if (R.length === 0) throw y("Unexpected end of expression: " + b);
      return R[0];
    }
    function i(a, b, c, d) {
      if (R.length > 0) {
    ...
    function f(b, c, d, f) {
      return (b = i(b, c, d, f))
        ? (a && !b.json && e("is not valid json", b), R.shift(), b)
        : !1;
    }
    function h(a) {
    ...
    this.$get = [
      ...
      function (a, c) {
        return function (d) {
          switch (typeof d) {
            case "string":
              return b.hasOwnProperty(d) ? b[d] : (b[d] = Hc(d, !1, a, c.csp));
            case "function":
              return d;
            default:
              return r;
    ...
    this.$get = [
      ...
      function (a, c, d) {
        function e() {
          ...
          m(b, function (b, e) {
            if (!d && (a = i(c.path(), e)))
              (d = Oa(b, { params: D({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
        ...
        e.prototype = {
                        ...
                        (o = !0),
                          ...
                          m < 5 &&
                            ...
                            (I = N(a.exp)
                              ...
                              : a.exp),
                            (I += "; newVal: " + aa(d) + "; oldVal: " + aa(e)),
                            A[p].push(I));
                    } catch (w) {
                      c(w);
                    }
                if (!(i = q.$$childHead || (q !== this && q.$$nextSibling)))
                  for (; q !== this && !(i = q.$$nextSibling); ) q = q.$parent;
              } while ((q = i));
              if (o && !m--)
                throw y(
                  b +
          ...
          $emit: function (a, b) {
            var d = [],
              ...
              i = [g].concat(fa.call(arguments, 1)),
              m,
              q;
            do {
              e = f.$$listeners[a] || d;
              ...
              for (q = e.length; m < q; m++)
                try {
                  if ((e[m].apply(null, i), g.cancelled)) return g;
                } catch (A) {
                  c(A);
                }
              f = f.$parent;
  ...
  function Qc() {
    var b = /^\s*(\[|\{[^\{])/,
      ...
      d = (this.defaults = {
        ...
        transformRequest: [
          function (a) {
            return J(a) && Pa.apply(a) !== "[object File]" ? aa(a) : a;
          },
        ],
        headers: {
          common: {
    ...
    this.$get = [
      ...
      function (a, b, c, h, k, j) {
        function n(a) {
          function c(a) {
            var b = D({}, a, { data: Jb(a.data, a.headers, f) });
            return 200 <= a.status && a.status < 300 ? b : k.reject(b);
          }
          a.method = ka(a.method);
        ...
        function l(b, c, d) {
          function e(a, b, c) {
            m && (200 <= a && a < 300 ? m.put(L, [a, b, Hb(c)]) : m.remove(L));
            f(b, a, c);
            h.$apply();
          }
          function f(a, c, d) {
          ...
          p || a(b.method, L, c, e, d, b.timeout, b.withCredentials);
          return j;
        }
        function s(a, b) {
          if (!b) return a;
    ...
    return function (e, h, k, j, n, l, s) {
      ...
      if (z(e) == "jsonp") {
        ...
        q.onreadystatechange = function () {
          q.readyState == 4 &&
            o(j, A || q.status, q.responseText, q.getAllResponseHeaders());
        };
  ...
  function Pb(b, a, c, d, e) {
    ...
    if (i.indexOf("e") !== -1) f = i;
      ...
      var i = Math.pow(10, e),
        ...
        n = a.gSize;
      if (i.length >= j + n)
        for (var k = i.length - j, l = 0; l < k; l++)
          (k - l) % n === 0 && l !== 0 && (f += c), (f += i.charAt(l));
      for (l = k; l < i.length; l++)
        (i.length - l) % j === 0 && l !== 0 && (f += c), (f += i.charAt(l));
      for (; b.length < e; ) b += "0";
      e && (f += d + b.substr(0, e));
    }
  ...
  function Mb(b) {
    ...
    return function (c, e) {
      ...
      H(c) && (c = $c.test(c) ? G(c) : a(c));
      va(c) && (c = new Date(c));
      if (!la(c)) return c;
      for (; e; )
        (h = ad.exec(e))
          ? ((i = i.concat(fa.call(h, 1))), (e = i.pop()))
          : (i.push(e), (e = null));
      m(i, function (a) {
        f = bd[a];
        g += f
    ...
    h &&
      (h.match(/^\/(.*)\/$/)
        ...
        : (e = function (a) {
            var c = b.$eval(h);
            if (!c || !c.test)
              throw new y("Expected " + h + " to be a RegExp but was " + c);
            return k(c, a);
          }),
      d.$formatters.push(e),
      d.$parsers.push(e));
  ...
  var ec = /[A-Z]/g,
    ...
    da = {},
    ha = (M.expando = "ng-" + new Date().getTime()),
    bb = 1,
        ...
        if (Ca[d])
          if (t(c))
            ...
            return b[a] || (b.attributes.getNamedItem(a) || r).specified
              ? d
              : p;
        else if (t(c)) b.setAttribute(a, c);
      ...
      function (a, c) {
        return {
          ...
          link: function (d, e, g, i) {
            i && (Vb[z(g.type)] || Vb.text)(d, e, g, i, c, a);
          },
        };
      },
    ],
    ...
    nd = function () {
      return {
        ...
        link: function (a, c, d, e) {
          ...
          e.$parsers.push(i);
          e.$formatters.push(function (a) {
            return K(a) && !ca(i(e.$viewValue), a) ? a.join(", ") : p;
          });
        },
      };
    },
        ...
        return function (a, c, i) {
          ...
          a.$watch(function (a) {
            ...
            if (K(i)) w = i || [];
              ...
              w = [];
              for (r in i)
                i.hasOwnProperty(r) && r.charAt(0) != "$" && w.push(r);
              w.sort();
            }
            e = 0;
            ...
            for (r in n)
              if (n.hasOwnProperty(r))
                for (w = n[r]; w.length; )
                  (u = w.pop()), u.element.remove(), u.scope.$destroy();
            n = v;
          });
        };
      },
                ...
                for (y = c.length; x < y; x++) {
                  ...
                  if (v.length <= x)
                    (r = {
                      ...
                      v.push(u),
                      f.append(r.element);
                  else if (((u = v[x]), (r = u[0]), r.label != d))
                    r.element.attr("label", (r.label = d));
                  z = null;
                  w = 0;
                  for (A = h.length; w < A; w++)
                    if (((d = h[w]), (t = u[w + 1]))) {
                      z = t.element;
                      ...
                      d.id === "" && q
                        ...
                        (z = B);
                  for (w++; u.length > w; ) u.pop().element.remove();
                }
            ...
            if (h[1]) {
              for (
                var l = h[0],
                  ...
                  q = !1,
                  A,
                  D = v($.createElement("option")),
                  E = v($.createElement("optgroup")),
                  z = D.clone(),
                  h = 0,
                  w = i.children(),
                  B = w.length;
  ...
  (function (a) {
    ...
    try {
      ...
      ra("ngLocale", []).provider("$locale", Uc);
    }
    ra(
      "ng",
      ["ngLocale"],
