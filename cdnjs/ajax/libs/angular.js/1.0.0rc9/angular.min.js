...
(function (V, aa, p) {
  ...
  function Zb(b, a, c) {
    for (var d = jb(b), e = 0; e < d.length; e++) a.call(c, b[d[e]], d[e]);
    return d;
  }
  function kb(b) {
    return function (a, c) {
  ...
  function ea(b, a) {
    ...
    if (c == typeof a && c == "object")
      if (K(b)) {
        ...
        c = {};
        for (d in b) {
          if (d.charAt(0) !== "$" && !N(b[d]) && !ea(b[d], a[d])) return !1;
          c[d] = !0;
        }
  ...
  function Ya(b, a) {
    function c() {
      var e;
      for (var b = [this], c = a, h, f, i, k, j, n, l; b.length; ) {
        h = b.shift();
        f = 0;
  ...
  function L(b) {
    ...
    if (!(this instanceof L)) {
      if (G(b) && b.charAt(0) != "<") throw w("selectors not implemented");
      return new L(b);
    }
    if (G(b)) {
  ...
  function qb(b) {
    var a = b[ja],
      c = fa[a];
    c &&
      (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), rb(b)),
      delete fa[a],
      (b[ja] = p));
  }
  function ca(b, a, c) {
    var d = b[ja],
      e = fa[d || -1];
    if (E(c)) e || ((b[ja] = d = ++ab), (e = fa[d] = {})), (e[a] = c);
    else if (E(a))
      if (J(a)) d || (b[ja] = d = ++ab), (fa[d] = e = fa[d] || {}), C(e, a);
      else return e ? e[a] : p;
    else return d || (b[ja] = d = ++ab), e ? e : (fa[d] = {});
  }
  function za(b, a) {
    return (
      (" " + b.className + " ").replace(/[\n\t]/g, " ").indexOf(" " + a + " ") >
  ...
  function ub(b, a) {
    a &&
      m(a.split(" "), function (a) {
        if (!za(b, a)) b.className = S(b.className + " " + S(a));
      });
  }
  function Za(b, a) {
    if (a)
      for (
        var a = !a.nodeName && E(a.length) && !na(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
  ...
  function ob(b) {
        ...
        if (!k.get(a))
          if ((k.put(a, !0), G(a))) {
            ...
            try {
              ...
              throw (
                (j.message && (j.message += " from " + String(a[a.length - 1])),
                j)
              );
            }
          else pa(a, "module");
    ...
    function g(a, b) {
      function c(d) {
        ...
        if (a.hasOwnProperty(d)) {
          if (a[d] === h) throw w("Circular dependency: " + i.join(" <- "));
          return a[d];
        } else
          try {
      ...
      function d(a, b, e) {
        ...
        typeof a == "function"
          ? ((g = jc(a)), (k = g.length))
          : (K(a) && ((g = a), (k = g.length - 1), (a = g[k])), pa(a, "fn"));
        for (var l = 0; l < k; l++)
          (h = g[l]), f.push(e && e.hasOwnProperty(h) ? e[h] : c(h, i));
        switch (b ? -1 : f.length) {
          case 0:
            return a();
          case 1:
    ...
    var h = {},
      ...
      n = g(j, function () {
        throw w("Unknown provider: " + i.join(" <- "));
      }),
      l = {},
      s = (l.$injector = g(l, function (a) {
        a = n.get(a + f);
  ...
  function pc(b, a, c, d) {
        ...
        ? ((P = a),
          d.history
            ? b
              ...
              : (j.pushState(null, "", a), I.attr("href", I.attr("href")))
            : b
            ? k.replace(a)
            : (k.href = a),
          f)
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (G(b))
            (d =
              (i.cookie = escape(a) + "=" + escape(b) + ";path=" + H).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        if (i.cookie !== A) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (g = e.indexOf("=")),
              g > 0 &&
                ($[unescape(e.substring(0, g))] = unescape(e.substring(g + 1)));
        }
        return $;
      }
    };
    ...
    f.defer.cancel = function (a) {
      return s[a] ? (delete s[a], l(a), e(r), !0) : !1;
    };
  }
  function qc() {
    this.$get = [
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            var c = j[a] || (j[a] = { key: a });
            e(c);
            t(b) || (a in i || h++, (i[a] = b), h > k && this.remove(l.key));
          },
          get: function (a) {
            var b = j[a];
            if (b) return e(b), i[a];
  ...
  function yb(b) {
    ...
    this.$get = [
      ...
      function (b, i, k, j, n, l, s) {
        ...
        function z(a, b, c, d) {
          function e(a, c, d, i) {
            for (var g, k, l, j, T, n = 0, s = 0, q = f.length; n < q; s++)
              (l = c[s]),
                (g = f[n++]),
                (k = f[n++]),
                g
                  ? (g.scope
                      ? ((j = a.$new(J(g.scope))), u(l).data("$scope", j))
                      : (j = a),
                    (T = g.transclude) || (!i && b)
                      ? g(
                          k,
                      ...
                      : g(k, j, l, p, i))
                  : k && k(a, l.childNodes, p, i);
          }
          for (var f = [], i, g, k, l = 0; l < a.length; l++)
            (g = new t()),
              (i = P(a[l], [], g, d)),
              (g =
                (i = i.length ? I(i, a[l], g, b, c) : null) && i.terminal
                  ? null
                  : z(a[l].childNodes, i ? i.transclude : b)),
              f.push(i),
              f.push(g),
              (k = k || i || g);
          return k ? e : null;
        ...
        function P(a, b, c, f) {
          ...
          switch (a.nodeType) {
            case 1:
              O(b, da(zb(a).toLowerCase()), "E", f);
              var k, l, j;
              g = a.attributes;
              for (var n = 0, s = g && g.length; n < s; n++)
                if (((k = g[n]), k.specified))
                  (l = k.name),
                    (j = da(l.toLowerCase())),
                    (i[j] = l),
                    (c[j] = k =
                      S(
                        Z && l == "href"
                          ? decodeURIComponent(a.getAttribute(l, 2))
                          : k.value
                      )),
                    wb(a, j) && (c[j] = !0),
                    X(a, b, k, j),
        ...
        function I(a, b, c, d, e) {
          function f(a, b) {
            ...
            if (b) (b.require = y.require), z.push(b);
          }
          function i(a, b) {
            var c,
              d = "data",
          ...
          function l(a, d, e, f, g) {
            var j, T, q, o, R;
            j = b === e ? c : bc(c, new t(u(e), c.$attr));
            T = j.$$element;
            A &&
              J(A.scope) &&
              m(A.scope, function (a, b) {
                (ga[a] || M)(b, a, d.$parent || d, d, j);
              });
            D &&
              m(D, function (a) {
                var b = { $scope: d, $element: T, $attrs: j, $transclude: g };
                m(a.inject || {}, function (a, c) {
                  (ga[a] || M)(c, a, A ? d.$parent || d : d, b, j);
                });
                R = a.controller;
                R == "@" && (R = j[a.name]);
                T.data("$" + a.name + "Controller", s(R, b));
              });
            f = 0;
            for (q = n.length; f < q; f++)
              try {
                (o = n[f]), o(d, T, j, o.require && i(o.require, T));
              } catch (uc) {
                k(uc, ya(T));
              }
            ...
            for (q = z.length; f < q; f++)
              try {
                (o = z[f]), o(d, T, j, o.require && i(o.require, T));
              } catch (tc) {
                k(tc, ya(T));
              }
          }
          for (
            ...
            y = a[B];
            r = p;
            if (j > y.priority) break;
            if ((v = y.scope))
              H("isolated scope", I, y, F),
                J(v) && (q(F, "ng-isolate-scope"), (I = y)),
                q(F, "ng-scope"),
                (A = A || y);
            X = y.name;
            if ((v = y.controller))
              (D = D || {}),
                H("'" + X + "' controller", D[X], y, F),
                (D[X] = y);
            if ((v = y.transclude))
              H("transclusion", C, y, F),
                (C = y),
                (j = y.priority),
                v == "element"
                  ? ((r = u(b)),
                    ...
                    Da(e, u(r[0]), b),
                    (E = o(r, d, j)))
                  : ((r = u($a(b)).contents()), F.html(""), (E = o(r, d)));
            if ((v = y.template))
              if (
                (H("template", O, y, F),
                (O = y),
                (r = u("<div>" + S(v) + "</div>").contents()),
                (b = r[0]),
                y.replace)
              ) {
                if (r.length != 1 || b.nodeType !== 1) throw new w(g + v);
                Da(e, F, b);
                X = { $attr: {} };
                a = a.concat(P(b, a.splice(B + 1, a.length - (B + 1)), X));
                R(c, X);
                L = a.length;
              } else F.html(v);
            if (y.templateUrl)
              H("template", O, y, F),
                (O = y),
                (l = $(a.splice(B, a.length - B), l, F, c, e, y.replace, E)),
                (L = a.length);
            else if (y.compile)
              try {
                (x = y.compile(F, c, E)),
            ...
            if (y.terminal) (l.terminal = !0), (j = Math.max(j, y.priority));
          }
          l.scope = A && A.scope;
          l.transclude = C && E;
          return l;
        ...
        function O(d, e, i, g) {
          ...
          if (a.hasOwnProperty(e))
            for (var j, e = b.get(e + c), n = 0, s = e.length; n < s; n++)
              try {
                if (
                  ((j = e[n]),
                  (g === p || g > j.priority) && j.restrict.indexOf(i) != -1)
                )
                  d.push(j), (l = !0);
              } catch (q) {
                k(q);
        ...
        function $(a, b, c, d, e, f, i) {
          ...
          c.html("");
          j.get(o.templateUrl, { cache: n })
            .success(function (j) {
              var n, o;
              if (f) {
                o = u("<div>" + S(j) + "</div>").contents();
                n = o[0];
                if (o.length != 1 || n.nodeType !== 1) throw new w(g + j);
                j = { $attr: {} };
                Da(e, c, n);
                P(n, a, j);
                R(d, j);
              ...
              a.unshift(M);
              k = I(a, c, d, i);
              for (s = z(c.contents(), i); l.length; ) {
                var m = l.pop(),
                  j = l.pop();
                o = l.pop();
                var A = l.pop(),
                  H = n;
                o !== q && ((H = $a(n)), Da(j, u(o), H));
                k(
                  function () {
                    b(s, A, H, e, m);
                  },
            ...
            accessor: function (a, b, c, d, e) {
              ...
              g &&
                ...
                (i =
                  f.assign ||
                  function () {
                    throw w("Expression '" + g + "' not assignable.");
                  }));
              d[a] = function (a) {
                return arguments.length ? i(c, a) : f(c);
              };
            },
    ...
    this.$get = [
      ...
      function (c) {
        var d = b.length,
          e = a.length;
        return function (g, h) {
          for (var f, i, k = 0, j = [], n = g.length, l = !1, s = []; k < n; )
            (f = g.indexOf(b, k)) != -1 && (i = g.indexOf(a, f + d)) != -1
              ? (k != f && j.push(g.substring(k, f)),
                j.push((k = c((l = g.substring(f + d, i))))),
                (k.exp = l),
                (k = i + e),
                (l = !0))
              : (k != n && j.push(g.substring(k)), (k = n));
  ...
  function Cc(b, a, c) {
    ...
    if (decodeURIComponent(d.path) == a) return b;
      ...
      if (d.path.indexOf(h) !== 0)
        throw 'Invalid url "' + b + '", missing path prefix "' + h + '" !';
      return ta(d.protocol, d.host, d.port) + a + "#" + c + f + e + g;
    }
  }
  function db(b, a) {
    a = a || "";
    ...
    this.$$compose = function () {
      var b = mb(this.$$search),
        d = this.$$hash ? "#" + Wa(this.$$hash) : "";
      this.$$url = Ab(this.$$path) + (b ? "?" + b : "") + d;
      this.$$absUrl =
        ta(this.$$protocol, this.$$host, this.$$port) + a + this.$$url;
    };
    this.$$parse(b);
  }
  function eb(b, a) {
    ...
    this.$$compose = function () {
      ...
      this.$$absUrl =
        ta(this.$$protocol, this.$$host, this.$$port) +
        c +
        (this.$$url ? "#" + a + this.$$url : "");
    };
    this.$$parse(b);
      ...
      function (c, d, e, g) {
        ...
        if (a) {
          var e = (h = e.history
              ? new db(Bc(k, f, b), i)
              : new eb(Cc(k, f, b), b)),
            j = ta(e.protocol(), e.host(), e.port()) + i;
          g.bind("click", function (a) {
            if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
              for (var b = u(a.target); b.length && v(b[0].nodeName) !== "a"; )
                b = b.parent();
              var d = b.prop("href");
              if (d && !(b.attr("target") || d.indexOf(j) !== 0))
                h.url(d.substr(j.length)),
                  c.$apply(),
                  a.preventDefault(),
  ...
  function Gc(b, a) {
    ...
    for (var l = [], s, o = 0, m = [], q, z = ":"; o < b.length; ) {
      q = b.charAt(o);
      if (c("\"'")) n(q);
      else if (e(q) || (c(".") && e(d()))) k();
      else if (h(q)) {
        if (
          (j(), "{,".indexOf(z) != -1 && m[0] == "{" && (s = l[l.length - 1]))
        )
        ...
        var P = q + d(),
          ...
          p = Ga[P];
        p
          ? (l.push({ index: o, text: P, fn: p }), (o += 2))
          : I
          ? (l.push({
              index: o,
              text: q,
  ...
  function Ic(b, a, c, d) {
    ...
    function g() {
      if (H.length === 0) throw w("Unexpected end of expression: " + b);
      return H[0];
    }
    function h(a, b, c, d) {
      if (H.length > 0) {
    ...
    function f(b, c, d, f) {
      return (b = h(b, c, d, f))
        ? (a && !b.json && e("is not valid json", b), H.shift(), b)
        : !1;
    }
    function i(a) {
    ...
    function q() {
      var a;
      a = z();
      for (var b; (b = f("+", "-")); ) a = j(a, b.fn, z());
      if ((b = f("<", ">", "<=", ">="))) a = j(a, b.fn, q());
      return a;
    }
    function z() {
      for (var a = P(), b; (b = f("*", "/", "%")); ) a = j(a, b.fn, P());
      return a;
    }
    function P() {
      var a;
    ...
    a
      ? ((F = s),
        ...
        (A = I()))
      : (A = n());
    H.length !== 0 && e("is an unexpected token", H[0]);
    return A;
  }
  function Fb(b, a, c) {
  ...
  function Eb(b, a) {
    if (fb.hasOwnProperty(b)) return fb[b];
    var c = b.split("."),
      d = c.length,
      e;
    if (a)
        ...
        e.prototype = {
                        ...
                        (o = !0),
                          ...
                          m < 5 &&
                            ...
                            (I = N(a.exp)
                              ...
                              : a.exp),
                            (I += "; newVal: " + ba(d) + "; oldVal: " + ba(e)),
                            z[p].push(I));
                    } catch (R) {
                      c(R);
                    }
                if (!(h = q.$$childHead || (q !== this && q.$$nextSibling)))
                  for (; q !== this && !(h = q.$$nextSibling); ) q = q.$parent;
              } while ((q = h));
              if (o && !m--)
                throw w(
                  b +
          ...
          $emit: function (a, b) {
            var d = [],
              ...
              h = [g].concat(ha.call(arguments, 1)),
              m,
              q;
            do {
              e = f.$$listeners[a] || d;
              ...
              for (q = e.length; m < q; m++)
                try {
                  if ((e[m].apply(null, h), g.cancelled)) return g;
                } catch (z) {
                  c(z);
                }
              f = f.$parent;
  ...
  function Pc() {
    this.$get = [
      ...
      function (b) {
        var a = {},
          c = x((/android (\d+)/.exec(v(b.navigator.userAgent)) || [])[1]);
        return {
  ...
  function Rc() {
      ...
      d = (this.defaults = {
        transformResponse: [
          function (d) {
            G(d) &&
              ((d = d.replace(c, "")),
              b.test(d) && a.test(d) && (d = lb(d, !0)));
            return d;
          },
        ],
        transformRequest: [
          function (a) {
            return J(a) && Pa.apply(a) !== "[object File]" ? ba(a) : a;
          },
        ],
        headers: {
          common: {
    ...
    this.$get = [
      ...
      function (a, b, c, i, k, j) {
        ...
        function l(b, c, d) {
          function e(a, b, c) {
            m && (200 <= a && a < 300 ? m.put(M, [a, b, Hb(c)]) : m.remove(M));
            f(b, a, c);
            i.$apply();
          }
          function f(a, c, d) {
          ...
          if (m)
            if ((p = m.get(M)))
              ...
              else K(p) ? f(p[1], p[0], W(p[2])) : f(p, 200, {});
            else m.put(M, j);
          p || a(b.method, M, c, e, d, b.timeout, b.withCredentials);
          return j;
        }
        function s(a, b) {
          if (!b) return a;
  ...
  function Tc(b, a, c, d, e, g) {
    ...
    return function (e, i, k, j, n, l, s) {
      function o(a, c, d, e) {
        c = (i.match(Bb) || ["", g])[1] == "file" ? (d ? 200 : 404) : c;
        a(c == 1223 ? 204 : c, d, e);
      ...
      if (v(e) == "jsonp") {
        ...
        q.onreadystatechange = function () {
          q.readyState == 4 &&
            o(j, z || q.status, q.responseText, q.getAllResponseHeaders());
        };
  ...
  function Pb(b, a, c, d, e) {
    ...
    if (h.indexOf("e") !== -1) f = h;
      ...
      var h = Math.pow(10, e),
        ...
        n = a.gSize;
      if (h.length >= j + n)
        for (var k = h.length - j, l = 0; l < k; l++)
          (k - l) % n === 0 && l !== 0 && (f += c), (f += h.charAt(l));
      for (l = k; l < h.length; l++)
        (h.length - l) % j === 0 && l !== 0 && (f += c), (f += h.charAt(l));
      for (; b.length < e; ) b += "0";
      e && (f += d + b.substr(0, e));
    }
  ...
  function Rb(b, a) {
    ...
    d.$setValidity = function (a, b, k) {
      ...
      if (b) {
        ...
        if (j) {
          if (Ra(j, k) != -1) return;
        } else (h[a] = j = []), g++, c(!1, a), e.$setValidity(a, !1, d);
        j.push(k);
        d.$valid = !1;
        d.$invalid = !0;
      }
    ...
    i &&
      (i.match(/^\/(.*)\/$/)
        ...
        : (e = function (a) {
            var c = b.$eval(i);
            if (!c || !c.test)
              throw new w("Expected " + i + " to be a RegExp but was " + c);
            return k(c, a);
          }),
      d.$formatters.push(e),
      d.$parsers.push(e));
    if (c.ngMinlength) {
      var j = x(c.ngMinlength),
        e = function (a) {
          return !U(a) && a.length < j
  ...
  var v = function (b) {
    ...
    w = V.Error,
    Z = x((/msie (\d+)/.exec(v(navigator.userAgent)) || [])[1]),
    u,
    ia,
    ha = [].slice,
    Na = [].push,
  ...
  var ec = /[A-Z]/g,
    ...
    fa = (L.cache = {}),
    ja = (L.expando = "ng-" + new Date().getTime()),
    ab = 1,
    ed = V.document.addEventListener
      ? function (b, a, c) {
    ...
    sb = V.document.removeEventListener
      ? function (b, a, c) {
      ...
      function (a, c) {
        return {
          ...
          link: function (d, e, g, h) {
            h && (Vb[v(g.type)] || Vb.text)(d, e, g, h, c, a);
          },
        };
      },
    ],
      ...
      function (a, c, d, e, g) {
        ...
        this.$setValidity = function (a, c) {
          if (k[a] !== !c) {
            ...
            } else h(!1), (this.$invalid = !0), (this.$valid = !1), i++;
            k[a] = !c;
            h(c, a);
          ...
          link: function (e, g, h) {
            ...
            e.$watch(
              function () {
                ...
                return isNaN(c)
                  ? ""
                  : (j[c] || (c = a.pluralCat(c - k)), n[c](e, g, !0));
              },
              function (a) {
                g.text(a);
              }
        ...
        return function (a, c, h) {
          ...
          a.$watch(function (a) {
            ...
            if (K(h)) v = h || [];
              ...
              v = [];
              for (r in h)
                h.hasOwnProperty(r) && r.charAt(0) != "$" && v.push(r);
              v.sort();
            }
            e = 0;
            for (f = v.length; e < f; e++) {
              ...
              if ((w = n.shift(t))) {
                p = w.scope;
                u.push(t, w);
                if (e !== w.index) (w.index = e), A.after(w.element);
                A = w.element;
              } else p = a.$new();
              p[k] = t;
              j && (p[j] = r);
              p.$index = e;
              p.$position = e === 0 ? "first" : e == m - 1 ? "last" : "middle";
              w ||
                d(p, function (a) {
                  A.after(a);
                  w = { scope: p, element: (A = a), index: e };
                  u.push(t, w);
                });
            }
            for (r in n)
              if (n.hasOwnProperty(r))
                for (v = n[r]; v.length; )
                  (t = v.pop()), t.element.remove(), t.scope.$destroy();
            n = u;
          });
        };
      },
          ...
          controller: [
            ...
            function (a, c, d) {
              ...
              i.addOption = function (c) {
                k[c] = !0;
                j.$viewValue == c && (a.val(c), m.parent() && m.remove());
              };
          ...
          link: function (e, h, f, i) {
              ...
              function h() {
                ...
                for (w = c.length; y < w; y++) {
                  ...
                  for (A = i.length; x < A; x++)
                    if (((d = i[x]), (t = u[x + 1]))) {
                      z = t.element;
                      if (t.label !== d.label) z.text((t.label = d.label));
                      if (t.id !== d.id) z.val((t.id = d.id));
                      if (t.element.selected !== d.selected)
                        z.prop("selected", (t.selected = d.selected));
                    } else
                      d.id === "" && q
                        ? (B = q)
                        : (B = C.clone())
                        ...
                        z ? z.after(B) : r.element.append(B),
                        (z = B);
            ...
            if (i[1]) {
              ...
              if (o && (f.required || f.ngRequired)) {
                ...
                s.$parsers.push(A);
                s.$formatters.unshift(A);
                f.$observe("required", function () {
                  A(s.$viewValue);
                });
              }
              r ? n(e, h, s) : o ? j(e, h, s) : k(e, h, s, l);
            }
          },
        };
      },
      ...
      function (a) {
        ...
        return {
          ...
          compile: function (d, e) {
            ...
            return function (a, d, e, k) {
              k.databound ? d.prop("selected", !1) : (k = c);
              g
