...
(function (A, e, w) {
  "use strict";
  e.module("ngResource", ["ng"]).factory("$resource", [
    "$http",
    "$parse",
    function (x, y) {
      function k(a, f) {
      ...
      function u(a, f, b) {
        ...
        l(b, function (g, c) {
          var k =
            g.method == "POST" || g.method == "PUT" || g.method == "PATCH";
      ...
      t.prototype = {
        url: function (a) {
          ...
          l(this.urlParams, function (g, c) {
            ...
            e.isDefined(d) && d !== null
              ? ((h = k(d, !0)
                  .replace(/%26/gi, "&")
                  .replace(/%3D/gi, "=")
                  .replace(/%2B/gi, "+")),
                (b = b.replace(RegExp(":" + c + "(\\W)", "g"), h + "$1")))
              : (b = b.replace(RegExp("/?:" + c + "(\\W)", "g"), "$1"));
          });
          var b = b.replace(/\/?#$/, ""),
            i = [];
          l(a, function (a, b) {
