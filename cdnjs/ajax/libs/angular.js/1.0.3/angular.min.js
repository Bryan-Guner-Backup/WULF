...
(function (U, ca, p) {
  ...
  function sb(b) {
    var a = b[Aa],
      c = Ba[a];
    c &&
      (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), tb(b)),
      delete Ba[a],
      (b[Aa] = p));
  }
  function $(b, a, c) {
    ...
    function g(a, b) {
      ...
      function d(a, b, e) {
        ...
        for (g = k.length; n < g; n++)
          (i = k[n]), f.push(e && e.hasOwnProperty(i) ? e[i] : c(i, h));
        a.$inject || (a = a[g]);
        switch (b ? -1 : f.length) {
          case 0:
            return a();
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (F(b))
            (d =
              (h.cookie = escape(a) + "=" + escape(b) + ";path=" + M).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
          ...
          function e(a, c, d, k) {
            for (var g, h, j, n, o, l = 0, r = 0, q = f.length; l < q; r++)
              (j = c[r]),
                ...
                g
                  ? (g.scope
                      ? ((n = a.$new(L(g.scope))), u(j).data("$scope", n))
                      : (n = a),
                    (o = g.transclude) || (!k && b)
                      ? g(
                          h,
            ...
            (g = new ea()),
              ...
              (g =
                ...
                !a[j].childNodes.length
                  ? null
                  : s(a[j].childNodes, k ? k.transclude : b)),
              f.push(k),
              f.push(g),
              (h = h || k || g);
          return h ? e : null;
              ...
              M("transclusion", D, z, y),
                ...
                Y == "element"
                  ? ((X = u(b)),
                    ...
                    Ga(e, u(X[0]), b),
                    (v = w(X, d, n)))
                  : ((X = u(cb(b)).contents()), y.html(""), (v = w(X, d)));
            if ((Y = z.template))
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((h = d.baseHref() || "/"),
            ...
            (f = e.history
              ? new gb(Fc(j, h, b), k, l)
              : new Hb(Gc(j, h, b), b, l, h.substr(k.length + 1))))
          : ((l =
  ...
  function Kc(b, a) {
    ...
    for (var o = [], r, n = 0, w = [], q, s = ":"; n < b.length; ) {
      ...
      if (c("\"'")) l(q);
        ...
        if (
          (j(), "{,".indexOf(s) != -1 && w[0] == "{" && (r = o[o.length - 1]))
        )
        ...
        var m = q + d(),
          ...
          A = Ka[m];
        A
          ? (o.push({ index: n, text: m, fn: A }), (n += 2))
          : C
          ? (o.push({
              index: n,
              text: q,
    ...
    return function (e, h, k, j, l, o, r) {
      ...
      if (E(e) == "jsonp") {
        ...
        q.onreadystatechange = function () {
          q.readyState == 4 &&
            n(j, s || q.status, q.responseText, q.getAllResponseHeaders());
        };
  ...
  function Qb(b) {
    ...
    return function (b, d) {
      ...
      return Ub(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  var kc = /[A-Z]/g,
    ...
    db = U.document.removeEventListener
      ? function (b, a, c) {
          ...
          a.$watch(function (a) {
            ...
            for (C in l)
              if (l.hasOwnProperty(C))
                for (v = l[C]; v.length; )
                  (A = v.pop()), A.element.remove(), A.scope.$destroy();
            l = u;
          });
        };
      },
            ...
            if (h[1]) {
              for (
                var o = h[0],
                  ...
                  q = !1,
                  s,
                  D = u(ca.createElement("option")),
                  C = u(ca.createElement("optgroup")),
                  A = D.clone(),
                  h = 0,
                  x = i.children(),
                  E = x.length;
