...
(function (T, Y, p) {
  ...
  function U(b, a) {
    if (oa(b) || (b && b.$evalAsync && b.$watch))
      throw u("Can't copy Window or Scope");
    if (a) {
  ...
  function ab(b, a, c) {
    if (!b)
      throw new u("Argument '" + (a || "?") + "' is " + (c || "required"));
    return b;
  }
  function qa(b, a, c) {
  ...
  function cb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && v(a.length) && !oa(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
  ...
  function rb(b) {
    ...
    function c(a, b) {
      ...
      if (!b.$get)
        throw u("Provider " + a + " must define $get factory method.");
      return (k[a + f] = b);
    }
    function d(a, b) {
      return c(a, { $get: b });
    ...
    function g(a, b) {
      ...
      function d(a, b, e) {
        ...
        for (j = h.length; g < j; g++)
          (n = h[g]), f.push(e && e.hasOwnProperty(n) ? e[n] : c(n));
        a.$inject || (a = a[j]);
        switch (b ? -1 : f.length) {
          case 0:
            return a();
  ...
  function vc(b, a, c, d) {
    ...
    f.onUrlChange = function (a) {
      J ||
        (d.history && z(b).bind("popstate", i),
        d.hashchange ? z(b).bind("hashchange", i) : f.addPollFn(i),
        (J = !0));
      s.push(a);
      return a;
    };
        ...
        if (h.cookie !== P) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (j = e.indexOf("=")),
              j > 0 &&
                (ba[unescape(e.substring(0, j))] = unescape(
                  e.substring(j + 1)
                ));
        }
        return ba;
      ...
      function (b, h, j, k, l, o, r, n) {
        ...
        function x(a, b, c, d) {
          function e(a, c, d, j) {
            ...
            r = o = 0;
            for (l = f.length; o < l; r++)
              (h = q[r]),
                (c = f[o++]),
                (g = f[o++]),
                c
                  ? (c.scope
                      ? ((k = a.$new(M(c.scope))), z(h).data("$scope", k))
                      : (k = a),
                    (n = c.transclude) || (!j && b)
                      ? c(
                          g,
                      ...
                      : c(g, k, h, p, j))
                  : g && g(a, h.childNodes, p, j);
          }
          for (var f = [], j, g, h, k = 0; k < a.length; k++)
            (g = new ea()),
              (j = X(a[k], [], g, d)),
              (g =
                ((j = j.length ? A(j, a[k], g, b, c) : null) && j.terminal) ||
                !a[k].childNodes.length
                  ? null
                  : x(a[k].childNodes, j ? j.transclude : b)),
              f.push(j),
              f.push(g),
              (h = h || j || g);
          return h ? e : null;
        ...
        function A(a, b, c, d, e) {
          ...
          for (
            ...
            if ((W = B.scope))
              K("isolated scope", A, B, s),
                M(W) && (q(s, "ng-isolate-scope"), (A = B)),
                q(s, "ng-scope"),
                (x = x || B);
            G = B.name;
            if ((W = B.controller))
              (t = t || {}),
                K("'" + G + "' controller", t[G], B, s),
                (t[G] = B);
            if ((W = B.transclude))
              K("transclusion", C, B, s),
                (C = B),
                (n = B.priority),
                W == "element"
                  ? ((V = z(b)),
                    (s = c.$$element =
                      z(Y.createComment(" " + G + ": " + c[G] + " "))),
                    (b = s[0]),
                    Fa(e, z(V[0]), b),
                    (v = w(V, d, n)))
                  : ((V = z(db(b)).contents()), s.html(""), (v = w(V, d)));
            if ((W = B.template))
            ...
            if (B.templateUrl)
              K("template", P, B, s),
                (P = B),
                (k = ba(a.splice(D, a.length - D), k, s, c, e, B.replace, v)),
                (F = a.length);
            else if (B.compile)
              try {
                (y = B.compile(s, c, v)),
                  L(y) ? f(null, y) : y && f(y.pre, y.post);
              } catch (H) {
                j(H, pa(s));
              }
  ...
  function Dc() {
    ...
    this.$get = [
      ...
      function (c) {
        function d(d, f) {
          for (var h, j, k = 0, l = [], o = d.length, r = !1, n = []; k < o; )
            (h = d.indexOf(b, k)) != -1 && (j = d.indexOf(a, h + e)) != -1
              ? (k != h && l.push(d.substring(k, h)),
                l.push((k = c((r = d.substring(h + e, j))))),
                (k.exp = r),
                (k = j + g),
                (r = !0))
              : (k != o && l.push(d.substring(k)), (k = o));
  ...
  function Fc(b, a, c) {
    ...
    if (decodeURIComponent(d.path) == a) return b;
      ...
      if (d.path.indexOf(i) !== 0)
        throw u('Invalid url "' + b + '", missing path prefix "' + i + '" !');
  ...
  function hb(b, a, c) {
    ...
    this.$$parse = function (b) {
      ...
      if (c.path.indexOf(a) !== 0)
        throw u('Invalid url "' + b + '", missing path prefix "' + a + '" !');
  ...
  function Ia(b, a, c) {
    ...
    this.$$parse = function (b) {
      ...
      if (c.hash && c.hash.indexOf(a) !== 0)
        throw u('Invalid url "' + b + '", missing hash prefix "' + a + '" !');
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((h = d.baseHref() || "/"),
            ...
            (f = e.history
              ? new hb(Ec(k, h, b), j, l)
              : new Ib(Fc(k, h, b), b, l, h.substr(j.length + 1))))
          : ((l =
  ...
  function Jc(b, a) {
    ...
    for (var o = [], r, n = 0, w = [], q, x = ":"; n < b.length; ) {
      ...
      if (c("\"'")) l(q);
        ...
        if (
          (k(), "{,".indexOf(x) != -1 && w[0] == "{" && (r = o[o.length - 1]))
        )
        ...
        var m = q + d(),
          ...
          s = Ka[m];
        s
          ? (o.push({ index: n, text: m, fn: s }), (n += 2))
          : A
          ? (o.push({
              index: n,
              text: q,
    ...
    this.$get = [
      ...
      function (a, c, d, e, g, i, f) {
        ...
        function k() {
          ...
          m(b, function (b, e) {
            if (!d && (a = h(c.path(), e)))
              (d = xa(b, { params: y({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
                        ...
                        (m = !0),
                          ...
                          q < 5 &&
                            ...
                            (s = L(a.exp)
                              ...
                              : a.exp),
                            (s += "; newVal: " + da(d) + "; oldVal: " + da(e)),
                            p[A].push(s));
                    } catch (ba) {
                      c(ba);
                    }
                if (!(i = x.$$childHead || (x !== this && x.$$nextSibling)))
    ...
    return function (e, h, j, k, l, o, r) {
      ...
      if (D(e) == "jsonp") {
        ...
        q.onreadystatechange = function () {
          q.readyState == 4 &&
            n(k, x || q.status, q.responseText, q.getAllResponseHeaders());
        };
  ...
  function Vb(b, a, c, d, e) {
    ...
    if (!j) {
      ...
      var i = Math.pow(10, e),
        ...
        l = a.gSize;
      if (i.length >= k + l)
        for (var j = i.length - k, o = 0; o < j; o++)
          (j - o) % l === 0 && o !== 0 && (f += c), (f += i.charAt(o));
      for (o = j; o < i.length; o++)
        (i.length - o) % k === 0 && o !== 0 && (f += c), (f += i.charAt(o));
      for (; b.length < e; ) b += "0";
      e && (f += d + b.substr(0, e));
    }
  ...
  function Sb(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (h = fd.exec(e))
          ? ((i = i.concat(ia.call(h, 1))), (e = i.pop()))
          : (i.push(e), (e = null));
      m(i, function (a) {
        f = gd[a];
        g += f
    ...
    h &&
      (h.match(/^\/(.*)\/$/)
        ...
        : (e = function (a) {
            var c = b.$eval(h);
            if (!c || !c.test)
              throw new u("Expected " + h + " to be a RegExp but was " + c);
            return j(c, a);
          }),
      d.$formatters.push(e),
      d.$parsers.push(e));
        ...
        return function (a, c, i) {
          ...
          a.$watch(function (a) {
            ...
            if (I(i)) t = i || [];
              ...
              t = [];
              for (s in i)
                i.hasOwnProperty(s) && s.charAt(0) != "$" && t.push(s);
              t.sort();
            }
            z = t.length;
            e = 0;
            ...
            for (s in l)
              if (l.hasOwnProperty(s))
                for (t = l[s]; t.length; )
                  (v = t.pop()), v.element.remove(), v.scope.$destroy();
            l = p;
          });
        };
      },
                  ...
                  for (z = i.length; y < z; y++)
                    if (((d = i[y]), (u = v[y + 1]))) {
                      ...
                      d.id === "" && q
                        ...
                        B ? B.after(D) : t.element.append(D),
                        (B = D);
            ...
            if (h[1]) {
              for (
                var o = h[0],
                  ...
                  q = !1,
                  x,
                  C = z(Y.createElement("option")),
                  A = z(Y.createElement("optgroup")),
                  s = C.clone(),
                  h = 0,
                  y = i.children(),
                  D = y.length;
