...
(function (N, Y, q) {
  ...
  function cb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && y(a.length) && !pa(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === q)
          ...
          if (B(b))
            (d =
              (j.cookie = escape(a) + "=" + escape(b) + ";path=" + Q).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        function z(a, b, c, d) {
          ...
          for (var g = [], i, h, j, k = 0; k < a.length; k++)
            (h = new ia()),
              (i = W(a[k], [], h, d)),
              (h =
                ((i = i.length ? J(i, a[k], h, b, c) : null) && i.terminal) ||
                !a[k].childNodes ||
            ...
            if ((X = r.transclude))
              ua("transclusion", ka, r, D),
                ...
                X == "element"
                  ? ((T = u(b)),
                    (D = c.$$element =
                      u(Y.createComment(" " + F + ": " + c[F] + " "))),
                    (b = D[0]),
                    w(e, u(T[0]), b),
                    (S = P(T, d, l)))
                  : ((T = u(db(b)).contents()), D.html(""), (S = P(T, d)));
            if ((X = r.template))
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((j = d.baseHref() || "/"),
            ...
            (f = e.history
              ? new ib(Fc(k, j, b), i, m)
              : new Jb(Gc(k, j, b), b, m, j.substr(i.length + 1))))
          : ((m =
  ...
  function Kc(b, a) {
    ...
    for (var l = [], t, o = 0, p = [], s, P = ":"; o < b.length; ) {
      ...
      if (c("\"'")) m(s);
        ...
        if (
          (k(), "{,".indexOf(P) != -1 && p[0] == "{" && (t = l[l.length - 1]))
        )
        ...
        var n = s + d(),
          ...
          W = Ja[n];
        W
          ? (l.push({ index: o, text: n, fn: W }), (o += 2))
          : z
          ? (l.push({
              index: o,
              text: s,
  ...
  function Mc(b, a, c, d) {
    ...
    function n() {
      for (var a = C(), b; (b = f("*", "/", "%")); ) a = k(a, b.fn, C());
      return a;
    }
    function C() {
      var a;
  ...
  var kc = /[A-Z]/g,
    ...
    eb = N.document.removeEventListener
      ? function (b, a, c) {
