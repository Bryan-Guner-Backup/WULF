...
(function (P, T, q) {
  ...
  function bb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && y(a.length) && !oa(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === q)
          ...
          if (B(b))
            (d =
              (i.cookie = escape(a) + "=" + escape(b) + ";path=" + R).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              ...
              j > 0 &&
                ...
                r[a] === q && (r[a] = unescape(e.substring(j + 1))));
        }
        return r;
      }
    };
      ...
      function (b, j, k, l, n, o, p, s, t) {
        function x(a, b, c) {
          ...
          return function (b, c) {
            $a(b, "scope");
            for (
              var e = c ? ua.clone.call(a) : a, j = 0, g = e.length;
              j < g;
              j++
            ) {
              var h = e[j];
          ...
          function e(a, c, d, g) {
            ...
            for (l = j.length; o < l; n++)
              (i = t[n]),
                ...
                c
                  ? (c.scope
                      ? ((k = a.$new(L(c.scope))), u(i).data("$scope", k))
                      : (k = a),
                    (p = c.transclude) || (!g && b)
                      ? c(
                          h,
                      ...
                      : c(h, k, i, q, g))
                  : h && h(a, i.childNodes, q, g);
          }
          for (var j = [], g, h, i, k = 0; k < a.length; k++)
            (h = new ia()),
              (g = N(a[k], [], h, d)),
              (h =
                ((g = g.length ? J(g, a[k], h, b, c) : null) && g.terminal) ||
                !a[k].childNodes ||
                !a[k].childNodes.length
                  ? null
                  : A(a[k].childNodes, g ? g.transclude : b)),
              j.push(g),
              j.push(h),
              (i = i || g || h);
          return i ? e : null;
        ...
        function J(a, b, c, d, e) {
          ...
          for (
            ...
            if ((Y = r.scope))
              ta("isolated scope", J, r, D),
                L(Y) && (M(D, "ng-isolate-scope"), (J = r)),
                M(D, "ng-scope"),
                (s = s || r);
            F = r.name;
            if ((Y = r.controller))
              (y = y || {}),
                ta("'" + F + "' controller", y[F], r, D),
                (y[F] = r);
            if ((Y = r.transclude))
              ta("transclusion", ja, r, D),
                (ja = r),
                (l = r.priority),
                Y == "element"
                  ? ((W = u(b)),
                    (D = c.$$element =
                      u(T.createComment(" " + F + ": " + c[F] + " "))),
                    (b = D[0]),
                    C(e, u(W[0]), b),
                    (V = x(W, d, l)))
                  : ((W = u(cb(b)).contents()), D.html(""), (V = x(W, d)));
            if ((Y = r.template))
            ...
            if (r.templateUrl)
              ta("template", A, r, D),
                (A = r),
                (i = R(a.splice(v, a.length - v), i, D, c, e, r.replace, V)),
                (z = a.length);
            else if (r.compile)
              try {
                (w = r.compile(D, c, V)),
                  H(w) ? j(null, w) : w && j(w.pre, w.post);
              } catch (G) {
                k(G, pa(D));
              }
  ...
  function Lc(b, a) {
    ...
    for (var n = [], o, p = 0, s = [], t, x = ":"; p < b.length; ) {
      ...
      if (c("\"'")) l(t);
        ...
        if (
          (k(), "{,".indexOf(x) != -1 && s[0] == "{" && (o = n[n.length - 1]))
        )
        ...
        var m = t + d(),
          ...
          N = Ia[m];
        N
          ? (n.push({ index: p, text: m, fn: N }), (p += 2))
          : A
          ? (n.push({
              index: p,
              text: t,
    ...
    this.$get = [
      ...
      function (a, c, d, e, g, h, f) {
        ...
        function k() {
          ...
          m(b, function (b, e) {
            if (!d && (a = i(c.path(), e)))
              (d = ya(b, { params: v({}, c.search(), a), pathParams: a })),
                (d.$$route = b);
          });
  ...
  var kc = /[A-Z]/g,
    ...
    db = P.document.removeEventListener
      ? function (b, a, c) {
            ...
            if (i[1]) {
              for (
                var n = i[0],
                  ...
                  t = !1,
                  v,
                  C = u(T.createElement("option")),
                  A = u(T.createElement("optgroup")),
                  z = C.clone(),
                  i = 0,
                  B = h.children(),
                  r = B.length;
