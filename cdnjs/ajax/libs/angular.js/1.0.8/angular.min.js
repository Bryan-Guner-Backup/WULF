...
(function (P, T, q) {
  ...
  function U(b, a) {
    ...
    if (a) {
      ...
      if (E(b)) for (var c = (a.length = 0); c < b.length; c++) a.push(U(b[c]));
      else {
        c = a.$$hashKey;
        m(a, function (b, c) {
          delete a[c];
  ...
  function eb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && v(a.length) && !pa(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
  ...
  function Eb(b) {
    ...
    if (typeof b == "function") {
      if (!(a = b.$inject))
        (a = []),
          (c = b.toString().replace(sc, "")),
          (c = c.match(tc)),
          m(c[1].split(uc), function (b) {
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === q)
          ...
          if (B(b))
            (d =
              (i.cookie = escape(a) + "=" + escape(b) + ";path=" + t).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        if (i.cookie !== Q) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (j = e.indexOf("=")),
              j > 0 &&
                ((a = unescape(e.substring(0, j))),
                ga[a] === q && (ga[a] = unescape(e.substring(j + 1))));
        }
        return ga;
      }
    };
      ...
      function (b, j, k, l, n, o, p, z, r) {
        function x(a, b, c) {
          ...
          return function (b, c) {
            bb(b, "scope");
            for (
              var e = c ? va.clone.call(a) : a, g = 0, j = e.length;
              g < j;
              g++
            ) {
              var h = e[g];
          ...
          function e(a, c, d, j) {
            ...
            for (l = g.length; o < l; n++)
              (i = r[n]),
                ...
                c
                  ? (c.scope
                      ? ((k = a.$new(M(c.scope))), w(i).data("$scope", k))
                      : (k = a),
                    (p = c.transclude) || (!j && b)
                      ? c(
                          h,
                      ...
                      : c(h, k, i, q, j))
                  : h && h(a, i.childNodes, q, j);
          }
          for (var g = [], j, h, i, k = 0; k < a.length; k++)
            (h = new ia()),
              (j = J(a[k], [], h, d)),
              (h =
                ((j = j.length ? K(j, a[k], h, b, c) : null) && j.terminal) ||
                !a[k].childNodes ||
                !a[k].childNodes.length
                  ? null
                  : A(a[k].childNodes, j ? j.transclude : b)),
              g.push(j),
              g.push(h),
              (i = i || j || h);
          return i ? e : null;
        ...
        function K(a, b, c, d, e) {
          ...
          for (
            ...
            if ((u = t.scope))
              ua("isolated scope", K, t, F),
                M(u) && (N(F, "ng-isolate-scope"), (K = t)),
                N(F, "ng-scope"),
                (z = z || t);
            C = t.name;
            if ((u = t.controller))
              (Y = Y || {}),
                ua("'" + C + "' controller", Y[C], t, F),
                (Y[C] = t);
            if ((u = t.transclude))
              ua("transclusion", ja, t, F),
                (ja = t),
                (l = t.priority),
                u == "element"
                  ? ((R = w(b)),
                    (F = c.$$element =
                      w(T.createComment(" " + C + ": " + c[C] + " "))),
                    (b = F[0]),
                    v(e, w(R[0]), b),
                    (da = x(R, d, l)))
                  : ((R = w(fb(b)).contents()), F.html(""), (da = x(R, d)));
            if ((u = t.template))
              if ((ua("template", A, t, F), (A = t), (u = Hb(u)), t.replace)) {
                R = w("<div>" + S(u) + "</div>").contents();
                b = R[0];
                if (R.length != 1 || b.nodeType !== 1) throw Error(g + u);
                v(e, F, b);
                C = { $attr: {} };
            ...
            if (t.templateUrl)
              ua("template", A, t, F),
                (A = t),
                (i = Q(a.splice(D, a.length - D), i, F, c, e, t.replace, da)),
                (y = a.length);
            else if (t.compile)
              try {
                (s = t.compile(F, c, da)),
                  H(s) ? j(null, s) : s && j(s.pre, s.post);
              } catch (G) {
                k(G, qa(F));
              }
          ...
          if (a.hasOwnProperty(e))
            for (var o, e = b.get(e + c), l = 0, p = e.length; l < p; l++)
              try {
                if (
                  ((o = e[l]),
                  (j === q || j > o.priority) && o.restrict.indexOf(g) != -1)
                )
                  d.push(o), (h = !0);
              } catch (n) {
                k(n);
      ...
      function (c) {
        function d(d, f) {
          for (var i, j, k = 0, l = [], n = d.length, o = !1, p = []; k < n; )
            (i = d.indexOf(b, k)) != -1 && (j = d.indexOf(a, i + e)) != -1
              ? (k != i && l.push(d.substring(k, i)),
                l.push((k = c((o = d.substring(i + e, j))))),
                (k.exp = o),
                (k = j + g),
                (o = !0))
              : (k != n && l.push(d.substring(k)), (k = n));
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((i = d.baseHref() || "/"),
            ...
            (f = e.history
              ? new ib(Jc(k, i, b), j, l)
              : new Lb(Kc(k, i, b), b, l, i.substr(j.length + 1))))
          : ((l =
  ...
  function Oc(b, a) {
    ...
    for (var n = [], o, p = 0, z = [], r, x = ":"; p < b.length; ) {
      ...
      if (c("\"'")) l(r);
        ...
        if (
          (k(), "{,".indexOf(x) != -1 && z[0] == "{" && (o = n[n.length - 1]))
        )
        ...
        var m = r + d(),
          ...
          J = Ja[m];
        J
          ? (n.push({ index: p, text: m, fn: J }), (p += 2))
          : A
          ? (n.push({
              index: p,
              text: r,
            ...
            (p += 1))
          : i("Unexpected next character ", p, p + 1);
      }
      x = r;
    }
    return n;
  ...
  function Xc() {
    this.$get = [
      ...
      function (b) {
        var a = {},
          c = G((/android (\d+)/.exec(y(b.navigator.userAgent)) || [])[1]);
        return {
        ...
        var c = E(c) ? c : [c],
          c = Ta(c, function (a) {
            ...
            return e(function (a, b) {
              ...
              f == g
                ? (f == "string" &&
                    ((c = c.toLowerCase()), (e = e.toLowerCase())),
                  (c = c === e ? 0 : c < e ? -1 : 1))
                : (c = f < g ? -1 : 1);
              return c;
            }, c);
  ...
  var mc = /[A-Z]/g,
    ...
    Ba = (L.cache = {}),
    Aa = (L.expando = "ng-" + new Date().getTime()),
    qc = 1,
    bc = P.document.addEventListener
      ? function (b, a, c) {
          ...
          link: function (e, g, h) {
            ...
            e.$watch(
              function () {
                ...
                return isNaN(c)
                  ? ""
                  : (c in k || (c = a.pluralCat(c - j)), l[c](e, g, !0));
              },
              function (a) {
                g.text(a);
              }
            ...
            function l(e, f, g) {
              function h() {
                ...
                for (z = 0; (C = x.length), z < C; z++) {
                  ...
                  B = j(e, y);
                  B = B === q ? "" : B;
                  i.push({ id: l ? x[z] : z, label: B, selected: d });
                }
                p ||
                  (r || s === null
                  ...
                  for (C = i.length; z < C; z++)
                    if (((d = i[z]), (u = v[z + 1]))) {
                      ...
                      d.id === "" && r
                        ...
                        B ? B.after(E) : s.element.append(E),
                        (B = E);
            ...
            if (i[1]) {
              for (
                var n = i[0],
                  ...
                  r = !1,
                  x,
                  D = w(T.createElement("option")),
                  A = w(T.createElement("optgroup")),
                  y = D.clone(),
                  i = 0,
                  B = h.children(),
                  C = B.length;
