...
(function (U, ba, p) {
  ...
  function bb(b, a) {
    function c() {
      var e;
      for (var b = [this], c = a, i, f, g, k, j, l; b.length; ) {
        i = b.shift();
        f = 0;
  ...
  function ta(b) {
    ub(b);
    for (var a = 0, b = b.childNodes || []; a < b.length; a++) ta(b[a]);
  }
  function vb(b, a, c) {
    var d = $(b, "events");
    $(b, "handle") &&
  ...
  function ub(b) {
    var a = b[Ea],
      c = Fa[a];
    c &&
      (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), vb(b)),
      delete Fa[a],
      (b[Ea] = p));
  }
  function $(b, a, c) {
    var d = b[Ea],
      d = Fa[d || -1];
    if (s(c)) d || ((b[Ea] = d = ++oc), (d = Fa[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function wb(b, a, c) {
    var d = $(b, "data"),
  ...
  function yb(b, a) {
    a &&
      m(a.split(" "), function (a) {
        if (!Ga(b, a)) b.className = R(b.className + " " + R(a));
      });
  }
  function cb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && s(a.length) && !pa(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
  ...
  function sb(b) {
        ...
        if (!k.get(a))
          if ((k.put(a, !0), F(a))) {
            ...
            try {
              ...
              throw (
                (q.message && (q.message += " from " + String(a[a.length - 1])),
                q)
              );
            }
          else sa(a, "module");
    ...
    function h(a, b) {
      function c(d) {
        ...
        if (a.hasOwnProperty(d)) {
          if (a[d] === i) throw y("Circular dependency: " + g.join(" <- "));
          return a[d];
        } else
          try {
            return g.unshift(d), (a[d] = i), (a[d] = b(d));
          } finally {
            g.shift();
          }
      }
      function d(a, b, e) {
        ...
        for (h = k.length; n < h; n++)
          (i = k[n]), f.push(e && e.hasOwnProperty(i) ? e[i] : c(i, g));
        a.$inject || (a = a[h]);
        switch (b ? -1 : f.length) {
          case 0:
            return a();
    ...
    var i = {},
      ...
      l = (j.$injector = h(j, function () {
        throw y("Unknown provider: " + g.join(" <- "));
      })),
      o = {},
      q = (o.$injector = h(o, function (a) {
        a = l.get(a + f);
  ...
  function vc(b, a, c, d) {
          ...
          return (
            ...
            d.history
              ? b
                ...
                : (j.pushState(null, "", a), C.attr("href", C.attr("href")))
              : b
              ? k.replace(a)
              : (k.href = a),
            f
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (F(b))
            (d =
              (g.cookie = escape(a) + "=" + escape(b) + ";path=" + I).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        if (g.cookie !== x) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (k = e.indexOf("=")),
              k > 0 &&
                (W[unescape(e.substring(0, k))] = unescape(e.substring(k + 1)));
        }
        return W;
      }
    };
    ...
    f.defer.cancel = function (a) {
      return q[a] ? (delete q[a], o(a), e(D), !0) : !1;
    };
  }
  function wc() {
    this.$get = [
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            ...
            e(c);
            if (!u(b))
              return a in g || i++, (g[a] = b), i > k && this.remove(o.key), b;
          },
          get: function (a) {
            var b = j[a];
            if (b) return e(b), g[a];
  ...
  function Db(b) {
            ...
            b.factory(d + c, [
              ...
              function (b, c) {
                ...
                m(a[d], function (a) {
                  try {
                    var f = b.invoke(a);
                    if (N(f)) f = { compile: L(f) };
                    else if (!f.compile && f.link) f.compile = L(f.link);
    ...
    this.$get = [
      ...
      "$controller",
      "$rootScope",
      function (b, g, k, j, l, o, q, n) {
        function z(a, b, c) {
          a instanceof t || (a = t(a));
          m(a, function (b, c) {
            b.nodeType == 3 && (a[c] = t(b).wrap("<span></span>").parent()[0]);
          });
          var d = v(a, b, a, c);
          return function (b, c) {
            ra(b, "scope");
            var e = c ? va.clone.call(a) : a;
            e.data("$scope", b);
            r(e, "ng-scope");
            c && c(e, b);
            d && d(b, e, e);
        ...
        function v(a, b, c, d) {
          function e(a, c, d, k) {
            for (var g, h, j, n, o, l = 0, q = 0, r = f.length; l < r; q++)
              (j = c[q]),
                (g = f[l++]),
                (h = f[l++]),
                g
                  ? (g.scope
                      ? ((n = a.$new(M(g.scope))), t(j).data("$scope", n))
                      : (n = a),
                    (o = g.transclude) || (!k && b)
                      ? g(
                          h,
                      ...
                      : g(h, n, j, p, k))
                  : h && h(a, j.childNodes, p, k);
          }
          for (var f = [], k, g, h, j = 0; j < a.length; j++)
            (g = new ea()),
              (k = da(a[j], [], g, d)),
              (g =
                ((k = k.length ? C(k, a[j], g, b, c) : null) && k.terminal) ||
                !a[j].childNodes.length
                  ? null
                  : v(a[j].childNodes, k ? k.transclude : b)),
              f.push(k),
              f.push(g),
              (h = h || k || g);
          return h ? e : null;
        ...
        function da(a, b, c, f) {
          ...
          switch (a.nodeType) {
            case 1:
              w(b, fa(Eb(a).toLowerCase()), "E", f);
              var h, j, n;
              g = a.attributes;
              for (var l = 0, o = g && g.length; l < o; l++)
                if (((h = g[l]), h.specified))
                  (j = h.name),
                    (n = fa(j.toLowerCase())),
                    (k[n] = j),
                    (c[n] = h =
        ...
        function C(a, b, c, d, e) {
          function f(a, b) {
            if (a) (a.require = A.require), l.push(a);
            if (b) (b.require = A.require), v.push(b);
          }
          function g(a, b) {
            var c,
              d = "data",
          ...
          function n(a, d, e, f, h) {
            var j, r, z, K, Q;
            j = b === e ? c : hc(c, new ea(t(e), c.$attr));
            r = j.$$element;
            if (C) {
              var zc = /^\s*([@=&])\s*(\w*)\s*$/,
                x = d.$parent || d;
                ...
                switch (c[1]) {
                  ...
                  case "=":
                    ...
                    k =
                      ...
                      function () {
                        f = d[b] = g(x);
                        throw y(Fb + j[e] + " (directive: " + C.name + ")");
                      };
                    f = d[b] = g(x);
                    d.$watch(function () {
                      var a = g(x);
                      a !== d[b] &&
                        (a !== f ? (f = d[b] = a) : k(x, (a = f = d[b])));
                      return a;
                    });
                    break;
                  case "&":
            ...
            s &&
              m(s, function (a) {
                var b = { $scope: d, $element: r, $attrs: j, $transclude: h };
                Q = a.controller;
                Q == "@" && (Q = j[a.name]);
                r.data("$" + a.name + "Controller", q(Q, b));
              });
            f = 0;
            for (z = l.length; f < z; f++)
              try {
                (K = l[f]), K(d, r, j, K.require && g(K.require, r));
              } catch (I) {
                k(I, qa(r));
              }
            a && a(d, e.childNodes, p, h);
            f = 0;
            for (z = v.length; f < z; f++)
              try {
                (K = v[f]), K(d, r, j, K.require && g(K.require, r));
              } catch (w) {
                k(w, qa(r));
              }
          }
          for (
            ...
            A = a[E];
            X = p;
            if (j > A.priority) break;
            if ((Y = A.scope))
              I("isolated scope", C, A, x),
                M(Y) && (r(x, "ng-isolate-scope"), (C = A)),
                r(x, "ng-scope"),
                (K = K || A);
            J = A.name;
            if ((Y = A.controller))
              (s = s || {}),
                I("'" + J + "' controller", s[J], A, x),
                (s[J] = A);
            if ((Y = A.transclude))
              I("transclusion", D, A, x),
                (D = A),
                (j = A.priority),
                Y == "element"
                  ? ((X = t(b)),
                    ...
                    Ka(e, t(X[0]), b),
                    (u = z(X, d, j)))
                  : ((X = t(db(b)).contents()), x.html(""), (u = z(X, d)));
            if ((Y = A.template))
              if ((I("template", w, A, x), (w = A), (Y = Gb(Y)), A.replace)) {
                X = t("<div>" + R(Y) + "</div>").contents();
                b = X[0];
                if (X.length != 1 || b.nodeType !== 1) throw new y(h + Y);
                Ka(e, x, b);
                J = { $attr: {} };
                a = a.concat(da(b, a.splice(E + 1, a.length - (E + 1)), J));
                Q(c, J);
                G = a.length;
              } else x.html(Y);
            if (A.templateUrl)
              I("template", w, A, x),
                (w = A),
                (n = W(a.splice(E, a.length - E), n, x, c, e, A.replace, u)),
                (G = a.length);
            else if (A.compile)
              try {
                (B = A.compile(x, c, u)),
                  N(B) ? f(null, B) : B && f(B.pre, B.post);
              } catch (L) {
                k(L, qa(x));
              }
            if (A.terminal) (n.terminal = !0), (j = Math.max(j, A.priority));
          }
          n.scope = K && K.scope;
          n.transclude = D && u;
          return n;
        ...
        function w(d, e, g, h) {
          ...
          if (a.hasOwnProperty(e))
            for (var n, e = b.get(e + c), l = 0, o = e.length; l < o; l++)
              try {
                if (
                  ((n = e[l]),
        ...
        function W(a, b, c, d, e, f, g) {
          ...
          c.html("");
          j.get(r.templateUrl, { cache: l })
            .success(function (j) {
              var l,
                r,
                j = Gb(j);
              if (f) {
                r = t("<div>" + R(j) + "</div>").contents();
                l = r[0];
                if (r.length != 1 || l.nodeType !== 1) throw new y(h + j);
                j = { $attr: {} };
                Ka(e, c, l);
                da(l, a, j);
                Q(d, j);
              ...
              a.unshift(z);
              n = C(a, c, d, g);
              for (o = v(c.contents(), g); k.length; ) {
                var K = k.pop(),
                  j = k.pop();
                r = k.pop();
                var x = k.pop(),
                  m = l;
                r !== q && ((m = db(l)), Ka(j, t(r), m));
                n(
                  function () {
                    b(o, x, m, e, K);
                  },
        ...
        var D = g.startSymbol(),
          ...
          Gb =
            D == "{{" || K == "}}"
              ? na
              : function (a) {
                  return a.replace(/\{\{/g, D).replace(/}}/g, K);
                };
        return z;
      },
    ];
  ...
  function Ec() {
    ...
    this.$get = [
      ...
      function (c, d) {
        function e(e, g) {
          for (var k, j, l = 0, o = [], q = e.length, n = !1, z = []; l < q; )
            (k = e.indexOf(b, l)) != -1 && (j = e.indexOf(a, k + h)) != -1
              ? (l != k && o.push(e.substring(l, k)),
                o.push((l = c((n = e.substring(k + h, j))))),
                (l.exp = n),
                (l = j + i),
                (n = !0))
              : (l != q && o.push(e.substring(l)), (l = q));
          if (!(q = o.length)) o.push(""), (q = 1);
          if (!g || n)
            return (
              (z.length = q),
              (l = function (a) {
  ...
  function Gc(b, a, c) {
    ...
    if (decodeURIComponent(d.path) == a) return b;
      ...
      if (d.path.indexOf(i) !== 0)
        throw y('Invalid url "' + b + '", missing path prefix "' + i + '" !');
      return ka(d.protocol, d.host, d.port) + a + "#" + c + f + e + h;
    }
  }
  function ib(b, a, c) {
    a = a || "";
  ...
  function Ic() {
    ...
    this.$get = [
      ...
      function (c, d, e, h) {
        ...
        a
          ? ((g = d.baseHref() || "/"),
            (k = g.substr(0, g.lastIndexOf("/"))),
            (l = ka(l.protocol, l.host, l.port) + k + "/"),
            (f = e.history
              ? new ib(Fc(j, g, b), k, l)
              : new Ib(Gc(j, g, b), b, l, g.substr(k.length + 1))))
          : ((l =
        ...
        h.bind("click", function (a) {
          if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
            for (var b = t(a.target); G(b[0].nodeName) !== "a"; )
  ...
  function Kc(b, a) {
    ...
    function k() {
      for (var a = "", c = n; n < b.length; ) {
        ...
        if (k == "." || e(k)) a += k;
          ...
          var h = d();
          if (k == "e" && f(h)) a += k;
          else if (f(k) && h && e(h) && a.charAt(a.length - 1) == "e") a += k;
          else if (f(k) && (!h || !e(h)) && a.charAt(a.length - 1) == "e")
            g("Invalid exponent");
          else break;
        }
        n++;
    ...
    function j() {
      for (var c = "", d = n, f, g, k; n < b.length; ) {
        var j = b.charAt(n);
      ...
      d = { index: d, text: c };
      if (Na.hasOwnProperty(c)) d.fn = d.json = Na[c];
      else {
        var l = Kb(c, a);
        d.fn = B(
          function (a, b) {
      ...
      k &&
        ...
        o.push({ index: f + 1, text: k, json: !1 }));
    }
    function l(a) {
      var c = n;
      n++;
      for (var d = "", e = a, f = !1; n < b.length; ) {
        ...
        if (f)
          k == "u"
            ? ((k = b.substring(n + 1, n + 5)),
              k.match(/[\da-f]{4}/i) ||
                g("Invalid unicode escape [\\u" + k + "]"),
              (n += 4),
              (d += String.fromCharCode(parseInt(k, 16))))
            : ((f = Lc[k]), (d += f ? f : k)),
            (f = !1);
        else if (k == "\\") f = !0;
        else if (k == a) {
    ...
    for (var o = [], q, n = 0, z = [], r, v = ":"; n < b.length; ) {
      ...
      if (c("\"'")) l(r);
        ...
        if (
          (j(), "{,".indexOf(v) != -1 && z[0] == "{" && (q = o[o.length - 1]))
        )
        ...
        var m = r + d(),
          ...
          w = Na[m];
        w
          ? (o.push({ index: n, text: m, fn: w }), (n += 2))
          : C
          ? (o.push({
              index: n,
              text: r,
            ...
            (n += 1))
          : g("Unexpected next character ", n, n + 1);
      }
      v = r;
    }
    return o;
  ...
  function Mc(b, a, c, d) {
    ...
    function h() {
      if (I.length === 0) throw y("Unexpected end of expression: " + b);
      return I[0];
    }
    function i(a, b, c, d) {
      if (I.length > 0) {
    ...
    function f(b, c, d, f) {
      return (b = i(b, c, d, f))
        ? (a && !b.json && e("is not valid json", b), I.shift(), b)
        : !1;
    }
    function g(a) {
    ...
    var W = L(0),
      ...
      t = function (a, b) {
        ...
        g(")");
        return function (d, e) {
          for (var f = [], k = b ? b(d, e) : d, g = 0; g < c.length; g++)
            f.push(c[g](d, e));
          g = a(d, e) || D;
          return g.apply ? g.apply(k, f) : g(f[0], f[1], f[2], f[3], f[4]);
        };
      },
      u = function (a) {
        var b = f().text,
    ...
    a
      ? ((J = q),
        ...
        (x = C()))
      : (x = l());
    I.length !== 0 && e("is an unexpected token", I[0]);
    return x;
  }
  function Lb(b, a, c) {
  ...
  function gb(b, a, c) {
    if (!a) return b;
    for (var a = a.split("."), d, e = b, h = a.length, i = 0; i < h; i++)
      (d = a[i]), b && (b = (e = b)[d]);
    return !c && N(b) ? Xa(e, b) : b;
  }
  function Mb(b, a, c, d, e) {
    return function (h, i) {
      var f = i && i.hasOwnProperty(b) ? i : h,
        g;
      ...
      function (a, c, d, e, h, i, f) {
        function g() {
          ...
          if (
            ...
            g &&
            b.$route === g.$route &&
            ha(b.pathParams, g.pathParams) &&
            !b.reloadOnSearch &&
            !o
          )
            (g.params = b.params),
              V(g.params, d),
              a.$broadcast("$routeUpdate", g);
          else if (b || g)
            (o = !1),
              a.$broadcast("$routeChangeStart", b, g),
              (q.current = b) &&
                b.redirectTo &&
                (F(b.redirectTo)
              ...
              e
                ...
                .then(
                  ...
                  function (c) {
                    b == q.current &&
                      a.$broadcast("$routeChangeError", b, g, c);
                  }
                );
        }
        function k() {
          ...
          m(b, function (b, e) {
            if (!d && (a = l(c.path(), e)))
              (d = Aa(b, { params: B({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
  ...
  function Sc() {
    ...
    this.$get = [
      ...
      function (a, c, d) {
        ...
        function h(a) {
          if (g.$$phase) throw y(g.$$phase + " already in progress");
          g.$$phase = a;
        }
        function i(a, b) {
          var c = d(a);
  ...
  function Tc() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = E((/android (\d+)/.exec(G(b.navigator.userAgent)) || [])[1]),
          e = a[0];
        return {
  ...
  function Vc(b, a) {
    ...
    var d = {
        protocol: c[2],
        host: c[4],
        port: E(c[6]) || xa[c[2]] || null,
        relativeProtocol: c[2] === p || c[2] === "",
      },
      c = hb.exec(a),
      c = { protocol: c[1], host: c[3], port: E(c[5]) || xa[c[1]] || null };
    return (
      (d.protocol == c.protocol || d.relativeProtocol) &&
      d.host == c.host &&
      (d.port == c.port || (d.relativeProtocol && c.port == xa[c.protocol]))
    );
  }
  function Ob(b) {
    var a = M(b) ? b : p;
  ...
  function Xc() {
    var b = /^\s*(\[|\{[^\{])/,
      ...
      d = (this.defaults = {
        ...
        transformRequest: [
          function (a) {
            return M(a) && Va.apply(a) !== "[object File]" ? ca(a) : a;
          },
        ],
        headers: {
    ...
    this.$get = [
      ...
      "$q",
      "$injector",
      function (a, b, c, g, k, j) {
        function l(a) {
          function c(a) {
            var b = B({}, a, { data: Pb(a.data, a.headers, f) });
          ...
          var e = a.transformRequest || d.transformRequest,
            ...
            g = d.headers,
            h = Vc(a.url, b.url()) ? b.cookies()["XSRF-TOKEN"] : p,
            g = B({ "X-XSRF-TOKEN": h }, g.common, g[G(a.method)], a.headers),
            e = Pb(a.data, Ob(g), e),
            j;
          u(a.data) && delete g["Content-Type"];
          if (u(a.withCredentials) && !u(d.withCredentials))
        ...
        function o(b, c, d) {
          function e(a, b, c) {
            m && (200 <= a && a < 300 ? m.put(z, [a, b, Nb(c)]) : m.remove(z));
            f(b, a, c);
            g.$apply();
          }
          function f(a, c, d) {
          ...
          if (m)
            if ((p = m.get(z)))
              ...
              else H(p) ? f(p[1], p[0], V(p[2])) : f(p, 200, {});
            else m.put(z, o);
          p ||
            a(
              b.method,
        ...
        var n = c("$http"),
          z = [];
        m(e, function (a) {
          z.push(F(a) ? j.get(a) : j.invoke(a));
        });
        l.pendingRequests = [];
        (function (a) {
          m(arguments, function (a) {
            l[a] = function (b, c) {
              return l(B(c || {}, { method: a, url: b }));
            };
          });
        ...
        (function (a) {
          m(arguments, function (a) {
            l[a] = function (b, c, d) {
              return l(B(d || {}, { method: a, url: b, data: c }));
            };
          });
        })("post", "put");
        l.defaults = d;
  ...
  function Zc(b, a, c, d, e, h) {
    ...
    return function (e, g, k, j, l, o, q, n) {
      function p(a, c, d, e) {
        c = (g.match(hb) || ["", h])[1] == "file" ? (d ? 200 : 404) : c;
        a(c == 1223 ? 204 : c, d, e);
      ...
      if (G(e) == "jsonp") {
        ...
        i(g.replace("JSON_CALLBACK", "angular.callbacks." + r), function () {
          d[r].data ? p(j, 200, d[r].data) : p(j, -2);
          delete d[r];
        });
      } else {
        var v = new a();
    ...
    if (!k) {
      ...
      if (i.length >= j + l)
        for (var k = i.length - j, o = 0; o < k; o++)
          (k - o) % l === 0 && o !== 0 && (f += c), (f += i.charAt(o));
      for (o = k; o < i.length; o++)
        (i.length - o) % j === 0 && o !== 0 && (f += c), (f += i.charAt(o));
      for (; b.length < e; ) b += "0";
      e && (f += d + b.substr(0, e));
    }
    g.push(h ? a.negPre : a.posPre);
    g.push(f);
    g.push(h ? a.negSuf : a.posSuf);
    return g.join("");
  }
  function kb(b, a, c) {
    var d = "";
  ...
  function Sb(b) {
    ...
    return function (c, e) {
      ...
      F(c) && (c = hd.test(c) ? E(c) : a(c));
      ya(c) && (c = new Date(c));
      if (!oa(c)) return c;
      for (; e; )
        (g = id.exec(e))
          ? ((i = i.concat(ia.call(g, 1))), (e = i.pop()))
          : (i.push(e), (e = null));
      m(i, function (a) {
        f = jd[a];
        h += f
  ...
  function Xb(b, a) {
    ...
    d.$setValidity = function (a, b, f) {
      ...
      if (b) {
        ...
        if (l) {
          if (Ba(l, f) != -1) return;
        } else (i[a] = l = []), h++, c(!1, a), e.$setValidity(a, !1, d);
        l.push(f);
        d.$valid = !1;
        d.$invalid = !0;
      }
  ...
  function Ta(b, a, c, d, e, h) {
    var i = function () {
      var e = a.val();
      if (Da(c.ngTrim || "T")) e = R(e);
      d.$viewValue !== e &&
        b.$apply(function () {
          d.$setViewValue(e);
        });
    ...
    g &&
      (g.match(/^\/(.*)\/$/)
        ? ((g = RegExp(g.substr(1, g.length - 2))),
          (e = function (a) {
            return k(g, a);
          }))
        : (e = function (a) {
            var c = b.$eval(g);
            if (!c || !c.test)
              throw new y("Expected " + g + " to be a RegExp but was " + c);
            return k(c, a);
          }),
      d.$formatters.push(e),
      d.$parsers.push(e));
    if (c.ngMinlength) {
      var j = E(c.ngMinlength),
        e = function (a) {
          return !T(a) && a.length < j
  ...
  function lb(b, a) {
    ...
    return S(function (c, d, e) {
      ...
      b !== "ngClass" &&
        c.$watch("$index", function (d, h) {
          var j = d % 2;
          j !== h % 2 && (j == a ? f(c.$eval(e[b])) : i(c.$eval(e[b])));
        });
    });
  }
  var G = function (b) {
    ...
    y = U.Error,
    aa = E((/msie (\d+)/.exec(G(navigator.userAgent)) || [])[1]),
    t,
    ja,
    ia = [].slice,
    Ua = [].push,
  ...
  var kc = /[A-Z]/g,
    ...
    Fa = (P.cache = {}),
    Ea = (P.expando = "ng-" + new Date().getTime()),
    oc = 1,
    Zb = U.document.addEventListener
      ? function (b, a, c) {
    ...
    eb = U.document.removeEventListener
      ? function (b, a, c) {
  ...
  m(
    ...
    function (b, a) {
      P.prototype[a] = function (a, d) {
        var e, h;
        if ((b.length == 2 && b !== Ga && b !== zb ? a : d) === p)
          if (M(a)) {
            for (e = 0; e < this.length; e++)
              if (b === wb) b(this[e], a);
              else for (h in a) b(this[e], h, a[h]);
            return this;
          } else {
  ...
  var rc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m,
    ...
    tc = /^\s*(_?)(\S+?)\1\s*$/,
    qc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm,
    Fb = "Non-assignable model expression: ";
  Db.$inject = ["$provide"];
  var Ac = /^(x[\:\-_]|data[\:\-_])/i,
    hb =
      /^([^:]+):\/\/(\w+:{0,1}\w*@)?([\w\.-]*)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/,
  ...
  var Ua = function (a) {
    ...
    ac = {
      ...
      url: function (a, c, d, e, h, i) {
        Ta(a, c, d, e, h, i);
        a = function (a) {
          return T(a) || od.test(a)
      ...
      email: function (a, c, d, e, h, i) {
        Ta(a, c, d, e, h, i);
        a = function (a) {
          return T(a) || pd.test(a)
    ...
    bc = [
      ...
      function (a, c) {
        return {
          restrict: "E",
          require: "?ngModel",
          link: function (d, e, h, i) {
            i && (ac[G(h.type)] || ac.text)(d, e, h, i, c, a);
          },
        };
      },
    ],
    ...
    rd = [
      ...
      function (a, c, d, e, h) {
        ...
        var f = h(d.ngModel),
          g = f.assign;
        if (!g) throw y(Fb + d.ngModel + " (" + qa(e) + ")");
        this.$render = D;
        var k = e.inheritedData("$formController") || Ra,
          j = 0,
          l = (this.$error = {});
        e.addClass(ma);
        i(!0);
          ...
          link: function (e, h, i) {
            ...
            e.$watch(
              function () {
                ...
                return isNaN(c)
                  ? ""
                  : (j[c] || (c = a.pluralCat(c - k)), l[c](e, h, !0));
              },
              function (a) {
                h.text(a);
              }
        ...
        return function (a, c, i) {
          ...
          a.$watch(function (a) {
            ...
            if (H(i)) s = i || [];
              ...
              s = [];
              for (C in i)
                i.hasOwnProperty(C) && C.charAt(0) != "$" && s.push(C);
              s.sort();
            }
            e = 0;
            for (f = s.length; e < f; e++) {
              C = i === s ? e : s[e];
              w = i[C];
              if ((u = l.shift(w))) {
                p = u.scope;
            ...
            for (C in l)
              if (l.hasOwnProperty(C))
                for (s = l[C]; s.length; )
                  (w = s.pop()), w.element.remove(), w.scope.$destroy();
            l = t;
          });
        };
      },
        ...
        return {
          ...
          controller: [
            ...
            function (a, c, d) {
              var g = this,
                ...
                j = e,
                l;
              g.databound = d.ngModel;
              g.init = function (a, c, d) {
                j = a;
                l = d;
              };
              g.addOption = function (c) {
                k[c] = !0;
                j.$viewValue == c && (a.val(c), l.parent() && l.remove());
              };
              g.removeOption = function (a) {
                this.hasOption(a) &&
                  (delete k[a],
                  j.$viewValue == a && this.renderUnknownOption(a));
              };
              g.renderUnknownOption = function (c) {
                c = "? " + ga(c) + " ?";
                l.val(c);
                a.prepend(l);
                a.val(c);
              ...
              g.hasOption = function (a) {
                return k.hasOwnProperty(a);
              };
              c.$on("$destroy", function () {
                g.renderUnknownOption = D;
              });
            },
          ],
          link: function (e, i, f, g) {
            ...
            function j(a, c, d) {
              ...
              a.$watch(function () {
                ha(e, d.$viewValue) || ((e = V(d.$viewValue)), d.$render());
              });
              c.bind("change", function () {
                a.$apply(function () {
                  var a = [];
            ...
            function l(e, f, g) {
              function h() {
                ...
                if (n) t = new Ja(s);
                  ...
                  a[""].push({ selected: s === null, id: "", label: "" }),
                    (t = !0);
                for (y = 0; (z = x.length), y < z; y++) {
                  ...
                  A = j(e, w);
                  A = A === p ? "" : A;
                  i.push({ id: l ? x[y] : y, label: A, selected: d });
                }
                !n && !t && a[""].unshift({ id: "?", label: "", selected: !0 });
                w = 0;
                  ...
                  for (z = i.length; y < z; y++)
                    if (((d = i[y]), (t = u[y + 1]))) {
                      ...
                      d.id === "" && r
                        ...
                        A ? A.after(B) : s.element.append(B),
                        (A = B);
            ...
            if (g[1]) {
              for (
                var o = g[0],
                  ...
                  r = !1,
                  v,
                  D = t(ba.createElement("option")),
                  C = t(ba.createElement("optgroup")),
                  w = D.clone(),
                  g = 0,
                  B = i.children(),
                  E = B.length;
              ...
              if (n && (f.required || f.ngRequired)) {
                ...
                q.$parsers.push(x);
                q.$formatters.unshift(x);
                f.$observe("required", function () {
                  x(q.$viewValue);
                });
              }
              z ? l(e, i, q) : n ? j(e, i, q) : k(e, i, q, o);
            }
          },
        };
      },
