...
(function (S, W, p) {
  ...
  function ga(b, a) {
    ...
    if (c == typeof a && c == "object")
      if (I(b)) {
        ...
        for (d in a)
          if (!c[d] && d.charAt(0) !== "$" && a[d] !== p && !K(a[d])) return !1;
        return !0;
      }
    return !1;
  }
  ...
  function Y(b, a, c) {
    var d = b[Ea],
      d = Fa[d || -1];
    if (s(c)) d || ((b[Ea] = d = ++nc), (d = Fa[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function wb(b, a, c) {
    var d = Y(b, "data"),
    ...
    function g(a, b) {
      ...
      function d(a, b, e) {
        ...
        for (g = h.length; j < g; j++)
          (o = h[j]), f.push(e && e.hasOwnProperty(o) ? e[o] : c(o));
        a.$inject || (a = a[g]);
        switch (b ? -1 : f.length) {
          case 0:
            return a();
  ...
  function uc(b, a, c, d) {
          ...
          return (
            ...
            d.history
              ? b
                ...
                : (k.pushState(null, "", a), C.attr("href", C.attr("href")))
              : b
              ? j.replace(a)
              : (j.href = a),
            f
    ...
    f.onUrlChange = function (a) {
      fa ||
        (d.history && x(b).bind("popstate", i),
        d.hashchange ? x(b).bind("hashchange", i) : f.addPollFn(i),
        (fa = !0));
      u.push(a);
      return a;
    };
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (G(b))
            (d =
              (h.cookie = escape(a) + "=" + escape(b) + ";path=" + J).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        if (h.cookie !== B) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (g = e.indexOf("=")),
              g > 0 &&
                (Q[unescape(e.substring(0, g))] = unescape(e.substring(g + 1)));
        }
        return Q;
      }
    };
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            ...
            e(c);
            if (!t(b))
              return a in h || i++, (h[a] = b), i > j && this.remove(n.key), b;
          },
          get: function (a) {
            var b = k[a];
            if (b) return e(b), h[a];
      ...
      function (b, h, j, k, l, n, q, o) {
        ...
        function v(a, b, c, d) {
          function e(a, c, d, g) {
            ...
            q = n = 0;
            for (l = f.length; n < l; q++)
              (h = r[q]),
                (c = f[n++]),
                (j = f[n++]),
                c
                  ? (c.scope
                      ? ((o = a.$new(M(c.scope))), x(h).data("$scope", o))
                      : (o = a),
                    (k = c.transclude) || (!g && b)
                      ? c(
                          j,
                      ...
                      : c(j, o, h, p, g))
                  : j && j(a, h.childNodes, p, g);
          }
          for (var f = [], g, j, h, o = 0; o < a.length; o++)
            (j = new ca()),
              (g = ba(a[o], [], j, d)),
              (j =
                ((g = g.length ? C(g, a[o], j, b, c) : null) && g.terminal) ||
                !a[o].childNodes.length
                  ? null
                  : v(a[o].childNodes, g ? g.transclude : b)),
              f.push(g),
              f.push(j),
              (h = h || g || j);
          return h ? e : null;
        ...
        function ba(a, b, c, f) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              var h, o, n;
              j = a.attributes;
              for (var k = 0, l = j && j.length; k < l; k++)
                if (((h = j[k]), h.specified))
                  (o = h.name),
                    (n = da(o.toLowerCase())),
                    (g[n] = o),
                    (c[n] = h =
                      O(
                        Z && o == "href"
                          ? decodeURIComponent(a.getAttribute(o, 2))
                          : h.value
                      )),
                    Ab(a, n) && (c[n] = !0),
                    U(a, b, h, n),
        ...
        function C(a, b, c, d, e) {
          ...
          function o(a, d, e, f, g) {
            ...
            z &&
              m(z, function (a) {
                ...
                w = a.controller;
                w == "@" && (w = k[a.name]);
                r.data("$" + a.name + "Controller", q(w, b));
              });
            f = 0;
          ...
          for (
            ...
            if ((V = w.scope))
              J("isolated scope", v, w, u),
                M(V) && (r(u, "ng-isolate-scope"), (v = w)),
                r(u, "ng-scope"),
                (B = B || w);
            U = w.name;
            if ((V = w.controller))
              (z = z || {}),
                J("'" + U + "' controller", z[U], w, u),
                (z[U] = w);
            if ((V = w.transclude))
              J("transclusion", E, w, u),
                (E = w),
                (k = w.priority),
                V == "element"
                  ? ((s = x(b)),
                    (u = c.$$element =
                      x(W.createComment(" " + U + ": " + c[U] + " "))),
                    (b = u[0]),
                    Ka(e, x(s[0]), b),
                    (t = A(s, d, k)))
                  : ((s = x(db(b)).contents()), u.html(""), (t = A(s, d)));
            if ((V = w.template))
              if ((J("template", C, w, u), (C = w), (V = Gb(V)), w.replace)) {
                s = x("<div>" + O(V) + "</div>").contents();
                b = s[0];
                if (s.length != 1 || b.nodeType !== 1) throw new y(g + V);
                Ka(e, u, b);
                U = { $attr: {} };
                a = a.concat(ba(b, a.splice(F + 1, a.length - (F + 1)), U));
                fa(c, U);
                H = a.length;
              } else u.html(V);
            if (w.templateUrl)
              J("template", C, w, u),
                (C = w),
                (o = Q(a.splice(F, a.length - F), o, u, c, e, w.replace, t)),
                (H = a.length);
            else if (w.compile)
              try {
                (D = w.compile(u, c, t)),
                  K(D) ? f(null, D) : D && f(D.pre, D.post);
              } catch (L) {
                j(L, qa(u));
              }
        ...
        function u(d, e, g, h) {
          ...
          if (a.hasOwnProperty(e))
            for (var k, e = b.get(e + c), n = 0, l = e.length; n < l; n++)
              try {
                if (
                  ((k = e[n]),
        ...
        var s = h.startSymbol(),
          ...
          Gb =
            s == "{{" || $ == "}}"
              ? na
              : function (a) {
                  return a.replace(/\{\{/g, s).replace(/}}/g, $);
                };
        return A;
      },
    ];
  ...
  function Cc() {
    ...
    this.$get = [
      ...
      function (c, d) {
        function e(e, h) {
          for (var j, k, l = 0, n = [], q = e.length, o = !1, A = []; l < q; )
  ...
  function Gc() {
    ...
    this.$get = [
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((h = d.baseHref() || "/"),
            (j = h.substr(0, h.lastIndexOf("/"))),
            (l = ka(l.protocol, l.host, l.port) + j + "/"),
            (f = e.history
              ? new ib(Dc(k, h, b), j, l)
              : new Ib(Ec(k, h, b), b, l, h.substr(j.length + 1))))
          : ((l =
        ...
        g.bind("click", function (a) {
          if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
            for (var b = x(a.target); F(b[0].nodeName) !== "a"; )
  ...
  function Ic(b, a) {
    ...
    function k() {
      ...
      d = { index: d, text: c };
      if (xa.hasOwnProperty(c)) d.fn = d.json = xa[c];
      else {
        var l = Kb(c, a);
        d.fn = z(
          function (a, b) {
    ...
    for (var n = [], q, o = 0, A = [], r, v = ":"; o < b.length; ) {
      ...
      if (c("\"'")) l(r);
        ...
        if (
          (k(), "{,".indexOf(v) != -1 && A[0] == "{" && (q = n[n.length - 1]))
        )
        ...
        var m = r + d(),
          ...
          Q = xa[C];
        Q
          ? (n.push({ index: o, text: C, fn: Q }), (o += 3))
          : p
          ? (n.push({ index: o, text: m, fn: p }), (o += 2))
          : u
          ? (n.push({
              index: o,
              text: r,
  ...
  function Kc(b, a, c, d) {
    ...
    function f(b, c, d, f) {
      return (b = i(b, c, d, f))
        ? (a && !b.json && e("is not valid json", b), J.shift(), b)
        : !1;
    }
    function h(a) {
    ...
    var Q = H(0),
      ...
      s = function (a, b) {
        ...
        h(")");
        return function (d, e) {
          for (var f = [], j = b ? b(d, e) : d, h = 0; h < c.length; h++)
            f.push(c[h](d, e));
          h = a(d, e) || E;
    ...
    a
      ? ((w = q),
        ...
        (B = C()))
      : (B = l());
    J.length !== 0 && e("is an unexpected token", J[0]);
    return B;
  }
  function Lb(b, a, c) {
    ...
    this.$get = [
      ...
      function (a, c, d, e, g, i, f) {
              ...
              e
                ...
                .then(function () {
                  if (b) {
                    ...
                    if (s((d = b.template))) K(d) && (d = d(b.params));
                    else if (s((d = b.templateUrl)))
                      if ((K(d) && (d = d(b.params)), s(d)))
        ...
        function k() {
          ...
          m(b, function (b, e) {
            if (!d && (a = h(c.path(), e)))
              (d = Aa(b, { params: z({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
  ...
  function Rc() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = D((/android (\d+)/.exec(F(b.navigator.userAgent)) || [])[1]),
          e = a[0];
        return {
  ...
  function Tc(b, a) {
    ...
    var d = {
        protocol: c[2],
        host: c[4],
        port: D(c[6]) || wa[c[2]] || null,
        relativeProtocol: c[2] === p || c[2] === "",
      },
      c = hb.exec(a),
      c = { protocol: c[1], host: c[3], port: D(c[5]) || wa[c[1]] || null };
    return (
      (d.protocol == c.protocol || d.relativeProtocol) &&
      d.host == c.host &&
      (d.port == c.port || (d.relativeProtocol && c.port == wa[c.protocol]))
    );
  }
  function Ob(b) {
    var a = M(b) ? b : p;
      ...
      function (a, b, c, h, j, k) {
        function l(a) {
          ...
          var e = a.transformRequest || d.transformRequest,
            ...
            h = d.headers,
            g = Tc(a.url, b.url()) ? b.cookies()["XSRF-TOKEN"] : p,
            h = z({ "X-XSRF-TOKEN": g }, h.common, h[F(a.method)], a.headers),
            e = Pb(a.data, Ob(h), e),
            k;
        ...
        function n(b, c, d) {
          ...
          n.then(i, i);
          b.cache && b.method == "GET" && (m = M(b.cache) ? b.cache : o);
          if (m)
            if ((w = m.get(p)))
              if (w.then) return w.then(i, i), w;
              else I(w) ? f(w[1], w[0], T(w[2])) : f(w, 200, {});
            else m.put(p, n);
          w ||
            a(
              b.method,
  ...
  function Vb(b, a, c, d, e) {
    ...
    if (!j) {
      ...
      var i = Math.pow(10, e),
        ...
        l = a.gSize;
      if (i.length >= k + l)
        for (var j = i.length - k, n = 0; n < j; n++)
          (j - n) % l === 0 && n !== 0 && (f += c), (f += i.charAt(n));
      for (n = j; n < i.length; n++)
        (i.length - n) % k === 0 && n !== 0 && (f += c), (f += i.charAt(n));
      for (; b.length < e; ) b += "0";
      e && (f += d + b.substr(0, e));
    }
  ...
  function cd() {
    return function (b, a) {
      if (!I(b) && !G(b)) return b;
      a = D(a);
      if (G(b)) return a ? (a >= 0 ? b.slice(0, a) : b.slice(a, b.length)) : "";
      var c = [],
        d,
        e;
  ...
  function Sa(b, a, c, d, e, g) {
    ...
    h &&
      ...
      d.$parsers.push(e));
    if (c.ngMinlength) {
      var k = D(c.ngMinlength),
        e = function (a) {
          return !R(a) && a.length < k
    ...
    if (c.ngMaxlength) {
      var l = D(c.ngMaxlength),
        e = function (a) {
          return !R(a) && a.length > l
  ...
  var F = function (b) {
    ...
    y = S.Error,
    Z = D((/msie (\d+)/.exec(F(navigator.userAgent)) || [])[1]),
    x,
    ia,
    ha = [].slice,
    Ta = [].push,
    Ua = Object.prototype.toString,
    Yb = S.angular || (S.angular = {}),
    ta,
    Eb,
    X = ["0", "0", "0"];
  E.$inject = [];
  ...
  var jc = /[A-Z]/g,
    ...
    Fa = (N.cache = {}),
    Ea = (N.expando = "ng-" + new Date().getTime()),
    nc = 1,
    Zb = S.document.addEventListener
      ? function (b, a, c) {
    ...
    eb = S.document.removeEventListener
      ? function (b, a, c) {
  ...
  var Ta = function (a) {
    ...
    pd = [
      ...
      function (a, c, d, e, g) {
        ...
        this.$render = E;
        var j = e.inheritedData("$formController") || Qa,
          k = 0,
          l = (this.$error = {});
        e.addClass(ma);
        i(!0);
        ...
        return function (a, c, i) {
          ...
          a.$watch(function (a) {
            ...
            if (I(i)) t = i || [];
              ...
              t = [];
              for (u in i)
                i.hasOwnProperty(u) && u.charAt(0) != "$" && t.push(u);
              t.sort();
            }
            s = t.length;
            e = 0;
            ...
            for (u in l)
              if (l.hasOwnProperty(u))
                for (t = l[u]; t.length; )
                  (x = t.pop()), x.element.remove(), x.scope.$destroy();
            l = p;
          });
        };
      },
                ...
                for (x = c.length; y < x; y++) {
                  ...
                  if (v.length <= y)
                    (s = {
                      ...
                      v.push(u),
                      f.append(s.element);
                  else if (((u = v[y]), (s = u[0]), s.label != d))
                    s.element.attr("label", (s.label = d));
                  A = null;
                  z = 0;
                  for (B = i.length; z < B; z++)
                    if (((d = i[z]), (t = u[z + 1]))) {
                      A = t.element;
                      ...
                      d.id === "" && r
                        ...
                        A ? A.after(D) : s.element.append(D),
                        (A = D);
            ...
            if (h[1]) {
              for (
                var n = h[0],
                  ...
                  r = !1,
                  v,
                  E = x(W.createElement("option")),
                  C = x(W.createElement("optgroup")),
                  u = E.clone(),
                  h = 0,
                  z = i.children(),
                  D = z.length;
