     ...
     */
        ...
        function parseRoute() {
          ...
          forEach(routes, function (route, path) {
            if (
              !match &&
              (params = switchRouteMatcher($location.path(), path))
            ) {
              match = inherit(route, {
        ...
        function $http(config) {
          ...
          var xsrfHeader = {},
            ...
            xsrfToken = isSameDomain(config.url, $browser.url())
              ? $browser.cookies()[xsrfCookieName]
              : undefined;
          xsrfHeader[xsrfHeaderName] = xsrfToken;

          var reqTransformFn =
              config.transformRequest || defaults.transformRequest,
            respTransformFn =
  ...
  var ngSwitchDirective = valueFn({
    ...
    link: function (scope, element, attr, ctrl) {
      ...
      scope.$watch(watchExpr, function ngSwitchWatchAction(value) {
        ...
        if (
          (selectedTranscludes = ctrl.cases["!" + value] || ctrl.cases["?"])
        ) {
