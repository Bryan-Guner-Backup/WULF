...
(function (Q, W, p) {
  ...
  function V(b, a) {
    ...
    if (a) {
      ...
      if (G(b)) for (var c = (a.length = 0); c < b.length; c++) a.push(V(b[c]));
      else
  ...
  function fa(b, a) {
    ...
    if (c == typeof a && c == "object")
      if (G(b)) {
        ...
        for (d in a)
          if (!c[d] && d.charAt(0) !== "$" && a[d] !== p && !J(a[d])) return !1;
        return !0;
      }
    return !1;
  }
  ...
  function wb(b) {
    var a = b[Ga],
      c = Ha[a];
    c &&
      (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), xb(b)),
      delete Ha[a],
      (b[Ga] = p));
  }
  function Z(b, a, c) {
    var d = b[Ga],
      d = Ha[d || -1];
    if (u(c)) d || ((b[Ga] = d = ++pc), (d = Ha[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function yb(b, a, c) {
    var d = Z(b, "data"),
  ...
  function cb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && u(a.length) && !pa(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
  ...
  function Eb(b) {
    ...
    if (typeof b == "function") {
      ...
      G(b)
        ? ((c = b.length - 1), ta(b[c], "fn"), (a = b.slice(0, c)))
        : ta(b, "fn", !0);
    return a;
  }
  function ub(b) {
    ...
    function g(a, b) {
      ...
      function d(a, b, e) {
        var f = [],
          ...
          h;
        i = 0;
        for (g = j.length; i < g; i++)
          (h = j[i]), f.push(e && e.hasOwnProperty(h) ? e[h] : c(h));
        a.$inject || (a = a[g]);
        switch (b ? -1 : f.length) {
          case 0:
            return a();
  ...
  function wc(b, a, c, d) {
          ...
          return (
            ...
            d.history
              ? b
                ...
                : (k.pushState(null, "", a), y.attr("href", y.attr("href")))
              : b
              ? j.replace(a)
              : (j.href = a),
            f
    ...
    f.onUrlChange = function (a) {
      H ||
        (d.history && w(b).bind("popstate", h),
        d.hashchange ? w(b).bind("hashchange", h) : f.addPollFn(h),
        (H = !0));
      ha.push(a);
      return a;
    };
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (D(b))
            (d =
              (i.cookie = escape(a) + "=" + escape(b) + ";path=" + O).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
        ...
        if (i.cookie !== I) {
          ...
          for (f = 0; f < d.length; f++)
            (e = d[f]),
              (j = e.indexOf("=")),
              j > 0 &&
                (s[unescape(e.substring(0, j))] = unescape(e.substring(j + 1)));
        }
        return s;
      }
    };
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            ...
            e(c);
            if (!t(b))
              return a in i || h++, (i[a] = b), h > j && this.remove(m.key), b;
          },
          get: function (a) {
            var b = k[a];
            if (b) return e(b), i[a];
            ...
            b.factory(d + c, [
              ...
              function (b, c) {
                ...
                n(a[d], function (a) {
                  try {
                    var g = b.invoke(a);
                    if (J(g)) g = { compile: K(g) };
                    else if (!g.compile && g.link) g.compile = K(g.link);
      ...
      function (b, j, k, l, m, q, o, z, v) {
        function r(a, b, c) {
          ...
          return function (b, c) {
            ab(b, "scope");
            for (
              var e = c ? xa.clone.call(a) : a, g = 0, j = e.length;
              g < j;
              g++
            ) {
              var h = e[g];
        ...
        function y(a, b, c, d) {
          function e(a, c, d, j) {
            ...
            q = o = 0;
            for (m = g.length; o < m; q++)
              (i = v[q]),
                (c = g[o++]),
                (h = g[o++]),
                c
                  ? (c.scope
                      ? ((k = a.$new(N(c.scope))), w(i).data("$scope", k))
                      : (k = a),
                    (l = c.transclude) || (!j && b)
                      ? c(
                          h,
                      ...
                      : c(h, k, i, p, j))
                  : h && h(a, i.childNodes, p, j);
          }
          for (var g = [], j, h, i, k = 0; k < a.length; k++)
            (h = new ia()),
              (j = ha(a[k], [], h, d)),
              (h =
                ((j = j.length ? H(j, a[k], h, b, c) : null) && j.terminal) ||
                !a[k].childNodes.length
                  ? null
                  : y(a[k].childNodes, j ? j.transclude : b)),
              g.push(j),
              g.push(h),
              (i = i || j || h);
          return i ? e : null;
        ...
        function ha(a, b, c, g) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              var i, k, o;
              h = a.attributes;
              for (var l = 0, m = h && h.length; l < m; l++)
                if (((i = h[l]), i.specified))
                  (k = i.name),
                    (o = ca(k.toLowerCase())),
                    (j[o] = k),
                    (c[o] = i =
        ...
        function H(a, b, c, d, e) {
          ...
          for (
            ...
            if ((t = s.scope))
              wa("isolated scope", $, s, E),
                N(t) && (B(E, "ng-isolate-scope"), ($ = s)),
                B(E, "ng-scope"),
                (y = y || s);
            H = s.name;
            if ((t = s.controller))
              (C = C || {}),
                wa("'" + H + "' controller", C[H], s, E),
                (C[H] = s);
            if ((t = s.transclude))
              wa("transclusion", ja, s, E),
                (ja = s),
                (m = s.priority),
                t == "element"
                  ? ((T = w(b)),
                    (E = c.$$element =
                      w(W.createComment(" " + H + ": " + c[H] + " "))),
                    (b = E[0]),
                    u(e, w(T[0]), b),
                    (ea = r(T, d, m)))
                  : ((T = w(db(b)).contents()), E.html(""), (ea = r(T, d)));
            if ((t = s.template))
              if ((wa("template", P, s, E), (P = s), (t = Hb(t)), s.replace)) {
                T = w("<div>" + R(t) + "</div>").contents();
                b = T[0];
                if (T.length != 1 || b.nodeType !== 1) throw Error(g + t);
                u(e, E, b);
                H = { $attr: {} };
                a = a.concat(ha(b, a.splice(A + 1, a.length - (A + 1)), H));
                I(c, H);
                F = a.length;
              } else E.html(t);
            if (s.templateUrl)
              wa("template", P, s, E),
                (P = s),
                (l = O(a.splice(A, a.length - A), l, E, c, e, s.replace, ea)),
                (F = a.length);
            else if (s.compile)
              try {
                (x = s.compile(E, c, ea)),
                  J(x) ? h(null, x) : x && h(x.pre, x.post);
              } catch (K) {
                k(K, ra(E));
              }
        ...
        function s(d, e, g, j) {
          ...
          if (a.hasOwnProperty(e))
            for (var o, e = b.get(e + c), m = 0, l = e.length; m < l; m++)
              try {
                if (
                  ((o = e[m]),
                  (j === p || j > o.priority) && o.restrict.indexOf(g) != -1)
                )
                  d.push(o), (h = !0);
              } catch (q) {
                k(q);
  ...
  function Fc() {
    ...
    this.$get = [
      ...
      function (c, d) {
        function e(e, i) {
          for (var j, k, l = 0, m = [], q = e.length, o = !1, z = []; l < q; )
            (j = e.indexOf(b, l)) != -1 && (k = e.indexOf(a, j + g)) != -1
              ? (l != j && m.push(e.substring(l, j)),
                m.push((l = c((o = e.substring(j + g, k))))),
                (l.exp = o),
                (l = k + h),
                (o = !0))
              : (l != q && m.push(e.substring(l)), (l = q));
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((i = d.baseHref() || "/"),
            ...
            (f = e.history
              ? new jb(Gc(k, i, b), j, l)
              : new Jb(Hc(k, i, b), b, l, i.substr(j.length + 1))))
          : ((l =
        ...
        g.bind("click", function (a) {
          if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
            for (var b = w(a.target); A(b[0].nodeName) !== "a"; )
  ...
  function Lc(b, a) {
    ...
    function k() {
      ...
      d = { index: d, text: c };
      if (Aa.hasOwnProperty(c)) d.fn = d.json = Aa[c];
      else {
        var l = Lb(c, a);
        d.fn = C(
          function (a, b) {
      ...
      i &&
        ...
        m.push({ index: f + 1, text: i, json: !1 }));
    }
    function l(a) {
      var c = o;
      o++;
    ...
    for (var m = [], q, o = 0, z = [], v, r = ":"; o < b.length; ) {
      v = b.charAt(o);
      if (c("\"'")) l(v);
      else if (e(v) || (c(".") && e(d()))) j();
      else if (h(v)) {
        if (
          (k(), "{,".indexOf(r) != -1 && z[0] == "{" && (q = m[m.length - 1]))
        )
        ...
        var B = v + d(),
          ...
          s = Aa[y];
        s
          ? (m.push({ index: o, text: y, fn: s }), (o += 3))
          : H
          ? (m.push({ index: o, text: B, fn: H }), (o += 2))
          : n
          ? (m.push({
              index: o,
              text: v,
  ...
  function Nc(b, a, c, d) {
    ...
    function f(b, c, d, f) {
      return (b = h(b, c, d, f))
        ? (a && !b.json && e("is not valid json", b), O.shift(), b)
        : !1;
    }
    function i(a) {
  ...
  function Lb(b, a) {
    ...
    if (a)
      e =
        d < 6
          ? Nb(c[0], c[1], c[2], c[3], c[4])
          : function (a, b) {
              var e = 0,
                g;
              do
                (g = Nb(c[e++], c[e++], c[e++], c[e++], c[e++])(a, b)),
                  (b = p),
                  (a = g);
              while (e < d);
              return g;
          ...
          if (
            ...
            (m = !1),
              ...
              (q.current = b) &&
                b.redirectTo &&
                (D(b.redirectTo)
                  ? c.path(l(b.redirectTo, b.params)).search(b.params).replace()
                  : c
              ...
              e
                ...
                .then(function () {
                  if (b) {
                    ...
                    if (u((d = b.template))) J(d) && (d = d(b.params));
                    else if (u((d = b.templateUrl)))
                      if ((J(d) && (d = d(b.params)), u(d)))
                        (b.loadedTemplateUrl = d),
                ...
                .then(
                  ...
                  function (c) {
                    b == q.current &&
                      a.$broadcast("$routeChangeError", b, j, c);
                  }
                );
        }
        function k() {
          ...
          n(b, function (b, e) {
            if (!d && (a = i(c.path(), e)))
              (d = Da(b, { params: C({}, c.search(), a), pathParams: a })),
                (d.$route = b);
          });
  ...
  function Uc() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = F((/android (\d+)/.exec(A(b.navigator.userAgent)) || [])[1]),
          e = a[0];
        return {
  ...
  function Wc(b, a) {
    ...
    var d = {
        protocol: c[2],
        host: c[4],
        port: F(c[6]) || za[c[2]] || null,
        relativeProtocol: c[2] === p || c[2] === "",
      },
      c = ib.exec(a),
      c = { protocol: c[1], host: c[3], port: F(c[5]) || za[c[1]] || null };
    return (
      (d.protocol == c.protocol || d.relativeProtocol) &&
      d.host == c.host &&
      (d.port == c.port || (d.relativeProtocol && c.port == za[c.protocol]))
    );
  }
  function Pb(b) {
    var a = N(b) ? b : p;
    ...
    this.$get = [
      ...
      function (a, b, c, i, j, k) {
        function l(a) {
          ...
          var e = {},
            f = a.xsrfCookieName || d.xsrfCookieName,
            g = a.xsrfHeaderName || d.xsrfHeaderName,
            f = Wc(a.url, b.url()) ? b.cookies()[f] : p;
          e[g] = f;
          var g = a.transformRequest || d.transformRequest,
            i = a.transformResponse || d.transformResponse,
            f = d.headers,
            e = C(e, f.common, f[A(a.method)], a.headers),
            g = Qb(a.data, Pb(e), g),
            k;
          t(a.data) && delete e["Content-Type"];
          if (t(a.withCredentials) && !t(d.withCredentials))
        ...
        function m(b, c, d) {
          ...
          if (n)
            if ((p = n.get(z)))
              ...
              else G(p) ? f(p[1], p[0], V(p[2])) : f(p, 200, {});
            else n.put(z, m);
          p ||
            a(
              b.method,
  ...
  function Wb(b, a, c, d, e) {
    ...
    if (!j) {
      ...
      var h = Math.pow(10, e),
        ...
        l = a.gSize;
      if (h.length >= k + l)
        for (var j = h.length - k, m = 0; m < j; m++)
          (j - m) % l === 0 && m !== 0 && (f += c), (f += h.charAt(m));
      for (m = j; m < h.length; m++)
        (h.length - m) % k === 0 && m !== 0 && (f += c), (f += h.charAt(m));
      for (; b.length < e; ) b += "0";
    ...
    i &&
      (i.match(/^\/(.*)\/$/)
        ...
        : (e = function (a) {
            var c = b.$eval(i);
            if (!c || !c.test)
              throw Error("Expected " + i + " to be a RegExp but was " + c);
            return j(c, a);
          }),
      d.$formatters.push(e),
      d.$parsers.push(e));
  ...
  var A = function (b) {
    ...
    X = F((/msie (\d+)/.exec(A(navigator.userAgent)) || [])[1]),
    w,
    aa,
    ga = [].slice,
    Ua = [].push,
  ...
  var lc = /[A-Z]/g,
    ...
    Ha = (M.cache = {}),
    Ga = (M.expando = "ng-" + new Date().getTime()),
    pc = 1,
    Zb = Q.document.addEventListener
      ? function (b, a, c) {
  ...
  var Ua = function (a) {
    ...
    qd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/,
    rd = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
    ac = {
      text: Ta,
    ...
    sd = [
      ...
      function (a, c, d, e, g) {
        ...
        this.$render = x;
        var j = e.inheritedData("$formController") || Ra,
          k = 0,
          l = (this.$error = {});
        e.addClass(ma);
        h(!0);
        ...
        return function (a, c, h) {
          ...
          a.$watch(function (a) {
            ...
            if (G(h)) s = h || [];
              ...
              s = [];
              for (t in h)
                h.hasOwnProperty(t) && t.charAt(0) != "$" && s.push(t);
              s.sort();
            }
            B = s.length;
            e = 0;
            ...
            function k() {
              ...
              if (k) {
                ...
                if (n.controller)
                  (j.$scope = l),
                    (j = h(n.controller, j)),
                    c.children().data("$ngControllerController", j);
                k(l);
        ...
        return {
          ...
          link: function (e, h, f, i) {
            ...
            function k(a, c, d) {
              ...
              a.$watch(function () {
                fa(e, d.$viewValue) || ((e = V(d.$viewValue)), d.$render());
              });
              c.bind("change", function () {
                a.$apply(function () {
                  var a = [];
                  ...
                  for (C = i.length; z < C; z++)
                    if (((d = i[z]), (u = t[z + 1]))) {
                      ...
                      if (u.element.selected !== d.selected)
                        A.prop("selected", (u.selected = d.selected));
                    } else
                      d.id === "" && v
                        ? (D = v)
                        : (D = B.clone())
                        ...
                        A ? A.after(D) : r.element.append(D),
                        (A = D);
            ...
            if (i[1]) {
              for (
                var m = i[0],
                  ...
                  v = !1,
                  r,
                  B = w(W.createElement("option")),
                  y = w(W.createElement("optgroup")),
                  C = B.clone(),
                  i = 0,
                  x = h.children(),
                  s = x.length;
