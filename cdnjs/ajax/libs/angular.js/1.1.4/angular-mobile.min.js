...
(function (r, h) {
  "use strict";
  var d = h.module("ngMobile", []);
  d.config([
    "$provide",
    function (j) {
      j.decorator("ngClickDirective", [
        "$delegate",
        function (g) {
          g.shift();
          return g;
    ...
    function (j, g, d) {
      function k(a, b, c) {
        for (var f = 0; f < a.length; f += 2)
          if (Math.abs(a[f] - b) < m && Math.abs(a[f + 1] - c) < m)
      ...
      function q(a, b) {
        c ||
          (d[0].addEventListener("click", h, !0),
          d[0].addEventListener("touchstart", p, !0),
          (c = []));
        n = Date.now();
        k(c, a, b);
      }
      ...
      return function (a, b, c) {
        ...
        b.bind("touchstart", function (a) {
          d = !0;
          i = a.target ? a.target : a.srcElement;
          ...
          var c = Date.now() - g,
            e =
              b.changedTouches && b.changedTouches.length
                ...
                ? b.touches
                : [b],
            l = e[0].originalEvent || e[0],
            e = l.clientX,
            l = l.clientY,
            j = Math.sqrt(Math.pow(e - h, 2) + Math.pow(l - k, 2));
          d &&
            c < 750 &&
            j < 12 &&
            (q(e, l),
