 ...
 */
  ...
  var $AnimatorProvider = function () {
    this.$get = [
      ...
      "$window",
      "$sniffer",
      function ($animation, $window, $sniffer) {
                ...
                function beginAnimation() {
                  ...
                  if (polyfillStart) {
                    ...
                    forEach(element, function (element) {
                      ...
                      duration = Math.max(
                        parseFloat(
                          globalStyles[w3cTransitionProp + durationKey]
                        ) ||
                          parseFloat(
                            globalStyles[vendorTransitionProp + durationKey]
                          ) ||
                          0,
                        duration
                      );
        ...
        link: function (scope, element, attr) {
          ...
          function update() {
            ...
            if (template) {
              clearContent();
              animate.enter(
                jqLite("<div></div>").html(template).contents(),
                element
              );
 ...
 */
  ...
  angular.scenario.dsl("input", function () {
    ...
    var supportInputEvent =
      "oninput" in document.createElement("div") && msie != 9;
