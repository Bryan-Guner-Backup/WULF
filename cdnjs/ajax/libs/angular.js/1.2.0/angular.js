 ...
 */
  ...
  function ensureSafeMemberName(name, fullExpression, allowConstructor) {
    if (
      typeof name !== "string" &&
      toString.apply(name) !== "[object String]"
    ) {
      return name;
    }
      ...
      return extend(
        function (self, locals) {
          var o = obj(self, locals),
            ...
            i = ensureSafeMemberName(
              indexFn(self, locals),
              parser.text,
              true /* allowConstructor */
            ),
            v,
            p;
 ...
 */
  ...
  function urlResolve(url) {
    ...
    return {
      ...
      pathname:
        urlParsingNode.pathname && urlParsingNode.pathname.charAt(0) === "/"
              ...
              for (
                ...
                if (!block.startNode) {
                  linker(childScope, function (clone) {
                    ...
                    block.startNode =
                      previousNode && previousNode.endNode
