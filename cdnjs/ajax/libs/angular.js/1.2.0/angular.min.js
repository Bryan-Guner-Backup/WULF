...
(function (W, O, s) {
  ...
  function Ub(b) {
    ...
    q((b || "").split("&"), function (b) {
      b &&
        ...
        z(d) &&
          ((b = z(c[1]) ? Tb(c[1]) : !0),
          a[d] ? (J(a[d]) ? a[d].push(b) : (a[d] = [a[d], b])) : (a[d] = b)));
    });
    return a;
  }
  function Vb(b) {
  ...
  function na(b, a) {
    if ("hasOwnProperty" === b) throw Ma("badname", a);
  }
  function ub(b, a, c) {
    if (!a) return b;
    a = a.split(".");
  ...
  function Yb(b, a) {
    ...
    d &&
      (a
        ? delete Ra[c].data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Zb(b)),
          delete Ra[c],
          (b[db] = s)));
  }
  function ja(b, a, c) {
  ...
  function dc(b) {
    ...
    "function" == typeof b
      ? (a = b.$inject) ||
        ((a = []),
        b.length &&
          ((c = b.toString().replace(Vc, "")),
          (c = c.match(Wc)),
          q(c[1].split(Xc), function (b) {
            b.replace(Yc, function (b, c, d) {
              a.push(d);
            });
          })),
        (b.$inject = a))
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : D(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + va).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[f]),
              ...
              0 < h &&
                ...
                oa[a] === s && (oa[a] = unescape(e.substring(h + 1))));
        return oa;
      }
    };
      ...
      function (b, l, n, r, p, C, H, I, A, S, G) {
        function v(a, b, c, d, e) {
          ...
          return function (b, c) {
            tb(b, "scope");
            for (
              var d = c ? Da.clone.call(a) : a, e = 0, h = d.length;
              e < h;
              e++
            ) {
              var g = d[e];
        ...
        function E(a, b, c, d, e, f) {
          function h(a, c, d, e) {
            ...
            for (r = g.length; p < r; C++)
              (k = X[C]),
                ...
                c
                  ? (c.scope
                      ? ((n = a.$new()), l.data("$scope", n), Z(l, "ng-scope"))
                      : (n = a),
                    (l = c.transclude) || (!e && b)
                      ? c(
                          f,
          ...
          for (var g = [], k, l, n, p = 0; p < a.length; p++)
            (l = new R()),
              (k = oa(a[p], [], l, 0 === p ? d : s, e)),
              (k =
                ((f = k.length ? M(k, a[p], l, b, c, null, [], [], f) : null) &&
                  f.terminal) ||
                !a[p].childNodes ||
                !a[p].childNodes.length
                  ? null
                  : E(a[p].childNodes, f ? f.transclude : b)),
              g.push(f),
              g.push(k),
              (n = n || f || k),
              (f = null);
        ...
        function oa(a, b, c, f, h) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              var l, n, p;
              k = a.attributes;
              for (var r = 0, C = k && k.length; r < C; r++) {
                var H = !1,
                  v = !1;
                l = k[r];
            ...
            case 8:
              try {
                if ((k = d.exec(a.nodeValue)))
                  (p = ka(k[1])), N(b, p, "M", f, h) && (c[p] = Y(k[2]));
              } catch (S) {}
          }
          b.sort(wa);
          return b;
        ...
        function M(a, b, c, d, e, f, h, k, g) {
          ...
          function r(a, b) {
            ...
            if (D(a)) {
              ...
              8 == b[0].nodeType &&
                b[0].$$controller &&
                ((c = c || b[0].$$controller), (b[0].$$controller = null));
          ...
          function S(a, d, e, f, g) {
            ...
            if (G) {
              ...
              f = y(e);
              K = d.$new(!0);
              N && N === G.$$originalDirective
                ? f.data("$isolateScope", K)
                : f.data("$isolateScopeNoTemplate", K);
            ...
            for (v = h.length; f < v; f++)
              try {
                (E = h[f]),
                  E(E.isolateScope ? K : d, X, p, E.require && r(E.require, X));
              } catch (M) {
                n(M, ea(X));
              }
            f = d;
          ...
          for (
            ...
            if ((t = F.scope))
              (I = I || F),
                F.templateUrl ||
                  (Va("new/isolated scope", G, F, M), T(t) && (G = F));
            ba = F.name;
            !F.templateUrl &&
              F.controller &&
              ((t = F.controller),
              (A = A || {}),
              Va("'" + ba + "' controller", A[ba], F, M),
              (A[ba] = F));
            if ((t = F.transclude))
              F.$$tlb || (Va("transclusion", g, F, M), (g = F)),
                "element" == t
                  ? ((E = F.priority),
                    (t = $(b, u, Fa)),
                    (M = c.$$element =
                      y(O.createComment(" " + ba + ": " + c[ba] + " "))),
                    (b = M[0]),
                    L(e, y(ta.call(t, 0)), b),
                    (wa = v(t, d, E, f && f.name, { transcludeDirective: g })))
                  : ((t = y(zb(b)).contents()), M.html(""), (wa = v(t, d)));
            if (F.template)
              if (
                (Va("template", N, F, M),
                (N = F),
                (t = B(F.template) ? F.template(M, c) : F.template),
                (t = fc(t)),
                F.replace)
              ) {
                f = F;
            ...
            if (F.templateUrl)
              Va("template", N, F, M),
                (N = F),
                F.replace && (f = F),
                (S = ad(a.splice(ga, a.length - ga), M, c, e, wa, h, k, {
              ...
              try {
                (x = F.compile(M, c, wa)),
                  B(x) ? p(null, x, u, Fa) : x && p(x.pre, x.post, u, Fa);
              } catch (ed) {
                n(ed, ea(M));
              }
        ...
        function ad(a, b, c, d, e, f, h, g) {
          ...
          b.html("");
          r.get(S.getTrustedResourceUrl(I), { cache: p })
            .success(function (p) {
              var r;
              p = fc(p);
              if (H.replace) {
        ...
        function Va(a, b, c, d) {
          if (b) throw fa("multidir", b.name, c.name, a, ea(d));
        }
        function t(a, b) {
          var c = l(b, !0);
          c &&
        ...
        function w(a, b, c, d) {
          var e = l(c, !0);
          if (e) {
            if ("multiple" === d && "SELECT" === Ea(a))
              throw fa("selmulti", ea(a));
            b.push({
              priority: 100,
              compile: function () {
                return {
        ...
        return function (e, f) {
          ...
          D(e) &&
            ...
            (e = b.hasOwnProperty(h)
              ? b[h]
              : ub(f.$scope, h, !0) || ub(d, h, !0)),
            Oa(e, h, !0));
          g = c.instantiate(e, f);
          if (m) {
            if (!f || "object" != typeof f.$scope)
              throw L("$controller")("noscp", h || e.name, m);
            f.$scope[m] = g;
          }
          return g;
        };
    ...
    var b = /^\s*(\[|\{[^\{])/,
      ...
      e = (this.defaults = {
        transformResponse: [
          function (d) {
            D(d) &&
              ((d = d.replace(c, "")), b.test(d) && a.test(d) && (d = Sb(d)));
            return d;
          },
        ],
        transformRequest: [
      ...
      function (a, b, c, d, n, r) {
        ...
        function C(b, c, f) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (q = T(b.cache) ? b.cache : T(e.cache) ? e.cache : I);
          if (q)
            if (((A = q.get(s)), z(A))) {
  ...
  function ld(b, a, c, d, e, f) {
    ...
    return function (e, m, k, l, n, r, p, C) {
      ...
      if ("jsonp" == w(e)) {
        ...
        var G = g(
          m.replace("JSON_CALLBACK", "angular.callbacks." + s),
          function () {
  ...
  function nd() {
    ...
    this.$get = [
      ...
      function (c, d, e) {
        function f(f, k, l) {
          for (var n, r, p = 0, C = [], H = f.length, q = !1, A = []; p < H; )
            -1 != (n = f.indexOf(b, p)) && -1 != (r = f.indexOf(a, n + g))
              ? (p != n && C.push(f.substring(p, n)),
                C.push((p = c((q = f.substring(n + g, r))))),
                (p.exp = q),
                (p = r + h),
                (q = !0))
              : (p != H && C.push(f.substring(p)), (p = H));
              ...
              (p = function (a) {
                try {
                  for (var b = 0, c = H, h; b < c; b++)
                    "function" == typeof (h = C[b]) &&
                      ((h = h(a)),
                      (h = l ? e.getTrusted(l, h) : e.valueOf(h)),
                      null === h || x(h)
                        ? (h = "")
                        : "string" != typeof h && (h = ma(h))),
                      (A[b] = h);
                  return A.join("");
                } catch (g) {
      ...
      function (c, d, e, f) {
        ...
        f.on("click", function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            for (var b = y(a.target); "a" !== w(b[0].nodeName); )
  ...
  function ha(b, a, c) {
    ...
    if ("_" === b.charAt(0) || "_" === b.charAt(b.length - 1))
      throw pa("isecprv", a);
    return b;
  }
  function Xa(b, a) {
  ...
  function rc(b, a, c) {
    ...
    if (a.csp)
      f =
        6 > e
          ? qc(d[0], d[1], d[2], d[3], d[4], c, a)
          : function (b, f) {
              var h = 0,
                g;
              do
                (g = qc(d[h++], d[h++], d[h++], d[h++], d[h++], c, a)(b, f)),
                  (f = s),
                  (b = g);
              while (h < e);
              return g;
                      ...
                      (c = g[s]) &&
                        ...
                        5 > G &&
                          ...
                          (z = B(c.exp)
                            ...
                            : c.exp),
                          (z += "; newVal: " + ma(e) + "; oldVal: " + ma(f)),
                          y[E].push(z)));
                    } catch (M) {
                      d(M);
                    }
                if (!(g = v.$$childHead || (v !== this && v.$$nextSibling)))
  ...
  function zd() {
    ...
    this.$get = [
      ...
      "$sceDelegate",
      function (a, c, d) {
        if (b && P && ((c = c[0].documentMode), c !== s && 8 > c))
          throw ra("iequirks");
        var e = da(ca);
  ...
  function Ad() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = U(
            (/android (\d+)/.exec(w((b.navigator || {}).userAgent)) || [])[1]
          ),
  ...
  function xa(b) {
    ...
    return {
      ...
      port: R.port,
      pathname:
        R.pathname && "/" === R.pathname.charAt(0)
          ? R.pathname
          : "/" + R.pathname,
    };
  }
  ...
  function wc(b) {
    ...
    return function (b, d) {
      ...
      return Ac(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  isNaN(P) &&
    (P = U((/trident\/.*; rv:(\d+)/.exec(w(navigator.userAgent)) || [])[1]));
  t.$inject = [];
  za.$inject = [];
  var Y = (function () {
  ...
  var Pc = /[A-Z]/g,
    ...
    Ra = (Q.cache = {}),
    db = (Q.expando = "ng-" + new Date().getTime()),
    Tc = 1,
    Dc = W.document.addEventListener
      ? function (b, a, c) {
    ...
    Da = (Q.prototype = {
      ready: function (b) {
        ...
        "complete" === O.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), Q(W).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, f, g) {
            ...
            q(g, function (a, c) {
              s.test(c) &&
                (l[w(c.replace("when", "").replace("Minus", "-"))] = f.attr(
                  g.$attr[c]
                ));
            });
            q(l, function (a, e) {
            ...
            return function (e, f, k) {
              ...
              e.$watchCollection(z, function (a) {
                ...
                if (pb(a)) (D = a), (z = p || s);
                  ...
                  D = [];
                  for (w in a)
                    a.hasOwnProperty(w) && "$" != w.charAt(0) && D.push(w);
                  D.sort();
                }
                G = D.length;
                n = J.length = D.length;
                ...
                for (n = D.length; k < n; k++) {
                  ...
                  if (u.startNode) {
                    ...
                    u.startNode != z && c.move(vb(u), null, y(r));
                    r = u.endNode;
                  } else N = e.$new();
                  N[A] = I;
                  x && (N[x] = w);
          ...
          link: function (e, g, h, m) {
            ...
            function n(e, f, g) {
              function h() {
                ...
                if (t)
                  if (v && J(u))
                    for (s = new Sa([]), B = 0; B < u.length; B++)
                      (K[m] = u[B]), s.put(v(e, K), u[B]);
                  else s = new Sa(u);
                for (B = 0; (H = A.length), B < H; B++) {
                  ...
                  t
                    ? (d = z(s.remove(v ? v(e, K) : q(e, K))))
                    : (v
                        ? ((d = {}), (d[m] = u), (d = v(e, d) === v(e, K)))
                        : (d = u === q(e, K)),
                      (s = s || d));
                  E = l(e, K);
                  E = z(E) ? E : "";
                    ...
                    (s = k[B]),
                      (d = x[B + 1])
                        ...
                        : ("" === s.id && w
                          ...
                          E ? E.after(L) : u.element.append(L),
                          (E = L));
