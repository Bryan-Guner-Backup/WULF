    ...
    return ensure(ensure(window, "angular", Object), "module", function () {
      ...
      return function module(name, requires, configFn) {
        ...
        return ensure(modules, name, function () {
          if (!requires) {
            throw minErr("$injector")(
              "nomod",
              "Module '{0}' is not available! You either misspelled the module name " +
        ...
        function ($timeout) {
          ...
          return {
            ...
            enter: function (element, parent, after, done) {
              ...
              var parentNode =
                (parent && parent[0]) || (afterNode && afterNode.parentNode);
              ...
              if (
                ...
                if (!msie || msie >= 8) {
                  ...
                  if (normalizedVal !== "") {
                    if (
                      (key === "href" &&
                        !normalizedVal.match(aHrefSanitizationWhitelist)) ||
                      (key === "src" &&
                        !normalizedVal.match(imgSrcSanitizationWhitelist))
                    ) {
                  ...
                  nodeLinkFn(
                    ...
                    (function (transcludeFn) {
                      return function (cloneFn) {
                        ...
                        return transcludeFn(transcludeScope, cloneFn).on(
                          "$destroy",
            ...
            case 1 /* Element */:
              ...
              for (
                ...
                if (!msie || msie >= 8 || attr.specified) {
                  ...
                  if (
                    (index = ngAttrName.lastIndexOf("Start")) != -1 &&
                    index == ngAttrName.length - 5
                  ) {
                    attrStartName = name;
 ...
 */
  ...
  function $SceDelegateProvider() {
    ...
    function isCompatibleProtocol(documentProtocol, resourceProtocol) {
      return (
        documentProtocol === resourceProtocol ||
    ...
    this.$get = [
      ...
      "$injector",
      "$$urlUtils",
      function ($log, $document, $injector, $$urlUtils) {
  ...
  var ngBindHtmlDirective = [
    ...
    function ($sce) {
      return function (scope, element, attr) {
        ...
        scope.$watch(
          $sce.parseAsHtml(attr.ngBindHtml),
    ...
    function ($http, $templateCache, $anchorScroll, $compile, $animate, $sce) {
      return {
        ...
        compile: function (element, attr) {
          ...
          element.html("");
          var anchor = jqLite(
            document.createComment(" ngInclude: " + srcExp + " ")
          );
