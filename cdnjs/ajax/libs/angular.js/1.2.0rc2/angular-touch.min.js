        ...
        bind: function (a, c) {
          ...
          a.on("touchmove mousemove", function (a) {
            if (g && r) {
              ...
              (10 > l && 10 > n) ||
                (n > l
                  ? ((g = !1), c.cancel && c.cancel())
                  : (a.preventDefault(), c.move && c.move(m)));
            }
          });
    ...
    function (f, a, c) {
      function l(d, a, c) {
        for (var h = 0; h < d.length; h += 2)
          if (Math.abs(d[h] - a) < g && Math.abs(d[h + 1] - c) < g)
            return d.splice(h, h + 2), !0;
        return !1;
      }
      function n(a) {
        if (!(Date.now() - m > e)) {
      ...
      return function (a, b, g) {
        ...
        b.on("touchend", function (a) {
          ...
          q &&
            ...
            12 > p &&
            (k ||
              (c[0].addEventListener("click", n, !0),
              c[0].addEventListener("touchstart", r, !0),
              (k = [])),
            (m = Date.now()),
            l(k, e, f),
            s && s.blur(),
            (v.isDefined(g.disabled) && !1 !== g.disabled) ||
