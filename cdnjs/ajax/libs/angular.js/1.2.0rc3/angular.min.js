...
(function (Y, R, s) {
  ...
  function p(b, a, c) {
    ...
    if (b)
      ...
      else if (nb(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
  ...
  function Ub(b, a) {
    ...
    d &&
      (a
        ? delete Oa[c].data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Vb(b)),
          delete Oa[c],
          (b[ab] = s)));
  }
  function ja(b, a, c) {
  ...
  function $b(b) {
    ...
    "function" == typeof b
      ? (a = b.$inject) ||
        ...
        (b.$inject = a))
      : H(b)
      ? ((c = b.length - 1), La(b[c], "fn"), (a = b.slice(0, c)))
      : La(b, "fn", !0);
    return a;
  }
  function Tb(b) {
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (l.pushState(null, "", a), M.attr("href", M.attr("href")))
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : F(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + ka).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[f]),
              ...
              0 < k &&
                ...
                N[a] === s && (N[a] = unescape(e.substring(k + 1))));
        return N;
      }
    };
  ...
  function bc(b) {
    ...
    this.$get = [
      ...
      "$sce",
      "$animate",
      function (b, l, r, q, n, y, A, C, u, U, M) {
        function t(a, b, c, d, e) {
          ...
          return function (b, c) {
            rb(b, "scope");
            for (
              var d = c ? Sa.clone.call(a) : a, e = 0, k = d.length;
              e < k;
              e++
            ) {
              var g = d[e];
          ...
          function k(a, c, d, e) {
            ...
            for (q = g.length; n < q; y++)
              (h = $[y]),
                ...
                c
                  ? (c.scope
                      ? ((l = a.$new(S(c.scope))), x(h).data("$scope", l))
                      : (l = a),
                    (r = c.transclude) || (!e && b)
                      ? c(
                          f,
                      ...
                      : c(f, l, h, s, e))
                  : f && f(a, h.childNodes, s, e);
          }
          for (var g = [], h, l, r, n = 0; n < a.length; n++)
            (l = new z()),
              (h = N(a[n], [], l, 0 == n ? d : s, e)),
              (h =
                ((f = h.length ? L(h, a[n], l, b, c, null, [], [], f) : null) &&
                  f.terminal) ||
                !a[n].childNodes ||
                !a[n].childNodes.length
                  ? null
                  : ca(a[n].childNodes, f ? f.transclude : b)),
              g.push(f),
              g.push(h),
              (r = r || f || h),
              (f = null);
            ...
            case 1:
              ...
              for (var q = 0, y = h && h.length; q < y; q++) {
                ...
                if (!Q || 8 <= Q || l.specified) {
                  ...
                  n === t + "Start" &&
                    ((A = r),
                    (p = r.substr(0, r.length - 5) + "end"),
                    (r = r.substr(0, r.length - 6)));
                  n = la(r.toLowerCase());
                  g[n] = r;
                  c[n] = l = ba(
                    Q && "href" == r
                      ? decodeURIComponent(a.getAttribute(r, 2))
                      : l.value
                  );
                  Yb(a, n) && (c[n] = !0);
                  B(a, b, l, n);
        ...
        function L(a, b, c, d, e, f, k, h, g) {
          ...
          function U(a, d, e, f, g) {
            ...
            v &&
              p(v, function (a) {
                var b = { $scope: d, $element: $, $attrs: n, $transclude: g },
                  c;
                T = a.controller;
                "@" == T && (T = n[a.name]);
                c = A(T, b);
          ...
          for (var O = d, v, B, ma = 0, K = a.length; ma < K; ma++) {
            ...
            if ((w = I.scope))
              (ca = ca || I),
                I.templateUrl ||
                  (P("new/isolated scope", u, I, L),
                  S(w) && (T(L, "ng-isolate-scope"), (u = I)),
                  T(L, "ng-scope"));
            Z = I.name;
            !I.templateUrl &&
              I.controller &&
              ((w = I.controller),
              (v = v || {}),
              P("'" + Z + "' controller", v[Z], I, L),
              (v[Z] = I));
            if ((w = I.transclude))
              "ngRepeat" !== Z && (P("transclusion", g, I, L), (g = I)),
                "element" == w
                  ? ((C = I.priority),
                    (w = da(b, G, D)),
                    (L = c.$$element =
                      x(R.createComment(" " + Z + ": " + c[Z] + " "))),
                    (b = L[0]),
                    db(e, x(ua.call(w, 0)), b),
                    (O = t(w, d, C, f && f.name, {
            ...
            if (I.template)
              if (
                (P("template", M, I, L),
                (M = I),
                (w = E(I.template) ? I.template(L, c) : I.template),
                (w = cc(w)),
                I.replace)
              ) {
                f = I;
            ...
            if (I.templateUrl)
              P("template", M, I, L),
                (M = I),
                I.replace && (f = I),
                (U = Bb(a.splice(ma, a.length - ma), L, c, e, O, k, h, {
                  newIsolateScopeDirective: u,
                  transcludeDirective: g,
                  templateDirective: M,
                })),
              ...
              try {
                (B = I.compile(L, c, O)),
                  E(B) ? n(null, B, G, D) : B && n(B.pre, B.post, G, D);
              } catch (J) {
                r(J, ga(L));
              }
        ...
        function Bb(a, b, c, d, e, f, k, g) {
          ...
          b.html("");
          q.get(U.getTrustedResourceUrl(t), { cache: n })
            .success(function (n) {
              var q;
              n = cc(n);
              if (A.replace) {
            ...
            b.push({
              ...
              compile: aa(function (b, c, f) {
                ...
                if ((e = l(f[d], !0, v(a, d))))
                  (f[d] = e(b)),
                    ((c[d] || (c[d] = [])).$$inter = !0),
                    ((f.$$observers && f.$$observers[d].$$scope) || b).$watch(
                      e,
                      function (a) {
                        f.$set(d, a);
                      }
    ...
    var b = /^\s*(\[|\{[^\{])/,
      ...
      e = (this.defaults = {
        transformResponse: [
          function (d) {
            F(d) &&
              ((d = d.replace(c, "")), b.test(d) && a.test(d) && (d = Ob(d)));
            return d;
          },
        ],
        transformRequest: [
      ...
      function (a, b, c, d, r, q) {
        ...
        function y(b, c, f) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (p = S(b.cache) ? b.cache : S(e.cache) ? e.cache : C);
          if (p)
            if (((u = p.get(s)), w(u))) {
      ...
      function (c, d, e) {
        function f(f, k, l) {
          for (var r, q, n = 0, y = [], A = f.length, p = !1, u = []; n < A; )
            -1 != (r = f.indexOf(b, n)) && -1 != (q = f.indexOf(a, r + g))
              ? (n != r && y.push(f.substring(n, r)),
                y.push((n = c((p = f.substring(r + g, q))))),
                (n.exp = p),
                (n = q + h),
                (p = !0))
              : (n != A && y.push(f.substring(n)), (n = A));
      ...
      function (b, a, c) {
        function d(d, g, h, m) {
          ...
          q.$$intervalId = k(function () {
            ...
            0 < h &&
              n >= h &&
              (r.resolve(n), l(q.$$intervalId), delete e[q.$$intervalId]);
            y || b.$apply();
          }, g);
          e[q.$$intervalId] = r;
          return q;
  ...
  function oc(b, a, c) {
    ...
    if (a.csp)
      f =
        6 > e
          ? nc(d[0], d[1], d[2], d[3], d[4], c, a)
          : function (b, f) {
              var h = 0,
                g;
              do
                (g = nc(d[h++], d[h++], d[h++], d[h++], d[h++], c, a)(b, f)),
                  (f = s),
                  (b = g);
              while (h < e);
              return g;
  ...
  function wd() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = W(
            (/android (\d+)/.exec(B((b.navigator || {}).userAgent)) || [])[1]
          ),
        ...
        if (m) {
          ...
          !d ||
            ...
            (l = F(f.body.style.webkitAnimation)));
        }
        return {
  ...
  function wa(b) {
    ...
    return {
      ...
      port: V.port,
      pathname:
        V.pathname && "/" === V.pathname.charAt(0)
          ? V.pathname
          : "/" + V.pathname,
    };
  }
  ...
  function tc(b) {
    ...
    return function (b, d) {
      ...
      return xc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  function uc(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (m = Fd.exec(e))
          ? ((g = g.concat(ua.call(m, 1))), (e = g.pop()))
          : (g.push(e), (e = null));
      p(g, function (a) {
        h = Gd[a];
        f += h
  ...
  isNaN(Q) &&
    (Q = W((/trident\/.*; rv:(\d+)/.exec(B(navigator.userAgent)) || [])[1]));
  v.$inject = [];
  za.$inject = [];
  var ba = (function () {
  ...
  var Nc = /[A-Z]/g,
    ...
    xb = Y.document.removeEventListener
      ? function (b, a, c) {
    ...
    Sa = (J.prototype = {
      ready: function (b) {
        ...
        "complete" === R.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), J(Y).on("load", a));
      },
      toString: function () {
        var b = [];
        p(this, function (a) {
        ...
        p(d.split(" "), function (d) {
          ...
          if (!f) {
            if ("mouseenter" == d || "mouseleave" == d) {
              var l =
                R.body.contains || R.body.compareDocumentPosition
                  ? function (a, c) {
  ...
  Ua.prototype = {
    ...
    unary: function () {
      ...
      return this.expect("+")
        ? this.primary()
        : (a = this.expect("-"))
        ? this.binaryFn(Ua.ZERO, a.fn, this.unary())
        : (a = this.expect("!"))
  ...
  var Nd = aa({
      ...
      compile: function (a, c) {
        8 >= Q &&
          ...
          a.append(R.createComment("IE fix")));
        return function (a, c) {
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, f, g) {
            ...
            p(g, function (a, c) {
              s.test(c) &&
                (l[B(c.replace("when", "").replace("Minus", "-"))] = f.attr(
                  g.$attr[c]
                ));
            });
            p(l, function (a, e) {
            ...
            function r(e, f, h) {
              function g() {
                ...
                for (A = 0; (G = B.length), A < G; A++) {
                  ...
                  y
                    ? (d = t.remove(u ? u(e, z) : p(e, z)) !== s)
                    : (u
                        ? ((d = {}), (d[m] = v), (d = u(e, d) === u(e, z)))
                        : (d = v === p(e, z)),
                      (t = t || d));
                  E = l(e, z);
                  E = E === s ? "" : E;
                ...
                for (B = c.length; z < B; z++) {
                  ...
                  w.length <= z
                    ...
                    : ((x = w[z]),
                      (v = x[0]),
                      v.label != d && v.element.attr("label", (v.label = d)));
                  E = null;
                  A = 0;
                  for (G = k.length; A < G; A++)
                    (t = k[A]),
                      (d = x[A + 1])
                        ? ((E = d.element),
                          d.label !== t.label && E.text((d.label = t.label)),
                          d.id !== t.id && E.val((d.id = t.id)),
                          E[0].selected !== t.selected &&
                            E.prop("selected", (d.selected = t.selected)))
                        : ("" === t.id && C
                            ? (J = C)
                            : (J = D.clone())
                                .val(t.id)
                                .attr("selected", t.selected)
                                .text(t.label),
                          x.push({
                            element: J,
                            label: t.label,
                          ...
                          E ? E.after(J) : v.element.append(J),
                          (E = J));
