      ...
      N.decorator("$animate", [
        ...
        function (t, A, F, m, G, p, H) {
          ...
          function n(a, d, b, c, h, g, m) {
            function p(a) {
              ...
              if (!0 === a) u();
                ...
                if ((a = b.data(f))) (a.done = u), b.data(f, a);
                s(v, "after", u);
              }
            }
            function s(c, h, g) {
              ...
              k(c, function (k, t) {
                var e = function () {
                  a: {
                    ...
                    a[e] = !0;
                    (a[f] || z)();
                    for (a = 0; a < c.length; a++) if (!c[a][e]) break a;
                    g();
                  }
                };
                "before" != h || ("enter" != a && "move" != a)
                  ? k[h]
                    ? (k[f] = n ? k[h](b, d, e) : k[h](b, e))
                    : e()
                  : e();
              });
            }
            ...
            if (J(b, c) || 0 === h.length) g(), u();
              ...
              0 === v.length
                ? (g(), t())
                : (r.running &&
                    (G.cancel(r.closeAnimationTimeout),
                    q(b),
                    K(r.animations),
                    (r.done || z)(!0)),
                  ("addClass" == a && b.hasClass(d)) ||
                  ("removeClass" == a && !b.hasClass(d))
                    ? (g(), t())
                    : (b.addClass(E),
                      b.data(f, {
                        running: !0,
          ...
          function L(a) {
            a = a[0];
            a.nodeType == T &&
              k(a.querySelectorAll("." + E), function (a) {
                a = s.element(a);
                var b = a.data(f);
          ...
          function q(a) {
            a[0] == m[0]
              ? g.disabled || ((g.running = !1), (g.structural = !1))
              : (a.removeClass(E), a.removeData(f));
          }
          function J(a, d) {
            if (g.disabled) return !0;
            if (a[0] == m[0]) return g.disabled || g.running;
            do {
              if (0 === d.length) break;
              var b = d[0] == m[0],
                c = b ? g : d.data(f),
        ...
        function (f, g, F) {
          ...
          function n(e, a) {
            ...
            0 < d.transitionDuration &&
              (e.addClass(U), (f += N + " "), (b.style[h + S] = "none"));
            ...
            if (a.hasClass(b) && x) {
              ...
              0 < x &&
                (0 < k.transitionDelay &&
                  ...
                  u && (q += ", " + l.transitionDelay + "s"),
                  (y +=
                    c +
                    "transition-delay: " +
                    K(q, k.transitionDelay, x) +
                    "; ")),
                0 < k.animationDelay &&
                  ...
                  (y +=
                    c +
                    "animation-delay: " +
                    K(l.animationDelayStyle, k.animationDelay, x) +
                    "; "));
              0 < y.length && (r = G(M, y));
              a.on(s, f);
              a.addClass(m);
          ...
          var c = "",
            ...
            I,
            P;
          A.ontransitionend === B && A.onwebkittransitionend !== B
            ? ((c = "-webkit-"),
              (h = "WebkitTransition"),
              (O = "webkitTransitionEnd transitionend"))
            : ((h = "transition"), (O = "transitionend"));
          A.onanimationend === B && A.onwebkitanimationend !== B
            ? ((c = "-webkit-"),
              (I = "WebkitAnimation"),
              (P = "webkitAnimationEnd animationend"))
            : ((I = "animation"), (P = "animationend"));
          var D = "Duration",
            S = "Property",
            u = "Delay",
            r = "IterationCount",
          ...
          return {
            ...
            beforeRemoveClass: function (a, c, d) {
              if ((a = q(a, b(c, "-remove")))) return m(d), a;
              d();
            },
