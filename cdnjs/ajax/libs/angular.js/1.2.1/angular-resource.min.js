        ...
        s(k, function (d, c) {
          ...
          b[c] = function (a, c, g, m) {
            ...
            var n = t instanceof b,
              l = n ? t : d.isArray ? [] : new b(t),
              y = {},
              w = (d.interceptor && d.interceptor.response) || e,
              A = (d.interceptor && d.interceptor.responseError) || z;
            s(d, function (b, a) {
              "params" != a &&
                "isArray" != a &&
                "interceptor" != a &&
            ...
            h && (y.data = t);
            F.setUrlParams(y, x({}, r(t, d.params || {}), p), d.url);
            p = D(y).then(
              function (a) {
                var c = a.data,
                  g = l.$promise;
                if (c) {
                  if (f.isArray(c) !== !!d.isArray)
                    throw v(
                      "badcfg",
                      d.isArray ? "array" : "object",
      ...
      n.prototype = {
        setUrlParams: function (m, h, k) {
          ...
          s(e.split(/\W/), function (c) {
            if ("hasOwnProperty" === c) throw v("badname");
            !/^\d+$/.test(c) &&
              c &&
              RegExp("(^|[^\\\\]):" + c + "(\\W|$)").test(e) &&
              (d[c] = !0);
