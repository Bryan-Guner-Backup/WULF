    ...
    .config([
      ...
      */
            function performAnimation(
              ...
              var isClassBased =
                animationEvent == "addClass" || animationEvent == "removeClass";
              ...
              var allowAnimations = isClassBased
                ? !ngAnimateState.disabled &&
                  (!ngAnimateState.running || !ngAnimateState.structural)
                : true;
              ...
              if (allowAnimations) {
                forEach(matches, function (animation) {
                  ...
                  if (
                    ...
                    animation.allowCancel(element, animationEvent, className)
                  ) {
                    var beforeFn,
                      afterFn = animation[animationEvent];
                    ...
                    if (animationEvent == "leave") {
                      ...
                      beforeFn =
                        animation[
                          "before" +
                            animationEvent.charAt(0).toUpperCase() +
                            animationEvent.substr(1)
                        ];
                    }
                    animations.push({
                      before: beforeFn,
              ...
              if (ngAnimateState.running) {
                ...
                var isFullyClassBasedAnimation =
                ...
                if (
                  ngAnimateState.beforeComplete ||
                  isRevertingClassAnimation
                ) {
                  ...
                  futureClassName =
                    ngAnimateState.event == "removeClass"
                      ? futureClassName.replace(
                          ONE_SPACE + ngAnimateState.className + ONE_SPACE,
                          ONE_SPACE
                        )
              ...
              if (
                (animationEvent == "addClass" &&
                  futureClassName.indexOf(classNameToken) >= 0) ||
                (animationEvent == "removeClass" &&
                  futureClassName.indexOf(classNameToken) == -1)
              ) {
                fireDOMOperation();
                fireBeforeCallbackAsync();
                fireAfterCallbackAsync();
              ...
              invokeRegisteredAnimationFns(
                animations,
                "before",
                onBeforeAnimationsComplete
              );
              ...
              function invokeRegisteredAnimationFns(
                ...
                forEach(animations, function (animation, index) {
                  ...
                  if (
                    phase == "before" &&
                    (animationEvent == "enter" || animationEvent == "move")
                  ) {
        ...
        $animateProvider.register("", [
          ...
          function ($window, $sniffer, $timeout, $$animateReflow) {
            ...
            function afterReflow(element, callback) {
              ...
              var animationTime =
                (elementData.maxDelay + elementData.maxDuration) *
                CLOSING_TIME_BUFFER;
              closingAnimationTime = Math.max(
                closingAnimationTime,
                (staggerTime + animationTime) * ONE_SECOND
              );
              ...
              cancelAnimationReflow = $$animateReflow(function () {
                ...
                $timeout(
                  function () {
                    closeAllAnimations(
                      elementQueueSnapshot,
                      animationCounterSnapshot
                    );
           ...
           that only has a delay and no duration */
            ...
            function animateRun(element, className, activeAnimationComplete) {
              ...
              var maxDelayTime =
                Math.max(timings.transitionDelay, timings.animationDelay) *
                ONE_SECOND;
            ...
            return {
              allowCancel: function (element, animationEvent, className) {
                ...
                if (
                  !oldClasses ||
                  ["enter", "leave", "move"].indexOf(animationEvent) >= 0
                ) {
                  return true;
                }

                var parentElement = element.parent();
                var clone = angular.element(
                  extractElementNode(element).cloneNode()
                );
