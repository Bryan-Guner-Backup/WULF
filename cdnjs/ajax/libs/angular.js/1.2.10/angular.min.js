...
(function (Z, Q, r) {
  ...
  function Ub() {
    return (
      (Q.securityPolicy && Q.securityPolicy.isActive) ||
      (Q.querySelector &&
  ...
  function ac(b, a) {
    ...
    d &&
      (a
        ? delete Sa[c].data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), bc(b)),
          delete Sa[c],
          (b[eb] = r)));
  }
  function la(b, a, c) {
    ...
    this.$get = [
      ...
      function (a, b, l, n, p, s, C, y, E, u, R, H) {
          ...
          function f(a, c, d, e) {
            ...
            for (p = m.length; n < p; I++)
              (k = C[I]),
                ...
                (s = A(k)),
                c
                  ? (c.scope ? ((l = a.$new()), s.data("$scope", l)) : (l = a),
                    (s = c.transclude) || (!e && b)
                      ? c(g, l, k, d, V(a, s || b))
                      : c(g, l, k, d, e))
                  : g && g(a, k.childNodes, r, e);
          }
          for (var m = [], k, s, l, n, p = 0; p < a.length; p++)
            (k = new Fb()),
              (s = J(a[p], [], k, 0 === p ? d : r, e)),
              (g = s.length ? ia(s, a[p], k, b, c, null, [], [], g) : null) &&
                g.scope &&
                ha(A(a[p]), "ng-scope"),
              (k =
        ...
        function ia(a, c, d, e, g, f, m, n, p) {
          function y(a, b, c, d) {
            if (a) {
              c && (a = P(a, c, d));
              a.require = G.require;
              if (H === G || G.$$isolateScope) a = kc(a, { isolateScope: !0 });
              m.push(a);
            }
            if (b) {
              c && (b = P(b, c, d));
          ...
          for (
            ...
            if ((U = G.scope))
              (u = u || G),
                G.templateUrl ||
                  (x("new/isolated scope", H, G, t), X(U) && (H = G));
            da = G.name;
            !G.templateUrl &&
              G.controller &&
              ((U = G.controller),
            ...
            if ((U = G.transclude))
              (T = !0),
                G.$$tlb || (x("transclusion", p, G, t), (p = G)),
                "element" == U
                  ? ((z = !0),
                    (N = G.priority),
                    (U = ca(c, Wa, S)),
                    (t = d.$$element =
                      A(Q.createComment(" " + da + ": " + d[da] + " "))),
                    (c = t[0]),
            ...
            if (G.templateUrl)
              ...
              try {
                (O = G.compile(t, d, F)),
                  L(O) ? y(null, O, Wa, S) : O && y(O.pre, O.post, Wa, S);
              } catch (Z) {
                l(Z, ga(t));
              }
        ...
        function w(a, b, c, d, e, g, f, m) {
          ...
          b.empty();
          n.get(u.getTrustedResourceUrl(R), { cache: p })
            .success(function (n) {
              var p, E;
              n = Y(n);
              if (y.replace) {
      ...
      function (a, b, c, d, n, p) {
        ...
        function C(b, c, g) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (u = X(b.cache) ? b.cache : X(e.cache) ? e.cache : E);
          if (u)
            if (((q = u.get(r)), B(q))) {
  ...
  function nd(b) {
    return 8 >= M && "patch" === x(b)
      ? new ActiveXObject("Microsoft.XMLHTTP")
      : new Z.XMLHttpRequest();
  }
  function od() {
    this.$get = [
      "$browser",
      ...
      function (c, d, e) {
        function g(g, k, l) {
          for (var n, p, s = 0, C = [], y = g.length, E = !1, u = []; s < y; )
            -1 != (n = g.indexOf(b, s)) && -1 != (p = g.indexOf(a, n + f))
              ? (s != n && C.push(g.substring(s, n)),
                C.push((s = c((E = g.substring(n + f, p))))),
                (s.exp = E),
                (s = p + h),
                (E = !0))
              : (s != y && C.push(g.substring(s)), (s = y));
      ...
      function (b, a, c) {
        function d(d, f, h, m) {
          ...
          p.$$intervalId = k(function () {
            ...
            0 < h &&
              s >= h &&
              (n.resolve(s), l(p.$$intervalId), delete e[p.$$intervalId]);
            C || b.$apply();
          }, f);
          e[p.$$intervalId] = n;
          return p;
        ...
        h.prototype = {
          ...
          $destroy: function () {
            if (!this.$$destroyed) {
              ...
              this.$$destroyed = !0;
              this !== p &&
                (q(this.$$listenerCount, cb(null, l, this)),
  ...
  function Cc(b) {
    ...
    return function (b, d) {
      ...
      return Gc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  function Dc(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (m = Pd.exec(e))
          ? ((f = f.concat(va.call(m, 1))), (e = f.pop()))
          : (f.push(e), (e = null));
      q(f, function (a) {
        h = Qd[a];
        g += h
  ...
  isNaN(M) &&
    (M = S((/trident\/.*; rv:(\d+)/.exec(x(navigator.userAgent)) || [])[1]));
  w.$inject = [];
  Ba.$inject = [];
  var ba = (function () {
    ...
    Ga = (O.prototype = {
      ready: function (b) {
        ...
        "complete" === Q.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), O(Z).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
  ...
  q(
    {
      ...
      scope: function (b) {
        return (
          A(b).data("$scope") ||
          fb(b.parentNode || b, ["$isolateScope", "$scope"])
        );
      },
        ...
        q(d.split(" "), function (d) {
          ...
          if (!g) {
            if ("mouseenter" == d || "mouseleave" == d) {
              var l =
                Q.body.contains || Q.body.compareDocumentPosition
                  ? function (a, c) {
