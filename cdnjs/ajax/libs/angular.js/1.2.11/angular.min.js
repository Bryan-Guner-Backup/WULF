...
(function (Q, S, s) {
  ...
  function q(b, a, c) {
    ...
    if (b)
      ...
      else if (qb(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
  ...
  function $(b, a) {
    ...
    if (a) {
      if (b === a) throw Na("cpi");
      if (K(b)) for (var c = (a.length = 0); c < b.length; c++) a.push($(b[c]));
      else {
        c = a.$$hashKey;
        q(a, function (b, c) {
          delete a[c];
  ...
  function $b(b, a) {
    ...
    d &&
      (a
        ? delete Ra[c].data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), ac(b)),
          delete Ra[c],
          (b[db] = s)));
  }
  function ja(b, a, c) {
    var d = b[db],
      d = Ra[d || -1];
    if (C(c)) d || ((b[db] = d = ++Xc), (d = Ra[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function bc(b, a, c) {
    var d = ja(b, "data"),
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (l.pushState(null, "", a), H.attr("href", H.attr("href")))
              : ((x = a), c ? k.replace(a) : (k.href = a)),
            h
          );
          ...
          for (
            ...
            (e = d[g]),
              ...
              0 < h &&
                ...
                V[a] === s && (V[a] = unescape(e.substring(h + 1))));
        return V;
      }
    };
  ...
  function ic(b, a) {
    ...
    this.$get = [
      ...
      "$animate",
      "$$sanitizeUri",
      function (a, b, l, n, p, r, E, z, F, u, R, H) {
          ...
          function f(a, c, d, e) {
            ...
            for (p = m.length; n < p; I++)
              (k = E[I]),
                ...
                (r = A(k)),
                c
                  ? (c.scope ? ((l = a.$new()), r.data("$scope", l)) : (l = a),
                    (r = c.transclude) || (!e && b)
                      ? c(g, l, k, d, V(a, r || b))
                      : c(g, l, k, d, e))
                  : g && g(a, k.childNodes, s, e);
          }
          for (var m = [], k, r, l, n, p = 0; p < a.length; p++)
            (k = new Db()),
              (r = J(a[p], [], k, 0 === p ? d : s, e)),
              (g = r.length ? ga(r, a[p], k, b, c, null, [], [], g) : null) &&
                g.scope &&
                ka(A(a[p]), "ng-scope"),
              (k =
                (g && g.terminal) || !(l = a[p].childNodes) || !l.length
                  ? null
                  : N(l, g ? g.transclude : b)),
              m.push(g, k),
              (n = n || g || k),
              (g = null);
          return n ? f : null;
        ...
        function J(a, b, c, d, f) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              var r, l, n;
              k = a.attributes;
              for (var p = 0, E = k && k.length; p < E; p++) {
                var z = !1,
                  R = !1;
                r = k[p];
            ...
            case 8:
              try {
                if ((k = e.exec(a.nodeValue)))
                  (n = la(k[1])), T(b, n, "M", d, f) && (c[n] = aa(k[2]));
              } catch (F) {}
          }
          b.sort(B);
          return b;
        ...
        function ga(a, c, d, e, g, f, m, n, p) {
          function z(a, b, c, d) {
            if (a) {
              c && (a = O(a, c, d));
              a.require = G.require;
              if (H === G || G.$$isolateScope) a = jc(a, { isolateScope: !0 });
              m.push(a);
            }
            if (b) {
              c && (b = O(b, c, d));
          ...
          for (
            ...
            if ((t = G.scope))
              (u = u || G),
                G.templateUrl ||
                  (v("new/isolated scope", H, G, y), X(t) && (H = G));
            ca = G.name;
            !G.templateUrl &&
              G.controller &&
              ((t = G.controller),
              (V = V || {}),
              v("'" + ca + "' controller", V[ca], G, y),
              (V[ca] = G));
            if ((t = G.transclude))
              (T = !0),
                G.$$tlb || (v("transclusion", p, G, y), (p = G)),
                "element" == t
                  ? ((B = !0),
                    (N = G.priority),
                    (t = ba(c, Va, U)),
                    (y = d.$$element =
                      A(S.createComment(" " + ca + ": " + d[ca] + " "))),
                    (c = y[0]),
                    hb(g, A(ua.call(t, 0)), c),
                    (Q = x(t, e, N, f && f.name, {
                      nonTlbTranscludeDirective: p,
                    })))
                  : ((t = A(yb(c)).contents()), y.empty(), (Q = x(t, e)));
            if (G.template)
              if (
                (v("template", ga, G, y),
                (ga = G),
                (t = L(G.template) ? G.template(y, d) : G.template),
                (t = W(t)),
                G.replace)
              ) {
                f = G;
            ...
            if (G.templateUrl)
              v("template", ga, G, y),
                (ga = G),
                G.replace && (f = G),
                (F = w(a.splice(M, a.length - M), y, d, g, Q, m, n, {
              ...
              try {
                (P = G.compile(y, d, Q)),
                  L(P) ? z(null, P, Va, U) : P && z(P.pre, P.post, Va, U);
              } catch (Z) {
                l(Z, fa(y));
              }
        ...
        function T(b, e, g, f, k, r, n) {
          ...
          if (c.hasOwnProperty(e)) {
            var p;
            e = a.get(e + d);
            for (var E = 0, z = e.length; E < z; E++)
              try {
                (p = e[E]),
                  (f === s || f > p.priority) &&
                    -1 != p.restrict.indexOf(g) &&
                    (r && (p = Qb(p, { $$start: r, $$end: n })),
                    b.push(p),
                    (k = p));
              } catch (R) {
                l(R);
        ...
        function w(a, b, c, d, e, g, f, k) {
          ...
          b.empty();
          n.get(u.getTrustedResourceUrl(x), { cache: p })
            .success(function (n) {
              var p, F;
              n = W(n);
              if (z.replace) {
      ...
      function (a, b, c, d, n, p) {
        function r(a) {
          ...
          (a = Eb(d.url)
            ...
            : s) && (g[d.xsrfHeaderName || e.xsrfHeaderName] = a);
          var f = [
              function (a) {
                g = a.headers;
        ...
        function E(b, c, g) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (u = X(b.cache) ? b.cache : X(e.cache) ? e.cache : F);
          if (u)
            if (((q = u.get(s)), C(q))) {
  ...
  function od(b, a, c, d, e) {
    ...
    return function (e, m, k, l, n, p, r, E) {
      ...
      if ("jsonp" == v(e)) {
        ...
        var H = g(
          m.replace("JSON_CALLBACK", "angular.callbacks." + R),
          function () {
  ...
  function pd() {
    ...
    this.$get = [
      ...
      function (c, d, e) {
        function g(g, k, l) {
          for (var n, p, r = 0, E = [], z = g.length, F = !1, u = []; r < z; )
            -1 != (n = g.indexOf(b, r)) && -1 != (p = g.indexOf(a, n + f))
              ? (r != n && E.push(g.substring(r, n)),
                E.push((r = c((F = g.substring(n + f, p))))),
                (r.exp = F),
                (r = p + h),
                (F = !0))
              : (r != z && E.push(g.substring(r)), (r = z));
          ...
          if (!k || F)
            return (
              ...
              (r = function (a) {
                try {
                  for (var b = 0, c = z, f; b < c; b++)
                    "function" == typeof (f = E[b]) &&
                      ((f = f(a)),
                      (f = l ? e.getTrusted(l, f) : e.valueOf(f)),
                      null === f || B(f)
                        ? (f = "")
                        : "string" != typeof f && (f = pa(f))),
                      (u[b] = f);
                  return u.join("");
                } catch (k) {
      ...
      function (c, d, e, g) {
        ...
        g.on("click", function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            for (var b = A(a.target); "a" !== v(b[0].nodeName); )
        ...
        h.prototype = {
          ...
          $digest: function () {
            ...
            do {
              ...
              if ((x || k.length) && !s--)
                throw ((p.$$phase = null), a("infdig", b, pa(V)));
            } while (x || k.length);
          ...
          $destroy: function () {
            if (!this.$$destroyed) {
              ...
              this.$$destroyed = !0;
              this !== p &&
                (q(this.$$listenerCount, bb(null, l, this)),
    ...
    this.$get = [
      ...
      function (b, a) {
        ...
        if (k) {
          ...
          !d ||
            (l && n) ||
            ((l = D(g.body.style.webkitTransition)),
  ...
  function Bc(b) {
    ...
    return function (b, d) {
      ...
      return Fc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  function Cc(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (m = Od.exec(e))
          ? ((f = f.concat(ua.call(m, 1))), (e = f.pop()))
          : (f.push(e), (e = null));
      q(f, function (a) {
        h = Pd[a];
        g += h
  ...
  isNaN(M) &&
    (M = W((/trident\/.*; rv:(\d+)/.exec(v(navigator.userAgent)) || [])[1]));
  w.$inject = [];
  Aa.$inject = [];
  var aa = (function () {
  ...
  var Tc = /[A-Z]/g,
    ...
    Ra = (P.cache = {}),
    db = (P.expando = "ng-" + new Date().getTime()),
    Xc = 1,
    Ic = Q.document.addEventListener
      ? function (b, a, c) {
    ...
    zb = Q.document.removeEventListener
      ? function (b, a, c) {
    ...
    Fa = (P.prototype = {
      ready: function (b) {
        ...
        "complete" === S.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), P(Q).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
  ...
  q(
    {
      ...
      isolateScope: function (b) {
        return (
          A(b).data("$isolateScope") || A(b).data("$isolateScopeNoTemplate")
        );
      },
      controller: cc,
      injector: function (b) {
      ...
      function (a, c, d, e, g) {
        ...
        this.$setValidity = function (a, c) {
          n[a] !== !c &&
            (c
              ? (n[a] && l--,
                l || (f(!0), (this.$valid = !0), (this.$invalid = !1)))
              : (f(!1), (this.$invalid = !0), (this.$valid = !1), l++),
            (n[a] = !c),
            f(c, a),
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, g, f) {
            ...
            q(f, function (a, c) {
              s.test(c) &&
                (l[v(c.replace("when", "").replace("Minus", "-"))] = g.attr(
                  f.$attr[c]
                ));
            });
            q(l, function (a, e) {
          ...
          link: function (e, g, f, h, m) {
            ...
            e.$watchCollection(h, function (a) {
              ...
              if (qb(a)) (T = a), (n = p || r);
                ...
                T = [];
                for (B in a)
                  a.hasOwnProperty(B) && "$" != B.charAt(0) && T.push(B);
                T.sort();
              }
              y = T.length;
              h = v.length = T.length;
          ...
          link: function (e, f, h, m) {
            ...
            function n(e, f, g) {
              function h() {
                ...
                if (r)
                  if (w && K(t))
                    for (s = new Sa([]), v = 0; v < t.length; v++)
                      (I[m] = t[v]), s.put(w(e, I), t[v]);
                  else s = new Sa(t);
                for (v = 0; (E = B.length), v < E; v++) {
                  ...
                  r
                    ? (d = C(s.remove(w ? w(e, I) : q(e, I))))
                    : (w
                        ? ((d = {}), (d[m] = t), (d = w(e, d) === w(e, I)))
                        : (d = t === q(e, I)),
                      (s = s || d));
                  F = l(e, I);
                  F = C(F) ? F : "";
                    ...
                    (s = k[v]),
                      (d = x[v + 1])
                        ...
                        : ("" === s.id && z
                          ...
                          F ? F.after(H) : t.element.append(H),
                          (F = H));
                  for (v++; x.length > v; ) x.pop().element.remove();
                }
                for (; y.length > I; ) y.pop()[0].element.remove();
              }
              var k;
            ...
            if (m[1]) {
              ...
              var r = h.multiple,
                ...
                z = !1,
                w,
                u = A(S.createElement("option")),
                D = A(S.createElement("optgroup")),
                y = u.clone();
              h = 0;
              for (var x = f.children(), v = x.length; h < v; h++)
                if ("" === x[h].value) {
                  w = z = x.eq(h);
                  break;
                }
