...
(function (P, R, s) {
  ...
  function $(b, a) {
    ...
    if (a) {
      if (b === a) throw Na("cpi");
      if (L(b)) for (var c = (a.length = 0); c < b.length; c++) a.push($(b[c]));
      else {
        c = a.$$hashKey;
        q(a, function (b, c) {
          delete a[c];
  ...
  function Sb() {
    return (
      (R.securityPolicy && R.securityPolicy.isActive) ||
      (R.querySelector &&
        !(!R.querySelector("[ng-csp]") && !R.querySelector("[data-ng-csp]")))
    );
  }
  function bb(b, a) {
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : w(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + aa).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[g]),
              ...
              0 < h &&
                ...
                U[a] === s && (U[a] = unescape(e.substring(h + 1))));
        return U;
      }
    };
              ...
              function (b, d) {
                ...
                q(c[a], function (c, g) {
                  try {
                    ...
                    M(f)
                      ? (f = { compile: Y(f) })
                      : !f.compile && f.link && (f.compile = Y(f.link));
    ...
    this.$get = [
      ...
      function (a, b, l, n, p, r, F, A, H, v, Q, K) {
        ...
        function ga(a, c, d, e, g, f, m, n, p) {
          function A(a, b, c, d) {
            if (a) {
              c && (a = B(a, c, d));
              a.require = G.require;
              if (K === G || G.$$isolateScope) a = jc(a, { isolateScope: !0 });
              m.push(a);
            }
            if (b) {
              c && (b = B(b, c, d));
          ...
          function H(a, e, g, f, p) {
            ...
            if (K) {
              ...
              f = z(g);
              B = e.$new(!0);
              ga && ga === K.$$originalDirective
                ? f.data("$isolateScope", B)
                : f.data("$isolateScopeNoTemplate", B);
          ...
          for (
            ...
            if ((t = G.scope))
              (I = I || G),
                G.templateUrl ||
                  (x("new/isolated scope", K, G, y), W(t) && (K = G));
            ca = G.name;
            !G.templateUrl &&
              G.controller &&
              ((t = G.controller),
              (U = U || {}),
              x("'" + ca + "' controller", U[ca], G, y),
              (U[ca] = G));
            if ((t = G.transclude))
              (S = !0),
                G.$$tlb || (x("transclusion", p, G, y), (p = G)),
                "element" == t
                  ? ((u = !0),
                    (v = G.priority),
                    (t = aa(c, Va, T)),
                    (y = d.$$element =
                      z(R.createComment(" " + ca + ": " + d[ca] + " "))),
                    (c = y[0]),
                    hb(g, z(ua.call(t, 0)), c),
                    (P = C(t, e, v, f && f.name, {
            ...
            if (G.template)
              if (
                (x("template", ga, G, y),
                (ga = G),
                (t = M(G.template) ? G.template(y, d) : G.template),
                (t = V(t)),
                G.replace)
              ) {
                f = G;
            ...
            if (G.templateUrl)
              x("template", ga, G, y),
                (ga = G),
                G.replace && (f = G),
                (H = E(a.splice(N, a.length - N), y, d, g, P, m, n, {
              ...
              try {
                (O = G.compile(y, d, P)),
                  M(O) ? A(null, O, Va, T) : O && A(O.pre, O.post, Va, T);
              } catch (Y) {
                l(Y, fa(y));
              }
        ...
        function E(a, b, c, d, e, g, f, k) {
          ...
          b.empty();
          n.get(v.getTrustedResourceUrl(C), { cache: p })
            .success(function (n) {
              var p, H;
              n = V(n);
              if (A.replace) {
      ...
      function (a, b, c, d, n, p) {
        ...
        function F(b, c, g) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (v = W(b.cache) ? b.cache : W(e.cache) ? e.cache : H);
          if (v)
            if (((q = v.get(s)), D(q))) {
  ...
  function od(b, a, c, d, e) {
    ...
    return function (e, m, k, l, n, p, r, F) {
      ...
      if ("jsonp" == x(e)) {
        ...
        var K = g(
          m.replace("JSON_CALLBACK", "angular.callbacks." + Q),
          function () {
        ...
        function g(g, k, l) {
          for (var n, p, r = 0, F = [], A = g.length, H = !1, v = []; r < A; )
            -1 != (n = g.indexOf(b, r)) && -1 != (p = g.indexOf(a, n + f))
              ? (r != n && F.push(g.substring(r, n)),
                F.push((r = c((H = g.substring(n + f, p))))),
                (r.exp = H),
                (r = p + h),
                (H = !0))
              : (r != A && F.push(g.substring(r)), (r = A));
    ...
    this.$get = [
      ...
      function (b, a) {
        ...
        if (k) {
          ...
          !d ||
            (l && n) ||
            ((l = w(g.body.style.webkitTransition)),
  ...
  isNaN(N) &&
    (N = V((/trident\/.*; rv:(\d+)/.exec(x(navigator.userAgent)) || [])[1]));
  E.$inject = [];
  Aa.$inject = [];
  var Z = (function () {
  ...
  var Tc = /[A-Z]/g,
    ...
    Xc = 1,
    Ic = P.document.addEventListener
      ? function (b, a, c) {
    ...
    zb = P.document.removeEventListener
      ? function (b, a, c) {
    ...
    Fa = (O.prototype = {
      ready: function (b) {
        ...
        "complete" === R.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), O(P).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, g, f) {
            ...
            q(f, function (a, c) {
              s.test(c) &&
                (l[x(c.replace("when", "").replace("Minus", "-"))] = g.attr(
                  f.$attr[c]
                ));
            });
            q(l, function (a, e) {
            ...
            function n(e, f, g) {
              function h() {
                ...
                for (x = 0; (F = C.length), x < F; x++) {
                  ...
                  r
                    ? (d = D(s.remove(w ? w(e, J) : q(e, J))))
                    : (w
                        ? ((d = {}), (d[m] = t), (d = w(e, d) === w(e, J)))
                        : (d = t === q(e, J)),
                      (s = s || d));
                  B = l(e, J);
                  B = D(B) ? B : "";
                ...
                for (C = c.length; J < C; J++) {
                  ...
                  for (F = k.length; x < F; x++)
                    (s = k[x]),
                      (d = u[x + 1])
                        ? ((B = d.element),
                          d.label !== s.label && B.text((d.label = s.label)),
                          d.id !== s.id && B.val((d.id = s.id)),
                          B[0].selected !== s.selected &&
                            B.prop("selected", (d.selected = s.selected)))
                        : ("" === s.id && A
                            ? (H = A)
                            : (H = v.clone())
                                .val(s.id)
                          ...
                          B ? B.after(H) : t.element.append(H),
                          (B = H));
                  for (x++; u.length > x; ) u.pop().element.remove();
                }
                for (; y.length > J; ) y.pop()[0].element.remove();
              }
              var k;
