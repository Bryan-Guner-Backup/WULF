      ...
      function ($, h) {
        ...
        $.decorator("$animate", [
          ...
          function (x, z, ca, F, J, B, T) {
            ...
            function M(a, c) {
              if (d(a) == d(F))
                s.disabled || ((s.running = !1), (s.structural = !1));
              else if (c) {
                var e = a.data(l) || {},
                  f = !0 === c;
                !f &&
                  e.active &&
                  e.active[c] &&
                  (e.totalActive--, delete e.active[c]);
        ...
        h.register("", [
          ...
          function (l, s, h, n) {
            ...
            function M(b, a, c) {
              "ng-enter" != a && "ng-move" != a && "ng-leave" != a && c
                ? b.addClass(ga)
                : (d(b).style[O + H] = "none");
            }
            function R(b, a) {
            ...
            function Z(b, a, c, e) {
              ...
              if (-1 != h.className.indexOf(c) && b) {
                ...
                0 < n &&
                  (0 < p.transitionDelay &&
                    ...
                    ((m +=
                      C +
                      "transition-delay: " +
                      W(r.transitionDelayStyle, p.transitionDelay, n) +
                      "; "),
                  ...
                  0 < p.animationDelay &&
                    ...
                    ((m +=
                      C +
                      "animation-delay: " +
                      W(r.animationDelayStyle, p.animationDelay, n) +
                      "; "),
                    q.push(C + "animation-delay")));
                0 < q.length &&
                  ((r = h.getAttribute("style") || ""),
                  h.setAttribute("style", r + " " + m));
                a.on(w, k);
                a.addClass(l);
                ...
                h =
                  (n * (Math.max(p.animationDelay, p.transitionDelay) || 0) +
                    (t + s) * v) *
                  y;
                b.running++;
                B(a, h);
            ...
            function A(b, a) {
              ...
              c &&
                (c.running && c.running--,
                (c.running && 0 !== c.running) || b.removeData(E));
            }
            function k(b, a) {
              var c = "";
