...
(function (C, T, s) {
  ...
  function cc(b, a) {
    ...
    d &&
      (a
        ? delete Sa[c].data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), dc(b)),
          delete Sa[c],
          (b[eb] = s)));
  }
  function ka(b, a, c) {
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : D(b) &&
            ((d =
              (n.cookie = escape(a) + "=" + escape(b) + ";path=" + U).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            ...
            e(c);
            if (!x(b))
              return a in n || g++, (n[a] = b), g > k && this.remove(p.key), b;
          },
          get: function (a) {
            var b = l[a];
            if (b) return e(b), n[a];
      ...
      function (a, b, m, p, q, A, B, I, u, G, W, y) {
        ...
        function L(a, b, c, d, e, f) {
          ...
          for (var g = [], k, q, l, m, p = 0; p < a.length; p++)
            (k = new Gb()),
              (q = U(a[p], [], k, 0 === p ? d : s, e)),
              (f = q.length ? Wa(q, a[p], k, b, c, null, [], [], f) : null) &&
                f.scope &&
                S(z(a[p]), "ng-scope"),
              (k =
                (f && f.terminal) || !(l = a[p].childNodes) || !l.length
                  ? null
                  : L(l, f ? f.transclude : b)),
              g.push(f, k),
              (m = m || f || k),
              (f = null);
          return m ? h : null;
            ...
            case 8:
              try {
                if ((k = e.exec(a.nodeValue)))
                  (m = la(k[1])), v(b, m, "M", d, h) && (c[m] = da(k[2]));
              } catch (y) {}
          }
          b.sort(E);
          return b;
        ...
        function Wa(a, c, d, e, f, h, g, k, q) {
          ...
          for (
            ...
            if ((t = F.scope))
              (u = u || F),
                F.templateUrl ||
                  (R("new/isolated scope", L, F, J), Z(t) && (L = F));
            ha = F.name;
            !F.templateUrl &&
              F.controller &&
              ((t = F.controller),
      ...
      function (a, b, c, d, m, p) {
        ...
        function A(b, c, f) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (u = Z(b.cache) ? b.cache : Z(e.cache) ? e.cache : I);
          if (u)
            if (((r = u.get(s)), v(r))) {
  ...
  function od(b) {
    if (
      8 >= P &&
      (!b.match(/^(get|post|head|put|delete|options)$/i) || !C.XMLHttpRequest)
    )
  ...
  function qd(b, a, c, d, e) {
    ...
    return function (e, n, k, l, m, p, q, A) {
      ...
      if ("jsonp" == O(e)) {
        ...
        var W = f(
          n.replace("JSON_CALLBACK", "angular.callbacks." + G),
          function () {
      ...
      function (b, a, c) {
        function d(d, g, h, n) {
          ...
          p.$$intervalId = k(function () {
            ...
            0 < h &&
              q >= h &&
              (m.resolve(q), l(p.$$intervalId), delete e[p.$$intervalId]);
            A || b.$apply();
          }, g);
          e[p.$$intervalId] = m;
          return p;
  ...
  function vd() {
    ...
    this.$get = [
      ...
      function (c, d, e, f) {
        ...
        a
          ? ((n =
              k.substring(0, k.indexOf("/", k.indexOf("//") + 2)) + (n || "/")),
            (e = e.history ? uc : vc))
          : ((n = Xa(k)), (e = Kb));
        h = new e(n, "#" + b);
        h.$$parse(h.$$rewrite(k));
        ...
        h.prototype = {
          ...
          $digest: function () {
            ...
            do {
              ...
              if ((y || k.length) && !s--)
                throw ((p.$$phase = null), a("infdig", b, oa(L)));
            } while (y || k.length);
    ...
    this.$get = [
      ...
      function (b, a) {
        ...
        if (k) {
          ...
          !d ||
            (l && m) ||
            ((l = D(f.body.style.webkitTransition)),
  ...
  function Hc(b, a, c, d, e) {
    ...
    if (k) 0 < e && -1 < b && 1 > b && (h = b.toFixed(e));
      ...
      var l = 0,
        ...
        p = a.gSize;
      if (g.length >= m + p)
        for (l = g.length - m, k = 0; k < l; k++)
          0 === (l - k) % p && 0 !== k && (h += c), (h += g.charAt(k));
      for (k = l; k < g.length; k++)
        0 === (g.length - k) % m && 0 !== k && (h += c), (h += g.charAt(k));
      for (; b.length < e; ) b += "0";
  ...
  function Ec(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (n = Rd.exec(e))
          ? ((g = g.concat(ua.call(n, 1))), (e = g.pop()))
          : (g.push(e), (e = null));
      r(g, function (a) {
        h = Sd[a];
        f += h
    ...
    Fa = (R.prototype = {
      ready: function (b) {
        ...
        "complete" === T.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), R(C).on("load", a));
      },
      toString: function () {
        var b = [];
        r(this, function (a) {
  ...
  r(
    {
      ...
      scope: function (b) {
        return (
          z(b).data("$scope") ||
          hb(b.parentNode || b, ["$isolateScope", "$scope"])
        );
      },
          ...
          link: function (e, g, h, n) {
            ...
            function m(e, f, g) {
              function h() {
                ...
                if (q)
                  if (w && H(t))
                    for (s = new Ta([]), C = 0; C < t.length; C++)
                      (X[m] = t[C]), s.put(w(e, X), t[C]);
                  else s = new Ta(t);
                    ...
                    (s = k[C]),
                      (d = x[C + 1])
                        ? ((K = d.element),
                          ...
                          K[0].selected !== s.selected &&
                            K.prop("selected", (d.selected = s.selected)))
                        : ("" === s.id && B
                            ? (I = B)
                            : (I = u.clone())
                                .val(s.id)
