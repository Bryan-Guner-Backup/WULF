        ...
        V.decorator("$animate", [
          ...
          function (x, F, aa, K, E, H, P) {
            ...
            function A(a, b, c, d, f, e, r) {
              ...
              if (l) {
                b = l.className;
                var w = g.element._data(l.node),
                  w = w && w.events;
                d || (d = f ? f.parent() : c.parent());
                var n = c.data(h) || {};
                f = n.active || {};
                var y = n.totalActive || 0,
                  C = n.last;
                if (
                  (l.isClassBased && (n.disabled || (C && !C.isClassBased))) ||
                  N(c, d)
                )
                  t(), q(), z(), v();
                else {
                  ...
                  if (d) q(), z(), s();
                    ...
                    l.before(function (d) {
                      ...
                      d =
                        ...
                        !e ||
                        !e.active[b] ||
                        (l.isClassBased && e.active[b].event != a);
                      t();
                      !0 === d ? v() : (z(), l.after(v));
                    });
                  }
          ...
          function (h, r, u, K) {
            ...
            function U(a, b, c, f) {
              ...
              if (-1 != l.className.indexOf(c) && a) {
                ...
                0 < t &&
                  (0 < q.transitionDelay &&
                    0 === q.transitionDuration &&
                    ((s +=
                      D +
                      "transition-delay: " +
                      S(m.transitionDelayStyle, q.transitionDelay, t) +
                      "; "),
                  ...
                  0 < q.animationDelay &&
                    ...
                    ((s +=
                      D +
                      "animation-delay: " +
                      S(m.animationDelayStyle, q.animationDelay, t) +
                      "; "),
                    u.push(D + "animation-delay")));
                0 < u.length &&
                  ((m = l.getAttribute("style") || ""),
                  l.setAttribute("style", m + " " + s));
                b.on(y, h);
                b.addClass(r);
                ...
                l =
                  (t * (Math.max(q.animationDelay, q.transitionDelay) || 0) +
                    (w + v) * V) *
                  ca;
                a.running++;
                H(b, l);
            ...
            function d(a, b) {
              ...
              c &&
                (c.running && c.running--,
                (c.running && 0 !== c.running) || a.removeData(n));
            }
            function f(a, b) {
              var c = "";
            ...
            var D = "",
              ...
              q,
              z;
            F.ontransitionend === P && F.onwebkittransitionend !== P
              ? ((D = "-webkit-"),
                (I = "WebkitTransition"),
                (G = "webkitTransitionEnd transitionend"))
              : ((I = "transition"), (G = "transitionend"));
            F.onanimationend === P && F.onwebkitanimationend !== P
              ? ((D = "-webkit-"),
                (q = "WebkitAnimation"),
                (z = "webkitAnimationEnd animationend"))
              : ((q = "animation"), (z = "animationend"));
            var s = "Duration",
              t = "Property",
              v = "Delay",
              l = "IterationCount",
