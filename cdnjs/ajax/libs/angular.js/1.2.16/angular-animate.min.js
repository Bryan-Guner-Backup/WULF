          ...
          function (h, r, u, K) {
            ...
            function V(a, b, c, f) {
              ...
              if (-1 != l.getAttribute("class").indexOf(c) && a) {
                ...
                0 < s &&
                  (0 < q.transitionDelay &&
                    ...
                    ((t +=
                      D +
                      "transition-delay: " +
                      T(m.transitionDelayStyle, q.transitionDelay, s) +
                      "; "),
                  ...
                  0 < q.animationDelay &&
                    ...
                    ((t +=
                      D +
                      "animation-delay: " +
                      T(m.animationDelayStyle, q.animationDelay, s) +
                      "; "),
                    u.push(D + "animation-delay")));
                0 < u.length &&
                  ((m = l.getAttribute("style") || ""),
                  l.setAttribute("style", m + " " + t));
                b.on(z, h);
                b.addClass(r);
                ...
                l =
                  (s * (Math.max(q.animationDelay, q.transitionDelay) || 0) +
                    (w + v) * Q) *
                  ca;
                a.running++;
                H(b, l);
            ...
            var D = "",
              ...
              q,
              y;
            s.ontransitionend === P && s.onwebkittransitionend !== P
              ? ((D = "-webkit-"),
                (I = "WebkitTransition"),
                (G = "webkitTransitionEnd transitionend"))
              : ((I = "transition"), (G = "transitionend"));
            s.onanimationend === P && s.onwebkitanimationend !== P
              ? ((D = "-webkit-"),
                (q = "WebkitAnimation"),
                (y = "webkitAnimationEnd animationend"))
              : ((q = "animation"), (y = "animationend"));
            var z = "Duration",
              v = "Property",
              w = "Delay",
              l = "IterationCount",
