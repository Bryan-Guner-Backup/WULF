...
(function (O, U, s) {
  ...
  function q(b, a, c) {
    ...
    if (b)
      ...
      else if (ab(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (m.pushState(null, "", a), A.attr("href", A.attr("href")))
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : w(b) &&
            ((d =
              (l.cookie = escape(a) + "=" + escape(b) + ";path=" + H).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[g]),
              ...
              0 < h &&
                ...
                Q[a] === s && (Q[a] = unescape(e.substring(h + 1))));
        return Q;
      }
    };
      ...
      function (a, b, m, n, p, r, z, u, F, v, J, A) {
        ...
        function L(a, b, c, d, e, g) {
          function f(a, c, d, e) {
            ...
            for (p = l.length; n < p; z++)
              (k = I[z]),
                ...
                (m = y(k)),
                c
                  ? (c.scope ? ((r = a.$new()), m.data("$scope", r)) : (r = a),
                    (m = c.transclude) || (!e && b)
                      ? c(g, r, k, d, Q(a, m || b))
                      : c(g, r, k, d, e))
          ...
          for (var l = [], k, m, r, n, p = 0; p < a.length; p++)
            (k = new Hb()),
              (m = da(a[p], [], k, 0 === p ? d : s, e)),
              (g = m.length ? ia(m, a[p], k, b, c, null, [], [], g) : null) &&
                g.scope &&
                ma(y(a[p]), "ng-scope"),
              (k =
                (g && g.terminal) || !(r = a[p].childNodes) || !r.length
                  ? null
                  : L(r, g ? g.transclude : b)),
              l.push(g, k),
              (n = n || g || k),
              (g = null);
          return n ? f : null;
        ...
        function ia(a, c, d, e, g, f, l, n, p) {
          function u(a, b, c, d) {
            if (a) {
              c && (a = R(a, c, d));
              a.require = G.require;
              if (Q === G || G.$$isolateScope) a = qc(a, { isolateScope: !0 });
              l.push(a);
            }
            if (b) {
              c && (b = R(b, c, d));
          ...
          function J(a, e, g, f, p) {
            ...
            if (Q) {
              ...
              f = y(g);
              H = e.$new(!0);
              ia && ia === Q.$$originalDirective
                ? f.data("$isolateScope", H)
                : f.data("$isolateScopeNoTemplate", H);
          ...
          for (
            ...
            if ((V = G.scope))
              (A = A || G),
                G.templateUrl ||
                  (K("new/isolated scope", Q, G, Z), X(V) && (Q = G));
            t = G.name;
            !G.templateUrl &&
              G.controller &&
              ((V = G.controller),
              (L = L || {}),
              K("'" + t + "' controller", L[t], G, Z),
              (L[t] = G));
            if ((V = G.transclude))
              (E = !0),
                G.$$tlb || (K("transclusion", T, G, Z), (T = G)),
                "element" == V
                  ? ((D = !0),
                    (v = G.priority),
                    (V = H(c, ra, W)),
                    (Z = d.$$element =
                      y(U.createComment(" " + t + ": " + d[t] + " "))),
                    (c = Z[0]),
                    mb(g, y(ya.call(V, 0)), c),
                    (Xa = x(V, e, v, f && f.name, {
            ...
            if (G.templateUrl)
              K("template", ia, G, Z),
                (ia = G),
                G.replace && (f = G),
                (J = C(a.splice(N, a.length - N), Z, d, g, Xa, l, n, {
              ...
              try {
                (O = G.compile(Z, d, Xa)),
                  P(O) ? u(null, O, ra, W) : O && u(O.pre, O.post, ra, W);
              } catch (aa) {
                m(aa, ha(Z));
              }
        ...
        function C(a, b, c, d, e, g, f, l) {
          ...
          b.empty();
          n.get(v.getTrustedResourceUrl(x), { cache: p })
            .success(function (n) {
              var p, J;
              n = Y(n);
              if (u.replace) {
        ...
        Hb.prototype = {
          ...
          $updateClass: function (a, b) {
            var c = rc(a, b),
              d = rc(b, a);
            0 === c.length
              ? J.removeClass(this.$$element, d)
              : 0 === d.length
              ? J.addClass(this.$$element, c)
              : J.setClass(this.$$element, c, d);
          },
          $set: function (a, b, c, d) {
            ...
            d
              ? (this.$attr[a] = d)
              : (d = this.$attr[a]) || (this.$attr[a] = d = fb(a, "-"));
            e = Ka(this.$$element);
    ...
    var b = /^\s*(\[|\{[^\{])/,
      ...
      e = (this.defaults = {
        transformResponse: [
          function (d) {
            w(d) &&
              ((d = d.replace(c, "")), b.test(d) && a.test(d) && (d = Wb(d)));
            return d;
          },
        ],
        transformRequest: [
    ...
    this.$get = [
      ...
      function (a, b, c, d, n, p) {
        ...
        function z(b, c, g) {
          function f(a, b, c, e) {
            v &&
              (200 <= a && 300 > a ? v.put(s, [a, b, sc(c), e]) : v.remove(s));
            l(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function l(a, c, d, e) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (v = X(b.cache) ? b.cache : X(e.cache) ? e.cache : F);
          if (v)
            if (((q = v.get(s)), B(q))) {
        ...
        (function (a) {
          q(arguments, function (a) {
            r[a] = function (b, c, d) {
              return r(D(d || {}, { method: a, url: b, data: c }));
            };
          });
        })("post", "put");
        r.defaults = e;
  ...
  function ue(b) {
    if (
      8 >= S &&
      (!b.match(/^(get|post|head|put|delete|options)$/i) || !O.XMLHttpRequest)
    )
  ...
  function ve(b, a, c, d, e) {
    ...
    return function (e, l, k, m, n, p, r, z) {
      ...
      if ("jsonp" == K(e)) {
        ...
        var A = g(
          l.replace("JSON_CALLBACK", "angular.callbacks." + J),
          function () {
        ...
        function g(g, k, m) {
          for (var n, p, r = 0, z = [], u = g.length, F = !1, v = []; r < u; )
            -1 != (n = g.indexOf(b, r)) && -1 != (p = g.indexOf(a, n + f))
              ? (r != n && z.push(g.substring(r, n)),
                z.push((r = c((F = g.substring(n + f, p))))),
                (r.exp = F),
                (r = p + h),
                (F = !0))
              : (r != u && z.push(g.substring(r)), (r = u));
              ...
              (r = function (a) {
                try {
                  for (var b = 0, c = u, f; b < c; b++)
                    "function" == typeof (f = z[b]) &&
                      ((f = f(a)),
                      (f = m ? e.getTrusted(m, f) : e.valueOf(f)),
                      null === f || E(f)
                        ? (f = "")
                        : "string" != typeof f && (f = qa(f))),
                      (v[b] = f);
                  return v.join("");
                } catch (h) {
      ...
      function (b, a, c) {
        function d(d, f, h, l) {
          ...
          p.$$intervalId = k(function () {
            ...
            0 < h &&
              r >= h &&
              (n.resolve(r), m(p.$$intervalId), delete e[p.$$intervalId]);
            z || b.$apply();
          }, f);
          e[p.$$intervalId] = n;
          return p;
        ...
        h.prototype = {
          ...
          $destroy: function () {
            if (!this.$$destroyed) {
              ...
              this.$$destroyed = !0;
              this !== p &&
                (q(this.$$listenerCount, eb(null, m, this)),
          ...
          $broadcast: function (a, b) {
            for (
              var c = this,
                ...
                f = [g].concat(ya.call(arguments, 1)),
                h,
                k;
              (c = d);
    ...
    this.$get = [
      ...
      function (b, a) {
        ...
        if (k) {
          ...
          !d ||
            (m && n) ||
            ((m = w(g.body.style.webkitTransition)),
  ...
  function Jc(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (l = He.exec(e))
          ? ((f = f.concat(ya.call(l, 1))), (e = f.pop()))
          : (f.push(e), (e = null));
      q(f, function (a) {
        h = Ie[a];
        g += h
            ...
            "ngClass" !== b &&
              g.$watch("$index", function (c, d) {
                ...
                if ((f !== d) & 1) {
                  var k = e(g.$eval(h[b]));
                  f === a
                    ? ((f = l(k, 1)), h.$addClass(f))
                    : ((f = l(k, -1)), h.$removeClass(f));
                }
              });
          },
        };
  ...
  isNaN(S) &&
    (S = Y((/trident\/.*; rv:(\d+)/.exec(K(navigator.userAgent)) || [])[1]));
  C.$inject = [];
  Da.$inject = [];
  var ca = (function () {
  ...
  var Xc = /[A-Z]/g,
    ...
    me = 1,
    Pc = O.document.addEventListener
      ? function (b, a, c) {
    ...
    Fb = O.document.removeEventListener
      ? function (b, a, c) {
  ...
  var Ja = (N.prototype = {
      ready: function (b) {
        ...
        "complete" === U.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), N(O).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
  ...
  q(
    {
      ...
      scope: function (b) {
        return (
          y(b).data("$scope") ||
          jb(b.parentNode || b, ["$isolateScope", "$scope"])
        );
      },
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, g, f) {
            ...
            q(f, function (a, c) {
              s.test(c) &&
                (m[K(c.replace("when", "").replace("Minus", "-"))] = g.attr(
                  f.$attr[c]
                ));
            });
            q(m, function (a, e) {
                ...
                for (E = c.length; I < E; I++) {
                  ...
                  for (F = k.length; A < F; A++)
                    (s = k[A]),
                      (d = z[A + 1])
                        ? ((D = d.element),
                          d.label !== s.label && D.text((d.label = s.label)),
                          d.id !== s.id && D.val((d.id = s.id)),
                          d.selected !== s.selected &&
                            D.prop("selected", (d.selected = s.selected)))
                        : ("" === s.id && u
                            ? (H = u)
                            : (H = v.clone())
                                .val(s.id)
                          ...
                          D ? D.after(H) : t.element.append(H),
                          (D = H));
