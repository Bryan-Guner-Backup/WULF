...
(function (P, V, s) {
  ...
  function $b() {
    return (
      (V.securityPolicy && V.securityPolicy.isActive) ||
      (V.querySelector &&
  ...
  function gb(b, a) {
    ...
    return !Q(a) || a instanceof RegExp
      ? a
      : c.length
      ? function () {
  ...
  function lc(b, a) {
    ...
    d &&
      (a
        ? delete Wa[c].data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), mc(b)),
          delete Wa[c],
          (b[jb] = s)));
  }
  function la(b, a, c) {
          ...
          try {
            ...
            throw (
              ...
              l.message &&
                ...
                (l = l.message + "\n" + l.stack),
              Ya("modulerr", a, l.stack || l.message || l))
            );
          }
        }
      });
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (l.pushState(null, "", a), B.attr("href", B.attr("href")))
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : C(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + F).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[f]),
              ...
              0 < h &&
                ...
                O[a] === s && (O[a] = unescape(e.substring(h + 1))));
        return O;
      }
    };
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            ...
            if (!H(b))
              return a in m || g++, (m[a] = b), g > k && this.remove(p.key), b;
          },
          get: function (a) {
            if (k < Number.MAX_VALUE) {
              var b = l[a];
    ...
    this.$get = [
      ...
      function (a, b, l, n, p, r, A, D, x, t, N, B) {
        ...
        function L(a, b, c, d, e, f) {
          ...
          for (var m = [], k, l, r, n, p = 0; p < a.length; p++)
            (k = new Lb()),
              (l = ca(a[p], [], k, 0 === p ? d : s, e)),
              (f = l.length ? ea(l, a[p], k, b, c, null, [], [], f) : null) &&
                f.scope &&
                ma(y(a[p]), "ng-scope"),
              (k =
                (f && f.terminal) || !(r = a[p].childNodes) || !r.length
                  ? null
                  : L(r, f ? f.transclude : b)),
              m.push(f, k),
              (n = n || f || k),
              (f = null);
          return n ? g : null;
            ...
            case 8:
              try {
                if ((k = e.exec(a.nodeValue)))
                  (n = na(k[1])), T(b, n, "M", d, g) && (c[n] = ba(k[2]));
              } catch (t) {}
          }
          b.sort(H);
          return b;
        ...
        function ea(a, c, d, e, f, g, m, n, p) {
          ...
          function N(a, e, f, g, p) {
            ...
            if (O) {
              ...
              g = y(f);
              F = e.$new(!0);
              !ea || (ea !== O && ea !== O.$$originalDirective)
                ? g.data("$isolateScopeNoTemplate", F)
                : g.data("$isolateScope", F);
              ...
              try {
                (B = m[g]),
                  B(
                    ...
                    I,
                    t,
                    B.require && D(B.directiveName, B.require, I, ca),
                    ob
                  );
              } catch (G) {
                l(G, ha(I));
          ...
          for (
            var t = -Number.MAX_VALUE,
              B,
              L = p.controllerDirectives,
              O = p.newIsolateScopeDirective,
              ea = p.templateDirective,
              T = p.nonTlbTranscludeDirective,
              H = !1,
              E = p.hasElementTranscludeDirective,
              Z = (d.$$element = y(c)),
              G,
              u,
              W,
            ...
            if ((W = G.scope))
              (B = B || G),
                G.templateUrl ||
                  (J("new/isolated scope", O, G, Z), U(W) && (O = G));
            u = G.name;
            !G.templateUrl &&
              G.controller &&
              ((W = G.controller),
              (L = L || {}),
              J("'" + u + "' controller", L[u], G, Z),
              (L[u] = G));
            if ((W = G.transclude))
              (H = !0),
                G.$$tlb || (J("transclusion", T, G, Z), (T = G)),
                "element" == W
                  ? ((E = !0),
                    (t = G.priority),
                    (W = F(c, ra, X)),
                    (Z = d.$$element =
                      y(V.createComment(" " + u + ": " + d[u] + " "))),
                    (c = Z[0]),
                    pb(f, y(ya.call(W, 0)), c),
                    (Za = v(W, e, t, g && g.name, {
            ...
            if (G.template)
              if (
                (J("template", ea, G, Z),
                (ea = G),
                (W = Q(G.template) ? G.template(Z, d) : G.template),
                (W = Y(W)),
                G.replace)
              ) {
                g = G;
            ...
            if (G.templateUrl)
              J("template", ea, G, Z),
                (ea = G),
                G.replace && (g = G),
                (N = w(a.splice(M, a.length - M), Z, d, f, Za, m, n, {
              ...
              try {
                (P = G.compile(Z, d, Za)),
                  Q(P) ? x(null, P, ra, X) : P && x(P.pre, P.post, ra, X);
              } catch (aa) {
                l(aa, ha(Z));
              }
        ...
        function w(a, b, c, d, e, f, g, k) {
          ...
          b.empty();
          n.get(t.getTrustedResourceUrl(N), { cache: p })
            .success(function (n) {
              var p, t;
              n = Y(n);
              if (x.replace) {
        ...
        return function (e, f) {
          ...
          if (m) {
            if (!f || "object" != typeof f.$scope)
              throw u("$controller")("noscp", h || e.name, m);
            f.$scope[m] = g;
          }
          return g;
        };
    ...
    var b = /^\s*(\[|\{[^\{])/,
      ...
      e = (this.defaults = {
        ...
        transformRequest: [
          function (a) {
            return U(a) &&
              "[object File]" !== wa.call(a) &&
              "[object Blob]" !== wa.call(a)
              ? qa(a)
              : a;
          },
        ],
    ...
    this.$get = [
      ...
      function (a, b, c, d, n, p) {
        ...
        function A(b, c, f) {
          function g(a, b, c, e) {
            t &&
              (200 <= a && 300 > a ? t.put(s, [a, b, wc(c), e]) : t.remove(s));
            m(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function m(a, c, d, e) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (t = U(b.cache) ? b.cache : U(e.cache) ? e.cache : x);
          if (t)
            if (((q = t.get(s)), z(q))) {
  ...
  function ue(b) {
    if (
      8 >= S &&
      (!b.match(/^(get|post|head|put|delete|options)$/i) || !P.XMLHttpRequest)
    )
  ...
  function Rd() {
    ...
    this.$get = [
      ...
      function (c, d, e) {
        function f(f, k, l) {
          for (var n, p, r = 0, A = [], D = f.length, x = !1, t = []; r < D; )
            -1 != (n = f.indexOf(b, r)) && -1 != (p = f.indexOf(a, n + g))
              ? (r != n && A.push(f.substring(r, n)),
                A.push((r = c((x = f.substring(n + g, p))))),
                (r.exp = x),
                (r = p + h),
                (x = !0))
              : (r != D && A.push(f.substring(r)), (r = D));
      ...
      function (b, a, c) {
        function d(d, g, h, m) {
          ...
          p.$$intervalId = k(function () {
            ...
            0 < h &&
              r >= h &&
              (n.resolve(r), l(p.$$intervalId), delete e[p.$$intervalId]);
            A || b.$apply();
          }, g);
          e[p.$$intervalId] = n;
          return p;
      ...
      function (c, d, e, f) {
        ...
        f.on("click", function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            for (var e = y(a.target); "a" !== J(e[0].nodeName); )
            ...
            if (m === Rb) {
              ...
              if (0 > k.indexOf("://"))
                if (((g = "#" + b), "/" == k[0])) g = n + g + k;
                  ...
                  for (
                    var l = h.path().split("/"), k = k.split("/"), p = 0;
                    p < k.length;
                    p++
                  )
                    "." != k[p] &&
                      (".." == k[p] ? l.pop() : k[p].length && l.push(k[p]));
                  g = n + g + l.join("/");
                }
            }
            l = h.$$rewrite(g);
            g &&
              ...
              l != d.url() &&
                (h.$$parse(l),
                c.$apply(),
                (P.angular["ff-684208-preventDefault"] = !0)));
          }
        });
        ...
        h.prototype = {
                ...
                if (h)
                  if (U(d))
                    if (db(d)) {
                      ...
                      for (a in ((g = {}), d)) Ab.call(d, a) && (g[a] = d[a]);
                  else g = d;
              }
            );
          },
          $digest: function () {
            ...
            do {
              ...
              if ((v || k.length) && !s--)
                throw ((p.$$phase = null), a("infdig", b, qa(O)));
            } while (v || k.length);
          ...
          $broadcast: function (a, b) {
            for (
              var c = this,
                ...
                g = [f].concat(ya.call(arguments, 1)),
                h,
                k;
              (c = d);
    ...
    this.$get = [
      ...
      function (b, a) {
        ...
        if (k) {
          ...
          !d ||
            (l && n) ||
            ((l = C(f.body.style.webkitTransition)),
  ...
  function Jc(b) {
    ...
    return function (b, d) {
      ...
      return Nc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
  ...
  function Kc(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (m = He.exec(e))
          ? ((g = g.concat(ya.call(m, 1))), (e = g.pop()))
          : (g.push(e), (e = null));
      q(g, function (a) {
        h = Ie[a];
        f += h
  ...
  function yb(b, a, c, d, e, f) {
    ...
    var l = function (e) {
      if (!k) {
        var f = a.val();
        if (S && "input" === (e || m).type && a[0].placeholder !== h)
          h = a[0].placeholder;
        else if (
          (Qa(c.ngTrim || "T") && (f = ba(f)),
  ...
  isNaN(S) &&
    (S = Y((/trident\/.*; rv:(\d+)/.exec(J(navigator.userAgent)) || [])[1]));
  w.$inject = [];
  Ea.$inject = [];
  var ba = (function () {
  ...
  var Xc = /[A-Z]/g,
    ...
    me = 1,
    qb = P.document.addEventListener
      ? function (b, a, c) {
    ...
    Va = P.document.removeEventListener
      ? function (b, a, c) {
  ...
  var Ja = (M.prototype = {
      ready: function (b) {
        ...
        "complete" === V.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), M(P).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
        ...
        q(d.split(" "), function (d) {
          ...
          if (!f) {
            if ("mouseenter" == d || "mouseleave" == d) {
              var l =
                V.body.contains || V.body.compareDocumentPosition
                  ? function (a, c) {
  ...
  var cd = aa({
      ...
      compile: function (a, c) {
        ...
        if (!c.href && !c.xlinkHref && !c.name)
          return function (a, c) {
            var f =
              "[object SVGAnimatedString]" === wa.call(c.prop("href"))
                ? "xlink:href"
                : "href";
      ...
      return {
        ...
        link: function (d, e, f) {
          var g = a,
            h = a;
          "href" === a &&
            "[object SVGAnimatedString]" === wa.call(e.prop("href")) &&
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, f, g) {
            ...
            q(g, function (a, c) {
              s.test(c) &&
                (l[J(c.replace("when", "").replace("Minus", "-"))] = f.attr(
                  g.$attr[c]
                ));
            });
            q(l, function (a, e) {
          ...
          link: function (e, f, g, h, m) {
            ...
            e.$watchCollection(h, function (a) {
              ...
              if (db(a)) (T = a), (n = p || r);
                ...
                T = [];
                for (C in a)
                  a.hasOwnProperty(C) && "$" != C.charAt(0) && T.push(C);
                T.sort();
              }
              F = T.length;
              h = E.length = T.length;
          ...
          link: function (e, g, h, m) {
            ...
            function n(e, f, g) {
              function h() {
                ...
                if (r)
                  if (w && K(u))
                    for (s = new Xa([]), B = 0; B < u.length; B++)
                      (I[m] = u[B]), s.put(w(e, I), u[B]);
                  else s = new Xa(u);
                for (B = 0; (E = A.length), B < E; B++) {
                  ...
                  r
                    ? (d = z(s.remove(w ? w(e, I) : q(e, I))))
                    : (w
                        ? ((d = {}), (d[m] = u), (d = w(e, d) === w(e, I)))
                        : (d = u === q(e, I)),
                      (s = s || d));
                  F = l(e, I);
                  F = z(F) ? F : "";
