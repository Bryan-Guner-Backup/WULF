...
(function (p, h, q) {
    ...
    for (
      ...
      if (f.last() && x[f.last()])
        ...
        if (0 === a.indexOf("\x3c!--"))
          (c = a.indexOf("--", 4)),
            0 <= c &&
              a.lastIndexOf("--\x3e", c) === c &&
              (d.comment && d.comment(a.substring(4, c)),
              (a = a.substring(c + 3)),
              (g = !1));
        else if (y.test(a)) {
          ...
          if ((c = a.match(z)))
            (a = a.substring(c[0].length)), c[0].replace(z, e), (g = !1);
        } else
          K.test(a) &&
            (c = a.match(A)) &&
            ((a = a.substring(c[0].length)), c[0].replace(A, b), (g = !1));
        g &&
          ((c = a.indexOf("<")),
          (g = 0 > c ? a : a.substring(0, c)),
          (a = 0 > c ? "" : a.substring(c)),
          d.chars && d.chars(r(g)));
      }
  ...
  function r(a) {
    ...
    var b = d[3];
    if ((d = d[2]))
      (n.innerHTML = d.replace(/</g, "&lt;")),
        (d = "textContent" in n ? n.textContent : n.innerText);
    return a + d + b;
  }
  function B(a) {
    return a
