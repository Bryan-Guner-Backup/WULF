...
(function (T, V, s) {
  ...
  function cc(b) {
    ...
    q((b || "").split("&"), function (b) {
      b &&
        ...
        B(d) &&
          ((b = B(c[1]) ? bc(c[1]) : !0),
          a[d] ? (O(a[d]) ? a[d].push(b) : (a[d] = [a[d], b])) : (a[d] = b)));
    });
    return a;
  }
  function Bb(b) {
  ...
  function la(b, a, c) {
    var d = b[ib],
      d = Xa[d || -1];
    if (B(c)) d || ((b[ib] = d = ++me), (d = Xa[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function nc(b, a, c) {
    var d = la(b, "data"),
    ...
    k.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : C(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + E).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
      ...
      function (a, b, l, n, p, r, v, I, x, u, M, F) {
        ...
        function P(a, b, c, d, e, g) {
          ...
          for (var m = [], h, l, r, n, p = 0; p < a.length; p++)
            (h = new Lb()),
              (l = ca(a[p], [], h, 0 === p ? d : s, e)),
              (g = l.length ? H(l, a[p], h, b, c, null, [], [], g) : null) &&
                g.scope &&
                ha(w(a[p]), "ng-scope"),
              (h =
        ...
        function H(a, c, d, e, g, f, m, n, p) {
          ...
          function M(a, e, g, f, p) {
            ...
            if (N) {
              ...
              f = w(g);
              E = e.$new(!0);
              !H || (H !== N && H !== N.$$originalDirective)
                ? f.data("$isolateScopeNoTemplate", E)
                : f.data("$isolateScope", E);
              ...
              try {
                (F = m[f]),
                  F(
                    ...
                    K,
                    u,
                    F.require && I(F.directiveName, F.require, K, ca),
                    nb
                  );
              } catch (G) {
                l(G, ga(K));
          ...
          for (
            var u = -Number.MAX_VALUE,
              F,
              P = p.controllerDirectives,
              N = p.newIsolateScopeDirective,
              H = p.templateDirective,
              ba = p.nonTlbTranscludeDirective,
              D = !1,
              J = !1,
              Ca = p.hasElementTranscludeDirective,
              t = (d.$$element = w(c)),
              G,
              na,
              X,
            ...
            if ((X = G.scope))
              (F = F || G),
                G.templateUrl ||
                  (L("new/isolated scope", N, G, t), U(X) && (N = G));
            na = G.name;
            !G.templateUrl &&
              G.controller &&
              ((X = G.controller),
              (P = P || {}),
              L("'" + na + "' controller", P[na], G, t),
              (P[na] = G));
            if ((X = G.transclude))
              (D = !0),
                G.$$tlb || (L("transclusion", ba, G, t), (ba = G)),
                "element" == X
                  ? ((Ca = !0),
                    (u = G.priority),
                    (X = E(c, W, Y)),
                    (t = d.$$element =
                      w(V.createComment(" " + na + ": " + d[na] + " "))),
                    (c = t[0]),
                    ob(g, w(ya.call(X, 0)), c),
                    (T = z(X, e, u, f && f.name, {
            ...
            if (G.template)
              if (
                ...
                L("template", H, G, t),
                (H = G),
                (X = Q(G.template) ? G.template(t, d) : G.template),
                (X = Z(X)),
                G.replace)
              ) {
                f = G;
            ...
            if (G.templateUrl)
              ...
              try {
                (R = G.compile(t, d, T)),
                  Q(R) ? x(null, R, W, Y) : R && x(R.pre, R.post, W, Y);
              } catch ($) {
                l($, ga(t));
              }
        ...
        function y(a, b, c, d, e, g, f, h) {
          ...
          b.empty();
          n.get(u.getTrustedResourceUrl(M), { cache: p })
            .success(function (n) {
              var p, u;
              n = Z(n);
              if (x.replace) {
        ...
        Lb.prototype = {
          ...
          $updateClass: function (a, b) {
            var c = vc(a, b),
              d = vc(b, a);
            0 === c.length
              ? M.removeClass(this.$$element, d)
              : 0 === d.length
              ? M.addClass(this.$$element, c)
          ...
          $set: function (a, b, c, d) {
            ...
            d
              ? (this.$attr[a] = d)
              : (d = this.$attr[a]) || (this.$attr[a] = d = hb(a, "-"));
            e = La(this.$$element);
    ...
    this.$get = [
      ...
      function (a, b, c, d, n, p) {
        ...
        function v(c, g, f) {
          function h(a, b, c, e) {
            A &&
              (200 <= a && 300 > a ? A.put(w, [a, b, wc(c), e]) : A.remove(w));
            p(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function p(a, b, d, e) {
          ...
          (c.cache || e.cache) &&
            !1 !== c.cache &&
            "GET" == c.method &&
            (A = U(c.cache) ? c.cache : U(e.cache) ? e.cache : x);
          if (A)
            if (((H = A.get(w)), B(H))) {
  ...
  function we(b, a, c, d, e) {
    ...
    return function (e, m, h, l, n, p, r, v) {
      ...
      if ("jsonp" == L(e)) {
        ...
        var F = g(
          m.replace("JSON_CALLBACK", "angular.callbacks." + M),
          M,
          function (a, b) {
            x(l, a, d[M].data, "", b);
            d[M] = y;
        ...
        function g(g, h, l) {
          for (var n, p, r = 0, v = [], I = g.length, x = !1, u = []; r < I; )
            -1 != (n = g.indexOf(b, r)) && -1 != (p = g.indexOf(a, n + f))
              ? (r != n && v.push(g.substring(r, n)),
                v.push((r = c((x = g.substring(n + f, p))))),
                (r.exp = x),
                (r = p + k),
                (x = !0))
              : (r != I && v.push(g.substring(r)), (r = I));
          (I = v.length) || (v.push(""), (I = 1));
          if (l && 1 < v.length) throw zc("noconcat", g);
          if (!h || x)
            return (
              (u.length = I),
              (r = function (a) {
            ...
            if (m === Rb) {
              ...
              if (0 > h.indexOf("://"))
                if (((f = "#" + b), "/" == h[0])) f = n + f + h;
                  ...
                  for (
                    var l = k.path().split("/"), h = h.split("/"), p = 0;
                    p < h.length;
                    p++
                  )
                    "." != h[p] &&
                      (".." == h[p] ? l.pop() : h[p].length && l.push(h[p]));
                  f = n + f + l.join("/");
                }
            }
            l = k.$$rewrite(f);
        ...
        k.prototype = {
          ...
          $destroy: function () {
            if (!this.$$destroyed) {
              ...
              this.$$destroyed = !0;
              this !== p &&
                (q(this.$$listenerCount, Ab(null, l, this)),
  ...
  function be() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = Z(
            (/android (\d+)/.exec(L((b.navigator || {}).userAgent)) || [])[1]
          ),
        ...
        if (h) {
          ...
          !d ||
            (l && n) ||
            ((l = C(g.body.style.webkitTransition)),
  ...
  function Kc(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (m = Ie.exec(e))
          ? ((f = f.concat(ya.call(m, 1))), (e = f.pop()))
          : (f.push(e), (e = null));
      q(f, function (a) {
        k = Je[a];
        g += k
    ...
    var l = function (e) {
      if (!h) {
        ...
        if (S && "input" === (e || m).type && a[0].placeholder !== k)
          ...
          (Ra(c.ngTrim || "T") && (g = aa(g)),
          d.$viewValue !== g || (f && "" === g && !f.valueMissing))
        )
          b.$$phase
            ? d.$setViewValue(g)
            : b.$apply(function () {
  ...
  isNaN(S) &&
    (S = Z((/trident\/.*; rv:(\d+)/.exec(L(navigator.userAgent)) || [])[1]));
  y.$inject = [];
  Fa.$inject = [];
  var O = (function () {
  ...
  var Xc = /[A-Z]/g,
    ...
    me = 1,
    pb = T.document.addEventListener
      ? function (b, a, c) {
  ...
  var Ka = (R.prototype = {
      ready: function (b) {
        ...
        "complete" === V.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), R(T).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, g, f) {
            ...
            q(f, function (a, c) {
              s.test(c) &&
                (l[L(c.replace("when", "").replace("Minus", "-"))] = g.attr(
                  f.$attr[c]
                ));
            });
            q(l, function (a, e) {
            ...
            function n(e, f, g) {
              function k() {
                ...
                for (A = 0; (F = D.length), A < F; A++) {
                  ...
                  r
                    ? (d = B(s.remove(x ? x(e, K) : q(e, K))))
                    : (x
                        ? ((d = {}), (d[m] = t), (d = x(e, d) === x(e, K)))
                        : (d = t === q(e, K)),
                      (s = s || d));
                  E = l(e, K);
                  E = B(E) ? E : "";
                    ...
                    (s = h[A]),
                      (d = v[A + 1])
                        ...
                        : ("" === s.id && y
                          ...
                          E ? E.after(J) : t.element.append(J),
                          (E = J));
