      ...
      function (W, H) {
        ...
        W.decorator("$animate", [
          ...
          function (y, u, $, L, F, I, P) {
            ...
            function z(a, b, c, d, e, w, g) {
              ...
              if (l) {
                ...
                var t = m.totalActive || 0,
                  u = m.last;
                if (
                  (l.isClassBased && (m.disabled || (u && !u.isClassBased))) ||
                  N(c, d)
                )
                  r(), p(), A(), v();
                else {
            ...
            function U(a) {
              if ((a = e(a)))
                (a = f.isFunction(a.getElementsByClassName)
        ...
        H.register("", [
          ...
          function (k, g, C, L) {
            ...
            function V(a, b, c, f) {
              ...
              if (-1 != k.getAttribute("class").indexOf(c) && a) {
                ...
                if (0 < s.transitionDuration) {
                  ...
                  -1 == B.indexOf("all") &&
                    ((q += w + "transition-property: " + B + ";"),
                    (q +=
                      w +
                      "transition-duration: " +
                      s.transitionDurationStyle +
                      ";"),
                    t.push(w + "transition-property"),
                    t.push(w + "transition-duration"));
                }
                0 < r &&
                  (0 < n.transitionDelay &&
                    ...
                    ((q +=
                      w +
                      "transition-delay: " +
                      T(s.transitionDelayStyle, n.transitionDelay, r) +
                      "; "),
                    t.push(w + "transition-delay")),
                  0 < n.animationDelay &&
                    0 === n.animationDuration &&
                    ((q +=
                      w +
                      "animation-delay: " +
                      T(s.animationDelayStyle, n.animationDelay, r) +
                      "; "),
                    t.push(w + "animation-delay")));
                0 < t.length &&
                  ((s = k.getAttribute("style") || ""),
                  k.setAttribute("style", s + "; " + q));
                b.on(z, l);
                b.addClass(p);
            ...
            function d(a, b) {
              ...
              c &&
                (c.running && c.running--,
                (c.running && 0 !== c.running) || a.removeData(m));
            }
            function G(a, b) {
              var c = "";
            ...
            var w = "",
              ...
              p,
              A;
            u.ontransitionend === P && u.onwebkittransitionend !== P
              ? ((w = "-webkit-"),
                (J = "WebkitTransition"),
                (H = "webkitTransitionEnd transitionend"))
              : ((J = "transition"), (H = "transitionend"));
            u.onanimationend === P && u.onwebkitanimationend !== P
              ? ((w = "-webkit-"),
                (p = "WebkitAnimation"),
