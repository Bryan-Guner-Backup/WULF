...
(function (T, V, s) {
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (l.pushState(null, "", a), Q.attr("href", Q.attr("href")))
  ...
  function fc(b, a) {
    ...
    this.$get = [
      ...
      "$animate",
      "$$sanitizeUri",
      function (a, b, l, p, n, r, t, J, w, u, K, Q) {
            ...
            case 8:
              try {
                if ((m = e.exec(a.nodeValue)))
                  (l = na(m[1])), ba(b, l, "M", d, f) && (c[l] = aa(m[2]));
              } catch (z) {}
          }
          b.sort(D);
          return b;
        ...
        function H(a, c, d, e, g, f, m, p, n) {
          function w(a, b, c, d) {
            if (a) {
              ...
              a.require = F.require;
              a.directiveName = oa;
              if (M === F || F.$$isolateScope) a = tc(a, { isolateScope: !0 });
              m.push(a);
            }
            if (b) {
              c && (b = G(b, c, d));
              ...
              try {
                (Q = m[f]),
                  Q(
                    ...
                    R,
                    u,
                    Q.require && J(Q.directiveName, Q.require, R, ca),
                    mb
                  );
              } catch (F) {
                l(F, ga(R));
          ...
          for (
            ...
            if ((X = F.scope))
              (Q = Q || F),
                F.templateUrl ||
                  (I("new/isolated scope", M, F, v), U(X) && (M = F));
            oa = F.name;
            !F.templateUrl &&
              F.controller &&
              ((X = F.controller),
              (N = N || {}),
              I("'" + oa + "' controller", N[oa], F, v),
              (N[oa] = F));
            if ((X = F.transclude))
              (D = !0),
                F.$$tlb || (I("transclusion", ba, F, v), (ba = F)),
                "element" == X
                  ? ((Da = !0),
                    (u = F.priority),
                    (X = C(c, W, Y)),
                    (v = d.$$element =
                      x(V.createComment(" " + oa + ": " + d[oa] + " "))),
                    (c = v[0]),
                    nb(g, x(za.call(X, 0)), c),
                    (T = z(X, e, u, f && f.name, {
            ...
            if (F.template)
              if (
                ...
                I("template", H, F, v),
                (H = F),
                (X = O(F.template) ? F.template(v, d) : F.template),
                (X = Z(X)),
                F.replace)
              ) {
                f = F;
            ...
            if (F.templateUrl)
              (E = !0),
                ...
                (H = F),
                F.replace && (f = F),
                (K = A(a.splice(P, a.length - P), v, d, g, D && T, m, p, {
              ...
              try {
                (S = F.compile(v, d, T)),
                  O(S) ? w(null, S, W, Y) : S && w(S.pre, S.post, W, Y);
              } catch ($) {
                l($, ga(v));
              }
    ...
    this.$get = [
      ...
      function (a, b, c, d, p, n) {
        ...
        function t(c, g, f) {
          function h(a, b, c, e) {
            G &&
              (200 <= a && 300 > a ? G.put(x, [a, b, vc(c), e]) : G.remove(x));
            n(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function n(a, b, d, e) {
          ...
          (c.cache || e.cache) &&
            !1 !== c.cache &&
            "GET" == c.method &&
            (G = U(c.cache) ? c.cache : U(e.cache) ? e.cache : w);
          if (G)
            if (((H = G.get(x)), B(H))) {
          ...
          "boolean" === d && c
            ...
            : function (a, b) {
                if (a && b && "object" === typeof a && "object" === typeof b) {
                  for (var d in a)
                    if ("$" !== d.charAt(0) && yb.call(a, d) && c(a[d], b[d]))
                      return !0;
                  return !1;
                }
                b = ("" + b).toLowerCase();
  ...
  var Ya = (S.cache = {}),
    ne = 1,
    ob = T.document.addEventListener
      ? function (b, a, c) {
    ...
    Xa = T.document.removeEventListener
      ? function (b, a, c) {
  ...
  q(
    {
      ...
      scope: function (b) {
        return (
          x(b).data("$scope") ||
          kb(b.parentNode || b, ["$isolateScope", "$scope"])
        );
      },
    ...
    Sc = {
      ...
      number: function (a, c, d, e, g, f) {
        ...
        d.max &&
          ...
          e.$formatters.push(a));
        e.$formatters.push(function (a) {
          return ra(e, "number", e.$isEmpty(a) || xb(a), a);
        });
      },
            ...
            function p(e, f, g) {
              function k() {
                ...
                for (C = 0; (G = D.length), C < G; C++) {
                  ...
                  r
                    ? (d = B(s.remove(w ? w(e, R) : q(e, R))))
                    : (w
                        ? ((d = {}), (d[m] = t), (d = w(e, d) === w(e, R)))
                        : (d = t === q(e, R)),
                      (s = s || d));
                  E = l(e, R);
                  E = B(E) ? E : "";
