...
(function (Z, P, s) {
  ...
  function Sb() {
    return (
      (P.securityPolicy && P.securityPolicy.isActive) ||
      (P.querySelector &&
        !(!P.querySelector("[ng-csp]") && !P.querySelector("[data-ng-csp]")))
    );
  }
  function qb(b, a) {
  ...
  function la(b, a, c) {
    var d = b[cb],
      d = Qa[d || -1];
    if (F(c)) d || ((b[cb] = d = ++Xc), (d = Qa[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function ac(b, a, c) {
    var d = la(b, "data"),
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (l.pushState(null, "", a), E.attr("href", E.attr("href")))
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : B(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + ca).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[f]),
              ...
              0 < h &&
                ...
                $[a] === s && ($[a] = unescape(e.substring(h + 1))));
        return $;
      }
    };
  ...
  function gc(b) {
    ...
    this.$get = [
      ...
      "$sce",
      "$animate",
      function (b, l, n, r, p, A, J, U, w, D, E) {
        ...
        function R(a, b, c, d, e, f) {
          function h(a, c, d, e) {
            var f,
              ...
              ea = [];
            p = 0;
            for (r = c.length; p < r; p++) ea.push(c[p]);
            A = p = 0;
            for (r = g.length; p < r; A++)
              (k = ea[A]),
                ...
                c
                  ? (c.scope
                      ? ((n = a.$new()), l.data("$scope", n), H(l, "ng-scope"))
                      : (n = a),
                    (l = c.transclude) || (!e && b)
                      ? c(f, n, k, d, $(a, l || b))
                      : c(f, n, k, s, e))
          ...
          for (var g = [], k, l, n, p = 0; p < a.length; p++)
            (l = new Db()),
              ...
              (k =
                ((f = k.length
                  ? wa(k, a[p], l, b, c, null, [], [], f)
                  : null) &&
                  f.terminal) ||
                !a[p].childNodes ||
                !a[p].childNodes.length
                  ? null
                  : R(a[p].childNodes, f ? f.transclude : b)),
              g.push(f),
              g.push(k),
              (n = n || f || k),
              (f = null);
            ...
            case 8:
              try {
                if ((k = d.exec(a.nodeValue)))
                  (p = ma(k[1])), ia(b, p, "M", f, h) && (c[p] = ba(k[2]));
              } catch (H) {}
          }
          b.sort(x);
          return b;
        ...
        function wa(a, b, c, d, e, f, h, g, k) {
          ...
          var U = -Number.MAX_VALUE,
            E,
            w = k.controllerDirectives,
            R = k.newIsolateScopeDirective,
            $ = k.templateDirective;
          ...
          for (
            ...
            if ((O = G.scope))
              (E = E || G),
                G.templateUrl ||
                  (z("new/isolated scope", R, G, Y), X(O) && (R = G));
            x = G.name;
            !G.templateUrl &&
              G.controller &&
              ((O = G.controller),
              (w = w || {}),
              z("'" + x + "' controller", w[x], G, Y),
              (w[x] = G));
            if ((O = G.transclude))
              (wa = !0),
                G.$$tlb || (z("transclusion", k, G, Y), (k = G)),
                "element" == O
                  ? ((ia = !0),
                    (U = G.priority),
                    (O = ca(b, N, fb)),
                    (Y = c.$$element =
                      y(P.createComment(" " + x + ": " + c[x] + " "))),
                    (b = Y[0]),
                    T(e, y(ta.call(O, 0)), b),
                    (v = t(O, d, U, f && f.name, {
                      nonTlbTranscludeDirective: k,
                    })))
                  : ((O = y(yb(b)).contents()), Y.html(""), (v = t(O, d)));
            if (G.template)
              if (
                (z("template", $, G, Y),
                ($ = G),
                (O = L(G.template) ? G.template(Y, c) : G.template),
                (O = hc(O)),
                G.replace)
              ) {
                f = G;
            ...
            if (G.templateUrl)
              z("template", $, G, Y),
                ($ = G),
                G.replace && (f = G),
                (D = F(a.splice(C, a.length - C), Y, c, e, v, h, g, {
              ...
              try {
                (u = G.compile(Y, c, v)),
                  L(u) ? p(null, u, N, fb) : u && p(u.pre, u.post, N, fb);
              } catch (Z) {
                n(Z, ha(Y));
              }
        ...
        function F(a, b, c, d, e, f, h, g) {
          var k = [],
            ...
            H = L(t.templateUrl) ? t.templateUrl(b, c) : t.templateUrl;
          b.html("");
          r.get(D.getTrustedResourceUrl(H), { cache: p })
            .success(function (p) {
              var r, D;
              p = hc(p);
              if (t.replace) {
                ...
                r = p[0];
                if (1 != p.length || 1 !== r.nodeType)
                  throw ja("tplrt", t.name, H);
                p = { $attr: {} };
                T(d, b, r);
                var E = S(r, [], p);
                X(t.scope) && V(E);
                  ...
                  pre: function (b, c, h) {
                    ...
                    if ((e = l(h[d], !0, C(a, d))))
                      (h[d] = e(b)),
                        ((c[d] || (c[d] = [])).$$inter = !0),
                        (
                          (h.$$observers && h.$$observers[d].$$scope) ||
                          b
                        ).$watch(e, function (a, b) {
                          "class" === d && a != b
                            ? h.$updateClass(a, b)
                            : h.$set(d, a);
                        });
  ...
  function ic(b, a) {
    var c = "",
      ...
      h = 0;
    a: for (; h < d.length; h++) {
      for (var g = d[h], f = 0; f < e.length; f++) if (g == e[f]) continue a;
      c += (0 < c.length ? " " : "") + g;
    }
    return c;
  }
      ...
      function (c, d) {
        return function (e, h) {
          ...
          B(e) &&
            ...
            (f = g[1]),
            (m = g[3]),
            (e = b.hasOwnProperty(f)
              ? b[f]
              : tb(h.$scope, f, !0) || tb(d, f, !0)),
            Na(e, f, !0));
          g = c.instantiate(e, h);
          if (m) {
            if (!h || "object" != typeof h.$scope)
              throw C("$controller")("noscp", f || e.name, m);
            h.$scope[m] = g;
          }
          return g;
        };
      ...
      function (a, b, c, d, n, r) {
          ...
          var d = {
            ...
            f = (function (a) {
              ...
              var c = e.headers,
                ...
                f,
                h,
                c = u({}, c.common, c[v(a.method)]);
              b(c);
              b(d);
              a: for (f in c) {
                a = v(f);
                for (h in d) if (v(h) === a) continue a;
                d[f] = c[f];
              }
              return d;
            })(a);
        ...
        function A(b, c, h) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (q = X(b.cache) ? b.cache : X(e.cache) ? e.cache : U);
          if (q)
            if (((w = q.get(s)), F(w))) {
  ...
  function od(b, a, c, d, e, h) {
    ...
    return function (e, k, l, n, r, p, A, J) {
      ...
      if ("jsonp" == v(e)) {
        ...
        var t = g(
          k.replace("JSON_CALLBACK", "angular.callbacks." + E),
          function () {
        ...
        H.onreadystatechange = function () {
          if (4 == H.readyState) {
            ...
            D !== f &&
              ...
              (b = H.responseType ? H.response : H.responseText));
            w(n, D || H.status, b, a);
          }
        };
      ...
      function (c, d, e) {
        function h(h, k, l) {
          for (var n, r, p = 0, A = [], J = h.length, q = !1, w = []; p < J; )
            -1 != (n = h.indexOf(b, p)) && -1 != (r = h.indexOf(a, n + g))
              ? (p != n && A.push(h.substring(p, n)),
                A.push((p = c((q = h.substring(n + g, r))))),
                (p.exp = q),
                (p = r + f),
                (q = !0))
              : (p != J && A.push(h.substring(p)), (p = J));
      ...
      function (b, a, c) {
        function d(d, g, f, m) {
          ...
          r.$$intervalId = k(function () {
            ...
            0 < f &&
              p >= f &&
              (n.resolve(p), l(r.$$intervalId), delete e[r.$$intervalId]);
            A || b.$apply();
          }, g);
          e[r.$$intervalId] = n;
          return r;
  ...
  function uc(b, a, c) {
    ...
    if (a.csp)
      h =
        6 > e
          ? tc(d[0], d[1], d[2], d[3], d[4], c, a)
          : function (b, f) {
              var h = 0,
                g;
              do
                (g = tc(d[h++], d[h++], d[h++], d[h++], d[h++], c, a)(b, f)),
                  (f = s),
                  (b = g);
              while (h < e);
              return g;
    ...
    this.$get = [
      ...
      function (b, a) {
        ...
        if (k) {
          ...
          !d ||
            (l && n) ||
            ((l = B(h.body.style.webkitTransition)),
            (n = B(h.body.style.webkitAnimation)));
        }
        return {
      ...
      var h = function (a, b) {
        ...
        switch (typeof a) {
          ...
          case "object":
            ...
            return !1;
          case "array":
            for (d = 0; d < a.length; d++) if (h(a[d], b)) return !0;
            return !1;
          default:
            return !1;
        }
  ...
  function Ec(b, a, c, d, e) {
    ...
    if (k) 0 < e && -1 < b && 1 > b && (f = b.toFixed(e));
    else {
  ...
  function nb(b, a, c, d, e, h) {
    ...
    if (e.hasEvent("input")) a.on("input", f);
    else {
      var m,
        k = function () {
          m ||
    ...
    l &&
      ((e = l.match(/^\/(.*)\/([gim]*)$/))
        ...
        : (e = function (c) {
            var d = b.$eval(l);
            if (!d || !d.test) throw C("ngPattern")("noregexp", l, d, ha(a));
            return n(d, c);
          }),
      d.$formatters.push(e),
      d.$parsers.push(e));
  ...
  var v = function (b) {
    ...
    La = C("ng"),
    ab = Z.angular || (Z.angular = {}),
    Ta,
    Fa,
    ka = ["0", "0", "0"];
  N = T((/msie (\d+)/.exec(v(navigator.userAgent)) || [])[1]);
  isNaN(N) &&
    (N = T((/trident\/.*; rv:(\d+)/.exec(v(navigator.userAgent)) || [])[1]));
  x.$inject = [];
  Aa.$inject = [];
  var ba = (function () {
  ...
  var Tc = /[A-Z]/g,
    ...
    Qa = (M.cache = {}),
    cb = (M.expando = "ng-" + new Date().getTime()),
    Xc = 1,
    Hc = Z.document.addEventListener
      ? function (b, a, c) {
    ...
    Ea = (M.prototype = {
      ready: function (b) {
        ...
        "complete" === P.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), M(Z).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
        ...
        q(d.split(" "), function (d) {
          ...
          if (!h) {
            if ("mouseenter" == d || "mouseleave" == d) {
              var l =
                P.body.contains || P.body.compareDocumentPosition
                  ? function (a, c) {
  ...
  Kb.prototype = {
      ...
      for (a = []; this.index < this.text.length; ) {
        ...
        if (this.is("\"'")) this.readString(this.ch);
          ...
          var d = this.ch + this.peek(),
            ...
            f = Ia[e];
          f
            ? (this.tokens.push({ index: this.index, text: e, fn: f }),
              (this.index += 3))
            : g
    ...
    readIdent: function () {
      for (
        var a = this, c = "", d = this.index, e, h, g, f;
        this.index < this.text.length;

      ) {
        f = this.text.charAt(this.index);
        if ("." === f || this.isIdent(f) || this.isNumber(f))
          "." === f && (e = this.index), (c += f);
        else break;
        this.index++;
      }
      if (e)
        for (h = this.index; h < this.text.length; ) {
  ...
  Wa.prototype = {
      ...
      for (var a = this.expect(), c = this.$filter(a.text), d = []; ; )
        if ((a = this.expect(":"))) d.push(this.expression());
          ...
          var e = function (a, e, f) {
            f = [f];
            for (var m = 0; m < d.length; m++) f.push(d[m](a, e));
            return c.apply(a, f);
          };
          return function () {
            return e;
    ...
    arrayDeclaration: function () {
      ...
      return u(
        function (c, d) {
          for (var g = [], f = 0; f < a.length; f++) g.push(a[f](c, d));
          return g;
        },
  ...
  var Jb = {},
    ...
    aa = P.createElement("a"),
    xc = /^\/?.*?:(\/.*)/,
    yc = xa(Z.location.href, !0);
  zc.$inject = ["$provide"];
  Ac.$inject = ["$locale"];
  Cc.$inject = ["$locale"];
  var Fc = ".",
  ...
  var Ud = da({
      ...
      compile: function (a, c) {
        8 >= N &&
          ...
          a.append(P.createComment("IE fix")));
        return function (a, c) {
  ...
  var Ic = function (a) {
    ...
    Yd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/,
    Zd = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
    Jc = {
      text: nb,
              ...
              Ma(h)
                ? m ||
                  ...
                  g(m, function (c) {
                    f = {
                      startNode: c[0],
                      endNode: (c[c.length++] = P.createComment(
                        " end ngIf: " + e.ngIf + " "
                      )),
                    };
    ...
    re = [
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, h, g) {
            var f = g.count,
              m = g.$attr.when && h.attr(g.$attr.when),
              k = g.offset || 0,
              l = e.$eval(m) || {},
              n = {},
              r = c.startSymbol(),
            ...
            q(g, function (a, c) {
              s.test(c) &&
                (l[v(c.replace("when", "").replace("Minus", "-"))] = h.attr(
                  g.$attr[c]
                ));
            });
            q(l, function (a, e) {
    ...
    xe = sa({
      ...
      compile: function (a, c) {
        return function (a, e, h, g, f) {
          ...
          g.cases["!" + c.ngSwitchWhen].push({ transclude: f, element: e });
        };
      },
    }),
    ye = sa({
          ...
          link: function (e, g, f, m) {
            ...
            function n(e, f, h) {
              function g() {
                ...
                for (I = 0; (B = z.length), I < B; I++) {
                  ...
                  A
                    ? (d = F(s.remove(t ? t(e, v) : q(e, v))))
                    : (t
                        ? ((d = {}), (d[m] = u), (d = t(e, d) === t(e, v)))
                        : (d = u === q(e, v)),
                      (s = s || d));
                  C = l(e, v);
                  C = F(C) ? C : "";
                ...
                for (z = c.length; v < z; v++) {
                  ...
                  for (B = k.length; I < B; I++)
                    (s = k[I]),
                      (d = w[I + 1])
                        ? ((C = d.element),
                          d.label !== s.label && C.text((d.label = s.label)),
                          d.id !== s.id && C.val((d.id = s.id)),
                          C[0].selected !== s.selected &&
                            C.prop("selected", (d.selected = s.selected)))
                        : ("" === s.id && x
                            ? (H = x)
                            : (H = D.clone())
                                .val(s.id)
                          ...
                          C ? C.after(H) : u.element.append(H),
                          (C = H));
                  for (I++; w.length > I; ) w.pop().element.remove();
                }
                for (; y.length > v; ) y.pop()[0].element.remove();
              }
              var k;
            ...
            if (m[1]) {
              var r = m[0],
                ...
                x = !1,
                w,
                D = y(P.createElement("option")),
                E = y(P.createElement("optgroup")),
                t = D.clone();
              m = 0;
