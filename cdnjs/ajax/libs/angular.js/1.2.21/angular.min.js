...
(function (P, W, s) {
  ...
  function Bb(b, a) {
    ...
    return !C(a) || a instanceof RegExp
      ? a
      : c.length
      ? function () {
    ...
    k.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : z(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + O).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[f]),
              ...
              0 < k &&
                ...
                T[a] === s && (T[a] = unescape(e.substring(k + 1))));
        return T;
      }
    };
  ...
  function ic(b, a) {
    ...
    this.$get = [
      ...
      "$animate",
      "$$sanitizeUri",
      function (a, b, l, p, n, r, t, L, w, u, M, X) {
        ...
        function J(a, b, c, d, e, f) {
          ...
          for (var m = [], h, l, r, p, n = 0; n < a.length; n++)
            (h = new Ob()),
              ...
              (f = l.length ? H(l, a[n], h, b, c, null, [], [], f) : null) &&
                f.scope &&
        ...
        function H(a, c, d, e, f, g, m, p, n) {
          ...
          function M(a, e, f, g, n) {
            ...
            if (J) {
              var ca = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
              O = e.$new(!0);
              !H || (H !== J && H !== J.$$originalDirective)
                ? N.data("$isolateScopeNoTemplate", O)
                : N.data("$isolateScope", O);
              ...
              try {
                (E = m[g]),
                  E(
                    ...
                    N,
                    u,
                    E.require && L(E.directiveName, E.require, N, ea),
                    pb
                  );
              } catch (ob) {
                l(ob, ha(N));
          ...
          for (
            ...
            if ((U = G.scope))
              (T = T || G),
                G.templateUrl ||
                  (K("new/isolated scope", J, G, y), S(U) && (J = G));
            na = G.name;
            !G.templateUrl &&
              G.controller &&
              ((U = G.controller),
              (X = X || {}),
              K("'" + na + "' controller", X[na], G, y),
              (X[na] = G));
            if ((U = G.transclude))
              (v = !0),
                G.$$tlb || (K("transclusion", ca, G, y), (ca = G)),
                "element" == U
                  ? ((Ea = !0),
                    (u = G.priority),
                    (U = y),
                    (y = d.$$element =
                      x(W.createComment(" " + na + ": " + d[na] + " "))),
                    (c = y[0]),
                    qb(f, Aa.call(U, 0), c),
                    (R = A(U, e, u, g && g.name, {
            ...
            if (G.template)
              if (
                ...
                K("template", H, G, y),
                (H = G),
                (U = C(G.template) ? G.template(y, d) : G.template),
                (U = Z(U)),
                G.replace)
              ) {
                g = G;
            ...
            if (G.templateUrl)
              ...
              try {
                (Q = G.compile(y, d, R)),
                  C(Q) ? w(null, Q, V, Y) : Q && w(Q.pre, Q.post, V, Y);
              } catch (ba) {
                l(ba, ha(y));
              }
        ...
        function D(a, b, c, d, e, f, g, m) {
          ...
          b.empty();
          p.get(u.getTrustedResourceUrl(M), { cache: n })
            .success(function (p) {
              var n, u;
              p = Z(p);
              if (w.replace) {
          ...
          return function (a, b, c, d, e) {
            ...
            h
              ...
              : (l.transcludeOnThisElement && (a = T(b, l.transclude, e)),
                l(r, b, c, d, a));
          };
        }
        function v(a, b) {
        ...
        Ob.prototype = {
          ...
          $set: function (a, b, c, d) {
            ...
            d
              ? (this.$attr[a] = d)
              : (d = this.$attr[a]) || (this.$attr[a] = d = jb(a, "-"));
            e = Ma(this.$$element);
    ...
    this.$get = [
      ...
      function (a, b, c, d, p, n) {
        ...
        function t(c, f, g) {
          function h(a, b, c, e) {
            E &&
              (200 <= a && 300 > a ? E.put(x, [a, b, vc(c), e]) : E.remove(x));
            n(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function n(a, b, d, e) {
          ...
          (c.cache || e.cache) &&
            !1 !== c.cache &&
            "GET" == c.method &&
            (E = S(c.cache) ? c.cache : S(e.cache) ? e.cache : w);
          if (E)
            if (((H = E.get(x)), B(H))) {
          ...
          v(H) &&
            ((H = Pb(c.url)
              ...
              : s) && (g[c.xsrfHeaderName || e.xsrfHeaderName] = H),
            a(
              c.method,
              x,
              f,
      ...
      function (c, d, e) {
        function f(f, h, l) {
          for (var p, n, r = 0, t = [], L = f.length, w = !1, u = []; r < L; )
            -1 != (p = f.indexOf(b, r)) && -1 != (n = f.indexOf(a, p + g))
              ? (r != p && t.push(f.substring(r, p)),
                t.push((r = c((w = f.substring(p + g, n))))),
                (r.exp = w),
                (r = n + k),
                (w = !0))
              : (r != L && t.push(f.substring(r)), (r = L));
            ...
            do {
              ...
              a: do {
                ...
                if (!(k = J.$$childHead || (J !== this && J.$$nextSibling)))
                  for (; J !== this && !(k = J.$$nextSibling); ) J = J.$parent;
              } while ((J = k));
              if ((A || h.length) && !s--)
      ...
      function (b, a) {
        ...
        if (h) {
          ...
          !d ||
            ...
            (p = z(f.body.style.webkitAnimation)));
        }
        return {
  ...
  isNaN(Q) &&
    (Q = Z((/trident\/.*; rv:(\d+)/.exec(K(navigator.userAgent)) || [])[1]));
  D.$inject = [];
  Ga.$inject = [];
  var I = (function () {
  ...
  var La = (R.prototype = {
      ready: function (b) {
        ...
        "complete" === W.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), R(P).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
  ...
  q(
    {
      ...
      isolateScope: function (b) {
        return (
          x.data(b, "$isolateScope") || x.data(b, "$isolateScopeNoTemplate")
        );
      },
      controller: oc,
      injector: function (b) {
  ...
  cb.prototype = {
    ...
    unary: function () {
      ...
      return this.expect("+")
        ? this.primary()
        : (a = this.expect("-"))
        ? this.binaryFn(cb.ZERO, a.fn, this.unary())
        : (a = this.expect("!"))
            ...
            function p(e, f, g) {
              function k() {
                ...
                for (C = 0; (E = A.length), C < E; C++) {
                  ...
                  r
                    ? (d = B(s.remove(w ? w(e, N) : q(e, N))))
                    : (w
                        ? ((d = {}), (d[m] = t), (d = w(e, d) === w(e, N)))
                        : (d = t === q(e, N)),
                      (s = s || d));
                  F = l(e, N);
                  F = B(F) ? F : "";
