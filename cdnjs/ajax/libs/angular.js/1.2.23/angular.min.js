...
(function (Q, X, t) {
      ...
      if (P(b))
        for (d in b)
          "prototype" == d ||
            ...
            a.call(c, b[d], d);
      else if (H(b) || fb(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (l.pushState(null, "", a), I.attr("href", I.attr("href")))
              : ((w = a), c ? h.replace(a) : (h.href = a)),
            k
          );
    ...
    k.cookies = function (a, b) {
      ...
      if (a)
        b === t
          ...
          : z(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + J).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[f]),
              ...
              0 < k &&
                ...
                W[a] === t && (W[a] = unescape(e.substring(k + 1))));
        return W;
      }
    };
  ...
  function ic(b, a) {
    ...
    this.$get = [
      ...
      "$animate",
      "$$sanitizeUri",
      function (a, b, l, n, p, q, s, L, v, C, O, I) {
        ...
        function K(a, b, c, d, e, f) {
          ...
          for (var m = [], h, l, q, n, p = 0; p < a.length; p++)
            (h = new Ob()),
              (l = ea(a[p], [], h, 0 === p ? d : t, e)),
              (f = l.length ? F(l, a[p], h, b, c, null, [], [], f) : null) &&
                f.scope &&
        ...
        function ea(a, b, c, d, g) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              for (
                var l, q, n, p = a.attributes, s = 0, L = p && p.length;
                s < L;
                s++
              ) {
                var C = !1,
        ...
        function F(a, c, d, e, f, g, m, n, p) {
          function L(a, b, c, d) {
            if (a) {
              ...
              a.require = G.require;
              a.directiveName = oa;
              if (K === G || G.$$isolateScope) a = tc(a, { isolateScope: !0 });
              m.push(a);
            }
            if (b) {
              c && (b = E(b, c, d));
          ...
          function O(a, e, f, g, p) {
            ...
            if (K) {
              var Na = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
              J = e.$new(!0);
              !F || (F !== K && F !== K.$$originalDirective)
                ? M.data("$isolateScopeNoTemplate", J)
                : M.data("$isolateScope", J);
              ...
              try {
                (I = m[g]),
                  I(
                    ...
                    M,
                    v,
                    I.require && C(I.directiveName, I.require, M, ea),
                    qb
                  );
              } catch (ca) {
                l(ca, ha(M));
          ...
          for (
            ...
            if ((U = G.scope))
              (I = I || G),
                G.templateUrl ||
                  (N("new/isolated scope", K, G, x), T(U) && (K = G));
            oa = G.name;
            !G.templateUrl &&
              G.controller &&
              ((U = G.controller),
              (W = W || {}),
              N("'" + oa + "' controller", W[oa], G, x),
              (W[oa] = G));
            if ((U = G.transclude))
              (D = !0),
                G.$$tlb || (N("transclusion", ca, G, x), (ca = G)),
                "element" == U
                  ? ((Ea = !0),
                    (v = G.priority),
                    (U = x),
                    (x = d.$$element =
                      u(X.createComment(" " + oa + ": " + d[oa] + " "))),
                    (c = x[0]),
                    Na(f, Aa.call(U, 0), c),
                    (S = w(U, e, v, g && g.name, {
            ...
            if (G.template)
              if (
                ...
                N("template", F, G, x),
                (F = G),
                (U = P(G.template) ? G.template(x, d) : G.template),
                (U = Z(U)),
                G.replace)
              ) {
                g = G;
            ...
            if (G.templateUrl)
              ...
              try {
                (R = G.compile(x, d, S)),
                  P(R) ? L(null, R, V, Y) : R && L(R.pre, R.post, V, Y);
              } catch (ba) {
                l(ba, ha(x));
              }
        ...
        function y(a, b, c, d, e, f, g, m) {
          ...
          b.empty();
          n.get(C.getTrustedResourceUrl(O), { cache: p })
            .success(function (n) {
              var p, C;
              n = Z(n);
              if (v.replace) {
        ...
        Ob.prototype = {
          ...
          $updateClass: function (a, b) {
            var c = uc(a, b),
              d = uc(b, a);
            0 === c.length
              ? O.removeClass(this.$$element, d)
              : 0 === d.length
              ? O.addClass(this.$$element, c)
              : O.setClass(this.$$element, c, d);
          },
        ...
        return function (e, f) {
          ...
          if (m) {
            if (!f || "object" !== typeof f.$scope)
              throw x("$controller")("noscp", k || e.name, m);
            f.$scope[m] = g;
          }
          return g;
        };
    ...
    this.$get = [
      ...
      function (a, b, c, d, n, p) {
        ...
        function s(c, f, g) {
          function h(a, b, c, e) {
            E &&
              (200 <= a && 300 > a ? E.put(u, [a, b, vc(c), e]) : E.remove(u));
            p(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function p(a, b, d, e) {
          ...
          (!c.cache && !e.cache) ||
            ...
            (E = T(c.cache) ? c.cache : T(e.cache) ? e.cache : v);
          if (E)
            if (((F = E.get(u)), A(F))) {
          ...
          D(F) &&
            ((F = Pb(c.url)
              ...
              : t) && (g[c.xsrfHeaderName || e.xsrfHeaderName] = F),
            a(
              c.method,
              u,
              f,
  ...
  function we(b, a, c, d, e) {
    ...
    return function (e, m, h, l, n, p, q, s) {
      ...
      if ("jsonp" == N(e)) {
        ...
        var I = f(
          m.replace("JSON_CALLBACK", "angular.callbacks." + O),
          O,
          function (a, b) {
            v(l, a, d[O].data, "", b);
            d[O] = y;
          ...
          for (var n, p, q = 0, s = [], L = f.length, v = !1, C = []; q < L; )
            -1 != (n = f.indexOf(b, q)) && -1 != (p = f.indexOf(a, n + g))
              ? (q != n && s.push(f.substring(q, n)),
                s.push((q = c((v = f.substring(n + g, p))))),
                (q.exp = v),
                (q = p + k),
                (v = !0))
              : (q != L && s.push(f.substring(q)), (q = L));
  ...
  function ce() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = Z(
            (/android (\d+)/.exec(N((b.navigator || {}).userAgent)) || [])[1]
          ),
        ...
        if (h) {
          ...
          !d ||
            (l && n) ||
            ((l = z(f.body.style.webkitTransition)),
            (n = z(f.body.style.webkitAnimation)));
        }
        return {
    ...
    var n = function (e) {
      if (!l) {
        ...
        if (R && "input" === (e || m).type && a[0].placeholder !== k)
          ...
          ("password" !== h && Ta(c.ngTrim || "T") && (f = aa(f)),
  ...
  isNaN(R) &&
    (R = Z((/trident\/.*; rv:(\d+)/.exec(N(navigator.userAgent)) || [])[1]));
  y.$inject = [];
  Ga.$inject = [];
  var H = (function () {
  ...
  var $a = (S.cache = {}),
    ne = 1,
    rb = Q.document.addEventListener
      ? function (b, a, c) {
    ...
    Za = Q.document.removeEventListener
      ? function (b, a, c) {
  ...
  var La = (S.prototype = {
      ready: function (b) {
        ...
        "complete" === X.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), S(Q).on("load", a));
      },
      toString: function () {
        var b = [];
        r(this, function (a) {
  ...
  r(
    {
      ...
      isolateScope: function (b) {
        return (
          u.data(b, "$isolateScope") || u.data(b, "$isolateScopeNoTemplate")
        );
      },
      controller: oc,
      injector: function (b) {
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, f, g) {
            ...
            r(g, function (a, c) {
              s.test(c) &&
                (l[N(c.replace("when", "").replace("Minus", "-"))] = f.attr(
                  g.$attr[c]
                ));
            });
            r(l, function (a, e) {
            ...
            function n(e, f, g) {
              function k() {
                ...
                for (B = 0; (I = E.length), B < I; B++) {
                  ...
                  q
                    ? (d = A(w.remove(u ? u(e, M) : r(e, M))))
                    : (u
                        ? ((d = {}), (d[m] = s), (d = u(e, d) === u(e, M)))
                        : (d = s === r(e, M)),
                      (w = w || d));
                  D = l(e, M);
                  D = A(D) ? D : "";
                ...
                for (E = c.length; M < E; M++) {
                  ...
                  for (I = h.length; B < I; B++)
                    (d = h[B]),
                      (w = t[B + 1])
                        ? ((D = w.element),
                          w.label !== d.label && D.text((w.label = d.label)),
                          w.id !== d.id && D.val((w.id = d.id)),
                          D[0].selected !== d.selected &&
                            (D.prop("selected", (w.selected = d.selected)),
                            R && D.prop("selected", w.selected)))
                        : ("" === d.id && x
                            ? (J = x)
                            : (J = C.clone())
                                .val(d.id)
                          ...
                          D ? D.after(J) : s.element.append(J),
                          (D = J));
