...
(function (W, X, t) {
      ...
      if (P(b))
        for (d in b)
          "prototype" == d ||
            ...
            a.call(c, b[d], d);
      else if (L(b) || Pa(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
  ...
  function bc(b, a) {
    return M(new (M(function () {}, { prototype: b }))(), a);
  }
  function y() {}
  function Qa(b) {
    return b;
  ...
  function oa(b, a, c) {
    var d = b.ng339,
      d = ab[d || -1];
    if (x(c)) d || ((b.ng339 = d = ++ne), (d = ab[d] = {})), (d[a] = c);
    else return d && d[a];
  }
  function Mb(b, a, c) {
    var d = oa(b, "data"),
    ...
    k.cookies = function (a, b) {
      ...
      if (a)
        b === t
          ...
          : A(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + I).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
  ...
  function ic(b, a) {
    ...
    this.$get = [
      ...
      "$animate",
      "$$sanitizeUri",
      function (a, b, l, n, p, q, s, F, v, B, N, R) {
            ...
            case 8:
              try {
                if ((h = e.exec(a.nodeValue)))
                  (l = pa(h[1])), fa(b, l, "M", d, g) && (c[l] = ba(h[2]));
              } catch (w) {}
          }
          b.sort(z);
          return b;
        ...
        function H(a, c, d, e, f, g, m, n, p) {
          ...
          function N(a, e, f, g, p) {
            ...
            if (J) {
              ...
              !H || (H !== J && H !== J.$$originalDirective)
                ? K.data("$isolateScopeNoTemplate", I)
                : K.data("$isolateScope", I);
              ...
              try {
                (O = m[g]),
                  O(
                    ...
                    K,
                    v,
                    O.require && B(O.directiveName, O.require, K, da),
                    rb
                  );
              } catch (G) {
                l(G, ia(K));
          ...
          for (
            ...
            if ((V = G.scope))
              (O = O || G),
                G.templateUrl ||
                  (db("new/isolated scope", J, G, Z), T(V) && (J = G));
            E = G.name;
            !G.templateUrl &&
              G.controller &&
              ((V = G.controller),
              (R = R || {}),
              db("'" + E + "' controller", R[E], G, Z),
              (R[E] = G));
            if ((V = G.transclude))
              (z = !0),
                ...
                "element" == V
                  ? ((D = !0),
                    ...
                    (V = Z),
                    (Z = d.$$element =
                      u(X.createComment(" " + E + ": " + d[E] + " "))),
                    (c = Z[0]),
                    Na(f, Ba.call(V, 0), c),
                    (S = w(V, e, v, g && g.name, {
                      nonTlbTranscludeDirective: fa,
                    })))
                  : ((V = u(Kb(c)).contents()), Z.empty(), (S = w(V, e)));
            if (G.template)
              if (
                ((M = !0),
                db("template", H, G, Z),
            ...
            if (G.templateUrl)
              (M = !0),
                ...
                (H = G),
                G.replace && (g = G),
                (N = ue(a.splice(Fa, a.length - Fa), Z, d, f, z && S, m, n, {
        ...
        function ue(a, b, c, d, e, f, g, h) {
          ...
          b.empty();
          n.get(B.getTrustedResourceUrl(N), { cache: p })
            .success(function (n) {
              var p, B;
              n = W(n);
              if (v.replace) {
              ...
              for (q = J(b[0].childNodes, e); m.length; ) {
                ...
                if (B !== s) {
                  var I = B.className;
                  (h.hasElementTranscludeDirective && v.replace) || (w = Kb(p));
                  Na(R, u(B), w);
                  ca(u(w), I);
                }
        ...
        return function (e, f) {
          ...
          if (m) {
            if (!f || "object" !== typeof f.$scope)
              throw E("$controller")("noscp", k || e.name, m);
            f.$scope[m] = g;
          }
          return g;
        };
    ...
    this.$get = [
      ...
      function (a, b, c, d, n, p) {
        ...
        function s(c, f, g) {
          function h(a, b, c, e) {
            C &&
              (200 <= a && 300 > a ? C.put(u, [a, b, vc(c), e]) : C.remove(u));
            p(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function p(a, b, d, e) {
          ...
          (!c.cache && !e.cache) ||
            ...
            (C = T(c.cache) ? c.cache : T(e.cache) ? e.cache : v);
          if (C)
            if (((H = C.get(u)), x(H))) {
  ...
  function Sd() {
    ...
    this.$get = [
      ...
      function (c, d, e) {
        function f(f, h, l) {
          for (var n, p, q = 0, s = [], F = f.length, v = !1, B = []; q < F; )
      ...
      function (c, d, e, f) {
        ...
        f.on("click", function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            for (var e = u(a.target); "a" !== D(e[0].nodeName); )
          ...
          $digest: function () {
            ...
            do {
              ...
              a: do {
                ...
                if (!(h = J.$$childHead || (J !== this && J.$$nextSibling)))
                  for (; J !== this && !(h = J.$$nextSibling); ) J = J.$parent;
              } while ((J = h));
              if ((w || l.length) && !t--)
  ...
  function ce() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = U(
            (/android (\d+)/.exec(D((b.navigator || {}).userAgent)) || [])[1]
          ),
        ...
        if (h) {
          ...
          !d ||
            (l && n) ||
            ((l = A(f.body.style.webkitTransition)),
    ...
    var n = function (e) {
      if (!l) {
        ...
        if (Q && "input" === (e || m).type && a[0].placeholder !== k)
          ...
          ("password" !== h && Ua(c.ngTrim || "T") && (f = ba(f)),
  ...
  isNaN(Q) &&
    (Q = U((/trident\/.*; rv:(\d+)/.exec(D(navigator.userAgent)) || [])[1]));
  y.$inject = [];
  Qa.$inject = [];
  var L = (function () {
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, f, g) {
            ...
            r(g, function (a, c) {
              s.test(c) &&
                (l[D(c.replace("when", "").replace("Minus", "-"))] = f.attr(
                  g.$attr[c]
                ));
            });
            r(l, function (a, e) {
          ...
          link: function (e, f, g, k, m) {
            ...
            e.$watchCollection(k, function (a) {
              ...
              if (Pa(a)) (E = a), (y = p || q);
                ...
                E = [];
                for (H in a)
                  a.hasOwnProperty(H) && "$" != H.charAt(0) && E.push(H);
                E.sort();
              }
              I = E.length;
              k = D.length = E.length;
          ...
          link: function (e, g, k, m) {
            ...
            function n(e, f, g) {
              function k() {
                ...
                y = !1;
                if (q)
                  if (((h = g.$modelValue), u && L(h)))
                    for (y = new bb([]), d = {}, w = 0; w < h.length; w++)
                      (d[m] = h[w]), y.put(u(e, d), h[w]);
                  else y = new bb(h);
                w = y;
                var C, I;
                ...
                for (A = c.length; K < A; K++) {
                  ...
                  C = null;
                  y = 0;
                  for (D = h.length; y < D; y++)
                    (d = h[y]),
                      (w = t[y + 1])
                        ? ((C = w.element),
                          w.label !== d.label && C.text((w.label = d.label)),
                          w.id !== d.id && C.val((w.id = d.id)),
                          C[0].selected !== d.selected &&
                            (C.prop("selected", (w.selected = d.selected)),
                            Q && C.prop("selected", w.selected)))
                        : ("" === d.id && F
                            ? (I = F)
                            : (I = B.clone())
                                .val(d.id)
                          ...
                          C ? C.after(I) : s.element.append(I),
                          (C = I));
            ...
            if (m[1]) {
              ...
              var q = k.multiple,
                ...
                F = !1,
                v,
                B = u(X.createElement("option")),
                E = u(X.createElement("optgroup")),
                A = B.clone();
              k = 0;
              for (var w = g.children(), D = w.length; k < D; k++)
                if ("" === w[k].value) {
                  v = F = w.eq(k);
                  break;
                }
