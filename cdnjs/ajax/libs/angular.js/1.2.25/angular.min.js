...
(function (W, X, t) {
      ...
      if (P(b))
        for (d in b)
          "prototype" == d ||
            ...
            a.call(c, b[d], d);
      else if (I(b) || Pa(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
        ...
        function da(a, b, c, d, g) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              for (
                var l, q, n, p = a.attributes, s = 0, E = p && p.length;
                s < E;
                s++
              ) {
                var B = !1,
        ...
        function H(a, c, d, e, f, g, m, n, p) {
          ...
          function N(a, e, f, g, p) {
            ...
            if (K) {
              var Na = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
              C = e.$new(!0);
              !H || (H !== K && H !== K.$$originalDirective)
                ? L.data("$isolateScopeNoTemplate", C)
                : L.data("$isolateScope", C);
              ...
              try {
                (O = m[g]),
                  O(
                    ...
                    L,
                    u,
                    O.require && B(O.directiveName, O.require, L, da),
                    rb
                  );
              } catch (G) {
                l(G, ia(L));
          ...
          for (
            var u = -Number.MAX_VALUE,
              ...
              y = !1,
              J = !1,
              M = p.hasElementTranscludeDirective,
              Z = (d.$$element = v(c)),
              G,
              D,
              V,
            ...
            if ((V = G.scope))
              (O = O || G),
                G.templateUrl ||
                  (db("new/isolated scope", K, G, Z), T(V) && (K = G));
            D = G.name;
            !G.templateUrl &&
              G.controller &&
              ((V = G.controller),
    ...
    this.$get = [
      ...
      function (a, b, c, d, n, p) {
        ...
        function s(c, f, g) {
          function h(a, b, c, e) {
            x &&
              (200 <= a && 300 > a ? x.put(v, [a, b, vc(c), e]) : x.remove(v));
            p(b, a, c, e);
            d.$$phase || d.$apply();
          }
          function p(a, b, d, e) {
          ...
          (!c.cache && !e.cache) ||
            ...
            (x = T(c.cache) ? c.cache : T(e.cache) ? e.cache : u);
          if (x)
            if (((H = x.get(v)), z(H))) {
  ...
  isNaN(Q) &&
    (Q = U((/trident\/.*; rv:(\d+)/.exec(M(navigator.userAgent)) || [])[1]));
  F.$inject = [];
  Qa.$inject = [];
  var I = (function () {
  ...
  r(
    {
      ...
      isolateScope: function (b) {
        return (
          v.data(b, "$isolateScope") || v.data(b, "$isolateScopeNoTemplate")
        );
      },
      controller: oc,
      injector: function (b) {
            ...
            function n(e, f, g) {
              function k() {
                ...
                for (x = 0; (F = A.length), x < F; x++) {
                  ...
                  q
                    ? (d = z(w.remove(v ? v(e, L) : r(e, L))))
                    : (v
                        ? ((d = {}), (d[m] = s), (d = v(e, d) === v(e, L)))
                        : (d = s === r(e, L)),
                      (w = w || d));
                  C = l(e, L);
                  C = z(C) ? C : "";
